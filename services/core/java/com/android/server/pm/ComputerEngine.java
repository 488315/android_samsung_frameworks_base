...
import com.samsung.android.server.p025pm.desktopmode.DesktopModeUtils;
import com.samsung.android.server.p025pm.nal.GetAppListHelper;
...
public class ComputerEngine implements Computer {
  public static final Comparator sProviderInitOrderSorter = new Comparator() { // from class:
        // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda0
  ...
  public int mUsed = 0;
  public final File mPendingThemePkgUninstallIndicatorFile =
      new File("/data/overlays", "pending_migrated_packages_uninstall.txt");
  ...
  public class Settings {
    ...
    public boolean isEnabledAndMatch(
        AndroidPackage androidPackage, ParsedMainComponent parsedMainComponent, long j, int i) {
    ...
    public void writePreferredActivitiesLPr(
        TypedXmlSerializer typedXmlSerializer, int i, boolean z) {
  ...
  public static /* synthetic */ int lambda$static$0(
      ProviderInfo providerInfo, ProviderInfo providerInfo2) {
  ...
  public ComputerEngine(PackageManagerService.Snapshot snapshot, int i) {
    ...
    DomainVerificationManagerInternal domainVerificationManagerInternal =
        packageManagerService2.mDomainVerificationManager;
    ...
    this.mCrossProfileIntentResolverEngine =
        new CrossProfileIntentResolverEngine(
            userManagerService, domainVerificationManagerInternal, defaultAppProvider, context);
  ...
  @Override // com.android.server.pm.Computer
  public final List queryIntentActivitiesInternal(
      Intent intent, String str, long j, long j2, int i, int i2, boolean z, boolean z2) {
    Intent intent2;
    ...
    long updateFlagsForResolve =
        updateFlagsForResolve(
                ...
                i,
                z,
                (componentName == null && str2 == null) ? false : true,
                isImplicitImageCaptureIntentAndNotSetByDpc(intent2, i2, str, j))
            | 536870912;
    ...
    if (componentName2 != null) {
      ...
      if (activityInfo != null) {
        ...
        boolean z9 =
            !equals
                && (!(z3 || z6 || !z7)
                    || (z4 && z6 && (!z8 || (z5 && !(z8 && (i7 & 2097152) == 0)))));
        boolean z10 =
            (!z || (z && !activityInfo.exported && !isCallerSameApp(str2, i)))
                && !z7
                && !z6
                && shouldFilterApplication(
                    getPackageStateInternal(activityInfo.applicationInfo.packageName, 1000), i, i2);
        if (!z9 && !z10) {
          ResolveInfo resolveInfo = new ResolveInfo();
          resolveInfo.activityInfo = activityInfo;
          resolveInfo.userHandle = UserHandle.of(i2);
          if (SystemProperties.getBoolean("sys.knox.app_name_change", false)
              && (applicationPolicy = getApplicationPolicy()) != null
              && (applicationNameFromDb =
                      applicationPolicy.getApplicationNameFromDb(
                          resolveInfo.activityInfo.packageName, i2))
                  != null) {
          ...
          PackageManagerServiceUtils.applyEnforceIntentFilterMatching(
              this.mInjector.getCompatibility(),
              this.mComponentResolver,
              arrayList,
              false,
              intent2,
              str,
      ...
      boolean z11 =
          SemDualAppManager.isDualAppId(i2)
              && SemDualAppManager.isDualAppId(UserHandle.getUserId(i));
      String action2 = intent2.getAction();
      if (z11
          && !DualAppManagerService.isSelfContainedAction(i, action2)
          && DualAppManagerService.mayForwardIntent(intent2)) {
        if ("android.intent.action.SEND".equals(action2)
            || "android.intent.action.SEND_MULTIPLE".equals(action2)) {
          j3 = updateFlagsForResolve;
        } else {
          j3 = updateFlagsForResolve;
          List queryActivities =
              this.mComponentResolver.queryActivities(
                  this, intent2, str, updateFlagsForResolve, i2);
          if (queryActivities != null && queryActivities.size() == 1) {
            ...
            if (!str3.equals("com.android.settings")
                && !str3.equals("com.google.android.packageinstaller")
                && !str3.equals("com.google.android.permissioncontroller")
                && !str3.equals("com.samsung.android.permissioncontroller")) {
              List queryActivities2 =
                  this.mComponentResolver.queryActivities(this, intent2, str, j3, 0);
              if (!DualAppManagerService.shouldForwardToOwner(str3)
                  && queryActivities2 != null
                  && queryActivities2.size() == 1) {
                i3 = 0;
      ...
      QueryIntentActivitiesResult queryIntentActivitiesInternalBody =
          queryIntentActivitiesInternalBody(
              intent2, str, j3, i, i4, z, z2, str2, instantAppPackageName);
      ...
      if (list2 != null) {
        ...
        if (queryIntentActivitiesInternalBody.addInstant) {
          queryIntentActivitiesInternalBody.result =
              maybeAddInstantAppInstaller(
                  ...
                  i5,
                  z,
                  isInstantApp(getInstantAppPackageName(i), i5));
        }
    ...
    if (intent3 != null) {
      PackageManagerServiceUtils.applyEnforceIntentFilterMatching(
          this.mInjector.getCompatibility(), this.mComponentResolver, list, false, intent3, str, i);
    }
    return i6 != 0
        ? list
        : applyPostResolutionFilter(list, instantAppPackageName, z2, i, z, i5, intent2);
  }
    ...
    if (this.mApplicationPolicy == null) {
      this.mApplicationPolicy =
          (ApplicationPolicyInternal)
              this.mInjector.getLocalService(ApplicationPolicyInternal.class);
    }
  ...
  public final List queryIntentActivitiesInternal(Intent intent, String str, long j, int i) {
    return queryIntentActivitiesInternal(
        intent, str, j, 0L, Binder.getCallingUid(), i, false, true);
  }

  @Override // com.android.server.pm.Computer
  public final List queryIntentServicesInternal(
      Intent intent, String str, long j, int i, int i2, boolean z) {
    Intent intent2;
    Intent intent3;
    int i3 = i;
    ...
    if (component != null) {
      ...
      boolean z2 = false;
      if (i3 == UserHandle.getUserId(Binder.getCallingUid())
          && SemDualAppManager.isDualAppId(i)
          && component.getPackageName() != null
          && DualAppManagerService.shouldForwardToOwner(component.getPackageName())) {
        i3 = 0;
      }
      if (serviceInfo != null) {
        boolean z3 = (8388608 & updateFlagsForResolve) != 0;
        ...
        boolean z7 =
            !equals && (!(z3 || z5 || !z6) || (z4 && z5 && ((serviceInfo.flags & 1048576) == 0)));
        if (!z6
            && !z5
            && shouldFilterApplication(
                getPackageStateInternal(applicationInfo.packageName, 1000), i2, i3)) {
          z2 = true;
        }
        if (!z7 && !z2) {
          ResolveInfo resolveInfo = new ResolveInfo();
      ...
      emptyList =
          queryIntentServicesInternalBody(
              intent2, str, updateFlagsForResolve, i, i2, instantAppPackageName);
    }
    List list = emptyList;
    if (intent3 != null) {
      PackageManagerServiceUtils.applyEnforceIntentFilterMatching(
  ...
  public List queryIntentServicesInternalBody(
      Intent intent, String str, long j, int i, int i2, String str2) {
    ...
    int i3 =
        (i == UserHandle.getUserId(Binder.getCallingUid())
                && SemDualAppManager.isDualAppId(i)
                && DualAppManagerService.shouldForwardToOwner(str3))
            ? 0
            : i;
    if (androidPackage != null) {
      List queryServices2 =
          this.mComponentResolver.queryServices(
              this, intent, str, j, androidPackage.getServices(), i3);
  ...
  public QueryIntentActivitiesResult queryIntentActivitiesInternalBody(
      Intent intent,
      String str,
      long j,
      int i,
    ...
    if (str2 == null) {
      if (!this.mCrossProfileIntentResolverEngine.shouldSkipCurrentProfile(this, intent, str, i2)) {
        arrayList.addAll(
            filterIfNotSystemUser(
                this.mComponentResolver.queryActivities(this, intent, str, j, i2), i2));
      }
      boolean isInstantAppResolutionAllowed =
          isInstantAppResolutionAllowed(intent, arrayList, i2, false, j);
      ...
      resolveIntent =
          crossProfileIntentResolverEngine.resolveIntent(
              this,
              intent,
              str,
              i2,
              j,
              str2,
              hasNonNegativePriority,
              z,
              new Function() { // from class:
                // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda3
      ...
      if ("android.intent.action.MAIN".equals(intent.getAction())
          ...
          && DesktopModeUtils.filterHomeActivitiesByDesktopMode(
              DesktopModeUtils.isNewDexMode(this.mContext),
          ...
          arrayList.addAll(
              filterIfNotSystemUser(
                  this.mComponentResolver.queryActivities(
                      ...
                      str,
                      j,
                      packageStateInternal.getAndroidPackage().getActivities(),
                      i2),
                  i3));
        }
      }
      boolean isInstantAppResolutionAllowed2 =
          arrayList.size() == 0 ? isInstantAppResolutionAllowed(intent, null, i2, true, j) : false;
      CrossProfileIntentResolverEngine crossProfileIntentResolverEngine2 =
          this.mCrossProfileIntentResolverEngine;
      final Settings settings2 = this.mSettings;
      Objects.requireNonNull(settings2);
      i4 = i3;
      resolveIntent =
          crossProfileIntentResolverEngine2.resolveIntent(
              this,
              intent,
              str,
              i2,
    ...
    CrossProfileIntentResolverEngine crossProfileIntentResolverEngine3 =
        this.mCrossProfileIntentResolverEngine;
    ...
    return crossProfileIntentResolverEngine3.combineFilterAndCreateQueryActivitiesResponse(
        this,
        intent,
        str,
        str3,
  ...
  public final ComponentName findInstallFailureActivity(String str, int i, int i2) {
    ...
    List queryIntentActivitiesInternal =
        queryIntentActivitiesInternal(intent, null, 0L, 0L, i, i2, false, false);
  ...
  public final ActivityInfo getActivityInfoCrossProfile(
      ComponentName componentName, long j, int i) {
    if (this.mUserManager.exists(i)) {
      return getActivityInfoInternalBody(
          componentName, updateFlagsForComponent(j, i), Binder.getCallingUid(), i);
    }
    return null;
  }
  ...
  public final ActivityInfo getActivityInfoInternal(
      ComponentName componentName, long j, int i, int i2) {
    if (!this.mUserManager.exists(i2)) {
      return null;
    }
  ...
  public ActivityInfo getActivityInfoInternalBody(
      ComponentName componentName, long j, int i, int i2) {
    ParsedActivity activity = this.mComponentResolver.getActivity(componentName);
    AndroidPackage androidPackage =
        activity == null ? null : (AndroidPackage) this.mPackages.get(activity.getPackageName());
    if (androidPackage != null
        && this.mSettings.isEnabledAndMatch(androidPackage, activity, j, i2)) {
      PackageStateInternal packageStateInternal =
          this.mSettings.getPackage(componentName.getPackageName());
      if (packageStateInternal == null
          || shouldFilterApplication(packageStateInternal, i, componentName, 1, i2)) {
        return null;
      }
    ...
    if (resolveComponentName().equals(componentName)) {
      return PackageInfoUtils.generateDelegateActivityInfo(
          this.mResolveActivity, j, PackageUserStateInternal.DEFAULT, i2);
    }
    return null;
  }
  ...
  public final ApplicationInfo generateApplicationInfoFromSettings(
      String str, long j, int i, int i2) {
    PackageStateInternal packageStateInternal;
    if (!this.mUserManager.exists(i2)
        || (packageStateInternal = this.mSettings.getPackage(str)) == null
        || filterSharedLibPackage(packageStateInternal, i, i2, j)
        || shouldFilterApplication(packageStateInternal, i, i2)) {
      return null;
    }
    ...
    if (generateApplicationInfo != null) {
      generateApplicationInfo.packageName =
          resolveExternalPackageName(packageStateInternal.getPkg());
    }
  ...
  public ApplicationInfo getApplicationInfoInternalBody(String str, long j, int i, int i2) {
    ...
    if (androidPackage != null) {
      PackageStateInternal packageStateInternal =
          this.mSettings.getPackage(resolveInternalPackageName);
      if (packageStateInternal == null) {
        return null;
      }
      int i3 =
          (SemDualAppManager.isDualAppId(i2)
                  && SemDualAppManager.isDualAppId(UserHandle.getUserId(Binder.getCallingUid()))
                  && DualAppManagerService.shouldForwardToOwner(resolveInternalPackageName)
                  && !DualAppManagerService.isDefalutAppPackage(resolveInternalPackageName))
              ? 0
              : i2;
      if ((!z && androidPackage.isApex())
          || filterSharedLibPackage(packageStateInternal, i, i3, j)
          || shouldFilterApplication(packageStateInternal, i, i3)) {
        return null;
      }
      ApplicationInfo generateApplicationInfo =
          PackageInfoUtils.generateApplicationInfo(
    ...
    if ("android".equals(resolveInternalPackageName)
        || "system".equals(resolveInternalPackageName)) {
  ...
  @Override // com.android.server.pm.Computer
  public final CrossProfileDomainInfo getCrossProfileDomainPreferredLpr(
      Intent intent, String str, long j, int i, int i2) {
    List queryActivities;
    if (!this.mUserManager.hasUserRestriction("allow_parent_profile_app_linking", i)
        || (queryActivities = this.mComponentResolver.queryActivities(this, intent, str, j, i2))
            == null
        || queryActivities.isEmpty()) {
      return null;
    }
    ...
    for (int i3 = 0; i3 < size; i3++) {
      ...
      if (!resolveInfo.handleAllWebDataURI) {
        PackageStateInternal packageStateInternal =
            this.mSettings.getPackage(resolveInfo.activityInfo.packageName);
        if (packageStateInternal != null) {
          int approvalLevelForDomain =
              this.mDomainVerificationManager.approvalLevelForDomain(
                  packageStateInternal, intent, j, i2);
          if (crossProfileDomainInfo == null) {
            crossProfileDomainInfo =
                new CrossProfileDomainInfo(
                    createForwardingResolveInfoUnchecked(new WatchedIntentFilter(), i, i2),
                    approvalLevelForDomain,
                    i2);
          } else {
            crossProfileDomainInfo.mHighestApprovalLevel =
                Math.max(approvalLevelForDomain, crossProfileDomainInfo.mHighestApprovalLevel);
          }
        }
      }
    }
  ...
  public final List getMatchingCrossProfileIntentFilters(Intent intent, String str, int i) {
    CrossProfileIntentResolver crossProfileIntentResolver =
        this.mSettings.getCrossProfileIntentResolver(i);
    ...
    while (size >= 0) {
      ...
      if (resolveInfo.isInstantAppAvailable && z5) {
        list.remove(size);
          ...
          || (str2 = activityInfo.splitName) == null
          || ArrayUtils.contains(activityInfo.applicationInfo.splitNames, str2)) {
        z3 = z4;
        if (str == null) {
          SettingBase settingBase = this.mSettings.getSettingBase(UserHandle.getAppId(i));
          PackageStateInternal packageStateInternal =
              getPackageStateInternal(resolveInfo.activityInfo.packageName, 0);
          if (!z2) {
            if (!this.mAppsFilter.shouldFilterApplication(
                this, i, settingBase, packageStateInternal, i2)) {}
            list.remove(size);
          }
        } else if (!str.equals(resolveInfo.activityInfo.packageName)
            && (!z2
                || ((!intent.isWebIntent()
                        && (intent.getFlags() & IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES)
                            == 0)
                    || intent.getPackage() != null
                    || intent.getComponent() != null))) {
          ActivityInfo activityInfo2 = resolveInfo.activityInfo;
          if ((activityInfo2.flags & 1048576) != 0
              && !activityInfo2.applicationInfo.isInstantApp()) {}
          list.remove(size);
        }
        size--;
        z4 = z3;
        ...
        ComponentName findInstallFailureActivity =
            findInstallFailureActivity(resolveInfo.activityInfo.packageName, i, i2);
        ActivityInfo activityInfo3 = resolveInfo.activityInfo;
        resolveInfo2.auxiliaryInfo =
            new AuxiliaryResolveInfo(
                findInstallFailureActivity,
                activityInfo3.packageName,
                activityInfo3.applicationInfo.longVersionCode,
    ...
    for (int size = list.size() - 1; size >= 0; size--) {
      ...
      if (str == null) {
        if (!this.mAppsFilter.shouldFilterApplication(
            this,
            i2,
            this.mSettings.getSettingBase(UserHandle.getAppId(i2)),
            getPackageStateInternal(resolveInfo.serviceInfo.packageName, 0),
            i)) {}
      }
          ...
          if (instantAppInstallerActivity() == null) {
            ...
            resolveInfo2.auxiliaryInfo =
                new AuxiliaryResolveInfo(
                    ...
                    serviceInfo2.applicationInfo.longVersionCode,
                    serviceInfo2.splitName);
            resolveInfo2.filter = new IntentFilter();
            resolveInfo2.resolvePackageName = resolveInfo.getComponentInfo().packageName;
            list.set(size, resolveInfo2);
          }
  ...
  */
  public final List maybeAddInstantAppInstaller(
      List list, Intent intent, String str, long j, int i, boolean z, boolean z2) {
    boolean z3;
    ResolveInfo resolveInfo;
    String str2;
    int i2;
    ...
    if (!((j & 8388608) != 0)) {
      List queryActivities =
          this.mComponentResolver.queryActivities(
              this, intent, str, 8388608 | j | 64 | 16777216, i);
      for (int size = queryActivities.size() - 1; size >= 0; size--) {
        resolveInfo = (ResolveInfo) queryActivities.get(size);
        ...
        if (packageStateInternal2.getUserStateOrDefault(i).isInstantApp()) {
          if (PackageManagerServiceUtils.hasAnyDomainApproval(
              this.mDomainVerificationManager, packageStateInternal2, intent, j, i)) {
            if (PackageManagerService.DEBUG_INSTANT) {
              ...
              auxiliaryResolveInfo =
                  InstantAppResolver.doInstantAppResolutionPhaseOne(
                      ...
                      new InstantAppRequest(
                          ...
                          (Bundle) null,
                          z,
                          InstantAppResolver.parseDigest(intent).getDigestPrefixSecure(),
            ...
            if ((intent.isWebIntent() || auxiliaryResolveInfo != null)
                && (packageStateInternal =
                        this.mSettings.getPackage(instantAppInstallerActivity().packageName))
                    != null
              ...
              resolveInfo2.activityInfo =
                  PackageInfoUtils.generateDelegateActivityInfo(
                      instantAppInstallerActivity(),
                      0L,
                      packageStateInternal.getUserStateOrDefault(i3),
                      i3);
    ...
    resolveInfo2.activityInfo =
        PackageInfoUtils.generateDelegateActivityInfo(
            instantAppInstallerActivity(), 0L, packageStateInternal.getUserStateOrDefault(i3), i3);
    resolveInfo2.match = 5799936;
    resolveInfo2.filter = new IntentFilter();
    if (intent.getAction() != null) {}
    if (intent.getData() != null) {}
  ...
  public final PackageInfo generatePackageInfo(
      PackageStateInternal packageStateInternal, long j, int i) {
    int[] gidsForUid;
    Set emptySet;
    Set emptySet2;
    if (!this.mUserManager.exists(i)
        || packageStateInternal == null
        || shouldFilterApplication(packageStateInternal, Binder.getCallingUid(), i)) {
      return null;
    }
    ...
    if (pkg != null) {
      if ((256 & j2) == 0) {
        ...
        gidsForUid =
            this.mPermissionManager.getGidsForUid(
                UserHandle.getUid(i, packageStateInternal.getAppId()));
      }
      int[] iArr = gidsForUid;
      long j3 = 4096 & j2;
      if (j3 == 0 || ArrayUtils.isEmpty(pkg.getPermissions())) {
        ...
        emptySet =
            this.mPermissionManager.getInstalledPermissions(packageStateInternal.getPackageName());
      }
      Set set = emptySet;
      if (j3 == 0 || ArrayUtils.isEmpty(pkg.getRequestedPermissions())) {
        ...
        emptySet2 =
            this.mPermissionManager.getGrantedPermissions(packageStateInternal.getPackageName(), i);
      }
      PackageInfo generate =
          PackageInfoUtils.generate(
              pkg,
              iArr,
              j2,
              userStateOrDefault.getFirstInstallTimeMillis(),
    ...
    if (((8192 & j2) == 0 || !PackageUserStateUtils.isAvailable(userStateOrDefault, j2))
        && !PmServerUtils.installedOnSdcardAsUser(packageStateInternal, j2, i)) {
      return null;
    }
    ...
    SharedUserApi sharedUserFromPackageName =
        this.mSettings.getSharedUserFromPackageName(packageInfo.packageName);
    packageInfo.sharedUserId =
        sharedUserFromPackageName != null ? sharedUserFromPackageName.getName() : null;
    ...
    packageInfo.applicationInfo =
        PackageInfoUtils.generateDelegateApplicationInfo(
            applicationInfo2, j2, userStateOrDefault, i);
    return packageInfo;
  }
  ...
  public PackageInfo getPackageInfoInternalBody(String str, long j, long j2, int i, int i2) {
    ...
    if (z
        && (disabledSystemPkg = this.mSettings.getDisabledSystemPkg(resolveInternalPackageName))
            != null) {
      if ((!z2 && disabledSystemPkg.getPkg() != null && disabledSystemPkg.getPkg().isApex())
          || filterSharedLibPackage(disabledSystemPkg, i, i2, j2)
          || shouldFilterApplication(disabledSystemPkg, i, i2)) {
        return null;
      }
    ...
    if (androidPackage != null) {
      ...
      if ((!z2 && androidPackage.isApex())
          || filterSharedLibPackage(packageStateInternal3, i, i2, j2)) {
        return null;
      }
    ...
    if (z
        || (4202496 & j2) == 0
        || (packageStateInternal = this.mSettings.getPackage(resolveInternalPackageName)) == null
        || filterSharedLibPackage(packageStateInternal, i, i2, j2)
        || shouldFilterApplication(packageStateInternal, i, i2)) {
      return null;
    }
  ...
  public PackageStateInternal getPackageStateFiltered(String str, int i, int i2) {
    PackageStateInternal packageStateInternal =
        this.mSettings.getPackage(resolveInternalPackageNameInternalLocked(str, -1L, i));
  ...
  public final ParceledListSlice getInstalledPackages(long j, int i) {
    ...
    if (PMRune.PM_NAL_GET_APP_LIST) {
      if (this.mGetAppListHelper.checkCallingGetAppList(
          this.mContext,
          callingUid,
          this.mGetAppListHelper.isExemptedPackage(
              callingUid, this.mSettings.getSettingBase(UserHandle.getAppId(callingUid))),
          new Function() { // from class:
            // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda4
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
              String[] lambda$getInstalledPackages$1;
              lambda$getInstalledPackages$1 =
                  ComputerEngine.this.lambda$getInstalledPackages$1((Integer) obj);
        ...
        this.mInjector
            ...
            .post(
                new Runnable() { // from class:
                  // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda5
      ...
      while (it.hasNext()) {
        ...
        if (z3) {
          if (packageStateInternal3.isSystem()) {
            PackageStateInternal disabledSystemPkg =
                this.mSettings.getDisabledSystemPkg(packageStateInternal3.getPackageName());
            if (disabledSystemPkg != null) {
              packageStateInternal2 = disabledSystemPkg;
              if (!z2
                  || packageStateInternal2.getPkg() == null
                  || !packageStateInternal2.getPkg().isApex()) {
                Iterator it2 = it;
                PackageStateInternal packageStateInternal4 = packageStateInternal2;
                if (!filterSharedLibPackage(packageStateInternal2, i2, i, j)
                    && !shouldFilterApplication(packageStateInternal4, i2, i)
                    && (generatePackageInfo2 = generatePackageInfo(packageStateInternal4, j, i))
                        != null
                    && (!needToFilterSamsungThemePackages
                        || !filterSamsungThemePackage(
                            packageStateInternal4, generatePackageInfo2.applicationInfo, i))) {
        ...
        if (z3) {
          if (packageStateInternal5.isSystem()) {
            PackageStateInternal disabledSystemPkg2 =
                this.mSettings.getDisabledSystemPkg(packageStateInternal5.getPackageName());
            if (disabledSystemPkg2 != null) {
              ...
              if (!z2 || !androidPackage.isApex()) {
                ...
                if (!filterSharedLibPackage(packageStateInternal, i2, i, j)
                    && !shouldFilterApplication(packageStateInternal6, i2, i)
                    && (generatePackageInfo = generatePackageInfo(packageStateInternal6, j, i))
                        != null
                    && (!needToFilterSamsungThemePackages
                        || !filterSamsungThemePackage(
                            packageStateInternal6, generatePackageInfo.applicationInfo, i))) {
  ...
  public final boolean filterSamsungThemePackage(
      PackageStateInternal packageStateInternal, ApplicationInfo applicationInfo, int i) {
    List asList;
    ...
    if (packageStateInternal != null && packageStateInternal.getPkg() != null) {
      ...
      asList =
          (applicationInfo == null
                  || (packageInfo = getPackageInfo(applicationInfo.packageName, 4096L, i)) == null)
              ? null
  ...
  public ServiceInfo getServiceInfoBody(ComponentName componentName, long j, int i, int i2) {
    ...
    if (!this.mSettings.isEnabledAndMatch(androidPackage, service, j, i)
        || (packageStateInternal = this.mSettings.getPackage(componentName.getPackageName()))
            == null
        || shouldFilterApplication(packageStateInternal, i2, componentName, 3, i)) {
      return null;
    }
    return PackageInfoUtils.generateServiceInfo(
        androidPackage,
        service,
        j,
        packageStateInternal.getUserStateOrDefault(i),
    ...
    if (staticLibraryInfos != null && staticLibraryInfos.size() > 0) {
      ...
      for (int i2 = 0; i2 < size; i2++) {
        ...
        if (longSparseLongArray == null
            || longSparseLongArray.indexOfKey(sharedLibraryInfo2.getLongVersion()) >= 0) {
  ...
  public String[] getPackagesForUidInternalBody(int i, int i2, int i3, boolean z) {
    ...
    for (int i5 = 0; i5 < size; i5++) {
      ...
      if (packageStateInternal2.getUserStateOrDefault(i2).isInstalled()
          && !shouldFilterApplication(packageStateInternal2, i, i2)) {
  ...
  public final boolean canViewInstantApps(int i, int i2) {
    if (i < 10000
        || this.mContext.checkCallingOrSelfPermission("android.permission.ACCESS_INSTANT_APPS")
            == 0) {
      return true;
    }
  ...
  public final boolean filterStaticSharedLibPackage(
      PackageStateInternal packageStateInternal, int i, int i2, long j) {
    SharedLibraryInfo sharedLibraryInfo;
    int indexOf;
    if (((j & 67108864) != 0
            && (PackageManagerServiceUtils.isSystemOrRootOrShell(UserHandle.getAppId(i))
                || checkUidPermission("android.permission.INSTALL_PACKAGES", i) == 0))
        || packageStateInternal == null
        || packageStateInternal.getPkg() == null
        || !packageStateInternal.getPkg().isStaticSharedLibrary()
        || (sharedLibraryInfo =
                getSharedLibraryInfo(
                    packageStateInternal.getPkg().getStaticSharedLibraryName(),
                    packageStateInternal.getPkg().getStaticSharedLibraryVersion()))
            == null) {
      return false;
    }
    ...
    for (String str : packagesForUid) {
      ...
      if (packageStateInternal2 != null
          && (indexOf =
                  ArrayUtils.indexOf(
                      packageStateInternal2.getUsesStaticLibraries(), sharedLibraryInfo.getName()))
              >= 0
          && packageStateInternal2.getPkg().getUsesStaticLibrariesVersions()[indexOf]
  ...
  public final boolean filterSdkLibPackage(
      PackageStateInternal packageStateInternal, int i, int i2, long j) {
    SharedLibraryInfo sharedLibraryInfo;
    int indexOf;
    if (((j & 67108864) != 0
        ...
        || packageStateInternal == null
        || packageStateInternal.getPkg() == null
        || !packageStateInternal.getPkg().isSdkLibrary()
        || (sharedLibraryInfo =
                getSharedLibraryInfo(
                    packageStateInternal.getPkg().getSdkLibraryName(),
                    packageStateInternal.getPkg().getSdkLibVersionMajor()))
            == null) {
      return false;
    }
    String[] packagesForUid = getPackagesForUid(UserHandle.getUid(i2, UserHandle.getAppId(i)));
    ...
    for (String str : packagesForUid) {
      ...
      if (packageStateInternal2 != null
          && (indexOf =
                  ArrayUtils.indexOf(
                      packageStateInternal2.getUsesSdkLibraries(), sharedLibraryInfo.getName()))
              >= 0
          && packageStateInternal2.getPkg().getUsesSdkLibrariesVersionsMajor()[indexOf]
              == sharedLibraryInfo.getLongVersion()) {
        return false;
      }
    }
  ...
  public final boolean filterSharedLibPackage(
      PackageStateInternal packageStateInternal, int i, int i2, long j) {
    return filterStaticSharedLibPackage(packageStateInternal, i, i2, j)
        || filterSdkLibPackage(packageStateInternal, i, i2, j);
  }

  public final boolean hasCrossUserPermission(int i, int i2, int i3, boolean z, boolean z2) {
    if ((!z2 && i3 == i2)
        || PackageManagerServiceUtils.isSystemOrRoot(i)
        || DualAppManagerService.isCrossAccessAllowed(i2, i3)) {
      return true;
    }
    if (z) {
    ...
    return hasPermission("android.permission.INTERACT_ACROSS_USERS_FULL")
        || hasPermission("android.permission.INTERACT_ACROSS_USERS");
  }
  ...
  public final boolean isCallerFromManagedUserOrProfile(int i) {
    ...
    return devicePolicyManagerInternal != null
        && devicePolicyManagerInternal.isUserOrganizationManaged(i);
  }

  public final boolean isComponentVisibleToInstantApp(ComponentName componentName) {
    if (isComponentVisibleToInstantApp(componentName, 1)
        || isComponentVisibleToInstantApp(componentName, 3)) {
      return true;
    }
  ...
  @Override // com.android.server.pm.Computer
  public final boolean isImplicitImageCaptureIntentAndNotSetByDpc(
      Intent intent, int i, String str, long j) {
    return intent.isImplicitImageCaptureIntent()
        && !isPersistentPreferredActivitySetByDpm(intent, i, str, j);
  }
  ...
  public boolean isInstantAppInternalBody(String str, int i, int i2) {
    ...
    if (packageStateInternal != null
        && (isCallerSameApp(str, i2)
            || canViewInstantApps(i2, i)
            || this.mInstantAppRegistry.isInstantAccessGranted(
                i, UserHandle.getAppId(i2), packageStateInternal.getAppId()))) {
      return packageStateInternal.getUserStateOrDefault(i).isInstantApp();
    }
    return false;
  }

  public final boolean isInstantAppResolutionAllowed(
      Intent intent, List list, int i, boolean z, long j) {
    if (this.mInstantAppResolverConnection == null
        || instantAppInstallerActivity() == null
        || intent.getComponent() != null
        || (intent.getFlags() & Integer.MIN_VALUE) != 0
        || (intent.getFlags() & 1024) != 0) {
      return false;
    }
    ...
    if (!intent.isWebIntent()) {
      if ((list != null && list.size() != 0)
          || (intent.getFlags() & IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES) == 0) {
        return false;
      }
    } else if (intent.getData() == null
        || TextUtils.isEmpty(intent.getData().getHost())
        || areWebInstantAppsDisabled(i)) {
      return false;
    }
  ...
  public boolean isInstantAppResolutionAllowedBody(
    ...
    if (z2) {
      Slog.d(
          "PackageManager",
          "Checking if instant app resolution allowed, resolvedActivities = " + list);
    }
    for (int i2 = 0; i2 < size; i2++) {
  ...
  public final boolean isPersistentPreferredActivitySetByDpm(
      Intent intent, int i, String str, long j) {
    List arrayList;
    PersistentPreferredIntentResolver persistentPreferredActivities =
        this.mSettings.getPersistentPreferredActivities(i);
  ...
  public final boolean isRecentsAccessingChildProfiles(int i, int i2) {
    if (!((ActivityTaskManagerInternal)
            this.mInjector.getLocalService(ActivityTaskManagerInternal.class))
        .isCallerRecents(i)) {
      return false;
    }
    long clearCallingIdentity = Binder.clearCallingIdentity();
  ...
  public final boolean shouldFilterApplication(
    ...
    if (Process.isSdkSandboxUid(i)) {
      ...
      if (packageStateInternal != null
          && appUidForSdkSandboxUid == UserHandle.getUid(i3, packageStateInternal.getAppId())) {
        return false;
      }
    }
    if (Process.isIsolated(i)) {
    ...
    if (packageStateInternal == null
        || !(!z
            || PackageManagerServiceUtils.isSystemOrRootOrShell(i4)
            || packageStateInternal.isHiddenUntilInstalled()
            || packageStateInternal.getUserStateOrDefault(i3).isInstalled())) {
    ...
    if (z2) {
      ...
      if (componentName != null) {
        ParsedInstrumentation parsedInstrumentation =
            (ParsedInstrumentation) this.mInstrumentation.get(componentName);
        if (parsedInstrumentation == null
            || !isCallerSameApp(parsedInstrumentation.getTargetPackage(), i4)) {
    ...
    if (packageStateInternal.getUserStateOrDefault(i3).isInstantApp()) {
      ...
      return !this.mInstantAppRegistry.isInstantAccessGranted(
          i3, UserHandle.getAppId(i4), packageStateInternal.getAppId());
    }
    return this.mAppsFilter.shouldFilterApplication(
        this, i4, this.mSettings.getSettingBase(UserHandle.getAppId(i4)), packageStateInternal, i3);
  }
  ...
  public final boolean shouldFilterApplication(SharedUserSetting sharedUserSetting, int i, int i2) {
    ...
    for (int size = packageStates.size() - 1; size >= 0 && z; size--) {
      z &=
          shouldFilterApplication(
              (PackageStateInternal) packageStates.valueAt(size), i, null, 0, i2, false);
    }
    return z;
  }
  ...
  public final boolean shouldFilterApplicationIncludingUninstalled(
      SharedUserSetting sharedUserSetting, int i, int i2) {
  ...
  public int getPackageUidInternal(String str, long j, int i, int i2) {
    ...
    AndroidPackage androidPackage = (AndroidPackage) this.mPackages.get(str);
    if (androidPackage != null
        && AndroidPackageUtils.isMatchForSystemOnly(packageStateInternal3, j)
        && (packageStateInternal2 = getPackageStateInternal(androidPackage.getPackageName(), i2))
            != null
        && packageStateInternal2.getUserStateOrDefault(i).isInstalled()
        && !shouldFilterApplication(packageStateInternal2, i2, i)) {
      return UserHandle.getUid(i, androidPackage.getUid());
    }
    if ((4202496 & j) == 0
        || (packageStateInternal = this.mSettings.getPackage(str)) == null
        || !PackageStateUtils.isMatch(packageStateInternal, j)
        || shouldFilterApplication(packageStateInternal, i2, i)) {
      return -1;
    }
  ...
  public final long updateFlags(long j, int i) {
    ...
    return j
        | (this.mInjector.getUserManagerInternal().isUserUnlockingOrUnlocked(i)
            ? 786432L
            : 524288L);
  }
  ...
  public final long updateFlagsForPackage(long j, int i) {
    ...
    if ((j & 4194304) != 0) {
      enforceCrossUserPermission(
          ...
          false,
          false,
          !isRecentsAccessingChildProfiles(Binder.getCallingUid(), i),
  ...
  public final long updateFlagsForResolve(
      long j, int i, int i2, boolean z, boolean z2, boolean z3) {
    long j2;
    if (safeMode() || z3) {
      j |= 1048576;
    }
  ...
  @Override // com.android.server.pm.Computer
  public final void enforceCrossUserOrProfilePermission(
      int i, int i2, boolean z, boolean z2, String str) {
    if (i2 < 0) {
      throw new IllegalArgumentException("Invalid userId " + i2);
    }
    if (z2) {
      PackageManagerServiceUtils.enforceShellRestriction(
          this.mInjector.getUserManagerInternal(), "no_debugging_features", i, i2);
    }
    int userId = UserHandle.getUserId(i);
    ...
    if (isSameProfileGroup
        && PermissionChecker.checkPermissionForPreflight(
                ...
                -1,
                i,
                getPackage(i).getPackageName())
            == 0) {
      return;
    }
    String buildInvalidCrossUserOrProfilePermissionMessage =
        buildInvalidCrossUserOrProfilePermissionMessage(i, i2, str, z, isSameProfileGroup);
  ...
  public static String buildInvalidCrossUserOrProfilePermissionMessage(
      int i, int i2, String str, boolean z, boolean z2) {
  ...
  public final void enforceCrossUserPermission(
      int i, int i2, boolean z, boolean z2, boolean z3, String str) {
    if (i2 < 0) {
      throw new IllegalArgumentException("Invalid userId " + i2);
    }
    if (z2) {
    ...
    String buildInvalidCrossUserPermissionMessage =
        buildInvalidCrossUserPermissionMessage(i, i2, str, z);
  ...
  public static String buildInvalidCrossUserPermissionMessage(
  ...
  public boolean filterAppAccess(AndroidPackage androidPackage, int i, int i2) {
    return shouldFilterApplicationIncludingUninstalled(
        getPackageStateInternal(androidPackage.getPackageName()), i, i2);
  }
  ...
  public boolean filterAppAccess(int i, int i2) {
    ...
    if (settingBase instanceof SharedUserSetting) {
      return shouldFilterApplicationIncludingUninstalled(
          (SharedUserSetting) settingBase, i2, userId);
    }
    if (settingBase instanceof PackageStateInternal) {
      return shouldFilterApplicationIncludingUninstalled(
          (PackageStateInternal) settingBase, i2, userId);
    }
    return true;
  }
  ...
  @Override // com.android.server.pm.Computer
  public void dump(
      int i, FileDescriptor fileDescriptor, PrintWriter printWriter, DumpState dumpState) {
      ...
      switch (i) {
        ...
        case IInstalld.FLAG_FORCE /* 8192 */:
          ...
          BufferedOutputStream bufferedOutputStream =
              new BufferedOutputStream(new FileOutputStream(fileDescriptor));
          ...
          try {
            ...
            newFastSerializer.setFeature(
                "http://xmlpull.org/v1/doc/features.html#indent-output", true);
            this.mSettings.writePreferredActivitiesLPr(
                newFastSerializer, 0, dumpState.isFullPreferred());
        ...
        case 262144:
          ...
          try {
            this.mDomainVerificationManager.printState(
                this, indentingPrintWriter, targetPackageName, -1);
          } catch (Exception e4) {
        ...
        case 524288:
          ...
          IndentingPrintWriter indentingPrintWriter2 =
              new IndentingPrintWriter(printWriter, "  ", 120);
          ...
          if (DexOptHelper.useArtService()) {
            ...
            for (PackageStateInternal packageStateInternal2 : values) {
              ...
              if (pkg != null && !pkg.isApex()) {
                ...
                indentingPrintWriter3.increaseIndent();
                try {
                  this.mPackageDexOptimizer.dumpDexoptState(
                      indentingPrintWriter3,
                      pkg,
                      packageStateInternal2,
                      this.mDexManager.getPackageUseInfoOrDefault(packageName));
          ...
          while (it.hasNext()) {
            ...
            if (pkg2 != null) {
              ...
              CompilerStats.PackageStats packageStats =
                  this.mCompilerStats.getPackageStats(packageName2);
        ...
        case 33554432:
          ...
          return;
        case 67108864:
          this.mAppsFilter.dumpQueries(
              printWriter,
              packageStateInternal != null
                  ? Integer.valueOf(packageStateInternal.getAppId())
                  : null,
              dumpState,
              this.mUserManager.getUserIds(),
              new QuadFunction() { // from class:
                // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda6
                public final Object apply(Object obj, Object obj2, Object obj3, Object obj4) {
                  return ComputerEngine.this.getPackagesForUidInternalBody(
  ...
  public static void dumpApexPackageStates(
      List list, boolean z, String str, IndentingPrintWriter indentingPrintWriter) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (str == null || str.equals(pkg.getPackageName())) {
        ...
        indentingPrintWriter.println(
            "IsFactory: " + (packageStateInternal.isUpdatedSystemApp() ^ true));
        indentingPrintWriter.println("ApplicationInfo: ");
        indentingPrintWriter.increaseIndent();
        AndroidPackageUtils.generateAppInfoWithoutState(pkg)
            .dump(new PrintWriterPrinter(indentingPrintWriter), "");
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.decreaseIndent();
      }
    }
  ...
  */
  public PackageManagerService.FindPreferredActivityBodyResult findPreferredActivityBody(
    ...
    String homeActivity;
    String str3;
    PackageManagerService.FindPreferredActivityBodyResult findPreferredActivityBodyResult =
        new PackageManagerService.FindPreferredActivityBodyResult();
    long updateFlagsForResolve =
        updateFlagsForResolve(
            j, i, i2, false, isImplicitImageCaptureIntentAndNotSetByDpc(intent, i, str, j));
    ...
    if (proKioskManager != null
        ...
        && updateIntentForResolve.hasCategory("android.intent.category.HOME")
        && updateIntentForResolve.getComponent() == null
        && (homeActivity = proKioskManager.getHomeActivity()) != null) {
      int indexOf = homeActivity.indexOf(47);
      if (indexOf != -1) {
        String substring = homeActivity.substring(indexOf + 1);
        homeActivity = homeActivity.substring(0, indexOf);
        Intent intent2 = new Intent();
        intent2.setClassName(homeActivity, substring);
        if (!queryIntentActivitiesInternal(intent2, null, 131072L, i).isEmpty()) {
          str3 = substring;
          Intent intent3 = new Intent("android.intent.action.MAIN", (Uri) null);
          intent3.addCategory("android.intent.category.LAUNCHER");
          String str4 = str3;
          for (ResolveInfo resolveInfo : queryIntentActivitiesInternal(intent3, null, 1024L, i)) {
            if (resolveInfo.activityInfo.packageName.equalsIgnoreCase(homeActivity)) {
              if (str4 != null) {
                resolveInfo.activityInfo.name = str4;
              }
      ...
      str3 = null;
      Intent intent32 = new Intent("android.intent.action.MAIN", (Uri) null);
      intent32.addCategory("android.intent.category.LAUNCHER");
      String str42 = str3;
      while (r1.hasNext()) {}
    }
    if (updateIntentForResolve.hasCategory("android.intent.category.HOME")) {
      try {
        IKioskMode asInterface =
            IKioskMode.Stub.asInterface(ServiceManager.getService("kioskmode"));
        if (asInterface != null
            && (kioskHomePackageAsUser = asInterface.getKioskHomePackageAsUser(i)) != null) {
          int size = list.size();
          for (int i7 = 0; i7 < size; i7++) {
            ResolveInfo resolveInfo2 = (ResolveInfo) list.get(i7);
            if (resolveInfo2.activityInfo.packageName.equals(kioskHomePackageAsUser)) {
        ...
        Log.e("PackageManager", "Failed talking with kiosk mode service", e);
      }
    }
    IApplicationPolicy asInterface2 =
    ...
    if (asInterface2 != null) {
      ...
      try {
        ComponentName defaultApplicationInternal =
            asInterface2.getDefaultApplicationInternal(updateIntentForResolve, i);
        if (defaultApplicationInternal != null) {
          int size2 = list.size();
          int i8 = 0;
          while (i8 < size2) {
            ResolveInfo resolveInfo3 = (ResolveInfo) list.get(i8);
            int i9 = size2;
            if (resolveInfo3.activityInfo.packageName.equals(
                    defaultApplicationInternal.getPackageName())
                && resolveInfo3.activityInfo.name.equals(
                    defaultApplicationInternal.getClassName())) {
              findPreferredActivityBodyResult.mPreferredResolveInfo = resolveInfo3;
              Binder.restoreCallingIdentity(clearCallingIdentity);
              return findPreferredActivityBodyResult;
            }
            i8++;
    ...
    String str6 = "android.intent.category.HOME";
    ResolveInfo findPersistentPreferredActivity =
        findPersistentPreferredActivity(
            updateIntentForResolve, str, updateFlagsForResolve, list, z3, i);
    ...
    if (z3) {
      Slog.v(str5, "Looking for preferred activities...");
    }
    if (preferredActivities != null) {
      list2 =
          preferredActivities.queryIntent(
              this, updateIntentForResolve, str, (65536 & updateFlagsForResolve) != 0, i);
    } else {
      list2 = null;
    }
    if (list2 != null && list2.size() > 0) {
      if (z3) {
        Slog.v(str5, "Figuring out best match...");
      }
      int size3 = list.size();
      int i10 = 0;
      int i11 = 0;
      while (i11 < size3) {
        String str7 = str5;
        ResolveInfo resolveInfo4 = (ResolveInfo) list.get(i11);
        if (z3) {
          Slog.v(
              str7,
              "Match for "
                  + resolveInfo4.activityInfo
                  + ": 0x"
                  + Integer.toHexString(resolveInfo4.match));
        }
        int i12 = resolveInfo4.match;
        if (i12 > i10) {
          i10 = i12;
        }
        i11++;
      ...
      String str8 = str5;
      if (z3) {
        Slog.v(str8, "Best match: 0x" + Integer.toHexString(i10));
      }
      int i13 = i10 & 268369920;
      int size4 = list2.size();
      int i14 = 0;
      while (i14 < size4) {
        PreferredActivity preferredActivity = (PreferredActivity) list2.get(i14);
        List list3 = list2;
        if (z3) {
          StringBuilder sb = new StringBuilder();
          i3 = size4;
          ...
          sb.append(
              preferredActivity.countDataSchemes() > 0
                  ? preferredActivity.getDataScheme(0)
                  : "<none>");
          sb.append("\n  component=");
          sb.append(preferredActivity.mPref.mComponent);
          Slog.v(str8, sb.toString());
          i4 = i14;
          preferredActivity.dump(new LogPrinter(2, str8, 3), "  ");
        } else {
          i3 = size4;
          i4 = i14;
        }
        PreferredComponent preferredComponent = preferredActivity.mPref;
        if (preferredComponent.mMatch != i13) {
          if (z3) {
            Slog.v(
                str8, "Skipping bad match " + Integer.toHexString(preferredActivity.mPref.mMatch));
          }
        } else if (!z || preferredComponent.mAlways) {
          ActivityInfo activityInfo =
              getActivityInfo(
                  preferredComponent.mComponent, 512 | updateFlagsForResolve | 524288 | 262144, i);
          if (z3) {
            Slog.v(str8, "Found preferred activity:");
            if (activityInfo != null) {
              i5 = i13;
              activityInfo.dump(new LogPrinter(2, str8, 3), "  ");
            } else {
              i5 = i13;
              Slog.v(str8, "  null");
            }
          ...
          if (activityInfo != null) {
            int i15 = 0;
            while (i15 < size3) {
              ResolveInfo resolveInfo5 = (ResolveInfo) list.get(i15);
              i6 = size3;
              j2 = updateFlagsForResolve;
              if (!resolveInfo5.activityInfo.applicationInfo.packageName.equals(
                      activityInfo.applicationInfo.packageName)
                  || !resolveInfo5.activityInfo.name.equals(activityInfo.name)) {
                i15++;
                size3 = i6;
                ...
                if (z && !preferredActivity.mPref.sameSet(list, z6, i)) {
                  if (updateIntentForResolve.hasCategory(str6)) {
                    try {
                      IKioskMode asInterface3 =
                          IKioskMode.Stub.asInterface(ServiceManager.getService("kioskmode"));
                      if (asInterface3 != null && asInterface3.isKioskModeEnabledAsUser(i)) {
                        findPreferredActivityBodyResult.mPreferredResolveInfo = resolveInfo5;
                        return findPreferredActivityBodyResult;
                      }
                    } catch (RemoteException e2) {
                      Log.e(str8, "Failed talking to Kiosk mode service", e2);
                    }
                  }
                    ...
                    if (z7) {
                      Slog.i(
                          ...
                          "Result set changed, dropping preferred activity for "
                              + updateIntentForResolve
                              + " type "
                              + str);
                      StringBuilder sb2 = new StringBuilder();
                      sb2.append("Result set changed, ");
                      sb2.append(updateIntentForResolve);
                      PreferredActivityLog.logDroppingPreferredActivity(
                          preferredActivity, list, sb2.toString());
                      preferredActivities.removeFilter((WatchedIntentFilter) preferredActivity);
                      PreferredComponent preferredComponent2 = preferredActivity.mPref;
                      preferredActivities.addFilter(
                          (PackageDataSnapshot) this,
                          (WatchedIntentFilter)
                              new PreferredActivity(
                                  (WatchedIntentFilter) preferredActivity,
                                  preferredComponent2.mMatch,
                                  (ComponentName[]) null,
                                  preferredComponent2.mComponent,
                                  false));
                      findPreferredActivityBodyResult.mChanged = true;
                    }
                  ...
                  if (z7) {
                    PreferredActivityLog.logDroppingPreferredActivity(
                        preferredActivity,
                        list,
                        "Result set changed, but still valid, " + updateIntentForResolve);
                    PreferredComponent preferredComponent3 = preferredActivity.mPref;
                    int i16 = preferredComponent3.mMatch;
                    ComponentName[] discardObsoleteComponents =
                        preferredComponent3.discardObsoleteComponents(list);
                    PreferredComponent preferredComponent4 = preferredActivity.mPref;
                    PreferredActivity preferredActivity2 =
                        new PreferredActivity(
                            preferredActivity,
                            i16,
                            discardObsoleteComponents,
                            preferredComponent4.mComponent,
                            preferredComponent4.mAlways);
                    preferredActivities.removeFilter((WatchedIntentFilter) preferredActivity);
                    preferredActivities.addFilter(
                        (PackageDataSnapshot) this, (WatchedIntentFilter) preferredActivity2);
                    findPreferredActivityBodyResult.mChanged = true;
                  }
                }
                if (z3) {
                  Slog.v(
                      str8,
                      "Returning preferred activity: "
                          + resolveInfo5.activityInfo.packageName
                          + "/"
                          + resolveInfo5.activityInfo.name);
                }
                findPreferredActivityBodyResult.mPreferredResolveInfo = resolveInfo5;
                return findPreferredActivityBodyResult;
              }
            ...
            Slog.w(
                str8,
                "Removing dangling preferred activity: " + preferredActivity.mPref.mComponent);
            preferredActivities.removeFilter((WatchedIntentFilter) preferredActivity);
            findPreferredActivityBodyResult.mChanged = true;
            i6 = size3;
            j2 = updateFlagsForResolve;
          ...
          Slog.v(str8, "Skipping mAlways=false entry");
        }
        i6 = size3;
        i5 = i13;
        j2 = updateFlagsForResolve;
  ...
  @Override // com.android.server.pm.Computer
  public final PackageManagerService.FindPreferredActivityBodyResult findPreferredActivityInternal2(
      Intent intent,
      String str,
      long j,
      List list,
    ...
    return findPreferredActivityBody(
        intent, str, j, list, z, z2, z3, i, z4, Binder.getCallingUid(), z5);
  }
  ...
  public final PackageManagerService.FindPreferredActivityBodyResult findPreferredActivityInternal(
    ...
    return findPreferredActivityBody(
        ...
        z4,
        Binder.getCallingUid(),
        Settings.Global.getInt(this.mContext.getContentResolver(), "device_provisioned", 0) == 1);
  }

  @Override // com.android.server.pm.Computer
  public final ResolveInfo findPersistentPreferredActivity(
    ...
    if (list2 != null && list2.size() > 0) {
      ...
      for (int i2 = 0; i2 < size2; i2++) {
        PersistentPreferredActivity persistentPreferredActivity =
            (PersistentPreferredActivity) list2.get(i2);
        if (z) {
          StringBuilder sb = new StringBuilder();
          sb.append("Checking PersistentPreferredActivity ds=");
          sb.append(
              persistentPreferredActivity.countDataSchemes() > 0
                  ? persistentPreferredActivity.getDataScheme(0)
                  : "<none>");
          sb.append("\n  component=");
        ...
        ActivityInfo activityInfo =
            getActivityInfo(persistentPreferredActivity.mComponent, j | 512, i);
        if (z) {
        ...
        if (activityInfo != null) {
          for (int i3 = 0; i3 < size; i3++) {
            ...
            if (resolveInfo.activityInfo.applicationInfo.packageName.equals(
                    activityInfo.applicationInfo.packageName)
                && resolveInfo.activityInfo.name.equals(activityInfo.name)) {
              if (z) {
                Slog.v(
                    "PackageManager",
                    "Returning persistent preferred activity: "
  ...
  public int getPackageStartability(boolean z, String str, int i, int i2) {
    ...
    if (packageStateInternal == null
        || shouldFilterApplication(packageStateInternal, i, i2)
        || !packageStateInternal.getUserStateOrDefault(i2).isInstalled()) {
      return 1;
    }
    ...
    if (!isUserKeyUnlocked
        && !AndroidPackageUtils.isEncryptionAware(packageStateInternal.getPkg())) {
      return 4;
    }
  ...
  public boolean isPackageAvailable(String str, int i) {
    ...
    if (packageStateInternal == null
        || packageStateInternal.getPkg() == null
        || shouldFilterApplication(packageStateInternal, callingUid, i)
        || (userStateOrDefault = packageStateInternal.getUserStateOrDefault(i)) == null) {
      return false;
    }
  ...
  public String[] currentToCanonicalPackageNames(String[] strArr) {
    ...
    for (int length = strArr.length - 1; length >= 0; length--) {
      ...
      boolean z = false;
      if (packageStateInternal != null
          && packageStateInternal.getRealName() != null
          && (!packageStateInternal.getUserStateOrDefault(userId).isInstantApp()
              || canViewInstantApps
              || this.mInstantAppRegistry.isInstantAccessGranted(
                  userId, UserHandle.getAppId(callingUid), packageStateInternal.getAppId()))) {
        z = true;
      }
  ...
  public int[] getPackageGids(String str, long j, int i) {
    ...
    if (packageStateInternal.getPkg() != null
        && AndroidPackageUtils.isMatchForSystemOnly(packageStateInternal, updateFlagsForPackage)
        && packageStateInternal.getUserStateOrDefault(i).isInstalled()
        && !shouldFilterApplication(packageStateInternal, callingUid, i)) {
      return this.mPermissionManager.getGidsForUid(
          UserHandle.getUid(i, packageStateInternal.getAppId()));
    }
    if ((4202496 & updateFlagsForPackage) == 0
        || !PackageStateUtils.isMatch(packageStateInternal, updateFlagsForPackage)
        || shouldFilterApplication(packageStateInternal, callingUid, i)) {
      return null;
    }
    return this.mPermissionManager.getGidsForUid(
  ...
  public int getTargetSdkVersion(String str) {
    ...
    if (packageStateInternal == null
        ...
        || shouldFilterApplicationIncludingUninstalled(
            packageStateInternal, Binder.getCallingUid(), UserHandle.getCallingUserId())) {
      return -1;
    }
  ...
  public boolean activitySupportsIntentAsUser(
      ComponentName componentName, ComponentName componentName2, Intent intent, String str, int i) {
    PackageStateInternal packageStateInternal;
    int callingUid = Binder.getCallingUid();
    ...
    if (activity == null
        || (packageStateInternal = getPackageStateInternal(componentName2.getPackageName())) == null
        || shouldFilterApplication(packageStateInternal, callingUid, componentName2, 1, i, true)) {
      return false;
    }
    for (int i2 = 0; i2 < activity.getIntents().size(); i2++) {
      if (((ParsedIntentInfo) activity.getIntents().get(i2))
              .getIntentFilter()
              .match(
                  intent.getAction(),
                  str,
  ...
  public ActivityInfo getReceiverInfo(ComponentName componentName, long j, int i) {
    ...
    ParsedActivity receiver = this.mComponentResolver.getReceiver(componentName);
    if (receiver == null
        || (packageStateInternal = getPackageStateInternal(receiver.getPackageName())) == null
        || packageStateInternal.getPkg() == null
        || !PackageStateUtils.isEnabledAndMatches(
            packageStateInternal, receiver, updateFlagsForComponent, i)
        || shouldFilterApplication(packageStateInternal, callingUid, componentName, 2, i)) {
      return null;
    }
    return PackageInfoUtils.generateActivityInfo(
        packageStateInternal.getPkg(),
  ...
  public ParceledListSlice getSharedLibraries(String str, long j, int i) {
    ...
    long updateFlagsForPackage = updateFlagsForPackage(j, i);
    boolean z =
        this.mContext.checkCallingOrSelfPermission("android.permission.INSTALL_PACKAGES") == 0
            || this.mContext.checkCallingOrSelfPermission("android.permission.DELETE_PACKAGES") == 0
            || canRequestPackageInstalls(str, callingUid, i, false)
    ...
    while (i4 < size) {
      WatchedLongSparseArray watchedLongSparseArray =
          (WatchedLongSparseArray) sharedLibraries.valueAt(i4);
      if (watchedLongSparseArray == null) {
        ...
        while (i5 < size2) {
          SharedLibraryInfo sharedLibraryInfo =
              (SharedLibraryInfo) watchedLongSparseArray.valueAt(i5);
              ...
              SharedLibraryInfo sharedLibraryInfo2 =
                  new SharedLibraryInfo(
                      ...
                      getPackagesUsingSharedLibrary(
                          sharedLibraryInfo, updateFlagsForPackage, callingUid, i),
                      sharedLibraryInfo.getDependencies() == null
                          ? null
                          : new ArrayList(sharedLibraryInfo.getDependencies()),
                      sharedLibraryInfo.isNative());
  ...
  public boolean canRequestPackageInstalls(String str, int i, int i2, boolean z) {
    AndroidPackage androidPackage;
    if (i != getPackageUidInternal(str, 0L, i2, i)
        && !PackageManagerServiceUtils.isSystemOrRoot(i)) {
      throw new SecurityException("Caller uid " + i + " does not own package " + str);
    }
    if (isInstantAppInternal(str, i2, 1000)
        || (androidPackage = (AndroidPackage) this.mPackages.get(str)) == null
        || androidPackage.getTargetSdkVersion() < 26) {
      return false;
    }
    if (androidPackage
  ...
  public final boolean isInstallDisabledForPackage(String str, int i, int i2) {
    if (this.mUserManager.hasUserRestriction("no_install_unknown_sources", i2)
        || this.mUserManager.hasUserRestriction("no_install_unknown_sources_globally", i2)) {
      return true;
    }
    PackageManagerInternal.ExternalSourcesPolicy externalSourcesPolicy =
        this.mExternalSourcesPolicy;
    return (externalSourcesPolicy == null
            || externalSourcesPolicy.getPackageTrustedToInstallApps(str, i) == 0)
        ? false
        : true;
  }

  @Override // com.android.server.pm.Computer
  public List getPackagesUsingSharedLibrary(
      SharedLibraryInfo sharedLibraryInfo, long j, int i, int i2) {
    ...
    for (int i3 = 0; i3 < size; i3++) {
      PackageStateInternal packageStateInternal = (PackageStateInternal) packageStates.valueAt(i3);
      if (packageStateInternal != null
          && PackageUserStateUtils.isAvailable(packageStateInternal.getUserStateOrDefault(i2), j)) {
        String name = sharedLibraryInfo.getName();
        if (sharedLibraryInfo.isStatic() || sharedLibraryInfo.isSdk()) {
          String[] usesStaticLibraries =
              sharedLibraryInfo.isStatic()
                  ? packageStateInternal.getUsesStaticLibraries()
                  : packageStateInternal.getUsesSdkLibraries();
          long[] usesStaticLibrariesVersions =
              sharedLibraryInfo.isStatic()
                  ? packageStateInternal.getUsesStaticLibrariesVersions()
                  : packageStateInternal.getUsesSdkLibrariesVersionsMajor();
          int indexOf = ArrayUtils.indexOf(usesStaticLibraries, name);
          if (indexOf >= 0
              && usesStaticLibrariesVersions[indexOf] == sharedLibraryInfo.getLongVersion()
              && !shouldFilterApplication(packageStateInternal, i, i2)) {
            if (arrayList == null) {
              arrayList = new ArrayList();
            }
            ...
            && ((ArrayUtils.contains(packageStateInternal.getPkg().getUsesLibraries(), name)
                    || ArrayUtils.contains(
                        packageStateInternal.getPkg().getUsesOptionalLibraries(), name))
                && !shouldFilterApplication(packageStateInternal, i, i2))) {
          if (arrayList == null) {
            arrayList = new ArrayList();
          }
          arrayList.add(
              new VersionedPackage(
                  packageStateInternal.getPackageName(), packageStateInternal.getVersionCode()));
        }
      }
    }
    return arrayList;
  ...
  public ParceledListSlice getDeclaredSharedLibraries(String str, long j, int i) {
    ...
    this.mContext.enforceCallingOrSelfPermission(
        "android.permission.ACCESS_SHARED_LIBRARIES", "getDeclaredSharedLibraries");
    int callingUid = Binder.getCallingUid();
    ...
    while (i6 < size) {
      WatchedLongSparseArray watchedLongSparseArray2 =
          (WatchedLongSparseArray) sharedLibraries.valueAt(i6);
      if (watchedLongSparseArray2 == null) {
        ...
        while (i7 < size2) {
          SharedLibraryInfo sharedLibraryInfo =
              (SharedLibraryInfo) watchedLongSparseArray2.valueAt(i7);
          VersionedPackage declaringPackage = sharedLibraryInfo.getDeclaringPackage();
              ...
              if (getPackageInfoInternal(
                ...
                SharedLibraryInfo sharedLibraryInfo2 =
                    new SharedLibraryInfo(
                        ...
                        getPackagesUsingSharedLibrary(sharedLibraryInfo, j, callingUid, i),
                        sharedLibraryInfo.getDependencies() == null
                            ? null
                            : new ArrayList(sharedLibraryInfo.getDependencies()),
                        sharedLibraryInfo.isNative());
  ...
  public ProviderInfo getProviderInfo(ComponentName componentName, long j, int i) {
    ...
    ParsedProvider provider = this.mComponentResolver.getProvider(componentName);
    if (provider == null
        || (packageStateInternal = getPackageStateInternal(provider.getPackageName())) == null
        || packageStateInternal.getPkg() == null
        || !PackageStateUtils.isEnabledAndMatches(
            packageStateInternal, provider, updateFlagsForComponent, i)
        || shouldFilterApplication(packageStateInternal, callingUid, componentName, 4, i)
        || (generateApplicationInfo =
                PackageInfoUtils.generateApplicationInfo(
                    packageStateInternal.getPkg(),
                    updateFlagsForComponent,
                    (userStateOrDefault = packageStateInternal.getUserStateOrDefault(i)),
                    i,
                    packageStateInternal))
            == null) {
      return null;
  ...
  public String[] getSystemSharedLibraryNames() {
    ...
    for (int i = 0; i < size; i++) {
      WatchedLongSparseArray watchedLongSparseArray =
          (WatchedLongSparseArray) sharedLibraries.valueAt(i);
      if (watchedLongSparseArray != null) {
        int size2 = watchedLongSparseArray.size();
        int i2 = 0;
        while (true) {
          if (i2 < size2) {
            SharedLibraryInfo sharedLibraryInfo =
                (SharedLibraryInfo) watchedLongSparseArray.valueAt(i2);
            if (!sharedLibraryInfo.isStatic()) {
              ...
              PackageStateInternal packageStateInternal =
                  getPackageStateInternal(sharedLibraryInfo.getPackageName());
              if (packageStateInternal == null
  ...
  public PackageStateInternal getPackageStateForInstalledAndFiltered(String str, int i, int i2) {
    PackageStateInternal packageStateInternal = getPackageStateInternal(str);
    if (packageStateInternal == null
        || shouldFilterApplicationIncludingUninstalled(packageStateInternal, i, i2)) {
      return null;
    }
    return packageStateInternal;
  }
  ...
  public int checkSignatures(String str, String str2, int i) {
    ...
    PackageStateInternal packageStateInternal =
        androidPackage == null ? null : getPackageStateInternal(androidPackage.getPackageName());
    PackageStateInternal packageStateInternal2 =
        androidPackage2 != null ? getPackageStateInternal(androidPackage2.getPackageName()) : null;
    if (androidPackage == null
        || packageStateInternal == null
        || androidPackage2 == null
        || packageStateInternal2 == null
        || shouldFilterApplicationIncludingUninstalled(packageStateInternal, callingUid, i)
        || shouldFilterApplicationIncludingUninstalled(packageStateInternal2, callingUid, i)) {
      return -4;
    }
    return checkSignaturesInternal(
        androidPackage.getSigningDetails(), androidPackage2.getSigningDetails());
  }
  ...
  public int checkUidSignatures(int i, int i2) {
    int callingUid = Binder.getCallingUid();
    int userId = UserHandle.getUserId(callingUid);
    SigningDetails signingDetailsAndFilterAccess =
        getSigningDetailsAndFilterAccess(i, callingUid, userId);
    SigningDetails signingDetailsAndFilterAccess2 =
        getSigningDetailsAndFilterAccess(i2, callingUid, userId);
  ...
  public int checkUidSignaturesForAllUsers(int i, int i2) {
    ...
    SigningDetails signingDetailsAndFilterAccess =
        getSigningDetailsAndFilterAccess(i, callingUid, userId);
    SigningDetails signingDetailsAndFilterAccess2 =
        getSigningDetailsAndFilterAccess(i2, callingUid, userId2);
    if (signingDetailsAndFilterAccess == null || signingDetailsAndFilterAccess2 == null) {
      return -4;
    }
    return checkSignaturesInternal(signingDetailsAndFilterAccess, signingDetailsAndFilterAccess2);
  ...
  public final int checkSignaturesInternal(
    ...
    int compareSignatures =
        PackageManagerServiceUtils.compareSignatures(
            signingDetails.getSignatures(), signingDetails2.getSignatures());
    if (compareSignatures == 0) {
      return compareSignatures;
    }
    if (!signingDetails.hasPastSigningCertificates()
        && !signingDetails2.hasPastSigningCertificates()) {
      return compareSignatures;
    }
    if (signingDetails.hasPastSigningCertificates()) {
  ...
  public boolean hasSigningCertificate(String str, byte[] bArr, int i) {
    ...
    PackageStateInternal packageStateInternal =
        getPackageStateInternal(androidPackage.getPackageName());
    if (packageStateInternal == null
        || shouldFilterApplicationIncludingUninstalled(packageStateInternal, callingUid, userId)) {
      return false;
    }
    if (i == 0) {
  ...
  public boolean hasUidSigningCertificate(int i, byte[] bArr, int i2) {
    int callingUid = Binder.getCallingUid();
    SigningDetails signingDetailsAndFilterAccess =
        getSigningDetailsAndFilterAccess(i, callingUid, UserHandle.getUserId(callingUid));
  ...
  public List getAllPackages() {
    ...
    if (instantAppPackageName != null) {
      ...
      for (AndroidPackage androidPackage2 : this.mPackages.values()) {
        PackageStateInternal packageStateInternal =
            getPackageStateInternal(androidPackage2.getPackageName());
        if (packageStateInternal == null
            || !packageStateInternal.getUserStateOrDefault(userId).isInstantApp()
            || this.mInstantAppRegistry.isInstantAccessGranted(
                userId, UserHandle.getAppId(callingUid), packageStateInternal.getAppId())) {
  ...
  public String getNameForUid(int i) {
    ...
    if (Process.isIsolatedUid(i)
        && this.mPermissionManager.getHotwordDetectionServiceProvider() != null
        && i == this.mPermissionManager.getHotwordDetectionServiceProvider().getUid()) {
      try {
        i = getIsolatedOwner(i);
  ...
  public int getUidForSharedUser(String str) {
    ...
    int callingUid = Binder.getCallingUid();
    if (getInstantAppPackageName(callingUid) != null
        || (sharedUserFromId = this.mSettings.getSharedUserFromId(str)) == null
        || shouldFilterApplicationIncludingUninstalled(
            sharedUserFromId, callingUid, UserHandle.getUserId(callingUid))) {
      return -1;
    }
  ...
  public String[] getAppOpPermissionPackages(String str, int i) {
    ...
    if (str == null
        || getInstantAppPackageName(callingUid) != null
        || !this.mUserManager.exists(i)) {
    ...
    for (int size = arraySet.size() - 1; size >= 0; size--) {
      if (shouldFilterApplicationIncludingUninstalled(
          this.mSettings.getPackage((String) arraySet.valueAt(size)), callingUid, i)) {
  ...
  public ParceledListSlice getPackagesHoldingPermissions(String[] strArr, long j, int i) {
    ...
    long updateFlagsForPackage = updateFlagsForPackage(j, i);
    enforceCrossUserPermission(
        Binder.getCallingUid(), i, true, false, "get packages holding permissions");
    ...
    for (PackageStateInternal packageStateInternal : getPackageStates().values()) {
      if (packageStateInternal.getPkg() != null || z) {
        addPackageHoldingPermissions(
            arrayList, packageStateInternal, strArr, zArr, updateFlagsForPackage, i);
      }
    }
    return new ParceledListSlice(arrayList);
  }

  public final void addPackageHoldingPermissions(
      ArrayList arrayList,
      PackageStateInternal packageStateInternal,
      String[] strArr,
      boolean[] zArr,
    ...
    for (int i3 = 0; i3 < strArr.length; i3++) {
      if (this.mPermissionManager.checkPermission(
              packageStateInternal.getPackageName(), strArr[i3], i)
          == 0) {
        zArr[i3] = true;
        i2++;
      } else {
    ...
    if (i2 == 0
        || (generatePackageInfo = generatePackageInfo(packageStateInternal, j, i)) == null) {
      return;
    }
    if ((j & 4096) == 0) {
      if (i2 == strArr.length) {
  ...
  public List getInstalledApplications(long j, int i, final int i2) {
    ...
    if (PMRune.PM_NAL_GET_APP_LIST) {
      if (this.mGetAppListHelper.checkCallingGetAppList(
          ...
          i2,
          this.mGetAppListHelper.isExemptedPackage(
              i2, this.mSettings.getSettingBase(UserHandle.getAppId(i2))),
          new Function() { // from class:
            // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
              String[] lambda$getInstalledApplications$3;
              lambda$getInstalledApplications$3 =
                  ComputerEngine.this.lambda$getInstalledApplications$3((Integer) obj);
        ...
        this.mInjector
            ...
            .post(
                new Runnable() { // from class:
                  // com.android.server.pm.ComputerEngine$$ExternalSyntheticLambda2
                  @Override // java.lang.Runnable
                  public final void run() {
    ...
    boolean needToFilterSamsungThemePackages =
        needToFilterSamsungThemePackages(updateFlagsForApplication);
    ArrayMap packageStates = getPackageStates();
    if (z) {
      ...
      for (PackageStateInternal packageStateInternal : packageStates.values()) {
        long j2 =
            packageStateInternal.isSystem()
                ? 4194304 | updateFlagsForApplication
                : updateFlagsForApplication;
        if (packageStateInternal.getPkg() != null) {
          if (z2 || !packageStateInternal.getPkg().isApex()) {
            if (!filterSharedLibPackage(packageStateInternal, i2, i, updateFlagsForApplication)
                && !shouldFilterApplication(packageStateInternal, i2, i)) {
              ...
              if (generateApplicationInfoFromSettings != null) {
                generateApplicationInfoFromSettings.packageName =
                    resolveExternalPackageName(packageStateInternal.getPkg());
              }
            }
          }
          ...
          generateApplicationInfoFromSettings =
              generateApplicationInfoFromSettings(packageStateInternal.getPackageName(), j2, i2, i);
        }
        if (generateApplicationInfoFromSettings != null
            && (!needToFilterSamsungThemePackages
                || !filterSamsungThemePackage(
                    packageStateInternal, generateApplicationInfoFromSettings, i))) {
      ...
      for (PackageStateInternal packageStateInternal2 : packageStates.values()) {
        ...
        if (pkg != null && (z2 || !pkg.isApex())) {
          if (!filterSharedLibPackage(
                  packageStateInternal2, Binder.getCallingUid(), i, updateFlagsForApplication)
              && !shouldFilterApplication(packageStateInternal2, i2, i)
              && (generateApplicationInfo =
                      PackageInfoUtils.generateApplicationInfo(
                          pkg,
                          updateFlagsForApplication,
                          packageStateInternal2.getUserStateOrDefault(i),
                          i,
                          packageStateInternal2))
                  != null) {
            generateApplicationInfo.packageName = resolveExternalPackageName(pkg);
            if (!needToFilterSamsungThemePackages
                || !filterSamsungThemePackage(packageStateInternal2, generateApplicationInfo, i)) {
  ...
  public ProviderInfo resolveContentProvider(String str, long j, int i, int i2) {
    ...
    ProviderInfo queryProvider =
        this.mComponentResolver.queryProvider(this, str, updateFlagsForComponent, i);
    boolean z = true;
    if (!((queryProvider == null || i == UserHandle.getUserId(i2))
        ? false
        : ((UriGrantsManagerInternal)
                this.mInjector.getLocalService(UriGrantsManagerInternal.class))
            .checkAuthorityGrants(i2, queryProvider, i, true))) {
      if (ContentProvider.isAuthorityRedirectedForCloneProfile(str)
          && (userInfo =
                  this.mInjector.getUserManagerInternal().getUserInfo(UserHandle.getUserId(i2)))
              != null
    ...
    if (PackageStateUtils.isEnabledAndMatches(
            packageStateInternal, queryProvider, updateFlagsForComponent, i)
        && !shouldFilterApplication(
            packageStateInternal,
            i2,
            new ComponentName(queryProvider.packageName, queryProvider.name),
            4,
            i)) {
  ...
  public ProviderInfo getGrantImplicitAccessProviderInfo(int i, String str) {
    ...
    ProviderInfo resolveContentProvider =
        resolveContentProvider(
            "com.android.contacts", 0L, UserHandle.getUserId(callingUid), callingUid);
    if (resolveContentProvider == null
        || (applicationInfo = resolveContentProvider.applicationInfo) == null
        || !UserHandle.isSameApp(applicationInfo.uid, callingUid)) {
  ...
  public void querySyncProviders(boolean z, List list, List list2) {
    ...
    for (int size = arrayList2.size() - 1; size >= 0; size--) {
      ...
      if (shouldFilterApplication(
          this.mSettings.getPackage(providerInfo.packageName),
          Binder.getCallingUid(),
  ...
  public ParceledListSlice queryContentProviders(String str, int i, long j, String str2) {
    ...
    List queryProviders =
        this.mComponentResolver.queryProviders(this, str, str2, i, updateFlagsForComponent, i2);
  ...
  public InstrumentationInfo getInstrumentationInfoAsUser(
    ...
    if (packageStateInternal == null
        || androidPackage == null
        || shouldFilterApplication(packageStateInternal, callingUid, componentName, 0, i2)) {
      return null;
    }
    return PackageInfoUtils.generateInstrumentationInfo(
        (ParsedInstrumentation) this.mInstrumentation.get(componentName),
        androidPackage,
        i,
        packageStateInternal.getUserStateOrDefault(i2),
  ...
  public ParceledListSlice queryInstrumentationAsUser(String str, int i, int i2) {
    ...
    while (i4 < size) {
      ParsedInstrumentation parsedInstrumentation =
          (ParsedInstrumentation) this.mInstrumentation.valueAt(i4);
      if (str == null || str.equals(parsedInstrumentation.getTargetPackage())) {
        ...
        if (androidPackage != null
            && packageStateInternal != null
            && !shouldFilterApplication(packageStateInternal, callingUid, i2)) {
          i3 = callingUid;
  ...
  public List findSharedNonSystemLibraries(PackageStateInternal packageStateInternal) {
    ...
    if (!findSharedLibraries.isEmpty()) {
      ...
      while (it.hasNext()) {
        PackageStateInternal packageStateInternal2 =
            getPackageStateInternal(((SharedLibraryInfo) it.next()).getPackageName());
  ...
  public boolean isPackageSuspendedForUser(String str, int i) {
    int callingUid = Binder.getCallingUid();
    enforceCrossUserPermission(
        callingUid, i, true, false, "isPackageSuspendedForUser for user " + i);
    PackageStateInternal packageStateInternal = this.mSettings.getPackage(str);
    if (packageStateInternal == null
        || shouldFilterApplicationIncludingUninstalled(packageStateInternal, callingUid, i)) {
  ...
  public boolean isSuspendingAnyPackages(String str, int i) {
    ...
    while (it.hasNext()) {
      PackageUserStateInternal userStateOrDefault =
          ((PackageStateInternal) it.next()).getUserStateOrDefault(i);
      if (userStateOrDefault.getSuspendParams() != null
          && userStateOrDefault.getSuspendParams().containsKey(str)) {
        return true;
      }
    }
    return false;
  ...
  public String getInstallerPackageName(String str, int i) {
    ...
    if (packageStateInternal == null
        || shouldFilterApplicationIncludingUninstalled(
            packageStateInternal, callingUid, UserHandle.getUserId(callingUid))) {
      return null;
    }
    return str2;
  }
  ...
  */
  public InstallSourceInfo getInstallSourceInfo(String str, int i) {
    ...
    String str7 =
        (str6 == null
                || !((packageStateInternal2 = this.mSettings.getPackage(str6)) == null
                    || shouldFilterApplicationIncludingUninstalled(
                        packageStateInternal2, callingUid, i)))
            ? str6
            : null;
    ...
    if (str8 != null) {
      ...
      if (packageStateInternal3 == null
          || shouldFilterApplicationIncludingUninstalled(packageStateInternal3, callingUid, i)
          || (!z && isCallerFromManagedUserOrProfile(i))) {
        str2 = null;
        if (!installSource.mIsInitiatingPackageUninstalled) {
          str3 =
              ((getInstantAppPackageName(callingUid) != null) || !isCallerSameApp(str, callingUid))
                  ? null
                  : installSource.mInitiatingPackageName;
        } else {
          if (Objects.equals(
              installSource.mInitiatingPackageName, installSource.mInstallerPackageName)) {
            str4 = str7;
          } else {
            ...
            if (packageStateInternal4 == null
                || shouldFilterApplicationIncludingUninstalled(
                    packageStateInternal4, callingUid, i)) {
              str4 = null;
            }
          }
          str5 = installSource.mOriginatingPackageName;
          if (str5 != null
              && ((packageStateInternal = this.mSettings.getPackage(str5)) == null
                  || shouldFilterApplicationIncludingUninstalled(
                      packageStateInternal, callingUid, i))) {
            str5 = null;
          }
          String str9 =
              (str5 != null
          ...
          if (str4 != null
              ...
              && packageSignatures.mSigningDetails != SigningDetails.UNKNOWN) {
            signingInfo = new SigningInfo(packageSignatures.mSigningDetails);
          }
          return new InstallSourceInfo(
              str4, signingInfo, str9, str7, str2, installSource.mPackageSource);
        }
        str4 = str3;
        str5 = installSource.mOriginatingPackageName;
        if (str5 != null) {
  ...
  public int getApplicationEnabledSetting(String str, int i) {
    ...
    try {
      if (shouldFilterApplicationIncludingUninstalled(
          this.mSettings.getPackage(str), callingUid, i)) {
  ...
  public boolean isComponentEffectivelyEnabled(ComponentInfo componentInfo, UserHandle userHandle) {
    try {
      ...
      int componentEnabledSetting =
          this.mSettings.getComponentEnabledSetting(componentInfo.getComponentName(), identifier);
  ...
  public boolean isApplicationEffectivelyEnabled(String str, UserHandle userHandle) {
    try {
      int applicationEnabledSetting =
          this.mSettings.getApplicationEnabledSetting(str, userHandle.getIdentifier());
      if (applicationEnabledSetting != 0) {
  ...
  public KeySet getKeySetByAlias(String str, String str2) {
    ...
    if (androidPackage == null
        || shouldFilterApplicationIncludingUninstalled(
            getPackageStateInternal(androidPackage.getPackageName()), callingUid, userId)) {
      Slog.w("PackageManager", "KeySet requested for unknown package: " + str);
      throw new IllegalArgumentException("Unknown package: " + str);
    }
    return new KeySet(
        this.mSettings.getKeySetManagerService().getKeySetByAliasAndPackageNameLPr(str, str2));
  }
  ...
  public KeySet getSigningKeySet(String str) {
    ...
    if (androidPackage == null
        || shouldFilterApplicationIncludingUninstalled(
            getPackageStateInternal(androidPackage.getPackageName()), callingUid, userId)) {
      Slog.w(
          "PackageManager", "KeySet requested for unknown package: " + str + ", uid:" + callingUid);
      throw new IllegalArgumentException("Unknown package: " + str);
    }
    ...
    return new KeySet(
        this.mSettings.getKeySetManagerService().getSigningKeySetByPackageNameLPr(str));
  }
  ...
  public boolean isPackageSignedByKeySet(String str, KeySet keySet) {
    ...
    if (token instanceof KeySetHandle) {
      return this.mSettings
          .getKeySetManagerService()
          .packageIsSignedByLPr(str, (KeySetHandle) token);
    }
    return false;
  }
  ...
  public boolean isPackageSignedByKeySetExactly(String str, KeySet keySet) {
    ...
    if (token instanceof KeySetHandle) {
      return this.mSettings
          .getKeySetManagerService()
          .packageIsSignedByExactlyLPr(str, (KeySetHandle) token);
    }
    return false;
  }
  ...
  public SparseArray getVisibilityAllowLists(String str, int[] iArr) {
    ...
    return this.mAppsFilter.getVisibilityAllowList(
        this, packageStateInternal, iArr, getPackageStates());
  }
  ...
  public boolean canAccessComponent(int i, ComponentName componentName, int i2) {
    PackageStateInternal packageStateInternal =
        getPackageStateInternal(componentName.getPackageName());
    return (packageStateInternal == null
            || shouldFilterApplication(packageStateInternal, i, componentName, 0, i2, true))
        ? false
        : true;
  }
  ...
  public boolean isCallerInstallerOfRecord(AndroidPackage androidPackage, int i) {
    ...
    return (androidPackage == null
            || (packageStateInternal = getPackageStateInternal(androidPackage.getPackageName()))
                == null
            || (packageStateInternal2 =
                    getPackageStateInternal(
                        packageStateInternal.getInstallSource().mInstallerPackageName))
                == null
            || !UserHandle.isSameApp(packageStateInternal2.getAppId(), i))
        ? false
        : true;
  }
    ...
    if (z) {
      throw new ParcelableException(
          new PackageManager.NameNotFoundException(
              "Package(s) " + str + " and/or " + Arrays.toString(strArr) + " not found."));
    }
  ...
  public boolean canForwardTo(Intent intent, String str, int i, int i2) {
    ...
    return getCrossProfileDomainPreferredLpr(
            intent,
            str,
            updateFlagsForResolve(
                    0L,
                    ...
                    callingUid,
                    false,
                    isImplicitImageCaptureIntentAndNotSetByDpc(intent, i3, str, 0L))
                | 65536,
            i,
            profileParent.id)
        != null;
  ...
  public List getPersistentApplications(boolean z, int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      PackageStateInternal packageStateInternal2 =
          this.mSettings.getPackage(androidPackage.getPackageName());
      ...
      if (androidPackage.isPersistent()
          && ((!z || packageStateInternal2.isSystem())
              && ((z2 || z3)
                  && (packageStateInternal =
                          this.mSettings.getPackage(androidPackage.getPackageName()))
                      != null
                  && (generateApplicationInfo =
                          PackageInfoUtils.generateApplicationInfo(
                              androidPackage,
                              i,
                              packageStateInternal.getUserStateOrDefault(callingUserId),
                              callingUserId,
                              packageStateInternal))
                      != null))) {
        arrayList.add(generateApplicationInfo);
  ...
  public String[] getSharedUserPackagesForPackage(String str, int i) {
    if (this.mSettings.getPackage(str) == null
        || this.mSettings.getSharedUserFromPackageName(str) == null) {
      return EmptyArray.STRING;
    }
    ...
    while (i2 < packages.size()) {
      ...
      if (packageStateInternal.getPkg() == null) {
        ...
        if (PackageManagerServiceUtils.isUnusedSinceTimeInMillis(
            PackageStateUtils.getEarliestFirstInstallTime(packageStateInternal.getUserStates()),
            currentTimeMillis,
            j,
            this.mDexManager.getPackageUseInfoOrDefault(packageStateInternal.getPackageName()),
    ...
    for (int i = 0; i < packages.size(); i++) {
      ...
      if (packageStateInternal.getPkg() != null) {
        long latestForegroundPackageUseTimeInMills =
            packageStateInternal.getTransientState().getLatestForegroundPackageUseTimeInMills();
        if (PackageManagerServiceUtils.isActiveInForegroundWithinThresholdTime(
            currentTimeMillis, j, latestForegroundPackageUseTimeInMills)) {
          arrayMap.put(
              packageStateInternal.getPackageName(),
              Long.valueOf(latestForegroundPackageUseTimeInMills));
        }
      }
    }
    return arrayMap;
  ...
  public CharSequence getHarmfulAppWarning(String str, int i) {
    ...
    if (!PackageManagerServiceUtils.isSystemOrRoot(appId)
        && checkUidPermission("android.permission.SET_HARMFUL_APP_WARNINGS", callingUid) != 0) {
      throw new SecurityException(
  ...
  public int getUidTargetSdkVersion(int i) {
    ...
    if (settingBase instanceof SharedUserSetting) {
      ...
      for (int i3 = 0; i3 < size; i3++) {
        PackageStateInternal packageStateInternal =
            (PackageStateInternal) packageStates.valueAt(i3);
        if (packageStateInternal.getPkg() != null
            && (targetSdkVersion = packageStateInternal.getPkg().getTargetSdkVersion()) < i2) {
          i2 = targetSdkVersion;
        }
      }
      return i2;
  ...
  public ArrayMap getProcessesForUid(int i) {
    ...
    if (!(settingBase instanceof PackageSetting)
        || (pkg = ((PackageSetting) settingBase).getPkg()) == null) {
      return null;
    }
