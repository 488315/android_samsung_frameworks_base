...
public class PersistentPreferredActivity extends WatchedIntentFilter {
  ...
  public final SnapshotCache makeCache() {
    return new SnapshotCache(
        this, this) { // from class: com.android.server.pm.PersistentPreferredActivity.1
  ...
  public PersistentPreferredActivity(
      IntentFilter intentFilter, ComponentName componentName, boolean z) {
    super(intentFilter);
  ...
  public PersistentPreferredActivity(
      WatchedIntentFilter watchedIntentFilter, ComponentName componentName, boolean z) {
  ...
  public PersistentPreferredActivity(TypedXmlPullParser typedXmlPullParser) {
    ...
    while (true) {
      ...
      if (next != 3 && next != 4 && next == 2) {
        ...
        PackageManagerService.reportSettingsProblem(
            5, "Unknown element: " + name + " at " + typedXmlPullParser.getPositionDescription());
    ...
    if (name.equals("filter")) {
      ...
      PackageManagerService.reportSettingsProblem(
          5, "Missing element filter at " + typedXmlPullParser.getPositionDescription());
      XmlUtils.skipCurrentTag(typedXmlPullParser);
    }
    this.mSnapshot = makeCache();
  }
  ...
  public String toString() {
    return "PersistentPreferredActivity{0x"
