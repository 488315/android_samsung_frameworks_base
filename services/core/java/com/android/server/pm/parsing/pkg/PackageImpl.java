...
public class PackageImpl
  ...
  public static final Comparator ORDER_COMPARATOR =
      new Comparator() { // from class:
                         // com.android.server.pm.parsing.pkg.PackageImpl$$ExternalSyntheticLambda0
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
          int lambda$static$0;
          lambda$static$0 =
              PackageImpl.lambda$static$0((ParsedMainComponent) obj, (ParsedMainComponent) obj2);
  ...
  public static ParsingUtils.StringPairListParceler sForIntentInfoPairs =
      new ParsingUtils.StringPairListParceler();
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: com.android.server.pm.parsing.pkg.PackageImpl.1
  ...
  public static /* synthetic */ int lambda$static$0(
      ParsedMainComponent parsedMainComponent, ParsedMainComponent parsedMainComponent2) {
  ...
  public PackageImpl addImplicitPermission(String str) {
    ...
    this.implicitPermissions =
        CollectionUtils.add(this.implicitPermissions, TextUtils.safeIntern(str));
    return this;
  }
  ...
  public final void addMimeGroupsFromComponent(ParsedComponent parsedComponent) {
    for (int size = parsedComponent.getIntents().size() - 1; size >= 0; size--) {
      IntentFilter intentFilter =
          ((ParsedIntentInfo) parsedComponent.getIntents().get(size)).getIntentFilter();
      for (int countMimeGroups = intentFilter.countMimeGroups() - 1;
        ...
        this.mimeGroups =
            CollectionUtils.add(this.mimeGroups, intentFilter.getMimeGroup(countMimeGroups));
      }
    }
  }
  ...
  public PackageImpl addPreferredActivityFilter(String str, ParsedIntentInfo parsedIntentInfo) {
    this.preferredActivityFilters =
        CollectionUtils.add(this.preferredActivityFilters, Pair.create(str, parsedIntentInfo));
    return this;
  }
  ...
  public PackageImpl addProtectedBroadcast(String str) {
    if (!this.protectedBroadcasts.contains(str)) {
      this.protectedBroadcasts =
          CollectionUtils.add(this.protectedBroadcasts, TextUtils.safeIntern(str));
    }
    return this;
  }
  ...
  public final PackageImpl addUsesNativeLibrary(String str) {
    this.usesNativeLibraries =
        CollectionUtils.add(this.usesNativeLibraries, TextUtils.safeIntern(str));
    return this;
  }
  ...
  public PackageImpl addUsesOptionalLibrary(String str) {
    this.usesOptionalLibraries =
        CollectionUtils.add(this.usesOptionalLibraries, TextUtils.safeIntern(str));
    return this;
  }
  ...
  public final PackageImpl addUsesOptionalNativeLibrary(String str) {
    this.usesOptionalNativeLibraries =
        CollectionUtils.add(this.usesOptionalNativeLibraries, TextUtils.safeIntern(str));
    return this;
  }
  ...
  public PackageImpl addUsesPermission(ParsedUsesPermission parsedUsesPermission) {
    ...
    this.requestedPermissions =
        CollectionUtils.add(this.requestedPermissions, parsedUsesPermission.getName());
    return this;
  }
  ...
  public PackageImpl addUsesSdkLibrary(String str, long j, String[] strArr) {
    ...
    this.usesSdkLibrariesVersionsMajor =
        ArrayUtils.appendLong(this.usesSdkLibrariesVersionsMajor, j, true);
    this.usesSdkLibrariesCertDigests =
        (String[][])
            ArrayUtils.appendElement(
                String[].class, this.usesSdkLibrariesCertDigests, strArr, true);
    return this;
  }
  ...
  public PackageImpl addUsesStaticLibrary(String str, long j, String[] strArr) {
    this.usesStaticLibraries =
        CollectionUtils.add(this.usesStaticLibraries, TextUtils.safeIntern(str));
    this.usesStaticLibrariesVersions =
        ArrayUtils.appendLong(this.usesStaticLibrariesVersions, j, true);
    this.usesStaticLibrariesCertDigests =
        (String[][])
            ArrayUtils.appendElement(
                String[].class, this.usesStaticLibrariesCertDigests, strArr, true);
    return this;
  }
  ...
  public final ArrayMap buildAppClassNamesByProcess() {
    ...
    for (String str : this.processes.keySet()) {
      ArrayMap appClassNamesByPackage =
          ((ParsedProcess) this.processes.get(str)).getAppClassNamesByPackage();
    ...
    if (this.mSplits == null) {
      ...
      if (this.splitNames != null) {
        ...
        while (true) {
          ...
          arrayList.add(
              new AndroidPackageSplitImpl(
                  strArr[i],
                  this.splitCodePaths[i],
                  this.splitRevisionCodes[i],
                  this.splitFlags[i],
                  this.splitClassLoaderNames[i]));
          i++;
        }
      }
      if (this.splitDependencies != null) {
        for (int i2 = 0; i2 < this.splitDependencies.size(); i2++) {
          ...
          ((AndroidPackageSplitImpl) arrayList.get(keyAt))
              .fillDependencies(Collections.unmodifiableList(arrayList2));
        }
      }
  ...
  public PackageImpl removeUsesOptionalNativeLibrary(String str) {
    this.usesOptionalNativeLibraries =
        CollectionUtils.remove(this.usesOptionalNativeLibraries, str);
    return this;
  }
  ...
  public ApplicationInfo toAppInfoWithoutStateWithoutFlags() {
    ...
    applicationInfo.splitDependencies =
        (sparseArray == null || sparseArray.size() == 0) ? null : this.splitDependencies;
    ...
    applicationInfo.setSplitCodePaths(
        ArrayUtils.size(this.splitCodePaths) == 0 ? null : this.splitCodePaths);
    applicationInfo.setSplitResourcePaths(
  ...
  public final void assignDerivedFields2() {
    ...
    this.mBaseAppInfoPrivateFlags =
        PackageInfoUtils.appInfoPrivateFlags(this, (PackageStateInternal) null);
    this.mBaseAppInfoPrivateFlagsExt =
        PackageInfoUtils.appInfoPrivateFlagsExt(this, (PackageStateInternal) null);
    ...
    this.mBaseAppDataCredentialProtectedDirForSystemUser =
        TextUtils.safeIntern(sb2 + "user" + str2);
  ...
  public PackageImpl addUsesOptionalLibrary(int i, String str) {
    this.usesOptionalLibraries =
        CollectionUtils.add(this.usesOptionalLibraries, i, TextUtils.safeIntern(str));
    return this;
  }
  ...
  public PackageImpl setPackageName(String str) {
    ...
    for (int i = 0; i < size; i++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.permissions.get(i), this.packageName);
    }
    int size2 = this.permissionGroups.size();
    for (int i2 = 0; i2 < size2; i2++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.permissionGroups.get(i2), this.packageName);
    }
    int size3 = this.activities.size();
    for (int i3 = 0; i3 < size3; i3++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.activities.get(i3), this.packageName);
    }
    int size4 = this.receivers.size();
    for (int i4 = 0; i4 < size4; i4++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.receivers.get(i4), this.packageName);
    }
    int size5 = this.providers.size();
    for (int i5 = 0; i5 < size5; i5++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.providers.get(i5), this.packageName);
    }
    int size6 = this.services.size();
    for (int i6 = 0; i6 < size6; i6++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.services.get(i6), this.packageName);
    }
    int size7 = this.instrumentations.size();
    for (int i7 = 0; i7 < size7; i7++) {
      ComponentMutateUtils.setPackageName(
          (ParsedComponent) this.instrumentations.get(i7), this.packageName);
    }
    return this;
  }
  ...
  public ApplicationInfo toAppInfoWithoutState() {
    ...
    appInfoWithoutStateWithoutFlags.nativeLibraryRootRequiresIsa =
  ...
  public PackageImpl(Parcel parcel) {
    ...
    this.usesPermissions =
        ParsingUtils.createTypedInterfaceList(parcel, ParsedUsesPermissionImpl.CREATOR);
    ...
    this.apexSystemServices =
        ParsingUtils.createTypedInterfaceList(parcel, ParsedApexSystemServiceImpl.CREATOR);
    ...
    this.attributions =
        ParsingUtils.createTypedInterfaceList(parcel, ParsedAttributionImpl.CREATOR);
    this.permissions = ParsingUtils.createTypedInterfaceList(parcel, ParsedPermissionImpl.CREATOR);
    this.permissionGroups =
        ParsingUtils.createTypedInterfaceList(parcel, ParsedPermissionGroupImpl.CREATOR);
    this.instrumentations =
        ParsingUtils.createTypedInterfaceList(parcel, ParsedInstrumentationImpl.CREATOR);
