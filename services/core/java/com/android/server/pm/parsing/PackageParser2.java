...
public class PackageParser2 implements AutoCloseable {
  ...
  public ThreadLocal mSharedAppInfo =
      ThreadLocal.withInitial(
          new Supplier() { // from class:
                           // com.android.server.pm.parsing.PackageParser2$$ExternalSyntheticLambda0
  ...
  public static PackageParser2 forParsingFileWithDefaults() {
    final IPlatformCompat asInterface =
        IPlatformCompat.Stub.asInterface(ServiceManager.getService("platform_compat"));
    return new PackageParser2(
        null,
        null,
        null,
        new Callback() { // from class: com.android.server.pm.parsing.PackageParser2.1
  ...
  public PackageParser2(
      String[] strArr, DisplayMetrics displayMetrics, File file, final Callback callback) {
    ...
    final ParseInput.Callback callback2 =
        new ParseInput
            .Callback() { // from class:
                          // com.android.server.pm.parsing.PackageParser2$$ExternalSyntheticLambda1
    ...
    this.mSharedResult =
        ThreadLocal.withInitial(
            new Supplier() { // from class:
                             // com.android.server.pm.parsing.PackageParser2$$ExternalSyntheticLambda2
              @Override // java.util.function.Supplier
              public final Object get() {
  ...
  public ParsedPackage parsePackage(File file, int i, boolean z) {
    ...
    if (z
        && (packageCacher = this.mCacher) != null
        && (cachedResult = packageCacher.getCachedResult(file, i)) != null) {
      return cachedResult;
    }
    boolean z2 = LOG_PARSE_TIMINGS;
    long uptimeMillis = z2 ? SystemClock.uptimeMillis() : 0L;
    ParseResult parsePackage =
        this.parsingUtils.parsePackage(((ParseTypeImpl) this.mSharedResult.get()).reset(), file, i);
    if (parsePackage.isError()) {
      throw new PackageManagerException(
          parsePackage.getErrorCode(), parsePackage.getErrorMessage(), parsePackage.getException());
    }
  ...
  public abstract class Callback implements ParsingPackageUtils.Callback {
    ...
    @Override // com.android.server.pm.pkg.parsing.ParsingPackageUtils.Callback
    public final ParsingPackage startParsingPackage(
