...
public final class AsecInstallArgs {
  ...
  public AsecInstallArgs(
      String str, String[] strArr, boolean z, PackageManagerService packageManagerService) {
    this(
    ...
    String absolutePath =
        !str.endsWith("pkg.apk") ? new File(str, "pkg.apk").getAbsolutePath() : str;
  ...
  public AsecInstallArgs(String str, String[] strArr, PackageManagerService packageManagerService) {
    this(
        ...
        null,
        null,
        AsecInstallHelper.isAsecExternal(str) ? 8 : 0,
        InstallSource.EMPTY,
        null,
        null,
        strArr,
  ...
  public int doPreInstall(int i) {
    if (i != 1) {
      ...
      String mountSdDir =
          PackageHelperExt.mountSdDir(this.cid, AsecInstallHelper.getEncryptKey(), 1000);
      if (mountSdDir == null) {
        return -18;
      }
  ...
  public final boolean pendingPostDeleteLI(final boolean z, final int i) {
    ...
    if (isContainerMounted) {
      Slog.d(
          "PackageManager",
          "AsecInstallArgs.doPostDeleteLI("
              + i
              + "): "
              + getPackageName()
              + ", codePath: "
      ...
      if (PackageHelperExt.unMountSdDir(this.cid, !z)) {
        ...
        if (i == 4) {
          PackageManagerServiceUtils.logCriticalInfo(
              5, "ASEC unmount failed and will try for last chance: " + this.cid);
        }
      }
    }
