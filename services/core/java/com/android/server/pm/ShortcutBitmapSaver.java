...
public class ShortcutBitmapSaver {
  ...
  public final Runnable mRunnable = new Runnable() { // from class:
        // com.android.server.pm.ShortcutBitmapSaver$$ExternalSyntheticLambda1
  ...
  public boolean waitForAllSavesLocked() {
    ...
    this.mExecutor.execute(
        new Runnable() { // from class:
          // com.android.server.pm.ShortcutBitmapSaver$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
    ...
    try {
      try {
        StrictMode.setThreadPolicy(
            new StrictMode.ThreadPolicy.Builder(threadPolicy).permitCustomSlowCalls().build());
        ...
        try {
          ...
          try {
            ShortcutService.FileOutputStreamWithPath openIconFileForWrite =
                this.mService.openIconFileForWrite(shortcutInfo.getUserId(), shortcutInfo);
