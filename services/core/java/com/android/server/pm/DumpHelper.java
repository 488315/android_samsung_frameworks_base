...
public final class DumpHelper {
  ...
  */
  public void doDump(
        ...
        if ("check-permission".equals(str3)) {
          ...
          if (i7 < strArr.length) {
            try {
              ...
              printWriter.println(
                  "Error: check-permission user argument is not a number: " + strArr[i7]);
              return;
            }
          }
          printWriter.println(
              this.mPermissionManager.checkPermission(
                  str4, computer.resolveInternalPackageName(str5, -1L), userId));
          return;
        }
        if ("l".equals(str3) || "libraries".equals(str3)) {
          dumpState.setDump(1);
        } else if (KnoxAnalyticsDataConverter.FEATURE.equals(str3) || "features".equals(str3)) {
          dumpState.setDump(2);
          ...
          if ("permission".equals(str3)) {
            ...
            if (targetPackageName == null
                && computer.getPackageStateInternal(targetPackageName) == null
                && !computer.isApexPackage(targetPackageName)) {
            ...
            if (!isCheckIn && dumpState.isDumping(134217728) && targetPackageName == null) {
              ...
              for (i3 = 0; i3 <= 19; i3++) {
                ...
                String[] knownPackageNames =
                    this.mKnownPackages.getKnownPackageNames(computer, i3, 0);
                indentingPrintWriter.increaseIndent();
            ...
            if (!dumpState.isDumping(IInstalld.FLAG_CLEAR_APP_DATA_KEEP_ART_PROFILES)
              ...
              ComponentName componentName =
                  this.mDomainVerificationManager.getProxy().getComponentName();
            ...
            if (!isCheckIn
                && dumpState.isDumping(IInstalld.FLAG_FORCE)
                && targetPackageName == null) {
            ...
            if (!isCheckIn && dumpState.isDumping(1024)) {
              componentResolver.dumpContentProviders(
                  computer, printWriter, dumpState, targetPackageName);
            }
            ...
            if (!isCheckIn && dumpState.isDumping(4194304) && str == null) {
              ...
              this.mChangedPackagesTracker.iterateAll(
                  new BiConsumer() { // from class:
                    // com.android.server.pm.DumpHelper$$ExternalSyntheticLambda0
            ...
            if (!isCheckIn && dumpState.isDumping(268435456) && str == null) {
              ...
              printWriter.println(
                  "    Default timeouts flag: " + PackageManagerService.getDefaultTimeouts());
              printWriter.println(
            ...
            if (isCheckIn && dumpState.isDumping(1073741824) && str == null) {
              ...
              for (int i8 = 0; i8 < this.mProtectedBroadcasts.size(); i8++) {
                printWriter.print("  ");
                printWriter.println((String) this.mProtectedBroadcasts.valueAt(i8));
              }
              return;
            }
            return;
          ...
          } else if (KnoxAnalyticsDataConverter.PAYLOAD.equals(str3) || "packages".equals(str3)) {
          ...
          } else if (KnoxAnalyticsDataConverter.TIMESTAMP.equals(str3) || "timeouts".equals(str3)) {
    ...
    if (!isCheckIn) {
      ...
      printWriter.println(
          "    Default timeouts flag: " + PackageManagerService.getDefaultTimeouts());
      printWriter.println(
          "    Known digesters list flag: " + PackageManagerService.getKnownDigestersList());
      printWriter.println("    Timeouts (" + this.mPerUidReadTimeouts.length + "):");
      while (r3 < r2) {}
    }
    if (!isCheckIn) {
  ...
  public static /* synthetic */ void lambda$doDump$0(
      PrintWriter printWriter, Integer num, SparseArray sparseArray) {
  ...
  public final void dumpAvailableFeaturesProto(ProtoOutputStream protoOutputStream) {
    ...
    for (int i = 0; i < size; i++) {
      ((FeatureInfo) this.mAvailableFeatures.valueAt(i))
