...
public class PackageDexOptimizer {
  ...
  public PackageDexOptimizer(Installer installer, Object obj, Context context, String str) {
    this(
        new Injector() { // from class: com.android.server.pm.PackageDexOptimizer.1
          ...
          public AppHibernationManagerInternal getAppHibernationManagerInternal() {
            return (AppHibernationManagerInternal)
  ...
  public PackageDexOptimizer(
      Injector injector, Installer installer, Object obj, Context context, String str) {
    this.mArtStatsLogger = new ArtStatsLogUtils.ArtStatsLogger();
  ...
  public boolean canOptimizePackage(AndroidPackage androidPackage) {
    ...
    AppHibernationManagerInternal appHibernationManagerInternal =
        this.mInjector.getAppHibernationManagerInternal();
    return (appHibernationManagerInternal != null
            && appHibernationManagerInternal.isHibernatingGlobally(androidPackage.getPackageName())
            && appHibernationManagerInternal.isOatArtifactDeletionEnabled())
        ? false
        : true;
  }

  public int performDexOpt(
  ...
  */
  public final int performDexOptLI(
    ...
    List nonNativeUsesLibraryInfos =
        packageStateInternal.getTransientState().getNonNativeUsesLibraryInfos();
    String[] dexCodeInstructionSets =
        InstructionSets.getDexCodeInstructionSets(
            strArr != null
                ? strArr
                : InstructionSets.getAppDexInstructionSets(
                    packageStateInternal.getPrimaryCpuAbi(),
                    packageStateInternal.getSecondaryCpuAbi()));
    ...
    String[] classLoaderContexts =
        DexoptUtils.getClassLoaderContexts(androidPackage2, nonNativeUsesLibraryInfos, zArr2);
    if (allCodePaths.size() != classLoaderContexts.length) {
      String[] splitCodePaths = androidPackage.getSplitCodePaths();
      StringBuilder sb = new StringBuilder();
      sb.append(
          "Inconsistent information between AndroidPackage and its ApplicationInfo."
              + " pkg.getAllCodePaths=");
      ...
      if (zArr2[i7]) {
        if (classLoaderContexts[i7] == null) {
          ...
          throw new IllegalStateException(
              "Inconsistent information in the package structure. A split is marked to contain code"
                  + " but has no dependency listed. Index="
                  + i8
                  + " path="
                  + ((String) allCodePaths.get(i8)));
        }
        String str11 = (String) allCodePaths.get(i7);
        if (dexoptOptions.getSplitName() == null
            || dexoptOptions.getSplitName().equals(new File(str11).getName())) {
          String profileName =
              ArtManager.getProfileName(i7 == 0 ? null : androidPackage.getSplitNames()[i7 - 1]);
          boolean isUsedByOtherApps =
              dexoptOptions.isDexoptAsSharedLibrary()
                  ? true
                  : DexOptHelper.useArtService() ? false : packageUseInfo.isUsedByOtherApps(str11);
          String realCompilerFilter =
              packageDexOptimizer3.getRealCompilerFilter(
                  androidPackage2, dexoptOptions.getCompilerFilter());
          boolean z =
              DexFile.isProfileGuidedCompilerFilter(realCompilerFilter)
                  && isUsedByOtherApps
                  && dexoptOptions.getCompilationReason() != 3;
          String absolutePath =
              ((dexoptOptions.isDexoptInstallWithDexMetadata() || z)
                      && (findDexMetadataForFile =
                              DexMetadataHelper.findDexMetadataForFile(new File(str11)))
                          != null)
                  ? findDexMetadataForFile.getAbsolutePath()
                  : null;
          int i9 = i6;
          int analyseProfiles =
              dexoptOptions.isCheckForProfileUpdates()
                  ? packageDexOptimizer3.analyseProfiles(
                      androidPackage2, i4, profileName, realCompilerFilter)
                  : 2;
          ...
          if (z) {
            try {
              ...
              try {
                if (packageDexOptimizer3.prepareCloudProfile(
                    androidPackage2, str4, str11, absolutePath)) {
                  str5 = str4;
                  compilerFilterForReason = realCompilerFilter;
                } else {
                  compilerFilterForReason =
                      PackageManagerServiceCompilerMapping.getCompilerFilterForReason(14);
                  str5 = null;
                }
                str6 = str5;
                i3 = 2;
          ...
          try {
                    ...
                    try {
                      ...
                      try {
                        ...
                        ArtStatsLogUtils.writeStatsLog(
                            packageDexOptimizer2.mArtStatsLogger,
                            sRandom.nextLong(),
                            compilerFilterForReason,
                            androidPackage.getUid(),
                            packageStats.getCompileTime(str9),
                            str14,
                            dexoptOptions.getCompilationReason(),
                            i12,
                            ArtStatsLogUtils.getApkType(
                                str9,
                        ...
                        try {
                          ...
                          try {
                            packageDexOptimizer2.mInstaller.deleteReferenceProfile(
                                androidPackage.getPackageName(), str4);
                            throw th;
                ...
                if (i12 == 2) {
                  if (i14 == -1) {
                    ...
                    if (str19 != null) {
                      try {
                        packageDexOptimizer2.mInstaller.deleteReferenceProfile(
                            androidPackage.getPackageName(), str19);
                  ...
                  if (str20 != null) {
                    try {
                      packageDexOptimizer2.mInstaller.deleteReferenceProfile(
                          androidPackage.getPackageName(), str20);
            ...
            if (str23 != null) {
              try {
                packageDexOptimizer.mInstaller.deleteReferenceProfile(
                    androidPackage.getPackageName(), str23);
  ...
  public final boolean prepareCloudProfile(
      AndroidPackage androidPackage, String str, String str2, String str3) {
    if (str3 != null) {
      ...
      try {
        ...
        this.mInstaller.prepareAppProfile(
            androidPackage.getPackageName(),
            -10000,
            UserHandle.getAppId(androidPackage.getUid()),
            str,
            str2,
            str3);
        return true;
  ...
  public final int dexOptPath(
      ...
      int i4) {
    String str7;
    String packageOatDirIfSupported =
        getPackageOatDirIfSupported(packageStateInternal, androidPackage);
    int dexoptNeeded =
        getDexoptNeeded(
            androidPackage.getPackageName(),
            str,
      ...
      try {
        if (!getInstallerLI()
            .dexopt(
                ...
                i2,
                str3,
                androidPackage.getVolumeUuid(),
                str4,
                packageStateInternal.getSeInfo(),
                false,
                androidPackage.getTargetSdkVersion(),
                str5,
                str6,
                getAugmentedReasonName(i4, str6 != null))) {
          return 2;
        }
        if (packageStats != null) {
        ...
        if (packageOatDirIfSupported != null) {
          F2fsUtils.releaseCompressedBlocks(
              this.mContext.getContentResolver(), new File(packageOatDirIfSupported));
        }
        return 1;
      } catch (Installer.InstallerException e) {
        e = e;
  ...
  public int dexOptSecondaryDexPath(
    ...
    synchronized (this.mInstallLock) {
      ...
      try {
        dexOptSecondaryDexPathLI =
            dexOptSecondaryDexPathLI(applicationInfo, str, dexUseInfo, dexoptOptions);
      } finally {
        releaseWakeLockLI(acquireWakeLockLI);
      }
    }
  ...
  public final int dexOptSecondaryDexPathLI(
      ApplicationInfo applicationInfo,
      String str,
      PackageDexUsage.DexUseInfo dexUseInfo,
      DexoptOptions dexoptOptions) {
    ...
    String realCompilerFilter =
        getRealCompilerFilter(
            applicationInfo, dexoptOptions.getCompilerFilter(), dexUseInfo.isUsedByOtherApps());
    ...
    if (str4 == null || !FileUtils.contains(str4, str)) {
      ...
      if (str6 == null || !FileUtils.contains(str6, str)) {
        Slog.e(
            "PackageDexOptimizer",
            "Could not infer CE/DE storage for package " + applicationInfo.packageName);
        return -1;
      }
      i = dexFlags | 128;
    } else {
    ...
    Log.d(
        ...
        "Running dexopt on: "
            ...
            + " isa="
            + dexUseInfo.getLoaderIsas()
            + " reason="
            + PackageManagerServiceCompilerMapping.getReasonName(compilationReason)
            + " dexoptFlags="
            + printDexoptFlags(i2)
            + " target-filter="
            + str7
  ...
  public void dumpDexoptState(
    ...
    for (String str : AndroidPackageUtils.getAllCodePathsExcludingResourceOnly(androidPackage)) {
      ...
      for (String str2 : dexCodeInstructionSets) {
        try {
          DexFile.OptimizationInfo dexFileOptimizationInfo =
              DexFile.getDexFileOptimizationInfo(str, str2);
          indentingPrintWriter.println(
              str2
                  + ": [status="
                  + dexFileOptimizationInfo.getStatus()
                  + "] [reason="
                  + dexFileOptimizationInfo.getReason()
                  + "]");
        } catch (IOException e) {
      ...
      if (packageUseInfo.isUsedByOtherApps(str)) {
        indentingPrintWriter.println(
            "used by other apps: " + packageUseInfo.getLoadingPackages(str));
      }
      ...
      if (!dexUseInfoMap.isEmpty()) {
        ...
        for (Map.Entry entry : dexUseInfoMap.entrySet()) {
          ...
          indentingPrintWriter.increaseIndent();
          indentingPrintWriter.println(
              "class loader context: " + dexUseInfo.getClassLoaderContext());
  ...
  public final String getRealCompilerFilter(
      ApplicationInfo applicationInfo, String str, boolean z) {
    ...
    return (DexFile.isProfileGuidedCompilerFilter(str) && z)
        ? PackageManagerServiceCompilerMapping.getCompilerFilterForReason(14)
        : str;
  }
  ...
  public final String getRealCompilerFilter(AndroidPackage androidPackage, String str) {
    ...
    return androidPackage.isVmSafeMode() || androidPackage.isDebuggable()
        ? DexFile.getSafeModeCompilerFilter(str)
        : str;
  }
  ...
  public final int getDexFlags(
      ApplicationInfo applicationInfo, String str, DexoptOptions dexoptOptions) {
    return getDexFlags(
        (applicationInfo.flags & 2) != 0,
        applicationInfo.getHiddenApiEnforcementPolicy(),
        applicationInfo.splitDependencies,
        applicationInfo.requestsIsolatedSplitLoading(),
        str,
        false,
        dexoptOptions);
  }
  ...
  public final int getDexFlags(
    ...
    return getDexFlags(
        ...
        AndroidPackageUtils.getHiddenApiEnforcementPolicy(androidPackage, packageStateInternal),
  ...
  public final int getDexFlags(
    ...
    boolean z4 =
        !isProfileGuidedCompilerFilter || dexoptOptions.isDexoptInstallWithDexMetadata() || z3;
    ...
    boolean z5 =
        (compilationReason == 0
            ...
            : true;
    boolean z6 =
        isProfileGuidedCompilerFilter && (sparseArray == null || !z2) && isAppImageEnabled();
    return adjustDexoptFlags(
        (z ? 4 : 0)
            | (z4 ? 2 : 0)
            | i2
            | (dexoptOptions.isBootComplete() ? 8 : 0)
            | (dexoptOptions.isDexoptIdleBackgroundJob() ? 512 : 0)
            | (z5 ? IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES : 0)
            | (z6 ? IInstalld.FLAG_USE_QUOTA : 0)
            | (dexoptOptions.isDexoptInstallForRestore() ? IInstalld.FLAG_FORCE : 0)
            | i3);
  }

  public final int getDexoptNeeded(
      String str,
      String str2,
      String str3,
      String str4,
    ...
    try {
      if (!z5 && z4 && z3) {
        if (isOdexPrivate(str, str2, str3, str6)) {
          ...
          return adjustDexoptNeeded(
              DexFile.getDexOptNeeded(
                  str2,
                  str3,
                  (compilerFilterDependsOnProfiles(str4) || i != 3) ? str4 : "verify",
                  str5,
                  z2,
                  z));
        }
      ...
      Slog.wtf(
          "PackageDexOptimizer", "Unexpected exception when calling dexoptNeeded on " + str2, e2);
      return -1;
    }
    z2 = z5;
  }
  ...
  public final String getPackageOatDirIfSupported(
      PackageState packageState, AndroidPackage androidPackage) {
  ...
  public class ForcedUpdatePackageDexOptimizer extends PackageDexOptimizer {
    ...
    public ForcedUpdatePackageDexOptimizer(
        Installer installer, Object obj, Context context, String str) {
