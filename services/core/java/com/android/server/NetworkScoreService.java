...
public class NetworkScoreService extends INetworkScoreService.Stub {
    ...
    public final void evaluateBinding(String str, boolean z) {
      if (this.mPackageToWatch.equals(str)) {
        ...
        if (NetworkScoreService.DBG) {
          Log.d(
              "NetworkScoreService",
              "Binding to " + activeScorer.getRecommendationServiceComponent() + " if needed.");
        }
  ...
  public NetworkScoreService(Context context) {
    this(
        context,
        new NetworkScorerAppManager(context),
  ...
  public NetworkScoreService(
    ...
    this.mUserIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.NetworkScoreService.1
    ...
    this.mLocationModeReceiver =
        new BroadcastReceiver() { // from class: com.android.server.NetworkScoreService.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    ContentObserver contentObserver =
        new ContentObserver(
            serviceHandler) { // from class: com.android.server.NetworkScoreService.3
          @Override // android.database.ContentObserver
          public void onChange(boolean z, Uri uri, int i) {
            if (Settings.Global.getUriFor("use_open_wifi_package").equals(uri)) {
              String string =
                  Settings.Global.getString(
                      NetworkScoreService.this.mContext.getContentResolver(),
              ...
              ((LegacyPermissionManagerInternal)
                  ...
                  .grantDefaultPermissionsToDefaultUseOpenWifiApp(string, i);
            }
          }
        };
    ...
    context
        ...
        .registerContentObserver(
            Settings.Global.getUriFor("use_open_wifi_package"), false, contentObserver);
    ((LegacyPermissionManagerInternal)
            LocalServices.getService(LegacyPermissionManagerInternal.class))
        .setUseOpenWifiAppPackagesProvider(
            new LegacyPermissionManagerInternal.PackagesProvider() { // from class:
              // com.android.server.NetworkScoreService$$ExternalSyntheticLambda0
  ...
  public /* synthetic */ String[] lambda$new$0(int i) {
    String string =
        Settings.Global.getString(this.mContext.getContentResolver(), "use_open_wifi_package");
    if (TextUtils.isEmpty(string)) {
      return null;
    }
  ...
  public final void registerRecommendationSettingsObserver() {
    this.mRecommendationSettingsObserver.observe(
        Settings.Global.getUriFor("network_recommendations_package"), 1);
    this.mRecommendationSettingsObserver.observe(
        Settings.Global.getUriFor("network_recommendations_enabled"), 2);
  }
    ...
    synchronized (this.mPackageMonitorLock) {
      if (this.mPackageMonitor != null
        ...
        if (z) {
          Log.d(
              "NetworkScoreService",
              "Unregistering package monitor for " + this.mPackageMonitor.mPackageToWatch);
        }
      ...
      if (activeScorer != null && this.mPackageMonitor == null) {
        NetworkScorerPackageMonitor networkScorerPackageMonitor =
            new NetworkScorerPackageMonitor(activeScorer.getRecommendationServicePackageName());
        ...
        if (z) {
          Log.d(
              "NetworkScoreService",
              "Registered package monitor for " + this.mPackageMonitor.mPackageToWatch);
        }
      }
    }
  }
      ...
      synchronized (this.mServiceConnectionLock) {
        ...
        if (this.mServiceConnection == null) {
          this.mServiceConnection =
              (ScoringServiceConnection) this.mServiceConnProducer.apply(networkScorerAppData);
        }
      ...
      if (scoringServiceConnection != null) {
        ...
        if (z) {
          Log.d(
              "NetworkScoreService",
              "Disconnected from: "
                  + this.mServiceConnection.getAppData().getRecommendationServiceComponent());
        }
      }
      ...
      while (true) {
        ...
        if (z) {
          ...
          sendCacheUpdateCallback(
              FilteringCacheUpdatingConsumer.create(
                  this.mContext, (List) entry.getValue(), ((Integer) entry.getKey()).intValue()),
  ...
  class FilteringCacheUpdatingConsumer implements BiConsumer {
    ...
    public void accept(INetworkScoreCache iNetworkScoreCache, Object obj) {
      try {
        List filterScores =
            filterScores(
                this.mScoredNetworkList, obj instanceof Integer ? ((Integer) obj).intValue() : 0);
      ...
      if (i == 1) {
        if (this.mCurrentNetworkFilter == null) {
          this.mCurrentNetworkFilter =
              new CurrentNetworkScoreCacheFilter(new WifiInfoSupplier(this.mContext));
        }
      ...
      if (i == 2) {
        if (this.mScanResultsFilter == null) {
          this.mScanResultsFilter =
              new ScanResultsScoreCacheFilter(new ScanResultsSupplier(this.mContext));
        }
  ...
  public final void enforceSystemOrHasScoreNetworks() {
    if (this.mContext.checkCallingOrSelfPermission("android.permission.REQUEST_NETWORK_SCORES") != 0
        && this.mContext.checkCallingOrSelfPermission("android.permission.SCORE_NETWORKS") != 0) {
  ...
  public final void clearInternal() {
    sendCacheUpdateCallback(
        new BiConsumer() { // from class: com.android.server.NetworkScoreService.4
          @Override // java.util.function.BiConsumer
          public void accept(INetworkScoreCache iNetworkScoreCache, Object obj) {
            try {
  ...
  public void registerNetworkScoreCache(int i, INetworkScoreCache iNetworkScoreCache, int i2) {
    ...
    try {
      synchronized (this.mScoreCaches) {
        RemoteCallbackList remoteCallbackList =
            (RemoteCallbackList) this.mScoreCaches.get(Integer.valueOf(i));
    ...
    while (it.hasNext()) {
      ...
      synchronized (remoteCallbackList) {
        ...
        for (int i = 0; i < beginBroadcast; i++) {
          try {
            biConsumer.accept(
                remoteCallbackList.getBroadcastItem(i), remoteCallbackList.getBroadcastCookie(i));
          } finally {
          }
        }
      }
  ...
  public class ScoringServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      if (NetworkScoreService.DBG) {
        Log.d(
            "NetworkScoreService", "ScoringServiceConnection: " + componentName.flattenToString());
      }
    ...
    public void onServiceDisconnected(ComponentName componentName) {
      if (NetworkScoreService.DBG) {
        Log.d(
            "NetworkScoreService",
            "ScoringServiceConnection, disconnected: " + componentName.flattenToString());
      }
      this.mConnected = false;
      this.mRecommendationProvider = null;
    }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      printWriter.println(
          "ScoringServiceConnection: "
              + this.mAppData.getRecommendationServiceComponent()
              + ", bound: "
              + this.mBound
              + ", connected: "
              + this.mConnected);
