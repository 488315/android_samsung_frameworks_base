...
public class SEAMService extends ISEAMS.Stub {
  ...
  public SEAMService(Context context) {
    ...
    new Thread("Service Keeper Thread") { // from class: com.android.server.SEAMService.1
      ...
      public void run() {
        SEAMService.this.mSKHandler.post(
            new Runnable() { // from class: com.android.server.SEAMService.1.1
              ...
              public void run() {
                ...
                if (SEAMSPolicy.DEBUG) {
                  SEAMService.mSKLog.logAll(
                      "SEAMService", "Service Keeper Initialized = " + authorizeLoadProcedure);
                }
              }
            });
      }
