...
public class TestHarnessModeService extends SystemService {
  ...
  public TestHarnessModeService(Context context) {
    super(context);
    this.mService =
        new Binder() { // from class: com.android.server.testharness.TestHarnessModeService.1
  ...
  public final byte[] getTestHarnessModeData() {
    ...
    if (persistentDataBlock == null) {
      Slog.e(
          TAG,
          "Failed to start Test Harness Mode; no implementation of"
      ...
      ((NotificationManager) getContext().getSystemService(NotificationManager.class))
          .notifyAsUser(
              ...
              new Notification.Builder(getContext(), SystemNotificationChannels.DEVELOPER)
                  ...
                  .setContentText(getContext().getString(17042990))
                  .setVisibility(1)
                  .build(),
              UserHandle.ALL);
    }
    ...
    public int onCommand(String str) {
      ...
      if (str.equals("enable") || str.equals("restore")) {
        ...
        try {
          if (isDeviceSecure()) {
            getErrPrintWriter()
                .println("Test Harness Mode cannot be enabled if there is a lock screen");
    ...
    public final void checkPermissions() {
      TestHarnessModeService.this
          ...
          .enforceCallingPermission(
              ...
              "You must hold android.permission.ENABLE_TEST_HARNESS_MODE to enable Test Harness"
                  + " Mode");
    }

    public final boolean isDeviceSecure() {
      return ((KeyguardManager)
              TestHarnessModeService.this.getContext().getSystemService(KeyguardManager.class))
          .isDeviceSecure(TestHarnessModeService.this.getMainUserId());
    }
