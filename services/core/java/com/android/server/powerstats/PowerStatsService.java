...
public class PowerStatsService extends SystemService {
  ...
  class Injector {
    ...
    public PowerStatsLogger createPowerStatsLogger(
        Context context,
        Looper looper,
        File file,
        String str,
      ...
      return new PowerStatsLogger(
          context, looper, file, str, str2, str3, str4, str5, str6, iPowerStatsHALWrapper);
    }
    ...
    public StatsPullAtomCallbackImpl createStatsPullerImpl(
        Context context, PowerStatsInternal powerStatsInternal) {
  ...
  public final class BinderService extends Binder {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          PowerStatsService.this.mContext, PowerStatsService.TAG, printWriter)) {
        ...
        if (strArr.length == 0) {
          ...
          ProtoStreamUtils.PowerEntityUtils.dumpsys(
              PowerStatsService.this.getPowerStatsHal().getPowerEntityInfo(), printWriter);
          printWriter.println("PowerStatsService dumpsys: available Channels");
          ProtoStreamUtils.ChannelUtils.dumpsys(
              PowerStatsService.this.getPowerStatsHal().getEnergyMeterInfo(), printWriter);
          printWriter.println("PowerStatsService dumpsys: available EnergyConsumers");
          ProtoStreamUtils.EnergyConsumerUtils.dumpsys(
              PowerStatsService.this.getPowerStatsHal().getEnergyConsumerInfo(), printWriter);
        }
      }
    }
  }
  ...
  public final void onSystemServicesReady() {
    this.mPullAtomCallback =
        this.mInjector.createStatsPullerImpl(this.mContext, this.mPowerStatsInternal);
  }
  ...
  public final void onBootCompleted() {
    if (getPowerStatsHal().isInitialized()) {
      ...
      PowerStatsLogger createPowerStatsLogger =
          this.mInjector.createPowerStatsLogger(
              this.mContext,
              getLooper(),
              this.mDataStoragePath,
              this.mInjector.createMeterFilename(),
              this.mInjector.createMeterCacheFilename(),
              this.mInjector.createModelFilename(),
              this.mInjector.createModelCacheFilename(),
              this.mInjector.createResidencyFilename(),
              this.mInjector.createResidencyCacheFilename(),
              getPowerStatsHal());
      this.mPowerStatsLogger = createPowerStatsLogger;
      this.mBatteryTrigger =
          this.mInjector.createBatteryTrigger(this.mContext, createPowerStatsLogger);
  ...
  public final class LocalService extends PowerStatsInternal {
      ...
      handler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // com.android.server.powerstats.PowerStatsService$LocalService$$ExternalSyntheticLambda0
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                  PowerStatsService.this.getEnergyConsumedAsync(
                      (CompletableFuture) obj, (int[]) obj2);
                }
              },
              completableFuture,
              iArr));
    ...
    public CompletableFuture getStateResidencyAsync(int[] iArr) {
      ...
      handler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // com.android.server.powerstats.PowerStatsService$LocalService$$ExternalSyntheticLambda1
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                  PowerStatsService.this.getStateResidencyAsync(
                      (CompletableFuture) obj, (int[]) obj2);
                }
              },
              completableFuture,
    ...
    public CompletableFuture readEnergyMeterAsync(int[] iArr) {
      ...
      handler.sendMessage(
          PooledLambda.obtainMessage(
              new BiConsumer() { // from class:
                                 // com.android.server.powerstats.PowerStatsService$LocalService$$ExternalSyntheticLambda2
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                  PowerStatsService.this.readEnergyMeterAsync(
                      (CompletableFuture) obj, (int[]) obj2);
                }
              },
              completableFuture,
