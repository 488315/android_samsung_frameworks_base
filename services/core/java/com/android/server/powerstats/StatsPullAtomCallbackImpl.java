      ...
      EnergyMeasurement[] energyMeasurementArr =
          (EnergyMeasurement[])
              this.mPowerStatsInternal
                  .readEnergyMeterAsync(new int[0])
        ...
        if (energyMeasurement.durationMs == energyMeasurement.timestampMs) {
          list.add(
              FrameworkStatsLog.buildStatsEvent(
                  i,
                  ((Channel) this.mChannels.get(Integer.valueOf(energyMeasurement.f7id))).subsystem,
                  ((Channel) this.mChannels.get(Integer.valueOf(energyMeasurement.f7id))).name,
