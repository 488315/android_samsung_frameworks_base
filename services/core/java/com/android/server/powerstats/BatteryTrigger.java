...
public final class BatteryTrigger extends PowerStatsLogTrigger {
  ...
  public BatteryTrigger(Context context, PowerStatsLogger powerStatsLogger, boolean z) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.powerstats.BatteryTrigger.1
    ...
    if (z) {
      Intent registerReceiver =
          this.mContext.registerReceiver(
              broadcastReceiver, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
