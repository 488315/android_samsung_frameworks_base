...
public final class TimerTrigger extends PowerStatsLogTrigger {
  ...
  public TimerTrigger(Context context, PowerStatsLogger powerStatsLogger, boolean z) {
    ...
    this.mLogDataLowFrequency =
        new Runnable() { // from class: com.android.server.powerstats.TimerTrigger.1
          @Override // java.lang.Runnable
          public void run() {
            TimerTrigger.this.mHandler.postDelayed(
                TimerTrigger.this.mLogDataLowFrequency,
                ClipboardService.DEFAULT_CLIPBOARD_TIMEOUT_MILLIS);
            TimerTrigger.this.logPowerStatsData(1);
          }
        };
    this.mLogDataHighFrequency =
        new Runnable() { // from class: com.android.server.powerstats.TimerTrigger.2
          @Override // java.lang.Runnable
          public void run() {
            TimerTrigger.this.mHandler.postDelayed(
                TimerTrigger.this.mLogDataHighFrequency, 120000L);
