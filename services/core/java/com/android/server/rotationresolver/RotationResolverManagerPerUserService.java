...
public final class RotationResolverManagerPerUserService extends AbstractPerUserSystemService {
  ...
  public RotationResolverManagerPerUserService(
      RotationResolverManagerService rotationResolverManagerService, Object obj, int i) {
  ...
  public void resolveRotationLocked(
    ...
    if (!isServiceAvailableLocked()) {
      ...
      RotationResolverManagerService.logRotationStats(
  ...
  public final void ensureRemoteServiceInitiated() {
    if (this.mRemoteService == null) {
      this.mRemoteService =
          new RemoteRotationResolverService(getContext(), this.mComponentName, getUserId(), 60000L);
    }
  }
  ...
  public ServiceInfo newServiceInfoLocked(ComponentName componentName) {
    try {
      ...
      if (serviceInfo != null
          && !"android.permission.BIND_ROTATION_RESOLVER_SERVICE".equals(serviceInfo.permission)) {
