...
class RemoteRotationResolverService extends ServiceConnector.Impl {
    ...
    final class RotationRequest {
        ...
        public final RotationResolverCallback mIRotationResolverCallback =
        ...
        public final class RotationResolverCallback extends IRotationResolverCallback.Stub {
            ...
            public final void onCancellable(ICancellationSignal iCancellationSignal) {
                RotationRequest rotationRequest =
                        (RotationRequest) this.mRequestWeakReference.get();
                    ...
                    if (rotationRequest.mCancellationSignalInternal.isCanceled()) {
                        try {
                            ...
                            Slog.w(
                                    ...
                                    "Failed to cancel the remote request.");
                        }
                    }
                }
            }
        ...
        public RotationRequest(
                RotationResolverManagerPerUserService.AnonymousClass1 anonymousClass1,
        ...
        public final void cancelInternal() {
            Handler.getMain()
                    .post(new RemoteRotationResolverService$$ExternalSyntheticLambda1(this, 1));
    ...
    public RemoteRotationResolverService(Context context, ComponentName componentName, int i) {
        super(
                ...
                67112960,
                i,
                new RemoteRotationResolverService$$ExternalSyntheticLambda2());
        ...
        post(
                new ServiceConnector
                    ...
                    public final void runNoResult(Object obj) {
                        RemoteRotationResolverService.RotationRequest rotationRequest2 =
                                RemoteRotationResolverService.RotationRequest.this;
                        RotationResolutionRequest rotationResolutionRequest2 =
                                rotationResolutionRequest;
                        int i = RemoteRotationResolverService.$r8$clinit;
                        ((IRotationResolverService) obj)
                                .resolveRotation(
                                        rotationRequest2.mIRotationResolverCallback,
                                        rotationResolutionRequest2);
                    }
                });
        getJobHandler()
                .postDelayed(
                        new RemoteRotationResolverService$$ExternalSyntheticLambda1(
                                rotationRequest, 0),
