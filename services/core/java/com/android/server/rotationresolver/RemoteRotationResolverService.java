...
class RemoteRotationResolverService extends ServiceConnector.Impl {
  ...
  public RemoteRotationResolverService(
      Context context, ComponentName componentName, int i, long j) {
    super(
        context,
        new Intent("android.service.rotationresolver.RotationResolverService")
            .setComponent(componentName),
        67112960,
        i,
        new Function() { // from class:
                         // com.android.server.rotationresolver.RemoteRotationResolverService$$ExternalSyntheticLambda2
  ...
  public void resolveRotation(final RotationRequest rotationRequest) {
    ...
    post(
        new ServiceConnector
            .VoidJob() { // from class:
                         // com.android.server.rotationresolver.RemoteRotationResolverService$$ExternalSyntheticLambda0
          public final void runNoResult(Object obj) {
            RemoteRotationResolverService.lambda$resolveRotation$0(
                RemoteRotationResolverService.RotationRequest.this,
                rotationResolutionRequest,
                (IRotationResolverService) obj);
          }
        });
    getJobHandler()
        .postDelayed(
            new Runnable() { // from class:
                             // com.android.server.rotationresolver.RemoteRotationResolverService$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
                RemoteRotationResolverService.lambda$resolveRotation$1(
                    RemoteRotationResolverService.RotationRequest.this);
              }
            },
  ...
  public static /* synthetic */ void lambda$resolveRotation$0(
      RotationRequest rotationRequest,
      RotationResolutionRequest rotationResolutionRequest,
      IRotationResolverService iRotationResolverService) {
    iRotationResolverService.resolveRotation(
        rotationRequest.mIRotationResolverCallback, rotationResolutionRequest);
  }
  ...
  final class RotationRequest {
    ...
    public final IRotationResolverCallback mIRotationResolverCallback =
    ...
    public RotationRequest(
        RotationResolverInternal.RotationResolverCallbackInternal rotationResolverCallbackInternal,
        RotationResolutionRequest rotationResolutionRequest,
    ...
    public void cancelInternal() {
      Handler.getMain()
          .post(
              new Runnable() { // from class:
                               // com.android.server.rotationresolver.RemoteRotationResolverService$RotationRequest$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public class RotationResolverCallback extends IRotationResolverCallback.Stub {
      ...
      public void onSuccess(int i) {
        ...
        synchronized (rotationRequest.mLock) {
          if (rotationRequest.mIsFulfilled) {
            Slog.w(
                RemoteRotationResolverService.TAG,
                "Callback received after the rotation request is fulfilled.");
            return;
          }
          rotationRequest.mIsFulfilled = true;
          rotationRequest.mCallbackInternal.onSuccess(i);
          long elapsedRealtime =
              SystemClock.elapsedRealtime() - rotationRequest.mRequestStartTimeMillis;
          RotationResolverManagerService.logRotationStatsWithTimeToCalculate(
              rotationRequest.mRemoteRequest.getProposedRotation(),
              rotationRequest.mRemoteRequest.getCurrentRotation(),
      ...
      public void onFailure(int i) {
        ...
        synchronized (rotationRequest.mLock) {
          ...
          RotationResolverManagerService.logRotationStatsWithTimeToCalculate(
              rotationRequest.mRemoteRequest.getProposedRotation(),
              rotationRequest.mRemoteRequest.getCurrentRotation(),
              RotationResolverManagerService.errorCodeToProto(i),
              elapsedRealtime);
