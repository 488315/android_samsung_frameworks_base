...
public class RotationResolverManagerService extends AbstractMasterSystemService {
  ...
  public RotationResolverManagerService(Context context) {
    super(context, new FrameworkResourcesServiceNameResolver(context, R.string.day), null, 68);
  ...
  public void onServiceRemoved(
      RotationResolverManagerPerUserService rotationResolverManagerPerUserService, int i) {
  ...
  public ComponentName getComponentNameShellCommand(int i) {
    synchronized (this.mLock) {
      RotationResolverManagerPerUserService rotationResolverManagerPerUserService =
          (RotationResolverManagerPerUserService) getServiceForUserLocked(i);
  ...
  public void resolveRotationShellCommand(
      int i,
    ...
    synchronized (this.mLock) {
      RotationResolverManagerPerUserService rotationResolverManagerPerUserService =
          (RotationResolverManagerPerUserService) getServiceForUserLocked(i);
      if (rotationResolverManagerPerUserService != null) {
        rotationResolverManagerPerUserService.resolveRotationLocked(
            rotationResolverCallbackInternal, rotationResolutionRequest, new CancellationSignal());
      } else {
    ...
    public void resolveRotation(
      ...
      synchronized (RotationResolverManagerService.this.mLock) {
        ...
        if (rotationResolverManagerService.mIsServiceEnabled && z) {
          ...
          rotationResolverManagerPerUserService.resolveRotationLocked(
              rotationResolverCallbackInternal, rotationResolutionRequest, cancellationSignal);
        } else {
          if (z) {
  ...
  public final class BinderService extends Binder {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          ...
          RotationResolverManagerService.TAG,
          printWriter)) {
        synchronized (RotationResolverManagerService.this.mLock) {
    ...
    public void onShellCommand(
      ...
      RotationResolverManagerService.this.mContext.enforceCallingOrSelfPermission(
          "android.permission.MANAGE_ROTATION_RESOLVER", RotationResolverManagerService.TAG);
  ...
  public static void logRotationStatsWithTimeToCalculate(int i, int i2, int i3, long j) {
    FrameworkStatsLog.write(
        FrameworkStatsLog.AUTO_ROTATE_REPORTED,
        surfaceRotationToProto(i2),
        surfaceRotationToProto(i),
        i3,
        j);
  }
