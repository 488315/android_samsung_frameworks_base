...
public class MetricsHelper {
        ...
        .setPullAtomCallback(
            ...
            new StatsManager
                .StatsPullAtomCallback() { // from class:
                                           // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda0
              public final int onPullAtom(int i, List list) {
                int lambda$registerPuller$12;
                lambda$registerPuller$12 =
                    MetricsHelper.this.lambda$registerPuller$12(supplier, i, list);
          ...
          FrameworkStatsLog.buildStatsEvent(
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda1
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda4
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean z;
                      z = ((Alarm) obj).wakeup;
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda5
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda6
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda7
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda8
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda9
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda10
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda11
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$registerPuller$8;
                      lambda$registerPuller$8 =
                          MetricsHelper.lambda$registerPuller$8(elapsedRealtime, (Alarm) obj);
                      return lambda$registerPuller$8;
                    }
                  }),
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda12
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
              ...
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$registerPuller$10;
                      lambda$registerPuller$10 =
                          MetricsHelper.lambda$registerPuller$10((Alarm) obj);
                      return lambda$registerPuller$10;
                    }
                  }),
              alarmStore.getCount(
                  new Predicate() { // from class:
                                    // com.android.server.alarm.MetricsHelper$$ExternalSyntheticLambda3
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$registerPuller$11;
                      lambda$registerPuller$11 =
                          MetricsHelper.lambda$registerPuller$11((Alarm) obj);
  ...
  public static void pushAlarmScheduled(Alarm alarm, int i) {
    FrameworkStatsLog.write(
        ...
        reasonToStatsReason(alarm.mExactAllowReason),
        AlarmManagerService.isRtc(alarm.type),
        ActivityManager.processStateAmToProto(i));
  }
