...
public class AlarmManagerService extends SystemService {
    ...
    final class Constants implements DeviceConfig.OnPropertiesChangedListener, EconomyManagerInternal.TareStateChangeListener {
        ...
        public void updateAllowWhileIdleWhitelistDurationLocked() {
            ...
            if (j != j2) {
                ...
                AlarmManagerService.this.mOptsWithFgs.setTemporaryAppAllowlist(j2, 0, FrameworkStatsLog.f63x1c64b730, "");
    ...
    public class IAlarmListenerStubC04663 extends IAlarmListener.Stub {
        ...
        public void doAlarm(final IAlarmCompleteListener iAlarmCompleteListener) {
            AlarmManagerService.this.mHandler.post(new Runnable() { // from class: com.android.server.alarm.AlarmManagerService$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AlarmManagerService.IAlarmListenerStubC04663.this.lambda$doAlarm$0(iAlarmCompleteListener);
                }
            });
            synchronized (AlarmManagerService.this.mLock) {
            ...
            try {
                if (pendingIntent != null) {
                    try {
                        ...
                        i5 = i6;
                        alarm = new Alarm(i5, j, j2, j3, j4, pendingIntent, iAlarmListener, str, workSource, i2, alarmClockInfo, i3, str2, bundle, i4);
                        if (alarm.type != i) {
                        }
                ...
                String action = (pendingIntent == null || pendingIntent.getIntent() == null || pendingIntent.getIntent().getAction() == null) ? null : pendingIntent.getIntent().getAction();
                    ...
                    if (isAlarmWakeupBlockList(creatorUid, creatorPackage, action, i2)) {
                        ...
                        try {
                            ...
                            if (MARsComponentTracker.getInstance().getEnabled()) {
                                if (workSource == null) {
                                    MARsComponentTracker.getInstance().sendCTInfo(-1, -1, -1, str2, creatorPackage, "alarm", action, System.currentTimeMillis(), null);
                                } else {
                                    MARsComponentTracker.getInstance().sendCTInfo(-1, -1, -1, str2, creatorPackage, "job", workSource.toString(), System.currentTimeMillis(), null);
                                }
                            }
        ...
        public void set(String str, int i, long j, long j2, long j3, int i2, PendingIntent pendingIntent, IAlarmListener iAlarmListener, String str2, WorkSource workSource, AlarmManager.AlarmClockInfo alarmClockInfo) {
            ...
            if (AlarmManagerService.this.mAppSync != null) {
                ...
                if (AlarmManagerService.this.mAppSync.isAdjustableAlarm(i, j, j2, j3, callingUid, str)) {
                    ...
                    Slog.d("AppSyncInfo", "Sync window " + j2 + " --->> " + j5 + " for alarm by <" + i4 + ", " + str + ">.");
                    if (i4 == AlarmManagerService.this.mPackageManagerInternal.getPackageUid(str, 0L, i3)) {
                        throw new SecurityException("Package " + str + " does not belong to the calling uid " + i4);
                    }
                    if (j3 != 0 && iAlarmListener != null) {
                        throw new IllegalArgumentException("Repeating alarms cannot use AlarmReceivers");
                    }
                    if (workSource != null) {
                        AlarmManagerService.this.getContext().enforcePermission("android.permission.UPDATE_DEVICE_STATS", Binder.getCallingPid(), i4, "AlarmManager.set");
                    }
                    if ((i2 & 16) == 0) {
                        j6 = j5;
                        i5 = i2;
                    ...
                    if ((i5 & 16) == 0 && alarmClockInfo == null && j6 == 0 && (i == 2 || i == 0)) {
                        ...
                        if (pendingIntent != null) {
                            long clearCallingIdentity = Binder.clearCallingIdentity();
                            try {
                                str3 = pendingIntent.getIntent() != null ? pendingIntent.getIntent().getAction() : null;
                            } catch (Exception e) {
                            ...
                            if (MARsPolicyManager.getInstance().isAlarmForceSetWindow(creatorPackage, str3)) {
                                ...
                                j7 = j;
                                j8 = j6;
                                long j11 = (AlarmManagerService.this.convertToElapsed(j7, i) - AlarmManagerService.this.mInjector.getElapsedRealtimeMillis()) / 2;
                                if (j11 > 0) {
                                    long j12 = j7 - j11;
                                    Slog.d("AlarmManager", "force change alarm method to setWindow() callingUid=" + i4 + ", sourcePackage=" + str4 + ", action=" + str3 + ", origTriggerAtTime=" + j7 + ", triggerAtTime=" + j12 + ", windowLength=" + j11);
                                    j9 = j12;
                                    i6 = i5 & (-43);
                                    if (alarmClockInfo != null) {
                                        ...
                                        if (workSource == null && (UserHandle.isCore(i4) || UserHandle.isSameApp(i4, AlarmManagerService.this.mSystemUiUid) || (AlarmManagerService.this.mAppStateTracker != null && AlarmManagerService.this.mAppStateTracker.isUidPowerSaveUserExempt(i4)))) {
                                            i6 = (i6 | 8) & (-69);
                                        }
                                        j10 = j11;
                                    }
                                    ...
                                    int i9 = -1;
                                    if ((i6 & 64) != 0) {
                                        AlarmManagerService.this.getContext().enforcePermission("android.permission.SCHEDULE_PRIORITIZED_ALARM", Binder.getCallingPid(), i4, "AlarmManager.setPrioritized");
                                        i6 &= -5;
                                        if (z) {
                                            i8 = 5;
                                            bundle3 = null;
                                            ...
                                            AlarmManagerService.this.setImpl(i, j9, j10, j3, pendingIntent, iAlarmListener, str2, i6, workSource, alarmClockInfo, i4, str, bundle3, i8);
                                            return;
                                        }
                                    } else if (z || z4) {
                                        if (AlarmManagerService.isExactAlarmChangeEnabled(str, i3)) {
                                            ...
                                            bundle = z ? alarmClockInfo != null ? AlarmManagerService.this.mOptsWithFgsForAlarmClock.toBundle() : AlarmManagerService.this.mOptsWithFgs.toBundle() : AlarmManagerService.this.mOptsWithoutFgs.toBundle();
                                        } else {
                                            bundle = (z4 || alarmClockInfo != null) ? AlarmManagerService.this.mOptsWithFgs.toBundle() : null;
                                            z2 = z4;
                                            z3 = false;
                                            if (z) {
                                                i9 = 2;
            ...
            synchronized (AlarmManagerService.this.mLock) {
                AlarmManagerService.this.removeAlarmsInternalLocked(new Predicate() { // from class: com.android.server.alarm.AlarmManagerService$5$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        ...
                        lambda$removeAll$0 = AlarmManagerService.IAlarmManagerStubC04685.lambda$removeAll$0(str, callingUid, (Alarm) obj);
        ...
        */
        public void run() {
            ...
            while (true) {
                ...
                ExpiredRecord expiredRecord = new ExpiredRecord(waitForAlarm, j4, j5, currentTimeMillis, elapsedRealtimeMillis, alarmManagerService.mLastTimeChangeClockTime, alarmManagerService.mLastTimeChangeRealtime);
                ...
                if ((waitForAlarm & 65536) != 0) {
                    ...
                    if (j2 == 0 || j < j3 - 1000 || j > j3 + 1000) {
                        ...
                        alarmManagerService6.mOptsTimeBroadcast.setTemporaryAppAllowlist(alarmManagerService6.mActivityManagerInternal.getBootTimeTempAllowListDuration(), 0, 205, "");
                            ...
                            synchronized (AlarmManagerService.this.mLock) {
                                ...
                                if (triggerAlarmsLocked == 0 && AlarmManagerService.this.checkAllowNonWakeupDelayLocked(elapsedRealtimeMillis)) {
                                    if (AlarmManagerService.this.mPendingNonWakeupAlarms.size() == 0) {
                                        ...
                                        alarmManagerService7.mNextNonWakeupDeliveryTime = elapsedRealtimeMillis + ((alarmManagerService7.currentNonWakeupFuzzLocked(elapsedRealtimeMillis) * 3) / 2);
                                    }
                                    ...
                                    if (AlarmManagerService.this.mPendingNonWakeupAlarms.size() > 0) {
                                        ...
                                        alarmManagerService8.calculateDeliveryPriorities(alarmManagerService8.mPendingNonWakeupAlarms);
                                    ...
                                    if (AlarmManagerService.this.mLastTimeChangeRealtime != elapsedRealtimeMillis && arrayList.isEmpty()) {
                                        ...
                                        if (i2 >= alarmThread.mWtfThreshold) {
                                            Slog.wtf("AlarmManager", "Too many (" + alarmThread.mFalseWakeups + ") false wakeups, nowElapsed=" + elapsedRealtimeMillis);
                        ...
                        if (stringArrayExtra != null && stringArrayExtra.length > 0) {
                            for (String str2 : stringArrayExtra) {
                                ...
                                for (int size = AlarmManagerService.this.mBroadcastStats.size() - 1; size >= 0; size--) {
                                    ArrayMap arrayMap = (ArrayMap) AlarmManagerService.this.mBroadcastStats.valueAt(size);
            ...
            synchronized (AlarmManagerService.this.mLock) {
                if (AlarmManagerService.this.mAlarmStore.updateAlarmDeliveries(new AlarmStore.AlarmDeliveryCalculator() { // from class: com.android.server.alarm.AlarmManagerService$9$$ExternalSyntheticLambda0
                    ...
                    public final boolean updateAlarmDelivery(Alarm alarm) {
                        ...
                        lambda$updateAllAlarms$0 = AlarmManagerService.C04729.this.lambda$updateAllAlarms$0(alarm);
            ...
            synchronized (AlarmManagerService.this.mLock) {
                if (AlarmManagerService.this.mAlarmStore.updateAlarmDeliveries(new AlarmStore.AlarmDeliveryCalculator() { // from class: com.android.server.alarm.AlarmManagerService$9$$ExternalSyntheticLambda1
                    ...
                    public final boolean updateAlarmDelivery(Alarm alarm) {
                        ...
                        lambda$updateAlarmsForUid$1 = AlarmManagerService.C04729.this.lambda$updateAlarmsForUid$1(i, alarm);
