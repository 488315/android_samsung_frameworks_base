...
public abstract class EventLogTags {
  ...
  public static void writeBatterySaverMode(
      int i, int i2, int i3, int i4, int i5, String str, int i6) {
    EventLog.writeEvent(
        2739,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeBatterySavingStats(
      int i, int i2, int i3, long j, int i4, int i5, long j2, int i6, int i7) {
    EventLog.writeEvent(
        27390,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeStorageState(String str, int i, int i2, long j, long j2) {
    EventLog.writeEvent(
        2749, str, Integer.valueOf(i), Integer.valueOf(i2), Long.valueOf(j), Long.valueOf(j2));
  }

  public static void writeNotificationEnqueue(
      int i, int i2, String str, int i3, String str2, int i4, String str3, int i5, String str4) {
    EventLog.writeEvent(
        2750,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeNotificationCancel(
      int i, int i2, String str, int i3, String str2, int i4, int i5, int i6, int i7, String str3) {
    EventLog.writeEvent(
        2751,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeNotificationCancelAll(
      int i, int i2, String str, int i3, int i4, int i5, int i6, String str2) {
    EventLog.writeEvent(
        2752,
        Integer.valueOf(i),
        Integer.valueOf(i2),
  ...
  public static void writeNotificationActionClicked(
  ...
  public static void writeNotificationCanceled(
      String str, int i, int i2, int i3, int i4, int i5, int i6, String str2) {
    EventLog.writeEvent(
        27530,
        str,
        Integer.valueOf(i),
  ...
  public static void writeNotificationVisibility(
      String str, int i, int i2, int i3, int i4, int i5) {
    EventLog.writeEvent(
        27531,
        str,
        Integer.valueOf(i),
  ...
  public static void writeIfwIntentMatched(
      int i,
      String str,
      int i2,
      int i3,
  ...
  public static void writeCameraGestureTriggered(long j, long j2, long j3, int i) {
    EventLog.writeEvent(
        40100, Long.valueOf(j), Long.valueOf(j2), Long.valueOf(j3), Integer.valueOf(i));
  }
