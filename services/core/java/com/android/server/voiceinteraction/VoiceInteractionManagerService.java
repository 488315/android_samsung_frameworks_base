...
public final class VoiceInteractionManagerService extends SystemService {
    ...
    public final class LocalService extends VoiceInteractionManagerInternal {
        ...
        public final VoiceInteractionManagerInternal.HotwordDetectionServiceIdentity
        ...
        public final String getVoiceInteractorPackageName(IBinder iBinder) {
            ...
            if (voiceInteractionManagerServiceImpl == null
                    || (voiceInteractionSessionConnection =
                                    voiceInteractionManagerServiceImpl.mActiveSession)
                            == null
        ...
        */
        public final void startListeningFromWearable(
                ...
                android.service.voice.VoiceInteractionManagerInternal
                                .WearableHotwordDetectionCallback
                        r13) {
            /*
                r7 = this;
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.voiceinteraction.VoiceInteractionManagerService.LocalService.startListeningFromWearable(android.os.ParcelFileDescriptor,"
                        + " android.media.AudioFormat, android.os.PersistableBundle,"
                        + " android.content.ComponentName, int,"
                        + " android.service.voice.VoiceInteractionManagerInternal$WearableHotwordDetectionCallback):void");
        }

        public final void startLocalVoiceInteraction(
                final IBinder iBinder, String str, Bundle bundle) {
            final VoiceInteractionManagerServiceStub voiceInteractionManagerServiceStub =
            ...
            try {
                LatencyTracker.getInstance(VoiceInteractionManagerService.this.mContext)
                        .onActionCancel(19);
                voiceInteractionManagerServiceStub.mImpl.showSessionLocked(
                        bundle,
                        16,
                        str,
                        new IVoiceInteractionSessionShowCallback
                            ...
                            public final void onShown() {
                                    ...
                                    try {
                                        if (voiceInteractionManagerServiceStub.mImpl != null) {
                                            voiceInteractionManagerServiceStub.mImpl
                                                    .grantImplicitAccessLocked(callingUid, null);
                                        }
                                    } catch (Throwable th) {
                                        throw th;
                                    }
                                ...
                                VoiceInteractionManagerServiceStub
                                        voiceInteractionManagerServiceStub2 =
                                                voiceInteractionManagerServiceStub;
                                ActivityTaskManagerInternal activityTaskManagerInternal =
                                        VoiceInteractionManagerService.this.mAtmInternal;
                                ...
                                synchronized (windowManagerGlobalLock) {
                                    try {
                                        ActivityTaskManagerService
                                                .m1053$$Nest$monLocalVoiceInteractionStartedLocked(
    ...
    public final class VoiceInteractionManagerServiceStub
        ...
        public final AnonymousClass2 mPackageMonitor =
                new PackageMonitor() { // from class:
                    ...
                    public final boolean onHandleForceStop(
                            Intent intent, String[] strArr, int i, boolean z) {
                        boolean z2;
                        boolean z3;
                        ...
                        while (true) {
                            ...
                            if (curInteractor != null
                                    && str.equals(curInteractor.getPackageName())) {
                                z3 = false;
                                z2 = true;
                                break;
                            }
                            if (curRecognizer != null
                                    && str.equals(curRecognizer.getPackageName())) {
                                z2 = false;
                                z3 = true;
                                break;
                            }
                                    ...
                                    Slog.i(
                                            ...
                                            "Force stopping current voice interactor: "
                                                    + VoiceInteractionManagerServiceStub.this
                                                            .getCurInteractor(userId));
                                    VoiceInteractionManagerServiceStub.this
                                            .unloadAllKeyphraseModels();
                                    if (VoiceInteractionManagerServiceStub.this.mImpl != null) {
                                        VoiceInteractionManagerServiceStub.this.mImpl
                                                .shutdownLocked();
                    ...
                    public final void onPackageModified(String str) {
                        ...
                        if (VoiceInteractionManagerServiceStub.this.mCurUser == getChangingUserId()
                            ...
                            VoiceInteractionManagerServiceStub voiceInteractionManagerServiceStub2 =
                                    VoiceInteractionManagerServiceStub.this;
                            if (voiceInteractionManagerServiceStub2.getCurRecognizer(
                            ...
                            if (curInteractor == null && !"".equals(stringForUser)) {
                                VoiceInteractionManagerServiceStub
                                        voiceInteractionManagerServiceStub4 =
                                                VoiceInteractionManagerServiceStub.this;
                                ...
                                if (findAvailInteractor != null) {
                                    ComponentName componentName =
                                            new ComponentName(
                                                    findAvailInteractor.getServiceInfo()
                                                            .packageName,
                                                    findAvailInteractor.getServiceInfo().name);
                                    VoiceInteractionManagerServiceStub
                                            voiceInteractionManagerServiceStub5 =
                                                    VoiceInteractionManagerServiceStub.this;
                                    voiceInteractionManagerServiceStub5.setCurInteractor(
                                            voiceInteractionManagerServiceStub5.mCurUser,
                                            componentName);
                                    return;
                                }
                                return;
                            ...
                            if (didSomePackagesChange()) {
                                ...
                                VoiceInteractionManagerServiceStub
                                        voiceInteractionManagerServiceStub6 =
                                                VoiceInteractionManagerServiceStub.this;
                            ...
                            VoiceInteractionManagerServiceStub voiceInteractionManagerServiceStub7 =
                                    VoiceInteractionManagerServiceStub.this;
                            synchronized (voiceInteractionManagerServiceStub7) {
                                voiceInteractionManagerServiceStub7
                                        .switchImplementationIfNeededLocked(true);
                            }
                        }
                    }
                    ...
                    public final void onSomePackagesChanged() {
                        ...
                        synchronized (VoiceInteractionManagerServiceStub.this) {
                            try {
                                ComponentName curInteractor =
                                        VoiceInteractionManagerServiceStub.this.getCurInteractor(
                                                changingUserId);
                                ComponentName curRecognizer =
                                        VoiceInteractionManagerServiceStub.this.getCurRecognizer(
                                                changingUserId);
                                String stringForUser =
                                        Settings.Secure.getStringForUser(
                                                VoiceInteractionManagerService.this.mContext
                                ...
                                if (curRecognizer == null
                                        ...
                                        && (findAvailRecognizer =
                                                ...
                                                != null) {
                                    voiceInteractionManagerServiceStub.setCurRecognizer(
                                            changingUserId, findAvailRecognizer);
                                }
                                if (curInteractor != null) {
                                    if (isPackageDisappearing(curInteractor.getPackageName())
                                            == 3) {
                                        VoiceInteractionManagerServiceStub.this.setCurInteractor(
                                                changingUserId, null);
                                        VoiceInteractionManagerServiceStub.this.setCurRecognizer(
                                                changingUserId, null);
                                        Settings.Secure.putStringForUser(
                                                ...
                                                null,
                                                changingUserId);
                                        VoiceInteractionManagerServiceStub.this.initForUser(
                                                changingUserId);
                                        return;
                                    }
                                    if (isPackageAppearing(curInteractor.getPackageName()) != 0) {
                                        VoiceInteractionManagerServiceStub
                                                .m1034$$Nest$mresetServicesIfNoRecognitionService(
                                                        VoiceInteractionManagerServiceStub.this,
                                                        curInteractor,
                                                        changingUserId);
                                        if (VoiceInteractionManagerServiceStub.this.mImpl != null
                                ...
                                if (unflattenFromString != null) {
                                    if (isPackageDisappearing(unflattenFromString.getPackageName())
                                            == 3) {
                                        VoiceInteractionManagerServiceStub.this.setCurInteractor(
                                                changingUserId, null);
                                        VoiceInteractionManagerServiceStub.this.setCurRecognizer(
                                    ...
                                    if (isPackageAppearing(unflattenFromString.getPackageName())
                                            != 0) {
                                        VoiceInteractionManagerServiceStub
                                                .m1034$$Nest$mresetServicesIfNoRecognitionService(
                                                        VoiceInteractionManagerServiceStub.this,
                                ...
                                if (curRecognizer != null) {
                                    int isPackageDisappearing =
                                            isPackageDisappearing(curRecognizer.getPackageName());
                                    ...
                                    VoiceInteractionManagerServiceStub
                                            voiceInteractionManagerServiceStub3 =
                                                    VoiceInteractionManagerServiceStub.this;
                                    voiceInteractionManagerServiceStub3.setCurRecognizer(
                                            changingUserId,
                                            voiceInteractionManagerServiceStub3.findAvailRecognizer(
                                                    changingUserId, null));
                                }
                            } finally {
                            }
        ...
        public final class RoleObserver implements OnRoleHoldersChangedListener {
            ...
            public RoleObserver(Executor executor) {
                ...
                RoleManager roleManager =
                        (RoleManager)
                                VoiceInteractionManagerService.this.mContext.getSystemService(
                                        RoleManager.class);
            ...
            public final void onRoleHoldersChanged(String str, UserHandle userHandle) {
                ...
                if (str.equals("android.app.role.ASSISTANT")) {
                    ...
                    if (roleHoldersAsUser.isEmpty()
                            && (userInfo =
                                            VoiceInteractionManagerService.this.mUserManagerInternal
                                                    .getUserInfo(userHandle.getIdentifier()))
                                    != null
                            && userInfo.preCreated) {
                        Slogf.d(
                                "VoiceInteractionManager",
                                "onRoleHoldersChanged(): ignoring pre-created user %s for now, this"
                                    + " method will be called again when it's converted to a real"
                                    + " user",
                    ...
                    while (it.hasNext()) {
                        ...
                        if (voiceInteractionServiceInfo.getSupportsAssist()) {
                            ...
                            if (voiceInteractionServiceInfo.getRecognitionService() == null) {
                                Slog.e(
                                        "VoiceInteractionManager",
                                        "The RecognitionService must be set to avoid boot loop on"
                                            + " earlier platform version. Also make sure that this"
                                            + " is a valid RecognitionService when running on"
        ...
        public final class SettingsObserver extends ContentObserver {
            public SettingsObserver(Handler handler) {
                ...
                VoiceInteractionManagerService.this
                        ...
                        .registerContentObserver(
                                Settings.Secure.getUriFor("voice_interaction_service"),
                                false,
                                this,
                                -1);
            }
            ...
            public final void onChange(boolean z) {
                synchronized (VoiceInteractionManagerServiceStub.this) {
                    VoiceInteractionManagerServiceStub.this.switchImplementationIfNeededLocked(
                            false);
                }
            }
        }
        ...
        public final class SoundTriggerSession extends IVoiceInteractionSoundTriggerSession.Stub {
            ...
            public static int m1035$$Nest$munloadKeyphraseModel(
                    SoundTriggerSession soundTriggerSession, int i) {
                soundTriggerSession.getClass();
                long clearCallingIdentity = Binder.clearCallingIdentity();
                try {
                    SoundTriggerService.LocalSoundTriggerService.SessionImpl sessionImpl =
                            soundTriggerSession.mSession;
                    sessionImpl.mEventLogger.enqueue(
                            new SoundTriggerEvent$ServiceEvent(
                                    SoundTriggerEvent$SessionEvent$Type.UNLOAD_MODEL,
                                    (UUID) sessionImpl.mModelUuid.get(i),
                                    (String) null));
                ...
                synchronized (VoiceInteractionManagerServiceStub.this) {
                    try {
                        ...
                        try {
                            ...
                            sessionImpl.mEventLogger.enqueue(
                                    new SoundTriggerEvent$ServiceEvent(
                                            SoundTriggerEvent$SessionEvent$Type
                                                    .GET_MODULE_PROPERTIES,
                                            (UUID) null,
                                            (String) null));
                            moduleProperties =
                                    sessionImpl.mSoundTriggerHelper.getModuleProperties();
                        } finally {
                            Binder.restoreCallingIdentity(clearCallingIdentity);
                        }
                    } catch (Throwable th) {
            ...
            public final int getParameter(int i, int i2) {
                ...
                try {
                    ...
                    synchronized (soundTriggerHelper.mLock) {
                        ...
                        parameterLocked =
                                soundTriggerHelper.getParameterLocked(
                                        soundTriggerHelper.getKeyphraseModelDataLocked(i), i2);
                    }
            ...
            public final SoundTrigger.ModelParamRange queryParameter(int i, int i2) {
                ...
                try {
                    ...
                    synchronized (soundTriggerHelper.mLock) {
                        ...
                        queryParameterLocked =
                                soundTriggerHelper.queryParameterLocked(
                                        soundTriggerHelper.getKeyphraseModelDataLocked(i), i2);
                    }
            ...
            public final int startRecognition(
                ...
                try {
                    ...
                    if (keyphraseSoundModel != null
                        ...
                        synchronized (VoiceInteractionManagerServiceStub.this) {
                            try {
                                VoiceInteractionManagerService.this.mLoadedKeyphraseIds.put(
                                        Integer.valueOf(i), this);
                                if (this.mSessionExternalCallback != null) {
                                    if (this.mSessionInternalCallback != null) {
                                        if (iHotwordRecognitionStatusCallback.asBinder()
                                ...
                                if (voiceInteractionManagerServiceStub.mImpl == null) {
                                    ...
                                    soundTriggerCallback =
                                            new HotwordDetectionConnection.SoundTriggerCallback(
                                                    context,
                    ...
                    Slog.w(
                            "VoiceInteractionManager",
                            "No matching sound model found in startRecognition");
                    Binder.restoreCallingIdentity(clearCallingIdentity);
            ...
            public final int stopRecognition(
                ...
                synchronized (VoiceInteractionManagerServiceStub.this) {
                    try {
                        ...
                        Slog.w(
                                "VoiceInteractionManager",
                                "stopRecognition() called with a different callback"
                                    + " thanstartRecognition()");
                        this.mSessionExternalCallback = null;
                        this.mSessionInternalCallback = null;
                    } catch (Throwable th) {
                        throw th;
                ...
                try {
                    ...
                    synchronized (sessionImpl) {
                        ...
                        stopKeyphraseRecognition =
                                sessionImpl.mSoundTriggerHelper.stopKeyphraseRecognition(
                                        i, soundTriggerCallback);
                    }
        ...
        public static void m1034$$Nest$mresetServicesIfNoRecognitionService(
                VoiceInteractionManagerServiceStub voiceInteractionManagerServiceStub,
                ComponentName componentName,
                int i) {
            ...
            Iterator it =
                    voiceInteractionManagerServiceStub
                            .queryInteractorServices(i, componentName.getPackageName())
                            .iterator();
            while (it.hasNext()) {
                VoiceInteractionServiceInfo voiceInteractionServiceInfo =
                ...
                if (voiceInteractionServiceInfo.getSupportsAssist()
                    ...
                    Slog.e(
                            "VoiceInteractionManager",
                            "The RecognitionService must be set to avoid boot loop on earlier"
                                + " platform version. Also make sure that this is a valid"
                                + " RecognitionService when running on Android 11 or earlier.");
        ...
        public VoiceInteractionManagerServiceStub() {
            ...
            Context context = VoiceInteractionManagerService.this.mContext;
            String string =
                    context.getResources().getString(R.string.duration_hours_shortest_future);
            this.mEnableService =
                    (TextUtils.isEmpty(string) ? null : string) != null
                            ? true
                            : context.getPackageManager()
                                    .hasSystemFeature("android.software.voice_recognizers");
            this.mRoleObserver =
                    new RoleObserver(
                            VoiceInteractionManagerService.this.mContext.getMainExecutor());
        }
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (voiceInteractionSessionConnection != null
                                    && iBinder == voiceInteractionSessionConnection.mToken) {
                                voiceInteractionManagerServiceImpl.mAm.closeSystemDialogs(
                                        "voiceinteraction");
                            }
                            Slog.w(
                                    "VoiceInteractionServiceManager",
                                    "closeSystemDialogs does not match active session");
        ...
        public final IVoiceInteractionSoundTriggerSession createSoundTriggerSessionAsOriginator(
                Identity identity,
                IBinder iBinder,
                SoundTrigger.ModuleProperties moduleProperties) {
            boolean z;
            ...
            synchronized (this) {
                try {
                    ...
                    z = true;
                    z2 =
                            (this.mImpl == null || this.mImpl.mHotwordDetectionConnection == null)
                                    ? false
                                    : true;
                } finally {
                }
            }
            SafeCloseable establishIdentityDirect =
                    PermissionUtil.establishIdentityDirect(identity);
            try {
        ...
        public final int deleteKeyphraseSoundModel(int i, String str) {
            ...
            try {
                SoundTriggerSession soundTriggerSession =
                        (SoundTriggerSession)
                                VoiceInteractionManagerService.this.mLoadedKeyphraseIds.get(
                                        Integer.valueOf(i));
                if (soundTriggerSession != null
                        && (m1035$$Nest$munloadKeyphraseModel =
                                        SoundTriggerSession.m1035$$Nest$munloadKeyphraseModel(
                                                soundTriggerSession, i))
                                != 0) {
                    Slog.w(
                            "VoiceInteractionManager",
                            "Unable to unload keyphrase sound model:"
                                    + m1035$$Nest$munloadKeyphraseModel);
                }
                ...
                if (deleteKeyphraseSoundModel) {
                    synchronized (this) {
                        try {
                            ...
                            VoiceInteractionManagerService.this.mLoadedKeyphraseIds.remove(
                                    Integer.valueOf(i));
                        } finally {
                        }
                    }
        ...
        public final boolean deliverNewSession(
                IBinder iBinder,
                IVoiceInteractionSession iVoiceInteractionSession,
                IVoiceInteractor iVoiceInteractor) {
                ...
                try {
                    if (this.mImpl == null) {
                        ...
                        Binder.withCleanCallingIdentity(
                                new VoiceInteractionManagerService$VoiceInteractionManagerServiceStub$$ExternalSyntheticLambda3(
                                        0, iBinder, this));
                    }
                } catch (Throwable th) {
                    throw th;
            ...
            synchronized (this) {
                try {
                    ...
                    if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection != null
                            && (visualQueryDetectorSessionLocked =
                                            voiceInteractionManagerServiceImpl
                                                    .mHotwordDetectionConnection
        ...
        public final void enableVisualQueryDetection(
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "enableVisualQueryDetection without running voice interaction"
                                    + " service");
                        return;
                    }
                    VoiceInteractionManagerServiceImpl voiceInteractionManagerServiceImpl =
                    ...
                    if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection != null
                            && (visualQueryDetectorSessionLocked =
                                            voiceInteractionManagerServiceImpl
                                                    ...
                                                    .getVisualQueryDetectorSessionLocked())
                                    != null) {
                        visualQueryDetectorSessionLocked.mAttentionListener =
        ...
        public final void enforceCallerAllowedToEnrollVoiceModel() {
            if (VoiceInteractionManagerService.this.mContext.checkCallingOrSelfPermission(
        ...
        public final void enforceCallingPermission(String str) {
            if (VoiceInteractionManagerService.this.mContext.checkCallingOrSelfPermission(str)
                    != 0) {
        ...
        public final void enforceIsCurrentVoiceInteractionService() {
            if (this.mImpl == null
                    || this.mImpl.mInfo.getServiceInfo().applicationInfo.uid
        ...
        public final VoiceInteractionServiceInfo findAvailInteractor(int i, String str) {
            ...
            if (size == 0) {
                DeviceIdleController$$ExternalSyntheticOutline0.m(
                        i,
                        "no available voice interaction services found for user ",
                        "VoiceInteractionManager");
                return null;
            }
            for (int i2 = 0; i2 < size; i2++) {
                ServiceInfo serviceInfo =
                        ((ResolveInfo) queryInteractorServices.get(i2)).serviceInfo;
                    ...
                    if (voiceInteractionServiceInfo2.getParseError() != null) {
                        ...
                        Slog.w(
                                ...
                                "More than one voice interaction service, picking first "
                                        + new ComponentName(
                                                voiceInteractionServiceInfo.getServiceInfo()
                                                        .packageName,
        ...
        public final ComponentName findAvailRecognizer(int i, String str) {
            ...
            Iterator it =
                    context.getPackageManager()
                            .queryIntentServicesAsUser(
                                    new Intent("android.speech.RecognitionService"), 786432, i)
                            .iterator();
            while (it.hasNext()) {
                RecognitionServiceInfo parseInfo =
                        RecognitionServiceInfo.parseInfo(
                                context.getPackageManager(), ((ResolveInfo) it.next()).serviceInfo);
                String str2 = parseInfo.mParseError;
                if (!TextUtils.isEmpty(str2)) {
                    NetworkScorerAppManager$$ExternalSyntheticOutline0.m(
                            "Parse error in getAvailableServices: ",
                            str2,
            ...
            if (arrayList.size() == 0) {
                DeviceIdleController$$ExternalSyntheticOutline0.m(
                        i,
                        "no available voice recognition services found for user ",
                        "VoiceInteractionManager");
                return null;
            }
            ...
            if (str != null) {
                for (int i2 = 0; i2 < size2; i2++) {
                    ServiceInfo serviceInfo =
                            ((RecognitionServiceInfo) arrayList.get(i2)).mServiceInfo;
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "finish without running voice interaction service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
        ...
        public final void forceRestartHotwordDetector() {
            ...
            if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection == null) {
                Slog.w(
                        "VoiceInteractionServiceManager",
                        "Failed to force-restart hotword detection: no hotword detection active");
                return;
            }
            HotwordDetectionConnection hotwordDetectionConnection =
                    voiceInteractionManagerServiceImpl.mHotwordDetectionConnection;
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "registerAccessibilityDetectionSettingsListener called without"
                    ...
                    return Settings.Secure.getIntForUser(
                                    voiceInteractionManagerServiceImpl.mContext
                                            .getContentResolver(),
                                    "visual_query_accessibility_detection_enabled",
                                    0,
                                    voiceInteractionManagerServiceImpl.mUser)
                            == 1;
                } catch (Throwable th) {
                    throw th;
                }
        ...
        public final void getActiveServiceSupportedActions(
            ...
            synchronized (this) {
                ...
                try {
                    ...
                    IVoiceInteractionService iVoiceInteractionService =
                            voiceInteractionManagerServiceImpl.mService;
                    if (iVoiceInteractionService == null) {
                        Slog.w(
                                "VoiceInteractionServiceManager",
                                "Not bound to voice interaction service "
                                        + voiceInteractionManagerServiceImpl.mComponent);
                        try {
                            iVoiceActionCheckCallback.onComplete((List) null);
                        ...
                        try {
                            iVoiceInteractionService.getActiveServiceSupportedActions(
                                    list, iVoiceActionCheckCallback);
                        } catch (RemoteException e) {
                            Slog.w(
                                    "VoiceInteractionServiceManager",
                                    "RemoteException while calling"
            ...
            while (it.hasNext()) {
                ...
                if (devicePolicyManagerInternal != null
                        && devicePolicyManagerInternal.isUserOrganizationManaged(
                                activityAssistInfo.mUserId)) {
                    z = true;
                }
            }
            ScreenCapture.ScreenshotHardwareBuffer takeAssistScreenshot =
                    VoiceInteractionManagerService.this.mWmInternal.takeAssistScreenshot(Set.of());
                ...
                try {
                    ...
                    try {
                        VoiceInteractionManagerServiceImpl voiceInteractionManagerServiceImpl =
                                this.mImpl;
                        int i =
                                voiceInteractionManagerServiceImpl.mInfo.getServiceInfo()
                                        .applicationInfo
                                        .uid;
                        if (callingUid != i) {
                            throw new SecurityException(
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "getUserDisabledShowContext without running voice interaction"
                                    + " service");
                        return 0;
                    }
                    int callingUid = Binder.getCallingUid();
                    ...
                    try {
                        ...
                        VoiceInteractionSessionConnection voiceInteractionSessionConnection =
                                voiceInteractionManagerServiceImpl.mActiveSession;
                        return voiceInteractionSessionConnection != null
                                ? voiceInteractionSessionConnection
        ...
        public final void hideCurrentSession() {
            ...
            try {
                if (this.mImpl.mActiveSession != null
                        && this.mImpl.mActiveSession.mSession != null) {
                    try {
        ...
        public final boolean hideSessionFromSession(IBinder iBinder) {
            synchronized (this) {
                try {
                    ...
                    try {
                        VoiceInteractionSessionConnection voiceInteractionSessionConnection =
                                this.mImpl.mActiveSession;
                        return voiceInteractionSessionConnection != null
                                ? voiceInteractionSessionConnection.hideLocked()
                                : false;
                    } finally {
                        Binder.restoreCallingIdentity(clearCallingIdentity);
                    }
        ...
        public final void initAndVerifyDetector(
                ...
                Binder.withCleanCallingIdentity(
                        new FunctionalUtils.ThrowingRunnable() { // from class:
                            ...
                            public final void runOrThrow() {
                                ...
                                int i2;
                                IHotwordRecognitionStatusCallback
                                        iHotwordRecognitionStatusCallback3;
                                ...
                                IHotwordRecognitionStatusCallback
                                        iHotwordRecognitionStatusCallback4 =
                                                iHotwordRecognitionStatusCallback;
                                int i3 = i;
                                VoiceInteractionManagerServiceImpl
                                        voiceInteractionManagerServiceImpl =
                                ...
                                if (i3 != 3) {
                                    ...
                                    int i4 =
                                            voiceInteractionManagerServiceImpl.mInfo
                                                    .getServiceInfo()
                                                    .applicationInfo
                                                    .uid;
                                    ComponentName componentName =
                                    ...
                                    if (componentName == null) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Hotword detection service name not found");
                                        VoiceInteractionManagerServiceImpl
                                    ...
                                    ServiceInfo serviceInfoLocked =
                                            VoiceInteractionManagerServiceImpl.getServiceInfoLocked(
                                                    voiceInteractionManagerServiceImpl.mUser,
                                                    componentName);
                                    if (serviceInfoLocked == null) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Hotword detection service info not found");
                                        VoiceInteractionManagerServiceImpl
                                                .logDetectorCreateEventIfNeeded(
                                                        iHotwordRecognitionStatusCallback4,
                                                        i3,
                                    ...
                                    if ((i5 & 2) == 0 || (i5 & 4) != 0) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Hotword detection service not in isolated"
                                                    + " process");
                                        VoiceInteractionManagerServiceImpl
                                                .logDetectorCreateEventIfNeeded(
                                                        iHotwordRecognitionStatusCallback4,
                                    ...
                                    if (!"android.permission.BIND_HOTWORD_DETECTION_SERVICE"
                                            .equals(serviceInfoLocked.permission)) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Hotword detection service does not require"
                                                    + " permission"
                                    ...
                                    if (voiceInteractionManagerServiceImpl
                                                    .mContext
                                                    .getPackageManager()
                                                    .checkPermission(
                                                            "android.permission.BIND_HOTWORD_DETECTION_SERVICE",
                                        ...
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Voice interaction service should not hold"
                                                    + " permission"
                                                    + " android.permission.BIND_HOTWORD_DETECTION_SERVICE");
                                        VoiceInteractionManagerServiceImpl
                                                .logDetectorCreateEventIfNeeded(
                                    ...
                                    if (sharedMemory2 != null
                                            && !sharedMemory2.setProtect(OsConstants.PROT_READ)) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Can't set sharedMemory to be read-only");
                                        VoiceInteractionManagerServiceImpl
                                                .logDetectorCreateEventIfNeeded(
                                                        iHotwordRecognitionStatusCallback4,
                                                        i3,
                                    ...
                                    if (componentName2 == null) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Visual query detection service name not found");
                                        throw new IllegalStateException(
                                                "Visual query detection service name not found");
                                    }
                                    ServiceInfo serviceInfoLocked2 =
                                            VoiceInteractionManagerServiceImpl.getServiceInfoLocked(
                                                    voiceInteractionManagerServiceImpl.mUser,
                                                    componentName2);
                                    if (serviceInfoLocked2 == null) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Visual query detection service info not found");
                                        throw new IllegalStateException(
                                                "Visual query detection service name not found");
                                    }
                                    ...
                                    if ((i6 & 2) == 0 || (i6 & 4) != 0) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Visual query detection service not in isolated"
                                                    + " process");
                                        throw new IllegalStateException(
                                                "Visual query detection not in isolated process");
                                    }
                                    if (!"android.permission.BIND_VISUAL_QUERY_DETECTION_SERVICE"
                                            .equals(serviceInfoLocked2.permission)) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                ...
                                if (VoiceInteractionManagerServiceImpl
                                    ...
                                    ServiceInfo serviceInfoLocked3 =
                                            VoiceInteractionManagerServiceImpl.getServiceInfoLocked(
                                                    i7, componentName3);
                                    ServiceInfo serviceInfoLocked4 =
                                            VoiceInteractionManagerServiceImpl.getServiceInfoLocked(
                                                    i7,
                                                    voiceInteractionManagerServiceImpl
                                                            .mVisualQueryDetectionComponentName);
                                    if (serviceInfoLocked3 != null
                                            && serviceInfoLocked4 != null
                                            && ((serviceInfoLocked3.flags & 16) == 0
                                                    || (serviceInfoLocked4.flags & 16) == 0)) {
                                        Slog.w(
                                                "VoiceInteractionServiceManager",
                                                "Sandboxed detection service not in shared isolated"
                                                    + " process");
                                        throw new IllegalStateException(
                                                "VisualQueryDetectionService or"
                                                    + " HotworDetectionService not in a shared"
                                                    + " isolated process. Please make sure to set"
                                                    + " android:allowSharedIsolatedProcess and"
                                                    + " android:isolatedProcess to be true and"
                                                    + " android:externalService to be false in the"
                                                    + " manifest file");
                                    }
                                }
                                if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                                        == null) {
                                    iHotwordRecognitionStatusCallback2 =
                                            iHotwordRecognitionStatusCallback4;
                                    iBinder2 = iBinder3;
                                    ...
                                    voiceInteractionManagerServiceImpl.mHotwordDetectionConnection =
                                            new HotwordDetectionConnection(
                                                    ...
                                                    voiceInteractionManagerServiceImpl.mUser,
                                                    i3,
                                                    new VoiceInteractionManagerServiceImpl$$ExternalSyntheticLambda1(
                                                            voiceInteractionManagerServiceImpl));
                                    voiceInteractionManagerServiceImpl
                                            .mAccessibilitySettingsListeners.add(
                                            voiceInteractionManagerServiceImpl
                                                    .mHotwordDetectionConnection
                                                    .mAccessibilitySettingsListener);
                                } else {
                                    iHotwordRecognitionStatusCallback2 =
                                            iHotwordRecognitionStatusCallback4;
                                    iBinder2 = iBinder3;
                                ...
                                DetectorSession detectorSession =
                                        (DetectorSession)
                                                hotwordDetectionConnection.mDetectorSessions.get(
                                                        i3);
                                ...
                                if (i3 == 1) {
                                    if (hotwordDetectionConnection.mRemoteHotwordDetectionService
                                            == null) {
                                        hotwordDetectionConnection.mRemoteHotwordDetectionService =
                                                hotwordDetectionConnection
                                    ...
                                    DspTrustedHotwordDetectorSession
                                            dspTrustedHotwordDetectorSession =
                                                    new DspTrustedHotwordDetectorSession(
                                                            ...
                                                            hotwordDetectionConnection.mLock,
                                                            ...
                                                            hotwordDetectionConnection.mUserId);
                                    dspTrustedHotwordDetectorSession.mValidatingDspTrigger = false;
                                    dspTrustedHotwordDetectorSession.mLastHotwordRejectedResult =
                                            null;
                                    softwareTrustedHotwordDetectorSession =
                                            dspTrustedHotwordDetectorSession;
                                } else {
                                    ...
                                    if (i3 == i2) {
                                        ...
                                        VisualQueryDetectorSession visualQueryDetectorSession =
                                        ...
                                        visualQueryDetectorSession.mEnableAccessibilityDataEgress =
                                                Settings.Secure.getIntForUser(
                                                                visualQueryDetectorSession.mContext
                                                                        .getContentResolver(),
                                                                "visual_query_accessibility_detection_enabled",
                                                                0,
                                                                visualQueryDetectorSession.mUserId)
                                                        == 1;
                                        softwareTrustedHotwordDetectorSession =
                                ...
                                hotwordDetectionConnection.mHotwordRecognitionCallback =
                                        iHotwordRecognitionStatusCallback3;
                                hotwordDetectionConnection.mDetectorSessions.put(
                                        i3, softwareTrustedHotwordDetectorSession);
                                synchronized (softwareTrustedHotwordDetectorSession.mLock) {
                                    try {
                                        if (!softwareTrustedHotwordDetectorSession.mInitialized
                                                && !softwareTrustedHotwordDetectorSession
                                                        .mDestroyed) {
                                            if (softwareTrustedHotwordDetectorSession
                                                            .mRemoteDetectionService
                                                            .postAsync(
                                                                    new DetectorSession$$ExternalSyntheticLambda1(
                                                                            softwareTrustedHotwordDetectorSession,
                                                                            persistableBundle2,
                                                                            sharedMemory2))
                                                            .whenComplete(
                                                                    new DetectorSession$$ExternalSyntheticLambda2(
                                                                            softwareTrustedHotwordDetectorSession))
                                                    == null) {
                                                Slog.w(
                                                        "DetectorSession",
                                                        "Failed to create AndroidFuture");
                                            }
                                            softwareTrustedHotwordDetectorSession.mInitialized =
                                                    true;
                                        }
                                    } finally {
                                    }
        ...
        public final void initForUser(int i) {
            ...
            if (stringForUser == null && curRecognizer != null && this.mEnableService) {
                voiceInteractionServiceInfo =
                        findAvailInteractor(i, curRecognizer.getPackageName());
            ...
            String string =
                    VoiceInteractionManagerService.this
                            .mContext
                            .getResources()
                            .getString(R.string.duration_hours_shortest_future);
            if (TextUtils.isEmpty(string)) {
                string = null;
            }
            if (string != null
                    && (voiceInteractionServiceInfo = findAvailInteractor(i, string)) != null) {
                curRecognizer = null;
            }
            ...
            if (curRecognizer != null) {
                    ...
                    if (serviceInfo != null) {
                        try {
                            ...
                            if (!TextUtils.isEmpty(str)) {
                                Log.w(
                                        "VoiceInteractionManager",
                                        "Parse error in getAvailableServices: " + str);
                            }
                ...
                if (unflattenFromString != null) {
                    ...
                    if (serviceInfo != null
                            && (unflattenFromString == null || serviceInfo2 != null)) {
                        return;
                    }
                }
                serviceInfo2 = null;
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "launchVoiceAssistFromKeyguard without running voice"
                                    + " interactionservice");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
        ...
        public final List listModuleProperties(Identity identity) {
            ...
            soundTriggerService.mServiceEventLogger.enqueue(
                    new SoundTriggerEvent$ServiceEvent(
                            SoundTriggerEvent$ServiceEvent.Type.LIST_MODULE,
                            identity.packageName,
                            (String) null));
            SafeCloseable establishIdentityDirect =
                    PermissionUtil.establishIdentityDirect(identity);
            try {
                List listUnderlyingModuleProperties =
                        soundTriggerService.listUnderlyingModuleProperties(identity);
                if (establishIdentityDirect != null) {
                    establishIdentityDirect.close();
                }
                        ...
                        Binder.withCleanCallingIdentity(
                                new FunctionalUtils
                                    ...
                                    public final void runOrThrow() {
                                        ...
                                        final int i2 = i;
                                        final VoiceInteractionSessionConnection
                                                voiceInteractionSessionConnection =
                                                        voiceInteractionManagerServiceStub
                                                                .mImpl
                                                                .mActiveSession;
                                        if (voiceInteractionSessionConnection != null
                                                && voiceInteractionSessionConnection.mShown
                                                && voiceInteractionSessionConnection
                                                        .mListeningVisibleActivity) {
                                            voiceInteractionSessionConnection
                                                    .mScheduledExecutorService.execute(
                                                    new Runnable() { // from class:
                                                                     // com.android.server.voiceinteraction.VoiceInteractionSessionConnection$$ExternalSyntheticLambda1
                                                        @Override // java.lang.Runnable
                                                        public final void run() {
                                                            VoiceInteractionSessionConnection
                                                                    voiceInteractionSessionConnection2 =
                                                                            VoiceInteractionSessionConnection
                                                                                    .this;
                    ...
                    try {
                        if (this.mImpl.mActiveSession != null
                            ...
                            try {
                                ...
                                Log.w(
                                        "VoiceInteractionManager",
                                        "Failed to call onLockscreenShown",
                                        e);
                            }
                        }
                    } finally {
        ...
        public final void registerAccessibilityDetectionSettingsListener(
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        ...
                        this.mImpl.mAccessibilitySettingsListeners.add(
                                iVoiceInteractionAccessibilitySettingsListener);
                    }
                } catch (Throwable th) {
                    throw th;
                ...
                try {
                    ...
                    if (z) {
                        ...
                        try {
                            ...
                            Log.w(
                                    "VoiceInteractionManager",
                                    "Failed to call hideCurrentSession",
                                    e);
                        }
                    } else {
        ...
        public final void setImplLocked(
            ...
            synchronized (windowManagerGlobalLock) {
                try {
                    ActivityTaskManagerService.this.mActiveVoiceInteractionServiceComponent =
                            activeServiceComponentName;
                } catch (Throwable th) {
                    WindowManagerService.resetPriorityAfterLockedSection();
                    throw th;
                }
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "setKeepAwake without running voice interaction service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        ...
                        try {
                            ...
                            if (voiceInteractionSessionConnection != null
                                    && iBinder == voiceInteractionSessionConnection.mToken) {
                                voiceInteractionManagerServiceImpl.mAtm.setVoiceKeepAwake(
                                        voiceInteractionSessionConnection.mSession, z);
                            }
                            Slog.w(
                                    "VoiceInteractionServiceManager",
                                    "setKeepAwake does not match active session");
                        } catch (RemoteException e) {
                            throw new IllegalStateException("Unexpected remote error", e);
                        }
                    } finally {
                    ...
                    if (z) {
                        ...
                        try {
                            iBinder.linkToDeath(
                                                ...
                                                try {
                                                    VoiceInteractionManagerService
                                                            voiceInteractionManagerService =
                                                                    VoiceInteractionManagerService
                                                                            .this;
                                                    if (voiceInteractionManagerService.mDbHelper
                                                            == testModelEnrollmentDatabase2) {
                                                        voiceInteractionManagerService.mDbHelper =
                                                                voiceInteractionManagerService
                                                                        .mRealDbHelper;
                                                        voiceInteractionManagerServiceStub.mImpl
                                    ...
                                    0);
                            VoiceInteractionManagerService.this.mDbHelper =
                                    testModelEnrollmentDatabase;
                            this.mImpl.notifySoundModelsChangedLocked();
                        } catch (RemoteException unused) {
                        }
                        ...
                        VoiceInteractionManagerService voiceInteractionManagerService =
                                VoiceInteractionManagerService.this;
                        IEnrolledModelDb iEnrolledModelDb =
                                voiceInteractionManagerService.mDbHelper;
                        DatabaseHelper databaseHelper =
                                voiceInteractionManagerService.mRealDbHelper;
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "setSessionWindowVisible called without running voice interaction"
                                    + " service");
                        return;
                    }
                    if (this.mImpl.mActiveSession != null
                            && iBinder == this.mImpl.mActiveSession.mToken) {
                        long clearCallingIdentity = Binder.clearCallingIdentity();
                        try {
                                    ...
                                    .broadcast(
                                            new Consumer() { // from class:
                                                ...
                                                public final void accept(Object obj) {
                                                    try {
                                                        ((IVoiceInteractionSessionListener) obj)
                                                                .onVoiceSessionWindowVisibilityChanged(
                                                                        z);
                                                    } catch (RemoteException e) {
                                                        Slog.e(
                                                                "VoiceInteractionManager",
                                                                "Error delivering window visibility"
                                                                    + " event to listener.",
                                                                e);
                                                    }
                                                }
                    ...
                    Slog.w(
                            "VoiceInteractionManager",
                            "setSessionWindowVisible does not match active session");
                } catch (Throwable th) {
                    throw th;
                }
            }
        ...
        public final boolean showSessionForActiveService(
                Bundle bundle,
                int i,
                String str,
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "showSessionForActiveService without running voice"
                                    + " interactionservice");
                        return false;
                    }
                    if (this.mTemporarilyDisabled) {
                        Slog.i(
                                "VoiceInteractionManager",
                                "showSessionForActiveService(): ignored while temporarily"
                                    + " disabled");
                        return false;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        ...
                        return this.mImpl.showSessionLocked(
                                bundle, i | 3, str, iVoiceInteractionSessionShowCallback, iBinder);
                    } finally {
                        Binder.restoreCallingIdentity(clearCallingIdentity);
                    }
                } catch (Throwable th) {
        ...
        public final boolean showSessionFromSession(
                IBinder iBinder, Bundle bundle, int i, String str) {
                ...
                try {
                    String string =
                            VoiceInteractionManagerService.this
                                    .mContext
                                    .getResources()
                                    .getString(R.string.date_picker_month_typeface);
                    String string2 =
                            VoiceInteractionManagerService.this
                                    .mContext
                                    .getResources()
                                    .getString(R.string.date_picker_mode);
                    if (bundle != null && bundle.containsKey(string)) {
                        if (bundle.getBoolean(string2, true)
                                && (contextualSearchIntent = getContextualSearchIntent(bundle))
                                        != null) {
                            Slog.d(
                                    "VoiceInteractionManager",
                                    "Handed over to contextual search helper.");
                            ...
                            try {
                                ...
                                VoiceInteractionManagerService voiceInteractionManagerService =
                                        VoiceInteractionManagerService.this;
                                return voiceInteractionManagerService.mAtmInternal
                                                .startActivityWithScreenshot(
                                                        Binder.getCallingUid(),
                                                        contextualSearchIntent,
                                                        Binder.getCallingPid(),
                                                        makeCustomTaskAnimation.toBundle(),
                                                        voiceInteractionManagerService.mContext
                                                                .getPackageName(),
                        ...
                        if (!bundle.getBoolean(
                                VoiceInteractionManagerService.this
                                        .mContext
                                        .getResources()
                                        .getString(R.string.date_picker_next_month_button),
                                true)) {
                            return false;
                        }
                        String string3 =
                        ...
                        if (curInteractor != null
                                && string3.equals(curInteractor.getPackageName())) {
                            Slog.d(
                                    "VoiceInteractionManager",
                    ...
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "showSessionFromSession without running voice interaction service");
                        return false;
                    }
                    if (iBinder == null) {
                        LatencyTracker.getInstance(VoiceInteractionManagerService.this.mContext)
            ...
            synchronized (this) {
                try {
                    ...
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "shutdownHotwordDetectionService without running voice interaction"
                                    + " service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        ...
                        if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                            ...
                            Slog.w(
                                    "VoiceInteractionServiceManager",
                                    "shutdown, but no hotword detection connection");
                        } else {
                            voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                                    .cancelLocked();
                            voiceInteractionManagerServiceImpl.mAccessibilitySettingsListeners
                                    .remove(
                                            voiceInteractionManagerServiceImpl
                                                    .mHotwordDetectionConnection
                                                    .mAccessibilitySettingsListener);
        ...
        public final int startAssistantActivity(
        ...
        public final void startListeningFromExternalSource(
            ...
            synchronized (this) {
                try {
                    ...
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "startListeningFromExternalSource without running voice interaction"
                                    + " service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        ...
                        if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                            ...
                            if (parcelFileDescriptor == null) {
                                Slog.w(
                                        "VoiceInteractionServiceManager",
                                        "External source is null for hotword detector");
                                throw new IllegalStateException(
                                        "External source is null for hotword detector");
                            }
                            DetectorSession detectorSessionByTokenLocked =
                                    voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                                            .getDetectorSessionByTokenLocked(iBinder);
                            if (detectorSessionByTokenLocked == null) {
                                Slog.v(
                                        "HotwordDetectionConnection",
                                        "Not found the detector by token");
                            } else {
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public final void startListeningFromMic(
                android.media.AudioFormat r6,
                android.service.voice.IMicrophoneHotwordDetectionVoiceInteractionCallback r7) {
            /*
                r5 = this;
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.voiceinteraction.VoiceInteractionManagerService.VoiceInteractionManagerServiceStub.startListeningFromMic(android.media.AudioFormat,"
                        + " android.service.voice.IMicrophoneHotwordDetectionVoiceInteractionCallback):void");
        }
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "startListeningVisibleActivityChanged without running voice"
                                    + " interaction service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
        ...
        public final void startPerceiving(
                        ...
                        if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection != null
                                && (visualQueryDetectorSessionLocked =
                                                voiceInteractionManagerServiceImpl
                                                        ...
                                                        .getVisualQueryDetectorSessionLocked())
                                        != null) {
                            final VisualQueryDetectorSession.AnonymousClass1 anonymousClass1 =
                                    new IDetectorSessionVisualQueryDetectionCallback
                                            .Stub() { // from class:
                                        // com.android.server.voiceinteraction.VisualQueryDetectorSession.1
                                        public final /* synthetic */
                                        IVisualQueryDetectionVoiceInteractionCallback val$callback;

                                        public AnonymousClass1(
                                                IVisualQueryDetectionVoiceInteractionCallback
                                                        iVisualQueryDetectionVoiceInteractionCallback2) {
                                        ...
                                        public final void onAttentionGained(
                                            ...
                                            Slog.v(
                                                    "VisualQueryDetectorSession",
                                                    "BinderCallback#onAttentionGained");
                                            synchronized (VisualQueryDetectorSession.this.mLock) {
                                                VisualQueryDetectorSession
                                                        visualQueryDetectorSession =
                                                                VisualQueryDetectorSession.this;
                                                visualQueryDetectorSession.mEgressingData = true;
                                                IVisualQueryDetectionAttentionListener
                                                        iVisualQueryDetectionAttentionListener =
                                                                visualQueryDetectorSession
                                                                        .mAttentionListener;
                                                if (iVisualQueryDetectionAttentionListener
                                                        == null) {
                                                    return;
                                                }
                                                try {
                                                    ...
                                                    Slog.e(
                                                            "VisualQueryDetectorSession",
                                                            "Error delivering attention gained"
                                                                + " event.",
                                                            e);
                                                    try {
                                                        r2.onVisualQueryDetectionServiceFailure(
                                                                new VisualQueryDetectionServiceFailure(
                                                                        3,
                                                                        "Attention listener fails"
                                                                            + " to switch to GAINED"
                                                                            + " state."));
                                                    } catch (RemoteException unused) {
                                                        Slog.v(
                                        ...
                                        public final void onAttentionLost(int i) {
                                            Slog.v(
                                                    "VisualQueryDetectorSession",
                                                    "BinderCallback#onAttentionLost");
                                            synchronized (VisualQueryDetectorSession.this.mLock) {
                                                VisualQueryDetectorSession
                                                        visualQueryDetectorSession =
                                                                VisualQueryDetectorSession.this;
                                                ...
                                                try {
                                                    ...
                                                    Slog.e(
                                                            "VisualQueryDetectorSession",
                                                            "Error delivering attention lost"
                                                                + " event.",
                                                            e);
                                                    try {
                                                        r2.onVisualQueryDetectionServiceFailure(
                                        ...
                                        public final void onQueryDetected(String str) {
                                            Slog.v(
                                                    "VisualQueryDetectorSession",
                                                    "BinderCallback#onQueryDetected");
                                            synchronized (VisualQueryDetectorSession.this.mLock) {
                                                ...
                                                if (!visualQueryDetectorSession.mEgressingData) {
                                                    Slog.v(
                                                            "VisualQueryDetectorSession",
                                                            "Query should not be egressed within"
                                                                + " the unattention state.");
                                                    r2.onVisualQueryDetectionServiceFailure(
                                                            new VisualQueryDetectionServiceFailure(
                                                                    4,
                                                                    "Cannot stream queries without"
                                                                        + " attention signals."));
                                                    return;
                                                }
                                                try {
                                                    Binder.withCleanCallingIdentity(
                                                            new VisualQueryDetectorSession$$ExternalSyntheticLambda1(
                                                                    visualQueryDetectorSession,
                                                    ...
                                                    Slog.i(
                                                            "VisualQueryDetectorSession",
                                                            "Egressed from visual query detection"
                                                                + " process.");
                                                } catch (SecurityException e) {
                                                    Slog.w(
                                                            "VisualQueryDetectorSession",
                                                            "Ignoring #onQueryDetected due to a"
                                                                + " SecurityException",
                                                            e);
                                                    try {
                                                        r2.onVisualQueryDetectionServiceFailure(
                                        ...
                                        public final void onQueryFinished() {
                                            Slog.v(
                                                    "VisualQueryDetectorSession",
                                                    "BinderCallback#onQueryFinished");
                                            synchronized (VisualQueryDetectorSession.this.mLock) {
                                                try {
                                                    if (VisualQueryDetectorSession.this
                                                            .mQueryStreaming) {
                                                        r2.onQueryFinished();
                                                        VisualQueryDetectorSession.this
                                                                        .mQueryStreaming =
                                                        ...
                                                        Slog.v(
                                                                "VisualQueryDetectorSession",
                                                                "Query streaming state signal"
                                                                    + " FINISHED is block since"
                                                                    + " there is no active query"
                                                                    + " being streamed.");
                                                        r2.onVisualQueryDetectionServiceFailure(
                                                                new VisualQueryDetectionServiceFailure(
                                                                        4,
                                                                        "Cannot send FINISHED"
                                                                            + " signal with no"
                                                                            + " query streamed."));
                                                    }
                                                } catch (Throwable th) {
                                        ...
                                        public final void onQueryRejected() {
                                            Slog.v(
                                                    "VisualQueryDetectorSession",
                                                    "BinderCallback#onQueryRejected");
                                            synchronized (VisualQueryDetectorSession.this.mLock) {
                                                try {
                                                    if (VisualQueryDetectorSession.this
                                                            .mQueryStreaming) {
                                        ...
                                        public final void onResultDetected(
                                                VisualQueryDetectedResult
                                                        visualQueryDetectedResult) {
                                            Slog.v(
                                                    "VisualQueryDetectorSession",
                                                    "BinderCallback#onResultDetected");
                                            synchronized (VisualQueryDetectorSession.this.mLock) {
                                                try {
                                                    ...
                                                    if (!VisualQueryDetectorSession.this
                                                        ...
                                                        Slog.v(
                                                                "VisualQueryDetectorSession",
                                                                "Result should not be egressed"
                                                                    + " within the unattention"
                                                                    + " state.");
                                                        r2.onVisualQueryDetectionServiceFailure(
                                                                new VisualQueryDetectionServiceFailure(
                                                                        4,
                                                                        "Cannot stream results"
                                                                            + " without attention"
                                                                            + " signals."));
                                                        return;
                                                    }
                                                    if (visualQueryDetectedResult
                                                                            .getAccessibilityDetectionData()
                                                                    != null
                                                            && !VisualQueryDetectorSession.this
                                                                    .mEnableAccessibilityDataEgress) {
                                                        Slog.v(
                                                                "VisualQueryDetectorSession",
                                                                "Accessibility data can be egressed"
                                                                    + " only when the"
                                                                    + " isAccessibilityDetectionEnabled()"
                                                                    + " is true.");
                                                        r2.onVisualQueryDetectionServiceFailure(
                                                                new VisualQueryDetectionServiceFailure(
                                                                        4,
                            ...
                            z =
                                    visualQueryDetectorSessionLocked.mRemoteDetectionService.run(
                                            new ServiceConnector
                                                    .VoidJob() { // from class:
                                                                 // com.android.server.voiceinteraction.VisualQueryDetectorSession$$ExternalSyntheticLambda0
                                                public final void runNoResult(Object obj) {
                                                    ((ISandboxedDetectionService) obj)
                                                            .detectWithVisualSignals(
                                                                    anonymousClass1);
                                                }
                                            });
                        }
        ...
        public final int startVoiceActivity(
                IBinder iBinder, Intent intent, String str, String str2) {
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                    ...
                    try {
                        ...
                        if (resolveActivityInfo != null) {
                            this.mImpl.grantImplicitAccessLocked(
                                    resolveActivityInfo.applicationInfo.uid, intent);
                        } else {
                            Slog.w(
                                    "VoiceInteractionManager",
                                    "Cannot find ActivityInfo in startVoiceActivity.");
                        }
                        int startVoiceActivityLocked =
                                this.mImpl.startVoiceActivityLocked(
            ...
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "stopListeningVisibleActivityChanged without running voice"
                                    + " interaction service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        ...
                        Slog.w(
                                "VoiceInteractionServiceManager",
                                "stopListeningVisibleActivityChangedLocked does not match active"
                                    + " session");
                    } finally {
                        Binder.restoreCallingIdentity(clearCallingIdentity);
                    }
                ...
                try {
                    ...
                    try {
                        ...
                        if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                            ...
                            Slog.w(
                                    "VoiceInteractionServiceManager",
                                    "stopPerceivingLocked() called but connection isn't"
                                        + " established");
                        } else {
                            VisualQueryDetectorSession visualQueryDetectorSessionLocked =
                                    voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                            ...
                            if (visualQueryDetectorSessionLocked != null) {
                                z =
                                        visualQueryDetectorSessionLocked.mRemoteDetectionService
                                                .run(
                                                        new SoftwareTrustedHotwordDetectorSession$$ExternalSyntheticLambda0());
                            }
                        }
                        if (z
                                && (iVisualQueryRecognitionStatusListener =
        ...
        public final void subscribeVisualQueryRecognitionStatus(
                IVisualQueryRecognitionStatusListener iVisualQueryRecognitionStatusListener) {
            subscribeVisualQueryRecognitionStatus_enforcePermission();
            synchronized (this) {
                VoiceInteractionManagerService.this.mVisualQueryRecognitionStatusListener =
                        iVisualQueryRecognitionStatusListener;
            }
        }
        ...
        */
        public final void switchImplementationIfNeededLocked(boolean r10) {
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.voiceinteraction.VoiceInteractionManagerService.VoiceInteractionManagerServiceStub.switchImplementationIfNeededLocked(boolean):void");
        }

        public final void triggerHardwareRecognitionEventForTest(
            ...
            synchronized (this) {
                try {
                    ...
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "triggerHardwareRecognitionEventForTest without running voice"
                                    + " interaction service");
                        return;
                    }
                    long clearCallingIdentity = Binder.clearCallingIdentity();
                    try {
                        ...
                        if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                            ...
                            Slog.w(
                                    "VoiceInteractionServiceManager",
                                    "triggerHardwareRecognitionEventForTestLocked() called but"
        ...
        public final synchronized void unloadAllKeyphraseModels() {
            for (int i = 0;
                    i < VoiceInteractionManagerService.this.mLoadedKeyphraseIds.size();
                    i++) {
                try {
                    int intValue =
                            ((Integer)
                                            VoiceInteractionManagerService.this.mLoadedKeyphraseIds
                                                    .keyAt(i))
                                    .intValue();
                    int m1035$$Nest$munloadKeyphraseModel =
                            SoundTriggerSession.m1035$$Nest$munloadKeyphraseModel(
        ...
        public final void unregisterAccessibilityDetectionSettingsListener(
                IVoiceInteractionAccessibilitySettingsListener
                        iVoiceInteractionAccessibilitySettingsListener) {
            synchronized (this) {
                try {
                    if (this.mImpl == null) {
                        Slog.w(
                                "VoiceInteractionManager",
                                "unregisterAccessibilityDetectionSettingsListener called without"
                                    + " running voice interaction service");
                    } else {
                        this.mImpl.mAccessibilitySettingsListeners.remove(
                                iVoiceInteractionAccessibilitySettingsListener);
                    }
                } catch (Throwable th) {
                    throw th;
        ...
        public final int updateKeyphraseSoundModel(
                SoundTrigger.KeyphraseSoundModel keyphraseSoundModel) {
            enforceCallerAllowedToEnrollVoiceModel();
            if (keyphraseSoundModel == null) {
                        ...
                        new FunctionalUtils
                            ...
                            public final void runOrThrow() {
                                ...
                                if (voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                                    ...
                                    Slog.w(
                                            "VoiceInteractionServiceManager",
                                            "update State, but no hotword detection connection");
                                    throw new IllegalStateException(
                                            "Hotword detection connection not found");
                                }
                                synchronized (
                                        voiceInteractionManagerServiceImpl
                                                .mHotwordDetectionConnection
                                    ...
                                    voiceInteractionManagerServiceImpl.mHotwordDetectionConnection
                                            .updateStateLocked(
                                                    persistableBundle2, sharedMemory2, iBinder2);
                                }
                            }
                        });
            }
    ...
    public VoiceInteractionManagerService(Context context) {
        ...
        this.mLatencyLoggingListener =
                new IVoiceInteractionSessionListener
                        .Stub() { // from class:
                ...
                legacyPermissionManagerInternal$PackagesProvider =
                        new LegacyPermissionManagerInternal$PackagesProvider() { // from class:
                            ...
                            public final String[] getPackages(int i) {
                                ...
                                ComponentName curInteractor =
                                        voiceInteractionManagerService.mServiceStub
                                                .getCurInteractor(i);
                                if (curInteractor != null) {
        ...
        synchronized (defaultPermissionGrantPolicy.mLock) {
            defaultPermissionGrantPolicy.mVoiceInteractionPackagesProvider =
                    legacyPermissionManagerInternal$PackagesProvider;
        }
    }
    ...
    public final void onBootPhase(int i) {
        if (500 == i) {
            ...
            this.mSoundTriggerInternal =
                    (SoundTriggerService.LocalSoundTriggerService)
                            LocalServices.getService(
                                    SoundTriggerService.LocalSoundTriggerService.class);
            return;
        }
        if (i != 600) {
            if (i == 1000) {
                this.mServiceStub.registerVoiceInteractionSessionListener(
                        this.mLatencyLoggingListener);
                return;
            }
            return;
        ...
        voiceInteractionManagerServiceStub.mPackageMonitor.register(
                VoiceInteractionManagerService.this.mContext,
    ...
    public final void onStart() {
        ...
        this.mAmInternal.setVoiceInteractionManagerProvider(
                new ActivityManagerInternal
                        .VoiceInteractionManagerProvider() { // from class:
                                ...
                                synchronized (voiceInteractionManagerServiceStub2) {
                                    ...
                                    UserInfo userInfo =
                                            VoiceInteractionManagerService.this.mUserManagerInternal
                                                    .getUserInfo(i);
                                    VoiceInteractionManagerService.this.getClass();
                                    voiceInteractionManagerServiceStub2.mCurUserSupported =
                                            userInfo.isFull();
                                    voiceInteractionManagerServiceStub2
