...
public final /* synthetic */ class HotwordDetectionConnection$$ExternalSyntheticLambda3
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ HotwordDetectionConnection f$0;

    public /* synthetic */ HotwordDetectionConnection$$ExternalSyntheticLambda3(
            HotwordDetectionConnection hotwordDetectionConnection, int i) {
        this.$r8$classId = i;
        ...
        switch (i) {
            case 0:
                Slog.v(
                        ...
                        "Timeout to reset mDebugHotwordLogging to false");
                synchronized (hotwordDetectionConnection.mLock) {
                    hotwordDetectionConnection.mDebugHotwordLogging = false;
                    hotwordDetectionConnection.runForEachDetectorSessionLocked(
                            new HotwordDetectionConnection$$ExternalSyntheticLambda1(2));
                }
                return;
            default:
                    ...
                    try {
                        ...
                        if (i2 != 3) {
                            FrameworkStatsLog.write(
                                    ...
                                    i2 != 1 ? i2 != 2 ? 0 : 2 : 1,
                                    2,
                                    hotwordDetectionConnection.mVoiceInteractionServiceUid);
                        }
                    } catch (Throwable th) {
                        throw th;
                    }
