            ...
            synchronized (SoftwareTrustedHotwordDetectorSession.this.mLock) {
                try {
                    ...
                    SoftwareTrustedHotwordDetectorSession softwareTrustedHotwordDetectorSession =
                            SoftwareTrustedHotwordDetectorSession.this;
                    ...
                    softwareTrustedHotwordDetectorSession.mPerformingSoftwareHotwordDetection =
                            false;
                    try {
                        Binder.withCleanCallingIdentity(
                                new DetectorSession$$ExternalSyntheticLambda6(
                                        softwareTrustedHotwordDetectorSession));
                        ...
                        try {
                            ...
                            try {
                                ...
                                Slog.i(
                                        "SoftwareTrustedHotwordDetectorSession",
                                        "Egressed "
                                                + HotwordDetectedResult.getUsageSize(
                                                        startCopyingAudioStreams)
                                                + " bits from hotword trusted process");
                                if (SoftwareTrustedHotwordDetectorSession.this
                                        .mDebugHotwordLogging) {
                                    Slog.i(
                                            "SoftwareTrustedHotwordDetectorSession",
                                            "Egressed detected result: "
                                                    + startCopyingAudioStreams);
                                }
    ...
    public final void informRestartProcessLocked() {
        ...
        if (this.mPerformingSoftwareHotwordDetection) {
            ...
            this.mRemoteDetectionService.run(
                    new SoftwareTrustedHotwordDetectorSession$$ExternalSyntheticLambda1(
                            new AnonymousClass1()));
