...
public final class TestModelEnrollmentDatabase implements IEnrolledModelDb {
    ...
    public final class EnrollmentKey {
        ...
        public final int hashCode() {
            return this.mLocale.hashCode()
                    + ((this.mUserIds.hashCode() + ((this.mKeyphraseId + 31) * 31)) * 31);
        }
        ...
        public final String toString() {
            ...
            return AmFmBandRange$$ExternalSyntheticOutline0.m(
                    stringJoiner, new StringBuilder("EnrollmentKey: "));
        }
    }
    ...
    public final boolean deleteKeyphraseSoundModel(int i, int i2, String str) {
        return ((HashMap) this.mModelMap)
                .keySet()
                .removeIf(new TestModelEnrollmentDatabase$$ExternalSyntheticLambda0(i, str, i2, 0));
    }
    ...
    public final SoundTrigger.KeyphraseSoundModel getKeyphraseSoundModel(
        ...
        return (SoundTrigger.KeyphraseSoundModel)
                ((HashMap) this.mModelMap)
                        .entrySet().stream()
                                .filter(
                                        new TestModelEnrollmentDatabase$$ExternalSyntheticLambda0(
                                                i, str, i2, 1))
                                .findFirst()
                                .map(new TestModelEnrollmentDatabase$$ExternalSyntheticLambda2(0))
                                .orElse(null);
    }
        ...
        return (SoundTrigger.KeyphraseSoundModel)
                ((HashMap) this.mModelMap)
                        .entrySet().stream()
                                ...
                                .findFirst()
                                .map(new TestModelEnrollmentDatabase$$ExternalSyntheticLambda2(1))
                                .orElse(null);
    }
