...
public final class BrightnessTracker {
    ...
    public final class Receiver extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            synchronized (brightnessTracker2.mDataCollectionLock) {
                try {
                    if (brightnessTracker2.mStarted) {
                        ...
                        injector.getClass();
                        ((SensorManager) context2.getSystemService(SensorManager.class))
            ...
            brightnessTracker3.mBgHandler.post(
                    new BrightnessTracker$$ExternalSyntheticLambda1(brightnessTracker3));
            ...
            synchronized (ambientBrightnessStatsTracker) {
                try {
                    if (ambientBrightnessStatsTracker.mTimer.started) {
                        ...
                        if (i == i2) {
                            AmbientBrightnessStatsTracker.AmbientBrightnessStats
                            ...
                            ambientBrightnessStats.log(
                                    i2,
                                    LocalDate.now(),
                                    ambientBrightnessStatsTracker.mCurrentAmbientBrightness,
                                    ambientBrightnessStatsTracker.mTimer.started
                                            ? (float)
                                                    ((r5.clock.elapsedTimeMillis()
                                                                    - r5.startTimeMillis)
                                                            / 1000.0d)
                            ...
                            if (AmbientBrightnessStatsTracker.DEBUG) {
                                Slog.v(
                                        "AmbientBrightnessStatsTracker",
                                        "User switched since last sensor event.");
                            }
                            ambientBrightnessStatsTracker.mCurrentUserId = i;
                        }
                        AmbientBrightnessStatsTracker.Timer timer =
                                ambientBrightnessStatsTracker.mTimer;
                        timer.started = false;
                        ...
                        Slog.e(
                                "AmbientBrightnessStatsTracker",
                                "Timer not running while trying to add brightness stats.");
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public final class TrackerHandler extends Handler {
        ...
        public final void handleMessage(Message message) {
            int i = message.what;
            if (i == 0) {
                BrightnessTracker.m436$$Nest$mbackgroundStart(
                        BrightnessTracker.this, ((Float) message.obj).floatValue());
                return;
            }
            if (i != 1) {
                if (i == 2) {
                ...
                BrightnessTracker.this.mShouldCollectColorSample =
                    ...
                    if (brightnessTracker3.mStarted) {
                        ...
                        if (z2) {
                            BrightnessChangeEvent.Builder builder =
                                    new BrightnessChangeEvent.Builder();
                                ...
                                if (focusedRootTaskInfo != null
                                    ...
                                    if (brightnessTracker3.mColorSamplingEnabled) {
                                        ...
                                        DisplayedContentSample displayedContentSample =
                                                ((DisplayManagerInternal)
                                                                LocalServices.getService(
                                                                        DisplayManagerInternal
                                                                                .class))
                                                        .getDisplayedContentSample(0, i3, 0L);
                                        if (displayedContentSample != null) {
                                            ...
                                            if (displayedContentSample.getSampleComponent(
                                                            colorComponent)
                                                    != null) {
    ...
    */
    public static void m436$$Nest$mbackgroundStart(
            com.android.server.display.BrightnessTracker r7, float r8) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.display.BrightnessTracker.m436$$Nest$mbackgroundStart(com.android.server.display.BrightnessTracker,"
                    + " float):void");
    }
    ...
    public final void dump(final PrintWriter printWriter) {
            ...
            try {
                ...
                for (int i = 0; i < brightnessChangeEventArr.length; i++) {
                    printWriter.print(
                            "    "
                                    + FORMAT.format(
                                            new Date(brightnessChangeEventArr[i].timeStamp)));
        ...
        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                new StringBuilder("  mWriteBrightnessTrackerStateScheduled="),
                this.mWriteBrightnessTrackerStateScheduled,
                printWriter);
                                        ...
                                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                BinaryTransparencyService$$ExternalSyntheticOutline0
                                                        .m(
                                                                new StringBuilder(
                                                                        "  mSensorRegistered="),
                                                                brightnessTracker.mSensorRegistered,
                                                                printWriter2,
                                                                "  mColorSamplingEnabled="),
                                                brightnessTracker.mColorSamplingEnabled,
                                                printWriter2,
                                                "  mNoFramesToSample="),
                                        brightnessTracker.mNoFramesToSample,
                                        printWriter2,
                                        "  mFrameRate="),
                                brightnessTracker.mFrameRate,
                                printWriter2);
            ...
            if (displayedContentSamplingAttributes != null
                ...
                if (z) {
                    ...
                    HeimdAllFsService$$ExternalSyntheticOutline0.m(
                            "BrightnessTracker", sb, this.mColorSamplingEnabled);
                }
            }
        ...
        if (!atomicFile.exists()) {
            ...
            if (atomicFile2.exists()) {
                BootReceiver$$ExternalSyntheticOutline0.m58m(
                        "Reading ", str, " from old location", "BrightnessTracker");
                return atomicFile2;
            }
        }
        return atomicFile;
    ...
    */
    public void readEventsLocked(java.io.InputStream r20) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.display.BrightnessTracker.readEventsLocked(java.io.InputStream):void");
    }
    ...
    public final void startSensorListener() {
        ...
        if (((PowerManager) context.getSystemService(PowerManager.class)).isInteractive()) {
            ...
            if (Settings.System.getIntForUser(contentResolver, "screen_brightness_mode", 0, -2)
                ...
                injector3.getClass();
                ((SensorManager) context2.getSystemService(SensorManager.class))
                        .registerListener(sensorListener, sensor, 3, BackgroundThread.getHandler());
            }
        }
    }
                ...
                try {
                    if (ambientBrightnessStatsTracker.mTimer.started) {
                        ...
                        ambientBrightnessStats.log(
                                ...
                                ambientBrightnessStatsTracker.mTimer.started
                                        ? (float)
                                                ((r5.clock.elapsedTimeMillis() - r5.startTimeMillis)
                                                        / 1000.0d)
                                        : FullScreenMagnificationGestureHandler.MAX_SCALE);
                    }
