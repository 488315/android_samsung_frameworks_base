...
public final class DisplayPowerController2
  ...
  public static final PathInterpolator COLOR_FADE_PATH_INTERPOLATOR =
      new PathInterpolator(0.45f, 0.18f, 0.35f, 1.0f);
  ...
  public final Animator.AnimatorListener mAnimatorListener =
      new Animator
          .AnimatorListener() { // from class: com.android.server.display.DisplayPowerController2.4
  ...
  public Runnable mBrightnessAnimationEndRunnable =
      new Runnable() { // from class: com.android.server.display.DisplayPowerController2.5
        @Override // java.lang.Runnable
        public void run() {
          if (!DisplayPowerController2.this.mBrightnessAnimationConsumerInvoked
              || DisplayPowerController2.this.mScreenBrightnessRampAnimator.isAnimating()) {
            return;
          }
  ...
  public final RampAnimator.Listener mRampAnimatorListener =
      new RampAnimator
          .Listener() { // from class: com.android.server.display.DisplayPowerController2.6
        @Override // com.android.server.display.RampAnimator.Listener
        public void onAnimationEnd() {
          if (CoreRune.FW_VRR_REFRESH_RATE_TOKEN) {
            DisplayPowerController2.this.mHandler.removeCallbacks(
                DisplayPowerController2.this.mBrightnessAnimationEndRunnable);
            DisplayPowerController2.this.mHandler.postDelayed(
                DisplayPowerController2.this.mBrightnessAnimationEndRunnable, 200L);
          }
          DisplayPowerController2.this.sendUpdatePowerState();
          DisplayPowerController2.this.mHandler.sendMessageAtTime(
              DisplayPowerController2.this.mHandler.obtainMessage(10),
              DisplayPowerController2.this.mClock.uptimeMillis());
        }
      };
  public final Runnable mCleanListener =
      new Runnable() { // from class:
                       // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda4
        @Override // java.lang.Runnable
  ...
  static {
    ...
    RATE_FROM_DOZE_TO_ON =
        PowerManagerUtil.SEC_FEATURE_FULLSCREEN_AOD ? 0.03f : RATE_FROM_DOZE_TO_ON;
    DEFAULT_WEIGHT_FOR_BRIGHTNESS_TRANSITION = 180;
    MAX_AUTO_BRIGHTNESS_TRANSITION_TIME = 60000;
  }

  /* JADX WARN: Multi-variable type inference failed */
  public DisplayPowerController2(
      Context context,
      Injector injector,
    ...
    DisplayControllerHandler displayControllerHandler =
        new DisplayControllerHandler(handler.getLooper());
    ...
    this.mIsDisplayInternal =
        logicalDisplay.getPrimaryDisplayDeviceLocked().getDisplayDeviceInfoLocked().type == 1;
    WakelockController wakelockController =
        injector2.getWakelockController(displayIdLocked, displayPowerCallbacks);
    this.mWakelockController = wakelockController;
    DisplayPowerProximityStateController displayPowerProximityStateController =
        injector2.getDisplayPowerProximityStateController(
            wakelockController,
            this.mDisplayDeviceConfig,
            displayControllerHandler.getLooper(),
            new Runnable() { // from class:
                             // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda5
              @Override // java.lang.Runnable
              public final void run() {
    ...
    this.mDisplayStateController =
        new DisplayStateController(displayPowerProximityStateController, displayIdLocked);
    AutomaticBrightnessStrategy automaticBrightnessStrategy =
        new AutomaticBrightnessStrategy(context, displayIdLocked);
    ...
    if (displayIdLocked == 0
        || (PowerManagerUtil.SEC_FEATURE_FLIP_COVER_DISPLAY && displayIdLocked == 1)) {
    ...
    this.mWindowManagerPolicy =
        (WindowManagerPolicy) LocalServices.getService(WindowManagerPolicy.class);
    this.mAodManagerInternal =
        (AODManagerInternal) LocalServices.getService(AODManagerInternal.class);
    ...
    this.mScreenBrightnessDozeConfig =
        BrightnessUtils.clampAbsoluteBrightness(powerManager.getBrightnessConstraint(4));
    ...
    this.mScreenBrightnessMinimumDimAmount =
        resources.getFloat(R.dimen.config_minScrollbarTouchTarget);
    ...
    this.mDisplayBrightnessController =
        new DisplayBrightnessController(
            context,
            null,
            displayIdLocked,
            logicalDisplay.getDisplayInfoLocked().brightnessDefault,
            brightnessSetting,
            new Runnable() { // from class:
                             // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda6
              @Override // java.lang.Runnable
              public final void run() {
    ...
    if (PowerManagerUtil.USE_SEC_LONG_TERM_MODEL
        && (brightnessMappingStrategy = this.mInteractiveModeBrightnessMapper) != null
        && displayIdLocked == 0) {
      this.mBrightnessTracker = null;
      this.mAdaptiveBrightnessLongtermModelBuilder =
          injector3.getAdaptiveBrightnessLongtermModelBuilder(
              context, null, brightnessMappingStrategy);
    } else {
    ...
    this.mDisplayBlanksAfterDozeConfig =
        resources.getBoolean(R.bool.config_defaultAdasGnssLocationEnabled);
    this.mBrightnessBucketsInDozeConfig =
        resources.getBoolean(R.bool.config_defaultBatteryPercentageSetting);
    this.mBootCompleted = z;
    if (this.mIsDisplayInternal) {
      this.mShutdownReceiver = new ShutdownReceiver();
      displayControllerHandler.post(
          new Runnable() { // from class:
                           // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    automaticBrightnessStrategy.setUseAutoBrightness(
        Settings.System.getIntForUser(
                context.getContentResolver(), this.mScreenBrightnessModeSettingName, 0, -2)
            == 1);
    Slog.m72d(
        str,
        "Create new DPC2 instance, mDisplayId="
            + displayIdLocked
            + " AutomaticBrightnessController="
            + this.mAutomaticBrightnessController
            + " mInteractiveModeBrightnessMapper="
            + this.mInteractiveModeBrightnessMapper);
  }
  ...
  public final void handleRbcChanged() {
    ...
    if ((!automaticBrightnessController.isInIdleMode()
            && this.mInteractiveModeBrightnessMapper == null)
        || (this.mAutomaticBrightnessController.isInIdleMode()
            && this.mIdleModeBrightnessMapper == null)) {
  ...
  public final void handleOnSwitchUser(int i) {
    ...
    if (PowerManagerUtil.USE_SEC_LONG_TERM_MODEL
        || (brightnessTracker = this.mBrightnessTracker) == null) {
      return;
    }
  ...
  */
  public boolean requestPowerState(
    ...
    synchronized (this.mLock) {
      ...
      boolean pendingWaitForNegativeProximityLocked =
          this.mDisplayPowerProximityStateController.setPendingWaitForNegativeProximityLocked(z);
      DisplayManagerInternal.DisplayPowerRequest displayPowerRequest2 = this.mPendingRequestLocked;
      if (displayPowerRequest2 == null) {
        this.mPendingRequestLocked =
            new DisplayManagerInternal.DisplayPowerRequest(displayPowerRequest);
      } else {
  ...
  @Override // com.android.server.display.DisplayPowerControllerInterface
  public BrightnessConfiguration getAppliedBackupConfiguration(
  ...
  public void onDisplayChanged(final HighBrightnessModeMetadata highBrightnessModeMetadata, int i) {
    ...
    final DisplayDevice primaryDisplayDeviceLocked =
        this.mLogicalDisplay.getPrimaryDisplayDeviceLocked();
    if (primaryDisplayDeviceLocked == null) {
      Slog.wtf(
          this.mTag,
          "Display Device is null in DisplayPowerController2 for display: "
              + this.mLogicalDisplay.getDisplayIdLocked());
      return;
    }
    final String uniqueId = primaryDisplayDeviceLocked.getUniqueId();
    final DisplayDeviceConfig displayDeviceConfig =
        primaryDisplayDeviceLocked.getDisplayDeviceConfig();
    final IBinder displayTokenLocked = primaryDisplayDeviceLocked.getDisplayTokenLocked();
    final DisplayDeviceInfo displayDeviceInfoLocked =
        primaryDisplayDeviceLocked.getDisplayDeviceInfoLocked();
    ...
    final boolean z =
        this.mLogicalDisplay.getPrimaryDisplayDeviceLocked() != null
            && this.mLogicalDisplay
                    .getPrimaryDisplayDeviceLocked()
                    .getDisplayDeviceInfoLocked()
                    .type
                == 1;
    final String str =
        this.mLogicalDisplay.getDisplayInfoLocked().thermalBrightnessThrottlingDataId;
    this.mHandler.postAtTime(
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
            DisplayPowerController2.this.lambda$onDisplayChanged$3(
                primaryDisplayDeviceLocked,
                uniqueId,
                displayDeviceConfig,
                str,
                displayTokenLocked,
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public /* synthetic */ void lambda$onDisplayChanged$3(
    ...
    if (this.mDisplayDevice != displayDevice) {
      ...
      this.mThermalBrightnessThrottlingDataId = str2;
      this.mBrightnessThrottler.loadThermalBrightnessThrottlingDataFromDisplayDeviceConfig(
      ...
      if (!PowerManagerUtil.SEC_FEATURE_DUAL_DISPLAY
          && this.mHbmController.isResolutionChanged(i, i2)) {
  ...
  public final void loadFromDisplayDeviceConfig(
      IBinder iBinder,
      DisplayDeviceInfo displayDeviceInfo,
      HighBrightnessModeMetadata highBrightnessModeMetadata) {
    if (PowerManagerUtil.SEC_FEATURE_DUAL_DISPLAY && this.mIsDisplayInternal) {
      ...
      this.mHbmController.resetHbmData(
          displayDeviceInfo.width,
          displayDeviceInfo.height,
          iBinder,
          displayDeviceInfo.uniqueId,
          this.mDisplayDeviceConfig.getHighBrightnessModeData(),
          new HighBrightnessModeController
              .HdrBrightnessDeviceConfig() { // from class:
                                             // com.android.server.display.DisplayPowerController2.2
            ...
            public float getHdrBrightnessFromSdr(float f, float f2) {
              return DisplayPowerController2.this.mDisplayDeviceConfig.getHdrBrightnessFromSdr(
                  f, f2);
            }
          });
      return;
    ...
    if (dualRampAnimator != null) {
      dualRampAnimator.setAnimationTimeLimits(
          this.mBrightnessRampIncreaseMaxTimeMillis, this.mBrightnessRampDecreaseMaxTimeMillis);
    }
    this.mHbmController.setHighBrightnessModeMetadata(highBrightnessModeMetadata);
    this.mHbmController.resetHbmData(
        displayDeviceInfo.width,
        ...
        new HighBrightnessModeController
            .HdrBrightnessDeviceConfig() { // from class:
                                           // com.android.server.display.DisplayPowerController2.3
          @Override // com.android.server.display.HighBrightnessModeController.HdrBrightnessDeviceConfig
          public float getHdrBrightnessFromSdr(float f, float f2) {
    ...
    this.mBrightnessThrottler.loadThermalBrightnessThrottlingDataFromDisplayDeviceConfig(
        this.mDisplayDeviceConfig.getThermalBrightnessThrottlingDataMapByThrottlingId(),
        this.mThermalBrightnessThrottlingDataId,
        this.mUniqueDisplayId);
  }
  ...
  public final void initialize(int i) {
    DisplayPowerState displayPowerState =
        this.mInjector.getDisplayPowerState(
            this.mBlanker,
            this.mColorFadeEnabled ? new ColorFade(this.mDisplayId) : null,
            this.mDisplayId,
            i);
    ...
    if (this.mColorFadeEnabled) {
      ...
      ObjectAnimator ofFloat =
          ObjectAnimator.ofFloat(displayPowerState, floatProperty, RATE_FROM_DOZE_TO_ON, 1.0f);
      this.mColorFadeOnAnimator = ofFloat;
      ofFloat.setDuration(160L);
      this.mColorFadeOnAnimator.addListener(this.mAnimatorListener);
      ObjectAnimator ofFloat2 =
          ObjectAnimator.ofFloat(this.mPowerState, floatProperty, 1.0f, RATE_FROM_DOZE_TO_ON);
      this.mColorFadeOffAnimator = ofFloat2;
      ofFloat2.setDuration(320L);
      this.mColorFadeOffAnimator.addListener(this.mAnimatorListener);
    }
    RampAnimator.DualRampAnimator dualRampAnimator =
        this.mInjector.getDualRampAnimator(
            this.mPowerState,
    ...
    float convertToAdjustedNits =
        this.mDisplayBrightnessController.convertToAdjustedNits(
            this.mPowerState.getScreenBrightness());
    ...
    this.mDisplayBrightnessController.registerBrightnessSettingChangeListener(
        new BrightnessSetting
            .BrightnessSettingListener() { // from class:
                                           // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda8
    ...
    this.mContext
        .getContentResolver()
        .registerContentObserver(
            Settings.System.getUriFor(this.mScreenBrightnessModeSettingName),
            false,
            this.mSettingsObserver,
            -1);
    if (this.mIsDisplayInternal) {
      this.mContext
          .getContentResolver()
          .registerContentObserver(
              Settings.Secure.getUriFor("game_autobrightness_lock"),
              false,
              this.mSettingsObserver,
              -1);
    }
    if (this.mIsCoverDisplay && !PowerManagerUtil.SHIP_BUILD) {
      this.mContext
          .getContentResolver()
          .registerContentObserver(
              Settings.System.getUriFor("cover_screen_demo_mode"),
              false,
              this.mSettingsObserver,
              -1);
    }
  ...
  public /* synthetic */ void lambda$initialize$4(float f) {
    this.mHandler.sendMessageAtTime(
        this.mHandler.obtainMessage(8, Float.valueOf(f)), this.mClock.uptimeMillis());
  }
  ...
  */
  public final void setUpAutoBrightness(Resources resources, Handler handler) {
    ...
    if (isAutoBrightnessAvailable) {
      ...
      if (brightnessMappingStrategy != null) {
        ...
        f =
            this.mInteractiveModeBrightnessMapper.convertToNits(
                this.mInteractiveModeBrightnessMapper.getUserBrightness());
        f2 = userLux;
      } else {
        f = -1.0f;
        f2 = -1.0f;
      ...
      this.mInteractiveModeBrightnessMapper =
          this.mInjector.getInteractiveModeBrightnessMapper(
              resources, this.mDisplayDeviceConfig, null);
      if (z) {
        this.mIdleModeBrightnessMapper =
            BrightnessMappingStrategy.createForIdleMode(resources, this.mDisplayDeviceConfig, null);
      }
      ...
      if (brightnessMappingStrategy2 != null) {
        if (brightnessMappingStrategy2
            instanceof BrightnessMappingStrategy.PhysicalMappingStrategy) {
          PowerManagerUtil.USE_SEC_LONG_TERM_MODEL = true;
        } else {
          PowerManagerUtil.USE_SEC_LONG_TERM_MODEL = false;
        }
        float fraction =
            resources.getFraction(R.fraction.config_prescaleAbsoluteVolume_index3, 1, 1);
        int[] intArray =
        ...
        HysteresisLevels hysteresisLevels3 =
            new HysteresisLevels(intArray, intArray2, intArray3, intArray4);
        ...
        if (PowerManagerUtil.SEC_LIGHT_SENSOR_BLOCKING_PREVENTION_MULTI) {
          ...
          int[] intArray8 =
              resources.getIntArray(R.array.config_force_cellular_transport_capabilities);
          HysteresisLevels hysteresisLevels5 =
              new HysteresisLevels(intArray, intArray2, intArray5, intArray6);
        ...
        long autoBrightnessBrighteningLightDebounce =
            this.mDisplayDeviceConfig.getAutoBrightnessBrighteningLightDebounce();
        long autoBrightnessDarkeningLightDebounce =
            this.mDisplayDeviceConfig.getAutoBrightnessDarkeningLightDebounce();
        ...
        if (50 > integer2) {
          Slog.m79w(
              this.mTag,
              "Expected config_autoBrightnessInitialLightSensorRate (50) to be less than or equal"
                  + " to config_autoBrightnessLightSensorRate ("
                  + integer2
                  + ").");
        }
        ...
        if (f >= RATE_FROM_DOZE_TO_ON) {
          ...
          if (convertToFloatScale != Float.NaN) {
            ...
            AutomaticBrightnessController automaticBrightnessController2 =
                this.mInjector.getAutomaticBrightnessController(
                    this,
                    handler.getLooper(),
                    this.mSensorManager,
                    this.mLightSensor,
                    ...
                    integer2,
                    50,
                    autoBrightnessBrighteningLightDebounce,
                    ...
                    this.mContext,
                    this.mHbmController,
                    this.mBrightnessThrottler,
                    this.mIdleModeBrightnessMapper,
                    this.mDisplayDeviceConfig.getAmbientHorizonShort(),
                    this.mDisplayDeviceConfig.getAmbientHorizonLong(),
                    f2,
                    f3,
                    hysteresisLevels,
                    hysteresisLevels2);
            this.mAutomaticBrightnessController = automaticBrightnessController2;
            this.mDisplayBrightnessController.setAutomaticBrightnessController(
                automaticBrightnessController2);
            this.mAutomaticBrightnessStrategy.setAutomaticBrightnessController(
                this.mAutomaticBrightnessController);
            ...
            int[] screenOffBrightnessSensorValueToLux =
                this.mDisplayDeviceConfig.getScreenOffBrightnessSensorValueToLux();
            ...
            this.mScreenOffBrightnessSensorController =
                this.mInjector.getScreenOffBrightnessSensorController(
                    ...
                    sensor,
                    this.mHandler,
                    new DisplayPowerController$$ExternalSyntheticLambda8(),
        ...
        f3 = -1.0f;
        AutomaticBrightnessController automaticBrightnessController22 =
            this.mInjector.getAutomaticBrightnessController(
                this,
                handler.getLooper(),
                this.mSensorManager,
        ...
        this.mDisplayBrightnessController.setAutomaticBrightnessController(
            automaticBrightnessController22);
        this.mAutomaticBrightnessStrategy.setAutomaticBrightnessController(
            this.mAutomaticBrightnessController);
        this.mBrightnessEventRingBuffer = new RingBuffer(BrightnessEvent.class, 100);
        screenOffBrightnessSensorController = this.mScreenOffBrightnessSensorController;
        if (screenOffBrightnessSensorController != null) {}
        loadScreenOffBrightnessSensor();
        int[] screenOffBrightnessSensorValueToLux2 =
            this.mDisplayDeviceConfig.getScreenOffBrightnessSensorValueToLux();
        sensor = this.mScreenOffBrightnessSensor;
        if (sensor != null) {
          return;
  ...
  public final void loadBrightnessRampRates() {
    this.mBrightnessRampRateFastDecrease =
        this.mDisplayDeviceConfig.getBrightnessRampFastDecrease();
    this.mBrightnessRampRateFastIncrease =
        this.mDisplayDeviceConfig.getBrightnessRampFastIncrease();
    this.mBrightnessRampRateSlowDecrease =
        this.mDisplayDeviceConfig.getBrightnessRampSlowDecrease();
    this.mBrightnessRampRateSlowIncrease =
        this.mDisplayDeviceConfig.getBrightnessRampSlowIncrease();
    this.mBrightnessRampDecreaseMaxTimeMillis =
        this.mDisplayDeviceConfig.getBrightnessRampDecreaseMaxMillis();
    this.mBrightnessRampIncreaseMaxTimeMillis =
        this.mDisplayDeviceConfig.getBrightnessRampIncreaseMaxMillis();
  }
  ...
  public final void loadNitsRange(Resources resources) {
    ...
    if (displayDeviceConfig != null && displayDeviceConfig.getNits() != null) {
      ...
      this.mNitsRange =
          BrightnessMappingStrategy.getFloatArray(resources.obtainTypedArray(17236294));
    }
  }
  ...
  public final void reloadReduceBrightColours() {
    ...
    if (colorDisplayServiceInternal == null
        || !colorDisplayServiceInternal.isReduceBrightColorsActivated()) {
      return;
    }
  ...
  public final void cleanupHandlerThreadAfterStop() {
    ...
    reportStats(
        displayPowerState != null ? displayPowerState.getScreenBrightness() : RATE_FROM_DOZE_TO_ON);
  ...
  */
  public final void updatePowerStateInternal() {
    ...
    synchronized (this.mLock) {
      ...
      if (displayPowerRequest3 == null) {
        this.mPowerRequest =
            new DisplayManagerInternal.DisplayPowerRequest(this.mPendingRequestLocked);
      ...
      int updateDisplayState =
          this.mDisplayStateController.updateDisplayState(
              this.mPowerRequest, this.mIsEnabled, this.mIsInTransition);
      ScreenOffBrightnessSensorController screenOffBrightnessSensorController2 =
          this.mScreenOffBrightnessSensorController;
      if (screenOffBrightnessSensorController2 != null) {
        screenOffBrightnessSensorController2.setLightSensorEnabled(
            this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()
                && this.mIsEnabled
      ...
      animateScreenStateChange(
          updateDisplayState, this.mDisplayStateController.shouldPerformScreenOffTransition());
      int screenState2 = this.mPowerState.getScreenState();
      boolean updateUserSetScreenBrightness =
          this.mDisplayBrightnessController.updateUserSetScreenBrightness();
      DisplayBrightnessState updateBrightness =
          this.mDisplayBrightnessController.updateBrightness(this.mPowerRequest, screenState2);
      ...
      boolean z33 = i17 == 1;
      boolean z34 =
          (i == 1 && i17 == 3 && Display.isOnState(screenState))
              || (Display.isDozeState(screenState) && Display.isOnState(screenState2));
      if (this.mIsSupportedAodMode
          && Float.isNaN(brightness)
          && ((z32 || this.mPendingScreenOnByAodReady || z33)
              && !PowerManagerUtil.isFakeAodAvailable(this.mDualScreenPolicy))) {
      ...
      this.mAutomaticBrightnessStrategy.setAutoBrightnessState(
          screenState2,
          this.mDisplayBrightnessController.isAllowAutoBrightnessWhileDozingConfig(),
          brightness,
          this.mBrightnessReasonTemp.getReason(),
          this.mPowerRequest.policy,
          this.mDisplayBrightnessController.getLastUserSetScreenBrightness(),
          updateUserSetScreenBrightness,
          isLightSensorCovered(),
          z3,
          this.mDualScreenPolicy);
      if (this.mAutoBrightnessEnabled
          != this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()) {
      ...
      boolean z36 =
          Float.isNaN(brightness)
              && (this.mAutomaticBrightnessStrategy.getAutoBrightnessAdjustmentChanged()
                  || updateUserSetScreenBrightness);
      this.mHbmController.setAutoBrightnessEnabled(
          (this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()
                  || (this.mEarlyWakeupEnabled
                      && this.mEarlyWakeUpManager.isEarlyLightSensorEnabled()))
              ? 1
              : 2);
      ...
      if (Float.isNaN(brightness)) {
        if (this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()) {
          float automaticScreenBrightness =
              this.mAutomaticBrightnessStrategy.getAutomaticScreenBrightness(
                  this.mTempBrightnessEvent);
          if (BrightnessUtils.isValidBrightnessValue(automaticScreenBrightness)
              || automaticScreenBrightness == RATE_FROM_DOZE_TO_ON) {
            ...
            z4 =
                this.mAutomaticBrightnessStrategy.hasAppliedAutoBrightness()
                    && !this.mAutomaticBrightnessStrategy.getAutoBrightnessAdjustmentChanged()
                    && z30;
            if (z4
                && (PowerManagerUtil.USE_PERSONAL_AUTO_BRIGHTNESS_V3
                    || PowerManagerUtil.USE_PERSONAL_AUTO_BRIGHTNESS_V4)) {
              BrightnessDynamicRampRatePair brightnessDynamicRampRatePair =
                  getBrightnessDynamicRampRatePair(brightness, ambientLux);
            ...
            if (Float.isNaN(brightness)
              ...
              if (BrightnessUtils.isValidBrightnessValue(brightness)) {
                ...
                boolean z37 =
                    this.mDisplayBrightnessController.getCurrentBrightness()
            ...
            if (Float.isNaN(brightness)) {
              ...
              if (this.mAppliedForceDimming
                  && !Float.isNaN(this.mLastScreenBrightnessSettingBeforeForceDim)) {
            ...
            if (this.mIsDisplayInternal && screenState2 == 2) {
              ...
              if (displayPowerRequest.policy == 3
                ...
                z28 =
                    !this.mBatteryLevelCritical
                        && this.mLastBatteryLevelCriticalTime
                            > sLastScreenBrightnessSettingChangedTime
                        && !displayPowerRequest.isPowered
                        && (!this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()
                            || ((automaticBrightnessController3 =
                                        this.mAutomaticBrightnessController)
                                    != null
                                && automaticBrightnessController3.isAmbientLuxValid()));
                if (!z28 && !this.mAppliedForceDimming) {
                  ...
                  if (this.mBrightnessReasonTemp.mReason == 4) {
                    ...
                    this.mLastScreenBrightnessSettingBeforeForceDim =
                        this.mDisplayBrightnessController.getCurrentBrightness();
                  }
                  if (!z34) {}
                  z29 = false;
                ...
                if (this.mAppliedForceDimming || brightness <= RATE_FROM_DOZE_TO_ON) {
                  ...
                  float max =
                      Math.max(
                          Math.min(
                              brightness - this.mScreenBrightnessMinimumDimAmount,
                              this.mScreenBrightnessDimConfig),
                          RATE_FROM_DOZE_TO_ON);
                ...
                if (!this.mBrightnessThrottler.isThrottled()) {
                  this.mTempBrightnessEvent.setThermalMax(
                      this.mBrightnessThrottler.getBrightnessCap());
                ...
                AutomaticBrightnessController automaticBrightnessController4 =
                    this.mAutomaticBrightnessController;
                float ambientLux2 =
                    automaticBrightnessController4 != null
                        ? RATE_FROM_DOZE_TO_ON
                        : automaticBrightnessController4.getAmbientLux();
                boolean z38 = z4;
                i3 = 0;
                while (i3 < clone.size()) {
                  ((DisplayPowerControllerInterface) clone.valueAt(i3))
                      .setBrightnessToFollow(
                          currentBrightness,
                          this.mDisplayBrightnessController.convertToNits(currentBrightness),
                          ambientLux2);
                  i3++;
                  f2 = f2;
                }
                ...
                if (z5) {
                  ...
                  if (this.mPowerRequest.policy != 2) {
                    ...
                    if (this.mPowerRequest.policy == i4) {
                      if (f5 > RATE_FROM_DOZE_TO_ON) {
                        f5 =
                            Math.max(
                                Math.min(
                                    f5 - this.mScreenBrightnessMinimumDimAmount,
                                    this.mScreenBrightnessDimConfig),
                                RATE_FROM_DOZE_TO_ON);
                        z26 = true;
                      ...
                      if (f5 > RATE_FROM_DOZE_TO_ON) {
                        f5 =
                            Math.max(
                                f5
                                    * Math.min(
                                        this.mPowerRequest.screenLowPowerBrightnessFactor, 1.0f),
                                RATE_FROM_DOZE_TO_ON);
                    ...
                    this.mHbmController.onBrightnessChanged(
                        finalBrightness, f4, this.mBrightnessThrottler.getBrightnessMaxReason());
                    boolean z39 =
                        this.mBrightnessReasonTemp.getReason() != 7
                            || this.mAutomaticBrightnessStrategy
                    ...
                    if (!this.mPendingScreenOff) {
                      if (this.mSkipScreenOnBrightnessRamp) {
                        ...
                        if (screenState2 == 2) {
                          ...
                          if (i18 == 0 && this.mDozing) {
                            ...
                            this.mSkipRampState = 1;
                              ...
                              && this.mUseSoftwareAutoBrightnessConfig
                              && !BrightnessSynchronizer.floatEquals(
                                  finalBrightness, this.mInitialAutoBrightness)) {
                            i11 = 2;
                        ...
                        boolean z40 =
                            !(screenState2 == i11 || this.mSkipRampState == 0)
                                || this.mDisplayPowerProximityStateController
                                    .shouldSkipRampBecauseOfProximityChangeToNegative();
                        boolean z41 =
                            !this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()
                                && (!this.mInitialAutoBrightnessUpdated || z3)
                                && !this.mWaitingAutoBrightnessFromDoze;
                        boolean z42 =
                            !Display.isDozeState(screenState2)
                                && this.mBrightnessReason.mReason == 11;
                        boolean isDozeState = Display.isDozeState(screenState2);
                        boolean z43 =
                            PowerManagerUtil.SEC_FEATURE_AOD_BRIGHTNESS_ANIM && isDozeState;
                        if (Display.isDozeState(screenState2)) {
                          ...
                          if (this.mBrightnessBucketsInDozeConfig) {
                            ...
                            z17 = true;
                            if (this.mColorFadeEnabled
                                || this.mPowerState.getColorFadeLevel() != 1.0f) {
                              z18 = z31;
                              z19 = false;
                            } else {
                              z18 = z31;
                            ...
                            float clampScreenBrightnessForFinal =
                                clampScreenBrightnessForFinal(finalBrightness);
                            f6 = f4;
                            i5 = i2;
                              ...
                              boolean z45 =
                                  !this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()
                                      || ((automaticBrightnessController2 =
                                                  this.mAutomaticBrightnessController)
                                              != null
                                          && automaticBrightnessController2.isAmbientLuxValid());
                              if (!z44 && z45) {
                                ...
                                float sdrScreenBrightness =
                                    this.mPowerState.getSdrScreenBrightness();
                                boolean shouldEnableMoreFastRampRateCase =
                                    shouldEnableMoreFastRampRateCase();
                                ...
                                boolean z47 =
                                    Math.abs(
                                                BrightnessSynchronizer.brightnessFloatToInt(
                                                        this.mScreenBrightnessRampAnimator
                                                            .getCurrentValue())
                                                    - BrightnessSynchronizer.brightnessFloatToInt(
                                                        f9))
                                            > 1
                                        && !this.mScreenBrightnessRampAnimator.isAnimating();
                                if (BrightnessUtils.isValidBrightnessValue(f9)
                                    || (f9 == screenBrightness
                                        && clampScreenBrightnessForFinal == sdrScreenBrightness)) {
                                  f10 = 0.0f;
                                  f11 = Float.NaN;
                                } else if (z40
                                    || z17
                                    || !z19
                                    || ((z39 && !this.mForceSlowChange)
                                        || this.mPassRampAnimation
                                        || z41
                                        || z42
                                        || z43
                                        || ((this.mBrightnessReasonTemp.getReason() == 6
                                                && this.mBrightnessReasonTemp
                                                    .isStartBrightnessChanged(
                                                        this.mBrightnessReason)
                                                && !shouldEnableMoreFastRampRateCase
                                                && !this.mAppliedDimming)
                                            || z10
                                            || z47))) {
                                  animateScreenBrightness(
                                      f9,
                                      clampScreenBrightnessForFinal,
                                      RATE_FROM_DOZE_TO_ON,
                                      RATE_FROM_DOZE_TO_ON);
                                  f11 = 0.0f;
                                  f10 = 0.0f;
                                  ...
                                  if (z48 && z38) {
                                    ...
                                    if (this.mScreenBrightnessRampAnimator.getTarget() != f9) {
                                      animateScreenBrightness(
                                          f9, clampScreenBrightnessForFinal, f10, f14);
                                    }
                                    f11 = f14;
                                  } else {
                                ...
                                for (i13 = 0; i13 < clone.size(); i13++) {
                                  ((DisplayPowerControllerInterface) clone.valueAt(i13))
                                      .setRampSpeedToFollower(f10, f11);
                                }
                                if (!this.mScreenBrightnessRampAnimator.isAnimating()
                                    && this.mForceSlowChange) {
                                ...
                                saveBrightnessInfo =
                                    saveBrightnessInfo(getScreenBrightnessSetting(), f9);
                                z12 = z18;
                              } else {
                                z21 = z11;
                            ...
                            boolean shouldEnableMoreFastRampRateCase2 =
                                shouldEnableMoreFastRampRateCase();
                            ...
                            if (Math.abs(
                                    BrightnessSynchronizer.brightnessFloatToInt(
                                            this.mScreenBrightnessRampAnimator.getCurrentValue())
                                        - BrightnessSynchronizer.brightnessFloatToInt(f9))
                                > 1) {}
                            if (BrightnessUtils.isValidBrightnessValue(f9)) {}
                            f10 = 0.0f;
                            f11 = Float.NaN;
                        ...
                        z18 = z31;
                        z19 = false;
                        float clampScreenBrightnessForFinal2 =
                            clampScreenBrightnessForFinal(finalBrightness);
                        f6 = f4;
                        i5 = i2;
                        if (this.mHbmController.getHighBrightnessMode() == 2) {}
                        ...
                        boolean shouldEnableMoreFastRampRateCase22 =
                            shouldEnableMoreFastRampRateCase();
                      ...
                      z18 = z31;
                      z19 = false;
                      float clampScreenBrightnessForFinal22 =
                          clampScreenBrightnessForFinal(finalBrightness);
                      f6 = f4;
                      i5 = i2;
                      if (this.mHbmController.getHighBrightnessMode() == 2) {}
                      ...
                      boolean shouldEnableMoreFastRampRateCase222 =
                          shouldEnableMoreFastRampRateCase();
                    ...
                    if (this.mBrightnessReasonTemp.equals(this.mBrightnessReason) || i5 != 0) {
                      ...
                      if (this.mBrightnessReasonTemp.getReason() == 1
                          && updateUserSetScreenBrightness) {
                    ...
                    this.mTempBrightnessEvent.setHbmMax(
                        this.mHbmController.getCurrentBrightnessMax());
                    this.mTempBrightnessEvent.setHbmMode(
                        this.mHbmController.getHighBrightnessMode());
                    ...
                    ColorDisplayService.ColorDisplayServiceInternal colorDisplayServiceInternal =
                        this.mCdsi;
                    brightnessEvent3.setRbcStrength(
                        colorDisplayServiceInternal != null
                            ? colorDisplayServiceInternal.getReduceBrightColorsStrength()
                            : -1);
                    this.mTempBrightnessEvent.setPowerFactor(
                        this.mPowerRequest.screenLowPowerBrightnessFactor);
                    this.mTempBrightnessEvent.setWasShortTermModelActive(isShortTermModelActive);
                    this.mTempBrightnessEvent.setDisplayBrightnessStrategyName(
                        updateBrightness.getDisplayBrightnessStrategyName());
                    this.mTempBrightnessEvent.setAutomaticBrightnessEnabled(
                        this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness());
                    boolean z49 =
                        this.mTempBrightnessEvent.getReason().getReason() != 7
                            && this.mLastBrightnessEvent.getReason().getReason() == 7;
                    z13 =
                        this.mLastBrightnessEvent.isRbcEnabled()
                            != this.mTempBrightnessEvent.isRbcEnabled();
                    if ((!this.mTempBrightnessEvent.equalsMainData(this.mLastBrightnessEvent)
                            && !z49)
                        || i9 != 0) {
                      this.mTempBrightnessEvent.setInitialBrightness(
                          this.mLastBrightnessEvent.getBrightness());
                      ...
                      brightnessEvent.setFlags(
                          brightnessEvent.getFlags() | (!updateUserSetScreenBrightness ? 8 : 0));
                      Slog.m76i(this.mTag, brightnessEvent.toString(false));
                      if (!updateUserSetScreenBrightness
                          || brightnessEvent.getReason().getReason() != 7) {
                    ...
                    z14 =
                        (this.mPendingScreenOnUnblocker == null
                                || (this.mColorFadeEnabled
                                    && (this.mColorFadeOnAnimator.isStarted()
                                        || this.mColorFadeOffAnimator.isStarted()))
                                || !this.mPowerState.waitUntilClean(this.mCleanListener)
                                || this.mPendingScreenOnByAodReady)
                            ? false
                            : true;
                    ...
                    boolean z50 =
                        this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()
                            || ((automaticBrightnessController =
                                        this.mAutomaticBrightnessController)
                                    != null
                                && automaticBrightnessController.isAmbientLuxValid());
                    if (z14 && z12 && z50) {
                      synchronized (this.mLock) {
                        if (!this.mPendingRequestChangedLocked) {
                    ...
                    if (z15) {
                      ...
                      if (i8 == 1) {
                        ...
                        if (screenOffProfiler.isStarted()
                            && !screenOffProfiler.mSaved
                            && this.mPowerRequest.lastGoToSleepReason != 3) {
                          screenOffProfiler.mSaved = true;
                          z16 = false;
                          Slog.m72d(this.mTag, screenOffProfiler.toString(false));
                          PowerManagerUtil.sScreenOffProfilers.append(
                              new PowerManagerUtil.ScreenOffProfiler(screenOffProfiler));
                ...
                if (this.mForceSlowChange) {}
                this.mHbmController.onBrightnessChanged(
                    finalBrightness2, f4, this.mBrightnessThrottler.getBrightnessMaxReason());
                ...
                ColorDisplayService.ColorDisplayServiceInternal colorDisplayServiceInternal2 =
                    this.mCdsi;
                brightnessEvent32.setRbcStrength(
                    colorDisplayServiceInternal2 != null
                        ? colorDisplayServiceInternal2.getReduceBrightColorsStrength()
                        : -1);
                this.mTempBrightnessEvent.setPowerFactor(
                    this.mPowerRequest.screenLowPowerBrightnessFactor);
                this.mTempBrightnessEvent.setWasShortTermModelActive(isShortTermModelActive);
                ...
                if (this.mLastBrightnessEvent.isRbcEnabled()
                    != this.mTempBrightnessEvent.isRbcEnabled()) {}
                if (!this.mTempBrightnessEvent.equalsMainData(this.mLastBrightnessEvent)) {
                  this.mTempBrightnessEvent.setInitialBrightness(
                      this.mLastBrightnessEvent.getBrightness());
            ...
            z10 = false;
            if (!this.mBrightnessThrottler.isThrottled()) {}
            AutomaticBrightnessController automaticBrightnessController42 =
                this.mAutomaticBrightnessController;
            ...
            if (this.mForceSlowChange) {}
            this.mHbmController.onBrightnessChanged(
                finalBrightness22, f4, this.mBrightnessThrottler.getBrightnessMaxReason());
            if (this.mBrightnessReasonTemp.getReason() != 7) {}
            if (!this.mPendingScreenOff) {}
            if (saveBrightnessInfo) {}
            if (this.mBrightnessReasonTemp.equals(this.mBrightnessReason)) {}
            ...
            ColorDisplayService.ColorDisplayServiceInternal colorDisplayServiceInternal22 =
                this.mCdsi;
            brightnessEvent322.setRbcStrength(
                colorDisplayServiceInternal22 != null
                    ? colorDisplayServiceInternal22.getReduceBrightColorsStrength()
                    : -1);
            this.mTempBrightnessEvent.setPowerFactor(
                this.mPowerRequest.screenLowPowerBrightnessFactor);
            this.mTempBrightnessEvent.setWasShortTermModelActive(isShortTermModelActive);
      ...
      if (this.mIsDisplayInternal) {
        ...
        if (displayPowerRequest.policy == 3) {
          ...
          z10 = z29;
          if (!this.mBrightnessThrottler.isThrottled()) {}
          AutomaticBrightnessController automaticBrightnessController422 =
              this.mAutomaticBrightnessController;
          ...
          if (this.mForceSlowChange) {}
          this.mHbmController.onBrightnessChanged(
              finalBrightness222, f4, this.mBrightnessThrottler.getBrightnessMaxReason());
          if (this.mBrightnessReasonTemp.getReason() != 7) {}
          if (!this.mPendingScreenOff) {}
          if (saveBrightnessInfo) {}
          if (this.mBrightnessReasonTemp.equals(this.mBrightnessReason)) {}
          ...
          ColorDisplayService.ColorDisplayServiceInternal colorDisplayServiceInternal222 =
              this.mCdsi;
          brightnessEvent3222.setRbcStrength(
              colorDisplayServiceInternal222 != null
                  ? colorDisplayServiceInternal222.getReduceBrightColorsStrength()
                  : -1);
          this.mTempBrightnessEvent.setPowerFactor(
              this.mPowerRequest.screenLowPowerBrightnessFactor);
          this.mTempBrightnessEvent.setWasShortTermModelActive(isShortTermModelActive);
      ...
      z10 = false;
      if (!this.mBrightnessThrottler.isThrottled()) {}
      AutomaticBrightnessController automaticBrightnessController4222 =
          this.mAutomaticBrightnessController;
      ...
      if (this.mForceSlowChange) {}
      this.mHbmController.onBrightnessChanged(
          finalBrightness2222, f4, this.mBrightnessThrottler.getBrightnessMaxReason());
      if (this.mBrightnessReasonTemp.getReason() != 7) {}
      if (!this.mPendingScreenOff) {}
      if (saveBrightnessInfo) {}
      if (this.mBrightnessReasonTemp.equals(this.mBrightnessReason)) {}
      ...
      brightnessEvent32222.setRbcStrength(
          colorDisplayServiceInternal2222 != null
              ? colorDisplayServiceInternal2222.getReduceBrightColorsStrength()
              : -1);
  ...
  public final boolean shouldEnableMoreFastRampRateCase() {
    ...
    return (brightnessReason.mReason == 4 && this.mBrightnessReason.mReason != 4)
        || brightnessReason.isReasonChanged(this.mBrightnessReason, 6);
  }
  ...
  public void setBrightnessConfiguration(
    ...
    this.mHandler
        .obtainMessage(
            4, z ? 1 : 0, brightnessConfiguration == null ? 1 : 0, brightnessConfiguration)
        .sendToTarget();
    ...
    this.mHandler.sendMessageDelayed(
        this.mHandler.obtainMessage(15), ClipboardService.DEFAULT_CLIPBOARD_TIMEOUT_MILLIS);
  }
  ...
  public BrightnessInfo getBrightnessInfo() {
    ...
    synchronized (this.mCachedBrightnessInfo) {
      ...
      brightnessInfo =
          new BrightnessInfo(
              cachedBrightnessInfo.brightness.value,
              cachedBrightnessInfo.adjustedBrightness.value,
              cachedBrightnessInfo.brightnessMin.value,
              cachedBrightnessInfo.brightnessMax.value,
              cachedBrightnessInfo.hbmMode.value,
              cachedBrightnessInfo.hbmTransitionPoint.value,
              cachedBrightnessInfo.brightnessMaxReason.value,
              cachedBrightnessInfo.isAnimating.value);
    }
  ...
  public final boolean saveBrightnessInfo(float f, float f2) {
    ...
    synchronized (this.mCachedBrightnessInfo) {
      float min =
          Math.min(
              this.mHbmController.getCurrentBrightnessMin(),
              this.mBrightnessThrottler.getBrightnessCap());
      float min2 =
          Math.min(
              this.mHbmController.getCurrentBrightnessMax(),
      ...
      boolean checkAndSetFloat =
          cachedBrightnessInfo.checkAndSetFloat(cachedBrightnessInfo.brightness, f);
      boolean z = false;
      CachedBrightnessInfo cachedBrightnessInfo2 = this.mCachedBrightnessInfo;
      boolean checkAndSetFloat2 =
          checkAndSetFloat
              | false
              | cachedBrightnessInfo2.checkAndSetFloat(
                  cachedBrightnessInfo2.adjustedBrightness, f2);
      CachedBrightnessInfo cachedBrightnessInfo3 = this.mCachedBrightnessInfo;
      boolean checkAndSetFloat3 =
          checkAndSetFloat2
              | cachedBrightnessInfo3.checkAndSetFloat(cachedBrightnessInfo3.brightnessMin, min);
      CachedBrightnessInfo cachedBrightnessInfo4 = this.mCachedBrightnessInfo;
      boolean checkAndSetFloat4 =
          checkAndSetFloat3
              | cachedBrightnessInfo4.checkAndSetFloat(cachedBrightnessInfo4.brightnessMax, min2);
      CachedBrightnessInfo cachedBrightnessInfo5 = this.mCachedBrightnessInfo;
      boolean checkAndSetInt =
          checkAndSetFloat4
              | cachedBrightnessInfo5.checkAndSetInt(
                  cachedBrightnessInfo5.hbmMode, this.mHbmController.getHighBrightnessMode());
      CachedBrightnessInfo cachedBrightnessInfo6 = this.mCachedBrightnessInfo;
      boolean checkAndSetFloat5 =
          checkAndSetInt
              | cachedBrightnessInfo6.checkAndSetFloat(
                  cachedBrightnessInfo6.hbmTransitionPoint,
                  this.mHbmController.getTransitionPoint());
      CachedBrightnessInfo cachedBrightnessInfo7 = this.mCachedBrightnessInfo;
      boolean checkAndSetInt2 =
          checkAndSetFloat5
              | cachedBrightnessInfo7.checkAndSetInt(
                  cachedBrightnessInfo7.brightnessMaxReason,
                  this.mBrightnessThrottler.getBrightnessMaxReason());
      ...
      checkAndSetBoolean =
          checkAndSetInt2
              | cachedBrightnessInfo8.checkAndSetBoolean(
                  mutableBoolean, dualRampAnimator != null && dualRampAnimator.isAnimating());
  ...
  public final HighBrightnessModeController createHbmControllerLocked() {
    DisplayDeviceConfig displayDeviceConfig =
        this.mLogicalDisplay.getPrimaryDisplayDeviceLocked().getDisplayDeviceConfig();
    IBinder displayTokenLocked =
        this.mLogicalDisplay.getPrimaryDisplayDeviceLocked().getDisplayTokenLocked();
    ...
    DisplayDeviceConfig.HighBrightnessModeData highBrightnessModeData =
        displayDeviceConfig != null ? displayDeviceConfig.getHighBrightnessModeData() : null;
    DisplayInfo displayInfoLocked = this.mLogicalDisplay.getDisplayInfoLocked();
    return new HighBrightnessModeController(
        this.mHandler,
        displayInfoLocked.logicalWidth,
        displayInfoLocked.logicalHeight,
        displayTokenLocked,
        uniqueId,
        Math.min(
            ((PowerManager) this.mContext.getSystemService(PowerManager.class))
                .getBrightnessConstraint(0),
            this.mScreenBrightnessDimConfig),
        this.mScreenExtendedBrightnessRangeMaximum,
        highBrightnessModeData,
        new HighBrightnessModeController
            .HdrBrightnessDeviceConfig() { // from class:
                                           // com.android.server.display.DisplayPowerController2.7
          @Override // com.android.server.display.HighBrightnessModeController.HdrBrightnessDeviceConfig
          public float getHdrBrightnessFromSdr(float f, float f2) {
            return DisplayPowerController2.this.mDisplayDeviceConfig.getHdrBrightnessFromSdr(f, f2);
          }
        ...
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda9
          @Override // java.lang.Runnable
          public final void run() {
            DisplayPowerController2.this.lambda$createHbmControllerLocked$5();
          }
        },
        this.mHighBrightnessModeMetadata,
        this.mContext);
  }
  ...
  public final BrightnessThrottler createBrightnessThrottlerLocked() {
    return new BrightnessThrottler(
        this.mHandler,
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final boolean setScreenState(int i, boolean z) {
    ...
    if (this.mPowerState.getScreenState() != i || this.mReportedScreenStateToPolicy == -1) {
      ...
      if (z2 && !this.mDisplayPowerProximityStateController.isScreenOffBecauseOfProximity()) {
        ...
        if (i3 == 2 || i3 == -1) {
          ...
          this.mWindowManagerPolicy.screenTurningOff(
              this.mDisplayId, this.mPendingScreenOffUnblocker);
          unblockScreenOff();
    ...
    if (z2
        ...
        && !this.mDisplayPowerProximityStateController.isScreenOffBecauseOfProximity()) {
  ...
  public final void loadScreenOffBrightnessSensor() {
    DisplayDeviceConfig.SensorData screenOffBrightnessSensor =
        this.mDisplayDeviceConfig.getScreenOffBrightnessSensor();
    this.mScreenOffBrightnessSensor =
        SensorUtils.findSensor(
            this.mSensorManager, screenOffBrightnessSensor.type, screenOffBrightnessSensor.name, 0);
  }
  ...
  public final void animateScreenBrightness(float f, float f2, float f3, float f4) {
    ...
    if (this.mScreenBrightnessRampAnimator.animateTo(f, f2, f3, f4)) {
      if (CoreRune.FW_VRR_REFRESH_RATE_TOKEN
          && this.mOnBrightnessAnimationConsumer != null
          && this.mScreenBrightnessRampAnimator.isAnimating()
          && !this.mBrightnessAnimationConsumerInvoked) {
  ...
  public final void animateScreenStateChange(int i, boolean z) {
    ...
    Slog.m72d(
        this.mTag,
        "animateScreenStateChange: target="
            + Display.stateToString(i)
            + ", mIsEnabled="
            + this.mIsEnabled);
    if (this.mColorFadeEnabled
        && (this.mColorFadeOnAnimator.isStarted() || this.mColorFadeOffAnimator.isStarted())) {
    ...
    if (this.mDisplayBlanksAfterDozeConfig
        && Display.isDozeState(this.mPowerState.getScreenState())
    ...
    if (i == 2) {
      if (this.mIsSupportedAodMode
          && PowerManagerUtil.SEC_FEATURE_AOD_DISABLE_CLOCK_TRANSITION
          && this.mPowerState.getScreenState() == 4) {
        setScreenState(3);
      }
      ...
      if (setScreenState(2)) {
        if (this.mAutomaticBrightnessController != null
            && this.mAutomaticBrightnessStrategy.isAutoBrightnessEnabled()
            && !this.mAutomaticBrightnessController.isAmbientLuxValid()
            && this.mPowerState.getScreenState() == 2
            && Float.isNaN(this.mPowerRequest.screenBrightnessOverride)
            && !isLightSensorCovered()
            && (!this.mIsCoverDisplay || this.mDualScreenPolicy == 1)) {
          Slog.m72d(
              this.mTag, "animateScreenStateChange is returned because lux is not yet valid!");
          return;
        } else {
    ...
    if (i == 6) {
      if (!this.mScreenBrightnessRampAnimator.isAnimating()
          || this.mPowerState.getScreenState() == 6) {
    ...
    if (z
        && this.mPowerState.prepareColorFade(this.mContext, i2)
        && this.mPowerState.getScreenState() != 1) {
      if (i2 == 3) {
  ...
  public final void handleSettingsChange(boolean z) {
    ...
    displayBrightnessController.setPendingScreenBrightness(
        displayBrightnessController.getScreenBrightnessSetting());
    ...
    if (z) {
      ...
      displayBrightnessController2.setAndNotifyCurrentScreenBrightness(
          displayBrightnessController2.getPendingScreenBrightness());
      if (!PowerManagerUtil.USE_SEC_LONG_TERM_MODEL
          && (automaticBrightnessController = this.mAutomaticBrightnessController) != null) {
    ...
    String format =
        String.format(
            " sb: %.3f abAdj: %.3f sbLock: %s",
            Float.valueOf(this.mDisplayBrightnessController.getPendingScreenBrightness()),
            Float.valueOf(this.mAutomaticBrightnessStrategy.getPendingAutoBrightnessAdjustment()),
            Boolean.valueOf(this.mAutomaticBrightnessStrategy.isGameAutoBrightnessLocked()));
    String str = this.mTag;
    StringBuilder sb = new StringBuilder();
  ...
  public final void handleBrightnessModeChange() {
    final int intForUser =
        Settings.System.getIntForUser(
            this.mContext.getContentResolver(), this.mScreenBrightnessModeSettingName, 0, -2);
    this.mHandler.postAtTime(
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda11
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$handleBrightnessModeChange$7(int i) {
    ...
    if (shouldUseAutoBrightness != this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()) {
      if (!this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()
    ...
    Slog.m72d(
        this.mTag,
        "[api] handleBrightnessModeChange: shouldUseAutoBrightness= "
            + this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness());
    lambda$new$0();
  }
  ...
  public final void notifyBrightnessTrackerChanged(
      float f, boolean z, boolean z2, boolean z3, boolean z4) {
    AutomaticBrightnessController automaticBrightnessController;
    AutomaticBrightnessController automaticBrightnessController2;
    float convertToAdjustedNits = this.mDisplayBrightnessController.convertToAdjustedNits(f);
    if (z4
        || (automaticBrightnessController = this.mAutomaticBrightnessController) == null
        || automaticBrightnessController.isInIdleMode()
        || !z3) {
      return;
    }
    if (PowerManagerUtil.USE_SEC_LONG_TERM_MODEL) {
    ...
    if (!this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()
        || convertToAdjustedNits < RATE_FROM_DOZE_TO_ON) {
      return;
    }
    if ((z
            && ((automaticBrightnessController2 = this.mAutomaticBrightnessController) == null
                || !automaticBrightnessController2.hasValidAmbientLux()))
        || this.mAutomaticBrightnessController.isHbmLux()) {
      z = false;
    }
    boolean z5 = z;
    ...
    if (f2 < RATE_FROM_DOZE_TO_ON || f2 == 1.0f) {
      ...
      float f3 =
          displayPowerRequest.lowPowerMode
              ? displayPowerRequest.screenLowPowerBrightnessFactor
              : 1.0f;
      if (PowerManagerUtil.USE_SEC_LONG_TERM_MODEL) {
        this.mAdaptiveBrightnessLongtermModelBuilder.notifyBrightnessChanged(
            convertToAdjustedNits,
            z5,
            f3,
            z2,
            this.mAutomaticBrightnessController.isDefaultConfig(),
            this.mUniqueDisplayId,
            this.mAutomaticBrightnessController.getBrightnessSpline());
      } else {
        this.mBrightnessTracker.notifyBrightnessChanged(
            convertToAdjustedNits,
            z5,
            f3,
            z2,
            this.mAutomaticBrightnessController.isDefaultConfig(),
            this.mUniqueDisplayId,
            this.mAutomaticBrightnessController.getLastSensorValues(),
            this.mAutomaticBrightnessController.getLastSensorTimestamps());
      }
    }
  }
  ...
  public void addDisplayBrightnessFollower(
    ...
    synchronized (this.mLock) {
      this.mDisplayBrightnessFollowers.append(
          displayPowerControllerInterface.getDisplayId(), displayPowerControllerInterface);
      sendUpdatePowerStateLocked();
    }
  }

  @Override // com.android.server.display.DisplayPowerControllerInterface
  public void removeDisplayBrightnessFollower(
      final DisplayPowerControllerInterface displayPowerControllerInterface) {
    synchronized (this.mLock) {
      this.mDisplayBrightnessFollowers.remove(displayPowerControllerInterface.getDisplayId());
      this.mHandler.postAtTime(
          new Runnable() { // from class:
                           // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              DisplayPowerControllerInterface.this.setBrightnessToFollow(
                  Float.NaN, -1.0f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
            }
          },
          this.mClock.uptimeMillis());
    }
  ...
  public final void clearDisplayBrightnessFollowersLocked() {
    for (int i = 0; i < this.mDisplayBrightnessFollowers.size(); i++) {
      final DisplayPowerControllerInterface displayPowerControllerInterface =
          (DisplayPowerControllerInterface) this.mDisplayBrightnessFollowers.valueAt(i);
      this.mHandler.postAtTime(
          new Runnable() { // from class:
                           // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              DisplayPowerControllerInterface.this.setBrightnessToFollow(
                  Float.NaN, -1.0f, DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
  ...
  public void dump(final PrintWriter printWriter) {
    synchronized (this.mLock) {
      ...
      printWriter.println(
          "  mPendingUpdatePowerStateLocked=" + this.mPendingUpdatePowerStateLocked);
    }
    printWriter.println();
    ...
    printWriter.println(
        "  mUseSoftwareAutoBrightnessConfig=" + this.mUseSoftwareAutoBrightnessConfig);
    ...
    synchronized (this.mCachedBrightnessInfo) {
      printWriter.println(
          "  mCachedBrightnessInfo.brightness=" + this.mCachedBrightnessInfo.brightness.value);
      printWriter.println(
          "  mCachedBrightnessInfo.adjustedBrightness="
              + this.mCachedBrightnessInfo.adjustedBrightness.value);
      printWriter.println(
          "  mCachedBrightnessInfo.brightnessMin="
              + this.mCachedBrightnessInfo.brightnessMin.value);
      printWriter.println(
          "  mCachedBrightnessInfo.brightnessMax="
              + this.mCachedBrightnessInfo.brightnessMax.value);
      printWriter.println(
          "  mCachedBrightnessInfo.hbmMode=" + this.mCachedBrightnessInfo.hbmMode.value);
      printWriter.println(
          "  mCachedBrightnessInfo.hbmTransitionPoint="
              + this.mCachedBrightnessInfo.hbmTransitionPoint.value);
      printWriter.println(
          "  mCachedBrightnessInfo.brightnessMaxReason ="
              + this.mCachedBrightnessInfo.brightnessMaxReason.value);
    }
    ...
    printWriter.println(
        "  USE_PERMISSIBLE_RATIO_FOR_LONGTERM_MODEL="
            + PowerManagerUtil.USE_PERMISSIBLE_RATIO_FOR_LONGTERM_MODEL);
    ...
    this.mHandler.runWithScissors(
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$dump$10(PrintWriter printWriter) {
    ...
    printWriter.println(
        "  mReportedToPolicy=" + reportedToPolicyToString(this.mReportedScreenStateToPolicy));
    ...
    if (this.mColorFadeOnAnimator != null) {
      printWriter.println(
          "  mColorFadeOnAnimator.isStarted()=" + this.mColorFadeOnAnimator.isStarted());
    }
    if (this.mColorFadeOffAnimator != null) {
      printWriter.println(
          "  mColorFadeOffAnimator.isStarted()=" + this.mColorFadeOffAnimator.isStarted());
    }
    DisplayPowerState displayPowerState = this.mPowerState;
    ...
    printWriter.println(
        "  mLastBrightnessConfigurationTime=" + this.mLastBrightnessConfigurationTime);
  ...
  public static String reportedToPolicyToString(int i) {
    return i != 0
        ? i != 1
            ? i != 2 ? Integer.toString(i) : "REPORTED_TO_POLICY_SCREEN_ON"
  ...
  public static String skipRampStateToString(int i) {
    return i != 0
        ? i != 1
            ? i != 2 ? Integer.toString(i) : "RAMP_STATE_SKIP_AUTOBRIGHT"
            : "RAMP_STATE_SKIP_INITIAL"
        : "RAMP_STATE_SKIP_NONE";
  }
  ...
  public final void dumpBrightnessEvents(PrintWriter printWriter) {
    ...
    BrightnessEvent[] brightnessEventArr =
        (BrightnessEvent[]) this.mBrightnessEventRingBuffer.toArray();
      ...
      try {
        if (PowerManagerUtil.SEC_FEATURE_DUAL_DISPLAY) {
          if (!(PowerManagerUtil.SEC_FEATURE_FLIP_COVER_DISPLAY
              && (((i2 = this.mDisplayId) == 0 && this.mDualScreenPolicy == 1)
                  || (i2 == 1 && this.mDualScreenPolicy == 0)))) {
            Slog.m72d(
                this.mTag,
                "noteDualScreenState: State="
                    + Display.stateToString(i)
                    + ", dualScreenPolicy="
                    + this.mDualScreenPolicy);
  ...
  public final void noteScreenBrightness(float f) {
    ...
    if (iBatteryStats != null) {
      try {
        if (PowerManagerUtil.SEC_FEATURE_DUAL_DISPLAY) {
          iBatteryStats.noteDualScreenBrightness(
              BrightnessSynchronizer.brightnessFloatToInt(f),
              this.mDisplayId,
              this.mDualScreenPolicy);
        } else {
  ...
  public final void logBrightnessEvent(BrightnessEvent brightnessEvent, float f) {
    ...
    float convertToAdjustedNits =
        this.mDisplayBrightnessController.convertToAdjustedNits(brightnessEvent.getBrightness());
    float powerFactor =
        brightnessEvent.isLowPowerModeSet() ? brightnessEvent.getPowerFactor() : -1.0f;
    int rbcStrength = brightnessEvent.isRbcEnabled() ? brightnessEvent.getRbcStrength() : -1;
    float convertToAdjustedNits2 =
        brightnessEvent.getHbmMode() == 0
            ? -1.0f
            : this.mDisplayBrightnessController.convertToAdjustedNits(brightnessEvent.getHbmMax());
    float convertToAdjustedNits3 =
        brightnessEvent.getThermalMax() == 1.0f
            ? -1.0f
            : this.mDisplayBrightnessController.convertToAdjustedNits(
                brightnessEvent.getThermalMax());
    if (this.mIsDisplayInternal) {
      FrameworkStatsLog.write(
          FrameworkStatsLog.DISPLAY_BRIGHTNESS_CHANGED,
          this.mDisplayBrightnessController.convertToAdjustedNits(
              brightnessEvent.getInitialBrightness()),
          convertToAdjustedNits,
          brightnessEvent.getLux(),
          brightnessEvent.getPhysicalDisplayId(),
          brightnessEvent.wasShortTermModelActive(),
          powerFactor,
          rbcStrength,
          convertToAdjustedNits2,
          convertToAdjustedNits3,
          brightnessEvent.isAutomaticBrightnessEnabled(),
          1,
          convertBrightnessReasonToStatsEnum(brightnessEvent.getReason().getReason()),
          nitsToRangeIndex(convertToAdjustedNits),
          z,
          brightnessEvent.getHbmMode() == 1,
          brightnessEvent.getHbmMode() == 2,
          (modifier & 2) > 0,
          this.mBrightnessThrottler.getBrightnessMaxReason(),
          (modifier & 1) > 0,
          brightnessEvent.isRbcEnabled(),
          (flags & 2) > 0,
          (flags & 4) > 0,
          (flags & 8) > 0,
          (flags & 16) > 0,
    ...
    public void handleMessage(Message message) {
      ...
      switch (message.what) {
        ...
        case 4:
          ...
          DisplayPowerController2.this.mAutomaticBrightnessStrategy.setBrightnessConfiguration(
              brightnessConfiguration, message.arg1 == 1);
          if (message.arg2 > 0) {
          ...
          break;
        case 5:
          DisplayPowerController2.this.mDisplayBrightnessController.setTemporaryBrightness(
              Float.valueOf(Float.intBitsToFloat(message.arg1)));
          if (message.arg2 > 0) {
            Slog.m72d(
                DisplayPowerController2.this.mTag,
                "[api] ForceSlowChange is requested from DisplayManager");
            DisplayPowerController2.this.mForceSlowChange = true;
          }
          DisplayPowerController2.this.lambda$new$0();
          break;
        case 6:
          DisplayPowerController2.this.mAutomaticBrightnessStrategy
              .setTemporaryAutoBrightnessAdjustment(Float.intBitsToFloat(message.arg1));
          DisplayPowerController2.this.lambda$new$0();
          break;
        case 7:
        ...
        case 10:
          if (DisplayPowerController2.this.mPowerState != null) {
            DisplayPowerController2.this.reportStats(
                DisplayPowerController2.this.mPowerState.getScreenBrightness());
            break;
          }
          break;
        case 11:
          DisplayPowerController2.this.logHbmBrightnessStats(
              Float.intBitsToFloat(message.arg1), message.arg2);
          break;
        case 12:
    ...
    public void onChange(boolean z, Uri uri) {
      ...
      if (uri.equals(
          Settings.System.getUriFor(
              DisplayPowerController2.this.mScreenBrightnessModeSettingName))) {
  ...
  public final class ScreenOnUnblocker implements WindowManagerPolicy.ScreenOnListener {
    ...
    public void onScreenOn() {
      Slog.m72d(
          DisplayPowerController2.this.mTag,
          "[api] WindowManagerPolicy.ScreenOnListener : called onScreenOn()");
      DisplayPowerController2.this.mHandler.sendMessageAtTime(
          DisplayPowerController2.this.mHandler.obtainMessage(2, this),
          DisplayPowerController2.this.mClock.uptimeMillis());
    }
  }
  ...
  public final class ScreenOffUnblocker implements WindowManagerPolicy.ScreenOffListener {
    ...
    public void onScreenOff() {
      Slog.m72d(
          DisplayPowerController2.this.mTag,
          "[api] WindowManagerPolicy.ScreenOffListener : called onScreenOff()");
      DisplayPowerController2.this.mHandler.sendMessageAtTime(
          DisplayPowerController2.this.mHandler.obtainMessage(3, this),
          DisplayPowerController2.this.mClock.uptimeMillis());
    }
  }
  ...
  class Injector {
    public Clock getClock() {
      return new Clock() { // from class:
                           // com.android.server.display.DisplayPowerController2$Injector$$ExternalSyntheticLambda0
    ...
    public DisplayPowerState getDisplayPowerState(
        DisplayBlanker displayBlanker, ColorFade colorFade, int i, int i2) {
      return new DisplayPowerState(displayBlanker, colorFade, i, i2);
    }

    public RampAnimator.DualRampAnimator getDualRampAnimator(
        DisplayPowerState displayPowerState,
    ...
    public WakelockController getWakelockController(
    ...
    public DisplayPowerProximityStateController getDisplayPowerProximityStateController(
        ...
        int i,
        SensorManager sensorManager) {
      return new DisplayPowerProximityStateController(
          wakelockController, displayDeviceConfig, looper, runnable, i, sensorManager, null);
    }

    public AutomaticBrightnessController getAutomaticBrightnessController(
        AutomaticBrightnessController.Callbacks callbacks,
        Looper looper,
        SensorManager sensorManager,
        Sensor sensor,
        BrightnessMappingStrategy brightnessMappingStrategy,
      ...
      return new AutomaticBrightnessController(
          callbacks,
          looper,
          sensorManager,
          sensor,
    ...
    public BrightnessMappingStrategy getInteractiveModeBrightnessMapper(
        Resources resources,
        DisplayDeviceConfig displayDeviceConfig,
        DisplayWhiteBalanceController displayWhiteBalanceController) {
      return BrightnessMappingStrategy.create(
          resources, displayDeviceConfig, displayWhiteBalanceController);
    }
    ...
    public ScreenOffBrightnessSensorController getScreenOffBrightnessSensorController(
      ...
      return new ScreenOffBrightnessSensorController(
          sensorManager, sensor, handler, clock, iArr, brightnessMappingStrategy);
    }

    public AdaptiveBrightnessLongtermModelBuilder getAdaptiveBrightnessLongtermModelBuilder(
        Context context,
        AdaptiveBrightnessLongtermModelBuilder.Injector injector,
        BrightnessMappingStrategy brightnessMappingStrategy) {
      return new AdaptiveBrightnessLongtermModelBuilder(
          context, injector, brightnessMappingStrategy);
    }
  ...
  public final class ShutdownReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      if (DisplayPowerController2.this.mInteractiveModeBrightnessMapper == null
          || !"android.intent.action.ACTION_SHUTDOWN".equals(intent.getAction())
          || !DisplayPowerController2.this.mAppliedForceDimming
          || DisplayPowerController2.this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()
          || Float.isNaN(DisplayPowerController2.this.mLastScreenBrightnessSettingBeforeForceDim)) {
        return;
      }
      Slog.m72d(
          DisplayPowerController2.this.mTag, "Restore low battery force dim (manual brightness)");
      ...
      DisplayPowerController2.this.mDisplayBrightnessController.setBrightness(
          DisplayPowerController2.this.mLastScreenBrightnessSettingBeforeForceDim);
    }
  }
  ...
  public final int getTransitionTimeWithHbm(float f, float f2, float f3, float f4) {
    ...
    if (f > 1.0f && f2 <= 1.0f) {
      ...
      Slog.m74e(
          this.mTag,
          "getTransitionTimeWithHbm: rateAtHbm: "
              + f4
              + " currentBrightness: "
              + f
              + " targetBrightness: "
  ...
  public final void putAutoBrightnessTransitionTime(float f, float f2, float f3) {
    ...
    Settings.System.putIntForUser(
        this.mContext.getContentResolver(), "auto_brightness_transition_time", i, -2);
  }
  ...
  public final float getFinalBrightness(float f, int i) {
    ...
    if (this.mAutomaticBrightnessStrategy.hasAppliedAutoBrightness()) {
      ...
      if (f7 >= RATE_FROM_DOZE_TO_ON
          && !this.mAppliedDimming
          && !this.mAppliedForceDimming
          && f < f7) {
    ...
    if (PowerManagerUtil.isFakeAodAvailable(this.mDualScreenPolicy)
        && Display.isDozeState(i)
        && f > 0.38f) {
      this.mBrightnessReasonTemp.addModifier(
          IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES, 0.38f);
      f = 0.38f;
    }
    ...
    DisplayManagerInternal.DisplayPowerRequest displayPowerRequest = this.mPowerRequest;
    if ((displayPowerRequest.isOutdoorMode || displayPowerRequest.lcdFlashMode)
        && displayPowerRequest.policy == 3) {
    ...
    if (!PowerManagerUtil.SHIP_BUILD
        && this.mIsCoverDisplay
        && this.mCoverDisplayDemoEnabled
        && this.mPowerRequest.policy == 3) {
      f3 = Math.max(this.mScreenExtendedBrightnessRangeMaximum, 1.0f);
    ...
    if (PowerManagerUtil.SEC_FEATURE_SCREEN_CURTAIN && this.mPowerRequest.screenCurtainEnabled) {
      ...
      f3 =
          clampScreenBrightnessForFinal(
              Math.min(f3, BrightnessSynchronizer.brightnessIntToFloat(49)));
  ...
  public void setActualDisplayState(final int i) {
    this.mHandler.postAtTime(
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2$$ExternalSyntheticLambda12
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$setActualDisplayState$11(int i) {
    if (i != this.mActualDisplayState) {
      Slog.m72d(
          this.mTag,
          "setActualDisplayState: "
              + Display.stateToString(this.mActualDisplayState)
              + " -> "
              + Display.stateToString(i));
  ...
  public void restartAdaptiveBrightnessLongtermModelBuilderInternal(boolean z) {
    AdaptiveBrightnessLongtermModelBuilder adaptiveBrightnessLongtermModelBuilder =
        this.mAdaptiveBrightnessLongtermModelBuilder;
    if (adaptiveBrightnessLongtermModelBuilder == null
        || !adaptiveBrightnessLongtermModelBuilder.isStarted()) {
      return;
    }
  ...
  public final boolean getCoverDisplayDemoSetting() {
    return Settings.System.getIntForUser(
            this.mContext.getContentResolver(), "cover_screen_demo_mode", 0, -2)
        > 0;
  }
  ...
  public final class SeamlessAodReadyListener implements AODManager.AODChangeListener {
    ...
    public void readyToScreenTurningOn() {
      Slog.m72d(
          DisplayPowerController2.this.mTag,
          "[api] AODManager.AODChangeListener : Received readyToScreenTurningOn().");
  ...
  public final class EarlyWakeUpManager {
    ...
    public final Runnable mEarlyLightSensorReadyListener =
        new Runnable() { // from class:
                         // com.android.server.display.DisplayPowerController2.EarlyWakeUpManager.1
          @Override // java.lang.Runnable
          public void run() {
    ...
    */
    public void update(boolean z, int i) {
      ...
      synchronized (this.mEarlyWakeUpLock) {
        ...
        if ((i == 2 || this.mIsRequestInvalidated || DisplayPowerController2.this.mIsInTransition)
            ? false
            : true) {
    ...
    public final void setEarlyLightSensorEnabledLocked(boolean z) {
      if (supportEarlyLightSensorEnableLocked()) {
        if ((!z || isCandidateForAutoBrightness()) && z != this.mEarlyLightSensorEnabled) {
          ...
          DisplayPowerController2.this.mAutomaticBrightnessController.setEarlyLightSensorEnabled(
              z, this.mEarlyLightSensorReadyListener);
        }
      }
    }
    ...
    public final void setEarlyDisplayEnabledLocked(final boolean z, int i) {
      ...
      if (!z || supportEarlyDisplayEnableLocked(i)) {
        ...
        this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.display.DisplayPowerController2.EarlyWakeUpManager.2
              @Override // java.lang.Runnable
              public void run() {
                DisplayPowerController2.this.mBlanker.setDisplayStateLimitForEarlyWakeUp(
                    DisplayPowerController2.this.mDisplayId, z ? 2 : 0);
                synchronized (EarlyWakeUpManager.this.mEarlyWakeUpLock) {
    ...
    public final boolean isCandidateForAutoBrightness() {
      return DisplayPowerController2.this.mAutomaticBrightnessStrategy.shouldUseAutoBrightness()
          && !DisplayPowerController2.this.mDisplayPowerProximityStateController
              .isProximityPositive();
    }
    ...
    public final void updateSuspendBlockerLocked() {
      if ((!this.mAppliedLocked
              && this.mEarlyDisplayReadyLocked
              && this.mEarlyLightSensorReadyLocked)
          ? false
          : true) {
    ...
    public void dump(PrintWriter printWriter) {
      synchronized (this.mEarlyWakeUpLock) {
        ...
        printWriter.println(
            "    mEarlyLightSensorReadyLocked=" + this.mEarlyLightSensorReadyLocked);
  ...
  public void onAmbientLuxChanged(float f) {
    AdaptiveBrightnessLongtermModelBuilder adaptiveBrightnessLongtermModelBuilder;
    if (!PowerManagerUtil.USE_SEC_LONG_TERM_MODEL
        || (adaptiveBrightnessLongtermModelBuilder = this.mAdaptiveBrightnessLongtermModelBuilder)
            == null) {
      return;
    }
  ...
  public final BrightnessDynamicRampRatePair getBrightnessDynamicRampRatePair(float f, float f2) {
    ...
    int i =
        SystemProperties.getInt(
            "sys.display.transition.weight", DEFAULT_WEIGHT_FOR_BRIGHTNESS_TRANSITION);
    int i2 = SystemProperties.getInt("sys.display.transition.weight.hbm", 15);
    if (f < currentValue) {
      float dynamicRampRate =
          getDynamicRampRate(i, f, currentValue, f4, f2, MAX_AUTO_BRIGHTNESS_TRANSITION_TIME);
