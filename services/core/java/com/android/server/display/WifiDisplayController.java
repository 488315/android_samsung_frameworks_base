...
public final class WifiDisplayController implements DumpUtils.Dump {
    ...
    */
    public final void handleConnectionFailure(int i) {
        ...
        if (i != 1) {
            if (i == 2) {
                Toast.makeText(new ContextThemeWrapper(this.mContext, R.style.Theme.DeviceDefault.Light), 17043291, 0).show();
            } else if (i == 3) {
                ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(this.mContext, R.style.Theme.DeviceDefault.Light);
                Context context = this.mContext;
                Toast.makeText(contextThemeWrapper, context.getString(17043289, context.getString(17042870)), 0).show();
            } else if (i == 5) {
                ContextThemeWrapper contextThemeWrapper2 = new ContextThemeWrapper(this.mContext, R.style.Theme.DeviceDefault.Light);
        ...
        ContextThemeWrapper contextThemeWrapper3 = new ContextThemeWrapper(this.mContext, R.style.Theme.DeviceDefault.Light);
