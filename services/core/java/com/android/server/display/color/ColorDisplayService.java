...
public final class ColorDisplayService extends SystemService {
    ...
    final class BinderService extends IColorDisplayManager.Stub {
        ...
        public final void dump(
            ...
            if (DumpUtils.checkDumpPermission(
                    ColorDisplayService.this.getContext(), "ColorDisplayService", printWriter)) {
                long clearCallingIdentity = Binder.clearCallingIdentity();
                try {
                    ColorDisplayService.m476$$Nest$mdumpInternal(
                            ColorDisplayService.this, printWriter);
                } finally {
                ...
                if (colorDisplayService.mCurrentUser != -10000) {
                    i =
                            Settings.Secure.getIntForUser(
                                    colorDisplayService.getContext().getContentResolver(),
                                    "night_display_auto_mode",
                                    -1,
                                    colorDisplayService.mCurrentUser);
                }
                return i;
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        public final int getNightDisplayColorTemperature() {
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                NightDisplayTintController nightDisplayTintController =
                        ColorDisplayService.this.mNightDisplayTintController;
                Integer num = nightDisplayTintController.mColorTemp;
                return num != null
                        ? nightDisplayTintController.clampNightDisplayColorTemperature(
                                num.intValue())
                        : nightDisplayTintController.getColorTemperatureSetting();
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        }
        ...
        public final Time getNightDisplayCustomEndTime() {
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                return ColorDisplayService.m477$$Nest$mgetNightDisplayCustomEndTimeInternal(
                        ColorDisplayService.this);
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        }
        ...
        public final Time getNightDisplayCustomStartTime() {
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                return ColorDisplayService.m478$$Nest$mgetNightDisplayCustomStartTimeInternal(
                        ColorDisplayService.this);
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        ...
        public final float getReduceBrightColorsOffsetFactor() {
            ...
            try {
                float[] fArr =
                        ColorDisplayService.this.mReduceBrightColorsTintController.mCoefficients;
        ...
        public final boolean isDeviceColorManaged() {
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                return ColorDisplayService.m480$$Nest$misDeviceColorManagedInternal(
                        ColorDisplayService.this);
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        ...
        public final boolean isSaturationActivated() {
            ...
            long clearCallingIdentity = Binder.clearCallingIdentity();
            try {
                if (!ColorDisplayService.this.mGlobalSaturationTintController
        ...
        public final boolean setNightDisplayCustomEndTime(Time time) {
            ...
            try {
                ...
                return Settings.Secure.putIntForUser(
                        ...
                        time.getLocalTime().toSecondOfDay() * 1000,
                        colorDisplayService.mCurrentUser);
            } finally {
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        ...
        public final boolean setReduceBrightColorsStrength(int i) {
            ...
            try {
                ColorDisplayService colorDisplayService = ColorDisplayService.this;
                return colorDisplayService.mCurrentUser == -10000
                        ? false
                        : Settings.Secure.putIntForUser(
                                colorDisplayService.getContext().getContentResolver(),
    ...
    public final class ColorDisplayServiceInternal {
        ...
        public final void onOpticalUdfpsStarted() {
            ColorDisplayService colorDisplayService = ColorDisplayService.this;
            GlobalSaturationTintController globalSaturationTintController =
            ...
            if (globalSaturationTintController.isActivated()) {
                colorDisplayService.mHandler.post(
                        new ColorDisplayService$ColorDisplayServiceInternal$$ExternalSyntheticLambda0(
                                this, 0));
            }
            NightDisplayTintController nightDisplayTintController =
                    colorDisplayService.mNightDisplayTintController;
            nightDisplayTintController.mIsActivationLocked = true;
            if (nightDisplayTintController.isActivated()) {
                colorDisplayService.mHandler.sendEmptyMessage(2);
            }
            ReduceBrightColorsTintController reduceBrightColorsTintController =
                    colorDisplayService.mReduceBrightColorsTintController;
    ...
    public final class CustomNightDisplayAutoMode extends NightDisplayAutoMode
        ...
        public final AnonymousClass1 mTimeChangedReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.android.server.display.color.ColorDisplayService.CustomNightDisplayAutoMode.1
        ...
        public final void onActivated(boolean z) {
            this.mLastActivatedTime =
                    ColorDisplayService.m479$$Nest$mgetNightDisplayLastActivatedTimeSetting(
                            ColorDisplayService.this);
        ...
        public final void onStart() {
            ...
            this.mStartTime =
                    ColorDisplayService.m478$$Nest$mgetNightDisplayCustomStartTimeInternal(
                                    ColorDisplayService.this)
                            .getLocalTime();
            this.mEndTime =
                    ColorDisplayService.m477$$Nest$mgetNightDisplayCustomEndTimeInternal(
                                    ColorDisplayService.this)
                            .getLocalTime();
            this.mLastActivatedTime =
                    ColorDisplayService.m479$$Nest$mgetNightDisplayLastActivatedTimeSetting(
        ...
        public final void updateActivated() {
            ...
            LocalDateTime dateTimeBefore =
                    ColorDisplayService.getDateTimeBefore(this.mStartTime, now);
            LocalDateTime dateTimeAfter =
                    ColorDisplayService.getDateTimeAfter(this.mEndTime, dateTimeBefore);
            ...
            if (localDateTime != null
                    ...
                    && this.mLastActivatedTime.isAfter(dateTimeBefore)
                    && (this.mLastActivatedTime.isAfter(dateTimeAfter)
                            || now.isBefore(dateTimeAfter))) {
                isBefore =
                        ColorDisplayService.this.mNightDisplayTintController.isActivatedSetting();
            }
            if (ColorDisplayService.this.mNightDisplayTintController.isActivatedStateNotSet()
                    || ColorDisplayService.this.mNightDisplayTintController.isActivated()
                            != isBefore) {
                NightDisplayTintController nightDisplayTintController =
                        ColorDisplayService.this.mNightDisplayTintController;
        ...
        public final void updateNextAlarm(Boolean bool, LocalDateTime localDateTime) {
            this.mAlarmManager.setExact(
                    1,
                    (bool.booleanValue()
                                    ? ColorDisplayService.getDateTimeAfter(
    ...
    public final class NightDisplayTintController extends TintController {
            ...
            if (i == -1) {
                i =
                        colorDisplayService
                                ...
                                .getInteger(
                                        R.integer
                                                .config_reevaluate_bootstrap_sim_data_usage_millis);
            }
            int minimumColorTemperature =
                    ColorDisplayManager.getMinimumColorTemperature(
                            colorDisplayService.getContext());
            int maximumColorTemperature =
                    ColorDisplayManager.getMaximumColorTemperature(
                            colorDisplayService.getContext());
            return i < minimumColorTemperature
                    ? minimumColorTemperature
                    : i > maximumColorTemperature ? maximumColorTemperature : i;
        }
        ...
        public final int getColorTemperatureSetting() {
            ...
            return clampNightDisplayColorTemperature(
                    Settings.Secure.getIntForUser(
                            colorDisplayService.getContext().getContentResolver(),
                            "night_display_color_temperature",
                            -1,
        ...
        public final boolean isAvailable(Context context) {
            if (this.mIsAvailable == null) {
                this.mIsAvailable =
                        Boolean.valueOf(ColorDisplayManager.isNightDisplayAvailable(context));
            }
        ...
        public final void setActivated(Boolean bool, LocalDateTime localDateTime) {
            ...
            if (isActivatedStateNotSet() || z) {
                ...
                Slog.i(
                        "ColorDisplayService",
                        booleanValue ? "Turning on night display" : "Turning off night display");
                NightDisplayAutoMode nightDisplayAutoMode =
                        colorDisplayService.mNightDisplayAutoMode;
                if (nightDisplayAutoMode != null) {
                    nightDisplayAutoMode.onActivated(booleanValue);
                }
                if (colorDisplayService.mDisplayWhiteBalanceTintController.isAvailable(
                        colorDisplayService.getContext())) {
            ...
            switch (message.what) {
                ...
                case 3:
                    ...
                    ColorDisplayService.m475$$Nest$mapplyTint(
                            ...
                            colorDisplayService2.mNightDisplayTintController,
                            false);
                    return;
                case 4:
                    GlobalSaturationTintController globalSaturationTintController =
                            ColorDisplayService.this.mGlobalSaturationTintController;
                    int i = message.arg1;
                    ...
                    AnyMotionDetector$$ExternalSyntheticOutline0.m(
                            i, "Setting saturation level: ", "ColorDisplayService");
                    ...
                    ColorDisplayService.m475$$Nest$mapplyTint(
                            ...
                            colorDisplayService3.mGlobalSaturationTintController,
                            false);
                    return;
                case 5:
                    final ColorDisplayService colorDisplayService4 = ColorDisplayService.this;
                    final DisplayWhiteBalanceTintController displayWhiteBalanceTintController =
                            colorDisplayService4.mDisplayWhiteBalanceTintController;
                    synchronized (colorDisplayService4.mCctTintApplierLock) {
                        try {
                            displayWhiteBalanceTintController.cancelAnimator();
                            final DisplayTransformManager displayTransformManager =
                                    (DisplayTransformManager)
                                            colorDisplayService4.getLocalService(
                                                    DisplayTransformManager.class);
                            final int i2 = displayWhiteBalanceTintController.mAppliedCct;
                            final int i3 =
                                    displayWhiteBalanceTintController.isActivated()
                                            ? displayWhiteBalanceTintController.mTargetCct
                                            : displayWhiteBalanceTintController
                                                    .mDisplayNominalWhiteCct;
                            long j =
                                    i3 > i2
                                            ? displayWhiteBalanceTintController
                                                    .mTransitionDurationIncrease
                                            : displayWhiteBalanceTintController
                                                    .mTransitionDurationDecrease;
                            Slog.d(
                                    "ColorDisplayService",
                                    "DisplayWhiteBalanceTintController animation started: toCct="
                                            + i3
                                            + " fromCct="
                                            + i2
                                            + " with duration="
                            ...
                            CctEvaluator cctEvaluator =
                                    displayWhiteBalanceTintController.mCctEvaluator;
                            ...
                            ofInt.setInterpolator(
                                    AnimationUtils.loadInterpolator(
                                            colorDisplayService4.getContext(),
                                            R.interpolator.linear));
                            ofInt.addUpdateListener(
                                    new ValueAnimator
                                            .AnimatorUpdateListener() { // from class:
                                                                        // com.android.server.display.color.ColorDisplayService$$ExternalSyntheticLambda0
                                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                        public final void onAnimationUpdate(
                                                ValueAnimator valueAnimator) {
                                            ColorDisplayService colorDisplayService5 =
                                                    ColorDisplayService.this;
                                            DisplayWhiteBalanceTintController
                                                    displayWhiteBalanceTintController2 =
                                                            displayWhiteBalanceTintController;
                                            DisplayTransformManager displayTransformManager2 =
                                                    displayTransformManager;
                                            synchronized (
                                                    colorDisplayService5.mCctTintApplierLock) {
                                                try {
                                                    int intValue =
                                                            ((Integer)
                                                                            valueAnimator
                                                    ...
                                                    if (intValue
                                                            != displayWhiteBalanceTintController2
                                                                    .mAppliedCct) {
                                                        displayTransformManager2.setColorMatrix(
                                                                125,
                                                                displayWhiteBalanceTintController2
                                                                        .computeMatrixForCct(
                                                                                intValue));
                            ...
                            ofInt.addListener(
                                    new AnimatorListenerAdapter() { // from class:
                                        // com.android.server.display.color.ColorDisplayService.4
                                        ...
                                        public final void onAnimationEnd(Animator animator) {
                                            synchronized (
                                                    ColorDisplayService.this.mCctTintApplierLock) {
                                                try {
                                                    Slog.d(
                                                            "ColorDisplayService",
                                                            displayWhiteBalanceTintController
                                                    ...
                                                    if (!this.mIsCancelled) {
                                                        ...
                                                        displayTransformManager2.setColorMatrix(
                                                                125,
                                                                displayWhiteBalanceTintController
                                                                        .computeMatrixForCct(i3));
                                                        displayWhiteBalanceTintController
                                                                        .mAppliedCct =
                                                                i3;
                                                    }
                                                    displayWhiteBalanceTintController.mAnimator =
                                                            null;
                                                } catch (Throwable th) {
                                                    throw th;
                                                }
                ...
                case 6:
                    ...
                    ColorDisplayService.m475$$Nest$mapplyTint(
                            colorDisplayService5,
                            colorDisplayService5.mReduceBrightColorsTintController,
                            true);
                    return;
                default:
                    return;
    ...
    public final class TwilightNightDisplayAutoMode extends NightDisplayAutoMode
        ...
        public TwilightNightDisplayAutoMode() {
            this.mTwilightManager =
                    (TwilightManager)
                            ColorDisplayService.this.getLocalService(TwilightManager.class);
        }
        ...
        public final void onStart() {
            ...
            TwilightService.AnonymousClass1 anonymousClass1 =
        ...
        public final void updateActivated(TwilightState twilightState) {
            ...
            if (localDateTime != null) {
                ...
                LocalDateTime ofInstant =
                        LocalDateTime.ofInstant(
                                Instant.ofEpochMilli(twilightState.mSunriseTimeMillis),
                                TimeZone.getDefault().toZoneId());
                LocalDateTime ofInstant2 =
                        LocalDateTime.ofInstant(
                                Instant.ofEpochMilli(twilightState.mSunsetTimeMillis),
                                TimeZone.getDefault().toZoneId());
                if (this.mLastActivatedTime.isBefore(now)) {
                    if (this.mLastActivatedTime.isBefore(ofInstant2)
                            ^ this.mLastActivatedTime.isBefore(ofInstant)) {
                        isNight =
                                colorDisplayService.mNightDisplayTintController
                                        .isActivatedSetting();
                    }
            ...
            boolean isActivatedStateNotSet =
                    colorDisplayService.mNightDisplayTintController.isActivatedStateNotSet();
            NightDisplayTintController nightDisplayTintController =
                    colorDisplayService.mNightDisplayTintController;
    ...
    public static void m475$$Nest$mapplyTint(
            ColorDisplayService colorDisplayService,
            final TintController tintController,
            boolean z) {
        float[] copyOf;
        colorDisplayService.getClass();
        ...
        final DisplayTransformManager displayTransformManager =
                (DisplayTransformManager)
                        colorDisplayService.getLocalService(DisplayTransformManager.class);
        ...
        tintValueAnimator.setInterpolator(
                AnimationUtils.loadInterpolator(
                        colorDisplayService.getContext(), R.interpolator.fast_out_slow_in));
        tintValueAnimator.addUpdateListener(
                new ValueAnimator
                        .AnimatorUpdateListener() { // from class:
                                                    // com.android.server.display.color.ColorDisplayService$$ExternalSyntheticLambda1
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        DisplayTransformManager displayTransformManager2 =
                                DisplayTransformManager.this;
                        TintController tintController2 = tintController;
                        displayTransformManager2.setColorMatrix(
                                tintController2.getLevel(),
                                (float[]) valueAnimator.getAnimatedValue());
                        ColorDisplayService.TintValueAnimator tintValueAnimator2 =
                                (ColorDisplayService.TintValueAnimator) valueAnimator;
        ...
        tintValueAnimator.addListener(
                new AnimatorListenerAdapter() { // from class:
                                                // com.android.server.display.color.ColorDisplayService.3
                    public boolean mIsCancelled;
                    ...
                    public final void onAnimationEnd(Animator animator) {
                        ...
                        Slog.d(
                                "ColorDisplayService",
                                TintController.this.getClass().getSimpleName()
                                        + " Animation cancelled: "
                                        + this.mIsCancelled
                                        + " to matrix: "
                                        + TintController.matrixToString(16, matrix)
                                        + " min matrix coefficients: "
                                        + TintController.matrixToString(16, tintValueAnimator2.min)
                                        + " max matrix coefficients: "
                                        + TintController.matrixToString(
                                                16, tintValueAnimator2.max));
                        if (!this.mIsCancelled) {
                            displayTransformManager.setColorMatrix(
                                    TintController.this.getLevel(), matrix);
                        }
    ...
    public static void m476$$Nest$mdumpInternal(
            ColorDisplayService colorDisplayService, PrintWriter printWriter) {
        colorDisplayService.getClass();
        printWriter.println("COLOR DISPLAY MANAGER dumpsys (color_display)");
        printWriter.println("Night display:");
        if (colorDisplayService.mNightDisplayTintController.isAvailable(
                colorDisplayService.getContext())) {
            printWriter.println(
                    "    Activated: "
                            + colorDisplayService.mNightDisplayTintController.isActivated());
        ...
        if (ColorDisplayManager.isColorTransformAccelerated(context)) {
            printWriter.println(
                    "    Activated: "
                            + colorDisplayService.mGlobalSaturationTintController.isActivated());
        } else {
            printWriter.println("    Not available");
        }
        AppSaturationController appSaturationController =
                colorDisplayService.mAppSaturationController;
        synchronized (appSaturationController.mLock) {
            try {
                ...
                if (((HashMap) appSaturationController.mAppsMap).size() == 0) {
                    ...
                    ArrayList arrayList =
                            new ArrayList(((HashMap) appSaturationController.mAppsMap).keySet());
                    ...
                    while (it.hasNext()) {
                        ...
                        SparseArray sparseArray =
                                (SparseArray) ((HashMap) appSaturationController.mAppsMap).get(str);
                        for (int i = 0; i < sparseArray.size(); i++) {
                            printWriter.println("        " + sparseArray.keyAt(i) + ":");
                            AppSaturationController.SaturationController.m474$$Nest$mdump(
                                    (AppSaturationController.SaturationController)
        ...
        if (colorDisplayService.mDisplayWhiteBalanceTintController.isAvailable(
            ...
            printWriter.println(
                    "    Activated: "
                            + colorDisplayService.mDisplayWhiteBalanceTintController.isActivated());
            DisplayWhiteBalanceTintController displayWhiteBalanceTintController =
                    colorDisplayService.mDisplayWhiteBalanceTintController;
            synchronized (displayWhiteBalanceTintController.mLock) {
                try {
                    ...
                    if (displayWhiteBalanceTintController.mSetUp) {
                        printWriter.println(
                                "    mTemperatureMin = "
                                        + displayWhiteBalanceTintController.mTemperatureMin);
                        printWriter.println(
                                "    mTemperatureMax = "
                                        + displayWhiteBalanceTintController.mTemperatureMax);
                        printWriter.println(
                                "    mTemperatureDefault = "
                                        + displayWhiteBalanceTintController.mTemperatureDefault);
                        printWriter.println(
                                "    mDisplayNominalWhiteCct = "
                                        + displayWhiteBalanceTintController
                                                .mDisplayNominalWhiteCct);
                        printWriter.println(
                                "    mCurrentColorTemperature = "
                                        + displayWhiteBalanceTintController
                                                .mCurrentColorTemperature);
                        printWriter.println(
                                "    mTargetCct = " + displayWhiteBalanceTintController.mTargetCct);
                        printWriter.println(
                                "    mAppliedCct = "
                                        + displayWhiteBalanceTintController.mAppliedCct);
                        printWriter.println(
                                "    mCurrentColorTemperatureXYZ = "
                                        + TintController.matrixToString(
                                                ...
                                                displayWhiteBalanceTintController
                                                        .mCurrentColorTemperatureXYZ));
                        printWriter.println(
                                "    mDisplayColorSpaceRGB RGB-to-XYZ = "
                                        + TintController.matrixToString(
                                                3,
                                                displayWhiteBalanceTintController
                                ...
                                "    mChromaticAdaptationMatrix = "
                                        + TintController.matrixToString(
                                                ...
                                                displayWhiteBalanceTintController
                                                        .mChromaticAdaptationMatrix));
                        printWriter.println(
                                "    mDisplayColorSpaceRGB XYZ-to-RGB = "
                                        + TintController.matrixToString(
                                                3,
                                                displayWhiteBalanceTintController
                                                        ...
                                                        .getInverseTransform()));
                        printWriter.println(
                                "    mMatrixDisplayWhiteBalance = "
                                        + TintController.matrixToString(
                                                4,
                                                displayWhiteBalanceTintController
                                                        .mMatrixDisplayWhiteBalance));
                        printWriter.println(
                                "    mIsAllowed = " + displayWhiteBalanceTintController.mIsAllowed);
                        printWriter.println(
                                "    mTransitionDuration = "
                                        + displayWhiteBalanceTintController.mTransitionDuration);
                        printWriter.println(
                                "    mTransitionDurationIncrease = "
                                        + displayWhiteBalanceTintController
                                                .mTransitionDurationIncrease);
        ...
        if (ColorDisplayManager.isColorTransformAccelerated(context2)) {
            printWriter.println(
                    "    Activated: "
                            + colorDisplayService.mReduceBrightColorsTintController.isActivated());
            AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                    new StringBuilder("    mStrength = "),
                    colorDisplayService.mReduceBrightColorsTintController.mStrength,
                    printWriter);
        } else {
            printWriter.println("    Not available");
        }
    ...
    public static Time m477$$Nest$mgetNightDisplayCustomEndTimeInternal(
            ColorDisplayService colorDisplayService) {
        int intForUser =
                Settings.Secure.getIntForUser(
                        colorDisplayService.getContext().getContentResolver(),
    ...
    public static Time m478$$Nest$mgetNightDisplayCustomStartTimeInternal(
            ColorDisplayService colorDisplayService) {
        int intForUser =
                Settings.Secure.getIntForUser(
                        colorDisplayService.getContext().getContentResolver(),
    ...
    public static LocalDateTime m479$$Nest$mgetNightDisplayLastActivatedTimeSetting(
            ColorDisplayService colorDisplayService) {
        String stringForUser =
                Settings.Secure.getStringForUser(
                        colorDisplayService.getContext().getContentResolver(),
                        "night_display_last_activated_time",
                        colorDisplayService.getContext().getUserId());
        if (stringForUser != null) {
            try {
                ...
                return LocalDateTime.ofInstant(
                        Instant.ofEpochMilli(Long.parseLong(stringForUser)),
    ...
    public static boolean m480$$Nest$misDeviceColorManagedInternal(
            ColorDisplayService colorDisplayService) {
        ((DisplayTransformManager)
                        colorDisplayService.getLocalService(DisplayTransformManager.class))
                .getClass();
    ...
    public static void m481$$Nest$msetColorModeInternal(
            ColorDisplayService colorDisplayService, int i) {
        if (!colorDisplayService.isColorModeAvailable(i)) {
            throw new IllegalArgumentException(
                    VibrationParam$1$$ExternalSyntheticOutline0.m(i, "Invalid colorMode: "));
        }
    ...
    public static LocalDateTime getDateTimeBefore(
            LocalTime localTime, LocalDateTime localDateTime) {
        LocalDateTime of =
                LocalDateTime.of(
                        localDateTime.getYear(),
                        localDateTime.getMonth(),
    ...
    public final int getColorModeInternal() {
        ...
        if ((Settings.Secure.getIntForUser(
                ...
                && (integer =
                                getContext()
                                        .getResources()
                                        .getInteger(R.integer.config_audio_notif_vol_steps))
                        >= 0) {
            return integer;
        }
        int intForUser =
                Settings.System.getIntForUser(
                        contentResolver, "display_color_mode", -1, this.mCurrentUser);
        if (intForUser == -1) {
            intForUser = SystemProperties.getInt("persist.sys.sf.native_mode", 0);
            if (intForUser == 0) {
                intForUser =
                        !ProfileUtilizationService.PU_VERSION.equals(
                                        SystemProperties.get("persist.sys.sf.color_saturation"))
                                ? 1
                                : 0;
        ...
        if (intForUser != -1
                && intArray.length > intForUser
                && isColorModeAvailable(intArray[intForUser])) {
            return intArray[intForUser];
        }
        int[] intArray2 =
                getContext()
                        .getResources()
                        .getIntArray(R.array.config_notificationSignalExtractors);
    ...
    public final int getNightDisplayAutoModeInternal() {
        ...
        NandswapManager$$ExternalSyntheticOutline0.m(
                intForUser, "Invalid autoMode: ", "ColorDisplayService");
        return 0;
    }
    ...
    public final boolean isDisplayWhiteBalanceSettingEnabled() {
        ...
        return Settings.Secure.getIntForUser(
                        ...
                        getContext()
                                        .getResources()
                                        .getBoolean(R.bool.config_dozeAfterScreenOffByDefault)
                                ? 1
                                : 0,
                        this.mCurrentUser)
                == 1;
    ...
    public final void onAccessibilityDaltonizerChanged() {
        ...
        int intForUser =
                Settings.Secure.getIntForUser(
                        ...
                        : -1;
        int intForUser2 =
                Flags.enableColorCorrectionSaturation()
                        ? Settings.Secure.getIntForUser(
                                contentResolver,
        ...
        DisplayTransformManager displayTransformManager =
                (DisplayTransformManager) getLocalService(DisplayTransformManager.class);
        if (intForUser == 0) {
    ...
    public final void onDisplayColorModeChanged(int i) {
        ...
        if (nightDisplayTintController.isAvailable(getContext())) {
            ...
            nightDisplayTintController.setMatrix(
                    nightDisplayTintController.getColorTemperatureSetting());
        }
        DisplayTransformManager displayTransformManager2 =
                (DisplayTransformManager) getLocalService(DisplayTransformManager.class);
    ...
    public final void onNightDisplayAutoModeChanged(int i) {
        AnyMotionDetector$$ExternalSyntheticOutline0.m(
                i, "onNightDisplayAutoModeChanged: autoMode=", "ColorDisplayService");
    ...
    public final void onReduceBrightColorsActivationChanged() {
        ...
        this.mReduceBrightColorsTintController.setActivated(
                Boolean.valueOf(
                        Settings.Secure.getIntForUser(
                                        getContext().getContentResolver(),
                                        "reduce_bright_colors_activated",
    ...
    public void onUserChanged(int i) {
        ...
        if (this.mCurrentUser != -10000) {
            ...
            if (contentObserver != null) {
                ...
                DeviceIdleController$$ExternalSyntheticOutline0.m(
                        new StringBuilder("tearDown: currentUser="),
                        this.mCurrentUser,
                        "ColorDisplayService");
                ...
                Context context = getContext();
                NightDisplayTintController nightDisplayTintController =
                        this.mNightDisplayTintController;
                ...
                GlobalSaturationTintController globalSaturationTintController =
                        this.mGlobalSaturationTintController;
                globalSaturationTintController.getClass();
                if (ColorDisplayManager.isColorTransformAccelerated(context2)) {
                ...
                ReduceBrightColorsTintController reduceBrightColorsTintController =
                        this.mReduceBrightColorsTintController;
                reduceBrightColorsTintController.getClass();
        ...
        if (i != -10000) {
            if (Settings.Secure.getIntForUser(contentResolver, "user_setup_complete", 0, i) != 1) {
                this.mUserSetupObserver =
                        new ContentObserver(
                                this
                                        .mHandler) { // from class:
                                                     // com.android.server.display.color.ColorDisplayService.1
                            ...
                            public final void onChange(boolean z, Uri uri) {
                                if (Settings.Secure.getIntForUser(
                                                ...
                                                "user_setup_complete",
                                                0,
                                                ColorDisplayService.this.mCurrentUser)
                                        == 1) {
    ...
    public final boolean setAppSaturationLevelInternal(int i, String str, String str2) {
        ...
        synchronized (appSaturationController.mLock) {
            AppSaturationController.SaturationController saturationControllerLocked =
                    appSaturationController.getSaturationControllerLocked(i2, str2);
            if (i == 100) {
            ...
            updateState =
                    !((ArrayList) saturationControllerLocked.mControllerRefs).isEmpty()
                            ? saturationControllerLocked.updateState()
                            : false;
        }
        return updateState;
    }
    ...
    public final void setUp() {
        ...
        boolean z = false;
        DeviceIdleController$$ExternalSyntheticOutline0.m(
                new StringBuilder("setUp: currentUser="), this.mCurrentUser, "ColorDisplayService");
        if (this.mContentObserver == null) {
            this.mContentObserver =
                    new ContentObserver(
                            this
                                    .mHandler) { // from class:
                                                 // com.android.server.display.color.ColorDisplayService.2
                        @Override // android.database.ContentObserver
                            ...
                            if (lastPathSegment != null) {
                                switch (lastPathSegment) {
                                    case "night_display_auto_mode":
                                        ColorDisplayService colorDisplayService =
                                                ColorDisplayService.this;
                                        colorDisplayService.onNightDisplayAutoModeChanged(
                                                colorDisplayService
                                                        .getNightDisplayAutoModeInternal());
                                        break;
                                    case "night_display_custom_end_time":
                                        ColorDisplayService colorDisplayService2 =
                                                ColorDisplayService.this;
                                        LocalTime localTime =
                                                ColorDisplayService
                                                        .m477$$Nest$mgetNightDisplayCustomEndTimeInternal(
                                                                colorDisplayService2)
                                                        .getLocalTime();
                                        Slog.d(
                                                "ColorDisplayService",
                                                "onNightDisplayCustomEndTimeChanged: endTime="
                                                        + localTime);
                                        NightDisplayAutoMode nightDisplayAutoMode =
                                                colorDisplayService2.mNightDisplayAutoMode;
                                        if (nightDisplayAutoMode != null) {
                                    ...
                                    case "night_display_color_temperature":
                                        ...
                                        if ((num != null
                                                        ? nightDisplayTintController
                                                                .clampNightDisplayColorTemperature(
                                                                        num.intValue())
                                                        : nightDisplayTintController
                                                                .getColorTemperatureSetting())
                                                != colorTemperatureSetting) {
                                            NightDisplayTintController nightDisplayTintController2 =
                                                    ColorDisplayService.this
                                                            .mNightDisplayTintController;
                                            nightDisplayTintController2.setMatrix(
                                                    colorTemperatureSetting);
                                    ...
                                    case "accessibility_display_daltonizer_enabled":
                                        ...
                                        ColorDisplayService colorDisplayService3 =
                                                ColorDisplayService.this;
                                        colorDisplayService3.onDisplayColorModeChanged(
                                                colorDisplayService3.getColorModeInternal());
                                        break;
                                    case "accessibility_display_inversion_enabled":
                                        ColorDisplayService.this.onAccessibilityInversionChanged();
                                        ColorDisplayService colorDisplayService4 =
                                                ColorDisplayService.this;
                                        colorDisplayService4.onDisplayColorModeChanged(
                                                colorDisplayService4.getColorModeInternal());
                                        break;
                                    ...
                                    case "night_display_activated":
                                        boolean isActivatedSetting =
                                                ColorDisplayService.this.mNightDisplayTintController
                                                        .isActivatedSetting();
                                        if (ColorDisplayService.this.mNightDisplayTintController
                                                        .isActivatedStateNotSet()
                                                || ColorDisplayService.this
                                                                .mNightDisplayTintController
                                                                .isActivated()
                                                        != isActivatedSetting) {
                                            NightDisplayTintController nightDisplayTintController3 =
                                                    ColorDisplayService.this
                                                            .mNightDisplayTintController;
                                            Boolean valueOf = Boolean.valueOf(isActivatedSetting);
                                            nightDisplayTintController3.getClass();
                                            nightDisplayTintController3.setActivated(
                                    ...
                                    case "display_color_mode":
                                        ColorDisplayService colorDisplayService5 =
                                                ColorDisplayService.this;
                                        colorDisplayService5.onDisplayColorModeChanged(
                                                colorDisplayService5.getColorModeInternal());
                                        break;
                                    case "night_display_custom_start_time":
                                        ColorDisplayService colorDisplayService6 =
                                                ColorDisplayService.this;
                                        LocalTime localTime2 =
                                                ColorDisplayService
                                                        .m478$$Nest$mgetNightDisplayCustomStartTimeInternal(
                                                                colorDisplayService6)
                                                        .getLocalTime();
                                        Slog.d(
                                                "ColorDisplayService",
                                                "onNightDisplayCustomStartTimeChanged: startTime="
                                                        + localTime2);
                                        NightDisplayAutoMode nightDisplayAutoMode2 =
                                                colorDisplayService6.mNightDisplayAutoMode;
                                        if (nightDisplayAutoMode2 != null) {
                                            nightDisplayAutoMode2.onCustomStartTimeChanged(
                                                    localTime2);
                                            break;
                                        }
                                        break;
        ...
        contentResolver.registerContentObserver(
                ...
                this.mCurrentUser);
        contentResolver.registerContentObserver(
                Settings.Secure.getUriFor("display_white_balance_enabled"),
                false,
                this.mContentObserver,
                this.mCurrentUser);
        contentResolver.registerContentObserver(
        ...
        if (intArray2 != null
                && (intArray = resources.getIntArray(R.array.config_trustedAccessibilityServices))
                        != null) {
            if (intArray2.length != intArray.length) {
                Slog.e(
                        "ColorDisplayService",
                        "Number of composition color spaces doesn't match specified color modes");
            } else {
        ...
        if (this.mNightDisplayTintController.isAvailable(getContext())) {
            ...
            Context context = getContext();
            displayTransformManager2.getClass();
            nightDisplayTintController2.setUp(
                    context, SystemProperties.getInt("persist.sys.sf.native_mode", 1) != 1);
            NightDisplayTintController nightDisplayTintController3 =
                    this.mNightDisplayTintController;
            nightDisplayTintController3.setMatrix(
                    nightDisplayTintController3.getColorTemperatureSetting());
            onNightDisplayAutoModeChanged(getNightDisplayAutoModeInternal());
            if (this.mNightDisplayTintController.isActivatedStateNotSet()) {
                NightDisplayTintController nightDisplayTintController4 =
                        this.mNightDisplayTintController;
                nightDisplayTintController4.setActivated(
                        Boolean.valueOf(nightDisplayTintController4.isActivatedSetting()),
                        LocalDateTime.now());
            }
        }
        if (this.mDisplayWhiteBalanceTintController.isAvailable(getContext())) {
            ...
            displayWhiteBalanceTintController.mIsAllowed =
                    resources2.getBoolean(R.bool.config_dozeAlwaysOnDisplayAvailable);
            SurfaceControl.DisplayPrimaries displayNativePrimaries =
                    displayWhiteBalanceTintController.mDisplayManagerInternal
                            .getDisplayNativePrimaries(0);
            if (displayNativePrimaries == null
                    || (cieXyz = displayNativePrimaries.red) == null
                    || (cieXyz2 = displayNativePrimaries.green) == null
                    || (cieXyz3 = displayNativePrimaries.blue) == null
                    || (cieXyz4 = displayNativePrimaries.white) == null) {
                displayTransformManager = displayTransformManager2;
            } else {
                displayTransformManager = displayTransformManager2;
                rgb =
                        new ColorSpace.Rgb(
                                "Display Color Space",
                                new float[] {
                                    cieXyz.X, cieXyz.Y, cieXyz.Z, cieXyz2.X, cieXyz2.Y, cieXyz2.Z,
                                    cieXyz3.X, cieXyz3.Y, cieXyz3.Z
                                },
                                new float[] {cieXyz4.X, cieXyz4.Y, cieXyz4.Z},
                                2.200000047683716d);
            }
            if (rgb == null) {
                Slog.w(
                ...
                String[] stringArray =
                        resources2.getStringArray(R.array.config_wearActivityModeRadios);
            ...
            if (transform != null && transform.length == 9) {
                ...
                if (inverseTransform != null && inverseTransform.length == 9) {
                    ...
                    String[] stringArray2 =
                            resources2.getStringArray(R.array.config_waterfallCutoutArray);
                    float[] fArr3 = new float[3];
                    for (int i5 = 0; i5 < stringArray2.length; i5++) {
                        fArr3[i5] = Float.parseFloat(stringArray2[i5]);
                    }
                    int integer =
                            resources2.getInteger(R.integer.config_fixedRefreshRateInHighZone);
                    ...
                    if (integer2 <= 0) {
                        ...
                        int integer3 =
                                resources2.getInteger(R.integer.config_extraFreeKbytesAbsolute);
                        if (integer3 < integer2) {
                            Slog.e(
                                    "ColorDisplayService",
                                    "Display white balance max temp must be greater or equal to"
                                        + " min");
                        } else {
                            int integer4 =
                            ...
                            displayWhiteBalanceTintController.mTransitionDuration =
                                    resources2.getInteger(R.integer.config_globalActionsKeyTimeout);
                            if (displayWhiteBalanceTintController.mDisplayManagerFlags
                                    .mAdaptiveToneImprovements2.isEnabled()) {
                                displayWhiteBalanceTintController.mTransitionDurationIncrease =
                                        resources2.getInteger(
                                                R.integer.config_immersive_mode_confirmation_panic);
                                displayWhiteBalanceTintController.mTransitionDurationDecrease =
                                        resources2.getInteger(
                                                R.integer
                                                        .config_hotwordDetectedResultMaxBundleSize);
                            } else {
                            ...
                            synchronized (displayWhiteBalanceTintController.mLock) {
                                ...
                                displayWhiteBalanceTintController.mCctEvaluator =
                                        new CctEvaluator(integer2, integer3, intArray3, intArray4);
                            }
                            int i6 = displayWhiteBalanceTintController.mTemperatureDefault;
                            if (!displayWhiteBalanceTintController.mSetUp) {
                                Slog.w(
                                        "ColorDisplayService",
                                        "Can't set display white balance temperature:"
                                            + " uninitialized");
                            } else if (i6 < displayWhiteBalanceTintController.mTemperatureMin) {
                                Slog.w(
                                        "ColorDisplayService",
                                        "Requested display color temperature is below allowed"
                                            + " minimum");
                                displayWhiteBalanceTintController.mTargetCct =
                                        displayWhiteBalanceTintController.mTemperatureMin;
                                ...
                                Slog.w(
                                        "ColorDisplayService",
                                        "Requested display color temperature is above allowed"
                                            + " maximum");
                                displayWhiteBalanceTintController.mTargetCct =
                                        displayWhiteBalanceTintController.mTemperatureMax;
                            } else {
                            ...
                            displayWhiteBalanceTintController.computeMatrixForCct(
                                    displayWhiteBalanceTintController.mTargetCct);
                        }
                    }
                    updateDisplayWhiteBalanceStatus();
        ...
        reduceBrightColorsTintController.getClass();
        if (ColorDisplayManager.isColorTransformAccelerated(context3)) {
            ReduceBrightColorsTintController reduceBrightColorsTintController2 =
                    this.mReduceBrightColorsTintController;
            ...
            String[] stringArray3 =
                    context4.getResources().getStringArray(z2 ? 17236287 : 17236288);
            for (int i7 = 0; i7 < 3 && i7 < stringArray3.length; i7++) {
                reduceBrightColorsTintController2.mCoefficients[i7] =
                        Float.parseFloat(stringArray3[i7]);
            }
            onReduceBrightColorsStrengthLevelChanged();
            if (this.mCurrentUser != -10000) {
                boolean z3 =
    ...
    public void updateDisplayWhiteBalanceStatus() {
        ...
        DisplayWhiteBalanceTintController displayWhiteBalanceTintController =
                this.mDisplayWhiteBalanceTintController;
        boolean z = false;
        if (isDisplayWhiteBalanceSettingEnabled()
                && !this.mNightDisplayTintController.isActivated()
                && Settings.Secure.getIntForUser(
                                getContext().getContentResolver(),
                                "accessibility_display_daltonizer_enabled",
                                0,
                ...
                && Settings.Secure.getIntForUser(
                        ...
                        == 0) {
            displayTransformManager.getClass();
            if (SystemProperties.getInt("persist.sys.sf.native_mode", 1) != 1
                    && this.mDisplayWhiteBalanceTintController.mIsAllowed) {
                z = true;
            }
        }
