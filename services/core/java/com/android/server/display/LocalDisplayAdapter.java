...
public final class LocalDisplayAdapter extends DisplayAdapter {
  ...
  public interface DisplayEventListener {
    void onFrameRateOverridesChanged(
        long j, long j2, DisplayEventReceiver.FrameRateOverride[] frameRateOverrideArr);
  ...
  public void registerLocked() {
    ...
    this.mInjector.setDisplayEventListenerLocked(
        getHandler().getLooper(), new LocalDisplayEventListener());
  ...
  public final void tryConnectDisplayLocked(long j) {
    ...
    if (physicalDisplayToken != null) {
      SurfaceControl.StaticDisplayInfo staticDisplayInfo =
          this.mSurfaceControlProxy.getStaticDisplayInfo(j);
      if (staticDisplayInfo == null) {
        Slog.m79w("LocalDisplayAdapter", "No valid static info found for display device " + j);
        return;
      }
      SurfaceControl.DynamicDisplayInfo dynamicDisplayInfo =
          this.mSurfaceControlProxy.getDynamicDisplayInfo(j);
      ...
      SurfaceControl.DesiredDisplayModeSpecs desiredDisplayModeSpecs =
          this.mSurfaceControlProxy.getDesiredDisplayModeSpecs(physicalDisplayToken);
      ...
      if (localDisplayDevice == null) {
        ...
        if (CoreRune.FW_VRR_RESOLUTION_POLICY && staticDisplayInfo.isInternal) {
          dynamicDisplayInfo.activeDisplayModeId =
              getOptimizedDisplayMode(dynamicDisplayInfo.supportedDisplayModes);
        }
        LocalDisplayDevice localDisplayDevice2 =
      ...
      if (localDisplayDevice.updateDisplayPropertiesLocked(
          staticDisplayInfo, dynamicDisplayInfo, desiredDisplayModeSpecs)) {
  ...
  public static int getPowerModeForState(int i) {
    ...
    if (i != 6) {
      return i != 3
          ? (i == 4 && !PowerManagerUtil.SEC_FEATURE_AOD_LOOK_CHARGING_UI) ? 3 : 2
          : PowerManagerUtil.SEC_FEATURE_AOD_LOOK_CHARGING_UI ? 2 : 1;
    }
    return 4;
  }
  ...
  public final class LocalDisplayDevice extends DisplayDevice {
    ...
    public LocalDisplayDevice(
      ...
      this.mBacklightAdapter =
          new BacklightAdapter(iBinder, z, LocalDisplayAdapter.this.mSurfaceControlProxy, j);
    ...
    public boolean updateDisplayPropertiesLocked(
        ...
        SurfaceControl.DynamicDisplayInfo dynamicDisplayInfo,
        SurfaceControl.DesiredDisplayModeSpecs desiredDisplayModeSpecs) {
      boolean updateStaticInfo =
          updateStaticInfo(staticDisplayInfo)
              | updateDisplayModesLocked(
                  dynamicDisplayInfo.supportedDisplayModes,
                  dynamicDisplayInfo.preferredBootDisplayMode,
                  dynamicDisplayInfo.activeDisplayModeId,
                  dynamicDisplayInfo.renderFrameRate,
                  desiredDisplayModeSpecs)
              | updateColorModesLocked(
                  dynamicDisplayInfo.supportedColorModes, dynamicDisplayInfo.activeColorMode)
              | updateHdrCapabilitiesLocked(dynamicDisplayInfo.hdrCapabilities)
              | updateAllmSupport(dynamicDisplayInfo.autoLowLatencyModeSupported)
    ...
    */
    public boolean updateDisplayModesLocked(
      ...
      boolean z3;
      boolean z4;
      this.mSfDisplayModes =
          (SurfaceControl.DisplayMode[]) Arrays.copyOf(displayModeArr, displayModeArr.length);
      ...
      while (i4 < displayModeArr.length) {
        ...
        while (i5 < displayModeArr.length) {
          ...
          if (i5 != i4
              && displayMode2.width == displayMode.width
              && displayMode2.height == displayMode.height
              && displayMode2.refreshRate != displayMode.refreshRate
              && displayMode2.group == displayMode.group) {
        ...
        while (true) {
          ...
          if (displayModeRecord3.hasMatchingMode(displayMode)
              && refreshRatesEquals(
                  arrayList2, displayModeRecord3.mMode.getAlternativeRefreshRates())) {
            z4 = true;
            break;
          }
        }
        ...
        if (displayModeRecord != null) {
          ...
          if (LocalDisplayAdapter.this.mIsBootDisplayModeSupported
            ...
            if (i3 != -1 || i3 == displayModeRecord2.mMode.getModeId()) {
              ...
              Slog.m72d(
                  "LocalDisplayAdapter",
                  "The active mode was changed from SurfaceFlinger or the display device to "
                      + displayModeRecord2.mMode);
            ...
            if (f2 > DisplayPowerController2.RATE_FROM_DOZE_TO_ON || f2 == f) {
              ...
              Slog.m72d(
                  "LocalDisplayAdapter",
                  "The render frame rate was changed from SurfaceFlinger or the display device to "
                      + f);
            ...
            if (this.mDisplayModeSpecs.baseModeId != -1) {
              int findMatchingModeIdLocked =
                  findMatchingModeIdLocked(desiredDisplayModeSpecs.defaultMode);
              if (findMatchingModeIdLocked != -1) {
                DisplayModeDirector.DesiredDisplayModeSpecs desiredDisplayModeSpecs2 =
                    this.mDisplayModeSpecs;
                if (desiredDisplayModeSpecs2.baseModeId == findMatchingModeIdLocked) {
                  if (desiredDisplayModeSpecs2.primary.equals(
                      desiredDisplayModeSpecs.primaryRanges)) {}
                }
              }
            ...
            if (i7 == -1) {
              ...
              Slog.m72d(
                  "LocalDisplayAdapter",
                  "New display modes are added and the active mode has changed, use active mode as"
                      + " default mode.");
              this.mDefaultModeId = displayModeRecord2.mMode.getModeId();
              this.mDefaultModeGroup = this.mActiveSfDisplayMode.group;
              this.mActiveRenderFrameRate = f;
              ...
              Slog.m79w(
                  "LocalDisplayAdapter",
                  "Default display mode no longer available, using currently active mode as"
                      + " default.");
              this.mDefaultModeId = displayModeRecord2.mMode.getModeId();
              this.mDefaultModeGroup = this.mActiveSfDisplayMode.group;
              this.mActiveRenderFrameRate = f;
            ...
            if (this.mSupportedModes.indexOfKey(this.mDisplayModeSpecs.baseModeId) < 0) {
              if (this.mDisplayModeSpecs.baseModeId != -1) {
                Slog.m79w(
                    "LocalDisplayAdapter",
                    "DisplayModeSpecs base mode no longer available, using currently active mode.");
              }
            ...
            if (this.mSupportedModes.indexOfKey(this.mActiveModeId) < 0) {
              if (this.mActiveModeId != -1) {
                Slog.m79w(
                    "LocalDisplayAdapter",
                    "Active display mode no longer available, reverting to default mode.");
              }
    ...
    public final int getLogicalDensity() {
      ...
      return densityMapping.getDensityForResolution(
          displayDeviceInfo.width, displayDeviceInfo.height);
    }

    public final void loadDisplayDeviceConfig() {
      DisplayDeviceConfig create =
          DisplayDeviceConfig.create(
              LocalDisplayAdapter.this.getOverlayContext(),
              this.mIsFirstDisplay,
              this.mStaticDisplayInfo.isInternal,
              this.mBacklightAdapter.mUseSurfaceControlBrightness);
    ...
    public final boolean updateColorModesLocked(int[] iArr, int i) {
      ...
      if (!this.mSupportedColorModes.contains(Integer.valueOf(this.mActiveColorMode))) {
        if (this.mActiveColorMode != 0) {
          Slog.m79w(
              "LocalDisplayAdapter",
              "Active color mode no longer available, reverting to default mode.");
          this.mActiveColorMode = 0;
        } else if (!this.mSupportedColorModes.isEmpty()) {
          Slog.m74e(
              "LocalDisplayAdapter",
              "Default and active color mode is no longer available! Reverting to first available"
                  + " mode.");
    ...
    public final SurfaceControl.DisplayMode getModeById(
        SurfaceControl.DisplayMode[] displayModeArr, int i) {
      for (SurfaceControl.DisplayMode displayMode : displayModeArr) {
        if (displayMode.id == i) {
          return displayMode;
        }
    ...
    public final DisplayModeRecord findDisplayModeRecord(
        SurfaceControl.DisplayMode displayMode, List list) {
      for (int i = 0; i < this.mSupportedModes.size(); i++) {
        ...
        if (displayModeRecord.hasMatchingMode(displayMode)
            && refreshRatesEquals(list, displayModeRecord.mMode.getAlternativeRefreshRates())
            && LocalDisplayAdapter.this.hdrTypesEqual(
                displayMode.supportedHdrTypes, displayModeRecord.mMode.getSupportedHdrTypes())) {
    ...
    public final boolean refreshRatesEquals(List list, float[] fArr) {
      ...
      for (int i = 0; i < list.size(); i++) {
        if (Float.floatToIntBits(((Float) list.get(i)).floatValue())
            != Float.floatToIntBits(fArr[i])) {
          return false;
        }
      }
      return true;
      ...
      if (this.mInfo == null) {
        if (CoreRune.FW_VRR_RESOLUTION_POLICY && this.mStaticDisplayInfo.isInternal) {
          displayMode =
              getModeById(
                  this.mSfDisplayModes,
                  findSfDisplayModeIdLocked(this.mDefaultModeId, this.mDefaultModeGroup));
        } else {
        ...
        for (int i = 0; i < this.mSupportedColorModes.size(); i++) {
          this.mInfo.supportedColorModes[i] =
              ((Integer) this.mSupportedColorModes.get(i)).intValue();
        }
        ...
        DisplayAddress.Physical fromPhysicalDisplayId =
            DisplayAddress.fromPhysicalDisplayId(this.mPhysicalDisplayId);
        ...
        if (z) {
          if (resources.getBoolean(R.bool.config_is_powerbutton_fps)
              || (Build.IS_EMULATOR
                  && SystemProperties.getBoolean("ro.emulator.circular", false))) {
        ...
        Display.Mode maximumResolutionDisplayMode =
            DisplayUtils.getMaximumResolutionDisplayMode(this.mInfo.supportedModes);
        int physicalWidth =
        ...
        if (this.mIsFirstDisplay) {
          ...
          displayDeviceInfo6.displayCutout =
              DisplayCutout.fromResourcesRectApproximation(
                  resources,
                  displayDeviceInfo6.uniqueId,
                  physicalWidth,
                  physicalHeight,
                  displayDeviceInfo6.width,
                  displayDeviceInfo6.height,
                  displayDeviceInfo6.densityDpi,
                  false);
        }
        if (this.mIsFirstDisplay) {
          DisplayDeviceInfo displayDeviceInfo7 = this.mInfo;
          displayDeviceInfo7.roundedCorners =
              RoundedCorners.fromResources(
                  resources,
                  displayDeviceInfo7.uniqueId,
                  physicalWidth,
                  physicalHeight,
                  displayDeviceInfo7.width,
                  displayDeviceInfo7.height);
        }
        ...
        displayDeviceInfo8.displayShape =
            DisplayShape.fromResources(
                resources,
                displayDeviceInfo8.uniqueId,
                physicalWidth,
                physicalHeight,
                displayDeviceInfo8.width,
                displayDeviceInfo8.height);
        ...
        if (this.mStaticDisplayInfo.isInternal) {
          ...
          if (displayDeviceInfo10.name == null) {
            displayDeviceInfo10.name =
                LocalDisplayAdapter.this
                    .getContext()
                    .getResources()
                    .getString(R.string.granularity_label_line);
          }
        }
    ...
    */
    public Runnable requestDisplayStateLocked(
        final int i, final float f, final float f2, final int i2, final ArrayList arrayList) {
      int i3;
      int i4;
      boolean z = this.mState != i;
      final boolean z2 =
          (this.mBrightnessState == f && this.mSdrBrightnessState == f2) ? false : true;
            ...
            */
            public void run() {
              ...
              if (z4 || z5) {
                ...
                localDisplayDevice.notifyStateChangeStart(
                    arrayList, localDisplayDevice.mState, i9, i6);
              ...
              if (z5) {
                ...
                localDisplayDevice2.notifyStateChangeFinish(
                    arrayList, localDisplayDevice2.mState, i9, i6);
              }
              if (i2 != 0) {
                if (z4) {
                  Slog.m72d(
                      ...
                      "display_state_limit: "
                          ...
                          + " (id:"
                          + j
                          + " ) is limited, pending current request. "
                          + Display.stateToString(LocalDisplayDevice.this.mState));
                  if (!z5) {
                    LocalDisplayDevice localDisplayDevice3 = LocalDisplayDevice.this;
                    localDisplayDevice3.notifyStateChangeFinish(
                        arrayList, localDisplayDevice3.mState, i9, i6);
                  }
                }
                if (z2) {
              ...
              if (Display.isSuspendedState(i13) || i5 == 0) {
                if (!Display.isSuspendedState(i)) {
                  ...
                  localDisplayDevice4.notifyStateChangeFinish(
                      arrayList, localDisplayDevice4.mState, i9, i6);
                } else {
                  int i14 = i;
                  if (i14 == 4 || (i7 = i5) == 4) {
                    setDisplayState(3);
                ...
                if (i8 == i11) {
                  ...
                  localDisplayDevice5.notifyStateChangeFinish(
                      arrayList, localDisplayDevice5.mState, i9, i6);
                  return;
                }
                return;
              }
            ...
            public final void setDisplayState(int i7) {
              ...
              Trace.traceBegin(
                  131072L,
                  "setDisplayState(id=" + j + ", state=" + Display.stateToString(i7) + ")");
              try {
                ...
                if (i7 == 2) {
                  PowerManagerUtil.sCurrentScreenOnProfiler.noteDisplayStart(
                      LocalDisplayDevice.this.mRequestedState);
                } else if (i7 == 1) {
                  PowerManagerUtil.sCurrentScreenOffProfiler.noteDisplayStart();
                }
                LocalDisplayAdapter.this.mSurfaceControlProxy.setDisplayPowerMode(
                    displayTokenLocked, powerModeForState);
                if (i7 == 2) {
                  PowerManagerUtil.ScreenOnProfiler screenOnProfiler =
                      PowerManagerUtil.sCurrentScreenOnProfiler;
                ...
                start.m69dk(
                    "LocalDisplayAdapter",
                    "display_state - "
                        + LocalDisplayDevice.this.mDisplayStateCount
                        + " : "
                        + Display.stateToString(i7)
                        + " ("
                        + PowerManagerUtil.displayTypeToString(i6)
                        + ")");
                LocalDisplayDevice localDisplayDevice = LocalDisplayDevice.this;
                ...
                if (!Display.isSuspendedState(i7)
                    || i7 == 1
                    || LocalDisplayDevice.this.mSidekickInternal == null
                    || LocalDisplayDevice.this.mSidekickActive) {
                  return;
                }
                Trace.traceBegin(131072L, "SidekickInternal#startDisplayControl");
                try {
                  LocalDisplayDevice localDisplayDevice2 = LocalDisplayDevice.this;
                  localDisplayDevice2.mSidekickActive =
                      localDisplayDevice2.mSidekickInternal.startDisplayControl(i7);
                } finally {
                }
              } finally {
              }
            ...
            public final void setCommittedState(int i7) {
              synchronized (LocalDisplayAdapter.this.getSyncRoot()) {
                ...
                if (CoreRune.FW_VRR_PERFORMANCE
                    && !LocalDisplayDevice.this.mStateChangeCallbacks.isEmpty()) {
            ...
            public final void setDisplayBrightness(float f3, float f4) {
              ...
              try {
                ...
                LocalDisplayDevice.this.mBacklightAdapter.setBacklight(
                    brightnessToBacklight2,
                    backlightToNits2,
                    brightnessToBacklight,
                    backlightToNits,
                    BrightnessSynchronizer.brightnessFloatToInt(f3),
                    BrightnessSynchronizer.brightnessFloatToInt(f4));
                Trace.traceCounter(
                    131072L, "ScreenBrightness", BrightnessSynchronizer.brightnessFloatToInt(f3));
                Trace.traceCounter(
                    131072L,
                    "SdrScreenBrightness",
                    BrightnessSynchronizer.brightnessFloatToInt(f4));
            ...
            public final float brightnessToBacklight(float f3) {
              return f3 == DisplayPowerController2.RATE_FROM_DOZE_TO_ON
                  ? DisplayPowerController2.RATE_FROM_DOZE_TO_ON
                  : LocalDisplayDevice.this.getDisplayDeviceConfig().getBacklightFromBrightness(f3);
            }
        ...
        */
        public void run() {
          ...
          if (z42 || z52) {
            ...
            LocalDisplayDevice localDisplayDevice = LocalDisplayDevice.this;
            localDisplayDevice.notifyStateChangeStart(
                arrayList, localDisplayDevice.mState, i9, i62);
            screenOnProfiler.noteListenerEnd();
          }
          int i11 = 3;
          if (z52) {
            ...
            LocalDisplayDevice localDisplayDevice2 = LocalDisplayDevice.this;
            localDisplayDevice2.notifyStateChangeFinish(
                arrayList, localDisplayDevice2.mState, i9, i62);
          }
          if (i2 != 0) {
            if (z42) {
              Slog.m72d(
              ...
              if (!z52) {
                LocalDisplayDevice localDisplayDevice3 = LocalDisplayDevice.this;
                localDisplayDevice3.notifyStateChangeFinish(
                    arrayList, localDisplayDevice3.mState, i9, i62);
              }
            }
            if (z2) {
              setDisplayBrightness(f, f2);
          ...
          if (Display.isSuspendedState(i13) || i5 == 0) {
            if (!Display.isSuspendedState(i)) {
              ...
              LocalDisplayDevice localDisplayDevice4 = LocalDisplayDevice.this;
              localDisplayDevice4.notifyStateChangeFinish(
                  arrayList, localDisplayDevice4.mState, i9, i62);
            } else {
              int i14 = i;
              if (i14 == 4 || (i7 = i5) == 4) {
                setDisplayState(3);
            ...
            if (i8 == i11) {
              ...
              LocalDisplayDevice localDisplayDevice5 = LocalDisplayDevice.this;
              localDisplayDevice5.notifyStateChangeFinish(
                  arrayList, localDisplayDevice5.mState, i9, i62);
              return;
            }
            return;
          }
        ...
        public final void setDisplayState(int i7) {
          ...
          int powerModeForState = LocalDisplayAdapter.getPowerModeForState(i7);
          Trace.traceBegin(
              131072L, "setDisplayState(id=" + j + ", state=" + Display.stateToString(i7) + ")");
          try {
            StringBuilder sb = new StringBuilder();
            sb.append("display_state - ");
            sb.append(LocalDisplayDevice.this.mDisplayStateCount);
            ...
            start.m69dk(
                ...
                "display_state - "
                    ...
                    + Display.stateToString(i7)
                    + " ("
                    + PowerManagerUtil.displayTypeToString(i62)
                    + ")");
            LocalDisplayDevice localDisplayDevice = LocalDisplayDevice.this;
            int i8 = localDisplayDevice.mDisplayStateCount + 1;
            localDisplayDevice.mDisplayStateCount = i8;
        ...
        public final void setDisplayBrightness(float f3, float f4) {
          ...
          try {
            ...
            Trace.traceCounter(
                131072L, "ScreenBrightness", BrightnessSynchronizer.brightnessFloatToInt(f3));
            Trace.traceCounter(
                131072L, "SdrScreenBrightness", BrightnessSynchronizer.brightnessFloatToInt(f4));
            if (LocalDisplayDevice.this.getDisplayDeviceConfig().hasSdrToHdrRatioSpline()) {
              handleHdrSdrNitsChanged(backlightToNits, backlightToNits2);
            }
          } finally {
    ...
    public void setUserPreferredDisplayModeLocked(Display.Mode mode) {
      ...
      if (mode != null
          && ((mode.isRefreshRateSet() || mode.isResolutionSet())
              && (findMode =
                      findMode(
      ...
      if (LocalDisplayAdapter.this.mIsBootDisplayModeSupported) {
        if (this.mUserPreferredModeId == -1) {
          LocalDisplayAdapter.this.mSurfaceControlProxy.clearBootDisplayMode(
              getDisplayTokenLocked());
        } else {
          LocalDisplayAdapter.this.mSurfaceControlProxy.setBootDisplayMode(
              getDisplayTokenLocked(),
              findSfDisplayModeIdLocked(
                  this.mUserPreferredMode.getModeId(), this.mDefaultModeGroup));
        }
      }
    }
    ...
    public void setDesiredDisplayModeSpecsLocked(
      ...
      if (findSfDisplayModeIdLocked < 0) {
        Slog.m79w(
            "LocalDisplayAdapter",
            "Ignoring request for invalid base mode id " + desiredDisplayModeSpecs.baseModeId);
      ...
      if (this.mDisplayModeSpecsInvalid
          || !desiredDisplayModeSpecs.equals(this.mDisplayModeSpecs)) {
        ...
        TriConsumer triConsumer =
            new TriConsumer() { // from class:
                                // com.android.server.display.LocalDisplayAdapter$LocalDisplayDevice$$ExternalSyntheticLambda1
              public final void accept(Object obj, Object obj2, Object obj3) {
                ((LocalDisplayAdapter.LocalDisplayDevice) obj)
                    .setDesiredDisplayModeSpecsAsync(
                        (IBinder) obj2, (SurfaceControl.DesiredDisplayModeSpecs) obj3);
              }
            };
        ...
        handler.sendMessage(
            PooledLambda.obtainMessage(
                ...
                new SurfaceControl.DesiredDisplayModeSpecs(
                    findSfDisplayModeIdLocked,
                    desiredDisplayModeSpecs2.allowGroupSwitching,
                    desiredDisplayModeSpecs2.primary,
                    desiredDisplayModeSpecs2.appRequest)));
      }
    }

    public final void setDesiredDisplayModeSpecsAsync(
        final IBinder iBinder,
        final SurfaceControl.DesiredDisplayModeSpecs desiredDisplayModeSpecs) {
      if (CoreRune.FW_VRR_PERFORMANCE) {
        synchronized (LocalDisplayAdapter.this.getSyncRoot()) {
          for (int i = 0; i < LocalDisplayAdapter.this.mDevices.size(); i++) {
            LocalDisplayDevice localDisplayDevice =
                (LocalDisplayDevice) LocalDisplayAdapter.this.mDevices.valueAt(i);
            int i2 = localDisplayDevice.mStateLimit;
            if (i2 != 0) {
              if (i2 != localDisplayDevice.mCommittedState) {
                localDisplayDevice.mStateChangeCallbacks.add(
                    new Runnable() { // from class:
                                     // com.android.server.display.LocalDisplayAdapter$LocalDisplayDevice$$ExternalSyntheticLambda3
                      @Override // java.lang.Runnable
                      public final void run() {
                        LocalDisplayAdapter.LocalDisplayDevice.this
                            .lambda$setDesiredDisplayModeSpecsAsync$0(
                                desiredDisplayModeSpecs, iBinder);
                      }
                    });
                return;
              }
      ...
      LocalDisplayAdapter.this.mSurfaceControlProxy.setDesiredDisplayModeSpecs(
          iBinder, desiredDisplayModeSpecs);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setDesiredDisplayModeSpecsAsync$0(
        SurfaceControl.DesiredDisplayModeSpecs desiredDisplayModeSpecs, IBinder iBinder) {
      EventLog.writeEvent(1290000, desiredDisplayModeSpecs.toString());
      Slog.m72d(
          "LocalDisplayAdapter",
          "Run! setDesiredDisplayModeSpecsAsync("
              + this.mPhysicalDisplayId
              + ") : "
              + desiredDisplayModeSpecs);
      LocalDisplayAdapter.this.mSurfaceControlProxy.setDesiredDisplayModeSpecs(
    ...
    public boolean updateActiveModeLocked(int i, float f) {
      ...
      if (findMatchingModeIdLocked == -1) {
        Slog.m79w(
            "LocalDisplayAdapter",
            "In unknown mode after setting allowed modes, activeModeId=" + i);
      } else if (CoreRune.FW_VRR_POLICY) {
        Slog.m72d(
            "LocalDisplayAdapter",
            "updateActiveModeLocked for d="
                + this.mPhysicalDisplayId
                + ", mActiveModeId="
                + this.mActiveModeId
                + ", mActiveSfDisplayMode="
                + this.mActiveSfDisplayMode);
      }
      if (CoreRune.FW_VRR_RESOLUTION_POLICY
          && this.mIsFirstDisplay
          && (displayMode = this.mActiveSfDisplayMode) != null
          && this.mLastResolution != (i2 = displayMode.width * displayMode.height)) {
    ...
    public void requestColorModeLocked(int i) {
      ...
      LocalDisplayAdapter.this
          ...
          .sendMessage(
              PooledLambda.obtainMessage(
                  new TriConsumer() { // from class:
                                      // com.android.server.display.LocalDisplayAdapter$LocalDisplayDevice$$ExternalSyntheticLambda0
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((LocalDisplayAdapter.LocalDisplayDevice) obj)
                          .requestColorModeAsync((IBinder) obj2, ((Integer) obj3).intValue());
                    }
                  },
                  this,
                  getDisplayTokenLocked(),
    ...
    public void setAutoLowLatencyModeLocked(boolean z) {
      ...
      if (!this.mAllmSupported) {
        Slog.m72d(
            "LocalDisplayAdapter",
            "Unable to set ALLM because the connected display does not support ALLM.");
      } else {
        LocalDisplayAdapter.this.mSurfaceControlProxy.setAutoLowLatencyMode(
            getDisplayTokenLocked(), z);
      }
    }
    ...
    public final int findUserPreferredModeIdLocked(Display.Mode mode) {
      ...
      for (int i = 0; i < this.mSupportedModes.size(); i++) {
        ...
        if (mode.matches(
            mode2.getPhysicalWidth(), mode2.getPhysicalHeight(), mode2.getRefreshRate())) {
      ...
      if (physical != null
          && (intArray =
                  LocalDisplayAdapter.this
                      .getOverlayContext()
                      .getResources()
                      .getIntArray(R.array.supported_locales))
              != null) {
    ...
    public final void notifyStateChangeStart(
        ArrayList arrayList, final int i, final int i2, final int i3) {
      ...
      arrayList.forEach(
          new Consumer() { // from class:
                           // com.android.server.display.LocalDisplayAdapter$LocalDisplayDevice$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              LocalDisplayAdapter.LocalDisplayDevice.lambda$notifyStateChangeStart$1(
                  PowerManagerUtil.StopwatchLogger.this,
                  i,
                  i2,
                  i3,
                  (DisplayManagerInternal.DisplayStateListener) obj);
            }
          });
    }

    public static /* synthetic */ void lambda$notifyStateChangeStart$1(
        PowerManagerUtil.StopwatchLogger stopwatchLogger,
        int i,
        int i2,
        int i3,
      ...
      stopwatchLogger.m68d(
          "LocalDisplayAdapter", "notifyStateChangeStart: " + displayStateListener);
    }

    public final void notifyStateChangeFinish(
        ArrayList arrayList, final int i, final int i2, final int i3) {
      if (arrayList == null || arrayList.isEmpty()) {
        return;
      }
      ...
      arrayList.forEach(
          new Consumer() { // from class:
                           // com.android.server.display.LocalDisplayAdapter$LocalDisplayDevice$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              LocalDisplayAdapter.LocalDisplayDevice.lambda$notifyStateChangeFinish$2(
                  PowerManagerUtil.StopwatchLogger.this,
                  i,
                  i2,
                  i3,
    ...
    public static /* synthetic */ void lambda$notifyStateChangeFinish$2(
        PowerManagerUtil.StopwatchLogger stopwatchLogger,
        int i,
        int i2,
        int i3,
      ...
      stopwatchLogger.m68d(
          "LocalDisplayAdapter", "notifyStateChangeFinish: " + displayStateListener);
    }
  }
    ...
    public DisplayModeRecord(SurfaceControl.DisplayMode displayMode, float[] fArr) {
      this.mMode =
          DisplayAdapter.createMode(
              ...
              fArr,
              displayMode.supportedHdrTypes);
    }

    public boolean hasMatchingMode(SurfaceControl.DisplayMode displayMode) {
      return this.mMode.getPhysicalWidth() == displayMode.width
          && this.mMode.getPhysicalHeight() == displayMode.height
          && Float.floatToIntBits(this.mMode.getRefreshRate())
              == Float.floatToIntBits(displayMode.refreshRate);
    }
  ...
  public class Injector {
    ...
    public void setDisplayEventListenerLocked(
        Looper looper, DisplayEventListener displayEventListener) {
  ...
  public final class LocalDisplayEventListener implements DisplayEventListener {
    ...
    public void onModeChanged(long j, long j2, int i, long j3) {
      synchronized (LocalDisplayAdapter.this.getSyncRoot()) {
        LocalDisplayDevice localDisplayDevice =
            (LocalDisplayDevice) LocalDisplayAdapter.this.mDevices.get(j2);
        if (localDisplayDevice == null) {
          return;
        }
  ...
  public class SurfaceControlProxy {
    ...
    public boolean setDesiredDisplayModeSpecs(
        IBinder iBinder, SurfaceControl.DesiredDisplayModeSpecs desiredDisplayModeSpecs) {
  ...
  public class BacklightAdapter {
    ...
    public BacklightAdapter(
        IBinder iBinder, boolean z, SurfaceControlProxy surfaceControlProxy, long j) {
      ...
      this.mIsFirstDisplay = z;
      SurfaceControl.StaticDisplayInfo staticDisplayInfo =
          surfaceControlProxy.getStaticDisplayInfo(j);
      boolean z2 = staticDisplayInfo != null && staticDisplayInfo.isInternal;
      if (!displayBrightnessSupport && z) {
        this.mBacklight =
            ((LightsManager) LocalServices.getService(LightsManager.class)).getLight(0);
      } else if (!displayBrightnessSupport && z2) {
        this.mBacklight =
            ((LightsManager) LocalServices.getService(LightsManager.class)).getLight(9);
      } else {
    ...
    public void setBacklight(float f, float f2, float f3, float f4, int i, int i2) {
      if (this.mUseSurfaceControlBrightness || this.mForceSurfaceControl) {
        ...
        Slog.m72d(
            "LocalDisplayAdapter",
            "surface lcd : "
                + PowerManagerUtil.brightnessToString(i, f3)
                + ", "
                + PowerManagerUtil.brightnessToString(i2, f)
                + ", "
                + PowerManagerUtil.displayTypeToString(this.mIsFirstDisplay)
                + " +");
    ...
    public String toString() {
      return "BacklightAdapter [useSurfaceControl="
          + this.mUseSurfaceControlBrightness
          + " (force_anyway? "
          + this.mForceSurfaceControl
          + "), backlight="
          + this.mBacklight
          + "]";
    }
