...
public abstract class DisplayAdapter {
    ...
    public final void sendDisplayDeviceEventLocked(final DisplayDevice displayDevice, final int i) {
        this.mHandler.post(
                new Runnable() { // from class:
                                 // com.android.server.display.DisplayAdapter$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DisplayAdapter displayAdapter = DisplayAdapter.this;
                        ((DisplayDeviceRepository) displayAdapter.mListener)
                                .onDisplayDeviceEvent(displayDevice, i);
                    }
                });
    }
    ...
    public final void sendTraversalRequestLocked() {
        this.mHandler.post(
                new Runnable() { // from class:
                                 // com.android.server.display.DisplayAdapter$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DisplayDeviceRepository displayDeviceRepository =
                                (DisplayDeviceRepository) DisplayAdapter.this.mListener;
