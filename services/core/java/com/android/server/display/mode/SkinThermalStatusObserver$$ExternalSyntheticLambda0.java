...
public final /* synthetic */ class SkinThermalStatusObserver$$ExternalSyntheticLambda0
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ SkinThermalStatusObserver f$0;
    public final /* synthetic */ int f$1;

    public /* synthetic */ SkinThermalStatusObserver$$ExternalSyntheticLambda0(
            SkinThermalStatusObserver skinThermalStatusObserver, int i, int i2) {
        this.$r8$classId = i2;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                synchronized (skinThermalStatusObserver.mThermalObserverLock) {
                    ...
                    sparseArray =
                            (SparseArray)
                                    skinThermalStatusObserver.mThermalThrottlingByDisplay.get(i2);
                }
                if (sparseArray == null) {
                    AnyMotionDetector$$ExternalSyntheticOutline0.m(
                            i2,
                            "Updating votes, display already removed, display=",
                ...
                if (skinThermalStatusObserver.mLoggingEnabled) {
                    StringBuilder m =
                            ArrayUtils$$ExternalSyntheticOutline0.m(
                                    i, i2, "Updating votes for status=", ", display =", ", map=");
