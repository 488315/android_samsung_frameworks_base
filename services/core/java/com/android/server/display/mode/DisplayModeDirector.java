    ...
    */
        ...
        synchronized (this.mLock) {
            ...
            if (modeArr != null && mode != null) {
                ...
                if (selectBaseMode == null) {
                    Slog.w("DisplayModeDirector", "Can't find a set of allowed modes which satisfies the votes. Falling back to the default mode. Display = " + i + ", votes = " + votes + ", supported modes = " + Arrays.toString(modeArr));
    ...
    final class SettingsObserver extends ContentObserver {
        ...
        public void setRefreshRates(DisplayDeviceConfig displayDeviceConfig, boolean z) {
            ...
            if (displayDeviceConfig == null) {
                defaultRefreshRate = this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceDecreaseDebounce);
            } else {
        ...
        */
        public final void setDefaultPeakRefreshRate(DisplayDeviceConfig displayDeviceConfig, boolean z) {
            ...
            if (z) {
                ...
                if (defaultPeakRefreshRate == null) {
                    if (displayDeviceConfig == null) {
                        defaultPeakRefreshRate2 = this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceColorTemperatureMin);
                    } else {
    ...
    public class BrightnessObserver implements DisplayManager.DisplayListener {
        ...
        public BrightnessObserver(Context context, Handler handler, Injector injector) {
            ...
            this.mRefreshRateInHighZone = context.getResources().getInteger(R.integer.config_letterboxDefaultPositionForBookModeReachability);
        }
        ...
        public final void loadLowBrightnessThresholds(final DisplayDeviceConfig displayDeviceConfig, boolean z) {
            ...
            }, R.array.config_requestVibrationParamsForUsages, displayDeviceConfig, z);
            ...
            }, R.array.config_minimumBrightnessCurveLux, displayDeviceConfig, z);
        ...
        public final void loadRefreshRateInLowZone(DisplayDeviceConfig displayDeviceConfig, boolean z) {
            ...
            if (displayDeviceConfig == null) {
                defaultLowBlockingZoneRefreshRate = this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceTransitionTime);
            } else {
        ...
        public final void loadRefreshRateInHighZone(DisplayDeviceConfig displayDeviceConfig, boolean z) {
            ...
            if (displayDeviceConfig == null) {
                defaultHighBlockingZoneRefreshRate = this.mContext.getResources().getInteger(R.integer.config_letterboxDefaultPositionForBookModeReachability);
            } else {
        ...
        public final void loadHighBrightnessThresholds(final DisplayDeviceConfig displayDeviceConfig, boolean z) {
            ...
            }, R.array.resolver_target_actions_pin, displayDeviceConfig, z);
            ...
            }, R.array.required_apps_managed_user, displayDeviceConfig, z);
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public final int[] loadBrightnessThresholds(Callable callable, Callable callable2, int i, DisplayDeviceConfig displayDeviceConfig, boolean z) {
            int[] iArr;
            int[] iArr2;
            if (z) {
                try {
        ...
        public final void onDeviceConfigLowBrightnessThresholdsChanged(int[] iArr, int[] iArr2) {
            ...
            if (iArr != null && iArr2 != null && iArr.length == iArr2.length) {
                ...
                }, R.array.config_requestVibrationParamsForUsages, displayDeviceConfig, false);
                ...
                }, R.array.config_minimumBrightnessCurveLux, displayDeviceConfig, false);
            }
            restartObserver();
        }
        ...
        public final void onDeviceConfigHighBrightnessThresholdsChanged(int[] iArr, int[] iArr2) {
            ...
            if (iArr != null && iArr2 != null && iArr.length == iArr2.length) {
                ...
                }, R.array.resolver_target_actions_pin, displayDeviceConfig, false);
                ...
                }, R.array.required_apps_managed_user, displayDeviceConfig, false);
            }
            restartObserver();
        }
        ...
        public final void reloadLightSensorData(DisplayDeviceConfig displayDeviceConfig) {
            if (displayDeviceConfig != null && displayDeviceConfig.getAmbientLightSensor() != null) {
                ...
                this.mLightSensorType = this.mContext.getResources().getString(R.string.demo_restarting_message);
    ...
    public class UdfpsObserver extends IUdfpsRefreshRateRequestCallback.Stub {
        ...
        public void observe() {
            ...
            if (statusBarManagerInternal == null || DisplayModeDirector.this.mContext.getResources().getBoolean(R.bool.config_faceAuthSupportsSelfIllumination)) {
                return;
            }
    ...
    public class DeviceConfigDisplaySettings implements DeviceConfig.OnPropertiesChangedListener {
        ...
        public int getRefreshRateInHbmHdr(DisplayDeviceConfig displayDeviceConfig) {
            ...
            if (displayDeviceConfig == null) {
                defaultRefreshRateInHbmHdr = DisplayModeDirector.this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceDisplayNominalWhiteCct);
            } else {
        ...
        public int getRefreshRateInHbmSunlight(DisplayDeviceConfig displayDeviceConfig) {
            ...
            if (displayDeviceConfig == null) {
                defaultRefreshRateInHbmSunlight = DisplayModeDirector.this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceIncreaseDebounce);
            } else {
