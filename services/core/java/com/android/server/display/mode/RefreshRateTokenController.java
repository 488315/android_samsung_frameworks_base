...
public class RefreshRateTokenController {
  ...
  public IRefreshRateToken createRefreshRateToken(
    ...
    synchronized (this.mLock) {
      ...
      refreshRateToken.init(
          refreshRateTokenInfo,
      ...
      if (CoreRune.FW_VRR_SYSTEM_HISTORY) {
        this.mRefreshRateTokenHistory.add(
            "Adding refreshRateToken=" + refreshRateToken + ", caller=" + Debug.getCallers(5));
      }
    }
  ...
  public void removeRefreshRateToken(RefreshRateToken refreshRateToken) {
    synchronized (this.mLock) {
      ...
      if (CoreRune.FW_VRR_SYSTEM_HISTORY) {
        this.mRefreshRateTokenHistory.add(
            "Removing refreshRateToken=" + refreshRateToken + ", caller=" + Debug.getCallers(5));
      }
    }
  }
