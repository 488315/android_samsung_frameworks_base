...
public final /* synthetic */ class DisplayModeDirector$BrightnessObserver$$ExternalSyntheticLambda0
        implements Callable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ DisplayModeDirector.BrightnessObserver f$0;

    public /* synthetic */ DisplayModeDirector$BrightnessObserver$$ExternalSyntheticLambda0(
            DisplayModeDirector.BrightnessObserver brightnessObserver, int i) {
        this.$r8$classId = i;
        ...
        switch (this.$r8$classId) {
            case 0:
                return DeviceConfigParsingUtils.displayBrightnessThresholdsIntToFloat(
                        this.f$0.this$0.mConfigParameterProvider.getIntArrayProperty(
