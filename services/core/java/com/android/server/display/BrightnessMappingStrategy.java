...
public abstract class BrightnessMappingStrategy {
    ...
    public static BrightnessMappingStrategy create(Resources resources, DisplayDeviceConfig displayDeviceConfig, boolean z, DisplayWhiteBalanceController displayWhiteBalanceController) {
        ...
        if (z) {
            autoBrightnessBrighteningLevelsNits = getFloatArray(resources.obtainTypedArray(R.array.config_networkSupportedKeepaliveCount));
            autoBrightnessBrighteningLevelsLux = getLuxLevels(resources.getIntArray(R.array.config_notificationFallbackVibeWaveform));
        } else {
        ...
        sScreenExtendedBrightnessRangeMaximum = resources.getInteger(R.integer.config_screenTimeoutOverride);
