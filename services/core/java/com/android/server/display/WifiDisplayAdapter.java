...
public final class WifiDisplayAdapter extends DisplayAdapter {
        ...
        public final void run() {
            ...
            switch (this.$r8$classId) {
                case 0:
                    ...
                    wifiDisplayAdapter.mDisplayController =
                            new WifiDisplayController(
                                    wifiDisplayAdapter.mContext,
                                    ((DisplayAdapter) wifiDisplayAdapter).mHandler,
                                    wifiDisplayAdapter.mWifiDisplayListener,
                                    wifiDisplayAdapter.mPersistentDataStore);
                    WifiDisplayAdapter wifiDisplayAdapter2 = this.this$0;
                    wifiDisplayAdapter2.mDlnaController =
                            new DlnaController(
                                    wifiDisplayAdapter2.mContext,
                                    ((DisplayAdapter) wifiDisplayAdapter2).mHandler);
                    WifiDisplayAdapter wifiDisplayAdapter3 = this.this$0;
                    wifiDisplayAdapter3.mVolumeController =
                            new VolumeController(
                                    ((DisplayAdapter) wifiDisplayAdapter3).mHandler,
                                    wifiDisplayAdapter3.mDisplayController,
                                    wifiDisplayAdapter3.mDlnaController);
                    ...
                    wifiDisplayAdapter4.mContext.registerReceiverAsUser(
                            wifiDisplayAdapter4.mBroadcastReceiver,
                            UserHandle.ALL,
                            intentFilter,
                            null,
                            wifiDisplayAdapter4.mHandler,
                            2);
                    break;
                case 1:
                ...
                case 3:
                    ...
                    if (wifiDisplayController3 != null
                            && (remoteDisplay = wifiDisplayController3.mRemoteDisplay) != null) {
                        remoteDisplay.pause();
                        break;
                    }
                    break;
                case 4:
                    ...
                    if (wifiDisplayController4 != null
                            && (remoteDisplay2 = wifiDisplayController4.mRemoteDisplay) != null) {
    ...
    public final class AnonymousClass11 implements Runnable {
        ...
        public /* synthetic */ AnonymousClass11(
                WifiDisplayAdapter wifiDisplayAdapter, boolean z, int i) {
            this.$r8$classId = i;
            this.this$0 = wifiDisplayAdapter;
            this.val$mode = z;
        }
            ...
            switch (this.$r8$classId) {
                case 0:
                    ...
                    SystemProperties.set(
                            "wlan.wfd.screenratiovalue", String.valueOf(this.val$mode));
                    break;
                default:
                    SemWifiManager semWifiManager =
                            (SemWifiManager) this.this$0.mContext.getSystemService("sem_wifi");
            ...
            synchronized (WifiDisplayAdapter.this.mSyncRoot) {
                try {
                    WifiDisplay applyWifiDisplayAlias =
                            WifiDisplayAdapter.this.mPersistentDataStore.applyWifiDisplayAlias(
                                    wifiDisplay);
                    if (surface != null) {
                        WifiDisplayAdapter.m465$$Nest$maddDisplayDeviceLocked(
                                WifiDisplayAdapter.this, applyWifiDisplayAlias, surface, i, i2, i3);
                    } else {
                    ...
                    if (wifiDisplayAdapter.mActiveDisplayState != 2
                            || (wifiDisplay2 = wifiDisplayAdapter.mActiveDisplay) == null
                            || !wifiDisplay2.equals(applyWifiDisplayAlias)
                    ...
                    wifiDisplayAdapter3.mHandler.post(
                            new AnonymousClass11(wifiDisplayAdapter3, false, 1));
                } catch (Throwable th) {
                    throw th;
                }
            }
    ...
    public final class WifiDisplayDevice extends DisplayDevice {
        ...
        public WifiDisplayDevice(
                IBinder iBinder, String str, int i, int i2, int i3, String str2, Surface surface) {
            super(
                    WifiDisplayAdapter.this,
                    iBinder,
                    ConnectivityModuleConnector$$ExternalSyntheticOutline0.m("wifi:", str2),
                    WifiDisplayAdapter.this.mContext,
                    false);
            this.mRotation = 0;
        ...
        public final DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            if (this.mInfo == null) {
                ...
                DisplayDeviceInfo displayDeviceInfo4 =
                        WifiDisplayAdapter.this.mDefaultDisplayDeviceInfo;
                ...
                try {
                    if (wifiDisplayAdapter.mPendingStatusChangeBroadcast) {
                        ...
                        intent.putExtra(
                                ...
                                (Parcelable) wifiDisplayAdapter.getWifiDisplayStatusLocked());
                        BroadcastOptions makeBasic = BroadcastOptions.makeBasic();
                        makeBasic.setDeliveryGroupPolicy(1);
                        wifiDisplayAdapter.mContext.sendBroadcastAsUser(
                                intent, UserHandle.ALL, null, makeBasic.toBundle());
                    }
                } finally {
                }
            }
    ...
    public static void m465$$Nest$maddDisplayDeviceLocked(
        ...
        int i4 =
                z
                        ? wifiDisplayAdapter.mSupportsProtectedBuffers ? 268435564 : 268435556
                        : 268435552;
        ...
        int i6 =
                ((wifiDisplay.getFlags() & 32) != 0 || wifiDisplay.getMode() == 1)
                        ? 536870912 | i4
                        : i4;
        ...
        WifiDisplayDevice wifiDisplayDevice =
                ...
                .new WifiDisplayDevice(
                        DisplayControl.createVirtualDisplay(friendlyDisplayName, z),
                        friendlyDisplayName,
                        i,
                        i2,
                        i6,
            ...
            ((DisplayAdapter) wifiDisplayAdapter)
                    .mHandler.post(
                            new Runnable() { // from class:
                                             // com.android.server.display.WifiDisplayAdapter$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    WifiDisplayAdapter wifiDisplayAdapter2 =
                                            WifiDisplayAdapter.this;
                                    int i7 = i5;
                                    ...
                                    wifiDisplayAdapter2.mContext.sendBroadcastAsUser(
    ...
    public static void m466$$Nest$mfixRememberedDisplayNamesFromAvailableDisplaysLocked(
        ...
        while (true) {
            ...
            if (wifiDisplay != null && !wifiDisplay2.equals(wifiDisplay)) {
                Slog.d(
                        "WifiDisplayAdapter",
                        "fixRememberedDisplayNamesFromAvailableDisplaysLocked: updating remembered"
                            + " display to "
                                + wifiDisplay);
                wifiDisplayAdapter.mRememberedDisplays[i] = wifiDisplay;
                z |=
                        persistentDataStore.rememberWifiDisplay(
                                new WifiDisplay(
                                        wifiDisplay.getDeviceAddress(),
    ...
    public static void m467$$Nest$mupdateDisplaySurfaceLocked(
            WifiDisplayAdapter wifiDisplayAdapter, Surface surface, int i, int i2) {
        ...
        if (wifiDisplayDevice != null) {
            DeviceIdleController$$ExternalSyntheticOutline0.m(
                    new StringBuilder("updateSurfaceLocked = "),
                    wifiDisplayDevice.mName,
                    "WifiDisplayAdapter");
            WifiDisplayAdapter wifiDisplayAdapter2 = WifiDisplayAdapter.this;
            if (wifiDisplayAdapter2.mDisplayDevice.mSurface.equals(surface)
    ...
    public WifiDisplayAdapter(
        ...
        this.mBroadcastReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.android.server.display.WifiDisplayAdapter.13
                    ...
                    public final void onReceive(Context context2, Intent intent) {
                        ...
                        if ("com.samsung.intent.action.SEC_PRESENTATION_START".equals(action)) {
                            try {
                                final String stringExtra =
                                        intent.getStringExtra("ownerPackageName");
                                ...
                                ((DisplayAdapter) wifiDisplayAdapter)
                                        .mHandler.post(
                                                new Runnable() { // from class:
                                                                 // com.android.server.display.WifiDisplayAdapter.10
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        Handler handler2 =
                                                                ((DisplayAdapter)
                                                        ...
                                                        int i = intExtra;
                                                        boolean z2 = z;
                                                        ((DisplayAdapter) WifiDisplayAdapter.this)
                                ...
                                Slog.e(
                                        "WifiDisplayAdapter",
                                        "SEM_PRESENTATION_START Error : " + e.toString());
                                return;
                            }
                        }
                        ...
                        try {
                            ...
                            ((DisplayAdapter) wifiDisplayAdapter2)
                                    .mHandler.post(
                                            new Runnable() { // from class:
                                                             // com.android.server.display.WifiDisplayAdapter.10
                                                @Override // java.lang.Runnable
                            ...
                            Slog.e(
                                    "WifiDisplayAdapter",
                                    "SEM_PRESENTATION_STOP Error : " + e2.toString());
                        }
                    }
                };
        ...
        if (!context.getPackageManager().hasSystemFeature("android.hardware.wifi.direct")) {
            throw new RuntimeException(
                    "WiFi display was requested, but there is no WiFi Direct feature");
        }
        ...
        this.mSupportsProtectedBuffers =
                context.getResources().getBoolean(R.bool.ignore_modem_config_emergency_numbers);
    }
    ...
    public final void dumpLocked(PrintWriter printWriter) {
        ...
        StringBuilder m =
                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                        new StringBuilder("mFeatureState="),
                                        this.mFeatureState,
                                        printWriter,
                                        "mScanState="),
                                this.mScanState,
        ...
        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                printWriter,
                                Arrays.toString(this.mRememberedDisplays),
                                "mPendingStatusChangeBroadcast=",
                                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                        printWriter,
                                        Arrays.toString(this.mAvailableDisplays),
                                        "mRememberedDisplays=",
                                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                printWriter,
                                                Arrays.toString(this.mDisplays),
                                                "mAvailableDisplays=",
                                                new StringBuilder("mDisplays=")))),
                        this.mPendingStatusChangeBroadcast,
                        printWriter,
        ...
        DumpUtils.dumpAsync(
                super.mHandler, this.mDisplayController, indentingPrintWriter, "", 200L);
    }
    ...
    public final void requestForgetLocked(String str) {
        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                "requestForgetLocked: address=", str, "WifiDisplayAdapter");
    ...
    */
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.display.WifiDisplayAdapter.requestRenameLocked(java.lang.String,"
                    + " java.lang.String):void");
    }

    public final boolean requestWifiDisplayParameter(
        ...
        if (wifiDisplayController.mAdvertisedDisplay != null && semWifiDisplayParameter != null) {
            ...
            switch (str) {
                case "initparams":
                    wifiDisplayController.setParam(
                            "setc",
                            WifiDisplayController.wifiDisplayParameterToJOSNArray(
                                    "initparams", semWifiDisplayParameter));
                    return true;
                case "setparams":
                    wifiDisplayController.setParam(
                            "setp",
                            WifiDisplayController.wifiDisplayParameterToJOSNArray(
                                    "setparams", semWifiDisplayParameter));
                    return true;
                case "getparams":
                    return true;
            }
    ...
    public final void setDlnaDevice(SemDlnaDevice semDlnaDevice, IBinder iBinder) {
        ...
        if (semDlnaDevice.getDlnaType() == -1 || semDlnaDevice.getDlnaType() == 3) {
            ...
            if (iBinder != null && dlnaController.mDlnaMonitor == null) {
                dlnaController.mDlnaMonitor =
                        dlnaController
                        .new DlnaClientDeathMonitor(iBinder, semDlnaDevice.getDlnaType());
            }
    ...
    public final void updateRememberedDisplaysLocked() {
        ...
        this.mRememberedDisplays =
                (WifiDisplay[]) arrayList.toArray(new WifiDisplay[arrayList.size()]);
        this.mActiveDisplay = persistentDataStore.applyWifiDisplayAlias(this.mActiveDisplay);
        this.mAvailableDisplays =
                persistentDataStore.applyWifiDisplayAliases(this.mAvailableDisplays);
