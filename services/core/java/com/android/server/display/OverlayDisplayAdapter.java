...
public final class OverlayDisplayAdapter extends DisplayAdapter {
  ...
  public void registerLocked() {
    ...
    getHandler()
        .post(
            new Runnable() { // from class: com.android.server.display.OverlayDisplayAdapter.1
  ...
  public final void updateOverlayDisplayDevicesLocked() {
    ...
    String[] split;
    String string =
        Settings.Global.getString(getContext().getContentResolver(), "overlay_display_devices");
    if (string == null) {
      string = "";
    }
    int i6 = 2;
      ...
      if (!matcher.matches()) {
        ...
        while (i7 < length2) {
          ...
          if (matcher2.matches()) {
            strArr2 = split3;
            try {
              parseInt = Integer.parseInt(matcher2.group(i8), 10);
              i4 = length2;
            ...
            try {
              ...
              if (parseInt >= 100
                ...
                Slog.w(
                    "OverlayDisplayAdapter", "Ignoring out-of-range overlay display mode: " + str2);
              }
        ...
        if (arrayList.isEmpty()) {
          ...
          String string2 =
              getContext()
                  .getResources()
                  .getString(R.string.granularity_label_link, Integer.valueOf(i13));
          ...
          if (CoreRune.MD_DEX_EMULATOR) {
            ...
            this.mOverlays.add(
                new OverlayDisplayHandle(
                    string2, arrayList, chooseOverlayGravity, parseFlags, i13, i9));
          } else {
            i3 = length;
            strArr = split2;
            i2 = i12;
            this.mOverlays.add(
                new OverlayDisplayHandle(
                    this, string2, arrayList, chooseOverlayGravity, parseFlags, i13));
          }
          i10 = i13;
          i11 = i2 + 1;
          length = i3;
  ...
  public abstract class OverlayDisplayDevice extends DisplayDevice {
    ...
    public OverlayDisplayDevice(
      ...
      super(
          ...
          iBinder,
          "overlay:" + i4,
          OverlayDisplayAdapter.this.getContext());
      this.mName = str;
      this.mRefreshRate = f;
    ...
    public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
      if (this.mInfo == null) {
        ...
        displayDeviceInfo2.presentationDeadlineNanos =
            this.mDisplayPresentationDeadlineNanos + (1000000000 / ((int) this.mRefreshRate));
  ...
  public final class OverlayDisplayHandle implements OverlayDisplayWindow.Listener {
    ...
    public OverlayDisplayHandle(
        String str, List list, int i, OverlayFlags overlayFlags, int i2, int i3) {
      this.mDisplayId = -1;
      this.mShowRunnable =
          new Runnable() { // from class:
                           // com.android.server.display.OverlayDisplayAdapter.OverlayDisplayHandle.2
            @Override // java.lang.Runnable
            public void run() {
              OverlayMode overlayMode =
                  (OverlayMode)
                      OverlayDisplayHandle.this.mModes.get(OverlayDisplayHandle.this.mActiveMode);
              OverlayDisplayWindow overlayDisplayWindow =
                  new OverlayDisplayWindow(
                      CoreRune.MD_DEX_EMULATOR
                          ? OverlayDisplayHandle.this.getDisplayContext()
                          : OverlayDisplayAdapter.this.getContext(),
                      OverlayDisplayHandle.this.mName,
                      overlayMode.mWidth,
                      overlayMode.mHeight,
                      overlayMode.mDensityDpi,
                      OverlayDisplayHandle.this.mGravity,
                      OverlayDisplayHandle.this.mFlags.mSecure,
      ...
      this.mDismissRunnable =
          new Runnable() { // from class:
                           // com.android.server.display.OverlayDisplayAdapter.OverlayDisplayHandle.3
            @Override // java.lang.Runnable
            public void run() {
              OverlayDisplayWindow overlayDisplayWindow;
              synchronized (OverlayDisplayAdapter.this.getSyncRoot()) {
      ...
      this.mResizeRunnable =
          new Runnable() { // from class:
                           // com.android.server.display.OverlayDisplayAdapter.OverlayDisplayHandle.4
            @Override // java.lang.Runnable
            public void run() {
              synchronized (OverlayDisplayAdapter.this.getSyncRoot()) {
                ...
                OverlayMode overlayMode =
                    (OverlayMode)
                        OverlayDisplayHandle.this.mModes.get(OverlayDisplayHandle.this.mActiveMode);
                OverlayDisplayHandle.this.mWindow.resize(
                    overlayMode.mWidth, overlayMode.mHeight, overlayMode.mDensityDpi);
              }
            }
          };
      this.mName = str;
      ...
      synchronized (OverlayDisplayAdapter.this.getSyncRoot()) {
        OverlayDisplayDevice overlayDisplayDevice =
            new OverlayDisplayDevice(
                DisplayControl.createDisplay(this.mName, this.mFlags.mSecure),
                this.mName,
                this.mModes,
                this.mActiveMode,
                0,
                ...
                this
                    .mNumber) { // from class:
                                // com.android.server.display.OverlayDisplayAdapter.OverlayDisplayHandle.1
              {
    ...
    public void dumpLocked(PrintWriter printWriter) {
      ...
      if (this.mWindow != null) {
        ...
        DumpUtils.dumpAsync(
            OverlayDisplayAdapter.this.mUiHandler, this.mWindow, indentingPrintWriter, "", 200L);
      }
    }
  ...
  public final class OverlayFlags {
    ...
    public String toString() {
      return "{secure="
          + this.mSecure
          + ", ownContentOnly="
          + this.mOwnContentOnly
          + ", shouldShowSystemDecorations="
          + this.mShouldShowSystemDecorations
          + "}";
    }
  }
}
