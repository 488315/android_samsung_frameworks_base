...
public final class WakelockController {
  ...
  public Runnable getOnProximityPositiveRunnable() {
    return new Runnable() { // from class:
                            // com.android.server.display.WakelockController$$ExternalSyntheticLambda1
  ...
  public Runnable getOnStateChangedRunnable() {
    return new Runnable() { // from class:
                            // com.android.server.display.WakelockController$$ExternalSyntheticLambda0
      @Override // java.lang.Runnable
      public final void run() {
  ...
  public Runnable getOnProximityNegativeRunnable() {
    return new Runnable() { // from class:
                            // com.android.server.display.WakelockController$$ExternalSyntheticLambda2
      @Override // java.lang.Runnable
      public final void run() {
