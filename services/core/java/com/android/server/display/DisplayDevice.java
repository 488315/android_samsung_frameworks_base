...
public abstract class DisplayDevice {
  ...
  public DisplayDevice(
      DisplayAdapter displayAdapter, IBinder iBinder, String str, Context context) {
  ...
  public final void setProjectionLocked(
      SurfaceControl.Transaction transaction, int i, Rect rect, Rect rect2) {
    Rect rect3;
    Rect rect4;
    if (this.mCurrentOrientation == i
        && (rect3 = this.mCurrentLayerStackRect) != null
        && rect3.equals(rect)
        && (rect4 = this.mCurrentDisplayRect) != null
        && rect4.equals(rect2)) {
      return;
    }
    ...
    Slog.d(
        "DisplayDevice",
        "setProjectionLocked, orientation="
            + i
            + ", layerStackRect="
            + rect
            + ", displayRect="
  ...
  public final void populateViewportLocked(DisplayViewport displayViewport) {
    ...
    DisplayDeviceInfo displayDeviceInfoLocked = getDisplayDeviceInfoLocked();
    displayViewport.deviceWidth =
        z ? displayDeviceInfoLocked.height : displayDeviceInfoLocked.width;
    displayViewport.deviceHeight =
        z ? displayDeviceInfoLocked.width : displayDeviceInfoLocked.height;
