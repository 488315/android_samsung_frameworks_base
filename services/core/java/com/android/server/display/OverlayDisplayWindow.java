...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
  ...
  public final DisplayManager.DisplayListener mDisplayListener =
      new DisplayManager
          .DisplayListener() { // from class: com.android.server.display.OverlayDisplayWindow.1
        ...
        public void onDisplayChanged(int i) {
          if (i == OverlayDisplayWindow.this.mDefaultDisplay.getDisplayId()) {
            if (OverlayDisplayWindow.this.updateDefaultDisplayInfo()) {
              ...
              OverlayDisplayWindow.this.mListener.onStateChanged(
                  OverlayDisplayWindow.this.mDefaultDisplayInfo.state);
            } else {
  ...
  public final TextureView.SurfaceTextureListener mSurfaceTextureListener =
      new TextureView
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
          OverlayDisplayWindow.this.mListener.onWindowCreated(
              surfaceTexture,
              OverlayDisplayWindow.this.mDefaultDisplayInfo.getRefreshRate(),
              OverlayDisplayWindow.this.mDefaultDisplayInfo.presentationDeadlineNanos,
              OverlayDisplayWindow.this.mDefaultDisplayInfo.state);
        }
  ...
  public final View.OnTouchListener mOnTouchListener =
      new View.OnTouchListener() { // from class: com.android.server.display.OverlayDisplayWindow.3
  ...
  public final ScaleGestureDetector.OnScaleGestureListener mOnScaleGestureListener =
  ...
  public OverlayDisplayWindow(
      Context context, String str, int i, int i2, int i3, int i4, boolean z, Listener listener) {
  ...
  public final void resize(int i, int i2, int i3, boolean z) {
    ...
    this.mTitle =
        this.mContext
            .getResources()
            .getString(
                R.string.gsm_alphabet_default_charset,
                this.mName,
                Integer.valueOf(this.mWidth),
                Integer.valueOf(this.mHeight),
                Integer.valueOf(this.mDensityDpi));
    if (this.mSecure) {
      this.mTitle += this.mContext.getResources().getString(R.string.granularity_label_word);
    }
    if (z) {
      relayout();
    }
  ...
  public final boolean updateDefaultDisplayInfo() {
    ...
    Slog.w(
        ...
        "Cannot show overlay display because there is no default display upon which to show it.");
    return false;
  }

  public final void createWindow() {
    View inflate =
        LayoutInflater.from(this.mContext).inflate(R.layout.preference_holo, (ViewGroup) null);
    this.mWindowContent = inflate;
    inflate.setOnTouchListener(this.mOnTouchListener);
    TextureView textureView =
        (TextureView) this.mWindowContent.findViewById(R.id.remote_input_progress);
    ...
    TextView textView = (TextView) this.mWindowContent.findViewById(R.id.remote_input_send);
    ...
    this.mScaleGestureDetector =
        new ScaleGestureDetector(this.mContext, this.mOnScaleGestureListener);
            ...
            Math.min(
                ...
                Math.min(
                    Math.min(
                        ...
                        this.mDefaultDisplayInfo.logicalWidth / this.mWidth),
  ...
  public final boolean isDexEmulatorWindow() {
    String[] split;
    String string =
        Settings.Global.getString(this.mContext.getContentResolver(), "overlay_display_devices");
    return string != null
