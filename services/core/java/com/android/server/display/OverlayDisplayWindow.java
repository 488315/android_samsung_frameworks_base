...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
    ...
    public final void resize(int i, int i2, int i3, boolean z) {
        ...
        this.mHeight = i2;
        this.mDensityDpi = i3;
        this.mTitle = this.mContext.getResources().getString(R.string.gsm_alphabet_default_charset, this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi));
        if (this.mSecure) {
    ...
    public final void createWindow() {
        ...
        TextureView textureView = (TextureView) this.mWindowContent.findViewById(R.id.remote_input_progress);
