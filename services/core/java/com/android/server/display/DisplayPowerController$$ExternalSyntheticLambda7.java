...
public final /* synthetic */ class DisplayPowerController$$ExternalSyntheticLambda7
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ DisplayPowerController f$0;
    public final /* synthetic */ Object f$1;

    public /* synthetic */ DisplayPowerController$$ExternalSyntheticLambda7(
            DisplayPowerController displayPowerController, Object obj, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                ...
                printWriter.println(
                        "  mBrightnessReason=" + displayPowerController.mBrightnessReason);
                ...
                StringBuilder m =
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                        new StringBuilder("  mScreenOnBlockStartRealTime="),
                                        displayPowerController.mScreenOnBlockStartRealTime,
                                        printWriter,
                                        "  mScreenOffBlockStartRealTime="),
                                displayPowerController.mScreenOffBlockStartRealTime,
                                printWriter,
                ...
                printWriter.println(
                        "  mPendingScreenOffUnblocker="
                                + displayPowerController.mPendingScreenOffUnblocker);
                StringBuilder m2 =
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                new StringBuilder("  mPendingScreenOff="),
                                displayPowerController.mPendingScreenOff,
                                printWriter,
                                "  mReportedToPolicy=");
                ...
                if (displayPowerController.mColorFadeOnAnimator != null) {
                    printWriter.println(
                            "  mColorFadeOnAnimator.isStarted()="
                                    + displayPowerController.mColorFadeOnAnimator.isStarted());
                }
                if (displayPowerController.mColorFadeOffAnimator != null) {
                    printWriter.println(
                            "  mColorFadeOffAnimator.isStarted()="
                                    + displayPowerController.mColorFadeOffAnimator.isStarted());
                }
                                            ...
                                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                    BinaryTransparencyService$$ExternalSyntheticOutline0
                                                            .m(
                                                                    ...
                                                                    printWriter,
                                                                    "  mColorFadePrepared="),
                                                    displayPowerState.mColorFadePrepared,
                                                    printWriter,
                                                    "  mColorFadeLevel="),
                                            displayPowerState.mColorFadeLevel,
                                            printWriter,
                                            "  mColorFadeReady="),
                                    displayPowerState.mColorFadeReady,
                                    printWriter,
                                    "  mColorFadeDrawPending="),
                            displayPowerState.mColorFadeDrawPending,
                            printWriter);
                    DisplayPowerState.PhotonicModulator photonicModulator =
                            displayPowerState.mPhotonicModulator;
                    synchronized (photonicModulator.mLock) {
                        printWriter.println();
                        printWriter.println("Photonic Modulator State:");
                        printWriter.println(
                                "  mPendingState="
                                        + Display.stateToString(photonicModulator.mPendingState));
                        printWriter.println(
                                "  mPendingBacklight=" + photonicModulator.mPendingBacklight);
                        printWriter.println(
                                "  mPendingSdrBacklight=" + photonicModulator.mPendingSdrBacklight);
                        printWriter.println(
                                "  mActualState="
                                        + Display.stateToString(photonicModulator.mActualState));
                        printWriter.println(
                                "  mActualBacklight=" + photonicModulator.mActualBacklight);
                        printWriter.println(
                                "  mActualSdrBacklight=" + photonicModulator.mActualSdrBacklight);
                        printWriter.println(
                                "  mStateChangeInProgress="
                                        + photonicModulator.mStateChangeInProgress);
                        printWriter.println(
                                "  mBacklightChangeInProgress="
                                        + photonicModulator.mBacklightChangeInProgress);
                    }
                                                        ...
                                                        .m(
                                                                BinaryTransparencyService$$ExternalSyntheticOutline0
                                                                        .m(
                                                                                ...
                                                                                printWriter,
                                                                                "  mDisplayWidth="),
                                                                colorFade.mDisplayWidth,
                                                                printWriter,
                                                                "  mDisplayHeight="),
                                                colorFade.mDisplayHeight,
                                                printWriter,
                                                "  mSurfaceVisible="),
                                        colorFade.mSurfaceVisible,
                                        printWriter,
                                        "  mSurfaceAlpha="),
                                colorFade.mSurfaceAlpha,
                                printWriter);
                    }
                }
                ...
                if (automaticBrightnessController != null) {
                                                    ...
                                                    BinaryTransparencyService$$ExternalSyntheticOutline0
                                                            .m(
                                                                                                    ...
                                                                                                    BinaryTransparencyService$$ExternalSyntheticOutline0
                                                                                                            .m(
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    KillPolicyManager$$ExternalSyntheticOutline0
                                                                                                                                                                                                            .m(
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    automaticBrightnessController
                                                                                                                                                                                                                            .mDozeScaleFactor,
                                                                                                                                                                                                                    printWriter,
                                                                                                                                                                                                                    "  mInitialLightSensorRate="),
                                                                                                                                                                                                    automaticBrightnessController
                                                                                                                                                                                                            .mInitialLightSensorRate,
                                                                                                                                                                                                    printWriter,
                                                                                                                                                                                                    "  mNormalLightSensorRate="),
                                                                                                                                                                                    automaticBrightnessController
                                                                                                                                                                                            .mNormalLightSensorRate,
                                                                                                                                                                                    printWriter,
                                                                                                                    ...
                                                                                                                    automaticBrightnessController
                                                                                                                            .mBrighteningLightDebounceConfigIdle,
                                                                                                                    printWriter,
                                                                                                                    "  mDarkeningLightDebounceConfigIdle="),
                                                                                                    automaticBrightnessController
                                                                                                            .mDarkeningLightDebounceConfigIdle,
                                                                                                    printWriter,
                                                                    ...
                                                                    automaticBrightnessController
                                                                            .mAmbientLightHorizonLong,
                                                                    printWriter,
                                                                    "  mAmbientLightHorizonShort="),
                                                    automaticBrightnessController
                                                            .mAmbientLightHorizonShort,
                                                    printWriter,
                                                    "  mWeightingIntercept="),
                                            automaticBrightnessController.mWeightingIntercept,
                                            printWriter,
                    ...
                    printWriter.println(
                            "  mLightSensor=" + automaticBrightnessController.mLightSensor);
                    printWriter.println(
                            "  mLightSensorCct=" + automaticBrightnessController.mLightSensorCct);
                    StringBuilder m5 =
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("  mLightSensorEnabled="),
                                    automaticBrightnessController.mLightSensorEnabled,
                                    printWriter,
                                    "  mLightSensorEnableTime=");
                    m5.append(
                            TimeUtils.formatUptime(
                                    automaticBrightnessController.mLightSensorEnableTime));
                    printWriter.println(m5.toString());
                    StringBuilder m6 =
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    KillPolicyManager$$ExternalSyntheticOutline0.m(
                                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                    new StringBuilder("  mCurrentLightSensorRate="),
                                                    automaticBrightnessController
                                            ...
                                            printWriter,
                                            "  mAmbientLuxValid="),
                                    automaticBrightnessController.mAmbientLuxValid,
                                    printWriter,
                                    "  mInjectedLuxEvent=");
                    ...
                    StringBuilder m7 =
                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                    KillPolicyManager$$ExternalSyntheticOutline0.m(
                                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                                    new StringBuilder("  mPreThesholdLux="),
                                                    automaticBrightnessController.mPreThresholdLux,
                                                    printWriter,
                                                    "  mPreThesholdBrightness="),
                                            automaticBrightnessController.mPreThresholdBrightness,
                                            printWriter,
                                            "  mAmbientBrighteningThreshold="),
                                    automaticBrightnessController.mAmbientBrighteningThreshold,
                                    printWriter,
                    ...
                    StringBuilder m8 =
                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("  mLastObservedLux="),
                                    automaticBrightnessController.mLastObservedLux,
                                    printWriter,
                                    "  mLastObservedLuxTime=");
                    m8.append(
                            TimeUtils.formatUptime(
                                    automaticBrightnessController.mLastObservedLuxTime));
                    printWriter.println(m8.toString());
                    StringBuilder m9 =
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("  mRecentLightSamples="),
                                    automaticBrightnessController.mRecentLightSamples,
                                    printWriter,
                    ...
                    StringBuilder m10 =
                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("  mScreenAutoBrightness="),
                                    automaticBrightnessController.mScreenAutoBrightness,
                                    printWriter,
                                    "  mDisplayPolicy=");
                    m10.append(
                            DisplayManagerInternal.DisplayPowerRequest.policyToString(
                                    automaticBrightnessController.mDisplayPolicy));
                    printWriter.println(m10.toString());
                    printWriter.println("  mShortTermModel=");
                    AutomaticBrightnessController.ShortTermModel shortTermModel =
                            automaticBrightnessController.mShortTermModel;
                    shortTermModel.getClass();
                    printWriter.println(shortTermModel);
                    printWriter.println("  mPausedShortTermModel=");
                    AutomaticBrightnessController.ShortTermModel shortTermModel2 =
                            automaticBrightnessController.mPausedShortTermModel;
                            ...
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                    printWriter,
                                                    automaticBrightnessController
                                                            .mPendingForegroundAppPackageName,
                    ...
                    AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("  mUseLightSensorBlockingPrevention="),
                                    automaticBrightnessController.mUseLightSensorBlockingPrevention,
                                    printWriter,
                                    "  mProximity="),
                    ...
                    if (PowerManagerUtil.SEC_LIGHT_SENSOR_BLOCKING_PREVENTION_MULTI) {
                        AggressivePolicyHandler$$ExternalSyntheticOutline0.m(
                                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                        new StringBuilder("  mIsRearLightSensor="),
                                        automaticBrightnessController.mIsRearLightSensor,
                                        printWriter,
                                        "  mLastAmbientLuxOfFrontLightSensor="),
                                automaticBrightnessController.mLastAmbientLuxOfFrontLightSensor,
                                printWriter);
                    }
                    for (int i3 = 0;
                            i3 < automaticBrightnessController.mBrightnessMappingStrategyMap.size();
                            i3++) {
                        printWriter.println();
                        printWriter.println(
                                "  Mapper for mode "
                                        + DisplayBrightnessMappingConfig.autoBrightnessModeToString(
                                                automaticBrightnessController
                                                        .mBrightnessMappingStrategyMap.keyAt(i3))
                                        + ":");
                    ...
                    printWriter.println(
                            "  mAmbientBrightnessThresholdsIdle="
                                    + automaticBrightnessController
                                            .mAmbientBrightnessThresholdsIdle);
                    if (PowerManagerUtil.SEC_LIGHT_SENSOR_BLOCKING_PREVENTION_MULTI) {
                        printWriter.println(
                                "mAmbientBrightnessThresholdsTouchHigh:"
                                        + automaticBrightnessController
                                                .mAmbientBrightnessThresholdsTouchHigh);
                        printWriter.println(
                                "mAmbientBrightnessThresholdsTouchLow:"
                                        + automaticBrightnessController
                                                .mAmbientBrightnessThresholdsTouchLow);
                    }
                    ...
                    if (size < 1) {
                        ...
                        ActiveServices$$ExternalSyntheticOutline0.m(
                                size,
                                printWriter,
                                "Automatic Brightness Adjustments Last ",
                                " Events: ");
                        BrightnessEvent[] brightnessEventArr =
                                (BrightnessEvent[])
                                        displayPowerController.mBrightnessEventRingBuffer.toArray();
                        for (int i4 = 0;
                                i4 < displayPowerController.mBrightnessEventRingBuffer.size();
                                i4++) {
                ...
                if (size2 < 1) {
                    ...
                    ActiveServices$$ExternalSyntheticOutline0.m(
                            size2,
                            printWriter,
                            "Reduce Bright Colors Adjustments Last ",
                            " Events: ");
                    BrightnessEvent[] brightnessEventArr2 =
                            (BrightnessEvent[])
                                    displayPowerController.mRbcEventRingBuffer.toArray();
                ...
                ScreenOffBrightnessSensorController screenOffBrightnessSensorController =
                        displayPowerController.mScreenOffBrightnessSensorController;
                if (screenOffBrightnessSensorController != null) {
                    screenOffBrightnessSensorController.dump(printWriter);
                }
                BrightnessRangeController brightnessRangeController =
                        displayPowerController.mBrightnessRangeController;
                if (brightnessRangeController != null) {
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    BinaryTransparencyService$$ExternalSyntheticOutline0.m$1(
                                            ...
                                            "  mUseNormalBrightnessController="),
                                    brightnessRangeController.mUseNbmController,
                                    printWriter,
                                    "  mUseHdrClamper="),
                            brightnessRangeController.mUseHdrClamper,
                            printWriter);
                    ...
                    highBrightnessModeController2.mHandler.runWithScissors(
                            new HighBrightnessModeController$$ExternalSyntheticLambda1(
                                    highBrightnessModeController2, printWriter, 1),
                            1000L);
                    NormalBrightnessModeController normalBrightnessModeController =
                            brightnessRangeController.mNormalBrightnessModeController;
                    ...
                    StringBuilder m12 =
                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                    KillPolicyManager$$ExternalSyntheticOutline0.m(
                                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                    new StringBuilder("  mAutoBrightnessEnabled="),
                                                    normalBrightnessModeController
                                                            .mAutoBrightnessEnabled,
                                                    printWriter,
                                                    "  mAmbientLux="),
                                            normalBrightnessModeController.mAmbientLux,
                                            printWriter,
                                            "  mMaxBrightness="),
                                    normalBrightnessModeController.mMaxBrightness,
                                    printWriter,
                                    "  mMaxBrightnessLimits=");
                                                                            ...
                                                                            KillPolicyManager$$ExternalSyntheticOutline0
                                                                                    .m(
                                                                                            ...
                                                                                            hdrClamper
                                                                                                    .mMaxBrightness,
                                                                                            printWriter,
                                                                                            "  mDesiredMaxBrightness="),
                                                                            hdrClamper
                                                                                    .mDesiredMaxBrightness,
                                                                            printWriter,
                                                                            "  mTransitionRate="),
                                                            hdrClamper.mTransitionRate,
                                                            printWriter,
                                                            "  mDesiredTransitionRate="),
                                                    hdrClamper.mDesiredTransitionRate,
                                                    printWriter,
                                                    "  mHdrVisible="),
                                            hdrClamper.mHdrVisible,
                                            printWriter,
                                            "  mHdrListener.mHdrMinPixels="),
                                    hdrClamper.mHdrListener.mHdrMinPixels,
                                    printWriter,
                                    "  mHdrBrightnessData=");
                    ...
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                                    printWriter,
                                                    hdrBrightnessData == null
                                                            ? "null"
                                                            : hdrBrightnessData.toString(),
                                                    "  mHdrListener registered=",
                                                    m13),
                                            hdrClamper.mRegisteredDisplayToken != null,
                                            printWriter,
                                            "  mAmbientLux="),
                                    hdrClamper.mAmbientLux,
                                    printWriter,
                                    "  mAutoBrightnessEnabled="),
                            hdrClamper.mAutoBrightnessEnabled,
                            printWriter);
                }
                BrightnessThrottler brightnessThrottler =
                        displayPowerController.mBrightnessThrottler;
                if (brightnessThrottler != null) {
                    brightnessThrottler.mHandler.runWithScissors(
                            new BrightnessThrottler$$ExternalSyntheticLambda2(
                                    0, brightnessThrottler, printWriter),
                            1000L);
                }
                printWriter.println();
                printWriter.println();
                ...
                if (wakelockController != null) {
                    StringBuilder m14 =
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    BinaryTransparencyService$$ExternalSyntheticOutline0.m$1(
                                            printWriter,
                                            "WakelockController State:",
                                            "  mDisplayId="),
                                    wakelockController.mDisplayId,
                                    printWriter,
                                    "  mUnfinishedBusiness=");
                    m14.append(wakelockController.hasUnfinishedBusiness());
                    printWriter.println(m14.toString());
                    printWriter.println(
                            "  mOnStateChangePending="
                                    + wakelockController.isOnStateChangedPending());
                    printWriter.println(
                            "  mOnProximityPositiveMessages="
                                    + wakelockController.isProximityPositiveAcquired());
                    printWriter.println(
                            "  mOnProximityNegativeMessages="
                                    + wakelockController.isProximityNegativeAcquired());
                    printWriter.println(
                            "  mIsRefreshRateRequested="
                                    + wakelockController.isRefreshRateRequested());
                    printWriter.println(
                            "  mIsEarlyWakeUpRequested="
                                    + wakelockController.isEarlyWakeupRequested());
                }
                printWriter.println();
                ...
                if (displayBrightnessController != null) {
                    ...
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            KillPolicyManager$$ExternalSyntheticOutline0.m(
                                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                            new StringBuilder("  mDisplayId=: "),
                                            displayBrightnessController.mDisplayId,
                                            printWriter,
                                            "  mScreenBrightnessDefault="),
                                    displayBrightnessController.mScreenBrightnessDefault,
                                    printWriter,
                                    "  mPersistBrightnessNitsForDefaultDisplay="),
                            displayBrightnessController.mPersistBrightnessNitsForDefaultDisplay,
                            printWriter);
                    synchronized (displayBrightnessController.mLock) {
                        try {
                            printWriter.println(
                                    "  mPendingScreenBrightness="
                                            + displayBrightnessController.mPendingScreenBrightness);
                            printWriter.println(
                                    "  mCurrentScreenBrightness="
                                            + displayBrightnessController.mCurrentScreenBrightness);
                            printWriter.println(
                            ...
                            displayBrightnessController.mDisplayBrightnessStrategySelector.dump(
                ...
                printWriter.println();
                DisplayStateController displayStateController =
                        displayPowerController.mDisplayStateController;
                if (displayStateController != null) {
                    ...
                    StringBuilder m15 =
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("  mPerformScreenOffTransition:"),
                                    displayStateController.mPerformScreenOffTransition,
                                    printWriter,
                                    "  mDozeStateOverride=");
                    ...
                    DisplayPowerProximityStateController displayPowerProximityStateController =
                            displayStateController.mDisplayPowerProximityStateController;
                    if (displayPowerProximityStateController != null) {
                        ...
                        indentingPrintWriter2.println(
                                "  mDisplayId=" + displayPowerProximityStateController.mDisplayId);
                        indentingPrintWriter2.println(
                        ...
                        indentingPrintWriter2.println(
                                "  mProximitySensor="
                                        + displayPowerProximityStateController.mProximitySensor);
                        indentingPrintWriter2.println(
                        ...
                        sb3.append(
                                i7 != -1
                                        ? i7 != 0
                                                ? i7 != 1 ? Integer.toString(i7) : "Positive"
                                                : "Negative"
                                        : "Unknown");
                ...
                if (PowerManagerUtil.USE_SEC_LONG_TERM_MODEL
                        && displayPowerController.mAdaptiveBrightnessLongtermModelBuilder != null) {
                    printWriter.println();
                    displayPowerController.mAdaptiveBrightnessLongtermModelBuilder.dump(
                            printWriter);
                }
                if (PowerManagerUtil.SEC_FEATURE_DUAL_DISPLAY) {
                    AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("  mDualScreenPolicy="),
                            displayPowerController.mDualScreenPolicy,
                            printWriter);
                }
                ...
                if (earlyWakeUpManager != null) {
                    synchronized (earlyWakeUpManager.mEarlyWakeUpLock) {
                        ...
                        printWriter.println(
                                "  mAppliedLocked=" + earlyWakeUpManager.mAppliedLocked);
                        printWriter.println(
                                "  mEarlyLightSensorEnabled="
                                        + earlyWakeUpManager.mEarlyLightSensorEnabled);
                        printWriter.println(
                                "  mEarlyDisplayEnabled="
                                        + earlyWakeUpManager.mEarlyDisplayEnabled);
                        printWriter.println(
                                "  mLastEnableRequestedTime="
                                        + earlyWakeUpManager.mLastEnableRequestedTime);
                        printWriter.println("  now=" + SystemClock.uptimeMillis());
                        printWriter.println(
                                "  mHoldingSuspendBlocker="
                                        + earlyWakeUpManager.mHoldingSuspendBlocker);
                        printWriter.println(
                                "    mEarlyLightSensorReadyLocked="
                                        + earlyWakeUpManager.mEarlyLightSensorReadyLocked);
                        printWriter.println(
                                "    mEarlyDisplayReadyLocked="
                                        + earlyWakeUpManager.mEarlyDisplayReadyLocked);
                    }
                }
                printWriter.println();
                ...
                BrightnessClamperController brightnessClamperController =
                        displayPowerController.mBrightnessClamperController;
                if (brightnessClamperController != null) {
                    indentingPrintWriter.println("BrightnessClamperController:");
                    indentingPrintWriter.println(
                            "  mBrightnessCap: " + brightnessClamperController.mBrightnessCap);
                    indentingPrintWriter.println(
                            "  mClamperType: " + brightnessClamperController.mClamperType);
                    indentingPrintWriter.println(
                            "  mClamperApplied: " + brightnessClamperController.mClamperApplied);
                    indentingPrintWriter.println(
                            "  mLightSensor=" + brightnessClamperController.mLightSensor);
                    indentingPrintWriter.println(
                            "  mRegisteredLightSensor="
                                    + brightnessClamperController.mRegisteredLightSensor);
                    ...
                    ((ArrayList) brightnessClamperController.mClampers)
                            .forEach(
                                    new BrightnessClamperController$$ExternalSyntheticLambda0(
                                            0, indentingPrintWriter3));
                    ((ArrayList) brightnessClamperController.mModifiers)
                            .forEach(
                                    new BrightnessClamperController$$ExternalSyntheticLambda0(
                                            1, indentingPrintWriter3));
                }
            ...
            default:
                ...
                DisplayManagerInternal.DisplayOffloadSession displayOffloadSession =
                        (DisplayManagerInternal.DisplayOffloadSession) this.f$1;
                DisplayPowerController.DisplayControllerHandler displayControllerHandler =
                        displayPowerController2.mHandler;
                displayControllerHandler.sendMessage(
                        displayControllerHandler.obtainMessage(18, displayOffloadSession));
                return;
        }
    }
}
