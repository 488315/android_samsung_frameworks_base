...
public final class BrightnessThermalClamper extends BrightnessClamper {
    ...
    public DisplayDeviceConfig.ThermalBrightnessThrottlingData
    ...
    public final class ThermalStatusObserver extends IThermalEventListener.Stub {
        ...
        public final void notifyThrottling(Temperature temperature) {
            Slog.d(
                    ...
                    "New thermal throttling status = " + temperature.getStatus());
            ...
            if (str == null || str.equals(temperature.getName())) {
                ...
                this.mHandler.post(
                        new Runnable() { // from class:
                                         // com.android.server.display.brightness.clamper.BrightnessThermalClamper$ThermalStatusObserver$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                BrightnessThermalClamper.ThermalStatusObserver
                                        thermalStatusObserver =
                                                BrightnessThermalClamper.ThermalStatusObserver.this;
                                int i = status;
                                BrightnessThermalClamper brightnessThermalClamper =
                                        BrightnessThermalClamper.this;
            ...
            Slog.i(
                    "BrightnessThermalClamper",
                    "Skipping thermal throttling notification as monitored sensor: "
                            + this.mObserverTempSensor.name
                            + " != notified sensor: "
                            + temperature.getName());
        }
        ...
        public final void registerThermalListener() {
            ...
            try {
                this.mThermalService.registerThermalEventListenerWithType(
                        this, SensorUtils.getSensorTemperatureType(this.mObserverTempSensor));
                this.mStarted = true;
    ...
    public BrightnessThermalClamper(
            Injector injector,
            Handler handler,
    ...
    public final void dump(PrintWriter printWriter) {
                        ...
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                ...
                                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                        BinaryTransparencyService$$ExternalSyntheticOutline0.m$1(
                                                ...
                                                "BrightnessThermalClamper:",
                                                "  mThrottlingStatus: "),
                                        this.mThrottlingStatus,
                                        printWriter,
                                        "  mUniqueDisplayId: ")));
        m.append(this.mThermalThrottlingDataOverride);
        printWriter.println(m.toString());
        printWriter.println(
                "  mDataFromDeviceConfig: " + this.mThermalThrottlingDataFromDeviceConfig);
        ...
        StringBuilder m2 =
                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                        new StringBuilder("    mStarted: "),
                        thermalStatusObserver.mStarted,
                        printWriter,
                        "    mObserverTempSensor: ");
    ...
    public final void onDeviceConfigChanged() {
        this.mHandler.post(
                new Runnable() { // from class:
                                 // com.android.server.display.brightness.clamper.BrightnessThermalClamper$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        BrightnessThermalClamper brightnessThermalClamper =
                                BrightnessThermalClamper.this;
                        brightnessThermalClamper.mThermalThrottlingDataOverride =
                                DeviceConfigParsingUtils.parseDeviceConfigMap(
                                        brightnessThermalClamper.mConfigParameterProvider
                                                .mDeviceConfig.getString(
                                                "display_manager",
                                                "brightness_throttling_data",
                                                (String) null),
                                        brightnessThermalClamper.mDataPointMapper,
                                        brightnessThermalClamper.mDataSetMapper);
    ...
    public final void onDisplayChanged(Object obj) {
        this.mHandler.post(
                new BrightnessThermalClamper$$ExternalSyntheticLambda1(this, (ThermalData) obj, 1));
    }
    ...
    public final void recalculateActiveData$1() {
        ...
        this.mThermalThrottlingDataActive =
                (DisplayDeviceConfig.ThermalBrightnessThrottlingData)
                        ((Map) this.mThermalThrottlingDataOverride.getOrDefault(str, Map.of()))
                                .getOrDefault(
                                        this.mDataId, this.mThermalThrottlingDataFromDeviceConfig);
    ...
    public final void recalculateBrightnessCap$1() {
        ...
        if (thermalBrightnessThrottlingData != null) {
            ...
            while (it.hasNext()) {
                DisplayDeviceConfig.ThermalBrightnessThrottlingData.ThrottlingLevel
                        throttlingLevel =
                                (DisplayDeviceConfig.ThermalBrightnessThrottlingData
                                                .ThrottlingLevel)
                                        it.next();
    ...
    public final void setDisplayData(ThermalData thermalData) {
        ...
        this.mUniqueDisplayId =
                ((BrightnessClamperController.DisplayDeviceData) thermalData).mUniqueDisplayId;
        BrightnessClamperController.DisplayDeviceData displayDeviceData =
                (BrightnessClamperController.DisplayDeviceData) thermalData;
        ...
        if (thermalBrightnessThrottlingData == null && !"default".equals(this.mDataId)) {
            Slog.wtf(
                    "BrightnessThermalClamper",
                    "Thermal throttling data is missing for thermalThrottlingDataId="
                            + this.mDataId);
        }
        SensorData sensorData2 = displayDeviceConfig.mTempSensor;
        ThermalStatusObserver thermalStatusObserver = this.mThermalStatusObserver;
        if (!thermalStatusObserver.mStarted
                || (sensorData = thermalStatusObserver.mObserverTempSensor) == null) {
