...
public final class BrightnessEvent {
  ...
  public boolean equalsMainData(BrightnessEvent brightnessEvent) {
    return this.mReason.equals(brightnessEvent.mReason)
        ...
        && Float.floatToRawIntBits(this.mLux) == Float.floatToRawIntBits(brightnessEvent.mLux)
        ...
        && Float.floatToRawIntBits(this.mHbmMax) == Float.floatToRawIntBits(brightnessEvent.mHbmMax)
