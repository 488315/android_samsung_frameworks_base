...
public final class BrightnessLowLuxModifier extends BrightnessModifier {
    ...
    public final class SettingsObserver extends ContentObserver {
        public SettingsObserver(Handler handler) {
            super(handler);
            BrightnessLowLuxModifier.this.mContentResolver.registerContentObserver(
                    Settings.Secure.getUriFor("even_dimmer_min_nits"), false, this);
            BrightnessLowLuxModifier.this.mContentResolver.registerContentObserver(
                    Settings.Secure.getUriFor("even_dimmer_activated"), false, this);
        }
    ...
    public BrightnessLowLuxModifier(
            Handler handler,
        ...
        handler.post(
                new Runnable() { // from class:
                                 // com.android.server.display.brightness.clamper.BrightnessLowLuxModifier$$ExternalSyntheticLambda0
    ...
    public void recalculateLowerBound() {
        ...
        float floatForUser =
                Settings.Secure.getFloatForUser(
                        this.mContentResolver, "even_dimmer_min_nits", 0.2f, -2);
        int i = 0;
        boolean z =
                ((Settings.Secure.getFloatForUser(
        ...
        if (z) {
            ...
            r4 =
                    evenDimmerBrightnessData != null
                            ? evenDimmerBrightnessData.mMinLuxToNits.interpolate(f2)
                            : -1.0f;
            float max = Math.max(floatForUser, r4);
            f =
                    displayDeviceConfig.getBrightnessFromBacklight(
                            displayDeviceConfig.getBacklightFromNits(max));
            ...
            f =
                    evenDimmerBrightnessData2 == null
                            ...
                            : evenDimmerBrightnessData2.mTransitionPoint;
        }
    ...
    public final boolean shouldListenToLightSensor() {
        return Settings.Secure.getFloatForUser(
                        this.mContentResolver, "even_dimmer_activated", 1.0f, -2)
                == 1.0f;
    }
