...
public class DisplayBrightnessStrategySelector {
  ...
  public DisplayBrightnessStrategySelector(Context context, Injector injector, int i) {
    ...
    this.mAllowAutoBrightnessWhileDozingConfig =
        context.getResources().getBoolean(R.bool.config_allowDisablingAssistDisclosure);
  ...
  public DisplayBrightnessStrategy selectStrategy(
    ...
    if (i == 1) {
      ...
      displayBrightnessStrategy = this.mDozeBrightnessStrategy;
        ...
        this.mFollowerBrightnessStrategy.getBrightnessToFollow())) {
      ...
      displayBrightnessStrategy = this.mOverrideBrightnessStrategy;
        ...
        this.mTemporaryBrightnessStrategy.getTemporaryScreenBrightness())) {
    ...
    if (!this.mOldBrightnessStrategyName.equals(displayBrightnessStrategy.getName())) {
      Slog.i(
          ...
          "Changing the DisplayBrightnessStrategy from "
              + this.mOldBrightnessStrategyName
              + " to"
              + displayBrightnessStrategy.getName()
              + " for display "
              + this.mDisplayId);
  ...
  public void dump(PrintWriter printWriter) {
    ...
    printWriter.println(
        "  mAllowAutoBrightnessWhileDozingConfig= " + this.mAllowAutoBrightnessWhileDozingConfig);
    this.mTemporaryBrightnessStrategy.dump(new IndentingPrintWriter(printWriter, " "));
  }

  public final boolean shouldUseDozeBrightnessStrategy(
