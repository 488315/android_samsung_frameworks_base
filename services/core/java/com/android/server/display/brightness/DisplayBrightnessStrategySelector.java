...
public final class DisplayBrightnessStrategySelector {
    ...
    public DisplayBrightnessStrategySelector(
            Context context, int i, DisplayManagerFlags displayManagerFlags) {
        new Injector();
        ...
        AutomaticBrightnessStrategy automaticBrightnessStrategy =
                !displayManagerFlags.mRefactorDisplayPowerController.isEnabled()
                        ? null
                        : new AutomaticBrightnessStrategy(context, i, null, displayManagerFlags);
        ...
        this.mAutomaticBrightnessStrategy =
                displayManagerFlags.mRefactorDisplayPowerController.isEnabled()
                        ...
                        : displayManagerFlags.mRefactorDisplayPowerController.isEnabled()
                                ? null
                                : new AutomaticBrightnessStrategy2(context, i);
        AutoBrightnessFallbackStrategy autoBrightnessFallbackStrategy =
                displayManagerFlags.mRefactorDisplayPowerController.isEnabled()
                        ? new AutoBrightnessFallbackStrategy()
                        : null;
        ...
        FallbackBrightnessStrategy fallbackBrightnessStrategy =
                displayManagerFlags.mRefactorDisplayPowerController.isEnabled()
                        ? new FallbackBrightnessStrategy()
                        : null;
        this.mFallbackBrightnessStrategy = fallbackBrightnessStrategy;
        this.mDisplayBrightnessStrategies =
                new DisplayBrightnessStrategy[] {
                    invalidBrightnessStrategy,
                    screenOffBrightnessStrategy,
                    dozeBrightnessStrategy,
                    followerBrightnessStrategy,
                    boostBrightnessStrategy,
                    overrideBrightnessStrategy,
                    temporaryBrightnessStrategy,
                    automaticBrightnessStrategy,
                    this.mOffloadBrightnessStrategy,
                    autoBrightnessFallbackStrategy,
                    fallbackBrightnessStrategy
                };
    ...
    public final void dump(PrintWriter printWriter) {
        ...
        StringBuilder m =
                BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                printWriter,
                                this.mOldBrightnessStrategyName,
                        ...
                        this.mAllowAutoBrightnessWhileDozingConfig,
                        printWriter,
    ...
    */
    public final com.android.server.display.brightness.strategy.DisplayBrightnessStrategy
            selectStrategy(com.android.server.display.brightness.StrategySelectionRequest r19) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.display.brightness.DisplayBrightnessStrategySelector.selectStrategy(com.android.server.display.brightness.StrategySelectionRequest):com.android.server.display.brightness.strategy.DisplayBrightnessStrategy");
    }

    public void setAllowAutoBrightnessWhileDozing(
        ...
        if (displayManagerFlags.mOffloadControlsDozeAutoBrightness.isEnabled()
                && displayManagerFlags.mDisplayOffloadFlagState.isEnabled()
                && displayOffloadSession != null) {
            this.mAllowAutoBrightnessWhileDozing =
                    displayOffloadSession.allowAutoBrightnessInDoze()
                            & this.mAllowAutoBrightnessWhileDozing;
        }
    }
}
