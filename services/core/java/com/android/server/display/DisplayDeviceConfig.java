...
public class DisplayDeviceConfig {
  ...
  public static final float[] DEFAULT_SCREEN_THRESHOLD_LEVELS = {
    DisplayPowerController2.RATE_FROM_DOZE_TO_ON
  };
  ...
  public float mAmbientLuxBrighteningMinThresholdIdle =
      DisplayPowerController2.RATE_FROM_DOZE_TO_ON;
  ...
  public static DisplayDeviceConfig create(Context context, boolean z, boolean z2, boolean z3) {
    ...
    configFromPmValues.copyUninitializedValuesFromSecondaryConfig(
        loadDefaultConfigurationXml(context));
    if (z3) {
  ...
  public static DisplayConfiguration loadDefaultConfigurationXml(Context context) {
    ...
    arrayList.add(
        Environment.buildPath(
            ...
            new String[] {"etc", "displayconfig", "default.xml"}));
    arrayList.add(
        Environment.buildPath(
            Environment.getVendorDirectory(),
            new String[] {"etc", "displayconfig", "default.xml"}));
    String uiModeTypeString =
        Configuration.getUiModeTypeString(
            context
                .getResources()
                .getInteger(R.integer.config_displayWhiteBalanceTransitionTimeIncrease));
    if (uiModeTypeString != null) {
      arrayList.add(
          Environment.buildPath(
              Environment.getRootDirectory(),
              new String[] {
                "etc", "displayconfig", String.format("default_%s.xml", uiModeTypeString)
              }));
    }
    arrayList.add(
        Environment.buildPath(
            Environment.getRootDirectory(), new String[] {"etc", "displayconfig", "default.xml"}));
    ...
    try {
      BufferedInputStream bufferedInputStream =
          new BufferedInputStream(new FileInputStream(firstExistingFile));
      try {
      ...
      Slog.e(
          "DisplayDeviceConfig",
          "Encountered an error while reading/parsing display config file: " + firstExistingFile,
          e);
    }
  ...
  public float getHdrBrightnessFromSdr(float f, float f2) {
    ...
    return this.mBacklightToBrightnessSpline.interpolate(
        Math.max(
            this.mBacklightMinimum,
            Math.min(this.mBacklightMaximum, spline.interpolate(interpolate))));
  }
  ...
  public String toString() {
    return "DisplayDeviceConfig{mLoadedFrom="
        + this.mLoadedFrom
        + ", mBacklightMinimum="
        + this.mBacklightMinimum
        + ", mBacklightMaximum="
        ...
        + this.mQuirks
        + ", isHbmEnabled="
        + this.mIsHighBrightnessModeEnabled
        + ", mHbmData="
        + this.mHbmData
        + ", mSdrToHdrSpline="
        + this.mSdrToHdrSpline
        ...
        + this.mBrightnessRampSlowDecrease
        + ", mBrightnessRampSlowIncrease="
        + this.mBrightnessRampSlowIncrease
        + ", mBrightnessRampDecreaseMaxMillis="
        + this.mBrightnessRampDecreaseMaxMillis
        + ", mBrightnessRampIncreaseMaxMillis="
        + this.mBrightnessRampIncreaseMaxMillis
        + "\n, mAmbientHorizonLong="
        + this.mAmbientHorizonLong
        + ", mAmbientHorizonShort="
        + this.mAmbientHorizonShort
        + "\n, mScreenDarkeningMinThreshold="
        + this.mScreenDarkeningMinThreshold
        + ", mScreenDarkeningMinThresholdIdle="
        + this.mScreenDarkeningMinThresholdIdle
        + ", mScreenBrighteningMinThreshold="
        + this.mScreenBrighteningMinThreshold
        + ", mScreenBrighteningMinThresholdIdle="
        + this.mScreenBrighteningMinThresholdIdle
        + ", mAmbientLuxDarkeningMinThreshold="
        + this.mAmbientLuxDarkeningMinThreshold
        + ", mAmbientLuxDarkeningMinThresholdIdle="
        + this.mAmbientLuxDarkeningMinThresholdIdle
        + ", mAmbientLuxBrighteningMinThreshold="
        + this.mAmbientLuxBrighteningMinThreshold
        + ", mAmbientLuxBrighteningMinThresholdIdle="
        + this.mAmbientLuxBrighteningMinThresholdIdle
        + "\n, mScreenBrighteningLevels="
        + Arrays.toString(this.mScreenBrighteningLevels)
        + ", mScreenBrighteningPercentages="
        + Arrays.toString(this.mScreenBrighteningPercentages)
        + ", mScreenDarkeningLevels="
        + Arrays.toString(this.mScreenDarkeningLevels)
        + ", mScreenDarkeningPercentages="
        + Arrays.toString(this.mScreenDarkeningPercentages)
        + ", mAmbientBrighteningLevels="
        + Arrays.toString(this.mAmbientBrighteningLevels)
        + ", mAmbientBrighteningPercentages="
        + Arrays.toString(this.mAmbientBrighteningPercentages)
        + ", mAmbientDarkeningLevels="
        + Arrays.toString(this.mAmbientDarkeningLevels)
        + ", mAmbientDarkeningPercentages="
        + Arrays.toString(this.mAmbientDarkeningPercentages)
        + "\n, mAmbientBrighteningLevelsIdle="
        + Arrays.toString(this.mAmbientBrighteningLevelsIdle)
        + ", mAmbientBrighteningPercentagesIdle="
        + Arrays.toString(this.mAmbientBrighteningPercentagesIdle)
        + ", mAmbientDarkeningLevelsIdle="
        + Arrays.toString(this.mAmbientDarkeningLevelsIdle)
        + ", mAmbientDarkeningPercentagesIdle="
        + Arrays.toString(this.mAmbientDarkeningPercentagesIdle)
        + ", mScreenBrighteningLevelsIdle="
        + Arrays.toString(this.mScreenBrighteningLevelsIdle)
        + ", mScreenBrighteningPercentagesIdle="
        + Arrays.toString(this.mScreenBrighteningPercentagesIdle)
        + ", mScreenDarkeningLevelsIdle="
        + Arrays.toString(this.mScreenDarkeningLevelsIdle)
        + ", mScreenDarkeningPercentagesIdle="
        + Arrays.toString(this.mScreenDarkeningPercentagesIdle)
        + "\n, mAmbientLightSensor="
        + this.mAmbientLightSensor
        + ", mScreenOffBrightnessSensor="
        + this.mScreenOffBrightnessSensor
        + ", mProximitySensor="
        + this.mProximitySensor
        + ", mRefreshRateLimitations= "
        + Arrays.toString(this.mRefreshRateLimitations.toArray())
        + ", mDensityMapping= "
        + this.mDensityMapping
        ...
        + ", mRefreshRateZoneProfiles= "
        + this.mRefreshRateZoneProfiles
        + ", mDefaultRefreshRateInHbmHdr= "
        + this.mDefaultRefreshRateInHbmHdr
        + ", mDefaultRefreshRateInHbmSunlight= "
        + this.mDefaultRefreshRateInHbmSunlight
        + ", mRefreshRateThrottlingMap= "
        + this.mRefreshRateThrottlingMap
        ...
        + Arrays.toString(this.mScreenOffBrightnessSensorValueToLux)
        + "\n, mUsiVersion= "
        + this.mHostUsiVersion
        + ", mUseSurfaceControlBrightness="
        + this.mUseSurfaceControlBrightness
        + "}";
  }
  ...
  public boolean initFromFile(File file) {
    ...
    try {
      ...
      Slog.e(
          "DisplayDeviceConfig",
          "Encountered an error while reading/parsing display config file: " + file,
          e);
    }
    try {
  ...
  public final void copyUninitializedValuesFromSecondaryConfig(
    ...
    for (int i = 0; i < density.size(); i++) {
      ...
      entryArr[i] =
          new DensityMapping.Entry(
              density2.getWidth().intValue(),
              density2.getHeight().intValue(),
              density2.getDensity().intValue());
    }
  ...
  public final void loadBrightnessDefaultFromConfigXml() {
    float f =
        this.mContext
            .getResources()
            .getFloat(R.dimen.config_pictureInPictureExpandedHorizontalHeight);
    if (f == -2.0f) {
      this.mBrightnessDefault =
          BrightnessSynchronizer.brightnessIntToFloat(
              this.mContext.getResources().getInteger(R.integer.config_screen_rotation_fade_in));
    } else {
  ...
  public final void loadBrightnessConstraintsFromConfigXml() {
    float f = this.mContext.getResources().getFloat(R.dimen.config_pictureInPictureMaxAspectRatio);
    float max =
        Math.max(
    ...
    if (f == -2.0f || max == -2.0f) {
      this.mBacklightMinimum =
          BrightnessSynchronizer.brightnessIntToFloat(
              this.mContext.getResources().getInteger(R.integer.config_screen_rotation_fade_out));
    ...
    for (Point point2 : point) {
      ...
      if (i > 0) {
        ...
        if (fArr[i] < fArr[i2]) {
          Slog.e(
              "DisplayDeviceConfig",
              "screenBrightnessMap must be non-decreasing, ignoring rest  of configuration. Nits: "
                  + fArr[i]
                  + " < "
                  + fArr[i2]);
          return;
        ...
        if (floatValue < fArr2[i2]) {
          Slog.e(
              "DisplayDeviceConfig",
              "screenBrightnessMap must be non-decreasing, ignoring rest  of configuration. Value: "
                  + fArr2[i]
                  + " < "
                  + fArr2[i2]);
          return;
  ...
  public final Spline loadSdrHdrMapFromConfigXml() {
    float[] floatArray =
        getFloatArray(this.mContext.getResources().obtainTypedArray(17236299), -1.0f);
    float[] floatArray2 =
        getFloatArray(this.mContext.getResources().obtainTypedArray(17236298), -1.0f);
    if (this.mIsCoverDisplay) {
      float[] floatArray3 =
          getFloatArray(
              this.mContext
                  .getResources()
                  .obtainTypedArray(R.array.config_screenDarkeningThresholds),
              -1.0f);
      float[] floatArray4 =
          getFloatArray(
              this.mContext.getResources().obtainTypedArray(R.array.config_screenBrightnessNits),
              -1.0f);
    ...
    if (floatArray.length != floatArray2.length) {
      Slog.w(
          "DisplayDeviceConfig",
          "loadSdrHdrMapFromConfigXml: wrong length: "
              + floatArray.length
              + ", "
              + floatArray2.length);
      return null;
    ...
    for (int i = 0; i < floatArray.length; i++) {
      if (i > 0) {
        ...
        if (f < floatArray[i2]) {
          Slog.e(
              "DisplayDeviceConfig",
              "loadSdrHdrMapFromConfigXml: sdrHdrRatioMap must be non-decreasing, ignoring rest  of"
                  + " configuration. sdr nits: "
                  + floatArray[i]
                  + " < "
                  + floatArray[i2]);
          return null;
        ...
        if (f < DisplayPowerController2.RATE_FROM_DOZE_TO_ON
            || floatArray2[i] < DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
          Slog.w(
              "DisplayDeviceConfig",
              "loadSdrHdrMapFromConfigXml: invalid value: ["
                  + i
                  + "] "
                  + floatArray[i]
                  + ", "
  ...
  public final void loadThermalBrightnessThrottlingMaps(ThermalThrottling thermalThrottling) {
    boolean z;
    List<BrightnessThrottlingMap> brightnessThrottlingMap =
        thermalThrottling.getBrightnessThrottlingMap();
    ...
    for (BrightnessThrottlingMap brightnessThrottlingMap2 : brightnessThrottlingMap) {
      ...
      while (true) {
        ...
        BrightnessThrottlingPoint brightnessThrottlingPoint2 =
            (BrightnessThrottlingPoint) it.next();
        ...
        arrayList.add(
            new ThermalBrightnessThrottlingData.ThrottlingLevel(
                convertThermalStatus(thermalStatus),
                brightnessThrottlingPoint2.getBrightness().floatValue()));
      }
      if (!z) {
        String id =
            brightnessThrottlingMap2.getId() == null ? "default" : brightnessThrottlingMap2.getId();
        if (this.mThermalBrightnessThrottlingDataMapByThrottlingId.containsKey(id)) {
          throw new RuntimeException(
              "Brightness throttling data with ID " + id + " already exists");
        }
        this.mThermalBrightnessThrottlingDataMapByThrottlingId.put(
            id, ThermalBrightnessThrottlingData.create(arrayList));
      }
    }
  }

  public final void loadThermalRefreshRateThrottlingMap(ThermalThrottling thermalThrottling) {
    List<RefreshRateThrottlingMap> refreshRateThrottlingMap =
        thermalThrottling.getRefreshRateThrottlingMap();
    ...
    for (RefreshRateThrottlingMap refreshRateThrottlingMap2 : refreshRateThrottlingMap) {
      List<RefreshRateThrottlingPoint> refreshRateThrottlingPoint =
          refreshRateThrottlingMap2.getRefreshRateThrottlingPoint();
      String id =
          refreshRateThrottlingMap2.getId() == null ? "default" : refreshRateThrottlingMap2.getId();
      if (refreshRateThrottlingPoint == null || refreshRateThrottlingPoint.isEmpty()) {
        ...
        for (RefreshRateThrottlingPoint refreshRateThrottlingPoint2 : refreshRateThrottlingPoint) {
          ...
          if (!thermalStatusIsValid(thermalStatus)) {
            ...
            if (sparseArray.contains(convertThermalStatus)) {
              Slog.wtf(
                  "DisplayDeviceConfig",
                  "RefreshRateThrottling: thermalStatus="
                      + thermalStatus.getRawName()
                      + " is already in the map, mapId="
                      + id);
            } else {
              sparseArray.put(
                  convertThermalStatus,
                  new SurfaceControl.RefreshRateRange(
                      refreshRateThrottlingPoint2.getRefreshRateRange().getMinimum().floatValue(),
                      refreshRateThrottlingPoint2.getRefreshRateRange().getMaximum().floatValue()));
            }
          }
        }
        if (sparseArray.size() == 0) {
          Slog.w(
              "DisplayDeviceConfig",
              "RefreshRateThrottling: no valid throttling points found for map, mapId=" + id);
        } else {
  ...
  public final void loadRefreshRateSetting(DisplayConfiguration displayConfiguration) {
    RefreshRateConfigs refreshRate =
        displayConfiguration == null ? null : displayConfiguration.getRefreshRate();
    BlockingZoneConfig lowerBlockingZoneConfigs =
        refreshRate == null ? null : refreshRate.getLowerBlockingZoneConfigs();
    BlockingZoneConfig higherBlockingZoneConfigs =
        refreshRate != null ? refreshRate.getHigherBlockingZoneConfigs() : null;
  ...
  public final void loadRefreshRateZoneProfiles(RefreshRateConfigs refreshRateConfigs) {
    ...
    for (RefreshRateZone refreshRateZone :
      ...
      this.mRefreshRateZoneProfiles.put(
          refreshRateZone.getId(),
          new SurfaceControl.RefreshRateRange(
              refreshRateRange.getMinimum().floatValue(),
              refreshRateRange.getMaximum().floatValue()));
    }
  }
  ...
  public final void loadDefaultRefreshRateInHbm(RefreshRateConfigs refreshRateConfigs) {
    if (refreshRateConfigs != null && refreshRateConfigs.getDefaultRefreshRateInHbmHdr() != null) {
      this.mDefaultRefreshRateInHbmHdr =
          refreshRateConfigs.getDefaultRefreshRateInHbmHdr().intValue();
    } else {
      this.mDefaultRefreshRateInHbmHdr =
          this.mContext
              .getResources()
  ...
  public final void loadHigherBlockingZoneDefaultRefreshRate(
    ...
    if (blockingZoneConfig == null) {
      ...
      this.mDefaultHighBlockingZoneRefreshRate =
          blockingZoneConfig.getDefaultRefreshRate().intValue();
    }
  }
  ...
  public final void loadLowerBrightnessThresholds(BlockingZoneConfig blockingZoneConfig) {
    if (blockingZoneConfig == null) {
      this.mLowDisplayBrightnessThresholds =
          this.mContext.getResources().getIntArray(R.array.config_requestVibrationParamsForUsages);
      int[] intArray =
          this.mContext.getResources().getIntArray(R.array.config_minimumBrightnessCurveLux);
      ...
      if (iArr == null || intArray == null || iArr.length != intArray.length) {
        throw new RuntimeException(
            "display low brightness threshold array and ambient brightness threshold array have"
                + " different length: mLowDisplayBrightnessThresholds="
                + Arrays.toString(this.mLowDisplayBrightnessThresholds)
                + ", mLowAmbientBrightnessThresholds="
                + Arrays.toString(this.mLowAmbientBrightnessThresholds));
      }
    ...
    for (int i = 0; i < size; i++) {
      this.mLowDisplayBrightnessThresholds[i] =
          (int) ((DisplayBrightnessPoint) displayBrightnessPoint.get(i)).getNits().floatValue();
      this.mLowAmbientBrightnessThresholds[i] =
          ((DisplayBrightnessPoint) displayBrightnessPoint.get(i)).getLux().intValue();
    }
  }
  ...
  public final void loadHigherBrightnessThresholds(BlockingZoneConfig blockingZoneConfig) {
    ...
    if (blockingZoneConfig == null) {
      this.mHighDisplayBrightnessThresholds =
          this.mContext.getResources().getIntArray(R.array.resolver_target_actions_pin);
      int[] intArray = this.mContext.getResources().getIntArray(R.array.required_apps_managed_user);
      this.mHighAmbientBrightnessThresholds = intArray;
      if (intArray == null
          || (iArr = this.mHighDisplayBrightnessThresholds) == null
          || intArray.length != iArr.length) {
        throw new RuntimeException(
            "display high brightness threshold array and ambient brightness threshold array have"
                + " different length: mHighDisplayBrightnessThresholds="
                + Arrays.toString(this.mHighDisplayBrightnessThresholds)
                + ", mHighAmbientBrightnessThresholds="
                + Arrays.toString(this.mHighAmbientBrightnessThresholds));
      }
    ...
    for (int i = 0; i < size; i++) {
      this.mHighDisplayBrightnessThresholds[i] =
          (int) ((DisplayBrightnessPoint) displayBrightnessPoint.get(i)).getNits().floatValue();
      this.mHighAmbientBrightnessThresholds[i] =
          ((DisplayBrightnessPoint) displayBrightnessPoint.get(i)).getLux().intValue();
    }
  }
  ...
  public final void loadAutoBrightnessBrighteningLightDebounce(AutoBrightness autoBrightness) {
    if (autoBrightness == null || autoBrightness.getBrighteningLightDebounceMillis() == null) {
      this.mAutoBrightnessBrighteningLightDebounce =
          this.mContext.getResources().getInteger(R.integer.config_bluetooth_tx_cur_ma);
    } else {
      this.mAutoBrightnessBrighteningLightDebounce =
          autoBrightness.getBrighteningLightDebounceMillis().intValue();
    }
  }
  ...
  public final void loadAutoBrightnessDarkeningLightDebounce(AutoBrightness autoBrightness) {
    if (autoBrightness == null || autoBrightness.getDarkeningLightDebounceMillis() == null) {
      this.mAutoBrightnessDarkeningLightDebounce =
          this.mContext.getResources().getInteger(R.integer.config_brightness_ramp_rate_fast);
    } else {
      this.mAutoBrightnessDarkeningLightDebounce =
          autoBrightness.getDarkeningLightDebounceMillis().intValue();
    }
  }
  ...
  public final void loadAutoBrightnessDisplayBrightnessMapping(AutoBrightness autoBrightness) {
    if (autoBrightness == null || autoBrightness.getDisplayBrightnessMapping() == null) {
      this.mBrightnessLevelsNits =
          getFloatArray(
              this.mContext.getResources().obtainTypedArray(R.array.config_networkNotifySwitches),
              DisplayPowerController2.RATE_FROM_DOZE_TO_ON);
      this.mBrightnessLevelsLux =
          getLuxLevels(
              this.mContext
                  .getResources()
                  .getIntArray(R.array.config_notificationFallbackVibePattern));
      return;
    }
    ...
    int i = 0;
    while (i < size) {
      this.mBrightnessLevelsNits[i] =
          ((DisplayBrightnessPoint)
                  autoBrightness.getDisplayBrightnessMapping().getDisplayBrightnessPoint().get(i))
              .getNits()
              .floatValue();
      int i2 = i + 1;
      this.mBrightnessLevelsLux[i2] =
          ((DisplayBrightnessPoint)
                  autoBrightness.getDisplayBrightnessMapping().getDisplayBrightnessPoint().get(i))
              .getLux()
              .floatValue();
  ...
  public final void loadAutoBrightnessAvailableFromConfigXml() {
    if (this.mIsCoverDisplay) {
      this.mAutoBrightnessAvailable =
          this.mContext
              .getResources()
              .getBoolean(R.bool.config_cecSystemAudioModeMutingEnabled_allowed);
    } else {
      this.mAutoBrightnessAvailable =
          this.mContext.getResources().getBoolean(R.bool.config_autoPowerModeUseMotionSensor);
    }
  }
  ...
  public final void loadBrightnessMapFromConfigXml() {
    ...
    Slog.d(
        "DisplayDeviceConfig",
        "backlight min=" + intArray[0] + " backlight max=" + intArray[intArray.length - 1]);
  ...
  public final void adjustBacklightArrayBoundary() {
    if (BrightnessSynchronizer.floatEquals(this.mRawBacklight[0], this.mBacklightMinimum)
  ...
  public final void loadHighBrightnessModeData(DisplayConfiguration displayConfiguration) {
    ...
    if (highBrightnessMode != null) {
      ...
      if (refreshRate_all != null) {
        this.mRefreshRateLimitations.add(
            new DisplayManagerInternal.RefreshRateLimitation(
                1,
                refreshRate_all.getMinimum().floatValue(),
                refreshRate_all.getMaximum().floatValue()));
      }
      BigDecimal minimumHdrPercentOfScreen_all =
          highBrightnessMode.getMinimumHdrPercentOfScreen_all();
  ...
  public final void loadBrightnessRamps(DisplayConfiguration displayConfiguration) {
    BigDecimal screenBrightnessRampFastDecrease =
        displayConfiguration.getScreenBrightnessRampFastDecrease();
    BigDecimal screenBrightnessRampFastIncrease =
        displayConfiguration.getScreenBrightnessRampFastIncrease();
    BigDecimal screenBrightnessRampSlowDecrease =
        displayConfiguration.getScreenBrightnessRampSlowDecrease();
    BigDecimal screenBrightnessRampSlowIncrease =
        displayConfiguration.getScreenBrightnessRampSlowIncrease();
    if (screenBrightnessRampFastDecrease != null
        && screenBrightnessRampFastIncrease != null
        && screenBrightnessRampSlowDecrease != null
        && screenBrightnessRampSlowIncrease != null) {
      ...
      if (screenBrightnessRampFastDecrease != null
        ...
        Slog.w(
            "DisplayDeviceConfig",
            "Per display brightness ramp values ignored because not all values are present in"
  ...
  public final void loadBrightnessRampsFromConfigXml() {
    this.mBrightnessRampFastIncrease =
        BrightnessSynchronizer.brightnessIntToFloat(
            this.mContext.getResources().getInteger(R.integer.config_datause_threshold_bytes));
    float brightnessIntToFloat =
        BrightnessSynchronizer.brightnessIntToFloat(
            this.mContext.getResources().getInteger(R.integer.config_datause_throttle_kbitsps));
  ...
  public final void loadAmbientLightSensorFromConfigXml() {
    ...
    sensorData.name = "";
    sensorData.type = this.mContext.getResources().getString(R.string.demo_restarting_message);
  }
  ...
  public final void loadScreenOffBrightnessSensorFromDdc(
      DisplayConfiguration displayConfiguration) {
  ...
  public final void loadDisplayBrightnessThresholds(DisplayConfiguration displayConfiguration) {
    ...
    if (displayConfiguration == null
        || displayConfiguration.getDisplayBrightnessChangeThresholds() == null) {
      brightnessThresholds = null;
      brightnessThresholds2 = null;
    } else {
      BrightnessThresholds brighteningThresholds =
          displayConfiguration.getDisplayBrightnessChangeThresholds().getBrighteningThresholds();
      brightnessThresholds =
          displayConfiguration.getDisplayBrightnessChangeThresholds().getDarkeningThresholds();
      brightnessThresholds2 = brighteningThresholds;
    }
    float[] fArr = DEFAULT_SCREEN_THRESHOLD_LEVELS;
    Pair brightnessLevelAndPercentage =
        getBrightnessLevelAndPercentage(
            brightnessThresholds2,
            17236297,
            17236292,
            fArr,
    ...
    Pair brightnessLevelAndPercentage2 =
        getBrightnessLevelAndPercentage(
            brightnessThresholds,
            17236297,
            17236296,
  ...
  public final void loadAmbientBrightnessThresholds(DisplayConfiguration displayConfiguration) {
    ...
    BrightnessThresholds brightnessThresholds2;
    if (displayConfiguration == null
        || displayConfiguration.getAmbientBrightnessChangeThresholds() == null) {
      brightnessThresholds = null;
      brightnessThresholds2 = null;
    } else {
      BrightnessThresholds brighteningThresholds =
          displayConfiguration.getAmbientBrightnessChangeThresholds().getBrighteningThresholds();
      brightnessThresholds =
          displayConfiguration.getAmbientBrightnessChangeThresholds().getDarkeningThresholds();
      brightnessThresholds2 = brighteningThresholds;
    }
    ...
    Pair brightnessLevelAndPercentage =
        getBrightnessLevelAndPercentage(
            brightnessThresholds2,
            R.array.config_maskBuiltInDisplayCutoutArray,
  ...
  public final void loadDisplayBrightnessThresholdsIdle(DisplayConfiguration displayConfiguration) {
    ...
    BrightnessThresholds brightnessThresholds2;
    if (displayConfiguration == null
        || displayConfiguration.getDisplayBrightnessChangeThresholdsIdle() == null) {
      brightnessThresholds = null;
      brightnessThresholds2 = null;
    } else {
      BrightnessThresholds brighteningThresholds =
          displayConfiguration
              .getDisplayBrightnessChangeThresholdsIdle()
              .getBrighteningThresholds();
      brightnessThresholds =
          displayConfiguration.getDisplayBrightnessChangeThresholdsIdle().getDarkeningThresholds();
      brightnessThresholds2 = brighteningThresholds;
    }
    float[] fArr = DEFAULT_SCREEN_THRESHOLD_LEVELS;
    Pair brightnessLevelAndPercentage =
  ...
  public final void loadAmbientBrightnessThresholdsIdle(DisplayConfiguration displayConfiguration) {
    ...
    BrightnessThresholds brightnessThresholds2;
    if (displayConfiguration == null
        || displayConfiguration.getAmbientBrightnessChangeThresholdsIdle() == null) {
      brightnessThresholds = null;
      brightnessThresholds2 = null;
    } else {
      BrightnessThresholds brighteningThresholds =
          displayConfiguration
              .getAmbientBrightnessChangeThresholdsIdle()
              .getBrighteningThresholds();
      brightnessThresholds =
          displayConfiguration.getAmbientBrightnessChangeThresholdsIdle().getDarkeningThresholds();
      brightnessThresholds2 = brighteningThresholds;
    }
    float[] fArr = DEFAULT_AMBIENT_THRESHOLD_LEVELS;
    Pair brightnessLevelAndPercentage =
  ...
  public final Pair getBrightnessLevelAndPercentage(
      BrightnessThresholds brightnessThresholds, int i, int i2, float[] fArr, float[] fArr2) {
  ...
  public final Pair getBrightnessLevelAndPercentage(
    ...
    if (brightnessThresholds != null
        && brightnessThresholds.getBrightnessThresholdPoints() != null
        && brightnessThresholds.getBrightnessThresholdPoints().getBrightnessThresholdPoint().size()
            != 0) {
      List<ThresholdPoint> brightnessThresholdPoint =
          brightnessThresholds.getBrightnessThresholdPoints().getBrightnessThresholdPoint();
  ...
  public final float[] constraintInRangeIfNeeded(float[] fArr) {
    ...
    Slog.w(
        "DisplayDeviceConfig", "Detected screen thresholdLevels on a deprecated brightness scale");
    float[] fArr2 = new float[fArr.length];
  ...
  public abstract /* synthetic */ class AbstractC12091 {
    public static final /* synthetic */ int[]
        $SwitchMap$com$android$server$display$config$ThermalStatus;
    ...
    static {
      ...
      try {
        $SwitchMap$com$android$server$display$config$ThermalStatus[ThermalStatus.light.ordinal()] =
            2;
      } catch (NoSuchFieldError unused2) {
      }
      try {
        $SwitchMap$com$android$server$display$config$ThermalStatus[
                ThermalStatus.moderate.ordinal()] =
            3;
      } catch (NoSuchFieldError unused3) {
      }
      try {
        $SwitchMap$com$android$server$display$config$ThermalStatus[ThermalStatus.severe.ordinal()] =
            4;
      } catch (NoSuchFieldError unused4) {
      }
      try {
        $SwitchMap$com$android$server$display$config$ThermalStatus[
                ThermalStatus.critical.ordinal()] =
            5;
      } catch (NoSuchFieldError unused5) {
      }
      try {
        $SwitchMap$com$android$server$display$config$ThermalStatus[
                ThermalStatus.emergency.ordinal()] =
            6;
      } catch (NoSuchFieldError unused6) {
      }
      try {
        $SwitchMap$com$android$server$display$config$ThermalStatus[
                ThermalStatus.shutdown.ordinal()] =
            7;
  ...
  public final boolean thermalStatusIsValid(ThermalStatus thermalStatus) {
    ...
    switch (AbstractC12091.$SwitchMap$com$android$server$display$config$ThermalStatus[
        thermalStatus.ordinal()]) {
    }
    return false;
  }
  ...
  public final void loadHighBrightnessModeDataFromConfigXml() {
    ...
    if (z) {
      this.mHbmData =
          new HighBrightnessModeData(
              this.mContext.getResources().getInteger(R.integer.config_brightness_ramp_rate_slow),
              1.0f,
              0L,
              0L,
              0L,
  ...
  public final void loadScreenOffBrightnessSensorValueToLuxFromDdc(
      DisplayConfiguration displayConfiguration) {
    IntegerArray screenOffBrightnessSensorValueToLux =
        displayConfiguration.getScreenOffBrightnessSensorValueToLux();
  ...
  public final void loadUsiVersion(DisplayConfiguration displayConfiguration) {
    ...
    this.mHostUsiVersion =
        usiVersion != null
            ? new HostUsiVersion(
                usiVersion.getMajorVersion().intValue(), usiVersion.getMinorVersion().intValue())
            : null;
  }
  ...
  public class HighBrightnessModeData {
    ...
    public HighBrightnessModeData(
        float f, float f2, long j, long j2, long j3, boolean z, float f3) {
      this.minimumLux = f;
  ...
  public class ThermalBrightnessThrottlingData {
    ...
    public static ThermalBrightnessThrottlingData create(List list) {
      ...
      while (i < size) {
        ...
        if (throttlingLevel2.thermalStatus <= throttlingLevel.thermalStatus) {
          Slog.e(
              "DisplayDeviceConfig",
              "brightnessThrottlingMap must be strictly increasing, ignoring configuration."
                  + " ThermalStatus "
                  + throttlingLevel2.thermalStatus
                  + " <= "
        ...
        if (throttlingLevel2.brightness >= throttlingLevel.brightness) {
          Slog.e(
              "DisplayDeviceConfig",
              "brightnessThrottlingMap must be strictly decreasing, ignoring configuration."
                  + " Brightness "
                  + throttlingLevel2.brightness
                  + " >= "
                  + throttlingLevel2.brightness);
          return null;
        }
      ...
      while (it.hasNext()) {
        ...
        if (throttlingLevel3.brightness > 1.0f) {
          Slog.e(
              "DisplayDeviceConfig",
              "brightnessThrottlingMap contains a brightness value exceeding system max. Brightness"
                  + " "
    ...
    public boolean equals(Object obj) {
      ...
      if (obj instanceof ThermalBrightnessThrottlingData) {
        return this.throttlingLevels.equals(
            ((ThermalBrightnessThrottlingData) obj).throttlingLevels);
      }
      return false;
    }
    ...
    public ThermalBrightnessThrottlingData(List list) {
      ...
      while (it.hasNext()) {
        ...
        this.throttlingLevels.add(
            new ThrottlingLevel(throttlingLevel.thermalStatus, throttlingLevel.brightness));
      }
    }
  }
}
