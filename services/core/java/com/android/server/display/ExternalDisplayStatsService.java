...
public final class ExternalDisplayStatsService {
    ...
    public final AnonymousClass2 mInteractivityReceiver = new BroadcastReceiver() { // from class:
                // com.android.server.display.ExternalDisplayStatsService.2
                @Override // android.content.BroadcastReceiver
                public final void onReceive(Context context, Intent intent) {
                    synchronized (ExternalDisplayStatsService.this.mExternalDisplayStates) {
                        try {
                            if (ExternalDisplayStatsService.this.mExternalDisplayStates.size()
                                    == 0) {
                                return;
                            }
                            int i = 0;
                            ...
                            ExternalDisplayStatsService externalDisplayStatsService2 =
                                    ExternalDisplayStatsService.this;
                            ...
                            if (i2 == 0) {
                                synchronized (externalDisplayStatsService2.mExternalDisplayStates) {
                                    while (i
                                            < externalDisplayStatsService2.mExternalDisplayStates
                                                    .size()) {
                                        try {
                                            Injector injector2 =
                                                    externalDisplayStatsService2.mInjector;
                                            int i5 = i + 1;
                                            boolean z =
                                                    externalDisplayStatsService2
                                            ...
                                            if (ExternalDisplayStatsService.DEBUG) {
                                                int keyAt2 =
                                                        externalDisplayStatsService2
                                                                .mExternalDisplayStates.keyAt(i);
                                                Slog.d(
                                                        "ExternalDisplayStatsService",
                                                        "logExternalDisplayIdleStarted displayId="
                                                                + keyAt2
                                                                + " currentState="
                                                                + externalDisplayStatsService2
                                                                        .mExternalDisplayStates.get(
                                                                        keyAt2, 1)
                                ...
                                synchronized (externalDisplayStatsService2.mExternalDisplayStates) {
                                    while (true) {
                                        try {
                                            ...
                                            int i6 =
                                                    externalDisplayStatsService2
                                                            .mExternalDisplayStates.get(keyAt3, 1);
                                            if (i6 == 1) {
                                                break;
                                            }
                                            Injector injector3 =
                                            ...
                                            if (ExternalDisplayStatsService.DEBUG) {
                                                Slog.d(
                                                        "ExternalDisplayStatsService",
                                                        "logExternalDisplayIdleEnded displayId="
                                                                + keyAt3
                                                                + " state="
                                                                + i6
                                                                + " countOfExternalDisplays="
    ...
    public final class AnonymousClass1 extends AudioManager.AudioPlaybackCallback {
        ...
        public AnonymousClass1() {
            ...
            this.mLogStateAfterAudioSinkEnabled =
                    new Runnable(
                            this) { // from class:
                                    // com.android.server.display.ExternalDisplayStatsService$1$$ExternalSyntheticLambda0
                        public final /* synthetic */ ExternalDisplayStatsService.AnonymousClass1
                                f$0;
                        ...
                        public final void run() {
                            ...
                            switch (i2) {
                                case 0:
                                    ExternalDisplayStatsService
                                            .m461$$Nest$mlogStateAfterAudioSinkChanged(
                                                    ExternalDisplayStatsService.this, true);
                                    break;
                                default:
                                    ExternalDisplayStatsService
                                            .m461$$Nest$mlogStateAfterAudioSinkChanged(
                                                    ExternalDisplayStatsService.this, false);
                                    break;
                            }
                        }
                    };
            final int i2 = 1;
            this.mLogStateAfterAudioSinkDisabled =
                    new Runnable(
                            this) { // from class:
                                    // com.android.server.display.ExternalDisplayStatsService$1$$ExternalSyntheticLambda0
                        public final /* synthetic */ ExternalDisplayStatsService.AnonymousClass1
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.display.ExternalDisplayStatsService.AnonymousClass1.onPlaybackConfigChanged(java.util.List):void");
        }
    }
    ...
    public static void m461$$Nest$mlogStateAfterAudioSinkChanged(
            ExternalDisplayStatsService externalDisplayStatsService, boolean z) {
        int size;
        ...
        if (DEBUG) {
            AnyMotionDetector$$ExternalSyntheticOutline0.m(
                    ...
                    BatteryService$$ExternalSyntheticOutline0.m(
                            size,
                            "logStateAfterAudioSinkChanged countOfExternalDisplays)=",
                            " mIsExternalDisplayUsedForAudio="),
        ...
        if (DEBUG) {
            AnyMotionDetector$$ExternalSyntheticOutline0.m(
                    ...
                    ArrayUtils$$ExternalSyntheticOutline0.m(
                            size,
                            i,
                            "logExternalDisplayError countOfExternalDisplays=",
                            " errorType=",
                            " mIsExternalDisplayUsedForAudio="),
                    this.mIsExternalDisplayUsedForAudio);
        }
    }
}
