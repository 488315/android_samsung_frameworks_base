...
public final class DisplayDeviceInfo {
  ...
  public int diff(DisplayDeviceInfo displayDeviceInfo) {
    ...
    return (Objects.equals(this.name, displayDeviceInfo.name)
            ...
            && Arrays.equals(this.supportedColorModes, displayDeviceInfo.supportedColorModes)
            ...
            && Objects.equals(this.deviceProductInfo, displayDeviceInfo.deviceProductInfo)
            && this.ownerUid == displayDeviceInfo.ownerUid
            && Objects.equals(this.ownerPackageName, displayDeviceInfo.ownerPackageName)
            && Arrays.equals(this.frameRateOverrides, displayDeviceInfo.frameRateOverrides)
  ...
  public static String touchToString(int i) {
    return i != 0
        ? i != 1 ? i != 2 ? i != 3 ? Integer.toString(i) : "VIRTUAL" : "EXTERNAL" : "INTERNAL"
        : "NONE";
  }
