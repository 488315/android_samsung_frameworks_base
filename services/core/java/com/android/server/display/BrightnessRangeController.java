...
public final class BrightnessRangeController {
    ...
    public BrightnessRangeController(
        ...
        if (isEnabled) {
            normalBrightnessModeController.mMaxBrightnessLimits =
                    displayDeviceConfig.mLuxThrottlingData;
    ...
    public final float getCurrentBrightnessMax() {
        ...
        return (!z
                        || (highBrightnessModeController.deviceSupportsHbm()
                                && highBrightnessModeController.isHbmCurrentlyAllowed()))
                ? highBrightnessModeController.getCurrentBrightnessMax()
                : Math.min(
                        highBrightnessModeController.getCurrentBrightnessMax(),
                        this.mNormalBrightnessModeController.mMaxBrightness);
    }
    ...
    public final void onAmbientLuxChange(final float f) {
        applyChanges(
                new BooleanSupplier() { // from class:
                                        // com.android.server.display.BrightnessRangeController$$ExternalSyntheticLambda2
                    @Override // java.util.function.BooleanSupplier
                    public final boolean getAsBoolean() {
                        BrightnessRangeController brightnessRangeController =
                                BrightnessRangeController.this;
                        float f2 = f;
                        NormalBrightnessModeController normalBrightnessModeController =
                ...
                new Runnable() { // from class:
                                 // com.android.server.display.BrightnessRangeController$$ExternalSyntheticLambda3
                    ...
                    public final void run() {
                        ...
                        if (highBrightnessModeController.deviceSupportsHbm()
                                && highBrightnessModeController.mIsAutoBrightnessEnabled) {
        ...
        if (this.mUseHdrClamper) {
            ...
            hdrClamper.recalculateBrightnessCap(
                    hdrClamper.mHdrBrightnessData, f, hdrClamper.mHdrVisible);
        }
    }
    ...
    public final void setAutoBrightnessEnabled(final int i) {
        applyChanges(
                new BooleanSupplier() { // from class:
                                        // com.android.server.display.BrightnessRangeController$$ExternalSyntheticLambda5
                    @Override // java.util.function.BooleanSupplier
                    public final boolean getAsBoolean() {
                        BrightnessRangeController brightnessRangeController =
                                BrightnessRangeController.this;
                ...
                new Runnable() { // from class:
                                 // com.android.server.display.BrightnessRangeController$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        BrightnessRangeController brightnessRangeController =
                                BrightnessRangeController.this;
                        ...
                        if (!highBrightnessModeController.deviceSupportsHbm()
                                || z == highBrightnessModeController.mIsAutoBrightnessEnabled) {
                            return;
                        }
                        if (HighBrightnessModeController.DEBUG) {
                            Slog.d(
                                    "HighBrightnessModeController",
                                    "setAutoBrightnessEnabled( " + z + " )");
                        }
        ...
        if (z != hdrClamper.mAutoBrightnessEnabled) {
            ...
            hdrClamper.recalculateBrightnessCap(
                    hdrClamper.mHdrBrightnessData, hdrClamper.mAmbientLux, hdrClamper.mHdrVisible);
        }
    }

    public final void updateHdrClamper(
            DisplayDeviceInfo displayDeviceInfo,
            IBinder iBinder,
            DisplayDeviceConfig displayDeviceConfig) {
        if (this.mUseHdrClamper) {
            ...
            hdrClamper.recalculateBrightnessCap(
                    hdrBrightnessData, hdrClamper.mAmbientLux, hdrClamper.mHdrVisible);
        }
    }
}
