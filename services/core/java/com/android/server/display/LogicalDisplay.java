...
public final class LogicalDisplay {
  ...
  public void updateLocked(DisplayDeviceRepository displayDeviceRepository) {
    ...
    if (!Objects.equals(this.mPrimaryDisplayDeviceInfo, displayDeviceInfoLocked) || this.mDirty) {
      ...
      displayInfo4.minimalPostProcessingSupported =
          displayDeviceInfoLocked.allmSupported || displayDeviceInfoLocked.gameContentTypeSupported;
      ...
      displayInfo4.displayCutout =
          (displayDeviceInfoLocked.flags & IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES) != 0
              ? null
  ...
  public final void updateFrameRateOverrides(DisplayDeviceInfo displayDeviceInfo) {
    ...
    DisplayEventReceiver.FrameRateOverride[] frameRateOverrideArr2 =
        displayDeviceInfo.frameRateOverrides;
        ...
        float floatValue =
            ((Float)
                    this.mTempFrameRateOverride.get(
                        ...
                        Float.valueOf(DisplayPowerController2.RATE_FROM_DOZE_TO_ON)))
                .floatValue();
        if (floatValue == DisplayPowerController2.RATE_FROM_DOZE_TO_ON
            || frameRateOverride2.frameRateHz != floatValue) {
          this.mTempFrameRateOverride.put(
              frameRateOverride2.uid, Float.valueOf(frameRateOverride2.frameRateHz));
        } else {
  ...
  public static Rect getMaskingInsets(DisplayDeviceInfo displayDeviceInfo) {
    ...
    if (((displayDeviceInfo.flags & IInstalld.FLAG_FREE_CACHE_DEFY_TARGET_FREE_BYTES) != 0)
  ...
  public void configureDisplayLocked(
      SurfaceControl.Transaction transaction, DisplayDevice displayDevice, boolean z) {
    int i;
    int i2;
    ...
    displayDevice.setDisplayFlagsLocked(
        transaction,
        (!isEnabledLocked() || displayDevice.getDisplayDeviceInfoLocked().touch == 0) ? 0 : 1);
    ...
    this.mTempLayerStackRect.set(
        0, 0, displayInfoLocked.logicalWidth, displayInfoLocked.logicalHeight);
    ...
    displayDevice.setProjectionLocked(
        transaction, i4, this.mTempLayerStackRect, this.mTempDisplayRect);
  }
  ...
  public void swapDisplaysLocked(LogicalDisplay logicalDisplay) {
    setPrimaryDisplayDeviceLocked(
        logicalDisplay.setPrimaryDisplayDeviceLocked(this.mPrimaryDisplayDevice));
  }
  ...
  public void dumpLocked(PrintWriter printWriter) {
    ...
    printWriter.println(
        "mDisplayOffset=(" + this.mDisplayOffsetX + ", " + this.mDisplayOffsetY + ")");
