...
public class BrightnessThrottler {
  ...
  public BrightnessThrottler(
      Handler handler, Runnable runnable, String str, String str2, HashMap hashMap) {
  ...
  public BrightnessThrottler(
    ...
    loadThermalBrightnessThrottlingDataFromDisplayDeviceConfig(
        this.mDdcThermalThrottlingDataMap,
  ...
  public void loadThermalBrightnessThrottlingDataFromDisplayDeviceConfig(
      HashMap hashMap, String str, String str2) {
    this.mDdcThermalThrottlingDataMap = hashMap;
  ...
  public final float verifyAndConstrainBrightnessCap(float f) {
    if (f < DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
      Slog.e(
          ...
          "brightness "
              + f
              + " is lower than the minimum possible brightness "
    ...
    Slog.e(
        "BrightnessThrottler",
        "brightness " + f + " is higher than the maximum possible brightness 1.0");
    return 1.0f;
  }
  ...
  public final void updateThermalThrottling() {
    ...
    if (deviceSupportsThrottling()) {
      ...
      if (this.mThrottlingStatus != -1
          && (thermalBrightnessThrottlingData = this.mThermalThrottlingData) != null) {
        for (DisplayDeviceConfig.ThermalBrightnessThrottlingData.ThrottlingLevel throttlingLevel :
            thermalBrightnessThrottlingData.throttlingLevels) {
  ...
  public void dump(final PrintWriter printWriter) {
    this.mHandler.runWithScissors(
        new Runnable() { // from class:
                         // com.android.server.display.BrightnessThrottler$$ExternalSyntheticLambda0
  ...
  public final void lambda$dump$0(PrintWriter printWriter) {
    ...
    printWriter.println(
        "  mThermalBrightnessThrottlingDataId=" + this.mThermalBrightnessThrottlingDataId);
    ...
    printWriter.println(
        "  mThermalBrightnessThrottlingDataOverride="
            + this.mThermalBrightnessThrottlingDataOverride);
    printWriter.println(
        "  mThermalBrightnessThrottlingDataString=" + this.mThermalBrightnessThrottlingDataString);
    this.mSkinThermalStatusObserver.dump(printWriter);
  }

  public final String getThermalBrightnessThrottlingDataString() {
    return this.mDeviceConfig.getString(
        "display_manager", "brightness_throttling_data", (String) null);
  }
  ...
  */
    ...
    try {
      ...
      try {
        ...
        while (i4 < parseInt) {
          ...
          try {
            i2 = i5 + 1;
          } catch (UnknownThermalStatusException
          ...
          try {
            arrayList.add(
                new DisplayDeviceConfig.ThermalBrightnessThrottlingData.ThrottlingLevel(
                    parseThermalStatus(split[i]), parseBrightness(split[i5])));
            i4++;
            i = i2;
          } catch (UnknownThermalStatusException
              | IndexOutOfBoundsException
        ...
        DisplayDeviceConfig.ThermalBrightnessThrottlingData create =
            DisplayDeviceConfig.ThermalBrightnessThrottlingData.create(arrayList);
        ...
        if (hashMap2 == null) {
          ...
          if (hashMap2.containsKey(str2)) {
            Slog.e(
                "BrightnessThrottler",
                "Throttling data for display "
                    + str3
                    + "contains duplicate throttling ids: '"
                    + str2
                    + "'");
            return false;
          }
  ...
  public final void resetThermalThrottlingData() {
    ...
    if (!"default".equals(this.mThermalBrightnessThrottlingDataId)
        && this.mThermalThrottlingData == null) {
  ...
  public final DisplayDeviceConfig.ThermalBrightnessThrottlingData getConfigFromId(String str) {
    DisplayDeviceConfig.ThermalBrightnessThrottlingData thermalBrightnessThrottlingData =
        this.mThermalBrightnessThrottlingDataOverride.get(this.mUniqueDisplayId) == null
            ? null
            : (DisplayDeviceConfig.ThermalBrightnessThrottlingData)
                ((HashMap) this.mThermalBrightnessThrottlingDataOverride.get(this.mUniqueDisplayId))
                    .get(str);
    return thermalBrightnessThrottlingData == null
        ? (DisplayDeviceConfig.ThermalBrightnessThrottlingData)
            this.mDdcThermalThrottlingDataMap.get(str)
        : thermalBrightnessThrottlingData;
  }
  ...
  public class DeviceConfigListener implements DeviceConfig.OnPropertiesChangedListener {
    ...
    public void startListening() {
      BrightnessThrottler.this.mDeviceConfig.addOnPropertiesChangedListener(
          "display_manager", this.mExecutor, this);
    }
  ...
  public final class SkinThermalStatusObserver extends IThermalEventListener.Stub {
    ...
    public void notifyThrottling(final Temperature temperature) {
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.display.BrightnessThrottler$SkinThermalStatusObserver$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              BrightnessThrottler.SkinThermalStatusObserver.this.lambda$notifyThrottling$0(
                  temperature);
            }
          });
    }
