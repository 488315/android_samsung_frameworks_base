...
public class Layout {
  ...
  public void createDefaultDisplayLocked(
      DisplayAddress displayAddress, DisplayIdProducer displayIdProducer) {
    createDisplayLocked(
        displayAddress, true, true, "", displayIdProducer, -1, -1, null, null, null);
  }
  ...
  public void createDisplayLocked(
      ...
      boolean z2,
      String str,
      DisplayIdProducer displayIdProducer,
      int i,
      int i2,
      String str2,
      String str3,
  ...
  public class Display {
    ...
    public boolean equals(Object obj) {
      ...
      return display.mIsEnabled == this.mIsEnabled
          ...
          && Objects.equals(
              this.mThermalBrightnessThrottlingMapId, display.mThermalBrightnessThrottlingMapId)
          && Objects.equals(display.mRefreshRateZoneId, this.mRefreshRateZoneId)
          && this.mLeadDisplayId == display.mLeadDisplayId
          && Objects.equals(
              this.mThermalRefreshRateThrottlingMapId, display.mThermalRefreshRateThrottlingMapId);
    }

    public int hashCode() {
      return ((((((((((((((((Boolean.hashCode(this.mIsEnabled) + 31) * 31) + this.mPosition) * 31)
                                                          + this.mLogicalDisplayId)
                                                      * 31)
                                                  + this.mDisplayGroupName.hashCode())
                                              * 31)
                                          + this.mAddress.hashCode())
                                      * 31)
                                  + this.mThermalBrightnessThrottlingMapId.hashCode())
                              * 31)
