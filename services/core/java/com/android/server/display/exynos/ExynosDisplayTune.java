    ...
    public void setCalibrationDQE(String str, String str2) {
        ...
        if (ExynosDisplayUtils.existFile(str) && getXMLVersion(str) != null) {
            ...
            try {
                ...
                if (itemEnable5 > 0) {
                    for (int m26id = CalibOrder.hsc48_lcg_s.m26id(); m26id <= CalibOrder.hsc48_lcg_e.m26id(); m26id++) {
                        iArr2[m26id] = 1;
                    }
                ...
                if (itemEnable7 > 0) {
                    for (int m26id2 = CalibOrder.cgc17_enc_s.m26id(); m26id2 <= CalibOrder.cgc17_enc_e.m26id(); m26id2++) {
                        iArr2[m26id2] = 1;
                    }
                            ...
                            if (i2 <= CalibOrder.degamma.m26id()) {
                                ...
                                if (i2 <= CalibOrder.gamma.m26id()) {
                                    ...
                                    if (i3 == 1) {
                                        ...
                                        String[] parserFactoryXMLText9 = ExynosDisplayUtils.parserFactoryXMLText(str, str2, "hsc48_lcg", m26id3, 0);
                                    ...
                                    if (i3 == 1) {
                                        ...
                                        String[] parserFactoryXMLText14 = ExynosDisplayUtils.parserFactoryXMLText(str, str2, "cgc17_enc", m26id4, m26id5);
