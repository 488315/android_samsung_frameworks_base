...
public class ExynosDisplayATC {
  ...
  public static boolean isDefaultSensorOff(Context context) {
    int integer = context.getResources().getInteger(R.integer.config_defaultUiModeType);
  ...
  public final void getApsInit() {
    String[] parserXMLALText =
        ExynosDisplayUtils.parserXMLALText(this.BYPASS_CAL_FILE_PATH, "atc", 0, "aps");
  ...
  public final int findBestATCTable() {
    ...
    if (strArr[i4] == null) {
      Log.e(
          "ExynosDisplayATC", "unable to find proper ATC table, return prev pos: " + this.mPrevPos);
      return this.mPrevPos;
    }
    if (TUNE_MODE) {
  ...
  public final void recordSensorEvent(SensorEvent sensorEvent) {
    ...
    synchronized (this.mDataCollectionLock) {
      if (!this.mLastSensorReadings.isEmpty()
          && sensorEvent.timestamp < ((LightData) this.mLastSensorReadings.getLast()).timestamp) {
  ...
  public final void initCountDownTimer() {
    this.mCountdownTimer =
        new CountDownTimer(
            this.mTimeoutMs,
            this.mIntervalMs) { // from class: com.android.server.display.exynos.ExynosDisplayATC.2
          ...
          public void onFinish() {
            ...
            if (ExynosDisplayATC.TUNE_MODE) {
              Log.d(
                  "ExynosDisplayATC",
                  "Finished Refresh Timer interval: "
                      + ExynosDisplayATC.this.mIntervalMs
                      + ", timeout: "
                      + ExynosDisplayATC.this.mTimeoutMs);
            }
          }
        };
  }
  ...
  public void parserATCXML(String str, String str2) {
    try {
      String[] parserFactoryXMLAttribute =
          ExynosDisplayUtils.parserFactoryXMLAttribute(str, str2, "atc", "al");
      ...
      synchronized (this.mLock) {
        ...
        while (true) {
          ...
          String[] parserFactoryXMLALText =
              ExynosDisplayUtils.parserFactoryXMLALText(str, str2, "atc", iArr2[i2], "aps", 0);
          ...
          String[] parserFactoryXMLALText2 =
              ExynosDisplayUtils.parserFactoryXMLALText(
                  str, str2, "atc", this.mAmbientLight[i2], "apsdoff", 0);
          ...
          for (int i3 = 0; i3 < 3; i3++) {
            String[] parserFactoryXMLALText7 =
                ExynosDisplayUtils.parserFactoryXMLALText(
                    str, str2, "atc", this.mAmbientLight[i2], "hsc48_lcg", i3);
          ...
          String[] parserFactoryXMLALText8 =
              ExynosDisplayUtils.parserFactoryXMLALText(
                  str, str2, "atc", this.mAmbientLight[i2], "hsc", 0);
  ...
  public final void parserTuneATCBLXML() {
    try {
      String[] parserXMLAttribute =
          ExynosDisplayUtils.parserXMLAttribute(this.ATC_BL_FILE_PATH, "atc", "al");
      ...
      while (true) {
        ...
        this.mBrightnessSetting[i2] =
            Integer.parseInt(
                ExynosDisplayUtils.parserXMLALText(this.ATC_BL_FILE_PATH, "atc", iArr[i2], "bl")[
                    0]);
        i2++;
      }
  ...
  public void setCountDownTimer(int i, int i2) {
    ...
    Log.d(
        "ExynosDisplayATC",
        "mTimeoutMs: " + this.mTimeoutMs + ", mIntervalMs: " + this.mIntervalMs);
    CountDownTimer countDownTimer = this.mCountdownTimer;
    if (countDownTimer != null) {
      this.mCountDownTimerCount = 0;
      countDownTimer.cancel();
