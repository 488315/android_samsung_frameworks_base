    ...
    public final void setGammaOn(int i) {
        ...
        try {
            if (this.gamma_bypass_array == null) {
                String[] parserFactoryXMLText = ExynosDisplayUtils.parserFactoryXMLText(this.BYPASS_XML_FILE_PATH, "bypass", "gamma", 0, 0);
                this.gamma_bypass_array = parserFactoryXMLText;
                this.gamma_ext_bypass_array = null;
                if (parserFactoryXMLText == null) {
                    this.gamma_bypass_array = ExynosDisplayUtils.parserFactoryXMLText(this.BYPASS_XML_FILE_PATH, "bypass", "gamma", 10, 0);
                    this.gamma_ext_bypass_array = ExynosDisplayUtils.parserFactoryXMLText(this.BYPASS_XML_FILE_PATH, "bypass", "gamma", 8, 0);
                }
            }
        ...
        if (strArr != null && strArr.length != 0) {
            if (this.cgc_dither_array == null) {
                this.cgc_dither_array = ExynosDisplayUtils.parserXML(this.BYPASS_XML_FILE_PATH, "bypass", "cgc_dither");
            }
            ...
            if (strArr != null && strArr.length != 0) {
                ...
                for (i2 = 0; i2 < 3; i2++) {
                    for (int i3 = 0; i3 < 17; i3++) {
                        String[] parserFactoryXMLText2 = ExynosDisplayUtils.parserFactoryXMLText(str, str2, "cgc17_enc", i2, i3);
                        if (parserFactoryXMLText2 != null && parserFactoryXMLText2.length >= 1) {
                            String str4 = parserFactoryXMLText2[0];
                            ExynosDisplayUtils.sysfsWriteSting(this.CGC17_IDX_SYSFS_PATH, Integer.toString(i2) + " " + Integer.toString(i3));
    ...
    */
    public void setRgbGain(float f, float f2, float f3) {
        ...
        try {
            ...
            String[] parserXML = ExynosDisplayUtils.parserXML(this.RGBGAIN_XML_FILE_PATH, "rgbgain", "red");
            this.rgain_array = parserXML;
            int i3 = 65;
            if (parserXML == null || parserXML[0].length() <= 0) {
                i = 65;
            } else {
                i = (int) this.rgain_array[0].codePoints().filter(new IntPredicate() { // from class: com.android.server.display.exynos.ExynosDisplayColor$$ExternalSyntheticLambda0
            ...
            if (i3 == 66) {
                ...
                while (i5 < 33) {
                    ...
                    iArr[i5 + 132] = i6;
                    iArr[i5 + FrameworkStatsLog.f643xde3a78eb] = (int) Math.round(((f3 * 255.0f) / 32.0d) * d);
                    i5++;
                    i4 = i4;
                }
                i2 = i4;
        ...
        if (sb.length() > 0) {
            str = sb.toString();
            if (str == null) {
                Log.d("ExynosDisplayColor", "setRgbGain(): r=" + (f * 255.0f) + ", g=" + (f2 * 255.0f) + ", b=" + (f3 * 255.0f));
                sysfsWriteGamma(str, this.EXTENSION_OFF);
                return;
            }
            return;
