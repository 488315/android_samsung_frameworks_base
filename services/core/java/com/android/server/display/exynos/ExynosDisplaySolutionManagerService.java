...
public class ExynosDisplaySolutionManagerService extends IExynosDisplaySolutionManager.Stub {
  ...
  public ExynosDisplaySolutionManagerService(Context context) {
    ...
    contentResolver.registerContentObserver(
        Settings.System.getUriFor("dqe_tune_enabled"), false, this.mSettingsObserver, -1);
    contentResolver.registerContentObserver(
        Settings.System.getUriFor("atc_mode_enabled"), false, this.mSettingsObserver, -1);
    contentResolver.registerContentObserver(
        Settings.System.getUriFor("display_color_mode"), false, this.mSettingsObserver, -1);
      ...
      if (str.equals("hdr_tune")) {
        if (str2 != null) {
          long parseUnsignedLong =
              Long.parseUnsignedLong(str2.replaceFirst("^0x", ""), str2.startsWith("0x") ? 16 : 10);
  ...
  public float[] getRgbGain() {
    ...
    synchronized (this.mLock) {
      ...
      if (this.DEBUG) {
        Log.d(
            "ExynosDisplaySolutionManagerService",
            "getRgbGain(): r=" + rgbGain[0] + ", g=" + rgbGain[1] + ", b=" + rgbGain[2]);
      }
    }
    return rgbGain;
  }
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if ("android.intent.action.BOOT_COMPLETED".equals(action)) {
        ...
        if (!ExynosDisplaySolutionManagerService.this.mAtcEnableSetting
            || ExynosDisplaySolutionManagerService.this.mAtcAlreadyEnable) {
          return;
        }
        ExynosDisplaySolutionManagerService.this.mExynosDisplayATC.enableATC(
            ExynosDisplaySolutionManagerService.this.mAtcEnableSetting);
  ...
  public final void settingChanged() {
    ...
    Log.d(
        "ExynosDisplaySolutionManagerService",
        "settingChanged: mAtcEnableSetting=" + this.mAtcEnableSetting + " atcEnableSetting =" + z2);
    if (this.DEBUG) {
      Log.d(
          "ExynosDisplaySolutionManagerService",
          "settingChanged: display_color_mode=" + intForUser);
    }
