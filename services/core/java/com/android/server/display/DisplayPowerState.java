...
public final class DisplayPowerState {
  ...
  public static final FloatProperty COLOR_FADE_LEVEL =
      new FloatProperty(
          "electronBeamLevel") { // from class: com.android.server.display.DisplayPowerState.1
  ...
  public static final FloatProperty SCREEN_BRIGHTNESS_FLOAT =
      new FloatProperty(
          "screenBrightnessFloat") { // from class: com.android.server.display.DisplayPowerState.2
        @Override // android.util.FloatProperty
        public void setValue(DisplayPowerState displayPowerState, float f) {
  ...
  public static final FloatProperty SCREEN_SDR_BRIGHTNESS_FLOAT =
      new FloatProperty(
          "sdrScreenBrightnessFloat") { // from class:
                                        // com.android.server.display.DisplayPowerState.3
        @Override // android.util.FloatProperty
        public void setValue(DisplayPowerState displayPowerState, float f) {
  ...
  public final Runnable mScreenUpdateRunnable =
      new Runnable() { // from class: com.android.server.display.DisplayPowerState.4
        ...
        public void run() {
          ...
          float f2 =
              (i == 1
                      || DisplayPowerState.this.mColorFadeLevel
                          <= DisplayPowerController2.RATE_FROM_DOZE_TO_ON)
                  ? 0.0f
                  : DisplayPowerState.this.mScreenBrightness;
          if (DisplayPowerState.this.mScreenState != 1
              && DisplayPowerState.this.mColorFadeLevel
                  > DisplayPowerController2.RATE_FROM_DOZE_TO_ON) {
            f = DisplayPowerState.this.mSdrScreenBrightness;
          }
          if (DisplayPowerState.this.mPhotonicModulator.setState(
              DisplayPowerState.this.mScreenState, f2, f)) {
            DisplayPowerState.this.mScreenReady = true;
            DisplayPowerState.this.invokeCleanListenerIfNeeded();
          }
        }
      };
  public final Runnable mColorFadeDrawRunnable =
      new Runnable() { // from class: com.android.server.display.DisplayPowerState.5
        @Override // java.lang.Runnable
        public void run() {
          ...
          if (DisplayPowerState.this.mColorFadePrepared) {
            ...
            Trace.traceCounter(
                131072L,
                DisplayPowerState.COUNTER_COLOR_FADE,
                Math.round(DisplayPowerState.this.mColorFadeLevel * 100.0f));
          }
  ...
  public void setColorFadeLevel(float f) {
    ...
    if (f2 != f) {
      if (f2 == 0.0d) {
        Slog.m73dk("DisplayPowerState", "ColorFade exit displayId=" + this.mDisplayId);
      } else if (f == 0.0d) {
        Slog.m73dk("DisplayPowerState", "ColorFade entry displayId=" + this.mDisplayId);
      }
