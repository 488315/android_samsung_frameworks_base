...
public class TunerSession extends ITuner.Stub {
  ...
  public TunerSession(
      RadioModule radioModule, ITunerSession iTunerSession, ITunerCallback iTunerCallback) {
    ...
    this.mModule.fanoutAidlCallback(
        new RadioModule
            .AidlCallbackRunnable() { // from class:
                                      // com.android.server.broadcastradio.hal2.TunerSession$$ExternalSyntheticLambda5
  ...
  public void step(boolean z, boolean z2) {
    ...
    if (!RadioServiceUserController.isCurrentOrSystemUser()) {
      Slogf.m102w("BcRadio2Srv.session", "Cannot step on HAL 2.0 client from non-current user");
      return;
    }
    synchronized (this.mLock) {
      checkNotClosedLocked();
  ...
  public void seek(boolean z, boolean z2) {
    ...
    if (!RadioServiceUserController.isCurrentOrSystemUser()) {
      Slogf.m102w("BcRadio2Srv.session", "Cannot scan on HAL 2.0 client from non-current user");
      return;
    }
    synchronized (this.mLock) {
      checkNotClosedLocked();
  ...
  public void tune(ProgramSelector programSelector) {
    ...
    if (!RadioServiceUserController.isCurrentOrSystemUser()) {
      Slogf.m102w("BcRadio2Srv.session", "Cannot tune on HAL 2.0 client from non-current user");
      return;
    }
    synchronized (this.mLock) {
      checkNotClosedLocked();
      Convert.throwOnError(
          "tune", this.mHwSession.tune(Convert.programSelectorToHal(programSelector)));
    }
  }
  ...
  public void cancel() {
    ...
    if (!RadioServiceUserController.isCurrentOrSystemUser()) {
      Slogf.m102w("BcRadio2Srv.session", "Cannot cancel on HAL 2.0 client from non-current user");
      return;
    }
    synchronized (this.mLock) {
      checkNotClosedLocked();
      ...
      Utils.maybeRethrow(
          new Utils
              .VoidFuncThrowingRemoteException() { // from class:
                                                   // com.android.server.broadcastradio.hal2.TunerSession$$ExternalSyntheticLambda1
    ...
    synchronized (this.mLock) {
      ...
      try {
        this.mHwSession.isConfigFlagSet(
            i,
            new ITunerSession
                .isConfigFlagSetCallback() { // from class:
                                             // com.android.server.broadcastradio.hal2.TunerSession$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$isConfigFlagSet$2(
      MutableInt mutableInt, MutableBoolean mutableBoolean, int i, boolean z) {
    mutableInt.value = i;
  ...
  public void setConfigFlag(int i, boolean z) {
    ...
    if (!RadioServiceUserController.isCurrentOrSystemUser()) {
      Slogf.m102w(
          "BcRadio2Srv.session", "Cannot set config flag for HAL 2.0 client from non-current user");
      return;
    }
    synchronized (this.mLock) {
      checkNotClosedLocked();
  ...
  public Map setParameters(final Map map) {
    ...
    if (!RadioServiceUserController.isCurrentOrSystemUser()) {
      Slogf.m102w(
          "BcRadio2Srv.session", "Cannot set parameters for HAL 2.0 client from non-current user");
      return new ArrayMap();
    }
    synchronized (this.mLock) {
      checkNotClosedLocked();
      vendorInfoFromHal =
          Convert.vendorInfoFromHal(
              (List)
                  Utils.maybeRethrow(
                      new Utils
                          .FuncThrowingRemoteException() { // from class:
                                                           // com.android.server.broadcastradio.hal2.TunerSession$$ExternalSyntheticLambda3
          ...
          Convert.vendorInfoFromHal(
              (List)
                  Utils.maybeRethrow(
                      new Utils
                          .FuncThrowingRemoteException() { // from class:
                                                           // com.android.server.broadcastradio.hal2.TunerSession$$ExternalSyntheticLambda2
                        @Override // com.android.server.broadcastradio.hal2.Utils.FuncThrowingRemoteException
                        public final Object exec() {
