...
public final class RadioModule {
  ...
  public final ITunerCallback mHalTunerCallback = new HwBinderC09641();
  ...
  public class HwBinderC09641 extends ITunerCallback.Stub {
    public HwBinderC09641() {}
    ...
    public void onTuneFailed(final int i, final ProgramSelector programSelector) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
                           // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.HwBinderC09641.this.lambda$onTuneFailed$1(programSelector, i);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onTuneFailed$1(ProgramSelector programSelector, int i) {
      final android.hardware.radio.ProgramSelector programSelectorFromHal =
      ...
      synchronized (RadioModule.this.mLock) {
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
                                         // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda5
    ...
    public void onCurrentProgramInfoChanged(final ProgramInfo programInfo) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
                           // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.HwBinderC09641.this.lambda$onCurrentProgramInfoChanged$3(programInfo);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCurrentProgramInfoChanged$3(ProgramInfo programInfo) {
      synchronized (RadioModule.this.mLock) {
        ...
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
                                         // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda8
              @Override // com.android.server.broadcastradio.hal2.RadioModule.AidlCallbackRunnable
              public final void run(android.hardware.radio.ITunerCallback iTunerCallback) {
    ...
    public void onProgramListUpdated(final ProgramListChunk programListChunk) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.HwBinderC09641.this.lambda$onProgramListUpdated$4(programListChunk);
            }
          });
    }
    ...
    public void onAntennaStateChange(final boolean z) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.HwBinderC09641.this.lambda$onAntennaStateChange$6(z);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onAntennaStateChange$6(final boolean z) {
      synchronized (RadioModule.this.mLock) {
        ...
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
                                         // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda6
              @Override // com.android.server.broadcastradio.hal2.RadioModule.AidlCallbackRunnable
              public final void run(android.hardware.radio.ITunerCallback iTunerCallback) {
    ...
    public void onParametersUpdated(final ArrayList arrayList) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
                           // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.HwBinderC09641.this.lambda$onParametersUpdated$8(arrayList);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onParametersUpdated$8(ArrayList arrayList) {
      ...
      synchronized (RadioModule.this.mLock) {
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
                                         // com.android.server.broadcastradio.hal2.RadioModule$1$$ExternalSyntheticLambda7
              @Override // com.android.server.broadcastradio.hal2.RadioModule.AidlCallbackRunnable
              public final void run(android.hardware.radio.ITunerCallback iTunerCallback) {
  ...
  public static RadioModule tryLoadingModule(int i, String str) {
    try {
      ...
      service.getAmFmRegionConfig(
          false,
          new IBroadcastRadio
              .getAmFmRegionConfigCallback() { // from class:
                                               // com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda3
      ...
      service.getDabRegionConfig(
          new IBroadcastRadio
              .getDabRegionConfigCallback() { // from class:
                                              // com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda4
      ...
      return new RadioModule(
          ...
          Convert.propertiesFromHal(
              ...
              (AmFmRegionConfig) mutable.value,
              (List) mutable2.value));
  ...
  public static /* synthetic */ void lambda$tryLoadingModule$0(
      Mutable mutable, int i, AmFmRegionConfig amFmRegionConfig) {
    if (i == 0) {
      mutable.value = amFmRegionConfig;
    }
  }

  public static /* synthetic */ void lambda$tryLoadingModule$1(
      Mutable mutable, int i, ArrayList arrayList) {
    if (i == 0) {
    ...
    synchronized (this.mLock) {
      if (this.mHalTunerSession == null) {
        ...
        this.mService.openSession(
            this.mHalTunerCallback,
            new IBroadcastRadio
                .openSessionCallback() { // from class:
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$openSession$2(
      Mutable mutable, int i, ITunerSession iTunerSession) {
      ...
      try {
        Convert.throwOnError(
            ...
            this.mHalTunerSession.startProgramListUpdates(
                Convert.programFilterToHal(buildUnionOfTunerSessionFiltersLocked)));
  ...
  public final void fireLater(final Runnable runnable) {
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
            runnable.run();
          }
  ...
  public void fanoutAidlCallback(final AidlCallbackRunnable aidlCallbackRunnable) {
    fireLater(
        new Runnable() { // from class:
                         // com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$fanoutAidlCallback$4(
  ...
  public ICloseHandle addAnnouncementListener(
    ...
    this.mService.registerAnnouncementListener(
        arrayList,
        new HwBinderC09652(iAnnouncementListener),
        new IBroadcastRadio
            .registerAnnouncementListenerCallback() { // from class:
                                                      // com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda2
          ...
          public final void onValues(
              int i2, android.hardware.broadcastradio.V2_0.ICloseHandle iCloseHandle) {
  ...
  public class HwBinderC09652 extends IAnnouncementListener.Stub {
    public final /* synthetic */ android.hardware.radio.IAnnouncementListener val$listener;

    public HwBinderC09652(android.hardware.radio.IAnnouncementListener iAnnouncementListener) {
    ...
    public void onListUpdated(ArrayList arrayList) {
      this.val$listener.onListUpdated(
          (List)
              arrayList.stream()
                  .map(
                      new Function() { // from class:
                                       // com.android.server.broadcastradio.hal2.RadioModule$2$$ExternalSyntheticLambda0
                        @Override // java.util.function.Function
                        public final Object apply(Object obj) {
                          Announcement announcementFromHal;
                          announcementFromHal =
                              Convert.announcementFromHal(
                                  (android.hardware.broadcastradio.V2_0.Announcement) obj);
  ...
  public static /* synthetic */ void lambda$addAnnouncementListener$5(
      MutableInt mutableInt,
      Mutable mutable,
      int i,
      android.hardware.broadcastradio.V2_0.ICloseHandle iCloseHandle) {
    mutableInt.value = i;
  ...
  public Bitmap getImage(final int i) {
    ...
    List list =
        (List)
            Utils.maybeRethrow(
                new Utils
                    .FuncThrowingRemoteException() { // from class:
                                                     // com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda0
