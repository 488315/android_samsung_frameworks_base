...
public final class RadioModule {
    ...
    public ICloseHandle addAnnouncementListener(int[] iArr, IAnnouncementListener iAnnouncementListener) {
        ...
        final Mutable mutable = new Mutable();
        this.mService.registerAnnouncementListener(arrayList, new HwBinderC09652(iAnnouncementListener), new IBroadcastRadio.registerAnnouncementListenerCallback() { // from class: com.android.server.broadcastradio.hal2.RadioModule$$ExternalSyntheticLambda2
