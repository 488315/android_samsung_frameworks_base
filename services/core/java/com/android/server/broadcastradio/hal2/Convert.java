...
public abstract class Convert {
  ...
  public static RadioManager.BandDescriptor[] amfmConfigToBands(AmFmRegionConfig amFmRegionConfig) {
    ...
    while (it.hasNext()) {
      ...
      if (band == FrequencyBand.UNKNOWN) {
        Slog.e(
            "BcRadio2Srv.convert", "Unknown frequency band at " + amFmBandRange.lowerBound + "kHz");
    ...
    return (RadioManager.BandDescriptor[])
        arrayList.toArray(new RadioManager.BandDescriptor[arrayList.size()]);
  }
            ...
            .collect(
                Collectors.toMap(
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda10
                    ...
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda11
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        Integer lambda$dabConfigFromHal$1;
                        lambda$dabConfigFromHal$1 =
                            Convert.lambda$dabConfigFromHal$1((DabTableEntry) obj);
  ...
  public static RadioManager.ModuleProperties propertiesFromHal(
      int i, String str, Properties properties, AmFmRegionConfig amFmRegionConfig, List list) {
    Objects.requireNonNull(str);
    Objects.requireNonNull(properties);
    int[] array =
        properties.supportedIdentifierTypes.stream()
    ...
    return new RadioManager.ModuleProperties(
        ...
        true,
        identifierTypesToProgramTypes(array),
        array,
        dabConfigFromHal(list),
        vendorInfoFromHal(properties.vendorInfo));
  }

  public static void programIdentifierToHal(
      ProgramIdentifier programIdentifier, ProgramSelector.Identifier identifier) {
  ...
  public static android.hardware.broadcastradio.V2_0.ProgramSelector programSelectorToHal(
    ...
    Stream map =
        Arrays.stream(programSelector.getSecondaryIds())
            .map(
                new Function() { // from class:
                                 // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda2
                  @Override // java.util.function.Function
                  public final Object apply(Object obj) {
    ...
    map.forEachOrdered(
        new Consumer() { // from class:
                         // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda3
  ...
  public static boolean isEmpty(
    ...
    return programIdentifier.type == 0
        ...
        && programSelector.secondaryIds.size() == 0;
  }
  ...
  public static ProgramSelector programSelectorFromHal(
    ...
    ProgramSelector.Identifier[] identifierArr =
        (ProgramSelector.Identifier[])
            programSelector.secondaryIds.stream()
                .map(
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda4
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                ...
                .map(
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda5
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                ...
                .toArray(
                    new IntFunction() { // from class:
                                        // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda6
                      @Override // java.util.function.IntFunction
                      public final Object apply(int i) {
                        ProgramSelector.Identifier[] lambda$programSelectorFromHal$2;
                        lambda$programSelectorFromHal$2 =
                            Convert.lambda$programSelectorFromHal$2(i);
    ...
    ProgramSelector.Identifier programIdentifierFromHal =
        programIdentifierFromHal(programSelector.primaryId);
    Objects.requireNonNull(programIdentifierFromHal);
    return new ProgramSelector(
        identifierTypeToProgramType, programIdentifierFromHal, identifierArr, (long[]) null);
  }

  public static /* synthetic */ ProgramSelector.Identifier[] lambda$programSelectorFromHal$2(
      int i) {
  ...
  static {
    ...
    hashMap.put(
        11, new MetadataDef(metadataType, "android.hardware.radio.metadata.DAB_ENSEMBLE_NAME"));
    hashMap.put(
        12,
        new MetadataDef(metadataType, "android.hardware.radio.metadata.DAB_ENSEMBLE_NAME_SHORT"));
    hashMap.put(
        13, new MetadataDef(metadataType, "android.hardware.radio.metadata.DAB_SERVICE_NAME"));
    hashMap.put(
        14,
        new MetadataDef(metadataType, "android.hardware.radio.metadata.DAB_SERVICE_NAME_SHORT"));
    hashMap.put(
        15, new MetadataDef(metadataType, "android.hardware.radio.metadata.DAB_COMPONENT_NAME"));
    hashMap.put(
        16,
        new MetadataDef(metadataType, "android.hardware.radio.metadata.DAB_COMPONENT_NAME_SHORT"));
  }
  ...
  public static RadioMetadata metadataFromHal(ArrayList arrayList) {
    ...
    while (it.hasNext()) {
      ...
      if (metadataDef == null) {
        Slog.i(
            "BcRadio2Srv.convert",
            "Ignored unknown metadata entry: " + MetadataKey.toString(metadata.key));
  ...
  public static RadioManager.ProgramInfo programInfoFromHal(ProgramInfo programInfo) {
    Collection collection =
        (Collection)
            programInfo.relatedContent.stream()
                .map(
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda7
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        ProgramSelector.Identifier lambda$programInfoFromHal$3;
                        lambda$programInfoFromHal$3 =
                            Convert.lambda$programInfoFromHal$3((ProgramIdentifier) obj);
    ...
    return new RadioManager.ProgramInfo(
        ...
        metadataFromHal(programInfo.metadata),
        vendorInfoFromHal(programInfo.vendorInfo));
  }

  public static /* synthetic */ ProgramSelector.Identifier lambda$programInfoFromHal$3(
      ProgramIdentifier programIdentifier) {
    ProgramSelector.Identifier programIdentifierFromHal =
        programIdentifierFromHal(programIdentifier);
    Objects.requireNonNull(programIdentifierFromHal);
  ...
  public static ProgramFilter programFilterToHal(ProgramList.Filter filter) {
    ...
    filter.getIdentifiers().stream()
        .forEachOrdered(
            new Consumer() { // from class:
                             // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda1
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                Convert.lambda$programFilterToHal$4(
                    ProgramFilter.this, (ProgramSelector.Identifier) obj);
              }
            });
  ...
  public static /* synthetic */ void lambda$programFilterToHal$4(
      ProgramFilter programFilter, ProgramSelector.Identifier identifier) {
  ...
  public static ProgramList.Chunk programListChunkFromHal(ProgramListChunk programListChunk) {
    return new ProgramList.Chunk(
        ...
        programListChunk.complete,
        (Set)
            programListChunk.modified.stream()
                .map(
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda8
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
        ...
        (Set)
            programListChunk.removed.stream()
                .map(
                    new Function() { // from class:
                                     // com.android.server.broadcastradio.hal2.Convert$$ExternalSyntheticLambda9
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        ProgramSelector.Identifier lambda$programListChunkFromHal$6;
                        lambda$programListChunkFromHal$6 =
                            Convert.lambda$programListChunkFromHal$6((ProgramIdentifier) obj);
  ...
  public static /* synthetic */ ProgramSelector.Identifier lambda$programListChunkFromHal$6(
      ProgramIdentifier programIdentifier) {
    ProgramSelector.Identifier programIdentifierFromHal =
        programIdentifierFromHal(programIdentifier);
    Objects.requireNonNull(programIdentifierFromHal);
  ...
  public static Announcement announcementFromHal(
      android.hardware.broadcastradio.V2_0.Announcement announcement) {
    ProgramSelector programSelectorFromHal = programSelectorFromHal(announcement.selector);
    Objects.requireNonNull(programSelectorFromHal);
    return new Announcement(
        programSelectorFromHal, announcement.type, vendorInfoFromHal(announcement.vendorInfo));
  }
