...
class TunerCallback implements ITunerCallback {
  ...
  public void onError(final int i) {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda3
  ...
  public void onConfigurationChanged(final RadioManager.BandConfig bandConfig) {
    ...
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda1
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onCurrentProgramInfoChanged$2(
  ...
  public void onCurrentProgramInfoChanged(final RadioManager.ProgramInfo programInfo) {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda2
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  public void onEmergencyAnnouncement(final boolean z) {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda10
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  public void onAntennaState(final boolean z) {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda6
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  public void onBackgroundScanAvailabilityChange(final boolean z) {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda8
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  public void onBackgroundScanComplete() {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda4
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  public void onProgramListChanged() {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda5
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
  ...
  public final void sendProgramListUpdate() {
    ...
    try {
      final ProgramList.Chunk chunk =
          new ProgramList.Chunk(
              true,
              true,
              (Set)
                  this.mTuner.getProgramList(filter.getVendorFilter()).stream()
                      .collect(Collectors.toSet()),
              (Set) null);
      dispatch(
          new RunnableThrowingRemoteException() { // from class:
                                                  // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda0
            @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
            public final void run() {
  ...
  public void onProgramListUpdated(final ProgramList.Chunk chunk) {
    dispatch(
        new RunnableThrowingRemoteException() { // from class:
                                                // com.android.server.broadcastradio.hal1.TunerCallback$$ExternalSyntheticLambda7
          @Override // com.android.server.broadcastradio.hal1.TunerCallback.RunnableThrowingRemoteException
          public final void run() {
