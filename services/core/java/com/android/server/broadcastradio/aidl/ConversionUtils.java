...
public abstract class ConversionUtils {
  ...
  public static VendorKeyValue[] vendorInfoToHalVendorKeyValues(Map map) {
    ...
    for (Map.Entry entry : map.entrySet()) {
      ...
      if (str2 == null || str == null) {
        Slogf.m105w(
            "BcRadioAidlSrv.convert",
            "VendorKeyValue contains invalid entry: key = %s, value = %s",
            str2,
            str);
      } else {
    ...
    return (VendorKeyValue[])
        arrayList.toArray(
            new IntFunction() { // from class:
                                // com.android.server.broadcastradio.aidl.ConversionUtils$$ExternalSyntheticLambda2
              @Override // java.util.function.IntFunction
              public final Object apply(int i) {
                VendorKeyValue[] lambda$vendorInfoToHalVendorKeyValues$0;
                lambda$vendorInfoToHalVendorKeyValues$0 =
                    ConversionUtils.lambda$vendorInfoToHalVendorKeyValues$0(i);
  ...
  public static RadioManager.BandDescriptor[] amfmConfigToBands(AmFmRegionConfig amFmRegionConfig) {
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (band == Utils.FrequencyBand.UNKNOWN) {
        Slogf.m92e(
            "BcRadioAidlSrv.convert",
            "Unknown frequency band at %d kHz",
            Integer.valueOf(amFmRegionConfig.ranges[i].lowerBound));
      } else if (band == Utils.FrequencyBand.FM) {
        AmFmBandRange amFmBandRange = amFmRegionConfig.ranges[i];
        arrayList.add(
            new RadioManager.FmBandDescriptor(
                0,
                1,
                amFmBandRange.lowerBound,
                amFmBandRange.upperBound,
                amFmBandRange.spacing,
                true,
                true,
                true,
                true,
        ...
        arrayList.add(
            new RadioManager.AmBandDescriptor(
                0,
                0,
                amFmBandRange2.lowerBound,
                amFmBandRange2.upperBound,
                amFmBandRange2.spacing,
                true));
      }
    }
    return (RadioManager.BandDescriptor[])
        arrayList.toArray(
            new IntFunction() { // from class:
                                // com.android.server.broadcastradio.aidl.ConversionUtils$$ExternalSyntheticLambda3
              @Override // java.util.function.IntFunction
  ...
  public static RadioManager.ModuleProperties propertiesFromHalProperties(
      int i,
      String str,
    ...
    return new RadioManager.ModuleProperties(
        ...
        false,
        false,
        amfmConfigToBands(amFmRegionConfig),
        true,
        identifierTypesToProgramTypes(properties.supportedIdentifierTypes),
        properties.supportedIdentifierTypes,
        dabConfigFromHalDabTableEntries(dabTableEntryArr),
        vendorInfoFromHalVendorKeyValues(properties.vendorInfo));
  }

  public static ProgramIdentifier identifierToHalProgramIdentifier(
  ...
  public static ProgramSelector.Identifier identifierFromHalProgramIdentifier(
  ...
  public static boolean isValidHalProgramSelector(
      android.hardware.broadcastradio.ProgramSelector programSelector) {
    int i = programSelector.primaryId.type;
    return i == 1 || i == 2 || i == 3 || i == 5 || i == 9 || i == 12 || isVendorIdentifierType(i);
  }

  public static android.hardware.broadcastradio.ProgramSelector programSelectorToHalProgramSelector(
      ProgramSelector programSelector) {
    android.hardware.broadcastradio.ProgramSelector programSelector2 =
    ...
    programSelector2.secondaryIds =
        (ProgramIdentifier[])
            arrayList.toArray(
                new IntFunction() { // from class:
                                    // com.android.server.broadcastradio.aidl.ConversionUtils$$ExternalSyntheticLambda0
                  @Override // java.util.function.IntFunction
                  public final Object apply(int i) {
                    ProgramIdentifier[] lambda$programSelectorToHalProgramSelector$2;
                    lambda$programSelectorToHalProgramSelector$2 =
                        ConversionUtils.lambda$programSelectorToHalProgramSelector$2(i);
  ...
  public static /* synthetic */ ProgramIdentifier[] lambda$programSelectorToHalProgramSelector$2(
      int i) {
  ...
  public static boolean isEmpty(android.hardware.broadcastradio.ProgramSelector programSelector) {
    ...
    return programIdentifier.type == 0
        && programIdentifier.value == 0
        && programSelector.secondaryIds.length == 0;
  }

  public static ProgramSelector programSelectorFromHalProgramSelector(
      android.hardware.broadcastradio.ProgramSelector programSelector) {
    ...
    while (true) {
      ...
      if (i < programIdentifierArr.length) {
        ...
        int identifierTypeToProgramType =
            identifierTypeToProgramType(programSelector.primaryId.type);
        ProgramSelector.Identifier identifierFromHalProgramIdentifier =
            identifierFromHalProgramIdentifier(programSelector.primaryId);
        Objects.requireNonNull(identifierFromHalProgramIdentifier);
        return new ProgramSelector(
            identifierTypeToProgramType,
            identifierFromHalProgramIdentifier,
            (ProgramSelector.Identifier[]) arrayList.toArray(new ProgramSelector.Identifier[0]),
            (long[]) null);
      }
    }
  }
  ...
  public static RadioMetadata radioMetadataFromHalMetadata(Metadata[] metadataArr) {
    ...
    for (int i = 0; i < metadataArr.length; i++) {
      switch (metadataArr[i].getTag()) {
        ...
        case 5:
          builder.putString(
              "android.hardware.radio.metadata.ARTIST", metadataArr[i].getSongArtist());
          break;
        case 6:
        ...
        case 9:
          builder.putString(
              "android.hardware.radio.metadata.PROGRAM_NAME", metadataArr[i].getProgramName());
          break;
        case 10:
          builder.putString(
              "android.hardware.radio.metadata.DAB_ENSEMBLE_NAME",
              metadataArr[i].getDabEnsembleName());
          break;
        case 11:
          builder.putString(
              "android.hardware.radio.metadata.DAB_ENSEMBLE_NAME_SHORT",
              metadataArr[i].getDabEnsembleNameShort());
          break;
        case 12:
          builder.putString(
              "android.hardware.radio.metadata.DAB_SERVICE_NAME",
              metadataArr[i].getDabServiceName());
          break;
        case 13:
          builder.putString(
              "android.hardware.radio.metadata.DAB_SERVICE_NAME_SHORT",
              metadataArr[i].getDabServiceNameShort());
          break;
        case 14:
          builder.putString(
              "android.hardware.radio.metadata.DAB_COMPONENT_NAME",
              metadataArr[i].getDabComponentName());
          break;
        case 15:
          builder.putString(
              "android.hardware.radio.metadata.DAB_COMPONENT_NAME_SHORT",
              metadataArr[i].getDabComponentNameShort());
          break;
        default:
          Slogf.m105w(
              "BcRadioAidlSrv.convert", "Ignored unknown metadata entry: %s", metadataArr[i]);
          break;
      }
    }
  ...
  public static boolean isValidHalProgramInfo(ProgramInfo programInfo) {
    return isValidHalProgramSelector(programInfo.selector)
        && isValidLogicallyTunedTo(programInfo.logicallyTunedTo)
        && isValidPhysicallyTunedTo(programInfo.physicallyTunedTo);
  }
  ...
  public static RadioManager.ProgramInfo programInfoFromHalProgramInfo(ProgramInfo programInfo) {
    ...
    if (programInfo.relatedContent != null) {
      ...
      while (true) {
        ...
        ProgramSelector.Identifier identifierFromHalProgramIdentifier =
            identifierFromHalProgramIdentifier(programIdentifierArr[i]);
    ...
    ProgramSelector programSelectorFromHalProgramSelector =
        programSelectorFromHalProgramSelector(programInfo.selector);
    ...
    return new RadioManager.ProgramInfo(
        ...
        identifierFromHalProgramIdentifier(programInfo.logicallyTunedTo),
        identifierFromHalProgramIdentifier(programInfo.physicallyTunedTo),
        arrayList,
        programInfo.infoFlags,
        programInfo.signalQuality,
        radioMetadataFromHalMetadata(programInfo.metadata),
        vendorInfoFromHalVendorKeyValues(programInfo.vendorInfo));
  }
  ...
  public static ProgramFilter filterToHalProgramFilter(ProgramList.Filter filter) {
    ...
    programFilter.identifiers =
        (ProgramIdentifier[])
            arrayList.toArray(
                new IntFunction() { // from class:
                                    // com.android.server.broadcastradio.aidl.ConversionUtils$$ExternalSyntheticLambda1
                  @Override // java.util.function.IntFunction
                  public final Object apply(int i) {
                    ProgramIdentifier[] lambda$filterToHalProgramFilter$3;
                    lambda$filterToHalProgramFilter$3 =
                        ConversionUtils.lambda$filterToHalProgramFilter$3(i);
  ...
  public static ProgramList.Chunk chunkFromHalProgramListChunk(ProgramListChunk programListChunk) {
    ...
    while (true) {
      ...
      RadioManager.ProgramInfo programInfoFromHalProgramInfo =
          programInfoFromHalProgramInfo(programInfoArr[i2]);
    ...
    return new ProgramList.Chunk(
        programListChunk.purge, programListChunk.complete, arraySet, arraySet2);
  }
  ...
  public static boolean programSelectorMeetsSdkVersionRequirement(
  ...
  public static boolean programInfoMeetsSdkVersionRequirement(
      RadioManager.ProgramInfo programInfo, int i) {
    if (isAtLeastU(i)) {
      return true;
    }
    if (!programSelectorMeetsSdkVersionRequirement(programInfo.getSelector(), i)
        || isNewIdentifierInU(programInfo.getLogicallyTunedTo())
        || isNewIdentifierInU(programInfo.getPhysicallyTunedTo())) {
      return false;
    }
  ...
  public static Announcement announcementFromHalAnnouncement(
      android.hardware.broadcastradio.Announcement announcement) {
    ProgramSelector programSelectorFromHalProgramSelector =
        programSelectorFromHalProgramSelector(announcement.selector);
    Objects.requireNonNull(
        programSelectorFromHalProgramSelector, "Program selector can not be null");
    return new Announcement(
        programSelectorFromHalProgramSelector,
        announcement.type,
        vendorInfoFromHalVendorKeyValues(announcement.vendorInfo));
  }
}
