...
public final class RadioModule {
    ...
    public class BinderC09591 extends ITunerCallback.Stub {
            ...
            synchronized (RadioModule.this.mLock) {
                RadioModule.this.fanoutAidlCallbackLocked(new AidlCallbackRunnable() { // from class: com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda9
                    ...
                    public final void run(android.hardware.radio.ITunerCallback iTunerCallback, int i2) {
                        RadioModule.BinderC09591.lambda$onTuneFailed$0(programSelectorFromHalProgramSelector, halResultToTunerResult, iTunerCallback, i2);
                    }
                });
            }
        }
        ...
        public static /* synthetic */ void lambda$onTuneFailed$0(android.hardware.radio.ProgramSelector programSelector, int i, android.hardware.radio.ITunerCallback iTunerCallback, int i2) {
            if (programSelector != null && !ConversionUtils.programSelectorMeetsSdkVersionRequirement(programSelector, i2)) {
                Slogf.m90e("BcRadioAidlSrv.module", "onTuneFailed: cannot send program selector requiring higher target SDK version");
            } else {
            ...
            synchronized (RadioModule.this.mLock) {
                ...
                RadioModule.this.fanoutAidlCallbackLocked(new AidlCallbackRunnable() { // from class: com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda6
                    ...
                    public final void run(android.hardware.radio.ITunerCallback iTunerCallback, int i) {
                        RadioModule.BinderC09591.lambda$onCurrentProgramInfoChanged$2(programInfoFromHalProgramInfo, iTunerCallback, i);
                    }
                });
            }
        }
        ...
        public static /* synthetic */ void lambda$onCurrentProgramInfoChanged$2(RadioManager.ProgramInfo programInfo, android.hardware.radio.ITunerCallback iTunerCallback, int i) {
            if (!ConversionUtils.programInfoMeetsSdkVersionRequirement(programInfo, i)) {
                Slogf.m90e("BcRadioAidlSrv.module", "onCurrentProgramInfoChanged: cannot send program info requiring higher target SDK version");
            } else {
    ...
    public static RadioModule tryLoadingModule(int i, String str, IBinder iBinder) {
        ...
        try {
            Slogf.m96i("BcRadioAidlSrv.module", "Try loading module for module id = %d, module name = %s", Integer.valueOf(i), str);
    ...
    public final void onTunerSessionProgramListFilterChangedLocked(TunerSession tunerSession) {
        ...
        if (buildUnionOfTunerSessionFiltersLocked == null) {
            ...
            try {
                ...
                Slogf.m93e("BcRadioAidlSrv.module", e, "mHalTunerSession.stopProgramListUpdates() failed", new Object[0]);
                return;
            }
        }
        synchronized (this.mLock) {
            ...
            try {
                ...
                Slogf.m93e("BcRadioAidlSrv.module", e2, "mHalTunerSession.startProgramListUpdates() failed", new Object[0]);
            ...
            return new ICloseHandle.Stub() { // from class: com.android.server.broadcastradio.aidl.RadioModule.3
                public void close() {
                    try {
                        ...
                        Slogf.m93e("BcRadioAidlSrv.module", e, "Failed closing announcement listener", new Object[0]);
                    }
