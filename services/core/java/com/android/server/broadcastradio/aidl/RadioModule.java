...
public final class RadioModule {
  ...
  public final ITunerCallback mHalTunerCallback = new BinderC09591();
  ...
  public class BinderC09591 extends ITunerCallback.Stub {
      ...
      RadioModule.this.fireLater(
          new Runnable() { // from class:
            ...
            public final void run() {
              RadioModule.BinderC09591.this.lambda$onTuneFailed$1(programSelector, i);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onTuneFailed$1(ProgramSelector programSelector, int i) {
      final android.hardware.radio.ProgramSelector programSelectorFromHalProgramSelector =
      ...
      synchronized (RadioModule.this.mLock) {
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
                                         // com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda9
              ...
              public final void run(android.hardware.radio.ITunerCallback iTunerCallback, int i2) {
                RadioModule.BinderC09591.lambda$onTuneFailed$0(
                    programSelectorFromHalProgramSelector,
                    halResultToTunerResult,
                    iTunerCallback,
                    i2);
              }
            });
    ...
    public static /* synthetic */ void lambda$onTuneFailed$0(
        android.hardware.radio.ProgramSelector programSelector,
        int i,
        android.hardware.radio.ITunerCallback iTunerCallback,
        int i2) {
      if (programSelector != null
          && !ConversionUtils.programSelectorMeetsSdkVersionRequirement(programSelector, i2)) {
        Slogf.m90e(
            "BcRadioAidlSrv.module",
            "onTuneFailed: cannot send program selector requiring higher target SDK version");
      } else {
    ...
    public void onCurrentProgramInfoChanged(final ProgramInfo programInfo) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
                           // com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.BinderC09591.this.lambda$onCurrentProgramInfoChanged$3(programInfo);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onCurrentProgramInfoChanged$3(ProgramInfo programInfo) {
      final RadioManager.ProgramInfo programInfoFromHalProgramInfo =
          ConversionUtils.programInfoFromHalProgramInfo(programInfo);
      Objects.requireNonNull(
          programInfoFromHalProgramInfo, "Program info from AIDL HAL is invalid");
      synchronized (RadioModule.this.mLock) {
        ...
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
              ...
              public final void run(android.hardware.radio.ITunerCallback iTunerCallback, int i) {
                RadioModule.BinderC09591.lambda$onCurrentProgramInfoChanged$2(
                    programInfoFromHalProgramInfo, iTunerCallback, i);
              }
            });
      }
    }

    public static /* synthetic */ void lambda$onCurrentProgramInfoChanged$2(
      ...
      if (!ConversionUtils.programInfoMeetsSdkVersionRequirement(programInfo, i)) {
        Slogf.m90e(
            "BcRadioAidlSrv.module",
            "onCurrentProgramInfoChanged: cannot send program info requiring higher target SDK"
                + " version");
      } else {
    ...
    public void onProgramListUpdated(final ProgramListChunk programListChunk) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
                           // com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.BinderC09591.this.lambda$onProgramListUpdated$4(programListChunk);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onProgramListUpdated$4(ProgramListChunk programListChunk) {
      synchronized (RadioModule.this.mLock) {
        ProgramList.Chunk chunkFromHalProgramListChunk =
        ...
        for (int i = 0; i < RadioModule.this.mAidlTunerSessions.size(); i++) {
          ((TunerSession) RadioModule.this.mAidlTunerSessions.valueAt(i))
              .onMergedProgramListUpdateFromHal(chunkFromHalProgramListChunk);
        }
      }
    }
    ...
    public void onAntennaStateChange(final boolean z) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.BinderC09591.this.lambda$onAntennaStateChange$6(z);
            }
          });
    }
    ...
    public void onConfigFlagUpdated(final int i, final boolean z) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
            ...
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.BinderC09591.this.lambda$onConfigFlagUpdated$8(i, z);
            }
          });
    }
    ...
    public void onParametersUpdated(final VendorKeyValue[] vendorKeyValueArr) {
      RadioModule.this.fireLater(
          new Runnable() { // from class:
                           // com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              RadioModule.BinderC09591.this.lambda$onParametersUpdated$10(vendorKeyValueArr);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onParametersUpdated$10(VendorKeyValue[] vendorKeyValueArr) {
      synchronized (RadioModule.this.mLock) {
        final Map vendorInfoFromHalVendorKeyValues =
            ConversionUtils.vendorInfoFromHalVendorKeyValues(vendorKeyValueArr);
        RadioModule.this.fanoutAidlCallbackLocked(
            new AidlCallbackRunnable() { // from class:
                                         // com.android.server.broadcastradio.aidl.RadioModule$1$$ExternalSyntheticLambda7
              @Override // com.android.server.broadcastradio.aidl.RadioModule.AidlCallbackRunnable
              public final void run(android.hardware.radio.ITunerCallback iTunerCallback, int i) {
  ...
  public static RadioModule tryLoadingModule(int i, String str, IBinder iBinder) {
    ...
    try {
      ...
      if (asInterface == null) {
        Slogf.m105w("BcRadioAidlSrv.module", "Module %s is null", str);
        return null;
      }
      try {
        amFmRegionConfig = asInterface.getAmFmRegionConfig(false);
      } catch (RuntimeException unused) {
        Slogf.m96i("BcRadioAidlSrv.module", "Module %s does not has AMFM config", str);
        amFmRegionConfig = null;
      }
      try {
        dabTableEntryArr = asInterface.getDabRegionConfig();
      } catch (RuntimeException unused2) {
        Slogf.m96i("BcRadioAidlSrv.module", "Module %s does not has DAB config", str);
        dabTableEntryArr = null;
      }
      return new RadioModule(
          asInterface,
          ConversionUtils.propertiesFromHalProperties(
              i, str, asInterface.getProperties(), amFmRegionConfig, dabTableEntryArr));
    } catch (RemoteException e) {
      Slogf.m93e("BcRadioAidlSrv.module", e, "Failed to load module %s", str);
      return null;
    }
  }
  ...
  public void closeSessions(int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      try {
        ...
        Slogf.m92e("BcRadioAidlSrv.module", "Failed to close TunerSession %s: %s", tunerSession, e);
      }
    }
  }
  ...
  public final ProgramList.Filter buildUnionOfTunerSessionFiltersLocked() {
    ...
    for (int i = 0; i < this.mAidlTunerSessions.size(); i++) {
      ProgramList.Filter programListFilter =
          ((TunerSession) this.mAidlTunerSessions.valueAt(i)).getProgramListFilter();
  ...
  public final void onTunerSessionProgramListFilterChangedLocked(TunerSession tunerSession) {
    ProgramList.Filter buildUnionOfTunerSessionFiltersLocked =
    ...
    if (buildUnionOfTunerSessionFiltersLocked == null) {
      ...
      try {
        ...
        Slogf.m93e(
            "BcRadioAidlSrv.module",
            e,
            "mHalTunerSession.stopProgramListUpdates() failed",
            new Object[0]);
        return;
      }
    }
    synchronized (this.mLock) {
      ...
      try {
        this.mService.startProgramListUpdates(
            ConversionUtils.filterToHalProgramFilter(buildUnionOfTunerSessionFiltersLocked));
  ...
  public void fanoutAidlCallback(final AidlCallbackRunnable aidlCallbackRunnable) {
    fireLater(
        new Runnable() { // from class:
                         // com.android.server.broadcastradio.aidl.RadioModule$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$fanoutAidlCallback$1(
      AidlCallbackRunnable aidlCallbackRunnable) {
    synchronized (this.mLock) {
      ...
      if (((TunerSession) this.mAidlTunerSessions.valueAt(i)).mUserId == currentUser
        ...
        try {
          aidlCallbackRunnable.run(
              ...
              ((TunerSession) this.mAidlTunerSessions.valueAt(i)).getUid());
        } catch (DeadObjectException unused) {
          Slogf.m90e("BcRadioAidlSrv.module", "Removing dead TunerSession");
          if (arrayList == null) {
            arrayList = new ArrayList();
          }
          arrayList.add((TunerSession) this.mAidlTunerSessions.valueAt(i));
        } catch (RemoteException e) {
          Slogf.m93e("BcRadioAidlSrv.module", e, "Failed to invoke ITunerCallback", new Object[0]);
        }
      }
    }
    if (arrayList != null) {
  ...
  public ICloseHandle addAnnouncementListener(
      final IAnnouncementListener iAnnouncementListener, int[] iArr) {
    ...
    try {
      iCloseHandleArr[0] =
          this.mService.registerAnnouncementListener(
              new IAnnouncementListener
                  .Stub() { // from class: com.android.server.broadcastradio.aidl.RadioModule.2
      ...
      return new ICloseHandle
        ...
        public void close() {
          try {
            ...
            Slogf.m93e(
                "BcRadioAidlSrv.module", e, "Failed closing announcement listener", new Object[0]);
          }
