...
public final /* synthetic */ class RadioModule$$ExternalSyntheticLambda0 implements Runnable {
    ...
    private final void
        ...
        synchronized (RadioModule.this.mLock) {
            ...
            radioModule.fanoutAidlCallbackLocked(
                    new RadioModule$1$$ExternalSyntheticLambda7(0, programInfoFromHalProgramInfo));
        }
    }
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                synchronized (RadioModule.this.mLock) {
                    try {
                        RadioModule.this.mProgramInfoCache.filterAndApplyChunkInternal(
            ...
            default:
                ...
                synchronized (RadioModule.this.mLock) {
                    RadioModule.this.fanoutAidlCallbackLocked(
                            new RadioModule$1$$ExternalSyntheticLambda7(
                                    1,
