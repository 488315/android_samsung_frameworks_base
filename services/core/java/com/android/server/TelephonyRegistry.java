...
public class TelephonyRegistry extends ITelephonyRegistry.Stub {
        ...
        public void handleMessage(Message message) {
          ...
          if (i == 1) {
            int activeModemCount =
                TelephonyRegistry.this.getTelephonyManager().getActiveModemCount();
            for (int i2 = 0; i2 < activeModemCount; i2++) {
              ...
              telephonyRegistry.notifyCellLocationForSubscriber(
                  subscriptionId, telephonyRegistry.mCellIdentity[i2], true);
            }
            return;
          }
          if (i != 2) {
          ...
          TelephonyRegistry.this.mLocalLog.log(
      ...
      new BroadcastReceiver() { // from class: com.android.server.TelephonyRegistry.2
        ...
        public void onReceive(Context context, Intent intent) {
          ...
          if ("android.intent.action.USER_SWITCHED".equals(action)) {
            TelephonyRegistry.this.mHandler.sendMessage(
                TelephonyRegistry.this.mHandler.obtainMessage(
                    1, intent.getIntExtra("android.intent.extra.user_handle", 0), 0));
            return;
          }
          if (action.equals("android.telephony.action.DEFAULT_SUBSCRIPTION_CHANGED")) {
            ...
            int intExtra2 =
                intent.getIntExtra(
                    ...
                    TelephonyRegistry.this.getPhoneIdFromSubId(intExtra));
            if (TelephonyRegistry.this.validatePhoneId(intExtra2)
                && (intExtra != TelephonyRegistry.this.mDefaultSubId
                    || intExtra2 != TelephonyRegistry.this.mDefaultPhoneId)) {
              TelephonyRegistry.this.mHandler.sendMessage(
                  TelephonyRegistry.this.mHandler.obtainMessage(2, intExtra2, intExtra));
              return;
            } else {
  ...
  public class Record {
    ...
    public String toString() {
      return "{callingPackage="
          + TelephonyRegistry.pii(this.callingPackage)
          + " callerUid="
          + this.callerUid
          + " binder="
          + this.binder
          ...
          + this.onSubscriptionsChangedListenerCallback
          + " onOpportunisticSubscriptionsChangedListenererCallback="
          + this.onOpportunisticSubscriptionsChangedListenerCallback
          + " carrierPrivilegesCallback="
          + this.carrierPrivilegesCallback
          + " carrierConfigChangeListener="
          + this.carrierConfigChangeListener
          + " subId="
          + this.subId
          + " phoneId="
          + this.phoneId
  ...
  public class ConfigurationProvider {
      ...
      return ((Integer)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.TelephonyRegistry$ConfigurationProvider$$ExternalSyntheticLambda2
                    public final Object getOrThrow() {
                      Integer lambda$getRegistrationLimit$0;
                      lambda$getRegistrationLimit$0 =
                          TelephonyRegistry.ConfigurationProvider.lambda$getRegistrationLimit$0();
    ...
    public static /* synthetic */ Integer lambda$getRegistrationLimit$0() {
      return Integer.valueOf(
          DeviceConfig.getInt("telephony", "phone_state_listener_per_pid_registration_limit", 50));
    }

    public static /* synthetic */ Boolean lambda$isRegistrationLimitEnabledInPlatformCompat$1(
        int i) {
    ...
    public boolean isRegistrationLimitEnabledInPlatformCompat(final int i) {
      return ((Boolean)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.TelephonyRegistry$ConfigurationProvider$$ExternalSyntheticLambda3
                    public final Object getOrThrow() {
                      Boolean lambda$isRegistrationLimitEnabledInPlatformCompat$1;
                      lambda$isRegistrationLimitEnabledInPlatformCompat$1 =
                          TelephonyRegistry.ConfigurationProvider
                              .lambda$isRegistrationLimitEnabledInPlatformCompat$1(i);
    ...
    public static /* synthetic */ Boolean
        lambda$isCallStateReadPhoneStateEnforcedInPlatformCompat$2(
    ...
    public boolean isCallStateReadPhoneStateEnforcedInPlatformCompat(
        final String str, final UserHandle userHandle) {
      return ((Boolean)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.TelephonyRegistry$ConfigurationProvider$$ExternalSyntheticLambda5
                    public final Object getOrThrow() {
    ...
    public static /* synthetic */ Boolean
        lambda$isActiveDataSubIdReadPhoneStateEnforcedInPlatformCompat$3(
            String str, UserHandle userHandle) {
    ...
    public boolean isActiveDataSubIdReadPhoneStateEnforcedInPlatformCompat(
      ...
      return ((Boolean)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.TelephonyRegistry$ConfigurationProvider$$ExternalSyntheticLambda0
                    public final Object getOrThrow() {
    ...
    public static /* synthetic */ Boolean lambda$isCellInfoReadPhoneStateEnforcedInPlatformCompat$4(
        String str, UserHandle userHandle) {
      return Boolean.valueOf(CompatChanges.isChangeEnabled(184323934L, str, userHandle));
    }

    public boolean isCellInfoReadPhoneStateEnforcedInPlatformCompat(
        final String str, final UserHandle userHandle) {
      return ((Boolean)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.TelephonyRegistry$ConfigurationProvider$$ExternalSyntheticLambda4
                    public final Object getOrThrow() {
                      Boolean lambda$isCellInfoReadPhoneStateEnforcedInPlatformCompat$4;
                      lambda$isCellInfoReadPhoneStateEnforcedInPlatformCompat$4 =
                          TelephonyRegistry.ConfigurationProvider
                              .lambda$isCellInfoReadPhoneStateEnforcedInPlatformCompat$4(
                                  str, userHandle);
    ...
    public static /* synthetic */ Boolean
        lambda$isDisplayInfoReadPhoneStateEnforcedInPlatformCompat$5(
            String str, UserHandle userHandle) {
    ...
    public boolean isDisplayInfoReadPhoneStateEnforcedInPlatformCompat(
      ...
      return ((Boolean)
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    // com.android.server.TelephonyRegistry$ConfigurationProvider$$ExternalSyntheticLambda6
                    public final Object getOrThrow() {
    ...
    public static /* synthetic */ Boolean lambda$isDisplayInfoNrAdvancedSupported$6(
        String str, UserHandle userHandle) {
              ...
              Binder.withCleanCallingIdentity(
                  new FunctionalUtils.ThrowingSupplier() { // from class:
                    ...
                    public final Object getOrThrow() {
                      ...
                      lambda$isDisplayInfoNrAdvancedSupported$6 =
                          TelephonyRegistry.ConfigurationProvider
                              .lambda$isDisplayInfoNrAdvancedSupported$6(str, userHandle);
  ...
  public final boolean isPhoneStatePermissionRequired(Set set, String str, UserHandle userHandle) {
    ...
    if ((set.contains(36) || set.contains(6))
        && this.mConfigurationProvider.isCallStateReadPhoneStateEnforcedInPlatformCompat(
            str, userHandle)) {
      return true;
    }
    if (set.contains(23)
        && this.mConfigurationProvider.isActiveDataSubIdReadPhoneStateEnforcedInPlatformCompat(
            str, userHandle)) {
      return true;
    }
    if (set.contains(11)
        && this.mConfigurationProvider.isCellInfoReadPhoneStateEnforcedInPlatformCompat(
            str, userHandle)) {
      return true;
    }
    return set.contains(21)
        && !this.mConfigurationProvider.isDisplayInfoReadPhoneStateEnforcedInPlatformCompat(
            str, userHandle);
  }
  ...
  public final void onMultiSimConfigChanged() {
    synchronized (this.mRecords) {
      ...
      this.mOutgoingCallEmergencyNumber =
          (EmergencyNumber[]) Arrays.copyOf(this.mOutgoingCallEmergencyNumber, this.mNumPhones);
      this.mOutgoingSmsEmergencyNumber =
          (EmergencyNumber[]) Arrays.copyOf(this.mOutgoingSmsEmergencyNumber, this.mNumPhones);
      this.mTelephonyDisplayInfos =
          (TelephonyDisplayInfo[]) Arrays.copyOf(this.mTelephonyDisplayInfos, this.mNumPhones);
  ...
  public void addOnSubscriptionsChangedListener(
      String str, String str2, IOnSubscriptionsChangedListener iOnSubscriptionsChangedListener) {
    ...
    synchronized (this.mRecords) {
      Record add =
          add(
              ...
              doesLimitApplyForListeners(Binder.getCallingUid(), Process.myUid()));
      if (add == null) {
        return;
      }
  ...
  public void listenWithEventList(
      boolean z,
      boolean z2,
      int i,
      String str,
    ...
    if (checkListenerPermission(set, i, str, str2, "listen")) {
      synchronized (this.mRecords) {
        ...
        if (z3 && validatePhoneId(phoneIdFromSubId)) {
          ...
          if (set.contains(36)) {
            try {
              ...
              iPhoneStateListener3.onLegacyCallStateChanged(
                  iArr[i2], getCallIncomingNumber(add, i2));
          ...
          if (set.contains(28)
              && (imsReasonInfo = (ImsReasonInfo) this.mImsReasonInfo.get(add.phoneId)) != null) {
            try {
          ...
          if (set.contains(13)) {
            try {
              Iterator it =
                  ((Map) this.mPreciseDataConnectionStates.get(add.phoneId)).values().iterator();
              while (it.hasNext()) {
          ...
          if (set.contains(32)
              && (barringInfo = (BarringInfo) this.mBarringInfo.get(add.phoneId)) != null) {
            ...
            try {
              if (this.mLinkCapacityEstimateLists.get(add.phoneId) != null) {
                add.callback.onLinkCapacityEstimateChanged(
                    (List) this.mLinkCapacityEstimateLists.get(add.phoneId));
              }
            ...
            if (callState != null) {
              ...
              try {
                MediaQualityStatus mediaQualityStatus =
                    (MediaQualityStatus)
                        ((SparseArray) this.mMediaQualityStatus.get(add.phoneId)).get(1);
                if (mediaQualityStatus != null
                    && mediaQualityStatus.getCallSessionId().equals(imsCallSessionId)) {
                  add.callback.onMediaQualityStatusChanged(mediaQualityStatus);
                }
                MediaQualityStatus mediaQualityStatus2 =
                    (MediaQualityStatus)
                        ((SparseArray) this.mMediaQualityStatus.get(add.phoneId)).get(2);
                if (mediaQualityStatus2 != null
                    && mediaQualityStatus2.getCallSessionId().equals(imsCallSessionId)) {
    ...
    synchronized (this.mRecords) {
      ...
      if (z && registrationLimit >= 1 && i3 >= registrationLimit) {
        String str =
            "Pid "
                + i2
                + " has exceeded the number of permissible registered listeners. Ignoring request"
                + " to add.";
        loge(str);
        ...
        Rlog.w(
            ...
            "Pid "
                + i2
                + " has exceeded half the number of permissible registered listeners. Now at "
                + i3);
      }
  ...
  public void notifyCarrierNetworkChange(boolean z) {
    int[] array =
        Arrays.stream(SubscriptionManager.from(this.mContext).getCompleteActiveSubscriptionIdList())
            .filter(
                new IntPredicate() { // from class:
                  // com.android.server.TelephonyRegistry$$ExternalSyntheticLambda3
                  @Override // java.util.function.IntPredicate
                  public final boolean test(int i) {
                    boolean lambda$notifyCarrierNetworkChange$0;
                    lambda$notifyCarrierNetworkChange$0 =
                        TelephonyRegistry.this.lambda$notifyCarrierNetworkChange$0(i);
  ...
  public void notifyCarrierNetworkChangeWithSubId(int i, boolean z) {
    if (!TelephonyPermissions.checkCarrierPrivilegeForSubId(this.mContext, i)) {
      throw new SecurityException(
          "notifyCarrierNetworkChange without carrier privilege on subId " + i);
    }
    notifyCarrierNetworkChangeWithPermission(i, z);
  }
        ...
        if (validatePhoneId(i)) {
          ...
          while (it.hasNext()) {
            ...
            if (record.matchTelephonyCallbackEvent(21) && idMatch(record, i2, i)) {
              try {
                if (!this.mConfigurationProvider.isDisplayInfoNrAdvancedSupported(
                    record.callingPackage, Binder.getCallingUserHandle())) {
                  record.callback.onDisplayInfoChanged(
                      getBackwardCompatibleTelephonyDisplayInfo(telephonyDisplayInfo));
                } else {
  ...
  public final TelephonyDisplayInfo getBackwardCompatibleTelephonyDisplayInfo(
    ...
    return new TelephonyDisplayInfo(
        networkType, overrideNetworkType, telephonyDisplayInfo.isRoaming());
  }
        ...
        if (validatePhoneId(i) && preciseDataConnectionState.getApnSetting() != null) {
          ...
          if (!Objects.equals(
              (PreciseDataConnectionState)
                  ((Map) this.mPreciseDataConnectionStates.get(i)).remove(create),
              preciseDataConnectionState)) {
            Iterator it = this.mRecords.iterator();
            while (it.hasNext()) {
              Record record = (Record) it.next();
          ...
          if (preciseDataConnectionState.getState() != 0) {
            ((Map) this.mPreciseDataConnectionStates.get(i))
                .put(create, preciseDataConnectionState);
          }
          ArrayMap arrayMap = new ArrayMap();
          int i4 = 0;
          if (preciseDataConnectionState.getState() == 0
              && preciseDataConnectionState.getApnSetting().getApnTypes().contains(17)) {
          ...
          for (Map.Entry entry : ((Map) this.mPreciseDataConnectionStates.get(i)).entrySet()) {
            if (((Integer) ((Pair) entry.getKey()).first).intValue() == 1
                && ((ApnSetting) ((Pair) entry.getKey()).second).getApnTypes().contains(17)) {
              arrayMap.put(
                  Integer.valueOf(((PreciseDataConnectionState) entry.getValue()).getState()),
          ...
          while (true) {
            ...
            if (arrayMap.containsKey(Integer.valueOf(i6))) {
              i3 =
                  ((PreciseDataConnectionState) arrayMap.get(Integer.valueOf(i6))).getNetworkType();
              i4 = i6;
              break;
            }
            i5++;
  ...
  public final void notifyCellLocationForSubscriber(int i, CellIdentity cellIdentity, boolean z) {
    log(
        "notifyCellLocationForSubscriber: subId="
            + i
            + " cellIdentity="
            + Rlog.pii(false, cellIdentity));
    if (checkNotifyPermission("notifyCellLocation()")) {
      int phoneIdFromSubId = getPhoneIdFromSubId(i);
      synchronized (this.mRecords) {
        if (validatePhoneId(phoneIdFromSubId)
            && (z || !Objects.equals(cellIdentity, this.mCellIdentity[phoneIdFromSubId]))) {
    ...
    if (checkNotifyPermission("notifyPreciseCallState()")) {
      ...
      synchronized (this.mRecords) {
        if (validatePhoneId(i)) {
          ...
          sb.append(
              z ? SemTelephonyUtils.preciseCallStateToString(this.mPreciseCallState[i]) : "false");
          sb.append(", notifyCallState: ");
          sb.append(
              z2
                  ? SemTelephonyUtils.callStateListToString((List) this.mCallStateLists.get(i))
                  : "false");
          log(sb.toString());
          if (z) {
            Iterator it2 = this.mRecords.iterator();
            ...
            if (record.matchTelephonyCallbackEvent(26) && idMatch(record, i2, i)) {
              try {
                record.callback.onCallDisconnectCauseChanged(
                    this.mCallDisconnectCause[i], this.mCallPreciseDisconnectCause[i]);
              } catch (RemoteException unused) {
                this.mRemoveList.add(record.binder);
              }
            }
            ...
            if (record.matchTelephonyCallbackEvent(28) && idMatch(record, i, phoneIdFromSubId)) {
              try {
                record.callback.onImsCallDisconnectCauseChanged(
                    (ImsReasonInfo) this.mImsReasonInfo.get(phoneIdFromSubId));
              } catch (RemoteException unused) {
                this.mRemoveList.add(record.binder);
              }
            }
      ...
      synchronized (this.mRecords) {
        if (validatePhoneId(i)) {
          this.mEmergencyNumberList =
              ((TelephonyManager) this.mContext.getSystemService("phone")).getEmergencyNumberList();
          Iterator it = this.mRecords.iterator();
          while (it.hasNext()) {
            Record record = (Record) it.next();
      ...
      synchronized (this.mRecords) {
        if (validatePhoneId(i)) {
          ...
          if (((CallState) ((List) this.mCallStateLists.get(i)).get(0)).getCallState() != 1 && !z) {
            log(
                "There is no active call to report CallQuality and call network type is not"
                    + " changed");
            return;
          }
            ...
            ((List) this.mCallStateLists.get(i))
                .add(
                    new CallState.Builder(callState.getCallState())
                        .setNetworkType(i3)
                        .setCallQuality(
                            callState.getCallState() == 1 ? callQuality : createCallQuality())
                        .setCallClassification(callState.getCallClassification())
                        .setImsCallSessionId(callState.getImsCallSessionId())
                        .setImsCallServiceType(callState.getImsCallServiceType())
  ...
  public void notifyRegistrationFailed(
    ...
    if (checkNotifyPermission("notifyRegistrationFailed()")) {
      ...
      this.mLocalLog.log(
          "Registration Failed for phoneId="
              + i6
              + " subId="
              + i2
              + "primaryPlmn="
              ...
              try {
                ...
                try {
                  record2.callback.onRegistrationFailed(
                      checkFineLocationAccess(record2, 1) ? cellIdentity : sanitizeLocationInfo,
                      str,
                      i3,
                      i4,
                      i5);
        ...
        if (validatePhoneId(i)) {
          ...
          while (it.hasNext()) {
            ...
            if (record.matchTelephonyCallbackEvent(33) && idMatch(record, i2, i)) {
              try {
                record.callback.onPhysicalChannelConfigChanged(
                    shouldSanitizeLocationForPhysicalChannelConfig(record)
  ...
  public void removeCarrierPrivilegesCallback(
    ...
    this.mAppOps.checkPackage(Binder.getCallingUid(), str);
    this.mContext.enforceCallingOrSelfPermission(
        "android.permission.READ_PRIVILEGED_PHONE_STATE", "removeCarrierPrivilegesCallback");
          ...
          if (record.matchCarrierPrivilegesCallback() && idMatch(record, -1, i)) {
            try {
              record.carrierPrivilegesCallback.onCarrierPrivilegesChanged(
                  Collections.unmodifiableList(list), Arrays.copyOf(iArr, iArr.length));
            } catch (RemoteException unused) {
              this.mRemoveList.add(record.binder);
            }
          }
  ...
  public void addCarrierConfigChangeListener(
  ...
  public void removeCarrierConfigChangeListener(
          ...
          if (((List) this.mCallStateLists.get(i)).size() > 0) {
            ...
            if (callState != null) {
              ...
              if (imsCallSessionId != null
                  && imsCallSessionId.equals(mediaQualityStatus.getCallSessionId())) {
                ((SparseArray) this.mMediaQualityStatus.get(i))
                    .put(mediaQualityStatus.getMediaSessionType(), mediaQualityStatus);
              } else {
                log(
    ...
    if (DumpUtils.checkDumpPermission(this.mContext, "TelephonyRegistry", indentingPrintWriter)) {
      synchronized (this.mRecords) {
        ...
        for (int i = 0; i < getTelephonyManager().getActiveModemCount(); i++) {
          ...
          indentingPrintWriter.println(
              "mCallPreciseDisconnectCause=" + this.mCallPreciseDisconnectCause[i]);
          ...
          indentingPrintWriter.println(
              "mPreciseDataConnectionStates=" + this.mPreciseDataConnectionStates.get(i));
          indentingPrintWriter.println(
              "mOutgoingCallEmergencyNumber=" + this.mOutgoingCallEmergencyNumber[i]);
          indentingPrintWriter.println(
              "mOutgoingSmsEmergencyNumber=" + this.mOutgoingSmsEmergencyNumber[i]);
          ...
          indentingPrintWriter.println(
              "mPhysicalChannelConfigs=" + this.mPhysicalChannelConfigs.get(i));
          indentingPrintWriter.println(
              "mLinkCapacityEstimateList=" + this.mLinkCapacityEstimateLists.get(i));
          ...
          Pair pair2 = (Pair) this.mCarrierServiceStates.get(i);
          indentingPrintWriter.println(
              "mCarrierServiceState=<package="
                  + pii((String) pair2.first)
                  + ", uid="
                  + pair2.second
                  + ">");
  ...
  public final void broadcastServiceStateChanged(ServiceState serviceState, int i, int i2) {
    ...
    if (LocationAccessPolicy.isLocationModeEnabled(context, context.getUserId())) {
      ...
      this.mContext
          .createContextAsUser(UserHandle.ALL, 0)
            ...
            Binder.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  ...
                  public final Object getOrThrow() {
                    ...
                    lambda$broadcastServiceStateChanged$1 =
                        TelephonyRegistry.this.lambda$broadcastServiceStateChanged$1();
  ...
  public final Intent createServiceStateIntent(
  ...
  public final void fillInSignalStrengthNotifierBundle(
      SignalStrength signalStrength, Bundle bundle) {
  ...
  public final void broadcastCallStateChanged(int i, String str, int i2, int i3) {
    ...
    this.mContext.sendBroadcastAsUser(
        intent2, UserHandle.ALL, "android.permission.READ_PRIVILEGED_PHONE_STATE");
    this.mContext.sendBroadcastAsUser(
        intent, UserHandle.ALL, "android.permission.READ_PHONE_STATE", 51);
    this.mContext.sendBroadcastAsUserMultiplePermissions(
        intent2,
        UserHandle.ALL,
        new String[] {"android.permission.READ_PHONE_STATE", "android.permission.READ_CALL_LOG"});
  }
  ...
  public final void broadcastDataConnectionStateChanged(
    ...
    intent.putExtra("subscription", i2);
    this.mContext.sendBroadcastAsUser(
        intent, UserHandle.ALL, "android.permission.READ_PHONE_STATE");
    this.mContext
        .createContextAsUser(UserHandle.ALL, 0)
        .sendBroadcastMultiplePermissions(
            intent,
  ...
  public final boolean checkListenerPermission(
      Set set, int i, String str, String str2, String str3) {
    boolean z = true;
    if (isLocationPermissionRequired(set)) {
      LocationAccessPolicy.LocationPermissionQuery.Builder callingUid =
          new LocationAccessPolicy.LocationPermissionQuery.Builder()
              .setCallingPackage(str)
              .setCallingFeatureId(str2)
              .setMethod(str3 + " events: " + set)
      ...
      int i2 =
          AbstractC03583.f1620x50ec2579[
              LocationAccessPolicy.checkLocationPermission(this.mContext, callingUid.build())
                  .ordinal()];
      if (i2 == 1) {
        throw new SecurityException(
            "Unable to listen for events " + set + " due to insufficient location permissions.");
      }
      if (i2 == 2) {
        z = false;
      }
    ...
    boolean z2 =
        (!isPhoneStatePermissionRequired(set, str, Binder.getCallingUserHandle())
                || TelephonyPermissions.checkCallingOrSelfReadPhoneState(
                    this.mContext, i, str, str2, str3))
            ? z
            : false;
    if (isPrecisePhoneStatePermissionRequired(set)) {
      try {
        this.mContext.enforceCallingOrSelfPermission(
            "android.permission.READ_PRECISE_PHONE_STATE", null);
      } catch (SecurityException unused) {
    ...
    if (isActiveEmergencySessionPermissionRequired(set)) {
      this.mContext.enforceCallingOrSelfPermission(
          "android.permission.READ_ACTIVE_EMERGENCY_SESSION", null);
    }
    if (isPrivilegedPhoneStatePermissionRequired(set)) {
      this.mContext.enforceCallingOrSelfPermission(
          "android.permission.READ_PRIVILEGED_PHONE_STATE", null);
    }
    return z2;
  }

  /* renamed from: com.android.server.TelephonyRegistry$3 */
  public abstract /* synthetic */ class AbstractC03583 {

    /* renamed from: $SwitchMap$android$telephony$LocationAccessPolicy$LocationPermissionResult */
    public static final /* synthetic */ int[] f1620x50ec2579;
    ...
    static {
      ...
      try {
        f1620x50ec2579[LocationAccessPolicy.LocationPermissionResult.DENIED_SOFT.ordinal()] = 2;
  ...
  public final boolean checkFineLocationAccess(Record record, int i) {
    ...
    final LocationAccessPolicy.LocationPermissionQuery build =
        new LocationAccessPolicy.LocationPermissionQuery.Builder()
    ...
    return ((Boolean)
            Binder.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  // com.android.server.TelephonyRegistry$$ExternalSyntheticLambda2
                  public final Object getOrThrow() {
                    Boolean lambda$checkFineLocationAccess$2;
                    lambda$checkFineLocationAccess$2 =
                        TelephonyRegistry.this.lambda$checkFineLocationAccess$2(build);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Boolean lambda$checkFineLocationAccess$2(
      LocationAccessPolicy.LocationPermissionQuery locationPermissionQuery) {
    return Boolean.valueOf(
        LocationAccessPolicy.checkLocationPermission(this.mContext, locationPermissionQuery)
            ...
            Binder.withCleanCallingIdentity(
                new FunctionalUtils.ThrowingSupplier() { // from class:
                  ...
                  public final Object getOrThrow() {
                    ...
                    lambda$checkCoarseLocationAccess$3 =
                        TelephonyRegistry.this.lambda$checkCoarseLocationAccess$3(build);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ Boolean lambda$checkCoarseLocationAccess$3(
      LocationAccessPolicy.LocationPermissionQuery locationPermissionQuery) {
    return Boolean.valueOf(
        LocationAccessPolicy.checkLocationPermission(this.mContext, locationPermissionQuery)
            == LocationAccessPolicy.LocationPermissionResult.ALLOWED);
    ...
    if (set.contains(7)) {
      try {
        record.callback.onDataConnectionStateChanged(
            this.mDataConnectionState[i], this.mDataConnectionNetworkType[i]);
      } catch (RemoteException unused10) {
        this.mRemoveList.add(record.binder);
      }
    }
