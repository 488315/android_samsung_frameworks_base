...
public abstract class WallpaperUtils {
    public static final String[] sPerUserFiles = {
        ...
        "wallpaper_subdisplay_info.xml",
        "wallpaper_desktop_orig",
        "wallpaper_desktop",
        "wallpaper_desktop_info.xml",
        "wallpaper_virtual_display_orig",
        "wallpaper_virtual_display",
        "wallpaper_virtualdisplay_info.xml"
    };
    public static final String[] sPerUserLockFiles = {
        "wallpaper_lock_orig",
        "wallpaper_lock",
    ...
    public static String getCropFileName(int i) {
        ...
        return mode != 8
                ? mode != 16
                        ? mode != 32
                                ? type == 2 ? "wallpaper_lock" : "wallpaper"
                                : type == 2 ? "" : "wallpaper_virtual_display"
                        : type == 2 ? "wallpaper_sub_display_lock" : "wallpaper_sub_display"
                : type == 2 ? "wallpaper_desktop_lock" : "wallpaper_desktop";
    }
    ...
    public static String getFileName(int i) {
        ...
        return mode != 8
                ? mode != 16
                        ? mode != 32
                                ? type == 2 ? "wallpaper_lock_orig" : "wallpaper_orig"
                                : type == 2 ? "" : "wallpaper_virtual_display_orig"
                        : type == 2
                                ? "wallpaper_sub_display_lock_orig"
                                : "wallpaper_sub_display_orig"
                : type == 2 ? "wallpaper_desktop_lock_orig" : "wallpaper_desktop_orig";
    }
    ...
    public static String getInfoFileName(int i) {
        ...
        return mode != 8
                ? mode != 16
                        ? mode != 32 ? "wallpaper_info.xml" : "wallpaper_virtualdisplay_info.xml"
                        : "wallpaper_subdisplay_info.xml"
                : "wallpaper_desktop_info.xml";
    }
