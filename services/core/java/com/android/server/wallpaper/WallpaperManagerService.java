...
public class WallpaperManagerService extends IWallpaperManager.Stub implements IWallpaperManagerService, SnapshotCallback {
    ...
    public class Lifecycle extends SystemService {
        ...
        public void onStart() {
            try {
                IWallpaperManagerService iWallpaperManagerService = (IWallpaperManagerService) Class.forName(getContext().getResources().getString(R.string.ext_media_unsupported_notification_message)).getConstructor(Context.class).newInstance(getContext());
    ...
    public class WallpaperObserver {
        ...
        public WallpaperObserver(WallpaperData wallpaperData) {
            ...
            this.mSemObserver = new SemWallpaperManagerService.SemWallpaperObserver(wallpaperDir, WallpaperUtils.getWallpaperLockDir(wallpaperData.userId), WallpaperManagerService.this.new SemCallback());
        }
        ...
        public final void sendRefreshCacheCommandLocked(WallpaperData wallpaperData, int i) {
            Log.m129d("WallpaperManagerService", "sendRefreshCacheCommand: send command to update cached wallpaper, which = " + i);
        ...
        */
        public final void updateWallpapersLegacy(int i, String str, File file, boolean z, boolean z2, int i2) {
            int i3;
            ...
            if (str != null && str.contains("wallpaper")) {
                Slog.v("WallpaperManagerService", "Wallpaper file change: evt=" + i + " path=" + str + " sys=" + z + " lock=" + z2 + " imagePending=" + dataForEvent.imageWallpaperPending + " mWhich=0x" + Integer.toHexString(dataForEvent.mWhich) + " written=" + z4 + " mode=" + i2 + " primaryColors:" + dataForEvent.primaryColors + " wallpaper = " + dataForEvent);
            }
            if (z3 && z2) {
                SELinux.restorecon(file);
                int i6 = 2 | i2;
                WallpaperManagerService.this.notifyLockWallpaperChanged(dataForEvent.mSemWallpaperData.getWpType(), i6);
            ...
            synchronized (WallpaperManagerService.this.mLock) {
                if (z || z2) {
                    int i7 = i2 | 2;
                    WallpaperData peekWallpaperDataLocked = WallpaperManagerService.this.peekWallpaperDataLocked(dataForEvent.userId, i7);
                    boolean isSystemAndLockPaired = WallpaperManagerService.this.isSystemAndLockPaired(dataForEvent.userId, i2);
                    ...
                    if (!WhichChecker.isSystemAndLock(dataForEvent.mWhich) || !z2) {
                        if (WhichChecker.isSystemAndLock(dataForEvent.mWhich) && z) {
                            if (peekWallpaperDataLocked != null) {
                                ...
                                WallpaperManagerService.this.notifyWallpaperColorsChanged(peekWallpaperDataLocked, i7);
                            }
                            WallpaperManagerService.this.notifyCallbacksLocked(dataForEvent);
                            if (Rune.SUPPORT_SUB_DISPLAY_MODE && Rune.SUPPORT_COVER_DISPLAY_WATCHFACE && WhichChecker.isWatchFaceDisplay(dataForEvent.mWhich)) {
                                WallpaperManagerService.this.notifyCoverWallpaperChanged(dataForEvent.mSemWallpaperData.getWpType(), dataForEvent.mWhich);
                            }
                        } else {
                            WallpaperManagerService.this.notifyCallbacksLocked(dataForEvent);
                    ...
                    if (dataForEvent.mSemWallpaperData.getWpType() != 5) {
                        WallpaperManagerService.this.resetSemWallpaperData(dataForEvent.mSemWallpaperData, dataForEvent.userId);
                    }
                    if (dataForEvent.wallpaperComponent == null || i != 8 || dataForEvent.imageWallpaperPending || (z && i == 8)) {
                        Log.m132i("WallpaperManagerService", "wallpaper.imageWallpaperPending = " + dataForEvent.imageWallpaperPending);
                        ...
                        if (z4) {
                            ...
                            dataForEvent.imageWallpaperPending = false;
                            if (z) {
                                if (WallpaperManagerService.this.mSemService.hasLockscreenWallpaper(false) && !isSystemAndLockPaired) {
                                    i5 = 0;
                                    IRemoteCallback.Stub stub = new IRemoteCallback.Stub() { // from class: com.android.server.wallpaper.WallpaperManagerService.WallpaperObserver.3
                                        public void sendResult(Bundle bundle) {
                                    ...
                                    if (!WallpaperManagerService.this.canBindComponentNow(dataForEvent.mWhich | i2)) {
                                        ...
                                        wallpaperManagerService.bindWallpaperComponentLocked(wallpaperManagerService.mImageWallpaper, true, false, dataForEvent, stub);
                                    } else {
                                        i3 = i7;
                                        semWallpaperColors = null;
                                        wallpaperData = dataForEvent;
                                        if (Rune.SUPPORT_SUB_DISPLAY_MODE && WhichChecker.isSystem(wallpaperData.mWhich)) {
                                ...
                                i5 = 2;
                                IRemoteCallback.Stub stub2 = new IRemoteCallback.Stub() { // from class: com.android.server.wallpaper.WallpaperManagerService.WallpaperObserver.3
                                    public void sendResult(Bundle bundle) {
                                        Slog.d("WallpaperManagerService", "publish system wallpaper changed!");
                                        WallpaperManagerService.this.notifyWallpaperChanged(dataForEvent);
                                    }
                            ...
                            if (z2 || (wallpaperData.mWhich & 2) != 0) {
                                ...
                                if (wallpaperData.mSemWallpaperData.getWpType() == 0) {
                                    WallpaperManagerService.this.notifyLockWallpaperChanged(wallpaperData.mSemWallpaperData.getWpType(), i3);
    ...
    */
    public final void notifyWallpaperColorsChangedOnDisplay(WallpaperData wallpaperData, int i, int i2) {
        ...
        synchronized (this.mLock) {
            ...
            if (wallpaperData.primaryColors != null && !wallpaperData.mIsColorExtractedFromDim && wallpaperData.mSemWallpaperData.getPrimarySemColors() != null) {
                z = false;
                if (z) {
    ...
    public final void extractColors(WallpaperData wallpaperData) {
        ...
        if (str == null && !z) {
            ...
            if (croppedBitmap != null) {
                Log.m132i("WallpaperManagerService", "extractColors: crop file is none so, get colors from cropped bitmap (CSC, OMC case)");
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (WallpaperManagerService.this.mLock) {
                ...
                if (wallpaperData.connection == this) {
                    ...
                    Log.m129d("WallpaperManagerService", "Wallpaper onServiceConnected : " + this.mWallpaper + " mode = " + mode);
        ...
        public /* synthetic */ void lambda$new$5() {
            synchronized (WallpaperManagerService.this.mLock) {
                ...
                if (this == wallpaperData.connection) {
                    ComponentName componentName = wallpaperData.wallpaperComponent;
                    Log.m129d("WallpaperManagerService", "Wallpaper onServiceDisconnected : " + componentName);
    ...
    public WallpaperManagerService(Context context) {
        ...
        Log.m129d("WallpaperManagerService", "WallpaperService startup (support sub display ? " + Rune.SUPPORT_SUB_DISPLAY_MODE + ")");
    ...
    public void switchUser(int i, IRemoteCallback iRemoteCallback) {
        ...
        synchronized (this.mLock) {
            ...
            Log.m129d("WallpaperManagerService", "switchUser: userId = " + i + ", lidState = " + getLidState());
            if (Rune.SUPPORT_SUB_DISPLAY_MODE) {
                this.mSemService.mSubDisplayMode.updateLidStateFromInputManager();
            }
            ...
            if (wallpaperSafeLocked != null && wallpaperSafeLocked2 != null) {
                ...
                if (Rune.VIRTUAL_DISPLAY_WALLPAPER && this.mSemService.mVirtualDisplayMode.isVirtualWallpaperDisplay(this.mActiveVirtualDisplayId)) {
                    ...
                    if (wallpaperConnection == null || wallpaperConnection.mService == null) {
                        Log.m129d("WallpaperManagerService", "switchUser: userId = " + i + ", mActiveVirtualDisplayId = " + this.mActiveVirtualDisplayId);
                        switchWallpaper(wallpaperSafeLocked4, null);
                    }
                }
                if (getLidState() != 0) {
    ...
    public void clearWallpaper(String str, int i, int i2) {
        ...
        WallpaperData wallpaperData;
        int i4 = i;
        Log.m133v("WallpaperManagerService", "clearWallpaper: callingPackage = " + str + ", which = " + i4);
        ...
        if (isWallpaperSupported(str) && isSetWallpaperAllowed(str)) {
            if (!this.mSemService.isSupportingMode(i4)) {
                Log.m130e("WallpaperManagerService", "clearWallpaper [" + WhichChecker.getMode(i) + "] mode isn't support");
                return;
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void clearWallpaperLocked(boolean z, int i, int i2, IRemoteCallback iRemoteCallback, String str) {
        WallpaperData wallpaperData;
        boolean z2;
            ...
            if (file != null && file.exists() && wallpaperData2.cropFile.delete()) {
                ...
                if (!WhichChecker.isLock(modeEnsuredWhich)) {
                    ...
                    if ("android.app.cts.wallpapers".equals(str)) {
                        Log.m129d("WallpaperManagerService", "clearWallpaperLocked (CTS): REMOVE LOCK WALLPAPER.");
                        ...
                        Log.m129d("WallpaperManagerService", "clearWallpaperLocked: DO NOT RESTORE TO DEFAULT LOCK WALLPAPER.");
                        notifyLockWallpaperChanged(-1, modeEnsuredWhich);
                    } else {
                        if ((WhichChecker.isPhone(modeEnsuredWhich) || WhichChecker.isSubDisplay(modeEnsuredWhich)) && getDefaultWallpaperType(modeEnsuredWhich) == 8 && !WallpaperManager.isDefaultOperatorWallpaper(this.mContext, modeEnsuredWhich)) {
                            if (!"com.android.wallpaper.livepicker".equals(str)) {
                                SemWallpaperData semWallpaperData2 = getWallpaperSafeLocked(i2, WhichChecker.getMode(modeEnsuredWhich) | 1).mSemWallpaperData;
                                if (!semWallpaperData2.getIsPreloaded() || semWallpaperData2.getWpType() != 7) {
                                    z3 = true;
                                    if (!z3) {
                                        Log.addLogString("WallpaperManagerService", "clearWallpaperLocked: Reset to default video wallpaper. But we don't update settings.");
                                        Log.m129d("WallpaperManagerService", "clearWallpaperLocked: Reset to default video wallpaper. But we don't update settings.");
                                    }
                            ...
                            wallpaperSafeLocked2.mSemWallpaperData.setWallpaperHistories(wallpaperData2.mSemWallpaperData.getWallpaperHistories());
                            ...
                            try {
                                if (isDefaultMultipack(i2, modeEnsuredWhich, str)) {
                                    ...
                                    wallpaperSafeLocked2.mSemWallpaperData.setUri(getDefaultMultiPackUri(modeEnsuredWhich));
                                    notifyCallbacksLocked(wallpaperData2);
                                    notifyMultipackApplied(modeEnsuredWhich);
                                } else if (!this.mSemWallpaperResourcesInfo.isDefaultMultipack(modeEnsuredWhich) || WallpaperManager.isDefaultOperatorWallpaper(this.mContext, 2, this.mSemService.mCMFWallpaper.getDeviceColor())) {
                                    wallpaperSafeLocked2.mSemWallpaperData.setWpType(0);
                                    WallpaperData wallpaperData3 = this.mWallpaperMap.get(i2, mode);
                                    if (wallpaperData3 == null || (semWallpaperData = wallpaperData3.mSemWallpaperData) == null || wallpaperData3.wallpaperComponent == null || semWallpaperData.getWpType() != 7 || !wallpaperData3.wallpaperComponent.equals(getDefaultPreloadedLiveWallpaperComponentName(mode | 1))) {
                                        notifyLockWallpaperChanged(wallpaperSafeLocked2.mSemWallpaperData.getWpType(), modeEnsuredWhich);
                                    } else {
                                        wallpaperSafeLocked2.mSemWallpaperData.setWpType(-1);
                                        setKWPTypeLiveWallpaperWithMode(mode, 0);
                                        if (Rune.SUPPORT_LARGE_FRONT_SUB_DISPLAY && getLidState() == 0 && WhichChecker.isPhone(modeEnsuredWhich)) {
                                            notifyLockWallpaperChanged(wallpaperSafeLocked2.mSemWallpaperData.getWpType(), modeEnsuredWhich);
                                        }
                                    }
                                    this.mSemService.mLegibilityColor.extractColor(wallpaperSafeLocked2.mSemWallpaperData.getWhich());
                                } else {
                                    notifyCallbacksLocked(wallpaperData2);
                                    notifyMultipackApplied(modeEnsuredWhich);
                                }
                ...
                wallpaperData2.setCallingPackage(str + "(clear)");
                if (WhichChecker.isSystem(modeEnsuredWhich) && WhichChecker.isPhone(modeEnsuredWhich) && !WallpaperManager.isDefaultOperatorWallpaper(this.mContext, modeEnsuredWhich) && getDefaultWallpaperType(modeEnsuredWhich) == 7) {
                    wallpaperData2.mSemWallpaperData.setWpType(7);
                    componentName = getDefaultPreloadedLiveWallpaperComponentName(modeEnsuredWhich);
                    if (componentName != null) {
                        Log.m129d("WallpaperManagerService", "clearWallpaperLocked: Set default preload live wallpaper, which = " + modeEnsuredWhich + ", componentName = " + componentName);
                ...
                try {
                    ...
                    if (Rune.SUPPORT_SUB_DISPLAY_MODE) {
                        wallpaperSafeLocked = getWallpaperSafeLocked(i2, !WhichChecker.isSubDisplay(modeEnsuredWhich) ? 5 : 17);
                        if (wallpaperSafeLocked != null) {
                            Log.m132i(str2, "clearWallpaperLocked: default failed on both screen. So bind wallpaper agian");
                            return;
                        }
                    }
                ...
                if (!canBindComponentNow(modeEnsuredWhich)) {
                    if (Rune.SUPPORT_SUB_DISPLAY_MODE && (modeEnsuredWhich & 1) == 1) {
                        if (this.mImageWallpaper.equals(wallpaperData2.wallpaperComponent)) {
                            Log.m129d("WallpaperManagerService", "clearWallpaperLocked: send command to update cached wallpaper for homescreen.");
                            Bundle bundle = new Bundle();
                ...
                if (isCoverVideoWallpaperDefault(modeEnsuredWhich) || getDefaultWallpaperType(modeEnsuredWhich) == 7) {
                }
                wallpaperData2.mSemWallpaperData.setWpType(0);
                str2 = "WallpaperManagerService";
                if (bindWallpaperComponentLocked(z ? this.mImageWallpaper : componentName, true, false, wallpaperData2, iRemoteCallback)) {
                    if (!z2) {
                        notifyCallbacksLocked(wallpaperData2);
                    }
                    return;
                ...
                if (Rune.SUPPORT_SUB_DISPLAY_MODE && !Rune.SUPPORT_COVER_DISPLAY_WATCHFACE) {
                    wallpaperSafeLocked = getWallpaperSafeLocked(i2, !WhichChecker.isSubDisplay(modeEnsuredWhich) ? 5 : 17);
                    if (wallpaperSafeLocked != null && wallpaperSafeLocked.wallpaperComponent == null && bindWallpaperComponentLocked(this.mImageWallpaper, true, false, wallpaperSafeLocked, iRemoteCallback)) {
                        Log.m132i(str2, "clearWallpaperLocked: default failed on both screen. So bind wallpaper agian");
                        return;
                    }
                }
    ...
    public final ParcelFileDescriptor getWallpaper(IWallpaperManagerCallback iWallpaperManagerCallback, int i, Bundle bundle, int i2, int i3, boolean z, boolean z2) {
        Log.m129d("WallpaperManagerService", "getWallpaper: which = " + i + ", wallpaperUserId = " + i2 + ", wpType = " + i3 + ", isDexEnabled = " + this.mSemService.mDesktopMode.isDesktopModeEnabled(i) + ", getCropped = " + z2 + ", includeCopiedFile = " + z);
        ...
        synchronized (this.mLock) {
            ...
            synchronized (this.mLock) {
                Log.m129d("WallpaperManagerService", "getWallpaper: which = " + modeEnsuredWhich + ", isCopied = " + wallpaperData.mSemWallpaperData.getIsCopied());
    ...
    */
    public WallpaperColors getWallpaperColors(int i, int i2, int i3) {
        ...
        Log.m129d("WallpaperManagerService", "getWallpaperColors: which = " + folderStateBasedWhich + " , userId = " + i2);
        ...
        synchronized (this.mLock) {
            WallpaperData peekWallpaperDataLocked = WhichChecker.isLock(folderStateBasedWhich) ? peekWallpaperDataLocked(handleIncomingUser, folderStateBasedWhich) : null;
            if (peekWallpaperDataLocked == null) {
                peekWallpaperDataLocked = findWallpaperAtDisplay(handleIncomingUser, i3, WhichChecker.getMode(folderStateBasedWhich));
            }
            if (peekWallpaperDataLocked == null) {
                return null;
            }
            if (peekWallpaperDataLocked.primaryColors != null && !peekWallpaperDataLocked.mIsColorExtractedFromDim) {
                z = false;
                if (z) {
    ...
    public ParcelFileDescriptor setWallpaper(String str, String str2, Rect rect, boolean z, Bundle bundle, int i, IWallpaperManagerCallback iWallpaperManagerCallback, int i2, int i3, boolean z2, Bundle bundle2) {
        ...
        if (!this.mSemService.isSupportingMode(i5)) {
            Log.m130e("WallpaperManagerService", "setWallpaper [" + WhichChecker.getMode(i) + "] mode isn't support");
            return null;
        }
        if (rect3 == null) {
    ...
    public ParcelFileDescriptor updateWallpaperBitmapLocked(String str, WallpaperData wallpaperData, Bundle bundle, int i) {
        ...
        try {
            ...
            if (wallpaperData.wallpaperFile != null) {
                Log.m133v("WallpaperManagerService", "updateWallpaperBitmapLocked: which = " + i + ", id = " + wallpaperData.wallpaperId + ", name = " + str + ",file = " + wallpaperData.wallpaperFile.getName());
            }
            return open;
        } catch (FileNotFoundException e) {
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        IRemoteCallback.Stub stub = new IRemoteCallback.Stub() { // from class: com.android.server.wallpaper.WallpaperManagerService.6
                            ...
                            if (canBindComponentNow(i3)) {
                                if (!z8) {
                                    if (!this.mImageWallpaper.equals(wallpaperSafeLocked.wallpaperComponent)) {
                                        ...
                                        obj = obj2;
                                        z3 = bindWallpaperComponentLocked(componentName, z9, true, wallpaperSafeLocked, stub);
                                        wallpaperData = wallpaperSafeLocked;
                                    }
                                }
                                z5 = true;
                                ...
                                wallpaperData2 = wallpaperData3;
                                obj = obj2;
                                z3 = bindWallpaperComponentLocked(componentName, z92, true, wallpaperSafeLocked, stub);
                                wallpaperData = wallpaperSafeLocked;
                            } else {
                                z = isPreloadedLiveWallpaper;
                                wallpaperData = wallpaperSafeLocked;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void setWallpaperComponentInternalLegacy(ComponentName componentName, String str, int i, int i2, Bundle bundle) {
        int i3;
        boolean z;
        WallpaperInfo wallpaperInfo;
        ...
        boolean isSystemAndLockPaired = isSystemAndLockPaired(handleIncomingUser, mode);
        synchronized (this.mLock) {
            Slog.v("WallpaperManagerService", "setWallpaperComponent name=" + componentName + " , which = " + i3 + " , coverWallpaperInfo = " + coverWallpaperInfo);
            if (!this.mSemService.mKnox.isWallpaperChangeAllowed(true)) {
                return;
            }
            String packageName = componentName != null ? componentName.getPackageName() : null;
            if (!"com.samsung.android.wallpaper.live".equals(packageName) && this.mIsPreviewLockLiveWallpaperEnabled && isLock) {
                i3 = mode | 1;
            }
            ...
            try {
                if (this.mImageWallpaper.equals(peekWallpaperDataLocked2.wallpaperComponent)) {
                    if (isSystemAndLockPaired && !"com.samsung.android.wallpaper.live".equals(packageName)) {
                        Slog.i("WallpaperManagerService", "Migrating current wallpaper to be lock-only beforeupdating system wallpaper");
                        boolean migrateStaticSystemToLockWallpaperLocked = migrateStaticSystemToLockWallpaperLocked(handleIncomingUser, mode | 1);
                    ...
                    if (isSystem && isSystemAndLockPaired && this.mIsPreviewLockLiveWallpaperEnabled) {
                        ...
                        z = isSystem;
                        boolean isPreloadedLiveWallpaperComponent = this.mLiveWallpaperHelper.isPreloadedLiveWallpaperComponent(peekWallpaperDataLocked2.wallpaperComponent);
                        wallpaperInfo = coverWallpaperInfo;
                        boolean isSupportSystemAndLockPairOnly = this.mLiveWallpaperHelper.isSupportSystemAndLockPairOnly(peekWallpaperDataLocked2.wallpaperComponent);
                        Slog.i("WallpaperManagerService", "setWallpaper: isPreloadedLiveComponent = " + isPreloadedLiveWallpaperComponent + "isSystemAndLockPairOnly = " + isSupportSystemAndLockPairOnly);
                        if (wpType == 7 && isPreloadedLiveWallpaperComponent && !isSupportSystemAndLockPairOnly) {
                            Slog.i("WallpaperManagerService", "Migrating current live wallpaper to be lock-only before updating system wallpaper");
                            migrateLiveSystemToLockWallpaperLocked = migrateLiveSystemToLockWallpaperLocked(mode, handleIncomingUser);
                            if (!migrateLiveSystemToLockWallpaperLocked) {
                                ...
                                if (isSystemAndLockPaired) {
                                    Slog.d("WallpaperManagerService", "setWallpaperComponent: Set both flags, FLAG_SYSTEM and FLAG_LOCK");
                                    i9 |= 2;
                                }
                                int i10 = i9;
                                if ("com.samsung.android.wallpaper.live".equals(packageName)) {
                                    ...
                                    componentName2 = componentName;
                                    if (isPreloadLiveWallpaperReApplied(componentName2, peekWallpaperDataLocked2, bundle)) {
                                        z3 = true;
                                        if (!z3) {
                                            resetSemWallpaperData(peekWallpaperDataLocked2.mSemWallpaperData, peekWallpaperDataLocked2.userId);
                                        }
                                        if (!WhichChecker.isSystemAndLock(i4) && !migrateLiveSystemToLockWallpaperLocked) {
                                            WallpaperData peekWallpaperDataLocked3 = peekWallpaperDataLocked(handleIncomingUser, mode | 2);
                                            if (peekWallpaperDataLocked3 != null) {
                                                resetSemWallpaperData(peekWallpaperDataLocked3.mSemWallpaperData, peekWallpaperDataLocked3.userId);
                                                setKWPTypeLiveWallpaperWithMode(mode, 0);
                                            }
                                        } else {
                                            setKWPTypeLiveWallpaperWithMode(mode, 1);
                                            ...
                                            if (isSystemAndLockPaired) {
                                                try {
                                                    if (WhichChecker.isLock(i4)) {
                                                        z4 = true;
                                                        if (z4 && (peekWallpaperDataLocked = peekWallpaperDataLocked(handleIncomingUser, (i8 = mode | 1))) != null) {
                                        ...
                                        putContentAttributes(peekWallpaperDataLocked2, invokePrepare(handleIncomingUser, i4, componentName2, bundle));
                                        synchronized (this.mLock) {
                                            if (canBindComponentNow(i4)) {
                                                peekWallpaperDataLocked2.fromForegroundApp = isFromForegroundApp(str);
                                                boolean changingToSame = changingToSame(componentName2, peekWallpaperDataLocked2);
                                                boolean z9 = changingToSame && !isSystemAndLockPaired && WhichChecker.isSystemAndLock(i4);
                                                if (changingToSame && !z9) {
                                                    updateEngineFlags(peekWallpaperDataLocked2);
                                                }
                                                if (!z9 && !this.mImageWallpaper.equals(peekWallpaperDataLocked2.wallpaperComponent)) {
                                                    z6 = false;
                                                    i5 = mode;
                                                    i6 = i10;
                                                    str2 = str;
                                                    if (bindWallpaperComponentLocked(componentName, z6, true, peekWallpaperDataLocked2, null, wallpaperInfo)) {
                                                        if (!changingToSame) {
                                                            peekWallpaperDataLocked2.primaryColors = null;
                                                        } else {
                                                            WallpaperConnection wallpaperConnection = peekWallpaperDataLocked2.connection;
                                                            if (wallpaperConnection != null) {
                                                                wallpaperConnection.forEachDisplayConnector(new Consumer() { // from class: com.android.server.wallpaper.WallpaperManagerService$$ExternalSyntheticLambda8
                                                                    @Override // java.util.function.Consumer
                                                                    public final void accept(Object obj) {
                                                                        WallpaperManagerService.lambda$setWallpaperComponentInternalLegacy$19((WallpaperManagerService.DisplayConnector) obj);
                                                                    }
                                                                });
                                                            }
                                                        }
                                            ...
                                            if (!componentName2.equals(this.mImageWallpaper)) {
                                                ...
                                                if (z) {
                                                    ...
                                                    i7 = i5;
                                                    WallpaperData peekWallpaperDataLocked4 = peekWallpaperDataLocked(handleIncomingUser, i7 | 2);
                                                    if (peekWallpaperDataLocked4 != null) {
                                                        peekWallpaperDataLocked4.mSemWallpaperData.setIsCopied(z5);
                                                    }
                                                }
                                                peekWallpaperDataLocked2.mSemWallpaperData.setIsPreloaded(isPreloadedLiveWallpaper(componentName2, bundle, i4));
                                        ...
                                        Binder.restoreCallingIdentity(clearCallingIdentity);
                                        Slog.i("WallpaperManagerService", "setWallpaperComponent: clear thumbnail files");
                                        ...
                                        if (containsLock || canBindComponentNow(i4)) {
                                            ...
                                            this.mSemService.mLegibilityColor.extractColor(peekWallpaperDataLocked2.mSemWallpaperData.getWhich());
                                            this.mSemService.mLegibilityColor.extractColor(peekWallpaperDataLocked2.mSemWallpaperData.getWhich(), true);
                                        }
                                        if (z8 || WhichChecker.isWatchFaceDisplay(i4)) {
                                            notifyCoverWallpaperChanged(peekWallpaperDataLocked2.mSemWallpaperData.getWpType(), i4);
                                            return;
                                        }
                                        return;
                                    }
    ...
    public final boolean isPreloadLiveWallpaperReApplied(ComponentName componentName, WallpaperData wallpaperData, Bundle bundle) {
        ...
        if (componentName2 != null && componentName.equals(componentName2) && (externalParams = wallpaperData.mSemWallpaperData.getExternalParams()) != null && bundle != null) {
            ...
            Log.m129d("WallpaperManagerService", "setWallpaperComponent preload settings : prev = " + json + ", new = " + json2);
    ...
    public final boolean bindWallpaperComponentLocked(ComponentName componentName, boolean z, boolean z2, WallpaperData wallpaperData, IRemoteCallback iRemoteCallback, WallpaperInfo wallpaperInfo) {
        ...
        try {
            ...
            PendingIntent activityAsUser = PendingIntent.getActivityAsUser(this.mContext, 0, Intent.createChooser(new Intent("android.intent.action.SET_WALLPAPER"), this.mContext.getText(R.string.config_retailDemoPackage)), 67108864, ActivityOptions.makeBasic().setPendingIntentCreatorBackgroundActivityStartMode(2).toBundle(), UserHandle.of(i));
            ...
            Log.m129d("WallpaperManagerService", "bindService request success. connect : " + wallpaperConnection);
            if (this.mIsLockscreenLiveWallpaperEnabled) {
    ...
    public final void putDefaultLiveWallpaperProperties(WallpaperData wallpaperData) {
        ...
        if (defaultLiveWallpaperExtras == null) {
            Log.m134w("WallpaperManagerService", "putDefaultLiveWallpaperProperties: default extra data is not present. which=" + which);
        ...
        try {
            ...
            for (int i2 = 0; i2 < list.size(); i2++) {
                ...
                if (serviceInfo2 != null && (serviceInfo2.name == null || serviceInfo2.packageName == null)) {
                    Log.m134w("WallpaperManagerService", "getWallpaperInfo: Invalid ServiceInfo, name = " + serviceInfo2.name + " , packageName = " + serviceInfo2.packageName);
                }
            }
            return null;
        } catch (RemoteException e3) {
    ...
    public final boolean rebindWallpaper(ComponentName componentName, WallpaperData wallpaperData) {
        ...
        Log.m129d("WallpaperManagerService", "Run binding timeout cause duplicated bind / unbind of image wallpaper");
        return true;
    }
    ...
    public boolean isWallpaperBackupEligible(int i, int i2) {
        ...
        Log.m129d("WallpaperManagerService", "isWallpaperBackupEligible: which = " + i + ", userId = " + i2 + ", wallpaper = " + peekWallpaperDataLocked);
        if (peekWallpaperDataLocked != null) {
    ...
    public WallpaperData getWallpaperSafeLocked(int i, int i2) {
        WallpaperData wallpaperData;
        Log.m129d("WallpaperManagerService", "getWallpaperSafeLocked, userId = " + i + ", which = " + i2 + ", caller = " + Debug.getCaller());
    ...
    public final void initializeFallbackWallpaper() {
        if (this.mFallbackWallpaper == null) {
            ...
            Log.m129d("WallpaperManagerService", "initializeFallbackWallpaper cropFileName : " + fileName2);
    ...
    public final void checkWallpaperData(int i, WallpaperData wallpaperData, int i2, int i3) {
        Log.m129d("WallpaperManagerService", "checkWallpaperData userId=" + i + ", wpType=" + i2 + ", wallpaperFile= " + wallpaperData.wallpaperFile);
    ...
    public boolean isDefaultWallpaperState(int i) {
        ...
        if (wpType != getDefaultWallpaperType(i)) {
            Log.m129d("WallpaperManagerService", "isDefaultWallpaperState false, currentType = " + wpType);
            return false;
        }
    ...
    public void setVideoWallpaper(String str, String str2, String str3, String str4, int i, int i2, boolean z, Bundle bundle) {
        ...
        checkPermission("android.permission.SET_WALLPAPER");
        if (this.mSemService.mKnox.isWallpaperChangeAllowed(true)) {
            Log.m129d("WallpaperManagerService", "setVideoWallpaper() videoFilePath = " + str + ", themePackage = " + str2 + ", userId = " + i + ", callingPackage = " + str4 + ", which = " + i2 + ", videoFileName = " + str3 + ", allowBackup = " + z + ", extras = " + bundle);
    ...
    public final void initCoverVideoWallpaper() {
        ...
        Log.m129d("WallpaperManagerService", "initCoverVideoWallpaper: fileName = " + defaultVideoWallpaperFileName);
    ...
    public final void initVideoWallpaper(int i, boolean z, boolean z2) {
        WallpaperData wallpaperSafeLocked;
        Log.m129d("WallpaperManagerService", "initVideoWallpaper: which = " + i + ", forceInit = " + z + ", updateSetting = " + z2);
        ...
        if (!wallpaperSafeLocked.mSemWallpaperData.getVideoDefaultHasBeenUsed() || z) {
            ...
            Log.m129d("WallpaperManagerService", "initVideoWallpaper: omcVideoFilePath = " + oMCVideoWallpaperFilePath + " , hasOMCVideoWallpaper = " + z3 + " , fileName = " + defaultVideoWallpaperFileName);
            if (z3) {
        ...
        synchronized (this.mLock) {
            ...
            if (this.mSemService.mOMCWallpaper.needToUpdateOMCWallpaper(wallpaperData.wallpaperFile)) {
                ...
                if (isDefaultComponent(wallpaperData)) {
                    Log.m132i("WallpaperManagerService", "handleOMCWallpaperUpdated: mCacheDefaultImageWallpaperColors = " + this.mCacheDefaultImageWallpaperColors);
    ...
    public void setKWPTypeLiveWallpaperWithMode(int i, int i2) {
        ...
        if (i2 == 0) {
            if (!this.mSemService.hasLockscreenWallpaper(WhichChecker.isSubDisplay(i))) {
                Log.m129d("WallpaperManagerService", "setKWPTypeLiveWallpaperWithMode: Setting value for transparent is already 0.");
                return;
            }
        } else if (i2 == 1) {
            if (this.mSemService.hasLockscreenWallpaper(WhichChecker.isSubDisplay(i))) {
                Log.m129d("WallpaperManagerService", "setKWPTypeLiveWallpaperWithMode: Setting value for transparent is already 1.");
                return;
            }
        } else {
    ...
    */
    public final void semSendWallpaperCommand(int i, String str, Bundle bundle, boolean z) {
        boolean z2;
        int i2 = 1;
        if (Rune.SUPPORT_PREVIEW_LOCK_ONLY_LIVE_WALLPAPER && WhichChecker.isLock(i) && !isSystemAndLockPaired(WhichChecker.getMode(i)) && hasPermission("android.permission.READ_WALLPAPER_INTERNAL")) {
            synchronized (this.mLock) {
                WallpaperData peekWallpaperDataLocked = peekWallpaperDataLocked(this.mCurrentUserId, i);
                z2 = peekWallpaperDataLocked != null && this.mLiveWallpaperHelper.isPreloadedLiveWallpaper(peekWallpaperDataLocked);
            }
            if (z2) {
                Log.m129d("WallpaperManagerService", "semSendWallpaperCommand: which=" + i + ", action=" + str);
                int modeEnsuredWhich = this.mSemService.getModeEnsuredWhich(i);
                ...
                this.mContext.sendBroadcastAsUser(intent, new UserHandle(this.mCurrentUserId), "android.permission.READ_WALLPAPER_INTERNAL");
                return;
            }
        }
        WallpaperData wallpaperData = this.mLastWallpaper;
    ...
    public final void notifySemColorListeners(WallpaperData wallpaperData, int i) {
        ...
        if (!Rune.DESKTOP_STANDALONE_MODE_WALLPAPER && this.mSemService.mDesktopMode.isDesktopSingleMode() && WhichChecker.isDex(which)) {
            Log.m129d("WallpaperManagerService", "ignore colors changed of dex wallpaper if standalone mode");
            return;
        }
        int i3 = this.mCurrentUserId;
        if (i3 > 0 && i2 != i3) {
    ...
    public void semClearWallpaperThumbnailCache(int i, int i2, String str) {
        ...
        Log.m129d("WallpaperManagerService", "semClearWallpaperThumbnailCache : which = " + i + ", callingPackage = " + str);
    ...
    public void semSetWallpaperColorOverrideAreas(int i, int i2, String str) {
        ...
        Log.m132i("WallpaperManagerService", "semSetWallpaperColorOverrideAreas : which=" + i + ", userId=" + i2 + ", len=" + str.length());
    ...
    public Rect semGetSmartCropRect(int i) {
        synchronized (this.mLock) {
            ...
            Log.m129d("WallpaperManagerService", "semgetSmartCropRect, " + i + ", " + peekWallpaperDataLocked.mSemWallpaperData.getSmartCropRect());
    ...
    public final boolean isSameRequest(int i, String str, WallpaperData wallpaperData) {
        ...
        Log.m129d("WallpaperManagerService", "isSameRequest: prevUriString = " + uri + ", uriString = " + str);
    ...
    public String semGetUri(int i, String str) {
        ...
        Log.m129d("WallpaperManagerService", "semGetUri: which = " + i + ", type = -1. Default type is not multiple!");
        return null;
    }
    ...
    public final String getDefaultMultiPackUri(int i) {
        ...
        if (TextUtils.isEmpty(defaultMultipackStyle) || !defaultMultipackStyle.contains("MULTIPLE")) {
            Log.m129d("WallpaperManagerService", "startMultipleWallpaper: defaultWallpaperStyle is empty or not MULTIPLE!");
            return null;
        }
    ...
    public final void initImageWallpaperCropFile(WallpaperData wallpaperData, int i) {
        if (wallpaperData == null) {
            Log.m134w("WallpaperManagerService", "initImageWallpaperCropFile: wallpaper data is not exist");
            return;
        }
    ...
    */
    public final void setDefaultWallpapers(int i) {
        ...
        boolean isDefaultOperatorWallpaper = WallpaperManager.isDefaultOperatorWallpaper(this.mContext, 5, this.mSemService.mCMFWallpaper.getDeviceColor());
        boolean isDefaultOperatorWallpaper2 = WallpaperManager.isDefaultOperatorWallpaper(this.mContext, 6, this.mSemService.mCMFWallpaper.getDeviceColor());
        Slog.d("WallpaperManagerService", "setDefaultWallpapers: isDefaultOperatorMainSystem = " + isDefaultOperatorWallpaper + ", isDefaultOperatorMainLock = " + isDefaultOperatorWallpaper2);
        ...
        if (wallpaperSafeLocked2.mSemWallpaperData.getWpType() == -1) {
            ...
            if (!isDefaultOperatorWallpaper2) {
                if (defaultWallpaperType == 8) {
                    ...
                    String lastCallingPackage = wallpaperSafeLocked2.mSemWallpaperData.getLastCallingPackage();
                    if (i > 0 && isDefaultMultipack(i, 6, lastCallingPackage)) {
                        wallpaperSafeLocked2.mSemWallpaperData.setUri(getDefaultMultiPackUri(6));
                        i2 = -1;
                        setUriInternal(wallpaperSafeLocked2, false, 6, 3, lastCallingPackage, i, wallpaperSafeLocked2.mSemWallpaperData.getExternalParams());
                    } else {
                        i2 = -1;
                        if (!isDefaultOperatorWallpaper && getDefaultWallpaperType(5) == 7) {
                    ...
                    if (Rune.SUPPORT_COVER_DISPLAY_WATCHFACE) {
                        if (isCoverVideoWallpaperDefault(17) && wallpaperData2 != null && wallpaperData2.mSemWallpaperData.getWpType() == i2) {
                            initCoverVideoWallpaper();
                            return;
                        }
                        return;
                    }
                    if (wallpaperData == null || wallpaperData.mSemWallpaperData.getWpType() != i2 || WallpaperManager.isDefaultOperatorWallpaper(this.mContext, 18, this.mSemService.mCMFWallpaper.getDeviceColor())) {
                        return;
                    }
                    ...
                    setUriInternal(wallpaperData, false, 18, 3, lastCallingPackage2, i, wallpaperData.mSemWallpaperData.getExternalParams());
                    return;
                }
            }
        }
    ...
    public final void resetSemWallpaperData(SemWallpaperData semWallpaperData, int i) {
        ...
        if (semWallpaperData.getCroppedBitmap() != null && !semWallpaperData.getCroppedBitmap().isRecycled()) {
            Log.m129d("WallpaperManagerService", "Wallpaper file is changed or deleted. Delete previous cropped bitmap");
    ...
    public final boolean isVisibleWhichWhenKeyguardLocked(int i) {
        ...
        if ((isPhone || isSubDisplay) && !this.mSemService.hasLockscreenWallpaper(isSubDisplay)) {
            Log.m129d("WallpaperManagerService", "isVisibleWhichWhenKeyguardLocked: No lockscreen wallpaper. SHOULD be visible on keyguard locked status.");
            return true;
        }
    ...
    public class SemCallback {
        ...
        public void updateDesktopModeState(boolean z) {
            ...
            if ((isDesktopDualMode && !z) || (WallpaperManagerService.this.mSemService.mDesktopMode.isDesktopDualMode() && z)) {
                Log.m132i("WallpaperManagerService", "Wallpaper ignore wallpaper refresh in default display when desktop dual mode is enabled/disabled");
            } else {
        ...
        public void switchWallpaperByDisplayChanged(int i, int i2) {
            ...
            WallpaperManagerService wallpaperManagerService = WallpaperManagerService.this;
            Log.m129d("WallpaperManagerService", "switchWallpaperByDisplayChanged   prevFolderState : " + i + " curFolderState : " + i2 + " which : " + folderStateBasedWhich2 + " oldwhich : " + folderStateBasedWhich + " mCurrentUserId : " + WallpaperManagerService.this.mCurrentUserId + " mOldUserId : " + WallpaperManagerService.this.mSemService.getOldUserId() + " userId : " + wallpaperManagerService.getConvertedUserId(wallpaperManagerService.mCurrentUserId, WallpaperManagerService.this.mSemService.getOldUserId()));
        ...
        */
        public SemWallpaperColors calcSemWallpaperColors(int i, int i2) {
            ...
            synchronized (WallpaperManagerService.this.mLock) {
                WallpaperManagerService wallpaperManagerService = WallpaperManagerService.this;
                peekWallpaperDataLocked = wallpaperManagerService.peekWallpaperDataLocked(wallpaperManagerService.getCurrentUserId(), i);
            }
            if (peekWallpaperDataLocked == null) {
            ...
            if (i != peekWallpaperDataLocked.mSemWallpaperData.getWhich()) {
                Log.addLogString("WallpaperManagerService", "calcSemWallpaperColors:" + i + ", " + peekWallpaperDataLocked.mSemWallpaperData.getWhich());
                i = peekWallpaperDataLocked.mSemWallpaperData.getWhich();
            }
            int liveWallpaperThumbnailTarget = getLiveWallpaperThumbnailTarget(i);
            Log.m132i("WallpaperManagerService", "calcSemWallpaperColors targetWhich = " + liveWallpaperThumbnailTarget);
            if (liveWallpaperThumbnailTarget != -1) {
                try {
                    synchronized (WallpaperManagerService.this.mLock) {
                        WallpaperManagerService wallpaperManagerService2 = WallpaperManagerService.this;
                        peekWallpaperDataLocked2 = wallpaperManagerService2.peekWallpaperDataLocked(wallpaperManagerService2.getCurrentUserId(), liveWallpaperThumbnailTarget);
                    }
                } catch (Exception e) {
                    e = e;
                    Bitmap bitmap3 = null;
                }
                if (WallpaperManagerService.this.mLiveWallpaperHelper.isPreloadedLiveWallpaper(peekWallpaperDataLocked2)) {
                    if (i2 != 90 && i2 != 270) {
                        r4 = 1;
                    }
                    File thumbnailFile = WallpaperManagerService.this.mLiveWallpaperHelper.getThumbnailFile(liveWallpaperThumbnailTarget, peekWallpaperDataLocked2.userId, r4);
                    if (thumbnailFile != null && thumbnailFile.exists()) {
                        bitmap = BitmapFactory.decodeFile(thumbnailFile.getAbsolutePath());
                        WallpaperManagerService wallpaperManagerService3 = WallpaperManagerService.this;
                        wallpaperInfoWithFlags = wallpaperManagerService3.getWallpaperInfoWithFlags(liveWallpaperThumbnailTarget, wallpaperManagerService3.mCurrentUserId);
                        if (wallpaperInfoWithFlags != null && bitmap == null && (bitmapDrawable = (BitmapDrawable) wallpaperInfoWithFlags.loadThumbnail(WallpaperManagerService.this.mContext.getPackageManager())) != null) {
                            bitmap = bitmapDrawable.getBitmap();
                        }
                        Log.m129d("WallpaperManagerService", "calcSemWallpaperColors - live case drawable: " + bitmap);
                        if (bitmap != null) {
                            return SemWallpaperColors.fromBitmap(WallpaperManagerService.this.mContext, bitmap, i, i2, (Rect[]) null);
                        }
                ...
                wallpaperInfoWithFlags = wallpaperManagerService32.getWallpaperInfoWithFlags(liveWallpaperThumbnailTarget, wallpaperManagerService32.mCurrentUserId);
                ...
                synchronized (WallpaperManagerService.this.mLock) {
                    if (semWallpaperData.getCroppedBitmap() == null || semWallpaperData.getCroppedBitmap().isRecycled()) {
                        ...
                        WallpaperManagerService.this.mSemService.generateResizedBitmap(peekWallpaperDataLocked.cropFile, semWallpaperData);
                    }
                    if (semWallpaperData.getCroppedBitmap() != null && !semWallpaperData.getCroppedBitmap().isRecycled()) {
                        bitmap2 = semWallpaperData.getCroppedBitmap().copy(semWallpaperData.getCroppedBitmap().getConfig(), true);
                    } else {
                        Log.addLogString("WallpaperManagerService", "wallpaper.croppedBitmap == null or recycled");
                        bitmap2 = null;
                    }
                }
                if (bitmap2 != null) {
                    ...
                    if (i2 != 0 && !semWallpaperData.getIsPreloaded()) {
                        bitmap2 = WallpaperManagerService.this.mSemService.mLegibilityColor.smartCropBitmap(bitmap2, semWallpaperData, i2);
                    }
                    if (Rune.isTablet() && semWallpaperData.getIsPreloaded()) {
                        if (WallpaperManagerService.this.mSemService.getOrientation() != (i2 == 0 ? 1 : 2)) {
                            bitmap2 = WallpaperManagerService.this.mSemService.getPreloadRotatedCroppedBitmap(peekWallpaperDataLocked.cropFile, semWallpaperData);
                        }
                    }
                    if (bitmap2 == null) {
                        return null;
                    ...
                    try {
                        return SemWallpaperColors.fromBitmap(WallpaperManagerService.this.mContext, bitmap2, i, i2, (Rect[]) null);
                    } catch (Exception e2) {
                        Log.addLogString("WallpaperManagerService", "exception " + e2 + ", which = " + i + ", smart crop info = " + semWallpaperData.getSmartCropOriginalRect() + ", " + semWallpaperData.getSmartCropRect());
                        return null;
                    }
                }
        ...
        public void saveSemWallpaperColors(int i, boolean z, SemWallpaperColors[] semWallpaperColorsArr) {
            synchronized (WallpaperManagerService.this.mLock) {
                ...
                if (z) {
                    ...
                    Log.m129d("WallpaperManagerService", "saveSemWallpaperColors " + i + ", " + wallpaperColorPath);
        ...
        public void dispatchHomeVisibilityChanged(boolean z) {
            ...
            synchronized (WallpaperManagerService.this.mLock) {
                ...
                if (peekWallpaperDataLocked != null) {
                    ...
                    Log.m129d("WallpaperManagerService", "dispatchHomeVisibilityChanged: visible = " + z + ", connection = " + peekWallpaperDataLocked.connection + ", systemWallpaper = " + peekWallpaperDataLocked);
    ...
    public void requestNotifyCoverWallpaperChanged(int i, int i2, Bundle bundle) {
        WallpaperData peekWallpaperDataLocked;
        Log.m130e("WallpaperManagerService", "requestNotifyCoverWallpaperChanged: userId = " + i + ", which = " + i2);
    ...
    public void requestNotifyMultipackApplied(int i, int i2, Bundle bundle) {
        int mode = WhichChecker.getMode(i2) | 2;
        Log.m129d("WallpaperManagerService", "requestNotifyMultipackApplied: which = " + i2 + "adjustedWhich = " + mode);
