...
public final class CurrentUserServiceSupplier extends BroadcastReceiver
  ...
  public static final Comparator sBoundServiceInfoComparator = new Comparator() { // from class:
        // com.android.server.servicewatcher.CurrentUserServiceSupplier$$ExternalSyntheticLambda0
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
          int lambda$static$0;
          lambda$static$0 =
              CurrentUserServiceSupplier.lambda$static$0(
                  (CurrentUserServiceSupplier.BoundServiceInfo) obj,
                  (CurrentUserServiceSupplier.BoundServiceInfo) obj2);
  ...
  public static /* synthetic */ int lambda$static$0(
      BoundServiceInfo boundServiceInfo, BoundServiceInfo boundServiceInfo2) {
  ...
  public class BoundServiceInfo extends ServiceWatcher.BoundServiceInfo {
    ...
    public static int parseUid(ResolveInfo resolveInfo) {
      ...
      return (bundle == null || !bundle.getBoolean("serviceIsMultiuser", false))
          ? i
          : UserHandle.getUid(0, UserHandle.getAppId(i));
    }
    ...
    public BoundServiceInfo(String str, ResolveInfo resolveInfo) {
      this(
          ...
          resolveInfo.serviceInfo.metaData);
    }
  ...
  public static CurrentUserServiceSupplier create(
  ...
  public static CurrentUserServiceSupplier createUnsafeForTestsOnly(
      Context context, String str, String str2, String str3, String str4) {
  ...
  public boolean hasMatchingService() {
    return !this.mContext
        .getPackageManager()
        .queryIntentServicesAsUser(this.mIntent, this.mMatchSystemAppsOnly ? 1835008 : 786432, 0)
        .isEmpty();
  }
  ...
  public void register(ServiceWatcher.ServiceChangedListener serviceChangedListener) {
    ...
    this.mContext.registerReceiverAsUser(
        this, UserHandle.ALL, intentFilter, null, FgThread.getHandler());
  }
  ...
  public BoundServiceInfo getServiceInfo() {
    ...
    for (ResolveInfo resolveInfo :
      ...
      if (str == null || str.equals(serviceInfo.permission)) {
        ...
        if (str2 != null
            && PermissionManager.checkPackageNamePermission(
                    str2, serviceInfo.packageName, boundServiceInfo2.getUserId())
                != 0) {
          Log.d(
              "CurrentUserServiceSupplier",
              boundServiceInfo2.getComponentName().flattenToShortString()
                  + " disqualified due to not holding "
                  + this.mCallerPermission);
        ...
        Log.d(
            ...
            serviceInfo.getComponentName().flattenToShortString()
                + " disqualified due to not requiring "
                + this.mCallerPermission);
      }
    }
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    if (action == null
        || (intExtra = intent.getIntExtra("android.intent.extra.user_handle", -10000)) == -10000
        || (serviceChangedListener = this.mListener) == null) {
      return;
    }
