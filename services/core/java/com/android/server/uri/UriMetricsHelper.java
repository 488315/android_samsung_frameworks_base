...
public final class UriMetricsHelper {
  ...
  public UriMetricsHelper(
      Context context, PersistentUriGrantsProvider persistentUriGrantsProvider) {
    ...
    ((StatsManager) this.mContext.getSystemService(StatsManager.class))
        .setPullAtomCallback(
            ...
            new StatsManager.StatsPullAtomCallback() { // from class:
              // com.android.server.uri.UriMetricsHelper$$ExternalSyntheticLambda0
  ...
  public final void reportPersistentUriPermissionsPerPackage(List list) {
    ArrayList providePersistentUriGrants =
        this.mPersistentUriGrantsProvider.providePersistentUriGrants();
    ...
    for (int i3 = 0; i3 < size2; i3++) {
      list.add(
          FrameworkStatsLog.buildStatsEvent(
              ...
              ((Integer) sparseArray.valueAt(i3)).intValue()));
    }
  }
}
