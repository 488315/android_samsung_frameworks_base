...
public class AlarmManagerEconomicPolicy extends EconomicPolicy {
  ...
  public AlarmManagerEconomicPolicy(
  ...
  public void setup(DeviceConfig.Properties properties) {
    ...
    loadConstants(
        this.mInjector.getSettingsGlobalString(
            this.mIrs.getContext().getContentResolver(), "tare_alarm_manager_constants"),
        properties);
  }
  ...
  public final void loadConstants(String str, DeviceConfig.Properties properties) {
    ...
    this.mActions.put(
        ...
        new EconomicPolicy.Action(
            ...
            getConstantAsCake(
                ...
                EconomyManager.DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_EXACT_WAKEUP_CTP_CAKES),
            getConstantAsCake(
                this.mParser,
                properties,
    ...
    this.mActions.put(
        ...
        new EconomicPolicy.Action(
            ...
            getConstantAsCake(
                ...
                EconomyManager.DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_WAKEUP_CTP_CAKES),
            getConstantAsCake(
                this.mParser,
                properties,
    ...
    this.mActions.put(
        ...
        new EconomicPolicy.Action(
            ...
            getConstantAsCake(
                ...
                EconomyManager.DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_EXACT_NONWAKEUP_CTP_CAKES),
            getConstantAsCake(
                this.mParser,
                properties,
    ...
    this.mActions.put(
        ...
        new EconomicPolicy.Action(
            ...
            getConstantAsCake(
                ...
                EconomyManager.DEFAULT_AM_ACTION_ALARM_EXACT_NONWAKEUP_BASE_PRICE_CAKES),
            false));
    long constantAsCake5 =
        getConstantAsCake(
            this.mParser,
            properties,
    ...
    this.mRewards.put(
        ...
        new EconomicPolicy.Reward(
            ...
            getConstantAsCake(
                this.mParser, properties, "am_reward_top_activity_ongoing", 10000000L),
            getConstantAsCake(
                this.mParser,
                properties,
