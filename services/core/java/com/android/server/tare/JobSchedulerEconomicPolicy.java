...
public class JobSchedulerEconomicPolicy extends EconomicPolicy {
  ...
  public JobSchedulerEconomicPolicy(
      InternalResourceService internalResourceService, EconomicPolicy.Injector injector) {
  ...
  public void setup(DeviceConfig.Properties properties) {
    ...
    loadConstants(
        this.mInjector.getSettingsGlobalString(
            this.mIrs.getContext().getContentResolver(), "tare_job_scheduler_constants"),
        properties);
  }
  ...
  public long getMinSatiatedBalance(int i, String str) {
    ...
    return Math.min(
        j
            + (this.mIrs.getAppUpdateResponsibilityCount(i, str)
                * this.mMinSatiatedBalanceIncrementalAppUpdater),
        this.mMaxSatiatedBalance);
  }
  ...
  public long getMaxSatiatedBalance(int i, String str) {
    ...
    if (installedPackageInfo == null) {
      Slog.wtfStack(
          TAG, "Tried to get max balance of invalid app: " + TareUtils.appToString(i, str));
  ...
  public final void loadConstants(String str, DeviceConfig.Properties properties) {
    ...
    this.mMinSatiatedBalanceExempted =
        getConstantAsCake(
            this.mParser,
            properties,
    ...
    this.mRewards.put(
        ...
        new EconomicPolicy.Reward(
            ...
            getConstantAsCake(
                this.mParser, properties, "js_reward_top_activity_ongoing", 500000000L),
            getConstantAsCake(
                this.mParser,
                properties,
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter
        .print("Exempted", TareUtils.cakeToString(this.mMinSatiatedBalanceExempted))
        .println();
    indentingPrintWriter
        .print("Other", TareUtils.cakeToString(this.mMinSatiatedBalanceOther))
        .println();
    indentingPrintWriter
        .print(
            "+App Updater", TareUtils.cakeToString(this.mMinSatiatedBalanceIncrementalAppUpdater))
        .println();
    indentingPrintWriter.decreaseIndent();
    indentingPrintWriter
        .print("Max satiated balance", TareUtils.cakeToString(this.mMaxSatiatedBalance))
        .println();
    ...
    for (int i = 0; i < this.mActions.size(); i++) {
      EconomicPolicy.dumpAction(
          indentingPrintWriter, (EconomicPolicy.Action) this.mActions.valueAt(i));
    }
    indentingPrintWriter.decreaseIndent();
    indentingPrintWriter.println();
    ...
    for (int i2 = 0; i2 < this.mRewards.size(); i2++) {
      EconomicPolicy.dumpReward(
          indentingPrintWriter, (EconomicPolicy.Reward) this.mRewards.valueAt(i2));
    }
    indentingPrintWriter.decreaseIndent();
  }
}
