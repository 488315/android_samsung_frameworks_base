...
public class InstalledPackageInfo {
  ...
  public InstalledPackageInfo(Context context, int i, PackageInfo packageInfo) {
            ...
            && ArrayUtils.isEmpty(
                context
                    ...
                    .queryIntentActivitiesAsUser(
                        ...
                        786944,
                        i));
    this.isSystemInstaller =
        applicationInfo != null
            && ArrayUtils.indexOf(
                    packageInfo.requestedPermissions, "android.permission.INSTALL_PACKAGES")
                >= 0
            && PermissionChecker.checkPermissionForPreflight(
                    context, "android.permission.INSTALL_PACKAGES", -1, applicationInfo.uid, str)
                == 0;
    try {
    ...
    this.installerPackageName =
        installSourceInfo != null ? installSourceInfo.getInstallingPackageName() : null;
  }
