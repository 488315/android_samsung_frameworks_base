...
public abstract class EconomicPolicy {
  ...
  public long getConstantAsCake(
    ...
    if (keyValueListParser.size() > 0) {
      return Math.max(
          j2, EconomyManager.parseCreditValue(keyValueListParser.getString(str, (String) null), j));
    }
    if (properties != null) {
      return Math.max(
          j2, EconomyManager.parseCreditValue(properties.getString(str, (String) null), j));
    }
  ...
  public static void dumpAction(IndentingPrintWriter indentingPrintWriter, Action action) {
    indentingPrintWriter.print(actionToString(action.f1726id));
  ...
  public static void dumpReward(IndentingPrintWriter indentingPrintWriter, Reward reward) {
    indentingPrintWriter.print(rewardToString(reward.f1727id));
    indentingPrintWriter.print(": ");
