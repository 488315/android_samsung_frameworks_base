...
public class CompleteEconomicPolicy extends EconomicPolicy {
  ...
  public CompleteEconomicPolicy(
      InternalResourceService internalResourceService, CompleteInjector completeInjector) {
  ...
  public void setup(DeviceConfig.Properties properties) {
    ...
    for (int i = 0; i < this.mEnabledEconomicPolicies.size(); i++) {
      for (int i2 :
          ((EconomicPolicy) this.mEnabledEconomicPolicies.valueAt(i)).getCostModifiers()) {
  ...
  public long getMinSatiatedBalance(int i, String str) {
    ...
    for (int i2 = 0; i2 < this.mEnabledEconomicPolicies.size(); i2++) {
      j +=
          ((EconomicPolicy) this.mEnabledEconomicPolicies.valueAt(i2))
              .getMinSatiatedBalance(i, str);
    }
    return j;
  }
  ...
  public EconomicPolicy.Action getAction(int i) {
    ...
    boolean z = false;
    for (int i2 = 0; i2 < this.mEnabledEconomicPolicies.size(); i2++) {
      EconomicPolicy.Action action =
          ((EconomicPolicy) this.mEnabledEconomicPolicies.valueAt(i2)).getAction(i);
      if (action != null) {
  ...
  public EconomicPolicy.Reward getReward(int i) {
    ...
    boolean z = false;
    for (int i2 = 0; i2 < this.mEnabledEconomicPolicies.size(); i2++) {
      EconomicPolicy.Reward reward =
          ((EconomicPolicy) this.mEnabledEconomicPolicies.valueAt(i2)).getReward(i);
      if (reward != null) {
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    for (int i3 = 0; i3 < this.mEnabledEconomicPolicies.size(); i3++) {
      ...
      indentingPrintWriter.println(
          economicPolicy.getClass().getSimpleName() + XmlUtils.STRING_ARRAY_SEPARATOR);
      indentingPrintWriter.increaseIndent();
