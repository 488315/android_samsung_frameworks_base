...
public interface EconomyManagerInternal {
  ...
  void registerAffordabilityChangeListener(
      int i,
      String str,
      AffordabilityChangeListener affordabilityChangeListener,
      ActionBill actionBill);

  void registerTareStateChangeListener(TareStateChangeListener tareStateChangeListener, int i);

  void unregisterAffordabilityChangeListener(
      int i,
      String str,
      AffordabilityChangeListener affordabilityChangeListener,
      ActionBill actionBill);
  ...
  public final class AnticipatedAction {
    ...
    public boolean equals(Object obj) {
      ...
      return this.actionId == anticipatedAction.actionId
          && this.numInstantaneousCalls == anticipatedAction.numInstantaneousCalls
          && this.ongoingDurationMs == anticipatedAction.ongoingDurationMs;
    }
  ...
  public final class ActionBill {
    public static final Comparator sAnticipatedActionComparator =
        Comparator.comparingInt(
            new ToIntFunction() { // from class:
                                  // com.android.server.tare.EconomyManagerInternal$ActionBill$$ExternalSyntheticLambda0
