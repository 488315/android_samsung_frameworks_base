...
public final class FontManagerService extends IFontManager.Stub {
  ...
  public final class Lifecycle extends SystemService {
    ...
    public void onStart() {
      LocalServices.addService(
          FontManagerInternal.class,
          new FontManagerInternal() { // from class:
                                      // com.android.server.graphics.fonts.FontManagerService.Lifecycle.1
  ...
  public final UpdatableFontDir createUpdatableFontDir() {
    ...
    String[] stringArray =
        this.mContext.getResources().getStringArray(R.array.no_ems_support_sim_operators);
        ...
        SharedMemory serializeFontMap =
            Typeface.serializeFontMap(
                SystemFonts.buildSystemTypefaces(
                    fontConfig, SystemFonts.buildSystemFallback(fontConfig, arrayMap)));
