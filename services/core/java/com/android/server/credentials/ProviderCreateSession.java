...
public final class ProviderCreateSession extends ProviderSession {
    ...
    public final void invokeSession() {
        ...
        if (remoteCredentialService != null) {
            ...
            remoteCredentialService.onBeginCreateCredential(
    ...
    public final void onCreateEntrySelected(
        ...
        if (providerPendingIntentResponse == null) {
            ...
            createCredentialException =
                    providerPendingIntentResponse.getResultCode() == 0
                            ? new CreateCredentialException(
        ...
        if (createCredentialException != null) {
            providerInternalCallback.onFinalErrorReceived(
                    createCredentialException.getType(), createCredentialException.getMessage());
            return;
        }
        ...
        CreateCredentialResponse createCredentialResponse =
                resultData2 == null
                        ...
                        : (CreateCredentialResponse)
                                resultData2.getParcelableExtra(
        ...
        if (createCredentialResponse != null) {
            providerInternalCallback.onFinalResponseReceived(
                    this.mComponentName, createCredentialResponse);
        } else {
            Slog.i(
                    "CredentialManager",
                    "onSaveEntrySelected - no response or error found in pending intent response");
            providerInternalCallback.onFinalErrorReceived(
                    "android.credentials.CreateCredentialException.TYPE_UNKNOWN", null);
        }
    }
    ...
    public final void onProviderResponseFailure(Exception exc) {
        ...
        if (z) {
            providerSessionMetric.collectCandidateFrameworkException(
                    ((CreateCredentialException) exc).getType());
        }
    ...
    public final void onProviderResponseSuccess(Object obj) {
        BeginCreateCredentialResponse beginCreateCredentialResponse =
                (BeginCreateCredentialResponse) obj;
        Slog.i(
                "CredentialManager",
        ...
        createEntries.forEach(
                new Consumer() { // from class:
                    ...
                    public final void accept(Object obj2) {
                        ProviderCreateSession.ProviderResponseDataHandler
                                providerResponseDataHandler2 =
                                        ProviderCreateSession.ProviderResponseDataHandler.this;
                        ...
                        intent.putExtra(
                                ...
                                providerCreateSession.mCompleteRequest);
                        Entry entry = new Entry("save_entry_key", generateUniqueId, slice, intent);
                        ((HashMap) providerResponseDataHandler2.mUiCreateEntries)
                                .put(generateUniqueId, new Pair(createEntry, entry));
                    }
                });
        ...
        ProviderSessionMetric providerSessionMetric = this.mProviderSessionMetric;
        if ((createEntries2 == null || beginCreateCredentialResponse.getCreateEntries().isEmpty())
                && beginCreateCredentialResponse.getRemoteCreateEntry() == null) {
            providerSessionMetric.collectCandidateEntryMetrics(
                    beginCreateCredentialResponse,
                    false,
                    ((RequestSession) obj2).mRequestSessionMetric.mInitialPhaseMetric);
            ...
            providerSessionMetric.collectCandidateEntryMetrics(
                    ...
                    ((RequestSession) obj2).mRequestSessionMetric.mInitialPhaseMetric);
            updateStatusAndInvokeCallback(
                    ProviderSession.Status.SAVE_ENTRIES_RECEIVED, credentialsSource);
        }
    }
    ...
    public final void onUiEntrySelected(
        ...
        if (str.equals("save_entry_key")) {
            if ((((HashMap) providerResponseDataHandler.mUiCreateEntries).get(str2) == null
                            ? null
                            : (CreateEntry)
                                    ((Pair)
                                                    ((HashMap)
        ...
        if (((pair == null
                                || (obj = pair.first) == null
                                || !((String) obj).equals(str2)
                                || (obj2 = providerResponseDataHandler.mUiRemoteEntry.second)
                                        == null)
                        ? null
                        : (RemoteEntry) ((Pair) obj2).first)
                != null) {
            onCreateEntrySelected(providerPendingIntentResponse);
        } else {
    ...
    public final ProviderData prepareUiData() {
        ...
        ProviderResponseDataHandler providerResponseDataHandler = this.mProviderResponseDataHandler;
        if (((HashMap) providerResponseDataHandler.mUiCreateEntries).isEmpty()
                && providerResponseDataHandler.mUiRemoteEntry == null) {
            return null;
        }
        CreateCredentialProviderData.Builder builder =
                new CreateCredentialProviderData.Builder(
        ...
        while (it.hasNext()) {
            arrayList.add(
                    (Entry)
                            ((Pair)
                                            ((HashMap) providerResponseDataHandler.mUiCreateEntries)
                                                    .get((String) it.next()))
                                    .second);
        }
