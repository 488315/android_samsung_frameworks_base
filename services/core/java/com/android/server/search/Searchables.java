    ...
    */
    public void updateSearchableList() {
        ...
        try {
            ...
            List queryIntentActivities2 = queryIntentActivities(new Intent("android.intent.action.WEB_SEARCH"), 268435584);
            List queryIntentActivities3 = queryIntentActivities(new Intent("android.intent.action.INSIGHT_SEARCH"), 128);
            List queryIntentActivities4 = queryIntentActivities(new Intent("com.samsung.android.intent.action.SEARCH"), 128);
            if (queryIntentActivities == null && queryIntentActivities2 == null && queryIntentActivities3 == null && queryIntentActivities4 == null) {
            ...
            while (i3 < size4) {
                if (i3 < size) {
                    ...
                    list = queryIntentActivities;
                    resolveInfo = (ResolveInfo) (i3 < i2 ? queryIntentActivities3.get((i3 - size) - size2) : queryIntentActivities4.get(((i3 - size) - size2) - size3));
                }
            ...
            ComponentName findGlobalSearchActivity2 = findGlobalSearchActivity(findGlobalSearchActivities2);
