...
public final class TracingServiceProxy extends SystemService {
    ...
    public TracingServiceProxy(Context context) {
        ...
        this.mTracingServiceProxy =
                new ITracingServiceProxy
                        .Stub() { // from class: com.android.server.tracing.TracingServiceProxy.1
                    public final void notifyTraceSessionEnded(boolean z) {
                        ...
                        try {
                            intent.setClassName(
                                    tracingServiceProxy.mPackageManager.getPackageInfo(
                                                    "com.android.traceur", 1048576)
                                            .packageName,
                                    "com.android.traceur.StopTraceService");
                            if (z) {
                            ...
                            try {
                                try {
                                    tracingServiceProxy.mContext.startForegroundServiceAsUser(
                                            intent, UserHandle.SYSTEM);
                                } catch (RuntimeException e) {
                                    Log.e(
                                            "TracingServiceProxy",
                                            "Failed to notifyTraceSessionEnded",
                                            e);
                                }
                            } finally {
                    ...
                    public final void reportTrace(final TraceReportParams traceReportParams) {
                        ...
                        FrameworkStatsLog.write(
                                FrameworkStatsLog.TRACING_SERVICE_REPORT_EVENT,
                                1,
                                traceReportParams.uuidLsb,
                                traceReportParams.uuidMsb);
                        ComponentName componentName =
                                new ComponentName(
                                        traceReportParams.reporterPackageName,
                                        traceReportParams.reporterClassName);
                        try {
                            serviceInfo =
                                    tracingServiceProxy.mPackageManager.getServiceInfo(
                                            componentName, 0);
                        } catch (PackageManager.NameNotFoundException unused) {
                            Slog.e(
                                    "TracingServiceProxy",
                                    "Trace reporting service "
                                            + componentName.toShortString()
                                            + " does not exist");
                        }
                        if (!"android.permission.BIND_TRACE_REPORT_SERVICE"
                                .equals(serviceInfo.permission)) {
                            StringBuilder sb = new StringBuilder("Trace reporting service ");
                            sb.append(componentName.toShortString());
                            sb.append(
                                    " does not request android.permission.BIND_TRACE_REPORT_SERVICE"
                                        + " permission; instead requests ");
                            BinaryTransparencyService$$ExternalSyntheticOutline0.m$1(
                                    sb, serviceInfo.permission, "TracingServiceProxy");
                            FrameworkStatsLog.write(
                                    FrameworkStatsLog.TRACING_SERVICE_REPORT_EVENT,
                                    3,
                                    traceReportParams.uuidLsb,
                        ...
                        boolean hasPermission =
                                tracingServiceProxy.hasPermission(
                                        componentName, "android.permission.DUMP");
                        boolean hasPermission2 =
                                tracingServiceProxy.hasPermission(
                                        componentName, "android.permission.PACKAGE_USAGE_STATS");
                        ...
                        try {
                            tracingServiceProxy
                                    .getOrCreateReporterService(componentName)
                                    .post(
                                            new ServiceConnector.VoidJob() { // from class:
                                                // com.android.server.tracing.TracingServiceProxy$$ExternalSyntheticLambda1
                                                public final void runNoResult(Object obj) {
                                                    TraceReportParams traceReportParams2 =
                                                            traceReportParams;
                                                    ...
                                                    FrameworkStatsLog.write(
                                                            ...
                                                            2,
                                                            traceReportParams2.uuidLsb,
                                                            traceReportParams2.uuidMsb);
                                                }
                                            })
                                    .whenComplete(
                                            new BiConsumer() { // from class:
                                                // com.android.server.tracing.TracingServiceProxy$$ExternalSyntheticLambda2
    ...
    public final ServiceConnector getOrCreateReporterService(ComponentName componentName) {
        ServiceConnector serviceConnector =
                (ServiceConnector) this.mCachedReporterServices.get(componentName);
        ...
        ServiceConnector.Impl impl =
                new ServiceConnector.Impl(
                        ...
                        new TracingServiceProxy$$ExternalSyntheticLambda0()) { // from class:
                                                                               // com.android.server.tracing.TracingServiceProxy.2
