...
public class TracingServiceProxy extends SystemService {
  ...
  public final void notifyTraceur(boolean z) {
    ...
    try {
      intent.setClassName(
          this.mPackageManager.getPackageInfo("com.android.traceur", 1048576).packageName,
  ...
  public final void reportTrace(TraceReportParams traceReportParams) {
    ...
    ComponentName componentName =
        new ComponentName(
            traceReportParams.reporterPackageName, traceReportParams.reporterClassName);
  ...
  public final void reportTrace(
      ServiceConnector serviceConnector, final TraceReportParams traceReportParams) {
    serviceConnector
        .post(
            new ServiceConnector
                .VoidJob() { // from class:
                             // com.android.server.tracing.TracingServiceProxy$$ExternalSyntheticLambda0
        ...
        .whenComplete(
            new BiConsumer() { // from class:
              ...
              public final void accept(Object obj, Object obj2) {
                TracingServiceProxy.lambda$reportTrace$1(
                    traceReportParams, (Void) obj, (Throwable) obj2);
              }
            });
  }

  public static /* synthetic */ void lambda$reportTrace$0(
      TraceReportParams traceReportParams, IMessenger iMessenger) {
    if (traceReportParams.usePipeForTesting) {
      ParcelFileDescriptor[] createPipe = ParcelFileDescriptor.createPipe();
      ParcelFileDescriptor.AutoCloseInputStream autoCloseInputStream =
          new ParcelFileDescriptor.AutoCloseInputStream(traceReportParams.fd);
      try {
  ...
  public static /* synthetic */ void lambda$reportTrace$1(
      TraceReportParams traceReportParams, Void r7, Throwable th) {
    if (th != null) {
      FrameworkStatsLog.write(
          FrameworkStatsLog.TRACING_SERVICE_REPORT_EVENT,
          5,
  ...
  public final boolean hasBindServicePermission(ComponentName componentName) {
    try {
      ...
      Slog.e(
          ...
          "Trace reporting service "
              + componentName.toShortString()
              + " does not request android.permission.BIND_TRACE_REPORT_SERVICE permission; instead"
              + " requests "
