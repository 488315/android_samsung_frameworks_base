...
public class CachedDeviceStateService extends SystemService {
  ...
  public CachedDeviceStateService(Context context) {
    ...
    this.mBroadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.CachedDeviceStateService.1
  ...
  public final boolean queryIsCharging() {
    ...
    Slog.wtf(
        "CachedDeviceStateService", "BatteryManager null while starting CachedDeviceStateService");
    return true;
  }
  ...
  public final boolean queryScreenInteractive(Context context) {
    ...
    if (powerManager == null) {
      Slog.wtf(
          "CachedDeviceStateService", "PowerManager null while starting CachedDeviceStateService");
      return false;
    }
