...
public final class CachedDeviceStateService extends SystemService {
    ...
    public CachedDeviceStateService(Context context) {
        ...
        this.mBroadcastReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.android.server.CachedDeviceStateService.1
                    ...
                    public final void onReceive(Context context2, Intent intent) {
                        ...
                        switch (action) {
                            case "android.intent.action.SCREEN_OFF":
                                CachedDeviceStateService.this.mDeviceState.setScreenInteractive(
                                        false);
                                break;
                            case "android.intent.action.BATTERY_CHANGED":
                                CachedDeviceStateService.this.mDeviceState.setCharging(
        ...
        if (500 == i) {
            ...
            if (batteryManagerInternal == null) {
                Slog.wtf(
                        ...
                        "BatteryManager null while starting CachedDeviceStateService");
            ...
            PowerManager powerManager =
                    (PowerManager) getContext().getSystemService(PowerManager.class);
            if (powerManager == null) {
                Slog.wtf(
                        "CachedDeviceStateService",
                        "PowerManager null while starting CachedDeviceStateService");
            } else {
    ...
    public final void onStart() {
        publishLocalService(
                CachedDeviceState.Readonly.class, this.mDeviceState.getReadonlyClient());
    }
}
