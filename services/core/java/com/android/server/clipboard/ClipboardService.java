...
public class ClipboardService extends SystemService {
  ...
  public ClipboardService(Context context) {
    ...
    VirtualDeviceManagerInternal virtualDeviceManagerInternal =
        (VirtualDeviceManagerInternal) LocalServices.getService(VirtualDeviceManagerInternal.class);
    this.mVdmInternal = virtualDeviceManagerInternal;
    this.mVdm =
        virtualDeviceManagerInternal != null
    ...
    context
        ...
        .registerContentObserver(
            ...
            true,
            ClipboardPolicyObserver.getInstance(this.mContext),
            -1);
    this.mContext
        .getContentResolver()
        .registerContentObserver(
    ...
    if (IS_EMULATOR) {
      this.mEmulatorClipboardMonitor =
          new EmulatorClipboardMonitor(
              new Consumer() { // from class:
                               // com.android.server.clipboard.ClipboardService$$ExternalSyntheticLambda0
      ...
      this.mEmulatorClipboardMonitor =
          new Consumer() { // from class:
                           // com.android.server.clipboard.ClipboardService$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    DeviceConfig.addOnPropertiesChangedListener(
        ...
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.clipboard.ClipboardService$$ExternalSyntheticLambda2
  ...
  public final void registerVirtualDeviceRemovedListener() {
    ...
    this.mVirtualDeviceRemovedReceiver =
        new BroadcastReceiver() { // from class: com.android.server.clipboard.ClipboardService.1
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context, Intent intent) {
            if (intent
                .getAction()
                .equals("android.companion.virtual.action.VIRTUAL_DEVICE_REMOVED")) {
              int intExtra =
                  intent.getIntExtra("android.companion.virtual.extra.VIRTUAL_DEVICE_ID", -1);
              synchronized (ClipboardService.this.mLock) {
                for (int numMaps = ClipboardService.this.mClipboards.numMaps() - 1;
                    numMaps >= 0;
                    numMaps--) {
                  ClipboardService.this.mClipboards.delete(
                      ClipboardService.this.mClipboards.keyAt(numMaps), Integer.valueOf(intExtra));
                }
              }
            }
          }
  ...
  public final void updateConfig() {
    synchronized (this.mLock) {
      this.mShowAccessNotifications =
          DeviceConfig.getBoolean("clipboard", "show_access_notifications", true);
      this.mAllowVirtualDeviceSilos =
          DeviceConfig.getBoolean("clipboard", "allow_virtualdevice_silos", true);
      this.mMaxClassificationLength =
          DeviceConfig.getInt("clipboard", "max_classification_length", 400);
    }
  }
  ...
  public final boolean isInternalSysWindowAppWithWindowFocus(String str) {
    return this.mPm.checkPermission("android.permission.INTERNAL_SYSTEM_WINDOW", str) == 0
        && this.mWm.isUidFocused(Binder.getCallingUid());
  }

  public final int getIntendingUserId(String str, int i) {
    int userId = UserHandle.getUserId(Binder.getCallingUid());
    return (!UserManager.supportsMultipleUsers() || userId == i)
        ? userId
        : this.mAmInternal.handleIncomingUser(
  ...
  public final int getIntendingUid(String str, int i) {
    return UserHandle.getUid(
        getIntendingUserId(str, i), UserHandle.getAppId(Binder.getCallingUid()));
  }
  ...
  public final int getIntendingDeviceId(int i, int i2) {
    ...
    synchronized (this.mLock) {
      ...
      if (i != 0) {
        if (this.mVdmInternal.getDeviceOwnerUid(i) == i2
            || deviceIdsForUid.contains(Integer.valueOf(i))) {
          return i;
        }
        return -1;
      }
  ...
  public class ClipboardImpl extends IClipboard.Stub {
    ...
    public ClipboardImpl() {
      this.mClipboardClearHandler =
          new ClipboardClearHandler(ClipboardService.this.mWorkerHandler.getLooper());
    }
    ...
    public final void checkAndSetPrimaryClip(
        ClipData clipData, String str, String str2, int i, int i2, String str3) {
      ...
      if (ClipboardService.this.clipboardAccessAllowed(
          30, str, str2, intendingUid, userId, intendingDeviceId)) {
        if (ClipboardService.this.getSemClipboardService() != null
            && clipData.getDescription().getExtras() != null
            && clipData.getDescription().getExtras().getBoolean("direct_clip")
            && SemClipboardPolicy.getInstance()
                .canAccessSemClipboard(ClipboardService.this.mContext, str3, i)) {
          ClipboardService.this.getSemClipboardService().setPrimaryClip(clipData, intendingUid);
          return;
        }
        synchronized (ClipboardService.this.mLock) {
          Clipboard clipboardLocked =
              ClipboardService.this.getClipboardLocked(userId, intendingDeviceId);
                      ...
                      public void run() {
                        Toast.makeText(
                                new ContextThemeWrapper(
                                    ClipboardService.this.mContext,
          ...
          synchronized (ClipboardService.this.mLock) {
            Clipboard clipboardLocked2 =
                ClipboardService.this.getClipboardLocked(userId, intendingDeviceId);
            if (isClipboardShareAllowed(getPersonaId()) == 0) {
              clipboardLocked2.primaryClipByUid.put(
                  Integer.valueOf(Binder.getCallingUid()), clipData);
              return;
            }
            ...
            synchronized (ClipboardService.this.mLock) {
              ...
              ClipboardService.this.setPrimaryClipInternalLocked(
                  clipData, intendingUid, intendingDeviceId, str3);
              if (ClipboardService.this.getSemClipboardService() != null) {
                ClipboardService.this
                    .getSemClipboardService()
                    .setPrimaryClip(clipData, intendingUid);
              }
            }
          }
        }
    ...
    public final void scheduleAutoClear(int i, int i2, int i3) {
      ...
      try {
        if (DeviceConfig.getBoolean("clipboard", "auto_clear_enabled", true)) {
          ...
          this.mClipboardClearHandler.sendMessageDelayed(
              Message.obtain(this.mClipboardClearHandler, 101, i, i2, pair),
    ...
    public final long getTimeoutForAutoClear() {
      return DeviceConfig.getLong(
          "clipboard", "auto_clear_timeout", ClipboardService.DEFAULT_CLIPBOARD_TIMEOUT_MILLIS);
    }
    ...
    public void clearPrimaryClip(String str, String str2, int i, int i2) {
      ...
      if (ClipboardService.this.clipboardAccessAllowed(
          30, str, str2, intendingUid, userId, intendingDeviceId)) {
        synchronized (ClipboardService.this.mLock) {
          this.mClipboardClearHandler.removeEqualMessages(
              101, new Pair(Integer.valueOf(i), Integer.valueOf(i2)));
          ClipboardService.this.setPrimaryClipInternalLocked(
              (ClipData) null, intendingUid, intendingDeviceId, str);
        }
      }
    }
    ...
    public ClipData getPrimaryClip(String str, String str2, int i, int i2) {
      ...
      int intendingDeviceId = ClipboardService.this.getIntendingDeviceId(i2, intendingUid);
      if (!ClipboardService.this.clipboardAccessAllowed(
              29, str, str2, intendingUid, userId, intendingDeviceId)
          || ClipboardService.this.isDeviceLocked(userId)) {
        return null;
      }
      synchronized (ClipboardService.this.mLock) {
        if (isClipboardAllowed(true, getPersonaId()) == 0) {
          ...
          ClipboardService.this.getClipboardLocked(userId, intendingDeviceId).primaryClipForKNOX =
              null;
          ClipboardService.this
              .getClipboardLocked(userId, intendingDeviceId)
              .primaryClipByUid
              .clear();
          return null;
        }
        ...
        try {
          ...
          if (isClipboardShareAllowed(getPersonaId()) == 0) {
            return (ClipData)
                ClipboardService.this
                    .getClipboardLocked(userId, intendingDeviceId)
                    .primaryClipByUid
                    .get(Integer.valueOf(Binder.getCallingUid()));
          }
          if (ClipboardService.this.mContainerID != 0) {
            Slog.d("ClipboardService", "getPrimaryClip knox return!!!");
            return ClipboardService.this.getClipboardLocked(userId, intendingDeviceId)
                .primaryClipForKNOX;
          }
          Clipboard clipboardLocked =
              ClipboardService.this.getClipboardLocked(userId, intendingDeviceId);
          ClipboardService.this.showAccessNotificationLocked(
              str, intendingUid, userId, clipboardLocked);
          ...
          Slog.i(
              "ClipboardService",
              "Could not grant permission to primary clip. Clearing clipboard.");
          ClipboardService.this.setPrimaryClipInternalLocked(
              (ClipData) null, intendingUid, intendingDeviceId, str);
          return null;
        }
    ...
    public ClipDescription getPrimaryClipDescription(String str, String str2, int i, int i2) {
      ...
      int intendingDeviceId = ClipboardService.this.getIntendingDeviceId(i2, intendingUid);
      if (!ClipboardService.this.clipboardAccessAllowed(
              29, str, str2, intendingUid, userId, intendingDeviceId, false)
          || ClipboardService.this.isDeviceLocked(userId)) {
        return null;
      }
      synchronized (ClipboardService.this.mLock) {
        ClipData clipData =
            ClipboardService.this.getClipboardLocked(userId, intendingDeviceId).primaryClip;
    ...
    public boolean hasPrimaryClip(String str, String str2, int i, int i2) {
      ...
      synchronized (ClipboardService.this.mLock) {
        ...
        if (isClipboardShareAllowed != 0) {
          clipboardLocked.primaryClipByUid.clear();
          return ClipboardService.this.getClipboardLocked(userId, intendingDeviceId).primaryClip
              != null;
        }
        clipboardLocked.primaryClip = null;
        clipboardLocked.primaryClipForKNOX = null;
        return clipboardLocked.primaryClipByUid.get(Integer.valueOf(Binder.getCallingUid()))
            != null;
      }
    }
    ...
    public void addPrimaryClipChangedListener(
      ...
      if (intendingDeviceId == -1) {
        Slog.i(
            "ClipboardService",
            "addPrimaryClipChangedListener invalid deviceId for userId:"
                + i
                + " uid:"
                + intendingUid
                + " callingPackage:"
      ...
      synchronized (ClipboardService.this.mLock) {
        ClipboardService.this
            ...
            .register(
                ...
                ClipboardService.this.new ListenerInfo(intendingUid, str, str2));
      }
    }
    ...
    public void removePrimaryClipChangedListener(
      ...
      if (intendingDeviceId == -1) {
        Slog.i(
            "ClipboardService",
            "removePrimaryClipChangedListener invalid deviceId for userId:"
                + i
                + " uid:"
                + intendingUid
                + " callingPackage:"
      ...
      synchronized (ClipboardService.this.mLock) {
        ClipboardService.this
            ...
            .primaryClipListeners
            .unregister(iOnPrimaryClipChangedListener);
      }
    }
    ...
    public boolean hasClipboardText(String str, String str2, int i, int i2) {
      ...
      boolean clipboardAccessAllowed =
          ClipboardService.this.clipboardAccessAllowed(
              29, str, str2, intendingUid, userId, intendingDeviceId, false);
      boolean z = false;
    ...
    public final int isClipboardAllowed(boolean z, int i) {
      ...
      return (ClipboardPolicyObserver.getInstance(ClipboardService.this.mContext)
                  .isClipboardAllowed(i)
              && ClipboardPolicyObserver.getInstance(ClipboardService.this.mContext)
                  .isPackageAllowed(i))
          ? 1
          : 0;
    }
    ...
    public final boolean getPersonaManager() {
      if (ClipboardService.this.mContext != null && ClipboardService.this.mPersonaManager == null) {
        ...
        clipboardService.mPersonaManager =
            (SemPersonaManager) clipboardService.mContext.getSystemService("persona");
      }
        ...
        if (message.what == 101) {
          ...
          synchronized (ClipboardService.this.mLock) {
            if (ClipboardService.this.getClipboardLocked(i, intValue).primaryClip != null) {
              ...
              ClipboardService.this.setPrimaryClipInternalLocked(
                  (ClipData) null, i2, intValue, (String) null);
            }
          }
          return;
        }
        Slog.wtf(
            "ClipboardService", "ClipboardClearHandler received unknown message " + message.what);
      }
    }
  }
  ...
  public final void setPrimaryClipInternalLocked(
      Clipboard clipboard, ClipData clipData, int i, String str) {
    int userId = UserHandle.getUserId(i);
    if (clipData != null) {
  ...
  public final void setPrimaryClipInternalNoClassifyLocked(
      Clipboard clipboard, ClipData clipData, int i, String str) {
    ClipDescription description;
    ...
    for (int i = 0; i < beginBroadcast; i++) {
      try {
        ListenerInfo listenerInfo =
            (ListenerInfo) clipboard.primaryClipListeners.getBroadcastCookie(i);
        ...
        if (clipboardAccessAllowed(
            29, str, str2, i2, UserHandle.getUserId(i2), clipboard.deviceId)) {
  ...
  public final void startClassificationLocked(final ClipData clipData, final int i, final int i2) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      final TextClassifier createTextClassificationSession =
          createTextClassificationManagerAsUser(i)
              .createTextClassificationSession(
                  new TextClassificationContext.Builder(getContext().getPackageName(), "clipboard")
                      .build());
      Binder.restoreCallingIdentity(clearCallingIdentity);
      if (text.length() > createTextClassificationSession.getMaxGenerateLinksTextLength()) {
        ...
        this.mWorkerHandler.post(
            new Runnable() { // from class:
                             // com.android.server.clipboard.ClipboardService$$ExternalSyntheticLambda4
              @Override // java.lang.Runnable
              public final void run() {
                ClipboardService.this.lambda$startClassificationLocked$3(
                    text, clipData, createTextClassificationSession, i, i2);
              }
            });
      }
    } catch (Throwable th) {
  ...
  public final void lambda$startClassificationLocked$3(
      CharSequence charSequence, ClipData clipData, TextClassifier textClassifier, int i, int i2) {
    int i3;
    TextLinks generateLinks =
        textClassifier.generateLinks(new TextLinks.Request.Builder(charSequence).build());
    ...
    while (true) {
      ...
      while (i3 < next.getEntityCount()) {
        ...
        if (confidenceScore
            > ((Float)
                    arrayMap.getOrDefault(
                        entity, Float.valueOf(DisplayPowerController2.RATE_FROM_DOZE_TO_ON)))
                .floatValue()) {
    ...
    synchronized (this.mLock) {
      ...
      if (clipboardLocked.primaryClip == clipData) {
        applyClassificationAndSendBroadcastLocked(
            clipboardLocked, arrayMap, generateLinks, textClassifier);
          ...
          while (i3 < size) {
            ...
            if (i4 != i && (!hasRestriction("no_sharing_into_profile", i4))) {
              ...
              if (hasTextLocked(clipboardLocked2, charSequence)) {
                applyClassificationAndSendBroadcastLocked(
                    clipboardLocked2, arrayMap, generateLinks, textClassifier);
              }
            }
            i3++;
          }
  ...
  public final void applyClassificationAndSendBroadcastLocked(
      Clipboard clipboard, ArrayMap arrayMap, TextLinks textLinks, TextClassifier textClassifier) {
  ...
  public final boolean hasTextLocked(Clipboard clipboard, CharSequence charSequence) {
    ...
    return clipData != null
        ...
        && charSequence.equals(clipboard.primaryClip.getItemAt(0).getText());
  }
  ...
  public final void checkUriOwner(Uri uri, int i) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      this.mUgmInternal.checkGrantUriPermission(
          i,
          null,
  ...
  public final void addActiveOwnerLocked(int i, int i2, String str) {
    ...
    if (clipboardLocked.primaryClip == null
        || clipboardLocked.activePermissionOwners.contains(str)) {
      return;
    }
    int itemCount = clipboardLocked.primaryClip.getItemCount();
    for (int i3 = 0; i3 < itemCount; i3++) {
      grantItemPermission(
          clipboardLocked.primaryClip.getItemAt(i3),
          clipboardLocked.primaryClipUid,
          str,
  ...
  public final void revokeUriPermission(Uri uri, int i) {
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      this.mUgmInternal.revokeUriPermissionFromOwner(
          this.mPermissionOwner,
          ContentProvider.getUriWithoutUserId(uri),
          1,
          ContentProvider.getUserIdFromUri(uri, UserHandle.getUserId(i)));
  ...
  public final boolean clipboardAccessAllowed(
      int i, String str, String str2, int i2, int i3, int i4) {
  ...
  */
  public final boolean clipboardAccessAllowed(
      int i, String str, String str2, int i2, int i3, int i4, boolean z) {
    ...
    if (i4 == -1) {
      Slog.w(
          "ClipboardService",
          "Clipboard access denied to " + i2 + "/" + str + " due to invalid device id");
      return false;
    }
    boolean isDefaultIme =
        this.mPm.checkPermission("android.permission.READ_CLIPBOARD_IN_BACKGROUND", str) == 0
            ? true
            : isDefaultIme(i3, str);
    if (i == 29) {
      if (!isDefaultIme) {
        isDefaultIme =
            isDefaultDeviceAndUidFocused(i4, i2)
                || isVirtualDeviceAndUidFocused(i4, i2)
                || isInternalSysWindowAppWithWindowFocus(str);
      }
      ...
      if (!isDefaultIme && i4 != 0) {
        VirtualDeviceManagerInternal virtualDeviceManagerInternal = this.mVdmInternal;
        if (virtualDeviceManagerInternal == null
            || virtualDeviceManagerInternal.getDeviceOwnerUid(i4) != i2) {
          isDefaultIme = false;
        }
      }
      if (!isDefaultIme) {
      ...
      Slog.e(
          "ClipboardService",
          "Denying clipboard access to "
              + str
              + ", application is not in focus nor is it a system service for user "
              + i3);
      return false;
    }
    if (i != 30) {
  ...
  public final boolean isVirtualDeviceAndUidFocused(int i, int i2) {
    ...
    return this.mVdm.getDeviceIdForDisplayId(this.mWm.getTopFocusedDisplayId()) == i
        && this.mWm.isUidFocused(i2);
  }

  public final boolean isDefaultIme(int i, String str) {
    String stringForUser =
        Settings.Secure.getStringForUser(
            getContext().getContentResolver(), "default_input_method", i);
  ...
  public final void showAccessNotificationLocked(
      final String str, int i, final int i2, Clipboard clipboard) {
    if (clipboard.primaryClip == null
        || Settings.Secure.getInt(
                getContext().getContentResolver(),
                "clipboard_show_access_notifications",
                this.mShowAccessNotifications ? 1 : 0)
            == 0
        || UserHandle.isSameApp(i, clipboard.primaryClipUid)
        || isDefaultIme(i2, str)) {
      return;
    }
    ...
    if (contentCaptureManagerInternal == null
        || !contentCaptureManagerInternal.isContentCaptureServiceForUser(i, i2)) {
      AutofillManagerInternal autofillManagerInternal = this.mAutofillInternal;
      if ((autofillManagerInternal == null
              || !autofillManagerInternal.isAugmentedAutofillServiceForUser(i, i2))
          && this.mPm.checkPermission(
                  "android.permission.SUPPRESS_CLIPBOARD_ACCESS_NOTIFICATION", str)
              != 0) {
        int i3 = clipboard.deviceId;
        if ((i3 == 0 || this.mVdmInternal.getDeviceOwnerUid(i3) != i)
            && !clipboard.mNotifiedUids.get(i)) {
          final ArraySet toastContexts = getToastContexts(clipboard);
          Binder.withCleanCallingIdentity(
              new FunctionalUtils
                  .ThrowingRunnable() { // from class:
                                        // com.android.server.clipboard.ClipboardService$$ExternalSyntheticLambda5
                public final void runOrThrow() {
                  ClipboardService.this.lambda$showAccessNotificationLocked$4(
                      str, i2, toastContexts);
                }
              });
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$showAccessNotificationLocked$4(
      String str, int i, ArraySet arraySet) {
    Toast makeText;
    try {
          ...
          getContext()
              .getString(
                  ...
                  packageManager.getApplicationLabel(
                      packageManager.getApplicationInfoAsUser(str, 0, i)));
  ...
  public final ArraySet getToastContexts(Clipboard clipboard) {
    ...
    if (clipboard.deviceId != 0) {
      DisplayManager displayManager =
          (DisplayManager) getContext().getSystemService(DisplayManager.class);
      ...
      if (displayIdsForDevice.contains(Integer.valueOf(topFocusedDisplayId))
          && (display = displayManager.getDisplay(topFocusedDisplayId)) != null) {
        arraySet.add(getContext().createDisplayContext(display));
        return arraySet;
      }
      for (int i = 0; i < displayIdsForDevice.size(); i++) {
        Display display2 =
            displayManager.getDisplay(((Integer) displayIdsForDevice.valueAt(i)).intValue());
        if (display2 != null) {
      ...
      Slog.e(
          "ClipboardService",
          "getToastContexts Couldn't find any VirtualDisplays for VirtualDevice "
              + clipboard.deviceId);
    }
  ...
  public static boolean isText(ClipData clipData) {
    ...
    return !TextUtils.isEmpty(itemAt.getText())
        && itemAt.getUri() == null
        && itemAt.getIntent() == null;
  }
  ...
  public final SemClipboardService getSemClipboardService() {
    ...
    SemClipboardService asInterface =
        IClipboardService.Stub.asInterface(ServiceManager.getService("semclipboard"));
  ...
  public final void notifyTextClassifierLocked(final Clipboard clipboard, final String str, int i) {
    ...
    if (clipData == null
        ...
        || !isText(clipboard.primaryClip)
        || (textClassifier = clipboard.mTextClassifier) == null
        || !this.mWm.isUidFocused(i)
        || clipboard.mNotifiedTextClassifierUids.get(i)) {
      return;
    }
    ...
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.clipboard.ClipboardService$$ExternalSyntheticLambda3
          public final void runOrThrow() {
  ...
  public static /* synthetic */ void lambda$notifyTextClassifierLocked$5(
      String str, Clipboard clipboard, TextClassifier textClassifier) {
    textClassifier.onTextClassifierEvent(
        ((TextClassifierEvent.TextLinkifyEvent.Builder)
                ((TextClassifierEvent.TextLinkifyEvent.Builder)
                        new TextClassifierEvent.TextLinkifyEvent.Builder(22)
                            .setEventContext(
                                new TextClassificationContext.Builder(str, "clipboard").build()))
                    .setExtras(Bundle.forPair("source_package", clipboard.mPrimaryClipPackage)))
            .build());
  }
