...
public class ValidateNotificationPeople implements NotificationSignalExtractor {
  ...
  public static final String[] LOOKUP_PROJECTION = {
    KnoxCustomManagerService.f1773ID, "lookup", "starred", "has_phone_number"
  };
    ...
    boolean z =
        1
            == Settings.Global.getInt(
                this.mBaseContext.getContentResolver(), "validate_notification_people_enabled", 1);
    this.mEnabled = z;
    if (z) {
          ...
          new ContentObserver(
            ...
            public void onChange(boolean z2, Uri uri, int i) {
              ...
              if ((ValidateNotificationPeople.DEBUG
                      || ValidateNotificationPeople.this.mEvictionCount % 100 == 0)
                  && ValidateNotificationPeople.VERBOSE) {
                Slog.i(
                    "ValidateNoPeople",
                    "mEvictionCount: " + ValidateNotificationPeople.this.mEvictionCount);
              }
              ValidateNotificationPeople.this.mPeopleCache.evictAll();
              ValidateNotificationPeople.this.mEvictionCount++;
              ValidateNotificationPeople.this.updateExceptionContacts(
                  context, uri, i, Binder.getCallingUid(), true);
            }
          };
      this.mBaseContext
          .getContentResolver()
          .registerContentObserver(ContactsContract.Contacts.CONTENT_URI, true, this.mObserver, -1);
    }
  }
  ...
  public float getContactAffinity(UserHandle userHandle, Bundle bundle, int i, float f) {
    ...
    final PeopleRankingReconsideration validatePeople =
    ...
    AsyncTask.THREAD_POOL_EXECUTOR.execute(
        new Runnable() { // from class: com.android.server.notification.ValidateNotificationPeople.2
    ...
    try {
      if (!semaphore.tryAcquire(i, TimeUnit.MILLISECONDS)) {
        Slog.w(
            "ValidateNoPeople",
            "Timeout while waiting for affinity: " + l + ". Returning timeoutAffinity=" + f);
        return f;
      }
      ...
      Slog.w(
          "ValidateNoPeople",
          "InterruptedException while waiting for affinity: " + l + ". Returning affinity=" + f2,
          e);
      return f2;
    }
  }
  ...
  public boolean isInExceptionContacts(UserHandle userHandle, Bundle bundle, List list) {
    ...
    if (extraPeople != null) {
      ...
      for (String str3 : extraPeople) {
        if (str3 != null
            && (split = str3.split(XmlUtils.STRING_ARRAY_SEPARATOR)) != null
            && split.length >= 2) {
          try {
      ...
      while (it2.hasNext()) {
        ...
        if (str4 != null) {
          for (int i = 0; i < list.size(); i++) {
            if (list.get(i) != null
                && PhoneNumberUtils.areSamePhoneNumber(str4, (String) list.get(i), str2)) {
  ...
  public final void updateExceptionContacts(
      final Context context, Uri uri, final int i, final int i2, final boolean z) {
  ...
  public /* synthetic */ void lambda$updateExceptionContacts$0(
      int i, Context context, int i2, boolean z) {
    ...
    this.mZenModeHelper.setNotificationPolicy(
        new NotificationManager.Policy(
            ...
            getUpdatedExceptionContacts(
                context, notificationPolicy.getExceptionContacts(), buildUpon.build())),
        i2,
        z);
  ...
  */
  public final List getUpdatedExceptionContacts(Context context, List list, Uri uri) {
    ArrayList arrayList = new ArrayList();
    if (list != null && !list.isEmpty()) {
      Iterator it = list.iterator();
      while (it.hasNext()) {
        String[] split = ((String) it.next()).split(KnoxVpnFirewallHelper.DELIMITER);
        if (split.length > 1) {
          try {
            Cursor query =
                context
                    .getContentResolver()
                    .query(uri, null, "contact_id = " + split[0], null, null);
            if (query != null) {
              try {
                if (query.moveToFirst()) {
                  String string = query.getString(query.getColumnIndex("data1"));
                  Slog.d("ValidateNoPeople", "There is a contact has been updated.");
            ...
            if (query == null) {
              Slog.d("ValidateNoPeople", "Failed to query the contact.");
            } else {
              Slog.d("ValidateNoPeople", "There is a contact has been deleted.");
            }
            if (query == null) {}
          } catch (Throwable th3) {
            Slog.w(
  ...
  public void fixExceptionContacts(final Context context, final List list) {
    BackgroundThread.getHandler()
        .post(
            new Runnable() { // from class:
                             // com.android.server.notification.ValidateNotificationPeople$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public RankingReconsideration validatePeople(
    ...
    PeopleRankingReconsideration validatePeople =
        validatePeople(
            context, key, bundle, notificationRecord.getPeopleOverride(), fArr, arraySet);
    float f = fArr[0];
    ...
    if (validatePeople == null) {
      this.mUsageStats.registerPeopleAffinity(
          notificationRecord, f > DisplayPowerController2.RATE_FROM_DOZE_TO_ON, f == 1.0f, true);
    } else {
  ...
  /*
      Code decompiled incorrectly, please refer to instructions dump.
  */
  public final PeopleRankingReconsideration validatePeople(
      Context context, String str, Bundle bundle, List list, float[] fArr, ArraySet arraySet) {
    ArraySet phoneNumbers;
    if (bundle == null) {
      return null;
    }
      ...
      if (!TextUtils.isEmpty(str2)) {
        synchronized (this.mPeopleCache) {
          LookupResult lookupResult =
              (LookupResult) this.mPeopleCache.get(getCacheKey(context.getUserId(), str2));
          if (lookupResult != null && !lookupResult.isExpired()) {
            ...
            if (lookupResult != null) {
              ...
              if (arraySet != null
                  && (phoneNumbers = lookupResult.getPhoneNumbers()) != null
                  && phoneNumbers.size() > 0) {
                arraySet.addAll(phoneNumbers);
              }
            }
          }
          linkedList.add(str2);
  ...
  public static String[] getExtraPeople(Bundle bundle) {
    return combineLists(
        getExtraPeopleForKey(bundle, "android.people"),
        getExtraPeopleForKey(bundle, "android.people.list"));
  }
  ...
  public class LookupResult {
    ...
    public void mergeContact(Cursor cursor) {
      ...
      int columnIndex = cursor.getColumnIndex(KnoxCustomManagerService.f1773ID);
      if (columnIndex >= 0) {
  ...
  class PeopleRankingReconsideration extends RankingReconsideration {
    ...
    public void work() {
      ...
      if (ValidateNotificationPeople.DEBUG) {
        Slog.d(
            "ValidateNoPeople",
            "Validation finished in " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
      }
      if (this.mRecord != null) {
        ...
        notificationUsageStats.registerPeopleAffinity(
            notificationRecord, f > DisplayPowerController2.RATE_FROM_DOZE_TO_ON, f == 1.0f, false);
      }
    }
    ...
    public static LookupResult resolveEmailContact(Context context, String str) {
      return searchContacts(
          ...
          Uri.withAppendedPath(
              ContactsContract.CommonDataKinds.Email.CONTENT_LOOKUP_URI, Uri.encode(str)));
    }
    ...
    public static void addContacts(LookupResult lookupResult, Context context, Uri uri) {
      try {
        Cursor query =
            context
                .getContentResolver()
                .query(uri, ValidateNotificationPeople.LOOKUP_PROJECTION, null, null, null);
        try {
          if (query == null) {
    ...
    public void applyChangesLocked(NotificationRecord notificationRecord) {
      notificationRecord.setContactAffinity(
          Math.max(this.mContactAffinity, notificationRecord.getContactAffinity()));
      if (ValidateNotificationPeople.VERBOSE) {
