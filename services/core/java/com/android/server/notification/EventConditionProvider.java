...
public class EventConditionProvider extends SystemConditionProviderService {
    ...
    public final void rescheduleAlarm(long j, long j2) {
        ...
        if (DEBUG) {
            Slog.d("ConditionProviders.ECP", String.format("Scheduling evaluate for %s, in %s, now=%s", SystemConditionProviderService.m51ts(j2), SystemConditionProviderService.formatDuration(j2 - j), SystemConditionProviderService.m51ts(j)));
        }
