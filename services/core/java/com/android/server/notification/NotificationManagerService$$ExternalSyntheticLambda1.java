...
public final /* synthetic */ class NotificationManagerService$$ExternalSyntheticLambda1
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ NotificationManagerService f$0;

    public /* synthetic */ NotificationManagerService$$ExternalSyntheticLambda1(
            NotificationManagerService notificationManagerService, int i) {
        this.$r8$classId = i;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                List<ApplicationInfo> installedApplications =
                        preferencesHelper.mPm.getInstalledApplications(0);
                ...
                try {
                    ...
                    for (ResolveInfo resolveInfo :
                            preferencesHelper.mPm.queryIntentActivities(intent, 0)) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < size; i++) {
                            PreferencesHelper.PackagePreferences packagePreferences =
                                    (PreferencesHelper.PackagePreferences)
                                            preferencesHelper.mPackagePreferences.valueAt(i);
                            if (arrayList2.contains(packagePreferences.pkg)) {
                                Slog.d(
                                        "NotificationPrefHelper",
                                        "resetDefaultAllowEdgeLightingExceptSettingApps -"
                                            + " excepPackage = "
                        ...
                        while (it.hasNext()) {
                            ...
                            if ((notificationRecord.sbn.getNotification().semFlags & 262144) != 0) {
                                if (NotificationManagerService.DBG) {
                                    Slog.e(
                                            "NotificationService",
                                            "skip already set insignificant flag");
                                }
                            } else if ((notificationRecord.sbn.getNotification().semFlags & 131072)
                                    != 0) {
                                if (NotificationManagerService.DBG) {
                            ...
                            } else if (currentTimeMillis - notificationRecord.mUpdateTimeMs
                                    < 172800000) {
                                Slog.e(
                                        "NotificationService",
                                        "skip 3th midnight is not passed package = "
                                                + notificationRecord.sbn.getPackageName());
                            } else {
