...
public final class VibratorHelper {
    ...
    public VibratorHelper(Context context) {
        ...
        this.mDefaultPattern = getLongArray(resources, R.array.config_serviceStateLocationAllowedPackages, 17, jArr);
        this.mFallbackPattern = getLongArray(context.getResources(), 17236258, 17, jArr);
        this.mDefaultPwlePattern = getFloatArray(context.getResources(), R.array.config_sfps_enroll_stage_thresholds);
