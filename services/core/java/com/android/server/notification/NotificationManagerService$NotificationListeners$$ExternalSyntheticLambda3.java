...
class NotificationManagerService$NotificationListeners$$ExternalSyntheticLambda3
        implements Runnable {
    ...
    public /* synthetic */
    NotificationManagerService$NotificationListeners$$ExternalSyntheticLambda3(
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (!managedServiceInfo.isSystem) {
                    ...
                    if (!notificationManagerService.hasCompanionDevice(
                            managedServiceInfo.userid,
                            managedServiceInfo.component.getPackageName(),
                            null)) {
                        IInterface iInterface = managedServiceInfo.service;
                        synchronized (notificationManagerService.mNotificationLock) {
                            NotificationManagerService.NotificationAssistants
                                    notificationAssistants = notificationManagerService.mAssistants;
                            z = false;
                            if (iInterface == null) {
                                notificationAssistants.getClass();
                            } else if (notificationAssistants.getServiceFromTokenLocked(iInterface)
                                    != null) {
                                z = true;
                            }
                        }
                ...
                try {
                    managedServiceInfo.service.onNotificationChannelModification(
                            str, userHandle, notificationChannel, i);
                    return;
                } catch (RemoteException e) {
                    Slog.e(
                            notificationListeners.TAG,
                            "unable to notify listener (channel changed): " + managedServiceInfo,
                            e);
                    return;
                }
            case 1:
                ...
                NotificationChannelGroup notificationChannelGroup =
                        (NotificationChannelGroup) this.f$4;
                int i2 = this.f$5;
                notificationListeners2.getClass();
                if (!managedServiceInfo2.isSystem) {
                    NotificationManagerService notificationManagerService2 =
                            NotificationManagerService.this;
                    notificationManagerService2.getClass();
                    if (!notificationManagerService2.hasCompanionDevice(
                            managedServiceInfo2.userid,
                            managedServiceInfo2.component.getPackageName(),
                            null)) {
                        return;
                    }
                }
                try {
                    managedServiceInfo2.service.onNotificationChannelGroupModification(
                            str2, userHandle2, notificationChannelGroup, i2);
                    return;
                } catch (RemoteException e2) {
                    Slog.e(
                            notificationListeners2.TAG,
                            "unable to notify listener (channel group changed): "
                                    + managedServiceInfo2,
                            e2);
                    return;
                }
            default:
                this.f$0.notifyRemoved(
                        this.f$1,
                        (StatusBarNotification) this.f$2,
                        (NotificationRankingUpdate) this.f$3,
                        (NotificationStats) this.f$4,
                        this.f$5);
                return;
        }
    }
