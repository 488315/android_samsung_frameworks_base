...
public interface NotificationRecordLogger {
    ...
    public class NotificationRecordPair {
        ...
        public boolean shouldLogReported(int i) {
            ...
            return (Objects.equals(notificationRecord.getSbn().getChannelIdLogTag(), this.old.getSbn().getChannelIdLogTag()) && Objects.equals(this.f1717r.getSbn().getGroupLogTag(), this.old.getSbn().getGroupLogTag()) && this.f1717r.getSbn().getNotification().isGroupSummary() == this.old.getSbn().getNotification().isGroupSummary() && Objects.equals(this.f1717r.getSbn().getNotification().category, this.old.getSbn().getNotification().category) && this.f1717r.getImportance() == this.old.getImportance() && NotificationRecordLogger.getLoggingImportance(this.f1717r) == NotificationRecordLogger.getLoggingImportance(this.old) && this.f1717r.rankingScoreMatches(this.old.getRankingScore())) ? false : true;
        }
        ...
        public int getNotificationIdHash() {
            return SmallHash.hash(this.f1717r.getSbn().getId() ^ Objects.hashCode(this.f1717r.getSbn().getTag()));
        }
    ...
    public class NotificationReported {
        ...
        public NotificationReported(NotificationRecordPair notificationRecordPair, NotificationReportedEvent notificationReportedEvent, int i, int i2, InstanceId instanceId) {
            ...
            this.is_group_summary = notificationRecordPair.f1717r.getSbn().getNotification().isGroupSummary();
            ...
            this.position = i;
            this.importance = NotificationRecordLogger.getLoggingImportance(notificationRecordPair.f1717r);
            this.alerting = i2;
            ...
            this.importance_initial_source = notificationRecordPair.f1717r.getInitialImportanceExplanationCode();
            ...
            this.is_foreground_service = NotificationRecordLogger.isForegroundService(notificationRecordPair.f1717r);
            this.timeout_millis = notificationRecordPair.f1717r.getSbn().getNotification().getTimeoutAfter();
            this.is_non_dismissible = NotificationRecordLogger.isNonDismissible(notificationRecordPair.f1717r);
        }
    }
