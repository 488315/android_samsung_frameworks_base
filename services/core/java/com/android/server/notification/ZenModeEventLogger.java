...
public class ZenModeEventLogger {
  ...
  public final void maybeLogZenChange(
      ZenModeInfo zenModeInfo, ZenModeInfo zenModeInfo2, int i, boolean z) {
  ...
  public final void maybeReassignCallingUid() {
    ...
    if (this.mChangeState.getChangedRuleType() == 1) {
      ...
      if (!zenStateChanges.mFromSystemOrSystemUi
          || zenStateChanges.getNewManualRuleEnabler() == null) {
        return;
      }
    ...
    if (this.mChangeState.getChangedRuleType() == 2) {
      ...
      if (changedAutomaticRules.size() != 1
          || (rulePackageAndUser =
                  this.mChangeState.getRulePackageAndUser(
                      (String) changedAutomaticRules.keyAt(0),
                      (ZenModeDiff.RuleDiff) changedAutomaticRules.valueAt(0)))
              == null
          || ((String) rulePackageAndUser.first).equals("android")) {
        return;
      }
  ...
  public void logChanges() {
    ...
    FrameworkStatsLog.write(
        FrameworkStatsLog.DND_STATE_CHANGED,
        id,
        zenStateChanges.mNewZenMode,
        zenStateChanges.mPrevZenMode,
        zenStateChanges.getChangedRuleType(),
        this.mChangeState.getNumRulesActive(),
        this.mChangeState.getIsUserAction(),
        this.mChangeState.getPackageUid(),
        this.mChangeState.getDNDPolicyProto(),
        this.mChangeState.getAreChannelsBypassing());
  }
  ...
  public class ZenStateChanges {
    ...
    public ZenStateChangedEvent getEventId() {
      if (!shouldLogChanges()) {
        Log.wtf(
            "ZenModeEventLogger", "attempt to get DNDStateChanged fields without shouldLog=true");
      }
      if (zenModeFlipped()) {
    ...
    public int getChangedRuleType() {
      ...
      if (manualRuleDiff != null
          && manualRuleDiff.hasDiff()
          && (manualRuleDiff.wasAdded() || manualRuleDiff.wasRemoved())) {
        return 1;
      }
    ...
    public byte[] getDNDPolicyProto() {
      ...
      if (policy != null) {
        ...
        protoOutputStream.write(
            1159641169937L, ZenModeConfig.getZenPolicySenders(this.mNewPolicy.allowCallsFrom()));
        protoOutputStream.write(
            1159641169938L, ZenModeConfig.getZenPolicySenders(this.mNewPolicy.allowMessagesFrom()));
    ...
    public final Pair getRulePackageAndUser(String str, ZenModeDiff.RuleDiff ruleDiff) {
      ...
      if (zenModeConfig == null
          || (zenRule =
                  (ZenModeConfig.ZenRule) zenModeConfig.automaticRules.getOrDefault(str, null))
              == null) {
        return null;
      }
      ...
      if (zenRule.configurationActivity != null) {
        return new Pair(
            zenRule.configurationActivity.getPackageName(), Integer.valueOf(zenModeConfig.user));
      }
      return null;
    }
