...
public class ZenModeHelper {
  ...
  public final HandlerC2036H mHandler;
  ...
  public ZenModeHelper(
    ...
    HandlerC2036H handlerC2036H = new HandlerC2036H(looper);
    this.mHandler = handlerC2036H;
    addCallback(metrics);
    ...
    SettingsObserver settingsObserver = new SettingsObserver(handlerC2036H);
  ...
  public boolean matchesCallFilter(
    ...
    synchronized (this.mConfig) {
      matchesCallFilter =
          ZenModeFiltering.matchesCallFilter(
              this.mContext,
              this.mZenMode,
              this.mConsolidatedPolicy,
              userHandle,
              bundle,
  ...
  public boolean shouldIntercept(NotificationRecord notificationRecord) {
    ...
    synchronized (this.mConfig) {
      shouldIntercept =
          this.mFiltering.shouldIntercept(
              this.mZenMode, this.mConsolidatedPolicy, notificationRecord);
    }
  ...
  public String addAutomaticZenRule(
      String str, AutomaticZenRule automaticZenRule, String str2, int i, boolean z) {
    String str3;
    if (!"android".equals(str)) {
      ...
      int i2 =
          bundle != null
              ? bundle.getInt("android.service.zen.automatic.ruleInstanceLimit", -1)
              : -1;
      int currentInstanceCount =
          getCurrentInstanceCount(automaticZenRule.getOwner())
  ...
  public boolean updateAutomaticZenRule(
    ...
    synchronized (this.mConfig) {
      ...
      if (DEBUG) {
        Log.d(
            "ZenModeHelper",
            "updateAutomaticZenRule zenRule=" + automaticZenRule + " reason=" + str2);
      }
      ZenModeConfig copy = this.mConfig.copy();
      if (str == null) {
      ...
      if (zenRule.enabled != automaticZenRule.isEnabled()) {
        dispatchOnAutomaticRuleStatusChanged(
            this.mConfig.user, zenRule.getPkg(), str, automaticZenRule.isEnabled() ? 1 : 2);
      }
  ...
  public void setAutomaticZenRuleState(Uri uri, Condition condition, int i, boolean z) {
    synchronized (this.mConfig) {
      ...
      setAutomaticZenRuleStateLocked(
          copy, findMatchingRules(copy, uri, condition), condition, i, z);
    }
  }

  public final void setAutomaticZenRuleStateLocked(
      ZenModeConfig zenModeConfig, List list, Condition condition, int i, boolean z) {
  ...
  public final boolean ruleMatches(Uri uri, Condition condition, ZenModeConfig.ZenRule zenRule) {
    ...
    return (uri == null
            || zenRule == null
            || (uri2 = zenRule.conditionId) == null
            || !uri2.equals(uri)
            || Objects.equals(condition, zenRule.condition))
        ? false
        : true;
  }
  ...
  public boolean canManageAutomaticZenRule(ZenModeConfig.ZenRule zenRule) {
    ...
    if (callingUid == 0
        || callingUid == 1000
        || this.mContext.checkCallingPermission("android.permission.MANAGE_NOTIFICATIONS") == 0) {
      return true;
    }
  ...
  public void updateDefaultZenRules(int i, boolean z) {
    ...
    for (ZenModeConfig.ZenRule zenRule : this.mDefaultConfig.automaticRules.values()) {
      ZenModeConfig.ZenRule zenRule2 =
          (ZenModeConfig.ZenRule) this.mConfig.automaticRules.get(zenRule.id);
      if (zenRule2 != null
          && !zenRule2.modified
          && !zenRule2.enabled
          && !zenRule.name.equals(zenRule2.name)
          && canManageAutomaticZenRule(zenRule2)) {
        if (DEBUG) {
          Slog.d(
              "ZenModeHelper",
              "Locale change - updating default zen rule name from "
                  + zenRule2.name
                  + " to "
                  + zenRule.name);
        }
        ...
        updateAutomaticZenRule(
            zenRule.id, createAutomaticZenRule(zenRule2), "locale changed", i, z);
      }
    }
  }
  ...
  public final ServiceInfo getServiceInfo(ComponentName componentName) {
    ...
    List queryIntentServicesAsUser =
        this.mPm.queryIntentServicesAsUser(intent, 132, UserHandle.getCallingUserId());
  ...
  public final ActivityInfo getActivityInfo(ComponentName componentName) {
    ...
    List queryIntentActivitiesAsUser =
        this.mPm.queryIntentActivitiesAsUser(intent, 129, UserHandle.getCallingUserId());
  ...
  public final void populateZenRule(
      String str, AutomaticZenRule automaticZenRule, ZenModeConfig.ZenRule zenRule, boolean z) {
    if (z) {
  ...
  public final void setManualZenMode(
      int i, Uri uri, String str, String str2, boolean z, int i2, boolean z2) {
    synchronized (this.mConfig) {
      if (this.mConfig == null) {
        return;
      }
    ...
    synchronized (this.mConfigsLock) {
      ...
      for (int i2 = 0; i2 < size; i2++) {
        dump(
            printWriter,
            str,
            "mConfigs[u=" + this.mConfigs.keyAt(i2) + "]",
            (ZenModeConfig) this.mConfigs.valueAt(i2));
      }
    }
    printWriter.print(str);
  ...
  public static void dump(
      PrintWriter printWriter, String str, String str2, ZenModeConfig zenModeConfig) {
    printWriter.print(str);
    ...
    printWriter.printf(
        "allow(alarms=%b,media=%b,system=%b,calls=%b,callsFrom=%s,repeatCallers=%b,messages=%b,messagesFrom=%s,conversations=%b,conversationsFrom=%s,events=%b,reminders=%bexceptionContacts=%s,appBypassDndList=%s)\n",
        Boolean.valueOf(zenModeConfig.allowAlarms),
        Boolean.valueOf(zenModeConfig.allowMedia),
        Boolean.valueOf(zenModeConfig.allowSystem),
        Boolean.valueOf(zenModeConfig.allowCalls),
        ZenModeConfig.sourceToString(zenModeConfig.allowCallsFrom),
        Boolean.valueOf(zenModeConfig.allowRepeatCallers),
        Boolean.valueOf(zenModeConfig.allowMessages),
        ZenModeConfig.sourceToString(zenModeConfig.allowMessagesFrom),
        Boolean.valueOf(zenModeConfig.allowConversations),
        ZenPolicy.conversationTypeToString(zenModeConfig.allowConversationsFrom),
        Boolean.valueOf(zenModeConfig.allowEvents),
        Boolean.valueOf(zenModeConfig.allowReminders),
        ZenModeConfig.joinStrings(",", zenModeConfig.allowExceptionContacts),
        ZenModeConfig.joinStrings(",", zenModeConfig.allowAppBypassDndList));
    printWriter.print(str);
    printWriter.printf(
        "  disallow(visualEffects=%s)\n", Integer.valueOf(zenModeConfig.suppressedVisualEffects));
    printWriter.print(str);
  ...
  public void readXml(TypedXmlPullParser typedXmlPullParser, boolean z, int i) {
    ...
    if (readXml != null) {
      ...
      if (Settings.Secure.getInt(this.mContext.getContentResolver(), "fixed_delete_mode_rule", 0)
          == 0) {
        ...
        for (int size = readXml.automaticRules.size() - 1; size >= 0; size--) {
          ZenModeConfig.ZenRule zenRule =
              (ZenModeConfig.ZenRule) readXml.automaticRules.valueAt(size);
          if ("com.android.settings".equals(zenRule.pkg)
              && !ZenModeConfig.isValidScheduleConditionId(zenRule.conditionId)) {
      ...
      for (int size2 = readXml.automaticRules.size() - 1; size2 >= 0; size2--) {
        ZenModeConfig.ZenRule zenRule2 =
            (ZenModeConfig.ZenRule) readXml.automaticRules.valueAt(size2);
        if ("SCHEDULED_DEFAULT_RULE".equals(zenRule2.id) && !zenRule2.modified) {
          zenRule2.name = this.mContext.getResources().getString(17043428);
          Log.d(
              "ZenModeHelper",
              "change default rule name= " + readXml.automaticRules.valueAt(size2));
      ...
      if (readXml.version < 8) {
        Settings.Secure.putIntForUser(
            this.mContext.getContentResolver(), "show_zen_upgrade_notification", 1, i);
      } else {
        Settings.Secure.putIntForUser(
            this.mContext.getContentResolver(), "zen_settings_updated", 1, i);
      }
      if (DEBUG) {
    ...
    synchronized (this.mConfig) {
      ...
      if (arrayMap != null) {
        for (int size = arrayMap.size() - 1; size >= 0; size--) {
          ...
          ZenModeConfig.ZenRule zenRule =
              (ZenModeConfig.ZenRule) arrayMap2.get(arrayMap2.keyAt(size));
  ...
  public boolean setConfigLocked(
      ZenModeConfig zenModeConfig, ComponentName componentName, String str, int i, boolean z) {
      ...
      if (zenModeConfig != null) {
        if (zenModeConfig.isValid()) {
          if (zenModeConfig.user != this.mUser) {
            ...
            if (DEBUG) {
              Log.d(
                  "ZenModeHelper", "setConfigLocked: store config for user " + zenModeConfig.user);
            }
            return true;
          }
          ...
          boolean z3 =
              !Objects.equals(
                  getNotificationPolicy(this.mConfig), getNotificationPolicy(zenModeConfig));
  ...
  public final void updateConfigAndZenModeLocked(
      ZenModeConfig zenModeConfig, String str, boolean z, int i, boolean z2) {
    boolean isEnabled =
        this.mFlagResolver.isEnabled(
            SystemUiSystemPropertiesFlags.NotificationFlags.LOG_DND_STATE_EVENTS);
    ZenModeEventLogger.ZenModeInfo zenModeInfo =
        new ZenModeEventLogger.ZenModeInfo(this.mZenMode, this.mConfig, this.mConsolidatedPolicy);
    ...
    Settings.Global.putString(
        ...
        Integer.toString(zenModeConfig.hashCode()));
    evaluateZenMode(str, z);
    if (isEnabled) {
      this.mZenModeEventLogger.maybeLogZenChange(
          zenModeInfo,
          new ZenModeEventLogger.ZenModeInfo(this.mZenMode, this.mConfig, this.mConsolidatedPolicy),
          i,
          z2);
  ...
  public void evaluateZenMode(String str, boolean z) {
    ...
    if (z
        && (computeZenMode != i
            || (computeZenMode == 1 && hashCode != this.mConsolidatedPolicy.hashCode()))) {
      z2 = true;
    }
      ...
      for (ZenModeConfig.ZenRule zenRule2 : zenModeConfig2.automaticRules.values()) {
        if (zenRule2.isAutomaticActive() && zenSeverity(zenRule2.zenMode) > zenSeverity(i)) {
          if (Settings.Secure.getInt(
                  this.mContext.getContentResolver(), "zen_settings_suggestion_viewed", 1)
              == 0) {
            Settings.Secure.putInt(
                this.mContext.getContentResolver(), "show_zen_settings_suggestion", 1);
          }
          i = zenRule2.zenMode;
        }
      }
  ...
  public final void applyCustomPolicy(ZenPolicy zenPolicy, ZenModeConfig.ZenRule zenRule) {
    ...
    if (i == 2) {
      ...
      zenPolicy.apply(
          new ZenPolicy.Builder().disallowAllSounds().allowAlarms(true).allowMedia(true).build());
    } else {
  ...
  public ArrayList getAppsToBypassDndForEnabledLifeStyle() {
    ...
    for (ZenModeConfig.ZenRule zenRule : this.mConfig.automaticRules.values()) {
      if (zenRule.isAutomaticActive()
          && zenRule.pkg.equals("com.android.settings")
  ...
  public final void updateDefaultAutomaticRuleNames() {
    for (ZenModeConfig.ZenRule zenRule : this.mDefaultConfig.automaticRules.values()) {
      if ("EVENTS_DEFAULT_RULE".equals(zenRule.id)) {
        zenRule.name = this.mContext.getResources().getString(17043427);
      } else if ("EVERY_NIGHT_DEFAULT_RULE".equals(zenRule.id)) {
        zenRule.name = this.mContext.getResources().getString(17043428);
      }
    }
  }
  ...
  public final ZenModeConfig readDefaultConfig(Resources resources) {
    ...
    try {
      try {
        xmlResourceParser = resources.getXml(R.xml.password_kbd_extension);
      ...
      for (int i = 0; i < size; i++) {
        ...
        list.add(
            this.mStatsEventBuilderFactory
                .newBuilder()
                .setAtomId(FrameworkStatsLog.DND_MODE_RULE)
                .writeInt(keyAt)
                .writeBoolean(zenModeConfig.manualRule != null)
                .writeBoolean(zenModeConfig.areChannelsBypassingDnd)
                .writeInt(-1)
                .writeString("")
                .writeInt(1000)
                .addBooleanAnnotation((byte) 1, true)
                .writeByteArray(zenModeConfig.toZenPolicy().toProto())
                .build());
  ...
  public final void ruleToProtoLocked(int i, ZenModeConfig.ZenRule zenRule, boolean z, List list) {
    ...
    SysUiStatsEvent$Builder addBooleanAnnotation =
        this.mStatsEventBuilderFactory
            .newBuilder()
            .setAtomId(FrameworkStatsLog.DND_MODE_RULE)
            .writeInt(i)
            .writeBoolean(zenRule.enabled)
            .writeBoolean(false)
            .writeInt(zenRule.zenMode)
            .writeString(str)
            .writeInt(getPackageUid(pkg, i))
            .addBooleanAnnotation((byte) 1, true);
    ...
    if (this.mRulesUidCache.get(packageUserKey) == null) {
      try {
        this.mRulesUidCache.put(
            packageUserKey, Integer.valueOf(this.mPm.getPackageUidAsUser(str, i)));
      } catch (PackageManager.NameNotFoundException unused) {
      }
    }
  ...
  public final class RingerModeDelegate implements AudioManagerInternal.RingerModeDelegate {
    ...
    public int onSetRingerModeInternal(
      ...
      if (i7 == 0
          || (i7 == 1
              && !ZenModeConfig.areAllPriorityOnlyRingerSoundsMuted(zenModeHelper2.mConfig))) {
      ...
      if (i2 != 0) {
        if (i2 == 1 || i2 == 2) {
          if (!z
              || i != 0
              || ((i5 = (zenModeHelper = ZenModeHelper.this).mZenMode) != 2
                  && i5 != 3
                  && (i5 != 1
                      || !ZenModeConfig.areAllPriorityOnlyRingerSoundsMuted(
                          zenModeHelper.mConfig)))) {
      ...
      if (i6 != -1) {
        ZenModeHelper.this.setManualZenMode(
            i6, null, "ringerModeInternal", null, false, 1000, true);
      }
      if (z || i6 != -1 || i3 != i4) {
    ...
    public int onSetRingerModeExternal(
        int i, int i2, String str, int i3, VolumePolicy volumePolicy) {
      int i4;
      int i5 = 0;
      boolean z = i != i2;
  ...
  public final class SettingsObserver extends ContentObserver {
    ...
    public void observe() {
      ZenModeHelper.this
          .mContext
          .getContentResolver()
          .registerContentObserver(this.ZEN_MODE, false, this);
      update(null);
    }
  ...
  */
  public final void showZenUpgradeNotification(int i) {
    ...
    if (this.mIsBootComplete
        ...
        && Settings.Secure.getInt(
                this.mContext.getContentResolver(), "show_zen_upgrade_notification", 0)
            != 0) {
      z = true;
    }
    z = false;
  ...
  public Notification createZenUpgradeNotification() {
    ...
    bundle.putString(
        "android.substName", this.mContext.getResources().getString(R.string.mediasize_iso_a4));
    if (NotificationManager.Policy.areAllVisualEffectsSuppressed(
        getConsolidatedNotificationPolicy().suppressedVisualEffects)) {
      i = 17043449;
      i2 = 17043448;
      i3 = R.drawable.ic_contact_picture_180_holo_light;
    } else {
      i = 17043447;
      i2 = 17043446;
    ...
    return new Notification.Builder(this.mContext, SystemNotificationChannels.DO_NOT_DISTURB)
        ...
        .setContentIntent(PendingIntent.getActivity(this.mContext, 0, intent, 201326592))
        .setAutoCancel(true)
        .setLocalOnly(true)
        .addExtras(bundle)
    ...
    public final void emitRules() {
      ...
      synchronized (ZenModeHelper.this.mConfig) {
        ...
        if (i != size || elapsedRealtime > 60000) {
          if (i != -1) {
            MetricsLogger.count(
                ZenModeHelper.this.mContext, "dnd_rule_count", size - this.mNumZenRules);
          }
    ...
    public final void emitDndType() {
      ...
      synchronized (ZenModeHelper.this.mConfig) {
        ...
        if (i != i2 || j > 60000) {
          if (i2 != -1) {
            MetricsLogger.count(
                zenModeHelper.mContext, "dnd_type_" + this.mPreviousZenType, (int) j);
          }
  ...
  public final class HandlerC2036H extends Handler {
    public HandlerC2036H(Looper looper) {
      super(looper);
    }
