...
public class ConditionProviders extends ManagedServices {
        ...
        synchronized (this.mMutex) {
            ...
            for (int i2 = 0; i2 < this.mRecords.size(); i2++) {
                ...
                if (dumpFilter == null || dumpFilter.matches(conditionRecord.component)) {
                    ...
                    String tryParseDescription = CountdownConditionProvider.tryParseDescription(conditionRecord.f1715id);
    ...
    public void loadDefaultsFromConfig() {
        String string = this.mContext.getResources().getString(R.string.date_picker_day_of_week_typeface);
        if (string != null) {
    ...
    public final ConditionRecord getRecordLocked(Uri uri, ComponentName componentName, boolean z) {
        if (uri != null && componentName != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (conditionRecord.f1715id.equals(uri) && conditionRecord.component.equals(componentName)) {
    ...
    public final void subscribeLocked(ConditionRecord conditionRecord) {
        ...
        if (provider != null) {
            try {
                Slog.d(this.TAG, "Subscribing to " + conditionRecord.f1715id + " with " + conditionRecord.component);
    ...
    public class ConditionRecord {
        ...
        public String toString() {
            return "ConditionRecord[id=" + this.f1715id + ",component=" + this.component + ",subscribed=" + this.subscribed + ']';
        }
    }
}
