...
public interface NotificationChannelLogger {
  ...
  void logNotificationChannel(
      NotificationChannelEvent notificationChannelEvent,
  ...
  void logNotificationChannelGroup(
      NotificationChannelEvent notificationChannelEvent,
  ...
  default void logNotificationChannelCreated(
      NotificationChannel notificationChannel, int i, String str) {
    logNotificationChannel(
        NotificationChannelEvent.getCreated(notificationChannel),
        notificationChannel,
        i,
        str,
        0,
  ...
  default void logNotificationChannelDeleted(
      NotificationChannel notificationChannel, int i, String str) {
    logNotificationChannel(
        NotificationChannelEvent.getDeleted(notificationChannel),
        notificationChannel,
        i,
        str,
        getLoggingImportance(notificationChannel),
  ...
  default void logNotificationChannelModified(
    ...
    logNotificationChannel(
        NotificationChannelEvent.getUpdated(z),
        notificationChannel,
        i,
        str,
        i2,
  ...
  default void logNotificationChannelGroup(
      NotificationChannelGroup notificationChannelGroup, int i, String str, boolean z, boolean z2) {
    logNotificationChannelGroup(
        NotificationChannelEvent.getGroupUpdated(z), notificationChannelGroup, i, str, z2);
  }

  default void logNotificationChannelGroupDeleted(
      NotificationChannelGroup notificationChannelGroup, int i, String str) {
    logNotificationChannelGroup(
