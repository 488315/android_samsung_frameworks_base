...
public class CustomToastRecord extends ToastRecord {
  ...
  public boolean show() {
    ...
    try {
      ...
      Slog.w(
          "NotificationService",
          "Object died trying to show custom toast " + this.token + " in package " + this.pkg);
  ...
  public void hide() {
    try {
      ...
      Slog.w(
          "NotificationService",
          "Object died trying to hide custom toast " + this.token + " in package " + this.pkg);
    }
  }
