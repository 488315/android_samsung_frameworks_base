...
public final class NotificationRecord {
    ...
    public final Light calculateLights() {
        int color = this.mContext.getResources().getColor(R.color.datepicker_default_pressed_text_color_material_light);
        int integer = this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceColorTemperatureFilterHorizon);
        int integer2 = this.mContext.getResources().getInteger(R.integer.config_displayWhiteBalanceColorTemperatureDefault);
