    ...
    public abstract class API {
        public static void putLogs(Context context, List list) {
            ...
            while (it.hasNext()) {
                ...
                hashMap.put(
                        "cancel_reason",
                        String.valueOf(collectionContract$Notification$Log.cancelReason));
                hashMap.put("tag", String.valueOf(collectionContract$Notification$Log.tag));
                hashMap.put(
                        "enqueued_time_ms",
                        String.valueOf(collectionContract$Notification$Log.enqueuedTimeMs));
                hashMap.put(
                        "canceled_time_ms",
                        String.valueOf(collectionContract$Notification$Log.canceledTimeMs));
                hashMap.put(
