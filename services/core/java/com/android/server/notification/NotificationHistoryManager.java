...
public class NotificationHistoryManager {
  ...
  public void cleanupHistoryFiles() {
    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < size; i++) {
        if (this.mUserUnlockedStates.valueAt(i)
            && (notificationHistoryDatabase =
                    (NotificationHistoryDatabase)
                        this.mUserState.get(this.mUserUnlockedStates.keyAt(i)))
                != null) {
  ...
  public void deleteNotificationHistoryItem(String str, int i, long j) {
    synchronized (this.mLock) {
      ...
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.w(
            "NotificationHistory",
            "Attempted to remove notif for locked/gone/disabled user " + userId);
        return;
      }
  ...
  public void deleteConversations(String str, int i, Set set) {
    synchronized (this.mLock) {
      ...
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.w(
            "NotificationHistory",
            "Attempted to remove conversation for locked/gone/disabled user " + userId);
        return;
      }
  ...
  public void deleteNotificationChannel(String str, int i, String str2) {
    synchronized (this.mLock) {
      ...
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.w(
            "NotificationHistory",
            "Attempted to remove channel for locked/gone/disabled user " + userId);
        return;
      }
  ...
  public void triggerWriteToDisk() {
    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        if (this.mUserUnlockedStates.get(keyAt)
            && (notificationHistoryDatabase =
                    (NotificationHistoryDatabase) this.mUserState.get(keyAt))
                != null) {
  ...
  public void addNotification(
      final NotificationHistory.HistoricalNotification historicalNotification) {
    Binder.withCleanCallingIdentity(
        new FunctionalUtils
            .ThrowingRunnable() { // from class:
                                  // com.android.server.notification.NotificationHistoryManager$$ExternalSyntheticLambda0
  ...
  public /* synthetic */ void lambda$addNotification$0(
    ...
    synchronized (this.mLock) {
      NotificationHistoryDatabase userHistoryAndInitializeIfNeededLocked =
          getUserHistoryAndInitializeIfNeededLocked(historicalNotification.getUserId());
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.w(
            "NotificationHistory",
  ...
  public void updateNotificationItems(
      int i, int i2, NotificationHistory.HistoricalNotification historicalNotification) {
    synchronized (this.mLock) {
      NotificationHistoryDatabase userHistoryAndInitializeIfNeededLocked =
          getUserHistoryAndInitializeIfNeededLocked(i2);
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.i(
            "NotificationHistory",
            "Attempted to update history for locked/gone/disabled user " + i2);
        return;
      }
  ...
  public NotificationHistory readFilteredNotificationHistoryForPackage(
      int i, String str, String str2, int i2) {
    synchronized (this.mLock) {
      NotificationHistoryDatabase userHistoryAndInitializeIfNeededLocked =
          getUserHistoryAndInitializeIfNeededLocked(i);
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.i(
            "NotificationHistory", "Attempted to read history for locked/gone/disabled user " + i);
        return new NotificationHistory();
      }
      NotificationHistory readNotificationHistoryForPackage =
          userHistoryAndInitializeIfNeededLocked.readNotificationHistoryForPackage(str, str2, i2);
      for (NotificationHistory.HistoricalNotification historicalNotification :
          readNotificationHistoryForPackage.getNotificationsToWrite()) {
        if (historicalNotification.getIcon() == null) {
          Slog.e("NotificationHistory", "check notification to delete : " + historicalNotification);
          userHistoryAndInitializeIfNeededLocked.deleteNotificationHistoryItem(
              historicalNotification.getPackage(), historicalNotification.getPostedTimeMs());
        }
      }
  ...
  public NotificationHistory readFilteredNotificationHistoryForDump(int i, String str, int i2) {
    synchronized (this.mLock) {
      ...
      if (userHistoryAndInitializeIfNeededLocked == null) {
        Slog.i(
            "NotificationHistory",
            "Attempted to read history(for dump) for locked/gone/disabled user " + i);
        return new NotificationHistory();
      }
  ...
  public final NotificationHistoryDatabase getUserHistoryAndInitializeIfNeededLocked(int i) {
    ...
    if (notificationHistoryDatabase == null) {
      notificationHistoryDatabase =
          NotificationHistoryDatabaseFactory.create(
              this.mContext,
              IoThread.getHandler(),
      ...
      if (this.mUserUnlockedStates.get(i)) {
        try {
          ...
          Slog.w(
              "NotificationHistory",
              "Attempted to initialize service for stopped or removed user " + i);
          return null;
        }
      } else {
        Slog.w(
  ...
  public final class SettingsObserver extends ContentObserver {
    ...
    public void observe() {
      NotificationHistoryManager.this
          .mContext
          .getContentResolver()
          .registerContentObserver(this.NOTIFICATION_HISTORY_URI, false, this, -1);
    ...
    public void update(Uri uri, int i) {
      ...
      if (uri == null || this.NOTIFICATION_HISTORY_URI.equals(uri)) {
        int intForUser =
            Settings.Secure.getIntForUser(contentResolver, "notification_history_enabled", 1, i);
