...
public class PreferencesHelper implements RankingConfig {
    ...
    */
    public final void restorePackage(TypedXmlPullParser typedXmlPullParser, boolean z, int i, String str, boolean z2, boolean z3, ArrayList arrayList, ArrayList arrayList2) {
        String str2;
        int i2;
        String str3;
        int attributeInt;
        ...
        try {
            ...
            try {
                if (z) {
                    ...
                    i2 = attributeInt2;
                    if ((z2 || i2 == UNKNOWN_UID || this.mAppOps.noteOpNoThrow(24, i2, str, (String) null, "check-notif-bubble") != 0) ? false : true) {
                        str3 = null;
                    ...
                    String str7 = str3;
                    String str8 = "uid";
                    PackagePreferences orCreatePackagePreferencesLocked = getOrCreatePackagePreferencesLocked(str, i, i2, attributeInt3, typedXmlPullParser.getAttributeInt(str3, "priority", 0), typedXmlPullParser.getAttributeInt(str3, LauncherConfigurationInternal.KEY_SUPPLEMENT_SERVICE_PAGE_VISIBILITY_BOOLEAN, -1000), typedXmlPullParser.getAttributeBoolean(str3, "show_badge", true), attributeInt, typedXmlPullParser.getAttributeBoolean(str3, "allow_edge_lighting", true), typedXmlPullParser.getAttributeBoolean(str3, "allow_sub_display_noti", false));
                    orCreatePackagePreferencesLocked.priority = typedXmlPullParser.getAttributeInt(str7, "priority", 0);
                    int attributeInt4 = typedXmlPullParser.getAttributeInt(str7, LauncherConfigurationInternal.KEY_SUPPLEMENT_SERVICE_PAGE_VISIBILITY_BOOLEAN, -1000);
                    ...
                    orCreatePackagePreferencesLocked.showBadge = typedXmlPullParser.getAttributeBoolean(str7, "show_badge", true);
                    orCreatePackagePreferencesLocked.lockedAppFields = typedXmlPullParser.getAttributeInt(str7, "app_user_locked_fields", 0);
                    orCreatePackagePreferencesLocked.hasSentInvalidMessage = typedXmlPullParser.getAttributeBoolean(str7, "sent_invalid_msg", false);
                    orCreatePackagePreferencesLocked.hasSentValidMessage = typedXmlPullParser.getAttributeBoolean(str7, "sent_valid_msg", false);
                    orCreatePackagePreferencesLocked.userDemotedMsgApp = typedXmlPullParser.getAttributeBoolean(str7, "user_demote_msg_app", false);
                    orCreatePackagePreferencesLocked.allowEdgeLighting = typedXmlPullParser.getAttributeBoolean(str7, "allow_edge_lighting", true);
                    orCreatePackagePreferencesLocked.allowSubDisplayNoti = typedXmlPullParser.getAttributeBoolean(str7, "allow_sub_display_noti", false);
                    orCreatePackagePreferencesLocked.isNotificationAlertsEnabled = typedXmlPullParser.getAttributeBoolean(str7, "notification_alerts_enabled", true);
                    orCreatePackagePreferencesLocked.muteByWearable = typedXmlPullParser.getAttributeInt(str7, "mute_for_wearable_app", -1);
                    orCreatePackagePreferencesLocked.appLockScreenVisibility = typedXmlPullParser.getAttributeInt(str7, "app_lockscreen_visibility", -1000);
                    orCreatePackagePreferencesLocked.isAllowPopup = typedXmlPullParser.getAttributeBoolean(str7, "allow_popup", true);
                    orCreatePackagePreferencesLocked.reminder = typedXmlPullParser.getAttributeBoolean(str7, "enable_reminder", false);
                    if (arrayList2 == null) {
                    ...
                    if (NmRune.NM_SUPPORT_HIDE_CONTENT_CONVERSATION_PACKAGE) {
                        ...
                        preferencesHelper = this;
                        i3 = 1;
                        if (preferencesHelper.mHideContentXmlVersion == 0 && preferencesHelper.mDeviceFirstApiLevel >= 33 && preferencesHelper.mAllowList.contains(orCreatePackagePreferencesLocked.pkg)) {
                            orCreatePackagePreferencesLocked.appLockScreenVisibility = 0;
                            Slog.d(str2, "restore appLockScreenVisibility pkg: " + orCreatePackagePreferencesLocked.pkg);
                            ...
                            while (true) {
                                ...
                                if (next != 3 && next != 4) {
                                    ...
                                    if (!"channel".equals(name)) {
                                        ...
                                        str5 = "name";
                                        str6 = name;
                                        restoreChannel(typedXmlPullParser, z, orCreatePackagePreferencesLocked, z4, preferencesHelper.hasNotificationChannelsBypassingDnd(orCreatePackagePreferencesLocked.pkg, orCreatePackagePreferencesLocked.uid));
                                    } else if (i5 == 0) {
                                    ...
                                    if ("delegate".equals(str6)) {
                                        ...
                                        String readStringAttribute = XmlUtils.readStringAttribute(typedXmlPullParser, str5);
                                        orCreatePackagePreferencesLocked.delegate = (attributeInt5 == UNKNOWN_UID || TextUtils.isEmpty(readStringAttribute)) ? str7 : new Delegate(readStringAttribute, attributeInt5, typedXmlPullParser.getAttributeBoolean(str7, "enabled", true));
                                        str8 = str4;
                                        i3 = 1;
                                    }
                                }
                            ...
                            if (z3) {
                                ...
                                if (i6 != UNKNOWN_UID) {
                                    ...
                                    arrayList.add(new PermissionHelper.PackagePermission(str9, userId, z5, preferencesHelper.hasUserConfiguredSettings(orCreatePackagePreferencesLocked)));
                                    return;
                                }
                                return;
                            }
                ...
                PackagePreferences orCreatePackagePreferencesLocked2 = getOrCreatePackagePreferencesLocked(str, i, i2, attributeInt3, typedXmlPullParser.getAttributeInt(str3, "priority", 0), typedXmlPullParser.getAttributeInt(str3, LauncherConfigurationInternal.KEY_SUPPLEMENT_SERVICE_PAGE_VISIBILITY_BOOLEAN, -1000), typedXmlPullParser.getAttributeBoolean(str3, "show_badge", true), attributeInt, typedXmlPullParser.getAttributeBoolean(str3, "allow_edge_lighting", true), typedXmlPullParser.getAttributeBoolean(str3, "allow_sub_display_noti", false));
                orCreatePackagePreferencesLocked2.priority = typedXmlPullParser.getAttributeInt(str7, "priority", 0);
                int attributeInt42 = typedXmlPullParser.getAttributeInt(str7, LauncherConfigurationInternal.KEY_SUPPLEMENT_SERVICE_PAGE_VISIBILITY_BOOLEAN, -1000);
                orCreatePackagePreferencesLocked2.visibility = attributeInt42;
                if (z) {
                }
                z4 = false;
                orCreatePackagePreferencesLocked2.showBadge = typedXmlPullParser.getAttributeBoolean(str7, "show_badge", true);
                orCreatePackagePreferencesLocked2.lockedAppFields = typedXmlPullParser.getAttributeInt(str7, "app_user_locked_fields", 0);
                orCreatePackagePreferencesLocked2.hasSentInvalidMessage = typedXmlPullParser.getAttributeBoolean(str7, "sent_invalid_msg", false);
                orCreatePackagePreferencesLocked2.hasSentValidMessage = typedXmlPullParser.getAttributeBoolean(str7, "sent_valid_msg", false);
                orCreatePackagePreferencesLocked2.userDemotedMsgApp = typedXmlPullParser.getAttributeBoolean(str7, "user_demote_msg_app", false);
                orCreatePackagePreferencesLocked2.allowEdgeLighting = typedXmlPullParser.getAttributeBoolean(str7, "allow_edge_lighting", true);
                orCreatePackagePreferencesLocked2.allowSubDisplayNoti = typedXmlPullParser.getAttributeBoolean(str7, "allow_sub_display_noti", false);
                orCreatePackagePreferencesLocked2.isNotificationAlertsEnabled = typedXmlPullParser.getAttributeBoolean(str7, "notification_alerts_enabled", true);
                orCreatePackagePreferencesLocked2.muteByWearable = typedXmlPullParser.getAttributeInt(str7, "mute_for_wearable_app", -1);
                orCreatePackagePreferencesLocked2.appLockScreenVisibility = typedXmlPullParser.getAttributeInt(str7, "app_lockscreen_visibility", -1000);
                orCreatePackagePreferencesLocked2.isAllowPopup = typedXmlPullParser.getAttributeBoolean(str7, "allow_popup", true);
                orCreatePackagePreferencesLocked2.reminder = typedXmlPullParser.getAttributeBoolean(str7, "enable_reminder", false);
                if (arrayList2 == null) {
                }
                if (NmRune.NM_SUPPORT_HIDE_CONTENT_CONVERSATION_PACKAGE) {
                }
    ...
    public final boolean createDefaultChannelIfNeededLocked(PackagePreferences packagePreferences) {
        ...
        if (packagePreferences.channels.containsKey("miscellaneous")) {
            ((NotificationChannel) packagePreferences.channels.get("miscellaneous")).setName(this.mContext.getString(R.string.fingerprint_udfps_error_not_match));
            return false;
        }
        if (!shouldHaveDefaultChannel(packagePreferences)) {
            return false;
        }
        NotificationChannel notificationChannel = new NotificationChannel("miscellaneous", this.mContext.getString(R.string.fingerprint_udfps_error_not_match), packagePreferences.importance);
    ...
    */
    public void createNotificationChannelGroup(String str, int i, NotificationChannelGroup notificationChannelGroup, boolean z, int i2, boolean z2) {
        ...
        synchronized (this.mPackagePreferences) {
            ...
            NotificationChannelGroup notificationChannelGroup2 = (NotificationChannelGroup) orCreatePackagePreferencesLocked.groups.get(notificationChannelGroup.getId());
    ...
    public boolean createNotificationChannel(String str, int i, NotificationChannel notificationChannel, boolean z, boolean z2, int i2, boolean z3) {
        ...
        synchronized (this.mPackagePreferences) {
            ...
            if (notificationChannel.getGroup() != null && !orCreatePackagePreferencesLocked.groups.containsKey(notificationChannel.getGroup())) {
                throw new IllegalArgumentException("NotificationChannelGroup doesn't exist : pkg=" + str + ", channel group=" + notificationChannel.getGroup());
            }
    ...
    public final void lockChannelsForOEMwithPackagePreferences(PackagePreferences packagePreferences) {
        ...
        if (this.mCscConfigNoneBlockableList.size() > 0) {
            for (String str : (String[]) this.mCscConfigNoneBlockableList.toArray(new String[this.mCscConfigNoneBlockableList.size()])) {
                if (!TextUtils.isEmpty(str) && (split = str.split(com.android.internal.util.jobs.XmlUtils.STRING_ARRAY_SEPARATOR)) != null && split.length > 0) {
                    String str2 = split[0];
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void dumpPackagePreferencesLocked(PrintWriter printWriter, String str, NotificationManagerService.DumpFilter dumpFilter, ArrayMap arrayMap, ArrayMap arrayMap2) {
        boolean z;
        boolean z2;
        boolean z3;
        ...
        while (true) {
            ...
            if (dumpFilter.matches(packagePreferences.pkg)) {
                ...
                if (arrayMap2 != null && keySet.contains(pair)) {
                    ...
                    printWriter.print(NotificationListenerService.Ranking.importanceToString(((Boolean) ((Pair) arrayMap2.get(pair)).first).booleanValue() ? 3 : 0));
                    ...
                    if (((Boolean) ((Pair) arrayMap2.get(pair)).first).booleanValue()) {
                        ...
                        if (this.mPermissionHelper.isPermissionFixed(packagePreferences.pkg, userId)) {
                            ...
                            try {
                                z = false;
                                try {
                                    ApplicationInfo applicationInfoAsUser = this.mPm.getApplicationInfoAsUser(packagePreferences.pkg, 0, userId);
                                    z2 = (applicationInfoAsUser.flags & 1) != 0;
                                    try {
                                        z3 = applicationInfoAsUser.isSignedWithPlatformKey();
                                    } catch (PackageManager.NameNotFoundException unused) {
                                        Slog.d("NotificationPrefHelper", "NameNotFoundException pkg " + packagePreferences.pkg);
                                        z3 = z;
                                        if (z2) {
                                        }
                                        if (z3) {
        ...
        if (keySet != null) {
            for (Pair pair2 : keySet) {
                if (dumpFilter.matches((String) pair2.second)) {
                    ...
                    printWriter.print(')');
                    printWriter.print(" importance=");
                    printWriter.print(NotificationListenerService.Ranking.importanceToString(((Boolean) ((Pair) arrayMap2.get(pair2)).first).booleanValue() ? 3 : 0));
                    printWriter.print(" userSet=");
        ...
        synchronized (this.mPackagePreferences) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (UserHandle.getUserId(packagePreferences.uid) == i && packagePreferences.channels.containsKey("miscellaneous")) {
                    ((NotificationChannel) packagePreferences.channels.get("miscellaneous")).setName(context.getResources().getString(R.string.fingerprint_udfps_error_not_match));
                }
            }
        }
    }
