...
public class ManagedApplicationService {
  ...
  public final Runnable mRetryRunnable =
  ...
  public class LogEvent implements LogFormattable {
    ...
    public static String eventToString(int i) {
      return i != 1
          ? i != 2
              ? i != 3
                  ? i != 4 ? "Unknown Event Occurred" : "Permanently Stopped"
                  : "Binding Died For"
              : "Disconnected"
          : "Connected";
    }
  ...
  public static ManagedApplicationService build(
      Context context,
      ComponentName componentName,
      int i,
      int i2,
      ...
      Handler handler,
      EventCallback eventCallback) {
    return new ManagedApplicationService(
        context, componentName, i, i2, str, binderChecker, z, i3, handler, eventCallback);
  }
  ...
  public void connect() {
    synchronized (this.mLock) {
      ...
      ServiceConnectionC27681 serviceConnectionC27681 = new ServiceConnectionC27681();
      this.mConnection = serviceConnectionC27681;
      try {
        if (!this.mContext.bindServiceAsUser(
            component,
            serviceConnectionC27681,
  ...
  public class ServiceConnectionC27681 implements ServiceConnection {
    public ServiceConnectionC27681() {}
    ...
    public void onBindingDied(ComponentName componentName) {
      ...
      synchronized (ManagedApplicationService.this.mLock) {
        ...
        ManagedApplicationService.this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.utils.ManagedApplicationService$1$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
                ManagedApplicationService.ServiceConnectionC27681.this.lambda$onBindingDied$0(
                    currentTimeMillis);
              }
            });
    ...
    public /* synthetic */ void lambda$onBindingDied$0(long j) {
      ManagedApplicationService.this.mEventCb.onServiceEvent(
          new LogEvent(j, ManagedApplicationService.this.mComponent, 3));
    }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      ...
      synchronized (ManagedApplicationService.this.mLock) {
        ...
        ManagedApplicationService.this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.utils.ManagedApplicationService$1$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
                ManagedApplicationService.ServiceConnectionC27681.this.lambda$onServiceConnected$1(
                    currentTimeMillis);
              }
            });
        ...
        if (ManagedApplicationService.this.mChecker != null) {
          ...
          managedApplicationService.mBoundInterface =
              managedApplicationService.mChecker.asInterface(iBinder);
          if (!ManagedApplicationService.this.mChecker.checkType(
              ManagedApplicationService.this.mBoundInterface)) {
            ManagedApplicationService.this.mBoundInterface = null;
    ...
    public /* synthetic */ void lambda$onServiceConnected$1(long j) {
      ManagedApplicationService.this.mEventCb.onServiceEvent(
          new LogEvent(j, ManagedApplicationService.this.mComponent, 1));
    }
    ...
    public void onServiceDisconnected(ComponentName componentName) {
      ...
      synchronized (ManagedApplicationService.this.mLock) {
        ...
        ManagedApplicationService.this.mHandler.post(
            new Runnable() { // from class:
                             // com.android.server.utils.ManagedApplicationService$1$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
                ManagedApplicationService.ServiceConnectionC27681.this
                    .lambda$onServiceDisconnected$2(currentTimeMillis);
              }
            });
        ManagedApplicationService.this.mBoundInterface = null;
        ManagedApplicationService.this.startRetriesLocked();
    ...
    public /* synthetic */ void lambda$onServiceDisconnected$2(long j) {
      ManagedApplicationService.this.mEventCb.onServiceEvent(
          new LogEvent(j, ManagedApplicationService.this.mComponent, 2));
    }
  }
  ...
  public final boolean checkAndDeliverServiceDiedCbLocked() {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
                         // com.android.server.utils.ManagedApplicationService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
            ManagedApplicationService.this.lambda$checkAndDeliverServiceDiedCbLocked$0(
                currentTimeMillis);
          }
        });
    return true;
