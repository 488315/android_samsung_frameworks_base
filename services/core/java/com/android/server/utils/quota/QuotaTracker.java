...
public abstract class QuotaTracker {
  public static final String ALARM_TAG_QUOTA_CHECK =
      "*" + QuotaTracker.class.getSimpleName() + ".quota_check*";
  ...
  public QuotaTracker(Context context, Categorizer categorizer, Injector injector) {
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.utils.quota.QuotaTracker.1
          ...
          public void onReceive(Context context2, Intent intent) {
            ...
            if (action.equals("android.intent.action.PACKAGE_FULLY_REMOVED")) {
              ...
              synchronized (QuotaTracker.this.mLock) {
                QuotaTracker.this.onAppRemovedLocked(
                    UserHandle.getUserId(intExtra2), getPackageName(intent));
              }
            }
          }
        };
    ...
    context.registerReceiverAsUser(
        broadcastReceiver, UserHandle.ALL, intentFilter, null, BackgroundThread.getHandler());
    context.registerReceiverAsUser(
        broadcastReceiver,
        UserHandle.ALL,
  ...
  public boolean isQuotaFreeLocked(int i, String str) {
    return this.mIsQuotaFree
        || ((Boolean) this.mFreeQuota.getOrDefault(i, str, Boolean.FALSE)).booleanValue();
  }
  ...
  public /* synthetic */ void lambda$scheduleAlarm$0(
      int i, long j, String str, AlarmManager.OnAlarmListener onAlarmListener) {
  ...
  public void scheduleQuotaCheck() {
    BackgroundThread.getHandler()
        .post(
            new Runnable() { // from class:
                             // com.android.server.utils.quota.QuotaTracker$$ExternalSyntheticLambda2
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void postQuotaStatusChanged(final int i, final String str, final String str2) {
    BackgroundThread.getHandler()
        .post(
            new Runnable() { // from class:
                             // com.android.server.utils.quota.QuotaTracker$$ExternalSyntheticLambda0
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public /* synthetic */ void lambda$postQuotaStatusChanged$3(int i, String str, String str2) {
    ...
    synchronized (this.mLock) {
      ...
      quotaChangeListenerArr =
          (QuotaChangeListener[]) arraySet.toArray(new QuotaChangeListener[arraySet.size()]);
    }
  ...
  public void maybeScheduleStartAlarmLocked(int i, String str, String str2) {
    ...
    if (isWithinQuota(i, str, str2)) {
      ...
      this.mInQuotaAlarmQueue.addAlarm(
          new Uptc(i, str, str2), getInQuotaTimeElapsedLocked(i, str, str2));
    }
  }
    ...
    public void removeAlarms(final int i, final String str) {
      removeAlarmsIf(
          new Predicate() { // from class:
                            // com.android.server.utils.quota.QuotaTracker$InQuotaAlarmQueue$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$removeAlarms$0;
              lambda$removeAlarms$0 =
                  QuotaTracker.InQuotaAlarmQueue.lambda$removeAlarms$0(i, str, (Uptc) obj);
