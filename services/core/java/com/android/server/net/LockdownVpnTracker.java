...
public class LockdownVpnTracker {
    ...
    public final void showNotification(int i, int i2) {
        this.mNotificationManager.notify(null, 20, new Notification.Builder(this.mContext, "VPN").setWhen(0L).setSmallIcon(i2).setContentTitle(this.mContext.getString(i)).setContentText(this.mContext.getString(17043243)).setContentIntent(this.mConfigIntent).setOngoing(true).addAction(R.drawable.ic_menu_login, this.mContext.getString(17042406), this.mResetIntent).setColor(this.mContext.getColor(R.color.system_notification_accent_color)).build());
    }
