...
public class WatchlistLoggingHandler extends Handler {
  ...
  public void handleMessage(Message message) {
    ...
    if (i == 1) {
      ...
      handleNetworkEvent(
          data.getString("host"),
          data.getStringArray("ipAddresses"),
          data.getInt("uid"),
  ...
  public final void insertRecord(int i, String str, long j) {
    ...
    if ((this.mConfig.isConfigSecure() || isPackageTestOnly(i))
        && (digestFromUid = getDigestFromUid(i)) != null
        && this.mDbHelper.insertNewRecord(digestFromUid, str, j)) {
  ...
  public final void tryAggregateRecords(long j) {
    ...
    try {
      ...
      if (dropBoxManager == null || !dropBoxManager.isTagEnabled("network_watchlist_report")) {
        ...
        byte[] encodeWatchlistReport =
            ReportEncoder.encodeWatchlistReport(
                this.mConfig,
                this.mSettings.getPrivacySecretKey(),
                getAllDigestsForReport(aggregatedRecords),
                aggregatedRecords);
  ...
  public List getAllDigestsForReport(WatchlistReportDbHelper.AggregatedResult aggregatedResult) {
    List<ApplicationInfo> installedApplications =
        this.mContext
            .getPackageManager()
            .getInstalledApplications(IInstalld.FLAG_CLEAR_APP_DATA_KEEP_ART_PROFILES);
    HashSet hashSet =
        new HashSet(installedApplications.size() + aggregatedResult.appDigestCNCList.size());
    ...
    return (byte[])
        this.mCachedUidDigestMap.computeIfAbsent(
            ...
            new Function() { // from class:
                             // com.android.server.net.watchlist.WatchlistLoggingHandler$$ExternalSyntheticLambda0
              @Override // java.util.function.Function
              public final Object apply(Object obj) {
                byte[] lambda$getDigestFromUid$0;
                lambda$getDigestFromUid$0 =
                    WatchlistLoggingHandler.this.lambda$getDigestFromUid$0(i, (Integer) obj);
  ...
  public /* synthetic */ byte[] lambda$getDigestFromUid$0(int i, Integer num) {
    ...
    if (!ArrayUtils.isEmpty(packagesForUid)) {
      for (String str : packagesForUid) {
        try {
          String str2 =
              this.mPm.getPackageInfoAsUser(str, 786432, userId).applicationInfo.publicSourceDir;
