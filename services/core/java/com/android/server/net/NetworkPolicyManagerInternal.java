...
public abstract class NetworkPolicyManagerInternal {
  ...
  public static int updateBlockedReasonsWithProcState(int i, int i2) {
    return NetworkPolicyManagerService.UidBlockedState.getEffectiveBlockedReasons(
        i, NetworkPolicyManagerService.UidBlockedState.getAllowedReasonsForProcState(i2));
  }
}
