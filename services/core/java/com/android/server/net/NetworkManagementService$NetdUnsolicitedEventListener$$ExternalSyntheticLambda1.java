...
class NetworkManagementService$NetdUnsolicitedEventListener$$ExternalSyntheticLambda1
        implements Runnable {
    ...
    public /* synthetic */
    NetworkManagementService$NetdUnsolicitedEventListener$$ExternalSyntheticLambda1(
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                AuditLog.log(
                        ...
                        XmlUtils$$ExternalSyntheticOutline0.m("Interface ", str, " is untethered"));
            ...
            default:
                ...
                AuditLog.log(
                        ...
                        Process.myPid(),
                        "NetworkManagementService",
                        XmlUtils$$ExternalSyntheticOutline0.m("Interface ", str2, " is tethered"));
                int beginBroadcast2 = networkManagementService2.mObservers.beginBroadcast();
                for (int i2 = 0; i2 < beginBroadcast2; i2++) {
                    try {
                        networkManagementService2
                                .mObservers
                                .getBroadcastItem(i2)
                                .interfaceAdded(str2);
