...
public class AppPrelaunchManagerService extends SystemService {
  ...
  public void initPrelauncher(
      SpegService spegService, ActivityManagerService activityManagerService) {
    if (!CoreRune.SYSFW_APP_PREL) {
      Slog.i("PREL", "Prelaunch service is disabled");
      return;
    }
    AppPrelaunchService appPrelaunchService =
        new AppPrelaunchService(getContext(), spegService, activityManagerService);
