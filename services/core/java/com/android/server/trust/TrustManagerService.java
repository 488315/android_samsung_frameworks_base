...
public class TrustManagerService extends SystemService {
    ...
    */
    public final void updateTrustWithRenewableUnlock(int i, int i2, boolean z, AndroidFuture androidFuture) {
        boolean z2;
        boolean z3;
        boolean z4;
        boolean z5;
    ...
    */
                    ...
                    TrustManagerService.this.mHandler.runWithScissors(new Runnable() { // from class: com.android.server.trust.TrustManagerService.1.1
                        ...
                        public void run() {
                            ...
                            for (UserInfo userInfo : aliveUsers) {
                                ...
                                iTrustManagerStubC26951.dumpUser(printWriter, userInfo, userInfo.id == TrustManagerService.this.mCurrentUser);
                            }
                        }
                    }, 1500L);
                }
        ...
        public void setDeviceLockedForUser(int i, boolean z) {
            ...
            try {
                if (DualDarManager.isOnDeviceOwner(i)) {
                    ...
                    DDLog.m33d("TrustManagerService", "setDeviceLocked for DualDAR DO. locked state : " + z, new Object[0]);
                    TrustManagerService.this.handleDualDARDeviceLockedChangedForUser(i, z);
                } else if (i == 0 && !z) {
                    DDLog.m33d("TrustManagerService", "setDeviceLocked false and update DualDAR user state", new Object[0]);
    ...
    public final void handleDualDARDeviceLockedChangedForUser(int i, boolean z) {
        ...
        if (PersonaServiceHelper.isDualDAREnabled()) {
            DDLog.m33d("TrustManagerService", "handleDualDARDeviceLockedChangedForUser() - userId : " + i + ", locked : " + z, new Object[0]);
    ...
    public final void updateDualDARStateAndUnlockIfNeeded(int i) {
        int dualDARUser;
        DDLog.m33d("TrustManagerService", "updateDualDARStateAndUnlockIfNeeded() - userId : " + i, new Object[0]);
        if (PersonaServiceHelper.isDualDAREnabled()) {
            ...
            DDLog.m33d("TrustManagerService", "Trying to unlock DualDAR user (TMS), isSecure? " + keyguardManager.isDeviceSecure(dualDARUser), new Object[0]);
            if (DualDarManager.isOnDeviceOwner(i)) {
                ...
                if (!DualDarManager.getInstance(this.mContext).isInnerLayerUnlocked(i) || SemPersonaManager.isDarDualEncrypted(i)) {
                    if (onPassword2Auth(dualDARUser) == VerifyCredentialResponse.OK) {
                        DDLog.m33d("TrustManagerService", "Inner layer for user " + i + " authenticated", new Object[0]);
                        return;
                    }
                    DDLog.m34e("TrustManagerService", "Failed in inner layer authentication for user " + i, new Object[0]);
                    return;
                }
                return;
            }
            ...
            DDLog.m33d("TrustManagerService", "Trying to unlock DualDAR user " + dualDARUser, new Object[0]);
            if (onPassword2Auth(dualDARUser) == VerifyCredentialResponse.OK) {
                try {
                    DDLog.m33d("TrustManagerService", "fetch outer layer key and unlock DualDAR user " + dualDARUser, new Object[0]);
                    ActivityManager.getService().unlockUser(dualDARUser, (byte[]) null, fetchOuterLayerKey(dualDARUser), (IProgressListener) null);
                    return;
                } catch (Exception e) {
                    e.printStackTrace();
                    DDLog.m34e("TrustManagerService", "Failed to unlock DualDAR user !" + dualDARUser, new Object[0]);
                    return;
                }
            }
            DDLog.m34e("TrustManagerService", "Default Authentication Failure by DualDAR client", new Object[0]);
        }
    }
    ...
    public final VerifyCredentialResponse onPassword2Auth(int i) {
        ...
        if (!SemPersonaManager.isDarDualEncryptionEnabled(i)) {
            DDLog.m34e("TrustManagerService", "User is not DualDAR eligible. so no need to verify DualDAR Passwords" + i, new Object[0]);
