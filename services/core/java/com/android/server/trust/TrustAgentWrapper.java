...
public class TrustAgentWrapper {
  ...
  public class HandlerC26913 extends Handler {
    public HandlerC26913() {}
    ...
    public void handleMessage(Message message) {
      ...
      switch (message.what) {
        case 1:
          if (!TrustAgentWrapper.this.isConnected()) {
            Log.w(
                "TrustAgentWrapper",
                "Agent is not connected, cannot grant trust: "
                    + TrustAgentWrapper.this.mName.flattenToShortString());
            return;
          }
          ...
          if ((i2 & 4) != 0) {
            ...
            androidFuture.thenAccept(
                new Consumer() { // from class:
                                 // com.android.server.trust.TrustAgentWrapper$3$$ExternalSyntheticLambda0
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
                    TrustAgentWrapper.HandlerC26913.this.lambda$handleMessage$0(
                        (GrantTrustResult) obj);
                  }
                });
          } else {
          ...
          if (j2 > 0) {
            if (TrustAgentWrapper.this.mMaximumTimeToLock != 0) {
              ...
              if (TrustAgentWrapper.DEBUG) {
                Slog.d(
                    "TrustAgentWrapper",
                    "DPM lock timeout in effect. Timeout adjusted from " + j2 + " to " + j);
              }
            } else {
              j = j2;
            }
            ...
            trustAgentWrapper.mAlarmPendingIntent =
                PendingIntent.getBroadcast(
                    trustAgentWrapper.mContext, 0, TrustAgentWrapper.this.mAlarmIntent, 301989888);
            TrustAgentWrapper.this.mAlarmManager.set(
                2, elapsedRealtime, TrustAgentWrapper.this.mAlarmPendingIntent);
          }
          TrustAgentWrapper.this.mTrustManagerService.mArchive.logGrantTrust(
              TrustAgentWrapper.this.mUserId,
              TrustAgentWrapper.this.mName,
              TrustAgentWrapper.this.mMessage != null
                  ? TrustAgentWrapper.this.mMessage.toString()
                  : null,
              j2,
              i2);
          TrustAgentWrapper.this.mTrustManagerService.updateTrust(
              TrustAgentWrapper.this.mUserId, i2, androidFuture);
          return;
        case 2:
          break;
        case 3:
          if (TrustAgentWrapper.DEBUG) {
            Slog.d(
                "TrustAgentWrapper",
                "Trust timed out : " + TrustAgentWrapper.this.mName.flattenToShortString());
          }
          TrustAgentWrapper.this.mTrustManagerService.mArchive.logTrustTimeout(
              TrustAgentWrapper.this.mUserId, TrustAgentWrapper.this.mName);
          TrustAgentWrapper.this.onTrustTimeout();
          break;
        case 4:
          Slog.w(
              "TrustAgentWrapper",
              "Connection attempt to agent "
                  + TrustAgentWrapper.this.mName.flattenToShortString()
                  + " timed out, rebinding");
          TrustAgentWrapper.this.destroy();
          TrustAgentWrapper.this.mTrustManagerService.resetAgent(
              TrustAgentWrapper.this.mName, TrustAgentWrapper.this.mUserId);
          return;
        case 5:
          ...
          if (TrustAgentWrapper.this.mSetTrustAgentFeaturesToken == iBinder) {
            ...
            if (TrustAgentWrapper.DEBUG) {
              Slog.d(
                  "TrustAgentWrapper",
                  "Re-enabling agent because it acknowledged enabled features: "
                      + TrustAgentWrapper.this.mName.flattenToShortString());
            }
            TrustAgentWrapper.this.mTrustDisabledByDpm = false;
            TrustAgentWrapper.this.mTrustManagerService.updateTrust(
                TrustAgentWrapper.this.mUserId, 0);
            return;
          }
          if (TrustAgentWrapper.DEBUG) {
            Slog.w(
                "TrustAgentWrapper",
                "Ignoring MSG_SET_TRUST_AGENT_FEATURES_COMPLETED with obsolete token: "
                    + TrustAgentWrapper.this.mName.flattenToShortString());
            return;
          }
          return;
        case 6:
          ...
          TrustAgentWrapper.this.mTrustManagerService.mArchive.logManagingTrust(
              TrustAgentWrapper.this.mUserId,
              TrustAgentWrapper.this.mName,
              TrustAgentWrapper.this.mManagingTrust);
          TrustAgentWrapper.this.mTrustManagerService.updateTrust(
              TrustAgentWrapper.this.mUserId, 0);
          return;
        case 7:
          ...
          long addEscrowToken =
              TrustAgentWrapper.this.mTrustManagerService.addEscrowToken(byteArray, i3);
          try {
            if (TrustAgentWrapper.this.mTrustAgentService != null) {
              TrustAgentWrapper.this.mTrustAgentService.onEscrowTokenAdded(
                  byteArray, addEscrowToken, UserHandle.of(i3));
            } else {
              z = false;
            }
            z2 = z;
        ...
        case 8:
          ...
          boolean removeEscrowToken =
              TrustAgentWrapper.this.mTrustManagerService.removeEscrowToken(
                  j3, message.getData().getInt("user_id"));
          try {
            if (TrustAgentWrapper.this.mTrustAgentService != null) {
        ...
        case 9:
          ...
          boolean isEscrowTokenActive =
              TrustAgentWrapper.this.mTrustManagerService.isEscrowTokenActive(
                  j4, message.getData().getInt("user_id"));
          try {
            if (TrustAgentWrapper.this.mTrustAgentService != null) {
        ...
        case 10:
          TrustAgentWrapper.this.mTrustManagerService.unlockUserWithToken(
              message.getData().getLong("handle"),
              message.getData().getByteArray("escrow_token"),
              message.getData().getInt("user_id"));
          return;
        case 11:
          TrustAgentWrapper.this.mTrustManagerService.showKeyguardErrorMessage(
              message.getData().getCharSequence("message"));
          return;
        case 12:
          TrustAgentWrapper.this.mTrusted = false;
          TrustAgentWrapper.this.mTrustable = false;
      ...
      if (message.what == 2) {
        TrustAgentWrapper.this.mTrustManagerService.mArchive.logRevokeTrust(
            TrustAgentWrapper.this.mUserId, TrustAgentWrapper.this.mName);
      }
  ...
  public TrustAgentWrapper(
      Context context,
      TrustManagerService trustManagerService,
      Intent intent,
      UserHandle userHandle) {
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.trust.TrustAgentWrapper.1
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent2) {
            if (TrustManagerService.ENABLE_ACTIVE_UNLOCK_FLAG
                && "android.intent.action.SCREEN_OFF".equals(intent2.getAction())) {
    ...
    BroadcastReceiver broadcastReceiver2 =
        new BroadcastReceiver() { // from class: com.android.server.trust.TrustAgentWrapper.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent2) {
            ComponentName componentName =
                (ComponentName) intent2.getParcelableExtra("componentName", ComponentName.class);
            if ("android.server.trust.TRUST_EXPIRED_ACTION".equals(intent2.getAction())
                && TrustAgentWrapper.this.mName.equals(componentName)) {
              TrustAgentWrapper.this.mHandler.removeMessages(3);
    ...
    this.mHandler = new HandlerC26913();
    this.mCallback =
        new ITrustAgentServiceCallback
            .Stub() { // from class: com.android.server.trust.TrustAgentWrapper.4
          public void grantTrust(
              CharSequence charSequence, long j, int i, AndroidFuture androidFuture) {
            if (TrustAgentWrapper.DEBUG) {
              Slog.d(
                  "TrustAgentWrapper",
                  "enableTrust("
            ...
            Message obtainMessage =
                TrustAgentWrapper.this.mHandler.obtainMessage(
                    1, i, 0, Pair.create(charSequence, androidFuture));
          ...
          public void showKeyguardErrorMessage(CharSequence charSequence) {
            if (TrustAgentWrapper.DEBUG) {
              Slog.d(
                  "TrustAgentWrapper",
                  "Showing keyguard error message: " + ((Object) charSequence));
            }
    ...
    ServiceConnection serviceConnection =
        new ServiceConnection() { // from class: com.android.server.trust.TrustAgentWrapper.5
          @Override // android.content.ServiceConnection
          public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            if (TrustAgentWrapper.DEBUG) {
              Slog.d(
                  "TrustAgentWrapper", "TrustAgent started : " + componentName.flattenToString());
            }
            TrustAgentWrapper.this.mHandler.removeMessages(4);
            TrustAgentWrapper.this.mTrustAgentService =
                ITrustAgentService.Stub.asInterface(iBinder);
            TrustAgentWrapper.this.mTrustManagerService.mArchive.logAgentConnected(
                TrustAgentWrapper.this.mUserId, componentName);
            TrustAgentWrapper trustAgentWrapper = TrustAgentWrapper.this;
            ...
            if (TrustAgentWrapper.this.mTrustManagerService.isDeviceLockedInner(
                TrustAgentWrapper.this.mUserId)) {
          ...
          public void onServiceDisconnected(ComponentName componentName) {
            if (TrustAgentWrapper.DEBUG) {
              Slog.d(
                  "TrustAgentWrapper",
                  "TrustAgent disconnected : " + componentName.flattenToShortString());
            }
            TrustAgentWrapper.this.mTrustAgentService = null;
            TrustAgentWrapper.this.mManagingTrust = false;
            TrustAgentWrapper.this.mSetTrustAgentFeaturesToken = null;
            TrustAgentWrapper.this.mTrustManagerService.mArchive.logAgentDied(
                TrustAgentWrapper.this.mUserId, componentName);
            TrustAgentWrapper.this.mHandler.sendEmptyMessage(2);
    ...
    Intent putExtra =
        new Intent("android.server.trust.TRUST_EXPIRED_ACTION")
            .putExtra("componentName", component);
    ...
    boolean bindServiceAsUser =
        context.bindServiceAsUser(intent, serviceConnection, 67108865, userHandle);
    this.mBound = bindServiceAsUser;
    if (bindServiceAsUser) {
      context.registerReceiver(
          broadcastReceiver2, intentFilter, "android.permission.PROVIDE_TRUST_AGENT", null, 2);
  ...
  */
      ...
      if (this.mTrustAgentService != null) {
        ...
        if ((devicePolicyManager.getKeyguardDisabledFeatures(null, this.mUserId) & 16) != 0) {
          List trustAgentConfiguration =
              devicePolicyManager.getTrustAgentConfiguration(null, this.mName, this.mUserId);
          z = true;
          if (z2) {
            try {
              Slog.d(
                  "TrustAgentWrapper",
                  "Detected trust agents disabled. Config = " + trustAgentConfiguration);
            } catch (RemoteException e) {
              e = e;
              onError(e);
          ...
          if (trustAgentConfiguration != null && trustAgentConfiguration.size() > 0) {
            if (z2) {
              Slog.d(
                  "TrustAgentWrapper",
                  "TrustAgent "
                      + this.mName.flattenToShortString()
                      + " disabled until it acknowledges "
  ...
  public final void setSecurityWindowTimer() {
    ...
    this.mAlarmManager.setExact(
        ...
        "TrustAgentWrapper",
        new AlarmManager
            .OnAlarmListener() { // from class: com.android.server.trust.TrustAgentWrapper.6
