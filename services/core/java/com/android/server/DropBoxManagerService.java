...
public final class DropBoxManagerService extends SystemService {
    ...
    */
    ...
    public final void getLowPriorityResourceConfigs() {
        this.mLowPriorityRateLimitPeriod = Resources.getSystem().getInteger(R.integer.config_jobSchedulerInactivityIdleThresholdOnStablePower);
        String[] stringArray = Resources.getSystem().getStringArray(R.array.device_state_notification_thermal_contents);
