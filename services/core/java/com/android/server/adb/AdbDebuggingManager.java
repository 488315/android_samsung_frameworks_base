...
public class AdbDebuggingManager {
  ...
  public static final Ticker SYSTEM_TICKER = new Ticker() { // from class:
        // com.android.server.adb.AdbDebuggingManager$$ExternalSyntheticLambda0
  ...
  class PairingThread extends Thread implements NsdManager.RegistrationListener {
    ...
    public PairingThread(String str, String str2) {
      ...
      this.mPort = -1;
      this.mNsdManager =
          (NsdManager) AdbDebuggingManager.this.mContext.getSystemService("servicediscovery");
    }
          ...
          while (true) {
            ...
            if (b == 80 && bArr[1] == 75) {
              ...
              if (b2 == 0) {
                ...
                Slog.e(
                    AdbDebuggingManager.TAG,
                    "Got unknown transport type from adbd (" + ((int) b2) + ")");
              }
            } else {
              if (b != 87 || bArr[1] != 70) {
                break;
              ...
              if (b3 == 0) {
                ...
                Slog.d(
                    AdbDebuggingManager.TAG, "Received WIFI TLS disconnect key message: " + str5);
                ...
                Slog.e(
                    AdbDebuggingManager.TAG,
                    "Got unknown transport type from adbd (" + ((int) b3) + ")");
              }
            }
          }
          Slog.e(
  ...
  public class AdbDebuggingHandler extends Handler {
    ...
    public final boolean isTv() {
      return AdbDebuggingManager.this
          .mContext
          .getPackageManager()
    ...
    public final void setupNotifications() {
      ...
      NotificationManager notificationManager =
          (NotificationManager) AdbDebuggingManager.this.mContext.getSystemService("notification");
      ...
      if (notificationManager == null) {
        ...
        this.mNotificationManager.createNotificationChannel(
            new NotificationChannel(
                ...
                AdbDebuggingManager.this.mContext.getString(R.string.beforeOneMonthDurationPast),
                4));
      }
    }
    ...
    public AdbDebuggingHandler(Looper looper, AdbDebuggingThread adbDebuggingThread) {
            ...
            public void onReceive(Context context, Intent intent) {
              ...
              if ("android.net.wifi.STATE_CHANGE".equals(action)) {
                NetworkInfo networkInfo =
                    (NetworkInfo) intent.getParcelableExtra("networkInfo", NetworkInfo.class);
                if (networkInfo.getType() == 1) {
                  ...
                  synchronized (AdbDebuggingManager.this.mAdbConnectionInfo) {
                    if (!bssid.equals(AdbDebuggingManager.this.mAdbConnectionInfo.getBSSID())) {
                      Slog.i(
                          AdbDebuggingManager.TAG,
                          "Detected wifi network change. Disabling adbwifi.");
                      Settings.Global.putInt(
                          AdbDebuggingManager.this.mContentResolver, "adb_wifi_enabled", 0);
                    }
                  }
      ...
      this.mAuthTimeObserver =
          new ContentObserver(this) { // from class:
    ...
    public void showAdbConnectedNotification(boolean z) {
      ...
      if (!this.mAdbNotificationShown) {
        Notification createNotification =
            AdbNotifications.createNotification(AdbDebuggingManager.this.mContext, (byte) 1);
      ...
      switch (message.what) {
        ...
        case 3:
          ...
          if (AdbDebuggingManager.this.mThread != null) {
            ...
            if (r3) {
              ...
              this.mAdbKeyStore.setLastConnectionTime(
                  str, AdbDebuggingManager.this.mTicker.currentTimeMillis());
              AdbDebuggingManager.this.sendPersistKeyStoreMessage();
              scheduleJobToUpdateAdbKeyStore();
            }
          ...
          if (Settings.Global.getInt(
            ...
            try {
              ...
              SystemService.waitForState(
                  ...
                  AdbDebuggingManager.ADBD_STATE_CHANGE_TIMEOUT);
        ...
        case 7:
          ...
          if (str3 != null && str3.length() > 0) {
            if (AdbDebuggingManager.this.mConnectedKeys.containsKey(str3)) {
              int intValue =
                  ((Integer) AdbDebuggingManager.this.mConnectedKeys.get(str3)).intValue() - 1;
              if (intValue == 0) {
                this.mAdbKeyStore.setLastConnectionTime(
                    str3, AdbDebuggingManager.this.mTicker.currentTimeMillis());
                AdbDebuggingManager.this.sendPersistKeyStoreMessage();
                scheduleJobToUpdateAdbKeyStore();
            ...
            Slog.w(
                AdbDebuggingManager.TAG, "Received a disconnected key message with an empty key");
          }
        ...
        case 10:
          ...
          if (!AdbDebuggingManager.this.mConnectedKeys.containsKey(str4)) {
            ...
            AdbDebuggingManager.this.mConnectedKeys.put(
                str4,
                Integer.valueOf(
                    ((Integer) AdbDebuggingManager.this.mConnectedKeys.get(str4)).intValue() + 1));
          }
          this.mAdbKeyStore.setLastConnectionTime(
              str4, AdbDebuggingManager.this.mTicker.currentTimeMillis());
          AdbDebuggingManager.this.sendPersistKeyStoreMessage();
          scheduleJobToUpdateAdbKeyStore();
        ...
        case 15:
          ...
          AdbDebuggingManager.this.mPairingThread =
              AdbDebuggingManager.this.new PairingThread(createPairingCode, null);
        ...
        case 16:
          ...
          AdbDebuggingManager.this.mPairingThread =
              ...
              .new PairingThread(bundle.getString("password"), bundle.getString("serviceName"));
          AdbDebuggingManager.this.mPairingThread.start();
          return;
        case 17:
    ...
    public final void onPairingResult(String str) {
      ...
      AdbDebuggingManager.sendBroadcastWithDebugPermission(
          AdbDebuggingManager.this.mContext, intent2, UserHandle.ALL);
      this.mAdbKeyStore.setLastConnectionTime(
          str, AdbDebuggingManager.this.mTicker.currentTimeMillis());
      AdbDebuggingManager.this.sendPersistKeyStoreMessage();
      scheduleJobToUpdateAdbKeyStore();
  ...
  public final void startConfirmationForNetwork(String str, String str2) {
    ...
    String string =
        Resources.getSystem().getString(R.string.conversation_title_fallback_group_chat);
    ComponentName unflattenFromString = ComponentName.unflattenFromString(string);
    UserInfo userInfo = UserManager.get(this.mContext).getUserInfo(currentUser);
    if (startConfirmationActivity(unflattenFromString, userInfo.getUserHandle(), arrayList)
        || startConfirmationService(unflattenFromString, userInfo.getUserHandle(), arrayList)) {
      return;
    }
    Slog.e(
        str3,
  ...
  public final void startConfirmationForKey(String str, String str2) {
    ...
    UserInfo userInfo =
        UserManager.get(this.mContext).getUserInfo(ActivityManager.getCurrentUser());
    if (userInfo.isAdmin()) {
      string = this.mConfirmComponent;
      if (string == null) {
        string =
            Resources.getSystem().getString(R.string.conversation_single_line_image_placeholder);
      }
    } else {
      string = Resources.getSystem().getString(R.string.conversation_single_line_name_display);
    }
    ComponentName unflattenFromString = ComponentName.unflattenFromString(string);
    if (startConfirmationActivity(unflattenFromString, userInfo.getUserHandle(), arrayList)
        || startConfirmationService(unflattenFromString, userInfo.getUserHandle(), arrayList)) {
  ...
  public final void writeKeys(Iterable iterable) {
    ...
    try {
      ...
      FileUtils.setPermissions(
          this.mUserKeyFile.toString(), FrameworkStatsLog.DISPLAY_HBM_STATE_CHANGED, -1, -1);
    } catch (IOException e2) {
      e = e2;
  ...
  public void setAdbEnabled(boolean z, byte b) {
    if (b == 0) {
      ...
      throw new IllegalArgumentException(
          "setAdbEnabled called with unimplemented transport type=" + ((int) b));
    }
  }
  ...
  public void dump(DualDumpOutputStream dualDumpOutputStream, String str, long j) {
    ...
    try {
      dualDumpOutputStream.write(
          "system_keys", 1138166333444L, FileUtils.readTextFile(new File("/adb_keys"), 0, null));
    } catch (IOException e2) {
      Slog.i(TAG, "Cannot read system keys", e2);
    }
    try {
      dualDumpOutputStream.write(
          "keystore", 1138166333445L, FileUtils.readTextFile(this.mTempKeysFile, 0, null));
  ...
  public class AdbKeyStore {
        ...
        if (this.mAtomicKeyFile == null) {
          Slog.e(
              ...
              "Unable to obtain the key file, "
                  + AdbDebuggingManager.this.mTempKeysFile
                  + ", for reading");
          return;
        }
      }
          ...
          try {
            try {
              ...
              if (attributeInt > 1) {
                Slog.e(
                    AdbDebuggingManager.TAG,
                    "Keystore version=" + attributeInt + " not supported (max_supported=1)");
                if (openRead != null) {
                  openRead.close();
                  return;
                }
    ...
    public final void addAdbKeyToKeyMap(TypedXmlPullParser typedXmlPullParser) {
      ...
      try {
        this.mKeyMap.put(
            attributeValue,
            Long.valueOf(typedXmlPullParser.getAttributeLong((String) null, "lastConnection")));
    ...
    public final void addExistingUserKeysToKeyStore() {
      if (AdbDebuggingManager.this.mUserKeyFile == null
          || !AdbDebuggingManager.this.mUserKeyFile.exists()) {
        return;
      }
      boolean z = false;
      try {
        BufferedReader bufferedReader =
            new BufferedReader(new FileReader(AdbDebuggingManager.this.mUserKeyFile));
        while (true) {
          try {
            String readLine = bufferedReader.readLine();
            if (readLine == null) {
              ...
              this.mKeyMap.put(
                  readLine, Long.valueOf(AdbDebuggingManager.this.mTicker.currentTimeMillis()));
              z = true;
            }
          } finally {
          }
        ...
        Slog.e(
            AdbDebuggingManager.TAG,
            "Caught an exception reading " + AdbDebuggingManager.this.mUserKeyFile + ": " + e);
      }
      if (z) {
        AdbDebuggingManager.this.sendPersistKeyStoreMessage();
      }
      ...
      try {
        ...
        for (Map.Entry entry : this.mKeyMap.entrySet()) {
          ...
          resolveSerializer.attributeLong(
              (String) null, "lastConnection", ((Long) entry.getValue()).longValue());
    ...
    public final boolean filterOutOldKeys() {
      ...
      while (it.hasNext()) {
        if (currentTimeMillis
            > ((Long) ((Map.Entry) it.next()).getValue()).longValue() + allowedConnectionTime) {
          it.remove();
          z = true;
        }
      }
    ...
    public void setLastConnectionTime(String str, long j, boolean z) {
      if ((!this.mKeyMap.containsKey(str) || ((Long) this.mKeyMap.get(str)).longValue() < j || z)
          && !this.mSystemKeys.contains(str)) {
