...
public abstract class DesktopModeSettings {
  ...
  public static Uri getUriAsUser(int i) {
    return Uri.parse(
        "content://" + i + "@com.sec.android.desktopmode.uiservice.SettingsProvider/settings");
  }
  ...
  public static Bundle getAllSettingsAsUser(ContentResolver contentResolver, int i) {
    try {
      ...
      Log.m9e(TAG, "Failed to get settings", e);
      return null;
    }
  }
  ...
  public static String getSettingsAsUser(
      ContentResolver contentResolver, String str, String str2, int i) {
    try {
  ...
  public static String getSettingsAsUserOrThrowException(
      ContentResolver contentResolver, String str, String str2, int i) {
  ...
  public static boolean getSettingsAsUser(
      ContentResolver contentResolver, String str, boolean z, int i) {
  ...
  public static float getSettingsAsUser(
      ContentResolver contentResolver, String str, float f, int i) {
  ...
  public static String getSettingsOrThrowException(
  ...
  public static void setSettingsAsUserOrThrowException(
      ContentResolver contentResolver, String str, String str2, int i) {
    Bundle bundle = new Bundle(2);
    bundle.putString("key", str);
  ...
  public static void setSettingsAsUser(
      ContentResolver contentResolver, String str, String str2, int i) {
    try {
      setSettingsAsUserOrThrowException(contentResolver, str, str2, i);
    } catch (IllegalArgumentException e) {
      Log.m9e(TAG, "Failed to set settings", e);
    }
  }
  ...
  public static void setSettingsOrThrowException(
      ContentResolver contentResolver, String str, String str2) {
    setSettingsAsUserOrThrowException(contentResolver, str, str2, sCurrentUserId);
  }

  public static void setSettingsOrThrowException(
      ContentResolver contentResolver, String str, int i) {
  ...
  public static void deleteSettingsAsUserOrThrowException(
      ContentResolver contentResolver, String str, int i) {
  ...
  public static void deleteSettingsAsUser(ContentResolver contentResolver, String str, int i) {
    try {
      ...
      Log.m9e(TAG, "Failed to delete settings", e);
    }
  }
  ...
  public static void deleteAllSettingsAsUserOrThrowException(
      ContentResolver contentResolver, int i) {
  ...
  public static void clearSettingsAsUser(ContentResolver contentResolver, int i) {
    try {
      ...
      Log.m9e(TAG, "Failed to clear Dex settings", e);
    }
  }

  public static void dumpApp(
  ...
  public static void dump(
    ...
    indentingPrintWriter.println(
        "Current " + DesktopModeSettings.class.getSimpleName() + " state:");
    ...
    indentingPrintWriter.println(
        "Current user ("
            + i
            + ") settings="
            + Utils.bundleToString(getAllSettingsAsUser(contentResolver, i)));
    if (i != 0) {
      indentingPrintWriter.println(
          "System user (0) settings"
              + Utils.bundleToString(getAllSettingsAsUser(contentResolver, 0)));
    }
