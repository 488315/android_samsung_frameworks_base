...
public abstract class Log {
  ...
  /* renamed from: d */
  public static int m7d(String str, String str2) {
    save('D', str, str2);
    return android.util.Log.d(str, str2);
  }

  /* renamed from: e */
  public static int m8e(String str, String str2) {
    save('E', str, str2);
    return android.util.Log.e(str, str2);
  }

  /* renamed from: e */
  public static int m9e(String str, String str2, Throwable th) {
    save('E', str, str2);
    return android.util.Log.e(str, str2, th);
  }

  /* renamed from: i */
  public static int m10i(String str, String str2) {
    save('I', str, str2);
    return android.util.Log.i(str, str2);
  }

  /* renamed from: v */
  public static int m11v(String str, String str2) {
    save('V', str, str2);
  ...
  public static void saveState(
      State state, BlockerManager.DesktopModeBlockerInfo desktopModeBlockerInfo) {
    SAVED_STATES.add(
        buildLogString(
            'W',
            "[DMS]State",
            "(enter) State=" + state + ", blocked by " + desktopModeBlockerInfo));
  }
