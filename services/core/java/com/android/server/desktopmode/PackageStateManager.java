...
public final class PackageStateManager extends PackageMonitor {
    ...
    public final class StateListener extends StateManager.StateListener {
        ...
        public final void onDualModeSetDesktopModeInternal(boolean z) {
            ...
            packageStateManager.setSettingsComponent(
                    ((StateManager) packageStateManager.mStateManager).getState());
            PackageStateManager.m417$$Nest$msetComponent(
                    packageStateManager,
                    "com.sec.android.desktopmode.uiservice.activity.touchpad.TouchpadActivity",
                    z);
        }
    ...
    public static void m417$$Nest$msetComponent(
            PackageStateManager packageStateManager, String str, boolean z) {
        packageStateManager.getClass();
        if (DesktopModeFeature.DEBUG) {
            Log.d(
                    "[DMS]PackageStateManager",
                    "setComponent(component= " + str + ", enabled=" + z + ")");
        }
        try {
            packageStateManager.mPackageManager.setComponentEnabledSetting(
                    ComponentName.createRelative("com.sec.android.desktopmode.uiservice", str),
                    z ? 1 : 2,
                    1,
                    ((StateManager) packageStateManager.mStateManager).getState().mCurrentUserId,
                    "");
            ...
            ApplicationInfo applicationInfoAsUser =
                    this.mContext
                            ...
                            .getApplicationInfoAsUser(
                                    str,
                                    0,
                                    ((StateManager) this.mStateManager).getState().mCurrentUserId);
    ...
    public final void setSettingsComponent(StateManager.InternalState internalState) {
        ...
        int i2 = (i == 3 || i == 4) ? 1 : 0;
        for (String str :
                this.mContext.getResources().getStringArray(R.array.config_default_vm_number)) {
            ComponentName unflattenFromString = ComponentName.unflattenFromString(str);
            if (unflattenFromString != null) {
                try {
                    if (this.mPackageManager.isPackageAvailable(
                            unflattenFromString.getPackageName(), internalState.mCurrentUserId)) {
                        this.mPackageManager.setComponentEnabledSetting(
                                unflattenFromString, i2, 1, internalState.mCurrentUserId, "");
                    }
        ...
        synchronized (this.mLock) {
            try {
                ...
                if (isPackageAvailable
                        == ((Boolean) ((ArrayMap) this.mPackageState).get(str)).booleanValue()) {
                    return false;
                }
