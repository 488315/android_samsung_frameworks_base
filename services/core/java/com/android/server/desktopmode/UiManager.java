...
public class UiManager {
  ...
  public final Runnable mBindServiceRunnable = new Runnable() { // from class:
        // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
        public final void run() {
          UiManager.this.bindService();
        }
      };
  public final Runnable mUnbindServiceRunnable = new Runnable() { // from class:
        // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda3
        @Override // java.lang.Runnable
        public final void run() {
          UiManager.this.unbindServiceIfHasNoUiElement();
        }
      };
  public final Runnable mDeferredConnectionCallback = new Runnable() { // from class:
        // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda4
        @Override // java.lang.Runnable
        public final void run() {
  ...
  public /* synthetic */ void lambda$new$0() {
    Log.m12w(
        TAG,
        "Binder supposed established connection but actual connection to service timed out, trying"
            + " again");
  ...
  public class ServiceConnectionC11511 implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName componentName, final IBinder iBinder) {
      Utils.runOnHandlerThread(
          ...
          new Runnable() { // from class:
            // com.android.server.desktopmode.UiManager$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onNullBinding(final ComponentName componentName) {
      Utils.runOnHandlerThread(
          UiManager.this.mHandler,
          new Runnable() { // from class:
            // com.android.server.desktopmode.UiManager$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onBindingDied(final ComponentName componentName) {
      Utils.runOnHandlerThread(
          UiManager.this.mHandler,
          new Runnable() { // from class:
            // com.android.server.desktopmode.UiManager$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public UiManager(Context context, ServiceThread serviceThread, IStateManager iStateManager) {
    StateManager.StateListener stateListener =
        new StateManager.StateListener() { // from class: com.android.server.desktopmode.UiManager.2
    ...
    this.mDeathRecipient =
        new IBinder.DeathRecipient() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda5
  ...
  public void setCurrentUserId(final int i) {
    Utils.runOnHandlerThread(
        this.mHandler,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda14
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void showDialog(final int i, final int i2, final InternalUiCallback internalUiCallback) {
    ...
    this.mHandler.schedule(
        i2,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$showDialogOnUiService$5(
      final int i, final int i2, final InternalUiCallback internalUiCallback) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(
          TAG,
          "handleShowDialog(), displayId="
              + i
              + ", dialogType="
              + DesktopModeUiConstants.typeToString(i2));
    }
    Runnable runnable = new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda12
          @Override // java.lang.Runnable
          public final void run() {
    ...
    if (bindUiServiceWithPendingCommand(900, i2, i, runnable)) {
      ...
      switch (i2) {
        ...
        case 3:
          stub =
              new IDesktopModeUiServiceCallback
                  .Stub() { // from class: com.android.server.desktopmode.UiManager.4
                public void onAnimationComplete() {}
        ...
        case 10:
          stub =
              new IDesktopModeUiServiceCallback
                  .Stub() { // from class: com.android.server.desktopmode.UiManager.3
                public void onAnimationComplete() {}
                ...
                public void onClickButtonPositive() {
                  if (internalUiCallback != null) {
                    ...
                    uiCommandHandler.post(
                        new Runnable() { // from class:
                          // com.android.server.desktopmode.UiManager$3$$ExternalSyntheticLambda0
                          @Override // java.lang.Runnable
                          public final void run() {
                ...
                public void onClickButtonNegative() {
                  if (internalUiCallback != null) {
                    ...
                    uiCommandHandler.post(
                        new Runnable() { // from class:
                          // com.android.server.desktopmode.UiManager$3$$ExternalSyntheticLambda3
                          @Override // java.lang.Runnable
                          public final void run() {
                ...
                public void onShow() {
                  if (internalUiCallback != null) {
                    ...
                    uiCommandHandler.post(
                        new Runnable() { // from class:
                          // com.android.server.desktopmode.UiManager$3$$ExternalSyntheticLambda1
                          @Override // java.lang.Runnable
                          public final void run() {
                ...
                public void onDismiss() {
                  if (internalUiCallback != null) {
                    ...
                    uiCommandHandler.post(
                        new Runnable() { // from class:
                          // com.android.server.desktopmode.UiManager$3$$ExternalSyntheticLambda2
                          @Override // java.lang.Runnable
                          public final void run() {
  ...
  public final void showDialogOnUiService(
      final int i,
      final int i2,
      final InternalUiCallback internalUiCallback,
      IDesktopModeUiServiceCallback.Stub stub) {
    IDesktopModeUiService iDesktopModeUiService = this.mService;
    if (iDesktopModeUiService != null) {
      try {
        ...
        handleRemoteException(
            ...
            i,
            new Runnable() { // from class:
              // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda21
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void dismissDialog(final int i, final int i2) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(
          TAG,
          "dismissDialog(), displayId=" + i + ", type=" + DesktopModeUiConstants.typeToString(i2));
    }
    this.mHandler.schedule(
        i2,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda11
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void showOverlay(final int i, final int i2, final InternalUiCallback internalUiCallback) {
    ...
    this.mHandler.schedule(
        i2,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda7
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$showOverlay$7(
      final int i, final int i2, final InternalUiCallback internalUiCallback) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(
          TAG,
    ...
    Runnable runnable = new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda20
          @Override // java.lang.Runnable
          public final void run() {
      ...
      try {
        this.mService.showOverlay(
            ...
            internalUiCallback != null
                ? new IDesktopModeUiServiceCallback
                    .Stub() { // from class: com.android.server.desktopmode.UiManager.5
                  public void onClickButtonNegative() {}
  ...
  public void showNotification(final int i) {
    ...
    this.mHandler.schedule(
        i,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda8
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$showNotification$10(final int i) {
    ...
    if (bindUiServiceWithPendingCommand(
        ...
        -1,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda15
          @Override // java.lang.Runnable
          public final void run() {
      ...
      if (this.mChangingStandaloneMode) {
        this.mPendingUiCommands.queue(
            ...
            -1,
            new Runnable() { // from class:
              // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda16
              @Override // java.lang.Runnable
              public final void run() {
      ...
      try {
        ...
        handleRemoteException(
            ...
            -1,
            new Runnable() { // from class:
              // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda17
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void removeNotification(final int i) {
    ...
    this.mHandler.schedule(
        i,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$removeNotification$14(final int i) {
    ...
    if (bindUiServiceWithPendingCommand(
        ...
        -1,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda18
          @Override // java.lang.Runnable
          public final void run() {
      ...
      try {
        ...
        handleRemoteException(
            ...
            -1,
            new Runnable() { // from class:
              // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda19
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void showNavBarIcon(final int i) {
    ...
    this.mHandler.schedule(
        i,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda22
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$showNavBarIcon$17(final int i) {
    ...
    if (bindUiServiceWithPendingCommand(
        ...
        -1,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda24
          @Override // java.lang.Runnable
          public final void run() {
      ...
      try {
        ...
        handleRemoteException(
            ...
            -1,
            new Runnable() { // from class:
              // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda25
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public void removeNavBarIcon(final int i) {
    ...
    this.mHandler.schedule(
        i,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda23
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$removeNavBarIcon$20(final int i) {
    ...
    if (bindUiServiceWithPendingCommand(
        ...
        -1,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda26
          @Override // java.lang.Runnable
          public final void run() {
      ...
      try {
        ...
        handleRemoteException(
            ...
            -1,
            new Runnable() { // from class:
              // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda27
              @Override // java.lang.Runnable
              public final void run() {
  ...
  public final void lambda$startActivity$23(
      final int i, final int i2, final InternalUiCallback internalUiCallback) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "handleStartActivity(), displayId=" + i + ", type=" + i2);
    }
    Runnable runnable = new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda13
          @Override // java.lang.Runnable
          public final void run() {
    ...
    if (bindUiServiceWithPendingCommand(900, i2, -1, runnable)) {
      try {
        this.mService.startActivity(
            i,
            i2,
            new IDesktopModeUiServiceCallback
                .Stub() { // from class: com.android.server.desktopmode.UiManager.6
              public void onAnimationComplete() {}
  ...
  public void finishActivity(final int i) {
    ...
    this.mHandler.schedule(
        i,
        new Runnable() { // from class:
          // com.android.server.desktopmode.UiManager$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void postUnbindServiceRunnable() {
    int i;
    if ((!this.mBound && this.mService == null)
        || (i = this.mStateManager.getState().getDesktopModeState().enabled) == 3
        || i == 4
        || i == 1) {
      return;
    }
  ...
  */
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter.println(
        "external overlay=" + DesktopModeUiConstants.typeToString(getCurrentOverlayType(103)));
    indentingPrintWriter.println(
        "internal overlay=" + DesktopModeUiConstants.typeToString(getCurrentOverlayType(102)));
      ...
      if (DesktopModeFeature.DEBUG) {
        Log.m7d(
            ...
            "schedule(), type="
                + DesktopModeUiConstants.typeToString(i)
                + ", "
                + messageIdToString(delayedUiCommandMessageId));
      }
      if (delayedUiCommandMessageId == 1) {
