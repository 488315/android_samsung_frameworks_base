...
public class DesktopModeService extends IDesktopMode.Stub {
    ...
    public final void setEnterRequestIfStandaloneLastBoot(State state) {
        if (DesktopModeSettings.getSettingsAsUser(this.mResolver, "display_type", 0, this.mCurrentUserId) == 101) {
            Log.m10i(TAG, "Request to enter standalone mode, since the standalone mode was enabled on last boot");
            setUserRequest(1);
        }
    ...
    public class PhonePreconditionChecker implements PreconditionChecker {
        ...
        public boolean isDesktopModeAvailableEx(boolean z, boolean z2) {
            ...
            if (DesktopModeFeature.DEBUG) {
                Log.m7d(DesktopModeService.TAG, "isDesktopModeAvailableEx(checkExternalDisplay=" + z + ", checkDesktopDock=" + z2 + ")=" + z3);
            }
            return z3;
        }
        ...
        public boolean updateDesktopMode(State state, boolean z, boolean z2) {
            if (DesktopModeFeature.DEBUG) {
                Log.m7d(DesktopModeService.TAG, "updateDesktopMode(), enter=" + z + ", isModeChangeLocked=" + state.isModeChangeLocked() + ", mUserRequest=" + DesktopModeService.userRequestToString(DesktopModeService.this.mUserRequest));
            }
            if (DesktopModeService.this.isSystemReady() && !state.isModeChangeLocked()) {
                ...
                if (z) {
                    if ((desktopModeState.compareTo(2, 0, 0) || desktopModeState.compareTo(2, 10, 102)) && DesktopModeService.isExternalDisplayConnectedOrForced(state) && DesktopModeService.this.isAllowedInternal(state, true, true)) {
                        ...
                        Log.m7d(DesktopModeService.TAG, "updateDesktopMode(welcomeCompleted=true, userRequest=" + DesktopModeService.userRequestToString(DesktopModeService.this.mUserRequest) + ")");
                        return false;
                    }
                } else {
    ...
    public class TabletPreconditionChecker implements PreconditionChecker {
        ...
        public boolean isDesktopModeAvailableEx(boolean z, boolean z2) {
            ...
            if (DesktopModeFeature.DEBUG) {
                Log.m7d(DesktopModeService.TAG, "isDesktopModeAvailable(checkExternalDisplay=" + z + ", checkDesktopDock=" + z2 + ")=" + isAllowed);
            }
            return isAllowed;
        }
        ...
        */
        public boolean updateDesktopMode(State state, boolean z, boolean z2) {
            if (DesktopModeFeature.DEBUG) {
                Log.m7d(DesktopModeService.TAG, "updateDesktopMode(), enter=" + z + ", isModeChangeLocked=" + state.isModeChangeLocked());
            }
            boolean z3 = false;
            if (DesktopModeService.this.isSystemReady() && !state.isModeChangeLocked()) {
                SemDesktopModeState desktopModeState = state.getDesktopModeState();
                boolean equals = "dual".equals(DesktopModeSettings.getSettings(DesktopModeService.this.mContext.getContentResolver(), "external_display_mode", "dual"));
                ...
                if (desktopModeService2.isAllowedInternal(state, true, desktopModeService2.mUserRequest == 1 || DesktopModeService.this.mEnteredViaWirelessDex)) {
                    if (!settings && DesktopModeService.this.mUserRequest == 1) {
                        DesktopModeService.this.startWelcomeActivity();
                    } else if (DesktopModeService.isExternalDisplayConnectedOrForced(state)) {
                        if (desktopModeState.compareTo(4, 0, 101) && (equals || DesktopModeService.this.mEnteredViaWirelessDex)) {
                            DesktopModeService.this.mUiManager.showOverlay(103, 115);
                            modeToModeChangeInfo = DesktopModeService.this.mStandaloneModeChanger.setDesktopMode(state, false, new ModeChanger.ModeToModeChangeInfo(DesktopModeService.this.mShowModeChangeScreen, 2));
                        } else if (desktopModeState.compareTo(2, 0, 0) || desktopModeState.compareTo(2, 10, 102)) {
                            if (DesktopModeService.this.mEnteredViaWirelessDex || ((DesktopModeService.this.mUserRequest == 1 && equals) || (DesktopModeService.this.mModeToModeChangeInfo != null && DesktopModeService.this.mModeToModeChangeInfo.getModeToMode() == 2))) {
                                ...
                                DesktopModeService.this.mDualModeChanger.setDesktopMode(state, true, DesktopModeService.this.mModeToModeChangeInfo);
                                ...
                                DesktopModeService.this.mStandaloneModeChanger.setDesktopMode(state, true, DesktopModeService.this.mModeToModeChangeInfo);
                            }
                        } else if (desktopModeState.compareTo(4, 0, 102) && !equals && !DesktopModeService.this.mEnteredViaWirelessDex) {
                            DesktopModeService.this.mUiManager.showOverlay(103, 115);
                            modeToModeChangeInfo = DesktopModeService.this.mDualModeChanger.setDesktopMode(state, false, new ModeChanger.ModeToModeChangeInfo(DesktopModeService.this.mShowModeChangeScreen, 1));
                        }
                        z3 = true;
                    } else {
        ...
        public final void showOrDismissOverlay(boolean z, boolean z2) {
            if (z && !this.mOverlayShown) {
                if (DesktopModeService.this.mCoverStateManager.isFlipTypeCoverClosed()) {
                    if (DesktopModeFeature.DEBUG) {
                        Log.m7d(DesktopModeService.TAG, "showOrDismissOverlay(), show=true, isCoverSupportStatePartial=" + z2 + ", skip showing external overlay since cover is closed");
                        return;
                    }
                    return;
                }
                if (DesktopModeFeature.DEBUG) {
                    Log.m7d(DesktopModeService.TAG, "showOrDismissOverlay(), show=true, isCoverSupportStatePartial=" + z2 + ", showing external overlay");
                }
            ...
            if (DesktopModeFeature.DEBUG) {
                Log.m7d(DesktopModeService.TAG, "showOrDismissOverlay(), show=false, isCoverSupportStatePartial=" + z2 + ", dismissing external overlay");
            }
            this.mOverlayShown = false;
    ...
    public final class LocalService extends DesktopModeManagerInternal {
        ...
        public int setDexHDMIAutoEnterState(int i) {
            ...
            try {
                ...
                Log.m8e(DesktopModeService.TAG, "setDexHDMIAutoEnterState(), Failed to setting(value=" + i + ")");
                return -1;
            }
        }
    ...
    public final void onUserUnlocking(int i) {
        if (DesktopModeFeature.DEBUG) {
            Log.m7d(TAG, "onUnlockUser(), userId=" + i + ", CurrentUser=" + ActivityManager.getCurrentUser());
        }
    ...
    public final void onUserStopping(int i) {
        if (DesktopModeFeature.DEBUG) {
            Log.m7d(TAG, "onStopUser(), userId=" + i + ", CurrentUser=" + ActivityManager.getCurrentUser());
        }
    }
    ...
    public final boolean isSystemReady() {
        ...
        Log.m10i(TAG, "isSystemReady(), mIsBootComplete=" + this.mIsBootComplete + ", isFactoryBinary=" + FactoryTest.isFactoryBinary() + ", mCurrentUserId=" + this.mCurrentUserId);
        return false;
    }
    ...
    public final boolean isConfigurationChangedFromDeX(Configuration configuration) {
        ...
        if (configuration != null && this.mStandaloneModeChanger != null) {
            ...
            Log.m10i(TAG, "isConfigurationChangedFromDeX()=" + z + ", config=" + configuration + ", desktopModeState=" + desktopModeState);
        }
        return z;
    }
            ...
            synchronized (this.mLock) {
                ...
                if (iDesktopModeLauncher != null) {
                    try {
                        ...
                        Log.m9e(TAG, "sendMessage(), Failed to communicate with launcher. Starting again...", e);
    ...
    public final boolean shouldStayInDesktopMode(State state) {
        ...
        Context context2 = this.mContext;
        ToastManager.showToast(context2, String.format(context2.getString(R.string.global_action_silent_mode_off_status), this.mContext.getString(R.string.global_actions_airplane_mode_off_status)));
        return true;
    }
