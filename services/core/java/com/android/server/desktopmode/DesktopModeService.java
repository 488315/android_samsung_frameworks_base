...
public final class DesktopModeService extends IDesktopMode.Stub {
    ...
    public final class AnonymousClass1 extends StateManager.StateListener {
                ...
                case 0:
                    ...
                    synchronized (hardwareManager.mLock) {
                        ...
                        DesktopModeSettings.setSettings(
                                hardwareManager.mResolver,
                                "dock_usbpd_ids",
                                hardwareManager.mDockState.mType);
                    }
                    CoverStateManager coverStateManager =
                            ((DesktopModeService) this.this$0).mCoverStateManager;
                    synchronized (coverStateManager.mLock) {
                        coverStateManager.mScreenMirroringDisabled =
                                DesktopModeSettings.getSettingsAsUser(
                                        coverStateManager.mContext.getContentResolver(),
                                        "mirroring_switch_disabled",
                                        false,
                                        DesktopModeSettings.sCurrentUserId);
                        coverStateManager.updateCoverSupportStateLocked();
                    }
                    StateManager.InternalState state =
                            ((StateManager) ((DesktopModeService) this.this$0).mStateManager)
                                    .getState();
                    if (DesktopModeFeature.SUPPORT_STANDALONE) {
                        DesktopModeService.m396$$Nest$mhandleHdmiAutoEnter(
                                (DesktopModeService) this.this$0,
                                state.mIsExternalDisplayConnected);
                        DesktopModeService.m397$$Nest$mhandlePogoAutoEnter(
                                (DesktopModeService) this.this$0, state.mIsPogoKeyboardConnected);
                        ((DesktopModeService) this.this$0)
                                .mHandler.postDelayed(
                                        new DesktopModeService$$ExternalSyntheticLambda2(1, this),
                                        5000L);
                        DesktopModeService.m401$$Nest$msetEnterRequestIfStandaloneLastBoot(
                                (DesktopModeService) this.this$0, state);
                    }
                    ((DesktopModeService) this.this$0).scheduleUpdateDesktopMode(true);
                    DesktopModeService.m400$$Nest$mrequestTileUpdate(
                            (DesktopModeService) this.this$0, state.mDesktopModeState);
                    return;
                default:
                    return;
            }
                ...
                case 0:
                    ...
                    if (z && desktopModeService.mEnteredViaWirelessDex) {
                        ...
                        if (i != i2) {
                            ...
                            DesktopModeSettings.setSettings(
                                    desktopModeService.mResolver, "wireless_dex", i2);
                        }
                    ...
                    DesktopModeService.m400$$Nest$mrequestTileUpdate(
                            desktopModeService, semDesktopModeState);
                    break;
            }
        }
            ...
            switch (this.$r8$classId) {
                case 0:
                    ...
                    if (!DesktopModeFeature.SUPPORT_STANDALONE) {
                        ...
                        desktopModeService.scheduleUpdateDesktopMode(
                                internalState.mIsExternalDisplayConnected);
                        break;
                    } else {
                        if (!internalState.isWirelessDexConnected()) {
                            DesktopModeService.m396$$Nest$mhandleHdmiAutoEnter(
                                    desktopModeService, internalState.isHdmiConnected());
                            desktopModeService.scheduleUpdateDesktopMode(
                                    internalState.isHdmiConnected());
                        } else if (desktopModeService.mCurrentUserId == 0
                                && desktopModeService.isSystemReady()) {
                            if (settingsAsUser) {
                ...
                default:
                    ...
                    WelcomeActivityListener welcomeActivityListener =
                            (WelcomeActivityListener) this.this$0;
                    welcomeActivityListener.showOrDismissOverlay(z, z2);
                    welcomeActivityListener.setDesktopModeState(
                            10, internalState.mIsExternalDisplayConnected);
                    break;
            }
        }
        ...
        public void onExternalDisplayUpdated(StateManager.InternalState internalState) {
            switch (this.$r8$classId) {
                case 0:
                    ...
                    if (displayInfo != null
                            && displayInfo2 != null
                            && displayInfo.mType != displayInfo2.mType) {
                        final DesktopModeService desktopModeService =
                                (DesktopModeService) this.this$0;
                        desktopModeService.mHandler.post(
                                new Runnable() { // from class:
                                                 // com.android.server.desktopmode.DesktopModeService$$ExternalSyntheticLambda4
                                    public final /* synthetic */ boolean f$1 = false;
                                    public final /* synthetic */ boolean f$2 = true;

                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        DesktopModeService desktopModeService2 =
                                                DesktopModeService.this;
                                        desktopModeService2.updateDesktopMode(
                                                ((StateManager) desktopModeService2.mStateManager)
                                                        .getState(),
                                                this.f$1,
                                                this.f$2);
                                    }
        ...
        public void onLauncherPackageReplaced(boolean z) {
            switch (this.$r8$classId) {
                case 0:
                    ...
                    if (z) {
                        desktopModeService.mSettingsHelper.clearSettingsByLauncherDataCleared(
                                state, desktopModeService.mCurrentUserId);
                    }
        ...
        public void onPackageStateChanged(StateManager.InternalState internalState) {
            switch (this.$r8$classId) {
                case 0:
                    ((DesktopModeService) this.this$0)
                            .scheduleUpdateDesktopMode(internalState.isPackagesAvailable());
                    break;
            }
        }
            ...
            switch (this.$r8$classId) {
                case 0:
                    if (DesktopModeFeature.SUPPORT_STANDALONE) {
                        DesktopModeService.m397$$Nest$mhandlePogoAutoEnter(
                                (DesktopModeService) this.this$0,
                                internalState.mIsPogoKeyboardConnected);
                        break;
                    }
                    break;
            }
        ...
        public final void onChange(boolean z) {
            switch (this.$r8$classId) {
                case 0:
                    DesktopModeService.m400$$Nest$mrequestTileUpdate(
                            this.this$0,
                            ((StateManager) this.this$0.mStateManager)
                                    .getState()
                                    .mDesktopModeState);
                    break;
                default:
    ...
    public final class AnonymousClass6 extends UiManager.InternalUiCallback {
        ...
        public final void onClickButtonPositive() {
            ...
            if (!this.val$startWelcomeActivity) {
                DesktopModeSettings.setSettings(
                        desktopModeService.mResolver, "welcome_completed", true);
            }
            desktopModeService.scheduleUpdateDesktopMode(true);
        }
        ...
        public final void onDismiss() {
            DesktopModeSettings.setSettings(
                    DesktopModeService.this.mResolver, this.val$firstConnectionKey, true);
        }
    }
    ...
    public final class Lifecycle extends SystemService {
        ...
        public final void onBootPhase(int i) {
            if (i == 500) {
                ...
                ActivityManagerService activityManagerService =
                        (ActivityManagerService) injector.get(ActivityManagerService.class);
                ActivityTaskManagerService activityTaskManagerService =
                        (ActivityTaskManagerService) injector.get(ActivityTaskManagerService.class);
                ActivityTaskManagerInternal activityTaskManagerInternal =
                        (ActivityTaskManagerInternal)
                                injector.get(ActivityTaskManagerInternal.class);
                BlockerManager blockerManager = (BlockerManager) injector.get(BlockerManager.class);
                EmergencyModeBlocker emergencyModeBlocker =
                        (EmergencyModeBlocker) injector.get(EmergencyModeBlocker.class);
                ...
                HardwareManager hardwareManager =
                        (HardwareManager) injector.get(HardwareManager.class);
                TouchpadManager touchpadManager =
                        (TouchpadManager) injector.get(TouchpadManager.class);
                CoverStateManager coverStateManager =
                        (CoverStateManager) injector.get(CoverStateManager.class);
                MultiResolutionManager multiResolutionManager =
                        (MultiResolutionManager) injector.get(MultiResolutionManager.class);
                DockManager dockManager = (DockManager) injector.get(DockManager.class);
                PackageStateManager packageStateManager =
                        (PackageStateManager) injector.get(PackageStateManager.class);
                StatusBarManager statusBarManager =
                        (StatusBarManager) injector.get(StatusBarManager.class);
                BootInitBlocker bootInitBlocker =
                        DesktopModeFeature.SUPPORT_STANDALONE
                                ? (BootInitBlocker) injector.get(BootInitBlocker.class)
                                : null;
                DisplayPortStateManager displayPortStateManager =
                        (DisplayPortStateManager) injector.get(DisplayPortStateManager.class);
                boolean z = DesktopModeFeature.SUPPORT_WIRELESS_DEX;
                this.mService.injectServices(
                        activityManagerService,
                        activityTaskManagerService,
                        activityTaskManagerInternal,
                        blockerManager,
                        emergencyModeBlocker,
                        uiManager,
                        settingsHelper,
                        hardwareManager,
                        touchpadManager,
                        ...
                        statusBarManager,
                        bootInitBlocker,
                        displayPortStateManager,
                        (z || DesktopModeFeature.SUPPORT_DEX_ON_PC)
                                ? (WirelessDexManager) injector.get(WirelessDexManager.class)
                                : null,
                        z
                                ? (BleAdvertiserServiceManager)
                                        injector.get(BleAdvertiserServiceManager.class)
                                : null,
                        (DualModeChanger) injector.get(DualModeChanger.class),
                        (StandaloneModeChanger) injector.get(StandaloneModeChanger.class),
                        (McfManager) injector.get(McfManager.class),
                        (DexManager) injector.get(DexManager.class));
            }
        }
        ...
        public final void onUserStarting(SystemService.TargetUser targetUser) {
            ...
            if (DesktopModeFeature.DEBUG) {
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        userIdentifier, "onStartUser(), userId=", "[DMS]DesktopModeService");
            }
        }
        ...
        public final void onUserStopped(SystemService.TargetUser targetUser) {
            ...
            if (DesktopModeFeature.DEBUG) {
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        userIdentifier, "onCleanupUser(), userId=", "[DMS]DesktopModeService");
            }
        }
            ...
            if (DesktopModeFeature.DEBUG) {
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                userIdentifier, "onStopUser(), userId=", ", CurrentUser=");
        ...
        public final void onUserSwitching(
            ...
            if (DesktopModeFeature.DEBUG) {
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        userIdentifier, "onSwitchUser(), userId=", "[DMS]DesktopModeService");
            }
        ...
        public final void onUserUnlocking(SystemService.TargetUser targetUser) {
            ...
            if (DesktopModeFeature.DEBUG) {
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                userIdentifier, "onUnlockUser(), userId=", ", CurrentUser=");
                m.append(ActivityManager.getCurrentUser());
                Log.d("[DMS]DesktopModeService", m.toString());
            }
    ...
    public final class LocalService extends DesktopModeManagerInternal {
        ...
        public final int getDexHDMIAutoEnterState() {
            return DesktopModeSettings.getSettingsAsUser(
                    DesktopModeService.this.mContext.getContentResolver(),
                    "knox_hdmi_auto_enter_state",
                    9,
                    DesktopModeSettings.sCurrentUserId);
        }
        ...
        public final int getModeToModeChangeType() {
            ...
            if (state.mDesktopModeState.getDisplayType() == 101) {
                ModeChanger.ModeToModeChangeInfo modeToModeChangeInfo2 =
                        desktopModeService.mStandaloneModeChanger.mModeToModeChangeInfo;
                if (modeToModeChangeInfo2 != null) {
                    return modeToModeChangeInfo2.mModeToMode;
                }
                return -1;
            }
            if (state.mDesktopModeState.getDisplayType() != 102
                    || (modeToModeChangeInfo =
                                    desktopModeService.mDualModeChanger.mModeToModeChangeInfo)
                            == null) {
                return -1;
            }
        ...
        */
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.desktopmode.DesktopModeService.LocalService.getTouchpadSupportedFeatures():int");
        }
        ...
        public final boolean isConfigurationChangedFromDeX(Configuration configuration) {
            ...
            if (configuration == null) {
                ...
                SemDesktopModeState semDesktopModeState =
                        ((StateManager) desktopModeService.mStateManager)
                                .getState()
                                .mDesktopModeState;
                int configurationState =
                        desktopModeService.mStandaloneModeChanger.getConfigurationState(
                                configuration);
                if (semDesktopModeState.state == 30
                        && ((configurationState == 1 && semDesktopModeState.enabled == 3)
                                || (configurationState == 0 && semDesktopModeState.enabled == 1))) {
                    z = true;
                }
                Log.i(
                        "[DMS]DesktopModeService",
                        "isConfigurationChangedFromDeX()="
                                + z
                                + ", config="
                                + configuration
                                + ", desktopModeState="
        ...
        public final boolean isDesktopModeAvailableEx(boolean z, boolean z2) {
            boolean z3 = false;
            PhonePreconditionChecker phonePreconditionChecker =
                    DesktopModeService.this.mPreconditionChecker;
            switch (phonePreconditionChecker.$r8$classId) {
                case 0:
                    DesktopModeService desktopModeService = phonePreconditionChecker.this$0;
                    StateManager.InternalState state =
                            ((StateManager) desktopModeService.mStateManager).getState();
                    if ((!z || DesktopModeService.isExternalDisplayConnectedOrForced(state))
                            && ((!z2
                                            || state.mDockState.mDesktopModeSupported
                                            || state.isDexOnPcOrWirelessDexConnected())
                                    && DesktopModeSettings.getSettingsAsUser(
                                            desktopModeService.mResolver,
                                            "hdmi_auto_enter",
                                            false,
                    ...
                    if (DesktopModeFeature.DEBUG) {
                        ...
                        StringBuilder m =
                                FullScreenMagnificationGestureHandler$$ExternalSyntheticOutline0.m(
                                        "isDesktopModeAvailableEx(checkExternalDisplay=",
                                        z,
                                        ", checkDesktopDock=",
                                        z2,
                                        ")=");
                ...
                default:
                    boolean isAllowed =
                            phonePreconditionChecker.isAllowed(
                                    ((StateManager) phonePreconditionChecker.this$0.mStateManager)
                                            .getState(),
                                    false);
                    if (!DesktopModeFeature.DEBUG) {
                        return isAllowed;
                    ...
                    StringBuilder m2 =
                            FullScreenMagnificationGestureHandler$$ExternalSyntheticOutline0.m(
                                    "isDesktopModeAvailable(checkExternalDisplay=",
                                    z,
                                    ", checkDesktopDock=",
                                    z2,
                                    ")=");
        ...
        public final boolean isDesktopModeEnablingOrEnabled() {
            int i =
                    ((StateManager) DesktopModeService.this.mStateManager)
                            .getState()
                            .mDesktopModeState
                            .enabled;
            return i == 3 || i == 4;
        ...
        public final boolean isDesktopModeForPreparing() {
            return DesktopModeService.isDesktopModeForPreparing(
                    ((StateManager) DesktopModeService.this.mStateManager).getState(), -1);
        }

        public final boolean isDesktopModeForPreparing(int i) {
            return DesktopModeService.isDesktopModeForPreparing(
                    ((StateManager) DesktopModeService.this.mStateManager).getState(), i);
        }

        public final boolean isExternalDisplayConnected() {
            return ((StateManager) DesktopModeService.this.mStateManager)
                    .getState()
        ...
        public final boolean isForcedInternalScreenModeEnabled() {
            return ((StateManager) DesktopModeService.this.mStateManager)
                    .getState()
                    .mForcedInternalScreenModeEnabled;
        }
        ...
        public final boolean isModeChangePending(int i) {
            SemDesktopModeState semDesktopModeState =
                    ((StateManager) DesktopModeService.this.mStateManager)
                            .getState()
                            .mDesktopModeState;
            return (i == -1 || semDesktopModeState.getDisplayType() == i)
                    && semDesktopModeState.state == 30;
        }
        ...
        public final void onConfigurationChanged(Configuration configuration) {
            ...
            final StandaloneModeChanger standaloneModeChanger =
                    desktopModeService.mStandaloneModeChanger;
            if (standaloneModeChanger != null) {
                final Configuration configuration2 = new Configuration(configuration);
                if (DesktopModeFeature.DEBUG) {
                    Log.v(
                            "[DMS]StandaloneModeChanger",
                            "onConfigurationChanged(), config=" + configuration2);
                }
                SemDesktopModeState semDesktopModeState =
                        ((StateManager) standaloneModeChanger.mStateManager)
                                .getState()
                                .mDesktopModeState;
                if (semDesktopModeState.state == 30
                        && semDesktopModeState.getDisplayType() == 101) {
                    standaloneModeChanger.mHandler.post(
                            new Runnable() { // from class:
                                             // com.android.server.desktopmode.StandaloneModeChanger$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    StandaloneModeChanger.this.handleOnConfigurationChanged(
                                            configuration2);
                                }
                            });
                }
        ...
        public final void onDesktopDisplayConfigured(final boolean z) {
            ...
            if (DesktopModeFeature.DEBUG) {
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                "onDesktopDisplayConfigured(), added=", ", mDesktopDisplayId=", z);
                m.append(dualModeChanger.mDesktopDisplayId);
                Log.v("[DMS]DualModeChanger", m.toString());
            }
            dualModeChanger.mHandler.post(
                    new Runnable() { // from class:
                                     // com.android.server.desktopmode.DualModeChanger$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            DualModeChanger dualModeChanger2 = DualModeChanger.this;
                            boolean z2 = z;
                            StateManager stateManager =
                                    (StateManager) dualModeChanger2.mStateManager;
                            ...
                            if (semDesktopModeState.state == 30
                                ...
                                if (!(z2 && semDesktopModeState.enabled == 3)
                                        && (z2 || semDesktopModeState.enabled != 1)) {
                                    return;
                                }
                                ...
                                if (z3) {
                                    Log.d(
                                            "[DMS]DualModeChanger",
                                            "handleDesktopDisplayConfigured(), added="
                                                    + z2
                                                    + ", desktopModeState="
                                                    + semDesktopModeState);
                                }
                                ...
                                if (z2) {
                                    dualModeChanger2.startHome(
                                            state, dualModeChanger2.mDesktopDisplayId);
                                } else {
                                ...
                                settingsHelper.backupOrRestoreSettings(
                                        z2, state, state.mCurrentUserId);
                                dualModeChanger2.setDesktopModeState(z2 ? 4 : 2, 50);
                                if (z3) {
                                    DesktopModeService$$ExternalSyntheticOutline0.m(
                                            "notifyDualOnConfigurationChanged(enter=",
                                            ")",
                                            "[DMS]StateManager",
                                            z2);
                                }
        ...
        public final int setDexHDMIAutoEnterState(int i) {
            ...
            try {
                if (i == 0) {
                    String settingsAsUserOrThrowException =
                            DesktopModeSettings.getSettingsAsUserOrThrowException(
                                    contentResolver,
                                    "hdmi_auto_enter_backup",
                                    null,
                                    DesktopModeSettings.sCurrentUserId);
                    if (settingsAsUserOrThrowException != null) {
                        DesktopModeSettings.setSettingsOrThrowException(
                                contentResolver, "hdmi_auto_enter", settingsAsUserOrThrowException);
                        DesktopModeSettings.deleteSettingsAsUser(
                                contentResolver,
                                "hdmi_auto_enter_backup",
                                DesktopModeSettings.sCurrentUserId);
                    }
                    DesktopModeSettings.setSettingsAsUserOrThrowException(
                            contentResolver,
                            "knox_hdmi_auto_enter_state",
                            Integer.toString(i),
                            DesktopModeSettings.sCurrentUserId);
                ...
                if (i != 1) {
                    ...
                    DesktopModeSettings.deleteSettingsAsUser(
                            contentResolver,
                            "hdmi_initial_connection_dialog_shown",
                            DesktopModeSettings.sCurrentUserId);
                    DesktopModeSettings.deleteSettingsAsUser(
                            contentResolver, "hdmi_auto_enter", DesktopModeSettings.sCurrentUserId);
                    DesktopModeSettings.deleteSettingsAsUser(
                            contentResolver,
                            "hdmi_auto_enter_backup",
                            DesktopModeSettings.sCurrentUserId);
                ...
                if (DesktopModeSettings.getSettingsAsUserOrThrowException(
                                contentResolver,
                                "hdmi_auto_enter_backup",
                                null,
                                DesktopModeSettings.sCurrentUserId)
                ...
                String settingsAsUserOrThrowException2 =
                        DesktopModeSettings.getSettingsAsUserOrThrowException(
                                contentResolver,
                                "hdmi_auto_enter",
                                null,
                ...
                if (settingsAsUserOrThrowException2 == null) {
                    DesktopModeSettings.setSettingsOrThrowException(
                            contentResolver, "hdmi_auto_enter_backup", "false");
                } else {
                    DesktopModeSettings.setSettingsOrThrowException(
                            contentResolver,
                            "hdmi_auto_enter_backup",
                            settingsAsUserOrThrowException2);
                }
                DesktopModeSettings.setSettingsOrThrowException(
                        contentResolver, "hdmi_auto_enter", "true");
                DesktopModeSettings.setSettingsAsUserOrThrowException(
                        contentResolver,
                        "knox_hdmi_auto_enter_state",
                        Integer.toString(i),
                ...
                Log.e(
                        "[DMS]DesktopModeService",
                        "setDexHDMIAutoEnterState(), Failed to setting(value=" + i + ")");
                return -1;
            }
        }
    ...
    public final class PhonePreconditionChecker {
        ...
        public /* synthetic */ PhonePreconditionChecker(
                DesktopModeService desktopModeService, int i) {
            this.$r8$classId = i;
            this.this$0 = desktopModeService;
        }
        ...
        public final boolean isAllowed(StateManager.InternalState internalState, boolean z) {
            switch (this.$r8$classId) {
                case 0:
                    ...
                    if (!desktopModeService.isSystemReady()
                            || !DesktopModeService.m399$$Nest$misBlockerRegistered(
                                    desktopModeService, internalState, z)
                            || !internalState.isPackagesAvailable()) {}
                    break;
                default:
                    ...
                    if (desktopModeService2.isSystemReady()) {
                        if (internalState.mIsExternalDisplayConnected
                                && internalState.mEmergencyModeEnabled) {
                            DesktopModeService.m399$$Nest$misBlockerRegistered(
                                    desktopModeService2, internalState, z);
                            break;
                        } else if (!DesktopModeService.m399$$Nest$misBlockerRegistered(
                                        desktopModeService2, internalState, z)
                                || !internalState.isPackagesAvailable()) {
                        }
                    }
        ...
        */
        public final void onReceive(android.content.Context r17, android.content.Intent r18) {
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.desktopmode.DesktopModeService.Receiver.onReceive(android.content.Context,"
    ...
    public final class WelcomeActivityListener extends UiManager.InternalUiCallback {
        ...
        public final void onClickButtonPositive() {
            ...
            if (state.isHdmiConnected()) {
                DesktopModeSettings.setSettings(
                        desktopModeService.mResolver, "hdmi_initial_connection_dialog_shown", true);
            }
            if (state.mIsPogoKeyboardConnected) {
                DesktopModeSettings.setSettings(
                        desktopModeService.mResolver, "pogo_initial_connection_dialog_shown", true);
            }
        }

        @Override // com.android.server.desktopmode.UiManager.InternalUiCallback
        public final void onDismiss() {
            DesktopModeService.this.mHandler.post(
                    new DesktopModeService$WelcomeActivityListener$$ExternalSyntheticLambda0(
                            this, 1));
        }
        ...
        public final void setDesktopModeState(int i, boolean z) {
            ...
            DesktopModeService desktopModeService = DesktopModeService.this;
            ((!z2 || z)
                            ? desktopModeService.mDualModeChanger
                            : desktopModeService.mStandaloneModeChanger)
                    .setDesktopModeState(2, i);
        }
        ...
        public final void showOrDismissOverlay(boolean z, boolean z2) {
            ...
            if (!z || this.mOverlayShown) {
                ...
                if (DesktopModeFeature.DEBUG) {
                    int i = DesktopModeService.$r8$clinit;
                    DesktopModeService$$ExternalSyntheticOutline0.m(
                            "showOrDismissOverlay(), show=false, isCoverSupportStatePartial=",
                            ", dismissing external overlay",
                            "[DMS]DesktopModeService",
                            z2);
                }
            ...
            if (z3) {
                if (DesktopModeFeature.DEBUG) {
                    int i2 = DesktopModeService.$r8$clinit;
                    DesktopModeService$$ExternalSyntheticOutline0.m(
                            "showOrDismissOverlay(), show=true, isCoverSupportStatePartial=",
                            ", skip showing external overlay since cover is closed",
                            "[DMS]DesktopModeService",
                            z2);
                    return;
                }
    ...
    public static void m396$$Nest$mhandleHdmiAutoEnter(
            DesktopModeService desktopModeService, boolean z) {
        if (desktopModeService.mCurrentUserId == 0 && desktopModeService.isSystemReady()) {
            ...
            if (!DesktopModeFeature.SUPPORT_NEW_DEX
                    ...
                    && !DesktopModeSettings.getSettingsAsUser(
                            ...
                            false,
                            DesktopModeSettings.sCurrentUserId)) {
                desktopModeService.mUiManager.showDialog(
                        0,
                        5,
                        desktopModeService
                        .new AnonymousClass6(false, "hdmi_initial_connection_dialog_shown"));
    ...
    public static void m397$$Nest$mhandlePogoAutoEnter(
            DesktopModeService desktopModeService, boolean z) {
        if (desktopModeService.mCurrentUserId == 0 && desktopModeService.isSystemReady()) {
            if (!z) {
            ...
            if (!parseBoolean) {
                if (DesktopModeFeature.SUPPORT_NEW_DEX
                        ...
                        || DesktopModeSettings.getSettingsAsUser(
                                desktopModeService.mResolver,
                                "pogo_initial_connection_dialog_shown",
                                false,
                                DesktopModeSettings.sCurrentUserId)
                        || !desktopModeService.mAllowPogoInitialDialog
                        || settingsAsUser2) {
                    return;
                }
                desktopModeService.mUiManager.showDialog(
                        ...
                        4,
                        desktopModeService
                        .new AnonymousClass6(true, "pogo_initial_connection_dialog_shown"));
                return;
            }
    ...
    public static boolean m398$$Nest$misAllowedInternal(
    ...
    public static boolean m399$$Nest$misBlockerRegistered(
            DesktopModeService desktopModeService,
            StateManager.InternalState internalState,
            boolean z) {
        BlockerManager blockerManager = desktopModeService.mBlockerManager;
        BlockerManager.DesktopModeBlockerInfo defaultBlockerInfo =
                blockerManager.getDefaultBlockerInfo(internalState);
            ...
            synchronized (blockerManager.mBlockers) {
                try {
                    ...
                    while (true) {
                        ...
                        BlockerManager.DesktopModeBlockerInfo desktopModeBlockerInfo =
                                (BlockerManager.DesktopModeBlockerInfo) it.next();
        ...
        if (defaultBlockerInfo != null) {
            Log.i(
                    "[DMS]DesktopModeService",
                    "isAllowed(showToast=" + z + "), blocked by " + defaultBlockerInfo);
            if (z) {
                try {
                    ToastManager.showToast(
                            desktopModeService.mContext, defaultBlockerInfo.blocker.onBlocked(), 1);
                    Log.SAVED_STATES.add(
                            Log.buildLogString(
                                    'W',
                                    "[DMS]State",
                                    "(enter) State="
                    ...
                    Log.e(
                            "[DMS]DesktopModeService",
                            "Failed to get blocking message from blocker " + defaultBlockerInfo,
                            e);
                }
            }
            z2 = false;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void m400$$Nest$mrequestTileUpdate(
            com.android.server.desktopmode.DesktopModeService r4,
            com.samsung.android.desktopmode.SemDesktopModeState r5) {
        /*
            r0 = 0
            r1 = 1
            if (r5 == 0) goto L17
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.desktopmode.DesktopModeService.m400$$Nest$mrequestTileUpdate(com.android.server.desktopmode.DesktopModeService,"
                    + " com.samsung.android.desktopmode.SemDesktopModeState):void");
    }

    /* renamed from: -$$Nest$msetEnterRequestIfStandaloneLastBoot, reason: not valid java name */
    public static void m401$$Nest$msetEnterRequestIfStandaloneLastBoot(
            DesktopModeService desktopModeService, StateManager.InternalState internalState) {
        if (DesktopModeSettings.getSettingsAsUser(
            ...
            Log.i(
                    "[DMS]DesktopModeService",
                    "Request to enter standalone mode, since the standalone mode was enabled on"
                        + " last boot");
            desktopModeService.setUserRequest(1);
        }
        DesktopModeSettings.setSettingsAsUser(
                desktopModeService.mResolver,
                "display_type",
                internalState.mDesktopModeState.getDisplayType(),
                desktopModeService.mCurrentUserId);
    }
    ...
    public DesktopModeService(
        ...
        this.mWelcomeCompletedSettingChangedListener =
                new SettingsHelper.OnSettingChangedListener(
                        this,
                        i) { // from class: com.android.server.desktopmode.DesktopModeService.3
                    public final /* synthetic */ int $r8$classId;
                    public final /* synthetic */ DesktopModeService this$0;
                    ...
                    public final void onSettingChanged(String str) {
                        switch (this.$r8$classId) {
                            ...
                            default:
                                ...
                                DesktopModeService desktopModeService2 = this.this$0;
                                desktopModeService2.mShowModeChangeScreen =
                                        ((StateManager) desktopModeService2.mStateManager)
                                                .getState()
                                                .isHdmiConnected();
        ...
        this.mExternalDisplayModeListener =
                new SettingsHelper.OnSettingChangedListener(
                        this,
                        1) { // from class: com.android.server.desktopmode.DesktopModeService.3
                    public final /* synthetic */ int $r8$classId;
                    public final /* synthetic */ DesktopModeService this$0;
        ...
        this.mPreconditionChecker =
                DesktopModeFeature.SUPPORT_STANDALONE
                        ? new PhonePreconditionChecker(this, 1)
                        : new PhonePreconditionChecker(this, 0);
    ...
    public static boolean isDesktopModeForPreparing(
            StateManager.InternalState internalState, int i) {
        SemDesktopModeState semDesktopModeState = internalState.mDesktopModeState;
        return (i == -1 || semDesktopModeState.getDisplayType() == i)
                && (semDesktopModeState.enabled == 4
                        || semDesktopModeState.compareTo(3, 30)
                        || semDesktopModeState.compareTo(1, 20));
    }

    public static boolean isExternalDisplayConnectedOrForced(
            StateManager.InternalState internalState) {
        return internalState.mIsExternalDisplayConnected
                || internalState.mForcedInternalScreenModeEnabled;
    }
    ...
    public final void dump(
            ...
            if (DesktopModeFeature.DEBUG) {
                ...
                if ("off".equals(str2) || "toggle".equals(str2)) {
                    ...
                    BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("  cmd desktopmode "), str2, printWriter);
                    return;
                } else {
                    if (!"settings".equals(str2)
                            && !"resolution".equals(str2)
                            && !"ui".equals(str2)) {
                        BinaryTransparencyService$$ExternalSyntheticOutline0.m(
                                printWriter,
                                "Unknown argument: ",
                                str2,
                                "; USAGE: [on|off|toggle|dblist]");
                        return;
                    }
        ...
        try {
            Bundle call =
                    this.mResolver.call(
                            DesktopModeSettings.getUriAsUser(this.mCurrentUserId),
                            "dumpApp",
                            (String) null,
                            (Bundle) null);
            if (call != null) {
        ...
        indentingPrintWriter.println(
                "DISPLAY_SIZE_FORCED="
                        + Settings.Global.getString(this.mResolver, "display_size_forced"));
        indentingPrintWriter.println(
                "DISPLAY_DENSITY_FORCED="
                        + Settings.Secure.getStringForUser(
                                this.mResolver, "display_density_forced", 0));
        indentingPrintWriter.println(
                "SCREEN_OFF_TIMEOUT="
                        + Settings.System.getStringForUser(
                                this.mResolver, "screen_off_timeout", this.mCurrentUserId));
        indentingPrintWriter.println(
        ...
        StringBuilder m =
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        DesktopModeService$$ExternalSyntheticOutline0.m(
                                new StringBuilder("mIsLockTaskModeEnabledAndSecured="),
                                standaloneModeChanger.mIsLockTaskModeEnabledAndSecured,
                                indentingPrintWriter,
                                "mStandaloneModeEnabled="),
                        standaloneModeChanger.mStandaloneModeEnabled,
                        indentingPrintWriter,
                        "mTopTaskId=");
        ...
        if (DesktopModeFeature.FEATURE_STANDALONE_MODE_WALLPAPER) {
            indentingPrintWriter.println(
                    "mWallpaperShown=" + standaloneModeChanger.mWallpaperShown);
        }
        ...
        StringBuilder m2 =
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        new StringBuilder("mDualModeEnabled="),
                        dualModeChanger.mDualModeEnabled,
                        indentingPrintWriter,
                        "mModeToModeChangeInfo=");
        m2.append(dualModeChanger.mModeToModeChangeInfo);
        indentingPrintWriter.println(m2.toString());
        indentingPrintWriter.println(
                "mPrevDesktopDisplayId=" + dualModeChanger.mPrevDesktopDisplayId);
        indentingPrintWriter.println("mTopTaskId=" + dualModeChanger.mTopTaskId);
        StringBuilder m3 =
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        new StringBuilder("mTopTaskIdValid="),
                        dualModeChanger.mTopTaskIdValid,
                        indentingPrintWriter,
                        "mTouchpadRequestedByNotification=");
        ...
        long clearCallingIdentity2 = Binder.clearCallingIdentity();
        StringBuilder m4 =
                BatteryService$$ExternalSyntheticOutline0.m(i, "Current user (", ") settings=");
        m4.append(
                Utils.bundleToString(DesktopModeSettings.getAllSettingsAsUser(i, contentResolver)));
        indentingPrintWriter.println(m4.toString());
        if (i != 0) {
            indentingPrintWriter.println(
                    "System user (0) settings"
                            + Utils.bundleToString(
                                    DesktopModeSettings.getAllSettingsAsUser(0, contentResolver)));
        }
        Binder.restoreCallingIdentity(clearCallingIdentity2);
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.println();
        ...
        indentingPrintWriter.println(
                "external overlay="
                        + DesktopModeUiConstants.typeToString(
                                uiManager.getCurrentOverlayType(103)));
        indentingPrintWriter.println(
                "internal overlay="
                        + DesktopModeUiConstants.typeToString(
                                uiManager.getCurrentOverlayType(102)));
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.println();
        ...
        synchronized (semDesktopModeStateNotifier.mInnerLock) {
            try {
                indentingPrintWriter.println(
                        "mListeners ("
                                + ((ArrayMap) semDesktopModeStateNotifier.mListeners).size()
                                + "):");
                indentingPrintWriter.increaseIndent();
                Iterator it =
                        ((ArrayMap) semDesktopModeStateNotifier.mListeners).values().iterator();
                while (it.hasNext()) {
                    indentingPrintWriter.println(
                            (SemDesktopModeStateNotifier.ListenerInfo) it.next());
                }
                indentingPrintWriter.decreaseIndent();
            } finally {
            }
        ...
        indentingPrintWriter.println(
                "DefaultBlocker="
                        + blockerManager.getDefaultBlockerInfo(
                                ((StateManager) blockerManager.mStateManager).getState()));
        synchronized (blockerManager.mBlockers) {
            try {
                indentingPrintWriter.println(
                        "mBlockers (" + ((ArrayMap) blockerManager.mBlockers).size() + "):");
                indentingPrintWriter.increaseIndent();
                Iterator it2 = ((ArrayMap) blockerManager.mBlockers).values().iterator();
                while (it2.hasNext()) {
                    indentingPrintWriter.println(
                            (BlockerManager.DesktopModeBlockerInfo) it2.next());
                }
                indentingPrintWriter.decreaseIndent();
            } finally {
            }
        ...
        StringBuilder m5 =
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        DesktopModeService$$ExternalSyntheticOutline0.m(
                                new StringBuilder("mIsSPenDetached="),
                                touchpadManager.mIsSPenDetached,
                                indentingPrintWriter,
                                "mIsSPenEnabled="),
                        touchpadManager.mIsSPenEnabled,
                        indentingPrintWriter,
                        "mIsTouchpadEnabled=");
        ...
        indentingPrintWriter.increaseIndent();
        indentingPrintWriter.println(
                "KEEP_POLICY_PACKAGES ("
                        + DesktopModeKillPolicyManager.KEEP_POLICY_PACKAGES.size()
                        + ")");
        indentingPrintWriter.println(
                "KILL_POLICY_PACKAGES ("
                        + DesktopModeKillPolicyManager.KILL_POLICY_PACKAGES.size()
                        + ")");
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.println();
        ...
        StringBuilder m6 =
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        DesktopModeService$$ExternalSyntheticOutline0.m(
                                new StringBuilder("mIsForcedSupportAllResolution="),
                                multiResolutionManager.mIsForcedSupportAllResolution,
                                indentingPrintWriter,
                                "mDisplayRemovedOnEnablingDesktopMode="),
                        multiResolutionManager.mDisplayRemovedOnEnablingDesktopMode,
                        indentingPrintWriter,
        ...
        indentingPrintWriter.println(
                "mCustomDisplayMetrics=" + multiResolutionManager.mCustomDisplayMetrics);
        indentingPrintWriter.println(
                "mUserSettingResolution=" + multiResolutionManager.mUserSettingResolution);
        indentingPrintWriter.println(
                "mMaxSupportedResolution=" + multiResolutionManager.mMaxSupportedResolution);
        indentingPrintWriter.println(
                "mSelectedDisplayMetrics=" + multiResolutionManager.mSelectedDisplayMetrics);
        indentingPrintWriter.println(
                "mLastDualModeMaxSupportedResolution="
                        + multiResolutionManager.mLastDualModeMaxSupportedResolution);
        indentingPrintWriter.decreaseIndent();
        indentingPrintWriter.println();
        ...
        while (true) {
            ...
            if (i2 >= ((ArrayMap) anonymousClass3.this$0).size()) {
                ...
                if (DesktopModeFeature.SUPPORT_WIRELESS_DEX) {
                    ...
                    indentingPrintWriter.increaseIndent();
                    indentingPrintWriter.println(
                            "mFrequencyValue=" + wirelessDexManager.mFrequencyValue);
                    StringBuilder m7 =
                            DesktopModeService$$ExternalSyntheticOutline0.m(
                                    DesktopModeService$$ExternalSyntheticOutline0.m(
                                            new StringBuilder("mIsLowLatencyMode="),
                                            wirelessDexManager.mIsLowLatencyMode,
                                            indentingPrintWriter,
                                            "mIsWirelessDexEntered="),
                                    wirelessDexManager.mIsWirelessDexEntered,
                                    indentingPrintWriter,
                                    "mPointerIconSync=");
                    m7.append(wirelessDexManager.mPointerIconSync);
                    indentingPrintWriter.println(m7.toString());
                    indentingPrintWriter.println(
                            "mReducedLatency=" + wirelessDexManager.mReducedLatency);
                    indentingPrintWriter.println(
                            "mTvTizenVersion=" + wirelessDexManager.mTvTizenVersion);
                    indentingPrintWriter.decreaseIndent();
                    if (this.mBleAdvertiserServiceManager != null) {
                        indentingPrintWriter.println();
                        BleAdvertiserServiceManager bleAdvertiserServiceManager =
                                this.mBleAdvertiserServiceManager;
                        bleAdvertiserServiceManager.getClass();
                        indentingPrintWriter.println("Current BleAdvertiserServiceManager state:");
                        indentingPrintWriter.increaseIndent();
                        indentingPrintWriter.println(
                                "mBound=" + bleAdvertiserServiceManager.mBound);
                        indentingPrintWriter.decreaseIndent();
                    }
                    if (this.mMcfManager != null) {
                        ...
                        StringBuilder m8 =
                                DesktopModeService$$ExternalSyntheticOutline0.m(
                                        sb, z, indentingPrintWriter, "mBleScannerState=");
                        m8.append(mcfManager.mBleScannerState);
                        indentingPrintWriter.println(m8.toString());
                        indentingPrintWriter.println(
                                "mBleStartScanReason="
                                        + McfManager.bleStartScanReasonToString(
                                                mcfManager.mBleStartScanReason));
                        indentingPrintWriter.println(
                                "mBleAdvertiserServiceTimeout="
                                        + mcfManager.mBleAdvertiserServiceTimeout);
                        indentingPrintWriter.println(
                                "mWakeLockTimeout=" + mcfManager.mWakeLockTimeout);
                        indentingPrintWriter.println(
                                "mLastBleScanFailedErrorCode="
                                        + mcfManager.mLastBleScanFailedErrorCode);
                        if (DesktopModeFeature.DEBUG) {
                            indentingPrintWriter.println(
                                    "mLastBleScanResult=" + mcfManager.mLastBleScanResult);
                        }
                        indentingPrintWriter.decreaseIndent();
                    }
                }
    ...
    public final Bundle getDesktopModeKillPolicy() {
        ...
        m142m.putSerializable(
                "kill_packages", (Serializable) DesktopModeKillPolicyManager.KILL_POLICY_PACKAGES);
        m142m.putSerializable(
                "keep_packages", (Serializable) DesktopModeKillPolicyManager.KEEP_POLICY_PACKAGES);
        m142m.putBoolean("skip_sdk_version_check", true);
        if (DesktopModeFeature.DEBUG) {
            Log.d(
                    "[DMS_POLICY]DesktopModeKillPolicyManager",
                    "getDesktopModeKillPolicy(), args=" + m142m);
        }
        return m142m;
    }
    ...
    public final void initializeStates() {
        if (!isUserSetupComplete()) {
            ...
            this.mResolver.registerContentObserver(
                    ...
                    false,
                    this.mUserSetupCompleteObserver,
                    this.mCurrentUserId);
            ...
            synchronized (stateManager.mLock) {
                stateManager.mHandler.post(
                        new StateManager$$ExternalSyntheticLambda2(stateManager));
            }
        }
    }
    ...
    public void injectServices(
        ...
        if (DesktopModeFeature.SUPPORT_NEW_DEX) {
            this.mResolver.registerContentObserver(
                    Settings.System.getUriFor("new_dex"), true, this.mNewDeXSettingObserver);
        }
    ...
    public final boolean isAllowed() {
        return this.mPreconditionChecker.isAllowed(
                ((StateManager) this.mStateManager).getState(), false);
    }
    ...
    public final boolean isSystemReady() {
        if (this.mIsBootComplete
            ...
            Iterator<ResolveInfo> it =
                    packageManager
                            ...
                            .iterator();
            while (it.hasNext()) {
                if ("com.sec.android.app.SecSetupWizard"
                        .equals(it.next().activityInfo.packageName)) {
        ...
        Log.i(
                "[DMS]DesktopModeService",
                "isSystemReady(), mIsBootComplete="
                        + this.mIsBootComplete
                        + ", isFactoryBinary="
                        + FactoryTest.isFactoryBinary()
                        + ", mCurrentUserId="
                        + this.mCurrentUserId);
    ...
    public final boolean isUserSetupComplete() {
        boolean z =
                Settings.Secure.getIntForUser(
                                this.mResolver, "user_setup_complete", 0, this.mCurrentUserId)
                        != 0;
    ...
    public final void onSecuredAppLaunched(final int i, final String str) {
        if (DesktopModeFeature.DEBUG) {
            Log.i(
                    "[DMS]DesktopModeService",
                    "onSecuredAppLaunched, taskId=" + i + ", packageName= " + str);
        }
        if (((StateManager) this.mStateManager).getState().isDexOnPcConnected()) {
            ...
            dualModeChanger.mHandler.post(
                    new Runnable() { // from class:
                        // com.android.server.desktopmode.DualModeChanger$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            DualModeChanger dualModeChanger2 = DualModeChanger.this;
                            int i2 = i;
                            ...
                            dualModeChanger2.mContext.sendBroadcastAsUser(
                                    new Intent(
                                                    "com.samsung.android.desktopmode.action.SECURED_APP_LAUNCHED")
                                            .setPackage("com.sec.android.app.dexonpc")
                                            .putExtra(
                                                    "com.samsung.android.desktopmode.extra.TASK_ID",
                                                    i2)
                                            .putExtra(
                                                    "com.samsung.android.desktopmode.extra.PACKAGE_NAME",
                                                    str2),
                                    UserHandle.CURRENT);
                        }
                    });
    ...
    public final void onUserChanged(int i) {
        if (i == this.mCurrentUserId) {
            Log.d(
                    "[DMS]DesktopModeService",
                    "onUserChanged(), userId and mCurrentUserId are same(" + i + ")");
            return;
        }
        boolean z = DesktopModeFeature.DEBUG;
        if (z) {
            DesktopModeService$$ExternalSyntheticOutline0.m(
                    i, "onUserChanged(), userId=", "[DMS]DesktopModeService");
        }
        if (z) {
            DesktopModeService$$ExternalSyntheticOutline0.m(
                    i, "setCurrentUserId(), userId=", "[DMS]DesktopModeService");
        }
        ...
        synchronized (blockerManager.mBlockers) {
            try {
                ...
                try {
                    ...
                    BlockerManager.DesktopModeBlockerInfo desktopModeBlockerInfo =
                            blockerManager
                            .new DesktopModeBlockerInfo(
                                    iDesktopModeBlocker, str, callingPid, Binder.getCallingUid());
                    asBinder.linkToDeath(desktopModeBlockerInfo, 0);
                    ((ArrayMap) blockerManager.mBlockers).put(asBinder, desktopModeBlockerInfo);
                    ((StateManager) blockerManager.mStateManager)
                            .notifyScheduleUpdateDesktopMode(false);
    ...
    public final boolean registerDesktopModeListener(
            IDesktopModeListener iDesktopModeListener, String str) {
        SemDesktopModeStateNotifier semDesktopModeStateNotifier = this.mSemDesktopModeStateNotifier;
        synchronized (semDesktopModeStateNotifier.mInnerLock) {
            try {
                ...
                try {
                    ...
                    int callingPid = Binder.getCallingPid();
                    semDesktopModeStateNotifier.mInjector.getClass();
                    SemDesktopModeStateNotifier.ListenerInfo listenerInfo =
                            semDesktopModeStateNotifier
                            .new ListenerInfo(
                                    iDesktopModeListener, str, callingPid, Binder.getCallingUid());
                    SemDesktopModeStateNotifier.enforceRegisterLimitLocked(
                            listenerInfo, semDesktopModeStateNotifier.mListeners);
                    ...
                    Log.e(
                            ...
                            "Failed to register DesktopModeListener",
                            e);
                    return false;
                }
            } finally {
    ...
    public final void scheduleUpdateDesktopMode(final boolean z) {
        this.mHandler.post(
                new Runnable() { // from class:
                                 // com.android.server.desktopmode.DesktopModeService$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        DesktopModeService desktopModeService = DesktopModeService.this;
                        desktopModeService.updateDesktopMode(
                                ((StateManager) desktopModeService.mStateManager).getState(),
                                z,
                                false);
                    }
    ...
    public final Bundle sendMessage(Bundle bundle) {
        if (this.mContext.checkCallingOrSelfPermission(
            ...
            if (bundle.getInt("command") == 1000) {
                final StateManager.InternalState state =
                        ((StateManager) this.mStateManager).getState();
                this.mHandler.post(
                        new Runnable() { // from class:
                                         // com.android.server.desktopmode.DesktopModeService$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                DesktopModeService desktopModeService = DesktopModeService.this;
                                ...
                                if (i != 0) {
                                    DualModeChanger dualModeChanger =
                                            desktopModeService.mDualModeChanger;
                                    dualModeChanger.mTopTaskId =
                                            dualModeChanger.mActivityTaskManagerInternal
                                                    .getForegroundTaskId(i);
                                    dualModeChanger.mTopTaskIdValid = true;
                                }
                                desktopModeService.mActivityTaskManagerInternal.minimizeAllTasks(
                                        i, false);
                            }
                        });
                return null;
            }
        } else if (this.mContext.checkCallingOrSelfPermission(
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    Log.e(
                            "[DMS]DesktopModeService",
                            "sendMessage(), Failed to communicate with launcher. Starting again...",
                            e);
    ...
    public final void startHome(StateManager.InternalState internalState) {
        ...
        if (semDesktopModeState.enabled == 4) {
            if (semDesktopModeState.getDisplayType() == 101) {
                ...
                if (semDesktopModeState.getDisplayType() != 102
                        || (i = (dualModeChanger = this.mDualModeChanger).mDesktopDisplayId)
                                == -1) {
                    return;
                }
    ...
    public final boolean unregisterBlocker(IDesktopModeBlocker iDesktopModeBlocker) {
        ...
        synchronized (blockerManager.mBlockers) {
            try {
                BlockerManager.DesktopModeBlockerInfo desktopModeBlockerInfo =
                        (BlockerManager.DesktopModeBlockerInfo)
                                ((ArrayMap) blockerManager.mBlockers)
                                        .remove(iDesktopModeBlocker.asBinder());
                z = false;
                if (desktopModeBlockerInfo != null) {
                    desktopModeBlockerInfo
                            .blocker
                            .asBinder()
                            .unlinkToDeath(desktopModeBlockerInfo, 0);
                    z = true;
                    if (((ArrayMap) blockerManager.mBlockers).isEmpty()) {
                        ((StateManager) blockerManager.mStateManager)
                                .notifyScheduleUpdateDesktopMode(true);
                    }
                }
            } finally {
            }
    ...
    public final boolean unregisterDesktopModeListener(IDesktopModeListener iDesktopModeListener) {
        ...
        synchronized (semDesktopModeStateNotifier.mInnerLock) {
            try {
                SemDesktopModeStateNotifier.ListenerInfo listenerInfo =
                        (SemDesktopModeStateNotifier.ListenerInfo)
                                ((ArrayMap) semDesktopModeStateNotifier.mListeners)
                                        .remove(iDesktopModeListener.asBinder());
    ...
    */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void updateDesktopMode(
            com.android.server.desktopmode.StateManager.InternalState r17,
            boolean r18,
            boolean r19) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.desktopmode.DesktopModeService.updateDesktopMode(com.android.server.desktopmode.StateManager$InternalState,"
    ...
    public final void updateNewDexMode(int i) {
        if (!DesktopModeFeature.SUPPORT_NEW_DEX) {
            if (DesktopModeFeature.DEBUG) {
                Log.d(
                        "[DMS]DesktopModeService",
                        "updateNewDexMode Failed : New Dex Feature Not Supported");
                return;
            }
            return;
        }
        ...
        if (emergencyModeBlocker.mEnabledInBroadcast
                || emergencyModeBlocker.mEmergencyModeEnabledInSettings
                || emergencyModeBlocker.mMpsmEnabledInSettings
                || emergencyModeBlocker.mLimitAppsAndHomeScreenEnabledInSettings) {
            Log.d(
                    "[DMS]DesktopModeService",
                    "New Dex Blocked, name = " + this.mEmergencyModeBlocker.toString());
        ...
        if (!KnoxCustomManagerService.LAUNCHER_PACKAGE.equals(str)) {
            ...
            ToastManager.showToast(
                    context2, context2.getString(R.string.scNullCipherIssueNonEncryptedSummary), 1);
        } else if (i == 1) {
