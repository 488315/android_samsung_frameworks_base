...
public class BlockerManager {
  ...
  public class DesktopModeBlockerInfo implements IBinder.DeathRecipient {
    ...
    public void binderDied() {
      Log.m11v(BlockerManager.TAG, "binderDied(): " + this);
    ...
    public String toString() {
      return DesktopModeBlockerInfo.class.getSimpleName()
          + "(name="
          + this.name
          + ", pid="
          + this.pid
  ...
  public boolean registerBlocker(IDesktopModeBlocker iDesktopModeBlocker, String str) {
    synchronized (this.mBlockers) {
      ...
      try {
        DesktopModeBlockerInfo desktopModeBlockerInfo =
  ...
  public boolean unregisterBlocker(IDesktopModeBlocker iDesktopModeBlocker) {
    synchronized (this.mBlockers) {
      DesktopModeBlockerInfo desktopModeBlockerInfo =
          (DesktopModeBlockerInfo) this.mBlockers.remove(iDesktopModeBlocker.asBinder());
  ...
  public final DesktopModeBlockerInfo getDefaultBlockerInfo(State state) {
    ...
    if (blocker != null) {
      return new DesktopModeBlockerInfo(
          blocker,
          DefaultBlocker.reasonToString(blocker.reasonCode),
          this.mInjector.binderGetCallingPid(),
          this.mInjector.binderGetCallingUid());
    }
    return null;
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter.println(
        "DefaultBlocker=" + getDefaultBlockerInfo(this.mStateManager.getState()));
    synchronized (this.mBlockers) {
