...
public class BleAdvertiserServiceManager {
  ...
  public final Runnable mBindServiceRunnable = new Runnable() { // from class:
        // com.android.server.desktopmode.BleAdvertiserServiceManager$$ExternalSyntheticLambda0
  ...
  public final Runnable mDeferredConnectionCallback = new Runnable() { // from class:
        // com.android.server.desktopmode.BleAdvertiserServiceManager$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
          BleAdvertiserServiceManager.this.lambda$new$0();
        }
      };
  public final ServiceConnection mServiceConnection = new ServiceConnectionC10981();
  ...
  /* renamed from: com.android.server.desktopmode.BleAdvertiserServiceManager$1 */
  public class ServiceConnectionC10981 implements ServiceConnection {
    @Override // android.content.ServiceConnection
    public void onServiceDisconnected(ComponentName componentName) {}

    public ServiceConnectionC10981() {}

    @Override // android.content.ServiceConnection
    public void onServiceConnected(ComponentName componentName, final IBinder iBinder) {
      Utils.runOnHandlerThread(
          BleAdvertiserServiceManager.this.mHandler,
          new Runnable() { // from class:
            // com.android.server.desktopmode.BleAdvertiserServiceManager$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              BleAdvertiserServiceManager.ServiceConnectionC10981.this.lambda$onServiceConnected$0(
                  iBinder);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onServiceConnected$0(IBinder iBinder) {
      ...
      BleAdvertiserServiceManager.this.mHandler.removeCallbacks(
          BleAdvertiserServiceManager.this.mDeferredConnectionCallback);
      BleAdvertiserServiceManager.this.mHandler.removeCallbacks(
          BleAdvertiserServiceManager.this.mBindServiceRunnable);
      try {
        ...
        if (DesktopModeFeature.DEBUG) {
          Log.m7d(
              BleAdvertiserServiceManager.TAG,
              "onServiceConnected(), mService=" + BleAdvertiserServiceManager.this.mService);
        }
      } catch (RemoteException e) {
        Log.m9e(BleAdvertiserServiceManager.TAG, "Lost connection to the service", e);
    ...
    public void onNullBinding(final ComponentName componentName) {
      Utils.runOnHandlerThread(
          BleAdvertiserServiceManager.this.mHandler,
          new Runnable() { // from class:
            // com.android.server.desktopmode.BleAdvertiserServiceManager$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
              BleAdvertiserServiceManager.ServiceConnectionC10981.this.lambda$onNullBinding$1(
                  componentName);
            }
          });
    }
    ...
    public void onBindingDied(final ComponentName componentName) {
      Utils.runOnHandlerThread(
          BleAdvertiserServiceManager.this.mHandler,
          new Runnable() { // from class:
            // com.android.server.desktopmode.BleAdvertiserServiceManager$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              BleAdvertiserServiceManager.ServiceConnectionC10981.this.lambda$onBindingDied$2(
                  componentName);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onBindingDied$2(ComponentName componentName) {
      Log.m12w(
          BleAdvertiserServiceManager.TAG,
          "Binding died of '" + componentName + "', try reconnecting");
      BleAdvertiserServiceManager.this.retryConnectionWithBackoff();
    }
  }
  ...
  public BleAdvertiserServiceManager(
    ...
    StateManager.StateListener stateListener = new StateManager.StateListener() { // from class:
          // com.android.server.desktopmode.BleAdvertiserServiceManager.2
    ...
    this.mDeathRecipient =
        new IBinder.DeathRecipient() { // from class:
          // com.android.server.desktopmode.BleAdvertiserServiceManager$$ExternalSyntheticLambda2
  ...
  public void setCurrentUserId(final int i) {
    Utils.runOnHandlerThread(
        this.mHandler,
        new Runnable() { // from class:
          // com.android.server.desktopmode.BleAdvertiserServiceManager$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
          ...
          this.mContext.bindServiceAsUser(
              new Intent()
                  .setClassName(
                      ...
                      "com.sec.android.desktopmode.uiservice.ble.BleAdvertiserService"),
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    indentingPrintWriter.println(
        "Current " + BleAdvertiserServiceManager.class.getSimpleName() + " state:");
