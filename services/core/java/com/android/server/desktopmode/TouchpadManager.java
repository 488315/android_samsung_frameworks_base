...
public final class TouchpadManager {
    ...
    public final AnonymousClass2 mSPenSettingChangedListener =
            new SettingsHelper.OnSettingChangedListener(
                    this, 0) { // from class: com.android.server.desktopmode.TouchpadManager.2
            ...
            TouchpadManager.this.mHandler.post(
                    new Runnable() { // from class:
                        ...
                        public final void run() {
                            ...
                            ((StateManager) touchpadManager.mStateManager)
            ...
            if (z) {
                ...
                touchpadManager
                        ...
                        .registerContentObserver(
                                ...
                                true,
                                touchpadManager.mNavBarModeObserver,
                                -2);
            } else {
                TouchpadManager.m418$$Nest$mupdateTouchpadAvailability(
                        touchpadManager, ((StateManager) touchpadManager.mStateManager).getState());
                touchpadManager.mSettingsHelper.unregisterListener(
                        touchpadManager.mSPenSettingChangedListener);
                touchpadManager
                        .mContext
                        .getContentResolver()
                        .unregisterContentObserver(touchpadManager.mNavBarModeObserver);
                if (DesktopModeFeature.SUPPORT_SPEN) {
                    touchpadManager.mContext.unregisterReceiver(
                            touchpadManager.mSPenDetachedReceiver);
                    ...
                    windowManagerService.unregisterPointerEventListener(
                            anonymousClass6, touchpadManager.mDesktopDisplayId);
                }
            }
            DesktopModeSettings.setSettings(
                    touchpadManager.mContext.getContentResolver(), "touchpad_enabled", false);
        ...
        public final void onDualModeStopLoadingScreen(boolean z) {
            if (z) {
                ...
                StateManager.InternalState state =
                        ((StateManager) touchpadManager.mStateManager).getState();
                TouchpadManager.m418$$Nest$mupdateTouchpadAvailability(touchpadManager, state);
                touchpadManager.mSettingsHelper.registerListener(
                        touchpadManager.mSPenSettingChangedListener);
                if (DesktopModeFeature.SUPPORT_SPEN) {
                    touchpadManager.mContext.registerReceiverAsUser(
                            touchpadManager.mSPenDetachedReceiver,
                            UserHandle.ALL,
                ...
                if (state.mDockState.isDexStation()
                        && state.mCoverSupportState == 2
                        && !state.mIsMouseConnected) {
    ...
    public static void m418$$Nest$mupdateTouchpadAvailability(
            TouchpadManager touchpadManager, StateManager.InternalState internalState) {
        IStateManager iStateManager = touchpadManager.mStateManager;
        boolean z =
                (internalState.isDexOnPcConnected() ^ true)
                        && internalState.mDesktopModeState.compareTo(4, 0, 102);
        StateManager stateManager = (StateManager) iStateManager;
        stateManager.getClass();
        if (DesktopModeFeature.DEBUG) {
            DesktopModeService$$ExternalSyntheticOutline0.m(
                    "setTouchpadAvailable(available=", ")", "[DMS]StateManager", z);
        }
    ...
    public TouchpadManager(
        ...
        SettingsHelper.OnSettingChangedListener onSettingChangedListener =
                new SettingsHelper.OnSettingChangedListener(
                        this, 1) { // from class: com.android.server.desktopmode.TouchpadManager.2
                    public final /* synthetic */ int $r8$classId;
                    public final /* synthetic */ TouchpadManager this$0;
        ...
        this.mSPenDetachedReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.android.server.desktopmode.TouchpadManager.4
                    @Override // android.content.BroadcastReceiver
                    public final void onReceive(Context context2, Intent intent) {
                        if ("com.samsung.pen.INSERT".equals(intent.getAction())) {
                            TouchpadManager.this.mIsSPenDetached =
                                    !intent.getBooleanExtra("penInsert", true);
                            if (DesktopModeFeature.DEBUG) {
                                Log.d(
                                        "[DMS]TouchpadManager",
                                        "mIsSPenDetached=" + TouchpadManager.this.mIsSPenDetached);
                            }
        ...
        this.mNavBarModeObserver =
                new ContentObserver() { // from class:
                                        // com.android.server.desktopmode.TouchpadManager.5
    ...
    public final void updateSPenState() {
        ...
        boolean z2 = false;
        if (DesktopModeFeature.SUPPORT_SPEN
                && !state.mDockState.isDexStation()
                && this.mIsSPenDetached
                && (!state.isDexOnPcConnected())
                && state.mDesktopModeState.compareTo(4, 0, 102)) {
            z2 = true;
        }
        if (this.mIsSPenEnabled != z2) {
            ...
            if (z) {
                DesktopModeService$$ExternalSyntheticOutline0.m(
                        "setSpenEnabled(enabled=", ")", "[DMS]StateManager", z2);
            }
            synchronized (stateManager.mLock) {
                try {
