...
public class StandaloneModeChanger extends ModeChanger {
  ...
  /* renamed from: com.android.server.desktopmode.StandaloneModeChanger$1 */
  public class C11421 extends StateManager.StateListener {
    ...
    public void onUserChanged(State state) {
      StandaloneModeChanger.this.storeDefaultHomePackageName(
          ...
          new Consumer() { // from class:
            // com.android.server.desktopmode.StandaloneModeChanger$1$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              StandaloneModeChanger.C11421.lambda$onUserChanged$0((Boolean) obj);
            }
          });
    }
  }
  ...
  public StandaloneModeChanger(
    ...
    C11421 c11421 = new C11421();
    this.mStateListener = c11421;
    ...
    this.mStateManager.registerListener(c11421);
  }
  ...
  public final boolean usingNativeInCallUi() {
    ...
    if (Settings.System.getIntForUser(this.mResolver, "skt_phone20_settings", -1, currentUserId)
        == 1) {
      if (DesktopModeFeature.DEBUG) {
        Log.m7d(TAG, "usingNativeInCallUi()=false, using T Phone");
      }
      return false;
    }
    String defaultDialerApplication =
        DefaultDialerManager.getDefaultDialerApplication(this.mContext, currentUserId);
    if (defaultDialerApplication != null
        && !"com.samsung.android.contacts".equals(defaultDialerApplication)) {
      ...
      while (it.hasNext()) {
        ...
        if (serviceInfo != null && defaultDialerApplication.equals(serviceInfo.packageName)) {
          if (DesktopModeFeature.DEBUG) {
            Log.m7d(TAG, "usingNativeInCallUi()=false");
          }
          return false;
        }
      }
    ...
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "usingNativeInCallUi()=true");
    }
    return true;
  }
  ...
  public void onConfigurationChanged(final Configuration configuration) {
    if (DesktopModeFeature.DEBUG) {
      Log.m11v(TAG, "onConfigurationChanged(), config=" + configuration);
    }
  ...
  public final void lambda$onConfigurationChanged$0(Configuration configuration) {
    ...
    if (desktopModeState.state == 30 && desktopModeState.getDisplayType() == 101) {
      if (DesktopModeFeature.DEBUG) {
        Log.m11v(
            TAG,
            "handleOnConfigurationChanged(), newConfig="
                + configuration
                + ", desktopModeDensity="
                + this.mMultiResolutionManager.getStandaloneModeDensity()
                + ", desktopModeState="
                + desktopModeState);
      }
      ...
      if ((configurationState == 1 && desktopModeState.enabled == 3)
        ...
        if (DesktopModeFeature.DEBUG) {
          Log.m7d(TAG, "handleOnConfigurationChanged(), enabled=" + z);
        }
        ...
        if (z) {
          if (this.mTelecomManager.isInCall() && !usingNativeInCallUi()) {
            if (DesktopModeFeature.DEBUG) {
              Log.m7d(TAG, "Ongoing phone call!");
            }
  ...
  public int getConfigurationState(Configuration configuration) {
    ...
    boolean z3 =
        multiResolutionManager != null
            && configuration.densityDpi == multiResolutionManager.getStandaloneModeDensity();
    MultiResolutionManager multiResolutionManager2 = this.mMultiResolutionManager;
    boolean z4 =
        multiResolutionManager2 != null
            && configuration.densityDpi
                == multiResolutionManager2.getStandaloneModeOriginalDensity(0);
    if (z && z2 && z3) {
      return 1;
    }
    return (z2 || !z4) ? -1 : 0;
  ...
  public void startHome(State state) {
    ...
    this.mContext.startActivityAsUser(
        ...
        UserHandle.of(state.getCurrentUserId()));
  }
  ...
  public final boolean verifyCurrentState() {
    ...
    SemDesktopModeState desktopModeState = this.mStateManager.getState().getDesktopModeState();
    int configurationState = getConfigurationState(configuration);
    if ((configurationState == 1 && !this.mStandaloneModeEnabled)
        || ((configurationState == 0 && this.mStandaloneModeEnabled)
            || configurationState == -1
            || (((i = desktopModeState.enabled) == 3 && configurationState == 0)
                || (i == 1 && configurationState == 1)))) {
      String str =
          "verifyCurrentState(), Something is wrong! config="
              + configuration
              + ", mStandaloneModeEnabled="
              + this.mStandaloneModeEnabled
              + ", desktopModeDensity="
              + this.mMultiResolutionManager.getStandaloneModeDensity()
              + ", desktopModeState="
              + desktopModeState;
      ...
      if ((i2 == 3 && configurationState == 1) || (i2 == 1 && configurationState == 0)) {
        Log.m8e(
            str2,
            "Configuration is changed correctly, but was too late. Calling onConfigurationChanged()"
                + " directly...");
  ...
  public ModeChanger.ModeToModeChangeInfo setDesktopMode(
      State state, final boolean z, ModeChanger.ModeToModeChangeInfo modeToModeChangeInfo) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "setDesktopMode(), desktopMode=" + z);
    }
    if (z) {
  ...
  public /* synthetic */ void lambda$setDesktopMode$1(boolean z, Boolean bool) {
    if (!bool.booleanValue()) {
      Log.m8e(TAG, "Failed to add home role holder. desktopMode=" + z);
    }
  ...
  public final void storeDefaultHomePackageName(boolean z, Consumer consumer) {
    ...
    if (z) {
      ...
      DesktopModeSettings.setSettings(
          this.mResolver, "default_home_package", getDefaultHomePackageName(roleManager));
      return;
    }
    String settings =
        DesktopModeSettings.getSettings(this.mResolver, "default_home_package", (String) null);
    if (settings != null) {
      roleManager.addRoleHolderAsUser(
          "android.app.role.HOME",
          settings,
      ...
      Log.m12w(TAG, "storeDefaultHomePackageName(), packageName is null");
    }
  }
  ...
  public String getDefaultHomePackageName(RoleManager roleManager) {
    ...
    List roleHoldersAsUser =
        roleManager.getRoleHoldersAsUser("android.app.role.HOME", Process.myUserHandle());
  ...
  public final void scheduleStartLoadingScreen(boolean z, int i, int i2) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "scheduleStartLoadingScreen(), enter=" + z + ", reason=" + i);
    }
  ...
  public final void handleStartLoadingScreen(final boolean z, int i) {
    ...
    if (i == -1) {
      Log.m12w(TAG, "Loading screen shown by in-call UI timeout enter=" + z);
    } else if (DesktopModeFeature.DEBUG) {
      Log.m10i(TAG, "Starting loading screen... enter=" + z + ", reason=" + i);
    }
    if (this.mUiManager.bindUiServiceWithPendingCommand(
        new Runnable() { // from class:
          ...
          new UiManager.InternalUiCallback() { // from class:
            ...
            public void onAnimationComplete() {
              ...
              StandaloneModeChanger.this
                  .mHandler
                  .obtainMessage(1, 0, 0, Boolean.valueOf(z))
                  .sendToTarget();
            }
          });
    ...
    Log.m12w(TAG, "handleStartLoadingScreen(), Binding DesktopUiService... enter=" + z);
  }
  ...
  public final void setDesktopModeInternal(boolean z) {
    ...
    if (state.getDesktopModeState().compareTo(z ? 3 : 1, 20, 101)) {
      if (DesktopModeFeature.DEBUG) {
        Log.m7d(TAG, "setDesktopModeInternal(), enabled=" + z);
      }
  ...
  public final void setCustomConfigurations(boolean z) {
    try {
      ...
      this.mCurrentUiMode =
          (this.mUiModeManagerInternal.isNightMode() ? 32 : 16)
              | this.mUiModeManager.getCurrentModeType();
    } catch (RemoteException e) {
      Log.m9e(TAG, "Failed to set custom configurations", e);
    }
  }
  ...
  public final void scheduleStopLoadingScreenIfPossible() {
    ...
    if (DesktopModeFeature.DEBUG) {
      ...
      Log.m7d(str2, sb.toString());
    }
    if ((!DesktopModeFeature.FEATURE_STANDALONE_MODE_WALLPAPER || this.mWallpaperShown)
        && desktopModeState.state == 50) {
      if ((this.mUiManager.hasOverlay(101, 113) && this.mStandaloneModeEnabled)
          || ((this.mUiManager.hasOverlay(101, 114) && !this.mStandaloneModeEnabled)
              || this.mUiManager.hasOverlay(101, 117)
              || this.mUiManager.hasOverlay(101, 116))) {
        this.mHandler.removeMessages(3);
        this.mHandler.sendEmptyMessageDelayed(3, 0L);
      }
    }
  ...
  public final void handleStopLoadingScreen(boolean z, int i) {
    if (i == -1) {
      if (DesktopModeFeature.DEBUG) {
        Log.m12w(TAG, "Loading screen dismissed by timeout enter=" + z);
      }
      if (!hasPackageTask(0, "com.sec.android.app.desktoplauncher", 2)) {
        if (DesktopModeFeature.DEBUG) {
          Log.m7d(TAG, "DeX Home task does not exist");
        }
        startHome(this.mStateManager.getState());
      }
    } else if (DesktopModeFeature.DEBUG) {
      Log.m10i(TAG, "Stopping loading screen... enter=" + z);
    }
    SemDvfsManager semDvfsManager = this.mDvfsManager;
    if (semDvfsManager != null) {
    ...
    if (verifyCurrentState()) {
      ...
      this.mUiManager.dismissOverlay(
          100,
          (modeToModeChangeInfo2 == null || !modeToModeChangeInfo2.showModeChangeScreen())
              ? z ? 113 : 114
              : z ? 116 : 117);
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    indentingPrintWriter.println(
        "Current " + StandaloneModeChanger.class.getSimpleName() + " state:");
    indentingPrintWriter.increaseIndent();
    indentingPrintWriter.println("mCurrentUiMode=" + this.mCurrentUiMode);
    indentingPrintWriter.println(
        "mIsLockTaskModeEnabledAndSecured=" + this.mIsLockTaskModeEnabledAndSecured);
  ...
  public final class ModeChangeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      if (i != 1) {
        if (i == 2) {
          StandaloneModeChanger.this.handleStartLoadingScreen(
          ...
          standaloneModeChanger.handleStopLoadingScreen(
              standaloneModeChanger.mStandaloneModeEnabled, message.arg1);
          return;
        }
      }
      ...
      if (z) {
        ActivityTaskManagerInternal activityTaskManagerInternal =
            StandaloneModeChanger.this.mActivityTaskManagerInternal;
        if (!booleanValue
            ? !activityTaskManagerInternal.goodToChangeMode(0, 1)
            : !activityTaskManagerInternal.goodToChangeMode(1, 0)) {
          if (DesktopModeFeature.DEBUG) {
            Log.m7d(
                StandaloneModeChanger.TAG,
                "Not all activities are stopped! retryCount=" + i2 + ", waiting more 500ms...");
          }
          Handler handler = StandaloneModeChanger.this.mHandler;
          handler.sendMessageDelayed(
              handler.obtainMessage(1, i2 + 1, 0, Boolean.valueOf(booleanValue)), 500L);
          return;
        }
      }
      if (!z) {
        Log.m8e(
            StandaloneModeChanger.TAG,
            "Not all activities are stopped! timeout!! retryCount=" + i2);
      }
  ...
  public class ModeChangeReceiver extends BroadcastReceiver {
    ...
    public final void register() {
      ...
      StandaloneModeChanger.this.mContext.registerReceiverAsUser(
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (DesktopModeFeature.DEBUG) {
        Log.m7d(StandaloneModeChanger.TAG, "onReceive(), action=" + action);
      }
      ...
      if ("android.intent.action.TIME_TICK".equals(action)) {
        ...
        if (freeMemory < 419430400) {
          if (DesktopModeFeature.DEBUG) {
            Log.m12w(
                StandaloneModeChanger.TAG, "Low memory warning: " + (freeMemory / 1048576) + "MB");
          }
          ToastManager.showToast(
              StandaloneModeChanger.this.mContext, R.string.global_action_restart);
        }
      }
    }
  }
