...
public abstract class DesktopModeKillPolicyManager {
  public static final String TAG =
      "[DMS_POLICY]" + DesktopModeKillPolicyManager.class.getSimpleName();
  public static final Set KEEP_POLICY_PACKAGES =
      Set.of(
  ...
  public static final Set KILL_POLICY_PACKAGES =
      Set.of(
  ...
  public static Bundle getDesktopModeKillPolicy() {
    ...
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "getDesktopModeKillPolicy(), args=" + bundle);
    }
    return bundle;
  }
  ...
  public static void dump(IndentingPrintWriter indentingPrintWriter) {
    indentingPrintWriter.println(
        "Current " + DesktopModeKillPolicyManager.class.getSimpleName() + " state:");
