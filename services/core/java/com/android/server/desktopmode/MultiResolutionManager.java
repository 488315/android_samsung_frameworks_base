...
public class MultiResolutionManager {
  ...
  /* renamed from: HD */
  public static final Resolution f1673HD;
  ...
  public final SettingsHelper.OnSettingChangedListener mUserSettingResolutionChangedListener =
      new SettingsHelper.OnSettingChangedListener("resolution_user_setting") { // from class:
        // com.android.server.desktopmode.MultiResolutionManager.1
        ...
        public void onSettingChanged(String str, int i) {
          if (MultiResolutionManager.this
              .mStateManager
              .getState()
          ...
          if (str == null) {
            if (DesktopModeFeature.DEBUG) {
              Log.m8e(MultiResolutionManager.TAG, "Resolution user setting is null.");
            }
            MultiResolutionManager multiResolutionManager = MultiResolutionManager.this;
            multiResolutionManager.setSelectedDisplayMetrics(
                multiResolutionManager.mMaxSupportedResolution,
                MultiResolutionManager.this.mSelectedDisplayMetrics.density);
            return;
          }
          ...
          multiResolutionManager2.setSelectedDisplayMetrics(
              resolution, MultiResolutionManager.this.mSelectedDisplayMetrics.density);
        }
      };
  public final SettingsHelper.OnSettingChangedListener mDualModeDensityChangedListener =
      new SettingsHelper.OnSettingChangedListener("dual_mode_screen_zoom") { // from class:
        // com.android.server.desktopmode.MultiResolutionManager.2
        @Override // com.android.server.desktopmode.SettingsHelper.OnSettingChangedListener
        public void onSettingChanged(String str, int i) {
          MultiResolutionManager multiResolutionManager = MultiResolutionManager.this;
          multiResolutionManager.setSelectedDisplayMetrics(
  ...
  public final SettingsHelper.OnSettingChangedListener mStandaloneModeDensityChangedListener =
      new SettingsHelper.OnSettingChangedListener("standalone_mode_screen_zoom") { // from class:
        // com.android.server.desktopmode.MultiResolutionManager.3
        @Override // com.android.server.desktopmode.SettingsHelper.OnSettingChangedListener
        public void onSettingChanged(String str, int i) {
          MultiResolutionManager.this.mStandaloneModeDisplayMetrics.setSelectedDensity(
              str == null ? -1 : Integer.parseInt(str));
        }
      };
  ...
  public MultiResolutionManager(
    ...
    StateManager.StateListener stateListener = new StateManager.StateListener() { // from class:
          ...
          public void onUserChanged(State state) {
            MultiResolutionManager.this.onUserChanged(
                state.getDesktopModeState().compareTo(4, 0, 102));
          }

          @Override // com.android.server.desktopmode.StateManager.StateListener
          public void onExternalDisplayUpdated(State state) {
            MultiResolutionManager.this.updateDisplayResolutionUnsupported(
                state.getConnectedDisplay());
            MultiResolutionManager multiResolutionManager = MultiResolutionManager.this;
            multiResolutionManager.handleReconnection(
                multiResolutionManager.mStateManager.getState());
          }
          ...
          public void onExternalDisplayConnectionChanged(State state) {
            ...
            if (((i != 4 || desktopModeState.state == 0) && i != 3)
                || state.getDesktopDisplayId() == -1) {
              return;
            }
          ...
          public void onStartLoadingScreen(boolean z) {
            if (z) {
              MultiResolutionManager.this.mSettingsHelper.registerListener(
                  MultiResolutionManager.this.mStandaloneModeDensityChangedListener);
            } else {
              MultiResolutionManager.this.mSettingsHelper.unregisterListener(
                  MultiResolutionManager.this.mStandaloneModeDensityChangedListener);
            }
          }
          ...
          public void onDualModeStartLoadingScreen(boolean z) {
            if (z) {
              MultiResolutionManager.this.mSettingsHelper.registerListener(
                  MultiResolutionManager.this.mUserSettingResolutionChangedListener);
              MultiResolutionManager.this.mSettingsHelper.registerListener(
                  MultiResolutionManager.this.mDualModeDensityChangedListener);
            } else {
              MultiResolutionManager.this.mSettingsHelper.unregisterListener(
                  MultiResolutionManager.this.mUserSettingResolutionChangedListener);
              MultiResolutionManager.this.mSettingsHelper.unregisterListener(
  ...
  public final void setSelectedDisplayMetrics(Resolution resolution, int i) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "setSelectedDisplayMetrics: resolution=" + resolution + ", density=" + i);
    }
    ...
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "changed to: " + displayMetrics);
    }
    this.mSelectedDisplayMetrics = displayMetrics;
    State state = this.mStateManager.getState();
    if (state.getDesktopDisplayId() != -1) {
      this.mWindowManagerInternal.setDisplaySizeAndDensityInDex(
          state.getDesktopDisplayId(),
          getSelectedDisplayMetrics().resolution.width,
          getSelectedDisplayMetrics().resolution.height,
          getSelectedDisplayMetrics().density);
    }
  }
  ...
  public int setDualDisplayResolutionDensity(boolean z) {
    if (z) {
      ...
      return this.mAtmInternal.enableDexDisplay(
          getSelectedDisplayMetrics().resolution.width,
          getSelectedDisplayMetrics().resolution.height,
          getSelectedDisplayMetrics().density);
    }
  ...
  public final void updateDisplayResolutionUnsupported(DisplayInfo displayInfo) {
    this.mStateManager.setDisplayResolutionUnsupported(
        calculateMaxSupportedResolution(displayInfo, null) == null);
  }

  public final void showUserSettingIsNotSupportedToast() {
    if (this.mUserSettingResolution == null
        || this.mStateManager.getState().isDexOnPcOrWirelessDexConnected()
        || this.mUserSettingResolution.isSupportedOn(getSelectedDisplayMetrics().resolution)) {
      return;
    }
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "showToastResolutionChanged()");
    }
    int desktopDisplayId = this.mStateManager.getState().getDesktopDisplayId();
    if (desktopDisplayId != -1) {
      ToastManager.showToast(
          Utils.getDisplayContext(this.mContext, desktopDisplayId),
  ...
  public final void updateDualDisplayMetrics() {
    ...
    if (connectedDisplay == null || this.mIsForcedSupportAllResolution) {
      ...
      if (this.mUserSettingResolution == null
        ...
        resolution =
            this.mUserSettingResolution.isSupportedOn(this.mMaxSupportedResolution)
    ...
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "mSelectedDisplayMetrics= " + this.mSelectedDisplayMetrics);
    }
  }
  ...
  public final boolean isResolutionChangeNeeded(State state) {
    ...
    if (this.mUserSettingResolution == null) {
      z =
          true
              ^ calculateMaxSupportedResolution(state.getConnectedDisplay())
                  .equals(this.mLastDualModeMaxSupportedResolution);
    } else if (!calculateMaxSupportedResolution(state.getConnectedDisplay())
        .isSupportedOn(getSelectedDisplayMetrics().resolution)) {
      z = false;
    } else if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "This display does not support current resolution.");
    }
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "isResolutionChangeNeeded: " + z);
    }
    return z;
  }
  ...
  public final void updateMaxSupportedResolution(Resolution resolution) {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "updateMaxSupportedResolution: " + resolution);
    }
    this.mMaxSupportedResolution = resolution;
  ...
  public final void updateUserSettingDisplayMetrics() {
    if (DesktopModeFeature.DEBUG) {
      Log.m7d(TAG, "updateUserSettingDisplayMetrics()");
    }
    this.mUserSettingResolution =
        (Resolution)
            RESOLUTION_TABLE.get(
                DesktopModeSettings.getSettings(
                    this.mResolver, "resolution_user_setting", (String) null));
    this.mSelectedDisplayMetrics.setDensity(
        DesktopModeSettings.getSettings(this.mResolver, "dual_mode_screen_zoom", 160));
  }
  ...
  public final Resolution calculateMaxSupportedResolution(
    ...
    if (displayInfo != null) {
      ...
      if (DesktopModeFeature.DEBUG) {
        Log.m7d(TAG, "calculateMaxSupportedResolution(), displayInfo=" + displayInfo);
      }
      if ((displayInfo.getRotation() == 1 || displayInfo.getRotation() == 3)
          && (i = realSize.y) > (i2 = realSize.x)) {
        realSize.set(i, i2);
      }
  ...
  public final void handleReconnection(State state) {
    ...
    if ((i == 4 || i == 3) && state.getDesktopDisplayId() != -1) {
      ...
      if (DesktopModeFeature.DEBUG) {
        Log.m7d(TAG, "No need to change resolution");
      }
      if (this.mUserSettingResolution != null) {
  ...
  public void dump(IndentingPrintWriter indentingPrintWriter) {
    indentingPrintWriter.println(
        "Current " + MultiResolutionManager.class.getSimpleName() + " state:");
    indentingPrintWriter.increaseIndent();
    indentingPrintWriter.println(
        "mIsForcedSupportAllResolution=" + this.mIsForcedSupportAllResolution);
    indentingPrintWriter.println(
        "mDisplayRemovedOnEnablingDesktopMode=" + this.mDisplayRemovedOnEnablingDesktopMode);
    indentingPrintWriter.println(
        "mStandaloneModeDisplayMetrics=" + this.mStandaloneModeDisplayMetrics);
    ...
    indentingPrintWriter.println(
        "mLastDualModeMaxSupportedResolution=" + this.mLastDualModeMaxSupportedResolution);
  ...
  public void setCustomResolutionFromAdbCommand(PrintWriter printWriter, int i, int i2, int i3) {
    try {
      ...
      printWriter.println(
          "Failed to set custom resolution. Width, height, and density must be greater than 0."
              + " Custom resolution is removed.");
    }
  }
  ...
  public class StandaloneModeDisplayMetrics {
    ...
    public StandaloneModeDisplayMetrics() {
      int[] initialDisplayProperties =
          MultiResolutionManager.this.mWindowManagerInternal.getInitialDisplayProperties(0);
      this.mDisplayProperties = initialDisplayProperties;
      DisplayMetrics displayMetrics =
          new DisplayMetrics(
              new Resolution("Tablet", initialDisplayProperties[0], initialDisplayProperties[1]),
    ...
    public final int getDesktopModeDefaultDensity() {
      ...
      if (fixedZoomProperty != 0) {
        Log.m7d(
            MultiResolutionManager.TAG,
            "getDesktopModeDefaultDensity(), dpi= " + fixedZoomProperty);
    ...
    public DisplayMetrics getSelectedDisplayMetrics() {
      return MultiResolutionManager.this.mCustomDisplayMetrics != null
    ...
    public final DisplayMetrics getOriginalDisplaySizeDensity(int i) {
      int[] initialDisplayProperties =
          MultiResolutionManager.this.mWindowManagerInternal.getInitialDisplayProperties(i);
      String string =
          Settings.Global.getString(MultiResolutionManager.this.mResolver, "display_size_forced");
      if (string != null && string.length() > 0) {
        ...
        if (indexOf > 0 && string.lastIndexOf(44) == indexOf) {
          try {
            ...
            Log.m9e(MultiResolutionManager.TAG, "Failed to parse previous forced display size", e);
          }
        }
      } else if (DesktopModeFeature.DEBUG) {
        Log.m10i(
      ...
      try {
        int intForUser =
            Settings.Secure.getIntForUser(
                MultiResolutionManager.this.mResolver, "display_density_forced", 0);
        if (intForUser > 0) {
      ...
      return new DisplayMetrics(
          new Resolution("Original", initialDisplayProperties[0], initialDisplayProperties[1]),
          initialDisplayProperties[2]);
    }

    public final void setSamsungWindowManagerForcedDisplaySizeDensity(
        int i, int i2, int i3, int i4) {
      MultiResolutionManager.this.mWindowManagerInternal.setDisplaySizeAndDensityInDex(
          i, i2, i3, i4);
    }
    ...
    public final void restoreOriginalSizeDensity(int i) {
      ...
      if (DesktopModeFeature.DEBUG) {
        Log.m10i(MultiResolutionManager.TAG, "Restoring display: " + originalDisplaySizeDensity);
      }
      Resolution resolution = originalDisplaySizeDensity.resolution;
      setSamsungWindowManagerForcedDisplaySizeDensity(
          i, resolution.width, resolution.height, originalDisplaySizeDensity.density);
    }
    ...
    public final void setForcedDisplayMertics(boolean z) {
      if (z) {
        ...
        setSamsungWindowManagerForcedDisplaySizeDensity(
            0, resolution.width, resolution.height, selectedDisplayMetrics.density);
        return;
      }
    ...
    public final void setSelectedDensity(int i) {
      ...
      if (this.mSelectedDisplayMetrics.density != i) {
        if (DesktopModeFeature.DEBUG) {
          Log.m7d(MultiResolutionManager.TAG, "changed to: " + i);
        }
