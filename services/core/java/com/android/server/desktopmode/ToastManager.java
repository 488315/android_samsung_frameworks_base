...
public abstract class ToastManager {
            ...
            public void onToastHidden() {
                synchronized (ToastManager.sToasts) {
                    ...
                    if (DesktopModeFeature.DEBUG) {
                        Log.m7d(ToastManager.TAG, "Toast.onToastHidden(), msg=" + str + ", sToasts=" + ToastManager.sToasts);
                    }
                }
            }
        });
    ...
    public static void adjustGravityForCoverUi(Context context, Toast toast) {
        ...
        if (display == null || display.getDisplayId() == 0) {
            ...
            toast.setGravity(80, 0, context.getResources().getDimensionPixelOffset(R.dimen.conversation_image_start_margin));
        }
    }
