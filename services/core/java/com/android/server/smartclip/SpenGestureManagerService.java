...
public class SpenGestureManagerService extends ISpenGestureService.Stub {
  ...
  public SmartClipRemoteRequestSyncManager mSmartClipRemoteRequestSyncManager =
      new SmartClipRemoteRequestSyncManager();
  public boolean mBootComplete = false;
  public long mLastScreenOffDoubleTapTime = 0;
  public BroadcastReceiver mBroadcastReceiver =
      new BroadcastReceiver() { // from class:
                                // com.android.server.smartclip.SpenGestureManagerService.1
        ...
        public void onReceive(Context context, Intent intent) {
          ...
          if ("com.samsung.pen.INSERT".equals(action)) {
            ...
            if (SpenGestureManagerService.this.mBleSpenManager.isSupportBleSpen()
              ...
              if (SpenGestureManagerService.this.mBleSpenManager.isAirActionSettingEnabled()) {
                SpenGestureManagerService.this.mBleSpenManager.startRemoteSpenService(
                    SpenGestureManagerService.mContext, null);
              } else {
                Log.i(
                    SpenGestureManagerService.TAG,
                    "onReceive : air action is disabled. startBlindChargeService");
                SpenGestureManagerService.this.mBleSpenManager.startBlindChargeService(
                    SpenGestureManagerService.mContext, null);
              }
            }
            if (booleanExtra) {
              long currentTimeMillis =
                  System.currentTimeMillis() - SpenGestureManagerService.this.mSpenUsingStartTime;
              str = "";
              ...
              SpenGestureManagerService.this.sendLogSpenInsertInfo(
                  packageName, SpenGestureManagerService.USE_APP_FEATURE_NAME_SPAT);
            } else {
              str = "";
              SpenGestureManagerService.this.mSpenUsingStartTime = System.currentTimeMillis();
              SpenGestureManagerService.this.sendLogSpenInsertInfo(
                  packageName, SpenGestureManagerService.USE_APP_FEATURE_NAME_SPEN);
            }
            ...
            bundle.putString(
                "topComponent", topMostPackage != null ? topMostPackage.getClassName() : str);
            ...
            bundle.putBoolean(
                "isReversed", SpenGestureManagerService.this.mIsPenReversed.booleanValue());
          ...
          if ("com.sec.android.intent.action.BLACK_MEMO".equals(action)) {
            ...
            SpenGestureManagerService.this.mAcIsScreenOffMemoShowing =
                KnoxCustomManagerService.SHOW.equals(str2);
            return;
          }
          if ("android.intent.action.AIRPLANE_MODE".equals(action)) {
            if (SpenGestureManagerService.this.mBleSpenManager.isSupportBleSpen()) {
              boolean booleanExtra4 =
                  intent.getBooleanExtra(LauncherConfigurationInternal.KEY_STATE_BOOLEAN, false);
              Intent intent2 =
                  new Intent(
                      "com.samsung.android.service.aircommand.remotespen.action.COMMON_BROADCAST");
          ...
          if ("android.intent.action.USER_SWITCHED".equals(action)) {
            ...
            if (SpenGestureManagerService.this.mBleSpenManager.isSupportBleSpen()) {
              if (SpenGestureManagerService.this.mIsPenInserted != null) {
                ...
                bundle2.putBoolean(
                    "penInsert", SpenGestureManagerService.this.mIsPenInserted.booleanValue());
              ...
              Log.i(
                  SpenGestureManagerService.TAG,
                  "onReceive : SPen insertion state is not detected yet");
              return;
            }
            return;
          }
          if ("android.intent.action.BOOT_COMPLETED".equals(action)) {
            ...
            if (SpenGarageSpecManager.getInstance().isBundledSpenSupported()) {
              Log.i(
                  SpenGestureManagerService.TAG,
                  "onReceive : This model is bundle pen provided model");
            } else {
              if (SpenGestureManagerService.this.isDigitizerEnabled(
                  SpenGestureManagerService.mContext)) {
                return;
              }
  ...
  public CoverManager.StateListener mCoverStateListener =
      new CoverManager
          .StateListener() { // from class: com.android.server.smartclip.SpenGestureManagerService.2
        public void onCoverStateChanged(CoverState coverState) {
          ...
          if (SpenGestureManagerService.this.mIsPenInserted == null
              || SpenGestureManagerService.this.mIsPenInserted.booleanValue()) {
            return;
          }
  ...
  public Runnable mPenDoubleTap =
      new Runnable() { // from class: com.android.server.smartclip.SpenGestureManagerService.5
        @Override // java.lang.Runnable
        public void run() {
          ContentResolver contentResolver = SpenGestureManagerService.mContext.getContentResolver();
          SpenGestureManagerService.this.mIsEnableLockScreenQuickNote =
              Settings.Secure.getIntForUser(contentResolver, "lock_screen_quick_note", 0, -2) != 0;
          if (!(Settings.System.semGetIntForUser(contentResolver, "spen_double_tap_launch", 1, -2)
              != 0)) {
            Log.i(
                SpenGestureManagerService.TAG,
                "Double tap is disable : Spen double tap launch disabled");
            return;
          }
          if (SpenGestureManagerService.this.keyguardOn()
              && !SpenGestureManagerService.this.mIsEnableLockScreenQuickNote) {
            Log.i(
                SpenGestureManagerService.TAG,
                "Double tap is disable : "
                    + SpenGestureManagerService.this.mIsEnableLockScreenQuickNote);
            return;
          }
          if (SpenGestureManagerService.this.isScreenPinningEnabled()) {
            Log.e(
                SpenGestureManagerService.TAG,
                "Double tap is disabled : Screen pinning mode enabled");
            return;
          }
          if (SpenGestureManagerService.this.isAppSwitchingBlocked()) {
            Log.e(
                SpenGestureManagerService.TAG, "Double tap is disabled : App switching is blocked");
          } else if (SpenGestureManagerService.this.isDoubleTapBlockedAppsByMetaData()) {
            Log.e(
                SpenGestureManagerService.TAG,
                "Double tap is disabled by MetaData : This is a double-tap blocked app.");
          } else {
  ...
  public SpenGestureManagerService(Context context, WindowManagerService windowManagerService) {
    ...
    Handler handler =
        new Handler() { // from class: com.android.server.smartclip.SpenGestureManagerService.6
    ...
    this.mAcServiceConnection =
        new ServiceConnection() { // from class:
                                  // com.android.server.smartclip.SpenGestureManagerService.7
          ...
          public void onServiceDisconnected(ComponentName componentName) {
            ...
            SpenGestureManagerService.mContext.unbindService(
                SpenGestureManagerService.this.mAcServiceConnection);
    ...
    if (isSupportSpen()) {
      SPenGestureInputEventReceiver sPenGestureInputEventReceiver =
          new SPenGestureInputEventReceiver();
    ...
    this.mSemInputDeviceManager =
        (SemInputDeviceManager) mContext.getSystemService("SemInputDeviceManagerService");
        ...
        new GestureDetector(
            ...
            new GestureDetector
                .SimpleOnGestureListener() { // from class:
                                             // com.android.server.smartclip.SpenGestureManagerService.3
              ...
              public boolean onDoubleTap(MotionEvent motionEvent) {
                ...
                Cursor query =
                    SpenGestureManagerService.mContext
                        .getContentResolver()
                        .query(
                            Uri.parse("content://com.sec.knox.provider2/KnoxCustomManagerService1"),
                            null,
                            "getSealedState",
                            null,
                            null);
                if (query != null) {
                  try {
                    ...
                    if (query.getString(query.getColumnIndex("getSealedState")).equals("true")) {
                      Log.i(
                          SpenGestureManagerService.TAG,
                          "now KNOX state : can't excute Double Tap");
                      query.close();
                      return true;
                    }
                  } finally {
                ...
                SpenGestureManagerService.this.mHandler.post(
                    SpenGestureManagerService.this.mPenDoubleTap);
                return true;
              }
            });
  }
  ...
  public final void registerPackageMonitor() {
    PackageMonitor packageMonitor =
        new PackageMonitor() { // from class:
                               // com.android.server.smartclip.SpenGestureManagerService.4
          public void onPackageDataCleared(String str, int i) {
            if ("com.samsung.android.service.aircommand".equals(str)) {
              Settings.System.putInt(
                  SpenGestureManagerService.mContext.getContentResolver(), "air_cmd_mode", 0);
            }
          }
        };
  ...
  public void sendSmartClipRemoteRequestResult(
      SmartClipRemoteRequestResult smartClipRemoteRequestResult) {
    if (smartClipRemoteRequestResult != null) {
      Log.i(
          TAG,
          "sendSmartClipRemoteRequestResult : requestId="
              + smartClipRemoteRequestResult.mRequestId
              + " requestType="
              + smartClipRemoteRequestResult.mRequestType);
  ...
  public final void checkPermission(String str) {
    ...
    Log.e(
        TAG,
        "checkPermission : Requires "
            + str
            + " permission. caller PID="
  ...
  public SemSmartClipDataRepository getSmartClipDataByScreenRect(
      Rect rect, IBinder iBinder, int i, int i2) {
    ...
    try {
      synchronized (this.mDataExtractionSync) {
        ...
        int allocateNewRequestId =
            this.mSmartClipRemoteRequestSyncManager.allocateNewRequestId(true);
        asInterface.dispatchSmartClipRemoteRequest(
            rect.centerX(),
            rect.centerY(),
            new SmartClipRemoteRequestInfo(
                allocateNewRequestId,
                1,
                i2,
                new SmartClipDataExtractionEvent(allocateNewRequestId, rect, i)),
            iBinder);
        SmartClipRemoteRequestResult waitResult =
            this.mSmartClipRemoteRequestSyncManager.waitResult(allocateNewRequestId, 500);
        if (waitResult != null) {
          ...
          Log.i(
              TAG,
              "getSmartClipDataByScreenRect : wait is unlocked. Repository = "
  ...
  public Bundle getScrollableAreaInfo(Rect rect, IBinder iBinder) {
    ...
    try {
      ...
      asInterface.dispatchSmartClipRemoteRequest(
          ...
          new SmartClipRemoteRequestInfo(allocateNewRequestId, 4, 1, (Parcelable) null),
          iBinder);
      SmartClipRemoteRequestResult waitResult =
          this.mSmartClipRemoteRequestSyncManager.waitResult(allocateNewRequestId, 500);
      if (waitResult != null) {
  ...
  public Bundle getScrollableViewInfo(Rect rect, int i, IBinder iBinder) {
    ...
    try {
      ...
      asInterface.dispatchSmartClipRemoteRequest(
          rect.left + (rect.width() / 2),
          rect.top + (rect.height() / 2),
          new SmartClipRemoteRequestInfo(allocateNewRequestId, 5, 1, bundle),
          iBinder);
      SmartClipRemoteRequestResult waitResult =
          this.mSmartClipRemoteRequestSyncManager.waitResult(allocateNewRequestId, 500);
      if (waitResult != null) {
  ...
  public void injectInputEvent(
      int i, int i2, InputEvent[] inputEventArr, boolean z, IBinder iBinder) {
    ...
    try {
      synchronized (this.mDataExtractionSync) {
        ...
        asInterface.dispatchSmartClipRemoteRequest(
            i, i2, new SmartClipRemoteRequestInfo(allocateNewRequestId, 3, 1, bundle), iBinder);
        if (z) {
          SmartClipRemoteRequestResult waitResult =
              this.mSmartClipRemoteRequestSyncManager.waitResult(allocateNewRequestId, 500);
          if (waitResult != null) {
  ...
  public final Rect getFullScreenRect() {
    ...
    return new Rect(
        0, 0, Math.abs(displayMetrics.widthPixels), Math.abs(displayMetrics.heightPixels));
  }

  public final void checkSettingCondition() {
    this.mIsEnableLockScreenQuickNote =
        Settings.Secure.getIntForUser(
                mContext.getContentResolver(), "lock_screen_quick_note", 0, -2)
            == 1;
    Log.i(
        TAG,
        "checkSettingCondition, LOCK_SCREEN_QUICK_NOTE : " + this.mIsEnableLockScreenQuickNote);
  }

  public final class SPenGestureInputEventReceiver
    ...
    public final void sendEventToCfmsService(int i) {
      ...
      try {
        if (this.sCfmsService == null
            && (service = ServiceManager.getService("CustomFrequencyManagerService")) != null) {
      ...
      try {
        ...
        boolean z =
            (motionEvent.getButtonState()
                    & SpenGestureManagerService.EVENT_STATE_PEN_BUTTON_PRESSED)
                != 0;
        if (SpenGestureManagerService.this.mSpenUspLevel >= 3) {
          ...
          if (SpenGestureManagerService.this.mHoverListeners != null
              && SpenGestureManagerService.this.mHoverListeners.getRegisteredCallbackCount() > 0) {
            SpenGestureManagerService.this.checkHoverStay(motionEvent, action, z);
          }
          if (z && action != 7 && action != 2) {
            Log.i(
                SpenGestureManagerService.TAG,
                "onPointerEvent 4 : Action="
                    + MotionEvent.actionToString(action)
                    + ", sideButtonPressed="
                    + z
                    + ", coverOpened="
                    + SpenGestureManagerService.this.mClearCoverOpened);
          }
          ...
          if (action == 9) {
            ...
            if (SpenGestureManagerService.this.mHandler.hasMessages(12312)) {
              ...
              Log.i(
                  SpenGestureManagerService.TAG,
                  "[HOVER] sending hover exit br is canceled by touch event.");
            }
          ...
          if (z2) {
            switch (action) {
              ...
              case 5:
                if (!"sec_unused_e-pen"
                    .equals(SpenGestureManagerService.this.getPenName(motionEvent))) {
        ...
        if (elapsedRealtimeNanos2 > 1000000000) {
          Log.e(
              SpenGestureManagerService.TAG,
              "onPointerEvent : total time = " + elapsedRealtimeNanos2);
        }
      }
    }
  }
  ...
  public final void processMotionEventForAirCMD(MotionEvent motionEvent, int i, boolean z) {
      ...
      if (i != 1) {
        if (i != 5) {
          if (i != 6) {
            if (i != 7) {
              if (i == 9) {
                if (this.mAcAutoFloatingIconMode && !this.mAcIsScreenOffMemoShowing) {
                  if (motionEvent.getDownTime() <= 0) {
                    ...
                    dispatchPenDetectionInfo(
                        i, motionEvent.getEventTime(), getPenName(motionEvent), 100L);
                  }
                }
              ...
              if (i == 10 && this.mAcAutoFloatingIconMode && !this.mAcIsScreenOffMemoShowing) {
                ...
                if (inputManager != null && inputManager.semGetScanCodeState(-1, -256, 320) == 0) {
                  ...
                  dispatchPenDetectionInfo(
                      i, motionEvent.getEventTime(), getPenName(motionEvent), 0L);
            ...
            int rawY = (int) motionEvent.getRawY();
            String str =
                rawX < mContext.getResources().getDisplayMetrics().widthPixels / 2
                    ? "left"
                    : "right";
    ...
    if (!this.mAcAutoFloatingIconMode
        || this.mAcIsScreenOffMemoShowing
        || this.mAcIsHoverOccuredBeforeTouchDown) {
      return;
    }
  ...
  public final void startAirCommandUiService(Bundle bundle) {
    if (canStartAirCommand()) {
      ...
      try {
        Intent intent =
            new Intent("com.samsung.android.service.aircommand.action.AIR_COMMAND_SERVICE");
          ...
          boolean bindServiceAsUser =
              this.mAcIsBound
                  ...
                  : mContext.bindServiceAsUser(
                      intent, this.mAcServiceConnection, 0, UserHandle.CURRENT);
          if (AC_DEBUG) {
  ...
  public final void startAirCommandSpenTriggerService(Bundle bundle) {
    if (canStartAirCommand()) {
      try {
        Intent intent =
            new Intent("com.samsung.android.service.aircommand.action.SPEN_TRIGGER_SERVICE");
        intent.setPackage("com.samsung.android.service.aircommand");
        if (bundle != null) {
          intent.putExtras(bundle);
        }
  ...
  public final void onFloatingIconSettingChanged(boolean z) {
    ...
    if (z) {
      ...
      if (true == this.mBootComplete
          || true == SpenGarageSpecManager.getInstance().isBundledSpenSupported()) {
        Bundle bundle = new Bundle();
  ...
  public class AcSettingsObserver extends ContentObserver {
    ...
    public void observe() {
      ContentResolver contentResolver = SpenGestureManagerService.mContext.getContentResolver();
      SpenGestureManagerService.this.onFloatingIconSettingChanged(
          isFloatingIconEnabled() && isAirCommandSettingEnabled());
      contentResolver.registerContentObserver(
          Settings.System.getUriFor("air_cmd_use_minimized"), false, this, -1);
      contentResolver.registerContentObserver(
          Settings.System.getUriFor("air_button_onoff"), false, this);
      contentResolver.registerContentObserver(
          Settings.System.getUriFor("pen_digitizer_enabled"),
          false,
          new ContentObserver(
              SpenGestureManagerService.this
                  .mHandler) { // from class:
                               // com.android.server.smartclip.SpenGestureManagerService.AcSettingsObserver.1
            @Override // android.database.ContentObserver
            public void onChange(boolean z) {
              SpenGestureManagerService.this.onSpenDigitizerOnOffChanged(
                  Settings.System.semGetIntForUser(
                          SpenGestureManagerService.mContext.getContentResolver(),
                          "pen_digitizer_enabled",
                          1,
                          -2)
                      == 1);
            }
    ...
    public final boolean isAirCommandSettingEnabled() {
      return Settings.System.getInt(
              SpenGestureManagerService.mContext.getContentResolver(), "air_button_onoff", 0)
          == 1;
    }
  }
    ...
    if (i == 7) {
      ...
      while (size >= 0) {
        ...
        if (penDataStruct2.EnterTime < penDataStruct.EnterTime - this.ALLOWANCE_HOVER_TIME) {
          ...
          Log.i(
              TAG,
              "dictionary service start : hover time = "
                  + this.ALLOWANCE_HOVER_TIME
                  + " x = "
                  + this.ALLOWANCE_RANGE_X
                  + " y = "
                  + this.ALLOWANCE_RANGE_Y);
  ...
  public final void launchDoubleTapAction() {
    ...
    if (spenThemeManager != null && spenThemeManager.canLaunchCustomDoubleTapAction()) {
      this.mThemeManager.launchCustomDoubleTapAction(
          getFocusedUserHandle(mContext), this.mLastDoubleTapPosition);
    } else {
  ...
  public final void launchActionMemo(Point point) {
    ...
    if (this.mSpenUspLevel >= 20) {
      ...
      intent.setClassName(
          ...
          "com.samsung.android.app.notes.popupnote.PopupNoteService");
      if (point != null) {
    ...
    intent2.setClassName(
        ...
        "com.samsung.android.snote.control.ui.quickmemo.service.QuickMemo_Service");
    ...
    if (mContext.startServiceAsUser(intent2, focusedUserHandle) == null) {
      Log.d(
          TAG,
          "launchActionMemo : Snote action memo launch failed. Trying to launch diotek PenMemo...");
      ...
      if (mContext.startServiceAsUser(intent3, focusedUserHandle) == null) {
        Log.e(
            TAG,
            "launchActionMemo : Diotek PenMemo launch failed. Sending legacy quick memo"
                + " broadcasting");
        mContext.sendBroadcastAsUser(
            new Intent("android.intent.action.QUICKMEMO_LAUNCH"), focusedUserHandle);
      }
    }
  }
  ...
  public final boolean moveMetaFilesToLocalStorage(
      SemSmartClipDataRepository semSmartClipDataRepository) {
  ...
  public void showTouchPointer(final boolean z) {
    ...
    checkSmartClipMetaExtractionPermission();
    this.mHandler.post(
        new Runnable() { // from class: com.android.server.smartclip.SpenGestureManagerService.8
          @Override // java.lang.Runnable
          public void run() {
            Settings.System.putInt(
                SpenGestureManagerService.mContext.getContentResolver(), "show_touches", z ? 1 : 0);
          }
        });
  }
  ...
  public final void broastcastHoverEvent(int i) {
    ...
    Log.i(
        TAG,
        "mHoverListeners.getRegisteredCallbackCount() = "
            + this.mHoverListeners.getRegisteredCallbackCount());
  }
  ...
  public final ComponentName getTopMostPackage() {
    List<ActivityManager.RunningTaskInfo> runningTasks =
        ((ActivityManager) mContext.getSystemService("activity")).getRunningTasks(1);
  ...
  public final void calculateSpenUsingDuration(long j) {
    float f = j >= 1000 ? (j / 1000.0f) / 60.0f : 1.0f;
    sendLogSpenInsertInfo(
        f > 60.0f
            ? "MoreThan1Hour"
            : f > 30.0f
                ? "30to60Minutes"
                : f > 10.0f
                    ? "10to30Minutes"
                    : f > 5.0f ? "5to10Minutes" : f > 1.0f ? "1to5Minutes" : "1MinuteOrLess",
        USE_APP_FEATURE_NAME_SPEN);
  }

  public final boolean isScreenPinningEnabled() {
    boolean z =
        ((ActivityManager) mContext.getSystemService("activity")).getLockTaskModeState() == 2;
    if (z) {
  ...
  public final boolean isDoubleTapBlockedAppsByMetaData() {
    ...
    Iterator<ResolveInfo> it =
        mContext.getPackageManager().queryIntentActivities(intent, 128).iterator();
    while (it.hasNext()) {
      Bundle bundle = it.next().activityInfo.metaData;
      if (bundle != null
          && bundle.getBoolean("com.samsung.android.sdk.spen.BLOCK_DOUBLE_TAP_ACTION")) {
        return true;
      }
    }
    return false;
  ...
  public void registerInputMethodInfoChangeListener(
      IInputMethodInfoChangeListener iInputMethodInfoChangeListener) {
    if (!isUidSignature()) {
      Log.e(
          TAG,
          "no permission to use registerInputMethodInfoChangeListener() : "
  ...
  public void unregisterInputMethodInfoChangeListener(
    ...
    if (!isUidSignature()) {
      Log.e(
          TAG,
          "no permission to use unregisterInputMethodInfoChangeListener() : "
              + Binder.getCallingUid());
      return;
    }
  ...
  public void setCurrentInputInfo(
    ...
    this.mHandler.post(
        new Runnable() { // from class: com.android.server.smartclip.SpenGestureManagerService.9
          @Override // java.lang.Runnable
          public void run() {
  ...
  public final void broastcastInputContextChanged() {
    ...
    Log.i(
        TAG,
        "broastcastInputContextChanged getRegisteredCallbackCount() = "
            + this.mInputInfoChangeListeners.getRegisteredCallbackCount());
    int beginBroadcast = this.mInputInfoChangeListeners.beginBroadcast();
    while (beginBroadcast > 0) {
      beginBroadcast--;
      try {
        this.mInputInfoChangeListeners
            .getBroadcastItem(beginBroadcast)
            .onInputInfoChanged(this.mInputConnection, this.mEditorInfo);
      } catch (RemoteException unused) {
      }
    }
  ...
  public void notifyKeyboardClosed() {
    this.mHandler.post(
        new Runnable() { // from class: com.android.server.smartclip.SpenGestureManagerService.10
          @Override // java.lang.Runnable
          public void run() {
  ...
  public final void broastcastKeyboardClosed() {
    ...
    Log.i(
        TAG,
        "broastcastKeyboardClosed getRegisteredCallbackCount() = "
            + this.mInputInfoChangeListeners.getRegisteredCallbackCount());
    int beginBroadcast = this.mInputInfoChangeListeners.beginBroadcast();
    while (beginBroadcast > 0) {
      beginBroadcast--;
  ...
  public Bitmap screenshot(int i, int i2, boolean z, Rect rect, int i3, int i4, boolean z2) {
    ...
    checkSmartClipMetaExtractionPermission();
    return new Object() { // from class:
                          // com.android.server.smartclip.SpenGestureScreenShotManager$Host
      public SpenGestureScreenShotManager$FutureScreenShot request(
          final int i5,
          final int i6,
          final boolean z3,
          final Rect rect2,
          ...
          final int i8,
          final boolean z4) {
        SpenGestureScreenShotManager$FutureScreenShot
            spenGestureScreenShotManager$FutureScreenShot =
                new SpenGestureScreenShotManager$FutureScreenShot(
                    new Callable() { // from class:
                                     // com.android.server.smartclip.SpenGestureScreenShotManager$Host.1
                      @Override // java.util.concurrent.Callable
                      public SpenGestureScreenShotManager$RealScreenShot call() {
                        return new SpenGestureScreenShotManager$RealScreenShot(
                            i5, i6, z3, rect2, i7, i8, z4);
                      }
                    });
  ...
  public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
    ...
    printWriter.print(
        "  mAcIsFloatingIconEnabled : "
            + this.mAcIsFloatingIconEnabled
            + ", "
            + this.mAcAutoFloatingIconMode);
  ...
  public final boolean isDigitizerEnabled(Context context) {
    return Settings.System.semGetIntForUser(
            context.getContentResolver(), "pen_digitizer_enabled", 1, -2)
        != 0;
  }
