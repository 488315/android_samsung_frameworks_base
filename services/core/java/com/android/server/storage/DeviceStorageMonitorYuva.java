...
public class DeviceStorageMonitorYuva {
  ...
  public static final String valueCscYuva =
      SemCscFeature.getInstance().getString("CscFeature_Common_ConfigYuva");
  ...
  public final void sendUserMemLowNotification(int i) {
    if (this.DEBUG) {
      Log.d(
          "DeviceStorageMonitorYuva", "Intent ACTION_USER_MEM_LOW broadcasting with (" + i + "%)");
    }
    Intent intent = new Intent("com.samsung.android.sm.ACTION_USER_MEM_LOW");
    intent.setClassName(
        "com.samsung.memorysaver", "com.samsung.memorysaver.receiver.StorageStatusReceiver");
