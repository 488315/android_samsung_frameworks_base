...
public final class DeviceStorageMonitorService extends SystemService {
        ...
        public static String m964$$Nest$smlevelToString(int i) {
            return i != -1
                    ? i != 0
                            ? i != 1
                                    ? i != 2
                                            ? i != 3 ? i != 4 ? Integer.toString(i) : "FULL" : "LOW"
                                            : "WARNING"
                                    : "CAUTION"
                            : "NORMAL"
                    : "UNKNOWN";
    ...
    public DeviceStorageMonitorService(Context context) {
        ...
        this.mRemoteService =
                new Binder() { // from class:
                               // com.android.server.storage.DeviceStorageMonitorService.3
                    ...
                    public final void dump(
                        ...
                        if (DumpUtils.checkDumpPermission(
                            ...
                            if (strArr != null && strArr.length != 0 && !"-a".equals(strArr[0])) {
                                deviceStorageMonitorService.new Shell()
                                        .exec(
                                                deviceStorageMonitorService.mRemoteService,
                                                (FileDescriptor) null,
                                                fileDescriptor,
                                                (FileDescriptor) null,
                                                strArr,
                            ...
                            for (int i = 0; i < deviceStorageMonitorService.mStates.size(); i++) {
                                ...
                                State state =
                                        (State) deviceStorageMonitorService.mStates.valueAt(i);
                                ...
                                indentingPrintWriter.printPair(
                                        "level", State.m964$$Nest$smlevelToString(state.level));
                                indentingPrintWriter.printPair(
                                        "lastUsableBytes", Long.valueOf(state.lastUsableBytes));
                                ...
                                while (true) {
                                    if (it.hasNext()) {
                                        ...
                                        if (Objects.equals(
                                                uuid,
                                                StorageManager.convert(volumeInfo.getFsUuid()))) {
                                            indentingPrintWriter.print("lowBytes=");
                                            indentingPrintWriter.print(
                                                    storageManager.getStorageLowBytes(path));
                                            indentingPrintWriter.print(" fullBytes=");
                                            indentingPrintWriter.println(
                                                    storageManager.getStorageFullBytes(path));
                            ...
                            for (int i2 = 0;
                                    i2 < deviceStorageMonitorService.mFnStates.size();
                                    i2++) {
                                UUID uuid2 = (UUID) deviceStorageMonitorService.mFnStates.keyAt(i2);
                                FileNodeState fileNodeState =
                                        (FileNodeState)
                                                deviceStorageMonitorService.mFnStates.valueAt(i2);
                            ...
                            indentingPrintWriter.printPair(
                                    "mSeq",
                                    Integer.valueOf(deviceStorageMonitorService.mSeq.get()));
                            indentingPrintWriter.printPair(
                                    "mForceState",
                                    State.m964$$Nest$smlevelToString(
                                            deviceStorageMonitorService.mForceLevel));
                            indentingPrintWriter.println();
                            indentingPrintWriter.println();
                            indentingPrintWriter.println("Storage info : ");
                            indentingPrintWriter.println(
                                    "  mRomTotalBytes : "
                                            + DeviceStorageMonitorService.mRomTotalBytes);
                            indentingPrintWriter.println();
                            indentingPrintWriter.println(
                                    "  mFullBytes : " + DeviceStorageMonitorService.mFullBytes);
                            indentingPrintWriter.println(
                                    "  mLowBytes : " + DeviceStorageMonitorService.mLowBytes);
                            indentingPrintWriter.println(
                                    "  mWarningBytes : "
                                            + DeviceStorageMonitorService.mWarningBytes);
                            indentingPrintWriter.println(
                                    "  mCautionBytes : "
                                            + DeviceStorageMonitorService.mCautionBytes);
                            indentingPrintWriter.println(
                                    "  mExhaustionBytes : "
                                            + DeviceStorageMonitorService.mExhaustionBytes);
                            indentingPrintWriter.println(
                                    "  mTotalBytes : " + DeviceStorageMonitorService.mTotalBytes);
                            indentingPrintWriter.println(
                                    "  mUsableBytes : " + DeviceStorageMonitorService.mUsableBytes);
                            indentingPrintWriter.println();
                            indentingPrintWriter.println(
                                    "  mFullFileNodes : "
                                            + DeviceStorageMonitorService.mFullFileNodes);
                            indentingPrintWriter.println(
                                    "  mLowFileNodes : "
                                            + DeviceStorageMonitorService.mLowFileNodes);
                            indentingPrintWriter.println(
                                    "  mTotalFileNode : "
                                            + DeviceStorageMonitorService.mTotalFileNode);
                            indentingPrintWriter.println(
                                    "  mUsableFileNode : "
                                            + DeviceStorageMonitorService.mUsableFileNode);
                            indentingPrintWriter.println();
                            indentingPrintWriter.println("Log history : ");
                            deviceStorageMonitorService.mLocalLog.dump(
                                    fileDescriptor, indentingPrintWriter, strArr);
                            indentingPrintWriter.println();
                        }
                    }
                        ...
                        */
                        throw new UnsupportedOperationException(
                                "Method not decompiled:"
                                    + " com.android.server.storage.DeviceStorageMonitorService.AnonymousClass1.handleMessage(android.os.Message):void");
                    }
                };
    ...
    public final void onStart() {
        ...
        new CacheFileDeletedObserver(Environment.getDownloadCacheDirectory().getAbsolutePath(), 512)
                .startWatching();
        if (context.getPackageManager().hasSystemFeature("android.software.leanback")) {
            this.mNotifManager.createNotificationChannel(
                    new NotificationChannel(
                            "devicestoragemonitor.tv",
                            context.getString(R.string.granularity_label_word),
                            4));
        }
