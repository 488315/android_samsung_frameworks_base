...
public abstract class FileCollector {
  ...
  public static MeasurementResult getMeasurementResult(File file) {
    return collectFiles(
        StorageManager.maybeTranslateEmulatedPathToInternal(file), new MeasurementResult());
  }
  ...
  public static long getSystemSize(Context context) {
    ...
    VolumeInfo primaryStorageCurrentVolume =
        context.getPackageManager().getPrimaryStorageCurrentVolume();
    StorageManager storageManager = (StorageManager) context.getSystemService("storage");
    VolumeInfo findEmulatedForPrivate =
        storageManager.findEmulatedForPrivate(primaryStorageCurrentVolume);
