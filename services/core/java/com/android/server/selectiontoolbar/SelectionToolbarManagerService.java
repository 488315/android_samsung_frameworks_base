...
public final class SelectionToolbarManagerService extends AbstractMasterSystemService {
  ...
  public final class SelectionToolbarManagerServiceStub extends ISelectionToolbarManager.Stub {
    ...
    public void showToolbar(
        ShowInfo showInfo, ISelectionToolbarCallback iSelectionToolbarCallback, int i) {
      synchronized (SelectionToolbarManagerService.this.mLock) {
        SelectionToolbarManagerServiceImpl selectionToolbarManagerServiceImpl =
            (SelectionToolbarManagerServiceImpl)
                SelectionToolbarManagerService.this.getServiceForUserLocked(i);
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          SelectionToolbarManagerService.this.getContext(),
