...
public final /* synthetic */ class ZeroJankProxy$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ ZeroJankProxy$$ExternalSyntheticLambda2(
    ...
    public final void runOrThrow() {
        switch (this.$r8$classId) {
            ...
            default:
                ...
                if (!((InputMethodManagerService) zeroJankProxy2.mInner)
                        .hideSoftInput(
                                iInputMethodClient, iBinder, token, i, resultReceiver, this.f$5)) {
