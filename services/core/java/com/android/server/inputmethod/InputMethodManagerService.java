...
public final class InputMethodManagerService extends IInputMethodManager.Stub implements Handler.Callback {
            ...
            synchronized (ImfLock.class) {
                if (isChangingPackagesOfCurrentUserLocked()) {
                    if (shouldRebuildInputMethodListLocked()) {
                        ...
                        if (selectedInputMethod != null) {
                            for (int i = 0; i < size; i++) {
                                InputMethodInfo inputMethodInfo3 = (InputMethodInfo) InputMethodManagerService.this.mMethodList.get(i);
                                ...
                                if (isPackageDisappearing2 != 2 && isPackageDisappearing2 != 3) {
                                    if (isPackageDisappearing2 == 1) {
                                        Slog.i("InputMethodManagerService", "Input method reinstalling, clearing additional subtypes: " + inputMethodInfo3.getComponent());
    ...
    public InputMethodManagerService(Context context, ServiceThread serviceThread, InputMethodBindingController inputMethodBindingController) {
        ...
        this.mPreventImeStartupUnlessTextEditor = resources.getBoolean(R.bool.config_preventImeStartupUnlessTextEditor);
    ...
    public final void maybeInitImeNavbarConfigLocked(int i) {
        ...
        if (this.mImeDrawsImeNavBarRes == null) {
            ...
            this.mImeDrawsImeNavBarRes = OverlayableSystemBooleanResourceWrapper.create(createContextAsUser, R.bool.config_fillMainBuiltInDisplayCutout, this.mHandler, new Consumer() { // from class: com.android.server.inputmethod.InputMethodManagerService$$ExternalSyntheticLambda14
        ...
        synchronized (ImfLock.class) {
            ...
            if (clientState != null && iInputMethodClient != null && clientState.mClient.asBinder() == iInputMethodClient.asBinder()) {
                if (canInteractWithImeLocked(callingUid, iInputMethodClient, "hideSoftInput", token)) {
                    ...
                    Slog.w("InputMethodManagerService", "hideSoftInput : Ignoring, called from invalid user, mInputShown=" + isInputShown());
                    return false;
                }
    ...
    public boolean hideCurrentInputLocked(IBinder iBinder, ImeTracker.Token token, int i, ResultReceiver resultReceiver, int i2) {
        ...
        if (getCurMethodLocked() != null) {
            ...
            if (!z) {
                ...
                Slog.v("InputMethodManagerService", "hideCurrentInputLocked : canceled, shouldHideSoftInput=" + z + ", mInputShown=" + isInputShown() + ", mImeWindowVis=" + this.mImeWindowVis);
            }
    ...
    public void reportVirtualDisplayGeometryAsync(IInputMethodClient iInputMethodClient, int i, float[] fArr) {
        ...
        try {
            ...
            synchronized (ImfLock.class) {
                ...
                VirtualDisplayInfo virtualDisplayInfo2 = (VirtualDisplayInfo) this.mVirtualDisplayIdToParentMap.get(i);
                ...
                if (clientState2 != null && clientState2.mCurSession != null) {
                    ...
                    while (true) {
                        z |= i2 == i;
                        VirtualDisplayInfo virtualDisplayInfo3 = (VirtualDisplayInfo) this.mVirtualDisplayIdToParentMap.get(i2);
    ...
    public void buildInputMethodListLocked(boolean z) {
        ...
        if (!z) {
            ...
            if (!z4) {
                ...
                z2 = true;
                if (!z || z2) {
                    ArrayList defaultEnabledImes = InputMethodInfoUtils.getDefaultEnabledImes(this.mContext, this.mMethodList, z2);
                    ...
                    for (i = 0; i < size; i++) {
                        ...
                        if (InputMethodInfoUtils.getMostApplicableDefaultIME(this.mSettings.getEnabledInputMethodListLocked()) == null || !"com.samsung.android.honeyboard/.service.HoneyBoardService".equals(inputMethodInfo2.getId())) {
        ...
        ArrayList defaultEnabledImes2 = InputMethodInfoUtils.getDefaultEnabledImes(this.mContext, this.mMethodList, z2);
    ...
    */
    public final void resetSelectedInputMethodAndSubtypeLocked(String str) {
        ...
        InputMethodInfo inputMethodInfo = (InputMethodInfo) this.mMethodMap.get(str);
        Slog.d("InputMethodManagerService", "resetSelectedInputMethodAndSubtypeLocked mMethodMap size : " + this.mMethodMap.size());
        if (inputMethodInfo != null) {
                        ...
                        for (int i2 : resolveUserId) {
                            ...
                            for (InputMethodInfo inputMethodInfo : enabledInputMethodListLocked) {
                                if (z2) {
                                    ...
                                    outPrintWriter.println(XmlUtils.STRING_ARRAY_SEPARATOR);
                                    inputMethodInfo.dump(new Printer() { // from class: com.android.server.inputmethod.InputMethodManagerService$$ExternalSyntheticLambda10
                ...
                if (intent != null) {
                    if (intent.getAction() != null) {
                        ...
                        if (UiModeManager.SEM_ACTION_ENTER_DESKTOP_MODE.equals(action)) {
                            ...
                            if ((InputMethodManagerService.this.isDEXStandAloneMode() || !InputMethodManagerService.this.shouldShowImeKeyboardDefaultDisplayOnly()) && !InputMethodManagerService.this.isSamsungDefaultMethodID()) {
                                InputMethodManagerService inputMethodManagerService2 = InputMethodManagerService.this;
                            ...
                            boolean z = true;
                            if (!InputMethodManagerService.this.shouldShowImeKeyboardDefaultDisplayOnly() && displayIdOfInputMethodWindowToBeAdded != 0) {
                                Slog.d("InputMethodManagerService", "Unbind service when Desktop disconnected and Keyboard not in default display: " + displayIdOfInputMethodWindowToBeAdded);
                            ...
                            if (!z) {
                                Slog.d("InputMethodManagerService", "KnoxDesktop Disconnected Restore previous inputmethod");
                                restorePreviousUsedInputMethod();
                            }
                            Slog.d("InputMethodManagerService", "KnoxDesktop Disconnected it do not need to unbind service");
                        }
                    }
                }
            }
    ...
    */
    public final int getTargetInputMethodSubtypeId(String str) {
        ...
        if (inputMethodInfo != null && !TextUtils.isEmpty(str) && lastSubtypeForInputMethodLocked != null) {
            try {
                return SubtypeUtils.getSubtypeIdFromHashCode(inputMethodInfo, Integer.parseInt(lastSubtypeForInputMethodLocked));
            } catch (NumberFormatException e) {
                Slog.w("InputMethodManagerService", "HashCode for subtype looks broken: " + lastSubtypeForInputMethodLocked, e);
            }
        }
