    ...
    if (arrayMap.isEmpty()) {
      if (inputMethodDir.exists()) {
        ...
        Slog.e(
            ...
            "Failed to delete the empty parent directory " + inputMethodDir);
        return;
      }
      return;
    }
            ...
            for (InputMethodSubtype inputMethodSubtype : list) {
              ...
              if (inputMethodSubtype.hasSubtypeId()) {
                resolveSerializer.attributeInt(
                    (String) null, "subtypeId", inputMethodSubtype.getSubtypeId());
              }
              resolveSerializer.attributeInt(
                  (String) null, KnoxCustomManagerService.ICON, inputMethodSubtype.getIconResId());
              resolveSerializer.attributeInt(
                  (String) null, "label", inputMethodSubtype.getNameResId());
              resolveSerializer.attribute(
                  (String) null, "nameOverride", inputMethodSubtype.getNameOverride().toString());
              ...
              resolveSerializer.attribute(
                  (String) null, "imeSubtypeLocale", inputMethodSubtype.getLocale());
              resolveSerializer.attribute(
                  (String) null, "languageTag", inputMethodSubtype.getLanguageTag());
              resolveSerializer.attribute(
                  (String) null, "imeSubtypeMode", inputMethodSubtype.getMode());
              resolveSerializer.attribute(
                  (String) null, "imeSubtypeExtraValue", inputMethodSubtype.getExtraValue());
              resolveSerializer.attributeInt(
                  (String) null, "isAuxiliary", inputMethodSubtype.isAuxiliary() ? 1 : 0);
              resolveSerializer.attributeInt(
                  (String) null, "isAsciiCapable", inputMethodSubtype.isAsciiCapable() ? 1 : 0);
                  ...
                  if ("imi".equals(name)) {
                    ...
                    try {
                      if (!TextUtils.isEmpty(str5) && arrayList != null) {
                        int attributeInt =
                            resolvePullParser.getAttributeInt(str4, KnoxCustomManagerService.ICON);
                        int attributeInt2 = resolvePullParser.getAttributeInt(str4, "label");
                        String attributeValue =
                            resolvePullParser.getAttributeValue(str4, "nameOverride");
                        String attributeValue2 =
                            resolvePullParser.getAttributeValue(str4, "pkLanguageTag");
                        String attributeValue3 =
                            resolvePullParser.getAttributeValue(str4, "pkLayoutType");
                        String attributeValue4 =
                            resolvePullParser.getAttributeValue(str4, "imeSubtypeLocale");
                        String attributeValue5 =
                            resolvePullParser.getAttributeValue(str4, "languageTag");
                        i3 = depth;
                        String attributeValue6 =
                            resolvePullParser.getAttributeValue(str4, "imeSubtypeMode");
                        String attributeValue7 =
                            resolvePullParser.getAttributeValue(str4, "imeSubtypeExtraValue");
                                ...
                                "1"
                                    .equals(
                                        String.valueOf(
                                            resolvePullParser.getAttributeValue(
                                                str4, "isAsciiCapable")));
                            InputMethodSubtype.InputMethodSubtypeBuilder subtypeNameResId =
                                new InputMethodSubtype.InputMethodSubtypeBuilder()
                                    .setSubtypeNameResId(attributeInt2);
                            ULocale uLocale =
                                attributeValue2 == null ? null : new ULocale(attributeValue2);
                            if (attributeValue3 == null) {
                              attributeValue3 = "";
                            }
                            InputMethodSubtype.InputMethodSubtypeBuilder isAsciiCapable =
                                subtypeNameResId
                                    .setPhysicalKeyboardHint(uLocale, attributeValue3)
                                    .setSubtypeIconResId(attributeInt)
                                    .setSubtypeLocale(attributeValue4)
                                    .setLanguageTag(attributeValue5)
                                    .setSubtypeMode(attributeValue6)
                                    .setSubtypeExtraValue(attributeValue7)
                                    .setIsAuxiliary(equals)
                                    .setIsAsciiCapable(equals2);
                            str = null;
                            int attributeInt3 =
                                resolvePullParser.getAttributeInt((String) null, "subtypeId", 0);
                            if (attributeInt3 != 0) {
