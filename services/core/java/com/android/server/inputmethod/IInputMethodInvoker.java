...
public final class IInputMethodInvoker {
  ...
  public static void logRemoteException(RemoteException remoteException) {
    ...
    Slog.w(
        ...
        "IPC failed at IInputMethodInvoker#" + getCallerMethodName(),
        remoteException);
  }
  ...
  public void initializeInternal(
      IBinder iBinder, IInputMethodPrivilegedOperations iInputMethodPrivilegedOperations, int i) {
  ...
  public void onCreateInlineSuggestionsRequest(
    ...
    try {
      this.mTarget.onCreateInlineSuggestionsRequest(
          inlineSuggestionsRequestInfo, iInlineSuggestionsRequestCallback);
    } catch (RemoteException e) {
      logRemoteException(e);
    }
  }
