...
public abstract class AdditionalSubtypeMapRepository {
        ...
        public SingleThreadedBackgroundWriter() {
            ...
            this.mWriterThread =
                    new Thread() { // from class:
                                   // com.android.server.inputmethod.AdditionalSubtypeMapRepository.SingleThreadedBackgroundWriter.1
                        @Override // java.lang.Thread, java.lang.Runnable
                        public final void run() {
                            Process.setThreadPriority(10);
                            while (true) {
                                SingleThreadedBackgroundWriter.this.mLock.lock();
                                while (SingleThreadedBackgroundWriter.this.mPendingTasks.size()
                                        == 0) {
                                    try {
                                        SingleThreadedBackgroundWriter.this.mLockNotifier
                                ...
                                SparseArray clone =
                                        SingleThreadedBackgroundWriter.this.mPendingTasks.clone();
                                SingleThreadedBackgroundWriter.this.mPendingTasks.clear();
                                IntArray clone2 =
                                        SingleThreadedBackgroundWriter.this.mRemovedUsers.size()
                                                        == 0
                                                ? null
                                                : SingleThreadedBackgroundWriter.this.mRemovedUsers
                                                        .clone();
                                SingleThreadedBackgroundWriter.this.mLock.unlock();
                                int size = clone.size();
                                ...
                                arrayList.forEach(
                                        new AdditionalSubtypeMapRepository$SingleThreadedBackgroundWriter$1$$ExternalSyntheticLambda0());
                            }
                        }
                    };
        }
    ...
    public final class WriteTask extends Record {
        ...
        public WriteTask(
                int i, AdditionalSubtypeMap additionalSubtypeMap, InputMethodMap inputMethodMap) {
            this.userId = i;
            ...
            return (boolean)
                    ObjectMethods.bootstrap(
                                    ...
                                    MethodType.methodType(
                                            Boolean.TYPE, WriteTask.class, Object.class),
                                    WriteTask.class,
                                    "userId;subtypeMap;inputMethodMap",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->userId:I",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->subtypeMap:Lcom/android/server/inputmethod/AdditionalSubtypeMap;",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->inputMethodMap:Lcom/android/server/inputmethod/InputMethodMap;")
                            .dynamicInvoker()
        ...
        public final int hashCode() {
            return (int)
                    ObjectMethods.bootstrap(
                                    MethodHandles.lookup(),
                                    "hashCode",
                                    MethodType.methodType(Integer.TYPE, WriteTask.class),
                                    WriteTask.class,
                                    "userId;subtypeMap;inputMethodMap",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->userId:I",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->subtypeMap:Lcom/android/server/inputmethod/AdditionalSubtypeMap;",
        ...
        public final String toString() {
            return (String)
                    ObjectMethods.bootstrap(
                                    MethodHandles.lookup(),
                                    "toString",
                                    MethodType.methodType(String.class, WriteTask.class),
                                    WriteTask.class,
                                    "userId;subtypeMap;inputMethodMap",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->userId:I",
                                    "FIELD:Lcom/android/server/inputmethod/AdditionalSubtypeMapRepository$WriteTask;->subtypeMap:Lcom/android/server/inputmethod/AdditionalSubtypeMap;",
