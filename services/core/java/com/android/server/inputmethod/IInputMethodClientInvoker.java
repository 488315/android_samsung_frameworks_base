...
public final class IInputMethodClientInvoker {
  ...
  public static IInputMethodClientInvoker create(
      IInputMethodClient iInputMethodClient, Handler handler) {
  ...
  public static void logRemoteException(RemoteException remoteException) {
    ...
    Slog.w(
        ...
        "IPC failed at IInputMethodClientInvoker#" + getCallerMethodName(),
        remoteException);
  }
    ...
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda2
  ...
  public void onBindAccessibilityService(final InputBindResult inputBindResult, final int i) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
              IInputMethodClientInvoker.this.lambda$onBindAccessibilityService$1(
                  inputBindResult, i);
            }
          });
    }
  ...
  public void onUnbindMethod(final int i, final int i2) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void onUnbindAccessibilityService(final int i, final int i2) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void setActive(final boolean z, final boolean z2) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void setInteractive(final boolean z, final boolean z2) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void scheduleStartInputIfNecessary(final boolean z) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void reportFullscreenMode(final boolean z) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void updateVirtualDisplayToScreenMatrix(final int i, final float[] fArr) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void setImeTraceEnabled(final boolean z) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public void throwExceptionFromSystem(final String str) {
    if (this.mIsProxy) {
      ...
      this.mHandler.post(
          new Runnable() { // from class:
                           // com.android.server.inputmethod.IInputMethodClientInvoker$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
