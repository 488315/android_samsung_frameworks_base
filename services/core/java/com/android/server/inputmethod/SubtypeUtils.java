...
public abstract class SubtypeUtils {
  ...
  public static final LocaleUtils.LocaleExtractor sSubtypeToLocale =
      new LocaleUtils
          .LocaleExtractor() { // from class:
                               // com.android.server.inputmethod.SubtypeUtils$$ExternalSyntheticLambda0
  ...
  public static boolean containsSubtypeOf(
      InputMethodInfo inputMethodInfo, Locale locale, boolean z, String str) {
    if (locale == null) {
      return false;
    }
    ...
    for (int i = 0; i < subtypeCount; i++) {
      ...
      if (z) {
        ...
        if (localeObject == null) {
          ...
          if (str != SUBTYPE_MODE_ANY
              || TextUtils.isEmpty(str)
              || str.equalsIgnoreCase(subtypeAt.getMode())) {
            return true;
          }
        } else {
          continue;
        ...
        if (!TextUtils.equals(
            new Locale(LocaleUtils.getLanguageFromLocaleString(subtypeAt.getLocale()))
                .getLanguage(),
            locale.getLanguage())) {
          continue;
        }
  ...
  public static ArrayList getImplicitlyApplicableSubtypesLocked(
      Resources resources, InputMethodInfo inputMethodInfo) {
    ...
    synchronized (obj) {
      ...
      ArrayList implicitlyApplicableSubtypesLockedImpl =
          getImplicitlyApplicableSubtypesLockedImpl(resources, inputMethodInfo);
      synchronized (obj) {
  ...
  public static ArrayList getImplicitlyApplicableSubtypesLockedImpl(
      Resources resources, InputMethodInfo inputMethodInfo) {
    ...
    if (!arrayList2.isEmpty()) {
      ...
      if (!z) {
        ...
        for (int i4 = 0; i4 < size3; i4++) {
          ...
          if ("keyboard".equals(inputMethodSubtype3.getMode())
              && inputMethodSubtype3.containsExtraValueKey("EnabledWhenDefaultIsNotAsciiCapable")) {
    ...
    if (arrayList2.isEmpty()
        && (findLastResortApplicableSubtypeLocked =
                findLastResortApplicableSubtypeLocked(
                    resources, subtypes, "keyboard", locale, true))
            != null) {
  ...
  public static InputMethodSubtype findLastResortApplicableSubtypeLocked(
      Resources resources, List list, String str, String str2, boolean z) {
