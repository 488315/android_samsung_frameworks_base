...
public final class SamsungIMMSHWKeyboard {
    ...
    public final class BTKeyboardReceiver extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            if ("android.bluetooth.input.profile.action.CONNECTION_STATE_CHANGED".equals(action)) {
                ...
                Log.w(
                        "InputMethodManagerServicePhysicalKey",
                        "onReceive() isKeyboard = " + booleanExtra);
                if (booleanExtra) {
                    Log.w(
                            "InputMethodManagerServicePhysicalKey",
                    ...
                    if (intExtra2 == 2) {
                        ...
                        AudioService$$ExternalSyntheticOutline0.m(
                                new StringBuilder("[STATE_CONNECTED] mBTKeyboardCount[+] -->"),
                                SamsungIMMSHWKeyboard.this.mBTKeyboardCount,
                                "InputMethodManagerServicePhysicalKey");
                        SamsungIMMSHWKeyboard samsungIMMSHWKeyboard = SamsungIMMSHWKeyboard.this;
                        samsungIMMSHWKeyboard.keyboardState |= 2;
                        SamsungIMMSHWKeyboard.m604$$Nest$mconnectedHWKeyboard(
                                samsungIMMSHWKeyboard);
                        return;
                    }
                    if (intExtra3 == 2) {
                        ...
                        if (i == 0
                                || (!this.mIsBTConnect
                                        && (samsungIMMSHWKeyboard2.keyboardState & 2) == 2)) {
                            resetBTKeyboardState();
                        }
                        Log.i(
                                "InputMethodManagerServicePhysicalKey",
        ...
        public final void resetBTKeyboardState() {
            ...
            UiModeManagerService$13$$ExternalSyntheticOutline0.m(
                    new StringBuilder("resetBTKeyboardState : keyboardState = "),
                    SamsungIMMSHWKeyboard.this.keyboardState,
                    "InputMethodManagerServicePhysicalKey");
        }
    }
    ...
    public final class KMSKeyboardReceiver extends BroadcastReceiver {
        ...
        public /* synthetic */ KMSKeyboardReceiver(
                SamsungIMMSHWKeyboard samsungIMMSHWKeyboard, int i) {
            this.$r8$classId = i;
        ...
        public final void onReceive(Context context, Intent intent) {
            switch (this.$r8$classId) {
                case 0:
                    ...
                    if ("com.sec.android.sidesync.action.KMS_KEYBOARD".equals(action)) {
                        ...
                        DeviceIdleController$$ExternalSyntheticOutline0.m(
                                intExtra,
                                "KMSKeyboardReceiver : onReceive(), getIntExtra ",
                                "InputMethodManagerServicePhysicalKey");
                        if (intExtra == 1) {
                ...
                case 1:
                    ...
                    Log.w(
                            "InputMethodManagerServicePhysicalKey",
                            "PSSKeyboardReceiver : onReceive() intentAction" + action2);
                ...
                default:
                    ...
                    while (true) {
                        if (i < interfaceCount) {
                            ...
                            if (usbInterface == null) {
                                NetworkScoreService$$ExternalSyntheticOutline0.m(
                                        i,
                                        "onReceive() usbInterface is null, index : ",
                                        "InputMethodManagerServicePhysicalKey");
                            } else {
                                ...
                                if (interfaceClass == 3 && interfaceProtocol == 1) {
                                    if ("android.hardware.usb.action.USB_DEVICE_ATTACHED"
                                        ...
                                        if (this.this$0.mUSBKeyboardCount < 0) {
                                            Log.e(
                                                    "InputMethodManagerServicePhysicalKey",
                                                    "[ACTION_USB_DEVICE_ATTACHED] change"
                                                        + " mUSBKeyboardCount "
                                        ...
                                        if (this.this$0.mUSBKeyboardCount < 1) {
                                            Log.e(
                                                    "InputMethodManagerServicePhysicalKey",
                                                    "[ACTION_USB_DEVICE_DETACHED] change"
                                                        + " mUSBKeyboardCount "
                                                            + this.this$0.mUSBKeyboardCount
                                                            + "--> 1");
                    ...
                    if ("android.hardware.usb.action.USB_DEVICE_ATTACHED".equals(action3)) {
                        if (z) {
                            ...
                            AudioService$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("onReceive() USBK Connect C : "),
                                    this.this$0.mUSBKeyboardCount,
                                    "InputMethodManagerServicePhysicalKey");
                        ...
                        if (samsungIMMSHWKeyboard4.mUSBKeyboardCount == 0) {
                            ...
                            AudioService$$ExternalSyntheticOutline0.m(
                                    new StringBuilder("onReceive() USBK DisConnect C : "),
                                    this.this$0.mUSBKeyboardCount,
                                    "InputMethodManagerServicePhysicalKey");
                    ...
                    AudioService$$ExternalSyntheticOutline0.m(
                            new StringBuilder("onReceive() keyboardState : "),
                            this.this$0.keyboardState,
                            "InputMethodManagerServicePhysicalKey");
                    break;
            }
    ...
    public static void m604$$Nest$mconnectedHWKeyboard(
            SamsungIMMSHWKeyboard samsungIMMSHWKeyboard) {
        InputMethodManagerService inputMethodManagerService =
                samsungIMMSHWKeyboard.mHardKeyboardStatusChangeListener.f$0;
        ...
        synchronized (ImfLock.class) {
            inputMethodManagerService.hideCurrentInputLocked(
                    inputMethodManagerService.mImeBindingState.mFocusedWindow,
                    inputMethodManagerService.createStatsTokenForFocusedClient(56, false),
                    0,
                    null,
                    56);
        }
    ...
    public final boolean isPogoBackfolded() {
        ...
        AccessibilityManagerService$$ExternalSyntheticOutline0.m(
                "isPogoBackfolded ", "InputMethodManagerServicePhysicalKey", z);
        return z;
    }
}
