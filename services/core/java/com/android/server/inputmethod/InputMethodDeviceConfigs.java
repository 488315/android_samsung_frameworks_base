...
public final class InputMethodDeviceConfigs {
  ...
  public InputMethodDeviceConfigs() {
    DeviceConfig.OnPropertiesChangedListener onPropertiesChangedListener =
        new DeviceConfig
            .OnPropertiesChangedListener() { // from class:
                                             // com.android.server.inputmethod.InputMethodDeviceConfigs$$ExternalSyntheticLambda0
    ...
    this.mHideImeWhenNoEditorFocus =
        DeviceConfig.getBoolean("input_method_manager", "hide_ime_when_no_editor_focus", true);
