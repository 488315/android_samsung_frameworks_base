...
public final class ImeTrackerService extends IImeTracker.Stub {
  ...
  public synchronized ImeTracker.Token onRequestHide(String str, int i, int i2, int i3) {
    ...
    this.mHandler.postDelayed(
        new Runnable() { // from class:
                         // com.android.server.inputmethod.ImeTrackerService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final class History {
    ...
    public final void dump(PrintWriter printWriter, String str) {
      ...
      printWriter.println(
          "ImeTrackerService#History.mLiveEntries: " + this.mLiveEntries.size() + " elements");
      ...
      printWriter.print(str);
      printWriter.println(
          "ImeTrackerService#History.mEntries: " + this.mEntries.size() + " elements");
    ...
    public final void dumpEntry(
        Entry entry, PrintWriter printWriter, String str, DateTimeFormatter dateTimeFormatter) {
      printWriter.print(str);
      ...
      printWriter.print(str);
      printWriter.print(
          "   startTime=" + dateTimeFormatter.format(Instant.ofEpochMilli(entry.mStartTime)));
