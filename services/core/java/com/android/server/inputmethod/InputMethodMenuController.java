...
public final class InputMethodMenuController {
    ...
    public void updateKeyboardFromSettingsLocked() {
        ...
        if (alertDialog != null && this.mSwitchingDialogTitleView != null && alertDialog.isShowing()) {
            ((Switch) this.mSwitchingDialogTitleView.findViewById(android.R.id.icon_menu_presenter)).setChecked(this.mShowImeWithHardKeyboard);
        }
        ...
        ((Switch) this.mSwitchInSelectDialogView.findViewById(android.R.id.icon_menu_presenter)).setChecked(this.mShowImeWithHardKeyboard);
    }
    ...
    public void handleHardKeyboardStatusChange(boolean z) {
        synchronized (ImfLock.class) {
            ...
            int i = 0;
            if (alertDialog != null && this.mSwitchingDialogTitleView != null && alertDialog.isShowing()) {
                this.mSwitchingDialogTitleView.findViewById(android.R.id.icon_menu).setVisibility(z ? 0 : 8);
            }
            AlertDialog alertDialog2 = this.mSwitchingDialog;
            if (alertDialog2 != null && this.mSwitchInSelectDialogView != null && alertDialog2.isShowing()) {
    ...
    public class ImeSubtypeListAdapter extends ArrayAdapter {
        ...
        public final void addSettingButton(View view) {
            if (((UserManager) getContext().getSystemService("user")).isUserUnlocked()) {
                ...
                drawable.setTint(getContext().getResources().getColor(android.R.color.language_picker_item_text_color_secondary_selected, null));
                ImageView imageView = new ImageView(getContext());
                WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
                int dimensionPixelSize = getContext().getResources().getDimensionPixelSize(android.R.dimen.indeterminate_progress_alpha_43);
                layoutParams.height = dimensionPixelSize;
                layoutParams.width = dimensionPixelSize;
                imageView.setLayoutParams(layoutParams);
                imageView.setImageDrawable(drawable);
                imageView.setBackground(getContext().getResources().getDrawable(android.R.drawable.quickcontact_badge_overlay_light));
                linearLayout.addView(imageView);
                linearLayout.setGravity(17);
                CharSequence string = getContext().getResources().getString(17042509);
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams();
                layoutParams2.width = getContext().getResources().getDimensionPixelSize(android.R.dimen.indeterminate_progress_alpha_44);
    ...
    public final void setupSwitchHardKeyboardAndShowKeyboardButton(Context context, LayoutInflater layoutInflater) {
        ...
        final Switch r0 = (Switch) this.mSwitchInSelectDialogView.findViewById(android.R.id.icon_menu_presenter);
        ...
        TextView textView = (TextView) this.mSwitchInSelectDialogView.findViewById(android.R.id.locale_native);
        ...
        final Switch r1 = (Switch) this.mSwitchInSelectDialogView.findViewById(android.R.id.voiceTrigger);
