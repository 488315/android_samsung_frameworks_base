...
public class AODSCoverController {
  ...
  public void register() {
    this.mCoverStateListener =
        new CoverManager
            .StateListener() { // from class: com.android.server.aod.AODSCoverController.1
          public void onCoverStateChanged(CoverState coverState) {
            if (coverState != null) {
              ...
              aODSCoverController.mCoverUIWorking =
                  aODSCoverController.mCoverAttached && AODSCoverController.this.mCoverClosed;
              if (AODSCoverController.this.mAODSettingHelper.isAODEnabled()
                  && AODSCoverController.this.mCoverAttached
                  && coverState.type == 1) {
  ...
  public void refresh() {
    ...
    CoverManager coverManager = this.mCoverManager;
    if (coverManager == null
        || (coverState = coverManager.getCoverState()) == null
        || !coverState.attached
        || coverState.type != 1) {
      return;
    }
    ...
    synchronized (queue) {
      ...
      if (this.mSViewSensorEventListener == null) {
        ...
        SensorEventListener sensorEventListener =
            new SensorEventListener() { // from class: com.android.server.aod.AODSCoverController.2
