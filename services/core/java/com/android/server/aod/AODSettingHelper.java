...
public class AODSettingHelper {
  ...
  public boolean isAODEnabled() {
    return Settings.System.getIntForUser(this.mResolver, "aod_mode", this.mAODDefaultSetting, -2)
        == 1;
  }

  public boolean isEdgeShowWhenScreenOff() {
    return Settings.System.getIntForUser(this.mResolver, "edge_lighting_show_condition", 0, -2)
        != 1;
  }
  ...
  public boolean isAODTapToShow() {
    return !AODConfig.isTapToShowDisabled
        && Settings.System.getIntForUser(this.mResolver, "aod_tap_to_show_mode", 1, -2) == 1;
  }
  ...
  public boolean isFingerScreenOffIconAOD() {
    return Settings.Secure.getIntForUser(this.mResolver, "fingerprint_screen_off_icon_aod", -1, -2)
        == 1;
  }
