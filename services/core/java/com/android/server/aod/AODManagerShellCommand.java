  ...
  */
  ...
  public void onHelp() {
    ...
    try {
      ...
      outPrintWriter.println(
          "NOTE: when aod is shown, the command should should be executed, and -user USER_ID is"
              + " optional argument.");
      ...
      case 11:
        ...
        while (true) {
          ...
          if (nextOption != null) {
            ...
            getOutPrintWriter()
                .println(
                    "aod service commands: runTspEvent : info: "
                        + infoToString(parseInt)
                        + " , x: "
                        + i
                        + " , y: "
                        + i2
                        ...
                        + userHandle.toString());
            Intent intent =
                new Intent("com.samsung.android.app.aodservice.intent.action.CHANGE_AOD_MODE");
