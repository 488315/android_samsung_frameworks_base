...
public final class UsbDirectMidiDevice implements Closeable {
    ...
    public static void m1016$$Nest$mopenLocked(UsbDirectMidiDevice usbDirectMidiDevice) {
        ...
        UsbManager usbManager =
                (UsbManager) usbDirectMidiDevice.mContext.getSystemService(UsbManager.class);
        ...
        for (int i = 0; i < usbDirectMidiDevice.mUsbInterfaces.size(); i++) {
            ...
            UsbInterfaceDescriptor usbInterfaceDescriptor =
                    (UsbInterfaceDescriptor) usbDirectMidiDevice.mUsbInterfaces.get(i);
            for (int i2 = 0; i2 < usbInterfaceDescriptor.mNumEndpoints; i2++) {
                UsbEndpointDescriptor endpointDescriptor =
                        usbInterfaceDescriptor.getEndpointDescriptor(i2);
                if (endpointDescriptor != null) {
                    if (endpointDescriptor.getDirection() == 0) {
                        arrayList2.add(
                                new UsbEndpoint(
                                        endpointDescriptor.mEndpointAddress,
                                        endpointDescriptor.mAttributes,
                                        endpointDescriptor.mPacketSize,
                                        endpointDescriptor.mInterval));
                        arrayList4.add(Integer.valueOf(getNumJacks(endpointDescriptor)));
                        arrayList5.add(
                                new MidiEventMultiScheduler(getNumJacks(endpointDescriptor)));
                    } else {
                        arrayList.add(
                                new UsbEndpoint(
                                        endpointDescriptor.mEndpointAddress,
            ...
            if (!arrayList2.isEmpty() || !arrayList.isEmpty()) {
                UsbDeviceConnection openDevice =
                        usbManager.openDevice(usbDirectMidiDevice.mUsbDevice);
                if (usbDirectMidiDevice.updateUsbInterface(
                        usbInterfaceDescriptor.toAndroid(usbDirectMidiDevice.mParser),
                        openDevice)) {
        ...
        for (int i4 = 0; i4 < usbDirectMidiDevice.mMidiEventMultiSchedulers.size(); i4++) {
            for (int i5 = 0;
                    i5 < ((ArrayList) usbDirectMidiDevice.mMidiEventMultiSchedulers.get(i4)).size();
                    i5++) {
                int intValue =
                        ((Integer)
                                        ((ArrayList)
                                                        usbDirectMidiDevice
                                                                .mOutputUsbEndpointCableCounts.get(
                                                                i4))
                                                .get(i5))
                                .intValue();
                MidiEventMultiScheduler midiEventMultiScheduler =
                        (MidiEventMultiScheduler)
                                ((ArrayList) usbDirectMidiDevice.mMidiEventMultiSchedulers.get(i4))
                                        .get(i5);
                for (int i6 = 0; i6 < intValue; i6++) {
                    MidiEventScheduler eventScheduler =
                            midiEventMultiScheduler.getEventScheduler(i6);
                    usbDirectMidiDevice.mMidiInputPortReceivers[i3].mReceiver =
                            eventScheduler.getReceiver();
                    i3++;
                }
            }
        }
        final MidiReceiver[] outputPortReceivers =
                usbDirectMidiDevice.mServer.getOutputPortReceivers();
        int i7 = 0;
        int i8 = 0;
        while (i8 < usbDirectMidiDevice.mInputUsbEndpoints.size()) {
            int i9 = i7;
            for (int i10 = 0;
                    i10 < ((ArrayList) usbDirectMidiDevice.mInputUsbEndpoints.get(i8)).size();
                    i10++) {
                final UsbDeviceConnection usbDeviceConnection =
                        (UsbDeviceConnection) usbDirectMidiDevice.mUsbDeviceConnections.get(i8);
                final UsbEndpoint usbEndpoint =
                        (UsbEndpoint)
                                ((ArrayList) usbDirectMidiDevice.mInputUsbEndpoints.get(i8))
                                        .get(i10);
                final int intValue2 =
                        ((Integer)
                                        ((ArrayList)
                                                        usbDirectMidiDevice
                                                                .mInputUsbEndpointCableCounts.get(
                                                                i8))
                                                .get(i10))
                                .intValue();
                final int i11 = i9;
                Thread thread =
                        new Thread(
                                VibrationParam$1$$ExternalSyntheticOutline0.m(
                                        i9, "UsbDirectMidiDevice input thread ")) { // from class:
                            // com.android.server.usb.UsbDirectMidiDevice.2
                            ...
                            public final void run() {
                                ...
                                UsbMidiPacketConverter usbMidiPacketConverter =
                                        new UsbMidiPacketConverter();
                                int i14 = intValue2;
                                UsbMidiPacketConverter.UsbMidiDecoder usbMidiDecoder =
                                        new UsbMidiPacketConverter.UsbMidiDecoder();
                                usbMidiDecoder.mNumJacks = i14;
                                usbMidiDecoder.mDecodedByteArrays = new ByteArrayOutputStream[i14];
                                for (int i15 = 0; i15 < i14; i15++) {
                                    usbMidiDecoder.mDecodedByteArrays[i15] =
                                    ...
                                    try {
                                        ...
                                        while (true) {
                                            ...
                                            if (usbRequest != requestWait) {
                                                ...
                                                if (position > 0) {
                                                    UsbDirectMidiDevice.m1018$$Nest$smlogByteArray(
                                                            position,
                                                            "Input before conversion ",
                                                            bArr);
                                                    if (!UsbDirectMidiDevice.this
                                                            .mIsUniversalMidiDevice) {
                                                        usbMidiPacketConverter.decodeMidiPackets(
                                                                position, bArr);
                                                    }
                                                    while (i12 < intValue2) {
                                                        UsbDirectMidiDevice usbDirectMidiDevice2 =
                                                                UsbDirectMidiDevice.this;
                                                        byte[] m1017$$Nest$mswapEndiannessPerWord =
                                                                usbDirectMidiDevice2
                                                                                .mIsUniversalMidiDevice
                                                                        ? UsbDirectMidiDevice
                                                                                .m1017$$Nest$mswapEndiannessPerWord(
                                                                                        usbDirectMidiDevice2,
                                                                                        bArr,
                                                                                        position)
                                                        ...
                                                        UsbDirectMidiDevice
                                                                .m1018$$Nest$smlogByteArray(
                                                                        ...
                                                                        "Input "
                                                                                ...
                                                                                + " conversion ",
                                                                        m1017$$Nest$mswapEndiannessPerWord);
                                                        if (m1017$$Nest$mswapEndiannessPerWord
                                                                        .length
                                                                == 0) {
                                                            i13 = i12;
                                                        } else {
                                                            MidiReceiver[] midiReceiverArr =
                                                                    outputPortReceivers;
        ...
        while (i13 < usbDirectMidiDevice.mOutputUsbEndpoints.size()) {
            int i14 = i12;
            for (int i15 = 0;
                    i15 < ((ArrayList) usbDirectMidiDevice.mOutputUsbEndpoints.get(i13)).size();
                    i15++) {
                final UsbDeviceConnection usbDeviceConnection2 =
                        (UsbDeviceConnection) usbDirectMidiDevice.mUsbDeviceConnections.get(i13);
                final UsbEndpoint usbEndpoint2 =
                        (UsbEndpoint)
                                ((ArrayList) usbDirectMidiDevice.mOutputUsbEndpoints.get(i13))
                                        .get(i15);
                final int intValue3 =
                        ((Integer)
                                        ((ArrayList)
                                                ...
                                                .get(i15))
                                .intValue();
                final MidiEventMultiScheduler midiEventMultiScheduler2 =
                        (MidiEventMultiScheduler)
                                ((ArrayList) usbDirectMidiDevice.mMidiEventMultiSchedulers.get(i13))
                                        .get(i15);
                Thread thread2 =
                        new Thread(
                                VibrationParam$1$$ExternalSyntheticOutline0.m(
                                        i14,
                                        "UsbDirectMidiDevice output write thread ")) { // from
                                                                                       // class:
                                                                                       // com.android.server.usb.UsbDirectMidiDevice.3
                            @Override // java.lang.Thread, java.lang.Runnable
                            public final void run() {
                                byte[] byteArray;
                                try {
                                    ...
                                    while (true) {
                                        ...
                                        for (int i17 = i16; i17 < intValue3; i17++) {
                                            MidiEventScheduler eventScheduler2 =
                                                    midiEventMultiScheduler2.getEventScheduler(i17);
                                            for (MidiEventScheduler.MidiEvent nextEvent =
                                                            eventScheduler2.getNextEvent(nanoTime);
                                                    nextEvent != null;
                                                    nextEvent =
                                                            (MidiEventScheduler.MidiEvent)
                                                                    eventScheduler2.getNextEvent(
                                                                            nanoTime)) {
                                                UsbDirectMidiDevice.m1018$$Nest$smlogByteArray(
                                                        nextEvent.count,
                                                ...
                                                if (usbDirectMidiDevice2.mIsUniversalMidiDevice) {
                                                    ...
                                                    usbMidiPacketConverter.encodeMidiPackets(
                                                            nextEvent.count, i17, nextEvent.data);
                                                }
                                        ...
                                        if (UsbDirectMidiDevice.this.mIsUniversalMidiDevice) {
                                            ...
                                            byteArray =
                                                    usbMidiPacketConverter.mEncoderOutputStream
                                                            .toByteArray();
                                        ...
                                        while (i18 < byteArray.length && !z) {
                                            ...
                                            while (true) {
                                                ...
                                                i19 =
                                                        usbDeviceConnection2.bulkTransfer(
                                                                usbEndpoint2,
                                                                byteArray,
                                                                i18,
                                                                min,
                                                ...
                                                if (Thread.interrupted()) {
                                                    Log.w(
                                                            "UsbDirectMidiDevice",
                                                            "output thread interrupted after send");
                                                    z = true;
                                                    break;
                                                } else if (i19 < 0) {
                                                    Log.d(
                                                            "UsbDirectMidiDevice",
                                                            "retrying packet. retryCount = "
                                                                    + i20
                                                                    + " result = "
                                                                    + i19);
                                                    if (i20 > 20) {
                                                        Log.w(
                                                                "UsbDirectMidiDevice",
                                                                "Skipping packet because timeout");
                                                    }
                                                }
                                            }
    ...
    public static byte[] m1017$$Nest$mswapEndiannessPerWord(
            UsbDirectMidiDevice usbDirectMidiDevice, byte[] bArr, int i) {
        usbDirectMidiDevice.getClass();
        int i2 = i & 3;
        if (i2 != 0) {
            ExtendedEthernetServiceImpl$1$$ExternalSyntheticOutline0.m(
                    i, "size not multiple of 4: ", "UsbDirectMidiDevice");
        }
    ...
    */
    public UsbDirectMidiDevice(
            android.hardware.usb.UsbDevice r17,
            com.android.server.usb.descriptors.UsbDescriptorParser r18,
            boolean r19,
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.usb.UsbDirectMidiDevice.<init>(android.hardware.usb.UsbDevice,"
                    + " com.android.server.usb.descriptors.UsbDescriptorParser, boolean,"
                    + " java.lang.String):void");
    }

    public static UsbDirectMidiDevice create(
            Context context,
            UsbDevice usbDevice,
        ...
        int i;
        int controlTransfer;
        UsbDirectMidiDevice usbDirectMidiDevice =
                new UsbDirectMidiDevice(usbDevice, usbDescriptorParser, z, str);
        ...
        if (midiManager == null) {
            ...
            if (usbDirectMidiDevice.mIsUniversalMidiDevice) {
                UsbManager usbManager =
                        (UsbManager)
                                usbDirectMidiDevice.mContext.getSystemService(UsbManager.class);
                int i2 = 0;
                while (true) {
                    if (i2 >= usbDirectMidiDevice.mUsbInterfaces.size()) {
                        Log.w(
                                "UsbDirectMidiDevice",
                                "Cannot find interface with both input and output endpoints");
                        i = 1;
                        break;
                    }
                    UsbInterfaceDescriptor usbInterfaceDescriptor =
                            (UsbInterfaceDescriptor) usbDirectMidiDevice.mUsbInterfaces.get(i2);
                    boolean z2 = false;
                    boolean z3 = false;
                    for (int i3 = 0;
                            i3 < usbInterfaceDescriptor.mNumEndpoints && (!z2 || !z3);
                            i3++) {
                        UsbEndpointDescriptor endpointDescriptor =
                                usbInterfaceDescriptor.getEndpointDescriptor(i3);
                        if (endpointDescriptor != null) {
                            if (endpointDescriptor.getDirection() == 0) {
                                z3 = true;
                            } else {
                    ...
                    if (z2 && z3) {
                        ...
                        if (usbDirectMidiDevice.updateUsbInterface(
                                usbInterfaceDescriptor.toAndroid(usbDirectMidiDevice.mParser),
                                openDevice)) {
                            UsbMidiBlockParser usbMidiBlockParser =
                                    usbDirectMidiDevice.mMidiBlockParser;
                            ...
                            try {
                                controlTransfer =
                                        openDevice.controlTransfer(129, 6, i5, i4, bArr, 5, 2000);
                            } catch (Exception e) {
                                Log.e(
                                        "UsbMidiBlockParser",
                                        "Can not communicate with USB device",
                                        e);
                            }
                            if (controlTransfer <= 0) {
                                Log.e(
                                        "UsbMidiBlockParser",
                                        "first transfer failed: " + controlTransfer);
                            } else if (bArr[1] != 38) {
                                Log.e(
                                        "UsbMidiBlockParser",
                                        "Incorrect descriptor type: " + ((int) bArr[1]));
                            } else if (bArr[2] != 1) {
                                Log.e(
                                        "UsbMidiBlockParser",
                                        "Incorrect descriptor subtype: " + ((int) bArr[2]));
                            } else {
                                int i6 =
                                        ((bArr[4]
                                ...
                                if (i6 <= 0) {
                                    Log.e(
                                            "UsbMidiBlockParser",
                                            "Parsed a non-positive block terminal size: " + i6);
                                } else {
                                    byte[] bArr2 = new byte[i6];
                                    int controlTransfer2 =
                                            openDevice.controlTransfer(
                                                    129, 6, i5, i4, bArr2, i6, 2000);
                                    if (controlTransfer2 > 0) {
                                        usbMidiBlockParser.parseRawDescriptors(
                                                new ByteStream(bArr2));
                                        if (usbMidiBlockParser.mGroupTerminalBlocks.isEmpty()) {
                                            Log.e(
                                                    "UsbMidiBlockParser",
                                                    "Group Terminal Blocks failed parsing: 1");
                                        } else {
                                            Log.d(
                                                    "UsbMidiBlockParser",
                                                    "MIDI protocol: "
                                                            + ((UsbMidiBlockParser
                                                                                    .GroupTerminalBlock)
                                                                            usbMidiBlockParser
                                                                                    .mGroupTerminalBlocks
                                                                                    .get(0))
                                                                    .mMidiProtocol);
                                            i =
                                                    ((UsbMidiBlockParser.GroupTerminalBlock)
                                                                    usbMidiBlockParser
                                                                            .mGroupTerminalBlocks
                                                                            .get(0))
                                                            .mMidiProtocol;
                                        ...
                                        Log.e(
                                                "UsbMidiBlockParser",
                                                "second transfer failed: " + controlTransfer2);
                                    }
                                }
                            }
                            i = 1;
            ...
            StringBuilder m =
                    Preconditions$$ExternalSyntheticOutline0.m(
                            (manufacturerName == null || manufacturerName.isEmpty())
                                    ? productName
            ...
            String m$1 =
                    usbDirectMidiDevice.mIsUniversalMidiDevice
            ...
            MidiDeviceServer createDeviceServer =
                    midiManager.createDeviceServer(
                            usbDirectMidiDevice.mMidiInputPortReceivers,
                            usbDirectMidiDevice.mNumInputs,
                            null,
                            null,
                            bundle,
                            1,
                            usbDirectMidiDevice.mDefaultMidiProtocol,
                            usbDirectMidiDevice.mCallback);
    ...
    public final void closeLocked() {
        ...
        for (int i2 = 0; i2 < this.mMidiEventMultiSchedulers.size(); i2++) {
            for (int i3 = 0;
                    i3 < ((ArrayList) this.mMidiEventMultiSchedulers.get(i2)).size();
                    i3++) {
                ((MidiEventMultiScheduler)
                                ((ArrayList) this.mMidiEventMultiSchedulers.get(i2)).get(i3))
                        .close();
            }
        }
    ...
    public final void dump(DualDumpOutputStream dualDumpOutputStream) {
        ...
        if (this.mIsUniversalMidiDevice) {
            ...
            dualDumpOutputStream.write(
                    "descriptor_type", 1120986464258L, usbMidiBlockParser.mHeaderDescriptorType);
            dualDumpOutputStream.write(
                    "descriptor_subtype",
                    1120986464259L,
                    usbMidiBlockParser.mHeaderDescriptorSubtype);
            dualDumpOutputStream.write(
                    "total_length", 1120986464260L, usbMidiBlockParser.mTotalLength);
            Iterator it = usbMidiBlockParser.mGroupTerminalBlocks.iterator();
            while (it.hasNext()) {
                UsbMidiBlockParser.GroupTerminalBlock groupTerminalBlock =
                        (UsbMidiBlockParser.GroupTerminalBlock) it.next();
                ...
                dualDumpOutputStream.write(
                        "descriptor_type", 1120986464258L, groupTerminalBlock.mDescriptorType);
                dualDumpOutputStream.write(
                        "descriptor_subtype",
                        1120986464259L,
                        groupTerminalBlock.mDescriptorSubtype);
                dualDumpOutputStream.write(
                        "group_block_id", 1120986464260L, groupTerminalBlock.mGroupBlockId);
                dualDumpOutputStream.write(
                        "group_terminal_block_type",
                        1120986464261L,
                        groupTerminalBlock.mGroupTerminalBlockType);
                dualDumpOutputStream.write(
                        "group_terminal", 1120986464262L, groupTerminalBlock.mGroupTerminal);
                dualDumpOutputStream.write(
                        "num_group_terminals",
                        1120986464263L,
                        groupTerminalBlock.mNumGroupTerminals);
                dualDumpOutputStream.write(
                        "block_item", 1120986464264L, groupTerminalBlock.mBlockItem);
                dualDumpOutputStream.write(
                        "midi_protocol", 1120986464265L, groupTerminalBlock.mMidiProtocol);
                dualDumpOutputStream.write(
                        "max_input_bandwidth",
                        1120986464266L,
                        groupTerminalBlock.mMaxInputBandwidth);
                dualDumpOutputStream.write(
                        "max_output_bandwidth",
                        1120986464267L,
                        groupTerminalBlock.mMaxOutputBandwidth);
    ...
    public final boolean updateUsbInterface(
            UsbInterface usbInterface, UsbDeviceConnection usbDeviceConnection) {
