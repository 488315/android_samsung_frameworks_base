...
public class UsbHostManager {
    ...
    public final class ConnectionRecord {
        ...
        public final void dump(DualDumpOutputStream dualDumpOutputStream) {
            ...
            if (i != -1) {
                UsbDescriptorParser usbDescriptorParser =
                        new UsbDescriptorParser(str, this.mDescriptors);
                UsbDeviceDescriptor usbDeviceDescriptor = usbDescriptorParser.mDeviceDescriptor;
                dualDumpOutputStream.write(
                        "manufacturer", 1120986464260L, usbDeviceDescriptor.mVendorID);
                dualDumpOutputStream.write(
                        "product", 1120986464261L, usbDeviceDescriptor.mProductID);
                long start2 = dualDumpOutputStream.start("is_headset", 1146756268038L);
                dualDumpOutputStream.write(
                        "in", 1133871366145L, usbDescriptorParser.isInputHeadset());
                dualDumpOutputStream.write(
                        "out", 1133871366146L, usbDescriptorParser.isOutputHeadset());
        ...
        public final String formatTime() {
            return new StringBuilder(UsbHostManager.sFormat.format(new Date(this.mTimestamp)))
                    .toString();
        }
    }

    /* renamed from: -$$Nest$mbroadcastWithPendingQueue, reason: not valid java name */
    public static void m1019$$Nest$mbroadcastWithPendingQueue(
            UsbHostManager usbHostManager, Intent intent, UserHandle userHandle) {
        synchronized (usbHostManager.mPendingIntentLock) {
            try {
                if (usbHostManager.mSystemReady) {
                    ...
                    Slog.d(
                            "UsbHostManager",
                            "broadcasting " + intent + " extras: " + intent.getExtras());
                } else {
    ...
    public UsbHostManager(
        ...
        UEventObserver uEventObserver =
                new UEventObserver(this) { // from class: com.android.server.usb.UsbHostManager.1
                        ...
                        switch (i) {
                            case 0:
                                ...
                                if (str2.equals("REMOVE")) {
                                    ...
                                    UsbHostManager.m1019$$Nest$mbroadcastWithPendingQueue(
                                            this.this$0, intent, UserHandle.ALL);
                                    return;
                                } else {
                                    if (str2.equals("ADD")) {
                                        Intent intent2 =
                                                new Intent("com.samsung.UsbOtgCableConnection");
                                        intent2.putExtra("Connect", "On");
                                        UsbHostManager.m1019$$Nest$mbroadcastWithPendingQueue(
                                                this.this$0, intent2, UserHandle.ALL);
                                        return;
                                    }
                                    return;
                                }
                            default:
                                ...
                                if ("usbaudio".equals(str3)) {
                                    ...
                                    if ("ADD".equals(str4)) {
                                        UsbAlsaManager usbAlsaManager2 =
                                                this.this$0.mUsbAlsaManager;
                                        int parseInt = Integer.parseInt(str6);
                                        usbAlsaManager2.getClass();
                                        Slog.d(
                                                "UsbAlsaManager",
                                                "usbDeviceAddedBundle(): deviceAddress="
                                                        + str5
                                                        + " cardNum="
                                                        + parseInt);
                                        ...
                                        if (Settings.Secure.getInt(
                                            ...
                                            Slog.e(
                                                    "UsbAlsaManager",
                                                    "Disable USB audio routing is ON at"
                                                        + " usbDeviceAddedBundle");
                                            return;
                                        }
                                        UsbAlsaDevice usbAlsaDevice =
                                                new UsbAlsaDevice(
                                                        usbAlsaManager2.mAudioService,
                                                        parseInt,
                                                        str5,
                                                        true,
                                                        true,
                                        ...
                                        synchronized (usbAlsaDevice) {
                                            usbAlsaDevice.mDeviceName =
                                                    "USB-Audio - Samsung USB C Earphone";
                                        }
                                        usbAlsaDevice.updateWiredDeviceConnectionStateByBundle(
                                                true);
                                        return;
                                    }
                                    if ("REMOVE".equals(str4)) {
                                        UsbAlsaManager usbAlsaManager3 =
                                                this.this$0.mUsbAlsaManager;
                                        int parseInt2 = Integer.parseInt(str6);
                                        usbAlsaManager3.getClass();
                                        Slog.d(
                                                "UsbAlsaManager",
                                                "usbDeviceRemovedBundle(): deviceAddress="
                                                        + str5
                                                        + " cardNum="
                                                        + parseInt2);
                                        ...
                                        if (Settings.Secure.getInt(
                                            ...
                                            Slog.e(
                                                    "UsbAlsaManager",
                                                    "Disable USB audio routing is ON at"
                                                        + " usbDeviceRemovedBundle");
                                            return;
                                        }
                                        if (usbAlsaManager3.mSelectedBundleDevice == null) {
                                            Slog.e(
                                                    "UsbAlsaManager",
                                                    "No Selected Bundel Device at"
                                                        + " usbDeviceRemovedBundle");
                                            return;
                                        }
                                        UsbAlsaDevice usbAlsaDevice2 =
                                                new UsbAlsaDevice(
                                                        usbAlsaManager3.mAudioService,
                                                        parseInt2,
                                                        str5,
                                                        true,
                                                        true,
                                        ...
                                        synchronized (usbAlsaDevice2) {
                                            usbAlsaDevice2.mDeviceName =
                                                    "USB-Audio - Samsung USB C Earphone";
                                        }
                                        usbAlsaDevice2.updateWiredDeviceConnectionStateByBundle(
                                                false);
                                        return;
                                    }
                                    return;
    ...
    public final void dump(DualDumpOutputStream dualDumpOutputStream) {
        ...
        synchronized (this.mLock) {
            try {
                ...
                while (it.hasNext()) {
                    com.android.internal.usb.DumpUtils.writeDevice(
                            dualDumpOutputStream,
                            "devices",
                            2246267895810L,
                            (UsbDevice) this.mDevices.get((String) it.next()));
                }
    ...
    public final void dumpDescriptors(IndentingPrintWriter indentingPrintWriter, String[] strArr) {
        ...
        if (strArr.length <= 1 || strArr[1].equals("-dump-short")) {
            ...
            indentingPrintWriter.println(
                    connectionRecord.formatTime() + " Connect " + str + " mode:" + i);
            UsbDescriptorParser usbDescriptorParser =
                    new UsbDescriptorParser(str, connectionRecord.mDescriptors);
            UsbDeviceDescriptor usbDeviceDescriptor = usbDescriptorParser.mDeviceDescriptor;
            StringBuilder sb = new StringBuilder("manfacturer:0x");
            BatteryService$$ExternalSyntheticOutline0.m(
                    usbDeviceDescriptor.mVendorID, sb, " product:");
            sb.append(Integer.toHexString(usbDeviceDescriptor.mProductID));
            indentingPrintWriter.println(sb.toString());
            indentingPrintWriter.println(
                    "isHeadset[in: "
                            + usbDescriptorParser.isInputHeadset()
                            + " , out: "
                            + usbDescriptorParser.isOutputHeadset()
                            + "], isDock: "
                            + usbDescriptorParser.isDock());
            return;
        }
        if (strArr[1].equals("-dump-tree")) {
            ...
            if (i2 == -1) {
                indentingPrintWriter.println(
                        connectionRecord2.formatTime() + " Disconnect " + str2);
                return;
            }
            indentingPrintWriter.println(
                    connectionRecord2.formatTime() + " Connect " + str2 + " mode:" + i2);
            UsbDescriptorParser usbDescriptorParser2 =
                    new UsbDescriptorParser(str2, connectionRecord2.mDescriptors);
            ...
            while (i3 < arrayList.size()) {
                ...
                if (b2 == b) {
                    usbDescriptorsDeviceNode =
                            new UsbDescriptorsDeviceNode((UsbDeviceDescriptor) usbDescriptor);
                } else if (b2 == 2) {
                    usbDescriptorsConfigNode =
                            new UsbDescriptorsConfigNode((UsbConfigDescriptor) usbDescriptor);
                    usbDescriptorsDeviceNode.mConfigNodes.add(usbDescriptorsConfigNode);
                } else if (b2 == 4) {
                    usbDescriptorsInterfaceNode =
                            new UsbDescriptorsInterfaceNode((UsbInterfaceDescriptor) usbDescriptor);
                    usbDescriptorsConfigNode.mInterfaceNodes.add(usbDescriptorsInterfaceNode);
                } else if (b2 == 5) {
                    usbDescriptorsInterfaceNode.mEndpointNodes.add(
                            new UsbDescriptorsEndpointNode((UsbEndpointDescriptor) usbDescriptor));
                }
                i3++;
                b = 1;
            }
            ...
            while (it.hasNext()) {
                UsbDescriptorsConfigNode usbDescriptorsConfigNode2 =
                        (UsbDescriptorsConfigNode) it.next();
                ...
                while (it2.hasNext()) {
                    UsbDescriptorsInterfaceNode usbDescriptorsInterfaceNode2 =
                            (UsbDescriptorsInterfaceNode) it2.next();
                    ...
                    if (usbDescriptorsInterfaceNode2.mEndpointNodes.size() > 0) {
                        ...
                        while (it4.hasNext()) {
                            ((UsbDescriptorsEndpointNode) it4.next())
                                    .mEndpointDescriptor.report(textReportCanvas);
                        }
                        textReportCanvas.closeList();
                    }
                }
            ...
            sb2.append(
                    "isHeadset[in: "
                            + usbDescriptorParser2.isInputHeadset()
                            + " , out: "
                            + usbDescriptorParser2.isOutputHeadset()
                            + "], isDock: "
                            + usbDescriptorParser2.isDock());
        ...
        if (strArr[1].equals("-dump-list")) {
            ...
            if (i4 == -1) {
                indentingPrintWriter.println(
                        connectionRecord3.formatTime() + " Disconnect " + str3);
                return;
            }
            indentingPrintWriter.println(
                    connectionRecord3.formatTime() + " Connect " + str3 + " mode:" + i4);
            UsbDescriptorParser usbDescriptorParser3 =
                    new UsbDescriptorParser(str3, connectionRecord3.mDescriptors);
            ...
            indentingPrintWriter.println(
                    "isHeadset[in: "
                            + usbDescriptorParser3.isInputHeadset()
                            + " , out: "
                            + usbDescriptorParser3.isOutputHeadset()
                            + "], isDock: "
                            + usbDescriptorParser3.isDock());
            return;
        }
        if (strArr[1].equals("-dump-raw")) {
            ...
            if (i5 == -1) {
                indentingPrintWriter.println(
                        connectionRecord4.formatTime() + " Disconnect " + str4);
                return;
            }
            indentingPrintWriter.println(
                    connectionRecord4.formatTime() + " Connect " + str4 + " mode:" + i5);
    ...
    public final ParcelFileDescriptor openDevice(
            String str,
            ...
            try {
                ...
                if (usbDevice == null) {
                    throw new IllegalArgumentException(
                            "device " + str + " does not exist or is restricted");
                }
    ...
    public final boolean usbDeviceAdded(String str, int i, int i2, byte[] bArr) {
        ...
        StringBuilder m =
                StorageManagerService$$ExternalSyntheticOutline0.m(
                        i,
                        "usbDeviceAdded - start: deviceAddress=",
                        str,
                        " deviceClass=",
                        " deviceSubclass=");
        m.append(i2);
            ...
            while (it.hasNext()) {
                ...
                if (usbDescriptor instanceof UsbInterfaceDescriptor) {
                    UsbInterfaceDescriptor usbInterfaceDescriptor =
                            (UsbInterfaceDescriptor) usbDescriptor;
                    int i6 = usbInterfaceDescriptor.mUsbClass;
                    z3 =
                            i6 == 9
                                    || (!FactoryTest.isFactoryBinary()
                                            && i6 == 3
                                            && usbInterfaceDescriptor.mUsbSubclass == 1);
                    if (!z3) {
                        break;
                    }
                }
        ...
        if (i3 != 7531) {
            ...
            StringBuilder m3 =
                    InitialConfiguration$$ExternalSyntheticOutline0.m(
                            " mfg/product/ver/serial ", str2, "/", str3, "/");
            m3.append(str4);
            ...
            StringBuilder m5 =
                    FullScreenMagnificationGestureHandler$$ExternalSyntheticOutline0.m(
                            " hasAudio/HID/Storage: ", z4, "/", hasHIDInterface, "/");
            m5.append(z5);
        ...
        synchronized (this.mLock) {
            try {
                ...
                UsbDevice.Builder androidUsbDeviceBuilder =
                        usbDescriptorParser.toAndroidUsbDeviceBuilder();
                if (androidUsbDeviceBuilder == null) {
                    ...
                    UsbSerialReader usbSerialReader =
                            new UsbSerialReader(
                                    this.mContext,
                                    this.mPermissionManager,
                                    androidUsbDeviceBuilder.serialNumber);
                    ...
                    if (this.mBootCompleted && this.mCurrentUnlockedUser != -10000) {
                        ...
                        if (componentName == null) {
                            ...
                            getCurrentUserSettings()
                                    .deviceAttachedForFixedHandler(build, componentName);
                        }
                    }
                    ...
                    if (this.mHasMidiFeature) {
                        ...
                        if (UsbDescriptorParser.doesInterfaceContainEndpoint(
                                usbDescriptorParser.findMidiInterfaceDescriptors(512))) {
                            UsbDirectMidiDevice create =
                                    UsbDirectMidiDevice.create(
                                            this.mContext,
                                            build,
                                            usbDescriptorParser,
                            ...
                            if (UsbDescriptorParser.doesInterfaceContainEndpoint(
                                    usbDescriptorParser.findMidiInterfaceDescriptors(256))) {
                                UsbDirectMidiDevice create2 =
                                        UsbDirectMidiDevice.create(
                                                this.mContext,
                                                build,
                                                usbDescriptorParser,
                    ...
                    FrameworkStatsLog.write(
                            ...
                            build.getVendorId(),
                            build.getProductId(),
                            !usbDescriptorParser.getInterfaceDescriptorsForClass(1).isEmpty(),
                            usbDescriptorParser.hasHIDInterface(),
                            !usbDescriptorParser.getInterfaceDescriptorsForClass(8).isEmpty(),
                            1,
                            0L);
                }
        ...
        synchronized (this.mLock) {
            try {
                ...
                if (usbDevice != null) {
                    Slog.d(
                            "UsbHostManager",
                            "Removed device at " + str + ": " + usbDevice.getProductName());
                    ...
                    if (connectionRecord != null) {
                        FrameworkStatsLog.write(
                                ...
                                !r13.getInterfaceDescriptorsForClass(1).isEmpty(),
                                new UsbDescriptorParser(str, connectionRecord.mDescriptors)
                                        .hasHIDInterface(),
                                !r13.getInterfaceDescriptorsForClass(8).isEmpty(),
                                0,
                                System.currentTimeMillis() - connectionRecord.mTimestamp);
                    }
                } else {
