            ...
            try {
                ...
                List queryIntentActivitiesAsUser =
                        this.mPackageManager.queryIntentActivitiesAsUser(
                                new Intent("android.hardware.usb.action.USB_DEVICE_ATTACHED"),
                                128,
                ...
                while (i < size) {
                    ...
                    long start2 =
                            dualDumpOutputStream.start(
                                    "device_attached_activities", 2246267895812L);
                    ...
                    ArrayList deviceFilters =
                            UsbProfileGroupSettingsManager.getDeviceFilters(
                                    this.mPackageManager, resolveInfo);
                    if (deviceFilters != null) {
                        int size2 = deviceFilters.size();
                        int i2 = 0;
                        while (i2 < size2) {
                            ((DeviceFilter) deviceFilters.get(i2))
                ...
                List queryIntentActivitiesAsUser2 =
                        this.mPackageManager.queryIntentActivitiesAsUser(
                                new Intent("android.hardware.usb.action.USB_ACCESSORY_ATTACHED"),
                                128,
                                this.mUser.getIdentifier());
                ...
                while (i3 < size3) {
                    ...
                    long start3 =
                            dualDumpOutputStream.start(
                                    "accessory_attached_activities", 2246267895813L);
                    ...
                    ArrayList accessoryFilters =
                            UsbProfileGroupSettingsManager.getAccessoryFilters(
                                    this.mPackageManager, resolveInfo2);
                    if (accessoryFilters != null) {
                        int size4 = accessoryFilters.size();
                        int i4 = 0;
                        while (i4 < size4) {
                            ((AccessoryFilter) accessoryFilters.get(i4))
                                    .dump(dualDumpOutputStream, "filters", 2246267895810L);
                            i4++;
