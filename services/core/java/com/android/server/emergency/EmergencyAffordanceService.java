...
public class EmergencyAffordanceService extends SystemService {
  ...
  public EmergencyAffordanceService(Context context) {
    ...
    String[] stringArray =
        context.getResources().getStringArray(R.array.disallowed_apps_managed_profile);
    ...
    if (Build.IS_DEBUGGABLE) {
      String string =
          Settings.Global.getString(
              this.mContext.getContentResolver(), "emergency_affordance_override_iso");
  ...
  public class MyHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      if (i == 2) {
        EmergencyAffordanceService.this.handleNetworkCountryChanged(
  ...
  public final void updateEmergencyAffordanceNeeded() {
    ...
    boolean z2 =
        this.mVoiceCapable
            && (this.mAnySimNeedsEmergencyAffordance || this.mAnyNetworkNeedsEmergencyAffordance);
  ...
  public final void dumpInternal(IndentingPrintWriter indentingPrintWriter) {
    ...
    indentingPrintWriter.println(
        "mAnySimNeedsEmergencyAffordance=" + this.mAnySimNeedsEmergencyAffordance);
    indentingPrintWriter.println(
        "mAnyNetworkNeedsEmergencyAffordance=" + this.mAnyNetworkNeedsEmergencyAffordance);
    indentingPrintWriter.println(
        "mEmergencyCallCountryIsos=" + String.join(",", this.mEmergencyCallCountryIsos));
  }
  ...
  public final class BinderService extends Binder {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          EmergencyAffordanceService.this.mContext, "EmergencyAffordanceService", printWriter)) {
