...
public final class MetricsTimeZoneDetectorState {
  ...
  public static MetricsTimeZoneDetectorState create(
    ...
    boolean isEnhancedMetricsCollectionEnabled =
    ...
    return new MetricsTimeZoneDetectorState(
        ...
        ordinalGenerator.ordinal(str),
        str2,
        createMetricsTimeZoneSuggestion(
            ordinalGenerator, manualTimeZoneSuggestion, isEnhancedMetricsCollectionEnabled),
        createMetricsTimeZoneSuggestion(
            ordinalGenerator, telephonyTimeZoneSuggestion, isEnhancedMetricsCollectionEnabled),
        locationAlgorithmEvent != null
            ? createMetricsTimeZoneSuggestion(
                ordinalGenerator,
                locationAlgorithmEvent.getSuggestion(),
  ...
  public boolean equals(Object obj) {
    ...
    return this.mDeviceTimeZoneIdOrdinal == metricsTimeZoneDetectorState.mDeviceTimeZoneIdOrdinal
        && Objects.equals(this.mDeviceTimeZoneId, metricsTimeZoneDetectorState.mDeviceTimeZoneId)
        && this.mConfigurationInternal.equals(metricsTimeZoneDetectorState.mConfigurationInternal)
        && Objects.equals(
            this.mLatestManualSuggestion, metricsTimeZoneDetectorState.mLatestManualSuggestion)
        && Objects.equals(
  ...
  public static MetricsTimeZoneSuggestion createMetricsTimeZoneSuggestion(
      OrdinalGenerator ordinalGenerator,
      ManualTimeZoneSuggestion manualTimeZoneSuggestion,
      boolean z) {
    ...
    return MetricsTimeZoneSuggestion.createCertain(
        z ? new String[] {zoneId} : null, new int[] {ordinalGenerator.ordinal(zoneId)});
  }
  ...
  public static MetricsTimeZoneSuggestion createMetricsTimeZoneSuggestion(
    ...
    return MetricsTimeZoneSuggestion.createCertain(
        z ? (String[]) zoneIds.toArray(new String[0]) : null, ordinalGenerator.ordinals(zoneIds));
  }
