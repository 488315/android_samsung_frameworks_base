...
public final class ServiceConfigAccessorImpl implements ServiceConfigAccessor {
    ...
    public ServiceConfigAccessorImpl(Context context) {
        ...
        contentResolver.registerContentObserver(Settings.Secure.getUriFor("preferred_time_zone_detection_method"), true, contentObserver);
    ...
    public final boolean isTelephonyFallbackSupported() {
        return this.mServerFlags.getBoolean("time_zone_detector_telephony_fallback_supported", getConfigBoolean(R.bool.config_showGesturalNavigationHints));
    }
