...
public final class DeviceActivityMonitorImpl implements Dumpable {
    ...
    public static void m973$$Nest$mnotifyFlightComplete(
            DeviceActivityMonitorImpl deviceActivityMonitorImpl) {
        ArrayList arrayList;
        ...
        while (it.hasNext()) {
            ((TimeZoneDetectorStrategyImpl)
                            ((TimeZoneDetectorService.Lifecycle.AnonymousClass1) it.next())
                                    .val$timeZoneDetectorStrategy)
                    .enableTelephonyTimeZoneFallback("onFlightComplete()");
        }
    }
                    ...
                    public final void onChange(boolean z) {
                        try {
                            if (Settings.Global.getInt(contentResolver, "airplane_mode_on") == 0) {
                                DeviceActivityMonitorImpl.m973$$Nest$mnotifyFlightComplete(
                                        DeviceActivityMonitorImpl.this);
                            }
