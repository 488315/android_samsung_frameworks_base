...
public class DisabledLocationTimeZoneProvider extends LocationTimeZoneProvider {
  public static /* synthetic */ TimeZoneProviderEvent lambda$new$0(
  ...
  public DisabledLocationTimeZoneProvider(
      LocationTimeZoneProvider.ProviderMetricsLogger providerMetricsLogger,
    ...
    super(
        ...
        threadingDomain,
        str,
        new TimeZoneProviderEventPreProcessor() { // from class:
                                                  // com.android.server.timezonedetector.location.DisabledLocationTimeZoneProvider$$ExternalSyntheticLambda0
          @Override // com.android.server.timezonedetector.location.TimeZoneProviderEventPreProcessor
          public final TimeZoneProviderEvent preProcess(
              TimeZoneProviderEvent timeZoneProviderEvent) {
