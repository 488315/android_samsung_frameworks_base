...
public class BinderLocationTimeZoneProvider extends LocationTimeZoneProvider {
  ...
  public BinderLocationTimeZoneProvider(
      ...
      String str,
      LocationTimeZoneProviderProxy locationTimeZoneProviderProxy,
      boolean z) {
    super(
  ...
  public boolean onInitialize() {
    this.mProxy.initialize(
        new LocationTimeZoneProviderProxy
            .Listener() { // from class:
                          // com.android.server.timezonedetector.location.BinderLocationTimeZoneProvider.1
  ...
  public final void handleOnProviderBound() {
    ...
    synchronized (this.mSharedLock) {
      LocationTimeZoneProvider.ProviderState providerState =
          (LocationTimeZoneProvider.ProviderState) this.mCurrentState.get();
