...
public class LocationTimeZoneManagerService extends Binder {
  ...
  public final ProviderConfig mPrimaryProviderConfig =
      new ProviderConfig(
          0, "primary", "android.service.timezone.PrimaryLocationTimeZoneProviderService");
  public final ProviderConfig mSecondaryProviderConfig =
      new ProviderConfig(
          1, "secondary", "android.service.timezone.SecondaryLocationTimeZoneProviderService");
    ...
    public void onStart() {
      ...
      if (this.mServiceConfigAccessor.isGeoTimeZoneDetectionFeatureSupportedInConfig()) {
        LocationTimeZoneManagerService locationTimeZoneManagerService =
            new LocationTimeZoneManagerService(context, this.mServiceConfigAccessor);
  ...
  public void onSystemReady() {
    this.mServiceConfigAccessor.addLocationTimeZoneManagerConfigListener(
  ...
  public final void handleServiceConfigurationChangedOnMainThread() {
    this.mThreadingDomain.post(
        new Runnable() { // from class:
                         // com.android.server.timezonedetector.location.LocationTimeZoneManagerService$$ExternalSyntheticLambda6
  ...
  public void startWithTestProviders(final String str, final String str2, final boolean z) {
    ...
    this.mThreadingDomain.postAndWait(
        new Runnable() { // from class:
                         // com.android.server.timezonedetector.location.LocationTimeZoneManagerService$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
    ...
    synchronized (this.mSharedLock) {
      ...
      if (this.mLocationTimeZoneProviderController == null) {
        ...
        locationTimeZoneProviderController.initialize(
            locationTimeZoneProviderControllerEnvironmentImpl,
            new LocationTimeZoneProviderControllerCallbackImpl(this.mThreadingDomain));
  ...
  public void stop() {
    ...
    this.mThreadingDomain.postAndWait(
        new Runnable() { // from class:
                         // com.android.server.timezonedetector.location.LocationTimeZoneManagerService$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
      ...
      return (LocationTimeZoneManagerServiceState)
          this.mThreadingDomain.postAndWait(
              new Callable() { // from class:
                               // com.android.server.timezonedetector.location.LocationTimeZoneManagerService$$ExternalSyntheticLambda2
                @Override // java.util.concurrent.Callable
                public final Object call() {
                  LocationTimeZoneManagerServiceState lambda$getStateForTests$2;
                  lambda$getStateForTests$2 =
                      LocationTimeZoneManagerService.this.lambda$getStateForTests$2();
  ...
  public final void enforceManageTimeZoneDetectorPermission() {
    this.mContext.enforceCallingPermission(
        "android.permission.MANAGE_TIME_AND_ZONE_DETECTION", "manage time and time zone detection");
  }
  ...
  public final class ProviderConfig implements Dumpable {
    ...
    */
    ...
    public final String getMode() {
      if (this.mIndex == 0) {
        return LocationTimeZoneManagerService.this.mServiceConfigAccessor
    ...
    public final RealLocationTimeZoneProviderProxy createBinderProxy() {
      ...
      return new RealLocationTimeZoneProviderProxy(
          LocationTimeZoneManagerService.this.mContext,
          LocationTimeZoneManagerService.this.mHandler,
          LocationTimeZoneManagerService.this.mThreadingDomain,
          str,
          getPackageName(),
          isTestProvider);
    ...
    public final String getPackageName() {
      if (this.mIndex == 0) {
        return LocationTimeZoneManagerService.this.mServiceConfigAccessor
            .getPrimaryLocationTimeZoneProviderPackageName();
      }
      return LocationTimeZoneManagerService.this.mServiceConfigAccessor
          .getSecondaryLocationTimeZoneProviderPackageName();
    }
  }
}
