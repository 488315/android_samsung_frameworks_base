...
public class LocationTimeZoneProviderControllerEnvironmentImpl
  ...
  public LocationTimeZoneProviderControllerEnvironmentImpl(
      ...
      final LocationTimeZoneProviderController locationTimeZoneProviderController) {
    ...
    StateChangeListener stateChangeListener =
        new StateChangeListener() { // from class:
                                    // com.android.server.timezonedetector.location.LocationTimeZoneProviderControllerEnvironmentImpl$$ExternalSyntheticLambda0
          @Override // com.android.server.timezonedetector.StateChangeListener
          public final void onChange() {
            LocationTimeZoneProviderControllerEnvironmentImpl.this.lambda$new$0(
  ...
  public /* synthetic */ void lambda$new$0(
    ...
    threadingDomain.post(
        new Runnable() { // from class:
                         // com.android.server.timezonedetector.location.LocationTimeZoneProviderControllerEnvironmentImpl$$ExternalSyntheticLambda1
  ...
  public void destroy() {
    this.mServiceConfigAccessor.removeConfigurationInternalChangeListener(
        this.mConfigurationInternalChangeListener);
  }
