...
public final /* synthetic */ class LocationTimeZoneManagerService$$ExternalSyntheticLambda1
        implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ LocationTimeZoneManagerService f$0;

    public /* synthetic */ LocationTimeZoneManagerService$$ExternalSyntheticLambda1(
            LocationTimeZoneManagerService locationTimeZoneManagerService, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        ...
        switch (i) {
            ...
            case 2:
                synchronized (locationTimeZoneManagerService.mSharedLock) {
                    LocationTimeZoneProviderController locationTimeZoneProviderController =
                            locationTimeZoneManagerService.mLocationTimeZoneProviderController;
                    if (locationTimeZoneProviderController != null) {
                        ...
                        synchronized (locationTimeZoneProviderController.mSharedLock) {
                            ...
                            locationTimeZoneProviderController.mPrimaryProvider
                                    .clearRecordedStates();
            ...
            default:
                ...
                synchronized (locationTimeZoneManagerService.mSharedLock) {
                    try {
                        if (locationTimeZoneManagerService.mLocationTimeZoneProviderController
                                != null) {
                            locationTimeZoneManagerService.stopOnDomainThread();
                            locationTimeZoneManagerService.startOnDomainThread();
                        }
