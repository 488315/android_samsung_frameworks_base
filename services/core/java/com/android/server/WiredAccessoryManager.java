...
public final class WiredAccessoryManager implements InputManagerService.WiredAccessoryCallbacks {
    ...
    public WiredAccessoryManager(Context context, InputManagerService inputManagerService) {
        ...
        this.mUseDevInputEventForAudioJack = context.getResources().getBoolean(R.bool.config_supportPreRebootSecurityLogs);
    ...
    public final void showToast() {
        Toast.makeText(new ContextThemeWrapper(this.mContext, R.style.Theme.DeviceDefault.Light), this.mContext.getResources().getString(R.string.managed_profile_label_badge), 1).show();
    }
}
