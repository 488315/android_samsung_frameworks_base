...
public class LooperStatsService extends Binder {
  ...
  public final void initFromSettings() {
    ...
    try {
      keyValueListParser.setString(
          Settings.Global.getString(this.mContext.getContentResolver(), "looper_stats"));
    ...
    setEnabled(
        SystemProperties.getBoolean(
            "debug.sys.looper_stats_enabled", keyValueListParser.getBoolean("enabled", true)));
  }
          ...
          Comparator.comparing(
                  new Function() { // from class:
                    ...
                    public final Object apply(Object obj) {
                      ...
                      lambda$dump$0 =
                          LooperStatsService.lambda$dump$0((LooperStats.ExportedEntry) obj);
                      return lambda$dump$0;
                    }
                  })
              .thenComparing(
                  new Function() { // from class:
                    // com.android.server.LooperStatsService$$ExternalSyntheticLambda1
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      String str;
              ...
              .thenComparing(
                  new Function() { // from class:
                    // com.android.server.LooperStatsService$$ExternalSyntheticLambda2
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      String str;
              ...
              .thenComparing(
                  new Function() { // from class:
                    // com.android.server.LooperStatsService$$ExternalSyntheticLambda3
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                      String str;
  ...
  public final void setSamplingInterval(int i) {
    ...
    Slog.w(
        "LooperStatsService", "Ignored invalid sampling interval (value must be positive): " + i);
  }
      ...
      if (500 == i) {
        ...
        getContext()
            ...
            .registerContentObserver(
                Settings.Global.getUriFor("looper_stats"), false, this.mSettingsObserver, 0);
