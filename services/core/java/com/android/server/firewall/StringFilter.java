...
public abstract class StringFilter implements Filter {
  ...
  public static final ValueProvider COMPONENT =
      new ValueProvider("component") { // from class: com.android.server.firewall.StringFilter.1
  ...
  public static final ValueProvider COMPONENT_NAME =
      new ValueProvider(
          "component-name") { // from class: com.android.server.firewall.StringFilter.2
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          if (componentName != null) {
  ...
  public static final ValueProvider COMPONENT_PACKAGE =
      new ValueProvider(
          "component-package") { // from class: com.android.server.firewall.StringFilter.3
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          if (componentName != null) {
  ...
  public static final FilterFactory ACTION =
      new ValueProvider("action") { // from class: com.android.server.firewall.StringFilter.4
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
  ...
  public static final ValueProvider DATA =
      new ValueProvider("data") { // from class: com.android.server.firewall.StringFilter.5
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
  ...
  public static final ValueProvider MIME_TYPE =
      new ValueProvider("mime-type") { // from class: com.android.server.firewall.StringFilter.6
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          return str;
        }
  ...
  public static final ValueProvider SCHEME =
      new ValueProvider("scheme") { // from class: com.android.server.firewall.StringFilter.7
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          Uri data = intent.getData();
          if (data != null) {
  ...
  public static final ValueProvider SSP =
      new ValueProvider(
          "scheme-specific-part") { // from class: com.android.server.firewall.StringFilter.8
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          Uri data = intent.getData();
          if (data != null) {
  ...
  public static final ValueProvider HOST =
      new ValueProvider("host") { // from class: com.android.server.firewall.StringFilter.9
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          Uri data = intent.getData();
          if (data != null) {
  ...
  public static final ValueProvider PATH =
      new ValueProvider("path") { // from class: com.android.server.firewall.StringFilter.10
        @Override // com.android.server.firewall.StringFilter.ValueProvider
        public String getValue(ComponentName componentName, Intent intent, String str) {
          Uri data = intent.getData();
          if (data != null) {
  ...
  public static StringFilter getFilter(
      ValueProvider valueProvider, XmlPullParser xmlPullParser, int i) {
