...
public class PortFilter implements Filter {
  public static final FilterFactory FACTORY =
      new FilterFactory("port") { // from class: com.android.server.firewall.PortFilter.1
        ...
        public Filter newFilter(XmlPullParser xmlPullParser) {
          ...
          if (attributeValue != null) {
            try {
              ...
              throw new XmlPullParserException(
                  "Invalid port value: " + attributeValue, xmlPullParser, null);
            }
          } else {
            parseInt = -1;
          }
          ...
          if (attributeValue2 != null || attributeValue3 != null) {
            if (attributeValue != null) {
              throw new XmlPullParserException(
                  "Port filter cannot use both equals and range filtering", xmlPullParser, null);
            }
            if (attributeValue2 != null) {
              try {
                ...
                throw new XmlPullParserException(
                    "Invalid minimum port value: " + attributeValue2, xmlPullParser, null);
              }
            }
            if (attributeValue3 != null) {
              try {
                ...
                throw new XmlPullParserException(
                    "Invalid maximum port value: " + attributeValue3, xmlPullParser, null);
              }
            }
          }
