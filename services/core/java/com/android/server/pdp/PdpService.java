...
public class PdpService extends SystemService {
      ...
      if (z2 && z) {
        ...
        if (equals || equals2) {
          if (str2.equals("backup_fail_suw") || str2.equals("setupwizard")) {
            ...
            PdpService.this.handleDisplayPDPToast(
  ...
  public PdpService(Context context) {
    ...
    HandlerThread handlerThread =
        new HandlerThread("mSvcPdpThread") { // from class: com.android.server.pdp.PdpService.1
          @Override // android.os.HandlerThread
          public void onLooperPrepared() {
            PdpService pdpService = PdpService.this;
            PdpService pdpService2 = PdpService.this;
            pdpService.mSvcPdpHandler =
                pdpService2.new SvcPdpHandler(pdpService2.mSvcPdpThread.getLooper());
          }
        };
