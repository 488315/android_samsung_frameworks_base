...
public final /* synthetic */ class ActiveRestoreSession$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ ActiveRestoreSession$$ExternalSyntheticLambda2(
        ...
        switch (this.$r8$classId) {
            case 0:
                return new RestoreParams(
                        ...
                        this.f$0.getBackupEligibilityRules((RestoreSet) this.f$4));
            default:
                return new RestoreParams(
                        (TransportConnection) obj,
                        this.f$1,
                        this.f$2,
                        this.f$3,
                        (PackageInfo) this.f$4,
                        0,
                        false,
                        null,
                        (OnTaskFinishedListener) obj2,
                        this.f$0.mBackupEligibilityRules);
        }
    }
}
