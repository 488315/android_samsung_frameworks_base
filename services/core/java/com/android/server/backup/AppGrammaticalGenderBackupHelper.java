...
public final class AppGrammaticalGenderBackupHelper extends BlobBackupHelper {
    public final GrammaticalInflectionService.GrammaticalInflectionManagerInternalImpl
            mGrammarInflectionManagerInternal;
    public final int mUserId;

    public AppGrammaticalGenderBackupHelper(int i) {
        super(1, new String[] {"app_gender"});
        this.mUserId = i;
        this.mGrammarInflectionManagerInternal =
    ...
    public final void applyRestoredPayload(String str, byte[] bArr) {
        ...
        int i = this.mUserId;
        GrammaticalInflectionBackupHelper grammaticalInflectionBackupHelper =
                GrammaticalInflectionService.this.mBackupHelper;
        synchronized (grammaticalInflectionBackupHelper.mCacheLock) {
            try {
                grammaticalInflectionBackupHelper.cleanStagedDataForOldEntries();
                HashMap readFromByteArray =
                        GrammaticalInflectionBackupHelper.readFromByteArray(bArr);
                if (readFromByteArray.isEmpty()) {
                    return;
                }
                GrammaticalInflectionBackupHelper.StagedData stagedData =
                        new GrammaticalInflectionBackupHelper.StagedData(
                                grammaticalInflectionBackupHelper.mClock.millis());
                for (Map.Entry entry : readFromByteArray.entrySet()) {
                    int i2 = 0;
                    try {
                        packageInfo =
                                grammaticalInflectionBackupHelper.mPackageManager
                                        .getPackageInfoAsUser((String) entry.getKey(), 0, i);
                    ...
                    if (packageInfo != null) {
                        ActivityTaskManagerInternal.PackageConfig findPackageConfiguration =
                                ActivityTaskManagerService.this.mPackageConfigPersister
                                        .findPackageConfiguration(i, (String) entry.getKey());
                        if (findPackageConfiguration != null
                                && (num = findPackageConfiguration.mGrammaticalGender) != null) {
                            i2 = num.intValue();
                        }
                        grammaticalInflectionBackupHelper.mGrammaticalGenderService
                                .setRequestedApplicationGrammaticalGender(
                                        (String) entry.getKey(),
                                        i,
                                        ((Integer) entry.getValue()).intValue());
                    } else if (((Integer) entry.getValue()).intValue() != 0) {
                        stagedData.mPackageStates.put(
                                (String) entry.getKey(), (Integer) entry.getValue());
                    }
                }
    ...
    public final byte[] getBackupPayload(String str) {
        ...
        for (ApplicationInfo applicationInfo :
                grammaticalInflectionBackupHelper.mPackageManager.getInstalledApplicationsAsUser(
                        PackageManager.ApplicationInfoFlags.of(0L), i)) {
            ActivityTaskManagerInternal.PackageConfig findPackageConfiguration =
                    ActivityTaskManagerService.this.mPackageConfigPersister
                            .findPackageConfiguration(i, applicationInfo.packageName);
            int intValue =
