...
public class SyncManagerConstants extends ContentObserver {
    ...
    BackgroundThread.getHandler()
        .post(
            new Runnable() { // from class:
                             // com.android.server.content.SyncManagerConstants$$ExternalSyntheticLambda0
  ...
  public /* synthetic */ void lambda$start$0() {
    this.mContext
        .getContentResolver()
        .registerContentObserver(Settings.Global.getUriFor("sync_manager_constants"), false, this);
    refresh();
  }
  ...
  public final void refresh() {
    synchronized (this.mLock) {
      String string =
          Settings.Global.getString(this.mContext.getContentResolver(), "sync_manager_constants");
