        ...
        */
        public final void collectMyObserversLocked(Uri uri, boolean z, IContentObserver iContentObserver, boolean z2, int i, int i2, ObserverCollector observerCollector) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ObserverEntry observerEntry = (ObserverEntry) this.mObservers.get(i4);
                boolean z3 = observerEntry.observer.asBinder() == asBinder;
                if ((!z3 || z2) && (i2 == -1 || observerEntry.userHandle == -1 || i2 == observerEntry.userHandle)) {
                    if (z) {
                        if ((i3 & 2) != 0 && observerEntry.notifyForDescendants) {
                        }
                        if (observerEntry.noDelay) {
                            i3 |= 32768;
                        }
                        int i5 = i3;
                        observerCollector.collect(observerEntry.observer, observerEntry.uid, z3, uri, i5, i2);
                        i3 = i5;
                    } else {
                        ...
                        int i52 = i3;
                        observerCollector.collect(observerEntry.observer, observerEntry.uid, z3, uri, i52, i2);
                        i3 = i52;
                    }
                }
            }
