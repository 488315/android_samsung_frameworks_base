...
public class SyncManager {
  ...
  public static final long LOCAL_SYNC_DELAY =
      SystemProperties.getLong("sync.local_sync_delay", 30000);
  public static final AccountAndUser[] INITIAL_ACCOUNTS_ARRAY = new AccountAndUser[0];
  public static final Comparator sOpDumpComparator =
      new Comparator() { // from class:
                         // com.android.server.content.SyncManager$$ExternalSyntheticLambda1
  ...
  public static final Comparator sOpRuntimeComparator =
      new Comparator() { // from class:
                         // com.android.server.content.SyncManager$$ExternalSyntheticLambda2
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
          int lambda$static$7;
  ...
  public final List getAllPendingSyncs() {
    ...
    for (int i = 0; i < size; i++) {
      SyncOperation maybeCreateFromJobExtras =
          SyncOperation.maybeCreateFromJobExtras(allPendingJobs.get(i).getExtras());
  ...
  public final boolean containsAccountAndUser(
      AccountAndUser[] accountAndUserArr, Account account, int i) {
  ...
  public final void removeStaleAccounts() {
    for (UserInfo userInfo : this.mUserManager.getAliveUsers()) {
      if (!userInfo.partial) {
        this.mSyncStorageEngine.removeStaleAccounts(
            AccountManagerService.getSingleton()
                .getAccounts(userInfo.id, this.mContext.getOpPackageName()),
            userInfo.id);
      }
    }
  }
  ...
  public final String getJobStats() {
    JobSchedulerInternal jobSchedulerInternal =
        (JobSchedulerInternal) LocalServices.getService(JobSchedulerInternal.class);
    StringBuilder sb = new StringBuilder();
    sb.append("JobStats: ");
    sb.append(
        jobSchedulerInternal == null
            ? "(JobSchedulerInternal==null)"
            : jobSchedulerInternal.getPersistStats().toString());
    return sb.toString();
  }
  ...
  public final ConnectivityManager getConnectivityManager() {
    ...
    synchronized (this) {
      if (this.mConnManagerDoNotUseDirectly == null) {
        this.mConnManagerDoNotUseDirectly =
  ...
  public final void cleanupJobs() {
    this.mSyncHandler.postAtFrontOfQueue(
        new Runnable() { // from class: com.android.server.content.SyncManager.6
            ...
            for (SyncOperation syncOperation : allPendingSyncs) {
              if (!hashSet.contains(syncOperation.key)) {
                ...
                for (SyncOperation syncOperation2 : allPendingSyncs) {
                  if (syncOperation != syncOperation2
                      && syncOperation.key.equals(syncOperation2.key)) {
                    SyncManager.this.mLogger.log("Removing duplicate sync: ", syncOperation2);
                    SyncManager.this.cancelJob(
                        syncOperation2,
                        "cleanupJobs() x=" + syncOperation + " y=" + syncOperation2);
                  }
                }
              }
            }
  ...
  public final void migrateSyncJobNamespaceIfNeeded() {
    ...
    if (!isJobNamespaceMigrated) {
      ...
      for (int size = allPendingJobs.size() - 1; size >= 0; size--) {
        ...
        SyncOperation maybeCreateFromJobExtras =
            SyncOperation.maybeCreateFromJobExtras(jobInfo.getExtras());
        if (maybeCreateFromJobExtras != null) {
          this.mJobScheduler.scheduleAsPackage(
              jobInfo,
              maybeCreateFromJobExtras.owningPackage,
              maybeCreateFromJobExtras.target.userId,
              maybeCreateFromJobExtras.wakeLockName());
    ...
    List systemScheduledOwnJobs =
        ((JobSchedulerInternal) LocalServices.getService(JobSchedulerInternal.class))
            .getSystemScheduledOwnJobs(this.mJobScheduler.getNamespace());
    for (int size2 = systemScheduledOwnJobs.size() - 1; size2 >= 0; size2--) {
      JobInfo jobInfo2 = (JobInfo) systemScheduledOwnJobs.get(size2);
      SyncOperation maybeCreateFromJobExtras2 =
          SyncOperation.maybeCreateFromJobExtras(jobInfo2.getExtras());
      if (maybeCreateFromJobExtras2 != null) {
        this.mJobScheduler.scheduleAsPackage(
            jobInfo2,
            maybeCreateFromJobExtras2.owningPackage,
            maybeCreateFromJobExtras2.target.userId,
            maybeCreateFromJobExtras2.wakeLockName());
        z = false;
      }
    }
  ...
  public final synchronized void verifyJobScheduler() {
    ...
    try {
      ...
      while (it.hasNext()) {
        SyncOperation maybeCreateFromJobExtras =
            SyncOperation.maybeCreateFromJobExtras(it.next().getExtras());
        if (maybeCreateFromJobExtras != null) {
      ...
      String str =
          "Loaded persisted syncs: "
              + i
              + " periodic syncs, "
              + i2
              + " oneshot syncs, "
              + allPendingJobs.size()
              + " total system server jobs, "
              + getJobStats();
  ...
  public SyncManager(Context context, boolean z) {
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.content.SyncManager.1
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            SyncManager.this.updateRunningAccounts(
                new SyncStorageEngine.EndPoint(null, null, getSendingUserId()));
          }
        };
    this.mAccountsUpdatedReceiver = broadcastReceiver;
    this.mConnectivityIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.content.SyncManager.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    this.mShutdownIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.content.SyncManager.3
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    BroadcastReceiver broadcastReceiver2 =
        new BroadcastReceiver() { // from class: com.android.server.content.SyncManager.4
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    this.mUserIntentReceiver =
        new BroadcastReceiver() { // from class: com.android.server.content.SyncManager.5
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    singleton.setOnSyncRequestListener(
        new SyncStorageEngine
            .OnSyncRequestListener() { // from class: com.android.server.content.SyncManager.7
          @Override // com.android.server.content.SyncStorageEngine.OnSyncRequestListener
          public void onSyncRequest(
              SyncStorageEngine.EndPoint endPoint, int i, Bundle bundle, int i2, int i3, int i4) {
    ...
    this.mSyncStorageEngine.setPeriodicSyncAddedListener(
        new SyncStorageEngine
            .PeriodicSyncAddedListener() { // from class: com.android.server.content.SyncManager.8
          @Override // com.android.server.content.SyncStorageEngine.PeriodicSyncAddedListener
          public void onPeriodicSyncAdded(
              SyncStorageEngine.EndPoint endPoint, Bundle bundle, long j, long j2) {
            SyncManager.this.updateOrAddPeriodicSync(endPoint, j, j2, bundle);
          }
        });
    this.mSyncStorageEngine.setOnAuthorityRemovedListener(
        new SyncStorageEngine
            .OnAuthorityRemovedListener() { // from class: com.android.server.content.SyncManager.9
    ...
    syncAdaptersCache.setListener(
        new RegisteredServicesCacheListener() { // from class:
                                                // com.android.server.content.SyncManager.10
          public void onServiceChanged(SyncAdapterType syncAdapterType, int i, boolean z2) {
            if (z2) {
              return;
            }
            SyncManager.this.scheduleSync(
                null, -1, -3, syncAdapterType.authority, null, -2, 0, Process.myUid(), -1, null);
          }
        },
        syncHandler);
    ...
    context.registerReceiver(
        this.mConnectivityIntentReceiver, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
    ...
    this.mContext.registerReceiverAsUser(
        this.mUserIntentReceiver, UserHandle.ALL, intentFilter2, null, null);
    context.registerReceiver(
        broadcastReceiver2, new IntentFilter("android.intent.action.TIME_SET"));
    ...
    accountManagerInternal.addOnAppPermissionChangeListener(
        new AccountManagerInternal
            .OnAppPermissionChangeListener() { // from class:
                                               // com.android.server.content.SyncManager$$ExternalSyntheticLambda0
    ...
    if (!this.mProvisioned) {
      ...
      ContentObserver contentObserver =
          new ContentObserver(handler) { // from class: com.android.server.content.SyncManager.11
      ...
      synchronized (syncHandler) {
        contentResolver.registerContentObserver(
            Settings.Global.getUriFor("device_provisioned"), false, contentObserver);
        this.mProvisioned |= isDeviceProvisioned();
        if (this.mProvisioned) {
  ...
  public /* synthetic */ void lambda$new$0(Account account, int i) {
    if (this.mAccountManagerInternal.hasAccountAccess(account, i)) {
      scheduleSync(
          account, UserHandle.getUserId(i), -2, null, null, 3, 0, Process.myUid(), -2, null);
    }
  }
  ...
  public void onStartUser(final int i) {
    this.mSyncHandler.post(
        new Runnable() { // from class:
                         // com.android.server.content.SyncManager$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
  ...
  public void onUnlockUser(final int i) {
    ...
    this.mSyncHandler.post(
        new Runnable() { // from class:
                         // com.android.server.content.SyncManager$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onStopUser(final int i) {
    ...
    this.mSyncHandler.post(
        new Runnable() { // from class:
                         // com.android.server.content.SyncManager$$ExternalSyntheticLambda9
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void whiteListExistingSyncAdaptersIfNeeded() {
    ...
    if (syncManager.mSyncStorageEngine.shouldGrantSyncAdaptersAccountAccess()) {
      ...
      while (i < size) {
        ...
        for (RegisteredServicesCache.ServiceInfo serviceInfo :
            syncManager.mSyncAdapters.getAllServices(identifier)) {
          String packageName = serviceInfo.componentName.getPackageName();
          Account[] accountsByTypeAsUser =
              syncManager.mAccountManager.getAccountsByTypeAsUser(
                  ((SyncAdapterType) serviceInfo.type).accountType, userHandle);
          ...
          while (i2 < length) {
            ...
            if (!syncManager.canAccessAccount(account, packageName, identifier)) {
              syncManager.mAccountManager.updateAppPermission(
                  account,
  ...
  public final long jitterize(long j, long j2) {
    ...
    if (j2 - j > 2147483647L) {
      throw new IllegalArgumentException(
          "the difference between the maxValue and the minValue must be less than 2147483647");
    }
  ...
  public final boolean areContactWritesEnabledForUser(UserInfo userInfo) {
    try {
      ...
      Log.w(
          "SyncManager",
          "Trying to fetch user properties for non-existing/partial user "
  ...
  public boolean isContactSharingAllowedForCloneProfile() {
    return this.mContext.getResources().getBoolean(R.bool.config_dontPreferApn)
        && this.mAppCloningDeviceConfigHelper.getEnableAppCloningBuildingBlocks();
  }

  public boolean shouldDisableSyncForUser(UserInfo userInfo, String str) {
    return (userInfo == null
            || str == null
            || !isContactSharingAllowedForCloneProfile()
  ...
  public final int getIsSyncable(Account account, int i, String str) {
    ...
    if (shouldDisableSyncForUser(userInfo, str)) {
      Log.w(
          "SyncManager",
          "Account sync is disabled for account: "
              + account
              + " userId: "
              + i
              + " provider: "
    ...
    RegisteredServicesCache.ServiceInfo serviceInfo =
        this.mSyncAdapters.getServiceInfo(SyncAdapterType.newKey(str, account.type), i);
    if (serviceInfo == null) {
      return 0;
    }
    try {
      packageInfo =
          AppGlobals.getPackageManager()
              .getPackageInfo(serviceInfo.componentName.getPackageName(), 0L, i);
    } catch (RemoteException unused) {
    }
    if (packageInfo == null
        || (str2 = packageInfo.restrictedAccountType) == null
        || !str2.equals(account.type)) {
      return 0;
    }
    return isSyncable;
  }
  ...
  */
  public final void scheduleSync(
              ...
              accountAndUserArr3 =
                  (AccountAndUser[])
                      ArrayUtils.appendElement(
                          AccountAndUser.class, accountAndUserArr3, accountAndUser2);
            }
          }
    ...
    while (i12 < length) {
      ...
      if (i8 < 0 || (i10 = accountAndUser3.userId) < 0 || i8 == i10) {
        ...
        while (it.hasNext()) {
          hashSet.add(
              ((SyncAdapterType) ((RegisteredServicesCache.ServiceInfo) it.next()).type).authority);
        }
        if (str3 != null) {
        ...
        while (it2.hasNext()) {
          ...
          int computeSyncable =
              syncManager2.computeSyncable(
                  accountAndUser3.account, accountAndUser3.userId, str5, !z);
          if (computeSyncable != 0) {
            RegisteredServicesCache.ServiceInfo serviceInfo =
                syncManager2.mSyncAdapters.getServiceInfo(
                    SyncAdapterType.newKey(str5, accountAndUser3.account.type),
                    accountAndUser3.userId);
            if (serviceInfo != null) {
              int i13 = serviceInfo.uid;
              if (computeSyncable == i11) {
                syncManager2.mLogger.log(
                    "scheduleSync: Not scheduling sync operation: isSyncable =="
                ...
                if (syncManager2.wasPackageEverLaunched(packageName, i8)) {
                  ...
                  syncManager2.mAccountManagerInternal.requestAccountAccess(
                      accountAndUser3.account,
                      packageName,
                      i,
                      new RemoteCallback(
                          new RemoteCallback
                              .OnResultListener() { // from class:
                                                    // com.android.server.content.SyncManager$$ExternalSyntheticLambda7
                            public final void onResult(Bundle bundle7) {
                              SyncManager.this.lambda$scheduleSync$4(
                                  accountAndUser4,
                                  i,
                                  i2,
                                  str5,
                ...
                boolean allowParallelSyncs =
                    ((SyncAdapterType) serviceInfo.type).allowParallelSyncs();
                ...
                if (z || computeSyncable >= 0 || !isAlwaysSyncable) {
                  ...
                  syncManager = this;
                  accountAndUser = accountAndUser5;
                  syncManager.mSyncStorageEngine.setIsSyncable(
                      accountAndUser.account, accountAndUser.userId, str5, 1, i5, i6);
                  computeSyncable = 1;
                }
                if ((i3 == -2 || i3 == computeSyncable)
                    && (((SyncAdapterType) serviceInfo.type).supportsUploading() || !z4)) {
                  if (computeSyncable < 0 || z6) {
                    str4 = str5;
                  } else {
                    if (syncManager.mSyncStorageEngine.getMasterSyncAutomatically(
                    ...
                    z3 = z7;
                    if (z3) {
                      syncManager.mLogger.log(
                          "scheduleSync: sync of ",
                          accountAndUser,
                          " ",
                          str4,
                          " is not allowed, dropping request");
                    } else {
                      syncManager.mSyncStorageEngine.getDelayUntilTime(
                          new SyncStorageEngine.EndPoint(
                              accountAndUser.account, str4, accountAndUser.userId));
                      ...
                      if (computeSyncable != -1) {
                        ...
                        if (i3 == -2 || i3 == computeSyncable) {
                          syncManager.mLogger.log(
                              "scheduleSync: scheduling sync ", accountAndUser, " ", str4);
                          syncManager.postScheduleSyncMessage(
                              new SyncOperation(
                          ...
                          syncManager.mLogger.log(
                              "scheduleSync: not handling ", accountAndUser, " ", str4);
                          i8 = i;
                          syncManager2 = syncManager;
                          accountAndUser3 = accountAndUser;
                          bundle5 = bundle3;
                        ...
                        sendOnUnsyncableAccount(
                            ...
                            serviceInfo,
                            accountAndUser.userId,
                            new OnReadyCallback() { // from class:
                                                    // com.android.server.content.SyncManager$$ExternalSyntheticLambda8
                              @Override // com.android.server.content.SyncManager.OnReadyCallback
                              public final void onReady() {
                                SyncManager.this.lambda$scheduleSync$5(
                                    accountAndUser6, i2, str6, bundle8, i3, j, i4, i5, i6, str2);
                              }
                            });
                        syncManager = this;
                        accountAndUser = accountAndUser;
                        ...
                        syncManager = this;
                        syncManager.mLogger.log(
                            "scheduleSync: schedule initialisation sync ",
                            accountAndUser,
                            " ",
                            str4);
                        j2 = j;
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$scheduleSync$4(
      AccountAndUser accountAndUser,
      int i,
      int i2,
      String str,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$scheduleSync$5(
      AccountAndUser accountAndUser,
      int i,
      String str,
      Bundle bundle,
  ...
  public final boolean canAccessAccount(Account account, String str, int i) {
    ...
    try {
      this.mContext
          .getPackageManager()
          .getApplicationInfoAsUser(str, 1048576, UserHandle.getUserId(i));
      return true;
  ...
  public void updateOrAddPeriodicSync(
      SyncStorageEngine.EndPoint endPoint, long j, long j2, Bundle bundle) {
    this.mSyncHandler
        .obtainMessage(13, new UpdatePeriodicSyncMessagePayload(endPoint, j, j2, bundle))
        .sendToTarget();
  }
      ...
      if (syncOperation.isPeriodic && syncOperation.target.matchesSpec(endPoint)) {
        ...
        arrayList.add(
            new PeriodicSync(
                endPoint2.account,
                endPoint2.provider,
                syncOperation.getClonedExtras(),
                syncOperation.periodMillis / 1000,
                syncOperation.flexMillis / 1000));
      }
    }
    return arrayList;
  }
  ...
  public void scheduleLocalSync(
      Account account, int i, int i2, String str, int i3, int i4, int i5, String str2) {
  ...
  public SyncAdapterType[] getSyncAdapterTypes(int i, int i2) {
    Collection<RegisteredServicesCache.ServiceInfo> allServices =
        this.mSyncAdapters.getAllServices(i2);
    ...
    for (RegisteredServicesCache.ServiceInfo serviceInfo : allServices) {
      ...
      if (TextUtils.isEmpty(packageName)
          || !this.mPackageManagerInternal.filterAppAccess(packageName, i, i2)) {
  ...
  public String[] getSyncAdapterPackagesForAuthorityAsUser(String str, int i, int i2) {
    String[] syncAdapterPackagesForAuthority =
        this.mSyncAdapters.getSyncAdapterPackagesForAuthority(str, i2);
  ...
  public String getSyncAdapterPackageAsUser(String str, String str2, int i, int i2) {
    ...
    if (str == null
        || str2 == null
        || (serviceInfo = this.mSyncAdapters.getServiceInfo(SyncAdapterType.newKey(str2, str), i2))
            == null) {
      return null;
    }
    String packageName = ((SyncAdapterType) serviceInfo.type).getPackageName();
  ...
  public final void sendSyncFinishedOrCanceledMessage(
      ActiveSyncContext activeSyncContext, SyncResult syncResult) {
    if (Log.isLoggable("SyncManager", 2)) {
  ...
  public final void sendCancelSyncsMessage(
      SyncStorageEngine.EndPoint endPoint, Bundle bundle, String str) {
    if (Log.isLoggable("SyncManager", 2)) {
  ...
  public final void postMonitorSyncProgressMessage(ActiveSyncContext activeSyncContext) {
    ...
    this.mSyncHandler.sendMessageDelayed(
        this.mSyncHandler.obtainMessage(8, activeSyncContext), 60000L);
  }

  public final void postScheduleSyncMessage(SyncOperation syncOperation, long j) {
    this.mSyncHandler
        .obtainMessage(12, new ScheduleSyncMessagePayload(syncOperation, j))
        .sendToTarget();
  }
  ...
  public class SyncFinishedOrCancelledMessagePayload {
    ...
    public SyncFinishedOrCancelledMessagePayload(
        ActiveSyncContext activeSyncContext, SyncResult syncResult) {
  ...
  public class UpdatePeriodicSyncMessagePayload {
    ...
    public UpdatePeriodicSyncMessagePayload(
        SyncStorageEngine.EndPoint endPoint, long j, long j2, Bundle bundle) {
  ...
  public final void clearBackoffSetting(SyncStorageEngine.EndPoint endPoint, String str) {
    ...
    if (backoff != null
        && ((Long) backoff.first).longValue() == -1
        && ((Long) backoff.second).longValue() == -1) {
      return;
    }
    if (Log.isLoggable("SyncManager", 2)) {
    ...
    if (backoff == null) {
      ...
      if (elapsedRealtime < ((Long) backoff.first).longValue()) {
        if (Log.isLoggable("SyncManager", 2)) {
          Slog.v(
              "SyncManager",
              "Still in backoff, do not increase it. Remaining: "
                  + ((((Long) backoff.first).longValue() - elapsedRealtime) / 1000)
                  + " seconds.");
          return;
        }
        return;
      ...
      j =
          (long)
              (((Long) backoff.second).longValue() * this.mConstants.getRetryTimeIncreaseFactor());
    }
    if (j <= 0) {
      long initialSyncRetryTimeInSeconds =
          this.mConstants.getInitialSyncRetryTimeInSeconds() * 1000;
  ...
  public final void setDelayUntilTime(SyncStorageEngine.EndPoint endPoint, long j) {
    ...
    long elapsedRealtime =
        j2 > currentTimeMillis ? SystemClock.elapsedRealtime() + (j2 - currentTimeMillis) : 0L;
  ...
  public final boolean isAdapterDelayed(SyncStorageEngine.EndPoint endPoint) {
    ...
    return !(backoff == null
            || ((Long) backoff.first).longValue() == -1
            || ((Long) backoff.first).longValue() <= elapsedRealtime)
        || this.mSyncStorageEngine.getDelayUntilTime(endPoint) > elapsedRealtime;
  }
  ...
  */
  public final void scheduleSyncOperationH(SyncOperation syncOperation, long j) {
    ...
    if (syncOperation.hasIgnoreBackoff()) {
      ...
      Pair backoff = this.mSyncStorageEngine.getBackoff(syncOperation.target);
      if (backoff == null) {
        Slog.e(
            "SyncManager",
            "Couldn't find backoff values for " + SyncLogger.logSafe(syncOperation.target));
    ...
    if (syncOperation.isPeriodic) {
      ...
      while (it.hasNext()) {
        if (((ActiveSyncContext) it.next()).mSyncOperation.key.equals(syncOperation.key)) {
          if (isLoggable) {
            Log.v(
                "SyncManager",
                "Duplicate sync is already running. Not scheduling " + syncOperation);
            return;
          }
          return;
        }
      ...
      if (syncOperation != syncOperation2 && j3 == 0) {
        ...
        if (i4 < i5) {
          ...
          for (SyncOperation syncOperation4 : allPendingSyncs) {
            if (!syncOperation4.isPeriodic
                && syncOperation4.key.equals(syncOperation.key)
                && syncOperation4 != syncOperation2) {
              if (isLoggable) {
    ...
    JobInfo.Builder flags =
        new JobInfo.Builder(
                syncOperation.jobId,
                new ComponentName(this.mContext, (Class<?>) SyncJobService.class))
            .setExtras(syncOperation.toJobInfoExtras())
            .setRequiredNetworkType(syncOperation.isNotAllowedOnMetered() ? 2 : 1)
            .setRequiresStorageNotLow(true)
            .setPersisted(true)
            .setBias(syncOperation.getJobBias())
            .setFlags(syncOperation.isAppStandbyExempted() ? 8 : 0);
    if (syncOperation.isPeriodic) {
    ...
    if (syncOperation.syncExemptionFlag == 2
        && (deviceIdleInternal =
      ...
      deviceIdleInternal.addPowerSaveTempWhitelistApp(
          ...
          this.mConstants.getKeyExemptionTempWhitelistDurationInSeconds() * 1000,
          1,
    ...
    if (usageStatsManagerInternal != null) {
      usageStatsManagerInternal.reportSyncScheduled(
          syncOperation.owningPackage,
          UserHandle.getUserId(syncOperation.owningUid),
    ...
    int scheduleAsPackage =
        getJobScheduler()
            .scheduleAsPackage(
                ...
                syncOperation.wakeLockName());
    if (scheduleAsPackage == 0 && build.isExpedited()) {
      if (isLoggable) {
        Slog.i(
            "SyncManager",
            "Failed to schedule EJ for "
                + syncOperation.owningPackage
  ...
  public void cancelScheduledSyncOperation(SyncStorageEngine.EndPoint endPoint, Bundle bundle) {
    for (SyncOperation syncOperation : getAllPendingSyncs()) {
      if (!syncOperation.isPeriodic
          && syncOperation.target.matchesSpec(endPoint)
          && syncOperation.areExtrasEqual(bundle, false)) {
  ...
  public final void maybeRescheduleSync(SyncResult syncResult, SyncOperation syncOperation) {
    ...
    if (isLoggable) {
      Log.d(
          "SyncManager",
          "encountered error(s) during the sync: " + syncResult + ", " + syncOperation);
    }
    ...
    if (syncOperation.hasDoNotRetry() && !syncResult.syncAlreadyInProgress) {
      if (isLoggable) {
        Log.d(
            "SyncManager",
            "not retrying sync operation because SYNC_EXTRAS_DO_NOT_RETRY was specified "
                + syncOperation);
        return;
      }
      return;
    ...
    if (syncOperation.isUpload() && !syncResult.syncAlreadyInProgress) {
      ...
      if (isLoggable) {
        Log.d(
            "SyncManager",
            "retrying sync operation as a two-way sync because an upload-only sync encountered an"
                + " error: "
                + syncOperation);
      }
    ...
    if (syncResult.tooManyRetries) {
      if (isLoggable) {
        Log.d(
            "SyncManager",
            "not retrying sync operation because it retried too many times: " + syncOperation);
        return;
      }
      return;
    }
    if (syncResult.madeSomeProgress()) {
      if (isLoggable) {
        Log.d(
            "SyncManager",
            "retrying sync operation because even though it had an error it achieved some success");
      }
      scheduleSyncOperationH(syncOperation);
      return;
    }
    if (syncResult.syncAlreadyInProgress) {
      if (isLoggable) {
        Log.d(
            "SyncManager",
            "retrying sync operation that failed because there was already a sync in progress: "
                + syncOperation);
      }
    ...
    if (syncResult.hasSoftError()) {
      if (isLoggable) {
        Log.d(
            "SyncManager",
            "retrying sync operation because it encountered a soft error: " + syncOperation);
      }
      scheduleSyncOperationH(syncOperation);
      return;
    }
    Log.e(
        "SyncManager",
        "not retrying sync operation because the error is a hard error: "
            + SyncLogger.logSafe(syncOperation));
  }
  ...
  public final void onUserUnlocked(int i) {
    ...
    for (Account account :
        AccountManagerService.getSingleton().getAccounts(i, this.mContext.getOpPackageName())) {
  ...
  public class ActiveSyncContext extends ISyncContext.Stub
    ...
    public ActiveSyncContext(SyncOperation syncOperation, long j, int i) {
      ...
      PowerManager.WakeLock syncWakeLock =
          SyncManager.this.mSyncHandler.getSyncWakeLock(syncOperation);
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      ...
      obtainMessage.obj = SyncManager.this.new ServiceConnectionData(this, iBinder);
    ...
    public void onServiceDisconnected(ComponentName componentName) {
      ...
      obtainMessage.obj = SyncManager.this.new ServiceConnectionData(this, null);
      SyncManager.this.mSyncHandler.sendMessage(obtainMessage);
    }
    ...
    public boolean bindToSyncAdapter(ComponentName componentName, int i) {
      ...
      Intent adapterBindIntent =
          SyncManager.getAdapterBindIntent(SyncManager.this.mContext, componentName, i);
      this.mBound = true;
      boolean bindServiceAsUser =
          SyncManager.this.mContext.bindServiceAsUser(
              adapterBindIntent, this, 21, new UserHandle(this.mSyncOperation.target.userId));
      SyncManager.this.mLogger.log(
          "bindService() returned=", Boolean.valueOf(this.mBound), " for ", this);
  ...
  public static /* synthetic */ int lambda$static$6(
      SyncOperation syncOperation, SyncOperation syncOperation2) {
    ...
    int compare2 =
        comparator.compare(syncOperation.target.account.type, syncOperation2.target.account.type);
    if (compare2 != 0) {
      return compare2;
    }
    int compare3 =
        comparator.compare(syncOperation.target.account.name, syncOperation2.target.account.name);
    if (compare3 != 0) {
      return compare3;
    }
    int compare4 =
        comparator.compare(syncOperation.target.provider, syncOperation2.target.provider);
    if (compare4 != 0) {
      return compare4;
    }
  ...
  public void dumpPendingSyncs(
      PrintWriter printWriter, SyncAdapterStateFetcher syncAdapterStateFetcher) {
    List<SyncOperation> allPendingSyncs = getAllPendingSyncs();
    ...
    printWriter.println(
        countIf(
            ...
            new Predicate() { // from class:
                              // com.android.server.content.SyncManager$$ExternalSyntheticLambda11
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean lambda$dumpPendingSyncs$8;
                lambda$dumpPendingSyncs$8 =
                    SyncManager.lambda$dumpPendingSyncs$8((SyncOperation) obj);
  ...
  public void dumpPeriodicSyncs(
    ...
    printWriter.println(
        countIf(
            allPendingSyncs,
            new Predicate() { // from class:
                              // com.android.server.content.SyncManager$$ExternalSyntheticLambda13
              @Override // java.util.function.Predicate
              public final boolean test(Object obj) {
                boolean z;
  ...
  public static StringBuilder formatDurationHMS(StringBuilder sb, long j) {
    ...
    if (!printTwoDigitNumber(
        sb, j3, 's', printTwoDigitNumber(sb, j5, 'm', printTwoDigitNumber(sb, j7, 'h', z)))) {
      sb.append("0s");
    }
    return sb;
  }
  ...
  public void dumpSyncState(
    ...
    int restrictBackgroundStatus =
        connectivityManager == null ? -1 : connectivityManager.getRestrictBackgroundStatus();
      ...
      for (UserInfo userInfo : allUsers) {
        printWriter.print(
            "u"
                + userInfo.id
                + "="
                + this.mSyncStorageEngine.getMasterSyncAutomatically(userInfo.id)
                + " ");
      }
      printWriter.println();
    }
    Intent registerReceiver =
        this.mContext.registerReceiver(
            null, new IntentFilter("android.intent.action.DEVICE_STORAGE_LOW"));
    ...
    AccountAndUser[] allAccountsForSystemProcess =
    ...
    while (it.hasNext()) {
      ...
      printWriter.print(" - ");
      printWriter.print(
          activeSyncContext.mSyncOperation.dump(
              packageManager, false, syncAdapterStateFetcher, false));
      printWriter.println();
    }
    printWriter.println();
    ...
    while (i2 < length) {
      ...
      Collections.sort(
          newArrayList,
          new Comparator() { // from class: com.android.server.content.SyncManager.12
            @Override // java.util.Comparator
            public int compare(
                RegisteredServicesCache.ServiceInfo serviceInfo,
                RegisteredServicesCache.ServiceInfo serviceInfo2) {
              return ((SyncAdapterType) serviceInfo.type)
                  .authority.compareTo(((SyncAdapterType) serviceInfo2.type).authority);
            }
          });
      Iterator it2 = newArrayList.iterator();
      while (it2.hasNext()) {
        RegisteredServicesCache.ServiceInfo serviceInfo =
            (RegisteredServicesCache.ServiceInfo) it2.next();
        if (((SyncAdapterType) serviceInfo.type).accountType.equals(accountAndUser.account.type)) {
          ...
          Iterator it3 = it2;
          Pair copyOfAuthorityWithSyncStatus =
              this.mSyncStorageEngine.getCopyOfAuthorityWithSyncStatus(
                  new SyncStorageEngine.EndPoint(
                      accountAndUser.account,
                      ((SyncAdapterType) serviceInfo.type).authority,
                      accountAndUser.userId));
          SyncStorageEngine.AuthorityInfo authorityInfo =
              (SyncStorageEngine.AuthorityInfo) copyOfAuthorityWithSyncStatus.first;
          ...
          printTable.set(
              ...
              0,
              str,
              Integer.valueOf(authorityInfo.syncable),
              Boolean.valueOf(authorityInfo.enabled));
          QuadConsumer quadConsumer =
              new QuadConsumer() { // from class:
                                   // com.android.server.content.SyncManager$$ExternalSyntheticLambda3
                public final void accept(Object obj, Object obj2, Object obj3, Object obj4) {
                  SyncManager.lambda$dumpSyncState$10(
                      sb,
                      printTable,
                      (String) obj,
                      (SyncStatusInfo.Stats) obj2,
                      (Function) obj3,
                      (Integer) obj4);
                }
              };
          ...
          quadConsumer.accept(
              "Total",
              syncStatusInfo.totalStats,
              new Function() { // from class:
                               // com.android.server.content.SyncManager$$ExternalSyntheticLambda4
          ...
          quadConsumer.accept(
              "Today",
              syncStatusInfo.todayStats,
              new Function() { // from class:
                               // com.android.server.content.SyncManager$$ExternalSyntheticLambda5
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  String zeroToEmpty;
          ...
          if (authorityInfo.delayUntil > elapsedRealtime) {
            printTable.set(
                numRows, 15, "D: " + ((authorityInfo.delayUntil - elapsedRealtime) / 1000));
            if (authorityInfo.backoffTime > elapsedRealtime) {
              printTable.set(
                  i4, 15, "B: " + ((authorityInfo.backoffTime - elapsedRealtime) / 1000));
          ...
          if (syncStatusInfo.lastSuccessTime != 0) {
            printTable.set(
                numRows,
                14,
                SyncStorageEngine.SOURCES[syncStatusInfo.lastSuccessSource] + " SUCCESS");
            numRows = i4 + 1;
          ...
          if (syncStatusInfo.lastFailureTime != 0) {
            ...
            printTable.set(
                numRows,
                14,
                SyncStorageEngine.SOURCES[syncStatusInfo.lastFailureSource] + " FAILURE");
    ...
    for (int i6 = 0; i6 < arrayList.size(); i6++) {
      ...
      while (true) {
        ...
        printWriter.println(
            formatTime(((SyncStatusInfo) pair.second).perSourceLastFailureTimes[i7]));
        i7++;
      }
  ...
  public static /* synthetic */ void lambda$dumpSyncState$10(
      StringBuilder sb,
      PrintTable printTable,
      String str,
      SyncStatusInfo.Stats stats,
      Function function,
      Integer num) {
    sb.setLength(0);
    printTable.set(
        ...
        3,
        str,
        function.apply(Integer.valueOf(stats.numSourceLocal)),
        function.apply(Integer.valueOf(stats.numSourcePoll)),
        function.apply(Integer.valueOf(stats.numSourcePeriodic)),
        function.apply(Integer.valueOf(stats.numSourceFeed)),
        function.apply(Integer.valueOf(stats.numSourceUser)),
        function.apply(Integer.valueOf(stats.numSourceOther)),
        function.apply(Integer.valueOf(stats.numSyncs)),
        function.apply(Integer.valueOf(stats.numFailures)),
        function.apply(Integer.valueOf(stats.numCancels)),
  ...
  */
  public final void dumpRecentHistory(PrintWriter printWriter) {
    ...
    String str12;
    SyncManager syncManager = this;
    ArrayList syncHistory = syncManager.mSyncStorageEngine.getSyncHistory();
    if (syncHistory == null || syncHistory.size() <= 0) {
      return;
    }
    HashMap newHashMap = Maps.newHashMap();
    int size = syncHistory.size();
    Iterator it = syncHistory.iterator();
    long j = 0;
    long j2 = 0;
    int i3 = 0;
    int i4 = 0;
    while (true) {
      ...
      SyncStorageEngine.SyncHistoryItem syncHistoryItem =
          (SyncStorageEngine.SyncHistoryItem) it.next();
      Iterator it2 = it;
      SyncStorageEngine.AuthorityInfo authority =
          syncManager.mSyncStorageEngine.getAuthority(syncHistoryItem.authorityId);
      if (authority != null) {
      ...
      long j3 = syncHistoryItem.elapsedTime;
      long j4 = j + j3;
      j2++;
      ...
      Map map = authoritySyncStats.accountMap;
      AccountSyncStats accountSyncStats = (AccountSyncStats) map.get(str12);
    ...
    ArrayList arrayList2 = syncHistory;
    if (j > 0) {
      printWriter.println();
      printWriter.printf(
          "Detailed Statistics (Recent history):  %d (# of times) %ds (sync time)\n",
          Long.valueOf(j2), Long.valueOf(j / 1000));
      ArrayList arrayList3 = new ArrayList(newHashMap.values());
      Collections.sort(
          arrayList3,
          new Comparator() { // from class: com.android.server.content.SyncManager.13
            @Override // java.util.Comparator
            public int compare(
                AuthoritySyncStats authoritySyncStats2, AuthoritySyncStats authoritySyncStats3) {
              int compare = Integer.compare(authoritySyncStats3.times, authoritySyncStats2.times);
              return compare == 0
                  ? Long.compare(authoritySyncStats3.elapsedTime, authoritySyncStats2.elapsedTime)
                  : compare;
            }
          });
      ...
      while (it3.hasNext()) {
        ...
        printWriter.printf(
            ...
            String.format(
                "%d/%d%%",
                Integer.valueOf(authoritySyncStats2.times), Long.valueOf((r4 * 100) / j2)),
            String.format("%ds/%d%%", Long.valueOf(j5 / 1000), Long.valueOf((j5 * 100) / j)));
        ArrayList arrayList4 = new ArrayList(authoritySyncStats2.accountMap.values());
        Collections.sort(
            arrayList4,
            new Comparator() { // from class: com.android.server.content.SyncManager.14
              @Override // java.util.Comparator
              public int compare(
                  AccountSyncStats accountSyncStats2, AccountSyncStats accountSyncStats3) {
                int compare = Integer.compare(accountSyncStats3.times, accountSyncStats2.times);
                return compare == 0
                    ? Long.compare(accountSyncStats3.elapsedTime, accountSyncStats2.elapsedTime)
                    : compare;
              }
            });
        ...
        while (it5.hasNext()) {
          ...
          printWriter.printf(
              str19,
              accountSyncStats2.name,
              String.format("%d/%d%%", Integer.valueOf(i7), Long.valueOf((i7 * 100) / j2)),
              String.format(str18, Long.valueOf(j6 / 1000), Long.valueOf((j6 * 100) / j)));
          format2 = str20;
          str18 = str18;
          it5 = it6;
        }
    ...
    while (i10 < i9) {
      ...
      SyncStorageEngine.SyncHistoryItem syncHistoryItem2 =
          (SyncStorageEngine.SyncHistoryItem) arrayList5.get(i10);
      SyncStorageEngine.AuthorityInfo authority2 =
          syncManager.mSyncStorageEngine.getAuthority(syncHistoryItem2.authorityId);
      if (authority2 != null) {
      ...
      long j7 = syncHistoryItem2.elapsedTime;
      String str25 = str23;
      String str26 = str24;
      long j8 = syncHistoryItem2.eventTime;
      ...
      if (l == null) {
        ...
        if (longValue < 60) {
          ...
          if (longValue < 3600) {
            ...
            String format4 =
                String.format(
                    "%02d:%02d", Long.valueOf(longValue / 60), Long.valueOf(longValue % 60));
            i = i9;
            format = format4;
          } else {
            arrayList2 = arrayList5;
            ...
            format =
                String.format(
                    "%02d:%02d:%02d",
                    Long.valueOf(longValue / 3600), Long.valueOf(j9 / 60), Long.valueOf(j9 % 60));
          }
          ...
          printWriter.printf(
              ...
              Integer.valueOf(i10),
              formatTime(j8),
              SyncStorageEngine.SOURCES[syncHistoryItem2.source],
              Float.valueOf(j7 / 1000.0f),
              format);
          printWriter.printf(
              str26,
              str8,
              str9,
              SyncOperation.reasonToString(packageManager, syncHistoryItem2.reason));
          i2 = syncHistoryItem2.event;
          if (i2 == 1) {
            if (syncHistoryItem2.upstreamActivity != 0) {}
          }
          printWriter.printf(
              "    event=%d upstreamActivity=%d downstreamActivity=%d\n",
              Integer.valueOf(i2),
              Long.valueOf(syncHistoryItem2.upstreamActivity),
              Long.valueOf(syncHistoryItem2.downstreamActivity));
          str10 = syncHistoryItem2.mesg;
          if (str10 != null && !"success".equals(str10)) {
            printWriter.printf("    mesg=%s\n", syncHistoryItem2.mesg);
          }
          syncManager = this;
          str24 = str26;
          str23 = str25;
      ...
      printWriter.printf(
          ...
          format);
      printWriter.printf(
          str26, str8, str9, SyncOperation.reasonToString(packageManager, syncHistoryItem2.reason));
      i2 = syncHistoryItem2.event;
      if (i2 == 1) {}
      printWriter.printf(
          "    event=%d upstreamActivity=%d downstreamActivity=%d\n",
    ...
    while (i12 < i11) {
      ...
      SyncStorageEngine.SyncHistoryItem syncHistoryItem3 =
          (SyncStorageEngine.SyncHistoryItem) arrayList6.get(i12);
      Bundle bundle = syncHistoryItem3.extras;
      if (bundle == null || bundle.size() == 0) {
        str3 = str22;
        str4 = str21;
      } else {
        SyncStorageEngine.AuthorityInfo authority3 =
            this.mSyncStorageEngine.getAuthority(syncHistoryItem3.authorityId);
        if (authority3 != null) {
        ...
        printWriter.printf(
            ...
            formatTime(syncHistoryItem3.eventTime),
            SyncStorageEngine.SOURCES[syncHistoryItem3.source]);
  ...
  public final void dumpDayStatistics(PrintWriter printWriter) {
    ...
    while (i3 <= 6
        ...
        && (dayStats = dayStatistics[i3]) != null
        && (i = i2 - dayStats.day) <= 6) {
  ...
  public final void dumpSyncAdapters(IndentingPrintWriter indentingPrintWriter) {
    ...
    if (allUsers != null) {
      for (UserInfo userInfo : allUsers) {
        indentingPrintWriter.println(
            "Sync adapters for " + userInfo + XmlUtils.STRING_ARRAY_SEPARATOR);
  ...
  public static void sendOnUnsyncableAccount(
      final Context context,
      RegisteredServicesCache.ServiceInfo serviceInfo,
      int i,
      OnReadyCallback onReadyCallback) {
    final OnUnsyncableAccountCheck onUnsyncableAccountCheck =
        new OnUnsyncableAccountCheck(serviceInfo, onReadyCallback);
    if (context.bindServiceAsUser(
        getAdapterBindIntent(context, serviceInfo.componentName, i),
      ...
      new Handler(Looper.getMainLooper())
          .postDelayed(
              new Runnable() { // from class:
                               // com.android.server.content.SyncManager$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
  ...
  public class OnUnsyncableAccountCheck implements ServiceConnection {
    ...
    public OnUnsyncableAccountCheck(
        RegisteredServicesCache.ServiceInfo serviceInfo, OnReadyCallback onReadyCallback) {
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
      try {
        ISyncAdapter.Stub.asInterface(iBinder)
            .onUnsyncableAccount(
                new ISyncAdapterUnsyncableAccountCallback
                    .Stub() { // from class:
                              // com.android.server.content.SyncManager.OnUnsyncableAccountCheck.1
  ...
  public static boolean readyToSync(int i) {
    ...
    return syncManager != null
        && SyncJobService.isReady()
        && syncManager.mProvisioned
        && syncManager.isUserUnlocked(i);
  }
  ...
  public class SyncHandler extends Handler {
    ...
    public final void handleSyncMessage(Message message) {
      ...
      try {
        ...
        boolean z = true;
        if (i == 1) {
          SyncFinishedOrCancelledMessagePayload syncFinishedOrCancelledMessagePayload =
              (SyncFinishedOrCancelledMessagePayload) message.obj;
          if (SyncManager.this.isSyncStillActiveH(
              syncFinishedOrCancelledMessagePayload.activeSyncContext)) {
            if (isLoggable) {
              Slog.v(
                  "SyncManager",
                  "syncFinished"
                      + syncFinishedOrCancelledMessagePayload.activeSyncContext.mSyncOperation);
            }
            SyncJobService.callJobFinished(
                syncFinishedOrCancelledMessagePayload.activeSyncContext.mSyncOperation.jobId,
                false,
                "sync finished");
            runSyncFinishedOrCanceledH(
                syncFinishedOrCancelledMessagePayload.syncResult,
                syncFinishedOrCancelledMessagePayload.activeSyncContext);
          } else if (isLoggable) {
            Log.d(
                "SyncManager",
                "handleSyncHandlerMessage: dropping since the sync is no longer active: "
                    + syncFinishedOrCancelledMessagePayload.activeSyncContext);
          }
        } else if (i == 4) {
          ...
          if (isLoggable) {
            Log.d(
                "SyncManager",
                "handleSyncHandlerMessage: MESSAGE_SERVICE_CONNECTED: "
                    + serviceConnectionData.activeSyncContext);
          }
          if (SyncManager.this.isSyncStillActiveH(serviceConnectionData.activeSyncContext)) {
            runBoundToAdapterH(
                serviceConnectionData.activeSyncContext, serviceConnectionData.adapter);
          }
        } else if (i == 5) {
          ActiveSyncContext activeSyncContext =
              ((ServiceConnectionData) message.obj).activeSyncContext;
          if (isLoggable) {
            Log.d(
                "SyncManager",
                "handleSyncHandlerMessage: MESSAGE_SERVICE_DISCONNECTED: " + activeSyncContext);
          }
          if (SyncManager.this.isSyncStillActiveH(activeSyncContext)) {
            try {
              if (activeSyncContext.mSyncAdapter != null) {
                SyncManager.this.mLogger.log(
                    "Calling cancelSync for SERVICE_DISCONNECTED ",
                    activeSyncContext,
                    " adapter=",
            ...
            SyncJobService.callJobFinished(
                activeSyncContext.mSyncOperation.jobId, false, "service disconnected");
          ...
          if (isLoggable) {
            Log.d(
                "SyncManager",
                "handleSyncHandlerMessage: MESSAGE_CANCEL: " + endPoint + " bundle: " + peekData);
          }
          ...
          switch (i) {
            case 8:
              ...
              if (isLoggable) {
                Log.d(
                    "SyncManager",
                    "handleSyncHandlerMessage: MESSAGE_MONITOR_SYNC: "
                        + activeSyncContext2.mSyncOperation.target);
              }
              if (isSyncNotUsingNetworkH(activeSyncContext2)) {
                Log.w(
                    ...
                    String.format(
                        ...
                        SyncLogger.logSafe(activeSyncContext2)));
                SyncJobService.callJobFinished(
                    activeSyncContext2.mSyncOperation.jobId, false, "no network activity");
            ...
            case 11:
              ...
              ActiveSyncContext findActiveSyncContextH =
                  findActiveSyncContextH(syncOperation.jobId);
              ...
              break;
            case 12:
              ScheduleSyncMessagePayload scheduleSyncMessagePayload =
                  (ScheduleSyncMessagePayload) message.obj;
              SyncManager.this.scheduleSyncOperationH(
                  scheduleSyncMessagePayload.syncOperation,
                  scheduleSyncMessagePayload.minDelayMillis);
              break;
            case 13:
              UpdatePeriodicSyncMessagePayload updatePeriodicSyncMessagePayload =
                  (UpdatePeriodicSyncMessagePayload) message.obj;
              updateOrAddPeriodicSyncH(
                  updatePeriodicSyncMessagePayload.target,
                  updatePeriodicSyncMessagePayload.pollFrequency,
                  updatePeriodicSyncMessagePayload.flex,
                  updatePeriodicSyncMessagePayload.extras);
              break;
            case 14:
              Pair pair = (Pair) message.obj;
              removePeriodicSyncH(
                  (SyncStorageEngine.EndPoint) pair.first, message.getData(), (String) pair.second);
              break;
          }
        }
      } finally {
    ...
    public final PowerManager.WakeLock getSyncWakeLock(SyncOperation syncOperation) {
      ...
      PowerManager.WakeLock newWakeLock =
          SyncManager.this.mPowerManager.newWakeLock(1, "*sync*/" + wakeLockName);
    ...
    public final void startSyncH(SyncOperation syncOperation) {
      ...
      while (true) {
        ...
        if (activeSyncContext.mSyncOperation.isConflict(syncOperation)) {
          if (activeSyncContext.mSyncOperation.getJobBias() >= syncOperation.getJobBias()) {
            if (isLoggable) {
              Slog.v(
                  "SyncManager", "Rescheduling sync due to conflict " + syncOperation.toString());
            }
      ...
      if (computeSyncOpState != 0) {
        SyncJobService.callJobFinished(
            syncOperation.jobId, false, "invalid op state: " + computeSyncOpState);
        return;
      }
      if (!dispatchSyncOperation(syncOperation)) {
        SyncJobService.callJobFinished(
            syncOperation.jobId, false, "dispatchSyncOperation() failed");
      }
    ...
    public final void updateRunningAccountsH(SyncStorageEngine.EndPoint endPoint) {
      ...
      synchronized (SyncManager.this.mAccountsLock) {
        ...
        SyncManager.this.mRunningAccounts =
        ...
        if (SyncManager.this.mLogger.enabled()) {
          SyncManager.this.mLogger.log(
              "updateRunningAccountsH: ", Arrays.toString(SyncManager.this.mRunningAccounts));
        }
        ...
        for (int i2 = 0; i2 < size; i2++) {
          ActiveSyncContext activeSyncContext =
              (ActiveSyncContext) SyncManager.this.mActiveSyncContexts.get(i2);
          SyncManager syncManager = SyncManager.this;
          SyncStorageEngine.EndPoint endPoint2 = activeSyncContext.mSyncOperation.target;
          if (!syncManager.containsAccountAndUser(
              accountAndUserArr2, endPoint2.account, endPoint2.userId)) {
        ...
        if (endPoint != null) {
          ...
          while (true) {
            ...
            if (SyncManager.this.containsAccountAndUser(
                accountAndUserArr, accountAndUser2.account, accountAndUser2.userId)) {
              i3++;
            } else {
              if (Log.isLoggable("SyncManager", 3)) {
                Log.d(
                    "SyncManager",
                    "Account " + accountAndUser2.account + " added, checking sync restore data");
              }
              AccountSyncSettingsBackupHelper.accountAdded(
                  SyncManager.this.mContext, endPoint.userId);
            }
          }
        }
      }
      ...
      for (i = 0; i < size2; i++) {
        ...
        if (!syncManager2.containsAccountAndUser(
            allAccountsForSystemProcess, endPoint3.account, endPoint3.userId)) {
    ...
    public final void maybeUpdateSyncPeriodH(SyncOperation syncOperation, long j, long j2) {
      ...
      if (Log.isLoggable("SyncManager", 2)) {
        Slog.v(
            "SyncManager", "updating period " + syncOperation + " to " + j + " and flex to " + j2);
      }
    ...
    public final void updateOrAddPeriodicSyncH(
        final SyncStorageEngine.EndPoint endPoint,
        final long j,
        final long j2,
        final Bundle bundle) {
      boolean isLoggable = Log.isLoggable("SyncManager", 2);
      ...
      if (isLoggable) {
        Slog.v(
            "SyncManager",
            "Addition to periodic syncs requested: "
                + endPoint
                + " period: "
                + j
                + " flexMillis: "
      ...
      RegisteredServicesCache.ServiceInfo serviceInfo =
          SyncManager.this.mSyncAdapters.getServiceInfo(
              SyncAdapterType.newKey(endPoint.provider, endPoint.account.type), endPoint.userId);
      if (serviceInfo == null) {
        return;
      }
      SyncOperation syncOperation2 =
          new SyncOperation(
              endPoint,
              serviceInfo.uid,
              serviceInfo.componentName.getPackageName(),
              -4,
              4,
              bundle,
              ((SyncAdapterType) serviceInfo.type).allowParallelSyncs(),
      ...
      if (computeSyncOpState != 2) {
        if (computeSyncOpState != 0) {
          ...
          SyncManager.this.scheduleSyncOperationH(syncOperation2);
          SyncManager.this.mSyncStorageEngine.reportChange(
              1, syncOperation2.owningPackage, endPoint.userId);
          return;
        }
      }
      ...
      if (SyncManager.this.wasPackageEverLaunched(str, userId)) {
        SyncManager.this.mLogger.log(
            "requestAccountAccess for SYNC_OP_STATE_INVALID_NO_ACCOUNT_ACCESS");
        SyncManager.this.mAccountManagerInternal.requestAccountAccess(
            syncOperation2.target.account,
            str,
            userId,
            new RemoteCallback(
                new RemoteCallback
                    .OnResultListener() { // from class:
                                          // com.android.server.content.SyncManager$SyncHandler$$ExternalSyntheticLambda0
                  public final void onResult(Bundle bundle2) {
                    SyncManager.SyncHandler.this.lambda$updateOrAddPeriodicSyncH$0(
                        endPoint, j, j2, bundle, bundle2);
                  }
                }));
      }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateOrAddPeriodicSyncH$0(
        SyncStorageEngine.EndPoint endPoint, long j, long j2, Bundle bundle, Bundle bundle2) {
      if (bundle2 == null || !bundle2.getBoolean("booleanResult")) {
        return;
      }
      SyncManager.this.updateOrAddPeriodicSync(endPoint, j, j2, bundle);
    ...
    public final void removePeriodicSyncInternalH(SyncOperation syncOperation, String str) {
      for (SyncOperation syncOperation2 : SyncManager.this.getAllPendingSyncs()) {
        ...
        if (i == i2 || syncOperation2.jobId == i2) {
          ...
          if (findActiveSyncContextH != null) {
            SyncJobService.callJobFinished(
                syncOperation.jobId, false, "removePeriodicSyncInternalH");
            runSyncFinishedOrCanceledH(null, findActiveSyncContextH);
          }
    ...
    public final void removePeriodicSyncH(
        SyncStorageEngine.EndPoint endPoint, Bundle bundle, String str) {
      SyncManager.this.verifyJobScheduler();
      for (SyncOperation syncOperation : SyncManager.this.getAllPendingSyncs()) {
        if (syncOperation.isPeriodic
            && syncOperation.target.matchesSpec(endPoint)
            && syncOperation.areExtrasEqual(bundle, true)) {
    ...
    public final boolean isSyncNotUsingNetworkH(ActiveSyncContext activeSyncContext) {
      long totalBytesTransferredByUid =
          SyncManager.this.getTotalBytesTransferredByUid(activeSyncContext.mSyncAdapterUid)
              - activeSyncContext.mBytesTransferredAtLastPoll;
      if (Log.isLoggable("SyncManager", 3)) {
        ...
        Log.d(
            ...
            String.format(
                ...
                Long.valueOf(
                    (SystemClock.elapsedRealtime() - activeSyncContext.mLastPolledTimeElapsed)
                        / 1000),
                Long.valueOf(totalBytesTransferredByUid / 1048576),
                Long.valueOf(j / 1024),
                Long.valueOf(j % 1024)));
      }
    ...
    public final int computeSyncOpState(SyncOperation syncOperation) {
      ...
      synchronized (SyncManager.this.mAccountsLock) {
        if (!SyncManager.this.containsAccountAndUser(
            SyncManager.this.mRunningAccounts, endPoint.account, endPoint.userId)) {
          if (isLoggable) {
        ...
        boolean z = true;
        int computeSyncable =
            SyncManager.this.computeSyncable(
                endPoint.account, endPoint.userId, endPoint.provider, true);
        if (computeSyncable == 3) {
          if (isLoggable) {
            Slog.v(
                "SyncManager",
                "    Dropping sync operation: isSyncable == SYNCABLE_NO_ACCOUNT_ACCESS");
          }
        ...
        boolean z2 =
            SyncManager.this.mSyncStorageEngine.getMasterSyncAutomatically(endPoint.userId)
                && SyncManager.this.mSyncStorageEngine.getSyncAutomatically(
                    endPoint.account, endPoint.userId, endPoint.provider);
    ...
    public final boolean dispatchSyncOperation(SyncOperation syncOperation) {
      ...
      if (syncOperation.isAppStandbyExempted()
          && (usageStatsManagerInternal =
              ...
              != null) {
        usageStatsManagerInternal.reportExemptedSyncStart(
            syncOperation.owningPackage, UserHandle.getUserId(syncOperation.owningUid));
      }
      SyncStorageEngine.EndPoint endPoint = syncOperation.target;
      SyncAdapterType newKey = SyncAdapterType.newKey(endPoint.provider, endPoint.account.type);
      RegisteredServicesCache.ServiceInfo serviceInfo =
          SyncManager.this.mSyncAdapters.getServiceInfo(newKey, endPoint.userId);
      if (serviceInfo == null) {
        SyncManager.this.mLogger.log(
            "dispatchSyncOperation() failed: no sync adapter info for ", newKey);
        Log.d(
            "SyncManager",
            "can't find a sync adapter for " + newKey + ", removing settings for it");
      ...
      ActiveSyncContext activeSyncContext =
          SyncManager.this
          .new ActiveSyncContext(syncOperation, insertStartSyncEvent(syncOperation), i);
      if (Log.isLoggable("SyncManager", 2)) {
        Slog.v("SyncManager", "dispatchSyncOperation: starting " + activeSyncContext);
      }
      activeSyncContext.mSyncInfo =
          SyncManager.this.mSyncStorageEngine.addActiveSync(activeSyncContext);
      ...
      SyncManager.this.mLogger.log(
          "dispatchSyncOperation() failed: bind failed. target: ", componentName);
    ...
    public final void runBoundToAdapterH(ActiveSyncContext activeSyncContext, IBinder iBinder) {
      ...
      try {
        ...
        if (SyncManager.this.mLogger.enabled()) {
          SyncManager.this.mLogger.log(
              "Sync start: account=" + syncOperation.target.account,
              " authority=",
              syncOperation.target.provider,
              " reason=",
              SyncOperation.reasonToString(null, syncOperation.reason),
              " extras=",
              syncOperation.getExtrasAsString(),
              " adapter=",
              activeSyncContext.mSyncAdapter);
        }
        ...
        Slog.e(
            "SyncManager",
            "Caught RuntimeException while starting the sync " + SyncLogger.logSafe(syncOperation),
            e2);
      }
    }

    public final void cancelActiveSyncH(
        SyncStorageEngine.EndPoint endPoint, Bundle bundle, String str) {
      Iterator it = new ArrayList(SyncManager.this.mActiveSyncContexts).iterator();
      while (it.hasNext()) {
        ActiveSyncContext activeSyncContext = (ActiveSyncContext) it.next();
        if (activeSyncContext != null
            && activeSyncContext.mSyncOperation.target.matchesSpec(endPoint)
            && (bundle == null || activeSyncContext.mSyncOperation.areExtrasEqual(bundle, false))) {
    ...
    public final void runSyncFinishedOrCanceledH(
        SyncResult syncResult, ActiveSyncContext activeSyncContext) {
      String str;
      boolean isLoggable = Log.isLoggable("SyncManager", 2);
      SyncOperation syncOperation = activeSyncContext.mSyncOperation;
      SyncStorageEngine.EndPoint endPoint = syncOperation.target;
      ...
      SyncManager.this.mLogger.log(
          "runSyncFinishedOrCanceledH() op=", syncOperation, " result=", syncResult);
      if (syncResult != null) {
        if (isLoggable) {
          Slog.v(
              "SyncManager",
              "runSyncFinishedOrCanceled [finished]: " + syncOperation + ", result " + syncResult);
        }
        closeActiveSyncContext(activeSyncContext);
        if (!syncOperation.isPeriodic) {
        ...
        if (!syncResult.hasError()) {
          ...
          Log.w(
              "SyncManager",
              "failed sync operation " + SyncLogger.logSafe(syncOperation) + ", " + syncResult);
          ...
          if (!syncOperation.isPeriodic) {
            ...
            SyncManager.this.postScheduleSyncMessage(
                syncOperation.createOneTimeSyncOperation(), 0L);
          }
        ...
        if (activeSyncContext.mSyncAdapter != null) {
          try {
            SyncManager.this.mLogger.log(
                "Calling cancelSync for runSyncFinishedOrCanceled ",
                activeSyncContext,
                "  adapter=",
                activeSyncContext.mSyncAdapter);
            activeSyncContext.mSyncAdapter.cancelSync(activeSyncContext);
      ...
      if (syncResult != null && syncResult.tooManyDeletions) {
        installHandleTooManyDeletesNotification(
            endPoint.account, endPoint.provider, syncResult.stats.numDeletes, endPoint.userId);
      } else {
        SyncManager.this.mNotificationMgr.cancelAsUser(
            Integer.toString(endPoint.account.hashCode() ^ endPoint.provider.hashCode()),
            18,
            new UserHandle(endPoint.userId));
      }
      ...
      SyncManager.this.scheduleSyncOperationH(
          new SyncOperation(
              endPoint.account,
              endPoint.userId,
              syncOperation.owningUid,
              syncOperation.owningPackage,
              syncOperation.reason,
              syncOperation.syncSource,
              endPoint.provider,
              new Bundle(),
    ...
    public final void closeActiveSyncContext(ActiveSyncContext activeSyncContext) {
      ...
      SyncManager.this.mSyncStorageEngine.removeActiveSync(
          activeSyncContext.mSyncInfo, activeSyncContext.mSyncOperation.target.userId);
      if (Log.isLoggable("SyncManager", 2)) {
        Slog.v(
            "SyncManager",
            "removing all MESSAGE_MONITOR_SYNC & MESSAGE_SYNC_EXPIRED for "
    ...
    public final void installHandleTooManyDeletesNotification(
        Account account, String str, long j, int i) {
      ProviderInfo resolveContentProvider;
      if (SyncManager.this.mNotificationMgr == null
          || (resolveContentProvider =
                  SyncManager.this.mContext.getPackageManager().resolveContentProvider(str, 0))
              == null) {
        return;
      }
      CharSequence loadLabel =
          resolveContentProvider.loadLabel(SyncManager.this.mContext.getPackageManager());
      Intent intent =
          new Intent(SyncManager.this.mContext, (Class<?>) SyncActivityTooManyDeletes.class);
      ...
      PendingIntent activityAsUser =
          PendingIntent.getActivityAsUser(
              SyncManager.this.mContext, 0, intent, 335544320, null, userHandle);
      CharSequence text =
          SyncManager.this
              .mContext
              .getResources()
              .getText(R.string.face_authenticated_confirmation_required);
      ...
      Notification build =
          new Notification.Builder(contextForUser, SystemNotificationChannels.ACCOUNT)
              .setSmallIcon(17304216)
              .setTicker(SyncManager.this.mContext.getString(R.string.face_acquired_too_similar))
              .setWhen(System.currentTimeMillis())
              .setColor(contextForUser.getColor(R.color.system_notification_accent_color))
              .setContentTitle(contextForUser.getString(R.string.face_app_setting_name))
              .setContentText(String.format(text.toString(), loadLabel))
              .setContentIntent(activityAsUser)
              .build();
      build.flags |= 2;
      SyncManager.this.mNotificationMgr.notifyAsUser(
          Integer.toString(account.hashCode() ^ str.hashCode()), 18, build, userHandle);
    }

    public final boolean isActivityAvailable(Intent intent) {
      List<ResolveInfo> queryIntentActivities =
          SyncManager.this.mContext.getPackageManager().queryIntentActivities(intent, 0);
    ...
    public long insertStartSyncEvent(SyncOperation syncOperation) {
      ...
      return SyncManager.this.mSyncStorageEngine.insertStartSyncEvent(
          syncOperation, currentTimeMillis);
    }

    public void stopSyncEvent(
        long j, SyncOperation syncOperation, String str, int i, int i2, long j2) {
      EventLog.writeEvent(2720, syncOperation.toEventLog(1));
      SyncManager.this.mSyncStorageEngine.stopSyncEvent(
          j, j2, str, i2, i, syncOperation.owningPackage, syncOperation.target.userId);
    }
  }
  ...
  public static boolean isSyncSetting(String str) {
    ...
    return str.equals("expedited")
        || str.equals("schedule_as_expedited_job")
