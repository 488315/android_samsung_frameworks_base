...
public final class SyncManager {
    ...
    public static final Context.BindServiceFlags SYNC_ADAPTER_CONNECTION_FLAGS =
            Context.BindServiceFlags.of(21);
    ...
    public final class AnonymousClass12 implements Comparator {
        ...
        public final int compare(Object obj, Object obj2) {
            switch (this.$r8$classId) {
                case 0:
                    return ((SyncAdapterType) ((RegisteredServicesCache.ServiceInfo) obj).type)
                            .authority.compareTo(
                                    ((SyncAdapterType)
                                                    ((RegisteredServicesCache.ServiceInfo) obj2)
                                                            .type)
                                            .authority);
                case 1:
                    ...
                    int compare =
                            Integer.compare(authoritySyncStats2.times, authoritySyncStats.times);
                    return compare == 0
                            ? Long.compare(
                                    authoritySyncStats2.elapsedTime, authoritySyncStats.elapsedTime)
                            : compare;
                default:
                    ...
                    return compare2 == 0
                            ? Long.compare(
                                    accountSyncStats2.elapsedTime, accountSyncStats.elapsedTime)
                            : compare2;
            }
        }
    }
    ...
    public final class ActiveSyncContext extends ISyncContext.Stub
        ...
        public ActiveSyncContext(SyncOperation syncOperation, long j, int i) {
            ...
            PowerManager.WakeLock wakeLock =
                    (PowerManager.WakeLock) syncHandler.mWakeLocks.get(wakeLockName);
            if (wakeLock == null) {
                wakeLock =
                        SyncManager.this.mPowerManager.newWakeLock(
                                1,
        ...
        public final void onFinished(SyncResult syncResult) {
            ...
            syncLogger.log(
                    ...
                    syncResult,
                    " endpoint=",
                    syncOperation == null ? "null" : syncOperation.target);
            SyncManager.m382$$Nest$msendSyncFinishedOrCanceledMessage(
                    SyncManager.this, this, syncResult);
        }
    ...
    public final class OnUnsyncableAccountCheck implements ServiceConnection {
        ...
        public OnUnsyncableAccountCheck(
                ...
                SyncManager$$ExternalSyntheticLambda5 syncManager$$ExternalSyntheticLambda5) {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            try {
                ...
                Slog.e(
                        "SyncManager",
                        "Could not call onUnsyncableAccountDone " + this.mSyncAdapterInfo,
                        e);
                onReady();
            }
        }
    ...
    public final class PackageMonitorImpl extends PackageMonitor {
        public final boolean onHandleForceStop(
            ...
            Log.d(
                    "SyncManager",
                    "Package force-stopped: " + Arrays.toString(strArr) + ", uid: " + i);
            return false;
        }
        ...
        public final void onPackageUnstopped(String str, int i, Bundle bundle) {
            if (Log.isLoggable("SyncManager", 3)) {
                NetworkScoreService$$ExternalSyntheticOutline0.m(
                        i, "Package unstopped: ", str, ", uid: ", "SyncManager");
            }
        }
    }
            ...
            if (length > i4) {
                StringBuilder m =
                        BatteryService$$ExternalSyntheticOutline0.m(
                                i4, "Table only has ", " columns. can't set ");
    ...
    public final class SyncHandler extends Handler {
                ...
                if (activeSyncContext != null
                        ...
                        && (bundle == null
                                || SyncManager.syncExtrasEquals(
                                        activeSyncContext.mSyncOperation.mImmutableExtras,
                                        bundle,
                                        false))) {
                    SyncJobService.callJobFinished(
                            activeSyncContext.mSyncOperation.jobId, "MESSAGE_CANCEL");
        ...
        public final void closeActiveSyncContext(ActiveSyncContext activeSyncContext) {
            ...
            if (activeSyncContext.mBound) {
                ...
                try {
                    SyncManager.this.mBatteryStats.noteSyncFinish(
                            activeSyncContext.mEventName, activeSyncContext.mSyncAdapterUid);
        ...
        public final int computeSyncOpState(SyncOperation syncOperation) {
            ...
            synchronized (SyncManager.this.mAccountsLock) {
                try {
                    if (!SyncManager.m377$$Nest$mcontainsAccountAndUser(
                            SyncManager.this,
                        ...
                        if (isLoggable) {
                            Slog.v(
                                    "SyncManager",
                                    "    Dropping sync operation: account doesn't exist.");
                        }
                    ...
                    if (computeSyncable == 3) {
                        if (isLoggable) {
                            Slog.v(
                                    "SyncManager",
                                    "    Dropping sync operation: isSyncable =="
                    ...
                    if (computeSyncable == 0) {
                        if (isLoggable) {
                            Slog.v(
                                    "SyncManager",
                                    "    Dropping sync operation: isSyncable == NOT_SYNCABLE");
                        }
                        Slog.wtf("SyncManager", "SYNC_OP_STATE_INVALID: NOT_SYNCABLE");
                        return 4;
                    }
                    boolean z2 = true;
                    if (SyncManager.this.mSyncStorageEngine.getMasterSyncAutomatically(
                            endPoint.userId)) {
                        if (SyncManager.this.mSyncStorageEngine.getSyncAutomatically(
                                endPoint.account, endPoint.provider, endPoint.userId)) {
                            z = true;
                            ...
                            if (isLoggable) {
                                Slog.v(
                                        "SyncManager",
                                        "    Dropping sync operation: disallowed by"
                                            + " settings/network.");
                            }
                            Slog.wtf(
                                    "SyncManager",
                                    "SYNC_OP_STATE_INVALID: disallowed by settings/network");
                            return 5;
                        }
                    }
                    z = false;
        ...
        public final void deferSyncH(SyncOperation syncOperation, long j, String str) {
            ...
            syncManager.mLogger.log(
                    "deferSyncH() ",
                    syncOperation.isPeriodic ? "periodic " : "",
                    "sync.  op=",
                    syncOperation,
                    " delay=",
                    Long.valueOf(j),
        ...
        public final void handleSyncMessage(Message message) {
            ...
            try {
                ...
                NetworkInfo activeNetworkInfo =
                        syncManager.getConnectivityManager().getActiveNetworkInfo();
                boolean z = true;
                syncManager.mDataConnectionIsConnected =
                ...
                if (i == 1) {
                    ...
                    if (SyncManager.m379$$Nest$misSyncStillActiveH(
                            SyncManager.this,
                        ...
                        if (isLoggable) {
                            Slog.v(
                                    "SyncManager",
                                    "syncFinished"
                                            + syncFinishedOrCancelledMessagePayload
                                                    .activeSyncContext
                                                    .mSyncOperation);
                        }
                        SyncJobService.callJobFinished(
                        ...
                        Log.d(
                                "SyncManager",
                                "handleSyncHandlerMessage: dropping since the sync is no longer"
                                    + " active: "
                                        + syncFinishedOrCancelledMessagePayload.activeSyncContext);
                    }
                } else if (i == 4) {
                    ServiceConnectionData serviceConnectionData =
                            (ServiceConnectionData) message.obj;
                    if (isLoggable) {
                        Log.d(
                                "SyncManager",
                    ...
                    if (SyncManager.m379$$Nest$misSyncStillActiveH(
                            SyncManager.this, serviceConnectionData.activeSyncContext)) {
                        runBoundToAdapterH(
                                serviceConnectionData.activeSyncContext,
                                serviceConnectionData.adapter);
                    }
                } else if (i == 5) {
                    ...
                    if (isLoggable) {
                        Log.d(
                                "SyncManager",
                                "handleSyncHandlerMessage: MESSAGE_SERVICE_DISCONNECTED: "
                                        + activeSyncContext);
                    }
                    if (SyncManager.m379$$Nest$misSyncStillActiveH(
                            SyncManager.this, activeSyncContext)) {
                        try {
                            ...
                            SyncManager.this.mLogger.log(
                                    "RemoteException ", Log.getStackTraceString(e));
                        }
                        SyncResult syncResult = new SyncResult();
                        syncResult.stats.numIoExceptions++;
                        SyncJobService.callJobFinished(
                                activeSyncContext.mSyncOperation.jobId, "service disconnected");
                    ...
                    switch (i) {
                        case 8:
                            ...
                            if (!isSyncNotUsingNetworkH(activeSyncContext2)) {
                                SyncManager.m380$$Nest$mpostMonitorSyncProgressMessage(
                                        SyncManager.this, activeSyncContext2);
                                break;
                            } else {
                                StringBuilder sb = new StringBuilder();
                                ...
                                Log.w(
                                        "SyncManager",
                                        "Detected sync making no progress for "
                                                + sb.toString()
                                                + ". cancelling.");
                                SyncJobService.callJobFinished(
                                        activeSyncContext2.mSyncOperation.jobId,
                                        "no network activity");
                        ...
                        case 9:
                            if (Log.isLoggable("SyncManager", 2)) {
                                Slog.v(
                                        "SyncManager",
                                        "handleSyncHandlerMessage: MESSAGE_ACCOUNTS_UPDATED");
                            }
                        ...
                        case 11:
                            ...
                            if (findActiveSyncContextH != null) {
                                ...
                                if (isLoggable) {
                                    Slog.v(
                                            "SyncManager",
                                            "Stopping sync. Reschedule: " + z2 + "Backoff: " + z);
                                }
                                if (z) {
                                    SyncManager.m378$$Nest$mincreaseBackoffSetting(
                                            SyncManager.this, syncOperation.target);
                                }
                                if (z2) {
                                    ...
                                    if (!z3) {
                                        ...
                                        syncManager2.scheduleSyncOperationH(
                        ...
                        case 14:
                            ...
                            removePeriodicSyncH(
                                    (SyncStorageEngine.EndPoint) pair.first,
                                    message.getData(),
                                    (String) pair.second);
                            break;
                    }
                    ...
                    if (isLoggable) {
                        Log.d(
                                "SyncManager",
                                "handleSyncHandlerMessage: MESSAGE_CANCEL: "
                                        + endPoint
                                        + " bundle: "
                                        + peekData);
                    }
        ...
        public final boolean isSyncNotUsingNetworkH(ActiveSyncContext activeSyncContext) {
            ...
            long uidTxBytes =
                    (TrafficStats.getUidTxBytes(i) + TrafficStats.getUidRxBytes(i))
                        ...
                        String.format(
                                ...
                                Long.valueOf(
                                        (SystemClock.elapsedRealtime()
                                                        - activeSyncContext.mLastPolledTimeElapsed)
                                                / 1000),
                                Long.valueOf(uidTxBytes / 1048576),
                                Long.valueOf(j / 1024),
                                Long.valueOf(j % 1024)));
            }
        ...
        public final void removePeriodicSyncH(
            ...
            while (it.hasNext()) {
                ...
                if (syncOperation.isPeriodic
                        ...
                        && SyncManager.syncExtrasEquals(
                                syncOperation.mImmutableExtras, bundle, true)) {
                    SyncManager syncManager = SyncManager.this;
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (i == i2 || syncOperation2.jobId == i2) {
                            ...
                            if (findActiveSyncContextH != null) {
                                SyncJobService.callJobFinished(
                                        syncOperation.jobId, "removePeriodicSyncInternalH");
                                runSyncFinishedOrCanceledH(null, findActiveSyncContextH);
                            }
                            syncManager.mLogger.log(
                                    "removePeriodicSyncInternalH-canceling: ", syncOperation2);
        ...
        public final void runBoundToAdapterH(ActiveSyncContext activeSyncContext, IBinder iBinder) {
            ...
            try {
                ...
                closeActiveSyncContext(activeSyncContext);
                StringBuilder sb2 =
                        new StringBuilder("Caught RuntimeException while starting the sync ");
                sb2.append(
                        syncOperation == null
                                ? "[null]"
                                : syncOperation.dump(null, true, null, true));
        ...
        */
        public final void runSyncFinishedOrCanceledH(
                android.content.SyncResult r26,
                com.android.server.content.SyncManager.ActiveSyncContext r27) {
            /*
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.content.SyncManager.SyncHandler.runSyncFinishedOrCanceledH(android.content.SyncResult,"
        ...
        */
        public final void updateOrAddPeriodicSyncH(
                final com.android.server.content.SyncStorageEngine.EndPoint r31,
                final long r32,
                final long r34,
                final android.os.Bundle r36) {
            /*
            ...
            */
            throw new UnsupportedOperationException(
                    "Method not decompiled:"
                        + " com.android.server.content.SyncManager.SyncHandler.updateOrAddPeriodicSyncH(com.android.server.content.SyncStorageEngine$EndPoint,"
                        + " long, long, android.os.Bundle):void");
        }
        ...
        public final void updateRunningAccountsH(SyncStorageEngine.EndPoint endPoint) {
            ...
            synchronized (SyncManager.this.mAccountsLock) {
                try {
                    ...
                    singleton.getClass();
                    try {
                        syncManager.mRunningAccounts =
                                singleton.getAccountsForSystem(
                                        ActivityManager.getService().getRunningUserIds());
                        if (Log.isLoggable("SyncManager", 2)) {
                            Slog.v("SyncManager", "Accounts list: ");
                            for (AccountAndUser accountAndUser :
                                    SyncManager.this.mRunningAccounts) {
                        ...
                        if (syncLogger instanceof SyncLogger.RotatingFileLogger) {
                            ...
                            syncManager2.mLogger.log(
                                    ...
                                    Arrays.toString(syncManager2.mRunningAccounts));
                        }
                        ...
                        for (int i2 = 0; i2 < size; i2++) {
                            ActiveSyncContext activeSyncContext =
                                    (ActiveSyncContext)
                                            SyncManager.this.mActiveSyncContexts.get(i2);
                            SyncManager syncManager3 = SyncManager.this;
                            SyncStorageEngine.EndPoint endPoint2 =
                            ...
                            if (!SyncManager.m377$$Nest$mcontainsAccountAndUser(
                                ...
                                Log.d(
                                        "SyncManager",
                                        "canceling sync since the account is no longer running");
                                SyncManager.m382$$Nest$msendSyncFinishedOrCanceledMessage(
                                        SyncManager.this, activeSyncContext, null);
                            }
                        }
                        if (endPoint != null) {
                            ...
                            while (true) {
                                ...
                                AccountAndUser accountAndUser2 =
                                        SyncManager.this.mRunningAccounts[i3];
                                if (SyncManager.m377$$Nest$mcontainsAccountAndUser(
                                        SyncManager.this,
                                        accountAndUserArr,
                                        accountAndUser2.account,
                                        accountAndUser2.userId)) {
                                    i3++;
                                } else {
                                    if (Log.isLoggable("SyncManager", 3)) {
                                        Log.d(
        ...
        public final synchronized void update() {
            try {
                ...
                if (z) {
                    ...
                    this.mTimeSpentSyncing =
                            (elapsedRealtime - this.mWhenSyncStarted) + this.mTimeSpentSyncing;
                }
    ...
    public static boolean m377$$Nest$mcontainsAccountAndUser(
            SyncManager syncManager, AccountAndUser[] accountAndUserArr, Account account, int i) {
    ...
    public static void m378$$Nest$mincreaseBackoffSetting(
            SyncManager syncManager, SyncStorageEngine.EndPoint endPoint) {
        long j;
        int i;
        int i2;
        float f;
        ...
        if (j <= 0) {
            ...
            if (((long) (j2 * 1.1d)) - j2 > 2147483647L) {
                throw new IllegalArgumentException(
                        "the difference between the maxValue and the minValue must be less than"
                            + " 2147483647");
            }
    ...
    public static boolean m379$$Nest$misSyncStillActiveH(
            SyncManager syncManager, ActiveSyncContext activeSyncContext) {
    ...
    public static void m380$$Nest$mpostMonitorSyncProgressMessage(
            SyncManager syncManager, ActiveSyncContext activeSyncContext) {
        syncManager.getClass();
        if (Log.isLoggable("SyncManager", 2)) {
    ...
    public static void m381$$Nest$mremoveStaleAccounts(SyncManager syncManager) {
        for (UserInfo userInfo : syncManager.mUserManager.getAliveUsers()) {
            if (!userInfo.partial) {
                syncManager.mSyncStorageEngine.removeStaleAccounts(
                        AccountManagerService.getSingleton()
                                .getAccounts(userInfo.id, syncManager.mContext.getOpPackageName()),
                        userInfo.id);
            }
        }
    }
    ...
    public static void m382$$Nest$msendSyncFinishedOrCanceledMessage(
            SyncManager syncManager, ActiveSyncContext activeSyncContext, SyncResult syncResult) {
        syncManager.getClass();
        if (Log.isLoggable("SyncManager", 2)) {
        ...
        obtainMessage.obj =
                new SyncFinishedOrCancelledMessagePayload(syncResult, activeSyncContext);
                    ...
                    public final int compare(Object obj, Object obj2) {
                        ...
                        switch (i) {
                                ...
                                if (compare2 != 0
                                        || (compare2 =
                                                        comparator.compare(
                                                                ...
                                                                endPoint2.account.name))
                                                != 0) {
                                    return compare2;
                                }
                                int compare3 =
                                        comparator.compare(endPoint.provider, endPoint2.provider);
                                if (compare3 != 0) {
                                    return compare3;
                                }
                                int compare4 =
                                        Integer.compare(
                                                syncOperation.reason, syncOperation2.reason);
                                if (compare4 != 0) {
                                    return compare4;
                                }
                                int compare5 =
                                        Long.compare(
                                                syncOperation.periodMillis,
                                                syncOperation2.periodMillis);
                                if (compare5 != 0) {
                                    return compare5;
                                }
                                int compare6 =
                                        Long.compare(
                                                syncOperation.expectedRuntime,
                                                syncOperation2.expectedRuntime);
                                if (compare6 != 0) {
                                    return compare6;
                                }
                                int compare7 =
                                        Long.compare(syncOperation.jobId, syncOperation2.jobId);
                                if (compare7 != 0) {
                                    return compare7;
                                }
                                return 0;
                            default:
                                ...
                                return compare8 != 0
                                        ? compare8
                                        : SyncManager.sOpDumpComparator.compare(
                                                syncOperation, syncOperation2);
                        }
                    }
                };
        final int i2 = 1;
        sOpRuntimeComparator =
                new Comparator() { // from class:
                                   // com.android.server.content.SyncManager$$ExternalSyntheticLambda0
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
    ...
    public SyncManager(Context context, boolean z) {
        ...
        BroadcastReceiver broadcastReceiver =
                new BroadcastReceiver(
                        this) { // from class: com.android.server.content.SyncManager.2
                        ...
                        switch (i2) {
                            case 0:
                                ...
                                if (Log.isLoggable("SyncManager", 2)) {
                                    Slog.v(
                                            "SyncManager",
                                            "Reconnection detected: clearing all backoffs");
                                }
                                SyncManager syncManager2 = this.this$0;
                                SyncStorageEngine syncStorageEngine3 =
                                        syncManager2.mSyncStorageEngine;
                                syncStorageEngine3.getClass();
                                ArraySet arraySet = new ArraySet();
                                synchronized (syncStorageEngine3.mAuthorities) {
                                    try {
                                        for (SyncStorageEngine.AccountInfo accountInfo :
                                                syncStorageEngine3.mAccounts.values()) {
                                            for (SyncStorageEngine.AuthorityInfo authorityInfo :
                                                    accountInfo.authorities.values()) {
                                                if (authorityInfo.backoffTime == -1
                                ...
                                for (int size = arraySet.size() - 1; size > 0; size--) {
                                    syncStorageEngine.reportChange(
                                            1, ((Integer) arraySet.valueAt(size)).intValue(), null);
                                }
                                syncManager2.rescheduleSyncs(
                                        SyncStorageEngine.EndPoint
                                                .USER_ALL_PROVIDER_ALL_ACCOUNTS_ALL,
                                        "network reconnect");
                                return;
                            case 1:
                                Log.w("SyncManager", "Writing sync state before shutdown...");
                                SyncStorageEngine syncStorageEngine4 =
                                        this.this$0.mSyncStorageEngine;
                                ...
                                return;
                            case 2:
                                this.this$0.updateRunningAccounts(
                                        new SyncStorageEngine.EndPoint(
                                                null, null, getSendingUserId()));
                                return;
                            case 3:
                                if ("android.intent.action.TIME_SET".equals(intent.getAction())) {
                                    SyncStorageEngine syncStorageEngine5 =
                                            this.this$0.mSyncStorageEngine;
                            ...
                            default:
                                ...
                                if ("android.intent.action.USER_REMOVED".equals(action)) {
                                    ...
                                    syncManager3.mLogger.log(
                                            "onUserRemoved: u", Integer.valueOf(intExtra));
                                    syncManager3.updateRunningAccounts(null);
                                    syncManager3.mSyncStorageEngine.removeStaleAccounts(
                                            null, intExtra);
                                    Iterator it =
                                            ((ArrayList) syncManager3.getAllPendingSyncs())
                                                    .iterator();
                                    while (it.hasNext()) {
                                        SyncOperation syncOperation = (SyncOperation) it.next();
                                        if (syncOperation.target.userId == intExtra) {
                                            syncManager3.cancelJob(
                                                    syncOperation, "user removed u" + intExtra);
                                        }
                                    }
                                    return;
                                }
                                ...
                                AccountManagerService singleton =
                                        AccountManagerService.getSingleton();
                                singleton.validateAccountsInternal(
                                        singleton.getUserAccounts(intExtra), true);
                                syncManager5.mSyncAdapters.invalidateCache(intExtra);
                                syncManager5.updateRunningAccounts(
                                        new SyncStorageEngine.EndPoint(null, null, intExtra));
                                for (Account account :
                                        AccountManagerService.getSingleton()
                                                .getAccounts(
                                                        intExtra,
                                                        syncManager5.mContext.getOpPackageName())) {
                                    syncManager5.scheduleSync(
                                            account,
                                            intExtra,
                                            -8,
                                            null,
        ...
        if (SyncStorageEngine.sSyncStorageEngine == null) {
            SyncStorageEngine.sSyncStorageEngine =
                    new SyncStorageEngine(context, Environment.getDataDirectory(), looper);
        }
        if (SyncStorageEngine.sSyncStorageEngine == null) {
        ...
        context.registerReceiver(
                broadcastReceiver2, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
        ...
        context.registerReceiver(
                broadcastReceiver4, new IntentFilter("android.intent.action.TIME_SET"));
        if (z) {
        ...
        if (syncStorageEngine.mGrantSyncAdaptersAccountAccess) {
            ...
            while (i7 < size) {
                ...
                for (RegisteredServicesCache.ServiceInfo serviceInfo :
                        this.mSyncAdapters.getAllServices(identifier)) {
                    String packageName = serviceInfo.componentName.getPackageName();
                    Account[] accountsByTypeAsUser =
                            this.mAccountManager.getAccountsByTypeAsUser(
                                    ((SyncAdapterType) serviceInfo.type).accountType, userHandle2);
                    ...
                    while (i8 < length) {
                        ...
                        if (canAccessAccount(account, packageName, identifier)) {
                            ...
                            list = aliveUsers;
                            this.mAccountManager.updateAppPermission(
                                    account,
    ...
    public static void dumpDayStatistic(
            PrintWriter printWriter, SyncStorageEngine.DayStats dayStats) {
    ...
    public static void formatDurationHMS(StringBuilder sb, long j) {
        ...
        if (printTwoDigitNumber(
                ...
                j3,
                's',
                printTwoDigitNumber(sb, j5, 'm', printTwoDigitNumber(sb, j7, 'h', z)))) {
            return;
        }
        sb.append("0s");
    }
        ...
        for (String str : bundle3.keySet()) {
            if (z
                ...
                if (!bundle.containsKey(str)
                        || !Objects.equals(bundle3.get(str), bundle.get(str))) {
                    return false;
                }
            }
        }
    ...
    public final boolean canAccessAccount(Account account, String str, int i) {
        if (this.mAccountManager.hasAccountAccess(
                account, str, UserHandle.getUserHandleForUid(i))) {
            return true;
        }
        try {
            this.mContext
    ...
    public final void cancelScheduledSyncOperation(
            SyncStorageEngine.EndPoint endPoint, Bundle bundle) {
        Iterator it = ((ArrayList) getAllPendingSyncs()).iterator();
        while (it.hasNext()) {
            SyncOperation syncOperation = (SyncOperation) it.next();
            if (!syncOperation.isPeriodic
                    && syncOperation.target.matchesSpec(endPoint)
                    && syncExtrasEquals(syncOperation.mImmutableExtras, bundle, false)) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int computeSyncable(
            android.accounts.Account r7, int r8, java.lang.String r9, boolean r10, boolean r11) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.content.SyncManager.computeSyncable(android.accounts.Account,"
    ...
    */
    public final void dump(java.io.PrintWriter r33, boolean r34) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.content.SyncManager.dump(java.io.PrintWriter,"
                    + " boolean):void");
    }
    ...
    */
    public final void dumpSyncHistory(java.io.PrintWriter r30) {
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.content.SyncManager.dumpSyncHistory(java.io.PrintWriter):void");
    }
    ...
    public final SyncAdapterType[] getSyncAdapterTypes(int i, int i2) {
        ...
        for (RegisteredServicesCache.ServiceInfo serviceInfo : allServices) {
            ...
            if (TextUtils.isEmpty(packageName)
                    || !this.mPackageManagerInternal.filterAppAccess(i, i2, packageName, true)) {
    ...
    public final boolean isDeviceProvisioned() {
        return Settings.Global.getInt(this.mContext.getContentResolver(), "device_provisioned", 0)
                != 0;
    }
    ...
    public final boolean isPackageStopped(int i, String str) {
        ...
        try {
            return ((PackageManagerService.PackageManagerInternalImpl) this.mPackageManagerInternal)
                    .mService
                    .snapshotComputer()
                    .isPackageStoppedForUser(str, i);
        } catch (PackageManager.NameNotFoundException unused) {
            StorageManagerService$$ExternalSyntheticOutline0.m(
                    "Couldn't determine stopped state for unknown package: ", str, "SyncManager");
            return false;
        }
    }
        ...
        while (i12 < length) {
            ...
            if (i8 < 0 || (i10 = accountAndUser3.userId) < 0 || i8 == i10) {
                ...
                Iterator it =
                        syncManager2
                                .mSyncAdapters
                                .getAllServices(accountAndUser3.userId)
                                .iterator();
                while (it.hasNext()) {
                    hashSet.add(
                            ((SyncAdapterType)
                                            ((RegisteredServicesCache.ServiceInfo) it.next()).type)
                                    .authority);
                }
                if (str3 != null) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (computeSyncable != 0
                            && (serviceInfo =
                                            syncManager2.mSyncAdapters.getServiceInfo(
                                                    SyncAdapterType.newKey(
                                                            str4, accountAndUser4.account.type),
                                                    accountAndUser4.userId))
                                    != null) {
                        ...
                        if (computeSyncable == i11) {
                            ...
                            try {
                                z3 =
                                        syncManager2.mPackageManagerInternal.wasPackageEverLaunched(
                                                i8, packageName);
                                        ...
                                        new RemoteCallback(
                                                new RemoteCallback
                                                    ...
                                                    public final void onResult(Bundle bundle7) {
                                                        ...
                                                        syncManager3.scheduleSync(
                                                                accountAndUser5.account,
                                                                i15,
                                                                i16,
                                                                str5,
                                                                bundle8,
                            ...
                            boolean isAlwaysSyncable =
                                    ((SyncAdapterType) serviceInfo.type).isAlwaysSyncable();
                            ...
                            if ((i3 == -2 || i3 == computeSyncable)
                                    && (((SyncAdapterType) serviceInfo.type).supportsUploading()
                                            || !z5)) {
                                if (computeSyncable < 0
                                        || z7
                                        || (syncManager.mSyncStorageEngine
                                    ...
                                    if (computeSyncable != -1) {
                                        ...
                                        final OnUnsyncableAccountCheck onUnsyncableAccountCheck =
                                                new OnUnsyncableAccountCheck(
                                                        serviceInfo,
                                                        new SyncManager$$ExternalSyntheticLambda5(
                                                                this,
                                                                accountAndUser,
                                                                i2,
                                                                str4,
                                        ...
                                        if (context.bindServiceAsUser(
                                                getAdapterBindIntent(
                                                        context, serviceInfo.componentName, i18),
                                                onUnsyncableAccountCheck,
                                                SYNC_ADAPTER_CONNECTION_FLAGS,
                                                UserHandle.of(i18))) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void scheduleSyncOperationH(
            com.android.server.content.SyncOperation r18, long r19) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.android.server.content.SyncManager.scheduleSyncOperationH(com.android.server.content.SyncOperation,"
                    + " long):void");
    }
    ...
    public boolean shouldDisableSyncForUser(UserInfo userInfo, String str) {
        ...
        if (userInfo == null
                || str == null
                || !this.mContext.getResources().getBoolean(R.bool.config_enableContextSyncInCall)
    ...
    public final void updateOrAddPeriodicSync(
            SyncStorageEngine.EndPoint endPoint, long j, long j2, Bundle bundle) {
        this.mSyncHandler
                                ...
                                if (!hashSet.contains(syncOperation.key)) {
                                    ...
                                    while (it3.hasNext()) {
                                        ...
                                        if (syncOperation != syncOperation2
                                                && str2.equals(syncOperation2.key)) {
                                            SyncManager.this.mLogger.log(
                                                    "Removing duplicate sync: ", syncOperation2);
            ...
            if (ENABLE_SUSPICIOUS_CHECK && i == 0) {
                try {
                    ...
                    if (size >= 6) {
                        Slog.wtf(
                                "SyncManager",
                                "Device booted with no persisted periodic syncs: " + str);
                    }
