...
public abstract class AbstractMasterSystemService extends SystemService {
  ...
  public AbstractMasterSystemService(
      Context context, ServiceNameResolver serviceNameResolver, String str) {
    this(context, serviceNameResolver, str, 34);
  }

  public AbstractMasterSystemService(
      Context context, ServiceNameResolver serviceNameResolver, final String str, int i) {
    super(context);
    ...
    if (serviceNameResolver != null) {
      serviceNameResolver.setOnTemporaryServiceNameChangedCallback(
          new ServiceNameResolver
              .NameResolverListener() { // from class:
  ...
  public final void setTemporaryService(int i, String str, int i2) {
    ...
    if (i2 > maximumTemporaryServiceDurationMs) {
      throw new IllegalArgumentException(
          "Max duration is " + maximumTemporaryServiceDurationMs + " (called with " + i2 + ")");
    }
    synchronized (this.mLock) {
  ...
  public final void setTemporaryServices(int i, String[] strArr, int i2) {
    Slog.i(
        this.mTag,
        "setTemporaryService(" + i + ") to " + Arrays.toString(strArr) + " for " + i2 + "ms");
    if (this.mServiceNameResolver == null) {
      return;
    }
    enforceCallingPermissionForManagement();
  ...
  public List getServiceListForUserLocked(int i) {
    ...
    int handleIncomingUser =
        ActivityManager.handleIncomingUser(
            Binder.getCallingPid(), Binder.getCallingUid(), i, false, false, null, null);
    ...
    if (serviceNameResolver != null && serviceNameResolver.isConfiguredInMultipleMode()) {
      arrayList =
          newServiceListLocked(
              handleIncomingUser,
              isDisabledLocked,
              this.mServiceNameResolver.getServiceNameList(i));
    } else {
    ...
    if (!isDisabledLocked) {
      for (int i2 = 0; i2 < arrayList.size(); i2++) {
        onServiceEnabledLocked(
            (AbstractPerUserSystemService) arrayList.get(i2), handleIncomingUser);
      }
    }
      ...
      if (abstractPerUserSystemService != null) {
        synchronized (abstractPerUserSystemService.mLock) {
          ...
          if (!abstractPerUserSystemService.isEnabledLocked()) {
            ...
            onServiceEnabledLocked(
                (AbstractPerUserSystemService) serviceListForUserLocked.get(i2), i);
          }
        }
      }
    }
  ...
  public class C16531 extends PackageMonitor {
    public C16531() {}
        ...
        synchronized (AbstractMasterSystemService.this.mLock) {
          if (AbstractMasterSystemService.this.mUpdatingPackageNames == null) {
            AbstractMasterSystemService.this.mUpdatingPackageNames =
                new SparseArray(AbstractMasterSystemService.this.mServicesCacheList.size());
          }
            ...
            if (abstractMasterSystemService2.debug) {
              Slog.d(
                  ...
                  "Holding service for user "
                      + changingUserId
                      + " while package "
                      + activeServicePackageNameLocked
                      + " is being updated");
            }
          } else {
            ...
            if ((AbstractMasterSystemService.this.mServicePackagePolicyFlags & 4) != 0) {
              ...
              if (abstractMasterSystemService4.debug) {
                Slog.d(
                    ...
                    "Eagerly recreating service for user " + changingUserId);
              }
      ...
      synchronized (AbstractMasterSystemService.this.mLock) {
        if (str.equals(
            AbstractMasterSystemService.this.mUpdatingPackageNames == null
                ? null
                : (String)
                    AbstractMasterSystemService.this.mUpdatingPackageNames.get(changingUserId))) {
          if (AbstractMasterSystemService.this.mUpdatingPackageNames != null) {
    ...
    public void onPackageRemoved(String str, int i) {
      ...
      synchronized (AbstractMasterSystemService.this.mLock) {
        ...
        AbstractPerUserSystemService peekServiceForUserLocked =
            AbstractMasterSystemService.this.peekServiceForUserLocked(changingUserId2);
        if (peekServiceForUserLocked != null
            && (serviceComponentName = peekServiceForUserLocked.getServiceComponentName()) != null
            && str.equals(serviceComponentName.getPackageName())) {
    ...
    public void onPackageDataCleared(String str, int i) {
      ...
      if (serviceNameResolver != null && serviceNameResolver.isConfiguredInMultipleMode()) {
        synchronized (AbstractMasterSystemService.this.mLock) {
          AbstractMasterSystemService.this.onServicePackageDataClearedMultiModeLocked(
              str, changingUserId);
        }
        return;
      }
      synchronized (AbstractMasterSystemService.this.mLock) {
        AbstractPerUserSystemService peekServiceForUserLocked =
            AbstractMasterSystemService.this.peekServiceForUserLocked(changingUserId);
        if (peekServiceForUserLocked != null
            && (serviceComponentName = peekServiceForUserLocked.getServiceComponentName()) != null
            && str.equals(serviceComponentName.getPackageName())) {
      ...
      if ((AbstractMasterSystemService.this.mServicePackagePolicyFlags & 16) != 0) {
        ...
        if (abstractMasterSystemService.debug) {
          Slog.d(
              ...
              "Holding service for user " + i + " while package " + str + " is being restarted");
        }
      } else {
        ...
        if (abstractMasterSystemService2.debug) {
          Slog.d(
              abstractMasterSystemService2.mTag,
              "Removing service for user " + i + " because package " + str + " is being restarted");
        }
        AbstractMasterSystemService.this.removeCachedServiceListLocked(i);
    ...
    public void onPackageModified(String str) {
      synchronized (AbstractMasterSystemService.this.mLock) {
        ...
        String[] defaultServiceNameList =
            AbstractMasterSystemService.this.mServiceNameResolver.getDefaultServiceNameList(
                changingUserId);
    ...
    public final void peekAndUpdateCachedServiceLocked(String str, int i, String str2) {
      ...
      if (str2 == null
          ...
          || (peekServiceForUserLocked =
                  AbstractMasterSystemService.this.peekServiceForUserLocked(i))
              == null
          || peekServiceForUserLocked.getServiceComponentName() != null) {
        return;
      }
      AbstractMasterSystemService abstractMasterSystemService = AbstractMasterSystemService.this;
      if (abstractMasterSystemService.verbose) {
    ...
    public final String getActiveServicePackageNameLocked() {
      ComponentName serviceComponentName;
      AbstractPerUserSystemService peekServiceForUserLocked =
          AbstractMasterSystemService.this.peekServiceForUserLocked(getChangingUserId());
      if (peekServiceForUserLocked == null
          || (serviceComponentName = peekServiceForUserLocked.getServiceComponentName()) == null) {
        return null;
      }
    ...
    public final void handlePackageUpdateLocked(final String str) {
      AbstractMasterSystemService.this.visitServicesLocked(
          new Visitor() { // from class:
                          // com.android.server.infra.AbstractMasterSystemService$1$$ExternalSyntheticLambda0
  ...
  public final void startTrackingPackageChanges() {
    new C16531().register(getContext(), (Looper) null, UserHandle.ALL, true);
  }
  ...
  public void removeServiceFromCache(
      AbstractPerUserSystemService abstractPerUserSystemService, int i) {
  ...
  public void removeServiceFromMultiModeSettings(String str, int i) {
    ServiceNameResolver serviceNameResolver;
    if (getServiceSettingsProperty() == null
        || (serviceNameResolver = this.mServiceNameResolver) == null
        || !serviceNameResolver.isConfiguredInMultipleMode()) {
      if (this.verbose) {
        Slog.v(
            this.mTag,
            "removeServiceFromSettings not implemented  for single backend implementation");
        return;
      }
      return;
    }
  ...
  public final class SettingsObserver extends ContentObserver {
    ...
    public void onChange(boolean z, Uri uri, int i) {
      ...
      if (lastPathSegment.equals(AbstractMasterSystemService.this.getServiceSettingsProperty())
