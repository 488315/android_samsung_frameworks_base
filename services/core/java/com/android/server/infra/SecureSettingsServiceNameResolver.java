...
public final class SecureSettingsServiceNameResolver extends ServiceNameBaseResolver {
  ...
  @Override // com.android.server.infra.ServiceNameBaseResolver,
            // com.android.server.infra.ServiceNameResolver
  ...
  public String[] readServiceNameList(int i) {
    return parseColonDelimitedServiceNames(
        Settings.Secure.getStringForUser(this.mContext.getContentResolver(), this.mProperty, i));
  }
  ...
  public void setServiceNameList(List list, int i) {
    ...
    Settings.Secure.putStringForUser(
        this.mContext.getContentResolver(), this.mProperty, sb.toString(), i);
  }
