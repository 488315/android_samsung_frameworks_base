...
public abstract class SnapshotHelper {
    ...
    public abstract class SettingsData {
        ...
        static {
            String[] strArr = {
                "lockscreen_wallpaper", "android.wallpaper.settings_systemui_transparency"
            };
            ...
            hashMap.put(
                    17,
                    new String[] {
                        "lockscreen_wallpaper_sub", "sub_display_system_wallpaper_transparency"
                    });
            hashMap.put(
                    18,
                    new String[] {
                        "lockscreen_wallpaper_sub", "sub_display_lockscreen_wallpaper_transparency"
                    });
            hashMap.put(33, new String[] {""});
            defaultSettings =
                    new HashMap() { // from class:
                                    // com.samsung.server.wallpaper.snapshot.SnapshotHelper.SettingsData.1
                        {
    ...
    public static void copyDirectory(File file, File file2) {
        Log.d(
                "SnapshotHelper",
                "copyDirectory: sourceLocation = " + file + ", targetLocation = " + file2);
        if (!file.isDirectory()) {
    ...
    public static File getBackupWallpaperAssetsDir(int i, int i2, int i3) {
        return new File(
                ...
                DualAppManagerService$$ExternalSyntheticOutline0.m(
                        i2, i3, "wallpaper_backup/", "/", "/wallpaper_assets"));
    }

    public static File getBackupWallpaperDir(int i, int i2, int i3) {
        return new File(
                Environment.getUserSystemDirectory(i),
                ArrayUtils$$ExternalSyntheticOutline0.m(i2, i3, "wallpaper_backup/", "/"));
    }

    public static String getBackupWallpaperDirLegacy(int i) {
        return WhichChecker.isDex(i)
                ? "dex_wallpaper_backup"
                : WhichChecker.isSubDisplay(i) ? "sub_wallpaper_backup" : "wallpaper_backup";
    }
    ...
    public static File getBackupWallpaperFile(int i, int i2, int i3) {
        ...
        return new File(
                WhichChecker.isLock(i3)
                        ? WallpaperUtils.getWallpaperLockDir(i)
                        : Environment.getUserSystemDirectory(i),
                (getBackupWallpaperDirLegacy(i3).concat("/") + i2 + "_") + i3);
    }
            ...
            File file =
                    new File(
                            WhichChecker.isLock(i2)
                                    ? WallpaperUtils.getWallpaperLockDir(i)
                                    : Environment.getUserSystemDirectory(i),
                            getBackupWallpaperDirLegacy(i2));
                ...
                File file =
                        new File(
                                WhichChecker.isLock(i3)
                                        ? WallpaperUtils.getWallpaperLockDir(i)
                                        : Environment.getUserSystemDirectory(i),
                                getBackupWallpaperDirLegacy(i3));
                if (file.exists()) {
                    File[] listFiles = file.listFiles();
                    if (listFiles != null && listFiles.length > 0) {
                        for (int i4 = 0; i4 < listFiles.length; i4++) {
                            if (!listFiles[i4].isDirectory()) {
                                ...
                                File backupWallpaperFile =
                                        getBackupWallpaperFile(
                                                i,
                                ...
                                Slog.d(
                                        "SnapshotHelper",
                                        "migrateFromOld: from "
                                                + listFiles[i4].getPath()
                                                + ", to "
                                                + backupWallpaperFile.getPath());
    ...
    public static void parseSnapshotHistory(
            TypedXmlPullParser typedXmlPullParser,
            SnapshotManager.SnapshotRepository snapshotRepository) {
        int attributeInt = typedXmlPullParser.getAttributeInt((String) null, "hisotory_count", 0);
        for (int i = 0; i < attributeInt; i++) {
            if (attributeInt > 0) {
                int attributeInt2 =
                        typedXmlPullParser.getAttributeInt((String) null, "type" + i, 0);
                int attributeInt3 = typedXmlPullParser.getAttributeInt((String) null, "key" + i, 0);
                String attributeValue =
                        typedXmlPullParser.getAttributeValue((String) null, "time" + i);
                String attributeValue2 =
                        typedXmlPullParser.getAttributeValue((String) null, "desc" + i);
                if (TextUtils.isEmpty(attributeValue2)) {
                    int attributeInt4 =
                            typedXmlPullParser.getAttributeInt((String) null, "resultCount" + i, 0);
                    if (attributeInt4 > 0) {
                        HashMap hashMap = new HashMap();
                        ...
                        SnapshotManager.SnapshotHistory snapshotHistory =
                                new SnapshotManager.SnapshotHistory();
                    ...
                    SnapshotManager.SnapshotHistory snapshotHistory2 =
                            new SnapshotManager.SnapshotHistory();
    ...
    public static void renameDirectory(File file, File file2) {
        ...
        Log.w(
                "SnapshotHelper",
                "renameDirectory: Failed to rename from "
    ...
    public static boolean saveFile(File file, File file2) {
        ...
        if (file.exists()) {
            if (!file2.exists()) {
                Log.d(
                        "SnapshotHelper",
                        "saveFile: target file doesn't exist, mkdir success? = " + file2.mkdirs());
            }
            if (FileUtils.copyFile(file, file2)) {
                Log.d(
                        "SnapshotHelper",
                        "saveFile: success copy file. \n\tsource = "
                                + file
                                + "\n\ttarget = "
                                + file2);
                return true;
    ...
    public static void updateSettings(
            Context context, int i, Map map, WallpaperManagerService.SemCallback semCallback) {
        int intForUser;
        if (map != null) {
            for (Map.Entry entry : map.entrySet()) {
                ...
                Log.d(
                        ...
                        AppStateTrackerImpl$MyHandler$$ExternalSyntheticOutline0.m(
                                intValue, "updateSettings: ", str, "[", "]"));
                try {
                    intForUser =
                            Settings.System.getIntForUser(context.getContentResolver(), str, -1, i);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                if (!str.equals("lockscreen_wallpaper")
                        && !str.equals("lockscreen_wallpaper_sub")) {
                    if (intValue != intForUser) {
                        if (intValue != -1) {
                            Settings.System.putIntForUser(
                                    context.getContentResolver(), str, intValue, i);
                        } else {
                            Log.d(
                                    "SnapshotHelper",
                                    "updateSettings: value is -1. Write default setting value. Need"
                                        + " to monitor behaviours.");
                            Settings.System.putIntForUser(
                                    context.getContentResolver(),
                                    str,
                                    SettingsData.getDefaultValue(str),
                                    i);
                        }
                    }
                }
                if (intValue == 0) {
                    Slog.d(
                            "SnapshotHelper",
                            "updateSettings: Set restored wallpaper to be system and lock");
                    int i2 = str.equals("lockscreen_wallpaper") ? 4 : 16;
                    int i3 = i2 | 1;
                    WallpaperData onWallpaperDataRequested =
                            semCallback.onWallpaperDataRequested(i, i3);
                    int i4 = i2 | 2;
                    WallpaperData onWallpaperDataRequested2 =
                            semCallback.onWallpaperDataRequested(i, i4);
                    ...
                    semCallback.onLockWallpaperChanged(
                            i, i4, onWallpaperDataRequested2.mSemWallpaperData.mExternalParams);
    ...
    public static void writeDefaultSettings(Context context, int i, int i2) {
        ...
        String[] strArr =
                (String[])
                        ((HashMap) SettingsData.settingsData).get(Integer.valueOf(checkWhich(i2)));
        if (strArr != null) {
            for (String str : strArr) {
                ...
                if (defaultValue != -1) {
                    Log.d(
                            "SnapshotHelper",
                            "writeDefultSettings: Reset to default settings. name = "
                                    + str
                                    + ", value = "
                                    + defaultValue);
                    if (str.equals("lockscreen_wallpaper")
                        ...
                        Settings.System.putIntForUser(
                                context.getContentResolver(), str, defaultValue, i);
                    }
                }
            }
        }
    ...
    public static void writeSnapshotHistory(
        ...
        typedXmlSerializer.attributeInt(
                (String) null, "hisotory_count", arrayList2 != null ? arrayList2.size() : 0);
        if (size > 0) {
            ArrayList arrayList3 = snapshotRepository.mSnapshotHistories;
            for (int i = 0; i < arrayList3.size(); i++) {
                SnapshotManager.SnapshotHistory snapshotHistory =
                        (SnapshotManager.SnapshotHistory) arrayList3.get(i);
                if (snapshotHistory != null) {
                    typedXmlSerializer.attributeInt(
                            (String) null,
                            VibrationParam$1$$ExternalSyntheticOutline0.m(i, "type"),
                            snapshotHistory.type);
                    ...
                    if (map == null) {
                        ...
                        if (size2 > 0) {
                            ...
                            for (Map.Entry entry : snapshotHistory.results.entrySet()) {
                                typedXmlSerializer.attributeInt(
                                        (String) null,
                                        "which" + String.valueOf(i) + String.valueOf(i2),
    ...
    public static void writeSnapshotSettingsData(
            XmlSerializer xmlSerializer, String str, HashMap hashMap, int i) {
        if (hashMap == null) {
            return;
        }
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            xmlSerializer.attribute(
                    null,
                    (String) entry.getKey(),
                    Integer.toString(((Integer) entry.getValue()).intValue()));
        }
