...
public final class UcmSignHelperPkcs1 extends UcmSignHelper {
    ...
    static {
        ...
        hashMap.put(
                "sha224withrsa",
                new byte[] {48, 45, 48, 13, 6, 9, 96, -122, 72, 1, 101, 3, 4, 2, 4, 5, 0, 4, 28});
        hashMap.put(
                "sha256withrsa",
                new byte[] {
                    48,
        ...
        hashMap.put(
                "sha384withrsa",
                new byte[] {48, 65, 48, 13, 6, 9, 96, -122, 72, 1, 101, 3, 4, 2, 2, 5, 0, 4, 48});
        hashMap.put(
                "sha512withrsa",
                new byte[] {48, 81, 48, 13, 6, 9, 96, -122, 72, 1, 101, 3, 4, 2, 3, 5, 0, 4, 64});
