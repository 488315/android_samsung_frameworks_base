...
public final /* synthetic */ class MaintenanceModeManager$$ExternalSyntheticLambda3
        implements Runnable {
    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ...
                maintenanceModeManager.checkPendingAdbProcessing(
                        0, SystemClock.elapsedRealtime() + 15000);
                return;
            case 1:
                ...
                synchronized (maintenanceModeManager2.mLifecycleListeners) {
                    ...
                    while (it.hasNext()) {
                        final LockSettingsService.AnonymousClass1 anonymousClass1 =
                                (LockSettingsService.AnonymousClass1) it.next();
                        final CompletableFuture completableFuture = new CompletableFuture();
                        arrayList.add(completableFuture);
                        try {
                            maintenanceModeManager2.logDebugInfoAsync(
                                    "Start to call onPostprocessing: " + anonymousClass1);
                            Consumer consumer =
                                    new Consumer() { // from class:
                                                     // com.samsung.android.server.pm.mm.MaintenanceModeManager$$ExternalSyntheticLambda10
                                        @Override // java.util.function.Consumer
                                        public final void accept(Object obj2) {
                                            MaintenanceModeManager maintenanceModeManager3 =
                                                    MaintenanceModeManager.this;
                                            LockSettingsService.AnonymousClass1 anonymousClass12 =
                                                    anonymousClass1;
                                            CompletableFuture completableFuture2 =
                                                    completableFuture;
                                            Boolean bool = (Boolean) obj2;
                                            maintenanceModeManager3.getClass();
                                            maintenanceModeManager3.logDebugInfoAsync(
                                                    "Received callback: "
                                                            + anonymousClass12
                                                            + " - "
                                                            + bool);
                            ...
                            maintenanceModeManager2.logDebugInfoAsync(
                                    "Finish calling onPostprocessing: " + anonymousClass1);
                        } catch (Exception e) {
                            maintenanceModeManager2.logDebugInfoAsync(
                                    "Got exception: " + anonymousClass1 + " - " + e.toString());
            ...
            case 2:
                ...
                Settings.Secure.putIntForUser(
                        maintenanceModeManager3.mContext.getContentResolver(),
                        "user_setup_complete",
                        1,
                        77);
                ...
                try {
                    ...
                    packageManager.setApplicationEnabledSetting(
                            "com.sec.android.app.SecSetupWizard", 2, 0, 77, "MaintenanceMode");
                    packageManager.setApplicationEnabledSetting(
                            "com.google.android.setupwizard", 2, 0, 77, "MaintenanceMode");
                    return;
                } catch (Exception e2) {
            ...
            case 3:
                ...
                try {
                    ComponentName componentName =
                            new ComponentName(
                                    "android", MaintenanceModeNotificationService.class.getName());
                    Intent intent = new Intent();
                    intent.setComponent(componentName);
                    maintenanceModeManager4.mContext.startForegroundServiceAsUser(
                            intent, new UserHandle(77));
                } catch (Exception e3) {
                ...
                try {
                    ...
                    maintenanceModeManager4.mOverlayView =
                            new TextView(maintenanceModeManager4.mContext);
                    int dimensionPixelSize =
                            resources.getDimensionPixelSize(
                                    R.dimen.preference_breadcrumbs_padding_start_material);
                    maintenanceModeManager4.mOverlayView.setGravity(17);
                    maintenanceModeManager4.mOverlayView.setPadding(
                            dimensionPixelSize,
                            dimensionPixelSize,
                            dimensionPixelSize,
                            dimensionPixelSize);
                    maintenanceModeManager4.mOverlayView.setBackgroundColor(
                            maintenanceModeManager4.mContext.getColor(
                                    R.color.primary_device_default_dark));
                    maintenanceModeManager4.mOverlayView.setTextAppearance(
                            R.style.Theme.DeviceDefault.Dialog.FixedSize);
                    maintenanceModeManager4.mOverlayView.setTextColor(
                            maintenanceModeManager4.mContext.getColor(
                                    R.color.primary_device_default_light));
                    maintenanceModeManager4.mOverlayView.setTextSize(
                            0,
                            resources.getDimensionPixelSize(R.dimen.preference_child_padding_side));
                    maintenanceModeManager4.mOverlayView.setText(
                            R.string.permlab_bindCarrierServices);
                    ...
                    layoutParams.format =
                            maintenanceModeManager4.mOverlayView.getBackground().getOpacity();
                    WindowManager.LayoutParams layoutParams2 =
                            maintenanceModeManager4.mOverlayViewParams;
                    layoutParams2.flags = 24;
                    layoutParams2.privateFlags |= 536870928;
                    maintenanceModeManager4.mWm =
                            (WindowManager)
                                    maintenanceModeManager4.mContext.getSystemService("window");
                } catch (Exception e4) {
                ...
                try {
                    ...
                    maintenanceModeManager4.mContext.registerReceiverForAllUsers(
                            maintenanceModeManager4.mOverlayReceiver,
                            intentFilter,
                            null,
                            maintenanceModeManager4.mHandler,
                            2);
                } catch (Exception e5) {
                    Log.i(
                            "MaintenanceMode",
                            "Failed to register overlay receiver: " + e5.toString());
                }
