...
public final class RoleLogger {
    ...
    public static final ComponentName sRoleLoggingServiceName =
            new ComponentName("android", RoleLoggingService.class.getName());
    public static final String[] ROLES_TO_LOG = {
        ...
        public final boolean onStartJob(final JobParameters jobParameters) {
            ...
            new Thread(
                            new Runnable() { // from class:
                                             // com.samsung.android.server.pm.role.RoleLogger$RoleLoggingService$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    RoleLogger.RoleLoggingService roleLoggingService =
                                            RoleLogger.RoleLoggingService.this;
                                    ...
                                    try {
                                        try {
                                            ComponentName componentName2 =
                                                    RoleLogger.sRoleLoggingServiceName;
                                            Log.i("RoleLogger", "Check role holders");
                                            SALoggingHelper.sendSettingLog(
                                                    roleLoggingService,
                                                    RoleLogger.m1232$$Nest$mgetEachRoleHolder(
                                                            new RoleLogger(),
                                                            roleLoggingService,
                                                            RoleLogger.ROLES_TO_LOG));
                                        } catch (Exception e) {
    ...
    public static HashMap m1232$$Nest$mgetEachRoleHolder(
            RoleLogger roleLogger, Context context, String[] strArr) {
