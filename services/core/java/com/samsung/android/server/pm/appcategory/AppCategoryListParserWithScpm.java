...
public final class AppCategoryListParserWithScpm extends AppCategoryListParser {
    ...
    static {
        ...
        TEMP_FILE_PATH =
                ConnectivityModuleConnector$$ExternalSyntheticOutline0.m$1(str, "tempcategory.xml");
        FILE_PATH =
                ConnectivityModuleConnector$$ExternalSyntheticOutline0.m$1(
                        str, "pm_app_category_from_scpm.xml");
    ...
    */
    public static com.samsung.android.server.pm.appcategory.AppCategoryListParserWithScpm
            updateParserIfNeeded(java.io.FileDescriptor r18) {
        /*
        ...
        */
        throw new UnsupportedOperationException(
                "Method not decompiled:"
                    + " com.samsung.android.server.pm.appcategory.AppCategoryListParserWithScpm.updateParserIfNeeded(java.io.FileDescriptor):com.samsung.android.server.pm.appcategory.AppCategoryListParserWithScpm");
    }
    ...
    public final void parseAppCategoryList() {
        ...
        if (new File(str).exists()) {
            ...
            try {
                ...
                Slog.d(
                        ...
                        "parseAppCategoryList: ScpmVersion="
                                + SystemProperties.getLong(
                                        "persist.sys.package_feature.version.appcategory",
                                        2024021301L));
                return;
            } catch (Exception e) {
        ...
        SystemProperties.set(
                "persist.sys.package_feature.version.appcategory", Long.toString(2024021301L));
        parseAppCategoryList(null);
        Slog.w(
                "AppCategoryListParserWithScpm",
                "SCPM file was not existed or corrupted. Read system file");
    }
    ...
    public final void restoreToSystemFile() {
        ...
        Slog.w(
                "AppCategoryListParserWithScpm",
                "SCPM file might be corrupted. Read system file instead");
    }
}
