        ...
        synchronized (packageFeatureController.mLock) {
            try {
                ...
                if (packageFeatureController.mShellCommand == null) {
                    packageFeatureController.mShellCommand =
                            new PackageFeatureShellCommand(packageFeatureController);
                }
                PackageFeatureShellCommand packageFeatureShellCommand =
                        packageFeatureController.mShellCommand;
                ...
                if (!PackageFeatureShellCommand.Command.PACKAGE_FEATURE.mCommand.equals(str)) {
                    for (PackageFeature packageFeature : PackageFeature.values()) {
                        if (packageFeature.mEnabled
                                && (packageFeatureDebugCommand = packageFeature.mDebugCommand)
                                        != null) {
                            for (String str2 : packageFeatureDebugCommand.mCommands) {
                                if (str2.equals(str)) {
                                    if (packageFeatureDebugCommand.assertValidOptions(
                                            str, strArr, printWriter)) {
                                        String[] split = strArr[0].split(":");
                                        String adjustExtra =
                                                packageFeatureDebugCommand.adjustExtra(
                                                        strArr.length > 1 ? strArr[1] : null);
                                        PackageFeatureController packageFeatureController2 =
                                                packageFeatureShellCommand.mImpl;
                                                                        ...
                                                                        ((ConcurrentHashMap)
                                                                                ...
                                                                                .get(
                                                                                        packageFeature
                                                                                                ...
                                                                                                .mName);
                                                executeDebugMode =
                                                        packageFeatureGroupRecord == null
                                                                ? "Group is null."
                                                                : packageFeatureGroupRecord
                                                                        .executeDebugMode(
                                                                                split,
                                        ...
                                        packageFeatureController2.mLogger.log(
                                                3, executeDebugMode, null);
                ...
                if (strArr.length <= 0
                        || !PackageFeatureShellCommand.Command
                                .PACKAGE_FEATURE_OPTION_SHOW_PACKAGE_NAME
                                .mCommand.equals(strArr[0])) {
                    packageFeatureShellCommand.mImpl.dump(printWriter);
                    if (strArr.length == 1) {
                        printWriter.println();
                        String str3 = strArr[0];
                        if (PackageFeatureShellCommand.Command.PACKAGE_FEATURE_OPTION_FORCE_UPDATE
                                .mCommand.equals(str3)) {
                            ...
                            PackageFeatureController packageFeatureController3 =
                                    packageFeatureShellCommand.mImpl;
                            packageFeatureController3.mHandler.post(
                                    new PackageFeatureController$$ExternalSyntheticLambda2(
                                            packageFeatureController3, null, 1000L));
                        } else if (PackageFeatureShellCommand.Command
                                .PACKAGE_FEATURE_OPTION_POLICY_RESET
                                .mCommand.equals(str3)) {
                            printWriter.println("Started reset.");
                            PackageFeatureController packageFeatureController4 =
                                    packageFeatureShellCommand.mImpl;
                            synchronized (packageFeatureController4.mLock) {
                                packageFeatureController4.mPackageFeatures.forAllGroups(
                                        new PackageFeatureController$$ExternalSyntheticLambda4());
                            }
                            printWriter.println(
                                    PackageFeatureGroupDataUtilWithEncryption.deleteCacheFiles(
                                            PackageFeatureGroupDataUtilWithEncryption.DIR_PATH));
                            packageFeatureShellCommand.mImpl.initializeGroups();
                            PackageFeatureController packageFeatureController5 =
                                    packageFeatureShellCommand.mImpl;
                            packageFeatureController5.mHandler.post(
                                    new PackageFeatureController$$ExternalSyntheticLambda2(
                                            packageFeatureController5, null, 1000L));
                        }
                    }
                } else {
                    int i =
                            Settings.Global.getInt(
                                    packageFeatureShellCommand.mImpl.mContext.getContentResolver(),
                                    "hidden_api_policy",
                                    -1);
                    if (i == 1 || i == 2) {
