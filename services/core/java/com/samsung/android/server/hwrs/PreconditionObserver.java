...
public final class PreconditionObserver {
    ...
    public PreconditionObserver(Context context) {
        ...
        this.mSettingObserver =
                new ContentObserver(
                        handler) { // from class:
                                   // com.samsung.android.server.hwrs.AbstractPreconditionObserver$1
                    ...
                    public final void onChange(boolean z, Uri uri) {
                        ...
                        if (PreconditionObserver.this.URI_CAMERASHARE.equals(uri)) {
                            ...
                            int i =
                                    preconditionObserver.getValues("hwrs_camerashare_setting") > 0
                                            ? 4
                                            : 5;
                            preconditionObserver.updateFlag(
                                    2, preconditionObserver.isSettingEnabled$1());
                        ...
                        if (PreconditionObserver.this.URI_STORAGESHARE.equals(uri)) {
                            ...
                            int i2 =
                                    preconditionObserver2.getValues("hwrs_storageshare_setting") > 0
                                            ? 6
                                            : 7;
                            preconditionObserver2.updateFlag(
                                    2, preconditionObserver2.isSettingEnabled$1());
        ...
        this.mOnAccountsUpdateListener =
                new OnAccountsUpdateListener() { // from class:
                                                 // com.samsung.android.server.hwrs.AbstractPreconditionObserver$2
                    @Override // android.accounts.OnAccountsUpdateListener
                    public final void onAccountsUpdated(Account[] accountArr) {
                        GestureWakeup$$ExternalSyntheticOutline0.m(
                                new StringBuilder("onAccountsUpdated - "),
                                accountArr.length,
                                "[HWRS_SYS]PreconditionObserver");
                        PreconditionObserver preconditionObserver = PreconditionObserver.this;
                        preconditionObserver.getClass();
                        Log.d("[HWRS_SYS]PreconditionObserver", "handleSamsungAccountUpdate");
                        preconditionObserver.updateFlag(
                                1, preconditionObserver.isSamsungAccountLogin());
                        preconditionObserver.notifyChanged(2);
                    }
                };
        this.mAccountChangeReceiver =
                new BroadcastReceiver() { // from class:
                    // com.samsung.android.server.hwrs.AbstractPreconditionObserver$3
                ...
                new Handler(
                        Looper
                                .getMainLooper()) { // from class:
                                                    // com.samsung.android.server.hwrs.PreconditionObserver.1
                    ...
                    public final void handleMessage(Message message) {
                        ...
                        int semGetIdentifier =
                                userHandle == null ? -10000 : userHandle.semGetIdentifier();
                        AnonymousClass2 anonymousClass2 =
                                preconditionObserver.new AnonymousClass2();
                        preconditionObserver.mUserId = semGetIdentifier;
                        preconditionObserver.mListener = anonymousClass2;
                        preconditionObserver.mCameraShareInstalled =
                                preconditionObserver.isPackageInstalled(
                                        "com.samsung.android.hwresourceshare");
                        preconditionObserver.mStorageShareInstalled =
                                preconditionObserver.isPackageInstalled(
                        ...
                        if (preconditionObserver.mStorageShareInstalled) {
                            ((ArrayList) preconditionObserver.settingList)
                                    .add("hwrs_storageshare_setting");
                        }
                        preconditionObserver.updateFlag(
                                1, preconditionObserver.isSamsungAccountLogin());
                        preconditionObserver.updateFlag(
                        ...
                        if (!z && preconditionObserver.mCameraShareInstalled) {
                            preconditionObserver
                                    ...
                                    .registerContentObserver(
                                            preconditionObserver.URI_CAMERASHARE,
                                            false,
                                            abstractPreconditionObserver$1,
                                            preconditionObserver.mUserId);
                            preconditionObserver.mIsRegisteredCameraShareObserver = true;
                        }
                        if (!preconditionObserver.mIsRegisteredStorageShareObserver
                                && preconditionObserver.mStorageShareInstalled) {
                            preconditionObserver
                                    .mContext
                                    .getContentResolver()
                                    .registerContentObserver(
                                            preconditionObserver.URI_STORAGESHARE,
                                            false,
                                            abstractPreconditionObserver$1,
                                            preconditionObserver.mUserId);
                        ...
                        if (preconditionObserver.mIsAddedAccountListener) {
                            ...
                            if (preconditionObserver.mUserId != 0) {
                                preconditionObserver.mContext.semRegisterReceiverAsUser(
                                        ...
                                        new UserHandle(preconditionObserver.mUserId),
                        ...
                        FlashNotificationsController$$ExternalSyntheticOutline0.m(
                                "[HWRS_SYS]PreconditionObserver",
                                new StringBuilder("mIsValidState : "),
                                preconditionObserver.mIsValidState);
                    }
                };
    }
    ...
    public final int getValues(String str) {
        int semGetIntForUser =
                Settings.System.semGetIntForUser(
                        this.mContext.getContentResolver(), str, -1, this.mUserId);
        Log.i(
                "[HWRS_SYS]PreconditionObserver",
                "getValues ID : " + str + ", value : " + semGetIntForUser);
        ...
        try {
            Log.i(
                    ...
                    XmlUtils$$ExternalSyntheticOutline0.m(
                            ...
                            str,
                            "(",
                            this.mContext.getPackageManager().getPackageInfo(str, 1).versionName,
                            ") installed"));
            return true;
        } catch (PackageManager.NameNotFoundException unused) {
            AudioDeviceInventory$$ExternalSyntheticOutline0.m(
                    "Package : ", str, " not installed", "[HWRS_SYS]PreconditionObserver");
            return false;
        }
    }

    public final boolean isSamsungAccountLogin() {
        if (AccountManager.get(this.mContext)
                        .getAccountsByTypeAsUser("com.osp.app.signin", new UserHandle(this.mUserId))
                        .length
                > 0) {
    ...
    public final boolean meetConditions() {
        Log.i(
                "[HWRS_SYS]PreconditionObserver",
                "meetConditions - current state : " + Integer.toHexString(this.mState));
    ...
    public final void notifyChanged(int i) {
        ...
        if (anonymousClass2 != null) {
            ...
            Log.i(
                    "[HWRS_SYS]PreconditionObserver",
                    "onChanged - isValid : " + meetConditions + ", reason : " + i);
    ...
    public final void setValues(int i) {
        DirEncryptService$$ExternalSyntheticOutline0.m(
                i, "setValues ID : hwrs_service, value : ", "[HWRS_SYS]PreconditionObserver");
        if (Settings.System.semGetIntForUser(
                        this.mContext.getContentResolver(), "hwrs_service", -1, this.mUserId)
                != i) {
            Settings.System.semPutIntForUser(
                    this.mContext.getContentResolver(), "hwrs_service", i, this.mUserId);
        } else {
    ...
    public final void stopUser() {
        ...
        if (this.mIsAddedAccountListener) {
            ...
            AccountManager.get(this.mContext)
                    .removeOnAccountsUpdatedListener(this.mOnAccountsUpdateListener);
            if (this.mUserId != 0) {
