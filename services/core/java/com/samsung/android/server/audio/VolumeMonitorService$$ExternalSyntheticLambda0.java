...
public final /* synthetic */ class VolumeMonitorService$$ExternalSyntheticLambda0
        implements Runnable {
            ...
            case 0:
                ...
                try {
                    volumeMonitorService
                            .getUserContext()
                            .getContentResolver()
                            .call(VolumeMonitorService.authority, "resetData()", "", (Bundle) null);
                    break;
                } catch (Exception e) {
                    RCPManagerService$$ExternalSyntheticOutline0.m(
                            e, new StringBuilder("resetData() "), "AS.VolumeMonitor");
                    return;
                }
            default:
                VolumeMonitorService volumeMonitorService2 =
                        ((VolumeMonitorService.VolumeMonitorThread.VolumeMonitorHandler) obj)
                                .this$1
                                .this$0;
                ...
                if (semVolumeMonitor == null) {
                    ...
                    try {
                        volumeMonitorService2
                                .getUserContext()
                                .getContentResolver()
                                .call(
                                        VolumeMonitorService.authority,
                                        "setVolumeData()",
                                        new String(
                                                semVolumeMonitor.getOneMinScoreStatus(
                        ...
                        RCPManagerService$$ExternalSyntheticOutline0.m(
                                e2, new StringBuilder("sendVolumeData() "), "AS.VolumeMonitor");
                    }
                }
        }
    }
