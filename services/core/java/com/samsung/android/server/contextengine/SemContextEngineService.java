...
public final class SemContextEngineService extends SystemService {
    ...
    public SemContextEngineService(Context context) {
        ...
        this.mBroadcastReceiver =
                new BroadcastReceiver() { // from class:
                                          // com.samsung.android.server.contextengine.SemContextEngineService.1
                    @Override // android.content.BroadcastReceiver
                    public final void onReceive(Context context2, Intent intent) {
                        if (intent != null) {
                            String action = intent.getAction();
                            if ("android.intent.action.SCREEN_ON".equals(action)) {
                                SemContextEngineService semContextEngineService =
                                        SemContextEngineService.this;
                            ...
                            if ("android.intent.action.SCREEN_OFF".equals(action)) {
                                SemContextEngineService semContextEngineService2 =
                                        SemContextEngineService.this;
                                if (semContextEngineService2.isScreenOn) {
                                    ...
                                    Intent intent3 =
                                            new Intent("com.samsung.android.ce.SCREEN_OFF");
                            ...
                            if ("android.telephony.action.SIM_CARD_STATE_CHANGED".equals(action)) {
                                ...
                                Intent intent5 =
                                        new Intent("com.samsung.android.ce.SIM_CARD_STATE_CHANGED");
    ...
    public final void onUserUnlocking(SystemService.TargetUser targetUser) {
        Log.d(
                "SemContextEngineService",
                "onUserUnlocking : " + targetUser.getUserHandle().toString());
