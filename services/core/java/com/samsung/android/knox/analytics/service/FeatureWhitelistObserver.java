...
public final class FeatureWhitelistObserver {
    ...
    public final class FeatureWhitelistContentObserver extends ContentObserver {
        ...
        public final void onChange(boolean z, Uri uri) {
            ...
            Log.d(
                    FeatureWhitelistObserver.TAG,
                    "FeatureWhitelist.onChange(" + uri.toString() + ")");
            updateFeatureWhitelistCache();
        }
        ...
        public final void updateFeatureWhitelistCache() {
            ...
            featureWhitelistObserver.mFeaturesWhitelistCache =
                    KnoxAnalyticsQueryResolver.getFeaturesWhitelist(
                            featureWhitelistObserver.mContext);
            if (FeatureWhitelistObserver.this.mFeaturesWhitelistCache == null) {
                Log.e(
                        FeatureWhitelistObserver.TAG,
                        "FeatureWhitelist.updateFeatureWhitelistCache(): Whitelist is null!");
            }
        }
    }
    ...
    public final void start() {
        ...
        handlerThread.start();
        this.mFeatureWhitelistContentObserver =
                new FeatureWhitelistContentObserver(this.mHandlerThread.getThreadHandler());
        this.mContext
                .getContentResolver()
    ...
    public final void stop() {
        ...
        if (this.mFeatureWhitelistContentObserver != null) {
            this.mContext
                    .getContentResolver()
                    .unregisterContentObserver(this.mFeatureWhitelistContentObserver);
        }
