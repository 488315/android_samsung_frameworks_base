...
public final class LauncherConfigurationInternal {
    ...
    public static final String METHOD_GET_SUPPLEMENT_SERVICE_PAGE_VISIBILITY =
            "get_supplement_service_page_visibility";
    ...
    public static final String METHOD_SET_SUPPLEMENT_SERVICE_PAGE_VISIBILITY =
            "set_supplement_service_page_visibility";
    ...
    public final int addShortcut(int i, Point point, ComponentName componentName) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, "add_shortcut", (String) null, bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final int addWidget(int i, Point point, Point point2, ComponentName componentName) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, METHOD_ADD_WIDGET, (String) null, bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final Size getAppsCellDimension() {
        Bundle call =
                this.mContext
                        ...
                        .call(
                                CONTENT_URI,
                                METHOD_GET_APPS_CELL_DIMENSION,
                                (String) null,
                                (Bundle) null);
        return new Size(
                call.getInt(KEY_CELLDIMENSION_ROWS_INT, 0),
                call.getInt(KEY_CELLDIMENSION_COLS_INT, 0));
    }
    ...
    public final Size getHomeCellDimension() {
        Bundle call =
                this.mContext
                        ...
                        .call(
                                CONTENT_URI,
                                METHOD_GET_HOME_CELL_DIMENSION,
                                (String) null,
                                (Bundle) null);
        return new Size(
                call.getInt(KEY_CELLDIMENSION_ROWS_INT, 0),
    ...
    public final int getHomeMode() {
        String string =
                this.mContext
                        .getContentResolver()
                        .call(CONTENT_URI, METHOD_GET_HOME_MODE, "home_mode", (Bundle) null)
                        .getString("home_mode");
    ...
    public final int getHotseatItemCount() {
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, METHOD_GET_HOTSEAT_ITEM_COUNT, (String) null, (Bundle) null)
                .getInt(KEY_ITEMCOUNT_INT, -2);
    }

    public final int getHotseatMaxItemCount() {
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, METHOD_GET_HOTSEAT_MAXITEM_COUNT, (String) null, (Bundle) null)
                .getInt(KEY_ITEMCOUNT_INT, -2);
    }
    ...
    public final boolean getSupplementServicePageVisibility() {
        Bundle call =
                this.mContext
                        ...
                        .call(
                                CONTENT_URI,
                                METHOD_GET_SUPPLEMENT_SERVICE_PAGE_VISIBILITY,
                                (String) null,
                                (Bundle) null);
        if (call.getInt("invocation_result", -2) == 0) {
    ...
    public final int isSupported(int i) {
        return this.mContext
                ...
                .call(
                        ...
                        METHOD_IS_SUPPORTED,
                        (String) null,
                        SystemUpdateManagerService$$ExternalSyntheticOutline0.m(i, KEY_FEATURE_INT))
                .getInt("invocation_result", -2);
    }
    ...
    public final int makeEmptyPosition(int i, Point point, Point point2) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, "make_empty_position", (String) null, bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final int removeHotseatItem(int i) {
        return this.mContext
                ...
                .call(
                        CONTENT_URI,
                        METHOD_REMOVE_HOTSEAT_ITEM,
                        (String) null,
                        SystemUpdateManagerService$$ExternalSyntheticOutline0.m(i, KEY_INDEX_INT))
                .getInt("invocation_result", -2);
    }
    ...
    public final int removePageFromHome(int i) {
        return this.mContext
                ...
                .call(
                        CONTENT_URI,
                        METHOD_REMOVE_PAGE_FROM_HOME,
                        (String) null,
                        SystemUpdateManagerService$$ExternalSyntheticOutline0.m(i, KEY_PAGE_INT))
                .getInt("invocation_result", -2);
    }
    ...
    public final int removeShortcut(ComponentName componentName) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, "remove_shortcut", (String) null, bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final int removeWidget(ComponentName componentName) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, METHOD_REMOVE_WIDGET, (String) null, bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final int setHotseatItem(int i, ComponentName componentName) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, METHOD_SET_HOTSEAT_ITEM, (String) null, bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final int setSupplementServicePageVisibility(boolean z) {
        ...
        return this.mContext
                ...
                .call(
                        CONTENT_URI,
                        METHOD_SET_SUPPLEMENT_SERVICE_PAGE_VISIBILITY,
                        (String) null,
                        bundle)
                .getInt("invocation_result", -2);
    }
    ...
    public final int switchHomeMode(int i) {
        ...
        return this.mContext
                .getContentResolver()
                .call(CONTENT_URI, METHOD_SWITCH_HOME_MODE, (String) null, bundle)
                .getInt("invocation_result", -2);
    }
}
