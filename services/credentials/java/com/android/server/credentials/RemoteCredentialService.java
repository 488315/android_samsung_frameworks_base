...
public class RemoteCredentialService extends ServiceConnector.Impl {
  ...
  public RemoteCredentialService(Context context, ComponentName componentName, int i) {
    super(
        ...
        new Function() { // from class:
          // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda2
  ...
  public void onBeginGetCredential(final BeginGetCredentialRequest beginGetCredentialRequest) {
    ...
    AndroidFuture orTimeout =
        postAsync(
                new ServiceConnector.Job() { // from class:
                  // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda5
                  public final Object run(Object obj) {
                    CompletableFuture lambda$onBeginGetCredential$0;
                    lambda$onBeginGetCredential$0 =
                        RemoteCredentialService.this.lambda$onBeginGetCredential$0(
                            beginGetCredentialRequest,
                            atomicReference2,
                            atomicReference,
                            (ICredentialProviderService) obj);
    ...
    orTimeout.whenComplete(
        new BiConsumer() { // from class:
          // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda6
          @Override // java.util.function.BiConsumer
          public final void accept(Object obj, Object obj2) {
            RemoteCredentialService.this.lambda$onBeginGetCredential$2(
                atomicReference, (BeginGetCredentialResponse) obj, (Throwable) obj2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ CompletableFuture lambda$onBeginGetCredential$0(
      BeginGetCredentialRequest beginGetCredentialRequest,
      final AtomicReference atomicReference,
      final AtomicReference atomicReference2,
      ICredentialProviderService iCredentialProviderService) {
    final CompletableFuture completableFuture = new CompletableFuture();
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      iCredentialProviderService.onBeginGetCredential(
          beginGetCredentialRequest,
          new IBeginGetCredentialCallback
              .Stub() { // from class: com.android.server.credentials.RemoteCredentialService.1
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onBeginGetCredential$2(
      final AtomicReference atomicReference,
      final BeginGetCredentialResponse beginGetCredentialResponse,
      final Throwable th) {
    Handler.getMain()
        .post(
            new Runnable() { // from class:
              // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda7
              @Override // java.lang.Runnable
              public final void run() {
                RemoteCredentialService.this.lambda$onBeginGetCredential$1(
                    beginGetCredentialResponse, th, atomicReference);
              }
            });
  }

  public void onBeginCreateCredential(
      final BeginCreateCredentialRequest beginCreateCredentialRequest) {
    if (this.mCallback == null) {
      Slog.w("RemoteCredentialService", "Callback is not set");
      return;
    }
    ...
    AndroidFuture orTimeout =
        postAsync(
                new ServiceConnector.Job() { // from class:
                  // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda3
                  public final Object run(Object obj) {
                    CompletableFuture lambda$onBeginCreateCredential$3;
                    lambda$onBeginCreateCredential$3 =
                        RemoteCredentialService.this.lambda$onBeginCreateCredential$3(
    ...
    orTimeout.whenComplete(
        new BiConsumer() { // from class:
          // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda4
          @Override // java.util.function.BiConsumer
          public final void accept(Object obj, Object obj2) {
            RemoteCredentialService.this.lambda$onBeginCreateCredential$5(
                atomicReference, (BeginCreateCredentialResponse) obj, (Throwable) obj2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ CompletableFuture lambda$onBeginCreateCredential$3(
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      iCredentialProviderService.onBeginCreateCredential(
          beginCreateCredentialRequest,
          new IBeginCreateCredentialCallback
              .Stub() { // from class: com.android.server.credentials.RemoteCredentialService.2
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onBeginCreateCredential$5(
      final AtomicReference atomicReference,
      final BeginCreateCredentialResponse beginCreateCredentialResponse,
      final Throwable th) {
    Handler.getMain()
        .post(
            new Runnable() { // from class:
              // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda9
              @Override // java.lang.Runnable
              public final void run() {
                RemoteCredentialService.this.lambda$onBeginCreateCredential$4(
                    beginCreateCredentialResponse, th, atomicReference);
              }
            });
  }

  public void onClearCredentialState(
      final ClearCredentialStateRequest clearCredentialStateRequest) {
    if (this.mCallback == null) {
      Slog.w("RemoteCredentialService", "Callback is not set");
      return;
    }
    ...
    AndroidFuture orTimeout =
        postAsync(
                new ServiceConnector.Job() { // from class:
                  // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda0
                  public final Object run(Object obj) {
                    CompletableFuture lambda$onClearCredentialState$6;
                    lambda$onClearCredentialState$6 =
                        RemoteCredentialService.this.lambda$onClearCredentialState$6(
    ...
    orTimeout.whenComplete(
        new BiConsumer() { // from class:
          // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda1
          @Override // java.util.function.BiConsumer
          public final void accept(Object obj, Object obj2) {
            RemoteCredentialService.this.lambda$onClearCredentialState$8(
                atomicReference, (Void) obj, (Throwable) obj2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ CompletableFuture lambda$onClearCredentialState$6(
    ...
    long clearCallingIdentity = Binder.clearCallingIdentity();
    try {
      iCredentialProviderService.onClearCredentialState(
          clearCredentialStateRequest,
          new IClearCredentialStateCallback
              .Stub() { // from class: com.android.server.credentials.RemoteCredentialService.3
            ...
            public void onFailure(String str, CharSequence charSequence) {
              ...
              completableFuture.completeExceptionally(
                  new ClearCredentialStateException(str, valueOf));
            }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onClearCredentialState$8(
      final AtomicReference atomicReference, final Void r4, final Throwable th) {
    Handler.getMain()
        .post(
            new Runnable() { // from class:
              // com.android.server.credentials.RemoteCredentialService$$ExternalSyntheticLambda8
              @Override // java.lang.Runnable
              public final void run() {
                RemoteCredentialService.this.lambda$onClearCredentialState$7(
                    r4, th, atomicReference);
              }
            });
  }
  ...
  public final void lambda$onClearCredentialState$7(
