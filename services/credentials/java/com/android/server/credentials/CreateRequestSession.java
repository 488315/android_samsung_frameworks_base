...
public final class CreateRequestSession extends RequestSession
  ...
  public CreateRequestSession(
    ...
    super(
        ...
        "android.credentials.ui.TYPE_CREATE",
        callingAppInfo,
        set,
        cancellationSignal,
        j);
    this.mRequestSessionMetric.collectCreateFlowInitialMetricInfo(
        createCredentialRequest.getOrigin() != null, createCredentialRequest);
  ...
  public ProviderSession initiateProviderSession(
    ...
    ProviderCreateSession createNewSession =
        ProviderCreateSession.createNewSession(
  ...
  public void onFinalResponseReceived(
      ComponentName componentName, CreateCredentialResponse createCredentialResponse) {
    Slog.i(
        "CreateRequestSession",
