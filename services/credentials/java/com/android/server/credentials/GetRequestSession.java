...
public class GetRequestSession extends RequestSession
  ...
  public /* bridge */ /* synthetic */ void addProviderSession(
      ComponentName componentName, ProviderSession providerSession) {
  ...
  public GetRequestSession(
    ...
    super(
        ...
        getRequestInfoFromRequest(getCredentialRequest),
        callingAppInfo,
        set,
        cancellationSignal,
        j);
  ...
  public ProviderSession initiateProviderSession(
    ...
    ProviderGetSession createNewSession =
        ProviderGetSession.createNewSession(
  ...
  public void onFinalResponseReceived(
    ...
    if (getCredentialResponse != null) {
      this.mRequestSessionMetric.collectChosenProviderStatus(
        ...
        .forEach(
            new Consumer() { // from class:
              ...
              public final void accept(Object obj) {
                GetRequestSession.this.lambda$handleEmptyAuthenticationSelection$1(
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$handleEmptyAuthenticationSelection$1(
  ...
  public final boolean providerDataContainsEmptyAuthEntriesOnly() {
    ...
    while (it.hasNext()) {
      if (!((ProviderGetSession) this.mProviders.get((String) it.next()))
          .containsEmptyAuthEntriesOnly()) {
        return false;
      }
    }
    return true;
