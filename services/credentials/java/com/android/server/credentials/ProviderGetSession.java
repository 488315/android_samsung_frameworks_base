...
public final class ProviderGetSession extends ProviderSession {
  ...
  public static ProviderGetSession createNewSession(
    ...
    GetCredentialRequest filterOptions =
        filterOptions(
            credentialProviderInfo.getCapabilities(),
            (GetCredentialRequest) getRequestSession.mClientRequest,
    ...
    Slog.i(
        "ProviderGetSession",
        "Unable to create provider session for: " + credentialProviderInfo.getComponentName());
    return null;
  }

  public static BeginGetCredentialRequest constructQueryPhaseRequest(
    ...
    getCredentialRequest
        ...
        .forEach(
            new Consumer() { // from class:
              // com.android.server.credentials.ProviderGetSession$$ExternalSyntheticLambda0
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                ProviderGetSession.lambda$constructQueryPhaseRequest$0(
                    builder, map, (CredentialOption) obj);
              }
            });
    if (z) {
  ...
  public static /* synthetic */ void lambda$constructQueryPhaseRequest$0(
      BeginGetCredentialRequest.Builder builder, Map map, CredentialOption credentialOption) {
  ...
  public static GetCredentialRequest filterOptions(
      List list,
      GetCredentialRequest getCredentialRequest,
      CredentialProviderInfo credentialProviderInfo) {
    Slog.i(
        "ProviderGetSession",
        "Filtering request options for: " + credentialProviderInfo.getComponentName());
    ...
    for (CredentialOption credentialOption : getCredentialRequest.getCredentialOptions()) {
      if (list.contains(credentialOption.getType())
          && isProviderAllowed(credentialOption, credentialProviderInfo)
          && checkSystemProviderRequirement(
              credentialOption, credentialProviderInfo.isSystemProvider())) {
        Slog.i(
            "ProviderGetSession",
            "Option of type: " + credentialOption.getType() + " meets all filteringconditions");
        arrayList.add(credentialOption);
      }
    }
    if (!arrayList.isEmpty()) {
      return new GetCredentialRequest.Builder(getCredentialRequest.getData())
          .setCredentialOptions(arrayList)
          .build();
    }
  ...
  public static boolean isProviderAllowed(
      CredentialOption credentialOption, CredentialProviderInfo credentialProviderInfo) {
    if (credentialProviderInfo.isSystemProvider()
        || credentialOption.getAllowedProviders().isEmpty()
        || credentialOption
            .getAllowedProviders()
            .contains(credentialProviderInfo.getComponentName())) {
      return true;
    }
    Slog.i(
        "ProviderGetSession", "Provider allow list specified but does not contain this provider");
    return false;
  }

  public static boolean checkSystemProviderRequirement(
      CredentialOption credentialOption, boolean z) {
    if (!credentialOption.isSystemProviderRequired() || z) {
      return true;
    }
    Slog.i(
        "ProviderGetSession",
        "System provider required, but this service is not a system provider");
    return false;
  }

  public ProviderGetSession(
      Context context,
      CredentialProviderInfo credentialProviderInfo,
      ProviderSession.ProviderInternalCallback providerInternalCallback,
      int i,
      RemoteCredentialService remoteCredentialService,
    ...
    this.mProviderResponseDataHandler =
        new ProviderResponseDataHandler(ComponentName.unflattenFromString(str));
  }
  ...
  public void onProviderResponseSuccess(BeginGetCredentialResponse beginGetCredentialResponse) {
    Slog.i(
        "ProviderGetSession",
        "Remote provider responded with a valid response: " + this.mComponentName);
  ...
  public void onProviderResponseFailure(int i, Exception exc) {
    if (exc instanceof GetCredentialException) {
      ...
      this.mProviderSessionMetric.collectCandidateFrameworkException(
          getCredentialException.getType());
    }
    this.mProviderSessionMetric.collectCandidateExceptionStatus(true);
    updateStatusAndInvokeCallback(
        ProviderSession.Status.CANCELED, ProviderSession.CredentialsSource.REMOTE_PROVIDER);
  }
  ...
  public void onProviderServiceDied(RemoteCredentialService remoteCredentialService) {
    if (remoteCredentialService.getComponentName().equals(this.mComponentName)) {
      updateStatusAndInvokeCallback(
          ProviderSession.Status.SERVICE_DEAD, ProviderSession.CredentialsSource.REMOTE_PROVIDER);
    } else {
      Slog.w(
          "ProviderGetSession",
          "Component names different in onProviderServiceDied - this should not happen");
    }
  }
  ...
  public void onUiEntrySelected(
      String str, String str2, ProviderPendingIntentResponse providerPendingIntentResponse) {
    Slog.i(
        "ProviderGetSession",
        "onUiEntrySelected with entryType: " + str + ", and entryKey: " + str2);
    str.hashCode();
    switch (str) {
      ...
      case "authentication_action_key":
        Action authenticationAction =
            this.mProviderResponseDataHandler.getAuthenticationAction(str2);
        ...
        if (authenticationAction == null) {
          ...
          Slog.i(
              "ProviderGetSession", "Additional content received - removing authentication entry");
          this.mProviderResponseDataHandler.removeAuthenticationAction(str2);
          if (!this.mProviderResponseDataHandler.isEmptyResponse()) {
            updateStatusAndInvokeCallback(
                ProviderSession.Status.CREDENTIALS_RECEIVED,
                ProviderSession.CredentialsSource.AUTH_ENTRY);
            break;
          }
        } else {
          ...
          updateStatusAndInvokeCallback(
              ProviderSession.Status.NO_CREDENTIALS_FROM_AUTH_ENTRY,
              ProviderSession.CredentialsSource.AUTH_ENTRY);
          break;
        }
        break;
  ...
  public void invokeSession() {
    if (this.mRemoteCredentialService != null) {
      ...
      this.mRemoteCredentialService.onBeginGetCredential(
          (BeginGetCredentialRequest) this.mProviderRequest);
    }
  }
  ...
  public GetCredentialProviderData mo4615prepareUiData() {
    ...
    return new Intent()
        .putExtra(
            ...
            new android.service.credentials.GetCredentialRequest(
                ...
                List.of((CredentialOption) this.mBeginGetOptionToCredentialOptionMap.get(str))));
  }
  ...
  public final Intent setUpFillInIntentWithQueryRequest() {
    ...
    intent.putExtra(
        ...
        (Parcelable) this.mProviderRequest);
    return intent;
  }

  public final void onRemoteEntrySelected(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    onCredentialEntrySelected(providerPendingIntentResponse);
  }

  public final void onCredentialEntrySelected(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    if (providerPendingIntentResponse == null) {
      invokeCallbackOnInternalInvalidState();
      return;
    }
    GetCredentialException maybeGetPendingIntentException =
        maybeGetPendingIntentException(providerPendingIntentResponse);
    if (maybeGetPendingIntentException != null) {
      invokeCallbackWithError(
          maybeGetPendingIntentException.getType(), maybeGetPendingIntentException.getMessage());
      return;
    }
    GetCredentialResponse extractGetCredentialResponse =
        PendingIntentResultHandler.extractGetCredentialResponse(
    ...
    if (extractGetCredentialResponse != null) {
      ...
      Slog.i(
          "ProviderGetSession",
          "Pending intent response contains no credential, or error for a credential entry");
      invokeCallbackOnInternalInvalidState();
    }
  }

  public final GetCredentialException maybeGetPendingIntentException(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    if (providerPendingIntentResponse == null) {
      return null;
    }
    if (PendingIntentResultHandler.isValidResponse(providerPendingIntentResponse)) {
      GetCredentialException extractGetCredentialException =
          PendingIntentResultHandler.extractGetCredentialException(
              providerPendingIntentResponse.getResultData());
    ...
    if (PendingIntentResultHandler.isCancelledResponse(providerPendingIntentResponse)) {
      return new GetCredentialException(
  ...
  public final boolean onAuthenticationEntrySelected(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    if (providerPendingIntentResponse == null) {
      return false;
    }
    ...
    BeginGetCredentialResponse extractResponseContent =
        PendingIntentResultHandler.extractResponseContent(
            providerPendingIntentResponse.getResultData());
    this.mProviderSessionMetric.collectCandidateEntryMetrics(extractResponseContent, true, null);
    if (extractResponseContent == null
        || this.mProviderResponseDataHandler.isEmptyResponse(extractResponseContent)) {
      return false;
    }
  ...
  public final void addToInitialRemoteResponse(
      BeginGetCredentialResponse beginGetCredentialResponse, boolean z) {
    if (beginGetCredentialResponse == null) {
      return;
    }
    this.mProviderResponseDataHandler.addResponseContent(
        beginGetCredentialResponse.getCredentialEntries(),
        beginGetCredentialResponse.getActions(),
        beginGetCredentialResponse.getAuthenticationActions(),
        beginGetCredentialResponse.getRemoteCredentialEntry(),
        z);
  }

  public final void onActionEntrySelected(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    Slog.i("ProviderGetSession", "onActionEntrySelected");
    onCredentialEntrySelected(providerPendingIntentResponse);
  }

  public final void onSetInitialRemoteResponse(
    ...
    if (this.mProviderResponseDataHandler.isEmptyResponse(beginGetCredentialResponse)) {
      this.mProviderSessionMetric.collectCandidateEntryMetrics(
          beginGetCredentialResponse, false, null);
      updateStatusAndInvokeCallback(
          ProviderSession.Status.EMPTY_RESPONSE, ProviderSession.CredentialsSource.REMOTE_PROVIDER);
    } else {
      this.mProviderSessionMetric.collectCandidateEntryMetrics(
          beginGetCredentialResponse, false, null);
      updateStatusAndInvokeCallback(
          ProviderSession.Status.CREDENTIALS_RECEIVED,
          ProviderSession.CredentialsSource.REMOTE_PROVIDER);
    }
  }

  public final void invokeCallbackOnInternalInvalidState() {
    this.mCallbacks.onFinalErrorReceived(
        this.mComponentName, "android.credentials.GetCredentialException.TYPE_NO_CREDENTIAL", null);
  }
  ...
  public boolean containsEmptyAuthEntriesOnly() {
    return this.mProviderResponseDataHandler.mUiCredentialEntries.isEmpty()
        && this.mProviderResponseDataHandler.mUiRemoteEntry == null
        && this.mProviderResponseDataHandler.mUiAuthenticationEntries.values().stream()
            .allMatch(
                new Predicate() { // from class:
                  // com.android.server.credentials.ProviderGetSession$$ExternalSyntheticLambda1
                  @Override // java.util.function.Predicate
                  public final boolean test(Object obj) {
                    boolean lambda$containsEmptyAuthEntriesOnly$1;
                    lambda$containsEmptyAuthEntriesOnly$1 =
                        ProviderGetSession.lambda$containsEmptyAuthEntriesOnly$1((Pair) obj);
  ...
  public static /* synthetic */ boolean lambda$containsEmptyAuthEntriesOnly$1(Pair pair) {
    return ((AuthenticationEntry) pair.second).getStatus() == 1
  ...
  public class ProviderResponseDataHandler {
    ...
    public void addResponseContent(
        List list, List list2, List list3, RemoteEntry remoteEntry, boolean z) {
      list.forEach(
          new Consumer() { // from class:
            // com.android.server.credentials.ProviderGetSession$ProviderResponseDataHandler$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ProviderGetSession.ProviderResponseDataHandler.this.addCredentialEntry(
                  (CredentialEntry) obj);
            }
          });
      list2.forEach(
          new Consumer() { // from class:
            // com.android.server.credentials.ProviderGetSession$ProviderResponseDataHandler$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
      ...
      list3.forEach(
          new Consumer() { // from class:
            // com.android.server.credentials.ProviderGetSession$ProviderResponseDataHandler$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ProviderGetSession.ProviderResponseDataHandler.this.lambda$addResponseContent$0(
                  (Action) obj);
            }
          });
      ...
      this.mUiCredentialEntries.put(
          ...
          new Pair(
              ...
              new Entry(
                  ...
                  ProviderGetSession.this.setUpFillInIntentWithFinalRequest(
      ...
      this.mUiActionsEntries.put(
          ...
          new Pair(
              ...
              new Entry(
                  ...
                  generateUniqueId,
                  action.getSlice(),
                  ProviderGetSession.this.setUpFillInIntentWithQueryRequest())));
    }

    public void addAuthenticationAction(Action action, int i) {
      String generateUniqueId = ProviderSession.generateUniqueId();
      this.mUiAuthenticationEntries.put(
          generateUniqueId,
          new Pair(
              action,
    ...
    public void setRemoteEntry(RemoteEntry remoteEntry) {
      if (!ProviderGetSession.this.enforceRemoteEntryRestrictions(
          this.mExpectedRemoteEntryProviderService)) {
        Slog.w(
            "ProviderGetSession",
            ...
            new Pair(
                ...
                new Pair(
                    ...
                    new Entry(
                        "remote_entry_key",
                        generateUniqueId,
                        remoteEntry.getSlice(),
                        ProviderGetSession.this.setUpFillInIntentForRemoteEntry())));
      }
    }

    public GetCredentialProviderData toGetCredentialProviderData() {
      return new GetCredentialProviderData.Builder(
              ProviderGetSession.this.mComponentName.flattenToString())
          .setActionChips(prepareActionEntries())
    ...
    public final List prepareAuthenticationEntries() {
      ...
      while (it.hasNext()) {
        arrayList.add(
            (AuthenticationEntry)
                ((Pair) this.mUiAuthenticationEntries.get((String) it.next())).second);
      }
      return arrayList;
    }
    ...
    public final boolean isEmptyResponse() {
      return this.mUiCredentialEntries.isEmpty()
          && this.mUiActionsEntries.isEmpty()
          && this.mUiAuthenticationEntries.isEmpty()
          && this.mUiRemoteEntry == null;
    }

    public final boolean isEmptyResponse(BeginGetCredentialResponse beginGetCredentialResponse) {
      return beginGetCredentialResponse.getCredentialEntries().isEmpty()
          && beginGetCredentialResponse.getActions().isEmpty()
          && beginGetCredentialResponse.getAuthenticationActions().isEmpty()
          && beginGetCredentialResponse.getRemoteCredentialEntry() == null;
    }
    ...
    public RemoteEntry getRemoteEntry(String str) {
      Object obj;
      if (!((String) this.mUiRemoteEntry.first).equals(str)
          || (obj = this.mUiRemoteEntry.second) == null) {
        return null;
      }
    ...
    public final void updateMostRecentAuthEntry(String str) {
      AuthenticationEntry authenticationEntry =
          (AuthenticationEntry) ((Pair) this.mUiAuthenticationEntries.get(str)).second;
      this.mUiAuthenticationEntries.put(
          str,
          new Pair(
              (Action) ((Pair) this.mUiAuthenticationEntries.get(str)).first,
              copyAuthEntryAndChangeStatus(authenticationEntry, 2)));
    }

    public final void updatePreviousMostRecentAuthEntry() {
      Optional findFirst =
          this.mUiAuthenticationEntries.entrySet().stream()
              .filter(
                  new Predicate() { // from class:
                    // com.android.server.credentials.ProviderGetSession$ProviderResponseDataHandler$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                      boolean lambda$updatePreviousMostRecentAuthEntry$1;
                      lambda$updatePreviousMostRecentAuthEntry$1 =
                          ProviderGetSession.ProviderResponseDataHandler
                              .lambda$updatePreviousMostRecentAuthEntry$1((Map.Entry) obj);
      ...
      this.mUiAuthenticationEntries.put(
          str,
          new Pair(
              (Action) ((Pair) ((Map.Entry) findFirst.get()).getValue()).first,
              copyAuthEntryAndChangeStatus(
                  (AuthenticationEntry) ((Pair) ((Map.Entry) findFirst.get()).getValue()).second,
                  1)));
    }

    public static /* synthetic */ boolean lambda$updatePreviousMostRecentAuthEntry$1(
        Map.Entry entry) {
      return ((AuthenticationEntry) ((Pair) entry.getValue()).second).getStatus() == 2;
    }

    public final AuthenticationEntry copyAuthEntryAndChangeStatus(
        AuthenticationEntry authenticationEntry, Integer num) {
      return new AuthenticationEntry(
          "authentication_action_key",
          authenticationEntry.getSubkey(),
          authenticationEntry.getSlice(),
          num.intValue(),
          authenticationEntry.getFrameworkExtrasIntent());
    }
  }
  ...
  public final Intent setUpFillInIntentForRemoteEntry() {
    return new Intent()
        .putExtra(
            "android.service.credentials.extra.GET_CREDENTIAL_REQUEST",
            new android.service.credentials.GetCredentialRequest(
                this.mCallingAppInfo, this.mCompleteRequest.getCredentialOptions()));
  }
}
