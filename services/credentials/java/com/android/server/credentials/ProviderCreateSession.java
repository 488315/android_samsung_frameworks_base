...
public final class ProviderCreateSession extends ProviderSession {
  ...
  public static ProviderCreateSession createNewSession(
    ...
    CreateCredentialRequest createProviderRequest =
        createProviderRequest(
            credentialProviderInfo.getCapabilities(),
            (android.credentials.CreateCredentialRequest) createRequestSession.mClientRequest,
            createRequestSession.mClientAppInfo,
            credentialProviderInfo.isSystemProvider());
  ...
  public static BeginCreateCredentialRequest constructQueryPhaseRequest(
      String str, Bundle bundle, CallingAppInfo callingAppInfo, boolean z) {
    if (z) {
  ...
  public static CreateCredentialRequest createProviderRequest(
      List list,
      android.credentials.CreateCredentialRequest createCredentialRequest,
    ...
    if (list.contains(type)) {
      return new CreateCredentialRequest(
          callingAppInfo, type, createCredentialRequest.getCredentialData());
    }
    return null;
  }

  public ProviderCreateSession(
      Context context,
      CredentialProviderInfo credentialProviderInfo,
  ...
  public void onProviderResponseFailure(int i, Exception exc) {
    if (exc instanceof CreateCredentialException) {
      ...
      this.mProviderSessionMetric.collectCandidateFrameworkException(
          createCredentialException.getType());
    }
  ...
  public final void onSetInitialRemoteResponse(
    ...
    this.mProviderResponseDataHandler.addResponseContent(
        beginCreateCredentialResponse.getCreateEntries(),
        beginCreateCredentialResponse.getRemoteCreateEntry());
    if (this.mProviderResponseDataHandler.isEmptyResponse(beginCreateCredentialResponse)) {
      this.mProviderSessionMetric.collectCandidateEntryMetrics(
          ...
          false,
          ((RequestSession) this.mCallbacks).mRequestSessionMetric.getInitialPhaseMetric());
      updateStatusAndInvokeCallback(
      ...
      this.mProviderSessionMetric.collectCandidateEntryMetrics(
          ...
          ((RequestSession) this.mCallbacks).mRequestSessionMetric.getInitialPhaseMetric());
      updateStatusAndInvokeCallback(
          ProviderSession.Status.SAVE_ENTRIES_RECEIVED,
  ...
  public CreateCredentialProviderData mo4615prepareUiData() {
    if (!ProviderSession.isUiInvokingStatus(getStatus())) {
      Slog.i(
          "ProviderCreateSession", "No data for UI from: " + this.mComponentName.flattenToString());
      return null;
    }
  ...
  public void invokeSession() {
    if (this.mRemoteCredentialService != null) {
      ...
      this.mRemoteCredentialService.onBeginCreateCredential(
          (BeginCreateCredentialRequest) this.mProviderRequest);
    }
  }
  ...
  public final Intent setUpFillInIntent() {
    ...
    intent.putExtra(
        "android.service.credentials.extra.CREATE_CREDENTIAL_REQUEST", this.mCompleteRequest);
    return intent;
  }

  public final void onCreateEntrySelected(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    CreateCredentialException maybeGetPendingIntentException =
    ...
    CreateCredentialResponse extractCreateCredentialResponse =
    ...
    if (extractCreateCredentialResponse != null) {
      ...
      Slog.i(
          "ProviderCreateSession",
          "onSaveEntrySelected - no response or error found in pending intent response");
      invokeCallbackOnInternalInvalidState();
    }
  }
  ...
  public final CreateCredentialException maybeGetPendingIntentException(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    if (providerPendingIntentResponse == null) {
      Slog.i("ProviderCreateSession", "pendingIntentResponse is null");
      return new CreateCredentialException(
    ...
    if (PendingIntentResultHandler.isValidResponse(providerPendingIntentResponse)) {
      CreateCredentialException extractCreateCredentialException =
          PendingIntentResultHandler.extractCreateCredentialException(
              providerPendingIntentResponse.getResultData());
  ...
  public final void invokeCallbackOnInternalInvalidState() {
    this.mCallbacks.onFinalErrorReceived(
        this.mComponentName, "android.credentials.CreateCredentialException.TYPE_UNKNOWN", null);
  }
  ...
  public class ProviderResponseDataHandler {
    ...
    public void addResponseContent(List list, RemoteEntry remoteEntry) {
      list.forEach(
          new Consumer() { // from class:
            // com.android.server.credentials.ProviderCreateSession$ProviderResponseDataHandler$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ProviderCreateSession.ProviderResponseDataHandler.this.addCreateEntry(
                  (CreateEntry) obj);
            }
          });
      if (remoteEntry != null) {
      ...
      this.mUiCreateEntries.put(
          ...
          new Pair(
              ...
              new Entry(
                  "save_entry_key",
                  generateUniqueId,
                  createEntry.getSlice(),
                  ProviderCreateSession.this.setUpFillInIntent())));
    }

    public void setRemoteEntry(RemoteEntry remoteEntry) {
      if (!ProviderCreateSession.this.enforceRemoteEntryRestrictions(
          this.mExpectedRemoteEntryProviderService)) {
        Slog.w(
            "ProviderCreateSession",
            "Remote entry being dropped as it does not meet the restrictionchecks.");
    ...
    public CreateCredentialProviderData toCreateCredentialProviderData() {
      return new CreateCredentialProviderData.Builder(
              ProviderCreateSession.this.mComponentName.flattenToString())
    ...
    public RemoteEntry getRemoteEntry(String str) {
      ...
      if (pair == null
          || (obj = pair.first) == null
          || !((String) obj).equals(str)
          || (obj2 = this.mUiRemoteEntry.second) == null) {
        return null;
      }
    ...
    public boolean isEmptyResponse(BeginCreateCredentialResponse beginCreateCredentialResponse) {
      return (beginCreateCredentialResponse.getCreateEntries() == null
              || beginCreateCredentialResponse.getCreateEntries().isEmpty())
          && beginCreateCredentialResponse.getRemoteCreateEntry() == null;
    }
  }
}
