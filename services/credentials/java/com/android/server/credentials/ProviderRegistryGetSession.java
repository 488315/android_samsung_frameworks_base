...
public class ProviderRegistryGetSession extends ProviderSession {
  ...
  public static ProviderRegistryGetSession createNewSession(
    ...
    return new ProviderRegistryGetSession(
        context, i, getRequestSession, callingAppInfo, str, credentialOption);
  }

  public ProviderRegistryGetSession(
      Context context,
      int i,
      GetRequestSession getRequestSession,
      CallingAppInfo callingAppInfo,
    ...
    super(
        ...
        credentialOption,
        getRequestSession,
        new ComponentName(str, UUID.randomUUID().toString()),
        i,
        null);
  ...
  public final Intent setUpFillInIntent() {
    ...
    intent.putExtra(
        ...
        new GetCredentialRequest(
            this.mCallingAppInfo, List.of((CredentialOption) this.mProviderRequest)));
    return intent;
  }

  @Override // com.android.server.credentials.ProviderSession
  /* renamed from: prepareUiData */
  public ProviderData mo4615prepareUiData() {
    if (!ProviderSession.isUiInvokingStatus(getStatus())) {
      Slog.i(
          "ProviderRegistryGetSession",
          "No date for UI coming from: " + this.mComponentName.flattenToString());
      return null;
    }
    if (this.mProviderResponse == null) {
      Slog.w(
          "ProviderRegistryGetSession",
          "response is null when preparing ui data. This is strange.");
      return null;
    }
    GetCredentialProviderData.Builder builder =
        new GetCredentialProviderData.Builder(this.mComponentName.flattenToString());
    List list = Collections.EMPTY_LIST;
    return builder
        .setActionChips(list)
        .setAuthenticationEntries(list)
        .setCredentialEntries(
            prepareUiCredentialEntries(
                (List)
                    ((Set) this.mProviderResponse)
                        .stream()
                            .flatMap(
                                new Function() { // from class:
                                  // com.android.server.credentials.ProviderRegistryGetSession$$ExternalSyntheticLambda0
                                  @Override // java.util.function.Function
                                  public final Object apply(Object obj) {
                                    Stream lambda$prepareUiData$0;
                                    lambda$prepareUiData$0 =
                                        ProviderRegistryGetSession.lambda$prepareUiData$0(
  ...
  public static /* synthetic */ Stream lambda$prepareUiData$0(
  ...
  public final void onCredentialEntrySelected(
    ...
    if (providerPendingIntentResponse != null) {
      ...
      if (extractGetCredentialResponse != null) {
        ...
        if (providerInternalCallback != null) {
          ((GetRequestSession) providerInternalCallback)
              .onFinalResponseReceived(this.mComponentName, extractGetCredentialResponse);
          return;
        }
        return;
      }
    ...
    Slog.w(
        "ProviderRegistryGetSession",
        "CredentialEntry does not have a credential or a pending intent result");
  }

  @Override // com.android.server.credentials.ProviderSession
  public void invokeSession() {
    startCandidateMetrics();
    Set filteredResultForProvider =
        this.mCredentialDescriptionRegistry.getFilteredResultForProvider(
            this.mCredentialProviderPackageName, this.mElementKeys);
    this.mProviderResponse = filteredResultForProvider;
    this.mCredentialEntries =
        (List)
            filteredResultForProvider.stream()
                .flatMap(
                    new Function() { // from class:
                      // com.android.server.credentials.ProviderRegistryGetSession$$ExternalSyntheticLambda1
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        Stream lambda$invokeSession$1;
                        lambda$invokeSession$1 =
                            ProviderRegistryGetSession.lambda$invokeSession$1(
                                (CredentialDescriptionRegistry.FilterResult) obj);
    ...
    updateStatusAndInvokeCallback(
        ProviderSession.Status.CREDENTIALS_RECEIVED, ProviderSession.CredentialsSource.REGISTRY);
    this.mProviderSessionMetric.collectCandidateEntryMetrics(this.mCredentialEntries);
  }

  public static /* synthetic */ Stream lambda$invokeSession$1(
      CredentialDescriptionRegistry.FilterResult filterResult) {
    return filterResult.mCredentialEntries.stream();
  }

  public GetCredentialException maybeGetPendingIntentException(
      ProviderPendingIntentResponse providerPendingIntentResponse) {
    if (providerPendingIntentResponse == null) {
      return null;
    }
