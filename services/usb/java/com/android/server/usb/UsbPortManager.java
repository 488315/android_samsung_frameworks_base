    ...
    public final void updateContaminantNotification() {
        ...
        if (i3 != 3 || (i2 = this.mIsPortContaminatedNotificationId) == 52) {
            ...
            if (i3 == 2) {
                ...
                this.mNotificationManager.notifyAsUser(null, this.mIsPortContaminatedNotificationId, new Notification.Builder(this.mContext, str).setSmallIcon(R.drawable.ic_sysbar_quicksettings).setTicker(text).setColor(this.mContext.getColor(R.color.system_notification_accent_color)).setContentTitle(text).setContentText(text2).setVisibility(1).setStyle(new Notification.BigTextStyle().bigText(text2)).build(), UserHandle.ALL);
                return;
            }
            return;
        }
        ...
        intent.setComponent(ComponentName.unflattenFromString(resources.getString(R.string.ext_media_status_unsupported)));
