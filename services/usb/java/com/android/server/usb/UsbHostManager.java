...
public class UsbHostManager {
    ...
    public UsbHostManager(Context context, UsbAlsaManager usbAlsaManager, UsbPermissionManager usbPermissionManager) {
        UEventObserver uEventObserver = new UEventObserver() { // from class: com.android.server.usb.UsbHostManager.1
        ...
        UEventObserver uEventObserver2 = new UEventObserver() { // from class: com.android.server.usb.UsbHostManager.2
            public void onUEvent(UEventObserver.UEvent uEvent) {
