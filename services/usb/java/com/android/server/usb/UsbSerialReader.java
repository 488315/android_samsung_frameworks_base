    ...
    if (callingUid != 1000) {
      ...
      try {
        try {
          if (this.mContext
                      .getPackageManager()
                      .getPackageInfoAsUser(str, 0, callingUserHandle.getIdentifier())
                      .applicationInfo
                      .targetSdkVersion
                  >= 29
            ...
            if (this.mDevice instanceof UsbDevice) {
              this.mPermissionManager
                  ...
                  .checkPermission((UsbDevice) this.mDevice, str, callingPid, callingUid);
            } else {
              this.mPermissionManager
                  .getPermissionsForUser(userId)
                  .checkPermission((UsbAccessory) this.mDevice, callingPid, callingUid);
            }
          }
