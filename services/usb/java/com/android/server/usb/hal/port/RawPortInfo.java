...
public final class RawPortInfo implements Parcelable {
  public static final Parcelable.Creator CREATOR =
      new Parcelable.Creator() { // from class: com.android.server.usb.hal.port.RawPortInfo.1
        ...
        public RawPortInfo createFromParcel(Parcel parcel) {
          ...
          return new RawPortInfo(
              ...
              readInt11,
              (readInt11 & 1) != 0
                  ? (DisplayPortAltModeInfo) DisplayPortAltModeInfo.CREATOR.createFromParcel(parcel)
                  : null);
        }
