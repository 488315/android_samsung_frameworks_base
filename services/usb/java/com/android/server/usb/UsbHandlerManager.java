...
public class UsbHandlerManager {
  ...
  public void showUsbAccessoryUriActivity(UsbAccessory usbAccessory, UserHandle userHandle) {
    ...
    createDialogIntent.setComponent(
        ComponentName.unflattenFromString(
            this.mContext.getResources().getString(R.string.ext_media_status_unmountable)));
  ...
  public void confirmUsbHandler(
      ResolveInfo resolveInfo, UsbDevice usbDevice, UsbAccessory usbAccessory) {
    Intent createDialogIntent = createDialogIntent();
    createDialogIntent.setComponent(
        ComponentName.unflattenFromString(
            this.mContext.getResources().getString(R.string.ext_media_status_unmounted)));
  ...
  public void selectUsbHandler(ArrayList arrayList, UserHandle userHandle, Intent intent) {
    ...
    createDialogIntent.setComponent(
        ComponentName.unflattenFromString(
            this.mContext
                .getResources()
                .getString(R.string.ext_media_unmountable_notification_message)));
