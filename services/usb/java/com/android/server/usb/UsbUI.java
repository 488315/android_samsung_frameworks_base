...
public class UsbUI implements ActivityTaskManagerInternal.ScreenObserver {
  ...
  public boolean isSupportWirelessCharging =
  ...
  public UsbUI(Context context, Looper looper) {
    ...
    BroadcastReceiver broadcastReceiver =
        new BroadcastReceiver() { // from class: com.android.server.usb.UsbUI.1
    ...
    BroadcastReceiver broadcastReceiver2 =
        new BroadcastReceiver() { // from class: com.android.server.usb.UsbUI.2
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            String string;
            Slog.d("UsbUI", "mUsbWetStateReceiver (" + intent + ")");
            UsbUI.this.mContext.sendBroadcastAsUser(
                new Intent("android.intent.action.CLOSE_SYSTEM_DIALOGS"), UserHandle.ALL);
            String string2 = UsbUI.this.mContext.getString(17043188);
            String string3 = UsbUI.this.mContext.getString(17043196);
            if (UsbUI.this.isSupportWirelessCharging) {
              string = UsbUI.this.mContext.getString(17043197);
            } else {
              string = UsbUI.this.mContext.getString(17043195);
            }
            String replace = string.replace("\\n", KnoxVpnFirewallHelper.DELIMITER_IP_RESTORE);
            AlertDialog.Builder builder =
                new AlertDialog.Builder(
                    UsbUI.this.mContext,
                    (UsbUI.this.mContext.getResources().getConfiguration().uiMode & 48) == 32
                        ? 4
                        : 5);
            ...
            builder.setPositiveButton(
                string3,
                new DialogInterface
                    .OnClickListener() { // from class: com.android.server.usb.UsbUI.2.1
    ...
    BroadcastReceiver broadcastReceiver3 =
        new BroadcastReceiver() { // from class: com.android.server.usb.UsbUI.3
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
    ...
    BroadcastReceiver broadcastReceiver4 =
        new BroadcastReceiver() { // from class: com.android.server.usb.UsbUI.4
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            ...
            if (z != UsbUI.this.mIsHiccupState) {
              Slog.d(
                  "UsbUI", "oldHiccupState=" + z + " mIsHiccupState=" + UsbUI.this.mIsHiccupState);
              UsbUI usbUI = UsbUI.this;
    ...
    BroadcastReceiver broadcastReceiver5 =
        new BroadcastReceiver() { // from class: com.android.server.usb.UsbUI.5
          @Override // android.content.BroadcastReceiver
          public void onReceive(Context context2, Intent intent) {
            ...
            if (intExtra == 3) {
              ...
              if (UsbUI.this.mSourcePower
                  || (!UsbUI.this.mSupportDualRole && UsbUI.this.mIsHostConnected)) {
    ...
    UEventObserver uEventObserver =
        new UEventObserver() { // from class: com.android.server.usb.UsbUI.6
          public void onUEvent(UEventObserver.UEvent uEvent) {
            ...
            if (str2.equals("OVERCURRENT")) {
              UsbUI.this.postNotification(112, 17043126, 17043125, 17304254, 0L);
            } else if (str2.equals("UNKNOWN")) {
              UsbUI.this.postNotification(113, 17043122, 0, 17304255, 0L);
            }
    ...
    UEventObserver uEventObserver2 =
        new UEventObserver() { // from class: com.android.server.usb.UsbUI.7
          public void onUEvent(UEventObserver.UEvent uEvent) {
            ...
            if ("unsupport_accessory".equals(str3)) {
              UsbUI.this.postNotification(114, 17043177, 17043176, 1L);
              return;
            }
            if ("no_response".equals(str3)) {
              UsbUI.this.postNotification(115, 17043147, 17043146, 1L);
              return;
            }
            if ("hub_depth_exceed".equals(str3)) {
              UsbUI.this.postNotification(116, 17043130, 17043129, 1L);
              return;
            }
            if ("hub_power_exceed".equals(str3)) {
              UsbUI.this.postNotification(117, 17043147, 17043131, 1L);
              return;
            }
            if ("host_resource_exceed".equals(str3)) {
              UsbUI.this.postNotification(118, 17043128, 17043127, 1L);
              return;
            }
            try {
              ...
              if (str4 != null && str5 != null && str6 != null) {
                UsbUI.this.notifyUsbInterface(
                    str, Integer.parseInt(str4), Integer.parseInt(str5), Integer.parseInt(str6));
              }
    ...
    UEventObserver uEventObserver3 =
        new UEventObserver() { // from class: com.android.server.usb.UsbUI.8
          public void onUEvent(UEventObserver.UEvent uEvent) {
            ...
            if ("usbrestrict".equals(str)) {
              ...
              switch (str4) {
                case "securerelease":
                  if ("ADD".equals(str2)) {
                    Slog.d("UsbUI", "onUEvent(USB Control): Cancel USB BLK Notification");
                    UsbUI.this.notifyUsbRestrict(false);
                    UsbUI.this.sendingUsbRestrictionStateIntent("OFF");
                    break;
                  }
                  break;
                case "securerestrict":
                  if ("ADD".equals(str2)) {
                    ...
                    UsbUI.this.makeLongToast(17043174);
                    break;
                  }
                  break;
                case "timesecurerestrict":
                  if ("ADD".equals(str2)) {
                    Slog.d("UsbUI", "onUEvent(USB Control): Show USB BLK Notification");
                    UsbUI.this.notifyUsbRestrict(true);
                    UsbUI.this.sendingUsbRestrictionStateIntent("ON");
                    break;
                  }
                  break;
              }
    ...
    UEventObserver uEventObserver4 =
        new UEventObserver() { // from class: com.android.server.usb.UsbUI.9
          public void onUEvent(UEventObserver.UEvent uEvent) {
            ...
            if ("115".equals(str)) {
              UsbUI.this.makeLongToast(17043180);
              UsbUI.this.postNotification(108, 17043181, 17043180, 14L);
    ...
    context.registerReceiver(
        broadcastReceiver, new IntentFilter("android.intent.action.LOCALE_CHANGED"));
    context.registerReceiver(
        broadcastReceiver2, new IntentFilter("com.samsung.intent.action.USB_WET_STATE"));
    context.registerReceiver(
        broadcastReceiver3, new IntentFilter("android.hardware.usb.action.USB_PORT_CHANGED"));
    context.registerReceiver(
        broadcastReceiver4,
        new IntentFilter("com.samsung.server.BatteryService.action.SEC_BATTERY_EVENT"));
    context.registerReceiver(
        broadcastReceiver5, new IntentFilter("com.samsung.intent.action.EMERGENCY_STATE_CHANGED"));
  }
  ...
  public void systemReady() {
    ...
    this.mIsEmergencyMode =
        Settings.System.getIntForUser(this.mContentResolver, "emergency_mode", 0, -2) != 0;
  }

  public void bootCompleted() {
    Slog.d("UsbUI", "boot completed");
    this.mBootCompleted = true;
    if (!"".equals(this.mUsbBlkPendingIntent)) {
      sendingUsbRestrictionStateIntent(this.mUsbBlkPendingIntent);
    }
    for (UsbDevice usbDevice :
        ((UsbManager) this.mContext.getSystemService("usb")).getDeviceList().values()) {
  ...
  public final void notifyUsbWetDetection(boolean z) {
    if (z) {
      String string = this.mContext.getString(17043200);
      PendingIntent broadcastAsUser =
          PendingIntent.getBroadcastAsUser(
              this.mContext,
              0,
              new Intent("com.samsung.intent.action.USB_WET_STATE"),
              67108864,
              UserHandle.ALL);
      turnOnDisplay();
      postNotification(
          ...
          17043198,
          17304211,
          new Notification.Action(0, string, broadcastAsUser),
          14L);
  ...
  public final void loggingUsbWetDetection(String str) {
    ...
    synchronized (this.mLoggingLock) {
      ...
      try {
        fileWriter.write(String.format("%s %s%n", format, str));
        try {
          fileWriter.close();
  ...
  public final void notifyIncreaseBatteryUsage(boolean z) {
    if (z) {
      makeShortToast(17043132);
      postNotification(107, 0, 17043132, 138L);
    } else {
  ...
  public final void notifyUsbRestrict(boolean z) {
    if (z) {
      ...
      postNotification(125, 17043175, 0, 17304252, 138L);
    } else {
  ...
  public final void postNotification(int i, int i2, int i3, long j) {
    postNotificationInternal(i, i2, i3, 17304253, null, null, j);
  }

  public final void postNotification(int i, int i2, int i3, int i4, long j) {
    postNotificationInternal(i, i2, i3, i4, null, null, j);
  }

  public final void postNotification(
      int i, int i2, int i3, int i4, Notification.Action action, long j) {
    postNotificationInternal(i, i2, i3, i4, null, action, j);
  }
  ...
  public final void postNotificationInternal(
      int i,
      int i2,
      int i3,
      int i4,
    ...
    NotificationWrapper notificationWrapper =
        new NotificationWrapper(i2, i3, i4, pendingIntent, action, j);
    if (this.mSystemReady && this.mNotificationManager != null) {
      if (notificationWrapper.instant || notificationWrapper.ongoing) {
        ...
        this.mNotificationManager.notifyAsUser(
            null, i, notificationWrapper.build(), UserHandle.ALL);
        return;
      }
    }
  ...
  public final class UsbUIHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      if (i == 0) {
        Toast.makeText(
                UsbUI.this.mContext, UsbUI.this.mContext.getResources().getString(message.arg1), 0)
            .show();
        return;
      }
      if (i == 1) {
        Toast.makeText(
                UsbUI.this.mContext, UsbUI.this.mContext.getResources().getString(message.arg1), 1)
            .show();
        return;
      }
      if (i == 2) {
  ...
  public final class NotificationWrapper {
    ...
    public final PendingIntent contentInent;
    ...
    public NotificationWrapper(
        int i, int i2, int i3, PendingIntent pendingIntent, Notification.Action action, long j) {
      this.title = i != 0 ? UsbUI.this.mContext.getString(i) : null;
      this.message = i2 != 0 ? UsbUI.this.mContext.getString(i2) : null;
      this.icon = i3;
      this.action = action;
      this.contentInent = pendingIntent;
      parseOptions(j);
    }
    ...
    public final void parseOptions(long j) {
      ...
      if (UsbUI.isIncludeOption(j, 256L)) {
        ...
        NotificationChannel notificationChannel =
            new NotificationChannel(this.channel, "USBImportanceLow", 2);
        notificationChannel.setDescription("USB connector connection");
        ((NotificationManager) UsbUI.this.mContext.getSystemService(NotificationManager.class))
    ...
    public final Notification.Builder buildNotificationBuilder() {
      Notification.Builder visibility =
          new Notification.Builder(UsbUI.this.mContext, this.channel)
              .setSmallIcon(this.icon)
              .setPriority(this.priority)
              .setColor(UsbUI.this.mContext.getColor(R.color.system_notification_accent_color))
              .setStyle(new Notification.BigTextStyle().bigText(this.message))
              .setShowWhen(false)
              .setDefaults(0)
              .setVisibility(1);
