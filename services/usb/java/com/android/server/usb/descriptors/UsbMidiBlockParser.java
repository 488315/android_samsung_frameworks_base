  ...
  public class GroupTerminalBlock {
    ...
    public void dump(DualDumpOutputStream dualDumpOutputStream, String str, long j) {
      ...
      dualDumpOutputStream.write(
          "group_terminal_block_type", 1120986464261L, this.mGroupTerminalBlockType);
  ...
  public int calculateMidiType(UsbDeviceConnection usbDeviceConnection, int i, int i2) {
    ...
    try {
      ...
      if (controlTransfer <= 0) {
        ...
        int i4 =
            (bArr[3] & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT)
                + ((bArr[4] & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT) << 8);
        if (i4 <= 0) {
        ...
        if (controlTransfer2 > 0) {
          ...
          Log.d(
              "UsbMidiBlockParser",
              "MIDI protocol: "
                  + ((GroupTerminalBlock) this.mGroupTerminalBlocks.get(0)).mMidiProtocol);
