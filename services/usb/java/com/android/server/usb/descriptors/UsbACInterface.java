...
public abstract class UsbACInterface extends UsbDescriptor {
  ...
  public static UsbDescriptor allocAudioControlDescriptor(
    ...
    switch (b2) {
      ...
      default:
        Log.w(
            "UsbACInterface", "Unknown Audio Class Interface subtype:0x" + Integer.toHexString(b2));
        return new UsbACInterfaceUnparsed(i, b, b2, i2);
    }
  }

  public static UsbDescriptor allocAudioStreamingDescriptor(
      UsbDescriptorParser usbDescriptorParser,
      ByteStream byteStream,
      int i,
      byte b,
    ...
    Log.w(
        "UsbACInterface", "Unknown Audio Streaming Interface subtype:0x" + Integer.toHexString(b2));
    return null;
  }
  ...
  public static UsbDescriptor allocMidiStreamingDescriptor(int i, byte b, byte b2, int i2) {
    ...
    Log.w(
        "UsbACInterface", "Unknown MIDI Streaming Interface subtype:0x" + Integer.toHexString(b2));
    return null;
  }

  public static UsbDescriptor allocDescriptor(
      UsbDescriptorParser usbDescriptorParser, ByteStream byteStream, int i, byte b) {
    ...
    Log.w(
        "UsbACInterface",
        "Unknown Audio Class Interface Subclass: 0x" + Integer.toHexString(usbSubclass));
    return null;
  }
  ...
  public void report(ReportCanvas reportCanvas) {
    ...
    reportCanvas.writeListItem(
        "Subclass: " + ReportCanvas.getHexString(subclass) + " " + aCInterfaceSubclassName);
    reportCanvas.writeListItem(
        "Subtype: " + ReportCanvas.getHexString(subtype) + " " + aCControlInterfaceName);
