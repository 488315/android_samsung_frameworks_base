...
public abstract class UsbStrings {
  ...
  public static void initTerminalNames() {
    ...
    sTerminalNames.put(
        ...
        "Desktop Microphone");
    sTerminalNames.put(
        Integer.valueOf(FrameworkStatsLog.AMBIENT_MODE_CHANGED), "Personal (headset) Microphone");
    ...
    sTerminalNames.put(
        Integer.valueOf(FrameworkStatsLog.APP_STANDBY_BUCKET_CHANGED__MAIN_REASON__MAIN_USAGE),
        "Undefined");
  ...
  public static String getAudioSubclassName(int i) {
    ...
    return "Unknown Audio Subclass [0x"
        + Integer.toHexString(i2)
        + XmlUtils.STRING_ARRAY_SEPARATOR
        + i2
        + "]";
  ...
  public static String getAudioFormatName(int i) {
    ...
    return "Unknown Format (encoding) ID [0x"
        + Integer.toHexString(i)
        + XmlUtils.STRING_ARRAY_SEPARATOR
        + i
        + "]";
