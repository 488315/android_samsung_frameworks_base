...
public final class UsbDescriptorsTree {
  ...
  public final void addConfigDescriptor(UsbConfigDescriptor usbConfigDescriptor) {
    UsbDescriptorsConfigNode usbDescriptorsConfigNode =
        new UsbDescriptorsConfigNode(usbConfigDescriptor);
  ...
  public final void addInterfaceDescriptor(UsbInterfaceDescriptor usbInterfaceDescriptor) {
    UsbDescriptorsInterfaceNode usbDescriptorsInterfaceNode =
        new UsbDescriptorsInterfaceNode(usbInterfaceDescriptor);
