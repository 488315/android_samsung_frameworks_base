...
public final class UsbAlsaMidiDevice implements Closeable {
  ...
  public final MidiDeviceServer.Callback mCallback =
      new MidiDeviceServer.Callback() { // from class: com.android.server.usb.UsbAlsaMidiDevice.1
        public void onClose() {}
  ...
  public final boolean openLocked() {
    ...
    if (i > 0) {
      new Thread("UsbAlsaMidiDevice input thread") { // from class:
        // com.android.server.usb.UsbAlsaMidiDevice.2
    ...
    for (int i5 = 0; i5 < i2; i5++) {
      ...
      final int i6 = i5;
      new Thread(
          "UsbAlsaMidiDevice output thread "
              + i5) { // from class: com.android.server.usb.UsbAlsaMidiDevice.3
        @Override // java.lang.Thread, java.lang.Runnable
        public void run() {
