...
public final class UsbDirectMidiDevice implements Closeable {
  ...
  public final MidiDeviceServer.Callback mCallback =
      new MidiDeviceServer.Callback() { // from class: com.android.server.usb.UsbDirectMidiDevice.1
        public void onClose() {}
          ...
          synchronized (UsbDirectMidiDevice.this.mLock) {
            Log.d(
                ...
                "numOpenPorts: "
                    + i
                    + " isOpen: "
                    + UsbDirectMidiDevice.this.mIsOpen
                    + " mServerAvailable: "
                    + UsbDirectMidiDevice.this.mServerAvailable);
            if (i > 0
                && !UsbDirectMidiDevice.this.mIsOpen
                && UsbDirectMidiDevice.this.mServerAvailable) {
  ...
  public UsbDirectMidiDevice(
      UsbDevice usbDevice, UsbDescriptorParser usbDescriptorParser, boolean z, String str) {
    ...
    if (z) {
      findLegacyMidiInterfaceDescriptors =
          usbDescriptorParser.findUniversalMidiInterfaceDescriptors();
    } else {
    ...
    if (this.mUsbDevice.getConfigurationCount() > 0) {
      ...
      if (this.mUsbDevice.getConfigurationCount() > 1) {
        Log.w(
            "UsbDirectMidiDevice",
            "Skipping some USB configurations. Count: " + this.mUsbDevice.getConfigurationCount());
      }
    }
    int i2 = 0;
    int i3 = 0;
    for (int i4 = 0; i4 < this.mUsbInterfaces.size(); i4++) {
      UsbInterfaceDescriptor usbInterfaceDescriptor2 =
          (UsbInterfaceDescriptor) this.mUsbInterfaces.get(i4);
      for (int i5 = 0; i5 < usbInterfaceDescriptor2.getNumEndpoints(); i5++) {
        UsbEndpointDescriptor endpointDescriptor =
            usbInterfaceDescriptor2.getEndpointDescriptor(i5);
    ...
    Log.d(
        "UsbDirectMidiDevice",
        "Created UsbDirectMidiDevice with "
            + i2
            + " inputs and "
            + i3
            + " outputs. isUniversalMidiDevice: "
            + z);
  ...
  public final int calculateDefaultMidiProtocol() {
    ...
    for (int i = 0; i < this.mUsbInterfaces.size(); i++) {
      UsbInterfaceDescriptor usbInterfaceDescriptor =
          (UsbInterfaceDescriptor) this.mUsbInterfaces.get(i);
      boolean z = false;
      boolean z2 = false;
      ...
      if (z && z2) {
        ...
        if (updateUsbInterface(usbInterfaceDescriptor.toAndroid(this.mParser), openDevice)) {
          int calculateMidiType =
              this.mMidiBlockParser.calculateMidiType(
                  openDevice,
                  usbInterfaceDescriptor.getInterfaceNumber(),
                  usbInterfaceDescriptor.getAlternateSetting());
          openDevice.close();
  ...
  public final boolean openLocked() {
    ...
    for (int i4 = 0; i4 < this.mMidiEventMultiSchedulers.size(); i4++) {
      for (int i5 = 0; i5 < ((ArrayList) this.mMidiEventMultiSchedulers.get(i4)).size(); i5++) {
        int intValue =
            ((Integer) ((ArrayList) this.mOutputUsbEndpointCableCounts.get(i4)).get(i5)).intValue();
        MidiEventMultiScheduler midiEventMultiScheduler =
            (MidiEventMultiScheduler) ((ArrayList) this.mMidiEventMultiSchedulers.get(i4)).get(i5);
        for (int i6 = 0; i6 < intValue; i6++) {
          this.mMidiInputPortReceivers[i3].setReceiver(
              midiEventMultiScheduler.getEventScheduler(i6).getReceiver());
          i3++;
        }
      }
    }
    ...
    while (i8 < this.mInputUsbEndpoints.size()) {
      ...
      for (int i10 = 0; i10 < ((ArrayList) this.mInputUsbEndpoints.get(i8)).size(); i10++) {
        final UsbDeviceConnection usbDeviceConnection =
            (UsbDeviceConnection) this.mUsbDeviceConnections.get(i8);
        final UsbEndpoint usbEndpoint =
            (UsbEndpoint) ((ArrayList) this.mInputUsbEndpoints.get(i8)).get(i10);
        final int intValue2 =
            ((Integer) ((ArrayList) this.mInputUsbEndpointCableCounts.get(i8)).get(i10)).intValue();
        final int i11 = i9;
        Thread thread =
            new Thread(
                "UsbDirectMidiDevice input thread "
                    + i9) { // from class: com.android.server.usb.UsbDirectMidiDevice.2
                  ...
                  try {
                    ...
                    while (true) {
                      ...
                      if (usbRequest != requestWait) {
                        ...
                        if (position > 0) {
                          int i15 = 0;
                          UsbDirectMidiDevice.logByteArray(
                              "Input before conversion ", bArr, 0, position);
                          ...
                          while (i16 < intValue2) {
                            if (UsbDirectMidiDevice.this.mIsUniversalMidiDevice) {
                              pullDecodedMidiPackets =
                                  UsbDirectMidiDevice.this.swapEndiannessPerWord(bArr, position);
                            } else {
                              pullDecodedMidiPackets =
                                  usbMidiPacketConverter.pullDecodedMidiPackets(i16);
                            }
                            byte[] bArr2 = pullDecodedMidiPackets;
                            UsbDirectMidiDevice.logByteArray(
                                "Input " + i16 + " after conversion ", bArr2, i15, bArr2.length);
                            if (bArr2.length != 0) {
                              ...
                              if (midiReceiverArr != null) {
                                ...
                                if (midiReceiverArr[i17 + i16] != null) {
                                  ...
                                  if (UsbDirectMidiDevice.this.mPowerBoostSetter != null) {
                                    if (bArr2.length > 1
                                        && (!UsbDirectMidiDevice.this.mIsUniversalMidiDevice
                                            || UsbDirectMidiDevice.this.isChannelVoiceMessage(
                                                bArr2))) {
    ...
    for (int i13 = 0; i13 < this.mOutputUsbEndpoints.size(); i13++) {
      for (int i14 = 0; i14 < ((ArrayList) this.mOutputUsbEndpoints.get(i13)).size(); i14++) {
        final UsbDeviceConnection usbDeviceConnection2 =
            (UsbDeviceConnection) this.mUsbDeviceConnections.get(i13);
        final UsbEndpoint usbEndpoint2 =
            (UsbEndpoint) ((ArrayList) this.mOutputUsbEndpoints.get(i13)).get(i14);
        final int intValue3 =
            ((Integer) ((ArrayList) this.mOutputUsbEndpointCableCounts.get(i13)).get(i14))
                .intValue();
        final MidiEventMultiScheduler midiEventMultiScheduler2 =
            (MidiEventMultiScheduler)
                ((ArrayList) this.mMidiEventMultiSchedulers.get(i13)).get(i14);
        Thread thread2 =
            new Thread(
                "UsbDirectMidiDevice output write thread "
                    + i12) { // from class: com.android.server.usb.UsbDirectMidiDevice.3
              @Override // java.lang.Thread, java.lang.Runnable
              public void run() {
                  ...
                  while (true) {
                    ...
                    for (int i16 = i15; i16 < intValue3; i16++) {
                      MidiEventScheduler eventScheduler =
                          midiEventMultiScheduler2.getEventScheduler(i16);
                      for (MidiEventScheduler.MidiEvent nextEvent =
                              eventScheduler.getNextEvent(nanoTime);
                          nextEvent != null;
                          nextEvent =
                              (MidiEventScheduler.MidiEvent)
                                  eventScheduler.getNextEvent(nanoTime)) {
                        UsbDirectMidiDevice.logByteArray(
                            "Output before conversion ", nextEvent.data, i15, nextEvent.count);
                        if (UsbDirectMidiDevice.this.mIsUniversalMidiDevice) {
                          byte[] swapEndiannessPerWord =
                              UsbDirectMidiDevice.this.swapEndiannessPerWord(
                                  nextEvent.data, nextEvent.count);
                          byteArrayOutputStream.write(
                              swapEndiannessPerWord, i15, swapEndiannessPerWord.length);
                        } else {
                          usbMidiPacketConverter.encodeMidiPackets(
                              nextEvent.data, nextEvent.count, i16);
                        }
                    ...
                    UsbDirectMidiDevice.logByteArray(
                        ...
                        pullEncodedMidiPackets,
                        i15,
                        pullEncodedMidiPackets.length);
                    int i17 = i15;
                    while (i17 < pullEncodedMidiPackets.length && !z) {
                      int min =
                          Math.min(
                              usbEndpoint2.getMaxPacketSize(), pullEncodedMidiPackets.length - i17);
                      int i18 = -1;
                      int i19 = i15;
                      while (true) {
                        if (i18 >= 0 || i19 > 20) {
                        ...
                        i18 =
                            usbDeviceConnection2.bulkTransfer(
                                usbEndpoint2, pullEncodedMidiPackets, i17, min, 50);
                        i19++;
                        Thread.currentThread();
                        if (Thread.interrupted()) {
                          ...
                          Log.d(
                              "UsbDirectMidiDevice",
                              "retrying packet. retryCount = " + i19 + " result = " + i18);
                          if (i19 > 20) {
  ...
  public final void closeLocked() {
    ...
    for (int i2 = 0; i2 < this.mMidiEventMultiSchedulers.size(); i2++) {
      for (int i3 = 0; i3 < ((ArrayList) this.mMidiEventMultiSchedulers.get(i2)).size(); i3++) {
        ((MidiEventMultiScheduler) ((ArrayList) this.mMidiEventMultiSchedulers.get(i2)).get(i3))
            .close();
      }
    }
  ...
  public final boolean areEquivalent(UsbInterface usbInterface, UsbInterface usbInterface2) {
    if (usbInterface.getId() != usbInterface2.getId()
        || usbInterface.getAlternateSetting() != usbInterface2.getAlternateSetting()
        || usbInterface.getInterfaceClass() != usbInterface2.getInterfaceClass()
        || usbInterface.getInterfaceSubclass() != usbInterface2.getInterfaceSubclass()
        || usbInterface.getInterfaceProtocol() != usbInterface2.getInterfaceProtocol()
        || usbInterface.getEndpointCount() != usbInterface2.getEndpointCount()) {
      return false;
    }
    ...
    for (int i = 0; i < usbInterface.getEndpointCount(); i++) {
      ...
      if (endpoint.getAddress() != endpoint2.getAddress()
          || endpoint.getAttributes() != endpoint2.getAttributes()
          || endpoint.getMaxPacketSize() != endpoint2.getMaxPacketSize()
          || endpoint.getInterval() != endpoint2.getInterval()) {
        return false;
      }
    }
    return true;
