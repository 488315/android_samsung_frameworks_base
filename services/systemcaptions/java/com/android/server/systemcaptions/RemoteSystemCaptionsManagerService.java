...
public final class RemoteSystemCaptionsManagerService {
  ...
  public RemoteSystemCaptionsManagerService(
      Context context, ComponentName componentName, int i, boolean z) {
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
            new Consumer() { // from class:
              // com.android.server.systemcaptions.RemoteSystemCaptionsManagerService$$ExternalSyntheticLambda0
  ...
  public final void scheduleBind() {
    ...
    this.mHandler.sendMessage(
        PooledLambda.obtainMessage(
                new Consumer() { // from class:
                  // com.android.server.systemcaptions.RemoteSystemCaptionsManagerService$$ExternalSyntheticLambda1
                  @Override // java.util.function.Consumer
                  public final void accept(Object obj) {
