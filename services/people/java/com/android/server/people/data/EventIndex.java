...
public class EventIndex {
          ...
          Arrays.asList(
              new Function() { // from class:
                ...
                public final Object apply(Object obj) {
                  ...
                  createOneDayLongTimeSlot =
                      EventIndex.createOneDayLongTimeSlot(((Long) obj).longValue());
                  return createOneDayLongTimeSlot;
                }
              },
              new Function() { // from class:
                // com.android.server.people.data.EventIndex$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  Range createFourHoursLongTimeSlot;
                  createFourHoursLongTimeSlot =
                      EventIndex.createFourHoursLongTimeSlot(((Long) obj).longValue());
                  return createFourHoursLongTimeSlot;
                }
              },
              new Function() { // from class:
                // com.android.server.people.data.EventIndex$$ExternalSyntheticLambda2
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  Range createOneHourLongTimeSlot;
                  createOneHourLongTimeSlot =
                      EventIndex.createOneHourLongTimeSlot(((Long) obj).longValue());
                  return createOneHourLongTimeSlot;
                }
              },
              new Function() { // from class:
                // com.android.server.people.data.EventIndex$$ExternalSyntheticLambda3
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  Range createTwoMinutesLongTimeSlot;
                  createTwoMinutesLongTimeSlot =
                      EventIndex.createTwoMinutesLongTimeSlot(((Long) obj).longValue());
    ...
    synchronized (this.mLock) {
      for (int i = 3; i >= 0; i--) {
        if (this.mEventBitmaps[i] != 0) {
          ...
          return Range.create(
              Long.valueOf(((Long) range.getLower()).longValue() - duration),
              Long.valueOf(((Long) range.getUpper()).longValue() - duration));
        }
      }
      return null;
    }
  ...
  public String toString() {
    return "EventIndex {perDayEventBitmap=0b"
        + Long.toBinaryString(this.mEventBitmaps[0])
        + ", perFourHoursEventBitmap=0b"
        + Long.toBinaryString(this.mEventBitmaps[1])
        + ", perHourEventBitmap=0b"
        + Long.toBinaryString(this.mEventBitmaps[2])
        + ", perTwoMinutesEventBitmap=0b"
        + Long.toBinaryString(this.mEventBitmaps[3])
        + ", lastUpdatedTime="
        + DateFormat.format("yyyy-MM-dd HH:mm:ss", this.mLastUpdatedTime)
        + "}";
  }
  ...
  public int hashCode() {
    return Objects.hash(
        Long.valueOf(this.mLastUpdatedTime), Integer.valueOf(Arrays.hashCode(this.mEventBitmaps)));
  }
  ...
  public final List getActiveTimeSlotsForType(int i) {
    ...
    Range range =
        (Range) ((Function) TIME_SLOT_FACTORIES.get(i)).apply(Long.valueOf(this.mLastUpdatedTime));
  ...
  public static Range createOneDayLongTimeSlot(long j) {
    ...
    return Range.create(
        Long.valueOf(toEpochMilli(truncatedTo)),
        Long.valueOf(toEpochMilli(truncatedTo.plusDays(1L))));
  }
  ...
  public static Range createFourHoursLongTimeSlot(long j) {
    LocalDateTime minusHours =
        toLocalDateTime(j)
            ...
            .minusHours(toLocalDateTime(j).getHour() % 4);
    return Range.create(
        Long.valueOf(toEpochMilli(minusHours)),
        Long.valueOf(toEpochMilli(minusHours.plusHours(4L))));
  }
  ...
  public static Range createOneHourLongTimeSlot(long j) {
    ...
    return Range.create(
        Long.valueOf(toEpochMilli(truncatedTo)),
        Long.valueOf(toEpochMilli(truncatedTo.plusHours(1L))));
  }
  ...
  public static Range createTwoMinutesLongTimeSlot(long j) {
    LocalDateTime minusMinutes =
        toLocalDateTime(j)
            ...
            .minusMinutes(toLocalDateTime(j).getMinute() % 2);
    return Range.create(
        Long.valueOf(toEpochMilli(minusMinutes)),
        Long.valueOf(toEpochMilli(minusMinutes.plusMinutes(2L))));
  }
