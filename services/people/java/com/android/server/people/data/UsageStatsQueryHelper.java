...
public class UsageStatsQueryHelper {
  ...
  public boolean querySince(long j) {
    UsageEvents queryEventsForUser =
        this.mUsageStatsManagerInternal.queryEventsForUser(
            this.mUserId, j, System.currentTimeMillis(), 0);
    boolean z = false;
        ...
        if (eventType != 2) {
          if (eventType == 8) {
            addEventByShortcutId(
                packageData, event.getShortcutId(), new Event(event.getTimeStamp(), 1));
            ...
            if (locusId != null
                && packageData.getConversationStore().getConversationByLocusId(locusId) != null) {
              this.mConvoStartEvents.put(
                  new ComponentName(packageName, event.getClassName()), event);
            }
  ...
  public static List queryAppMovingToForegroundEvents(int i, long j, long j2) {
    ...
    UsageEvents queryEventsForUser =
        getUsageStatsManagerInternal().queryEventsForUser(i, j, j2, 10);
    if (queryEventsForUser == null) {
      return arrayList;
    }
    while (queryEventsForUser.hasNextEvent()) {
  ...
  public static Map queryAppUsageStats(int i, long j, long j2, Set set) {
    List<UsageStats> queryUsageStatsForUser =
        getUsageStatsManagerInternal().queryUsageStatsForUser(i, 4, j, j2, false);
            ...
            (AppUsageStatsData)
                arrayMap.computeIfAbsent(
                    ...
                    new Function() { // from class:
                      // com.android.server.people.data.UsageStatsQueryHelper$$ExternalSyntheticLambda0
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        AppUsageStatsData lambda$queryAppUsageStats$0;
                        lambda$queryAppUsageStats$0 =
                            UsageStatsQueryHelper.lambda$queryAppUsageStats$0((String) obj);
  ...
  public final void onInAppConversationEnded(PackageData packageData, UsageEvents.Event event) {
    ...
    addEventByLocusId(
        packageData,
        new LocusId(event2.getLocusId()),
        new Event.Builder(event2.getTimeStamp(), 13)
            .setDurationSeconds((int) ((event.getTimeStamp() - event2.getTimeStamp()) / 1000))
            .build());
  }
  ...
  public final void addEventByLocusId(PackageData packageData, LocusId locusId, Event event) {
    ConversationInfo conversationByLocusId =
