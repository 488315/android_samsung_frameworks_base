...
public class DataManager {
  ...
  public void initialize() {
    ...
    this.mNotificationManagerInternal =
        (NotificationManagerInternal) LocalServices.getService(NotificationManagerInternal.class);
    this.mUserManager = (UserManager) this.mContext.getSystemService(UserManager.class);
    this.mShortcutServiceInternal.addShortcutChangeCallback(new ShortcutServiceCallback());
    ConversationStatusExpirationBroadcastReceiver conversationStatusExpirationBroadcastReceiver =
        new ConversationStatusExpirationBroadcastReceiver();
    this.mStatusExpReceiver = conversationStatusExpirationBroadcastReceiver;
    this.mContext.registerReceiver(
        conversationStatusExpirationBroadcastReceiver,
  ...
  public void onUserUnlocked(final int i) {
    ...
    this.mScheduledExecutor.execute(
        new Runnable() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda1
  ...
  public void onUserStopping(final int i) {
    ...
    this.mScheduledExecutor.execute(
        new Runnable() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public List getShareShortcuts(IntentFilter intentFilter, int i) {
    return this.mShortcutServiceInternal.getShareTargets(
        this.mContext.getPackageName(), intentFilter, i);
  }
  ...
  public final ConversationChannel getConversationChannel(
      String str, int i, String str2, ConversationInfo conversationInfo) {
  ...
  public final ConversationChannel getConversationChannel(
    ...
    if (shortcutInfo == null) {
      ...
      this.mInjector
          ...
          .execute(
              new Runnable() { // from class:
                // com.android.server.people.data.DataManager$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    NotificationChannel notificationChannel =
        this.mNotificationManagerInternal.getNotificationChannel(
            str, packageUid, conversationInfo.getNotificationChannelId());
    return new ConversationChannel(
        shortcutInfo,
        packageUid,
        notificationChannel,
        notificationChannel != null
            ? this.mNotificationManagerInternal.getNotificationChannelGroup(
                str, packageUid, notificationChannel.getId())
            : null,
        conversationInfo.getLastEventTimestamp(),
        hasActiveNotifications(str, i, str2),
        false,
  ...
  public List getRecentConversations(int i) {
    ...
    forPackagesInProfile(
        ...
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda4
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$getRecentConversations$4(
      final List list, final PackageData packageData) {
    if (packageData == null) {
      return;
    }
    packageData.forAllConversations(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda8
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DataManager.this.lambda$getRecentConversations$3(
                packageData, list, (ConversationInfo) obj);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$getRecentConversations$3(
      PackageData packageData, List list, ConversationInfo conversationInfo) {
  ...
  public void removeRecentConversation(String str, int i, String str2, int i2) {
    ...
    this.mShortcutServiceInternal.uncacheShortcuts(
        i2, this.mContext.getPackageName(), str, Collections.singletonList(str2), i, 16384);
  }
  ...
  public void pruneOldRecentConversations(final int i, final long j) {
    forPackagesInProfile(
        i,
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda5
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$pruneOldRecentConversations$6(
      final long j, int i, PackageData packageData) {
    if (packageData == null) {
      return;
    }
    ...
    packageData.forAllConversations(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda7
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DataManager.this.lambda$pruneOldRecentConversations$5(
                j, packageName, userId, arrayList, (ConversationInfo) obj);
          }
        });
    ...
    this.mShortcutServiceInternal.uncacheShortcuts(
        i, this.mContext.getPackageName(), packageName, arrayList, userId, 16384);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$pruneOldRecentConversations$5(
      long j, String str, int i, List list, ConversationInfo conversationInfo) {
    String shortcutId = conversationInfo.getShortcutId();
    if (!isCachedRecentConversation(conversationInfo)
        || j - conversationInfo.getLastEventTimestamp() <= 864000000
        || hasActiveNotifications(str, i, shortcutId)) {
      return;
    }
    list.add(shortcutId);
  }
  ...
  public void pruneExpiredConversationStatuses(int i, final long j) {
    forPackagesInProfile(
        i,
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda11
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$pruneExpiredConversationStatuses$8(
      final long j, final PackageData packageData) {
    if (packageData == null) {
      return;
    }
    ...
    packageData.forAllConversations(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda14
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DataManager.this.lambda$pruneExpiredConversationStatuses$7(
                j, conversationStore, packageData, (ConversationInfo) obj);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$pruneExpiredConversationStatuses$7(
      long j,
    ...
    updateConversationStoreThenNotifyListeners(
        conversationStore, builder.build(), packageData.getPackageName(), packageData.getUserId());
  }
  ...
  public boolean isConversation(String str, int i, String str2) {
    ...
    return (conversation == null
            || conversation.getShortcutInfo() == null
            || TextUtils.isEmpty(conversation.getShortcutInfo().getLabel()))
        ? false
        : true;
  }
  ...
  public void addOrUpdateStatus(
      String str, int i, String str2, ConversationStatus conversationStatus) {
    ConversationStore conversationStoreOrThrow = getConversationStoreOrThrow(str, i);
    ConversationInfo.Builder builder =
        new ConversationInfo.Builder(getConversationInfoOrThrow(conversationStoreOrThrow, str2));
  ...
  public final ConversationInfo getConversationInfoOrThrow(
      ConversationStore conversationStore, String str) {
  ...
  public void reportShareTargetEvent(AppTargetEvent appTargetEvent, IntentFilter intentFilter) {
    ...
    if (target == null
        ...
        || (unlockedUserData = getUnlockedUserData(target.getUser().getIdentifier())) == null) {
      return;
    }
    PackageData orCreatePackageData =
        unlockedUserData.getOrCreatePackageData(target.getPackageName());
    ...
    if ("direct_share".equals(appTargetEvent.getLaunchLocation())) {
      ...
      orCreateEventHistory =
          orCreatePackageData.getEventStore().getOrCreateEventHistory(4, target.getClassName());
    }
  ...
  public void pruneDataForUser(final int i, final CancellationSignal cancellationSignal) {
    ...
    unlockedUserData.forAllPackages(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda6
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$pruneDataForUser$9(
      CancellationSignal cancellationSignal, int i, PackageData packageData) {
  ...
  public final void lambda$onUserUnlocked$0(int i) {
    synchronized (this.mLock) {
      ...
      Object[] objArr5 = 0;
      Object[] objArr6 = 0;
      this.mUsageStatsQueryFutures.put(
          i,
          this.mScheduledExecutor.scheduleAtFixedRate(
              new UsageStatsQueryRunnable(i), 1L, 120L, TimeUnit.SECONDS));
      ...
      if (this.mBroadcastReceivers.get(i) == null) {
        ...
        this.mContext.registerReceiverAsUser(
            perUserBroadcastReceiver, UserHandle.of(i), intentFilter, null, null);
      }
      ContactsContentObserver contactsContentObserver =
          new ContactsContentObserver(BackgroundThread.getHandler());
      this.mContactsContentObservers.put(i, contactsContentObserver);
      this.mContext
          .getContentResolver()
          .registerContentObserver(
              ContactsContract.Contacts.CONTENT_URI, true, contactsContentObserver, i);
      ...
      try {
        notificationListener.registerAsSystemService(
            this.mContext, new ComponentName(this.mContext, getClass()), i);
      ...
      if (i == 0) {
        ...
        this.mContext
            .getContentResolver()
            .registerContentObserver(CallLog.CONTENT_URI, true, this.mCallLogContentObserver, 0);
        this.mMmsSmsContentObserver = new MmsSmsContentObserver(BackgroundThread.getHandler());
        this.mContext
            .getContentResolver()
            .registerContentObserver(
                Telephony.MmsSms.CONTENT_URI, false, this.mMmsSmsContentObserver, 0);
      }
      ...
      if (userData != null && !userData.isUnlocked()) {
        ...
        if (this.mContactsContentObservers.indexOfKey(i) >= 0) {
          contentResolver.unregisterContentObserver(
              (ContentObserver) this.mContactsContentObservers.get(i));
        }
  ...
  public final void pruneUninstalledPackageData(UserData userData) {
    ...
    this.mPackageManagerInternal.forEachInstalledPackage(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda12
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
        ...
        userData.getUserId());
    final ArrayList arrayList = new ArrayList();
    userData.forAllPackages(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda13
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DataManager.lambda$pruneUninstalledPackageData$11(
                arraySet, arrayList, (PackageData) obj);
          }
        });
  ...
  public static /* synthetic */ void lambda$pruneUninstalledPackageData$10(
      Set set, AndroidPackage androidPackage) {
    set.add(androidPackage.getPackageName());
  }

  public static /* synthetic */ void lambda$pruneUninstalledPackageData$11(
      Set set, List list, PackageData packageData) {
  ...
  public final List getShortcuts(String str, int i, List list) {
    return this.mShortcutServiceInternal.getShortcuts(
        0,
  ...
  public final void updateDefaultDialer(UserData userData) {
    ...
    userData.setDefaultDialer(
        telecomManager != null
            ? telecomManager.getDefaultDialerPackage(new UserHandle(userData.getUserId()))
            : null);
  }
  ...
  public final void updateDefaultSmsApp(UserData userData) {
    ComponentName defaultSmsApplicationAsUser =
        SmsApplication.getDefaultSmsApplicationAsUser(
            this.mContext, false, UserHandle.of(userData.getUserId()));
    userData.setDefaultSmsApp(
        defaultSmsApplicationAsUser != null ? defaultSmsApplicationAsUser.getPackageName() : null);
  }

  public final PackageData getPackageIfConversationExists(
      StatusBarNotification statusBarNotification, Consumer consumer) {
    PackageData packageData;
    ...
    if (shortcutId == null
        || (packageData =
            ...
            == null
        || (conversation = packageData.getConversationStore().getConversation(shortcutId))
            == null) {
      return null;
    }
  ...
  public final boolean hasActiveNotifications(String str, int i, String str2) {
    NotificationListener notificationListener =
        (NotificationListener) this.mNotificationListeners.get(i);
  ...
  public final void cleanupCachedShortcuts(int i, int i2) {
    ...
    unlockedUserData.forAllPackages(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda9
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
        ...
        new PriorityQueue(
            ...
            Comparator.comparingLong(
                    new ToLongFunction() { // from class:
                      // com.android.server.people.data.DataManager$$ExternalSyntheticLambda10
                      @Override // java.util.function.ToLongFunction
                      public final long applyAsLong(Object obj) {
                        long lambda$cleanupCachedShortcuts$14;
                        lambda$cleanupCachedShortcuts$14 =
                            DataManager.lambda$cleanupCachedShortcuts$14((Pair) obj);
    ...
    for (Pair pair : arrayList) {
      if (!hasActiveNotifications(
          (String) pair.first, i, ((ConversationInfo) pair.second).getShortcutId())) {
    ...
    while (!priorityQueue.isEmpty()) {
      ...
      this.mShortcutServiceInternal.uncacheShortcuts(
          ...
          this.mContext.getPackageName(),
          (String) pair2.first,
          Collections.singletonList(((ConversationInfo) pair2.second).getShortcutId()),
          i,
          16384);
    }
  }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$cleanupCachedShortcuts$13(
      final List list, final PackageData packageData) {
    packageData.forAllConversations(
        new Consumer() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda15
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            DataManager.this.lambda$cleanupCachedShortcuts$12(
                list, packageData, (ConversationInfo) obj);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$cleanupCachedShortcuts$12(
      List list, PackageData packageData, ConversationInfo conversationInfo) {
  ...
  public static /* synthetic */ long lambda$cleanupCachedShortcuts$14(Pair pair) {
    return Math.max(
        ((ConversationInfo) pair.second).getLastEventTimestamp(),
        ((ConversationInfo) pair.second).getCreationTimestamp());
  }
  ...
  public void addOrUpdateConversationInfo(ShortcutInfo shortcutInfo) {
    ...
    ConversationStore conversationStore =
        unlockedUserData.getOrCreatePackageData(shortcutInfo.getPackage()).getConversationStore();
    ...
    if (shortcutInfo.getPersons() != null && shortcutInfo.getPersons().length != 0) {
      ...
      if (uri != null) {
        ContactsQueryHelper createContactsQueryHelper =
            this.mInjector.createContactsQueryHelper(this.mContext);
    ...
    updateConversationStoreThenNotifyListeners(
        conversationStore, creationTimestamp.build(), shortcutInfo);
  }
  ...
  public class ContactsContentObserver extends ContentObserver {
    ...
    public void onChange(boolean z, Uri uri, int i) {
      ContactsQueryHelper createContactsQueryHelper =
          DataManager.this.mInjector.createContactsQueryHelper(DataManager.this.mContext);
      if (createContactsQueryHelper.querySince(this.mLastUpdatedTimestamp)) {
        ...
        unlockedUserData.forAllPackages(
            new Consumer() { // from class:
              // com.android.server.people.data.DataManager$ContactsContentObserver$$ExternalSyntheticLambda0
              @Override // java.util.function.Consumer
              public final void accept(Object obj) {
                DataManager.ContactsContentObserver.lambda$onChange$0(
                    contactUri, conversationSelector, (PackageData) obj);
              }
            });
        ...
        DataManager.this.updateConversationStoreThenNotifyListeners(
            conversationSelector.mConversationStore,
            builder.build(),
            conversationSelector.mPackageName,
            i);
    ...
    public static /* synthetic */ void lambda$onChange$0(
        Uri uri, ConversationSelector conversationSelector, PackageData packageData) {
      ConversationInfo conversationByContactUri =
          packageData.getConversationStore().getConversationByContactUri(uri);
  ...
  public class CallLogContentObserver extends ContentObserver implements BiConsumer {
    ...
    public CallLogContentObserver(Handler handler) {
      super(handler);
      this.mCallLogQueryHelper =
          DataManager.this.mInjector.createCallLogQueryHelper(DataManager.this.mContext, this);
      this.mLastCallTimestamp =
    ...
    public void accept(final String str, final Event event) {
      DataManager.this.forAllUnlockedUsers(
          new Consumer() { // from class:
            // com.android.server.people.data.DataManager$CallLogContentObserver$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public static /* synthetic */ void lambda$accept$0(String str, Event event, UserData userData) {
      ...
      if (defaultDialer == null
          || defaultDialer.getConversationStore().getConversationByPhoneNumber(str) == null) {
        return;
      }
  ...
  public class MmsSmsContentObserver extends ContentObserver implements BiConsumer {
    ...
    public MmsSmsContentObserver(Handler handler) {
      super(handler);
      this.mMmsQueryHelper =
          DataManager.this.mInjector.createMmsQueryHelper(DataManager.this.mContext, this);
      this.mSmsQueryHelper =
          DataManager.this.mInjector.createSmsQueryHelper(DataManager.this.mContext, this);
    ...
    public void accept(final String str, final Event event) {
      DataManager.this.forAllUnlockedUsers(
          new Consumer() { // from class:
            // com.android.server.people.data.DataManager$MmsSmsContentObserver$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public static /* synthetic */ void lambda$accept$0(String str, Event event, UserData userData) {
      ...
      if (defaultSmsApp == null
          || defaultSmsApp.getConversationStore().getConversationByPhoneNumber(str) == null) {
        return;
      }
  ...
  public class ShortcutServiceCallback implements LauncherApps.ShortcutChangeCallback {
    ...
    public void onShortcutsAddedOrUpdated(
        final String str, final List list, final UserHandle userHandle) {
      DataManager.this
          .mInjector
          .getBackgroundExecutor()
          .execute(
              new Runnable() { // from class:
                // com.android.server.people.data.DataManager$ShortcutServiceCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                  DataManager.ShortcutServiceCallback.this.lambda$onShortcutsAddedOrUpdated$0(
                      str, userHandle, list);
                }
              });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onShortcutsAddedOrUpdated$0(
        String str, UserHandle userHandle, List list) {
      ...
      while (it.hasNext()) {
        ...
        if (ShortcutHelper.isConversationShortcut(
            shortcutInfo, DataManager.this.mShortcutServiceInternal, userHandle.getIdentifier())) {
          if (shortcutInfo.isCached()) {
            ConversationInfo conversationInfo =
                packageData != null ? packageData.getConversationInfo(shortcutInfo.getId()) : null;
    ...
    public void onShortcutsRemoved(final String str, final List list, final UserHandle userHandle) {
      DataManager.this
          ...
          .execute(
              new Runnable() { // from class:
                // com.android.server.people.data.DataManager$ShortcutServiceCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                  DataManager.ShortcutServiceCallback.this.lambda$onShortcutsRemoved$1(
                      list, str, userHandle);
                }
              });
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onShortcutsRemoved$1(
        List list, String str, UserHandle userHandle) {
  ...
  public final void removeConversations(String str, int i, Set set) {
    ...
    try {
      this.mNotificationManagerInternal.onConversationRemoved(
          str, this.mContext.getPackageManager().getPackageUidAsUser(str, i), set);
  ...
  public class NotificationListener extends NotificationListenerService {
    ...
    public void onNotificationPosted(
      ...
      PackageData packageIfConversationExists =
          DataManager.this.getPackageIfConversationExists(
              statusBarNotification,
              new Consumer() { // from class:
                // com.android.server.people.data.DataManager$NotificationListener$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  DataManager.NotificationListener.this.lambda$onNotificationPosted$1(
                      statusBarNotification, shortcutId, (ConversationInfo) obj);
                }
              });
      if (packageIfConversationExists != null) {
        ...
        ConversationInfo conversationInfo =
            packageIfConversationExists.getConversationInfo(shortcutId);
        if (conversationInfo == null) {
          return;
        }
        ConversationInfo.Builder notificationChannelId =
            new ConversationInfo.Builder(conversationInfo)
                .setLastEventTimestamp(statusBarNotification.getPostTime())
                .setNotificationChannelId(ranking.getChannel().getId());
        if (!TextUtils.isEmpty(ranking.getChannel().getParentChannelId())) {
          notificationChannelId.setParentNotificationChannelId(
              ranking.getChannel().getParentChannelId());
        } else {
          notificationChannelId.setParentNotificationChannelId(
              statusBarNotification.getNotification().getChannelId());
        }
        packageIfConversationExists
            .getConversationStore()
            .addOrUpdate(notificationChannelId.build());
        packageIfConversationExists
            .getEventStore()
            .getOrCreateEventHistory(0, shortcutId)
            .addEvent(new Event(statusBarNotification.getPostTime(), 2));
      }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onNotificationPosted$1(
        StatusBarNotification statusBarNotification,
        String str,
        ConversationInfo conversationInfo) {
      synchronized (this) {
        ((Set)
                this.mActiveNotifKeys.computeIfAbsent(
                    Pair.create(statusBarNotification.getPackageName(), str),
                    new Function() { // from class:
                      // com.android.server.people.data.DataManager$NotificationListener$$ExternalSyntheticLambda3
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        Set lambda$onNotificationPosted$0;
                        lambda$onNotificationPosted$0 =
                            DataManager.NotificationListener.lambda$onNotificationPosted$0(
                                (Pair) obj);
    ...
    public synchronized void onNotificationRemoved(
      ...
      PackageData packageIfConversationExists =
          DataManager.this.getPackageIfConversationExists(
              statusBarNotification,
              new Consumer() { // from class:
                // com.android.server.people.data.DataManager$NotificationListener$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  DataManager.NotificationListener.this.lambda$onNotificationRemoved$3(
                      statusBarNotification, shortcutId, (ConversationInfo) obj);
                }
              });
      if (i == 1 && packageIfConversationExists != null) {
        ...
        packageIfConversationExists
            ...
            .addOrUpdate(
                new ConversationInfo.Builder(conversationInfo)
                    .setLastEventTimestamp(currentTimeMillis)
                    .build());
        packageIfConversationExists
            .getEventStore()
            .getOrCreateEventHistory(0, shortcutId)
            .addEvent(new Event(currentTimeMillis, 3));
      }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onNotificationRemoved$3(
        StatusBarNotification statusBarNotification,
        String str,
        ConversationInfo conversationInfo) {
        ...
        Set set =
            (Set)
                this.mActiveNotifKeys.computeIfAbsent(
                    create,
                    new Function() { // from class:
                      // com.android.server.people.data.DataManager$NotificationListener$$ExternalSyntheticLambda2
                      @Override // java.util.function.Function
                      public final Object apply(Object obj) {
                        Set lambda$onNotificationRemoved$2;
                        lambda$onNotificationRemoved$2 =
                            DataManager.NotificationListener.lambda$onNotificationRemoved$2(
                                (Pair) obj);
    ...
    public void onNotificationChannelModified(
      ...
      if (packageData == null
          || conversationId == null
          || (conversation =
                  (conversationStore = packageData.getConversationStore())
      ...
      DataManager.this.updateConversationStoreThenNotifyListeners(
          conversationStore, builder.build(), str, packageData.getUserId());
    }
  ...
  public class UsageStatsQueryRunnable implements Runnable, UsageStatsQueryHelper.EventListener {
    ...
    public UsageStatsQueryRunnable(final int i) {
      this.mUsageStatsQueryHelper =
          DataManager.this.mInjector.createUsageStatsQueryHelper(
              i,
              new Function() { // from class:
                // com.android.server.people.data.DataManager$UsageStatsQueryRunnable$$ExternalSyntheticLambda0
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                  PackageData lambda$new$0;
                  lambda$new$0 =
                      DataManager.UsageStatsQueryRunnable.this.lambda$new$0(i, (String) obj);
                  return lambda$new$0;
                }
              },
              this);
  ...
  public void updateConversationStoreThenNotifyListeners(
      ConversationStore conversationStore, ConversationInfo conversationInfo, String str, int i) {
    conversationStore.addOrUpdate(conversationInfo);
    ConversationChannel conversationChannel =
        getConversationChannel(str, i, conversationInfo.getShortcutId(), conversationInfo);
    if (conversationChannel != null) {
      notifyConversationsListeners(Arrays.asList(conversationChannel));
    }
  }

  public final void updateConversationStoreThenNotifyListeners(
      ConversationStore conversationStore,
      ConversationInfo conversationInfo,
      ShortcutInfo shortcutInfo) {
    conversationStore.addOrUpdate(conversationInfo);
  ...
  public void notifyConversationsListeners(final List list) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.people.data.DataManager$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public class PerUserBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if ("android.telecom.action.DEFAULT_DIALER_CHANGED".equals(intent.getAction())) {
        unlockedUserData.setDefaultDialer(
            intent.getStringExtra("android.telecom.extra.CHANGE_DEFAULT_DIALER_PACKAGE_NAME"));
      } else if ("android.provider.action.DEFAULT_SMS_PACKAGE_CHANGED_INTERNAL"
  ...
  public class ShutdownBroadcastReceiver extends BroadcastReceiver {
    ...
    public static /* synthetic */ void lambda$onReceive$0(UserData userData) {
      userData.forAllPackages(
          new Consumer() { // from class:
            // com.android.server.people.data.DataManager$ShutdownBroadcastReceiver$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onReceive(Context context, Intent intent) {
      DataManager.this.forAllUnlockedUsers(
          new Consumer() { // from class:
            // com.android.server.people.data.DataManager$ShutdownBroadcastReceiver$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
  ...
  class Injector {
    ...
    public UsageStatsQueryHelper createUsageStatsQueryHelper(
        int i, Function function, UsageStatsQueryHelper.EventListener eventListener) {
