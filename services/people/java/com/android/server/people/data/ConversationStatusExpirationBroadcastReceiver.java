...
public class ConversationStatusExpirationBroadcastReceiver extends BroadcastReceiver {
  public void scheduleExpiration(
      Context context, int i, String str, String str2, ConversationStatus conversationStatus) {
              ...
              PendingIntent.getBroadcast(
                  ...
                  new Intent("ConversationStatusExpiration")
                      ...
                      .setData(
                          new Uri.Builder()
                              .scheme("expStatus")
                              .appendPath(getKey(i, str, str2, conversationStatus))
                              .build())
                      .addFlags(268435456)
                      .putExtra("userId", i),
                  201326592));
  ...
  public static String getKey(
      int i, String str, String str2, ConversationStatus conversationStatus) {
  ...
  public static /* synthetic */ void lambda$onReceive$0(Intent intent) {
    ((PeopleServiceInternal) LocalServices.getService(PeopleServiceInternal.class))
        .pruneDataForUser(
            intent.getIntExtra("userId", ActivityManager.getCurrentUser()),
