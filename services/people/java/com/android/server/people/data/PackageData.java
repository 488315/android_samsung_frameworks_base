...
public class PackageData {
  ...
  public static Map packagesDataFromDisk(
      int i,
      Predicate predicate,
      Predicate predicate2,
      ScheduledExecutorService scheduledExecutorService,
    ...
    for (File file2 : listFiles) {
      PackageData packageData =
          new PackageData(
              file2.getName(), i, predicate, predicate2, scheduledExecutorService, file);
  ...
  public EventHistory getEventHistory(String str) {
    ...
    if (locusId != null
        && (eventHistory3 = getEventStore().getEventHistory(1, locusId.getId())) != null) {
    ...
    if (isDefaultDialer()
        && (eventHistory2 = getEventStore().getEventHistory(2, contactPhoneNumber)) != null) {
      aggregateEventHistoryImpl.addEventHistory(eventHistory2);
    }
    if (isDefaultSmsApp()
        && (eventHistory = getEventStore().getEventHistory(3, contactPhoneNumber)) != null) {
  ...
  public void pruneOrphanEvents() {
    this.mEventStore.pruneOrphanEventHistories(
        0,
    ...
    this.mEventStore.pruneOrphanEventHistories(
        1,
        new Predicate() { // from class:
          // com.android.server.people.data.PackageData$$ExternalSyntheticLambda1
          @Override // java.util.function.Predicate
          public final boolean test(Object obj) {
    ...
    if (isDefaultDialer()) {
      this.mEventStore.pruneOrphanEventHistories(
          2,
          new Predicate() { // from class:
            // com.android.server.people.data.PackageData$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$pruneOrphanEvents$2;
              lambda$pruneOrphanEvents$2 =
                  PackageData.this.lambda$pruneOrphanEvents$2((String) obj);
    ...
    if (isDefaultSmsApp()) {
      this.mEventStore.pruneOrphanEventHistories(
          3,
          new Predicate() { // from class:
            // com.android.server.people.data.PackageData$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
              boolean lambda$pruneOrphanEvents$3;
              lambda$pruneOrphanEvents$3 =
                  PackageData.this.lambda$pruneOrphanEvents$3((String) obj);
