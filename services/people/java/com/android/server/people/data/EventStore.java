...
public class EventStore {
  ...
  public synchronized void loadFromDisk() {
    for (int i = 0; i < this.mEventsCategoryDirs.size(); i++) {
      ((Map) this.mEventHistoryMaps.get(i))
          .putAll(
              EventHistoryImpl.eventHistoriesImplFromDisk(
                  (File) this.mEventsCategoryDirs.get(i), this.mScheduledExecutorService));
    }
  }
            ...
            .computeIfAbsent(
                ...
                new Function() { // from class:
                  ...
                  public final Object apply(Object obj) {
                    ...
                    lambda$getOrCreateEventHistory$0 =
                        EventStore.this.lambda$getOrCreateEventHistory$0(i, str, (String) obj);
  ...
  public /* synthetic */ EventHistoryImpl lambda$getOrCreateEventHistory$0(
      int i, String str, String str2) {
    return new EventHistoryImpl(
        new File((File) this.mEventsCategoryDirs.get(i), Uri.encode(str)),
  ...
  public synchronized void deleteEventHistory(int i, String str) {
    EventHistoryImpl eventHistoryImpl =
        (EventHistoryImpl) ((Map) this.mEventHistoryMaps.get(i)).remove(str);
