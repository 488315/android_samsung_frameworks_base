...
public class PeopleService extends SystemService {
        ...
        new IPeopleManager.Stub() { // from class: com.android.server.people.PeopleService.1
          ...
          public ParceledListSlice getRecentConversations() {
            ...
            return new ParceledListSlice(
                PeopleService.this.mDataManager.getRecentConversations(
          ...
          public void removeRecentConversation(String str, int i, String str2) {
            ...
            PeopleService.this.mDataManager.removeRecentConversation(
                str, i, str2, Binder.getCallingUserHandle().getIdentifier());
          }

          public void removeAllRecentConversations() {
            PeopleService.enforceSystemOrRoot("remove all recent conversations");
            PeopleService.this.mDataManager.removeAllRecentConversations(
                Binder.getCallingUserHandle().getIdentifier());
          }
          ...
          public final void enforceHasReadPeopleDataPermission() {
            if (PeopleService.this
                    .getContext()
                    .checkCallingPermission("android.permission.READ_PEOPLE_DATA")
                != 0) {
          ...
          public void registerConversationListener(
            ...
            PeopleService.this.mConversationListenerHelper.addConversationListener(
                new ListenerKey(str, Integer.valueOf(i), str2), iConversationListener);
          }
          ...
          public void unregisterConversationListener(IConversationListener iConversationListener) {
            ...
            PeopleService.this.mConversationListenerHelper.removeConversationListener(
  ...
  public final int handleIncomingUser(int i) {
    try {
      return ActivityManager.getService()
          .handleIncomingUser(
              Binder.getCallingPid(), Binder.getCallingUid(), i, true, true, "", (String) null);
  ...
  public final void checkCallerIsSameApp(String str) {
    int callingUid = Binder.getCallingUid();
    if (this.mPackageManagerInternal.getPackageUid(str, 0L, UserHandle.getUserId(callingUid))
        == callingUid) {
      return;
    }
    throw new SecurityException(
        "Calling uid " + callingUid + " cannot query eventsfor package " + str);
  }
  ...
  public class ConversationListenerHelper implements ConversationsListener {
    ...
    public synchronized void addConversationListener(
        ListenerKey listenerKey, IConversationListener iConversationListener) {
      ...
      for (int i = 0; i < beginBroadcast; i++) {
        ...
        if (hashMap.containsKey(listenerKey)) {
          try {
            this.mListeners
                .getBroadcastItem(i)
                .onConversationUpdate((ConversationChannel) hashMap.get(listenerKey));
          } catch (RemoteException unused) {
          }
        }
      }
  ...
  public class ListenerKey {
    ...
    public boolean equals(Object obj) {
      ...
      return listenerKey.getPackageName().equals(this.mPackageName)
          && Objects.equals(listenerKey.getUserId(), this.mUserId)
          && listenerKey.getShortcutId().equals(this.mShortcutId);
    }
  ...
  final class LocalService extends PeopleServiceInternal {
    ...
    public void onCreatePredictionSession(
        AppPredictionContext appPredictionContext, AppPredictionSessionId appPredictionSessionId) {
      this.mSessions.put(
          appPredictionSessionId,
          new SessionInfo(
              appPredictionContext,
              PeopleService.this.mDataManager,
              appPredictionSessionId.getUserId(),
              PeopleService.this.getContext()));
    }

    public void notifyAppTargetEvent(
        AppPredictionSessionId appPredictionSessionId, final AppTargetEvent appTargetEvent) {
      runForSession(
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda6
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PeopleService.LocalService.lambda$notifyAppTargetEvent$0(
                  appTargetEvent, (SessionInfo) obj);
            }
          });
    }

    public static /* synthetic */ void lambda$notifyAppTargetEvent$0(
        AppTargetEvent appTargetEvent, SessionInfo sessionInfo) {
    ...
    public void notifyLaunchLocationShown(
      ...
      runForSession(
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PeopleService.LocalService.lambda$notifyLaunchLocationShown$1(
                  str, parceledListSlice, (SessionInfo) obj);
            }
          });
    }

    public static /* synthetic */ void lambda$notifyLaunchLocationShown$1(
        String str, ParceledListSlice parceledListSlice, SessionInfo sessionInfo) {
    ...
    public void sortAppTargets(
      ...
      runForSession(
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PeopleService.LocalService.this.lambda$sortAppTargets$3(
                  parceledListSlice, iPredictionCallback, (SessionInfo) obj);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sortAppTargets$3(
      ...
      sessionInfo
          ...
          .onSortAppTargets(
              ...
              new Consumer() { // from class:
                // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda7
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                  PeopleService.LocalService.this.lambda$sortAppTargets$2(
                      iPredictionCallback, (List) obj);
                }
              });
    }
    ...
    public void registerPredictionUpdates(
      ...
      runForSession(
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void unregisterPredictionUpdates(
      ...
      runForSession(
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void requestPredictionUpdate(AppPredictionSessionId appPredictionSessionId) {
      runForSession(
          appPredictionSessionId,
          new Consumer() { // from class:
            // com.android.server.people.PeopleService$LocalService$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onDestroyPredictionSession(final AppPredictionSessionId appPredictionSessionId) {
      runForSession(
          ...
          new Consumer() { // from class:
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              PeopleService.LocalService.this.lambda$onDestroyPredictionSession$7(
                  appPredictionSessionId, (SessionInfo) obj);
            }
          });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onDestroyPredictionSession$7(
        AppPredictionSessionId appPredictionSessionId, SessionInfo sessionInfo) {
