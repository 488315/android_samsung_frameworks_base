...
public class WallpaperEffectsGenerationManagerService extends AbstractMasterSystemService {
  ...
  public WallpaperEffectsGenerationManagerService(Context context) {
    super(
        context,
        new FrameworkResourcesServiceNameResolver(context, R.string.default_audio_route_name),
        null,
        17);
  ...
  public void enforceCallingPermissionForManagement() {
    getContext()
        .enforceCallingPermission("android.permission.MANAGE_WALLPAPER_EFFECTS_GENERATION", TAG);
  }
  ...
  public class WallpaperEffectsGenerationManagerStub
    ...
    public void generateCinematicEffect(
          ...
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              ((WallpaperEffectsGenerationPerUserService) obj)
                  .onGenerateCinematicEffectLocked(
                      cinematicEffectRequest, iCinematicEffectListener);
            }
          })) {
        return;
      }
      try {
        iCinematicEffectListener.onCinematicEffectGenerated(
            new CinematicEffectResponse.Builder(0, cinematicEffectRequest.getTaskId()).build());
      } catch (RemoteException unused) {
      }
    }

    public void returnCinematicEffectResponse(
      ...
      runForUser(
          ...
          new Consumer() { // from class:
            ...
            public final void accept(Object obj) {
              ((WallpaperEffectsGenerationPerUserService) obj)
                  .onReturnCinematicEffectResponseLocked(cinematicEffectResponse);
            }
          });
    }
    ...
    public final boolean runForUser(String str, boolean z, Consumer consumer) {
      ...
      if (z
          && WallpaperEffectsGenerationManagerService.this
                  .getContext()
                  .checkCallingPermission("android.permission.MANAGE_WALLPAPER_EFFECTS_GENERATION")
              != 0
          && !WallpaperEffectsGenerationManagerService.this.mServiceNameResolver.isTemporary(
              handleIncomingUser)
        ...
        synchronized (WallpaperEffectsGenerationManagerService.this.mLock) {
          WallpaperEffectsGenerationPerUserService wallpaperEffectsGenerationPerUserService =
              (WallpaperEffectsGenerationPerUserService)
                  WallpaperEffectsGenerationManagerService.this.getServiceForUserLocked(
                      handleIncomingUser);
          if (wallpaperEffectsGenerationPerUserService != null) {
