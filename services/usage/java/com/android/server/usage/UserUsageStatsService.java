...
public class UserUsageStatsService {
  ...
  public static final UsageStatsDatabase.StatCombiner sUsageStatsCombiner =
      new UsageStatsDatabase
          .StatCombiner() { // from class: com.android.server.usage.UserUsageStatsService.1
  ...
  public static final UsageStatsDatabase.StatCombiner sConfigStatsCombiner =
      new UsageStatsDatabase
          .StatCombiner() { // from class: com.android.server.usage.UserUsageStatsService.2
        @Override // com.android.server.usage.UsageStatsDatabase.StatCombiner
        public boolean combine(IntervalStats intervalStats, boolean z, List list) {
          if (!z) {
          ...
          for (int i = 0; i < size; i++) {
            list.add(
                new ConfigurationStats(
                    (ConfigurationStats) intervalStats.configurations.valueAt(i)));
          }
          return true;
        }
      };
  public static final UsageStatsDatabase.StatCombiner sEventStatsCombiner =
      new UsageStatsDatabase
          .StatCombiner() { // from class: com.android.server.usage.UserUsageStatsService.3
        @Override // com.android.server.usage.UsageStatsDatabase.StatCombiner
        public boolean combine(IntervalStats intervalStats, boolean z, List list) {
  ...
  public void init(long j, HashMap hashMap, boolean z) {
    ...
    if (intervalStats != null) {
      UsageEvents.Event event =
          new UsageEvents.Event(26, Math.max(intervalStats.lastTimeSaved, intervalStats.endTime));
  ...
  public boolean updatePackageMappingsLocked(HashMap hashMap) {
    ...
    for (int size = this.mDatabase.mPackagesTokenData.packagesToTokensMap.size() - 1;
        size >= 0;
        size--) {
    ...
    for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
      this.mDatabase.mPackagesTokenData.removePackage(
          (String) arrayList.get(size2), currentTimeMillis);
    }
    try {
    ...
    this.track.forEach(
        new BiConsumer() { // from class:
          ...
          public final void accept(Object obj, Object obj2) {
            UserUsageStatsService.this.lambda$onTimeChanged$1(
                j2, j, (String) obj, (ArrayList) obj2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onTimeChanged$1(
      final long j, final long j2, String str, ArrayList arrayList) {
  ...
  public static /* synthetic */ void lambda$onTimeChanged$0(
      ArrayList arrayList, long j, long j2, Long l) {
  ...
  public final long checkAndGetTimeLocked() {
    ...
    if (Math.abs(j2) > 2000) {
      Slog.i(
          "UsageStatsService", this.mLogPrefix + "Time changed in by " + (j2 / 1000) + " seconds");
  ...
  */
  public void reportEvent(UsageEvents.Event event) {
    ...
    boolean z = true;
    if (event.mEventType == 19 && !TextUtils.isEmpty(event.mPackage)) {
      ArrayList arrayList = (ArrayList) this.track.get(event.mPackage);
      if (arrayList == null) {
        arrayList = new ArrayList();
        this.track.put(event.mPackage, arrayList);
      }
      while (arrayList.size() > 0
          && ((Long) arrayList.get(0)).longValue()
              <= event.mTimeStamp - TimeUnit.HOURS.toMillis(3L)) {
        ((Long) arrayList.remove(0)).longValue();
      }
      arrayList.add(Long.valueOf(event.mTimeStamp));
      if (arrayList.size() >= 10000) {
        removeForegroundEvents(event.mPackage, ((Long) arrayList.get(0)).longValue());
        Slog.d(
            "UsageStatsService",
            "remove after "
                + sLoggingFormat.format(new Date(((Long) arrayList.get(0)).longValue())));
        arrayList.clear();
  ...
  public final List queryStats(
      int i, long j, long j2, UsageStatsDatabase.StatCombiner statCombiner) {
    ...
    if (i2 >= 0) {
      ...
      if (i2 < intervalStatsArr.length) {
        ...
        list =
            this.mDatabase.queryUsageStats(
                i2, j, Math.min(intervalStats.beginTime, j2), statCombiner);
  ...
  public UsageEvents queryEvents(final long j, final long j2, final int i) {
    ...
    List queryStats =
        queryStats(
            ...
            j2,
            new UsageStatsDatabase
                .StatCombiner() { // from class: com.android.server.usage.UserUsageStatsService.4
              @Override // com.android.server.usage.UsageStatsDatabase.StatCombiner
              public boolean combine(IntervalStats intervalStats, boolean z, List list) {
                int size = intervalStats.events.size();
                for (int firstIndexOnOrAfter = intervalStats.events.firstIndexOnOrAfter(j);
        ...
        queryStats(
            ...
            new UsageStatsDatabase
              ...
              public final boolean combine(IntervalStats intervalStats, boolean z, List list) {
                ...
                lambda$queryEarliestAppEvents$2 =
                    UserUsageStatsService.lambda$queryEarliestAppEvents$2(
                        j, j2, arraySet2, arraySet, i, intervalStats, z, list);
  ...
  public static /* synthetic */ boolean lambda$queryEarliestAppEvents$2(
      long j,
      long j2,
      ArraySet arraySet,
      ArraySet arraySet2,
        ...
        queryStats(
            ...
            new UsageStatsDatabase
              ...
              public final boolean combine(IntervalStats intervalStats, boolean z2, List list) {
                ...
                lambda$queryEventsForPackage$3 =
                    UserUsageStatsService.lambda$queryEventsForPackage$3(
                        j, j2, str, arraySet, z, intervalStats, z2, list);
  ...
  public static /* synthetic */ boolean lambda$queryEventsForPackage$3(
      long j,
      long j2,
      String str,
      ArraySet arraySet,
  ...
  public UsageEvents queryEarliestEventsForPackage(
      long j, final long j2, final String str, final int i) {
    long j3;
    ...
    if (cachedEarlyEvents2 == null) {
      ...
      if (cachedEarlyEvents2.searchBeginTime <= j && j <= cachedEarlyEvents2.eventTime) {
        ...
        if (size == 0
            || ((UsageEvents.Event) cachedEarlyEvents2.events.get(size - 1)).getEventType() != i) {
          ...
          if (j4 < j2) {
                ...
                queryStats(
                    ...
                    new UsageStatsDatabase
                      ...
                      public final boolean combine(
                        ...
                        lambda$queryEarliestEventsForPackage$4 =
                            UserUsageStatsService.lambda$queryEarliestEventsForPackage$4(
                                j5, j2, str, i, intervalStats, z, list2);
            ...
            cachedEarlyEvents.eventTime =
                ((UsageEvents.Event) queryStats.get(queryStats.size() - 1)).getTimeStamp();
        ...
        queryStats(
            ...
            new UsageStatsDatabase
              ...
              public final boolean combine(IntervalStats intervalStats, boolean z, List list2) {
                ...
                lambda$queryEarliestEventsForPackage$4 =
                    UserUsageStatsService.lambda$queryEarliestEventsForPackage$4(
                        j52, j2, str, i, intervalStats, z, list2);
                return lambda$queryEarliestEventsForPackage$4;
              }
            });
    if (queryStats != null) {}
  ...
  public static /* synthetic */ boolean lambda$queryEarliestEventsForPackage$4(
      long j, long j2, String str, int i, IntervalStats intervalStats, boolean z, List list) {
    int size = intervalStats.events.size();
    for (int firstIndexOnOrAfter = intervalStats.events.firstIndexOnOrAfter(j);
        firstIndexOnOrAfter < size;
        firstIndexOnOrAfter++) {
  ...
  public final void rolloverStats(long j) {
      ...
      while (i6 < size) {
        ...
        if (usageStats2.mActivities.size() > 0 || !usageStats2.mForegroundServices.isEmpty()) {
          if (usageStats2.mActivities.size() > 0) {
            ...
            intervalStats2.update(
                usageStats2.mPackageName, null, this.mDailyExpiryDate.getTimeInMillis() - 1, 3, 0);
          ...
          if (!usageStats.mForegroundServices.isEmpty()) {
            ...
            intervalStats.update(
                usageStats.mPackageName, null, this.mDailyExpiryDate.getTimeInMillis() - 1, 22, 0);
          }
    ...
    for (int i7 = 0; i7 < size2; i7++) {
      ...
      while (i8 < length2) {
        ...
        if (arrayMap.containsKey(str)) {
          ...
          while (i9 < size3) {
            long j4 = j3;
            intervalStats4.update(
                str, null, j4, sparseIntArray.valueAt(i9), sparseIntArray.keyAt(i9));
            i9++;
        ...
        if (arrayMap2.containsKey(str)) {
          ...
          for (int i12 = 0; i12 < size4; i12++) {
            intervalStats5.update(
                str,
                (String) arrayMap3.keyAt(i12),
                j5,
                ((Integer) arrayMap3.valueAt(i12)).intValue(),
                0);
          }
        }
    ...
    Slog.i(
        "UsageStatsService",
        this.mLogPrefix
            + "Rolling over usage stats complete. Took "
  ...
  public final void updateRolloverDeadline() {
    ...
    Slog.i(
        ...
        this.mLogPrefix
            + "Rollover scheduled @ "
            + sDateFormat.format(Long.valueOf(this.mDailyExpiryDate.getTimeInMillis()))
            + "("
            + this.mDailyExpiryDate.getTimeInMillis()
            + ")");
  }
  ...
  public void checkin(final IndentingPrintWriter indentingPrintWriter) {
    this.mDatabase.checkinDailyFiles(
        new UsageStatsDatabase
            .CheckinAction() { // from class: com.android.server.usage.UserUsageStatsService.5
          @Override // com.android.server.usage.UsageStatsDatabase.CheckinAction
          public boolean checkin(IntervalStats intervalStats) {
            UserUsageStatsService.this.printIntervalStats(
                indentingPrintWriter, intervalStats, false, false, null);
            return true;
          }
        });
  }
    ...
    try {
      ...
      try {
        IntervalStats readIntervalStatsForFile =
            this.mDatabase.readIntervalStatsForFile(
                stringToInterval, Long.valueOf(strArr[1]).longValue());
        if (readIntervalStatsForFile == null) {
          indentingPrintWriter.println("the specified filename does not exist.");
        } else {
          dumpFileDetails(
              indentingPrintWriter, readIntervalStatsForFile, Long.valueOf(strArr[1]).longValue());
        }
  ...
  public final void dumpFileDetailsForInterval(IndentingPrintWriter indentingPrintWriter, int i) {
    ...
    for (int i2 = 0; i2 < size; i2++) {
      ...
      dumpFileDetails(
          indentingPrintWriter, this.mDatabase.readIntervalStatsForFile(i, keyAt), keyAt);
  ...
  public void printLast24HrEvents(
      IndentingPrintWriter indentingPrintWriter, boolean z, final List list) {
    ...
    List queryStats =
        queryStats(
            ...
            currentTimeMillis,
            new UsageStatsDatabase
                .StatCombiner() { // from class: com.android.server.usage.UserUsageStatsService.6
              @Override // com.android.server.usage.UsageStatsDatabase.StatCombiner
              public boolean combine(IntervalStats intervalStats, boolean z2, List list2) {
                int size = intervalStats.events.size();
                for (int firstIndexOnOrAfter =
                        intervalStats.events.firstIndexOnOrAfter(timeInMillis);
                    firstIndexOnOrAfter < size;
                    firstIndexOnOrAfter++) {
    ...
    if (z) {
      indentingPrintWriter.printPair(
          "timeRange",
          "\""
              + DateUtils.formatDateRange(this.mContext, timeInMillis, currentTimeMillis, 131093)
              + "\"");
    } else {
    ...
    indentingPrintWriter.printPair(
        "mDumpInitLastTimeSaved", formatDateTime(this.mDumpInitLastTimeSaved, z));
    indentingPrintWriter.printPair("mDumpInitEndTime", formatDateTime(this.mDumpInitEndTime, z));
    indentingPrintWriter.println();
  }

  public void printEventAggregation(
  ...
  public void printIntervalStats(
      ...
      indentingPrintWriter.printPair(
          ...
          "\""
              + DateUtils.formatDateRange(
                  this.mContext, intervalStats.beginTime, intervalStats.endTime, 131093)
              + "\"");
    } else {
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (CollectionUtils.isEmpty(list) || list.contains(usageStats2.mPackageName)) {
        ...
        indentingPrintWriter.printPair(
            "totalTimeUsed", formatElapsedTime(usageStats2.mTotalTimeInForeground, z));
        indentingPrintWriter.printPair(
            "lastTimeUsed", formatDateTime(usageStats2.mLastTimeUsed, z));
        indentingPrintWriter.printPair(
            "totalTimeVisible", formatElapsedTime(usageStats2.mTotalTimeVisible, z));
        indentingPrintWriter.printPair(
            "lastTimeVisible", formatDateTime(usageStats2.mLastTimeVisible, z));
        indentingPrintWriter.printPair(
            "lastTimeComponentUsed", formatDateTime(usageStats2.mLastTimeComponentUsed, z));
        indentingPrintWriter.printPair(
            "totalTimeFS", formatElapsedTime(usageStats2.mTotalTimeForegroundServiceUsed, z));
        indentingPrintWriter.printPair(
            "lastTimeFS", formatDateTime(usageStats2.mLastTimeForegroundServiceUsed, z));
        indentingPrintWriter.printPair(
            "appLaunchCount", Integer.valueOf(usageStats2.mAppLaunchCount));
        indentingPrintWriter.println();
      }
    }
    indentingPrintWriter.decreaseIndent();
    ...
    if (CollectionUtils.isEmpty(list)) {
      ...
      for (int i4 = 0; i4 < size4; i4++) {
        ...
        indentingPrintWriter.printPair(
            "config", Configuration.resourceQualifierString(configurationStats.mConfiguration));
        indentingPrintWriter.printPair(
      ...
      printEventAggregation(
          indentingPrintWriter, "screen-interactive", intervalStats.interactiveTracker, z);
      printEventAggregation(
          indentingPrintWriter, "screen-non-interactive", intervalStats.nonInteractiveTracker, z);
      printEventAggregation(
          indentingPrintWriter, "keyguard-shown", intervalStats.keyguardShownTracker, z);
      printEventAggregation(
          indentingPrintWriter, "keyguard-hidden", intervalStats.keyguardHiddenTracker, z);
      indentingPrintWriter.decreaseIndent();
    }
    if (!z2) {
