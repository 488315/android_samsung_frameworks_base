    ...
    */
        ...
        if (this.mAppIdleEnabled) {
            synchronized (this.mAppIdleLock) {
                ...
                if (i10 == i2 && z6 && z7) {
                    ...
                    int i14 = (appUsageHistory.bucketingReason & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT) | FrameworkStatsLog.APP_STANDBY_BUCKET_CHANGED__MAIN_REASON__MAIN_FORCED_BY_SYSTEM | (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT);
                ...
                if (i2 == 45) {
                    ...
                    this.mAppIdleHistory.noteRestrictionAttempt(str, i, j, i3);
                    if (z10) {
                        if (Build.IS_DEBUGGABLE && (i3 & IDnsResolverUnsolicitedEventListener.DNS_HEALTH_RESULT_TIMEOUT) != 2) {
                            z2 = false;
                            Toast.makeText(this.mContext, this.mHandler.getLooper(), this.mContext.getResources().getString(R.string.config_batterymeterBoltPath, str), 0).show();
                        } else {
                            z2 = false;
    ...
    public final boolean isDeviceProvisioningPackage(String str) {
        if (this.mCachedDeviceProvisioningPackage == null) {
            this.mCachedDeviceProvisioningPackage = this.mContext.getResources().getString(R.string.default_notification_channel_label);
        }
    ...
    public class Injector {
        ...
        public boolean isAppIdleEnabled() {
            return this.mContext.getResources().getBoolean(R.bool.config_dozeAlwaysOnDisplayAvailable) && (Settings.Global.getInt(this.mContext.getContentResolver(), "app_standby_enabled", 1) == 1 && Settings.Global.getInt(this.mContext.getContentResolver(), "adaptive_battery_management_enabled", 1) == 1);
        }
