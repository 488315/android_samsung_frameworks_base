...
public class AppTimeLimitController {
  ...
  public abstract class UsageGroup {
    ...
    public void onLimitReached() {
      ...
      AppTimeLimitController.this.mListener.onLimitReached(
          this.mObserverId,
          userData.userId,
          this.mTimeLimitMs,
          this.mUsageTimeMs,
          this.mLimitReachedCallback);
    }
  ...
  public class SessionUsageGroup extends UsageGroup implements AlarmManager.OnAlarmListener {
    ...
    public void noteUsageStop(long j) {
      ...
      AppTimeLimitController.this
          ...
          .setExact(
              3,
              this.mNewSessionThresholdMs + AppTimeLimitController.this.getElapsedRealtime(),
              "AppTimeLimitController",
              this,
    ...
    public void onSessionEnd() {
      ...
      AppTimeLimitController.this.mListener.onSessionEnd(
          this.mObserverId, userData.userId, this.mUsageTimeMs, this.mSessionEndCallback);
    }
  ...
  public AppTimeLimitController(
      Context context, TimeLimitCallbackListener timeLimitCallbackListener, Looper looper) {
    ...
    synchronized (this.mLock) {
      ...
      if (arrayList != null && !arrayList.isEmpty()) {
        ...
        return new UsageStatsManagerInternal.AppUsageLimitData(
            appUsageLimitGroup2.getTotaUsageLimit(), appUsageLimitGroup2.getUsageRemaining());
      }
      return null;
    }
  }
  ...
  public void addAppUsageObserver(
    ...
    synchronized (this.mLock) {
      ...
      AppUsageGroup appUsageGroup =
          (AppUsageGroup) orCreateObserverAppDataLocked.appUsageGroups.get(i2);
      ...
      AppUsageGroup appUsageGroup2 =
          new AppUsageGroup(
              orCreateUserDataLocked, orCreateObserverAppDataLocked, i2, strArr, j, pendingIntent);
  ...
  public void addUsageSessionObserver(
      int i,
      int i2,
      String[] strArr,
      long j,
    ...
    synchronized (this.mLock) {
      ...
      ObserverAppData orCreateObserverAppDataLocked = getOrCreateObserverAppDataLocked(i);
      SessionUsageGroup sessionUsageGroup =
          (SessionUsageGroup) orCreateObserverAppDataLocked.sessionUsageGroups.get(i2);
      if (sessionUsageGroup != null) {
        sessionUsageGroup.remove();
      }
      if (orCreateObserverAppDataLocked.sessionUsageGroups.size()
          >= getUsageSessionObserverPerUidLimit()) {
        throw new IllegalStateException("Too many app usage observers added by uid " + i);
      }
      SessionUsageGroup sessionUsageGroup2 =
  ...
  public void addAppUsageLimitObserver(
    ...
    synchronized (this.mLock) {
      ...
      ObserverAppData orCreateObserverAppDataLocked = getOrCreateObserverAppDataLocked(i);
      AppUsageLimitGroup appUsageLimitGroup =
          (AppUsageLimitGroup) orCreateObserverAppDataLocked.appUsageLimitGroups.get(i2);
      if (appUsageLimitGroup != null) {
        appUsageLimitGroup.remove();
      }
      if (orCreateObserverAppDataLocked.appUsageLimitGroups.size()
          >= getAppUsageLimitObserverPerUidLimit()) {
        throw new IllegalStateException("Too many app usage observers added by uid " + i);
      }
      AppUsageLimitGroup appUsageLimitGroup2 =
  ...
  public void noteUsageStart(String str, int i, long j) {
    ...
    synchronized (this.mLock) {
      ...
      if (indexOfKey >= 0
          && (num = (Integer) orCreateUserDataLocked.currentlyActive.valueAt(indexOfKey)) != null) {
  ...
  public void noteUsageStop(String str, int i) {
    synchronized (this.mLock) {
      ...
      if (!((Integer) orCreateUserDataLocked.currentlyActive.valueAt(indexOfKey)).equals(ONE)) {
        orCreateUserDataLocked.currentlyActive.setValueAt(
            indexOfKey, Integer.valueOf(r2.intValue() - 1));
        return;
      }
