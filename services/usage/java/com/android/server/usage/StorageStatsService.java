...
public class StorageStatsService extends IStorageStatsManager.Stub {
    ...
    public final HandlerC2720H mHandler;
    ...
    public StorageStatsService(Context context) {
        ...
        installer.onStart();
        invalidateMounts();
        HandlerC2720H handlerC2720H = new HandlerC2720H(IoThread.get().getLooper());
        this.mHandler = handlerC2720H;
        handlerC2720H.sendEmptyMessage(101);
    ...
    public class HandlerC2720H extends Handler {
        public long mPreviousBytes;
        public final StatFs mStats;
        public long mTotalBytes;

        public HandlerC2720H(Looper looper) {
            super(looper);
