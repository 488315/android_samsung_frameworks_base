...
public class UsageStatsService extends SystemService implements UserUsageStatsService.StatsUpdatedListener {
    ...
    public void onStart() {
        ...
        this.mHandler = new HandlerC2725H(BackgroundThread.get().getLooper());
    ...
    */
    public void reportEvent(UsageEvents.Event event, int i) {
        ...
        String str;
        if (!CoreRune.SYSFW_APP_SPEG || (packageManager = this.mPackageManager) == null || (str = event.mPackage) == null || !packageManager.isSpeg(str, i)) {
            ...
            if (str2 != null && isInstantApp(str2, i)) {
                event.mFlags |= 1;
            }
            synchronized (this.mLock) {
                if (!this.mUserUnlockedStates.contains(Integer.valueOf(i))) {
                ...
                if (i3 == 1) {
                    ...
                    ActivityData activityData2 = (ActivityData) this.mVisibleActivities.get(event.mInstanceId);
                    ...
                    synchronized (this.mUsageEventListeners) {
                        ...
                        for (int i5 = 0; i5 < size2; i5++) {
                            ((UsageStatsManagerInternal.UsageEventListener) this.mUsageEventListeners.valueAt(i5)).onUsageEvent(i, event);
                        }
                    }
                    return;
                }
    ...
    */
    ...
    public class HandlerC2725H extends Handler {
        public HandlerC2725H(Looper looper) {
            super(looper);
        }
