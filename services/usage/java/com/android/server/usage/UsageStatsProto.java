...
public abstract class UsageStatsProto {
  ...
  public static void loadUsageStats(
      ProtoInputStream protoInputStream, long j, IntervalStats intervalStats, List list) {
    ...
    while (protoInputStream.nextField() != -1) {
      switch (protoInputStream.getFieldNumber()) {
        case 1:
          orCreateUsageStats =
              intervalStats.getOrCreateUsageStats(protoInputStream.readString(1138166333441L));
        ...
        case 3:
          usageStats.mLastTimeUsed =
              intervalStats.beginTime + protoInputStream.readLong(1112396529667L);
          continue;
        case 4:
        ...
        case 8:
          usageStats.mLastTimeForegroundServiceUsed =
              intervalStats.beginTime + protoInputStream.readLong(1112396529672L);
          continue;
        case 9:
        ...
        case 10:
          usageStats.mLastTimeVisible =
              intervalStats.beginTime + protoInputStream.readLong(1112396529674L);
          continue;
        case 11:
        ...
        case 12:
          usageStats.mLastTimeComponentUsed =
              intervalStats.beginTime + protoInputStream.readLong(1112396529676L);
          continue;
      }
      usageStats = orCreateUsageStats;
    }
  ...
  public static void loadConfigStats(
      ProtoInputStream protoInputStream, long j, IntervalStats intervalStats) {
  ...
  public static void writeStringPool(
      ProtoOutputStream protoOutputStream, IntervalStats intervalStats) {
  ...
  public static void writeUsageStats(
    ...
    UsageStatsProtoV2.writeOffsetTimestamp(
        protoOutputStream, 1112396529667L, usageStats.mLastTimeUsed, intervalStats.beginTime);
    ...
    UsageStatsProtoV2.writeOffsetTimestamp(
        protoOutputStream, 1112396529674L, usageStats.mLastTimeVisible, intervalStats.beginTime);
  ...
  public static void write(OutputStream outputStream, IntervalStats intervalStats) {
    ...
    protoOutputStream.write(
        1112396529665L,
        UsageStatsProtoV2.getOffsetTimestamp(intervalStats.endTime, intervalStats.beginTime));
    ...
    for (int i = 0; i < size; i++) {
      try {
        writeUsageStats(
            ...
            2246267895828L,
            intervalStats,
            (UsageStats) intervalStats.packageStats.valueAt(i));
