...
public final class FieldClassificationStrategy {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
              ...
              synchronized (FieldClassificationStrategy.this.mLock) {
                FieldClassificationStrategy.this.mRemoteService =
                    IAutofillFieldClassificationService.Stub.asInterface(iBinder);
                if (FieldClassificationStrategy.this.mQueuedCommands != null) {
                  ...
                  for (int i = 0; i < size; i++) {
                    Command command2 =
                        (Command) FieldClassificationStrategy.this.mQueuedCommands.get(i);
                    try {
                      if (Helper.sVerbose) {
                      ...
                      Slog.w(
                          "FieldClassificationStrategy",
                          "exception calling " + componentName + ": " + e2);
                    }
                  }
  ...
  public String[] getAvailableAlgorithms() {
    return (String[])
        getMetadataValue(
            ...
            new MetadataParser() { // from class:
              // com.android.server.autofill.FieldClassificationStrategy$$ExternalSyntheticLambda0
  ...
  public String getDefaultAlgorithm() {
    return (String)
        getMetadataValue(
            ...
            new MetadataParser() { // from class:
              // com.android.server.autofill.FieldClassificationStrategy$$ExternalSyntheticLambda1
              @Override // com.android.server.autofill.FieldClassificationStrategy.MetadataParser
              public final Object get(Resources resources, int i) {
                String string;
  ...
  public final Object getMetadataValue(String str, MetadataParser metadataParser) {
    ...
    try {
      return metadataParser.get(
          this.mContext.getPackageManager().getResourcesForApplication(serviceInfo.applicationInfo),
          serviceInfo.metaData.getInt(str));
  ...
  public void calculateScores(
      ...
      final ArrayMap arrayMap2) {
    connectAndRun(
        new Command() { // from class:
          // com.android.server.autofill.FieldClassificationStrategy$$ExternalSyntheticLambda2
          @Override // com.android.server.autofill.FieldClassificationStrategy.Command
          public final void run(
              IAutofillFieldClassificationService iAutofillFieldClassificationService) {
            iAutofillFieldClassificationService.calculateScores(
                remoteCallback, list, strArr, strArr2, str, bundle, arrayMap, arrayMap2);
          }
        });
  }
