...
public final class FillRequestEventLogger {
  ...
  public void maybeSetAutofillServiceUid(final int i) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda7
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void maybeSetInlineSuggestionHostUid(final Context context, final int i) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda5
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            FillRequestEventLogger.lambda$maybeSetInlineSuggestionHostUid$2(
                context, i, (FillRequestEventLogger.FillRequestEventInternal) obj);
          }
        });
  }

  public static /* synthetic */ void lambda$maybeSetInlineSuggestionHostUid$2(
      Context context, int i, FillRequestEventInternal fillRequestEventInternal) {
  ...
  public void maybeSetFlags(final int i) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda1
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void maybeSetRequestTriggerReason(final int i) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda4
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void maybeSetIsAugmented(final boolean z) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda2
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void maybeSetIsFillDialogEligible(final boolean z) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda8
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void maybeSetLatencyFillRequestSentMillis(final int i) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda0
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
            ((FillRequestEventLogger.FillRequestEventInternal) obj).mLatencyFillRequestSentMillis =
                i;
          }
        });
  }
  ...
  public void maybeSetAppPackageUid(final int i) {
    this.mEventInternal.ifPresent(
        new Consumer() { // from class:
          // com.android.server.autofill.FillRequestEventLogger$$ExternalSyntheticLambda6
          @Override // java.util.function.Consumer
          public final void accept(Object obj) {
  ...
  public void logAndEndEvent() {
    ...
    if (Helper.sVerbose) {
      Slog.v(
          "FillRequestEventLogger",
          "Log AutofillFillRequestReported: requestId="
              ...
              + " mIsClientSuggestionFallback="
              + fillRequestEventInternal.mIsClientSuggestionFallback
              + " mIsFillDialogEligible="
              + fillRequestEventInternal.mIsFillDialogEligible
              + " mRequestTriggerReason="
