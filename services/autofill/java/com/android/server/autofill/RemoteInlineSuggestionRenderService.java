...
public final class RemoteInlineSuggestionRenderService
  ...
  public RemoteInlineSuggestionRenderService(
      Context context,
      ComponentName componentName,
      String str,
      int i,
      InlineSuggestionRenderCallbacks inlineSuggestionRenderCallbacks,
      boolean z,
      boolean z2) {
    super(
        context,
        ...
        componentName,
        i,
        inlineSuggestionRenderCallbacks,
  ...
  public void renderSuggestion(
      final IInlineSuggestionUiCallback iInlineSuggestionUiCallback,
    ...
    scheduleAsyncRequest(
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.autofill.RemoteInlineSuggestionRenderService$$ExternalSyntheticLambda1
          public final void run(IInterface iInterface) {
            ((IInlineSuggestionRenderService) iInterface)
                .renderSuggestion(
                    iInlineSuggestionUiCallback, inlinePresentation, i, i2, iBinder, i3, i4, i5);
          }
        });
  }
  ...
  public void getInlineSuggestionsRendererInfo(final RemoteCallback remoteCallback) {
    scheduleAsyncRequest(
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.autofill.RemoteInlineSuggestionRenderService$$ExternalSyntheticLambda2
          public final void run(IInterface iInterface) {
            ((IInlineSuggestionRenderService) iInterface)
  ...
  public void destroySuggestionViews(final int i, final int i2) {
    scheduleAsyncRequest(
        new AbstractRemoteService.AsyncRequest() { // from class:
          // com.android.server.autofill.RemoteInlineSuggestionRenderService$$ExternalSyntheticLambda0
          public final void run(IInterface iInterface) {
  ...
  public static ServiceInfo getServiceInfo(Context context, int i) {
    ...
    ResolveInfo resolveServiceAsUser =
        context.getPackageManager().resolveServiceAsUser(intent, 132, i);
