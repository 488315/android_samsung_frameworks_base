...
final class RemoteAugmentedAutofillService extends ServiceConnector.Impl {
  ...
  public RemoteAugmentedAutofillService(
      Context context,
      int i,
      ComponentName componentName,
      int i2,
      RemoteAugmentedAutofillServiceCallbacks remoteAugmentedAutofillServiceCallbacks,
      boolean z,
      boolean z2,
      int i3,
      int i4) {
    super(
        context,
        new Intent("android.service.autofill.augmented.AugmentedAutofillService")
            .setComponent(componentName),
        z ? 4194304 : 0,
        i2,
        new Function() { // from class:
          // com.android.server.autofill.RemoteAugmentedAutofillService$$ExternalSyntheticLambda1
  ...
  public void onServiceConnectionStatusChanged(
      IAugmentedAutofillService iAugmentedAutofillService, boolean z) {
    try {
      if (z) {
  ...
  public void onRequestAutofillLocked(
      final int i,
      final IAutoFillManagerClient iAutoFillManagerClient,
      final int i2,
      final ComponentName componentName,
      final IBinder iBinder,
      final AutofillId autofillId,
      final AutofillValue autofillValue,
      final InlineSuggestionsRequest inlineSuggestionsRequest,
      final Function function,
      final Runnable runnable,
      final RemoteInlineSuggestionRenderService remoteInlineSuggestionRenderService,
      final int i3) {
    final long elapsedRealtime = SystemClock.elapsedRealtime();
    final AtomicReference atomicReference = new AtomicReference();
    postAsync(
            new ServiceConnector.Job() { // from class:
              // com.android.server.autofill.RemoteAugmentedAutofillService$$ExternalSyntheticLambda3
              public final Object run(Object obj) {
                CompletableFuture lambda$onRequestAutofillLocked$0;
                lambda$onRequestAutofillLocked$0 =
                    RemoteAugmentedAutofillService.this.lambda$onRequestAutofillLocked$0(
                        ...
                        iBinder,
                        atomicReference,
                        (IAugmentedAutofillService) obj);
                return lambda$onRequestAutofillLocked$0;
              }
            })
        .orTimeout(this.mRequestTimeoutMs, TimeUnit.MILLISECONDS)
        .whenComplete(
            new BiConsumer() { // from class:
              // com.android.server.autofill.RemoteAugmentedAutofillService$$ExternalSyntheticLambda4
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
                RemoteAugmentedAutofillService.this.lambda$onRequestAutofillLocked$1(
                    atomicReference, componentName, i, (Void) obj, (Throwable) obj2);
              }
            });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ CompletableFuture lambda$onRequestAutofillLocked$0(
      final IAutoFillManagerClient iAutoFillManagerClient,
      final int i,
      final int i2,
      final ComponentName componentName,
      ...
      final IAugmentedAutofillService iAugmentedAutofillService) {
    final AndroidFuture androidFuture = new AndroidFuture();
    iAutoFillManagerClient.getAugmentedAutofillClient(
        new IResultReceiver
            .Stub() { // from class: com.android.server.autofill.RemoteAugmentedAutofillService.1
          public void send(int i4, Bundle bundle) {
            iAugmentedAutofillService.onFillRequest(
                i,
                bundle.getBinder("android.view.autofill.extra.AUGMENTED_AUTOFILL_CLIENT"),
                i2,
                componentName,
                autofillId,
                autofillValue,
                j,
                inlineSuggestionsRequest,
                new IFillCallback.Stub() { // from class:
                  // com.android.server.autofill.RemoteAugmentedAutofillService.1.1
                  public void onSuccess(List list, Bundle bundle2, boolean z) {
                    RemoteAugmentedAutofillService.this.mCallbacks.resetLastResponse();
                    C07721 c07721 = C07721.this;
                    RemoteAugmentedAutofillService.this.maybeRequestShowInlineSuggestions(
                        i,
                        inlineSuggestionsRequest,
                        list,
                        bundle2,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onRequestAutofillLocked$1(
      AtomicReference atomicReference, ComponentName componentName, int i, Void r10, Throwable th) {
    ...
    if (componentName2 != null) {
      android.service.autofill.augmented.Helper.logResponse(
          15, componentName2.getPackageName(), componentName, i, this.mRequestTimeoutMs);
    }
  }
    ...
    Handler.getMain()
        .post(
            new Runnable() { // from class:
              // com.android.server.autofill.RemoteAugmentedAutofillService$$ExternalSyntheticLambda0
  ...
  public static /* synthetic */ void lambda$dispatchCancellation$2(
  ...
  public final void maybeRequestShowInlineSuggestions(
      final int i,
    ...
    if (list == null
        ...
        || remoteInlineSuggestionRenderService == null) {
            ...
            function.apply(
                InlineFillUi.forAugmentedAutofill(
                    new InlineFillUi.InlineFillUiInfo(
                        ...
                        i),
                    list,
                    new InlineFillUi.InlineSuggestionUiCallback() { // from class:
                      // com.android.server.autofill.RemoteAugmentedAutofillService.2
                      ...
                      public void autofill(Dataset dataset, int i3) {
                        ...
                        if (dataset.getAuthentication() != null) {
                          RemoteAugmentedAutofillService.this.mCallbacks
                              .logAugmentedAutofillAuthenticationSelected(
                                  i, dataset.getId(), bundle);
                          ...
                          try {
                            iAutoFillManagerClient.authenticate(
                                i, makeAuthenticationId, authentication, intent, false);
                            return;
                        ...
                        RemoteAugmentedAutofillService.this.mCallbacks.logAugmentedAutofillSelected(
                            i, dataset.getId(), bundle);
                        try {
                          ArrayList fieldIds = dataset.getFieldIds();
                          ClipData fieldContent = dataset.getFieldContent();
                          if (fieldContent != null) {
                            RemoteAugmentedAutofillService.this.mUriGrantsManager
                                .grantUriPermissions(componentName, iBinder, i2, fieldContent);
                            AutofillId autofillId2 = (AutofillId) fieldIds.get(0);
                            if (Helper.sDebug) {
                              Slog.d(
                                  RemoteAugmentedAutofillService.TAG,
                                  "Calling client autofillContent(): id="
                                      + autofillId2
                                      + ", content="
                                      + fieldContent);
                            }
                            ...
                            if (fieldIds.size() != 1
                                || !((AutofillId) fieldIds.get(0)).equals(autofillId)) {
                              z = false;
                            }
                            if (Helper.sDebug) {
                              Slog.d(
                                  RemoteAugmentedAutofillService.TAG,
                                  "Calling client autofill(): ids="
                                      + fieldIds
                                      + ", values="
                                      + dataset.getFieldValues());
                            }
                            iAutoFillManagerClient.autofill(
                                i, fieldIds, dataset.getFieldValues(), z);
                          }
                          function.apply(InlineFillUi.emptyUi(autofillId));
                        } catch (RemoteException unused2) {
                          Slog.w(
                              RemoteAugmentedAutofillService.TAG,
                              "Encounter exception autofilling the values");
                        }
                      }
                      ...
                      public void authenticate(int i3, int i4) {
                        Slog.e(
                            RemoteAugmentedAutofillService.TAG,
                            "authenticate not implemented for augmented autofill");
                      }
                      ...
                      public void startIntentSender(IntentSender intentSender) {
                        try {
                          ...
                          Slog.w(
                              RemoteAugmentedAutofillService.TAG,
                              "RemoteException starting intent sender");
                        }
                      }
  ...
  public void onDestroyAutofillWindowsRequest() {
    run(
        new ServiceConnector.VoidJob() { // from class:
          // com.android.server.autofill.RemoteAugmentedAutofillService$$ExternalSyntheticLambda2
