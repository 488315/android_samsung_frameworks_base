...
public final class InlineFillUi {
  ...
  public static InlineFillUi forAutofill(
      InlineFillUiInfo inlineFillUiInfo,
      FillResponse fillResponse,
      InlineSuggestionUiCallback inlineSuggestionUiCallback) {
    if (fillResponse.getAuthentication() != null && fillResponse.getInlinePresentation() != null) {
      return new InlineFillUi(
          inlineFillUiInfo,
          InlineSuggestionFactory.createInlineAuthentication(
              inlineFillUiInfo, fillResponse, inlineSuggestionUiCallback));
    }
  ...
  public static InlineFillUi forAugmentedAutofill(
      InlineFillUiInfo inlineFillUiInfo,
      List list,
      InlineSuggestionUiCallback inlineSuggestionUiCallback) {
    return new InlineFillUi(
        inlineFillUiInfo,
        InlineSuggestionFactory.createInlineSuggestions(
            inlineFillUiInfo, "android:platform", list, inlineSuggestionUiCallback));
  }
  ...
  public final InlineSuggestion copy(int i, InlineSuggestion inlineSuggestion) {
    ...
    InlineSuggestion inlineSuggestion2 =
        new InlineSuggestion(inlineSuggestion.getInfo(), contentProvider.copy());
