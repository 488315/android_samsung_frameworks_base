...
public final class DialogFillUi {
  ...
  public DialogFillUi(
    ...
    View inflate =
        LayoutInflater.from(contextThemeWrapper)
            .inflate(R.layout.car_alert_dialog_title, (ViewGroup) null);
    ...
    if (fillResponse.getAuthentication() != null) {
      ...
      this.mListView = (ListView) inflate.findViewById(R.id.autofill_service_icon);
    ...
    dialog.setOnCancelListener(
        new DialogInterface.OnCancelListener() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda0
    ...
    dialog.setOnShowListener(
        new DialogInterface.OnShowListener() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda1
  ...
  public final int getVisibleDatasetsMaxCount() {
    ...
    return this.mContext.getResources().getInteger(R.integer.auto_data_switch_validation_max_retry);
  }
  ...
  public final void setDialogParamsAsBottomSheet() {
    ...
    attributes.width =
        Math.min(
            ...
            this.mContext
                .getResources()
                .getDimensionPixelSize(R.dimen.autofill_dataset_picker_max_width));
    attributes.accessibilityTitle =
        this.mContext.getString(R.string.config_cameraLaunchGestureSensorStringType);
  ...
  public final void setServiceIcon(View view, Drawable drawable) {
    ...
    ImageView imageView = (ImageView) view.findViewById(R.id.bevel);
  ...
  public final void setHeader(View view, FillResponse fillResponse) {
    ...
    ViewGroup viewGroup = (ViewGroup) view.findViewById(R.id.autofill_save_yes);
    viewGroup.addView(
        sanitizeRemoteView.applyWithTheme(
            this.mContext,
            (ViewGroup) view,
            new RemoteViews.InteractionHandler() { // from class:
              // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda6
              public final boolean onInteraction(
                ...
                lambda$setHeader$2 =
                    DialogFillUi.this.lambda$setHeader$2(view2, pendingIntent, remoteResponse);
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ boolean lambda$setHeader$2(
  ...
  public final void setDismissButton(View view) {
    TextView textView = (TextView) view.findViewById(R.id.autofill_sheet_divider);
    textView.setText(R.string.config_clockFontFamily);
    textView.setOnClickListener(
        new View.OnClickListener() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda5
  ...
  public final void setContinueButton(View view, View.OnClickListener onClickListener) {
    TextView textView = (TextView) view.findViewById(R.id.autofill_sheet_scroll_view_space);
    textView.setText(R.string.config_biometric_prompt_ui_package);
  ...
  public final void initialAuthenticationLayout(View view, final FillResponse fillResponse) {
    RemoteViews sanitizeRemoteView =
        Helper.sanitizeRemoteView(fillResponse.getDialogPresentation());
    if (sanitizeRemoteView == null) {
    ...
    ViewGroup viewGroup = (ViewGroup) view.findViewById(R.id.autofill_save_title);
    viewGroup.addView(
        sanitizeRemoteView.applyWithTheme(
            this.mContext,
            (ViewGroup) view,
            new RemoteViews.InteractionHandler() { // from class:
              // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda2
              public final boolean onInteraction(
                  View view2,
                  PendingIntent pendingIntent,
                  RemoteViews.RemoteResponse remoteResponse) {
                boolean lambda$initialAuthenticationLayout$4;
                lambda$initialAuthenticationLayout$4 =
                    DialogFillUi.this.lambda$initialAuthenticationLayout$4(
                        view2, pendingIntent, remoteResponse);
    ...
    viewGroup.setOnClickListener(
        new View.OnClickListener() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda3
          @Override // android.view.View.OnClickListener
          public final void onClick(View view2) {
    ...
    setContinueButton(
        view,
        new View.OnClickListener() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda4
          @Override // android.view.View.OnClickListener
          public final void onClick(View view2) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ boolean lambda$initialAuthenticationLayout$4(
      View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
    if (pendingIntent == null) {
      return true;
    }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$initialAuthenticationLayout$5(
      FillResponse fillResponse, View view) {
    this.mCallback.onResponsePicked(fillResponse);
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$initialAuthenticationLayout$6(
      FillResponse fillResponse, View view) {
    this.mCallback.onResponsePicked(fillResponse);
  }
  ...
  public final ArrayList createDatasetItems(FillResponse fillResponse, AutofillId autofillId) {
    ...
    if (Helper.sVerbose) {
      Slog.v(
          "DialogFillUi",
          "Number datasets: " + size + " max visible: " + this.mVisibleDatasetsMaxCount);
    }
    RemoteViews.InteractionHandler interactionHandler =
        new RemoteViews.InteractionHandler() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda10
          public final boolean onInteraction(
              View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
            boolean lambda$createDatasetItems$7;
            lambda$createDatasetItems$7 =
                DialogFillUi.this.lambda$createDatasetItems$7(view, pendingIntent, remoteResponse);
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (indexOf >= 0) {
        RemoteViews sanitizeRemoteView =
            Helper.sanitizeRemoteView(dataset.getFieldDialogPresentation(indexOf));
        if (sanitizeRemoteView == null) {
          if (Helper.sDebug) {
            Slog.w(
                "DialogFillUi",
                "not displaying UI on field "
                    + autofillId
                    + " because service didn't provide a presentation for it on "
                    + dataset);
          }
        } else {
          try {
            ...
            View applyWithTheme =
                sanitizeRemoteView.applyWithTheme(
                    this.mContext, null, interactionHandler, this.mThemeId);
            ...
            if (filter == null) {
              ...
              str =
                  (autofillValue == null || !autofillValue.isText())
                      ? null
                      : autofillValue.getTextValue().toString().toLowerCase();
            } else {
              ...
              if (pattern2 == null) {
                if (Helper.sVerbose) {
                  Slog.v(
                      "DialogFillUi",
                      "Explicitly disabling filter at id "
                          + autofillId
                          + " for dataset #"
                          + indexOf);
                }
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ boolean lambda$createDatasetItems$7(
      View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
    if (pendingIntent == null) {
      return true;
    }
  ...
  public final void initialDatasetLayout(View view, String str) {
    final AdapterView.OnItemClickListener onItemClickListener =
        new AdapterView.OnItemClickListener() { // from class:
          // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda7
    ...
    if (this.mAdapter.getCount() == 1) {
      setContinueButton(
          view,
          new View.OnClickListener() { // from class:
            // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
    ...
    this.mAdapter
        ...
        .filter(
            this.mFilterText,
            new Filter.FilterListener() { // from class:
              // com.android.server.autofill.ui.DialogFillUi$$ExternalSyntheticLambda9
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$initialDatasetLayout$8(
  ...
  public /* synthetic */ void lambda$initialDatasetLayout$10(int i, int i2) {
    ...
    if (i2 <= 0) {
      if (Helper.sDebug) {
        ...
        Slog.d(
            "DialogFillUi",
            "No dataset matches filter with " + (str != null ? str.length() : 0) + " chars");
      }
      this.mCallback.onCanceled();
      return;
    }
  ...
  public final class AnnounceFilterResult implements Runnable {
    ...
    public void run() {
      ...
      if (count <= 0) {
        format =
            DialogFillUi.this.mContext.getString(R.string.config_cameraLiftTriggerSensorStringType);
      } else {
        HashMap hashMap = new HashMap();
        hashMap.put("count", Integer.valueOf(count));
        format =
            PluralsMessageFormatter.format(
                DialogFillUi.this.mContext.getResources(),
                hashMap,
                R.string.config_cameraShutterSound);
      }
  ...
  public final class ItemsAdapter extends BaseAdapter implements Filterable {
    ...
    public class C07831 extends Filter {
      public C07831() {}
      ...
      public Filter.FilterResults performFiltering(final CharSequence charSequence) {
        List list =
            (List)
                ItemsAdapter.this.mAllItems.stream()
                    .filter(
                        new Predicate() { // from class:
                          // com.android.server.autofill.ui.DialogFillUi$ItemsAdapter$1$$ExternalSyntheticLambda0
                          @Override // java.util.function.Predicate
                          public final boolean test(Object obj) {
                            boolean lambda$performFiltering$0;
                            lambda$performFiltering$0 =
                                DialogFillUi.ItemsAdapter.C07831.lambda$performFiltering$0(
                                    charSequence, (DialogFillUi.ViewItem) obj);
      ...
      public static /* synthetic */ boolean lambda$performFiltering$0(
          CharSequence charSequence, ViewItem viewItem) {
