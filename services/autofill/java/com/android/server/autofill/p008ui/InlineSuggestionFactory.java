...
public abstract class InlineSuggestionFactory {
  ...
  public static InlineSuggestion createInlineAuthentication(
      ...
      final InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {
    ...
    return createInlineSuggestion(
        ...
        new Runnable() { // from class:
          // com.android.server.autofill.ui.InlineSuggestionFactory$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
            InlineFillUi.InlineSuggestionUiCallback.this.authenticate(
                requestId, GnssNative.GNSS_AIDING_TYPE_ALL);
          }
        },
        mergedInlinePresentation(inlineFillUiInfo.mInlineRequest, 0, inlinePresentation),
        createInlineSuggestionTooltip(
            inlineFillUiInfo.mInlineRequest,
            inlineFillUiInfo,
            "android:autofill",
            fillResponse.getInlineTooltipPresentation()),
        inlineSuggestionUiCallback);
  }

  public static SparseArray createInlineSuggestions(
      InlineFillUi.InlineFillUiInfo inlineFillUiInfo,
      String str,
      List list,
      final InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {
    ...
    for (final int i = 0; i < list.size(); i++) {
      ...
      if (indexOf < 0) {
        Slog.w(
            ...
            "AutofillId=" + inlineFillUiInfo.mFocusedId + " not found in dataset");
      } else {
          ...
          if (z) {
            ...
            inlineSuggestion =
                createInlineSuggestionTooltip(
                    ...
                    inlineFillUiInfo,
                    str,
                    dataset.getFieldInlineTooltipPresentation(indexOf));
              ...
              Pair.create(
                  ...
                  createInlineSuggestion(
                      ...
                      mergedInlinePresentation(
                          inlineSuggestionsRequest, i, fieldInlinePresentation),
                      inlineSuggestion,
                      inlineSuggestionUiCallback)));
          z = z;
        }
  ...
  public static InlineSuggestion createInlineSuggestion(
      InlineFillUi.InlineFillUiInfo inlineFillUiInfo,
      String str,
      String str2,
      Runnable runnable,
    ...
    return new InlineSuggestion(
        new InlineSuggestionInfo(
            ...
            inlineSuggestion),
        createInlineContentProvider(
            inlineFillUiInfo, inlinePresentation, runnable, inlineSuggestionUiCallback));
  }

  public static InlinePresentation mergedInlinePresentation(
      InlineSuggestionsRequest inlineSuggestionsRequest,
      int i,
      InlinePresentation inlinePresentation) {
    List<InlinePresentationSpec> inlinePresentationSpecs =
        inlineSuggestionsRequest.getInlinePresentationSpecs();
    if (inlinePresentationSpecs.isEmpty()) {
      return inlinePresentation;
    }
    return new InlinePresentation(
        inlinePresentation.getSlice(),
        new InlinePresentationSpec.Builder(
                inlinePresentation.getInlinePresentationSpec().getMinSize(),
                inlinePresentation.getInlinePresentationSpec().getMaxSize())
            .setStyle(
                inlinePresentationSpecs
                    .get(Math.min(inlinePresentationSpecs.size() - 1, i))
                    .getStyle())
            .build(),
        inlinePresentation.isPinned());
  }

  public static InlineSuggestion createInlineSuggestionTooltip(
      InlineSuggestionsRequest inlineSuggestionsRequest,
      InlineFillUi.InlineFillUiInfo inlineFillUiInfo,
      String str,
      InlinePresentation inlinePresentation) {
    ...
    InlinePresentationSpec inlineTooltipPresentationSpec =
        inlineSuggestionsRequest.getInlineTooltipPresentationSpec();
    if (inlineTooltipPresentationSpec == null) {
      ...
      build =
          new InlinePresentationSpec.Builder(
                  inlinePresentation.getInlinePresentationSpec().getMinSize(),
                  inlinePresentation.getInlinePresentationSpec().getMaxSize())
              .setStyle(inlineTooltipPresentationSpec.getStyle())
              .build();
    }
    InlinePresentationSpec inlinePresentationSpec = build;
    return new InlineSuggestion(
        new InlineSuggestionInfo(
            inlinePresentationSpec, str, null, "android:autofill:suggestion", false, null),
        createInlineContentProvider(
            inlineFillUiInfo,
            new InlinePresentation(inlinePresentation.getSlice(), inlinePresentationSpec, false),
            new Runnable() { // from class:
              // com.android.server.autofill.ui.InlineSuggestionFactory$$ExternalSyntheticLambda1
              @Override // java.lang.Runnable
              public final void run() {
            ...
            new InlineFillUi.InlineSuggestionUiCallback() { // from class:
              // com.android.server.autofill.ui.InlineSuggestionFactory.1
  ...
  public static IInlineContentProvider createInlineContentProvider(
      InlineFillUi.InlineFillUiInfo inlineFillUiInfo,
      InlinePresentation inlinePresentation,
      Runnable runnable,
      InlineFillUi.InlineSuggestionUiCallback inlineSuggestionUiCallback) {
    return new InlineContentProviderImpl(
