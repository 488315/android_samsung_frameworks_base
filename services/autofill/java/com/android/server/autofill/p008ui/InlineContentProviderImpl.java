...
public final class InlineContentProviderImpl extends IInlineContentProvider.Stub {
  ...
  public InlineContentProviderImpl(
  ...
  public InlineContentProviderImpl copy() {
    return new InlineContentProviderImpl(
        this.mRemoteInlineSuggestionViewConnector, this.mRemoteInlineSuggestionUi);
  }

  public void provideContent(
      final int i, final int i2, final IInlineContentCallback iInlineContentCallback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.InlineContentProviderImpl$$ExternalSyntheticLambda2
  ...
  public void requestSurfacePackage() {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.InlineContentProviderImpl$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void onSurfacePackageReleased() {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.InlineContentProviderImpl$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$provideContent$0(
      int i, int i2, IInlineContentCallback iInlineContentCallback) {
    if (Helper.sVerbose) {
    ...
    if (remoteInlineSuggestionUi == null || !remoteInlineSuggestionUi.match(i, i2)) {
      this.mRemoteInlineSuggestionUi =
          new RemoteInlineSuggestionUi(
              this.mRemoteInlineSuggestionViewConnector, i, i2, this.mHandler);
    }
  ...
  public final void handleGetSurfacePackage() {
    ...
    if (!this.mProvideContentCalled
        || (remoteInlineSuggestionUi = this.mRemoteInlineSuggestionUi) == null) {
      return;
    }
