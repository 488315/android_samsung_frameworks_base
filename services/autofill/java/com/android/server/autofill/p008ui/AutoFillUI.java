...
public final class AutoFillUI {
  ...
  public final UiModeManagerInternal mUiModeMgr =
  ...
  public void clearCallback(final AutoFillUiCallback autoFillUiCallback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda6
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void showError(
      final CharSequence charSequence, final AutoFillUiCallback autoFillUiCallback) {
    Slog.w("AutofillUI", "showError(): " + ((Object) charSequence));
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda9
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public /* synthetic */ void lambda$showError$2(
      AutoFillUiCallback autoFillUiCallback, CharSequence charSequence) {
    if (this.mCallback != autoFillUiCallback) {
      return;
    }
    lambda$hideAll$10(autoFillUiCallback);
  ...
  public void hideFillUi(final AutoFillUiCallback autoFillUiCallback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda7
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void hideFillDialog(final AutoFillUiCallback autoFillUiCallback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda10
          @Override // java.lang.Runnable
          public final void run() {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$filterFillUi$5(
      AutoFillUiCallback autoFillUiCallback, String str) {
    FillUi fillUi;
  ...
  public void showFillUi(
      ...
      final AutoFillUiCallback autoFillUiCallback,
      Context context,
      int i,
      boolean z,
      final int i2) {
    if (Helper.sDebug) {
      Slogf.m88d(
          "AutofillUI",
          "showFillUi(): id=%s, filter=%d chars, displayId=%d",
          autofillId,
          Integer.valueOf(str == null ? 0 : str.length()),
          Integer.valueOf(context.getDisplayId()));
    }
    final LogMaker addTaggedData =
        Helper.newLogMaker(910, componentName, str2, i, z)
            .addTaggedData(911, Integer.valueOf(str == null ? 0 : str.length()))
            .addTaggedData(
                909,
                Integer.valueOf(
                    fillResponse.getDatasets() != null ? fillResponse.getDatasets().size() : 0));
    Runnable runnable = new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda11
          @Override // java.lang.Runnable
          public final void run() {
            AutoFillUI.this.lambda$showFillUi$6(
                autoFillUiCallback,
                i2,
                fillResponse,
                autofillId,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$showFillUi$6(
      final AutoFillUiCallback autoFillUiCallback,
      int i,
      final FillResponse fillResponse,
      final AutofillId autofillId,
    ...
    this.mFillUi =
        new FillUi(
            this.mContextForResources,
            fillResponse,
            autofillId,
            str,
            this.mOverlayControl,
            charSequence,
            drawable,
            this.mUiModeMgr.isNightMode(),
            new FillUi.Callback() { // from class: com.android.server.autofill.ui.AutoFillUI.1
              ...
              public void onResponsePicked(FillResponse fillResponse2) {
                ...
                if (AutoFillUI.this.mCallback != null) {
                  AutoFillUI.this.mCallback.authenticate(
                      fillResponse2.getRequestId(),
                      GnssNative.GNSS_AIDING_TYPE_ALL,
                      fillResponse2.getAuthentication(),
                      fillResponse2.getClientState(),
                      1);
                }
              }
              ...
              public void onDatasetPicked(Dataset dataset) {
                ...
                AutoFillUI.this.hideFillUiUiThread(autoFillUiCallback, true);
                if (AutoFillUI.this.mCallback != null) {
                  AutoFillUI.this.mCallback.fill(
                      fillResponse.getRequestId(),
                      fillResponse.getDatasets().indexOf(dataset),
                      dataset,
                      1);
                }
              }
              ...
              public void requestShowFillUi(
                  int i2, int i3, IAutofillWindowPresenter iAutofillWindowPresenter) {
                if (AutoFillUI.this.mCallback != null) {
                  AutoFillUI.this.mCallback.requestShowFillUi(
                      autofillId, i2, i3, iAutofillWindowPresenter);
                }
              }
  ...
  public void showSaveUi(
      ...
      final ValueFinder valueFinder,
      final ComponentName componentName,
      final AutoFillUiCallback autoFillUiCallback,
      Context context,
      final PendingUi pendingUi,
      final boolean z,
      final boolean z2,
      final boolean z3,
      final SaveEventLogger saveEventLogger,
      final int i) {
    if (Helper.sVerbose) {
      Slogf.m100v(
          "AutofillUI",
          "showSaveUi(update=%b) for %s and display %d: %s",
          Boolean.valueOf(z),
    ...
    final LogMaker addTaggedData =
        Helper.newLogMaker(916, componentName, str, pendingUi.sessionId, z2)
            .addTaggedData(
                917,
                Integer.valueOf(
                    (saveInfo.getRequiredIds() == null ? 0 : saveInfo.getRequiredIds().length)
                        + 0
                        + (saveInfo.getOptionalIds() != null
                            ? saveInfo.getOptionalIds().length
                            : 0)));
    if (z) {
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda8
          @Override // java.lang.Runnable
          public final void run() {
            AutoFillUI.this.lambda$showSaveUi$7(
                autoFillUiCallback,
                i,
                pendingUi,
                charSequence,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$showSaveUi$7(
      final AutoFillUiCallback autoFillUiCallback,
      int i,
      final PendingUi pendingUi,
      CharSequence charSequence,
    ...
    this.mSaveUi =
        new SaveUi(
            ...
            valueFinder,
            this.mOverlayControl,
            new SaveUi.OnSaveListener() { // from class: com.android.server.autofill.ui.AutoFillUI.2
  ...
  public void showFillDialog(
    ...
    if (Helper.sVerbose) {
      Slog.v(
          "AutofillUI",
          "showFillDialog for " + componentName.toShortString() + ": " + fillResponse);
    }
    final LogMaker addTaggedData =
        Helper.newLogMaker(910, componentName, str2, i, z)
            .addTaggedData(911, Integer.valueOf(str == null ? 0 : str.length()))
    ...
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda5
          @Override // java.lang.Runnable
          public final void run() {
            AutoFillUI.this.lambda$showFillDialog$8(
                autoFillUiCallback,
                fillResponse,
                autofillId,
                str,
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$showFillDialog$8(
      final AutoFillUiCallback autoFillUiCallback,
      final FillResponse fillResponse,
      final AutofillId autofillId,
      String str,
    ...
    this.mFillDialog =
        new DialogFillUi(
            ...
            this.mUiModeMgr.isNightMode(),
            new DialogFillUi
                .UiCallback() { // from class: com.android.server.autofill.ui.AutoFillUI.3
  ...
  public void onPendingSaveUi(final int i, final IBinder iBinder) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda3
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void hideAll(final AutoFillUiCallback autoFillUiCallback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void destroyAll(
      final PendingUi pendingUi, final AutoFillUiCallback autoFillUiCallback, final boolean z) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.AutoFillUI$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void lambda$destroyAll$11(
      PendingUi pendingUi, AutoFillUiCallback autoFillUiCallback, boolean z) {
  ...
  public final void lambda$hideAll$10(AutoFillUiCallback autoFillUiCallback) {
    ...
    if (Helper.sDebug) {
      Slog.d(
          "AutofillUI",
          "hideAllUiThread(): destroying Save UI because pending restoration is finished");
    }
