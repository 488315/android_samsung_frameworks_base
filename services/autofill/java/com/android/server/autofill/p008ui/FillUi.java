...
import com.android.server.autofill.p008ui.FillUi;
...
public final class FillUi {
    ...
    public FillUi(Context context, final FillResponse fillResponse, AutofillId autofillId, String str, OverlayControl overlayControl, CharSequence charSequence, Drawable drawable, boolean z, Callback callback) {
        ...
        if (Helper.sVerbose) {
            Slogf.m100v("FillUi", "nightMode: %b displayId: %d", Boolean.valueOf(z), Integer.valueOf(context.getDisplayId()));
        }
        int i2 = z ? R.style.Theme.DeviceDefault.Settings.SearchBar : R.style.Theme.GameSessionTrampoline;
        this.mThemeId = i2;
        ...
        if (isFullScreen) {
            viewGroup = (ViewGroup) from.inflate(R.layout.car_alert_dialog, (ViewGroup) null);
        } else if (sanitizeRemoteView != null || sanitizeRemoteView2 != null) {
            viewGroup = (ViewGroup) from.inflate(R.layout.car_alert_dialog_button_bar, (ViewGroup) null);
        } else {
            viewGroup = (ViewGroup) from.inflate(R.layout.calendar_view, (ViewGroup) null);
        }
        viewGroup.setClipToOutline(true);
        TextView textView = (TextView) viewGroup.findViewById(R.id.autofill_save_no);
        if (textView != null) {
            textView.setText(contextThemeWrapper.getString(R.string.config_defaultAutofillService, charSequence));
        }
        ImageView imageView = (ImageView) viewGroup.findViewById(R.id.autofill_save_button_bar);
        if (imageView != null) {
        ...
        if (AutofillManagerService.getVisibleDatasetsMaxCount() > 0) {
            ...
            this.mVisibleDatasetsMaxCount = contextThemeWrapper.getResources().getInteger(R.integer.auto_data_switch_validation_max_retry);
        }
        ...
        if (fillResponse.getAuthentication() != null) {
            ...
            this.mFooter = null;
            this.mAdapter = null;
            ViewGroup viewGroup3 = (ViewGroup) viewGroup.findViewById(R.id.autofill_save_icon);
            try {
        ...
        if (sanitizeRemoteView != null) {
            ...
            LinearLayout linearLayout = (LinearLayout) viewGroup.findViewById(R.id.autofill_save);
        ...
        if (sanitizeRemoteView2 != null) {
            LinearLayout linearLayout2 = (LinearLayout) viewGroup.findViewById(R.id.autofill_dialog_yes);
        ...
        ListView listView = (ListView) viewGroup.findViewById(R.id.autofill_save_custom_subtitle);
    ...
    public final class AnchoredWindow {
        ...
        public void show(WindowManager.LayoutParams layoutParams) {
            ...
            try {
                ...
                if (!this.mShowing) {
                    layoutParams.accessibilityTitle = this.mContentView.getContext().getString(R.string.config_cameraLaunchGestureSensorStringType);
    ...
    public final class ItemsAdapter extends BaseAdapter implements Filterable {
        ...
        public class C07841 extends Filter {
            public C07841() {
            }
            ...
            public Filter.FilterResults performFiltering(final CharSequence charSequence) {
                List list = (List) ItemsAdapter.this.mAllItems.stream().filter(new Predicate() { // from class: com.android.server.autofill.ui.FillUi$ItemsAdapter$1$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        ...
                        lambda$performFiltering$0 = FillUi.ItemsAdapter.C07841.lambda$performFiltering$0(charSequence, (FillUi.ViewItem) obj);
    ...
    public final class AnnounceFilterResult implements Runnable {
        ...
        public void run() {
            ...
            if (count <= 0) {
                format = FillUi.this.mContext.getString(R.string.config_cameraLiftTriggerSensorStringType);
            } else {
                HashMap hashMap = new HashMap();
                hashMap.put("count", Integer.valueOf(count));
                format = PluralsMessageFormatter.format(FillUi.this.mContext.getResources(), hashMap, R.string.config_cameraShutterSound);
            }
