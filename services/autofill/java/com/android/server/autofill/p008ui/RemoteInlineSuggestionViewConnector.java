...
public final class RemoteInlineSuggestionViewConnector {
  ...
  public RemoteInlineSuggestionViewConnector(
    ...
    this.mOnErrorCallback =
        new Runnable() { // from class:
          // com.android.server.autofill.ui.RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
            InlineFillUi.InlineSuggestionUiCallback.this.onError();
          }
        };
    this.mOnInflateCallback =
        new Runnable() { // from class:
          // com.android.server.autofill.ui.RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
            InlineFillUi.InlineSuggestionUiCallback.this.onInflate();
          }
        };
    this.mStartIntentSenderFromClientApp =
        new Consumer() { // from class:
          // com.android.server.autofill.ui.RemoteInlineSuggestionViewConnector$$ExternalSyntheticLambda2
  ...
  public boolean renderSuggestion(
      int i, int i2, IInlineSuggestionUiCallback iInlineSuggestionUiCallback) {
    ...
    this.mRemoteRenderService.renderSuggestion(
  ...
  public void onTransferTouchFocusToImeWindow(IBinder iBinder, int i) {
    if (((InputMethodManagerInternal) LocalServices.getService(InputMethodManagerInternal.class))
        .transferTouchFocusToImeWindow(iBinder, i)) {
      return;
    }
