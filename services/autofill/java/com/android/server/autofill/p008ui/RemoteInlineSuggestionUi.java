...
public final class RemoteInlineSuggestionUi {
  ...
  public RemoteInlineSuggestionUi(
  ...
  public void setInlineContentCallback(final IInlineContentCallback iInlineContentCallback) {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.RemoteInlineSuggestionUi$$ExternalSyntheticLambda2
  ...
  public /* synthetic */ void lambda$setInlineContentCallback$0(
  ...
  public void requestSurfacePackage() {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.RemoteInlineSuggestionUi$$ExternalSyntheticLambda1
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public void surfacePackageReleased() {
    this.mHandler.post(
        new Runnable() { // from class:
          // com.android.server.autofill.ui.RemoteInlineSuggestionUi$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
  ...
  public final void handleRequestSurfacePackage() {
    ...
    if (iInlineSuggestionUi == null) {
      if (this.mWaitingForUiCreation) {
        ...
        this.mRemoteInlineSuggestionViewConnector.renderSuggestion(
            this.mWidth, this.mHeight, this.mInlineSuggestionUiCallback);
        this.mWaitingForUiCreation = true;
        return;
      }
    }
    try {
      iInlineSuggestionUi.getSurfacePackage(new C07921());
  ...
  public class C07921 extends ISurfacePackageResultCallback.Stub {
    public C07921() {}

    public void onResult(final SurfaceControlViewHost.SurfacePackage surfacePackage) {
      RemoteInlineSuggestionUi.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              RemoteInlineSuggestionUi.C07921.this.lambda$onResult$0(surfacePackage);
            }
          });
    }
    ...
    public /* synthetic */ void lambda$onResult$0(
      ...
      try {
        RemoteInlineSuggestionUi.this.mInlineContentCallback.onContent(
            surfacePackage,
            RemoteInlineSuggestionUi.this.mActualWidth,
            RemoteInlineSuggestionUi.this.mActualHeight);
  ...
  public final void handleUpdateRefCount(int i) {
    ...
    if (i2 <= 0) {
      Runnable runnable = new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
  ...
  public final void handleInlineSuggestionUiReady(
    ...
    if (this.mInlineContentCallback != null) {
      try {
        ...
        handleUpdateRefCount(1);
        this.mInlineContentCallback.onContent(
            surfacePackage, this.mActualWidth, this.mActualHeight);
      } catch (RemoteException unused) {
  ...
  public class InlineSuggestionUiCallbackImpl extends IInlineSuggestionUiCallback.Stub {
    ...
    public void onClick() {
      ...
      handler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$InlineSuggestionUiCallbackImpl$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onLongClick() {
      ...
      handler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$InlineSuggestionUiCallbackImpl$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onContent$0(
        IInlineSuggestionUi iInlineSuggestionUi,
        SurfaceControlViewHost.SurfacePackage surfacePackage,
        int i,
        int i2) {
      RemoteInlineSuggestionUi.this.handleInlineSuggestionUiReady(
          iInlineSuggestionUi, surfacePackage, i, i2);
    }

    public void onContent(
        final IInlineSuggestionUi iInlineSuggestionUi,
        final SurfaceControlViewHost.SurfacePackage surfacePackage,
        final int i,
        final int i2) {
      RemoteInlineSuggestionUi.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$InlineSuggestionUiCallbackImpl$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
              RemoteInlineSuggestionUi.InlineSuggestionUiCallbackImpl.this.lambda$onContent$0(
                  iInlineSuggestionUi, surfacePackage, i, i2);
            }
          });
    }
    ...
    public void onError() {
      ...
      handler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$InlineSuggestionUiCallbackImpl$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onTransferTouchFocusToImeWindow(final IBinder iBinder, final int i) {
      RemoteInlineSuggestionUi.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$InlineSuggestionUiCallbackImpl$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
              RemoteInlineSuggestionUi.InlineSuggestionUiCallbackImpl.this
                  .lambda$onTransferTouchFocusToImeWindow$1(iBinder, i);
            }
          });
    }
    ...
    public void onStartIntentSender(final IntentSender intentSender) {
      RemoteInlineSuggestionUi.this.mHandler.post(
          new Runnable() { // from class:
            // com.android.server.autofill.ui.RemoteInlineSuggestionUi$InlineSuggestionUiCallbackImpl$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
              RemoteInlineSuggestionUi.InlineSuggestionUiCallbackImpl.this
                  .lambda$onStartIntentSender$2(intentSender);
            }
          });
    }
  }
