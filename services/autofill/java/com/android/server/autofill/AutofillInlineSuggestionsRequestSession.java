    ...
    public final class InlineSuggestionsRequestCallbackImpl extends IInlineSuggestionsRequestCallback.Stub {
        ...
        public void onInlineSuggestionsUnsupported() {
            ...
            if (autofillInlineSuggestionsRequestSession != null) {
                autofillInlineSuggestionsRequestSession.mHandler.sendMessage(PooledLambda.obtainMessage(new C0762xe2687de6(), autofillInlineSuggestionsRequestSession, (Object) null, (Object) null));
            }
        }
        ...
        public void onInlineSuggestionsRequest(InlineSuggestionsRequest inlineSuggestionsRequest, IInlineSuggestionsResponseCallback iInlineSuggestionsResponseCallback) {
            ...
            AutofillInlineSuggestionsRequestSession autofillInlineSuggestionsRequestSession = (AutofillInlineSuggestionsRequestSession) this.mSession.get();
            if (autofillInlineSuggestionsRequestSession != null) {
                autofillInlineSuggestionsRequestSession.mHandler.sendMessage(PooledLambda.obtainMessage(new C0762xe2687de6(), autofillInlineSuggestionsRequestSession, inlineSuggestionsRequest, iInlineSuggestionsResponseCallback));
            }
        }
        ...
        public void onInputMethodStartInputView() {
            ...
            if (autofillInlineSuggestionsRequestSession != null) {
                ...
                handler.sendMessage(PooledLambda.obtainMessage(c0764xe2687de8, autofillInlineSuggestionsRequestSession, bool, bool));
            }
        }
        ...
        public void onInputMethodFinishInputView() {
            ...
            AutofillInlineSuggestionsRequestSession autofillInlineSuggestionsRequestSession = (AutofillInlineSuggestionsRequestSession) this.mSession.get();
            if (autofillInlineSuggestionsRequestSession != null) {
                autofillInlineSuggestionsRequestSession.mHandler.sendMessage(PooledLambda.obtainMessage(new C0764xe2687de8(), autofillInlineSuggestionsRequestSession, Boolean.TRUE, Boolean.FALSE));
            }
        }
