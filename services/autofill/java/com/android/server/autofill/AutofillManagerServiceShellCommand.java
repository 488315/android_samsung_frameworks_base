...
public final class AutofillManagerServiceShellCommand extends ShellCommand {
  ...
  public final int getFieldClassificationScore(final PrintWriter printWriter) {
    ...
    this.mService.calculateScore(
        str2,
        str,
        nextArgRequired2,
        new RemoteCallback(
            new RemoteCallback.OnResultListener() { // from class:
              // com.android.server.autofill.AutofillManagerServiceShellCommand$$ExternalSyntheticLambda1
              public final void onResult(Bundle bundle) {
                AutofillManagerServiceShellCommand.lambda$getFieldClassificationScore$0(
                    printWriter, countDownLatch, bundle);
              }
            }));
    return waitForLatch(printWriter, countDownLatch);
  }

  public static /* synthetic */ void lambda$getFieldClassificationScore$0(
      PrintWriter printWriter, CountDownLatch countDownLatch, Bundle bundle) {
  ...
  public final int setTemporaryDetectionService(PrintWriter printWriter) {
    ...
    printWriter.println(
        "Autofill Detection Service temporarily set to "
            + nextArg
            + " for "
            + nextIntArgRequired2
            + "ms");
  ...
  public final int isFieldDetectionServiceEnabled(PrintWriter printWriter) {
    printWriter.println(
        this.mService.isFieldDetectionServiceEnabledForUser(getNextIntArgRequired()));
    return 0;
  }
  ...
  public final int setTemporaryAugmentedService(PrintWriter printWriter) {
    ...
    int nextIntArgRequired2 = getNextIntArgRequired();
    this.mService.setTemporaryAugmentedAutofillService(
        nextIntArgRequired, nextArg, nextIntArgRequired2);
    printWriter.println(
        "AugmentedAutofillService temporarily set to "
            + nextArg
            + " for "
            + nextIntArgRequired2
            + "ms");
  ...
  public final int getSavedPasswordCount(final PrintWriter printWriter) {
    int nextIntArgRequired = getNextIntArgRequired();
    final CountDownLatch countDownLatch = new CountDownLatch(1);
    if (!this.mService.requestSavedPasswordCount(
        nextIntArgRequired,
        new IResultReceiver.Stub() { // from class:
          // com.android.server.autofill.AutofillManagerServiceShellCommand.1
          public void send(int i, Bundle bundle) {
            printWriter.println("resultCode=" + i);
            if (i == 0 && bundle != null) {
              printWriter.println(
                  "value=" + bundle.getInt(KnoxCustomManagerService.SPCM_KEY_RESULT));
            }
            countDownLatch.countDown();
          }
        })) {
  ...
  public final int requestDestroy(PrintWriter printWriter) {
    ...
    final CountDownLatch countDownLatch = new CountDownLatch(1);
    final IResultReceiver.Stub stub = new IResultReceiver.Stub() { // from class:
          // com.android.server.autofill.AutofillManagerServiceShellCommand.2
          public void send(int i, Bundle bundle) {
            countDownLatch.countDown();
          }
        };
    return requestSessionCommon(
        printWriter,
        countDownLatch,
        new Runnable() { // from class:
          // com.android.server.autofill.AutofillManagerServiceShellCommand$$ExternalSyntheticLambda2
          @Override // java.lang.Runnable
          public final void run() {
            AutofillManagerServiceShellCommand.this.lambda$requestDestroy$1(
                userIdFromArgsOrAllUsers, stub);
          }
        });
  }
  ...
  public final int requestList(final PrintWriter printWriter) {
    ...
    final CountDownLatch countDownLatch = new CountDownLatch(1);
    final IResultReceiver.Stub stub = new IResultReceiver.Stub() { // from class:
          // com.android.server.autofill.AutofillManagerServiceShellCommand.3
          public void send(int i, Bundle bundle) {
    ...
    return requestSessionCommon(
        ...
        countDownLatch,
        new Runnable() { // from class:
          // com.android.server.autofill.AutofillManagerServiceShellCommand$$ExternalSyntheticLambda0
          @Override // java.lang.Runnable
          public final void run() {
            AutofillManagerServiceShellCommand.this.lambda$requestList$2(
                userIdFromArgsOrAllUsers, stub);
          }
        });
  }
  ...
  public final int requestSessionCommon(
