...
final class RemoteFillService extends ServiceConnector.Impl {
    ...
    AndroidFuture orTimeout =
        postAsync(
                new ServiceConnector.Job() { // from class:
                  // com.android.server.autofill.RemoteFillService$$ExternalSyntheticLambda2
                  public final Object run(Object obj) {
                    CompletableFuture lambda$onFillRequest$0;
                    lambda$onFillRequest$0 =
                        RemoteFillService.this.lambda$onFillRequest$0(
                            fillRequest, atomicReference2, atomicReference, (IAutoFillService) obj);
    ...
    orTimeout.whenComplete(
        new BiConsumer() { // from class:
          ...
          public final void accept(Object obj, Object obj2) {
            RemoteFillService.this.lambda$onFillRequest$2(
                fillRequest, atomicReference, (FillResponse) obj, (Throwable) obj2);
          }
        });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ CompletableFuture lambda$onFillRequest$0(
    ...
    iAutoFillService.onFillRequest(
        fillRequest,
        new IFillCallback.Stub() { // from class: com.android.server.autofill.RemoteFillService.1
          ...
          public void onFailure(int i, CharSequence charSequence) {
            completableFuture.completeExceptionally(
                new RuntimeException(charSequence == null ? "" : String.valueOf(charSequence)));
          }
        });
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onFillRequest$2(
      final FillRequest fillRequest,
      final AtomicReference atomicReference,
    ...
    Handler.getMain()
        .post(
            new Runnable() { // from class:
              // com.android.server.autofill.RemoteFillService$$ExternalSyntheticLambda4
              @Override // java.lang.Runnable
              public final void run() {
                RemoteFillService.this.lambda$onFillRequest$1(
                    th, fillRequest, fillResponse, atomicReference);
              }
            });
  }

  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onFillRequest$1(
      Throwable th,
      FillRequest fillRequest,
    ...
    if (th == null) {
      this.mCallbacks.onFillRequestSuccess(
          fillRequest.getId(),
          fillResponse,
    ...
    postAsync(
            new ServiceConnector.Job() { // from class:
              ...
              public final Object run(Object obj) {
                ...
                lambda$onSaveRequest$3 =
                    RemoteFillService.this.lambda$onSaveRequest$3(
                        saveRequest, (IAutoFillService) obj);
        ...
        .whenComplete(
            new BiConsumer() { // from class:
              // com.android.server.autofill.RemoteFillService$$ExternalSyntheticLambda6
              @Override // java.util.function.BiConsumer
              public final void accept(Object obj, Object obj2) {
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ CompletableFuture lambda$onSaveRequest$3(
      SaveRequest saveRequest, IAutoFillService iAutoFillService) {
    if (Helper.sVerbose) {
      Slog.v("RemoteFillService", "calling onSaveRequest()");
    }
    final CompletableFuture completableFuture = new CompletableFuture();
    iAutoFillService.onSaveRequest(
        saveRequest,
        new ISaveCallback.Stub() { // from class: com.android.server.autofill.RemoteFillService.2
  ...
  /* JADX INFO: Access modifiers changed from: private */
  public /* synthetic */ void lambda$onSaveRequest$5(
      final IntentSender intentSender, final Throwable th) {
    Handler.getMain()
        .post(
            new Runnable() { // from class:
              // com.android.server.autofill.RemoteFillService$$ExternalSyntheticLambda7
              @Override // java.lang.Runnable
              public final void run() {
