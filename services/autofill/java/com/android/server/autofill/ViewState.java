...
public final class ViewState {
  ...
  /* renamed from: id */
  public final AutofillId f1646id;
  ...
  public void maybeCallOnFillReady(int i) {
    if ((this.mState & 4) != 0 && (i & 1) == 0) {
      if (Helper.sDebug) {
        Slog.d("ViewState", "Ignoring UI for " + this.f1646id + " on " + getStateAsString());
        return;
      }
      return;
    }
    ...
    if (fillResponse != null) {
      ...
      this.mListener.onFillReady(this.mResponse, this.f1646id, this.mCurrentValue, i);
    }
  }

  public String toString() {
    StringBuilder sb = new StringBuilder("ViewState: [id=");
    sb.append(this.f1646id);
  ...
  public void dump(String str, PrintWriter printWriter) {
    ...
    printWriter.println(this.f1646id);
    if (this.mDatasetId != null) {
      printWriter.print(str);
