...
public final class AutofillManagerService extends AbstractMasterSystemService {
    ...
    public AutofillManagerService(Context context) {
        ...
        FrameworkResourcesServiceNameResolver frameworkResourcesServiceNameResolver = new FrameworkResourcesServiceNameResolver(getContext(), R.string.data_usage_mobile_limit_title);
        ...
        FrameworkResourcesServiceNameResolver frameworkResourcesServiceNameResolver2 = new FrameworkResourcesServiceNameResolver(getContext(), R.string.date_picker_decrement_day_button);
    ...
    public final class AutoFillManagerServiceStub extends IAutoFillManager.Stub {
        ...
        */
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public void setAugmentedAutofillWhitelist(List list, List list2, IResultReceiver iResultReceiver) {
            boolean z;
                                ...
                                try {
                                    try {
                                        try {
                                            ...
                                            e = e;
                                            Log.wtf("AutofillManagerService", "setAugmentedAutofillWhitelist(): failed " + e.toString());
                                            autofillManagerService = AutofillManagerService.this;
                                        }
                                    } catch (Throwable th2) {
                                        th = th2;
