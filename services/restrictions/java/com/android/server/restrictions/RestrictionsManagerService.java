    ...
    public RestrictionsManagerImpl(Context context) {
      ...
      this.mDpmInternal =
          (DevicePolicyManagerInternal)
              RestrictionsManagerService.this.getLocalService(DevicePolicyManagerInternal.class);
    }
    ...
    public Intent createLocalApprovalIntent() {
      ...
      try {
        ...
        ResolveInfo resolveIntent =
            AppGlobals.getPackageManager().resolveIntent(intent, (String) null, 0L, callingUserId);
