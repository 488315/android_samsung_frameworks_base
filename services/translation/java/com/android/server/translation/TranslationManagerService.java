...
public final class TranslationManagerService extends AbstractMasterSystemService {
  ...
  public TranslationManagerService(Context context) {
    super(
        ...
        new FrameworkResourcesServiceNameResolver(
            context, R.string.default_audio_route_category_name),
        null,
        4);
  }
  ...
  public final boolean isCalledByServiceAppLocked(int i, String str) {
    ...
    if (serviceName == null) {
      Slog.e(
          ...
          str + ": called by UID " + callingUid + ", but there's no service set for user " + i);
      return false;
    }
    ...
    try {
      ...
      Slog.e(
          "TranslationManagerService",
          str + ": called by UID " + callingUid + ", but service UID is " + packageUidAsUser);
      return false;
  ...
  public final class TranslationManagerServiceStub extends ITranslationManager.Stub {
    ...
    public void onTranslationCapabilitiesRequest(
        int i, int i2, ResultReceiver resultReceiver, int i3) {
      synchronized (TranslationManagerService.this.mLock) {
        ...
        if (translationManagerServiceImpl != null
            && (TranslationManagerService.this.isDefaultServiceLocked(i3)
                || TranslationManagerService.this.isCalledByServiceAppLocked(
                    i3, "getTranslationCapabilities"))) {
          translationManagerServiceImpl.onTranslationCapabilitiesRequestLocked(
              i, i2, resultReceiver);
        } else {
          Slog.v(
              "TranslationManagerService",
    ...
    public void registerTranslationCapabilityCallback(IRemoteCallback iRemoteCallback, int i) {
      ...
      if (translationManagerServiceImpl != null) {
        translationManagerServiceImpl.registerTranslationCapabilityCallback(
            iRemoteCallback, Binder.getCallingUid());
      }
    }
    ...
    public void onSessionCreated(
        TranslationContext translationContext, int i, IResultReceiver iResultReceiver, int i2) {
      synchronized (TranslationManagerService.this.mLock) {
        TranslationManagerServiceImpl translationManagerServiceImpl =
            (TranslationManagerServiceImpl)
                TranslationManagerService.this.getServiceForUserLocked(i2);
        if (translationManagerServiceImpl != null
            && (TranslationManagerService.this.isDefaultServiceLocked(i2)
                || TranslationManagerService.this.isCalledByServiceAppLocked(
                    i2, "onSessionCreated"))) {
          translationManagerServiceImpl.onSessionCreatedLocked(
              translationContext, i, iResultReceiver);
        } else {
    ...
    public void updateUiTranslationState(
        ...
        int i3) {
      TranslationManagerService.this.enforceCallerHasPermission(
      ...
      synchronized (TranslationManagerService.this.mLock) {
        ...
        if (translationManagerServiceImpl != null
            && (TranslationManagerService.this.isDefaultServiceLocked(i3)
                || TranslationManagerService.this.isCalledByServiceAppLocked(
                    i3, "updateUiTranslationState"))) {
          translationManagerServiceImpl.updateUiTranslationStateLocked(
              i, translationSpec, translationSpec2, list, iBinder, i2, uiTranslationSpec);
        }
      }
    }
    ...
    public void onTranslationFinished(
      ...
      synchronized (TranslationManagerService.this.mLock) {
        ((TranslationManagerServiceImpl) TranslationManagerService.this.getServiceForUserLocked(i))
            .onTranslationFinishedLocked(z, iBinder, componentName);
      }
    }
    ...
    public void getServiceSettingsActivity(IResultReceiver iResultReceiver, int i) {
      ...
      if (translationManagerServiceImpl != null) {
        ComponentName serviceSettingsActivityLocked =
            translationManagerServiceImpl.getServiceSettingsActivityLocked();
        if (serviceSettingsActivityLocked == null) {
          try {
            iResultReceiver.send(1, (Bundle) null);
          } catch (RemoteException e) {
            Slog.w(
                "TranslationManagerService", "Unable to send getServiceSettingsActivity(): " + e);
          }
        }
        ...
        try {
          try {
            ...
            Slog.w(
                "TranslationManagerService", "Unable to send getServiceSettingsActivity(): " + e2);
          }
          return;
        } finally {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
      if (DumpUtils.checkDumpPermission(
          TranslationManagerService.this.getContext(), "TranslationManagerService", printWriter)) {
        synchronized (TranslationManagerService.this.mLock) {
