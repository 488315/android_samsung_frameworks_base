...
final class RemoteTranslationService extends ServiceConnector.Impl {
  ...
  public RemoteTranslationService(
      Context context, ComponentName componentName, int i, boolean z, IBinder iBinder) {
    super(
        context,
        new Intent("android.service.translation.TranslationService").setComponent(componentName),
        z ? 4194304 : 0,
        i,
        new Function() { // from class:
          // com.android.server.translation.RemoteTranslationService$$ExternalSyntheticLambda0
        ...
        new ServiceConnector.VoidJob() { // from class:
          ...
          public final void runNoResult(Object obj) {
            ((ITranslationService) obj)
                .onCreateTranslationSession(translationContext, i, iResultReceiver);
          }
        });
  }

  public void onTranslationCapabilitiesRequest(
      final int i, final int i2, final ResultReceiver resultReceiver) {
    run(
        new ServiceConnector.VoidJob() { // from class:
