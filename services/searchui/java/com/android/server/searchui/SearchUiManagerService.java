...
public class SearchUiManagerService extends AbstractMasterSystemService {
  ...
  public SearchUiManagerService(Context context) {
    super(
        context,
        new FrameworkResourcesServiceNameResolver(context, R.string.db_default_journal_mode),
        null,
        17);
  ...
  public void onServicePackageUpdatedLocked(int i) {
    SearchUiPerUserService searchUiPerUserService =
        (SearchUiPerUserService) peekServiceForUserLocked(i);
  ...
  public class SearchUiManagerStub extends ISearchUiManager.Stub {
    ...
    public void createSearchSession(
      ...
      runForUserLocked(
          ...
          new Consumer() { // from class:
            // com.android.server.searchui.SearchUiManagerService$SearchUiManagerStub$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((SearchUiPerUserService) obj)
                  .onCreateSearchSessionLocked(searchContext, searchSessionId, iBinder);
            }
          });
    }
    ...
    public void notifyEvent(
      ...
      runForUserLocked(
          ...
          searchSessionId,
          new Consumer() { // from class:
            // com.android.server.searchui.SearchUiManagerService$SearchUiManagerStub$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((SearchUiPerUserService) obj)
                  .notifyLocked(searchSessionId, query, searchTargetEvent);
            }
          });
    }
    ...
    public void query(
      ...
      runForUserLocked(
          ...
          searchSessionId,
          new Consumer() { // from class:
            // com.android.server.searchui.SearchUiManagerService$SearchUiManagerStub$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void registerEmptyQueryResultUpdateCallback(
      ...
      runForUserLocked(
          ...
          searchSessionId,
          new Consumer() { // from class:
            // com.android.server.searchui.SearchUiManagerService$SearchUiManagerStub$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((SearchUiPerUserService) obj)
                  .registerEmptyQueryResultUpdateCallbackLocked(searchSessionId, iSearchCallback);
            }
          });
    }
    ...
    public void unregisterEmptyQueryResultUpdateCallback(
        final SearchSessionId searchSessionId, final ISearchCallback iSearchCallback) {
      runForUserLocked(
          "unregisterEmptyQueryResultUpdateCallback",
          searchSessionId,
          new Consumer() { // from class:
            // com.android.server.searchui.SearchUiManagerService$SearchUiManagerStub$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
              ((SearchUiPerUserService) obj)
                  .unregisterEmptyQueryResultUpdateCallbackLocked(searchSessionId, iSearchCallback);
            }
          });
    }
    ...
    public void destroySearchSession(final SearchSessionId searchSessionId) {
      runForUserLocked(
          ...
          searchSessionId,
          new Consumer() { // from class:
            // com.android.server.searchui.SearchUiManagerService$SearchUiManagerStub$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public final void runForUserLocked(
        String str, SearchSessionId searchSessionId, Consumer consumer) {
      int handleIncomingUser =
          ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class))
              .handleIncomingUser(
                  Binder.getCallingPid(),
                  Binder.getCallingUid(),
                  searchSessionId.getUserId(),
                  false,
                  0,
                  (String) null,
                  (String) null);
      if (!SearchUiManagerService.this.mServiceNameResolver.isTemporary(handleIncomingUser)
          && !SearchUiManagerService.this.mActivityTaskManagerInternal.isCallerRecents(
              Binder.getCallingUid())) {
        String str2 =
            "Permission Denial: "
                + str
        ...
        synchronized (SearchUiManagerService.this.mLock) {
          consumer.accept(
              (SearchUiPerUserService)
                  SearchUiManagerService.this.getServiceForUserLocked(handleIncomingUser));
        }
      } finally {
