...
public final class UserState
  ...
  public Bundle print(
    ...
    if (!this.mPrintJobForAppCache.onPrintJobCreated(
        iPrintDocumentAdapter.asBinder(), i, printJobInfo)) {
      return null;
    }
  ...
  public Icon getCustomPrinterIcon(PrinterId printerId) {
    ...
    if (customPrinterIcon == null
        && (remotePrintService =
                (RemotePrintService) this.mActiveServices.get(printerId.getServiceName()))
            != null) {
  ...
  */
  public List getPrintServices(int i) {
    ...
    synchronized (this.mLock) {
      ...
      arrayList = null;
      for (int i2 = 0; i2 < size; i2++) {
        PrintServiceInfo printServiceInfo = (PrintServiceInfo) this.mInstalledServices.get(i2);
        printServiceInfo.setIsEnabled(
            this.mActiveServices.containsKey(
                new ComponentName(
                    printServiceInfo.getResolveInfo().serviceInfo.packageName,
                    printServiceInfo.getResolveInfo().serviceInfo.name)));
      ...
      if (z) {
        ...
        while (true) {
          if (i >= size) {
            ...
            if (((PrintServiceInfo) this.mInstalledServices.get(i))
                .getComponentName()
  ...
  public void createPrinterDiscoverySession(IPrinterDiscoveryObserver iPrinterDiscoveryObserver) {
    ...
    synchronized (this.mLock) {
      throwIfDestroyedLocked();
      PrinterDiscoverySessionMediator printerDiscoverySessionMediator =
          this.mPrinterDiscoverySession;
      if (printerDiscoverySessionMediator == null) {
        PrinterDiscoverySessionMediator printerDiscoverySessionMediator2 =
            new PrinterDiscoverySessionMediator() { // from class:
              // com.android.server.print.UserState.1
  ...
  public void addPrintJobStateChangeListener(
      IPrintJobStateChangeListener iPrintJobStateChangeListener, int i) {
    synchronized (this.mLock) {
      throwIfDestroyedLocked();
      if (this.mPrintJobStateChangeListenerRecords == null) {
        this.mPrintJobStateChangeListenerRecords = new ArrayList();
      }
      this.mPrintJobStateChangeListenerRecords.add(
          new PrintJobStateChangeListenerRecord(
              iPrintJobStateChangeListener, i) { // from class: com.android.server.print.UserState.2
  ...
  public void removePrintJobStateChangeListener(
    ...
    synchronized (this.mLock) {
      ...
      while (true) {
        ...
        PrintJobStateChangeListenerRecord printJobStateChangeListenerRecord =
            (PrintJobStateChangeListenerRecord) this.mPrintJobStateChangeListenerRecords.get(i);
        if (printJobStateChangeListenerRecord
            .listener
            .asBinder()
  ...
  public void addPrintServicesChangeListener(
    ...
    synchronized (this.mLock) {
      ...
      this.mPrintServicesChangeListenerRecords.add(
          new ListenerRecord(
              iPrintServicesChangeListener) { // from class: com.android.server.print.UserState.3
    ...
    synchronized (this.mLock) {
      ...
      while (true) {
        ...
        ListenerRecord listenerRecord =
            (ListenerRecord) this.mPrintServicesChangeListenerRecords.get(i);
  ...
  public void addPrintServiceRecommendationsChangeListener(
    ...
    synchronized (this.mLock) {
      ...
      this.mPrintServiceRecommendationsChangeListenerRecords.add(
          new ListenerRecord(
              iRecommendationsChangeListener) { // from class: com.android.server.print.UserState.4
            @Override // com.android.server.print.UserState.ListenerRecord
            public void onBinderDied() {
              synchronized (UserState.this.mLock) {
  ...
  public void removePrintServiceRecommendationsChangeListener(
    ...
    synchronized (this.mLock) {
      ...
      while (true) {
        ...
        ListenerRecord listenerRecord =
            (ListenerRecord) this.mPrintServiceRecommendationsChangeListenerRecords.get(i);
        ...
        .sendMessage(
            PooledLambda.obtainMessage(
                new TriConsumer() { // from class:
                  // com.android.server.print.UserState$$ExternalSyntheticLambda3
                  public final void accept(Object obj, Object obj2, Object obj3) {
                    ((UserState) obj)
                        .handleDispatchPrintJobStateChanged(
                            (PrintJobId) obj2, (PooledSupplier.OfInt) obj3);
                  }
                },
                this,
                printJobInfo.getId(),
                PooledLambda.obtainSupplier(printJobInfo.getAppId()).recycleOnUse()));
  }
        ...
        .sendMessage(
            PooledLambda.obtainMessage(
                new Consumer() { // from class:
                  // com.android.server.print.UserState$$ExternalSyntheticLambda0
        ...
        .sendMessage(
            PooledLambda.obtainMessage(
                new BiConsumer() { // from class:
                  // com.android.server.print.UserState$$ExternalSyntheticLambda4
    ...
    synchronized (this.mLock) {
      ...
      Handler.getMain()
          .sendMessageDelayed(
              PooledLambda.obtainMessage(
                  new Consumer() { // from class:
                    // com.android.server.print.UserState$$ExternalSyntheticLambda2
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        DumpUtils.writeStringIfNotNull(
            ...
            1138166333444L,
            printServiceInfo.getAdvancedOptionsActivityName());
        dualDumpOutputStream.end(start);
      }
      Iterator it = this.mDisabledServices.iterator();
      while (it.hasNext()) {
        DumpUtils.writeComponentName(
            dualDumpOutputStream, "disabled_services", 2246267895811L, (ComponentName) it.next());
      }
      ...
      if (!"android.permission.BIND_PRINT_SERVICE".equals(resolveInfo.serviceInfo.permission)) {
        ...
        Slog.w(
            ...
            "Skipping print service "
                ...
                + " since it does not require permission android.permission.BIND_PRINT_SERVICE");
      } else {
  ...
  public final void upgradePersistentStateIfNeeded() {
    if (Settings.Secure.getStringForUser(
            this.mContext.getContentResolver(), "enabled_print_services", this.mUserId)
        != null) {
      ...
      for (int i = 0; i < size; i++) {
        ComponentName componentName =
            ((PrintServiceInfo) this.mInstalledServices.get(i)).getComponentName();
      ...
      Settings.Secure.putStringForUser(
          this.mContext.getContentResolver(), "enabled_print_services", null, this.mUserId);
    }
  }
  ...
  public final void readPrintServicesFromSettingLocked(String str, Set set) {
    ...
    String stringForUser =
        Settings.Secure.getStringForUser(this.mContext.getContentResolver(), str, this.mUserId);
  ...
  public final void writeDisabledPrintServicesLocked(Set set) {
    ...
    Settings.Secure.putStringForUser(
        this.mContext.getContentResolver(), "disabled_print_services", sb.toString(), this.mUserId);
  }
  ...
  public final ArrayList getInstalledComponents() {
    ...
    for (int i = 0; i < size; i++) {
      ServiceInfo serviceInfo =
          ((PrintServiceInfo) this.mInstalledServices.get(i)).getResolveInfo().serviceInfo;
    ...
    if (Looper.getMainLooper().isCurrentThread()) {
      BackgroundThread.getHandler()
          .sendMessage(
              PooledLambda.obtainMessage(
                  new BiConsumer() { // from class:
                    // com.android.server.print.UserState$$ExternalSyntheticLambda1
                    @Override // java.util.function.BiConsumer
                    public final void accept(Object obj, Object obj2) {
                      ((UserState) obj)
                          .failScheduledPrintJobsForServiceInternal((ComponentName) obj2);
                    }
                  },
                  this,
                  componentName));
    ...
    try {
      ...
      for (int i = 0; i < size; i++) {
        this.mSpooler.setPrintJobState(
            ((PrintJobInfo) printJobInfos.get(i)).getId(), 6, this.mContext.getString(17042361));
      }
    } finally {
      Binder.restoreCallingIdentity(clearCallingIdentity);
    }
  ...
  public final void handleDispatchPrintJobStateChanged(
      PrintJobId printJobId, IntSupplier intSupplier) {
    ...
    synchronized (this.mLock) {
      ...
      for (int i = 0; i < size; i++) {
        PrintJobStateChangeListenerRecord printJobStateChangeListenerRecord =
            (PrintJobStateChangeListenerRecord) arrayList.get(i);
  ...
  public abstract class PrintJobStateChangeListenerRecord implements IBinder.DeathRecipient {
    ...
    public PrintJobStateChangeListenerRecord(
        IPrintJobStateChangeListener iPrintJobStateChangeListener, int i) {
  ...
  public abstract class PrinterDiscoverySessionMediator {
    ...
    public final RemoteCallbackList mDiscoveryObservers = new RemoteCallbackList() { // from class:
          ...
          public void onCallbackDied(IPrinterDiscoveryObserver iPrinterDiscoveryObserver) {
            synchronized (UserState.this.mLock) {
              PrinterDiscoverySessionMediator.this.stopPrinterDiscoveryLocked(
    ...
    public PrinterDiscoverySessionMediator() {
      Handler.getMain()
          .sendMessage(
              PooledLambda.obtainMessage(
                  new BiConsumer() { // from class:
                    // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda1
                    @Override // java.util.function.BiConsumer
                    public final void accept(Object obj, Object obj2) {
                      ((UserState.PrinterDiscoverySessionMediator) obj)
                          .handleDispatchCreatePrinterDiscoverySession((ArrayList) obj2);
                    }
                  },
                  this,
    ...
    public void addObserverLocked(IPrinterDiscoveryObserver iPrinterDiscoveryObserver) {
      ...
      Handler.getMain()
          .sendMessage(
              PooledLambda.obtainMessage(
                  new TriConsumer() { // from class:
                    // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda10
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((UserState.PrinterDiscoverySessionMediator) obj)
                          .handlePrintersAdded((IPrinterDiscoveryObserver) obj2, (ArrayList) obj3);
                    }
                  },
                  this,
                  iPrinterDiscoveryObserver,
      ...
      if (z && list != null && !list.isEmpty()) {
        ...
        Handler.getMain()
            .sendMessage(
                PooledLambda.obtainMessage(
                    new TriConsumer() { // from class:
                      // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda6
                      public final void accept(Object obj, Object obj2, Object obj3) {
                        ((UserState.PrinterDiscoverySessionMediator) obj)
                            .handleDispatchStartPrinterDiscovery((ArrayList) obj2, (List) obj3);
                      }
                    },
                    this,
                    new ArrayList(UserState.this.mActiveServices.values()),
    ...
    public final void stopPrinterDiscoveryLocked(
      ...
      } else if (this.mStartedPrinterDiscoveryTokens.remove(iPrinterDiscoveryObserver.asBinder())
          && this.mStartedPrinterDiscoveryTokens.isEmpty()) {
        Handler.getMain()
            .sendMessage(
                PooledLambda.obtainMessage(
                    new BiConsumer() { // from class:
                      // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda9
                      @Override // java.util.function.BiConsumer
                      public final void accept(Object obj, Object obj2) {
                        ((UserState.PrinterDiscoverySessionMediator) obj)
                            .handleDispatchStopPrinterDiscovery((ArrayList) obj2);
                      }
                    },
                    this,
                    new ArrayList(UserState.this.mActiveServices.values())));
    ...
    public void validatePrintersLocked(List list) {
      ...
      while (!arrayList.isEmpty()) {
        ...
        RemotePrintService remotePrintService =
            (RemotePrintService) UserState.this.mActiveServices.get(componentName);
        if (remotePrintService != null) {
          Handler.getMain()
              .sendMessage(
                  PooledLambda.obtainMessage(
                      new TriConsumer() { // from class:
                        // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda0
                        public final void accept(Object obj, Object obj2, Object obj3) {
                          ((UserState.PrinterDiscoverySessionMediator) obj)
                              .handleValidatePrinters((RemotePrintService) obj2, (List) obj3);
                        }
                      },
                      this,
                      remotePrintService,
    ...
    public final void startPrinterStateTrackingLocked(PrinterId printerId) {
      ...
      if (contains
          || (remotePrintService =
                  (RemotePrintService)
                      UserState.this.mActiveServices.get(printerId.getServiceName()))
              == null) {
        return;
      }
      Handler.getMain()
          .sendMessage(
              PooledLambda.obtainMessage(
                  new TriConsumer() { // from class:
                    // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda11
                    public final void accept(Object obj, Object obj2, Object obj3) {
                      ((UserState.PrinterDiscoverySessionMediator) obj)
                          .handleStartPrinterStateTracking(
                              (RemotePrintService) obj2, (PrinterId) obj3);
                    }
                  },
                  this,
                  remotePrintService,
    ...
    public final void stopPrinterStateTrackingLocked(PrinterId printerId) {
      ...
      if (this.mIsDestroyed) {
        ...
        if (this.mStartedPrinterDiscoveryTokens.isEmpty()
            || !this.mStateTrackedPrinters.remove(printerId)
            || (remotePrintService =
                    (RemotePrintService)
                        UserState.this.mActiveServices.get(printerId.getServiceName()))
                == null) {
        ...
        Handler.getMain()
            .sendMessage(
                PooledLambda.obtainMessage(
                    new TriConsumer() { // from class:
                      // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda8
                      public final void accept(Object obj, Object obj2, Object obj3) {
                        ((UserState.PrinterDiscoverySessionMediator) obj)
                            .handleStopPrinterStateTracking(
                                (RemotePrintService) obj2, (PrinterId) obj3);
                      }
                    },
                    this,
      ...
      for (int i2 = 0; i2 < size2; i2++) {
        stopPrinterDiscoveryLocked(
            IPrinterDiscoveryObserver.Stub.asInterface(
                (IBinder) this.mStartedPrinterDiscoveryTokens.get(i2)));
      }
      Handler.getMain()
          .sendMessage(
              PooledLambda.obtainMessage(
                  new BiConsumer() { // from class:
                    // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda2
                    @Override // java.util.function.BiConsumer
                    public final void accept(Object obj, Object obj2) {
                      ((UserState.PrinterDiscoverySessionMediator) obj)
                          .handleDispatchDestroyPrinterDiscoverySession((ArrayList) obj2);
                    }
                  },
                  this,
                  new ArrayList(UserState.this.mActiveServices.values())));
      ...
      if (arrayList != null) {
        Handler.getMain()
            .sendMessage(
                PooledLambda.obtainMessage(
                    new BiConsumer() { // from class:
                      // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda13
                      @Override // java.util.function.BiConsumer
                      public final void accept(Object obj, Object obj2) {
                        ((UserState.PrinterDiscoverySessionMediator) obj)
                            .handleDispatchPrintersAdded((List) obj2);
                      }
                    },
                    this,
                    arrayList));
    ...
    public void onPrintersRemovedLocked(List list) {
      ...
      if (arrayList != null) {
        Handler.getMain()
            .sendMessage(PooledLambda.obtainMessage(new C2439x41132d4b(), this, arrayList));
      }
    }
      ...
      if (printerInfo != null) {
        ...
        Handler.getMain()
            .sendMessage(
                PooledLambda.obtainMessage(
                    new BiConsumer() { // from class:
                      // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda12
                      @Override // java.util.function.BiConsumer
                      public final void accept(Object obj, Object obj2) {
                        ((UserState.PrinterDiscoverySessionMediator) obj)
                            .handleDispatchPrintersAdded((ArrayList) obj2);
                      }
                    },
                    this,
                    arrayList));
    ...
    public void onServiceAddedLocked(RemotePrintService remotePrintService) {
      ...
      Handler.getMain()
          .sendMessage(
              PooledLambda.obtainMessage(
                  new Consumer() { // from class:
                    // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda3
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
      ...
      if (!this.mStartedPrinterDiscoveryTokens.isEmpty()) {
        Handler.getMain()
            .sendMessage(
                PooledLambda.obtainMessage(
                    new BiConsumer() { // from class:
                      // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda4
                      @Override // java.util.function.BiConsumer
                      public final void accept(Object obj, Object obj2) {
        ...
        if (printerId.getServiceName().equals(remotePrintService.getComponentName())) {
          Handler.getMain()
              .sendMessage(
                  PooledLambda.obtainMessage(
                      new BiConsumer() { // from class:
                        // com.android.server.print.UserState$PrinterDiscoverySessionMediator$$ExternalSyntheticLambda5
                        @Override // java.util.function.BiConsumer
                        public final void accept(Object obj, Object obj2) {
    ...
    public void dumpLocked(DualDumpOutputStream dualDumpOutputStream) {
      ...
      for (int i = 0; i < beginBroadcast; i++) {
        dualDumpOutputStream.write(
            ...
            2237677961219L,
            this.mDiscoveryObservers.getBroadcastItem(i).toString());
      }
      ...
      for (int i2 = 0; i2 < size; i2++) {
        dualDumpOutputStream.write(
            "discovery_requests",
            2237677961220L,
            ((IBinder) this.mStartedPrinterDiscoveryTokens.get(i2)).toString());
      }
      ...
      for (int i3 = 0; i3 < size2; i3++) {
        com.android.internal.print.DumpUtils.writePrinterId(
            ...
            2246267895813L,
            (PrinterId) this.mStateTrackedPrinters.get(i3));
      }
      int size3 = this.mPrinters.size();
      for (int i4 = 0; i4 < size3; i4++) {
        com.android.internal.print.DumpUtils.writePrinterInfo(
    ...
    public final void handleDispatchPrintersAdded(List list) {
      ...
      for (int i = 0; i < beginBroadcast; i++) {
        handlePrintersAdded(
            (IPrinterDiscoveryObserver) this.mDiscoveryObservers.getBroadcastItem(i), list);
      }
      this.mDiscoveryObservers.finishBroadcast();
    }
    ...
    public final void handleStartPrinterStateTracking(
        RemotePrintService remotePrintService, PrinterId printerId) {
      remotePrintService.startPrinterStateTracking(printerId);
    }

    public final void handleStopPrinterStateTracking(
        RemotePrintService remotePrintService, PrinterId printerId) {
      remotePrintService.stopPrinterStateTracking(printerId);
    }

    public final void handlePrintersAdded(
        IPrinterDiscoveryObserver iPrinterDiscoveryObserver, List list) {
      try {
    ...
    public final void handlePrintersRemoved(
        IPrinterDiscoveryObserver iPrinterDiscoveryObserver, List list) {
      try {
  ...
  public final class PrintJobForAppCache {
    ...
    public boolean onPrintJobCreated(
        final IBinder iBinder, final int i, PrintJobInfo printJobInfo) {
      try {
        iBinder.linkToDeath(
    ...
    public void dumpLocked(DualDumpOutputStream dualDumpOutputStream) {
      ...
      while (i < size) {
        ...
        while (i2 < size2) {
          ...
          com.android.internal.print.DumpUtils.writePrintJobInfo(
              UserState.this.mContext,
              dualDumpOutputStream,
              "print_job",
              1146756268034L,
