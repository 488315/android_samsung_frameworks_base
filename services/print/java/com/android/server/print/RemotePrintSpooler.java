...
public final class RemotePrintSpooler {
  ...
  public final OnCustomPrinterIconLoadedCaller mCustomPrinterIconLoadedCaller =
      new OnCustomPrinterIconLoadedCaller();
  public final ClearCustomPrinterIconCacheCaller mClearCustomPrinterIconCache =
      new ClearCustomPrinterIconCacheCaller();
  public final GetCustomPrinterIconCaller mGetCustomPrinterIconCaller =
  ...
  public RemotePrintSpooler(
      Context context, int i, boolean z, PrintSpoolerCallbacks printSpoolerCallbacks) {
    ...
    try {
      try {
        PrintJobInfo printJobInfo =
            this.mGetPrintJobInfoCaller.getPrintJobInfo(getRemoteInstanceLazy(), printJobId, i);
        synchronized (this.mLock) {
          this.mCanUnbind = true;
          this.mLock.notifyAll();
        }
    ...
    try {
      try {
        Icon customPrinterIcon =
            this.mGetCustomPrinterIconCaller.getCustomPrinterIcon(
                getRemoteInstanceLazy(), printerId);
        synchronized (this.mLock) {
          this.mCanUnbind = true;
          this.mLock.notifyAll();
        }
  ...
  public final boolean setPrintJobTag(PrintJobId printJobId, String str) {
    ...
    try {
      try {
        boolean printJobTag =
            this.mSetPrintJobTagCaller.setPrintJobTag(getRemoteInstanceLazy(), printJobId, str);
        synchronized (this.mLock) {
          this.mCanUnbind = true;
          this.mLock.notifyAll();
        }
    ...
    try {
      if (dualDumpOutputStream.isProto()) {
        dualDumpOutputStream.write(
            (String) null,
            1146756268035L,
            TransferPipe.dumpAsync(getRemoteInstanceLazy().asBinder(), new String[] {"--proto"}));
      } else {
        dualDumpOutputStream.writeNested(
            "internal_state",
            TransferPipe.dumpAsync(getRemoteInstanceLazy().asBinder(), new String[0]));
      }
  ...
  public final class GetPrintJobInfosCaller extends TimedRemoteCaller {
    ...
    public GetPrintJobInfosCaller() {
      super(5000L);
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.GetPrintJobInfosCaller.1
  ...
  public final class GetPrintJobInfoCaller extends TimedRemoteCaller {
    ...
    public GetPrintJobInfoCaller() {
      ...
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.GetPrintJobInfoCaller.1
            @Override // com.android.server.print.RemotePrintSpooler.BasePrintSpoolerServiceCallbacks
  ...
  public final class SetPrintJobStateCaller extends TimedRemoteCaller {
    ...
    public SetPrintJobStateCaller() {
      ...
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.SetPrintJobStateCaller.1
            @Override // com.android.server.print.RemotePrintSpooler.BasePrintSpoolerServiceCallbacks
  ...
  public final class SetPrintJobTagCaller extends TimedRemoteCaller {
    ...
    public SetPrintJobTagCaller() {
      ...
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.SetPrintJobTagCaller.1
            @Override // com.android.server.print.RemotePrintSpooler.BasePrintSpoolerServiceCallbacks
  ...
  public final class OnCustomPrinterIconLoadedCaller extends TimedRemoteCaller {
    ...
    public OnCustomPrinterIconLoadedCaller() {
      ...
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.OnCustomPrinterIconLoadedCaller.1
            @Override // com.android.server.print.RemotePrintSpooler.BasePrintSpoolerServiceCallbacks
  ...
  public final class ClearCustomPrinterIconCacheCaller extends TimedRemoteCaller {
    ...
    public ClearCustomPrinterIconCacheCaller() {
      ...
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.ClearCustomPrinterIconCacheCaller.1
            @Override // com.android.server.print.RemotePrintSpooler.BasePrintSpoolerServiceCallbacks
  ...
  public final class GetCustomPrinterIconCaller extends TimedRemoteCaller {
    ...
    public GetCustomPrinterIconCaller() {
      ...
      this.mCallback =
          new BasePrintSpoolerServiceCallbacks() { // from class:
            // com.android.server.print.RemotePrintSpooler.GetCustomPrinterIconCaller.1
            @Override // com.android.server.print.RemotePrintSpooler.BasePrintSpoolerServiceCallbacks
