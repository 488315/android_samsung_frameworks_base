    ...
    List queryIntentServicesAsUser =
        this.mContext
            ...
            .queryIntentServicesAsUser(
                new Intent("android.printservice.recommendation.RecommendationService"),
                268435588,
    ...
    try {
      ...
      synchronized (obj) {
        boolean bindServiceAsUser =
            context.bindServiceAsUser(serviceIntent, connection, 67108865, userHandle);
      ...
      Log.e(
          "RemotePrintServiceRecS", "Could not connect to print service recommendation service", e);
    }
  }
      ...
      synchronized (RemotePrintServiceRecommendationService.this.mLock) {
        ...
        try {
          RemotePrintServiceRecommendationService.this.mService.registerCallbacks(
              new IRecommendationServiceCallbacks.Stub() { // from class:
                ...
                public void onRecommendationsUpdated(List list) {
                  synchronized (RemotePrintServiceRecommendationService.this.mLock) {
                    if (RemotePrintServiceRecommendationService.this.mIsBound
