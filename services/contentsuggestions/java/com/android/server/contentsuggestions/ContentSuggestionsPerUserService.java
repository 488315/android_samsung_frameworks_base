...
public final class ContentSuggestionsPerUserService extends AbstractPerUserSystemService {
  ...
  public ContentSuggestionsPerUserService(
      ContentSuggestionsManagerService contentSuggestionsManagerService, Object obj, int i) {
  ...
  public ServiceInfo newServiceInfoLocked(ComponentName componentName) {
    try {
      ...
      Slog.w(
          TAG,
          "ContentSuggestionsService from '"
  ...
  public void provideContextImageLocked(
      int i, HardwareBuffer hardwareBuffer, int i2, Bundle bundle) {
  ...
  public void suggestContentSelectionsLocked(
  ...
  public void classifyContentSelectionsLocked(
  ...
  public final RemoteContentSuggestionsService ensureRemoteServiceLocked() {
    if (this.mRemoteService == null) {
      ...
      this.mRemoteService =
          new RemoteContentSuggestionsService(
              getContext(),
              ComponentName.unflattenFromString(componentNameLocked),
              this.mUserId,
              new RemoteContentSuggestionsService.Callbacks() { // from class:
                // com.android.server.contentsuggestions.ContentSuggestionsPerUserService.1
                public void onServiceDied(
                    RemoteContentSuggestionsService remoteContentSuggestionsService) {
                  Slog.w(
                      ContentSuggestionsPerUserService.TAG,
                      "remote content suggestions service died");
                  ContentSuggestionsPerUserService.this.updateRemoteServiceLocked();
                }
              },
              ((ContentSuggestionsManagerService) this.mMaster).isBindInstantServiceAllowed(),
              ((ContentSuggestionsManagerService) this.mMaster).verbose);
    }
