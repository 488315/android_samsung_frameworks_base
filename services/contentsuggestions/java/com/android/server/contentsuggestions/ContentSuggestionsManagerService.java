...
public class ContentSuggestionsManagerService extends AbstractMasterSystemService {
  ...
  public ContentSuggestionsManagerService(Context context) {
    super(
        context,
        new FrameworkResourcesServiceNameResolver(context, R.string.data_usage_restricted_title),
  ...
  public final void enforceCaller(int i, String str) {
    if (getContext().checkCallingPermission("android.permission.MANAGE_CONTENT_SUGGESTIONS") == 0
        || this.mServiceNameResolver.isTemporary(i)
        || this.mActivityTaskManagerInternal.isCallerRecents(Binder.getCallingUid())) {
      return;
    }
    String str2 =
        "Permission Denial: "
  ...
  public class ContentSuggestionsManagerStub extends IContentSuggestionsManager.Stub {
    ...
    public void provideContextBitmap(int i, Bitmap bitmap, Bundle bundle) {
      ...
      ContentSuggestionsManagerService.this.enforceCaller(
          UserHandle.getCallingUserId(), "provideContextBitmap");
    ...
    public void provideContextImage(int i, int i2, Bundle bundle) {
      ...
      ContentSuggestionsManagerService.this.enforceCaller(
          UserHandle.getCallingUserId(), "provideContextImage");
      int i3 = 0;
      if (bundle.containsKey("android.contentsuggestions.extra.BITMAP")
          || (taskSnapshotBlocking =
                  ContentSuggestionsManagerService.this.mActivityTaskManagerInternal
                      .getTaskSnapshotBlocking(i2, false))
              == null) {
        hardwareBuffer = null;
      } else {
    ...
    public void suggestContentSelections(
      ...
      ContentSuggestionsManagerService.this.enforceCaller(
          UserHandle.getCallingUserId(), "suggestContentSelections");
      synchronized (ContentSuggestionsManagerService.this.mLock) {
        ContentSuggestionsPerUserService contentSuggestionsPerUserService =
            (ContentSuggestionsPerUserService)
                ContentSuggestionsManagerService.this.getServiceForUserLocked(i);
        if (contentSuggestionsPerUserService != null) {
          contentSuggestionsPerUserService.suggestContentSelectionsLocked(
    ...
    public void classifyContentSelections(
      ...
      ContentSuggestionsManagerService.this.enforceCaller(
          UserHandle.getCallingUserId(), "classifyContentSelections");
      synchronized (ContentSuggestionsManagerService.this.mLock) {
        ContentSuggestionsPerUserService contentSuggestionsPerUserService =
            (ContentSuggestionsPerUserService)
                ContentSuggestionsManagerService.this.getServiceForUserLocked(i);
        if (contentSuggestionsPerUserService != null) {
          contentSuggestionsPerUserService.classifyContentSelectionsLocked(
    ...
    public void notifyInteraction(int i, String str, Bundle bundle) {
      ContentSuggestionsManagerService.this.enforceCaller(
          UserHandle.getCallingUserId(), "notifyInteraction");
      synchronized (ContentSuggestionsManagerService.this.mLock) {
        ContentSuggestionsPerUserService contentSuggestionsPerUserService =
            (ContentSuggestionsPerUserService)
                ContentSuggestionsManagerService.this.getServiceForUserLocked(i);
    ...
    public void isEnabled(int i, IResultReceiver iResultReceiver) {
      ...
      ContentSuggestionsManagerService.this.enforceCaller(
          UserHandle.getCallingUserId(), "isEnabled");
      synchronized (ContentSuggestionsManagerService.this.mLock) {
