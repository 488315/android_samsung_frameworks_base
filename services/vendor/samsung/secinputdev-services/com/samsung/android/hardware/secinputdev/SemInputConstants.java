...
public class SemInputConstants {
    ...
    public enum MotionType implements Parcelable {
        ...
        PALM_MUTE(
                1,
                SemInputDeviceManager.MOTION_ENABLE_TYPE_PALM,
                SemInputDeviceManager.SUPPORT_RAWDATA_MOTION_PALM),
        PALM_SWIPE(
                2,
                SemInputDeviceManager.MOTION_ENABLE_TYPE_PALM_SWIPE,
                SemInputDeviceManager.SUPPORT_RAWDATA_MOTION_PALM_SWIPE),
        EAR_DETECTION(3, "EAR_DETECTION", 0),
        GRIP_FILTER(4, "GRIP_FILTER", 0),
        AIVF(
                5,
                SemInputDeviceManager.MOTION_ENABLE_TYPE_AIVF,
                SemInputDeviceManager.SUPPORT_RAWDATA_MOTION_AIVF),
        AWD(
                6,
                SemInputDeviceManager.MOTION_ENABLE_TYPE_AWD,
                SemInputDeviceManager.SUPPORT_RAWDATA_MOTION_AWD),
        CALLBACK(7, "CALLBACK", -1),
        STREAM(8, "STREAM", -1),
        APD(
                9,
                SemInputDeviceManager.MOTION_ENABLE_TYPE_POCKET_DETECT,
