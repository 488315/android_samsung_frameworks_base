...
public interface ISehSysInputDev extends IBase {
    public static final String kInterfaceName =
            "vendor.samsung.hardware.sysinput@1.0::ISehSysInputDev";
    ...
    void getKeyCodePressed(int i, getKeyCodePressedCallback getkeycodepressedcallback)
            throws RemoteException;

    void getSpenCommandList(getSpenCommandListCallback getspencommandlistcallback)
            throws RemoteException;

    void getSpenPosition(getSpenPositionCallback getspenpositioncallback) throws RemoteException;

    void getTspAodActiveArea(int i, getTspAodActiveAreaCallback gettspaodactiveareacallback)
            throws RemoteException;

    void getTspCommandList(int i, getTspCommandListCallback gettspcommandlistcallback)
            throws RemoteException;

    void getTspFodInformation(int i, getTspFodInformationCallback gettspfodinformationcallback)
            throws RemoteException;

    void getTspFodPosition(int i, getTspFodPositionCallback gettspfodpositioncallback)
            throws RemoteException;

    void getTspScrubPosition(int i, getTspScrubPositionCallback gettspscrubpositioncallback)
            throws RemoteException;

    void getTspSupportFeature(int i, getTspSupportFeatureCallback gettspsupportfeaturecallback)
            throws RemoteException;
