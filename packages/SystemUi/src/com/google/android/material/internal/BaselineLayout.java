    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int m8m = AbsActionBarView$$ExternalSyntheticOutline0.m8m(paddingRight, measuredWidth, 2, paddingLeft);
                int baseline = (this.baseline == -1 || childAt.getBaseline() == -1) ? paddingTop : (this.baseline + paddingTop) - childAt.getBaseline();
                childAt.layout(m8m, baseline, measuredWidth + m8m, measuredHeight + baseline);
            }
        }
    }
