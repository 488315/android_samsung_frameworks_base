...
public final class Domain {
    ...
    static {
        ...
        Domain domain = new Domain("REGISTRATION", 0, str.equals("eng") ? "https://stg-api.di.atlas.samsung.com" : "https://regi.di.atlas.samsung.com");
        REGISTRATION = domain;
        Domain domain2 = new Domain("POLICY", 1, str.equals("eng") ? "https://stg-api.di.atlas.samsung.com" : "https://dc.di.atlas.samsung.com");
        POLICY = domain2;
