...
import com.samsung.android.knox.p046zt.devicetrust.cert.ICertProvisionListener;
import com.samsung.android.knox.p046zt.devicetrust.monitor.IMonitoringListener;
import com.samsung.android.knox.p046zt.service.IKnoxZtService;
import com.samsung.android.knox.p046zt.service.IServiceCertProvisionListener;
import com.samsung.android.knox.p046zt.service.IServiceMonitoringListener;
import java.io.File;
...
public final class KnoxZtService {
    ...
    public final int provisionCert(CertProvisionProfile certProvisionProfile, final ICertProvisionListener iCertProvisionListener) {
        ...
        int provisionCert = getService().provisionCert(getParcelableProfile(certProvisionProfile), new IServiceCertProvisionListener.Stub() { // from class: com.samsung.android.knox.zt.service.KnoxZtService.1
            @Override // com.samsung.android.knox.p046zt.service.IServiceCertProvisionListener
