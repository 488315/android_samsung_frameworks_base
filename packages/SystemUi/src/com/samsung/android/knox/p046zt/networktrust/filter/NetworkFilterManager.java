package com.samsung.android.knox.p046zt.networktrust.filter;
        ...
        if (getService() != null) {
            ...
            if (i == 0) {
                ...
                if (this.mContext != null) {
                    ListPopupWindow$$ExternalSyntheticOutline0.m10m("startActivityAsUser  KnoxVpnPPDialog userId = ", userId, TAG);
