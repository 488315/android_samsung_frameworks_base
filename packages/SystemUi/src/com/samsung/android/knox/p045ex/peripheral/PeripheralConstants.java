...
public final class PeripheralConstants {
    ...
    public static final String KEY_PROFILE_REMOVE_BLUETOOTH_POPUP_BOOL = "KEY_PROFILE_REMOVE_BLUETOOTH_POPUP_BOOL";
    ...
    public static class BarcodeDataProcessMode {
        ...
        private BarcodeDataProcessMode() {
        }
    }
    ...
    public static class BtPeripheralListOption {
        ...
        private BtPeripheralListOption() {
        }
    }
    ...
    public static class VibrationEffect {
        ...
        private VibrationEffect() {
        }
    }

    private PeripheralConstants() {
    }
}
