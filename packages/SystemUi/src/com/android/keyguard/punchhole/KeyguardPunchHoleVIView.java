...
public class KeyguardPunchHoleVIView extends FrameLayout {
    ...
    public KeyguardPunchHoleVIViewController.C08711 mPunchHoleCallback;
    ...
    public final void setPrepareState(int i) {
        ...
        KeyguardSecUpdateMonitorImpl$$ExternalSyntheticOutline0.m79m(new StringBuilder("setPrepareState() "), this.mPreparedState, " -> ", i, this.TAG);
    ...
    public final void updateScreenConfig() {
        ...
        boolean z = ((DisplayLifecycle) Dependency.get(DisplayLifecycle.class)).mIsFolderOpened || this.mLastDisplayDeviceType == 0;
        ...
        if (this.mLastUpdatedRotation != screenRotation || this.mLastUpdatedScreenWidth != screenWidth || this.mLastUpdatedScreenHeight != screenHeight || z2) {
            ...
            AutoFitGridLayoutManager$$ExternalSyntheticOutline0.m40m(sb2, this.mLastUpdatedRotation, " -> ", screenRotation, ", screen width ");
            AutoFitGridLayoutManager$$ExternalSyntheticOutline0.m40m(sb2, this.mLastUpdatedScreenWidth, " -> ", screenWidth, ", screen height ");
            KeyguardSecUpdateMonitorImpl$$ExternalSyntheticOutline0.m79m(sb2, this.mLastUpdatedScreenHeight, " -> ", screenHeight, str2);
            ...
            if (z2) {
                KeyguardCarrierViewController$$ExternalSyntheticOutline0.m63m(new StringBuilder("updateScreenConfig() isFolderOpened "), this.mLastUpdatedFolderOpened, " -> ", z, this.TAG);
                this.mLastUpdatedFolderOpened = z;
                KeyguardPunchHoleVIViewController.C08711 c08711 = this.mPunchHoleCallback;
                if (c08711 != null) {
        ...
        KeyguardPunchHoleVIViewController.C08711 c087112 = this.mPunchHoleCallback;
        if (c087112 != null) {
    ...
    public final void updateVILocation() {
        ...
        if (z) {
            ...
            if (pointF2 == null) {
                ListPopupWindow$$ExternalSyntheticOutline0.m10m("getVIViewLocation() - return; vi size is not supported, animation = ", i2, "KeyguardPunchHoleVIView_VIDirector");
            } else {
        ...
        sb2.append(z);
        sb2.append(" rotation = ");
        KeyguardSecUpdateMonitorImpl$$ExternalSyntheticOutline0.m79m(sb2, this.mLastUpdatedRotation, " -> ", screenRotation, str2);
        this.mLastUpdatedRotation = screenRotation;
