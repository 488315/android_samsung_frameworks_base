...
public class KeyguardSecSecurityContainer extends KeyguardSecurityContainer {
    ...
    public final class ArrowViewMode implements SecViewMode {
        ...
        public final void updateSecurityViewPosition(int i, boolean z) {
            ...
            int i3 = ((KeyguardUpdateMonitor) Dependency.get(KeyguardUpdateMonitor.class)).isInDisplayFingerprintMarginAccepted() ? DeviceState.sInDisplayFingerprintHeight : 0;
            if (i == 0 ? rotation == 3 : !(i != 2 || rotation != 1)) {
                dimensionPixelSize += i3;
            }
            int i4 = dimensionPixelSize;
            Resources resources2 = this.mView.getResources();
            int dimensionPixelSize2 = LsRune.SECURITY_NAVBAR_ENABLED ? resources2.getDimensionPixelSize(android.R.dimen.notification_content_margin_end) : 0;
            ...
            int i5 = (rotation2 != 0 || i2 == 0) ? dimensionPixelSize2 : i2;
            if (i == 0) {
                constraintSet.connect(this.mViewFlipper.getId(), 1, 0, 1, i4);
            } else if (i == 2) {
                constraintSet.connect(this.mViewFlipper.getId(), 2, 0, 2, i4);
            } else {
                constraintSet.connect(this.mViewFlipper.getId(), 1, 0, 1);
                constraintSet.connect(this.mViewFlipper.getId(), 2, 0, 2);
            }
            constraintSet.connect(this.mViewFlipper.getId(), 4, 0, 4, i5);
