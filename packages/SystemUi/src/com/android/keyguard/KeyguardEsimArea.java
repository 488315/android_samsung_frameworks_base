    ...
    public KeyguardEsimArea(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mReceiver = new BroadcastReceiver() { // from class: com.android.keyguard.KeyguardEsimArea.1
            ...
            public final void onReceive(Context context2, Intent intent) {
                ...
                AlertDialog create = new AlertDialog.Builder(((Button) KeyguardEsimArea.this).mContext).setMessage(com.android.systemui.R.string.error_disable_esim_msg).setTitle(com.android.systemui.R.string.error_disable_esim_title).setCancelable(false).setPositiveButton(com.android.systemui.R.string.f789ok, (DialogInterface.OnClickListener) null).create();
