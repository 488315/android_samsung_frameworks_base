...
public class SystemUITextView extends TextView implements SystemUIWidgetCallback {
    ...
    public final C37341 mLockStarCallback;
    ...
    public void onAttachedToWindow() {
        ...
        RecyclerView$$ExternalSyntheticOutline0.m46m(new StringBuilder("onAttachedToWindow mAttrCount = "), this.mAttrCount, "SystemUITextView");
    ...
    public final void updateCompoundDrawable(boolean z) {
        ...
        } else if (WallpaperUtils.mSettingsHelper.isOpenThemeLockWallpaper() || !WallpaperUtils.isWhiteKeyguardWallpaper(this.mResData.mWallpaperArea)) {
    ...
    */
    public final void updateTextView() {
        ...
        int alphaComponent = ColorUtils.setAlphaComponent(isWhiteKeyguardWallpaper ? getContext().getColor(R.color.black_font_shadow_color) : getContext().getColor(R.color.white_font_shadow_color), (int) (hint.getShadowOpacity() * 255.0f));
        float shadowSize = hint.getShadowSize();
        ResData resData = this.mResData;
        int i4 = isWhiteKeyguardWallpaper ? resData.mWhiteBgBackgroundId : resData.mOriginBackgroundId;
        if ((this.mUpdateFlag & 1) == 0 || !WallpaperUtils.isOpenThemeLook()) {
            ResData resData2 = this.mResData;
            if (resData2.mWallpaperColorIgnorable) {
                int i5 = isWhiteKeyguardWallpaper ? resData2.mWhiteBgColorId : resData2.mOriginColorId;
                int i6 = isWhiteKeyguardWallpaper ? resData2.mWhiteBgShadowColorId : resData2.mOriginShadowColorId;
                if (i5 > 0) {
        ...
        if (this.mResData.mReduceTransparency) {
            ...
            if (((SettingsHelper) Dependency.get(SettingsHelper.class)).isReduceTransparencyEnabled()) {
                setTextColor(((TextView) this).mContext.getResources().getColor(isWhiteKeyguardWallpaper ? this.mResData.mOriginColorId : this.mResData.mWhiteBgColorId, null));
        ...
        if (r7 > 0) {
            fontColorRgb = ((TextView) this).mContext.getResources().getColor(r7, null);
        }
