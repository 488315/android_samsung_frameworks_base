...
public class InvocationLightsView extends View implements NavigationBarTransitions.DarkIntensityListener {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (rotation != perimeterPathGuide.mRotation) {
            if (rotation != 0 && rotation != 1 && rotation != 2 && rotation != 3) {
                NestedScrollView$$ExternalSyntheticOutline0.m34m("Invalid rotation provided: ", rotation, "PerimeterPathGuide");
            } else {
    ...
    public final void setLight(float f, float f2, int i) {
        if (i < 0 || i >= 4) {
            IconCompat$$ExternalSyntheticOutline0.m30m("invalid invocation light index: ", i, "InvocationLightsView");
        }
