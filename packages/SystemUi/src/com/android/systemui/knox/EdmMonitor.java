...
public final class EdmMonitor extends ISystemUIAdapterCallback.Stub implements Dumpable {
    ...
    public final void setAdminLock(boolean z, boolean z2) {
        EmergencyButtonController$$ExternalSyntheticOutline0.m59m("setAdminLock enabled:", z, "  licenseExpired:", z2, "EdmMonitor");
    ...
    public final void updateFailedUnlockAttemptForDeviceDisabled() {
        ...
        ActionBarContextView$$ExternalSyntheticOutline0.m9m(new StringBuilder("isDeviceDisabledForMaxFailedAttempt="), this.mIsDeviceDisableForMaxFailedAttempt, "EdmMonitor");
    ...
    public final void updateFailedUnlockAttemptForProfileDisabled() {
        ...
        int currentFailedAttempts = getCurrentFailedAttempts();
        this.mIsProfileDisableForMaxFailedAttempt = currentFailedAttempts >= this.mMaxNumFailedAttemptForProfileDisable;
        ...
        ActionBarContextView$$ExternalSyntheticOutline0.m9m(new StringBuilder("isProfileDisableForMaxFailedAttempt="), this.mIsProfileDisableForMaxFailedAttempt, "EdmMonitor");
