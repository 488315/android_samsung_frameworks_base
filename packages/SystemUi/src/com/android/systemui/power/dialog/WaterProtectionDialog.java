...
public final class WaterProtectionDialog extends PowerUiDialog {
    ...
    public final AlertDialog getDialog() {
        ...
        ((TextView) inflate.findViewById(R.id.notice_text)).setText(DeviceType.isTablet() ? context.getString(R.string.water_protection_notification_body_tablet) : PowerUiRune.WIRELESS_CHARGING ? context.getString(R.string.water_protection_notification_body_support_wireless_charging) : context.getString(R.string.water_protection_notification_body));
        ...
        String string = context.getString(R.string.water_protection_notification_title);
