...
public class UnintentionalLcdOnView extends LinearLayout {
    ...
    public final C19712 mDCircleEndListener;
    ...
    public static void m1614$$Nest$monLockerActionMove(UnintentionalLcdOnView unintentionalLcdOnView, MotionEvent motionEvent) {
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                try {
                    ...
                    if (action != 0) {
                        if (action != 1) {
                            if (action == 2) {
                                UnintentionalLcdOnView.m1614$$Nest$monLockerActionMove(UnintentionalLcdOnView.this, motionEvent);
