...
public final class BackupRestoreReceiver {
    public final HandlerC36571 mHandler = new Handler(this) { // from class: com.android.systemui.wallpaper.BackupRestoreReceiver.1
    ...
    public final C36582 mBroadcastReceiver = new BroadcastReceiver() { // from class: com.android.systemui.wallpaper.BackupRestoreReceiver.2
