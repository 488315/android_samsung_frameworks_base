...
public final class Operator {
    ...
    public static int getMessageIdForMobileDataOnOffPopup(boolean z) {
        ...
        if (!z) {
            return z2 ? R.string.mobile_data_show_popup_enable_kor_lgt : R.string.mobile_data_show_popup_enable_kor;
        }
        if (z2) {
        ...
        return TelephonyManager.getDefault().isDataEnabledForApn(2) ? R.string.mobile_data_show_popup_disable_kor_kt_mms_available : R.string.mobile_data_show_popup_disable_kor_kt;
    }

    public static int getMessageIdMobileDataOff() {
        return isUSAQsTileBranding() ? QUICK_IS_ATT_BRANDING ? R.string.mobile_data_show_popup_disable_att : R.string.mobile_data_show_popup_disable : QUICK_IS_DCM_BRANDING ? R.string.mobile_data_show_popup_disable_dcm : R.string.mobile_data_show_popup_disable_jpn;
    }
    ...
    public static boolean supportNetworkInfoAtMultisimBar() {
        return "US".equals(SemCscFeature.getInstance().getString("CountryISO", "")) || "CA".equals(SemCscFeature.getInstance().getString("CountryISO", ""));
    }
}
