...
public final class VideoCallMicModeBar extends BarItemImpl {
    ...
    public final void updateBarVisibilities() {
        ...
        StringBuilder m69m = KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m69m("updateBarVisibilities: videoCall: ", booleanValue, " micMode: ", booleanValue3, " voIPTranslator: ");
        m69m.append(booleanValue2);
        Log.d(this.TAG, m69m.toString());
