...
public final class LightSourceDrawable extends Drawable {
    ...
    */
    ...
    public void draw(Canvas canvas) {
        ...
        paint.setShader(new RadialGradient(rippleData2.f308x, rippleData2.f309y, lerp, new int[]{alphaComponent, 0}, LightSourceDrawableKt.GRADIENT_STOPS, Shader.TileMode.CLAMP));
        RippleData rippleData3 = this.rippleData;
        canvas.drawCircle(rippleData3.f308x, rippleData3.f309y, lerp, this.paint);
    }
    ...
    public Rect getDirtyBounds() {
        ...
        float lerp = MathUtils.lerp(rippleData.minSize, rippleData.maxSize, rippleData.progress);
        RippleData rippleData2 = this.rippleData;
        float f = rippleData2.f308x;
        float f2 = rippleData2.f309y;
