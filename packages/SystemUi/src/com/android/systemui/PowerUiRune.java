...
public final class PowerUiRune extends Rune {
    ...
    static {
        ...
        LOW_BATTTERY_SOUND_THEME = Build.VERSION.SEM_PLATFORM_INT >= 120100;
        String string2 = ("user".equals(Build.TYPE) || (SystemProperties.getInt("persist.debug.subdisplay_test_mode", 0) & 1) == 0) ? SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_SUBDISPLAY_POLICY") : "";
        ...
        boolean z2 = (Build.VERSION.SEM_PLATFORM_INT >= 150100) && z && !SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_BATTERY_DISABLE_ECO_BATTERY");
        BATTERY_PROTECTION = z2;
        POLICY_CHARGING_NOTIFICATION = Build.VERSION.SEM_PLATFORM_INT >= 150000;
