...
public final class WirelessChargingAnimation {
    ...
    public final class WirelessChargingView {
        ...
        public final HandlerC11371 mHandler;
        ...
        public final void hide(long j) {
            HandlerC11371 handlerC11371 = this.mHandler;
            handlerC11371.removeMessages(1);
            if (WirelessChargingAnimation.DEBUG) {
                Slog.d("WirelessChargingView", "HIDE: " + this);
            }
            handlerC11371.sendMessageDelayed(Message.obtain(handlerC11371, 1), j);
        }
    }
    ...
    public static WirelessChargingAnimation makeWirelessChargingAnimation(Context context, int i, CentralSurfacesImpl.C30268 c30268, RippleShader.RippleShape rippleShape, UiEventLogger uiEventLogger) {
        return new WirelessChargingAnimation(context, null, -1, i, c30268, false, rippleShape, uiEventLogger);
    }
}
