...
public final class TextInterpolator {
    ...
    public final class FontRun {
        ...
        public final int hashCode() {
            return this.targetFont.hashCode() + ((this.baseFont.hashCode() + AppInfoViewData$$ExternalSyntheticOutline0.m42m(this.end, Integer.hashCode(this.start) * 31, 31)) * 31);
        }
    ...
    public final void drawFontRun(Canvas canvas, Run run, FontRun fontRun, int i, Paint paint) {
        ...
        while (i11 < i7) {
            ...
            tmpGlyph.getClass();
            int i14 = i12;
            getTmpGlyph().f227x = MathUtils.lerp(fArr5[i11], fArr4[i11], this.progress);
            getTmpGlyph().f228y = MathUtils.lerp(fArr3[i11], fArr2[i11], this.progress);
            ...
            int i15 = i4 + 1;
            this.tmpPositionArray[i4] = getTmpGlyph().f227x;
            this.tmpPositionArray[i15] = getTmpGlyph().f228y;
            i11 = i2 + 1;
            i12 = i15 + 1;
            i7 = i3;
            fArr5 = fArr;
        ...
        while (it5.hasNext() && it6.hasNext()) {
            ...
            while (it7.hasNext() && it8.hasNext()) {
                ...
                if (!(positionedGlyphs3.glyphCount() == positionedGlyphs2.glyphCount())) {
                    throw new IllegalArgumentException(AbstractC0000x2c234b15.m0m("Inconsistent glyph count at line ", textInterpolator.lines.size()).toString());
                }
                ...
                for (int i3 = 0; i3 < glyphCount; i3++) {
                    ...
                    if (!(glyphId == positionedGlyphs2.getGlyphId(i3))) {
                        throw new IllegalArgumentException(AbstractC0970x34f4116a.m94m("Inconsistent glyph ID at ", i3, " in line ", textInterpolator.lines.size()).toString());
                    }
                ...
                if (glyphCount != 0) {
                    ...
                    while (i9 < glyphCount) {
                        ...
                        if (font3 != font4) {
                            if (!(font2 != font5)) {
                                throw new IllegalArgumentException(LocaleListCompatWrapper$$ExternalSyntheticOutline0.m31m("Base font has changed at ", i9, " but target font is unchanged.").toString());
                            }
                            ...
                            positionedGlyphs = positionedGlyphs2;
                            if (!(font2 == font5)) {
                                throw new IllegalArgumentException(LocaleListCompatWrapper$$ExternalSyntheticOutline0.m31m("Base font is unchanged at ", i9, " but target font has changed.").toString());
                            }
                        }
                        i9++;
