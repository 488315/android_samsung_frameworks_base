...
public final class LooperSlowLogControllerImpl implements Dumpable, LooperSlowLogController {
    ...
    public final class LogType {
        ...
        public final int hashCode() {
            int m51m = TraceMetadata$$ExternalSyntheticOutline0.m51m(this.lastEnabledTime, TraceMetadata$$ExternalSyntheticOutline0.m51m(this.deliveryTime, TraceMetadata$$ExternalSyntheticOutline0.m51m(this.dispatchTime, Integer.hashCode(this.type) * 31, 31), 31), 31);
    ...
    public final void update() {
        ...
        sb.append(j2);
        sb.append(" cOnly=");
        KeyguardCarrierViewController$$ExternalSyntheticOutline0.m63m(sb, z, " hasLogHandler=", z2, "LooperSlow");
