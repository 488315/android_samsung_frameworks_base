...
public final class DoubleShadowTextHelper {
    ...
    public final class ShadowInfo {
        ...
        public final int hashCode() {
            return Float.hashCode(this.alpha) + UdfpsOverlayParams$$ExternalSyntheticOutline0.m90m(this.offsetY, UdfpsOverlayParams$$ExternalSyntheticOutline0.m90m(this.offsetX, Float.hashCode(this.blur) * 31, 31), 31);
        }
