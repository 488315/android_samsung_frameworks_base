            ...
            synchronized (this.mTaskStackListeners) {
                ...
                if (i == 1) {
                            ...
                            switch (i) {
                                ...
                                case 102:
                                    for (int size23 = ((ArrayList) this.mTaskStackListeners).size() - 1; size23 >= 0; size23--) {
                                        TaskStackChangeListener taskStackChangeListener4 = (TaskStackChangeListener) ((ArrayList) this.mTaskStackListeners).get(size23);
                    ...
                    for (int size24 = ((ArrayList) this.mTaskStackListeners).size() - 1; size24 >= 0; size24--) {
                        ((TaskStackChangeListener) ((ArrayList) this.mTaskStackListeners).get(size24)).onTaskProfileLocked(runningTaskInfo2, i2);
                    }
                }
            }
