...
public final class PickupController extends SensorController implements Dumpable {
    ...
    public static final boolean access$isLiftToWakeEnabled(PickupController pickupController) {
        ...
        return !FactoryTest.isFactoryBinary() && pickupController.settingsHelper.mItemLists.get("lift_to_wake").getIntValue() == 1;
    }
    ...
    public final void onTrigger() {
        ...
        ListPopupWindow$$ExternalSyntheticOutline0.m10m("onTrigger Listener.size()=", this.pickupListener.size(), "PickupController");
