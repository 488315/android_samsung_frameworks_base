...
public final class KeyButtonDrawable extends Drawable {
    public static final C18711 KEY_DRAWABLE_ROTATE = new FloatProperty("KeyButtonRotation") { // from class: com.android.systemui.navigationbar.buttons.KeyButtonDrawable.1
    ...
    public static final C18722 KEY_DRAWABLE_TRANSLATE_Y = new FloatProperty("KeyButtonTranslateY") { // from class: com.android.systemui.navigationbar.buttons.KeyButtonDrawable.2
        @Override // android.util.Property
        public final Float get(Object obj) {
    ...
    public final C18733 mAnimatedDrawableCallback;
