                        ...
                        new Thread(str) { // from class: com.android.systemui.qs.tiles.ScreenCaptureTile.2
                            ...
                            public final void run() {
                                try {
                                    ...
                                    int i2 = ScreenCaptureTile.$r8$clinit;
                                    DisplayMetrics displayMetrics = screenCaptureTile3.mContext.getResources().getDisplayMetrics();
                    ...
                    new Thread(str) { // from class: com.android.systemui.qs.tiles.ScreenCaptureTile.2
                        ...
                        public final void run() {
                            try {
                                ...
                                int i2 = ScreenCaptureTile.$r8$clinit;
                                DisplayMetrics displayMetrics = screenCaptureTile32.mContext.getResources().getDisplayMetrics();
                                Thread.sleep(((float) displayMetrics.widthPixels) / displayMetrics.density > 457.0f ? 370 : 100);
