...
public class QSDetailItems extends FrameLayout {
    ...
    public final HandlerC2045H mHandler;
    ...
    public final class HandlerC2045H extends Handler {
        public HandlerC2045H() {
        ...
        public final void handleMessage(Message message) {
            ...
            if (i2 == 3) {
                ...
                if (qSDetailItems2.mItemsVisible == z2) {
                    return;
                }
                qSDetailItems2.mItemsVisible = z2;
                for (int i3 = 0; i3 < qSDetailItems2.mItemList.getChildCount(); i3++) {
                    qSDetailItems2.mItemList.getChildAt(i3).setVisibility(qSDetailItems2.mItemsVisible ? 0 : 4);
                }
            }
        }
    }
    ...
    public QSDetailItems(Context context, AttributeSet attributeSet) {
        ...
        this.mHandler = new HandlerC2045H();
