...
@DebugMetadata(m276c = "com.android.systemui.keyguard.domain.interactor.FromPrimaryBouncerTransitionInteractor$listenForPrimaryBouncerToAodOrDozing$1", m277f = "FromPrimaryBouncerTransitionInteractor.kt", m278l = {108}, m279m = "invokeSuspend")
/* renamed from: com.android.systemui.keyguard.domain.interactor.FromPrimaryBouncerTransitionInteractor$listenForPrimaryBouncerToAodOrDozing$1 */
/* loaded from: classes.dex */
final class C1693x832cb018 extends SuspendLambda implements Function2 {
    int label;
    ...
    public C1693x832cb018(FromPrimaryBouncerTransitionInteractor fromPrimaryBouncerTransitionInteractor, Continuation<? super C1693x832cb018> continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new C1693x832cb018(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((C1693x832cb018) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromPrimaryBouncerTransitionInteractor$listenForPrimaryBouncerToAodOrDozing$1.4
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    if (!booleanValue) {
                        ...
                        if (keyguardState == keyguardState2 && ((wakefulnessState = wakefulnessModel.state) == WakefulnessState.STARTING_TO_SLEEP || wakefulnessState == WakefulnessState.ASLEEP)) {
                            KeyguardState keyguardState3 = booleanValue2 ? KeyguardState.AOD : KeyguardState.DOZING;
