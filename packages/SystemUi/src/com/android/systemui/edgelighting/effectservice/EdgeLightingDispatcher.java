...
public final class EdgeLightingDispatcher implements IEdgeLightingController {
    ...
    public C13452 mSettingObserver;
    ...
    public final void setForceSettingValue(String str) {
        C13452 c13452 = this.mSettingObserver;
    ...
    public final void updateSetting(String str) {
        ...
        Context context = this.mContext;
        String edgeLightingStyleType = isEmpty ? EdgeLightingStyleManager.getInstance().getEdgeLightingStyleType(context.getContentResolver()) : str;
        ...
        StringBuilder m4m = ActivityResultRegistry$$ExternalSyntheticOutline0.m4m("updateSetting:forceValue=", str, ",mDefaultLighting=");
        m4m.append(this.mDefaultLighting);
        m4m.append(",mPackageName=null,mClassName=null");
        Slog.d("EdgeLightingDispatcher", m4m.toString());
    }
