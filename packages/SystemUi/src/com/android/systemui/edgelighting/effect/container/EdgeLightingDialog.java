...
public final class EdgeLightingDialog extends Dialog implements IEdgeLightingController {
    ...
    public final C13144 mEdgeAnimationListener;
    public final HandlerC13111 mHandler;
    ...
    /* compiled from: qb/89794335 06599c810852d30e4467fa5f916efb8291776d5f5b22da1b00b853844284f76c */
    /* renamed from: com.android.systemui.edgelighting.effect.container.EdgeLightingDialog$4 */
    public final class C13144 {
        public C13144() {
        }
        ...
        public final void onFinishAnimation() {
            ...
            if (applicationEffect == null || !(applicationEffect == null || applicationEffect.isShown())) {
                ...
                if (notificationEffect == null || !(notificationEffect == null || notificationEffect.isShown())) {
                    EdgeLightingDialog.m1535$$Nest$mselfDismissWindow(edgeLightingDialog);
                }
            }
        }
    }
    ...
    public static void m1534$$Nest$mdismissInternal(EdgeLightingDialog edgeLightingDialog) {
    ...
    public static void m1535$$Nest$mselfDismissWindow(EdgeLightingDialog edgeLightingDialog) {
    ...
    public EdgeLightingDialog(Context context) {
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: com.android.systemui.edgelighting.effect.container.EdgeLightingDialog.1
            ...
            public final void dispatchMessage(Message message) {
                ...
                EdgeLightingDialog.m1534$$Nest$mdismissInternal(EdgeLightingDialog.this);
            }
        };
        this.mEdgeAnimationListener = new C13144();
    }
    ...
    public final void stopPreview() {
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.android.systemui.edgelighting.effect.container.EdgeLightingDialog.3
            ...
            public final void run() {
                EdgeLightingDialog.m1535$$Nest$mselfDismissWindow(EdgeLightingDialog.this);
            }
        }, 500L);
    }
