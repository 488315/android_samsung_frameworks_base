        ...
        if (match == 1) {
            ...
            for (String str5 : str.split(END_DELEMETER)) {
                ...
                if (split3 != null && split3.length == 2) {
                    ...
                    String stringForUser = Settings.System.getStringForUser(context.getContentResolver(), "edge_lighting_custom_text_color", -2);
                    Settings.System.putStringForUser(context.getContentResolver(), "edge_lighting_custom_text_color", AbstractC0950x8906c950.m92m(stringForUser != null ? stringForUser : "", str6, ";", parseInt, ";").toString(), -2);
                }
            }
        }
        return null;
