            ...
            public final void run() {
                ...
                if (list.isEmpty()) {
                    ...
                    if (selectedIndex >= list.size()) {
                        ...
                        walletScreenController.mWalletView.showCardCarousel(list, selectedIndex, true ^ walletScreenController.mKeyguardStateController.isUnlocked(), walletScreenController.mKeyguardUpdateMonitor.isUdfpsEnrolled() && walletScreenController.mKeyguardUpdateMonitor.isFingerprintDetectionRunning());
                    }
                }
