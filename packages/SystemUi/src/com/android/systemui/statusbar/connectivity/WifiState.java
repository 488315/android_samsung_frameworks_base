...
public final class WifiState extends ConnectivityState {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual(WifiState.class, obj != null ? obj.getClass() : null) || !super.equals(obj)) {
            return false;
        }
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (Boolean.hashCode(this.isDefault) + ((Boolean.hashCode(this.isTransient) + ((hashCode + (str != null ? str.hashCode() : 0)) * 31)) * 31)) * 31;
        String str2 = this.statusLabel;
        return ((Boolean.hashCode(this.isDefaultConnectionValidated) + ((Boolean.hashCode(this.isCarrierMerged) + ((hashCode2 + (str2 != null ? str2.hashCode() : 0)) * 31)) * 31)) * 31) + this.subId;
    }
