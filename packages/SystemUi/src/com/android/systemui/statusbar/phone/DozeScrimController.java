...
public final class DozeScrimController implements StatusBarStateController.StateListener {
    ...
    public final C30301 mScrimCallback = new ScrimController.Callback() { // from class: com.android.systemui.statusbar.phone.DozeScrimController.1
    ...
    public final RunnableC30312 mPulseOutExtended = new Runnable() { // from class: com.android.systemui.statusbar.phone.DozeScrimController.2
    ...
    public final RunnableC30323 mPulseOut = new RunnableC30323();

    /* compiled from: qb/89794335 06599c810852d30e4467fa5f916efb8291776d5f5b22da1b00b853844284f76c */
    /* renamed from: com.android.systemui.statusbar.phone.DozeScrimController$3 */
    public final class RunnableC30323 implements Runnable {
        public RunnableC30323() {
        }
