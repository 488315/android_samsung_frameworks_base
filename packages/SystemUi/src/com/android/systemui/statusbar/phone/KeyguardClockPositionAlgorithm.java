...
public class KeyguardClockPositionAlgorithm {
    ...
    public void run(Result result) {
        ...
        result.stackScrollerPadding = z ? (int) (this.mUnlockedStackScrollerPadding + this.mOverStretchAmount) : this.mIsSplitShade ? ((clockY2 + 0) + this.mUserSwitchHeight) - ((int) this.mCurrentBurnInOffsetY) : clockY2 + this.mKeyguardStatusHeight;
        if (z) {
