...
public class BarTransitions {
    ...
    public static String modeToString(int i) {
        ...
        throw new IllegalArgumentException(AbstractC0000x2c234b15.m0m("Unknown mode ", i));
    }
    ...
    public class BarBackgroundDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (i2 == 5) {
                ...
                boolean z = BasicRune.NAVBAR_ENABLED;
                i = (z && i2 == 7) ? this.mLightSemiTransparent : (z && i2 == 8) ? this.mNavBarStateManager.isNavigationBarUseThemeDefault() ? this.mLightSemiTransparent : this.mOpaque : this.mOpaque;
            }
            if (this.mAnimating) {
