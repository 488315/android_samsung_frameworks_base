...
public abstract class SubscreenNotificationTemplate {
    ...
    public final ViewOnTouchListenerC27721 mOnTouchListener = new View.OnTouchListener() { // from class: com.android.systemui.statusbar.notification.SubscreenNotificationTemplate.1
        public float mInitX;
        public float mInitY;
