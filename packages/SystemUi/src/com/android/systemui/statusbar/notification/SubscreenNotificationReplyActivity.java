...
public final class SubscreenNotificationReplyActivity extends Activity implements CommandQueue.Callbacks {
    ...
    public final SubscreenNotificationReplyActivity$displayListener$1 displayListener = new DisplayLifecycle.Observer() { // from class: com.android.systemui.statusbar.notification.SubscreenNotificationReplyActivity$displayListener$1
        ...
        public final void onFolderStateChanged(boolean z) {
            KeyguardCarrierPasswordViewController$$ExternalSyntheticOutline0.m62m("isFolderOpened: ", z, SubscreenNotificationReplyActivity.TAG);
            if (z) {
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (valueOf != null) {
            if (valueOf.intValue() == 1 && keyEvent.getKeyCode() == 66) {
                ImageView imageView2 = this.sendButton;
                if ((imageView2 != null && imageView2.isFocused()) && (imageView = this.sendButton) != null) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        ObjectAnimator.ofFloat(linearLayout2 != null ? linearLayout2 : null, (Property<LinearLayout, Float>) View.ALPHA, 0.5f, 1.0f).setDuration(250L).start();
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.SubscreenNotificationReplyActivity$initView$4$1
            ...
            public final void onClick(View view) {
                ...
                LinearLayout linearLayout3 = subscreenNotificationReplyActivity4.replyLayout;
                if (linearLayout3 == null) {
                    linearLayout3 = null;
                }
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(linearLayout3, (Property<LinearLayout, Float>) View.ALPHA, 1.0f, 0.0f);
