...
public final class CastControllerImpl implements CastController {
    ...
    public final C33752 mProjectionCallback;
    ...
    public final C33741 mMediaCallback = new MediaRouter.SimpleCallback() { // from class: com.android.systemui.statusbar.policy.CastControllerImpl.1
        ...
        public final void onRouteAdded(MediaRouter mediaRouter, MediaRouter.RouteInfo routeInfo) {
            ...
            CastControllerImpl.m1722$$Nest$mupdateRemoteDisplays(CastControllerImpl.this);
        }
        ...
        public final void onRouteSelected(MediaRouter mediaRouter, int i, MediaRouter.RouteInfo routeInfo) {
            if (CastControllerImpl.DEBUG) {
                StringBuilder m1m = AbstractC0000x2c234b15.m1m("onRouteSelected(", i, "): ");
                m1m.append(CastControllerImpl.routeToString(routeInfo));
                Log.d("CastController", m1m.toString());
            }
            CastControllerImpl.m1722$$Nest$mupdateRemoteDisplays(CastControllerImpl.this);
        }
        ...
        public final void onRouteUnselected(MediaRouter mediaRouter, int i, MediaRouter.RouteInfo routeInfo) {
            if (CastControllerImpl.DEBUG) {
                StringBuilder m1m = AbstractC0000x2c234b15.m1m("onRouteUnselected(", i, "): ");
                m1m.append(CastControllerImpl.routeToString(routeInfo));
                Log.d("CastController", m1m.toString());
            }
            CastControllerImpl.m1722$$Nest$mupdateRemoteDisplays(CastControllerImpl.this);
    ...
    public static void m1721$$Nest$msetProjection(CastControllerImpl castControllerImpl, MediaProjectionInfo mediaProjectionInfo, boolean z) {
        boolean z2;
    ...
    public static void m1722$$Nest$mupdateRemoteDisplays(CastControllerImpl castControllerImpl) {
    ...
    public CastControllerImpl(Context context, DumpManager dumpManager) {
        ?? r0 = new MediaProjectionManager.Callback() { // from class: com.android.systemui.statusbar.policy.CastControllerImpl.2
            public final void onStart(MediaProjectionInfo mediaProjectionInfo) {
                CastControllerImpl.m1721$$Nest$msetProjection(CastControllerImpl.this, mediaProjectionInfo, true);
            }

            public final void onStop(MediaProjectionInfo mediaProjectionInfo) {
                CastControllerImpl.m1721$$Nest$msetProjection(CastControllerImpl.this, mediaProjectionInfo, false);
            }
        };
