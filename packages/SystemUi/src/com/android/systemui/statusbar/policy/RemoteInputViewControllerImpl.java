        ...
        this.onSendRemoteInputListener = new Runnable() { // from class: com.android.systemui.statusbar.policy.RemoteInputViewControllerImpl$onSendRemoteInputListener$1
            ...
            public final void run() {
                ...
                if (notificationRemoteInputManager$$ExternalSyntheticLambda1 != null) {
                    ...
                    ToolbarActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m7m(notificationRemoteInputManager$$ExternalSyntheticLambda1.f$1);
                ...
                for (int i = 0; i < size; i++) {
                    ((RemoteInputController.Callback) arrayList.get(i)).onRemoteInputSent(notificationEntry3);
                }
                ...
                try {
                    if (NotiRune.NOTI_SUBSCREEN_SUPPORT_NOTIFICATION_HISTORY && (iNotificationManager = remoteInputViewControllerImpl2.notifManager) != null) {
                        iNotificationManager.addReplyHistory(1, notificationEntry3.mKey, notificationEntry3.mSbn.getPackageName(), notificationEntry3.mSbn.getUser().getIdentifier(), "NOUI_2023", remoteInputView3.getText().toString());
                    }
