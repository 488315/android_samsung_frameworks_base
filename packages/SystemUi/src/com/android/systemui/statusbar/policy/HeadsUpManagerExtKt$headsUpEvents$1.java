...
@DebugMetadata(m276c = "com.android.systemui.statusbar.policy.HeadsUpManagerExtKt$headsUpEvents$1", m277f = "HeadsUpManagerExt.kt", m278l = {37}, m279m = "invokeSuspend")
        ...
        if (i == 0) {
            ...
            final ?? r1 = new OnHeadsUpChangedListener() { // from class: com.android.systemui.statusbar.policy.HeadsUpManagerExtKt$headsUpEvents$1$listener$1
                ...
                public final void onHeadsUpStateChanged(NotificationEntry notificationEntry, boolean z) {
                    ((ChannelCoroutine) ProducerScope.this).mo2872trySendJP2dKIU(new Pair(notificationEntry, Boolean.valueOf(z)));
                }
            };
