...
public final class KeyguardUserSwitcherController extends ViewController implements DesktopManager.Callback {
    ...
    public final C34084 mDataSetObserver;
    ...
    public final C34062 mScreenObserver;
    public final SysuiStatusBarStateController mStatusBarStateController;
    public final C34073 mStatusBarStateListener;
    ...
    public final void updatevisibility() {
        ...
        if (LsRune.LOCKUI_MULTI_USER) {
            ...
            if (LsRune.KEYGUARD_FBE) {
                ...
                if (!keyguardUpdateMonitor.isKidsModeRunning() && !this.mIsDexModeEnabled && keyguardUpdateMonitor.isUserUnlocked()) {
                    z = true;
                    if (!(this.mDynamicLockMode != 0)) {
                        if (((SettingsHelper) Dependency.get(SettingsHelper.class)).isUserSwitcherSettingOn()) {
    ...
    public final class KeyguardUserAdapter extends BaseUserSwitcherAdapter implements View.OnClickListener {
        ...
        public final View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null) {
                ...
                createBitmap = (mutate.getIntrinsicWidth() <= 0 || mutate.getIntrinsicHeight() <= 0) ? Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888) : Bitmap.createBitmap(mutate.getIntrinsicWidth(), mutate.getIntrinsicHeight(), Bitmap.Config.ARGB_8888);
