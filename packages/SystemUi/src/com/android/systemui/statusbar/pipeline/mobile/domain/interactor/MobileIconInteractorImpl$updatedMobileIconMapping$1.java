...
@DebugMetadata(m276c = "com.android.systemui.statusbar.pipeline.mobile.domain.interactor.MobileIconInteractorImpl$updatedMobileIconMapping$1", m277f = "MobileIconInteractor.kt", m278l = {}, m279m = "invokeSuspend")
            ...
            if (carrierInfraMediator.isEnabled(CarrierInfraMediator.Conditions.IS_USA_VZW, i, new Object[0])) {
                ...
                if (Intrinsics.areEqual(carrierInfraMediator.get(values2, i, new Object[0]), "KTT")) {
                    ...
                    if (!Intrinsics.areEqual(carrierInfraMediator.get(values2, i, new Object[0]), "VID")) {
                        hashMap.put(Integer.toString(0), TelephonyIcons.f221G);
                    }
                    ...
                    SignalIcon$MobileIconGroup signalIcon$MobileIconGroup10 = TelephonyIcons.H_PLUS;
                    ...
                    hashMap.put(Integer.toString(17), signalIcon$MobileIconGroup11);
                    String num12 = Integer.toString(13);
                    SignalIcon$MobileIconGroup signalIcon$MobileIconGroup12 = TelephonyIcons.LTE;
                    hashMap.put(num12, signalIcon$MobileIconGroup12);
                    hashMap.put(MobileMappings.toDisplayIconKey(1), signalIcon$MobileIconGroup12);
                    hashMap.put(MobileMappings.toDisplayIconKey(999), TelephonyIcons.NR_5G_CONNECTED);
                    hashMap.put(MobileMappings.toDisplayIconKey(2), TelephonyIcons.LTE_CA_5G_E);
