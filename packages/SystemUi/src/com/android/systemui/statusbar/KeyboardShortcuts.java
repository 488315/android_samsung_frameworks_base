...
public final class KeyboardShortcuts {
    ...
    public KeyboardShortcuts(Context context, WindowManager windowManager) {
        ...
        sparseArray.put(4, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_home, sparseArray, 3, com.android.systemui.R.string.keyboard_key_back));
        sparseArray.put(20, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_dpad_up, sparseArray, 19, com.android.systemui.R.string.keyboard_key_dpad_down));
        sparseArray.put(22, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_dpad_left, sparseArray, 21, com.android.systemui.R.string.keyboard_key_dpad_right));
        sparseArray.put(23, context.getString(com.android.systemui.R.string.keyboard_key_dpad_center));
        sparseArray.put(56, ".");
        sparseArray.put(62, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_tab, sparseArray, 61, com.android.systemui.R.string.keyboard_key_space));
        sparseArray.put(67, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_enter, sparseArray, 66, com.android.systemui.R.string.keyboard_key_backspace));
        sparseArray.put(86, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_media_play_pause, sparseArray, 85, com.android.systemui.R.string.keyboard_key_media_stop));
        sparseArray.put(88, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_media_next, sparseArray, 87, com.android.systemui.R.string.keyboard_key_media_previous));
        sparseArray.put(90, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_media_rewind, sparseArray, 89, com.android.systemui.R.string.keyboard_key_media_fast_forward));
        sparseArray.put(93, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_page_up, sparseArray, 92, com.android.systemui.R.string.keyboard_key_page_down));
        ...
        sparseArray.put(123, KeyboardShortcutListSearch$$ExternalSyntheticOutline0.m191m(context, com.android.systemui.R.string.keyboard_key_move_home, sparseArray, 122, com.android.systemui.R.string.keyboard_key_move_end));
