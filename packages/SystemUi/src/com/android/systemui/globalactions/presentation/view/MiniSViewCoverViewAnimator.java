...
public final class MiniSViewCoverViewAnimator implements GlobalActionsAnimator {
    public MiniSViewCoverContentView.C14321 mCallback;
    ...
    public final void startDismissAnimation(boolean z) {
        ...
        if (!z) {
            ...
            MiniSViewCoverContentView.C14321 c14321 = this.mCallback;
            c14321.getClass();
    ...
    public final void startToastAnimation() {
        MiniSViewCoverContentView.C14321 c14321 = this.mCallback;
        MiniSViewCoverContentView.this.mSelectedViewModel.getActionInfo().setLabel(c14321.toastMessage);
