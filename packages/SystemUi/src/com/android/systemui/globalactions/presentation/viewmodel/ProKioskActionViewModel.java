...
public final class ProKioskActionViewModel implements ActionViewModel {
        ...
        if (this.mConditionChecker.isEnabled(SystemUIConditions.GET_PROKIOSK_STATE)) {
            ...
            if (exitUI == null || exitUI2 == null || exitUI.isEmpty() || exitUI2.isEmpty()) {
                ...
                if (!exitUI2.startsWith(exitUI)) {
                    exitUI2 = exitUI2.startsWith(".") ? exitUI.concat(exitUI2) : AbstractResolvableFuture$$ExternalSyntheticOutline0.m15m(exitUI, ".", exitUI2);
                }
    ...
    public final void setState(ActionViewModel.ToggleState toggleState) {
        ...
        if (proKioskString != null) {
            ...
            this.mInfo.setLabel(this.mResourcesWrapper.getString(R.string.mediasize_iso_a9));
        }
        if (this.mConditionChecker.isEnabled(SystemUIConditions.GET_PROKIOSK_STATE)) {
            if (proKioskString2 != null) {
                ...
                this.mInfo.setStateLabel(this.mResourcesWrapper.getString(R.string.mediasize_chinese_prc_8));
                return;
            }
        }
        if (proKioskString3 != null) {
            ...
            this.mInfo.setStateLabel(this.mResourcesWrapper.getString(R.string.mediasize_chinese_prc_7));
        }
    }
