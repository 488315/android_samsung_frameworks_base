    ...
    public final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            Boolean bool = (Boolean) new ViewCompat.AccessibilityViewProperty(R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.1
                public C01551(int i, Class cls, int i2) {
                    super(i, cls, i2);
                }
            ...
            Boolean bool2 = (Boolean) new ViewCompat.C01584(R.id.tag_accessibility_heading, Boolean.class, 28).get(view);
            accessibilityNodeInfo2.setHeading(bool2 != null && bool2.booleanValue());
            accessibilityNodeInfo2.setPaneTitle((CharSequence) new ViewCompat.C01562(R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28).get(view));
            accessibilityNodeInfo2.setStateDescription((CharSequence) new ViewCompat.C01573(R.id.tag_state_description, CharSequence.class, 64, 30).get(view));
