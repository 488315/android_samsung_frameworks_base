...
public class CategorySelectableItem extends SelectableItem implements DisposableHandle {
    ...
    private final void bindSelectableItemList() {
        ...
        this.disposableHandle = new DisposableHandle() { // from class: androidx.picker.loader.select.CategorySelectableItem$$ExternalSyntheticLambda0
            ...
            public final void dispose() {
                CategorySelectableItem.m340bindSelectableItemList$lambda3(DisposableHandle.this, arrayList);
            }
        };
    }
    ...
    public static final void m340bindSelectableItemList$lambda3(DisposableHandle disposableHandle, List list) {
        disposableHandle.dispose();
        Iterator it = list.iterator();
        while (it.hasNext()) {
    ...
    */
    public CategorySelectableItem(List<? extends SelectableItem> list, Function1 function1) {
