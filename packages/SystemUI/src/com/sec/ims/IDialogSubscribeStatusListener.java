    ...
    public abstract class Stub extends Binder implements IDialogSubscribeStatusListener {
        ...
        class Proxy implements IDialogSubscribeStatusListener {
            ...
            public void onDialogSubscribeStatus(int i) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IDialogSubscribeStatusListener.DESCRIPTOR);
        ...
        public static IDialogSubscribeStatusListener asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IDialogSubscribeStatusListener.DESCRIPTOR);
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IDialogSubscribeStatusListener)) ? new Proxy(iBinder) : (IDialogSubscribeStatusListener) iInterfaceQueryLocalInterface;
        }
