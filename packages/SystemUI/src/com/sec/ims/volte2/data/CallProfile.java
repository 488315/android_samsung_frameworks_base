...
public class CallProfile implements Parcelable {
    ...
    private void readFromParcel(Parcel parcel) {
        ...
        this.mMediaProfile = (MediaProfile) parcel.readParcelable(MediaProfile.class.getClassLoader(), MediaProfile.class);
        ...
        if (parcel.readInt() == 1) {
            this.mAdditionalSipHeaders = (HashMap) parcel.readBundle().getSerializable("extra_header", HashMap.class);
        }
        ...
        this.mQuantumSecurityInfo = (QuantumSecurityInfo) parcel.readParcelable(QuantumSecurityInfo.class.getClassLoader(), QuantumSecurityInfo.class);
    ...
    public void setPulledDialogId(String str) {
