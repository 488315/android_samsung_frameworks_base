...
public class ImsRegistration implements Parcelable {
    ...
    private boolean mNetworkRttSupported;
    ...
    public class Builder {
        ...
        private boolean mNetworkRttSupported = false;
        ...
        public Builder setNetworkRttSupported(boolean z) {
            this.mNetworkRttSupported = z;
            return this;
        }
    ...
    public NameAddr getPreferredImpu() {
        ...
        return nameAddr != null ? nameAddr : new NameAddr("", "");
    }
    ...
    public boolean isNetworkRttSupported() {
        return this.mNetworkRttSupported;
    }
    ...
    public void setNetworkRttSupported(boolean z) {
        this.mNetworkRttSupported = z;
    }
    ...
    public String toString() {
        if (SHIP_BUILD) {
            ...
            sb.append(", mNetworkRttSupported=");
            sb.append(this.mNetworkRttSupported);
            sb.append(", mNetwork=");
            sb.append(this.mNetwork);
            sb.append(", mDeregiReason =");
            return ReorderTile$$ExternalSyntheticOutline0.m(this.mDeregiReason, "]", sb);
        }
        ...
        sb2.append(", mNetworkRttSupported=");
        sb2.append(this.mNetworkRttSupported);
        sb2.append(", mNetwork=");
        sb2.append(this.mNetwork);
        sb2.append(", mDeregiReason =");
        return ReorderTile$$ExternalSyntheticOutline0.m(this.mDeregiReason, "]", sb2);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.mNetworkRttSupported ? 1 : 0);
    ...
    private ImsRegistration(Parcel parcel) {
        this.mNetworkRttSupported = false;
        ...
        this.mPreferredPublicUserId = (NameAddr) parcel.readParcelable(NameAddr.class.getClassLoader(), NameAddr.class);
        ArrayList arrayList = new ArrayList();
        ...
        this.mNetworkRttSupported = parcel.readInt() == 1;
    ...
    public ImsRegistration(ImsRegistration imsRegistration) {
        ...
        this.mNetworkRttSupported = imsRegistration.mNetworkRttSupported;
    ...
    public ImsRegistration(Builder builder) {
        ...
        this.mNetworkRttSupported = builder.mNetworkRttSupported;
