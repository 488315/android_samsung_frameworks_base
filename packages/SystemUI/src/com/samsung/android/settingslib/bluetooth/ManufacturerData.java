...
public class ManufacturerData {
    ...
    public class Data {
        ...
        public byte mDeviceStatus = 0;
        public byte mDeviceSubType = 0;
    ...
    public final int getDeviceIcon() {
        ...
        if (i == 1) {
            ...
            switch (b2) {
                ...
                case 5:
                    return b3 != 1 ? b3 != 2 ? b3 != 3 ? b3 != 4 ? R.drawable.list_ic_accessory_default : R.drawable.list_ic_spen : R.drawable.list_ic_keyboard : R.drawable.list_ic_game_device : R.drawable.list_ic_mouse;
                case 6:
                    return b3 != 2 ? b3 != 3 ? b3 != 4 ? b3 != 5 ? b3 != 6 ? R.drawable.list_ic_tv : R.drawable.list_ic_the_wall : R.drawable.list_ic_monitor_m7 : R.drawable.list_ic_projector : R.drawable.list_ic_the_wall : R.drawable.list_ic_sero_tv;
                case 7:
                    return b3 != 1 ? b3 != 2 ? b3 != 3 ? b3 != 6 ? b3 != 7 ? R.drawable.list_ic_dlna_audio : R.drawable.list_ic_music_frame : R.drawable.list_ic_soundbar : R.drawable.list_ic_akg_vl : R.drawable.list_ic_av360r7 : R.drawable.list_ic_soundbar;
                case 8:
                ...
                case 21:
                    return b3 != 2 ? b3 != 3 ? b3 != 4 ? b3 != 5 ? R.drawable.list_ic_headset : R.drawable.list_ic_earbuds_stem : R.drawable.list_ic_true_wireless_earbuds : ManufacturerData.this.isBuds3Device() ? R.drawable.list_ic_earbuds_stem : R.drawable.list_ic_true_wireless_earbuds : R.drawable.list_ic_mono_headset;
                case 22:
                    return b3 != 1 ? R.drawable.list_ic_sound_accessory_default : R.drawable.list_ic_dlna_audio;
                case 23:
                    return b3 != 1 ? b3 != 2 ? R.drawable.list_ic_monitor : R.drawable.list_ic_monitor_ark : R.drawable.list_ic_monitor_m7;
                case 24:
                    return R.drawable.list_ic_eboard;
                case 25:
                    return b3 != 2 ? b3 != 3 ? R.drawable.list_ic_samsung_connect : R.drawable.list_ic_smart_home_adapter : R.drawable.list_ic_samsung_connect_auto;
                case 26:
                ...
                case 41:
                    return b3 != 1 ? b3 != 2 ? R.drawable.list_ic_signage : R.drawable.list_ic_projector : R.drawable.list_ic_the_wall;
                case 42:
                ...
                case 44:
                    return R.drawable.list_ic_ring;
                case 45:
                    return R.drawable.list_ic_vst;
                case 46:
                    return R.drawable.list_ic_countertop_water_purifier;
                case 47:
                    return R.drawable.list_ic_vrf;
                case 48:
                    return R.drawable.list_ic_ballie;
            }
        }
        return 0;
    }
    ...
    public final boolean isBuds3Device() {
        int i;
        byte[] bArr = this.mData.mDeviceId;
    ...
    */
    public final void updateDeviceInfo(byte[] bArr) {
        ...
        try {
            if (this.mManufacturerType == 3 && isSupportFeature((byte) 4) && bArr.length > BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_TYPE + BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_STATUS) {
                data.mDeviceStatus = bArr[BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_TYPE + BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_STATUS];
            }
        } catch (ArrayIndexOutOfBoundsException e4) {
            e4.printStackTrace();
        }
        try {
            if (this.mManufacturerType == 3 && isSupportFeature((byte) 4) && bArr.length > BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_TYPE + BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_SUBTYPE) {
                data.mDeviceSubType = bArr[BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_TYPE + BluetoothManufacturerData.OFFSET_SS_LE_DEVICE_SUBTYPE];
            }
        ...
        try {
            ...
            if (i18 == 1) {
                ...
                if (bArr2[0] == 0 && (i2 = bArr2[1] & 255) >= 144 && i2 <= 255) {
        ...
        if (BluetoothUtils.DEBUG) {
            ...
            sb2.append(", [DeviceStatus] " + (255 & data.mDeviceStatus));
            sb2.append(", [DeviceSubType] " + ((int) data.mDeviceSubType));
