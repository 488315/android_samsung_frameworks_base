...
public class CachedBluetoothCastDevice implements Comparable {
    ...
    public CachedBluetoothCastDevice(Context context, LocalBluetoothCastProfileManager localBluetoothCastProfileManager, SemBluetoothCastDevice semBluetoothCastDevice) {
        ...
        Log.d(simpleName, "updateCastProfiles : " + String.valueOf(linkedHashSet.size()));
    }
    ...
    public final void connect() {
        if (Settings.System.getInt(this.mContext.getContentResolver(), "dexonpc_connection_state", 0) == 3) {
    ...
    public final String getConnectionSummary() {
        ...
        for (int i = 0; i < castProfiles.size(); i++) {
            LocalBluetoothCastProfile localBluetoothCastProfile = (LocalBluetoothCastProfile) castProfiles.get(i);
            if (localBluetoothCastProfile == null) {
    ...
    public final int getMaxConnectionState() {
        ...
        for (int i2 = 0; i2 < castProfiles.size(); i2++) {
            LocalBluetoothCastProfile localBluetoothCastProfile = (LocalBluetoothCastProfile) castProfiles.get(i2);
            String str = this.TAG;
