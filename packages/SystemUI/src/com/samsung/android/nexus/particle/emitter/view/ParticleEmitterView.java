...
public class ParticleEmitterView extends ViewGroup {
    ...
    public final void setEffectLayerSize(int i, int i2) {
        ...
        layerContainer2.getNexusContext().mWidth = i;
        layerContainer2.getNexusContext().mHeight = i2;
        if (!layerContainer2.mIsReadyToCreate) {
            layerContainer2.onCreate();
        }
        layerContainer2.onSizeChanged(i, i2);
        layerContainer2.mIsReadyToCreate = true;
    }
