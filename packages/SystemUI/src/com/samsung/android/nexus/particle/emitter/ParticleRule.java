...
public class ParticleRule {
    ...
    public BitmapParticleTexture particleTexture;
    public final int posMode;
    ...
    public ParticleRule(ParticleRule particleRule) {
        ...
        Interpolator[] interpolatorArr = factorRangeableKeyFrameSetList2.mFactorInterpolator;
        Interpolator[] interpolatorArr2 = factorRangeableKeyFrameSetList.mFactorInterpolator;
        System.arraycopy(interpolatorArr, 0, interpolatorArr2, 0, interpolatorArr2.length);
        Interpolator[][] interpolatorArr3 = factorRangeableKeyFrameSetList2.mFactorInterpolators;
        Interpolator[][] interpolatorArr4 = factorRangeableKeyFrameSetList.mFactorInterpolators;
        System.arraycopy(interpolatorArr3, 0, interpolatorArr4, 0, interpolatorArr4.length);
