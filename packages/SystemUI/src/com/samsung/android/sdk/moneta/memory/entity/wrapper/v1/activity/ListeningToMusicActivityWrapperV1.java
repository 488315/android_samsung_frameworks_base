...
public final class ListeningToMusicActivityWrapperV1 extends ActivityWrapper {
    ...
    public final class Creator implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            int iM = 0;
            while (iM != i) {
                iM = Engram$Creator$$ExternalSyntheticOutline0.m(ListeningToMusicActivityWrapperV1.class, parcel, arrayList, iM, 1);
            }
            return new ListeningToMusicActivityWrapperV1(string, arrayList, MediaSession.CREATOR.createFromParcel(parcel), parcel.readLong(), parcel.readInt() == 0 ? null : Long.valueOf(parcel.readLong()));
        }

        @Override // android.os.Parcelable.Creator
        public final Object[] newArray(int i) {
            return new ListeningToMusicActivityWrapperV1[i];
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public ListeningToMusicActivityWrapperV1(String str, List<? extends Content> list, MediaSession mediaSession, long j, Long l) {
        this.id = str;
        this.contents = list;
    ...
    public ListeningToMusicActivity toActivity() {
        return new ListeningToMusicActivity(this.id, this.contents, this.iconic, this.startTimestamp, this.endTimestamp);
    }
}
