...
public final class StayingActivityWrapperV1 extends ActivityWrapper {
    ...
    public final class Creator implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            int iM = 0;
            while (iM != i) {
                iM = Engram$Creator$$ExternalSyntheticOutline0.m(StayingActivityWrapperV1.class, parcel, arrayList, iM, 1);
            }
            return new StayingActivityWrapperV1(string, arrayList, Place.CREATOR.createFromParcel(parcel), parcel.readLong(), parcel.readInt() == 0 ? null : Long.valueOf(parcel.readLong()));
        }

        @Override // android.os.Parcelable.Creator
        public final Object[] newArray(int i) {
            return new StayingActivityWrapperV1[i];
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public StayingActivityWrapperV1(String str, List<? extends Content> list, Place place, long j, Long l) {
        this.id = str;
        this.contents = list;
        this.location = place;
    ...
    public StayingActivity toActivity() {
        return new StayingActivity(this.id, this.contents, this.location, this.startTimestamp, this.endTimestamp);
    }
}
