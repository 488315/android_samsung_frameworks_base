...
public final class Message extends Content {
    ...
    public int hashCode() {
        int iM = MoveResult$$ExternalSyntheticOutline0.m(PropertyValuesHolder2D$$ExternalSyntheticOutline0.m(this.id.hashCode() * 31, 31, this.contentUri), 31, this.messageId);
