...
public final class StoringContentsActivityWrapperV1 extends ActivityWrapper {
    ...
    public final class Creator implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            int iM = 0;
            while (iM != i) {
                iM = Engram$Creator$$ExternalSyntheticOutline0.m(StoringContentsActivityWrapperV1.class, parcel, arrayList, iM, 1);
            }
            return new StoringContentsActivityWrapperV1(string, arrayList, parcel.readLong(), MobileApplication.CREATOR.createFromParcel(parcel), parcel.readInt() == 0 ? null : Person.CREATOR.createFromParcel(parcel));
        }
