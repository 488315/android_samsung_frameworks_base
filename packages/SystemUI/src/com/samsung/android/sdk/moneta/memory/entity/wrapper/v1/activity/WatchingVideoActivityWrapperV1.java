...
public final class WatchingVideoActivityWrapperV1 extends ActivityWrapper {
    ...
    public final class Creator implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            int iM = 0;
            while (iM != i) {
                iM = Engram$Creator$$ExternalSyntheticOutline0.m(WatchingVideoActivityWrapperV1.class, parcel, arrayList, iM, 1);
            }
            return new WatchingVideoActivityWrapperV1(string, arrayList, MediaSession.CREATOR.createFromParcel(parcel), parcel.readLong(), parcel.readInt() == 0 ? null : Long.valueOf(parcel.readLong()));
        }
