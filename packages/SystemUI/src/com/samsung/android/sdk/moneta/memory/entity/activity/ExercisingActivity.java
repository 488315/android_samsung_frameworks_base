...
public final class ExercisingActivity extends Activity {
    ...
    public int hashCode() {
        int m = PropertyValuesHolder2D$$ExternalSyntheticOutline0.m(PropertyValuesHolder2D$$ExternalSyntheticOutline0.m(this.contents, this.id.hashCode() * 31, 31), 31, this.name);
        ...
        int m2 = MoveResult$$ExternalSyntheticOutline0.m((hashCode4 + (f4 == null ? 0 : f4.hashCode())) * 31, 31, this.startTimestamp);
        Long l = this.endTimestamp;
        return this.exerciseType.hashCode() + ((m2 + (l != null ? l.hashCode() : 0)) * 31);
    }
