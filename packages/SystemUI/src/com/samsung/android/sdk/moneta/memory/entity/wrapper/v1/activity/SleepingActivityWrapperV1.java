...
public final class SleepingActivityWrapperV1 extends ActivityWrapper {
    ...
    public final class Creator implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            int iM = 0;
            while (iM != i) {
                iM = Engram$Creator$$ExternalSyntheticOutline0.m(SleepingActivityWrapperV1.class, parcel, arrayList, iM, 1);
            }
            return new SleepingActivityWrapperV1(string, arrayList, parcel.readLong(), parcel.readInt() == 0 ? null : Long.valueOf(parcel.readLong()), parcel.readInt());
        }

        @Override // android.os.Parcelable.Creator
        public final Object[] newArray(int i) {
            return new SleepingActivityWrapperV1[i];
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public SleepingActivityWrapperV1(String str, List<? extends Content> list, long j, Long l, int i) {
        this.id = str;
        this.contents = list;
    ...
    public SleepingActivity toActivity() {
        return new SleepingActivity(this.id, this.contents, this.startTimestamp, this.endTimestamp, this.sleepScore);
    }
}
