...
public class Feature {
    ...
    static {
        ...
        map.put("FEATURE_TEXT_GET_REMINDER_ENTITY", 23);
        map.put("FEATURE_TEXT_GET_EVENT_CATEGORY", 25);
        ...
        sinceVersionMap = Collections.unmodifiableMap(map);
    }
    ...
    public static boolean isSIVSAvailableOSVersion(Context context) {
        try {
            ...
            } else if (Build.VERSION.SEM_PLATFORM_INT >= 150100) {
                return true;
            }
            return false;
    ...
    public static boolean isVst(Context context) {
        ...
        try {
            Boolean boolValueOf = Boolean.valueOf(context.getPackageManager().hasSystemFeature("android.software.xr.immersive"));
            sIsVst = boolValueOf;
