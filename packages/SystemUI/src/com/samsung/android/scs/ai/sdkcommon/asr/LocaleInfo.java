...
public class LocaleInfo implements Parcelable {
    public static final Parcelable.Creator<LocaleInfo> CREATOR = new Parcelable.Creator<LocaleInfo>() { // from class: com.samsung.android.scs.ai.sdkcommon.asr.LocaleInfo.1
    ...
    public String toString() {
        ...
        sb.append("', Order='");
        return ReorderTile$$ExternalSyntheticOutline0.m(this.mOrder, "'}", sb);
    }
