...
public interface IRecognitionListener extends IInterface {
    ...
    public class _Parcel {
        ...
        public static /* bridge */ /* synthetic */ Object m3309$$Nest$smreadTypedObject(Parcel parcel) {
    ...
    public abstract class Stub extends Binder implements IRecognitionListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                onError((Bundle) _Parcel.m3309$$Nest$smreadTypedObject(parcel));
                parcel2.writeNoException();
                return true;
            }
            if (i == 2) {
                Parcelable.Creator creator2 = Bundle.CREATOR;
                onResults((Bundle) _Parcel.m3309$$Nest$smreadTypedObject(parcel));
                parcel2.writeNoException();
                return true;
            }
            if (i != 3) {
            ...
            onPartialResults((Bundle) _Parcel.m3309$$Nest$smreadTypedObject(parcel));
            parcel2.writeNoException();
            return true;
        }
