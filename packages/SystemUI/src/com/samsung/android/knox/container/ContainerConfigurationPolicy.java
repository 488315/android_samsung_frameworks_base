...
public class ContainerConfigurationPolicy {
    ...
    public void addCrossProfileIntentFilter(ComponentName componentName, IntentFilter intentFilter, int i) {
        ...
        Log.i(TAG, "addCrossProfileIntentFilter is deprecated from Knox 3.4.1, This API is not available since Android 13.");
    }
    ...
    public void clearCrossProfileIntentFilters(ComponentName componentName) {
        ...
        Log.i(TAG, "clearCrossProfileIntentFilters is deprecated from Knox 3.4.1, This API is not available since Android 13.");
    }
    ...
    public Signature[] getPackageSignaturesFromExternalStorageWhiteList(String str) {
        ...
        try {
            List<String> packageSignaturesFromExternalStorageWhiteList = mUMContainerService.getPackageSignaturesFromExternalStorageWhiteList(this.mContextInfo, str);
            Signature[] signatureArr = new Signature[packageSignaturesFromExternalStorageWhiteList.size()];
            for (int i = 0; i < packageSignaturesFromExternalStorageWhiteList.size(); i++) {
                signatureArr[i] = new Signature(packageSignaturesFromExternalStorageWhiteList.get(i));
            }
            return signatureArr;
        } catch (RemoteException e) {
