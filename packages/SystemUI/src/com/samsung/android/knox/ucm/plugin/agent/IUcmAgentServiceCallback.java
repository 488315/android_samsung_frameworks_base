    ...
    public abstract class Stub extends Binder implements IUcmAgentServiceCallback {
        ...
        class Proxy implements IUcmAgentServiceCallback {
            ...
            public void onCredentialStorageChange() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IUcmAgentServiceCallback.DESCRIPTOR);
        ...
        public static IUcmAgentServiceCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IUcmAgentServiceCallback.DESCRIPTOR);
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IUcmAgentServiceCallback)) ? new Proxy(iBinder) : (IUcmAgentServiceCallback) iInterfaceQueryLocalInterface;
        }
