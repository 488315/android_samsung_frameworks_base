...
public class UniversalCredentialManager {
    ...
    */
    ...
    public int addPackagesToWhiteListInternal(int i, int i2, CredentialStorage credentialStorage, List<AppIdentity> list, Bundle bundle) {
    ...
    public KeyPair generateKeyPair(CredentialStorage credentialStorage, String str, KeyGenParameterSpec keyGenParameterSpec) {
        EnterpriseLicenseManager.log(this.mContextInfo, "UniversalCredentialManager.generateKeyPair");
        Log.i(TAG, "UniversalCredentialManager.generateKeyPair is called....");
        ...
        if (getUCMService() == null) {
            Log.i(TAG, "UniversalCredentialStorageManager.generateKeyPair getUCMService is null....");
            return null;
        }
        Bundle bundle = new Bundle();
        bundle.putString("keystoreAlias", keyGenParameterSpec.getKeystoreAlias());
        bundle.putInt("keySize", keyGenParameterSpec.getKeySize());
        bundle.putStringArray("blockModes", keyGenParameterSpec.getBlockModes());
        bundle.putStringArray("digests", keyGenParameterSpec.getDigests());
        bundle.putStringArray("signaturePaddings", keyGenParameterSpec.getSignaturePaddings());
        bundle.putInt("purposes", keyGenParameterSpec.getPurposes());
        AlgorithmParameterSpec algorithmParameterSpec = keyGenParameterSpec.getAlgorithmParameterSpec();
    ...
    public boolean setKeyPairCertificate(CredentialStorage credentialStorage, String str, List<Certificate> list) throws IOException {
        ...
        try {
        } catch (RemoteException | IOException | CertificateEncodingException e) {
            Log.w(TAG, "The exception occurs " + e.getMessage());
        }
        if (getUCMService() == null) {
            Log.i(TAG, "UniversalCredentialStorageManager.setKeyPairCertificate getUCMService is null....");
            return false;
        }
        ...
        try {
            ...
            boolean keyPairCertificate = mUCMService.setKeyPairCertificate(this.mContextInfo, credentialStorage, str, byteArrayOutputStream.toByteArray());
