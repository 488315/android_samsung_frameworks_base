...
public class UcmAgentProviderImpl extends Provider {
    ...
    public abstract class UcmAgentCipherSpi extends CipherSpi implements UcmAgentSpiProperty {
        ...
        @Override // javax.crypto.CipherSpi
        public abstract void engineUpdateAAD(byte[] bArr, int i, int i2) throws IllegalStateException, UnsupportedOperationException;
    ...
    public abstract class UcmAgentKeyAgreementSpi extends KeyAgreementSpi implements UcmAgentSpiProperty {
        ...
        public abstract Key engineDoPhase(Key key, boolean z) throws IllegalStateException, InvalidKeyException;
    ...
    public abstract class UcmAgentKeyStoreSpi extends KeyStoreSpi implements UcmAgentSpiProperty {
        ...
        @Override // java.security.KeyStoreSpi
        public abstract void engineSetEntry(String str, KeyStore.Entry entry, KeyStore.ProtectionParameter protectionParameter) throws KeyStoreException;
