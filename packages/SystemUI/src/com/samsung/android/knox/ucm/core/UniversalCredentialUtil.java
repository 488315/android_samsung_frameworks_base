...
public class UniversalCredentialUtil {
    ...
    public static final String AGENT_IS_SUPPORT_KEYAGREEMENT = "isSupportKeyAgreement";
    ...
    public class UcmUri {
        ...
        public String getSource() {
            ...
            try {
                String str = UniversalCredentialUtil.getUCMVersion().equals("v1") ? pathSegments.get(0) : "";
                Log.d(UniversalCredentialUtil.TAG, "resource:" + str);
                return str;
            } catch (IndexOutOfBoundsException e) {
                e.printStackTrace();
        ...
        public int getUid() {
            ...
            try {
                String str = UniversalCredentialUtil.getUCMVersion().equals("v1") ? pathSegments.get(2) : "";
