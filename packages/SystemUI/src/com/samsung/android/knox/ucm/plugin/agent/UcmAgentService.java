...
import com.samsung.android.knox.ucm.plugin.service.KeyAgreement;
...
public abstract class UcmAgentService extends Service {
    ...
    public static final int ERROR_INVALID_PUBLICKEY_ENTRY = 39;
    ...
    final class UcmAgentServiceWrapper extends IUcmAgentService.Stub {
        ...
        public Bundle generateKey(String str, String str2, int i, Bundle bundle) throws RemoteException {
            ...
            return UcmAgentService.this.generateKey(new KeyGenParameterSpec.Builder(str, i, i2, false, 1, i2).setAlgorithm(str2).setPurpose(bundle.getInt(UcmAgentProviderImpl.KEY_EXTRA_PURPOSE)).setRandomizedEncryptionRequired(bundle.getBoolean(UcmAgentProviderImpl.KEY_EXTRA_RANDOMIZED_ENCRYPTION, true)).setEcCurveName(bundle.getString(UcmAgentProviderImpl.KEY_EXTRA_EC_CURVE_NAME, "")).setBlockModes(bundle.getStringArray(UcmAgentProviderImpl.KEY_EXTRA_BLOCK_MODES)).setDigests(bundle.getStringArray(UcmAgentProviderImpl.KEY_EXTRA_DIGESTS)).setSignaturePaddings(bundle.getStringArray(UcmAgentProviderImpl.KEY_EXTRA_SIGNATURE_PADDINGS)).setOptions(bundle.getBundle(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_EXTRA_ARGS)).build(), bundle);
        }
    ...
    public final Bundle generateKey(KeyGenParameterSpec keyGenParameterSpec, Bundle bundle) {
        ...
        Log.i(TAG, "generateKey " + keyGenParameterSpec.getKeystoreAlias() + ", uid: " + bundle.getInt(UcmAgentProviderImpl.UcmAgentSpiProperty.KEY_CALLER_UID) + ", caller: " + Binder.getCallingUid());
        Bundle bundle2 = new Bundle();
        try {
            KeyGenerator keyGenerator = KeyGenerator.getInstance(keyGenParameterSpec.getAlgorithm(), this.mProvider);
    ...
    private final Bundle keyAgreement(String str, String str2, byte[] bArr, Bundle bundle) throws IllegalStateException, InvalidKeySpecException {
        ...
        try {
            ...
            KeyStore.Entry entry = keyStore.getEntry(str, null);
            if (entry == null) {
                Log.e(TAG, "keyAgreement. getEntry null");
                return responseErrorWithNullBytes(keyStore.getErrorStatus() == 0 ? 8 : keyStore.getErrorStatus());
            }
            PrivateKey privateKey = ((KeyStore.PrivateKeyEntry) entry).getPrivateKey();
            if (privateKey == null) {
                Log.e(TAG, "keyAgreement. getPrivateKey null");
            ...
            try {
                ...
                e.printStackTrace();
                return responseErrorWithNullBytes(39);
            }
    ...
    private final Bundle mac(String str, byte[] bArr, String str2, Bundle bundle) {
        Log.d(TAG, "mac");
        if (bundle == null) {
    ...
    private final Bundle sign(String str, byte[] bArr, String str2, Bundle bundle) {
        Log.d(TAG, "sign");
        if (bundle == null) {
