...
public interface IDateTimePolicy extends IInterface {
    ...
    public class Default implements IDateTimePolicy {
        ...
        @Override // com.samsung.android.knox.datetime.IDateTimePolicy
        public boolean setDateTimeChangeEnabled(ContextInfo contextInfo, boolean z) throws RemoteException {
            return false;
        }
    ...
    public abstract class Stub extends Binder implements IDateTimePolicy {
        ...
        class Proxy implements IDateTimePolicy {
            ...
            public boolean getAutomaticTime(ContextInfo contextInfo) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IDateTimePolicy.DESCRIPTOR);
            ...
            public NtpInfo getNtpInfo(ContextInfo contextInfo) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    return (NtpInfo) parcelObtain2.readTypedObject(NtpInfo.CREATOR);
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
            ...
            public boolean setNtpInfo(ContextInfo contextInfo, NtpInfo ntpInfo) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IDateTimePolicy.DESCRIPTOR);
                    parcelObtain.writeTypedObject(contextInfo, 0);
                    parcelObtain.writeTypedObject(ntpInfo, 0);
        ...
        public static IDateTimePolicy asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IDateTimePolicy.DESCRIPTOR);
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IDateTimePolicy)) ? new Proxy(iBinder) : (IDateTimePolicy) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    boolean dateTime = setDateTime(contextInfo, j);
                ...
                case 3:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean timeZone = setTimeZone(contextInfo3, string);
                    parcel2.writeNoException();
                ...
                case 5:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean timeFormat = setTimeFormat(contextInfo5, string2);
                    parcel2.writeNoException();
                ...
                case 7:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean dateFormat = setDateFormat(contextInfo7, string3);
                    parcel2.writeNoException();
                ...
                case 9:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean automaticTime = setAutomaticTime(contextInfo9, z);
                    parcel2.writeNoException();
                ...
                case 12:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean dateTimeChangeEnabled = setDateTimeChangeEnabled(contextInfo12, z2);
                    parcel2.writeNoException();
                ...
                case 13:
                    ...
                    parcel.enforceNoDataAvail();
                    boolean zIsDateTimeChangeEnabled = isDateTimeChangeEnabled(contextInfo13);
                    parcel2.writeNoException();
                    parcel2.writeBoolean(zIsDateTimeChangeEnabled);
                    return true;
                case 14:
