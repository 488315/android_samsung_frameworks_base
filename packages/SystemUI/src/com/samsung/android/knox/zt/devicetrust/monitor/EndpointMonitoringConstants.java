...
public class EndpointMonitoringConstants {
    public static final String ACTION_ZERO_TRUST_FRAMEWORK_STARTED = "com.samsung.android.knox.zt.devicetrust.monitor.action.ZERO_TRUST_FRAMEWORK_STARTED";
    public static final int ERROR_ALREADY_ACKED = -6;
    public static final int ERROR_NONE = 0;
    public static final int ERROR_NO_MATCHING_ID = -7;
