...
public class LSOConstants {
    ...
    public static String getLSOFeatureName(int i) {
        return i != -1 ? i != 0 ? i != 1 ? i != 2 ? MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(i, "Unknown ") : LSO_FEATURE_WALLPAPER : LSO_FEATURE_OVERLAY : LSO_FEATURE_ANY : LSO_FEATURE_ALL;
    }

    public static String getLayerName(int i) {
        return i != 0 ? i != 1 ? i != 2 ? i != 3 ? MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(i, "LAYER") : "EMERGENCY_PHONE_LAYER" : "CUSTOM_LAYER" : "DEFAULT_LAYER" : "RESET_ALL_LAYER";
    }
}
