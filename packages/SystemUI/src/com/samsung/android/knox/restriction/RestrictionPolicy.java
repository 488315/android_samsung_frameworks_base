...
public class RestrictionPolicy {
    ...
    public static final String ACTION_USB_TETHERING_DISBALED_INTERNAL = "com.samsung.android.knox.intent.action.USB_TETHERING_DISBALED_INTERNAL";
    ...
    public boolean allowWiFiSharing(boolean z) {
        EnterpriseLicenseManager.log(this.mContextInfo, "RestrictionPolicy.allowWiFiSharing");
        if (getService() == null) {
            return false;
        }
        try {
            return this.mService.allowWiFiSharing(this.mContextInfo, z);
        } catch (RemoteException e) {
            Log.w(TAG, "Failed talking with restriction policy", e);
            return false;
        }
    ...
    public boolean isWiFiSharingEnabled() {
        ...
        try {
            return this.mService.isWiFiSharingEnabled(this.mContextInfo);
        } catch (RemoteException e) {
            Log.w(TAG, "Failed talking with restriction policy", e);
            return false;
        }
    ...
    public void setMultiSimPolicy(int i, int i2, String[] strArr, String[] strArr2, String[] strArr3) {
        if (getService() != null) {
            try {
