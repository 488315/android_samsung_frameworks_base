...
public abstract class BasicColorSchemeKt {
    public static final long toColor(SeslColorSchemeKeyTokens seslColorSchemeKeyTokens, Composer composer) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart("com.samsung.sesl.compose.foundation.theme.toColor (BasicColorScheme.kt:43)");
        }
        ...
        if (seslColorSchemeKeyTokens instanceof SeslColorPrimitiveTokens) {
            ...
            int i2 = SeslPopupTokens.WhenMappings.$EnumSwitchMapping$0[((SeslPopupColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i2 == 1) {
            ...
            int i3 = SeslAlertDialogTokens.WhenMappings.$EnumSwitchMapping$0[((SeslAlertDialogColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i3 == 1) {
                ...
                j = alertDialogTokens.listTextColor;
            }
            ...
            int i4 = SeslSpinnerTokens.WhenMappings.$EnumSwitchMapping$0[((SeslSpinnerColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i4 == 1) {
            ...
            listTokens.getClass();
            int i5 = SeslListTokens.WhenMappings.$EnumSwitchMapping$0[((SeslListColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i5 == 1) {
            ...
            int i6 = SeslAppBarTokens.WhenMappings.$EnumSwitchMapping$0[((SeslAppBarColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i6 == 1) {
        ...
        } else if (seslColorSchemeKeyTokens instanceof SeslDividerColorSchemeKeyTokens) {
            SeslDividerTokens dividerTokens = seslTokenScheme.getDividerTokens();
            dividerTokens.getClass();
            int i7 = SeslDividerTokens.WhenMappings.$EnumSwitchMapping$0[((SeslDividerColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i7 == 1) {
            ...
            if (!(seslColorSchemeKeyTokens instanceof SeslButtonColorSchemeKeyTokens)) {
                throw new NoWhenBranchMatchedException();
            }
            SeslButtonTokens buttonTokens = seslTokenScheme.getButtonTokens();
            buttonTokens.getClass();
            int i8 = SeslButtonTokens.WhenMappings.$EnumSwitchMapping$0[((SeslButtonColorSchemeKeyTokens) seslColorSchemeKeyTokens).ordinal()];
            if (i8 == 1) {
                j = buttonTokens.containerColor;
            } else {
                if (i8 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                j = buttonTokens.contentColor;
            }
        }
        if (ComposerKt.isTraceInProgress()) {
