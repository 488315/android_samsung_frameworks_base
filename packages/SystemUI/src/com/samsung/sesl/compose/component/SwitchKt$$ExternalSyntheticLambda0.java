    ...
    public final Object invoke(Object obj, Object obj2) {
        switch (this.$r8$classId) {
            case 0:
                ...
                boolean z = this.f$3;
                SwitchKt.SeslOpenThemeSwitchTrack(this.f$0, this.f$1, modifier, z, (Composer) obj, updateChangedFlags);
                break;
            default:
                ((Integer) obj2).getClass();
                ...
                boolean z2 = this.f$3;
                SwitchKt.SeslDefaultSwitchTrack(this.f$0, this.f$1, modifier2, z2, (Composer) obj, updateChangedFlags2);
                break;
        }
