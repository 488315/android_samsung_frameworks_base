...
public class NumberParser {
    ...
    */
    public final float parseNumber(int r24, int r25, java.lang.String r26) {
        /*
            Method dump skipped, instructions count: 342
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.caverock.androidsvg.NumberParser.parseNumber(int, int, java.lang.String):float");
    }
}
