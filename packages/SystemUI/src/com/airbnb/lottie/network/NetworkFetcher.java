...
public class NetworkFetcher {
    ...
    public final LottieResult fromInputStream(Context context, String str, InputStream inputStream, String str2, String str3) {
        ...
        if (zContains || str2.contains("application/x-zip") || str2.contains("application/x-zip-compressed") || str.split("\\?")[0].endsWith(".lottie")) {
            ...
            lottieResultFromZipStreamSync = (str3 == null || networkCache == null) ? LottieCompositionFactory.fromZipStreamSync(context, new ZipInputStream(inputStream), null) : LottieCompositionFactory.fromZipStreamSync(context, new ZipInputStream(new FileInputStream(networkCache.writeTempCacheFile(str, inputStream, fileExtension2))), str);
            fileExtension = fileExtension2;
        } else {
            Logger.debug();
            fileExtension = FileExtension.JSON;
            lottieResultFromZipStreamSync = (str3 == null || networkCache == null) ? LottieCompositionFactory.fromJsonInputStreamSync(inputStream, null) : LottieCompositionFactory.fromJsonInputStreamSync(new FileInputStream(networkCache.writeTempCacheFile(str, inputStream, fileExtension).getAbsolutePath()), str);
        }
        if (str3 != null && lottieResultFromZipStreamSync.value != null && networkCache != null) {
