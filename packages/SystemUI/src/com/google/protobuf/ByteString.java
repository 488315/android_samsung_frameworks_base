...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    class LiteralByteString extends LeafByteString {
        ...
        public final boolean isValidUtf8() {
            ...
            byte[] bArr = this.bytes;
            return Utf8.processor.isValidUtf8(offsetIntoBytes, size() + offsetIntoBytes, bArr);
        }
    ...
    static {
        ...
        byteArrayCopier = new SystemByteArrayCopier(null);
        new Comparator() { // from class: com.google.protobuf.ByteString.2
            ...
            public final int compare(Object obj, Object obj2) {
                ...
                byteString.getClass();
                AnonymousClass1 anonymousClass1 = byteString.new AnonymousClass1();
                byteString2.getClass();
                AnonymousClass1 anonymousClass12 = byteString2.new AnonymousClass1();
                while (anonymousClass1.hasNext() && anonymousClass12.hasNext()) {
                    int iCompareTo = Integer.valueOf(anonymousClass1.nextByte() & 255).compareTo(Integer.valueOf(anonymousClass12.nextByte() & 255));
                    if (iCompareTo != 0) {
                        return iCompareTo;
                    }
                }
