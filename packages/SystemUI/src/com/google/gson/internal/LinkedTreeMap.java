...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class EntrySet extends AbstractSet<Map.Entry<Object, Object>> {
        ...
        public Iterator<Map.Entry<Object, Object>> iterator() {
            return new LinkedTreeMapIterator<Map.Entry<Object, Object>>() { // from class: com.google.gson.internal.LinkedTreeMap.EntrySet.1
                {
    ...
    final class KeySet extends AbstractSet<Object> {
        ...
        public Iterator<Object> iterator() {
            return new LinkedTreeMapIterator<Object>() { // from class: com.google.gson.internal.LinkedTreeMap.KeySet.1
                {
                    LinkedTreeMap linkedTreeMap = LinkedTreeMap.this;
                }
    ...
    abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        public final Node<Object, Object> nextNode() {
            Node<Object, Object> node = this.next;
            LinkedTreeMap linkedTreeMap = LinkedTreeMap.this;
        ...
        public final void remove() {
            Node<Object, Object> node = this.lastReturned;
            if (node == null) {
