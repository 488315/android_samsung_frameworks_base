...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [androidx.core.view.AccessibilityDelegateCompat, com.google.android.material.internal.NavigationMenuItemView$1] */
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.isBold = true;
        ?? r5 = new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.NavigationMenuItemView.1
