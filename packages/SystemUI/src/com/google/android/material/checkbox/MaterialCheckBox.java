...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public class SavedState extends View.BaseSavedState {
        ...
        public final String toString() {
            ...
            return TransitionKt$$ExternalSyntheticOutline0.m(sb, i != 1 ? i != 2 ? "unchecked" : "indeterminate" : "checked", "}");
        }
    ...
    /* JADX WARN: Type inference failed for: r9v6, types: [com.google.android.material.checkbox.MaterialCheckBox$1] */
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        this.buttonTintList = colorStateList == null ? super.getButtonTintList() != null ? super.getButtonTintList() : null : colorStateList;
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.mCompoundButtonHelper;
        if (appCompatCompoundButtonHelper != null) {
