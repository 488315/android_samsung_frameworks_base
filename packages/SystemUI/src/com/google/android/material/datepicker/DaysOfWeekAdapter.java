...
public class DaysOfWeekAdapter extends BaseAdapter {
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            textView = (TextView) KeyguardSecurityContainer$UserSwitcherViewMode$2$$ExternalSyntheticOutline0.m(viewGroup, R.layout.mtrl_calendar_day_of_week, viewGroup, false);
        }
