    ...
    public final void findIntersectingTextView() {
        ...
        for (int i2 = 0; i2 < this.textViewPool.size(); i2++) {
            ...
            if (textView3 != null) {
                ...
                textView3.getPaint().setShader(!RectF.intersects(rectF, this.scratch) ? null : new RadialGradient(rectF.centerX() - this.scratch.left, rectF.centerY() - this.scratch.top, 0.5f * rectF.width(), this.gradientColors, this.gradientPositions, Shader.TileMode.CLAMP));
