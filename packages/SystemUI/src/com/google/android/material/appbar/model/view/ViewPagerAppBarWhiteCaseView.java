...
public class ViewPagerAppBarWhiteCaseView extends ViewPagerAppBarView {
    ...
    public void updateResource(Context context) {
        ...
        if (viewpager != null) {
            ...
            RecyclerView.Adapter adapter = viewpager.mRecyclerView.mAdapter;
            if (adapter != null) {
    ...
    public /* synthetic */ ViewPagerAppBarWhiteCaseView(Context context, AttributeSet attributeSet, int i, DefaultConstructorMarker defaultConstructorMarker) {
