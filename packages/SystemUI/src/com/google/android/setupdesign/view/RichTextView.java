...
public class RichTextView extends AppCompatTextView implements LinkSpan.OnLinkClickListener {
    ...
    public Item onLinkClickListener;
        ...
        if (charSequence instanceof Spanned) {
            ...
            for (Annotation annotation : (Annotation[]) spannableString.getSpans(0, spannableString.length(), Annotation.class)) {
                ...
                if ("textAppearance".equals(key)) {
                    ...
                    if (identifier == 0) {
                        RecordingInputConnection$$ExternalSyntheticOutline0.m(identifier, "Cannot find resource: ", "RichTextView");
                    }
                    ...
                    Object[] objArr2 = {new BoldLinkSpan(context, annotation.getValue()), spanTypeface != null ? new TypefaceSpan(spanTypeface) : new TypefaceSpan("sans-serif-medium")};
