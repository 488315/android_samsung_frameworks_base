...
public final class State {
    ...
    public final State appendFLGn(int i) {
        ...
        if (i < 0) {
            ...
            token.getClass();
            SimpleToken simpleToken2 = new SimpleToken(token, length, 3);
            int length2 = bytes.length;
            int i3 = 0;
            while (i3 < length2) {
                SimpleToken simpleToken3 = new SimpleToken(simpleToken2, bytes[i3] - 46, 4);
                i3++;
        ...
        return new State(simpleToken, this.mode, 0, this.bitCount + i2);
    }
