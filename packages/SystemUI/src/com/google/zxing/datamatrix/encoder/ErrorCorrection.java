...
public final class ErrorCorrection {
    ...
    public static String createECCBlock(int i, CharSequence charSequence) {
        ...
        if (i4 < 0) {
            throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(i, "Illegal number of error correction codewords specified: "));
        }
