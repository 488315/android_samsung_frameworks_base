...
public class SymbolInfo {
    ...
    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, Dimension dimension, Dimension dimension2) {
        ...
        throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(i, "Can't find a symbol arrangement that matches the message. Data codewords: "));
    }
