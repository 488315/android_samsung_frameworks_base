...
public class RestartDialogLayout extends ConstraintLayout implements DialogContainerSupplier {
    ...
    public final void setDismissOnClickListener(Runnable runnable) {
        findViewById(R.id.letterbox_restart_dialog_dismiss_button).setOnClickListener(runnable == null ? null : new RestartDialogLayout$$ExternalSyntheticLambda1((RestartDialogWindowManager$$ExternalSyntheticLambda0) runnable, 1));
    }
