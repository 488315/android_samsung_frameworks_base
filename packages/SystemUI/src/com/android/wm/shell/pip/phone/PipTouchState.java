...
public class PipTouchState {
    ...
    public final void onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            if (!this.mAllowTouches) {
                Log.d("PipTouchState", "pip touch event not allowed");
                return;
            }
        ...
        if (actionMasked != 1) {
                ...
                if (this.mIsUserInteracting) {
                    ...
                    if (iFindPointerIndex == -1) {
                        if (ProtoLogImpl_1771455215.Cache.WM_SHELL_PICTURE_IN_PICTURE_enabled[4]) {
                            ProtoLogImpl_1771455215.e(ShellProtoLogGroup.WM_SHELL_PICTURE_IN_PICTURE, 6468678591909016462L, 4, "PipTouchState", Long.valueOf(this.mActivePointerId));
                            return;
                        }
                        return;
                    }
            ...
            if (iFindPointerIndex2 == -1) {
                if (ProtoLogImpl_1771455215.Cache.WM_SHELL_PICTURE_IN_PICTURE_enabled[4]) {
                    ProtoLogImpl_1771455215.e(ShellProtoLogGroup.WM_SHELL_PICTURE_IN_PICTURE, -2717992408921393635L, 4, "PipTouchState", Long.valueOf(this.mActivePointerId));
                    return;
                }
                return;
            }
    ...
    public final void reset() {
        KeyguardSecUpdateMonitorImpl$$ExternalSyntheticOutline0.m(3, "PipTouchState", new StringBuilder("reset PipTouchState callers="));
    ...
    public void scheduleHoverExitTimeoutCallback() {
        ...
        ShellExecutor shellExecutor = this.mMainExecutor;
        ((HandlerExecutor) shellExecutor).removeCallbacks(runnable);
        ((HandlerExecutor) shellExecutor).executeDelayed(this.mHoverExitTimeoutCallback, 150L);
    }
}
