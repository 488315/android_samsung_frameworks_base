...
public final /* synthetic */ class BubbleController$BubblesImpl$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ BubbleController$BubblesImpl$$ExternalSyntheticLambda4(BubbleController.BubblesImpl bubblesImpl, BubbleEntry bubbleEntry, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            default:
                ...
                if (bubbleController2.canLaunchInTaskView(bubbleController2.mContext, bubbleEntry2)) {
