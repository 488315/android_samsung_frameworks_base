...
public final class DesktopWindowingEducationPromoController implements DisplayChangeController.OnDisplayChangingListener {
    ...
    public View educationView;
    public AdditionalSystemViewContainer popupWindow;
    public final Lazy springConfig$delegate = LazyKt__LazyJVMKt.lazy(new DesktopWindowingEducationPromoController$$ExternalSyntheticLambda0());

    public DesktopWindowingEducationPromoController(Context context, AdditionalSystemViewContainer.Factory factory, DisplayController displayController) {
