...
public final /* synthetic */ class DesktopModeWindowDecorViewModel$$ExternalSyntheticLambda25 implements Consumer {
    public final /* synthetic */ int $r8$classId;

    public /* synthetic */ DesktopModeWindowDecorViewModel$$ExternalSyntheticLambda25(int i) {
        this.$r8$classId = i;
    }
        ...
        switch (this.$r8$classId) {
            case 0:
                if (DesktopModeWindowDecoration.isAppHandle(desktopModeWindowDecoration.mWindowDecorViewHolder)) {
                    MultiTaskingHandleViewHolder asMultiTaskingAppHandle = DesktopModeWindowDecoration.asMultiTaskingAppHandle(desktopModeWindowDecoration.mWindowDecorViewHolder);
                    if (asMultiTaskingAppHandle != null) {
                        ...
                        ActivityManager.RunningTaskInfo runningTaskInfo = asMultiTaskingAppHandle.taskInfo;
                        if (runningTaskInfo == null) {
                            runningTaskInfo = null;
                        }
                        imageButton.setImageTintList(ColorStateList.valueOf(asMultiTaskingAppHandle.getCaptionHandleColor(runningTaskInfo, z)));
                        break;
                    }
                } else if (DesktopModeWindowDecoration.isAppHeader(desktopModeWindowDecoration.mWindowDecorViewHolder) && (asMultiTaskingAppHeader = DesktopModeWindowDecoration.asMultiTaskingAppHeader(desktopModeWindowDecoration.mWindowDecorViewHolder)) != null) {
                    CaptionButtonPolicy captionButtonPolicy = asMultiTaskingAppHeader.captionButtonPolicy;
                    View view = asMultiTaskingAppHeader.captionView;
