...
public final /* synthetic */ class DesktopModeWindowDecoration$$ExternalSyntheticLambda8 implements Function0 {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ DesktopModeWindowDecoration f$0;

    public /* synthetic */ DesktopModeWindowDecoration$$ExternalSyntheticLambda8(DesktopModeWindowDecoration desktopModeWindowDecoration, int i) {
        this.$r8$classId = i;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (CoreRune.MW_CAPTION) {
                    final MultiTaskingHeaderViewHolder asMultiTaskingAppHeader = DesktopModeWindowDecoration.asMultiTaskingAppHeader(desktopModeWindowDecoration.mWindowDecorViewHolder);
                    if (asMultiTaskingAppHeader != null && (imageButton = asMultiTaskingAppHeader.maximizeWindowButton) != null) {
                        imageButton.post(new Runnable() { // from class: com.android.wm.shell.windowdecor.viewholder.MultiTaskingHeaderViewHolder$requestAccessibilityFocus$1
                            ...
                            public final void run() {
                                MultiTaskingHeaderViewHolder.this.maximizeWindowButton.sendAccessibilityEvent(8);
                            }
                        });
                    }
                } else {
                    final AppHeaderViewHolder asAppHeader = DesktopModeWindowDecoration.asAppHeader(desktopModeWindowDecoration.mWindowDecorViewHolder);
                    if (asAppHeader != null) {
                        asAppHeader.maximizeWindowButton.post(new Runnable() { // from class: com.android.wm.shell.windowdecor.viewholder.AppHeaderViewHolder$requestAccessibilityFocus$1
                            @Override // java.lang.Runnable
                            public final void run() {
                                AppHeaderViewHolder.this.maximizeWindowButton.sendAccessibilityEvent(8);
                            }
                        });
                    }
                }
