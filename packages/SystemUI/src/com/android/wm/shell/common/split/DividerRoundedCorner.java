...
public class DividerRoundedCorner extends View {
    ...
    public class InvertedRoundedCornerDrawInfo {
        ...
        public static void m3237$$Nest$mcalculateStartPos(InvertedRoundedCornerDrawInfo invertedRoundedCornerDrawInfo, Point point) {
    ...
    public final void onDraw(Canvas canvas) {
        canvas.save();
        InvertedRoundedCornerDrawInfo.m3237$$Nest$mcalculateStartPos(this.mTopLeftCorner, this.mStartPos);
        ...
        InvertedRoundedCornerDrawInfo.m3237$$Nest$mcalculateStartPos(this.mTopRightCorner, this.mStartPos);
        ...
        InvertedRoundedCornerDrawInfo.m3237$$Nest$mcalculateStartPos(this.mBottomLeftCorner, this.mStartPos);
        ...
        InvertedRoundedCornerDrawInfo.m3237$$Nest$mcalculateStartPos(this.mBottomRightCorner, this.mStartPos);
