...
public class DividerPanelView extends LinearLayout {
    ...
    public LottieAnimationView mChangeLayoutIcon;
    ...
    public final void onFinishInflate() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt instanceof LottieAnimationView) {
                ((LottieAnimationView) childAt).addValueCallback(new KeyPath("**"), (KeyPath) LottieProperty.COLOR_FILTER, new SimpleLottieValueCallback() { // from class: com.android.wm.shell.common.split.DividerPanelView.4
        ...
        createLottieTask(this.mChangeLayoutIcon, "splitview_divider_option_icon_rotating_layout_vertical.json");
    }
