...
public class NonDragTarget extends FrameLayout {
    ...
    public final void setDropTargetView() {
        ...
        ShellExecutor shellExecutor = this.mBackgroundExecutor;
        if (dropTargetView.mUiHandler == null && Looper.myLooper() != null) {
            dropTargetView.mUiHandler = new Handler(Looper.myLooper());
        }
        dropTargetView.mBackgroundExecutor = shellExecutor;
        dropTargetView.mBounds.set(rect);
    ...
    public final void setThumbnail() {
        ...
        if (this.mHasProtectedContent) {
            ...
            Bitmap blurredBitmap = getBlurredBitmap(((FrameLayout) this).mContext, snapshotBitmap);
    ...
    public final String toString() {
        ...
        return MoveResult$$ExternalSyntheticOutline0.m(sb, this.mDropTargetView != null, "}");
    }
}
