...
public abstract class IStartingWindow$Stub extends Binder implements IInterface {
    ...
    public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        if (strongBinder == null) {
            ...
            IInterface iInterfaceQueryLocalInterface = strongBinder.queryLocalInterface("com.android.wm.shell.startingsurface.IStartingWindowListener");
            iStartingWindowListener$Stub$Proxy = (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IStartingWindowListener$Stub$Proxy)) ? new IStartingWindowListener$Stub$Proxy(strongBinder) : (IStartingWindowListener$Stub$Proxy) iInterfaceQueryLocalInterface;
        }
        ...
        ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(iStartingWindowImpl.mController, "setStartingWindowListener", new Consumer() { // from class: com.android.wm.shell.startingsurface.StartingWindowController$IStartingWindowImpl$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) throws RemoteException {
                StartingWindowController.IStartingWindowImpl iStartingWindowImpl2 = iStartingWindowImpl;
