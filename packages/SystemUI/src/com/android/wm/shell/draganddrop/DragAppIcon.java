...
public class DragAppIcon extends ImageView {
    ...
    public final void onFinishInflate() {
        ...
        springAnimation.mSpring = ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(220.0f, 0.7f);
        this.mScaleUpAnimX = springAnimation;
        SpringAnimation springAnimation2 = new SpringAnimation(this, DynamicAnimation.SCALE_Y);
        springAnimation2.mSpring = ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(220.0f, 0.7f);
