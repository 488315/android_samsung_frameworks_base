...
public abstract class IRecentTasks$Stub extends Binder implements IInterface {
    ...
    public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        final IRecentTasksListener proxy = null;
        IRecentsAnimationRunner iRecentsAnimationRunner$Stub$Proxy = null;
        if (i == 2) {
            IBinder strongBinder = parcel.readStrongBinder();
            if (strongBinder != null) {
                IInterface iInterfaceQueryLocalInterface = strongBinder.queryLocalInterface("com.android.wm.shell.recents.IRecentTasksListener");
                proxy = (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IRecentTasksListener)) ? new IRecentTasksListener.Stub.Proxy(strongBinder) : (IRecentTasksListener) iInterfaceQueryLocalInterface;
            }
            ...
            ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(iRecentTasksImpl.mController, "registerRecentTasksListener", new Consumer() { // from class: com.android.wm.shell.recents.RecentTasksController$IRecentTasksImpl$$ExternalSyntheticLambda5
                ...
                public final void accept(Object obj) throws RemoteException {
                    ...
                    iRecentTasksImpl2.mListener.register(proxy);
                }
            }, false);
            return true;
        }
        if (i == 3) {
            ...
            if (strongBinder2 != null) {
                IInterface iInterfaceQueryLocalInterface2 = strongBinder2.queryLocalInterface("com.android.wm.shell.recents.IRecentTasksListener");
                if (iInterfaceQueryLocalInterface2 == null || !(iInterfaceQueryLocalInterface2 instanceof IRecentTasksListener)) {
                    new IRecentTasksListener.Stub.Proxy(strongBinder2);
                }
            }
            parcel.enforceNoDataAvail();
            RecentTasksController.IRecentTasksImpl iRecentTasksImpl2 = (RecentTasksController.IRecentTasksImpl) this;
            ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(iRecentTasksImpl2.mController, "unregisterRecentTasksListener", new RecentTasksController$$ExternalSyntheticLambda7(iRecentTasksImpl2, 2), false);
            return true;
        }
        if (i == 4) {
            ...
            if (recentTasksController == null) {
                ...
                ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(recentTasksController, "getRecentTasks", new Consumer() { // from class: com.android.wm.shell.recents.RecentTasksController$IRecentTasksImpl$$ExternalSyntheticLambda1
                    ...
                    public final void accept(Object obj) {
                        ...
                        int i9 = RecentTasksController.IRecentTasksImpl.$r8$clinit;
                        groupedTaskInfoArr3[0] = (GroupedTaskInfo[]) ((RecentTasksController) obj).getRecentTasks(i6, i7, i8).toArray(new GroupedTaskInfo[0]);
                    }
                }, true);
        ...
        if (i == 5) {
            ...
            ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(((RecentTasksController.IRecentTasksImpl) this).mController, "getRunningTasks", new Consumer() { // from class: com.android.wm.shell.recents.RecentTasksController$IRecentTasksImpl$$ExternalSyntheticLambda2
                ...
                public final void accept(Object obj) {
                    ...
                    int i7 = i6;
                    int i8 = RecentTasksController.IRecentTasksImpl.$r8$clinit;
                    runningTaskInfoArr2[0] = (ActivityManager.RunningTaskInfo[]) ActivityTaskManager.getInstance().getTasks(i7).toArray(new ActivityManager.RunningTaskInfo[0]);
                }
            }, true);
        ...
        final IApplicationThread iApplicationThreadAsInterface = IApplicationThread.Stub.asInterface(parcel.readStrongBinder());
        IBinder strongBinder3 = parcel.readStrongBinder();
        if (strongBinder3 != null) {
            IInterface iInterfaceQueryLocalInterface3 = strongBinder3.queryLocalInterface("com.android.wm.shell.recents.IRecentsAnimationRunner");
            iRecentsAnimationRunner$Stub$Proxy = (iInterfaceQueryLocalInterface3 == null || !(iInterfaceQueryLocalInterface3 instanceof IRecentsAnimationRunner)) ? new IRecentsAnimationRunner$Stub$Proxy(strongBinder3) : (IRecentsAnimationRunner) iInterfaceQueryLocalInterface3;
        }
        ...
        ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(recentTasksController2, "startRecentsTransition", new Consumer() { // from class: com.android.wm.shell.recents.RecentTasksController$IRecentTasksImpl$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) throws Resources.NotFoundException {
                ...
                IApplicationThread iApplicationThread = iApplicationThreadAsInterface;
                IRecentsAnimationRunner iRecentsAnimationRunner2 = iRecentsAnimationRunner;
                int i7 = RecentTasksController.IRecentTasksImpl.$r8$clinit;
