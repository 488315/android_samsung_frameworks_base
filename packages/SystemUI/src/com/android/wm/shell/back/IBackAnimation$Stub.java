...
public abstract class IBackAnimation$Stub extends Binder implements IInterface {
    ...
    public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        final IOnBackInvokedCallback iOnBackInvokedCallbackAsInterface = IOnBackInvokedCallback.Stub.asInterface(parcel.readStrongBinder());
        final IRemoteAnimationRunner iRemoteAnimationRunnerAsInterface = IRemoteAnimationRunner.Stub.asInterface(parcel.readStrongBinder());
        parcel.enforceNoDataAvail();
        ...
        if (CoreRune.FW_PREDICTIVE_BACK_ANIM_LOG) {
            Log.i("ShellBackPreview", "setBackToLauncherCallback, callback=" + iOnBackInvokedCallbackAsInterface + ", runner=" + iRemoteAnimationRunnerAsInterface);
        }
        ExternalInterfaceBinder.executeRemoteCallWithTaskPermission(iBackAnimationImpl.mController, "setBackToLauncherCallback", new Consumer() { // from class: com.android.wm.shell.back.BackAnimationController$IBackAnimationImpl$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                BackAnimationController.IBackAnimationImpl iBackAnimationImpl2 = iBackAnimationImpl;
                IOnBackInvokedCallback iOnBackInvokedCallback = iOnBackInvokedCallbackAsInterface;
                IRemoteAnimationRunner iRemoteAnimationRunner = iRemoteAnimationRunnerAsInterface;
