...
public final class ToggleResizeDesktopTaskTransitionHandler implements Transitions.TransitionHandler {
    ...
    public final boolean startAnimation(IBinder iBinder, TransitionInfo transitionInfo, final SurfaceControl.Transaction transaction, final SurfaceControl.Transaction transaction2, final Transitions.TransitionFinishCallback transitionFinishCallback) {
        ...
        Rect startAbsBounds = this.initialBounds;
        if (startAbsBounds == null) {
            startAbsBounds = change2.getStartAbsBounds();
        }
        final Rect rect = startAbsBounds;
        ...
        ValueAnimator duration = ValueAnimator.ofObject(this.rectEvaluator, rect, endAbsBounds).setDuration(300L);
        duration.getClass();
        duration.addListener(new Animator.AnimatorListener(transaction2, leash, endAbsBounds, this, i, transitionFinishCallback, transaction, leash, rect, this, i) { // from class: com.android.wm.shell.desktopmode.ToggleResizeDesktopTaskTransitionHandler$startAnimation$lambda$2$$inlined$addListener$default$1
            ...
            public final void onAnimationEnd(Animator animator2) {
                ...
                Rect rect2 = this.$endBounds$inlined;
                transaction4.setPosition(surfaceControl, rect2.left, rect2.top).setWindowCrop(this.$leash$inlined, this.$endBounds$inlined.width(), this.$endBounds$inlined.height()).show(this.$leash$inlined);
            ...
            public final void onAnimationStart(Animator animator2) {
                ...
                Rect rect2 = this.$startBounds$inlined;
                transaction4.setPosition(surfaceControl, rect2.left, rect2.top).setWindowCrop(this.$leash$inlined$1, this.$startBounds$inlined.width(), this.$startBounds$inlined.height()).show(this.$leash$inlined$1);
                DesktopModeWindowDecorViewModel.DesktopModeOnTaskResizeAnimationListener desktopModeOnTaskResizeAnimationListener = this.this$0.onTaskResizeAnimationListener;
                if (desktopModeOnTaskResizeAnimationListener == null) {
                    desktopModeOnTaskResizeAnimationListener = null;
                }
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.wm.shell.desktopmode.ToggleResizeDesktopTaskTransitionHandler$startAnimation$1$3
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                transaction3.setPosition(leash, rect2.left, rect2.top).setWindowCrop(leash, rect2.width(), rect2.height()).show(leash).setFrameTimeline(Choreographer.getInstance().getVsyncId());
                ...
                desktopModeOnTaskResizeAnimationListener.onBoundsChange(i, transaction3, rect2);
            }
        });
        duration.start();
