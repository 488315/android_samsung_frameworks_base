...
public final /* synthetic */ class DesktopRepository$$ExternalSyntheticLambda5 implements Function1 {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ DesktopRepository f$0;
    public final /* synthetic */ int f$1;

    public /* synthetic */ DesktopRepository$$ExternalSyntheticLambda5(int i, int i2, DesktopRepository desktopRepository) {
        this.$r8$classId = i2;
        ...
        switch (this.$r8$classId) {
            ...
            default:
                ...
                if (desk.closingTasks.remove(Integer.valueOf(i))) {
                    desktopRepository.logD("Removed closing task=%d deskId=%d", Integer.valueOf(i), Integer.valueOf(desk.deskId));
                }
                break;
        }
    ...
    public /* synthetic */ DesktopRepository$$ExternalSyntheticLambda5(int i, DesktopRepository desktopRepository) {
        this.$r8$classId = 2;
        this.f$1 = i;
        this.f$0 = desktopRepository;
    }
