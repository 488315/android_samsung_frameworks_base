...
public final class AppToWebEducationDatastoreRepository {
    ...
    public AppToWebEducationDatastoreRepository(DataStore dataStore) {
        this.dataStore = dataStore;
        this.dataStoreFlow = new FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1(dataStore.getData(), new AppToWebEducationDatastoreRepository$dataStoreFlow$1(null));
    }

    public AppToWebEducationDatastoreRepository(final Context context) {
        this(DataStoreFactory.create$default(DataStoreFactory.INSTANCE, Companion.WindowingEducationProtoSerializer.INSTANCE, new ReplaceFileCorruptionHandler(new AppToWebEducationDatastoreRepository$$ExternalSyntheticLambda0()), null, new Function0() { // from class: com.android.wm.shell.desktopmode.education.data.AppToWebEducationDatastoreRepository$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Context context2 = context;
                int i = AppToWebEducationDatastoreRepository.$r8$clinit;
                return DataStoreFile.dataStoreFile(context2, "app_to_web_education.pb");
            }
        }, 12));
    }
}
