...
public final class DesktopPersistentRepositories extends GeneratedMessageLite implements MessageLiteOrBuilder {
    ...
    public static MapFieldLite m3240$$Nest$mgetMutableDesktopRepoByUserMap(DesktopPersistentRepositories desktopPersistentRepositories) {
        ...
        return desktopPersistentRepositories.desktopRepoByUser_;
    }
    ...
    public final Map getDesktopRepoByUserMap() {
        return Collections.unmodifiableMap(this.desktopRepoByUser_);
    }

    public final DesktopRepositoryState getDesktopRepoByUserOrDefault(int i, DesktopRepositoryState desktopRepositoryState) {
        MapFieldLite<Integer, DesktopRepositoryState> mapFieldLite = this.desktopRepoByUser_;
        return mapFieldLite.containsKey(Integer.valueOf(i)) ? mapFieldLite.get(Integer.valueOf(i)) : desktopRepositoryState;
    }
}
