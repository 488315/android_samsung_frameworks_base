...
public class SmartPopupViewService extends NotificationListenerService {
    ...
    public class SmartPopupViewPackageListObserver extends ContentObserver {
        ...
        public final void loadingEnabledListFromDB() {
            ...
            ArrayList arrayList = (ArrayList) SmartPopupViewService.this.mEnabledList;
    ...
    public final void onNotificationPosted(StatusBarNotification statusBarNotification, NotificationListenerService.RankingMap rankingMap) {
        ...
        if (this.mZenMode != 0 && (ranking.getSuppressedVisualEffects() & 16) != 0) {
        ...
        if (((ArrayList) this.mEnabledList).contains(packageName)) {
            ...
            if (str == null || !(str.equals("progress") || notification2.category.equals("service"))) {
                ...
                if (notification2.isForegroundService()) {
                    ...
                    freeformContainerManager.mH.sendMessage(23, new SmartPopupViewItem(freeformContainerManager.mContext, packageName, notification2, key));
                }
            }
        }
    }
