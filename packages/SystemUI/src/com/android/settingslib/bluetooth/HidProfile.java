...
public final class HidProfile implements LocalBluetoothProfile {
    ...
    public final int getConnectionStatus(BluetoothDevice bluetoothDevice) {
        ...
        if (bluetoothHidHost == null) {
            Log.d("HidProfile", "getConnectionStatus: BluetoothProfile.STATE_DISCONNECTED");
            return 0;
        }
        int connectionState = bluetoothHidHost.getConnectionState(bluetoothDevice);
        ListPopupWindow$$ExternalSyntheticOutline0.m(connectionState, "getConnectionStatus: ", "HidProfile");
