...
public final class SapProfile implements LocalBluetoothProfile {
    ...
    public final int getConnectionStatus(BluetoothDevice bluetoothDevice) {
        ...
        if (bluetoothSap == null) {
            Log.d("SapProfile", "getConnectionStatus: BluetoothProfile.STATE_DISCONNECTED");
            return 0;
        }
        int connectionState = bluetoothSap.getConnectionState(bluetoothDevice);
        ListPopupWindow$$ExternalSyntheticOutline0.m(connectionState, "getConnectionStatus: ", "SapProfile");
