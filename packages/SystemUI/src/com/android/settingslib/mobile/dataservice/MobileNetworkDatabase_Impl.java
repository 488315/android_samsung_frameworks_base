...
public final class MobileNetworkDatabase_Impl extends MobileNetworkDatabase {
    ...
    public final RoomOpenDelegate createOpenDelegate() {
        return new RoomOpenDelegate(1, "c4b8b3a0a8ec44684d55f07bbe0fbdb5", "1cdce0c1e59b9e90ca6bdf9ec4c4e881") { // from class: com.android.settingslib.mobile.dataservice.MobileNetworkDatabase_Impl.1
            ...
            public final RoomOpenDelegate.ValidationResult onValidateSchema(SQLiteConnection sQLiteConnection) {
                ...
                hashMap.put("sudId", new TableInfo.Column("sudId", ImsSettings.TYPE_TEXT, true, 1, null, 1));
                ...
                hashMap.put("uniqueName", new TableInfo.Column("uniqueName", ImsSettings.TYPE_TEXT, false, 0, null, 1));
                ...
                hashMap2.put("subId", new TableInfo.Column("subId", ImsSettings.TYPE_TEXT, true, 1, null, 1));
                hashMap2.put("isMobileDataEnabled", new TableInfo.Column("isMobileDataEnabled", "INTEGER", true, 0, null, 1));
                HashSet hashSet3 = new HashSet(0);
                HashSet hashSet4 = new HashSet(1);
                hashSet4.add(new TableInfo.Index("index_MobileNetworkInfo_subId", false, Arrays.asList("subId"), Arrays.asList("ASC")));
                TableInfo tableInfo2 = new TableInfo("MobileNetworkInfo", hashMap2, hashSet3, hashSet4);
                TableInfo read2 = TableInfo.read(sQLiteConnection, "MobileNetworkInfo");
    ...
    public final Map getRequiredTypeConverters() {
        ...
        hashMap.put(SubscriptionInfoDao_Impl.class, list);
        hashMap.put(MobileNetworkInfoDao_Impl.class, list);
        return hashMap;
    }
}
