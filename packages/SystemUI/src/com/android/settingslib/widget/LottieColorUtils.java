...
public class LottieColorUtils {
    ...
    static {
        Integer numValueOf = Integer.valueOf(R.color.settingslib_color_red500);
        Integer numValueOf2 = Integer.valueOf(R.color.settingslib_color_green500);
        DARK_TO_LIGHT_THEME_COLOR_MAP = Map.ofEntries(Map.entry(".grey200", Integer.valueOf(R.color.settingslib_color_grey800)), Map.entry(".grey600", Integer.valueOf(R.color.settingslib_color_grey400)), Map.entry(".grey800", Integer.valueOf(R.color.settingslib_color_grey300)), Map.entry(".grey900", Integer.valueOf(R.color.settingslib_color_grey50)), Map.entry(".red100", numValueOf), Map.entry(".red200", numValueOf), Map.entry(".red400", Integer.valueOf(R.color.settingslib_color_red600)), Map.entry(".black", Integer.valueOf(android.R.color.white)), Map.entry(".blue200", Integer.valueOf(R.color.settingslib_color_blue700)), Map.entry(".blue400", Integer.valueOf(R.color.settingslib_color_blue600)), Map.entry(".green100", numValueOf2), Map.entry(".green200", numValueOf2), Map.entry(".green400", Integer.valueOf(R.color.settingslib_color_green600)), Map.entry(".cream", Integer.valueOf(R.color.settingslib_color_charcoal)));
