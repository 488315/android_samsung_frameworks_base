...
public class OsuWifiEntry extends WifiEntry {
        ...
        public final void onProvisioningComplete() {
            ...
            while (true) {
                ...
                if (TextUtils.equals(wifiConfiguration.getKey(), uniqueId)) {
                    ...
                    wifiConfiguration.SSID = TransitionKt$$ExternalSyntheticOutline0.m(new StringBuilder("\""), bestScanResultByLevel.SSID, "\"");
    ...
    public OsuWifiEntry(WifiTrackerInjector wifiTrackerInjector, Handler handler, OsuProvider osuProvider, WifiManager wifiManager, boolean z) throws IllegalArgumentException {
    ...
    public final synchronized void updateScanResultInfo(List list) {
        ...
        if (bestScanResultByLevel != null) {
            ...
            if (getConnectedState() == 0) {
                this.mScanResultLevel = SemWifiUtils.calculateSignalLevel(this.mRssi);
            }
