...
public final class ActiveUnlockConfig$settingsObserver$1 extends ContentObserver {
    ...
    public final void onChange(boolean z, Collection collection, int i, int i2) {
        ...
        if (z || collection.contains(this.faceErrorsUri)) {
            ...
            processStringArray(activeUnlockConfig5.secureSettings.getStringForUser("active_unlock_on_face_errors", activeUnlockConfig5.selectedUserInteractor.getSelectedUserId()), this.this$0.faceErrorsToTriggerBiometricFailOn, Collections.singleton(3));
        }
        if (z || collection.contains(this.faceAcquireInfoUri)) {
            ActiveUnlockConfig activeUnlockConfig6 = this.this$0;
            processStringArray(activeUnlockConfig6.secureSettings.getStringForUser("active_unlock_on_face_acquire_info", activeUnlockConfig6.selectedUserInteractor.getSelectedUserId()), this.this$0.faceAcquireInfoToTriggerBiometricFailOn, EmptySet.INSTANCE);
        }
        if (z || collection.contains(this.unlockIntentWhenBiometricEnrolledUri)) {
            ActiveUnlockConfig activeUnlockConfig7 = this.this$0;
            processStringArray(activeUnlockConfig7.secureSettings.getStringForUser("active_unlock_on_unlock_intent_when_biometric_enrolled", activeUnlockConfig7.selectedUserInteractor.getSelectedUserId()), this.this$0.onUnlockIntentWhenBiometricEnrolled, Collections.singleton(Integer.valueOf(ActiveUnlockConfig.BiometricType.NONE.getIntValue())));
        }
        if (z || collection.contains(this.wakeupsConsideredUnlockIntentsUri)) {
            ActiveUnlockConfig activeUnlockConfig8 = this.this$0;
            processStringArray(activeUnlockConfig8.secureSettings.getStringForUser("active_unlock_wakeups_considered_unlock_intents", activeUnlockConfig8.selectedUserInteractor.getSelectedUserId()), this.this$0.wakeupsConsideredUnlockIntents, Collections.singleton(12));
        }
        if (z || collection.contains(this.wakeupsToForceDismissKeyguardUri)) {
            ActiveUnlockConfig activeUnlockConfig9 = this.this$0;
            processStringArray(activeUnlockConfig9.secureSettings.getStringForUser("active_unlock_wakeups_to_force_dismiss_keyguard", activeUnlockConfig9.selectedUserInteractor.getSelectedUserId()), this.this$0.wakeupsToForceDismissKeyguard, Collections.singleton(12));
        }
    }
}
