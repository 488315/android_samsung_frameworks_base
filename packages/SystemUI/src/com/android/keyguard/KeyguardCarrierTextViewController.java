...
public class KeyguardCarrierTextViewController extends ViewController implements SystemUIWidgetCallback, IndicatorGarden {
    ...
    public final void updateStyle(long j, SemWallpaperColors semWallpaperColors) {
        ((CarrierText) ((KeyguardCarrierTextView) this.mView).findViewById(R.id.bouncer_carrier_text)).setTextColor(getResources().getColor(WallpaperUtils.isWhiteKeyguardWallpaper(BriefViewController.SUGGESTION_BACKGROUND_KEY) ? R.color.whitebg_keyguard_text_color : R.color.origin_bouncer_carrier_text_color, null));
    }
}
