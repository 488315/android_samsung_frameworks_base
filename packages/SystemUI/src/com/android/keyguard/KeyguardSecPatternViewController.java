...
public class KeyguardSecPatternViewController extends KeyguardPatternViewController {
    ...
    public class SecUnlockPatternListener extends KeyguardPatternViewController.UnlockPatternListener {
        ...
        public final void onPatternChecked(int i, int i2, boolean z, boolean z2) {
            ...
            if (i2 == 0) {
                ...
                if (remainingAttempt > 0) {
                    string = TransitionKt$$ExternalSyntheticOutline0.m(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(string, " ("), KeyguardSecPatternViewController.this.getResources().getQuantityString(R.plurals.kg_attempt_left, remainingAttempt, Integer.valueOf(remainingAttempt)), ")");
                }
        ...
        public final void onPatternDetected(List list) {
            ...
            if (knoxStateMonitor != null) {
                if (((KnoxStateMonitorImpl) knoxStateMonitor).isDualDarDeviceOwner(keyguardSecPatternViewController.mSelectedUserInteractor.getSelectedUserId())) {
                    KeyguardSecPatternViewController keyguardSecPatternViewController2 = KeyguardSecPatternViewController.this;
                    if (!((KnoxStateMonitorImpl) keyguardSecPatternViewController2.mKnoxStateMonitor).isDualDarInnerLayerUnlocked(keyguardSecPatternViewController2.mSelectedUserInteractor.getSelectedUserId())) {
                        ...
                        final int selectedUserId = KeyguardSecPatternViewController.this.mSelectedUserInteractor.getSelectedUserId();
                        if (list.size() < 4) {
                            android.util.Log.e("KeyguardSecPatternViewController", "!@Password too short!");
                            if (list.size() == 1) {
                                KeyguardSecPatternViewController.this.mFalsingCollector.updateFalseConfidence(FalsingClassifier.Result.falsed(0.7d, getClass().getSimpleName(), "empty pattern input"));
                            }
    ...
    public KeyguardSecPatternViewController(KeyguardSecPatternView keyguardSecPatternView, Executor executor, ConfigurationController configurationController, VibrationUtil vibrationUtil, KeyguardUpdateMonitor keyguardUpdateMonitor, KeyguardSecurityModel.SecurityMode securityMode, LockPatternUtils lockPatternUtils, KeyguardSecurityCallback keyguardSecurityCallback, LatencyTracker latencyTracker, FalsingCollector falsingCollector, EmergencyButtonController emergencyButtonController, KeyguardMessageAreaController.Factory factory, DevicePostureController devicePostureController, FeatureFlags featureFlags, SelectedUserInteractor selectedUserInteractor, BouncerHapticPlayer bouncerHapticPlayer) {
        super(keyguardSecPatternView, keyguardUpdateMonitor, securityMode, lockPatternUtils, keyguardSecurityCallback, latencyTracker, falsingCollector, emergencyButtonController, factory, devicePostureController, featureFlags, selectedUserInteractor, bouncerHapticPlayer);
        ...
        this.mConfigurationListener = new ConfigurationController.ConfigurationListener() { // from class: com.android.keyguard.KeyguardSecPatternViewController.1
            ...
            public final void onConfigChanged(Configuration configuration) {
                ...
                if (keyguardSecPatternViewController.mIsNightModeOn != z) {
                    CarrierTextManager$$ExternalSyntheticOutline0.m(new StringBuilder("night mode changed : "), keyguardSecPatternViewController.mIsNightModeOn, " -> ", z, "KeyguardSecPatternViewController");
        ...
        this.mKeyguardUpdateMonitorCallback = new KeyguardUpdateMonitorCallback() { // from class: com.android.keyguard.KeyguardSecPatternViewController.3
            ...
            public final void onLockModeChanged() {
                ...
                if (((KeyguardPatternViewController) keyguardSecPatternViewController).mKeyguardUpdateMonitor.getLockoutAttemptDeadline() == 0) {
                    keyguardSecPatternViewController.mSecondsRemaining = -1;
                    AnonymousClass2 anonymousClass2 = keyguardSecPatternViewController.mCountdownTimer;
            ...
            public final void onSimulationFailToUnlock(int i) {
                ...
                if (i2 == 0) {
                    ...
                    if (remainingAttempt > 0) {
                        string = TransitionKt$$ExternalSyntheticOutline0.m(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(string, " ("), keyguardSecPatternViewController.getResources().getQuantityString(R.plurals.kg_attempt_left, remainingAttempt, Integer.valueOf(remainingAttempt)), ")");
                    }
                    keyguardSecPatternViewController.mMessageAreaController.setMessage(string, false);
    ...
    public final void displayDefaultSecurityMessage() {
        ...
        if (keyguardUpdateMonitor.isShowEditModeRequest()) {
            ...
            EmergencyButtonController$$ExternalSyntheticOutline0.m(new StringBuilder("displayDefaultSecurityMessage - strongAuth ( "), this.mPromptReason, " )", "KeyguardSecPatternViewController");
    ...
    public final void handleAttemptLockout(long j) {
        ...
        if (shouldTipsPopup()) {
            ...
            KeyguardInputViewController$$ExternalSyntheticLambda0 keyguardInputViewController$$ExternalSyntheticLambda0 = this.mShowTipsRunnable;
            handler.removeCallbacks(keyguardInputViewController$$ExternalSyntheticLambda0);
            handler.postDelayed(keyguardInputViewController$$ExternalSyntheticLambda0, 500L);
        }
    ...
    public final boolean isHintText$1() {
        ...
        KeyguardUpdateMonitor keyguardUpdateMonitor = ((KeyguardPatternViewController) this).mKeyguardUpdateMonitor;
        return keyguardUpdateMonitor.getFailedUnlockAttempts(selectedUserId) > 0 && keyguardUpdateMonitor.getLockoutAttemptDeadline() == 0;
    }
    ...
    public final void startAppearAnimation() {
        if (((KeyguardPatternViewController) this).mKeyguardUpdateMonitor.isAnimationDisabled()) {
            this.mBottomView.setScaleX(1.0f);
            this.mBottomView.setScaleY(1.0f);
    ...
    public final void updateLayoutForAttemptRemainingBeforeWipe$1() {
        ...
        KeyguardUpdateMonitor keyguardUpdateMonitor = ((KeyguardPatternViewController) this).mKeyguardUpdateMonitor;
        if (i <= 1 && keyguardUpdateMonitor.getLockoutAttemptDeadline() == 0) {
            this.mSecondsRemaining = -1;
            return;
        }
        Resources resources = getResources();
    ...
    public final void updateStyle(final long j, final SemWallpaperColors semWallpaperColors) {
        if (semWallpaperColors != null) {
            this.mBackgroundExecutor.execute(new Runnable() { // from class: com.android.keyguard.KeyguardSecPatternViewController$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ...
                    android.util.Log.d("KeyguardSecPatternViewController", "updateStyle theme color: " + semWallpaperColors2.getColorThemeColor(j2));
                    if (keyguardSecPatternViewController.mLockPatternView instanceof SecLockPatternView) {
                        final int colorThemeColor = semWallpaperColors2.getColorThemeColor(512L);
