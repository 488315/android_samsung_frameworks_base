        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (pinResult.getResult() == 0) {
                    ...
                    keyguardSimPinViewController2.getKeyguardSecurityCallback().dismiss(true, KeyguardSimPinViewController.this.mSelectedUserInteractor.getSelectedUserId(), KeyguardSecurityModel.SecurityMode.SimPin);
                } else {
                    ...
                    if (pinResult.getResult() != 1) {
                        ...
                        keyguardSimPinViewController3.mMessageAreaController.setMessage(((KeyguardSimPinView) ((ViewController) keyguardSimPinViewController3).mView).getResources().getString(R.string.kg_password_pin_failed), false);
                    } else if (pinResult.getAttemptsRemaining() <= 2) {
                        KeyguardSimPinViewController.m963$$Nest$mgetSimRemainingAttemptsDialog(KeyguardSimPinViewController.this, pinResult.getAttemptsRemaining()).show();
                    } else {
                ...
                break;
            default:
                KeyguardSimPinViewController.CheckSimPin checkSimPin = this.f$0;
                PinResult pinResult2 = this.f$1;
                int i = KeyguardSimPinViewController.CheckSimPin.$r8$clinit;
                checkSimPin.onSimCheckResponse(pinResult2);
                break;
        }
    }
}
