            ...
            case 0:
                ...
                if (pinResult.getResult() == 0) {
                    ...
                    if (pinResult.getResult() != 1) {
                        ...
                        keyguardSecMessageAreaController.setMessage(((KeyguardSimPinView) view2).getResources().getString(R.string.kg_password_pin_failed), false);
                    } else if (pinResult.getAttemptsRemaining() <= 2) {
                        KeyguardSimPinViewController.m961$$Nest$mgetSimRemainingAttemptsDialog(KeyguardSimPinViewController.this, pinResult.getAttemptsRemaining()).show();
                    } else {
