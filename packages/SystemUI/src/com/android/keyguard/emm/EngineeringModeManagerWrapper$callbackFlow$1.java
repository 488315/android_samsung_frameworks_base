...
final class EngineeringModeManagerWrapper$callbackFlow$1 extends SuspendLambda implements Function2 {
    private /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ EngineeringModeManagerWrapper this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EngineeringModeManagerWrapper$callbackFlow$1(EngineeringModeManagerWrapper engineeringModeManagerWrapper, Continuation continuation) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new KeyguardStateController.Callback() { // from class: com.android.keyguard.emm.EngineeringModeManagerWrapper$callbackFlow$1$callback$1
                ...
                public final void onKeyguardShowingChanged() {
                    ((ChannelCoroutine) ProducerScope.this).mo3456trySendJP2dKIU(Boolean.valueOf(((KeyguardStateControllerImpl) engineeringModeManagerWrapper.keyguardStateController).mShowing));
                }
            };
            ...
            Function0 function0 = new Function0() { // from class: com.android.keyguard.emm.EngineeringModeManagerWrapper$callbackFlow$1$$ExternalSyntheticLambda0
