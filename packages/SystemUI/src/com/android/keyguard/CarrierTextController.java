...
public class CarrierTextController extends ViewController {
    ...
    public CarrierTextController(CarrierText carrierText, CarrierTextManager.Builder builder, KeyguardUpdateMonitor keyguardUpdateMonitor, ConfigurationController configurationController, IndicatorScaleGardener indicatorScaleGardener) {
        ...
        this.mCarrierTextCallback = new CarrierTextManager.CarrierTextCallback() { // from class: com.android.keyguard.CarrierTextController.1
            ...
            public final void updateCarrierInfo(CarrierTextManager.CarrierTextCallbackInfo carrierTextCallbackInfo) {
                ...
                Log.d("CarrierTextController", "info.location: " + carrierTextCallbackInfo.location + ", info.carrierText: " + ((Object) carrierTextCallbackInfo.carrierText) + ", info.carrierTextShort: " + ((Object) carrierTextCallbackInfo.carrierTextShort));
                ...
                if (charSequence == null || !charSequence.toString().contains("&")) {
                    ...
                    ((CarrierText) ((ViewController) carrierTextController).mView).setTextDirection(3);
                }
                if ("Keyguard".equals(carrierTextCallbackInfo.location)) {
                    ((CarrierText) ((ViewController) carrierTextController).mView).setText(carrierTextCallbackInfo.carrierTextShort);
                } else {
    ...
    public final void onViewAttached() {
        AnonymousClass1 anonymousClass1 = this.mCarrierTextCallback;
        CarrierTextManager carrierTextManager = this.mCarrierTextManager;
        carrierTextManager.mBgExecutor.execute(new CarrierTextManager$$ExternalSyntheticLambda1(carrierTextManager, anonymousClass1));
    ...
    public final void onViewDetached() {
        CarrierTextManager carrierTextManager = this.mCarrierTextManager;
        carrierTextManager.mBgExecutor.execute(new CarrierTextManager$$ExternalSyntheticLambda1(carrierTextManager, (CarrierTextManager.CarrierTextCallback) null));
