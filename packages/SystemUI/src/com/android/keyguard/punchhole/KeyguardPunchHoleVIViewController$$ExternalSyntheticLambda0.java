...
public final /* synthetic */ class KeyguardPunchHoleVIViewController$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                KeyguardPunchHoleVIViewController.$r8$lambda$cNlzCeNAAKTX1ka2SNKtt0InTQI(keyguardPunchHoleVIViewController);
                break;
            default:
                KeyguardPunchHoleVIViewController.$r8$lambda$ELksg8YKUHKs1dcJxyczqlKuknQ(keyguardPunchHoleVIViewController);
                break;
        }
    }
}
