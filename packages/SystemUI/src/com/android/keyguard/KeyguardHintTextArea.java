...
public class KeyguardHintTextArea extends RelativeLayout {
    ...
    public final void setVisibility(int i) {
        if (!DeviceType.isTablet()) {
            ...
            if (i == 0 && ((rotation == 1 || rotation == 3) && (!LsRune.SECURITY_SUB_DISPLAY_LOCK || !((DisplayLifecycle) Dependency.sDependency.getDependencyInner(DisplayLifecycle.class)).mIsFolderOpened))) {
                i = 8;
            }
        }
