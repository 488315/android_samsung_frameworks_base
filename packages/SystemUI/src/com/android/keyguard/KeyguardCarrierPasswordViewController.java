...
public class KeyguardCarrierPasswordViewController extends KeyguardSecAbsKeyInputViewController implements TextWatcher, TextView.OnEditorActionListener {
    ...
    public static void m953$r8$lambda$goCXBIlA97VX0btFJtY2f5PTY8(KeyguardCarrierPasswordViewController keyguardCarrierPasswordViewController, boolean z) throws Resources.NotFoundException {
        ...
        if (i > 4) {
            keyguardCarrierPasswordViewController.handleAttemptLockout(keyguardCarrierPasswordViewController.mLockPatternUtils.setCarrierLockoutAttemptDeadline(keyguardCarrierPasswordViewController.mSelectedUserInteractor.getSelectedUserId()));
        }
    }
    ...
    public KeyguardCarrierPasswordViewController(KeyguardCarrierPasswordView keyguardCarrierPasswordView, ConfigurationController configurationController, VibrationUtil vibrationUtil, AccessibilityManager accessibilityManager, KeyguardUpdateMonitor keyguardUpdateMonitor, KeyguardSecurityModel.SecurityMode securityMode, LockPatternUtils lockPatternUtils, KeyguardSecurityCallback keyguardSecurityCallback, KeyguardMessageAreaController.Factory factory, LatencyTracker latencyTracker, FalsingCollector falsingCollector, EmergencyButtonController emergencyButtonController, FeatureFlags featureFlags, InputMethodManager inputMethodManager, SelectedUserInteractor selectedUserInteractor, BouncerHapticPlayer bouncerHapticPlayer, UserActivityNotifier userActivityNotifier) {
        super(keyguardCarrierPasswordView, configurationController, vibrationUtil, accessibilityManager, keyguardUpdateMonitor, securityMode, lockPatternUtils, keyguardSecurityCallback, factory, latencyTracker, falsingCollector, emergencyButtonController, featureFlags, selectedUserInteractor, bouncerHapticPlayer, userActivityNotifier);
    ...
    public final void reset$1() {
        ...
        this.mPasswordEntry.requestFocus();
        long carrierLockoutAttemptDeadline = this.mLockPatternUtils.getCarrierLockoutAttemptDeadline(this.mSelectedUserInteractor.getSelectedUserId());
