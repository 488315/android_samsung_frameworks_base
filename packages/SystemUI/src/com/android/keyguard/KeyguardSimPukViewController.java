        ...
        new CheckSimPuk(str2, str2, this.mSubId) { // from class: com.android.keyguard.KeyguardSimPukViewController.2
            ...
            public final void onSimLockChangedResponse(PinResult pinResult) {
                ...
                if (pinResult.getAttemptsRemaining() >= 0) {
                    ...
                    KeyguardSimPukViewController keyguardSimPukViewController = KeyguardSimPukViewController.this;
                    keyguardSimPukViewController.mMessageAreaController.setMessage(((KeyguardSimPukView) ((ViewController) keyguardSimPukViewController).mView).getPukPasswordErrorMessage(pinResult.getAttemptsRemaining(), true, KeyguardEsimArea.isEsimLocked(this.mSubId, ((KeyguardSimPukView) ((ViewController) KeyguardSimPukViewController.this).mView).getContext())), false);
                }
            }
        }.start();
    }
