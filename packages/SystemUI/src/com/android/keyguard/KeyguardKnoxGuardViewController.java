...
public class KeyguardKnoxGuardViewController extends KeyguardSecAbsKeyInputViewController {
    ...
    class AnonymousClass3 extends KeyguardUpdateMonitorCallback {
        ...
        public final void onSimStateChanged(int i, int i2, int i3) {
            RecyclerView$$ExternalSyntheticOutline0.m(i3, "KeyguardKnoxGuardView", MutableObjectList$$ExternalSyntheticOutline0.m(i, i2, "onSimStateChanged subID : ", ", slotId : ", ", simState : "));
            if (i3 == 1 || i3 == 5) {
        ...
        if (remoteLockInfo != null) {
            ...
            if (i2 > 0 && remoteLockInfo2.lockTimeOut > 0 && i > 0 && i % i2 == 0) {
                ...
                if (keyguardKnoxGuardViewController.mRemoteLockInfo == null) {
                    ...
                    keyguardKnoxGuardViewController.setLong(ReorderTile$$ExternalSyntheticOutline0.m(keyguardKnoxGuardViewController.mRemoteLockInfo.lockType, "remotelockscreen.failedunlockcount", new StringBuilder()), i, selectedUserId2);
                }
    ...
    /* JADX WARN: Type inference failed for: r1v15, types: [com.android.keyguard.KeyguardKnoxGuardViewController$6] */
    /* JADX WARN: Type inference failed for: r1v17, types: [com.android.keyguard.KeyguardKnoxGuardViewController$7] */
    /* JADX WARN: Type inference failed for: r1v3, types: [com.android.keyguard.KeyguardKnoxGuardViewController$1] */
    /* JADX WARN: Type inference failed for: r1v4, types: [com.android.keyguard.KeyguardKnoxGuardViewController$2] */
    /* JADX WARN: Type inference failed for: r1v6, types: [com.android.keyguard.KeyguardKnoxGuardViewController$4] */
    /* JADX WARN: Type inference failed for: r1v7, types: [com.android.keyguard.KeyguardKnoxGuardViewController$5] */
    public KeyguardKnoxGuardViewController(KeyguardKnoxGuardView keyguardKnoxGuardView, ConfigurationController configurationController, VibrationUtil vibrationUtil, AccessibilityManager accessibilityManager, KeyguardUpdateMonitor keyguardUpdateMonitor, KeyguardSecurityModel.SecurityMode securityMode, LockPatternUtils lockPatternUtils, KeyguardSecurityCallback keyguardSecurityCallback, KeyguardMessageAreaController.Factory factory, LatencyTracker latencyTracker, FalsingCollector falsingCollector, EmergencyButtonController emergencyButtonController, FeatureFlags featureFlags, SelectedUserInteractor selectedUserInteractor, InputMethodManager inputMethodManager, TelephonyManager telephonyManager, WifiManager wifiManager, NetworkController networkController, ScreenLifecycle screenLifecycle, BouncerHapticPlayer bouncerHapticPlayer, UserActivityNotifier userActivityNotifier) {
        super(keyguardKnoxGuardView, configurationController, vibrationUtil, accessibilityManager, keyguardUpdateMonitor, securityMode, lockPatternUtils, keyguardSecurityCallback, factory, latencyTracker, falsingCollector, emergencyButtonController, featureFlags, selectedUserInteractor, bouncerHapticPlayer, userActivityNotifier);
    ...
    public final void setKnoxGuardInfo() {
        ...
        if (remoteLockInfo == null) {
            ...
            keyguardSecurityCallback.dismiss(true, this.mSelectedUserInteractor.getSelectedUserId(), this.mSecurityMode);
            return;
        }
