...
public final class ActiveUnlockConfig implements Dumpable {
    ...
    public final class ActiveUnlockRequestOrigin {
        ...
        private ActiveUnlockRequestOrigin(String str, int i) {
        }
    ...
    public final class BiometricType {
        ...
        static {
            BiometricType biometricType = new BiometricType(PeripheralBarcodeConstants.Symbology.Type.TYPE_NONE, 0, 0);
            NONE = biometricType;
        ...
        private BiometricType(String str, int i, int i2) {
            this.intValue = i2;
        }
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "   requestActiveUnlockOnUnlockIntent=", this.requestActiveUnlockOnUnlockIntent);
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "   requestActiveUnlockOnBioFail=", this.requestActiveUnlockOnBioFail);
        ...
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "   isFaceEnabledAndEnrolled=", keyguardUpdateMonitor.isFaceEnabledAndEnrolled());
        ...
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "   udfpsEnrolled=", keyguardUpdateMonitor.isUdfpsEnrolled());
    }
