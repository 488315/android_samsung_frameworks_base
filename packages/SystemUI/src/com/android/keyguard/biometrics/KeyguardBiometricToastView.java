...
public class KeyguardBiometricToastView extends FrameLayout {
    ...
    public static float mToastIconFrom = 1.0f;
    public final AnonymousClass1 mAnimHandler;
    public AnimatorSet mAnimatorSet;
    public String mAssetName;
    public BiometricUnlockController$$ExternalSyntheticLambda0 mBiometricToastViewStateUpdater;
    ...
    public final void dismiss(boolean z) {
        EmergencyButtonController$$ExternalSyntheticOutline0.m("dismiss() , force = ", "KeyguardBiometricToastView", z);
        ...
        if (z) {
            ...
            BiometricUnlockController$$ExternalSyntheticLambda0 biometricUnlockController$$ExternalSyntheticLambda0 = this.mBiometricToastViewStateUpdater;
            if (biometricUnlockController$$ExternalSyntheticLambda0 != null) {
                biometricUnlockController$$ExternalSyntheticLambda0.accept(Boolean.FALSE);
                return;
            }
            return;
        }
    ...
    public final boolean shouldDisappearLockIcon() {
        if (this.mIsBackgroundAuth) {
            return true;
        }
        return LsRune.SECURITY_BIOMETRICS_TABLET && DeviceState.getRotation(getResources().getConfiguration().windowConfiguration.getRotation()) == 2;
    }
        ...
        if (toastType != ToastType.Authenticating) {
            ...
            this.mAnimatorSet.addListener(new Animator.AnimatorListener() { // from class: com.android.keyguard.biometrics.KeyguardBiometricToastView.2
                ...
                public final void onAnimationStart(Animator animator) {
                    ...
                    BiometricUnlockController$$ExternalSyntheticLambda0 biometricUnlockController$$ExternalSyntheticLambda0 = keyguardBiometricToastView.mBiometricToastViewStateUpdater;
                    if (biometricUnlockController$$ExternalSyntheticLambda0 != null) {
                        biometricUnlockController$$ExternalSyntheticLambda0.accept(Boolean.TRUE);
                    }
