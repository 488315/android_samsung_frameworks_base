...
public class DualDarInnerLockScreenController {
    ...
    public final void updateLayoutMargins(KeyguardSecurityContainer keyguardSecurityContainer, View view) {
        int i;
        int i2;
        int i3;
        ...
        updateLayoutParams(i, i2, i3, keyguardSecurityContainer, view);
    }

    public final void updateLayoutParams(int i, int i2, int i3, KeyguardSecurityContainer keyguardSecurityContainer, View view) {
        if (view == null) {
        ...
        if (DeviceType.isTablet()) {
            ...
            Context context = keyguardSecurityContainer.getContext();
