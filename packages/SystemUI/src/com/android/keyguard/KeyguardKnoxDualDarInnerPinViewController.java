...
public class KeyguardKnoxDualDarInnerPinViewController extends KeyguardSecPinViewController {
    ...
    public final void onPasswordChecked(int i, int i2, boolean z, boolean z2) {
        boolean z3 = this.mSelectedUserInteractor.getSelectedUserId() == ((KnoxStateMonitorImpl) this.mKnoxStateMonitor).getMainUserId(i);
    ...
    public final void verifyPasswordAndUnlock() {
        ...
        final int innerAuthUserId = ((KnoxStateMonitorImpl) this.mKnoxStateMonitor).getInnerAuthUserId(this.mSelectedUserInteractor.getSelectedUserId());
