...
public class KeyguardPasswordView extends KeyguardSecAbsKeyInputView {
    ...
    public boolean mIsStartDisappearTimeout;
    ...
    public final void runFinishRunnableOrNot(Runnable runnable, String str) {
        if (this.mIsStartDisappearTimeout) {
            Log.d("KeyguardPasswordView", str.concat(" - Timeout"));
        } else {
            removeMessages(1);
            runnable.run();
        }
    ...
    public boolean startDisappearAnimation(Runnable runnable) {
        Log.d("KeyguardPasswordView", "startDisappearAnimation");
        this.mIsStartDisappearTimeout = false;
        AnonymousClass1 anonymousClass1 = this.mTimeoutHandler;
        anonymousClass1.sendMessageDelayed(anonymousClass1.obtainMessage(1, runnable), 500L);
        getWindowInsetsController().controlWindowInsetsAnimation(WindowInsets.Type.ime(), 100L, Interpolators.LINEAR, null, new AnonymousClass2(runnable));
        return true;
    }

    /* JADX WARN: Type inference failed for: r1v2, types: [com.android.keyguard.KeyguardPasswordView$1] */
    public KeyguardPasswordView(Context context, AttributeSet attributeSet) {
        ...
        this.mIsStartDisappearTimeout = false;
        this.mTimeoutHandler = new Handler(Looper.getMainLooper()) { // from class: com.android.keyguard.KeyguardPasswordView.1
            @Override // android.os.Handler
            public final void handleMessage(Message message) {
                if (message.what != 1) {
                    return;
                }
                Log.d("KeyguardPasswordView", "startDisappearAnimation timeout!!");
                KeyguardPasswordView.this.mIsStartDisappearTimeout = true;
    ...
    public class AnonymousClass2 implements WindowInsetsAnimationControlListener {
        ...
        public final void onCancelled(WindowInsetsAnimationController windowInsetsAnimationController) {
            ...
            KeyguardPasswordViewController$$ExternalSyntheticLambda0 keyguardPasswordViewController$$ExternalSyntheticLambda0 = keyguardPasswordView.mOnFinishImeAnimationRunnable;
            if (keyguardPasswordViewController$$ExternalSyntheticLambda0 != null) {
                keyguardPasswordViewController$$ExternalSyntheticLambda0.run();
                keyguardPasswordView.mOnFinishImeAnimationRunnable = null;
            }
            KeyguardPasswordView.this.runFinishRunnableOrNot(this.val$finishRunnable, "onCancelled");
        }
        ...
        public class AnonymousClass1 extends AnimatorListenerAdapter {
            ...
            public final void onAnimationEnd(Animator animator) {
                ...
                final Runnable runnable = AnonymousClass2.this.val$finishRunnable;
                DejankUtils.postAfterTraversal(new Runnable() { // from class: com.android.keyguard.KeyguardPasswordView$2$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ...
                        KeyguardPasswordView.this.runFinishRunnableOrNot(runnable2, "KeyguardPasswordView#onAnimationEnd");
