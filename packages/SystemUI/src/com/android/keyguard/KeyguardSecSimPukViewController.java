...
public class KeyguardSecSimPukViewController extends KeyguardSimPukViewController {
    ...
    class AnonymousClass2 extends KeyguardUpdateMonitorCallback {
        ...
        public final void onSimStateChanged(int i, int i2, int i3) throws Resources.NotFoundException {
            ...
            KeyguardSecurityModel.SecurityMode securityMode = keyguardSecSimPukViewController.mSecurityMode;
            SelectedUserInteractor selectedUserInteractor = keyguardSecSimPukViewController.mSelectedUserInteractor;
            if (i3 != 1) {
                if (i3 == 3) {
                ...
                public final void run() throws Resources.NotFoundException {
                    ...
                    if (pinResult2.getResult() == 0) {
                        ...
                        if (KeyguardSecSimPukViewController.this.getKeyguardSecurityCallback() != null) {
                            KeyguardSecSimPukViewController.this.getKeyguardSecurityCallback().dismiss(true, KeyguardSecSimPukViewController.this.mSelectedUserInteractor.getSelectedUserId(), KeyguardSecSimPukViewController.this.mSecurityMode);
                        }
                    } else {
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [com.android.keyguard.KeyguardSecSimPukViewController$1] */
    ...
    public final boolean checkPin() {
        ...
        this.mPinText = ((SecPasswordTextView) this.mPasswordEntry).mText;
        return true;
    }
    ...
    public final boolean checkPuk() {
        ...
        this.mPukText = ((SecPasswordTextView) this.mPasswordEntry).mText;
        return true;
    }
