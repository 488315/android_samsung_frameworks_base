...
public abstract class KeyguardSecAbsKeyInputViewController extends KeyguardAbsKeyInputViewController {
    ...
    public AnonymousClass4 mCountdownTimer;
        ...
        this.mUpdateMonitorCallbacks = new KeyguardUpdateMonitorCallback() { // from class: com.android.keyguard.KeyguardSecAbsKeyInputViewController.2
            ...
            public final void onLockModeChanged() throws Resources.NotFoundException {
                ...
                if (((KeyguardAbsKeyInputViewController) keyguardSecAbsKeyInputViewController).mKeyguardUpdateMonitor.getLockoutAttemptDeadline() == 0) {
                    keyguardSecAbsKeyInputViewController.mSecondsRemaining = -1;
                    AnonymousClass4 anonymousClass4 = keyguardSecAbsKeyInputViewController.mCountdownTimer;
            ...
            public final void onSimulationFailToUnlock(int i2) {
                ...
                if (i3 == 0) {
                    ...
                    if (remainingAttempt > 0) {
                        string = TransitionKt$$ExternalSyntheticOutline0.m(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(string, " ("), keyguardSecAbsKeyInputViewController.getResources().getQuantityString(R.plurals.kg_attempt_left, remainingAttempt, Integer.valueOf(remainingAttempt)), ")");
                    }
                    keyguardSecAbsKeyInputViewController.mMessageAreaController.setMessage(string, false);
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [android.os.CountDownTimer, com.android.keyguard.KeyguardSecAbsKeyInputViewController$4] */
    ...
    public void handleAttemptLockout(long j) {
        ...
        AnonymousClass4 anonymousClass4 = this.mCountdownTimer;
        if (anonymousClass4 != null) {
            anonymousClass4.cancel();
    ...
    public final boolean isBiometricLockoutLandscape() {
        if (LsRune.SECURITY_SUB_DISPLAY_LOCK && isLandscapeDisplay() && isPasswordView(getSecurityViewId())) {
            return ((KeyguardAbsKeyInputViewController) this).mKeyguardUpdateMonitor.isMaxFailedBiometricUnlockAttempts(this.mSelectedUserInteractor.getSelectedUserId());
        }
        return false;
    }
    ...
    public void onPasswordChecked(int i, int i2, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            if (i2 == 0) {
                ...
                if (remainingAttempt > 0) {
                    string = TransitionKt$$ExternalSyntheticOutline0.m(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(string, " ("), getResources().getQuantityString(R.plurals.kg_attempt_left, remainingAttempt, Integer.valueOf(remainingAttempt)), ")");
                }
                KeyguardSecMessageAreaController keyguardSecMessageAreaController = this.mMessageAreaController;
    ...
    public final void updatePortraitLayout(int i) throws Resources.NotFoundException {
                ...
                if (zIsPasswordView) {
                    ...
                    if (keyguardUpdateMonitor.isInDisplayFingerprintMarginAccepted() && this.mSecondsRemaining == -1 && DeviceState.isInDisplayFpSensorPositionHigh()) {
                        ...
                        if (zIsLandscapeDisplay) {
                            ...
                            layoutParams5.bottomMargin = resources.getDimensionPixelSize(i4);
                        } else {
        ...
        if (view != null) {
            ...
            if (zIsPasswordView) {
                ...
                i2 = i;
                i3 = i2 == R.id.keyguard_fmm_view ? R.dimen.kg_fmm_eca_margin_bottom : R.dimen.kg_pin_eca_margin_bottom;
            }
            layoutParams6.bottomMargin = resources.getDimensionPixelSize(i3);
        ...
        if (keyguardSecMessageAreaController != null && isPINSecurityView(i2) && isAllowedToAdjustSecurityView()) {
    ...
    public void verifyPasswordAndUnlock() {
        ...
        if (knoxStateMonitor != null) {
            KnoxStateMonitorImpl knoxStateMonitorImpl = (KnoxStateMonitorImpl) knoxStateMonitor;
            if (knoxStateMonitorImpl.isDualDarDeviceOwner(selectedUserInteractor.getSelectedUserId()) && !knoxStateMonitorImpl.isDualDarInnerLayerUnlocked(selectedUserInteractor.getSelectedUserId())) {
        ...
        this.mPendingLockCheck = LockPatternChecker.checkCredential(this.mLockPatternUtils, zIsForgotPasswordView ? this.mPrevCredential : enteredCredential2, selectedUserId2, new LockPatternChecker.OnCheckCallback() { // from class: com.android.keyguard.KeyguardAbsKeyInputViewController.3
            ...
            public final void onChecked(boolean z, int i) {
                Log.w("KeyguardAbsKeyInputViewController", "checkCredential : onChecked");
                KeyguardAbsKeyInputViewController.this.mLatencyTracker.onActionEnd(4);
