...
public class KeyguardBouncerContainer extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [android.view.View$OnAttachStateChangeListener, com.android.keyguard.KeyguardBouncerContainer$1] */
    public KeyguardBouncerContainer(Context context, SysUIKeyEventHandler sysUIKeyEventHandler, KeyguardSysDumpTrigger keyguardSysDumpTrigger) {
        super(context);
        ?? r2 = new View.OnAttachStateChangeListener() { // from class: com.android.keyguard.KeyguardBouncerContainer.1
    ...
    public static String getBackCallbackInstanceName(OnBackInvokedCallback onBackInvokedCallback) {
        ...
        if (onBackInvokedCallback != null) {
            str = onBackInvokedCallback instanceof OnBackAnimationCallback ? "OnBackAnimationCallback" : "null";
            ...
            if (onBackInvokedCallback instanceof CompatOnBackInvokedCallback) {
                return "CompatOnBackInvokedCallback";
            }
        }
        return str;
    }
