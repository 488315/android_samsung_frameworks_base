...
public class KeyguardSecPinViewController extends KeyguardPinViewController {
    ...
    public void displayDefaultSecurityMessage() {
        ...
        if ((passwordTextView == null || ((SecPasswordTextView) passwordTextView).mText.length() <= 0) && !((KeyguardPinViewController) this).mKeyguardUpdateMonitor.isFingerprintLockedOut()) {
            ...
            if (((KeyguardPinViewController) this).mKeyguardUpdateMonitor.isShowEditModeRequest()) {
                ...
                EmergencyButtonController$$ExternalSyntheticOutline0.m(new StringBuilder("displayDefaultSecurityMessage - strongAuth ( "), this.mPromptReason, " )", "KeyguardSecPinViewController");
    ...
    public void setOkButtonEnabled(boolean z) {
        if (this.mOkButton != null) {
            ...
            if (getDigitsPIN(this.mSelectedUserInteractor.getSelectedUserId()) <= 0 || !z2) {
    ...
    public final void startAppearAnimation() {
        if (((KeyguardPinViewController) this).mKeyguardUpdateMonitor.isAnimationDisabled()) {
    ...
    public void verifyNDigitsPIN() {
        int digitsPIN = getDigitsPIN(this.mSelectedUserInteractor.getSelectedUserId());
        boolean z = this.mSecurityMode == KeyguardSecurityModel.SecurityMode.PIN;
        if (digitsPIN <= 0 || !z) {
            return;
        }
        PasswordTextView passwordTextView = this.mPasswordEntry;
        if ((passwordTextView instanceof SecPasswordTextView) && passwordTextView.isEnabled() && ((SecPasswordTextView) this.mPasswordEntry).mText.length() == digitsPIN) {
            ...
            ((SecPasswordTextView) passwordTextView2).mMaxLength = digitsPIN;
            passwordTextView2.setEnabled(false);
