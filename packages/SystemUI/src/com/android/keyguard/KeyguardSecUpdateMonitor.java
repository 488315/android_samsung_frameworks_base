...
public interface KeyguardSecUpdateMonitor {
    ...
    default boolean isLockScreenRotationAllowed$1() {
        return true;
    }
    ...
    default boolean isUserUnlocked$1() {
        return false;
    }
    ...
    default boolean updateSecureLockTimeout(int i) {
        return false;
    }
    ...
    default void updateBatteryRemainTime(Intent intent) {
    }
    ...
    default void updateTspFpGuideShown(boolean z) {
    }
