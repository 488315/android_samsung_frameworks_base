...
public final class SecBrightBarViewModel extends ViewModel {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        public final Object invoke(Object obj, Object obj2) {
            return ((AnonymousClass1) create(GammaBrightness.m1066boximpl(((GammaBrightness) obj).value), (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                int iConvertLinearToGammaFloat = BrightnessUtils.convertLinearToGammaFloat(f, 0.0f, 1.0f);
                ScreenBrightnessInteractor screenBrightnessInteractor = SecBrightBarViewModel.this.screenBrightnessInteractor;
                this.label = 1;
                if (screenBrightnessInteractor.m1064setTemporaryBrightnesssaDbZGg(iConvertLinearToGammaFloat, this) == coroutineSingletons) {
    ...
    public SecBrightBarViewModel(ScreenBrightnessInteractor screenBrightnessInteractor) {
        ...
        FlowKt.launchIn(new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(readonlyStateFlowAsStateFlow, new AnonymousClass2(null)), ViewModelKt.getViewModelScope(this));
    }
}
