...
public final class SecBrightnessDetailScene extends ExclusiveActivatable implements Scene {
    public final QuickSettingSceneViewModel viewModel;

    public SecBrightnessDetailScene(QuickSettingSceneViewModel quickSettingSceneViewModel) {
