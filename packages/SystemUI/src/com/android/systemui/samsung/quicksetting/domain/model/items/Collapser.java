...
public final class Collapser extends IdAssignedGridTileItem {
    ...
    public Collapser(long j, String str, String str2, int i, String str3, Function0 function0, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        long j2;
        if ((i2 & 1) != 0) {
            long j3 = 1;
        ...
        this(j2, (i2 & 2) != 0 ? "Collapser" : str, (i2 & 4) != 0 ? "" : str2, (i2 & 8) != 0 ? 0 : i, (i2 & 16) == 0 ? str3 : "", (i2 & 32) != 0 ? new Collapser$$ExternalSyntheticLambda0() : function0, null);
    }
}
