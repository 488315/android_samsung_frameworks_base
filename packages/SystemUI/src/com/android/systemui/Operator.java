...
public class Operator {
    ...
    public static final boolean QUICK_IS_DSH_BRANDING;
    ...
    static {
        ...
        QUICK_IS_DSH_BRANDING = "DSH".equals(string);
    ...
    public static boolean shouldSupportMobileDataOffDontShowPopup() {
        return QUICK_IS_VZW_BRANDING || QUICK_IS_ATT_BRANDING || QUICK_IS_AIO_BRANDING || QUICK_IS_APP_BRANDING || QUICK_IS_TMB_BRANDING || QUICK_IS_MTR_BRANDING || QUICK_IS_SPR_BRANDING || QUICK_IS_VMU_BRANDING || QUICK_IS_BST_BRANDING || QUICK_IS_XAS_BRANDING || QUICK_IS_USC_BRANDING || QUICK_IS_LRA_BRANDING || QUICK_IS_TFN_BRANDING || QUICK_IS_CCT_BRANDING || QUICK_IS_CHA_BRANDING || QUICK_IS_ACG_BRANDING || QUICK_IS_CSP_BRANDING || QUICK_IS_XAR_BRANDING || QUICK_IS_XAA_BRANDING || QUICK_IS_DSH_BRANDING;
    }
}
