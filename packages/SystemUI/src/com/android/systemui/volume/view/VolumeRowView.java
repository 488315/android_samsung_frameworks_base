...
public final class VolumeRowView extends FrameLayout implements VolumeObserver<VolumePanelState> {
    ...
    public final void initialize(VolumePanelStore volumePanelStore, HandlerWrapper handlerWrapper, VolumePanelRow volumePanelRow, VolumePanelState volumePanelState, VolumePanelMotion volumePanelMotion) {
        ...
        if (volumePanelState.isExpanded() || this.isDualViewEnabled) {
            ...
            updateProgressDrawable(volumePanelState);
            int i3 = ((SettingsHelper) Dependency.sDependency.getDependencyInner(SettingsHelper.class)).isReduceTransparencyEnabled() ? com.android.systemui.R.drawable.volume_seekbar_bg_reduce_transparency : (BasicRune.VOLUME_PARTIAL_BLUR || BasicRune.VOLUME_CAPTURED_BLUR) ? com.android.systemui.R.drawable.volume_seekbar_bg_blur : com.android.systemui.R.drawable.volume_seekbar_bg;
    ...
    public final boolean isIconClicked(float f, float f2) {
        ...
        viewUtil.getClass();
        return ViewUtil.isTouched(vPVolumeIcon3, f, f2);
    }
    ...
    public final void updateContentDescription(VolumePanelState volumePanelState, VolumePanelRow volumePanelRow) {
        ...
        if (this.stream == 2) {
            if (volumePanelRow.getIconType() == 0) {
                string = getContext().getString(com.android.systemui.R.string.volume_icon_content_description_ringtone_to_sound);
                string.getClass();
            } else if (volumePanelState.isHasVibrator()) {
                string = getContext().getString(com.android.systemui.R.string.volume_icon_content_description_ringtone_to_vib);
                string.getClass();
            } else {
                string = getContext().getString(com.android.systemui.R.string.volume_icon_content_description_ringtone_to_mute);
                string.getClass();
            }
    ...
    public final void updateProgress(VolumePanelState volumePanelState) {
        ...
        if (findRow != null) {
            ...
            if (!findRow.isVisible()) {
                ...
                this.progressBarSpring.setStartValue((this.seekBar != null ? r0 : null).getProgress());
