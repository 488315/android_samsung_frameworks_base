...
public final class VolumePanelExpandView extends FrameLayout implements VolumeObserver<VolumePanelState> {
    ...
    public VolumePanelExpandWindow dialog;
    ...
    public final void addRows(VolumePanelState volumePanelState) {
        ...
        while (i < size) {
            ...
            volumeRowView.initialize(volumePanelStore2, handlerWrapper2, volumePanelRow, volumePanelState2, volumePanelMotion == null ? null : volumePanelMotion);
