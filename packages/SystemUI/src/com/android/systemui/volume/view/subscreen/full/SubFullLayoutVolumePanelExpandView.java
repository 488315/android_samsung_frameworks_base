...
public final class SubFullLayoutVolumePanelExpandView extends FrameLayout implements VolumeObserver<VolumePanelState> {
    ...
    public SubFullLayoutVolumePanelExpandWindow dialog;
    ...
    public final void addRows$1(VolumePanelState volumePanelState) {
        ...
        while (i < size) {
            ...
            subFullLayoutVolumeRowView.initialize(volumePanelStore2, handlerWrapper2, volumePanelRow, volumePanelState2, subFullLayoutVolumePanelMotion == null ? null : subFullLayoutVolumePanelMotion);
    ...
    public final void onChanged(VolumePanelState volumePanelState) {
        ...
        if (activeStream != this.activeStream) {
            ...
            if (!this.rowsLabel.containsKey(Integer.valueOf(activeStream))) {
                ViewGroup viewGroup = this.rowContainer;
                if (viewGroup == null) {
                    viewGroup = null;
                }
