        ...
        switch (WhenMappings.$EnumSwitchMapping$0[volumePanelState.getStateType().ordinal()]) {
            ...
            case 8:
                if (isShowing() && !volumePanelState.isAnimating()) {
                    ...
                    if (volumePanelExpandWindow == null) {
                        volumePanelExpandWindow = null;
                    }
                    Window window = volumePanelExpandWindow.getWindow();
                    window.getClass();
                    ...
                    final Runnable runnable2 = new Runnable() { // from class: com.android.systemui.volume.view.expand.VolumePanelExpandView$startDismissAnimation$2
                        ...
                        public final void run() {
                            ...
                            volumePanelExpandWindow2.dismiss();
                        }
                    };
                    AnimatorSet animatorSet = volumePanelMotion.expandShowAnimation;
                    if (animatorSet != null) {
                        animatorSet.cancel();
                    }
