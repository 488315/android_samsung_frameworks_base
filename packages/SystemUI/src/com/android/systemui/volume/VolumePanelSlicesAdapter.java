...
public class VolumePanelSlicesAdapter extends RecyclerView.Adapter {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new SliceRowViewHolder(KeyguardSecurityContainer$UserSwitcherViewMode$2$$ExternalSyntheticOutline0.m(viewGroup, R.layout.volume_panel_slice_slider_row, viewGroup, false));
    }
