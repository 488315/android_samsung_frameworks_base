...
public final class AncViewModel {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        if (obj instanceof AncSlices.Ready) {
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Slice slice = ((AncSlices.Ready) obj).popupSlice;
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(slice, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Slice slice = ((AncSlices.Ready) obj).buttonSlice;
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(slice, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
    ...
    public static boolean isClickable(Slice slice) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            } else if (Intrinsics.areEqual(str, "slice") && (slice2 = sliceItem.getSlice()) != null && (listAsList = Arrays.asList(slice2.mItems)) != null) {
                arrayDeque.addAll(listAsList);
            }
        }
        return true;
    }
