...
public final class MediaOutputComponentInteractor {
    ...
    public MediaOutputComponentInteractor(CoroutineScope coroutineScope, MediaDeviceSessionInteractor mediaDeviceSessionInteractor, AudioOutputInteractor audioOutputInteractor, AudioModeInteractor audioModeInteractor, MediaOutputInteractor mediaOutputInteractor) {
        ...
        this.currentAudioDevice = new Flow() { // from class: com.android.systemui.volume.panel.component.mediaoutput.domain.interactor.MediaOutputComponentInteractor$special$$inlined$filter$1
                ...
                */
                public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
                    ...
                    L2f:
                        ...
                        boolean r6 = r6 instanceof com.android.systemui.volume.domain.model.AudioOutputDevice.Unknown
                        r6 = r6 ^ r3
                        if (r6 == 0) goto L45
                        r0.label = r3
        ...
        this.mediaOutputModel = FlowKt.stateIn(new ResultKt$wrapInResult$$inlined$map$1(FlowKt.transformLatest(audioModeInteractor.isOngoingCall, new MediaOutputComponentInteractor$special$$inlined$flatMapLatest$2(null, audioOutputInteractor, this))), coroutineScope, startedEagerly, new Result.Loading());
    }
}
