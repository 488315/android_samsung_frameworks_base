        ...
        if (i == 0) {
            ...
            for (final MediaController mediaController : list2) {
                ...
                if (mediaController == null) {
                    ...
                    final Flow flowOn = FlowKt.flowOn(FlowConflatedKt.conflatedCallbackFlow(new MediaControllerInteractorImpl$stateChanges$1(mediaController, mediaControllerInteractorImpl, null)), mediaControllerInteractorImpl.backgroundCoroutineContext);
