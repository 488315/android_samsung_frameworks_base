    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (mediaDeviceSession == null) {
                ...
                final MediaDeviceSessionInteractor$playbackState$$inlined$map$1 mediaDeviceSessionInteractor$playbackState$$inlined$map$1PlaybackState = this.$mediaDeviceSessionInteractor$inlined.playbackState(mediaDeviceSession);
                flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = new Flow() { // from class: com.android.systemui.volume.panel.component.volume.ui.viewmodel.AudioVolumeComponentViewModel$isActive$lambda$1$$inlined$map$1
                    ...
                    public final Object collect(FlowCollector flowCollector2, Continuation continuation) {
                        Object objCollect = mediaDeviceSessionInteractor$playbackState$$inlined$map$1PlaybackState.collect(new AnonymousClass2(flowCollector2), continuation);
