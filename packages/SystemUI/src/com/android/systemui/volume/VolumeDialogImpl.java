...
import com.android.systemui.haptics.slider.SliderState;
...
public final class VolumeDialogImpl implements VolumeDialog, Dumpable, ConfigurationController.ConfigurationListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public final AnonymousClass7 mControllerCallbackH = new VolumeDialogController.Callbacks() { // from class: com.android.systemui.volume.VolumeDialogImpl.7
        ...
        public final void onShowRequested(int i, boolean z, int i2) {
            VolumeDialogImpl.m2366$$Nest$mshowH(VolumeDialogImpl.this, i, z, i2);
        }
    ...
    public final class H extends Handler {
        ...
        public final void handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    VolumeDialogImpl volumeDialogImpl = VolumeDialogImpl.this;
                    VolumeDialogImpl.m2366$$Nest$mshowH(volumeDialogImpl, message.arg1, volumeDialogImpl.mKeyguard.isKeyguardLocked(), VolumeDialogImpl.this.mActivityManager.getLockTaskModeState());
                    return;
                case 2:
    ...
    public final class VolumeRow {
        ...
        public final boolean deliverOnProgressChangedHaptics(int i, boolean z) {
            ...
            if (seekbarHapticPlugin.isTracking()) {
                ...
                SliderStateProducer sliderStateProducer = seekbarHapticPlugin.sliderEventProducer;
                if (sliderState != sliderState2 || z) {
                    float normalizeProgress = SeekbarHapticPlugin.normalizeProgress(seekBar, i);
                    sliderStateProducer.getClass();
                    sliderStateProducer._currentEvent.updateState(null, new SliderEvent(z ? SliderEventType.PROGRESS_CHANGE_BY_USER : SliderEventType.PROGRESS_CHANGE_BY_PROGRAM, normalizeProgress));
                } else {
                    sliderStateProducer._currentEvent.updateState(null, new SliderEvent(SliderEventType.NOTHING, SeekbarHapticPlugin.normalizeProgress(seekBar, i)));
    ...
    public static void m2366$$Nest$mshowH(VolumeDialogImpl volumeDialogImpl, int i, boolean z, int i2) {
            ...
            if (volumeRow.slider.getVisibility() == 0) {
                volumeRow.slider.setOnTouchListener(new View.OnTouchListener() { // from class: com.android.systemui.volume.VolumeDialogImpl.VolumeRow.1
                    ...
                    public final boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        seekbarHapticPlugin.getClass();
                        Integer valueOf = motionEvent != null ? Integer.valueOf(motionEvent.getActionMasked()) : null;
                        if ((valueOf != null && valueOf.intValue() == 1) || (valueOf != null && valueOf.intValue() == 3)) {
                            seekbarHapticPlugin.velocityTracker.clear();
                            return false;
                        }
                        if ((valueOf == null || valueOf.intValue() != 0) && (valueOf == null || valueOf.intValue() != 2)) {
                            return false;
                        }
                        seekbarHapticPlugin.velocityTracker.addMovement(motionEvent);
                        return false;
                    }
                });
            }
    ...
    public void addSliderHapticsToRows() {
        ...
        while (it.hasNext()) {
            addSliderHapticsToRow((VolumeRow) it.next());
        }
    }
    ...
    public final void checkODICaptionsTooltip(boolean z) {
        ...
        if (z2 && z && this.mODICaptionsTooltipView != null && (view = this.mODICaptionsTooltipView) != null && view.getVisibility() == 0) {
    ...
    public final void dismissH(int i) {
        ...
        ViewPropertyAnimator withEndAction = this.mDialogView.animate().alpha(0.0f).setDuration(this.mDialogHideAnimationDurationMs).setInterpolator(new SystemUIInterpolators$LogAccelerateInterpolator()).withEndAction(new VolumeDialogImpl$$ExternalSyntheticLambda2(this, 7));
        ...
        withEndAction.setListener(this.mShouldListenForJank ? new AnonymousClass3(this.mDialogView, PopupUIUtil.EXTRA_SIM_CARD_TRAY_WATER_PROTECTION_POPUP_DISMISS, this.mDialogHideAnimationDurationMs) : null).start();
    ...
    public final void initDialog(int i) {
        ...
        if (viewGroup3 != null) {
            ...
            this.mRingerDrawerIconColorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.volume.VolumeDialogImpl$$ExternalSyntheticLambda14
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    int intValue = ((Integer) ArgbEvaluator.getInstance().evaluate(floatValue, Integer.valueOf(i2), Integer.valueOf(i3))).intValue();
                    int intValue2 = ((Integer) ArgbEvaluator.getInstance().evaluate(floatValue, Integer.valueOf(i3), Integer.valueOf(i2))).intValue();
        ...
        if (((ArrayList) this.mRows).isEmpty()) {
            ...
            if (!AudioSystem.isSingleVolume(this.mContext)) {
                ...
                addRow(0, android.R.drawable.ic_signal_cellular_2_5_bar, false, false, android.R.drawable.ic_signal_cellular_2_5_bar);
    ...
    public final void onStateChangedH(VolumeDialogController.State state) {
        ...
        for (int i3 = 0; i3 < state.states.size(); i3++) {
            ...
            if (state.states.valueAt(i3).dynamic) {
                ...
                if (volumeRow == null) {
                    addRow(keyAt, R.drawable.ic_volume_remote, true, false, R.drawable.ic_volume_remote_mute);
                }
            }
        }
    ...
    public final void rescheduleTimeoutH() {
        ...
        String str = TAG;
        StringBuilder m = MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(recommendedTimeoutMillis, "rescheduleTimeout ", " ");
    ...
    public final void setRingerMode(int i) {
        ...
        if (i == 0) {
            str = this.mContext.getString(17043447);
        } else if (i != 2) {
            str = this.mContext.getString(17043448);
        } else {
    ...
    public void showCsdWarningH(int i, int i2) {
        synchronized (this.mSafetyWarningLock) {
            try {
                ...
                CsdWarningDialog create = this.mCsdWarningDialogFactory.create(i, new VolumeDialogImpl$$ExternalSyntheticLambda2(this, 5));
                ...
                if (i2 > 0) {
                    ...
                    String str = TAG;
                    StringBuilder m = MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(i2, "scheduleCsdTimeoutH ", "ms ");
                    m.append(Debug.getCaller());
                    Log.i(str, m.toString());
                    this.mController.userActivity();
                }
    ...
    public final void updateRowsH(VolumeRow volumeRow) {
        ...
        while (true) {
            ...
            if (shouldBeVisibleH && this.mRingerAndDrawerContainerBackground != null) {
                i = !isRtl$1() ? Math.max(i, this.mDialogRowsView.indexOfChild(volumeRow2.view)) : Math.min(i, this.mDialogRowsView.indexOfChild(volumeRow2.view));
    ...
    public final void updateVolumeRowTintH(VolumeRow volumeRow, boolean z) {
        ...
        if (z2 || this.mChangeVolumeRowTintWhenInactive) {
            ...
            ColorStateList colorAttr3 = Utils.getColorAttr(17957259, this.mContext);
