...
public final class MultitaskingShortcutsSource implements KeyboardShortcutGroupsSource {
    ...
    public final Object shortcutGroups(int i, Continuation continuation) throws Resources.NotFoundException {
        ...
        listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder.label, keyboardShortcutInfoBuilder.keyCode, keyboardShortcutInfoBuilder.modifiers));
        ...
        listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder2.label, keyboardShortcutInfoBuilder2.keyCode, keyboardShortcutInfoBuilder2.modifiers));
        ...
        listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder3.label, keyboardShortcutInfoBuilder3.keyCode, keyboardShortcutInfoBuilder3.modifiers));
        if (DesktopModeStatus.canEnterDesktopMode(this.context)) {
            ...
            listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder4.label, keyboardShortcutInfoBuilder4.keyCode, keyboardShortcutInfoBuilder4.modifiers));
        }
        ...
        listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder5.label, keyboardShortcutInfoBuilder5.keyCode, keyboardShortcutInfoBuilder5.modifiers));
        if (DesktopModeStatus.canEnterDesktopMode(this.context) && DesktopModeFlags.ENABLE_TASK_RESIZING_KEYBOARD_SHORTCUTS.isTrue()) {
            ...
            listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder6.label, keyboardShortcutInfoBuilder6.keyCode, keyboardShortcutInfoBuilder6.modifiers));
            ...
            listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder7.label, keyboardShortcutInfoBuilder7.keyCode, keyboardShortcutInfoBuilder7.modifiers));
            ...
            listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder8.label, keyboardShortcutInfoBuilder8.keyCode, keyboardShortcutInfoBuilder8.modifiers));
            ...
            listBuilderCreateListBuilder.add(new KeyboardShortcutInfo(keyboardShortcutInfoBuilder9.label, keyboardShortcutInfoBuilder9.keyCode, keyboardShortcutInfoBuilder9.modifiers));
        }
        return Collections.singletonList(new KeyboardShortcutGroup(string, listBuilderCreateListBuilder.build()));
    }
}
