...
final class ShortcutHelperActivityStarter$start$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow flow = shortcutHelperActivityStarter.viewModel.shouldShow;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyboard.shortcut.ui.ShortcutHelperActivityStarter$start$1.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    if (((Boolean) obj2).booleanValue()) {
                        ...
                        shortcutHelperActivityStarter2.startActivity.invoke(new Intent(shortcutHelperActivityStarter2.context, (Class<?>) ShortcutHelperActivity.class).setFlags(QuickStepContract.SYSUI_STATE_NAV_BAR_VIS_GONE));
                    }
