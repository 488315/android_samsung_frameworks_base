...
final class CustomInputGesturesRepository$deleteCustomInputGesture$2 extends SuspendLambda implements Function2 {
    final /* synthetic */ InputGestureData $inputGesture;
    int label;
    final /* synthetic */ CustomInputGesturesRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomInputGesturesRepository$deleteCustomInputGesture$2(CustomInputGesturesRepository customInputGesturesRepository, InputGestureData inputGestureData, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new CustomInputGesturesRepository$deleteCustomInputGesture$2(this.this$0, this.$inputGesture, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((CustomInputGesturesRepository$deleteCustomInputGesture$2) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int iRemoveCustomInputGesture = customInputGesturesRepository.getInputManager().removeCustomInputGesture(this.$inputGesture);
        if (iRemoveCustomInputGesture != 1) {
            Log.w("CustomInputGesturesRepository", "Attempted to delete inputGesture: " + this.$inputGesture + " but ran into an error with code: " + iRemoveCustomInputGesture);
