...
public final class KeyboardRepositoryImpl implements KeyboardRepository {
    ...
    public KeyboardRepositoryImpl(CoroutineDispatcher coroutineDispatcher, InputManager inputManager, InputDeviceRepository inputDeviceRepository) {
        ...
        final Flow flow = new Flow() { // from class: com.android.systemui.keyboard.data.repository.KeyboardRepositoryImpl$special$$inlined$map$1
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(collection, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = readonlySharedFlow2.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        };
        final Flow flowDistinctUntilChanged = FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.keyboard.data.repository.KeyboardRepositoryImpl$special$$inlined$map$2
                ...
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        for (Object obj3 : (Collection) obj) {
                            if (KeyboardRepositoryImpl.access$isPhysicalFullKeyboard(this.this$0, ((Number) obj3).intValue())) {
                                arrayList.add(obj3);
                            }
                        }
                        anonymousClass1.label = 1;
        ...
        this.isAnyKeyboardConnected = FlowKt.flowOn(FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.keyboard.data.repository.KeyboardRepositoryImpl$special$$inlined$map$4
                    ...
                    if (i2 == 0) {
                        ...
                        if (!(collection instanceof Collection) || !collection.isEmpty()) {
                            ...
                            while (true) {
                                ...
                                if (KeyboardRepositoryImpl.access$isPhysicalFullKeyboard(this.this$0, ((Number) it.next()).intValue())) {
                                    z = true;
                                    break;
                                }
                            }
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = readonlySharedFlow2.collect(new AnonymousClass2(flowCollector, this), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        }), coroutineDispatcher);
        final Flow flowConflatedCallbackFlow = FlowConflatedKt.conflatedCallbackFlow(new KeyboardRepositoryImpl$backlightStateListener$1(this, null));
