...
final class WallpaperRepositoryImpl$getWallpaper$2 extends SuspendLambda implements Function2 {
    ...
    public WallpaperRepositoryImpl$getWallpaper$2(int i, WallpaperRepositoryImpl wallpaperRepositoryImpl, SelectedUserModel selectedUserModel, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new WallpaperRepositoryImpl$getWallpaper$2(this.$which, this.this$0, this.$selectedUser, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.$which == 2 && this.this$0.wallpaperManager.lockScreenWallpaperExists()) {
            return this.this$0.wallpaperManager.getWallpaperInfo(2, this.$selectedUser.userInfo.id);
        }
