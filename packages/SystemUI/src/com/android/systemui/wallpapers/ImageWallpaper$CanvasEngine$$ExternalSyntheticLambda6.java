...
public final /* synthetic */ class ImageWallpaper$CanvasEngine$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ ImageWallpaper$CanvasEngine$$ExternalSyntheticLambda6(ImageWallpaper.BaseEngine baseEngine, Object obj, int i) {
        this.$r8$classId = i;
        this.f$0 = baseEngine;
        this.f$1 = obj;
    }
    ...
    public /* synthetic */ ImageWallpaper$CanvasEngine$$ExternalSyntheticLambda6(ImageWallpaper.CanvasEngine.AnonymousClass7 anonymousClass7, Boolean bool) {
        this.$r8$classId = 1;
