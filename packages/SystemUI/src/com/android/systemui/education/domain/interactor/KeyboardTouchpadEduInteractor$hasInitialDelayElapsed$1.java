...
final class KeyboardTouchpadEduInteractor$hasInitialDelayElapsed$1 extends ContinuationImpl {
    Object L$0;
    Object L$1;
    int label;
    ...
    public KeyboardTouchpadEduInteractor$hasInitialDelayElapsed$1(KeyboardTouchpadEduInteractor keyboardTouchpadEduInteractor, Continuation continuation) {
        super(continuation);
