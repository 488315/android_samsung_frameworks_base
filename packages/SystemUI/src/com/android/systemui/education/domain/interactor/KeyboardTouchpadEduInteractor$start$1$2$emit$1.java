...
final class KeyboardTouchpadEduInteractor$start$1$2$emit$1 extends ContinuationImpl {
    ...
    final /* synthetic */ KeyboardTouchpadEduInteractor$start$1.AnonymousClass2 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KeyboardTouchpadEduInteractor$start$1$2$emit$1(KeyboardTouchpadEduInteractor$start$1.AnonymousClass2 anonymousClass2, Continuation continuation) {
        super(continuation);
