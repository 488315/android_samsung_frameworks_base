...
public class SubscreenBrightnessDetailActivity extends Activity implements WakefulnessLifecycle.Observer {
    ...
    public final AnonymousClass6 mDisplayListener = new DisplayLifecycle.Observer() { // from class: com.android.systemui.qp.SubscreenBrightnessDetailActivity.6
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.mContext = this;
        getWindow().setBackgroundDrawable(new ColorDrawable(getResources().getColor(com.android.systemui.R.color.subscreen_panel_flashlight_background)));
        ...
        new BrightnessAnimationIcon((LottieAnimationView) findViewById(com.android.systemui.R.id.subscreen_brightness_icon)).init(this.mContext);
        ...
        boolean z = subscreenBrightnessDetailActivity2.getResources().getBoolean(R.bool.config_defaultEmergencyGestureEnabled);
        if (QpRune.QUICK_SUBSCREEN_SETTINGS && z) {
            ...
            this.mAutoBrightnessContainer.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.qp.SubscreenBrightnessDetailActivity.3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.mAutoBrightnessContainer.setOnTouchListener(new View.OnTouchListener(this) { // from class: com.android.systemui.qp.SubscreenBrightnessDetailActivity.4
        ...
        this.mSubBrightnessDetail.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.android.systemui.qp.SubscreenBrightnessDetailActivity.2
            ...
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                LinearLayout linearLayout2 = SubscreenBrightnessDetailActivity.this.mSubBrightnessDetail;
                linearLayout2.setPadding(linearLayout2.getPaddingLeft(), safeInsetTop, SubscreenBrightnessDetailActivity.this.mSubBrightnessDetail.getPaddingRight(), SubscreenBrightnessDetailActivity.this.mSubBrightnessDetail.getPaddingBottom());
                return windowInsets;
            }
        });
