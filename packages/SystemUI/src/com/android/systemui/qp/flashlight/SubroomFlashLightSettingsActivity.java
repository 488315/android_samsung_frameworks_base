...
public class SubroomFlashLightSettingsActivity extends Activity {
    ...
    public final boolean isValidKey(int i, KeyEvent keyEvent) {
        ...
        return (i == 25 || i == 24) && keyEvent.getEventTime() - this.mLastEvent > 70;
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.mSubRoomPresentationView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.android.systemui.qp.flashlight.SubroomFlashLightSettingsActivity.2
            @Override // android.view.View.OnApplyWindowInsetsListener
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                DisplayCutout displayCutout = windowInsets.getDisplayCutout();
                int safeInsetTop = displayCutout != null ? displayCutout.getSafeInsetTop() : 0;
                FrameLayout frameLayout = SubroomFlashLightSettingsActivity.this.mSubRoomPresentationView;
                frameLayout.setPadding(frameLayout.getPaddingLeft(), safeInsetTop, SubroomFlashLightSettingsActivity.this.mSubRoomPresentationView.getPaddingRight(), SubroomFlashLightSettingsActivity.this.mSubRoomPresentationView.getPaddingBottom());
                return windowInsets;
            }
        });
    }
    ...
    public final void onDestroy() {
        ...
        runOnUiThread(new Runnable() { // from class: com.android.systemui.qp.flashlight.SubroomFlashLightSettingsActivity.3
    ...
    public final void onStart() {
        ...
        if (((FlashlightControllerImpl) this.mFlashlightController).isEnabled()) {
            ...
            final int i = 0;
            this.mBackButton.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.systemui.qp.flashlight.SubroomFlashLightSettingsActivity$$ExternalSyntheticLambda1
    ...
    public final void onStop() {
        super.onStop();
        this.mActivityState = 2;
        Log.d("SubroomFlashLightSettingsActivity", "onStop: " + this.mActivityState);
