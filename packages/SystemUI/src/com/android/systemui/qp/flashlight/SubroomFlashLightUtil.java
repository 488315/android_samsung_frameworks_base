    ...
    public SubroomFlashLightUtil(Activity activity) throws Resources.NotFoundException {
        ...
        if (z) {
            ...
            if (QpRune.QUICK_SUBSCREEN_FULLSCREEN_PANEL) {
                ((ImageView) this.mFlashLightHelpView.findViewById(R.id.flashlight_help_subpanel)).setImageDrawable(activity.getResources().getDrawable(R.drawable.flashlight_help_subpanel_b7));
            }
            ...
            this.mFlashLightHelpView.setBackgroundColor(z ? resources.getColor(R.color.subscreen_panel_flashlight_background) : resources.getColor(R.color.subscreen_settings_flashlight_background));
            ...
            this.mFlashLightTurnOff.setBackgroundColor(z ? resources.getColor(R.color.subscreen_panel_flashlight_background) : resources.getColor(R.color.subscreen_settings_flashlight_background));
            ...
            this.mFlashLightTurnOn.setBackgroundColor(z ? resources.getColor(R.color.subscreen_panel_flashlight_background) : resources.getColor(R.color.subscreen_settings_flashlight_background));
        }
    }
