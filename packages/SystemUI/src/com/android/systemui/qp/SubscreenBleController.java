...
public class SubscreenBleController implements SubscreenQSControllerContract$Presenter {
    ...
    public SubroomBluetoothSettingsView mBleView;
    ...
    public final AnonymousClass1 mCallback = new BluetoothController.Callback() { // from class: com.android.systemui.qp.SubscreenBleController.1
        ...
        public final void onBluetoothStateChange(boolean z) {
            ...
            SubroomBluetoothSettingsView subroomBluetoothSettingsView = subscreenBleController.mBleView;
            if (subroomBluetoothSettingsView != null) {
                if (bluetoothState == 12 || bluetoothState == 10) {
                    subroomBluetoothSettingsView.updateView(z);
                }
            }
        }
