...
public final class NowBarData {
    ...
    public int hashCode() {
        byte[] bArr = this.icon;
        int iM = PropertyValuesHolder2D$$ExternalSyntheticOutline0.m((bArr == null ? 0 : Arrays.hashCode(bArr)) * 31, 31, this.title);
    ...
    public String toString() {
        String string = Arrays.toString(this.icon);
        ...
        StringBuilder sbM = SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("NowBarData(icon=", string, ", title=", str, ", subTitle=");
        sbM.append(str2);
        sbM.append(", background=");
        sbM.append(arrayList);
        sbM.append(", backgroundForDark=");
        sbM.append(arrayList2);
        sbM.append(", fullBackground=");
        sbM.append(str3);
        sbM.append(", fullBackgroundForDark=");
        return TransitionKt$$ExternalSyntheticOutline0.m(sbM, str4, ")");
    }
