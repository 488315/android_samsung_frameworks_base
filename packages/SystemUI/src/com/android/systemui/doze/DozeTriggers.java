...
public class DozeTriggers implements DozeMachine.Part {
    ...
    /* JADX WARN: Type inference failed for: r0v3, types: [com.android.systemui.doze.DozeTriggers$2] */
    public DozeTriggers(Context context, DozeHost dozeHost, AmbientDisplayConfiguration ambientDisplayConfiguration, DozeParameters dozeParameters, AsyncSensorManager asyncSensorManager, WakeLock wakeLock, DockManager dockManager, ProximitySensor proximitySensor, ProximityCheck proximityCheck, DozeLog dozeLog, BroadcastDispatcher broadcastDispatcher, SecureSettings secureSettings, AuthController authController, UiEventLogger uiEventLogger, SessionTracker sessionTracker, KeyguardStateController keyguardStateController, DevicePostureController devicePostureController, UserTracker userTracker, SelectedUserInteractor selectedUserInteractor) {
        ...
        this.mHostCallback = new DozeHost.Callback() { // from class: com.android.systemui.doze.DozeTriggers.2
            ...
            public final void onNotificationAlerted(DozeServiceHost$$ExternalSyntheticLambda3 dozeServiceHost$$ExternalSyntheticLambda3) {
                boolean z = DozeTriggers.sWakeDisplaySensorState;
                DozeTriggers dozeTriggers = DozeTriggers.this;
                ...
                if (!z2) {
                    ...
                    dozeServiceHost$$ExternalSyntheticLambda3.run();
                ...
                dozeTriggers.requestPulse(1, false, dozeServiceHost$$ExternalSyntheticLambda3);
                DozeLogger dozeLogger = dozeLog2.mLogger;
                dozeLogger.getClass();
                LogLevel logLevel = LogLevel.INFO;
                DozeLogger$$ExternalSyntheticLambda3 dozeLogger$$ExternalSyntheticLambda3 = new DozeLogger$$ExternalSyntheticLambda3(3);
    ...
    public static void runIfNotNull(DozeServiceHost$$ExternalSyntheticLambda3 dozeServiceHost$$ExternalSyntheticLambda3) {
        if (dozeServiceHost$$ExternalSyntheticLambda3 != null) {
            dozeServiceHost$$ExternalSyntheticLambda3.run();
        }
    }
    ...
    public void onSensor(final int i, final float f, final float f2, final float[] fArr) {
                ...
                public final void accept(Object obj) {
                    ...
                    if (!z10 && !z11) {
                        ...
                        if (DozeTriggers.canPulse(dozeTriggers.mMachine.getState(), true)) {
                            ...
                            dozeLogger.getClass();
                            LogBuffer.log$default(dozeLogger.buffer, "DozeLog", LogLevel.DEBUG, "updfsLongPress - setting aodInterruptRunnable to run when the display is on");
                            ...
                            LogBuffer.log$default(dozeLogger2.buffer, "DozeLog", LogLevel.DEBUG, "udfpsLongPress - Not sending aodInterrupt. Unsupported doze state.");
                        }
        ...
        boolean z10 = SystemClock.elapsedRealtime() - this.mNotificationPulseTime < ((long) this.mDozeParameters.getInt$1(R.integer.doze_pickup_vibration_threshold, "doze.pickup.vibration.threshold"));
    ...
    public final void requestPulse(final int i, final boolean z, final DozeServiceHost$$ExternalSyntheticLambda3 dozeServiceHost$$ExternalSyntheticLambda3) {
        Assert.isMainThread();
        DozeServiceHost dozeServiceHost = (DozeServiceHost) this.mDozeHost;
        ...
        if (z3 && !dozeServiceHost.mPulsePending && canPulse(state, z)) {
            ...
            Consumer consumer = new Consumer() { // from class: com.android.systemui.doze.DozeTriggers$$ExternalSyntheticLambda4
                ...
                public final void accept(Object obj) {
                    ...
                    if (bool != null && bool.booleanValue()) {
                        ...
                        DozeTriggers.runIfNotNull(dozeServiceHost$$ExternalSyntheticLambda32);
                        return;
                    }
                    ...
                    if (z5 && ((BiometricUnlockController) lazy.get()).mMode != 1 && DozeTriggers.canPulse(state3, z4)) {
                    ...
                    } else if (!DozeTriggers.canPulse(state3, z4)) {
                        dozeLog.tracePulseDropped("continuePulseRequest - doze state cannot pulse", state3);
                    }
                    DozeTriggers.runIfNotNull(dozeServiceHost$$ExternalSyntheticLambda32);
                }
            };
        ...
        runIfNotNull(dozeServiceHost$$ExternalSyntheticLambda3);
    }
