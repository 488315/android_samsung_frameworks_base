...
public final class HomeControlsComponentInteractor$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new FlowKt.AnonymousClass1(null), SharedPreferencesExt.INSTANCE.observe(((UserFileManagerImpl) secSelectedComponentRepositoryImpl.userFileManager).getSharedPreferences$1(userHandle.getIdentifier(), SystemUIAnalytics.CONTROL_PREF_NAME)));
            Flow flowFlowOn = kotlinx.coroutines.flow.FlowKt.flowOn(new Flow() { // from class: com.android.systemui.controls.panels.SecSelectedComponentRepositoryImpl$selectedComponentFlow$$inlined$map$1
                    ...
                    */
                    public final Object emit(Object obj, Continuation continuation) {
                        ...
                        if (i2 == 0) {
                            ...
                            SelectedComponentRepository.SelectedComponent selectedComponent = this.this$0.getSelectedComponent(this.$userHandle$inlined);
                ...
                public final Object collect(FlowCollector flowCollector2, Continuation continuation) {
                    Object objCollect = flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1.collect(new AnonymousClass2(flowCollector2, secSelectedComponentRepositoryImpl, userHandle), continuation);
                    return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
                }
            }, secSelectedComponentRepositoryImpl.bgDispatcher);
            this.label = 1;
            if (kotlinx.coroutines.flow.FlowKt.emitAll(flowCollector, flowFlowOn, this) == coroutineSingletons) {
                return coroutineSingletons;
            }
        } else {
            if (i != 1) {
