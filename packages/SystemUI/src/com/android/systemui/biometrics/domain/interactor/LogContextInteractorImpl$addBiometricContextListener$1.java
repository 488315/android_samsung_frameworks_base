...
final class LogContextInteractorImpl$addBiometricContextListener$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        FlowKt.launchIn(new FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1(new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(FlowKt.distinctUntilChanged((Flow) this.this$0.displayState$delegate.getValue()), new AnonymousClass3(this.$listener, null)), new AnonymousClass4(null)), coroutineScope);
