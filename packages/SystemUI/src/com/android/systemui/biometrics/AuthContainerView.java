...
public class AuthContainerView extends LinearLayout implements WakefulnessLifecycle.Observer, CredentialView.Host {
    ...
    final class BiometricCallback implements Spaghetti.Callback {
        ...
        public final void onAuthenticatedAndConfirmed() {
            AuthContainerView.this.animateAway(1, true);
        }
        ...
        public final void onUseDeviceCredential() {
            ...
            authContainerView.mConfig.mPromptInfo.setAuthenticators(NetworkAnalyticsConstants.DataPoints.FLAG_UID);
        }
    ...
    /* JADX WARN: Type inference failed for: r4v1, types: [com.android.systemui.biometrics.AuthContainerView$$ExternalSyntheticLambda3] */
    public AuthContainerView(Config config, CoroutineScope coroutineScope, List<FingerprintSensorPropertiesInternal> list, List<FaceSensorPropertiesInternal> list2, WakefulnessLifecycle wakefulnessLifecycle, UserManager userManager, AuthContextPlugins authContextPlugins, LockPatternUtils lockPatternUtils, InteractionJankMonitor interactionJankMonitor, Provider provider, PromptViewModel promptViewModel, Provider provider2, DelayableExecutor delayableExecutor, VibratorHelper vibratorHelper, MSDLPlayer mSDLPlayer) {
        ...
        this.mEffectiveUserId = userManager.getCredentialOwnerProfile(config.mUserId);
        this.mWindowManager = WindowManagerUtils.getWindowManager(getContext());
    ...
    public final void animateAway(int i, boolean z) {
        ...
        postOnAnimation(new Runnable() { // from class: com.android.systemui.biometrics.AuthContainerView$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ...
                }).withLayer().withEndAction(authContainerView$$ExternalSyntheticLambda02).start();
            }
        });
    }
    ...
    public final void removeWindowIfAttached() {
        ...
        if (num != null) {
            ...
            if (authContainerView == null || j == authContainerView.mConfig.mRequestId) {
