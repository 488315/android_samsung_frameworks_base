...
public final class DefaultUdfpsTouchOverlayViewModel implements UdfpsTouchOverlayViewModel {
    ...
    public DefaultUdfpsTouchOverlayViewModel(ShadeInteractor shadeInteractor, SystemUIDialogManager systemUIDialogManager) {
        StateFlow stateFlowIsAnyExpanded = ((ShadeInteractorImpl) shadeInteractor).baseShadeInteractor.isAnyExpanded();
        this.shadeExpandedOrExpanding = stateFlowIsAnyExpanded;
        this.shouldHandleTouches = new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(stateFlowIsAnyExpanded, SystemUIDialogManagerExtKt.getHideAffordancesRequest(systemUIDialogManager), new DefaultUdfpsTouchOverlayViewModel$shouldHandleTouches$1(null));
    }
