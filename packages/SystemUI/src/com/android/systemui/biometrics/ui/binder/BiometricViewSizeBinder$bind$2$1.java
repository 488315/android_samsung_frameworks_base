...
final class BiometricViewSizeBinder$bind$2$1 extends SuspendLambda implements Function3 {
    ...
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2 flowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2 = this.$viewModel.iconSize;
                final View view = this.$iconHolderView;
                final ConstraintSet constraintSet = this.$mediumConstraintSet;
    ...
    final class AnonymousClass4 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowKt__ZipKt$combine$$inlined$unsafeFlow$1 flowKt__ZipKt$combine$$inlined$unsafeFlow$1 = new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(promptViewModel.hideSensorIcon, promptViewModel.size, AnonymousClass3.INSTANCE);
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.biometrics.ui.binder.BiometricViewSizeBinder.bind.2.1.4.4
                    @Override // kotlinx.coroutines.flow.FlowCollector
                    public final Object emit(Object obj2, Continuation continuation) {
                        Pair pair = (Pair) obj2;
    ...
    final class AnonymousClass5 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                PromptViewModel promptViewModel = this.$viewModel;
                FlowKt__ZipKt$combine$$inlined$unsafeFlow$1 flowKt__ZipKt$combine$$inlined$unsafeFlow$1 = new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(promptViewModel.position, promptViewModel.size, AnonymousClass3.INSTANCE);
                final ConstraintSet constraintSet = this.$flipConstraintSet;
                final ConstraintSet constraintSet2 = this.$smallConstraintSet;
                final ConstraintSet constraintSet3 = this.$mediumConstraintSet;
                final float f = this.$pxToDp;
                final View view = this.$view;
                final Ref$ObjectRef<PromptSize> ref$ObjectRef = this.$currentSize;
                final ConstraintSet constraintSet4 = this.$largeConstraintSet;
                final Ref$ObjectRef<PromptPosition> ref$ObjectRef2 = this.$currentPosition;
                final View view2 = this.$panelView;
                final AccessibilityManager accessibilityManager = this.$accessibilityManager;
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.biometrics.ui.binder.BiometricViewSizeBinder.bind.2.1.5.4
                    /* JADX WARN: Multi-variable type inference failed */
                    /* JADX WARN: Type inference failed for: r10v3, types: [T, com.android.systemui.biometrics.ui.viewmodel.PromptSize] */
                    /* JADX WARN: Type inference failed for: r11v2, types: [T, com.android.systemui.biometrics.ui.viewmodel.PromptPosition] */
                    @Override // kotlinx.coroutines.flow.FlowCollector
                    public final Object emit(Object obj2, Continuation continuation) {
                        Pair pair = (Pair) obj2;
                        ?? r11 = (PromptPosition) pair.component1();
                        ...
                        } else if (r11 != 0 && r11 == PromptPosition.Top) {
                        ...
                        if (!isSmall) {
                            if (PromptSizeKt.isMedium(r10) && PromptSizeKt.isSmall((PromptSize) ref$ObjectRef3.element)) {
                                ...
                                if (r11 == 0 || r11 != PromptPosition.Left) {
                            ...
                            } else if (PromptSizeKt.isMedium(r10)) {
                                if (r11 == 0 || r11 != PromptPosition.Left) {
                                    constraintSet7.applyTo((ConstraintLayout) view);
                                } else {
                                    constraintSet6.applyTo((ConstraintLayout) view);
                                }
                            } else if (r10 != 0 && r10 == PromptSize.LARGE) {
                        ...
                        } else if (r11 == 0 || r11 != PromptPosition.Left) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        CoroutineTracingKt.launchTraced$default(LifecycleOwnerKt.getLifecycleScope(lifecycleOwner), null, null, new AnonymousClass1(this.$viewModel, this.$iconHolderView, this.$mediumConstraintSet, this.$smallConstraintSet, null), 7);
        CoroutineTracingKt.launchTraced$default(LifecycleKt.getCoroutineScope(lifecycleOwner.getLifecycle()), null, null, new AnonymousClass2(this.$viewModel, this.$iconHolderView, this.$mediumConstraintSet, null), 7);
        CoroutineTracingKt.launchTraced$default(LifecycleKt.getCoroutineScope(lifecycleOwner.getLifecycle()), null, null, new AnonymousClass3(this.$viewModel, this.$windowManager, this.$mediumConstraintSet, this.$leftGuideline, this.$smallConstraintSet, this.$rightGuideline, this.$topGuideline, this.$midGuideline, this.$view, null), 7);
        CoroutineTracingKt.launchTraced$default(LifecycleKt.getCoroutineScope(lifecycleOwner.getLifecycle()), null, null, new AnonymousClass4(this.$viewModel, this.$viewsToHideWhenSmall, this.$largeConstraintSet, this.$iconHolderView, this.$smallConstraintSet, this.$mediumConstraintSet, null), 7);
        CoroutineTracingKt.launchTraced$default(LifecycleKt.getCoroutineScope(lifecycleOwner.getLifecycle()), null, null, new AnonymousClass5(this.$viewModel, this.$flipConstraintSet, this.$smallConstraintSet, this.$mediumConstraintSet, this.$pxToDp, this.$view, this.$currentSize, this.$largeConstraintSet, this.$currentPosition, this.$panelView, this.$accessibilityManager, null), 7);
        return Unit.INSTANCE;
    }
}
