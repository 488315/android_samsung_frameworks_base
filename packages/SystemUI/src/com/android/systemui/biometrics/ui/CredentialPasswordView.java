...
public final class CredentialPasswordView extends LinearLayout implements CredentialView, View.OnApplyWindowInsetsListener {
    ...
    public CredentialPasswordView(final Context context, AttributeSet attributeSet) {
        ...
        LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.biometrics.ui.CredentialPasswordView$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Context context2 = context;
                int i = CredentialPasswordView.$r8$clinit;
                return (AccessibilityManager) context2.getSystemService(AccessibilityManager.class);
            }
        });
    }
