...
public class BiometricNotificationDialogFactory {
    ...
    public BiometricNotificationDialogFactory(Resources resources, SystemUIDialog.Factory factory, ShadeDialogContextInteractor shadeDialogContextInteractor, FingerprintManager fingerprintManager, FaceManager faceManager) {
        this.mResources = resources;
        this.mSystemUIDialogFactory = factory;
        this.mDialogContextInteractor = shadeDialogContextInteractor;
