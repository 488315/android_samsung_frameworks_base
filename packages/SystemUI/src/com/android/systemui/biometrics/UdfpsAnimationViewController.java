...
public abstract class UdfpsAnimationViewController extends ViewController implements Dumpable {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function3 {
        ...
        final class C00271 extends SuspendLambda implements Function2 {
            private /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ UdfpsAnimationViewController this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C00271(UdfpsAnimationViewController udfpsAnimationViewController, Continuation continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C00271 c00271 = new C00271(UdfpsAnimationViewController.this, null);
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(lifecycleOwner, state, c00271, this) == coroutineSingletons) {
                    return coroutineSingletons;
                }
            } else {
                if (i != 1) {
            ...
            public final void shouldHideAffordances(boolean z) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.biometrics.UdfpsAnimationViewController$runDialogAlphaAnimator$1$1
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ...
                        view.updateAlpha();
                        UdfpsAnimationViewController.this.getView().updateAlpha();
    ...
    public final Object listenForShadeExpansion(CoroutineScope coroutineScope, Continuation continuation) {
        return CoroutineTracingKt.launchTraced$default(coroutineScope, null, null, new UdfpsAnimationViewController$listenForShadeExpansion$2(this, null), 7);
    }
