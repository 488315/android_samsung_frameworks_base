                    ...
                    public final void run() {
                        switch (i) {
                            case 0:
                                ...
                                String str2 = string2;
                                String str3 = string3;
                                int i2 = BiometricNotificationService.$r8$clinit;
                                biometricNotificationService2.showNotification("face_action_show_reenroll_dialog", str, str2, str3, 1, false);
                                break;
                            default:
                                BiometricNotificationService biometricNotificationService3 = biometricNotificationService;
                                biometricNotificationService3.showNotification("fingerprint_action_show_reenroll_dialog", string, string2, string3, 2, biometricNotificationService3.mIsFingerprintReenrollForced);
                                break;
                        }
                    }
                }, 5000L);
                ...
                public final void run() {
                    switch (i2) {
                        case 0:
                            ...
                            String str2 = string5;
                            String str3 = string6;
                            int i22 = BiometricNotificationService.$r8$clinit;
                            biometricNotificationService2.showNotification("face_action_show_reenroll_dialog", str, str2, str3, 1, false);
                            break;
                        default:
                            BiometricNotificationService biometricNotificationService3 = biometricNotificationService;
                            biometricNotificationService3.showNotification("fingerprint_action_show_reenroll_dialog", string4, string5, string6, 2, biometricNotificationService3.mIsFingerprintReenrollForced);
                            break;
                    }
                }
            }, 5000L);
