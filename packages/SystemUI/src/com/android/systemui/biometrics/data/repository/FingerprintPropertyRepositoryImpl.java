...
public final class FingerprintPropertyRepositoryImpl implements FingerprintPropertyRepository {
    ...
    public FingerprintPropertyRepositoryImpl(CoroutineScope coroutineScope, CoroutineDispatcher coroutineDispatcher, FingerprintManager fingerprintManager) {
        ...
        Flow flowConflatedCallbackFlow = FlowConflatedKt.conflatedCallbackFlow(new FingerprintPropertyRepositoryImpl$props$1(this, null));
        SharingStarted.Companion companion = SharingStarted.Companion;
        companion.getClass();
        StartedEagerly startedEagerly = SharingStarted.Companion.Eagerly;
        final ReadonlyStateFlow readonlyStateFlowStateIn = FlowKt.stateIn(flowConflatedCallbackFlow, coroutineScope, startedEagerly, UNINITIALIZED_PROPS);
        this.props = readonlyStateFlowStateIn;
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        Integer num = new Integer(((FingerprintSensorPropertiesInternal) obj).sensorId);
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        SensorStrength sensorStrength = SensorStrengthKt.toSensorStrength(((FingerprintSensorPropertiesInternal) obj).sensorStrength);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(sensorStrength, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        FingerprintSensorType sensorType = FingerprintSensorTypeKt.toSensorType(((FingerprintSensorPropertiesInternal) obj).sensorType);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(sensorType, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
        ...
        this.sensorType = FlowKt.stateIn(flow, coroutineScope, startedWhileSubscribedWhileSubscribed$default, FingerprintSensorTypeKt.toSensorType(((FingerprintSensorPropertiesInternal) stateFlow.getValue()).sensorType));
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        List allLocations = ((FingerprintSensorPropertiesInternal) obj).getAllLocations();
                        int iMapCapacity = MapsKt__MapsJVMKt.mapCapacity(CollectionsKt__IterablesKt.collectionSizeOrDefault(allLocations, 10));
                        if (iMapCapacity < 16) {
                            iMapCapacity = 16;
                        }
                        LinkedHashMap linkedHashMap = new LinkedHashMap(iMapCapacity);
                        for (Object obj3 : allLocations) {
                            linkedHashMap.put(((SensorLocationInternal) obj3).displayId, obj3);
                        }
                        anonymousClass1.label = 1;
        ...
        final ReadonlyStateFlow readonlyStateFlowStateIn2 = FlowKt.stateIn(flow2, coroutineScope, startedEagerly, linkedHashMap);
        this.sensorLocations = readonlyStateFlowStateIn2;
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Boolean boolValueOf = Boolean.valueOf(!Intrinsics.areEqual((FingerprintSensorPropertiesInternal) obj, FingerprintPropertyRepositoryImpl.UNINITIALIZED_PROPS));
                        anonymousClass1.label = 1;
        ...
        FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$12 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new FingerprintPropertyRepositoryImpl$propertiesInitialized$4(this, null), new Flow() { // from class: com.android.systemui.biometrics.data.repository.FingerprintPropertyRepositoryImpl$special$$inlined$map$6
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = fingerprintPropertyRepositoryImpl$special$$inlined$map$1.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        });
        ...
        this.propertiesInitialized = FlowKt.distinctUntilChanged(FlowKt.combine(flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$12, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$13, flowKt__EmittersKt$onStart$$inlined$unsafeFlow$14, new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new FingerprintPropertyRepositoryImpl$propertiesInitialized$10(this, null), new Flow() { // from class: com.android.systemui.biometrics.data.repository.FingerprintPropertyRepositoryImpl$special$$inlined$map$9
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = fingerprintPropertyRepositoryImpl$special$$inlined$map$2.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
