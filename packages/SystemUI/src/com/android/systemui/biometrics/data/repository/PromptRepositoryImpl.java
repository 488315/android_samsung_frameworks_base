...
public final class PromptRepositoryImpl implements PromptRepository {
    ...
    public PromptRepositoryImpl(FaceSettingsRepository faceSettingsRepository, AuthController authController) {
        ...
        Flow distinctUntilChanged = FlowKt.distinctUntilChanged(FlowKt.transformLatest(FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.biometrics.data.repository.PromptRepositoryImpl$special$$inlined$map$1
        ...
        this.isConfirmationRequired = FlowKt.distinctUntilChanged(new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(r1, distinctUntilChanged, new PromptRepositoryImpl$isConfirmationRequired$1(null)));
    }
}
