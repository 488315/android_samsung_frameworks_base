...
public final class UdfpsOverlayParams {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.sensorType) + ReorderTile$$ExternalSyntheticOutline0.m(this.rotation, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.scaleFactor, ReorderTile$$ExternalSyntheticOutline0.m(this.naturalDisplayHeight, ReorderTile$$ExternalSyntheticOutline0.m(this.naturalDisplayWidth, (this.overlayBounds.hashCode() + (this.sensorBounds.hashCode() * 31)) * 31, 31), 31), 31), 31);
    }
    ...
    public final String toString() {
        ...
        return ReorderTile$$ExternalSyntheticOutline0.m(this.sensorType, ")", sb);
    }
    ...
    public /* synthetic */ UdfpsOverlayParams(Rect rect, Rect rect2, int i, int i2, float f, int i3, int i4, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this((i5 & 1) != 0 ? new Rect() : rect, (i5 & 2) != 0 ? new Rect() : rect2, (i5 & 4) != 0 ? 0 : i, (i5 & 8) != 0 ? 0 : i2, (i5 & 16) != 0 ? 1.0f : f, (i5 & 32) != 0 ? 0 : i3, (i5 & 64) != 0 ? 3 : i4);
    }
}
