...
public final class UdfpsHapticsSimulator implements Command {
    ...
    public static void invalidCommand$1(PrintWriter printWriter) {
        AuthRippleController$AuthRippleCommand$$ExternalSyntheticOutline0.m(printWriter, "invalid command", "Usage: adb shell cmd statusbar udfps-haptic <haptic>", "Available commands:", "  start");
