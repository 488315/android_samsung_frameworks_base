...
public final class TurbulenceNoiseAnimationConfig {
    ...
    public final int hashCode() {
        return Boolean.hashCode(this.shouldInverseNoiseLuminosity) + FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.lumaMatteOverallBrightness, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.lumaMatteBlendFactor, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.pixelDensity, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.easeOutDuration, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.easeInDuration, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.maxDuration, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.height, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.width, ReorderTile$$ExternalSyntheticOutline0.m(this.screenColor, ReorderTile$$ExternalSyntheticOutline0.m(this.color, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.noiseMoveSpeedZ, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.noiseMoveSpeedY, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.noiseMoveSpeedX, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.noiseOffsetZ, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.noiseOffsetY, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.noiseOffsetX, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.luminosityMultiplier, Float.hashCode(this.gridCount) * 31, 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31), 31);
    }
    ...
    public final String toString() {
        ...
        return MoveResult$$ExternalSyntheticOutline0.m(sb, this.shouldInverseNoiseLuminosity, ")");
    }
