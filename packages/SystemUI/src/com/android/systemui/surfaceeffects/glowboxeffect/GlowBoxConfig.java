...
public final class GlowBoxConfig {
    ...
    public final int hashCode() {
        return Long.hashCode(this.easeOutDuration) + MoveResult$$ExternalSyntheticOutline0.m(MoveResult$$ExternalSyntheticOutline0.m(FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.blurAmount, ReorderTile$$ExternalSyntheticOutline0.m(this.color, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.height, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.width, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.endCenterY, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.endCenterX, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.startCenterY, Float.hashCode(this.startCenterX) * 31, 31), 31), 31), 31), 31), 31), 31), 31, this.duration), 31, this.easeInDuration);
    }
