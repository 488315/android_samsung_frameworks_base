...
public final class IssueRecordingState {
    ...
    static {
        Integer numValueOf = Integer.valueOf(R.string.performance);
        ...
        Pair pair = new Pair(numValueOf, new TraceConfig(PresetTraceConfigs.PERFORMANCE_TRACE_OPTIONS, PresetTraceConfigs.mPerformanceTagList));
        Integer numValueOf2 = Integer.valueOf(R.string.user_interface);
        ...
        Pair pair2 = new Pair(numValueOf2, new TraceConfig(PresetTraceConfigs.UI_TRACE_OPTIONS, PresetTraceConfigs.mUiTagList));
        Integer numValueOf3 = Integer.valueOf(R.string.battery);
        ...
        Pair pair3 = new Pair(numValueOf3, new TraceConfig(PresetTraceConfigs.BATTERY_TRACE_OPTIONS, PresetTraceConfigs.mBatteryTagList));
        Integer numValueOf4 = Integer.valueOf(R.string.thermal);
        ...
        Pair[] pairArr = {pair, pair2, pair3, new Pair(numValueOf4, new TraceConfig(PresetTraceConfigs.THERMAL_TRACE_OPTIONS, PresetTraceConfigs.mThermalTagList)), new Pair(Integer.valueOf(R.string.custom), null)};
