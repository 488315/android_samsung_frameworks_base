...
public class SlimIndicatorPluginMediator implements SPluginListener {
    ...
    public final void onPluginConnected(SPlugin sPlugin, Context context) {
        ...
        if (!slimIndicatorReceiverManager.mIsRegistered) {
            ArrayList arrayList = slimIndicatorReceiverManager.receivers;
            int size = arrayList.size();
            int i = 0;
            while (i < size) {
                Object obj = arrayList.get(i);
                i++;
                ((SlimIndicatorReceiver) obj).register();
            }
    ...
    public final void onPluginDisconnected(SPlugin sPlugin, int i) {
        ...
        if (this.mIsSPluginConnected) {
            ...
            while (i2 < size) {
                ...
                i2++;
                ((SlimIndicatorReceiver) obj).unregister();
            }
