...
public final class NoteTaskEntryPoint {
    ...
    public static final NoteTaskEntryPoint QS_NOTES_TILE;
    ...
    static {
        ...
        NoteTaskEntryPoint noteTaskEntryPoint7 = new NoteTaskEntryPoint("QS_NOTES_TILE", 6);
        QS_NOTES_TILE = noteTaskEntryPoint7;
        NoteTaskEntryPoint[] noteTaskEntryPointArr = {noteTaskEntryPoint, noteTaskEntryPoint2, noteTaskEntryPoint3, noteTaskEntryPoint4, noteTaskEntryPoint5, noteTaskEntryPoint6, noteTaskEntryPoint7};
