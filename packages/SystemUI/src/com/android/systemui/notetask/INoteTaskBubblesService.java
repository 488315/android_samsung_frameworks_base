    ...
    public abstract class Stub extends Binder implements INoteTaskBubblesService {
        ...
        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            if (i == 1) {
                ...
                NoteTaskBubbleExpandBehavior noteTaskBubbleExpandBehavior = (NoteTaskBubbleExpandBehavior) parcel.readTypedObject(NoteTaskBubbleExpandBehavior.CREATOR);
                parcel.enforceNoDataAvail();
                ((NoteTaskBubblesController$NoteTaskBubblesService$onBind$1) this).showOrHideNoteBubble(intent, userHandle, icon, noteTaskBubbleExpandBehavior);
                parcel2.writeNoException();
            }
            return true;
        }
