...
public class GlobalActionsImpl implements GlobalActions, CommandQueue.Callbacks {
    ...
    @Override // com.android.systemui.plugins.GlobalActions
    public final void showShutdownUi(boolean z, String str) throws Resources.NotFoundException {
        ShutdownUi shutdownUi = this.mShutdownUi;
        shutdownUi.getClass();
        ScrimDrawable scrimDrawable = new ScrimDrawable();
        Dialog dialog = new Dialog(shutdownUi.mContext, R.style.Theme_SystemUI_Dialog_GlobalActions);
        scrimDrawable.setAlpha((int) SecurityUtils$$ExternalSyntheticOutline0.m(shutdownUi.mContext, R.dimen.shutdown_scrim_behind_alpha, 255.0f));
        ...
        int color = shutdownUi.mContext.getResources().getColor(R.color.global_actions_shutdown_ui_text, shutdownUi.mContext.getTheme());
