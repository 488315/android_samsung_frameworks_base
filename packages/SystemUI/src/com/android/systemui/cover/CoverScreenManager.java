...
public class CoverScreenManager implements PluginListener, ScreenLifecycle.Observer, WakefulnessLifecycle.Observer, Dumpable {
        ...
        public final void onLockDisabledChanged(boolean z) {
            ...
            if (coverState != null && coverState.getAttachState() && CoverScreenManager.isUseDisplayCoverPlugin(coverScreenManager.mCoverState)) {
                ...
                if (pluginCover == null) {
                    ...
                    EmergencyButtonController$$ExternalSyntheticOutline0.m("onLockDisabledChanged() ", "CoverScreenManager", z);
    ...
    public CoverScreenManager(Context context, CoverHost coverHost, KeyguardUpdateMonitor keyguardUpdateMonitor, Lazy lazy, Lazy lazy2, PluginManager pluginManager, DisplayManager displayManager, DelayableExecutor delayableExecutor, PowerManager powerManager, SettingsHelper settingsHelper, DumpManager dumpManager, ScreenLifecycle screenLifecycle, WakefulnessLifecycle wakefulnessLifecycle, CoverWindowDelegate coverWindowDelegate, KeyguardInteractor keyguardInteractor, JavaAdapter javaAdapter) {
        ...
        javaAdapter.alwaysCollectFlow(keyguardInteractor.dozeTimeTick, new Consumer() { // from class: com.android.systemui.cover.CoverScreenManager$$ExternalSyntheticLambda1
            ...
            public final void accept(Object obj) {
                ...
                Log.d("CoverScreenManager", "dozeTimeTick() time=" + l);
    ...
    public final void removePluginListener$1() {
    ...
    public final void updatePluginListener() {
        ...
        removePluginListener$1();
        if (this.mIsAttached) {
            requestPluginConnection(this.mCoverState);
        }
    }

    public final void updateRefreshRate$1(boolean z) {
