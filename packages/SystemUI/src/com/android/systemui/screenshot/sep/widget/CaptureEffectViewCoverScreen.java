...
public class CaptureEffectViewCoverScreen extends CaptureEffectView {
    ...
    public CaptureEffectViewCoverScreen(Context context) {
        this(context, null);
    }

    public final Bitmap getBitmapFromVectorDrawable$1(int i) throws Resources.NotFoundException {
    ...
    public CaptureEffectViewCoverScreen(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mCoverShape = getBitmapFromVectorDrawable$1(R.drawable.b7_cover_screen_shape);
        this.mCoverShapeBackground = getBitmapFromVectorDrawable$1(R.drawable.b7_cover_screen_shape_background);
