...
public class ScreenCaptureHelper {
    ...
    public boolean isShowScreenshotAnimation(Context context) {
        return !(Settings.System.getInt(context.getContentResolver(), SettingsHelper.INDEX_REMOVE_ANIMATION, 0) == 1);
    }
