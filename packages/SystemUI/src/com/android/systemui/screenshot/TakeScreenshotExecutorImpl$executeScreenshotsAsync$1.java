...
final class TakeScreenshotExecutorImpl$executeScreenshotsAsync$1 extends SuspendLambda implements Function2 {
    ...
    /* JADX WARN: Type inference failed for: r4v0, types: [com.android.systemui.screenshot.TakeScreenshotExecutorImpl$executeScreenshotsAsync$1$$ExternalSyntheticLambda0] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (takeScreenshotExecutorImpl.executeScreenshots(screenshotRequest, r4, requestCallback, this) == coroutineSingletons) {
