    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ...
                ((SystemUIConditionListenerService) obj).mEntries = ((NotifLiveDataStoreImpl) ((NotifLiveDataStore) Dependency.sDependency.getDependencyInner(NotifLiveDataStore.class))).activeNotifList;
                break;
            default:
                NotificationEntry notificationEntry = (NotificationEntry) obj;
                int i3 = SystemUIConditionListenerService.AnonymousClass1.$r8$clinit;
