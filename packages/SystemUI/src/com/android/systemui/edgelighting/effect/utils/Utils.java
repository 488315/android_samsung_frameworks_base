...
public class Utils {
    ...
    public static float getCutoffHeight(Context context) {
        if (MODEL_NAME.contains("SM-F766")) {
            return 0.0f;
        }
        return context.getResources().getDimensionPixelOffset(R.dimen.cut_off_height);
    }
