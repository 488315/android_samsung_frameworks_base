...
public class MorphView extends AbsToastView {
    ...
    public final float mAnimationRangeY;
    public final TextView mCodeText;
    public final ImageView mExpandButton;
    public final float mHideShowRange;
    ...
    public final void hide() {
        ...
        SpringAnimation springAnimation = new SpringAnimation(this, SpringAnimation.TRANSLATION_Y, -f);
        springAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: com.android.systemui.edgelighting.effect.view.MorphView.5
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f2, float f3) {
                MorphView.this.reset();
                MorphView.this.mIsHiding = false;
            }
        });
        SpringForce springForce = new SpringForce(-this.mAnimationRangeY);
    ...
    public final void reset() {
        setTranslationY((-this.mAnimationRangeY) * 2.0f);
        setAlpha(0.0f);
    ...
    public final void show() {
        ...
        springAnimation.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: com.android.systemui.edgelighting.effect.view.MorphView.3
