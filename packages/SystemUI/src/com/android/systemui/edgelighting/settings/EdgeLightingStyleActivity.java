...
public class EdgeLightingStyleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public class EdgeLightingStyleEffectAdapter extends BaseAdapter {
        ...
        /* JADX WARN: Type inference failed for: r6v2, types: [com.android.systemui.edgelighting.settings.EdgeLightingStyleActivity$EdgeLightingStyleEffectAdapter$1] */
        public EdgeLightingStyleEffectAdapter() {
            ...
            while (i < size) {
                ...
                i++;
                EdgeLightingStyle edgeLightingStyle = (EdgeLightingStyle) obj;
    ...
    public final void onClick(View view) {
        ...
        edgeLightingStyleManager.getClass();
        EdgeLightingStyleManager.setEdgeLightingStyleType(contentResolver, key);
    ...
    public final void onCreate(Bundle bundle) throws Resources.NotFoundException, NumberFormatException {
        ...
        FontSizeUtils.updateFontSize(this.mApplyBtn, R.dimen.settings_edge_lighting_style_action_bar_button_title_text_size, 0.8f, 1.3f);
        FontSizeUtils.updateFontSize(this.mCancelBtn, R.dimen.settings_edge_lighting_style_action_bar_button_title_text_size, 0.8f, 1.3f);
    ...
    public final void showBottomBarOption(int i) throws Resources.NotFoundException {
        ...
        if (hideBottomBarSubOption(i)) {
            if (this.mEffectAdapter == null) {
                ...
                int i6 = i5 - 1;
                final int dimensionPixelOffset = (getResources().getDimensionPixelOffset(R.dimen.settings_edge_lighting_style_effect_option_grid_horizontal_space) * (i6 >= 0 ? i6 : 0)) + (getResources().getDimensionPixelOffset(R.dimen.setting_edge_lighting_style_grid_item_select_size) * i6);
    ...
    public final void showPreviewEdgeLighting(int[] iArr) {
        ...
        int i2 = this.mCurThickness;
        edgeEffectInfo2.mStrokeWidth = edgeLightingStyleWidth;
        edgeEffectInfo2.mWidthDepth = i2;
        ...
        if (preloadIndex == 100) {
            ...
            while (true) {
                ...
                Object obj = arrayList.get(i);
                i++;
                IEdgeLightingStyle iEdgeLightingStyle2 = (IEdgeLightingStyle) obj;
