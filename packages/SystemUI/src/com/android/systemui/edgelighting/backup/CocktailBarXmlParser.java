...
public class CocktailBarXmlParser extends DefaultHandler {
    ...
    public CocktailBarXmlParser(Context context, File file) throws ParserConfigurationException, SAXException, IOException {
