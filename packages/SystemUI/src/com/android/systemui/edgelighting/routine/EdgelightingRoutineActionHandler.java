...
public class EdgelightingRoutineActionHandler {
    ...
    public final AnonymousClass1 mHandler = new Handler(Looper.getMainLooper()) { // from class: com.android.systemui.edgelighting.routine.EdgelightingRoutineActionHandler.1
        ...
        public final void dispatchMessage(Message message) {
            ...
            EdgeLightingDispatcher edgeLightingDispatcher2 = edgelightingRoutineActionHandler.mController;
            int i2 = 0;
            if (edgeLightingDispatcher2 == null) {
                edgelightingRoutineActionHandler.mController = new EdgeLightingDispatcher(edgelightingRoutineActionHandler.mContext, 2227, false);
            } else {
                edgeLightingDispatcher2.stopEdgeEffect();
            ...
            EdgeLightingDialog edgeLightingDialog = edgelightingRoutineActionHandler.mController.mDialog;
            if (edgeLightingDialog != null) {
                edgeLightingDialog.mDozeDraw = true;
            }
