...
public class LightingScheduleInfo {
    ...
    public final ChainItemTitle mNotiTextPolicyChain;
    ...
    public abstract class NotiTextChain {
        ...
        public final void mergeTextChainItem(NotiTextChain notiTextChain, LightingScheduleInfo lightingScheduleInfo) {
            ...
            if (extraText != null) {
                Bundle extra = lightingScheduleInfo2.mLightingInfo.getExtra();
                if (extra == null) {
                    extra = new Bundle();
                }
                extra.putCharSequence(extraKey2, extraText);
                lightingScheduleInfo2.mLightingInfo.setExtra(extra);
            }
    ...
    public final int getPackageVisibility() {
        Bundle extra = this.mLightingInfo.getExtra();
        if (extra != null) {
            return Integer.valueOf(extra.getInt("package_visiblity")).intValue();
        }
        return -1000;
    }
