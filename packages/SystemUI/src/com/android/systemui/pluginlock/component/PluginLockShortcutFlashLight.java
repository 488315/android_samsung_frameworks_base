...
public class PluginLockShortcutFlashLight extends PluginLockShortcutTask implements FlashlightController.FlashlightListener {
    ...
    public void onFlashlightChanged(boolean z) {
        LogUtil.d(TAG, KeyguardUpdateMonitorLogger$$ExternalSyntheticOutline0.m("onFlashlightChanged [enabled] ", z), new Object[0]);
    ...
    public void setState(boolean z) {
        LogUtil.d(TAG, KeyguardUpdateMonitorLogger$$ExternalSyntheticOutline0.m("setState [state] ", z), new Object[0]);
