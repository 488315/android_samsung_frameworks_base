...
public class PluginLockDelegateSysUi implements PluginLockBasicManager.Callback {
    ...
    public void updateDynamicLockData(String str) {
        ...
        KeyguardCarrierViewController$2$$ExternalSyntheticOutline0.m(currentScreenType, "updateDynamicLockData() screenType: ", ", dynamicLockData: ", str, TAG);
        if (str == null) {
    ...
    public void updateWindowSecureState(boolean z) {
        EmergencyButtonController$$ExternalSyntheticOutline0.m("updateWindowSecureState : ", TAG, z);
        PluginLockMediator pluginLockMediator = this.mMediator;
        if (pluginLockMediator != null) {
    ...
    public void setPluginWallpaper(int i, int i2, int i3, String str, String str2) {
        ExifInterface$$ExternalSyntheticOutline0.m(MutableObjectList$$ExternalSyntheticOutline0.m(i, i2, "setPluginWallpaper() screen: ", ", wallpaperType:", ", iCrops = "), str2, TAG);
