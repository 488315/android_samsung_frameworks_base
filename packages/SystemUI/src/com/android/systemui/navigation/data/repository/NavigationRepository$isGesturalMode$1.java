        ...
        if (i == 0) {
            ...
            final ?? r1 = new NavigationModeController.ModeChangedListener() { // from class: com.android.systemui.navigation.data.repository.NavigationRepository$isGesturalMode$1$listener$1
                ...
                public final void onNavigationModeChanged(int i2) {
                    ((ChannelCoroutine) ProducerScope.this).mo3456trySendJP2dKIU(Boolean.valueOf(QuickStepContract.isGesturalMode(i2)));
                }
            };
            ((ChannelCoroutine) producerScope).mo3456trySendJP2dKIU(Boolean.valueOf(QuickStepContract.isGesturalMode(this.this$0.controller.addListener(r1))));
