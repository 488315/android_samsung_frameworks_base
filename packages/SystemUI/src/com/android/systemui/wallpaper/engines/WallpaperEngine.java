...
public abstract class WallpaperEngine {
    ...
    public final int getCurrentUserId() {
        return ImageWallpaper.IntegratedEngine.this.getCurrentUserId();
    }
    ...
    public final boolean isWindowVisible() {
        ...
        try {
            ...
            WallpaperScreenShotProvider$$ExternalSyntheticOutline0.m("isWindowVisible: e=", e, integratedEngine.TAG, e);
            return false;
        }
    }
    ...
    public final void setVisibleRectOfSurface(final Rect rect) {
        ...
        try {
            ...
            WallpaperScreenShotProvider$$ExternalSyntheticOutline0.m("getBlastBufferQueue: e=", e, integratedEngine.TAG, e);
        ...
        bLASTBufferQueue2.syncNextTransaction(new Consumer() { // from class: com.android.systemui.wallpapers.ImageWallpaper$IntegratedEngine$2$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                ...
                if (surfaceControl == null || !surfaceControl.isValid()) {
                    Log.i(integratedEngine2.TAG, "setVisibleRectOfSurface : failed to get surface control");
                } else {
                    try {
                        transaction.setGeometry(surfaceControl, rect3, rect2, 0);
                    } catch (Exception e2) {
                        WallpaperScreenShotProvider$$ExternalSyntheticOutline0.m("setVisibleRectOfSurface : e=", e2, integratedEngine2.TAG, e2);
                    }
                }
                transaction.apply();
