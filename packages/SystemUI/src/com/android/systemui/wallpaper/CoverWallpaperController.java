...
public class CoverWallpaperController extends IWallpaperManagerCallback.Stub implements CoverWallpaper, PluginWallpaperCallback {
    ...
    public final KeyguardUpdateMonitorCallback mMonitorCallback = new KeyguardUpdateMonitorCallback() { // from class: com.android.systemui.wallpaper.CoverWallpaperController.1
        ...
        public final void onUserSwitchComplete(int i) {
            ...
            try {
                ...
                boolean z = true;
                if (Settings.Secure.getIntForUser(smartCardController.context.getContentResolver(), SettingsHelper.INDEX_USER_SETUP_COMPLETE, -2) != 1) {
                    z = false;
                }
                Log.d("SmartCardController", "onUserSwitchCompleted, " + i + " " + z);
                if (!z) {
                    smartCardController.registerSetupWizardCompleteObserver();
                }
                smartCardController.sendUpdateState(0L, false);
            } catch (Exception e) {
                KeyguardSecSimPinViewController$$ExternalSyntheticOutline0.m("onUserSwitchComplete, e: ", e, "CoverWallpaperController");
            }
        }
        ...
        public final void onUserSwitching(int i) {
            ...
            try {
                ...
                KeyguardSecSimPinViewController$$ExternalSyntheticOutline0.m("onUserSwitching, e: ", e, "CoverWallpaperController");
            }
        }
    ...
    public CoverWallpaperController(Context context, WallpaperManager wallpaperManager, WallpaperLogger wallpaperLogger, PluginWallpaperManager pluginWallpaperManager, PluginLockUtils pluginLockUtils, SubScreenManager subScreenManager, SettingsHelper settingsHelper, KeyguardUpdateMonitor keyguardUpdateMonitor, SelectedUserInteractor selectedUserInteractor, WallpaperChangeNotifier wallpaperChangeNotifier) {
        ...
        if (LsRune.WALLPAPER_SUPPORT_SUIT_CASE) {
            ...
            try {
                smartCardController.context.getContentResolver().registerContentObserver(Settings.System.getUriFor(SettingsHelper.SMART_COVER_ACCESSORY_COVER_URI), false, smartCardController$settingObserver$1);
            } catch (Exception e) {
                EmergencyButton$$ExternalSyntheticOutline0.m("registerAccessoryUriObserver, error: ", e, "SmartCardController");
            }
            smartCardController.registerSetupWizardCompleteObserver();
            try {
                ...
                EmergencyButton$$ExternalSyntheticOutline0.m("registerDlsStateObserver, error: ", e2, "SmartCardController");
            }
    ...
    public final Bitmap getWallpaperBitmap() {
        Bitmap homeWallpaperBitmap = !isFbeAvailable() ? this.mPluginWallpaperManager.getHomeWallpaperBitmap(getCoverMode()) : null;
        if (WallpaperUtils.isValidBitmap(homeWallpaperBitmap) && !isFbeAvailable()) {
            return homeWallpaperBitmap;
        }
        ...
        EmergencyButtonController$$ExternalSyntheticOutline0.m("getWallpaperBitmap: hasICrops = ", "CoverWallpaperController", z);
    ...
    public final void onDataCleared() {
        ...
        if ((coverWhich & 60) != 0 && this.mWallpaperManager.semGetWallpaperType(coverWhich) == 3) {
            if (this.mMultiPackDispatcher == null) {
                this.mMultiPackDispatcher = new MultiPackDispatcher(this.mContext, this.mWallpaperLogger, this.mPluginLockUtils, this.mSelectedUserInteractor.getSelectedUserId());
            }
