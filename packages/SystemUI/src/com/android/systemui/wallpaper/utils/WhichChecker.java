...
public class WhichChecker {
    public static int convertDisplayIdToMode(int i, Context context) {
        ...
        ClockEventController$$ExternalSyntheticOutline0.m(i, "convertDisplayIdToMode: unexpected display id. id=", "WhichChecker");
        return -1;
    }
    ...
    public static boolean isVirtualDisplay(int i) {
        return LsRune.COVER_VIRTUAL_DISPLAY && isFlagEnabled(i, 32);
    }
