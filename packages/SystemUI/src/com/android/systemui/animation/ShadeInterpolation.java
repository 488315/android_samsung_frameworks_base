...
public final class ShadeInterpolation {
    ...
    public static final float getContentAlpha(float f) {
        float fConstrainedMap = MathUtils.constrainedMap(0.0f, 1.0f, 0.3f, 1.0f, f);
        INSTANCE.getClass();
        return interpolateEaseInOut(fConstrainedMap);
    }

    public static final float getNotifContentAlpha(float f) {
        float fConstrainedMap = MathUtils.constrainedMap(0.0f, 1.0f, 0.45f, 1.0f, f);
        INSTANCE.getClass();
        return interpolateEaseInOut(fConstrainedMap);
    }

    public static final float getNotificationScrimAlpha(float f) {
        float fConstrainedMap = MathUtils.constrainedMap(0.0f, 1.0f, 0.0f, 0.5f, f);
        INSTANCE.getClass();
        return interpolateEaseInOut(fConstrainedMap);
    }
