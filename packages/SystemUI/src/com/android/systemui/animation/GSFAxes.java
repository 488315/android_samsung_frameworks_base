...
public final class GSFAxes {
    ...
    static {
        ...
        List<AxisDefinition> asList = Arrays.asList(axisDefinition, axisDefinition2, axisDefinition3, axisDefinition4, new AxisDefinition("GRAD", 0.0f, 0.0f, 100.0f, 1.0f), new AxisDefinition("opsz", 6.0f, 18.0f, 144.0f, 1.0f), new AxisDefinition("ITAL", 0.0f, 0.0f, 1.0f, 0.1f));
        ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(asList, 10));
        for (AxisDefinition axisDefinition5 : asList) {
