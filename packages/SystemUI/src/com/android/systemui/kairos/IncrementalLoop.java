    ...
    public IncrementalLoop(String str) {
        ...
        this.init = new Init(str, new Function1() { // from class: com.android.systemui.kairos.IncrementalLoop$$ExternalSyntheticLambda0
            ...
            public final Object mo781invoke(Object obj) {
                return (IncrementalImpl) ((Incremental) this.f$0.deferred.getValue()).getInit$frameworks__base__packages__SystemUI__utils__kairos__android_common__kairos().connect((NetworkScope) obj);
            }
        });
    }
