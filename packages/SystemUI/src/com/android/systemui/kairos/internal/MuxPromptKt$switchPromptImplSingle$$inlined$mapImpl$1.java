...
public final class MuxPromptKt$switchPromptImplSingle$$inlined$mapImpl$1 implements EventsImpl {
    public final /* synthetic */ EventsImpl $switchPromptImpl$inlined;
    public final /* synthetic */ Function3 $transform$inlined;

    public MuxPromptKt$switchPromptImplSingle$$inlined$mapImpl$1(Function3 function3, EventsImpl eventsImpl) {
        this.$transform$inlined = function3;
        this.$switchPromptImpl$inlined = eventsImpl;
    }
    ...
    public final ActivationResult activate(EvalScope evalScope, Schedulable schedulable) {
        ActivationResult activationResultActivate = this.$switchPromptImpl$inlined.activate(evalScope, schedulable);
