...
public class WalletActivity extends ComponentActivity implements QuickAccessWalletClient.WalletServiceEventListener {
    ...
    /* JADX WARN: Type inference failed for: r12v3, types: [com.android.systemui.wallet.ui.WalletActivity$$ExternalSyntheticLambda0] */
    /* JADX WARN: Type inference failed for: r12v4, types: [com.android.systemui.wallet.ui.WalletActivity$$ExternalSyntheticLambda0] */
                                ...
                                if (!walletActivity.mKeyguardStateController.isUnlocked()) {
                                    ...
                                    walletActivity.mKeyguardDismissUtil.executeWhenUnlocked(new ActivityStarter.OnDismissAction() { // from class: com.android.systemui.wallet.ui.WalletActivity$$ExternalSyntheticLambda2
                                        ...
                                        public final boolean onDismiss() {
                                            ...
                                            walletActivity2.mActivityStarter.startActivity(walletActivity2.mWalletClient.createWalletIntent(), true, null, true, walletActivity2.mWalletClient.getUser());
                                    ...
                                    walletActivity.mActivityStarter.startActivity(walletActivity.mWalletClient.createWalletIntent(), true, null, true, walletActivity.mWalletClient.getUser());
    ...
    public final void onResume() {
        ...
        Utils.getColorAttrDefaultColor(this, android.R.^attr-private.closeItemLayout, 0);
