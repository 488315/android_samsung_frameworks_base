...
final class RetailModeSettingsRepository$retailMode$1 extends SuspendLambda implements Function2 {
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [android.database.ContentObserver, com.android.systemui.retail.data.repository.impl.RetailModeSettingsRepository$retailMode$1$observer$1] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ?? r1 = new ContentObserver() { // from class: com.android.systemui.retail.data.repository.impl.RetailModeSettingsRepository$retailMode$1$observer$1
                {
                    super(null);
                }
