...
public final class PrivacyType {
    ...
    static {
        ...
        PrivacyType privacyType3 = new PrivacyType("TYPE_LOCATION", 2, R.string.privacy_type_location, R.drawable.stat_sys_privacy_location, "android.permission-group.LOCATION", "location");
