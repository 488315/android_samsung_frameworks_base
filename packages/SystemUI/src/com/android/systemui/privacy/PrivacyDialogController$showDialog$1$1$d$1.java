...
final /* synthetic */ class PrivacyDialogController$showDialog$1$1$d$1 extends FunctionReferenceImpl implements Function4 {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        if (intent == null) {
            ...
            intent.putExtra("android.intent.extra.USER", UserHandle.of(iIntValue));
        }
        privacyDialogController.uiEventLogger.log(PrivacyDialogEvent.PRIVACY_DIALOG_ITEM_CLICKED_TO_APP_SETTINGS, iIntValue, str);
        ...
        privacyDialogController.activityStarter.startActivity(intent, true, new ActivityStarter.Callback() { // from class: com.android.systemui.privacy.PrivacyDialogController$startActivity$1
            ...
            public final void onActivityStarted(int i2) {
                boolean zIsStartResultSuccessful = ActivityManager.isStartResultSuccessful(i2);
                PrivacyDialogController privacyDialogController2 = privacyDialogController;
                if (zIsStartResultSuccessful) {
