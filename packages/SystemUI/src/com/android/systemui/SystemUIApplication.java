...
import com.android.app.viewcapture.ViewCapture$$ExternalSyntheticLambda6;
...
public class SystemUIApplication extends Application implements SystemUIAppComponentFactoryBase.ContextInitializer, HasWMComponent {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.mServicesStarted) {
            if (this.mThemeHelper != null && (configuration2 = getResources().getConfiguration()) != null && (configuration2.updateFrom(Configuration.generateDelta(configuration2, configuration)) & (-2147418112)) != 0) {
                try {
            ...
            if (Trace.isEnabled()) {
                Trace.traceBegin(4096L, configurationForwarder.getClass().getSimpleName().concat(".onConfigurationChanged()"));
            }
            ((ConfigurationControllerImpl) configurationForwarder).onConfigurationChanged(configuration);
            Trace.endSection();
    ...
    public final void onCreate() {
        ...
        ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(gPUContextPriority, "Found SurfaceFlinger's GPU Priority: ", "SystemUIService");
                ...
                if (set == null || hashSet.containsAll(set)) {
                    ...
                    timeInitialization(name, new Runnable() { // from class: com.android.systemui.SystemUIApplication$$ExternalSyntheticLambda3
                        ...
                        public final void run() {
                            ...
                            Log.d("SystemUIService", "loading: ".concat(str3));
                            if (Trace.isEnabled()) {
    ...
    public final void startSystemUserServicesIfNeeded() {
        ...
        } : new ViewCapture$$ExternalSyntheticLambda6()));
