...
public interface PluginKeyguardStatusView extends Plugin {
    ...
    public interface Callback {
        ...
        @VersionCheck(version = 3027)
        void applyBlur(View view, int i);
    ...
    @VersionCheck(version = 3025)
    void onConfigurationChanged(Configuration configuration);

    void onDensityOrFontScaleChanged();

    @VersionCheck(version = 4002)
    ...
    @VersionCheck(version = 3026)
    void onNioLayoutUpdated(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f);

    @VersionCheck(version = VolteConstants.ErrorCode.MDMN_CALL_FORWARDED)
    void onNioLayoutUpdated(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f);

    @VersionCheck(version = 3029)
    void onNioViewStateUpdated(float f, int i);
    ...
    void setIsDesktopStandAlone(boolean z);

    void setIsExternalDesktopWindowing(boolean z);
    ...
    @VersionCheck(version = 4005)
    void updateBarState(int i);

    @VersionCheck(version = 4004)
    void updateNowBarVisibility(int i);
}
