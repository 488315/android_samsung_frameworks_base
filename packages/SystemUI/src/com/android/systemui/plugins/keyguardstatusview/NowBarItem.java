...
public class NowBarItem {
    ...
    public static final String EXTRA_PENDING_INTENT_ON_SUB_SCREEN = "android.pendingIntentOnSubScreen";
    ...
    private RemoteViews chronometerViewOnSubScreen;
    private View contentViewForExpandCard;
    private View contentViewForExpandCardOnSubScreen;
    private View contentViewForNormalCard;
    private View contentViewForNormalCardOnSubScreen;
    ...
    private RemoteViews ongoingExpandViewOnSubScreen;
    private RemoteViews ongoingNowbarView;
    private RemoteViews ongoingNowbarViewOnSubScreen;
    private PendingIntent pendingIntent;
    private PendingIntent pendingIntentOnSubScreen;
    ...
    public NowBarItem() {
        ...
        this.pendingIntentOnSubScreen = null;
        this.chipIcon = null;
        ...
        this.contentViewForNormalCardOnSubScreen = null;
        this.contentViewForExpandCard = null;
        this.contentViewForExpandCardOnSubScreen = null;
    ...
    public RemoteViews getChronometerViewOnSubScreen() {
        return this.chronometerViewOnSubScreen;
    }
    ...
    public View getContentViewForExpandCardOnSubScreen() {
        return this.contentViewForExpandCardOnSubScreen;
    }
    ...
    public View getContentViewForNormalCardOnSubScreen() {
        return this.contentViewForNormalCardOnSubScreen;
    }
    ...
    public RemoteViews getOngoingExpandViewOnSubScreen() {
        return this.ongoingExpandViewOnSubScreen;
    }
    ...
    public RemoteViews getOngoingNowbarViewOnSubScreen() {
        return this.ongoingNowbarViewOnSubScreen;
    }
    ...
    public PendingIntent getPendingIntentOnSubScreen() {
        return this.pendingIntentOnSubScreen;
    }
    ...
    public boolean isCall() {
        ...
        return bundle != null && (bundle.getInt("nowbar_key_call_type", 0) == 1 || this.extraData.getInt("nowbar_key_call_type", 0) == 2);
    }
    ...
    public void setChronometerViewOnSubScreen(RemoteViews remoteViews) {
        this.chronometerViewOnSubScreen = remoteViews;
    }
    ...
    public void setContentViewForExpandCardOnSubScreen(View view) {
        this.contentViewForExpandCardOnSubScreen = view;
    }
    ...
    public void setContentViewForNormalCardOnSubScreen(View view) {
        this.contentViewForNormalCardOnSubScreen = view;
    }
    ...
    public void setOngoingExpandViewOnSubScreen(RemoteViews remoteViews) {
        this.ongoingExpandViewOnSubScreen = remoteViews;
    }
    ...
    public void setOngoingNowbarViewOnSubScreen(RemoteViews remoteViews) {
        this.ongoingNowbarViewOnSubScreen = remoteViews;
    }
    ...
    public void setPendingIntentOnSubScreen(PendingIntent pendingIntent) {
        this.pendingIntentOnSubScreen = pendingIntent;
    }
    ...
    public String toString() {
        if (isCall()) {
            return OpaqueKey$$ExternalSyntheticOutline0.m(new StringBuilder("NowBarItem{notiID="), this.notiID, '}');
        }
        return "NowBarItem{notiID=" + this.notiID + ", nowBarKey='" + this.nowBarKey + ", nowBarPackage='" + this.nowBarPackage + ", nowBarViewStyle=" + this.nowBarViewStyle + ", userId=" + this.userId + ", pendingIntent=" + this.pendingIntent + ", pendingIntentOnSubScreen=" + this.pendingIntentOnSubScreen + ", chipIcon=" + this.chipIcon + ", expandedChipView=" + this.expandedChipView + ", chipBackground=" + this.chipBackground + ", actions=" + this.actions + ", actionBgColors=" + this.actionBgColors + ", primaryActionNum=" + this.primaryActionNum + ", cardIcon=" + this.cardIcon + ", cardIconBg=" + this.cardIconBg + ", primaryInfo='" + this.primaryInfo + ", primaryInfoColor=" + this.primaryInfoColor + ", secondaryInfo='" + this.secondaryInfo + ", secondaryInfoColor=" + this.secondaryInfoColor + ", moreInfo='" + this.moreInfo + ", customExpandedCardView=" + this.customExpandedCardView + ", cardBackground=" + this.cardBackgroundColor + ", faceWidgetMediaData=" + this.faceWidgetMediaData + ", expandedChipText=" + ((Object) this.expandedChipText) + ", chronometerView=" + this.chronometerView + ", chronometerViewOnSubScreen=" + this.chronometerViewOnSubScreen + ", chronometerTag=" + this.chronometerTag + ", shouldRemoveCard=" + this.shouldRemoveCard + ", contentViewForNormalCard=" + this.contentViewForNormalCard + ", contentViewForExpandCardOnSubScreen=" + this.contentViewForExpandCardOnSubScreen + ", contentViewForNormalCard=" + this.contentViewForNormalCard + ", contentViewForExpandCardOnSubScreen=" + this.contentViewForExpandCardOnSubScreen + '}';
    }
    ...
    public NowBarItem(Intent intent) {
        try {
            ...
            setPendingIntentOnSubScreen((PendingIntent) intent.getParcelableExtra(EXTRA_PENDING_INTENT_ON_SUB_SCREEN, PendingIntent.class));
