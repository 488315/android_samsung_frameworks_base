...
public interface PluginSubScreen extends Plugin {
    ...
    default Rect getNowTouchableRect() {
        return null;
    }
    ...
    public interface Callback {
        ...
        default ActivityOptions getRemoteTransitionOption() {
        ...
        default void setDisplayStateOverrideWithDisplayId(int i, int i2) {
        }

        default void setBatteryMeterViewColor(int i, int i2, float f) {
        }
    }
    ...
    default void onCoverOccludedStateChanged(boolean z) {
    }
    ...
    default void requestDismissBouncer() {
    }

    default void onBiometricRunningStateChanged(boolean z, int i) {
    }

    default void onEnterRemoteTransition(SubScreenSurfaceControl subScreenSurfaceControl, ComponentName componentName) {
    }
    ...
    default void onExitRemoteTransition(SubScreenSurfaceControl subScreenSurfaceControl, ComponentName componentName) {
    }
