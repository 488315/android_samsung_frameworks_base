...
public final class MediaMuteAwaitConnectionCli implements CoreStartable {
    ...
    public final class MuteAwaitCommand implements Command {
        ...
        public final void execute(PrintWriter printWriter, List list) throws NumberFormatException {
            int i = Integer.parseInt((String) list.get(0));
            String str = (String) list.get(1);
            EmptyList emptyList = EmptyList.INSTANCE;
            AudioDeviceAttributes audioDeviceAttributes = new AudioDeviceAttributes(2, i, "address", str, emptyList, emptyList);
            String str2 = (String) list.get(2);
            boolean zAreEqual = Intrinsics.areEqual(str2, NetworkAnalyticsConstants.DataPoints.OPEN_TIME);
    ...
    public final void start() {
        this.commandRegistry.registerCommand("media-mute-await", new Function0() { // from class: com.android.systemui.media.muteawait.MediaMuteAwaitConnectionCli$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                ...
                return this.f$0.new MuteAwaitCommand();
            }
        });
    }
}
