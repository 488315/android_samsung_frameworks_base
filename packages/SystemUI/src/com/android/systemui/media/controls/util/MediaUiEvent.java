...
public final class MediaUiEvent implements UiEventLogger.UiEventEnum {
    ...
    public static final MediaUiEvent MEDIA_CAROUSEL_LOCATION_STATUS_BAR_POPUP;
    ...
    public static final MediaUiEvent MEDIA_OPEN_BROADCAST_DIALOG = null;
    ...
    static {
        ...
        MediaUiEvent mediaUiEvent7 = new MediaUiEvent("RESUME_MEDIA_ADDED", 6, EnterpriseContainerCallback.CONTAINER_CHANGE_PWD_FAILED);
        RESUME_MEDIA_ADDED = mediaUiEvent7;
        MediaUiEvent mediaUiEvent8 = new MediaUiEvent("ACTIVE_TO_RESUME", 7, EnterpriseContainerCallback.CONTAINER_VERIFY_PWD_SUCCESSFUL);
        ACTIVE_TO_RESUME = mediaUiEvent8;
        MediaUiEvent mediaUiEvent9 = new MediaUiEvent("MEDIA_TIMEOUT", 8, EnterpriseContainerCallback.CONTAINER_VERIFY_PWD_FAILED);
        MEDIA_TIMEOUT = mediaUiEvent9;
        MediaUiEvent mediaUiEvent10 = new MediaUiEvent("MEDIA_REMOVED", 9, EnterpriseContainerCallback.CONTAINER_CANCELLED);
        ...
        MediaUiEvent mediaUiEvent29 = new MediaUiEvent("MEDIA_CAROUSEL_LOCATION_STATUS_BAR_POPUP", 28, 2170);
        MEDIA_CAROUSEL_LOCATION_STATUS_BAR_POPUP = mediaUiEvent29;
        MediaUiEvent mediaUiEvent30 = new MediaUiEvent("MEDIA_RECOMMENDATION_ADDED", 29, 1041);
        MediaUiEvent mediaUiEvent31 = new MediaUiEvent("MEDIA_RECOMMENDATION_REMOVED", 30, 1042);
        MediaUiEvent mediaUiEvent32 = new MediaUiEvent("MEDIA_RECOMMENDATION_ACTIVATED", 31, 1043);
        MediaUiEvent mediaUiEvent33 = new MediaUiEvent("MEDIA_RECOMMENDATION_ITEM_TAP", 32, 1044);
        MediaUiEvent mediaUiEvent34 = new MediaUiEvent("MEDIA_RECOMMENDATION_CARD_TAP", 33, 1045);
        MediaUiEvent mediaUiEvent35 = new MediaUiEvent("MEDIA_OPEN_BROADCAST_DIALOG", 34, 1079);
        MediaUiEvent mediaUiEvent36 = new MediaUiEvent("MEDIA_CAROUSEL_SINGLE_PLAYER", 35, 1244);
        MEDIA_CAROUSEL_SINGLE_PLAYER = mediaUiEvent36;
        MediaUiEvent mediaUiEvent37 = new MediaUiEvent("MEDIA_CAROUSEL_MULTIPLE_PLAYERS", 36, 1245);
        MEDIA_CAROUSEL_MULTIPLE_PLAYERS = mediaUiEvent37;
        MediaUiEvent[] mediaUiEventArr = {mediaUiEvent, mediaUiEvent2, mediaUiEvent3, mediaUiEvent4, mediaUiEvent5, mediaUiEvent6, mediaUiEvent7, mediaUiEvent8, mediaUiEvent9, mediaUiEvent10, mediaUiEvent11, mediaUiEvent12, mediaUiEvent13, mediaUiEvent14, mediaUiEvent15, mediaUiEvent16, mediaUiEvent17, mediaUiEvent18, mediaUiEvent19, mediaUiEvent20, mediaUiEvent21, mediaUiEvent22, mediaUiEvent23, mediaUiEvent24, mediaUiEvent25, mediaUiEvent26, mediaUiEvent27, mediaUiEvent28, mediaUiEvent29, mediaUiEvent30, mediaUiEvent31, mediaUiEvent32, mediaUiEvent33, mediaUiEvent34, mediaUiEvent35, mediaUiEvent36, mediaUiEvent37};
