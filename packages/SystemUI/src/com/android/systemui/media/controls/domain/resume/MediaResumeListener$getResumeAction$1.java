...
public final class MediaResumeListener$getResumeAction$1 implements Runnable {
    ...
    public final void run() {
        ...
        if (resumeMediaBrowser != null) {
            ...
            ResumeMediaBrowser.AnonymousClass3 anonymousClass3 = new MediaBrowser.ConnectionCallback() { // from class: com.android.systemui.media.controls.domain.resume.ResumeMediaBrowser.3
