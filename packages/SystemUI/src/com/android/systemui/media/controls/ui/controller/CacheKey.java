...
public final class CacheKey {
    ...
    public final int hashCode() {
        return Boolean.hashCode(this.gutsVisible) + FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.expansion, ReorderTile$$ExternalSyntheticOutline0.m(this.heightMeasureSpec, Integer.hashCode(this.widthMeasureSpec) * 31, 31), 31);
    }
