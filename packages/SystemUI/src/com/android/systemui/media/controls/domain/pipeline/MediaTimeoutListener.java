...
public final class MediaTimeoutListener implements MediaDataManager.Listener {
    ...
    public final class PlaybackStateListener extends MediaController.Callback {
        ...
        public final void onSessionDestroyed() {
            ...
            (legacyMediaDataManagerImpl$$ExternalSyntheticLambda2 != null ? legacyMediaDataManagerImpl$$ExternalSyntheticLambda2 : null).mo779invoke(this.key);
            destroy();
        }

        /* JADX WARN: Code restructure failed: missing block: B:28:0x009e, code lost:
        
            if (com.android.systemui.media.controls.domain.pipeline.MediaProcessingHelperKt.areCustomActionListsEqual(r7 != null ? r7.getCustomActions() : null, r11 != null ? r11.getCustomActions() : null) != false) goto L40;
         */
    ...
    public final void onMediaDataLoaded(final String str, String str2, final MediaData mediaData, boolean z) {
        Object obj;
        String m = AndroidCompositionLocals_androidKt$$ExternalSyntheticOutline0.m("run onMediaDataLoaded ", str);
        MediaTimeoutLogger mediaTimeoutLogger = this.logger;
        mediaTimeoutLogger.logCustomFromTimeout(str, m);
        ...
        if (playbackStateListener == null) {
            ...
            LogMessage obtain = logBuffer.obtain("MediaTimeout", LogLevel.DEBUG, new MediaTimeoutLogger$$ExternalSyntheticLambda0(9), null);
            ((LogMessageImpl) obtain).str1 = str;
            logBuffer.commit(obtain);
        ...
        if (str2 != null && !Intrinsics.areEqual(str, str2)) {
            ...
            boolean z2 = obj != null;
            LogMessage obtain2 = logBuffer.obtain("MediaTimeout", LogLevel.DEBUG, new MediaTimeoutLogger$$ExternalSyntheticLambda0(10), null);
        ...
        if (playbackStateListener2 != null) {
            this.bgExecutor.execute(new Runnable() { // from class: com.android.systemui.media.controls.domain.pipeline.MediaTimeoutListener$onMediaDataLoaded$2$1
                ...
                public final void run() {
                    ...
                    LogMessage obtain3 = logBuffer2.obtain("MediaTimeout", logLevel, mediaTimeoutLogger$$ExternalSyntheticLambda0, null);
                    ...
                    MediaTimeoutListener.this.mediaListeners.put(str5, playbackStateListener3);
                    if (isPlaying$1 != playbackStateListener2.isPlaying$1()) {
                        ...
                        delayableExecutor.execute(new Runnable() { // from class: com.android.systemui.media.controls.domain.pipeline.MediaTimeoutListener$onMediaDataLoaded$2$1.1
                            @Override // java.lang.Runnable
                            public final void run() {
                                MediaTimeoutListener.PlaybackStateListener playbackStateListener4 = (MediaTimeoutListener.PlaybackStateListener) ((LinkedHashMap) MediaTimeoutListener.this.mediaListeners).get(str6);
                                ...
                                LogMessage obtain4 = logBuffer3.obtain("MediaTimeout", logLevel2, mediaTimeoutLogger$$ExternalSyntheticLambda02, null);
                                ((LogMessageImpl) obtain4).str1 = str7;
