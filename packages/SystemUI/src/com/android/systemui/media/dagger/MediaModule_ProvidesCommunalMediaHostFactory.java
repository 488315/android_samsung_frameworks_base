...
public final class MediaModule_ProvidesCommunalMediaHostFactory implements Provider {
    ...
    public MediaModule_ProvidesCommunalMediaHostFactory(Provider provider, Provider provider2, Provider provider3, Provider provider4, Provider provider5, Provider provider6) {
    ...
    public static MediaHost providesCommunalMediaHost(MediaHost.MediaHostStateHolder mediaHostStateHolder, MediaHierarchyManager mediaHierarchyManager, MediaDataManager mediaDataManager, MediaHostStatesManager mediaHostStatesManager, MediaCarouselController mediaCarouselController, MediaCarouselControllerLogger mediaCarouselControllerLogger) {
