...
public final class CoverMusicWidgetController {
    ...
    public CoverMusicWidgetController(Consumer<SecMediaHost.MediaPanelVisibilityListener> consumer, Consumer<SecMediaHost.MediaPanelVisibilityListener> consumer2, SubScreenManager subScreenManager, WakefulnessLifecycle wakefulnessLifecycle) {
        ...
        this.enabled = true;
        this.onPlayerVisibilityListener$delegate = LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.media.CoverMusicWidgetController$$ExternalSyntheticLambda0
    ...
    public final void enableWidget(boolean z) {
        KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m("enabled: ", ", enable : ", "CoverMusicWidgetController", this.enabled, z);
        if (this.enabled == z) {
            return;
        }
        this.enabled = z;
