...
final class LabsViewModel$setGrayscaleThumbnail$1 extends SuspendLambda implements Function2 {
    final /* synthetic */ boolean $enabled;
    int label;
    final /* synthetic */ LabsViewModel this$0;

    /* renamed from: com.android.systemui.media.mediaoutput.viewmodel.LabsViewModel$setGrayscaleThumbnail$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LabsViewModel$setGrayscaleThumbnail$1(LabsViewModel labsViewModel, boolean z, Continuation continuation) {
        super(2, continuation);
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new LabsViewModel$setGrayscaleThumbnail$1(this.this$0, this.$enabled, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((LabsViewModel$setGrayscaleThumbnail$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
