...
final class LabsViewModel$setShowLabsMenu$1 extends SuspendLambda implements Function2 {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LabsViewModel$setShowLabsMenu$1(LabsViewModel labsViewModel, boolean z, Continuation continuation) {
        super(2, continuation);
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new LabsViewModel$setShowLabsMenu$1(this.this$0, this.$enabled, continuation);
    }
