...
final class SessionAudioPathViewModel$cancel$1 extends SuspendLambda implements Function2 {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new SessionAudioPathViewModel$cancel$1(this.this$0, this.$device, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((SessionAudioPathViewModel$cancel$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (deviceController != null) {
            deviceController.cancel(this.$device);
        }
