...
final class MusicShareDeviceController$Companion$castDeviceChanges$1 extends SuspendLambda implements Function2 {
    ...
    public static final StandaloneCoroutine invokeSuspend$updateDevices(ProducerScope producerScope, AudioManager audioManager) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            intentFilter.addAction("com.samsung.android.bluetooth.audiocast.action.device.AUDIO_SHARING_DEVICE_VOLUME_CHANGED");
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.media.mediaoutput.controller.device.MusicShareDeviceController$Companion$castDeviceChanges$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    AudioManager audioManager4 = audioManager3;
                    Context context3 = context2;
                    Log.d("MusicShareDeviceController", "unregisterAudioDeviceCallback");
                    audioManager4.unregisterAudioDeviceCallback(r1);
                    context3.unregisterReceiver(r3);
