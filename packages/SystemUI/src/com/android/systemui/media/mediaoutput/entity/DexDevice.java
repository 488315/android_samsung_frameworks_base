...
public final class DexDevice implements AudioDevice {
    ...
    public final int hashCode() {
        ...
        return Boolean.hashCode(this.cancelable) + ((this.state.hashCode() + ReorderTile$$ExternalSyntheticOutline0.m(this.volumeMax, ReorderTile$$ExternalSyntheticOutline0.m(this.volume, (hashCode + (painter != null ? painter.hashCode() : 0)) * 31, 31), 31)) * 31);
    }
