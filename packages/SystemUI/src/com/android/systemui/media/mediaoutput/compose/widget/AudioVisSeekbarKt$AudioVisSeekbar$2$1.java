...
final class AudioVisSeekbarKt$AudioVisSeekbar$2$1 extends SuspendLambda implements Function2 {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new AudioVisSeekbarKt$AudioVisSeekbar$2$1(this.$interactionSource, this.$isDragging, this.$onValueChangeFinished, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.media.mediaoutput.compose.widget.AudioVisSeekbarKt$AudioVisSeekbar$2$1.1
