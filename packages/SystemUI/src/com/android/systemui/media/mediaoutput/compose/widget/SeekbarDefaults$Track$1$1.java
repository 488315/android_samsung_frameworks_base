...
final class SeekbarDefaults$Track$1$1 extends SuspendLambda implements Function2 {
    ...
    final /* synthetic */ MutableState<Float> $trackHeight$delegate;
    final /* synthetic */ MutableState<Float> $trackRound$delegate;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SeekbarDefaults$Track$1$1(State<Boolean> state, MutableState<Float> mutableState, MutableState<Float> mutableState2, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        MutableState<Float> mutableState = this.$trackHeight$delegate;
        State<Boolean> state = this.$isDragging$delegate;
