...
public final class SmartMirroringClient {
    ...
    public final Flow connectionFlow = FlowKt.buffer$default(FlowKt.callbackFlow(new SmartMirroringClient$connectionFlow$1(this, null)), -1, 2);
    ...
    public final void stopScanMirroring() {
        Object failure;
        if ((this.isScanStarted ? this : null) == null) {
            return;
        }
