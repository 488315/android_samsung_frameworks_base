...
public final class RemoteDevice implements AudioDevice {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.volumeMax) + ReorderTile$$ExternalSyntheticOutline0.m(this.volume, ControlInfo$$ExternalSyntheticOutline0.m(this.id.hashCode() * 31, 31, this.name), 31);
    }
