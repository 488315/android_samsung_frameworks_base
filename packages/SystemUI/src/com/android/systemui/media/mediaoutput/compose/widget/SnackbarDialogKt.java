    ...
    public static final void SnackbarDialog(final SnackbarDialogImpl snackbarDialogImpl, final SnackbarData snackbarData, Composer composer, final int i) {
        ...
        if ((i4 & 19) == 18 && composerImpl5.getSkipping()) {
            ...
            if (objRememberedValue == Composer.Companion.Empty) {
                objRememberedValue = new SnackbarDialogKt$$ExternalSyntheticLambda0();
                composerImpl5.updateRememberedValue(objRememberedValue);
            }
            composerImpl5.end(false);
            Dp.Companion companion3 = Dp.Companion;
            Modifier modifierM144width3ABfNKs = SizeKt.m144width3ABfNKs(ClickableKt.m34clickableO2vRcR0$default(companion2, null, null, false, null, null, (Function0) objRememberedValue, 28), 340);
            ...
            long jColor = DarkThemeKt.isSystemInDarkTheme(composerImpl5) ? ColorKt.Color(4280624424L) : ColorKt.Color(4294769919L);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composerImpl5.end(false);
            Modifier modifierM26backgroundbw27NRU = BackgroundKt.m26backgroundbw27NRU(modifierM144width3ABfNKs, jColor, RoundedCornerShapeKt.m187RoundedCornerShape0680j_4(26));
            float f = 24;
            Modifier modifierM128paddingqDBjuR0 = PaddingKt.m128paddingqDBjuR0(modifierM26backgroundbw27NRU, f, f, f, 20);
            ...
            Modifier modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composerImpl5, modifierM128paddingqDBjuR0);
            ...
            Updater.m337setimpl(composerImpl5, columnMeasurePolicy, function25);
            Function2 function26 = ComposeUiNode.Companion.SetResolvedCompositionLocals;
            Updater.m337setimpl(composerImpl5, persistentCompositionLocalMapCurrentCompositionLocalScope, function26);
            ...
            Updater.m337setimpl(composerImpl5, modifierMaterializeModifier, function28);
            ...
            if (str2 == null) {
                ...
                long jColor2 = ColorKt.Color(DarkThemeKt.isSystemInDarkTheme(composerImpl5) ? 4294638335L : 4278255874L);
                TextUnitType.Companion.getClass();
                TextStyle textStyleM756copyp1EtxEg$default = TextStyle.m756copyp1EtxEg$default(secSemiBold, jColor2, TextUnitKt.pack(17.0f, TextUnitType.Sp), null, null, 0L, 0, 0L, null, null, 0, 16777212);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composerImpl5.end(false);
                ...
                function24 = function27;
                z = true;
                TextKt.m317Text4IGK_g(str2, null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, textStyleM756copyp1EtxEg$default, composerImpl5, 0, 0, 65534);
                ComposerImpl composerImpl6 = composerImpl5;
                SpacerKt.Spacer(composerImpl6, SizeKt.m131height3ABfNKs(companion, 12));
            ...
            long jColor3 = DarkThemeKt.isSystemInDarkTheme(composerImpl) ? ColorKt.Color(4293585643L) : ColorKt.Color(4280624424L);
            TextUnitType.Companion.getClass();
            TextStyle textStyleM756copyp1EtxEg$default2 = TextStyle.m756copyp1EtxEg$default(secRegular, jColor3, TextUnitKt.pack(14.0f, TextUnitType.Sp), null, null, 0L, 0, 0L, null, null, 0, 16777212);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composerImpl.end(r3);
            ComposerImpl composerImpl7 = composerImpl;
            TextKt.m317Text4IGK_g(snackbarDialogImpl.body, null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, textStyleM756copyp1EtxEg$default2, composerImpl7, 0, 0, 65534);
            ...
            if (((ArrayList) snackbarDialogImpl.actions).isEmpty()) {
                ...
                SpacerKt.Spacer(composerImpl8, SizeKt.m131height3ABfNKs(companion, 17));
                ...
                PersistentCompositionLocalMap persistentCompositionLocalMapCurrentCompositionLocalScope2 = composerImpl8.currentCompositionLocalScope();
                Modifier modifierMaterializeModifier2 = ComposedModifierKt.materializeModifier(composerImpl8, companion);
                ...
                Updater.m337setimpl(composerImpl8, rowMeasurePolicy, function2);
                Updater.m337setimpl(composerImpl8, persistentCompositionLocalMapCurrentCompositionLocalScope2, function23);
                ...
                Updater.m337setimpl(composerImpl8, modifierMaterializeModifier2, function22);
                RowScopeInstance rowScopeInstance = RowScopeInstance.INSTANCE;
                final List listReversed = CollectionsKt___CollectionsKt.reversed(snackbarDialogImpl.actions);
                ButtonDefaults.INSTANCE.getClass();
                ButtonColors buttonColors2 = ButtonDefaults.buttonColors(composerImpl8);
                Color.Companion.getClass();
                ButtonColors buttonColorsM251copyjRlVdoo = buttonColors2.m251copyjRlVdoo(Color.Transparent, ((Color) composerImpl8.consume(ContentColorKt.LocalContentColor)).value, buttonColors2.disabledContainerColor, buttonColors2.disabledContentColor);
                float f2 = (float) r3;
                PaddingValuesImpl paddingValuesImplM121PaddingValuesYgX7TsA = PaddingKt.m121PaddingValuesYgX7TsA(f2, f2);
                ...
                for (Object obj : listReversed) {
                    ...
                    if (i5 > 0) {
                        buttonColors = buttonColorsM251copyjRlVdoo;
                        Modifier modifierM127paddingVpY3zN4$default = PaddingKt.m127paddingVpY3zN4$default(SizeKt.m131height3ABfNKs(Modifier.Companion, 16), 6, 0.0f, 2);
                        ...
                        long jColor4 = ColorKt.Color(DarkThemeKt.isSystemInDarkTheme(composerImpl9) ? 4282861386L : 4293519852L);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        ...
                        i2 = i5;
                        str = str3;
                        DividerKt.m264VerticalDivider9IZ8Weo(modifierM127paddingVpY3zN4$default, 0.0f, jColor4, composer2, 6, 2);
                    ...
                    boolean zChanged = composerImpl3.changed(i2) | composerImpl3.changedInstance(listReversed) | ((i4 & 112) == 32 ? z : r3);
                    Object objRememberedValue2 = composerImpl3.rememberedValue();
                    if (zChanged || objRememberedValue2 == Composer.Companion.Empty) {
                        objRememberedValue2 = new Function0() { // from class: com.android.systemui.media.mediaoutput.compose.widget.SnackbarDialogKt$$ExternalSyntheticLambda1
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                int size = listReversed.size() - 1;
                                int i7 = i2;
                    ...
                    composerImpl3.end(r3);
                    Modifier modifierWeight = rowScopeInstance.weight(Modifier.Companion, 1.0f, z);
                    ComposableLambdaImpl composableLambdaImplRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1140690427, new Function3() { // from class: com.android.systemui.media.mediaoutput.compose.widget.SnackbarDialogKt$SnackbarDialog$2$2$1$2
                        ...
                        public final Object invoke(Object obj2, Object obj3, Object obj4) {
                            ...
                            if ((((Number) obj4).intValue() & 17) == 16) {
                                ...
                                if (composerImpl10.getSkipping()) {
                                    ...
                                    long jColor5 = ColorKt.Color(DarkThemeKt.isSystemInDarkTheme(composerImpl11) ? 4294638335L : 4278255874L);
                                    TextUnitType.Companion.getClass();
                                    TextStyle textStyleM756copyp1EtxEg$default3 = TextStyle.m756copyp1EtxEg$default(secSemiBold2, jColor5, TextUnitKt.pack(18.0f, TextUnitType.Sp), null, null, 0L, 0, 0L, null, null, 0, 16777212);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                    composerImpl11.end(false);
                                    TextKt.m317Text4IGK_g(str, null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, textStyleM756copyp1EtxEg$default3, composer3, 0, 0, 65534);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                }
                    ...
                    PaddingValuesImpl paddingValuesImpl = paddingValuesImplM121PaddingValuesYgX7TsA;
                    ComposerImpl composerImpl10 = composerImpl3;
                    ButtonColors buttonColors3 = buttonColors;
                    ButtonKt.Button(function03, modifierWeight, false, null, buttonColors3, null, null, paddingValuesImpl, null, composableLambdaImplRememberComposableLambda, composerImpl10, 817889280, 364);
                    buttonColorsM251copyjRlVdoo = buttonColors3;
                    paddingValuesImplM121PaddingValuesYgX7TsA = paddingValuesImpl;
                    i5 = i6;
                    listReversed = list;
                    z = true;
            ...
            boolean zM = AnimatedContentKt$$ExternalSyntheticOutline0.m(composerImpl2, r3, z2);
        ...
        if (recomposeScopeImplEndRestartGroup != null) {
            recomposeScopeImplEndRestartGroup.block = new Function2() { // from class: com.android.systemui.media.mediaoutput.compose.widget.SnackbarDialogKt$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj2, Object obj3) {
                    ((Integer) obj3).intValue();
                    int iUpdateChangedFlags = RecomposeScopeImplKt.updateChangedFlags(i | 1);
                    SnackbarDialogKt.SnackbarDialog(snackbarDialogImpl, snackbarData, (Composer) obj2, iUpdateChangedFlags);
                    return Unit.INSTANCE;
                }
            };
        }
