...
final class WifiDisplayDeviceController$Companion$activeVolumeChanges$1 extends SuspendLambda implements Function2 {
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Consumer consumer = new Consumer() { // from class: com.android.systemui.media.mediaoutput.controller.device.WifiDisplayDeviceController$Companion$activeVolumeChanges$1$listener$1
                ...
                public final void accept(Object obj2) {
                    DisplayManagerWrapper displayManagerWrapper2 = displayManagerWrapper;
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$this_activeVolumeChanges, consumer, null);
        ...
        producerScope = (ProducerScope) this.L$0;
        ResultKt.throwOnFailure(obj);
        final DisplayManagerWrapper displayManagerWrapper2 = this.$this_activeVolumeChanges;
        Function0 function0 = new Function0() { // from class: com.android.systemui.media.mediaoutput.controller.device.WifiDisplayDeviceController$Companion$activeVolumeChanges$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Log.d("WifiDisplayDeviceController", "unregisterDisplayVolumeListener");
                DisplayManagerWrapper displayManagerWrapper3 = displayManagerWrapper2;
                if (displayManagerWrapper3.displayVolumeListener != null) {
                    SystemServiceExtension systemServiceExtension = SystemServiceExtension.INSTANCE;
                    Context context = displayManagerWrapper3.context;
                    systemServiceExtension.getClass();
                    SystemServiceExtension.getDisplayManager(context).semUnregisterDisplayVolumeListener(displayManagerWrapper3.displayVolumeListener);
                }
                return Unit.INSTANCE;
            }
        };
