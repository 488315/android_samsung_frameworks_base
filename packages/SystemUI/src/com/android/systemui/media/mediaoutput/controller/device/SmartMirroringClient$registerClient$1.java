...
final class SmartMirroringClient$registerClient$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Log.d("SmartMirroringClient", "registerClient()");
                ...
                public final void handleMessage(Message message) {
                    ...
                    switch (message.what) {
                        case 1:
                            ...
                            if (string == null || (deviceInfo = (DeviceInfo) new Gson().fromJson(string, DeviceInfo.class)) == null) {
                                deviceInfo = null;
                            } else {
                        ...
                        case 2:
                            ...
                            if (string2 == null || (deviceInfo2 = (DeviceInfo) new Gson().fromJson(string2, DeviceInfo.class)) == null) {
                                deviceInfo2 = null;
                            } else {
                        ...
                        case 3:
                            ...
                            if (string3 == null || (deviceInfo3 = (DeviceInfo) new Gson().fromJson(string3, DeviceInfo.class)) == null) {
                                deviceInfo3 = null;
                            } else {
