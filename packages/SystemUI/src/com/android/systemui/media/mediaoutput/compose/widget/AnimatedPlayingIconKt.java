...
public abstract class AnimatedPlayingIconKt {
    public static final void AnimatedPlayingIcon(List list, final Modifier modifier, final long j, Composer composer, final int i) {
        ...
        if ((i2 & 147) == 146 && composerImpl.getSkipping()) {
            ...
            boolean zChangedInstance = ((i2 & 896) == 256) | composerImpl.changedInstance(list2);
            ...
            if (zChangedInstance || objRememberedValue2 == composer$Companion$Empty$1) {
                ...
                objRememberedValue2 = animatedPlayingIconKt$AnimatedPlayingIcon$1$1;
            } else {
                mutableState = mutableState2;
            }
            composerImpl.end(false);
            ...
            CrossfadeKt.Crossfade(list2.get(((Number) mutableState.getValue()).intValue()), (Modifier) null, (FiniteAnimationSpec) null, (String) null, ComposableLambdaKt.rememberComposableLambda(-1146096476, new Function3() { // from class: com.android.systemui.media.mediaoutput.compose.widget.AnimatedPlayingIconKt.AnimatedPlayingIcon.2
                ...
                */
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    ...
                    if ((iIntValue & 6) == 0) {
                        iIntValue |= ((ComposerImpl) composer2).changed(imageVector) ? 4 : 2;
                    }
                    if ((iIntValue & 19) == 18) {
                        ...
                        if (composerImpl2.getSkipping()) {
                            ...
                            IconKt.m271Iconww6aTOc(imageVector, "", modifier, 0L, composer2, (iIntValue & 14) | 48, 8);
                            if (ComposerKt.isTraceInProgress()) {
        ...
        if (recomposeScopeImplEndRestartGroup != null) {
            recomposeScopeImplEndRestartGroup.block = new Function2() { // from class: com.android.systemui.media.mediaoutput.compose.widget.AnimatedPlayingIconKt$$ExternalSyntheticLambda1
    ...
    public static final void EqualizerPlayingIcon(final Modifier.Companion companion, final long j, Composer composer, final int i) {
        ...
        RecomposeScopeImpl recomposeScopeImplEndRestartGroup = composerImpl.endRestartGroup();
        if (recomposeScopeImplEndRestartGroup != null) {
            recomposeScopeImplEndRestartGroup.block = new Function2(j, i) { // from class: com.android.systemui.media.mediaoutput.compose.widget.AnimatedPlayingIconKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    AnimatedPlayingIconKt.EqualizerPlayingIcon(this.f$0, this.f$1, (Composer) obj, iUpdateChangedFlags);
                    return Unit.INSTANCE;
                }
            };
        }
