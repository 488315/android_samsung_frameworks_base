    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object objSend = ((ChannelCoroutine) producerScope2)._channel.send(emptyList, this);
        ...
        final ?? r7 = new MediaSessionManager.OnActiveSessionsChangedListener() { // from class: com.android.systemui.media.mediaoutput.viewmodel.MediaSessionViewModel$Companion$activeMediaChanges$1$listener$1
        ...
        this.$this_activeMediaChanges.addOnActiveSessionsChangedListener(r7, null);
        final MediaSessionManager mediaSessionManager = this.$this_activeMediaChanges;
        Function0 function0 = new Function0() { // from class: com.android.systemui.media.mediaoutput.viewmodel.MediaSessionViewModel$Companion$activeMediaChanges$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                MediaSessionManager mediaSessionManager2 = mediaSessionManager;
                MediaSessionViewModel$Companion$activeMediaChanges$1$listener$1 mediaSessionViewModel$Companion$activeMediaChanges$1$listener$1 = r7;
                Log.d("MediaSessionViewModel", "removeOnActiveSessionsChangedListener");
                mediaSessionManager2.removeOnActiveSessionsChangedListener(mediaSessionViewModel$Companion$activeMediaChanges$1$listener$1);
                return Unit.INSTANCE;
            }
        };
        this.L$0 = null;
