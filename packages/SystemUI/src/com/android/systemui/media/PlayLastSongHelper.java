...
public final class PlayLastSongHelper {
    ...
    public final ImageView playLastSongIcon;
    ...
    public PlayLastSongHelper(View view, Context context, Consumer<SecMediaHost.MediaPanelVisibilityListener> consumer, Consumer<SecMediaHost.MediaPanelVisibilityListener> consumer2, ColoredBGHelper coloredBGHelper) {
        ...
        final int i = 0;
        Lazy lazy = LazyKt__LazyJVMKt.lazy(new Function0(this) { // from class: com.android.systemui.media.PlayLastSongHelper$$ExternalSyntheticLambda0
            public final /* synthetic */ PlayLastSongHelper f$0;
            ...
            public final Object invoke() {
                final PlayLastSongHelper playLastSongHelper = this.f$0;
                switch (i) {
                    case 0:
                        int i2 = PlayLastSongHelper.$r8$clinit;
                    ...
                    case 1:
                        int i3 = PlayLastSongHelper.$r8$clinit;
                    ...
                    default:
                        int i4 = PlayLastSongHelper.$r8$clinit;
        ...
        final int i2 = 1;
        this.onMediaKeyEventSessionChangeListener$delegate = LazyKt__LazyJVMKt.lazy(new Function0(this) { // from class: com.android.systemui.media.PlayLastSongHelper$$ExternalSyntheticLambda0
            public final /* synthetic */ PlayLastSongHelper f$0;
            ...
            public final Object invoke() {
                ...
                switch (i2) {
                    case 0:
                        int i22 = PlayLastSongHelper.$r8$clinit;
                        return new View.OnClickListener() { // from class: com.android.systemui.media.PlayLastSongHelper$onClickListener$2$1
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                                PlayLastSongHelper playLastSongHelper2 = PlayLastSongHelper.this;
        ...
        final int i3 = 2;
        this.onPlayerVisibilityListener$delegate = LazyKt__LazyJVMKt.lazy(new Function0(this) { // from class: com.android.systemui.media.PlayLastSongHelper$$ExternalSyntheticLambda0
            public final /* synthetic */ PlayLastSongHelper f$0;
            ...
            public final Object invoke() {
                ...
                switch (i3) {
                    ...
                    case 1:
                        int i32 = PlayLastSongHelper.$r8$clinit;
                        return new SemSoundAssistantManager.OnMediaKeyEventSessionChangedListener() { // from class: com.android.systemui.media.PlayLastSongHelper$onMediaKeyEventSessionChangeListener$2$1
                            public final void onMediaKeyEventSessionChanged(String str, MediaSession.Token token) {
                                MediaController mediaController;
                                KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m("OnMediaKeyEventSessionChanged ", "  ", "PlayLastSongHelper", str != null, token != null);
        ...
        this.playLastSongIcon = (ImageView) frameLayout2.requireViewById(R.id.sec_play_last_song_icon);
    ...
    public final void enableWidget(boolean z) {
        KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m("enabled: ", ", enable : ", "PlayLastSongHelper", this.enabled, z);
        if (this.enabled == z) {
            return;
        }
        this.enabled = z;
        if (z) {
            ...
            this.playLastSongIcon.setImageResource(R.drawable.ic_media_play_solid);
            return;
        }
        ...
        this.playLastSongIcon.setImageResource(R.drawable.ic_musicnote_small);
    }
    ...
    public final void updateRestartViewVisibility() {
        ...
        EmergencyButtonController$$ExternalSyntheticOutline0.m("updateRestartViewVisibility ", "PlayLastSongHelper", this.playerVisible);
