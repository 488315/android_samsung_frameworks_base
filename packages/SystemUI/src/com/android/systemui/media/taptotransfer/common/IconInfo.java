...
public final class IconInfo {
    ...
    public final TintedIcon toTintedIcon() {
        ...
        if (mediaTttIcon instanceof MediaTttIcon.Loaded) {
            resource = new Icon.Loaded(((MediaTttIcon.Loaded) mediaTttIcon).drawable, this.contentDescription, null, 4, null);
        } else {
            if (!(mediaTttIcon instanceof MediaTttIcon.Resource)) {
                throw new NoWhenBranchMatchedException();
            }
            resource = new Icon.Resource(((MediaTttIcon.Resource) mediaTttIcon).res, this.contentDescription);
        }
