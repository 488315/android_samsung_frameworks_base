...
public final class MediaTttReceiverRippleController {
    ...
    public static final void access$layoutIconRipple(MediaTttReceiverRippleController mediaTttReceiverRippleController, ReceiverChipRippleView receiverChipRippleView) {
        ...
        receiverChipRippleView.setCenter(fWidth * 0.5f, (fHeight - (mediaTttReceiverRippleController.getReceiverIconSize$frameworks__base__packages__SystemUI__android_common__SystemUI_core() * 0.5f)) - mediaTttReceiverRippleController.context.getResources().getDimensionPixelSize(R.dimen.media_ttt_receiver_icon_bottom_margin));
    ...
    public final void layoutRipple(ReceiverChipRippleView receiverChipRippleView, boolean z) {
        ...
        float fWidth = bounds.width();
        if (z) {
            this.maxRippleHeight = fHeight * 2.0f;
            this.maxRippleWidth = 2.0f * fWidth;
        } else {
        ...
        receiverChipRippleView.setCenter(fWidth * 0.5f, fHeight);
