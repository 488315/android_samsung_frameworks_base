...
public class RingtonePlayer implements CoreStartable {
    ...
    public final AnonymousClass1 mCallback = new IRingtonePlayer.Stub() { // from class: com.android.systemui.media.RingtonePlayer.1
        ...
        public final String getTitle(Uri uri) {
            RingtonePlayer.m2625$$Nest$menforceUriUserId(RingtonePlayer.this, uri);
            return Ringtone.getTitle(RingtonePlayer.m2626$$Nest$mgetContextForUser(RingtonePlayer.this, Binder.getCallingUserHandle()), uri, false, false);
        }
        ...
        public final ParcelFileDescriptor openRingtone(Uri uri) {
            Uri uri2;
            RingtonePlayer.m2625$$Nest$menforceUriUserId(RingtonePlayer.this, uri);
            ContentResolver contentResolver = RingtonePlayer.m2626$$Nest$mgetContextForUser(RingtonePlayer.this, Binder.getCallingUserHandle()).getContentResolver();
        ...
        public final void playAsync(Uri uri, UserHandle userHandle, boolean z, AudioAttributes audioAttributes, float f) {
            ...
            ringtonePlayer.mAsyncPlayer.play(RingtonePlayer.m2626$$Nest$mgetContextForUser(ringtonePlayer, userHandle), uri, z, audioAttributes, f);
        }
    ...
    public class Client implements IBinder.DeathRecipient {
        ...
        public Client(IBinder iBinder, Uri uri, UserHandle userHandle, AudioAttributes audioAttributes, VolumeShaper.Configuration configuration) {
            this.mToken = iBinder;
            Ringtone ringtone = new Ringtone(RingtonePlayer.m2626$$Nest$mgetContextForUser(RingtonePlayer.this, userHandle), false);
    ...
    public static void m2625$$Nest$menforceUriUserId(RingtonePlayer ringtonePlayer, Uri uri) {
    ...
    public static Context m2626$$Nest$mgetContextForUser(RingtonePlayer ringtonePlayer, UserHandle userHandle) {
        ringtonePlayer.getClass();
        try {
