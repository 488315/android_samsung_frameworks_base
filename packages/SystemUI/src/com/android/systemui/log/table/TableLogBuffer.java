...
public final class TableLogBuffer implements Dumpable, TableLogBufferBase {
    ...
    public TableLogBuffer(int i, String str, SystemClock systemClock, LogcatEchoTracker logcatEchoTracker, LogProxy logProxy) {
        this.name = str;
        ...
        this.buffer = new RingBuffer(i, new TableLogBuffer$$ExternalSyntheticLambda0());
    ...
    public final synchronized void logDiffs(String str, Diffable diffable, Diffable diffable2) {
        TableRowLoggerImpl tableRowLoggerImpl = this.tempRow;
        tableRowLoggerImpl.timestamp = this.systemClock.currentTimeMillis();
    ...
    public final synchronized TableChange obtain(long j, String str, String str2, boolean z) {
        ...
        try {
            if (StringsKt__StringsKt.contains(str, "|", false)) {
                throw new IllegalArgumentException(AndroidCompositionLocals_androidKt$$ExternalSyntheticOutline0.m("columnPrefix cannot contain | but was ", str));
            }
            if (StringsKt__StringsKt.contains(str2, "|", false)) {
                throw new IllegalArgumentException(AndroidCompositionLocals_androidKt$$ExternalSyntheticOutline0.m("columnName cannot contain | but was ", str2));
            }
    ...
    public final void saveEvictedValue(TableChange tableChange) {
        ...
        TableChange tableChange3 = (TableChange) ((LinkedHashMap) this.lastEvictedValues).get(name);
        if (tableChange3 == null) {
            TableChange tableChange4 = new TableChange(0L, null, null, false, null, false, null, null, 255, null);
            this.lastEvictedValues.put(name, tableChange4);
            tableChange2 = tableChange4;
        } else {
        ...
        if (i == 1) {
            ...
            Integer num = tableChange.f49int;
            tableChange2.type = TableChange.DataType.INT;
            tableChange2.f49int = num;
        } else if (i == 3) {
