...
public final class ShelfToolTipManager {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (z) {
                ...
                if (!shelfToolTipManager.mFirstExpanded && z2) {
                    ...
                    ShelfToolTipManager.access$tryToShowToolTip(shelfToolTipManager);
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.android.systemui.ShelfToolTipManager$stateListener$1, com.android.systemui.plugins.statusbar.StatusBarStateController$StateListener] */
    public ShelfToolTipManager(Context context, NotificationShelfManager notificationShelfManager, AmbientState ambientState, StatusBarStateController statusBarStateController, ShadeInteractor shadeInteractor, CoroutineScope coroutineScope, ShadeExpansionStateManager shadeExpansionStateManager, SecPanelSplitHelper secPanelSplitHelper) {
        ...
        statusBarStateController.removeCallback(r0);
        ...
        secPanelSplitHelper.addListener(new PanelTransitionStateListener() { // from class: com.android.systemui.ShelfToolTipManager.2
        ...
        shadeExpansionStateManager.addExpansionListener(new ShadeExpansionListener() { // from class: com.android.systemui.ShelfToolTipManager.3
            ...
            public final void onPanelExpansionChanged(ShadeExpansionChangeEvent shadeExpansionChangeEvent) {
                ...
                if (SecPanelSplitHelper.isEnabled) {
                    ...
                    ShelfToolTipManager shelfToolTipManager = ShelfToolTipManager.this;
                    if (f == 1.0f) {
                        if (shelfToolTipManager.mFirstExpanded || !shelfToolTipManager.mPanelSplitHelper.isShadeState()) {
                            return;
                        }
                        shelfToolTipManager.mFirstExpanded = true;
                        ShelfToolTipManager.access$tryToShowToolTip(shelfToolTipManager);
                    ...
                    if (f < 0.9f && shelfToolTipManager.mNotiSettingTip != null) {
                        shelfToolTipManager.releaseToolTip(true);
                    } else if (f == 0.0f) {
                        shelfToolTipManager.mFirstExpanded = false;
                    }
                }
            }
        });
    ...
    public static final void access$tryToShowToolTip(ShelfToolTipManager shelfToolTipManager) {
    ...
    public final boolean needsToShow() {
        ...
        if (this.alreadyToolTipShown || this.isTappedNotiSettings || this.panelExpandedCount != 200 || (notificationShelf = this.mNotificationShelf) == null || (expandableView = (ambientState = this.mAmbientState).mLastVisibleBackgroundChild) == null) {
            return false;
        }
        return ambientState.mLastVisibleBackgroundChild.getIntrinsicHeight() + ((int) expandableView.getTranslationY()) >= ((int) notificationShelf.getTranslationY());
    }
