...
public class Dependency {
    ...
    public Lazy mAllowedOngoingActivityListManager;
    ...
    public Lazy mKeyguardStatusBarNioLayoutRepository;
    ...
    public Lazy mLauncherProxyService;
    ...
    public Lazy mSecQsUiDisplayModeInteractor;
    ...
    public Lazy mSplitStateInteractor;
    public Lazy mStatusBarIconControllerLazy;
    public Lazy mStatusBarStateController;
    public Lazy mStatusBarWindowControllerStoreLazy;
    ...
    public static final DependencyKey BACK_ANIMATION = new DependencyKey("back_animation");
