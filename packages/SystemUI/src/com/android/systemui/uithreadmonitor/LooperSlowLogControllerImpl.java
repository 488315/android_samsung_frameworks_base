...
public final class LooperSlowLogControllerImpl implements Dumpable, LooperSlowLogController {
    ...
    public final Lazy choreographerCallStackCnt$delegate;
    public final dagger.Lazy choreographerLazy;
    public final Lazy choreographerSlowDispatchMs$delegate;
    ...
    public final Lazy dumpBuf$delegate;
    ...
    public final class LogType {
        ...
        public /* synthetic */ LogType(int i, long j, long j2, long j3, boolean z, Function2 function2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? -1 : i, (i2 & 2) != 0 ? 0L : j, (i2 & 4) != 0 ? 0L : j2, (i2 & 8) != 0 ? 0L : j3, (i2 & 16) != 0 ? false : z, (i2 & 32) != 0 ? null : function2);
        }
    }
    ...
    public LooperSlowLogControllerImpl(Looper looper, CoroutineScope coroutineScope, CoroutineDispatcher coroutineDispatcher, dagger.Lazy lazy, DumpManager dumpManager) {
        this.mainLooper = looper;
        this.scope = coroutineScope;
        this.bgDispatcher = coroutineDispatcher;
        this.choreographerLazy = lazy;
        final int i = 0;
        this.dumpBuf$delegate = LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.uithreadmonitor.LooperSlowLogControllerImpl$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                switch (i) {
                    ...
                    case 1:
                        int i3 = LooperSlowLogControllerImpl.$r8$clinit;
                        return Integer.valueOf(SystemProperties.getInt("debug.sysui.looper_slow.choreographer.callstack", 25));
                    default:
                        int i4 = LooperSlowLogControllerImpl.$r8$clinit;
                        return Integer.valueOf(SystemProperties.getInt("debug.sysui.looper_slow.choreographer.slow_dispatch", 30));
                }
            }
        });
        final int i2 = 1;
        this.choreographerCallStackCnt$delegate = LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.uithreadmonitor.LooperSlowLogControllerImpl$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                switch (i2) {
                    case 0:
                        int i22 = LooperSlowLogControllerImpl.$r8$clinit;
                        return new ArrayDeque();
                    case 1:
                        int i3 = LooperSlowLogControllerImpl.$r8$clinit;
                        return Integer.valueOf(SystemProperties.getInt("debug.sysui.looper_slow.choreographer.callstack", 25));
        ...
        final int i3 = 2;
        this.choreographerSlowDispatchMs$delegate = LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.uithreadmonitor.LooperSlowLogControllerImpl$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                switch (i3) {
                    case 0:
                        ...
                        return new ArrayDeque();
                    case 1:
                        int i32 = LooperSlowLogControllerImpl.$r8$clinit;
                        return Integer.valueOf(SystemProperties.getInt("debug.sysui.looper_slow.choreographer.callstack", 25));
                    default:
                        int i4 = LooperSlowLogControllerImpl.$r8$clinit;
                        return Integer.valueOf(SystemProperties.getInt("debug.sysui.looper_slow.choreographer.slow_dispatch", 30));
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        synchronized (((ArrayDeque) this.dumpBuf$delegate.getValue())) {
            try {
    ...
    public final boolean enable(int i, long j, long j2, long j3, boolean z, UiThreadMonitor$$ExternalSyntheticLambda3 uiThreadMonitor$$ExternalSyntheticLambda3) {
        ...
        String str = "enable type=" + i + " dispatch=" + j + " delivery=" + j2 + " dur=" + j3 + ", cOnly=" + z + ", hasLogHandler=" + (uiThreadMonitor$$ExternalSyntheticLambda3 != null);
        if (this.debug) {
    ...
    public final void update$5$1() {
        ...
        sb.append(j2);
        sb.append(" cOnly=");
        CarrierTextManager$$ExternalSyntheticOutline0.m(sb, z, " hasLogHandler=", z2, "LooperSlow");
        ...
        dagger.Lazy lazy = this.choreographerLazy;
        if (z3) {
