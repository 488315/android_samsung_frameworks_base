...
public class PluginInstance implements PluginLifecycleManager, ProtectedPluginListener {
    ...
    public class PluginFactory {
        ...
        public final boolean checkVersion(Plugin plugin) {
            ...
            if (versionInfo2.mVersions.isEmpty()) {
                return plugin.getVersion() == ((VersionInfo.Version) versionInfo.mVersions.get(versionInfo.mDefault)).mVersion;
            }
    ...
    public final synchronized boolean onFail(String str, String str2, Throwable th) {
        Log.e("PluginInstance", "Failure from " + this.mPlugin + ". Disabling Plugin.");
        this.mHasError = true;
        unloadPlugin();
        this.mListener.onPluginDetached(this);
        return true;
