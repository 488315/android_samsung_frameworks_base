...
public final class DoubleShadowTextHelper {
    ...
    public static void applyShadows(ShadowInfo shadowInfo, ShadowInfo shadowInfo2, TextView textView, Canvas canvas, Function0 function0) {
        textView.getPaint().setShadowLayer(shadowInfo2.blur, shadowInfo2.offsetX, shadowInfo2.offsetY, Color.argb(shadowInfo2.alpha, 0.0f, 0.0f, 0.0f));
        function0.invoke();
        canvas.save();
        ...
        textView.getPaint().setShadowLayer(shadowInfo.blur, shadowInfo.offsetX, shadowInfo.offsetY, Color.argb(shadowInfo.alpha, 0.0f, 0.0f, 0.0f));
        function0.invoke();
        canvas.restore();
    }
    ...
    public final class ShadowInfo {
        ...
        public final String toString() {
            ...
            sb.append(", alpha=");
            return DpCornerSize$$ExternalSyntheticOutline0.m(this.alpha, ")", sb);
        }
