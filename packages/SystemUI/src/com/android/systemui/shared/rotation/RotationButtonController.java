...
public class RotationButtonController {
    ...
    public SamsungNavigationBarProxy mBarProxy;
                    ...
                    Optional.ofNullable(ActivityManagerWrapper.sInstance).map(new RotationButtonController$TaskStackListenerImpl$$ExternalSyntheticLambda1()).ifPresent(new Consumer() { // from class: com.android.systemui.shared.rotation.RotationButtonController$TaskStackListenerImpl$$ExternalSyntheticLambda2
                        ...
                        public final void accept(Object obj) {
                            ...
                            if (((ActivityManager.RunningTaskInfo) obj).id == i3) {
                                RotationButtonController.this.mMainThreadHandler.post(new RotationButtonController$$ExternalSyntheticLambda0(taskStackListenerImpl2, 5));
                            }
                        }
                    });
                }
    ...
    public boolean canShowRotationButton() {
        return this.mIsNavigationBarShowing || this.mBehavior == 1 || QuickStepContract.isGesturalMode(this.mNavBarMode) || (BasicRuneWrapper.NAVBAR_ENABLED && this.mNavBarMode == 0);
    }
    ...
    public final void onRotationWatcherChanged(int i, Boolean bool) {
        ...
        if (this.mListenersRegistered && bool != null) {
            if (bool.booleanValue() || (BasicRuneWrapper.NAVBAR_ENABLED && (floatingRotationButton = this.mRotationButton) != null && floatingRotationButton.mIsShowing)) {
                if (this.mSkipOverrideUserLockPrefsOnce) {
                    this.mSkipOverrideUserLockPrefsOnce = false;
                } else if (i == 0 && bool.booleanValue() && !this.mDocked && BasicRuneWrapper.NAVBAR_ENABLED) {
                    this.mBarProxy.getClass();
    ...
    public final void setRotateSuggestionButtonState(boolean z, boolean z2) {
        ...
        if (z) {
            ...
            OneShotPreDrawListener.add(floatingRotationButton2.mKeyButtonView, new FloatingRotationButton$$ExternalSyntheticLambda0(floatingRotationButton2, 1));
            return;
        }
