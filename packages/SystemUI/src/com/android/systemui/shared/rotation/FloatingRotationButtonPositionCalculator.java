...
public final class FloatingRotationButtonPositionCalculator {
    ...
    public final class Position {
        ...
        public final int hashCode() {
            return Integer.hashCode(this.translationY) + ReorderTile$$ExternalSyntheticOutline0.m(this.translationX, Integer.hashCode(this.gravity) * 31, 31);
        }
        ...
        public final String toString() {
            ...
            return ReorderTile$$ExternalSyntheticOutline0.m(this.translationY, ")", sb);
        }
    }
