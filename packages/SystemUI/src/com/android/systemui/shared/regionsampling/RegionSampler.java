...
public class RegionSampler implements WallpaperManager.LocalWallpaperColorConsumer {
    ...
    public final void dump(PrintWriter printWriter) {
        ...
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "regionSamplingEnabled: ", this.regionSamplingEnabled);
        printWriter.println("regionDarkness: " + this.regionDarkness);
        ActionReceiver$$ExternalSyntheticOutline0.m(printWriter, "lightForegroundColor: ", Integer.toHexString(this.lightForegroundColor));
        ActionReceiver$$ExternalSyntheticOutline0.m(printWriter, "darkForegroundColor: ", Integer.toHexString(this.darkForegroundColor));
    ...
    public final void onColorsChanged(RectF rectF, WallpaperColors wallpaperColors) {
        ...
        this.regionDarkness = !z ? RegionDarkness.DARK : RegionDarkness.LIGHT;
