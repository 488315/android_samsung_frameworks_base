...
final class ClockRegistry$triggerOnCurrentClockChanged$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.this$0.f104assert.isMainThread();
        int i = 0;
        this.this$0.isClockChanged.set(false);
        ArrayList arrayList = (ArrayList) this.this$0.clockChangeListeners;
        int size = arrayList.size();
        while (i < size) {
            Object obj2 = arrayList.get(i);
            i++;
            ((ClockRegistry.ClockChangeListener) obj2).onCurrentClockChanged();
        }
