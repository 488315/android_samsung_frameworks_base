...
public final class ClockContext {
    ...
    public final int hashCode() {
        int iHashCode = (this.messageBuffer.hashCode() + ((this.messageBuffers.hashCode() + ((this.typefaceCache.hashCode() + ((this.settings.hashCode() + ((this.resources.hashCode() + (this.context.hashCode() * 31)) * 31)) * 31)) * 31)) * 31)) * 31;
        Vibrator vibrator = this.vibrator;
        return iHashCode + (vibrator == null ? 0 : vibrator.hashCode());
    }
