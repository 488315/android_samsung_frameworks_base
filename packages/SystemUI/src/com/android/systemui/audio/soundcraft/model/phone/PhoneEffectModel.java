...
public final class PhoneEffectModel {
    ...
    public final int hashCode() {
        return Boolean.hashCode(this.spatialAudio) + TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.eqIndex, Integer.hashCode(this.dolbyIndex) * 31, 31), 31, this.voiceBoost), 31, this.volumeNormalization), 31, this.uhqUpscaler);
    }
