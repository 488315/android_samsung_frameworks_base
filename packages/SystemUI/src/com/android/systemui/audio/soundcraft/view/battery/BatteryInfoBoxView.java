...
public final class BatteryInfoBoxView extends LinearLayout implements SoundCraftVMComponent {
    ...
    public BatteryInfoBoxView(Context context) {
        ...
        this.viewModel$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, new Function0() { // from class: com.android.systemui.audio.soundcraft.view.battery.BatteryInfoBoxView$special$$inlined$lazyViewModel$1
            {
                super(0);
            }
            ...
            public final Object invoke() {
                ...
                return SoundCraftDetailPageView$bind$2$$ExternalSyntheticOutline0.m(soundCraftViewModelExt2, soundCraftViewComponent, soundCraftViewComponent, BatteryInfoBoxViewModel.class);
            }
        });
    }
    ...
    public BatteryInfoBoxView(Context context, AttributeSet attributeSet) {
        ...
        SoundCraftViewModelExt soundCraftViewModelExt = SoundCraftViewModelExt.INSTANCE;
        this.viewModel$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, new Function0() { // from class: com.android.systemui.audio.soundcraft.view.battery.BatteryInfoBoxView$special$$inlined$lazyViewModel$2
            {
                super(0);
            }
    ...
    public BatteryInfoBoxView(Context context, AttributeSet attributeSet, int i) {
        ...
        SoundCraftViewModelExt soundCraftViewModelExt = SoundCraftViewModelExt.INSTANCE;
        this.viewModel$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, new Function0() { // from class: com.android.systemui.audio.soundcraft.view.battery.BatteryInfoBoxView$special$$inlined$lazyViewModel$3
            {
                super(0);
            }
