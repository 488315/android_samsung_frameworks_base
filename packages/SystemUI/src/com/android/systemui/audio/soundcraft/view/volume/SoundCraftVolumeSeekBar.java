...
public final class SoundCraftVolumeSeekBar extends SeslSeekBar implements SoundCraftVMComponent {
    ...
    public final class SeekbarChangeListener implements SeslSeekBar.OnSeekBarChangeListener {
        ...
        public final void onProgressChanged(SeslSeekBar seslSeekBar, int i, boolean z) {
            seslSeekBar.setBackground(null);
                ...
                if (isTagEnabled) {
                    ...
                    try {
                        ...
                        if (volumeDialogController != null) {
                            volumeDialogController.setStreamVolume(3, i3);
                    ...
                    VolumeDialogController volumeDialogController2 = (VolumeDialogController) lazy.getValue();
                    if (volumeDialogController2 != null) {
                        volumeDialogController2.setStreamVolume(3, i3);
    ...
    public SoundCraftVolumeSeekBar(Context context) {
        ...
        this.viewModel$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, new Function0(this) { // from class: com.android.systemui.audio.soundcraft.view.volume.SoundCraftVolumeSeekBar$special$$inlined$lazyViewModel$1
    ...
    public SoundCraftVolumeSeekBar(Context context, AttributeSet attributeSet) {
        ...
        SoundCraftViewModelExt soundCraftViewModelExt = SoundCraftViewModelExt.INSTANCE;
        this.viewModel$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, new Function0(this) { // from class: com.android.systemui.audio.soundcraft.view.volume.SoundCraftVolumeSeekBar$special$$inlined$lazyViewModel$2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                SoundCraftViewModelExt soundCraftViewModelExt2 = SoundCraftViewModelExt.INSTANCE;
                SoundCraftLocalViewModelStoreOwner.INSTANCE.getClass();
