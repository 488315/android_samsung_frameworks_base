...
public final class SpatialAudioViewModel extends BaseSingleChoiceViewModel {
    ...
    public final void onItemSelected(int i) {
        ...
        SoundCraftSALogging.sendEventLog$default(SoundCraftSALogging.INSTANCE, SoundCraftSALogging.ScreenId.EID_BUDS_DETAIL_SETTING, SoundCraftSALogging.Event.SPATIAL_AUDIO, String.valueOf(i), 8);
