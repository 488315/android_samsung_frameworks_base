...
public final class SoundCraftVolumeIcon extends FrameLayout implements SoundCraftVMComponent {
    ...
    public SoundCraftVolumeIcon(Context context, AttributeSet attributeSet) {
        ...
        this.viewModel$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, new Function0(this) { // from class: com.android.systemui.audio.soundcraft.view.volume.SoundCraftVolumeIcon$special$$inlined$lazyViewModel$1
        ...
        this.init = true;
        this.iconColor = context.getColor(R.color.animated_brightness_sun_icon_color);
    ...
    public final void updateLayout$2(int i) throws Resources.NotFoundException {
        ...
        int color = this.context.getColor(getViewModel().isVolumeShocked(i) ? R.color.volume_icon_earshock_color : R.color.animated_brightness_sun_icon_color);
