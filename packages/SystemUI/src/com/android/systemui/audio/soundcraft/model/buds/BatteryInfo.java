...
public final class BatteryInfo {
    ...
    public final String toString() {
        String str = this.batteryLeft;
        String str2 = this.batteryRight;
        return TransitionKt$$ExternalSyntheticOutline0.m(SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("BatteryInfo(batteryLeft=", str, ", batteryRight=", str2, ", batteryCradle="), this.batteryCradle, ")");
    }
