...
import com.android.systemui.audio.soundcraft.activity.SoundCraftActivity$onCreate$3;
import com.android.systemui.audio.soundcraft.activity.SoundCraftActivity$onCreate$5;
...
public final class SoundCraftViewComponent implements LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SoundCraftVMComponent {
    ...
    public final void onCreate(Context context, ViewGroup viewGroup) {
        ...
        soundCraftDetailPageView.getViewModel().updateBatteryInfoBox.observe(lifecycleOwner, new SoundCraftDetailPageView$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.android.systemui.audio.soundcraft.view.SoundCraftDetailPageView$$ExternalSyntheticLambda3
            /* JADX WARN: Code restructure failed: missing block: B:134:0x0314, code lost:
                ...
                if (java.lang.Integer.parseInt(r8) > java.lang.Integer.parseInt(r7)) goto L130;
             */
            /* JADX WARN: Code restructure failed: missing block: B:143:0x0301, code lost:
            
                if (java.lang.Integer.parseInt(r8) > java.lang.Integer.parseInt(r7)) goto L124;
             */
            ...
            */
            public final java.lang.Object mo779invoke(java.lang.Object r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.audio.soundcraft.view.SoundCraftDetailPageView$$ExternalSyntheticLambda3.mo779invoke(java.lang.Object):java.lang.Object");
            }
        }));
        ...
        soundCraftActionBarBinding.backButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.audio.soundcraft.view.actionbar.SoundCraftActionBarView$bind$2
            ...
            public final void onClick(View view) {
                ...
                SoundCraftActivity$onCreate$5 soundCraftActivity$onCreate$5 = soundCraftActionBarViewModel.soundCraftCoverController.listener;
                if (soundCraftActivity$onCreate$5 != null) {
                    int i8 = SoundCraftActivity.$r8$clinit;
                    SoundCraftActivity soundCraftActivity = soundCraftActivity$onCreate$5.this$0;
                    SoundCraftActivity$onCreate$3 soundCraftActivity$onCreate$3 = soundCraftActivity.actionScreenReceiver;
                    if (soundCraftActivity$onCreate$3 != null) {
                        soundCraftActivity.unregisterReceiver(soundCraftActivity$onCreate$3);
        ...
        audioEffectBoxLayoutBinding.detailJumpButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.audio.soundcraft.view.audioeffect.AudioEffectBoxView$bind$13
            ...
            public final void onClick(View view) {
                Object failure;
                SoundCraftActivity$onCreate$5 soundCraftActivity$onCreate$5;
                ...
                try {
                    ...
                    if (viewModel2.modelProvider.isFromCover && (soundCraftActivity$onCreate$5 = viewModel2.soundCraftCoverController.listener) != null) {
                ...
                if (m3422exceptionOrNullimpl != null) {
                    Log.d("SoundCraft.AudioEffectBoxViewModel", "jumpToDetailPage : onFailure, e=" + m3422exceptionOrNullimpl);
                }
            }
        });
        ...
        if (routineTestViewBinding != null) {
            ...
            mutableLiveData3.observe(lifecycleOwner8, new RoutineTestView$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.android.systemui.audio.soundcraft.view.routine.RoutineTestView$$ExternalSyntheticLambda0
                ...
                public final Object mo779invoke(Object obj) {
                    ...
                    RoutineTestViewBinding.this.routineCountText.setText(((Integer) obj).toString());
                    return Unit.INSTANCE;
                }
            }));
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void updateModel(int r21) {
        /*
            Method dump skipped, instructions count: 922
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.audio.soundcraft.view.SoundCraftViewComponent.updateModel(int):void");
    }
}
