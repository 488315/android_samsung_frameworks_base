...
public final class SoundCraftViewModelFactory implements ViewModelProvider.Factory {
    ...
    public SoundCraftViewModelFactory(Lazy lazy, Lazy lazy2, Lazy lazy3, Lazy lazy4, Lazy lazy5, Lazy lazy6, Lazy lazy7, Lazy lazy8, Lazy lazy9, Lazy lazy10, Lazy lazy11, Lazy lazy12, Lazy lazy13, Lazy lazy14, Lazy lazy15, Lazy lazy16, Lazy lazy17, Lazy lazy18, Lazy lazy19, Lazy lazy20, Lazy lazy21) {
        ...
        linkedHashMap.put(SpatialAudioSwitchViewModel.class, lazy9);
        linkedHashMap.put(EqualizerViewModel.class, lazy10);
        linkedHashMap.put(VoiceBoostViewModel.class, lazy11);
        linkedHashMap.put(VolumeNormalizationViewModel.class, lazy12);
        linkedHashMap.put(ActiveNoiseCancelingViewModel.class, lazy13);
        linkedHashMap.put(AdaptiveViewModel.class, lazy14);
        linkedHashMap.put(AmbientSoundViewModel.class, lazy15);
        linkedHashMap.put(NoiseCancelingLevelViewModel.class, lazy16);
        linkedHashMap.put(NoiseControlEffectBoxViewModel.class, lazy17);
        linkedHashMap.put(NoiseControlOffViewModel.class, lazy18);
