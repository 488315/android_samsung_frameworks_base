...
public final class EqualizerViewModel extends BaseSingleChoiceViewModel {
    ...
    public final void onItemSelected(int i) {
        ...
        SoundCraftSALogging.sendEventLog$default(SoundCraftSALogging.INSTANCE, modelProvider.effectOutDeviceType == EffectOutDeviceType.PHONE ? SoundCraftSALogging.ScreenId.EID_PHONE_DETAIL_SETTING : SoundCraftSALogging.ScreenId.EID_BUDS_DETAIL_SETTING, SoundCraftSALogging.Event.EQUALIZER, String.valueOf(i), 8);
        notifyChange();
        dismiss();
    }
}
