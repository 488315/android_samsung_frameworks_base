...
import com.android.systemui.audio.soundcraft.viewmodel.common.volume.VolumeBarViewModel$$ExternalSyntheticLambda1;
...
public final class VolumeManager {
    ...
    public final List bleDeviceList;
    ...
    public final Lazy volumeController$delegate = LazyKt__LazyJVMKt.lazy(new VolumeManager$$ExternalSyntheticLambda0());
    ...
    public VolumeManager(Context context, BluetoothAdapterWrapper bluetoothAdapterWrapper, DisplayManagerWrapper displayManagerWrapper) {
        ...
        this.wiredEarphoneDeviceList = Arrays.asList(3, 4, 22);
        this.bleDeviceList = Arrays.asList(26, 27);
    ...
    public final int getDevice() {
        ...
        if (this.bleDeviceList.contains(Integer.valueOf(i))) {
            return VolumePanelValues.FLAG_SHOW_CSD_100_WARNINGS;
        }
        if (this.volumeModel.isBroadcast && !bluetoothAdapterWrapper.getConnectedLeDevices().isEmpty()) {
            return VolumePanelValues.FLAG_SHOW_CSD_100_WARNINGS;
        }
        if (i == 8 || this.volumeModel.isMusicShareEnabled) {
            return 128;
        }
        if (this.wiredEarphoneDeviceList.contains(Integer.valueOf(i))) {
            return 67108864;
        }
        if (i == 25 && this.volumeModel.isSmartViewEnabled) {
    ...
    public final boolean isStreamEnabled() {
        ...
        return (isAurCastEnabled() && this.bluetoothAdapterWrapper.getConnectedLeDevices().isEmpty()) ? false : true;
    }
    ...
    public final void updateCurrentVolume() {
        if (!Trace.isTagEnabled(4096L)) {
            ...
            VolumeBarViewModel$$ExternalSyntheticLambda1 volumeBarViewModel$$ExternalSyntheticLambda1 = this.volumeModelCallback;
            if (volumeBarViewModel$$ExternalSyntheticLambda1 != null) {
                volumeBarViewModel$$ExternalSyntheticLambda1.invoke(volumeModel, Boolean.valueOf(this.isTracking));
            }
        ...
        try {
            if (!this.isTracking) {
                ...
                VolumeBarViewModel$$ExternalSyntheticLambda1 volumeBarViewModel$$ExternalSyntheticLambda12 = this.volumeModelCallback;
                if (volumeBarViewModel$$ExternalSyntheticLambda12 != null) {
                    volumeBarViewModel$$ExternalSyntheticLambda12.invoke(volumeModel2, Boolean.valueOf(this.isTracking));
                }
