...
public final class ActionParamCreator {
    ...
    public static void putActionValue(HashMap map, PhoneActionType phoneActionType, String str) {
    ...
    public static void putActionValue(HashMap map, String str, BudsActionType budsActionType, String str2) {
        BudsPluginInfo.Companion.getClass();
        String strFindProjectName = BudsPluginInfo.Companion.findProjectName(str);
        if (strFindProjectName != null) {
            MetaInfo.Companion companion = MetaInfo.Companion;
            String tag = budsActionType.getTag(strFindProjectName);
            companion.getClass();
