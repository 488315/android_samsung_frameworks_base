...
public class FaceAuthUiEvent implements UiEventLogger.UiEventEnum {
    ...
    static {
        ...
        FaceAuthUiEvent faceAuthUiEvent3 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_SWIPE_UP_ON_BOUNCER", 2, 1148, "Face auth due to swipe up on bouncer", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent5 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_FACE_LOCKOUT_RESET", 4, 1150, "Face auth due to face lockout reset.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent7 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_NOTIFICATION_PANEL_CLICKED", 6, 1152, "Face auth due to notification panel click.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent12 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_RETRY_AFTER_HW_UNAVAILABLE", 11, 1156, "Face auth due to retry after hardware unavailable.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent14 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_TRUST_ENABLED", 13, 1173, "Face auth stopped due to trust enabled.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent19 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_DREAM_STOPPED", 18, 1162, "Face auth due to dream stopped.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent21 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_ENROLLMENTS_CHANGED", 20, 1164, "Face auth due to enrolments changed.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent23 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_FACE_CANCEL_NOT_RECEIVED", 22, 1174, "Face auth stopped due to face cancel signal not received.", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent25 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_DREAM_STARTED", 24, 1176, "Face auth stopped because dreaming started", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent27 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_USER_INPUT_ON_BOUNCER", 26, 1178, "Face auth stopped because user started typing password/pin", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent29 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_CAMERA_LAUNCHED", 28, 1180, "Face auth started/stopped because camera launched", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent31 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_GOING_TO_SLEEP", 30, 1182, "Face auth started/stopped because going to sleep", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent33 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_ON_KEYGUARD_INIT", 32, 1189, "Face auth started/stopped because Keyguard is initialized", 0, 4, null);
        FaceAuthUiEvent faceAuthUiEvent34 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_KEYGUARD_RESET", 33, 1185, "Face auth started/stopped because Keyguard is reset", 0, 4, null);
        FACE_AUTH_UPDATED_KEYGUARD_RESET = faceAuthUiEvent34;
        FaceAuthUiEvent faceAuthUiEvent35 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_USER_SWITCHING", 34, 1186, "Face auth started/stopped because user is switching", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent37 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_BIOMETRIC_ENABLED_ON_KEYGUARD", 36, 1188, "Face auth started/stopped because biometric is enabled on keyguard", 0, 4, null);
        FACE_AUTH_UPDATED_BIOMETRIC_ENABLED_ON_KEYGUARD = faceAuthUiEvent37;
        FaceAuthUiEvent faceAuthUiEvent38 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_STRONG_AUTH_CHANGED", 37, 1255, "Face auth stopped because strong auth allowed changed", 0, 4, null);
        ...
        FaceAuthUiEvent faceAuthUiEvent40 = new FaceAuthUiEvent("FACE_AUTH_ACCESSIBILITY_ACTION", 39, 1454, "Face auth due to an accessibility action.", 0, 4, null);
        FACE_AUTH_ACCESSIBILITY_ACTION = faceAuthUiEvent40;
        FaceAuthUiEvent faceAuthUiEvent41 = new FaceAuthUiEvent("FACE_AUTH_DISPLAY_OFF", 40, 1461, "Face auth stopped due to display state OFF.", 0, 4, null);
        FaceAuthUiEvent faceAuthUiEvent42 = new FaceAuthUiEvent("FACE_AUTH_CAMERA_AVAILABLE_CHANGED", 41, 1623, "Face auth started due to the available camera changed", 0, 4, null);
        FaceAuthUiEvent faceAuthUiEvent43 = new FaceAuthUiEvent("FACE_AUTH_TRIGGERED_RETRY_BUTTON_CLICKED", 42, VolteConstants.ErrorCode.UT_RETRY_TO_CDMA_DIAL, "Face auth triggered due to retry button click.", 0, 4, null);
        FACE_AUTH_TRIGGERED_RETRY_BUTTON_CLICKED = faceAuthUiEvent43;
        FaceAuthUiEvent faceAuthUiEvent44 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_QS_FULLY_EXPANDED", 43, 5002, "Face auth because qs is fully expanded", 0, 4, null);
        FACE_AUTH_UPDATED_QS_FULLY_EXPANDED = faceAuthUiEvent44;
        FaceAuthUiEvent faceAuthUiEvent45 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_LOCKOUT_DEADLINE", 44, 5003, "Face auth started/stopped because PPP lockout deadline is set", 0, 4, null);
        FACE_AUTH_UPDATED_LOCKOUT_DEADLINE = faceAuthUiEvent45;
        FaceAuthUiEvent faceAuthUiEvent46 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_BIOMETRIC_LOCKOUT_DEADLINE", 45, 5004, "Face auth started/stopped because biometric lockout deadline is set", 0, 4, null);
        FACE_AUTH_UPDATED_BIOMETRIC_LOCKOUT_DEADLINE = faceAuthUiEvent46;
        FaceAuthUiEvent faceAuthUiEvent47 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_COCKTAIL_BAR_SHOWING_CHANGED", 46, 5005, "Face auth started/stopped because cocktail bar showing state is changed", 0, 4, null);
        FACE_AUTH_UPDATED_COCKTAIL_BAR_SHOWING_CHANGED = faceAuthUiEvent47;
        FaceAuthUiEvent faceAuthUiEvent48 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_SECURE_STATE_UNLOCK_CHANGED", 47, 5006, "Face auth started/stopped because secure state unlock is changed", 0, 4, null);
        FACE_AUTH_UPDATED_SECURE_STATE_UNLOCK_CHANGED = faceAuthUiEvent48;
        FaceAuthUiEvent faceAuthUiEvent49 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_SUB_SCREEN", 48, 5007, "Face auth started/stopped because sub screen requests biometrics", 0, 4, null);
        FACE_AUTH_UPDATED_SUB_SCREEN = faceAuthUiEvent49;
        FaceAuthUiEvent faceAuthUiEvent50 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_KEYGUARD_UNLOCKING", 49, 5008, "Face auth started/stopped because keyguard is unlocking", 0, 4, null);
        FACE_AUTH_UPDATED_KEYGUARD_UNLOCKING = faceAuthUiEvent50;
        FaceAuthUiEvent faceAuthUiEvent51 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_SESSION_CLOSE", 50, 5009, "Face auth stopped because face manager session is closed", 0, 4, null);
        FACE_AUTH_STOPPED_SESSION_CLOSE = faceAuthUiEvent51;
        FaceAuthUiEvent faceAuthUiEvent52 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_WINDOW_FOCUS_CHANGED", 51, 5010, "Face auth started/stopped because window focus is changed", 0, 4, null);
        FACE_AUTH_UPDATED_WINDOW_FOCUS_CHANGED = faceAuthUiEvent52;
        FaceAuthUiEvent faceAuthUiEvent53 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_FACE_ERROR", 52, 5011, "Face auth stopped due to face recognition error", 0, 4, null);
        FACE_AUTH_STOPPED_FACE_ERROR = faceAuthUiEvent53;
        FaceAuthUiEvent faceAuthUiEvent54 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_FACE_FAILED", 53, 5012, "Face auth stopped due to face recognition failed", 0, 4, null);
        FACE_AUTH_STOPPED_FACE_FAILED = faceAuthUiEvent54;
        FaceAuthUiEvent faceAuthUiEvent55 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_COVER_STATE_CHANGED", 54, 5013, "Face auth started/stopped because cover state is changed", 0, 4, null);
        FACE_AUTH_UPDATED_COVER_STATE_CHANGED = faceAuthUiEvent55;
        FaceAuthUiEvent faceAuthUiEvent56 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_FULL_SCREEN_FACE_WIDGET", 55, 5014, "Face auth started/stopped because full screen face widget is changed", 0, 4, null);
        FACE_AUTH_UPDATED_FULL_SCREEN_FACE_WIDGET = faceAuthUiEvent56;
        FaceAuthUiEvent faceAuthUiEvent57 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_DYNAMIC_LOCK", 56, 5015, "Face auth started/stopped because dynamic lock screen is changed", 0, 4, null);
        FACE_AUTH_UPDATED_DYNAMIC_LOCK = faceAuthUiEvent57;
        FaceAuthUiEvent faceAuthUiEvent58 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_NOTI_STAR_STATE_CHANGED", 57, 5016, "Face auth started/stopped because noti star state is changed", 0, 4, null);
        FACE_AUTH_UPDATED_NOTI_STAR_STATE_CHANGED = faceAuthUiEvent58;
        FaceAuthUiEvent faceAuthUiEvent59 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_LOCK_ICON_PRESSED", 58, 5017, "Face auth started/stopped because lock icon is pressed", 0, 4, null);
        FACE_AUTH_UPDATED_LOCK_ICON_PRESSED = faceAuthUiEvent59;
        FaceAuthUiEvent faceAuthUiEvent60 = new FaceAuthUiEvent("FACE_AUTH_UPDATED_FOLDER_STATE_CHANGED", 59, 5018, "Face auth started/stopped because folder state is changed", 0, 4, null);
        FACE_AUTH_UPDATED_FOLDER_STATE_CHANGED = faceAuthUiEvent60;
        FaceAuthUiEvent faceAuthUiEvent61 = new FaceAuthUiEvent("FACE_AUTH_STOPPED_PREV_CREDENTIAL_VIEW", 60, 5019, "Face auth stopped because showing prev credential view is changed", 0, 4, null);
        FACE_AUTH_STOPPED_PREV_CREDENTIAL_VIEW = faceAuthUiEvent61;
        FaceAuthUiEvent faceAuthUiEvent62 = new FaceAuthUiEvent("FACE_AUTH_STARTED_LOCK_EDIT_MODE_FINISHED", 61, 5020, "Face auth started because lock edit mode is finished.", 0, 4, null);
