...
public final class FaceDetectionStatus {
    ...
    public final int hashCode() {
        return Long.hashCode(this.createdAt) + TransitionData$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.userId, Integer.hashCode(this.sensorId) * 31, 31), 31, this.isStrongBiometric);
    }
