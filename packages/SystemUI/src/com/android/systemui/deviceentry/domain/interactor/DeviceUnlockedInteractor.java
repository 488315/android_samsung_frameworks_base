...
public final class DeviceUnlockedInteractor {
    ...
    public DeviceUnlockedInteractor(CoroutineScope coroutineScope, AuthenticationInteractor authenticationInteractor, final DeviceEntryRepository deviceEntryRepository, TrustInteractor trustInteractor, DeviceEntryFaceAuthInteractor deviceEntryFaceAuthInteractor, DeviceEntryFingerprintAuthInteractor deviceEntryFingerprintAuthInteractor, PowerInteractor powerInteractor) {
        ...
        Flow flow3 = new Flow() { // from class: com.android.systemui.deviceentry.domain.interactor.DeviceUnlockedInteractor$special$$inlined$map$2
            ...
            public final class AnonymousClass2 implements FlowCollector {
                public final /* synthetic */ DeviceEntryRepository $deviceEntryRepository$inlined;
                public final /* synthetic */ FlowCollector $this_unsafeFlow;
                ...
                public AnonymousClass2(FlowCollector flowCollector, DeviceEntryRepository deviceEntryRepository) {
                    this.$this_unsafeFlow = flowCollector;
                    this.$deviceEntryRepository$inlined = deviceEntryRepository;
                }
                ...
                */
                public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
                    ...
                    L2f:
                        ...
                        r5.getClass()
                        com.android.systemui.deviceentry.data.repository.DeviceEntryRepository r5 = r4.$deviceEntryRepository$inlined
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object collect = Flow.this.collect(new AnonymousClass2(flowCollector, deviceEntryRepository), continuation);
                return collect == CoroutineSingletons.COROUTINE_SUSPENDED ? collect : Unit.INSTANCE;
            }
        };
        final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = trustInteractor.isTrusted;
        ...
        ChannelFlowTransformLatest transformLatest = FlowKt.transformLatest(authenticationInteractor.authenticationMethod, new DeviceUnlockedInteractor$special$$inlined$flatMapLatest$1(null, this));
        SharingStarted.Companion.getClass();
        this.deviceUnlockStatus = FlowKt.stateIn(transformLatest, coroutineScope, SharingStarted.Companion.Eagerly, new DeviceUnlockStatus(false, null));
    }
}
