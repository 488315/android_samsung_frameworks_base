...
public final class RecentTask {
    ...
    public /* synthetic */ RecentTask(TaskInfo taskInfo, boolean z, UserType userType, SplitBounds splitBounds, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(taskInfo, z, userType, (i & 8) != 0 ? null : splitBounds);
    }
