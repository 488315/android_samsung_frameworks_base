...
final class BadgedAppIconLoader$loadIcon$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i5 = BadgedAppIconLoader.WhenMappings.$EnumSwitchMapping$0[userType.ordinal()];
        if (i5 == 1) {
            i3 = 2;
        } else if (i5 != 2) {
            i3 = 3;
        ...
        FastBitmapDrawable newIcon$1 = iconFactory.createBadgedIconBitmap(drawable, iconOptions).newIcon$1(0, badgedAppIconLoader.context);
        AutoCloseableKt.closeFinally(autoCloseable, null);
        return newIcon$1;
    }
}
