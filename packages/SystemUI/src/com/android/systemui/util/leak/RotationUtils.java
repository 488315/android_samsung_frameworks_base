...
public final class RotationUtils {
    ...
    public static String toString(int i) {
        return i != 0 ? i != 1 ? i != 2 ? i != 3 ? ParcelableSnapshotMutableState$Companion$CREATOR$1$$ExternalSyntheticOutline0.m(i, "Unknown (", ")") : "Seascape (3)" : "Upside down (2)" : "Landscape (1)" : "None (0)";
    }
}
