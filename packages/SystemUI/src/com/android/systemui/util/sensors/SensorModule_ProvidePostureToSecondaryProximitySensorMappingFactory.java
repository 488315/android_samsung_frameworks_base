...
public final class SensorModule_ProvidePostureToSecondaryProximitySensorMappingFactory implements Provider {
    ...
    public static ThresholdSensor[] providePostureToSecondaryProximitySensorMapping(ThresholdSensorImpl.BuilderFactory builderFactory, Resources resources) {
        ThresholdSensor[] thresholdSensorArrProvidePostureToSecondaryProximitySensorMapping = SensorModule.providePostureToSecondaryProximitySensorMapping(builderFactory, resources);
        thresholdSensorArrProvidePostureToSecondaryProximitySensorMapping.getClass();
        return thresholdSensorArrProvidePostureToSecondaryProximitySensorMapping;
    }
