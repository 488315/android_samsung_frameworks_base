...
public class ProximitySensorImpl implements ProximitySensor {
    ...
    public void onPrimarySensorEvent(ThresholdSensorEvent thresholdSensorEvent) {
        ...
        if (this.mLastPrimaryEvent == null || thresholdSensorEvent.getBelow() != this.mLastPrimaryEvent.getBelow()) {
            ...
            if (this.mSecondarySafe && this.mSecondaryThresholdSensor.isLoaded()) {
                logDebug(TransitionKt$$ExternalSyntheticOutline0.m(new StringBuilder("Primary sensor reported "), thresholdSensorEvent.getBelow() ? "near" : "far", ". Checking secondary."));
    ...
    public void logDebug(String str) {
        if (DEBUG) {
            ExifInterface$$ExternalSyntheticOutline0.m(new StringBuilder(), this.mTag != null ? TransitionKt$$ExternalSyntheticOutline0.m(new StringBuilder("["), this.mTag, "] ") : "", str, TAG);
        }
    }
