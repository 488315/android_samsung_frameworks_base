...
final class SecQsUiDisplayModeInteractor$foldState$1 extends SuspendLambda implements Function2 {
    ...
    public static final Unit invokeSuspend$lambda$0(SecQsUiDisplayModeInteractor secQsUiDisplayModeInteractor, SecQsUiDisplayModeInteractor$foldState$1$deviceStateCallback$1 secQsUiDisplayModeInteractor$foldState$1$deviceStateCallback$1) {
        ...
        deviceStateManager = secQsUiDisplayModeInteractor.deviceStateManager;
        deviceStateManager.unregisterCallback(secQsUiDisplayModeInteractor$foldState$1$deviceStateCallback$1);
        ...
        if (i == 0) {
            ...
            final ?? r1 = new DeviceStateManager.DeviceStateCallback() { // from class: com.android.systemui.util.SecQsUiDisplayModeInteractor$foldState$1$deviceStateCallback$1
                public void onDeviceStateChanged(android.hardware.devicestate.DeviceState deviceState) {
                    ...
                    bool = SecQsUiDisplayModeInteractor.this.wasFolded;
                    if (Intrinsics.areEqual(bool, Boolean.valueOf(z))) {
                        return;
                    }
                    bool2 = SecQsUiDisplayModeInteractor.this.wasFolded;
                    ...
                    SecQsUiDisplayModeInteractor secQsUiDisplayModeInteractor2 = SecQsUiDisplayModeInteractor.this;
                    Boolean valueOf = Boolean.valueOf(z);
                    ((ChannelCoroutine) producerScope).mo3456trySendJP2dKIU(z ? SecQsUiDisplayModeInteractor.FoldState.FOLD : SecQsUiDisplayModeInteractor.FoldState.UNFOLD);
                    secQsUiDisplayModeInteractor2.wasFolded = valueOf;
                }
            };
            deviceStateManager = this.this$0.deviceStateManager;
            delayableExecutor = this.this$0.mainExecutor;
            deviceStateManager.registerCallback(delayableExecutor, (DeviceStateManager.DeviceStateCallback) r1);
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.util.SecQsUiDisplayModeInteractor$foldState$1$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    ...
                    invokeSuspend$lambda$0 = SecQsUiDisplayModeInteractor$foldState$1.invokeSuspend$lambda$0(SecQsUiDisplayModeInteractor.this, r1);
