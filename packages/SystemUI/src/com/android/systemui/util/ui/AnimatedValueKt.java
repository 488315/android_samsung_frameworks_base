...
public final class AnimatedValueKt {
    public static final <A, B> AnimatedValue<B> flatMap(AnimatedValue<? extends A> animatedValue, Function1 function1) {
        if (animatedValue instanceof AnimatedValue.NotAnimating) {
            return (AnimatedValue) function1.mo779invoke(((AnimatedValue.NotAnimating) animatedValue).getValue());
        }
        ...
        AnimatedValue animatedValue2 = (AnimatedValue) function1.mo779invoke(animating.getValue());
    ...
    public static final <A, B> AnimatedValue<B> map(AnimatedValue<? extends A> animatedValue, Function1 function1) {
        if (animatedValue instanceof AnimatedValue.Animating) {
            return new AnimatedValue.Animating(function1.mo779invoke(((AnimatedValue.Animating) animatedValue).getValue()), new AnimatedValueKt$map$1(animatedValue));
        }
        if (animatedValue instanceof AnimatedValue.NotAnimating) {
            return new AnimatedValue.NotAnimating(function1.mo779invoke(((AnimatedValue.NotAnimating) animatedValue).getValue()));
        }
        throw new NoWhenBranchMatchedException();
    }
