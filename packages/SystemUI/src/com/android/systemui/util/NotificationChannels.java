...
public class NotificationChannels implements CoreStartable {
    ...
    public static void createAll(Context context) {
        ...
        NotificationChannel notificationChannel6 = new NotificationChannel(str, string, i2);
        ...
        NotificationChannel notificationChannel9 = new NotificationChannel(INSIGNIFICANT, context.getString(R.string.notification_inginificatn_header_text), 2);
        NotificationChannel[] notificationChannelArr = new NotificationChannel[12];
        notificationChannelArr[0] = notificationChannel3;
        notificationChannelArr[1] = notificationChannel4;
        notificationChannelArr[2] = notificationChannel5;
        notificationChannelArr[3] = notificationChannel6;
        notificationChannelArr[4] = notificationChannel9;
        notificationChannelArr[i] = createScreenshotChannel(context.getString(R.string.notification_channel_screenshot));
        notificationChannelArr[6] = notificationChannel2;
        notificationChannelArr[7] = notificationChannel8;
        notificationChannelArr[8] = notificationChannel;
        notificationChannelArr[9] = notificationChannel7;
        notificationChannelArr[10] = createZenChannel(context.getString(R.string.noti_dnd_channel_name));
        notificationChannelArr[11] = createFlashLightChannel(context.getString(R.string.notification_channel_ongoing));
        ...
        if (isTv(context)) {
            notificationManager.createNotificationChannel(new NotificationChannel(TVPIP, context.getString(R.string.notification_channel_tv_pip), i));
        }
    }
