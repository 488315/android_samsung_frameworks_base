...
public final class SysUIConcurrencyModule {
    ...
    public final UiThreadContext provideBackPanelUiThreadContext(Looper looper, Handler handler, Executor executor) {
        return new UiThreadContext(looper, handler, executor, (Choreographer) UiThreadContextKt.runWithScissors(handler, new SysUIConcurrencyModule$$ExternalSyntheticLambda0()));
    }
    ...
    public final Looper provideNotifInflationLooper() {
    ...
    public final Choreographer providesChoreographer() {
