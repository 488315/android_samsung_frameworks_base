...
public final class ConfigurationState {
    ...
    public static final CharSequence toCompareString$lambda$5(ConfigurationState configurationState, Configuration configuration, ConfigurationField configurationField) {
        return configurationField.toCompareString(configurationState.fieldMap, configuration);
    }
