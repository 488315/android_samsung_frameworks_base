...
final class AnimationStatusRepositoryImpl$areAnimationsEnabled$1 extends SuspendLambda implements Function2 {
    ...
    public static final Unit invokeSuspend$lambda$0(AnimationStatusRepositoryImpl animationStatusRepositoryImpl, AnimationStatusRepositoryImpl$areAnimationsEnabled$1$observer$1 animationStatusRepositoryImpl$areAnimationsEnabled$1$observer$1) {
        ...
        contentResolver = animationStatusRepositoryImpl.resolver;
        contentResolver.unregisterContentObserver(animationStatusRepositoryImpl$areAnimationsEnabled$1$observer$1);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            companion.getClass();
            ((ChannelCoroutine) producerScope).mo3456trySendJP2dKIU(Boolean.valueOf(ScaleAwareTransitionProgressProvider.Companion.areAnimationsEnabled(contentResolver)));
            ...
            final ?? r3 = new ContentObserver(handler) { // from class: com.android.systemui.util.animation.data.repository.AnimationStatusRepositoryImpl$areAnimationsEnabled$1$observer$1
                ...
                public void onChange(boolean z) {
                    ...
                    ((ChannelCoroutine) producerScope).mo3456trySendJP2dKIU(Boolean.valueOf(areAnimationsEnabled));
                }
            };
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.util.animation.data.repository.AnimationStatusRepositoryImpl$areAnimationsEnabled$1$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    ...
                    invokeSuspend$lambda$0 = AnimationStatusRepositoryImpl$areAnimationsEnabled$1.invokeSuspend$lambda$0(AnimationStatusRepositoryImpl.this, r3);
