...
public final class SystemUIAnalytics {
    ...
    public static final String EID_EDIT_FULL_QUICK_SETTINGS_BUTTONS = "QPPE1008";
    ...
    public static final String EID_PANEL_SETTINGS = "QPPE1011";
    public static final String EID_POWER_OFF_BUTTON = "QPPE1002";
    public static final String EID_PREVIOUS_CREDENTIAL = "LSE2039";
    ...
    public static final String EID_QPNE_DND_DETAIL_OPTION = "QPNE0301";
    ...
    public static final String EID_QPNE_OPEN_NOTIFICATION_PANEL_SEPARATE = "QPNE0040";
    ...
    public static final String EID_QP_DND_LEVEL_COVER = "QPBE2027";
    public static final String EID_QP_FLASHLIGHT_COVER = "QPBE2019";
    public static final String EID_QP_MEDIA_CONTROLLER_COVER = "QPBE2029";
    public static final String EID_QP_MEDIA_SONG_TITLE_COVER = "QPBE2028";
    public static final String EID_QP_MOBILEDATA_COVER = "QPBE2020";
    public static final String EID_QP_MODES_COVER = "QPBE2022";
    public static final String EID_QP_PLAY_LAST_SONG_COVER = "QPBE2030";
    public static final String EID_QP_PLAY_MUSIC_COVER = "QPBE2031";
    ...
    public static final String MEDIA_OUTPUT_PREF_NAME = "media_output_pref";
    public static final String MIC_MODE_PREF_NAME = "micmode_pref";
    public static final String NAVBAR_KEY_ASSISTANT_COVER_STATE = "CoverState";
    public static final String NAVBAR_KEY_ASSISTANT_FOREGROUND_APP = "ForegroundApp";
    public static final String NAVBAR_KEY_ASSISTANT_INVOCATION_TYPE = "InvocationType";
    public static final String NAVBAR_KEY_ASSISTANT_LOCK_STATE = "LockState";
    public static final String NAVBAR_KEY_DIGITAL_ASSISTANT_APP = "DigitalAssistantApp";
    ...
    public static final String OAID_ONGOING_SHOW_EXPAND_VIEW = "SBOA0008";
    public static final String OAID_ONGOING_SHOW_GUTS = "SBOA0005";
    public static final String OAID_ONGOING_SWIPE_TO_SEE_OTHER_ACTIVITY = "SBOA0007";
    ...
    public static final String SID_NOTIFICATION_PANEL = "QPN003";
    ...
    public static final String STATUS_ID_LOCK_LEFT_SHORTCUT = "LSS9026";
    public static final String STATUS_ID_LOCK_RIGHT_SHORTCUT = "LSS9027";
    ...
    public static final String STATUS_QUICK_PANEL_COLLAPSED_ROW = "QPPS1029";
    public static final String STATUS_QUICK_PANEL_LAYOUT = "QPPS1028";
    public static final String STATUS_QUICK_SETTINGS_REVERSE_SWIPE = "QPPS1027";
    ...
    public static final String STID_LOCK_CLOCK_NR_FAMILY_FONT_WEIGHT = "LSS9011";
    ...
    public static final String STID_NOTIFICATION_POSTED_PACKAGE_AND_COUNT = "QPNS0003";
    ...
    public static String convertScreenID(String str) {
        Context context;
        return (isSupportA11yLog(str) || (context = sContext) == null || !DeviceState.isSubDisplay(context) || str == null || str.contains(SID_SUB_SCREEN)) ? str : str.concat(SID_SUB_SCREEN);
    }
    ...
    public static /* synthetic */ boolean lambda$prepareIdMap$0(Field field) {
        if (field.getType() == String.class) {
            return field.getName().startsWith("SID_") || field.getName().startsWith("EID_") || field.getName().startsWith("OAID_");
        }
        return false;
    }
    ...
    private static void makeSAPreferences() {
        try {
            ...
            logBuilders$SettingPrefBuilder.addKey(LOCK_PREF_NAME, STID_LOCK_CLOCK_NR_FAMILY_FONT_WEIGHT);
            logBuilders$SettingPrefBuilder.addKey(LOCK_PREF_NAME, STID_LOCK_BOUNCER_POSITION);
            logBuilders$SettingPrefBuilder.addKey(LOCK_PREF_NAME, STATUS_ID_LOCK_LEFT_SHORTCUT);
            logBuilders$SettingPrefBuilder.addKey(LOCK_PREF_NAME, STATUS_ID_LOCK_RIGHT_SHORTCUT);
            ...
            logBuilders$SettingPrefBuilder.addKey(MEDIA_OUTPUT_PREF_NAME, "Mo501");
            logBuilders$SettingPrefBuilder.addKey(MEDIA_OUTPUT_PREF_NAME, "Mo502");
            logBuilders$SettingPrefBuilder.addKey(MEDIA_OUTPUT_PREF_NAME, "Mo503");
            ...
            try {
                ...
                Debug.LogException(samsungAnalytics.getClass(), e);
            }
        } catch (Exception e2) {
