...
public final class DeviceType {
    ...
    public static boolean isMultiFoldDevice() {
        return false;
    }
    ...
    public static boolean isSupportModelPopOverStatusBar() {
        return BasicRune.STATUS_POP_OVER_PANEL_BAR;
    }
    ...
    public static boolean isTouchProximitySupported(Context context) {
        if (supportTouchProximity == -1) {
            supportTouchProximity = ((SensorManager) context.getSystemService("sensor")).getDefaultSensor(8) != null ? 1 : 0;
        }
