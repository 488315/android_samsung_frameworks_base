...
public class SettingsHelper implements Dumpable {
    ...
    public static final String INDEX_AICORE_ENABLED_FEATURES = "aicore_enabled_features";
    ...
    public static final String INDEX_DEVELOP_RON_TEST = "enable_notification_nowbar_test";
    ...
    public static final String INDEX_MEDIA_ONGOING = "key_now_bar_servicebox_music";
    ...
    public static final String INDEX_NAVIGATION_MODE = "navigation_mode";
    ...
    public static final String INDEX_NOTI_SETTINGS_INSIGNIFICANT_BG_ACTIVITIES = "noti_filter_background_notification";
    public static final String INDEX_NOTI_SETTINGS_INSIGNIFICANT_MINIMIZED_NOTIFICATIONS = "noti_filter_low_importance_notification";
    public static final String INDEX_NOTI_SETTINGS_INSIGNIFICANT_OLD_NOTIFICATIONS = "noti_filter_old_notification";
    public static final String INDEX_NOTI_SETTINGS_INSIGNIFICANT_PROMOTION = "noti_filter_promotion_notification";
    ...
    public static final String INDEX_SATELLITE_MODE_ENABLED = "satellite_mode_enabled";
    public static final String INDEX_SCREEN_OFF_MEMO = "screen_off_memo";
    public static final String INDEX_SEARCH_ALL_ENTRYPOINTS_ENABLED = "search_all_entrypoints_enabled";
    ...
    public static final String INDEX_SPLIT_QUICK_PANEL_REVERSED = "split_quick_panel_reversed";
    ...
    public static final String INDEX_USER_SETUP_COMPLETE = "user_setup_complete";
    ...
    private String getDefaultShortcut(int i) {
    ...
    private boolean isInstalledPackageAsUser(String str, int i) {
        try {
            this.mContext.getPackageManager().getApplicationInfoAsUser(str, 128, i);
            return true;
        } catch (PackageManager.NameNotFoundException unused) {
            MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Package not found : ", str, TAG);
            return false;
        }
    }
    ...
    private void setUpSettingsItem() {
        ...
        Integer num7 = num;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_MIC_MODE_ENABLE, DATA_TYPE_INT, num7, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_MIC_MODE_EFFECT, DATA_TYPE_INT, num7, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_MIC_MODE_WIFI_CALL, DATA_TYPE_INT, num7, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_VOIP_TRANSLATOR_ENABLE, DATA_TYPE_INT, num7, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_BUDS_ENABLE, DATA_TYPE_INT, num7, false));
        if (QpRune.QUICK_CLOCK_BELL_TOWER_ALTERNATE_CALENDAR) {
            ...
            this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_HIJRI_CALENDAR, DATA_TYPE_INT, num, false));
        }
        ...
        if (QpRune.QUICK_MUM_TWO_PHONE) {
            Integer num8 = num;
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_TWO_PHONE_REGISTER, DATA_TYPE_INT, num8, false));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_TWO_PHONE_ACCOUNT, DATA_TYPE_INT, num8, false));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_TWO_PHONE_CALL_ENABLED, DATA_TYPE_INT, num8, false));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_TWO_PHONE_SMS_ENABLED, DATA_TYPE_INT, num8, false));
        }
        ...
        Integer num9 = num;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_SPLIT_QUICK_PANEL_REVERSED, DATA_TYPE_INT, num9, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, EMERGENCY_MESSAGE_IN_WORKING_STATE, DATA_TYPE_INT, num9, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_BLUE_LIGHT_FILTER, DATA_TYPE_INT, num9, true));
        ...
        Integer num10 = num;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_BLUELIGHT_FLITER_TYPE, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_GRAYSCALE, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NEGATIVE_COLORS, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_COLOR_ADJUSTMENT, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_COLOR_LENS, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NIGHT_DIM, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_ACCESSIBILITY_DISPLAY_INVERSION_ENABLED, DATA_TYPE_INT, num10, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_ACCESSIBILITY_REDUCE_BRIGHT_COLORS_ACTIVATED, DATA_TYPE_INT, num10, true));
        ...
        Integer num11 = num;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_FLASHLIGHT_SOS_ON, DATA_TYPE_INT, num11, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_CAMERA_FLASH_NOTIFICATION, DATA_TYPE_INT, num11, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_ACCESSIBILITY_HIGH_TEXT_CONTRAST_ENABLED, DATA_TYPE_INT, num11, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_MOBILE_DATA_QUESTION, DATA_TYPE_INT, num11, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_ROTATION_HOME_SCREEN, DATA_TYPE_INT, num11, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_ROTATION_CALL_SCREEN, DATA_TYPE_INT, num11, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_ACCELEROMETER_ROTATION, DATA_TYPE_INT, num11, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_PROTECT_BATTERY, DATA_TYPE_INT, num11, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_POWERSAVING_SWITCH, DATA_TYPE_INT, num11, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_PSM_SWITCH, DATA_TYPE_INT, num11, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_LOW_POWER_MODE, DATA_TYPE_INT, num11, false));
        if (BasicRune.STATUS_REAL_TIME_NETWORK_SPEED) {
            num2 = num11;
            this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_STATUSBAR_NETWORK_SPEED, DATA_TYPE_INT, num11, true));
        } else {
            num2 = num11;
        }
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_INDICATOR_SHOW_NETWORK_INFORMATION, DATA_TYPE_INT, 1, true));
        Integer num12 = num2;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_ACCESSIBILITY_REDUCE_TRANSPARENCY, DATA_TYPE_INT, num12, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_EMERGENCY_MODE, DATA_TYPE_INT, num12, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_MINIMAL_BATTERY_USE, DATA_TYPE_INT, num12, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_ULTRA_POWERSAVING_MODE, DATA_TYPE_INT, num12, true));
        ...
        Integer num13 = num2;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_WALLPAPER_THEME_COLOR_GRAY, DATA_TYPE_INT, num13, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_SNOOZE_SETTING, DATA_TYPE_INT, num13, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_MEDIA_ONGOING, DATA_TYPE_INT, 1, true));
        Integer num14 = num2;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_DEVELOP_RON_TEST, DATA_TYPE_INT, num14, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NOTI_SETTINGS_INSIGNIFICANT, DATA_TYPE_INT, num14, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NOTI_SETTINGS_INSIGNIFICANT_PROMOTION, DATA_TYPE_INT, num14, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NOTI_SETTINGS_INSIGNIFICANT_BG_ACTIVITIES, DATA_TYPE_INT, num14, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NOTI_SETTINGS_INSIGNIFICANT_MINIMIZED_NOTIFICATIONS, DATA_TYPE_INT, num14, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_NOTI_SETTINGS_INSIGNIFICANT_OLD_NOTIFICATIONS, DATA_TYPE_INT, num14, true));
        ...
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_FINGER_SENSOR_BLOCK_POPUP_SHOW_AGAIN, DATA_TYPE_INT, num2, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_FACE_STAY_ON_LOCK, DATA_TYPE_INT, 1, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_AIRPLANE_MODE_ON, DATA_TYPE_INT, num2, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_BOUNCER_ONE_HAND_POSITION, DATA_TYPE_INT, 1, false));
        Integer num15 = num2;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_LOCKSCREEN_2_STEP_VERIFICATION, DATA_TYPE_INT, num15, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_MDM_AUTO_WIPE_ENABLE, DATA_TYPE_INT, num15, true));
        ...
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_RESET_CREDENTIAL, DATA_TYPE_INT, num2, true));
        ...
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_FINGERPRINT_STAY_ON_LOCK, DATA_TYPE_INT, num2, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_THEME_FONT_NUMERIC, DATA_TYPE_STRING, null, true));
        Integer num16 = num2;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_NDIGITS_PIN, DATA_TYPE_INT, num16, true));
        if (CscRune.SECURITY_DISABLE_EMERGENCY_CALL_WHEN_OFFLINE) {
            num3 = num16;
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, "satellite_mode_enabled", DATA_TYPE_INT, num16, false));
        } else {
            num3 = num16;
        }
        ...
        Integer num17 = num3;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_AOD_MODE_START_TIME, DATA_TYPE_INT, num17, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_AOD_MODE_END_TIME, DATA_TYPE_INT, num17, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_AOD_SHOW_STATE, DATA_TYPE_INT, num17, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_AOD_SHOW_FOR_NEW_NOTI, DATA_TYPE_INT, num17, true));
        if (LsRune.SUBSCREEN_WATCHFACE) {
            num4 = num17;
            this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_SHOW_NAVIGATION_FOR_SUBSCREEN, DATA_TYPE_INT, num17, false));
        } else {
            num4 = num17;
        }
        if (z) {
            ...
            this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, SMART_COVER_ENABLED, DATA_TYPE_INT, num4, true));
        ...
        Integer num18 = num4;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_COLOR_THEME_APP_ICON, DATA_TYPE_INT, num18, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, "wallpapertheme_state", DATA_TYPE_INT, num18, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_SHOW_BUTTON_BACKGROUND, DATA_TYPE_INT, num18, true));
        this.mItemLists.add(new Item(SETTING_TYPE_SYSTEM, INDEX_DARK_FILTER_WALLPAPER, DATA_TYPE_INT, 1, true, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, "wallpapertheme_state", DATA_TYPE_INT, num4, true));
        ...
        Integer num19 = num4;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_PLUGIN_LOCK_WALLPAPER_TYPE, DATA_TYPE_INT, num19, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_PLUGIN_LOCK_WALLPAPER_TYPE_SUB, DATA_TYPE_INT, num19, true));
        ...
        Integer num20 = num4;
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_DARK_THEME, DATA_TYPE_INT, num20, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_AWESOME_SHORTCUT_APP_LIST, DATA_TYPE_STRING, num20, true));
        if (BasicRune.NAVBAR_ENABLED) {
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATIONBAR_KEY_ORDER, DATA_TYPE_INT, num20, false));
            ...
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATIONBAR_USE_THEME_DEFAULT, DATA_TYPE_INT, num20, false));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATIONBAR_CURRENT_COLOR, DATA_TYPE_INT, -855310, false));
            num20 = num20;
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATIONBAR_COLOR, DATA_TYPE_INT, num20, false));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATIONBAR_SPLUGIN_FLAGS, DATA_TYPE_INT, num20, false));
            this.mItemLists.add(new Item(SETTING_TYPE_SECURE, INDEX_USER_SETUP_COMPLETE, DATA_TYPE_INT, num20, true, true));
        }
        if (BasicRune.NAVBAR_REMOTEVIEW) {
            this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_GAME_DOUBLE_SWIPE_ENABLE, DATA_TYPE_INT, num20, false));
            num5 = num20;
            this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_GAME_SHOW_FLOATING_ICON, DATA_TYPE_INT, num20, false));
        } else {
            num5 = num20;
        }
        ...
        if (BasicRune.NAVBAR_GESTURE) {
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATION_BAR_GESTURE_WHILE_HIDDEN, DATA_TYPE_INT, num5, false));
            ...
            Integer num21 = num5;
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATIONBAR_BLOCK_GESTURES_WITH_SPEN, DATA_TYPE_INT, num21, false));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NAVIGATION_BAR_GESTURE_DISABLED_BY_POLICY, DATA_TYPE_INT, num21, false));
            ...
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_MW_ENTER_SPLIT_USING_GESTURE, DATA_TYPE_INT, num5, false));
        }
        ...
        if (BasicRune.NAVBAR_SUPPORT_LARGE_COVER_SCREEN) {
            num6 = num5;
            this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_LARGE_COVER_SCREEN_NAVIGATION, DATA_TYPE_INT, num6, false));
        } else {
            num6 = num5;
        }
        if (BasicRune.NAVBAR_MULTI_MODAL_ICON) {
            this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_KEYBOARD_BUTTON_POSITION, DATA_TYPE_INT, num6, true));
        }
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_MOBILE_DATA, DATA_TYPE_INT, num6, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_DATA_ROAMING, DATA_TYPE_INT, num6, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_MULTI_SIM_DEVICE_SIM1_ON, DATA_TYPE_INT, num6, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_MULTI_SIM_DEVICE_SIM2_ON, DATA_TYPE_INT, num6, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_FILL_UDC_DISPLAY_CUTOUT, DATA_TYPE_INT, num6, false));
        Integer num22 = num6;
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, "satellite_mode_enabled", DATA_TYPE_INT, num6, false));
        ...
        if (BasicRune.SEARCLE) {
            ...
            this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_SEARCH_ALL_ENTRYPOINTS_ENABLED, DATA_TYPE_INT, Integer.valueOf(Settings.Secure.getInt(this.mContext.getContentResolver(), INDEX_SEARCH_ALL_ENTRYPOINTS_ENABLED, 1)), true));
        }
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_NAVIGATION_MODE, DATA_TYPE_STRING, null, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_ASSIST_DISCLOSURE_ENABLED, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, "icon_blacklist", DATA_TYPE_STRING, null, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_QUICKSTAR_DATE_FORMAT, DATA_TYPE_INT, num22, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_QS_BUTTON_GRID_POPUP, DATA_TYPE_INT, num22, false));
        ...
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_ACCESS_CONTROL_ENABLED, DATA_TYPE_INT, num22, true));
        ...
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_LIFT_TO_WAKE, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_ACTION_MEMO_ON_OFF_SCREEN, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_SCREEN_OFF_MEMO, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_REFRESH_RATE_MODE, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_REFRESH_RATE_MODE_COVER, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_DOUBLE_TAP_TO_SLEEP, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_DARK_THEME, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_PREMIUM_WATCH_SWITCH_ONOFF, DATA_TYPE_INT, num22, true));
        if (DeviceType.isSupportPenDetachmentOption(this.mContext)) {
            this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_PEN_DETACHMENT_OPTION, DATA_TYPE_INT, null, true));
        }
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_TRANSITION_ANIMATION_SCALE, DATA_TYPE_STRING, null, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_ACCESSIBILITY_INTERACTIVE_UI_TIMEOUT_MS, DATA_TYPE_INT, num22, true));
        ...
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_NOTI_POLICY_APPLY_WALPAPER_THEME, DATA_TYPE_INT, num22, false));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_LOCK_TOUCH_AND_HOLD_TO_EDIT, DATA_TYPE_INT, 1, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_REMOVE_ANIMATION, DATA_TYPE_INT, num22, true));
        this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_ALL_SOUND_OFF, DATA_TYPE_INT, num22, false));
        ...
        if (z2 || NotiRune.NOTI_SUBSCREEN_CLEAR_COVER) {
            ...
            if (z2) {
                this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_COVER_SCREEN_SHOW_NOTIFICATION_TIP, DATA_TYPE_INT, num22, true));
        ...
        if (NotiRune.NOTI_SUBSCREEN_NOTIFICATION_FIFTH) {
            ...
            this.mItemLists.add(new Item(this, SETTING_TYPE_SYSTEM, INDEX_AI_INFO_CONFIRMED, DATA_TYPE_INT, num22, true));
            this.mItemLists.add(new Item(this, SETTING_TYPE_GLOBAL, INDEX_SUGGESTION_RESPONSES, DATA_TYPE_INT, num22, false));
            if (NotiRune.NOTI_SUBSCREEN_SUPPORT_SMART_REPLY_AI_FOR_CHINA) {
                ItemMap itemMap3 = this.mItemLists;
                Item item = new Item(this, SETTING_TYPE_GLOBAL, INDEX_SUGGESTION_RESPONSES_USED, DATA_TYPE_INT, num22, false);
                num22 = num22;
                itemMap3.add(item);
                this.mItemLists.add(new Item(this, SETTING_TYPE_SECURE, INDEX_AICORE_ENABLED_FEATURES, DATA_TYPE_STRING, null, false));
            } else {
                num22 = num22;
            }
        }
    ...
    public String getAiCoreEnabledFeatures() {
        if (NotiRune.NOTI_SUBSCREEN_NOTIFICATION_FIFTH && NotiRune.NOTI_SUBSCREEN_SUPPORT_SMART_REPLY_AI_FOR_CHINA) {
            return this.mItemLists.get(INDEX_AICORE_ENABLED_FEATURES).getStringValue();
        }
        return null;
    }
    ...
    public int getBinderCallMonitor() {
        return this.mItemLists.get(BINDER_CALL_MONITOR).getIntValue();
    }
    ...
    public int getEdgeBackGestureDisablePolicy() {
        if (BasicRune.NAVBAR_GESTURE) {
            return this.mItemLists.get(INDEX_NAVIGATION_BAR_GESTURE_DISABLED_BY_POLICY).getIntValue();
        }
        return 0;
    }
    ...
    public boolean isCarrierLogoEnabled() {
        return DeviceState.isTestModeIndicatorGarden() || this.mItemLists.get(INDEX_INDICATOR_SHOW_NETWORK_INFORMATION).getIntValue() == 1;
    }
    ...
    public boolean isDevelopRonTestAllowed() {
        return this.mItemLists.get(INDEX_DEVELOP_RON_TEST).getIntValue() == 1;
    }
    ...
    public boolean isEnableInsignificant() {
        return this.mItemLists.get(INDEX_NOTI_SETTINGS_INSIGNIFICANT).getIntValue() == 1;
    }

    public boolean isEnableInsignificantBgActivities() {
        return this.mItemLists.get(INDEX_NOTI_SETTINGS_INSIGNIFICANT_BG_ACTIVITIES).getIntValue() == 1;
    }

    public boolean isEnableInsignificantMinimized() {
        return this.mItemLists.get(INDEX_NOTI_SETTINGS_INSIGNIFICANT_MINIMIZED_NOTIFICATIONS).getIntValue() == 1;
    }

    public boolean isEnableInsignificantOld() {
        return this.mItemLists.get(INDEX_NOTI_SETTINGS_INSIGNIFICANT_OLD_NOTIFICATIONS).getIntValue() == 1;
    }

    public boolean isEnableInsignificantPromotion() {
        return this.mItemLists.get(INDEX_NOTI_SETTINGS_INSIGNIFICANT_PROMOTION).getIntValue() == 1;
    }
    ...
    public boolean isMediaOngoingAllowed() {
        return this.mItemLists.get(INDEX_MEDIA_ONGOING).getIntValue() == 1;
    }
    ...
    public String isNavigationMode() {
        return this.mItemLists.get(INDEX_NAVIGATION_MODE).getStringValue();
    }
    ...
    public boolean isPanelSplitReversed() {
        return Settings.Secure.getIntForUser(this.mContext.getContentResolver(), INDEX_SPLIT_QUICK_PANEL_REVERSED, 0, -2) != 0;
    }
    ...
    public boolean isPopStyleDetail() {
        return this.mItemLists.get(INDEX_EDGE_LIGHTING_ON).getIntValue() == 0;
    }
    ...
    public boolean isSatelliteEnabled() {
        return this.mItemLists.get("satellite_mode_enabled").getIntValue() == 1;
    }

    public boolean isSatelliteModeEnabled() {
        return this.mItemLists.get("satellite_mode_enabled").getIntValue() != 0;
    }
    ...
    public boolean isSearchAllEntryPointsEnabled() {
        return BasicRune.SEARCLE && this.mItemLists.get(INDEX_SEARCH_ALL_ENTRYPOINTS_ENABLED).getIntValue() == 1;
    }
    ...
    public boolean isShowNetworkSpeedInStatusBar() {
        return DeviceState.isTestModeIndicatorGarden() || this.mItemLists.get(INDEX_STATUSBAR_NETWORK_SPEED).getIntValue() != 0;
    }
    ...
    public boolean isUserSetupComplete() {
        return this.mItemLists.get(INDEX_USER_SETUP_COMPLETE).getIntValue() == 1;
    }
    ...
    public void resetBinderCallMonitor() {
        Settings.System.putIntForUser(this.mContext.getContentResolver(), BINDER_CALL_MONITOR, 0, -2);
    }

    public void resetShortcutValue(int i) {
        Settings.System.putStringForUser(this.mContext.getContentResolver(), INDEX_AWESOME_SHORTCUT_APP_LIST, getDefaultShortcut(i), -2);
    }
    ...
    public void setEdgeBackGestureDisablePolicy(int i) {
        Settings.Global.putInt(this.mResolver, INDEX_NAVIGATION_BAR_GESTURE_DISABLED_BY_POLICY, i);
    }
    ...
    public void setPanelSplitReversed(boolean z) {
        Settings.Secure.putIntForUser(this.mContext.getContentResolver(), INDEX_SPLIT_QUICK_PANEL_REVERSED, z ? 1 : 0, -2);
    }
