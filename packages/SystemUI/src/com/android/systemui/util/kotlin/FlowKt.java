...
public final class FlowKt {
    ...
    public static final <T> Flow onSubscriberAdded(MutableSharedFlow mutableSharedFlow) {
        final Flow pairwise = pairwise(mutableSharedFlow.getSubscriptionCount(), 0);
    ...
    public static final <T> Flow pairwise(Flow flow) {
        return pairwiseBy(flow, FlowKt$pairwise$3.INSTANCE);
    }
    ...
    public static final <T> Flow setChanges(Flow flow, boolean z) {
        return setChangesBy(flow, FlowKt$setChanges$3.INSTANCE, z);
    }
    ...
    public static final <T> Flow m3149slidingWindow8Mi8wO0(Flow flow, long j, SystemClock systemClock) {
    ...
    public static /* synthetic */ Flow m3150slidingWindow8Mi8wO0$default(Flow flow, long j, SystemClock systemClock, int i, Object obj) {
        if ((i & 2) != 0) {
            systemClock = new SystemClockImpl();
        }
        return m3149slidingWindow8Mi8wO0(flow, j, systemClock);
    }
    ...
    public static final <S, T extends S> Flow pairwise(Flow flow, S s) {
        return pairwiseBy(flow, s, FlowKt$pairwise$6.INSTANCE);
    }
