...
public final class SysUICoroutinesModule_NotifInflationCoroutineDispatcherFactory implements Provider {
    ...
    public static CoroutineDispatcher notifInflationCoroutineDispatcher(SysUICoroutinesModule sysUICoroutinesModule, Executor executor, CoroutineDispatcher coroutineDispatcher) {
        CoroutineDispatcher coroutineDispatcherNotifInflationCoroutineDispatcher = sysUICoroutinesModule.notifInflationCoroutineDispatcher(executor, coroutineDispatcher);
        coroutineDispatcherNotifInflationCoroutineDispatcher.getClass();
        return coroutineDispatcherNotifInflationCoroutineDispatcher;
    }
