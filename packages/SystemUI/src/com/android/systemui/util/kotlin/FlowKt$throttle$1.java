...
final class FlowKt$throttle$1 extends SuspendLambda implements Function2 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        final class C04151<T> implements FlowCollector {
            final /* synthetic */ ProducerScope $$this$channelFlow;
            ...
            final class C04161 extends SuspendLambda implements Function2 {
                ...
                final class C04171 extends SuspendLambda implements Function2 {
                    ...
                    public C04171(ProducerScope producerScope, Object obj, Ref$LongRef ref$LongRef, SystemClock systemClock, Continuation continuation) {
                    ...
                    public final Continuation create(Object obj, Continuation continuation) {
                        return new C04171(this.$$this$channelFlow, this.$it, this.$previousEmitTimeMs, this.$clock, continuation);
                    }
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C04161(long j, Ref$ObjectRef<Job> ref$ObjectRef, CoroutineScope coroutineScope, ProducerScope producerScope, Object obj, Ref$LongRef ref$LongRef, SystemClock systemClock, Continuation continuation) {
                    super(2, continuation);
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation create(Object obj, Continuation continuation) {
                    return new C04161(this.$timeUntilNextEmit, this.$sendJob, this.$outerScope, this.$$this$channelFlow, this.$it, this.$previousEmitTimeMs, this.$clock, continuation);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    this.$sendJob.element = (T) CoroutineTracingKt.launchTraced$default(this.$outerScope, null, CoroutineStart.UNDISPATCHED, new C04171(this.$$this$channelFlow, this.$it, this.$previousEmitTimeMs, this.$clock, null), 3);
                    return Unit.INSTANCE;
                }
            ...
            public C04151(Ref$ObjectRef<Job> ref$ObjectRef, Ref$ObjectRef<Job> ref$ObjectRef2, SystemClock systemClock, Ref$LongRef ref$LongRef, long j, CoroutineScope coroutineScope, ProducerScope producerScope, CoroutineScope coroutineScope2) {
            ...
            */
            public final java.lang.Object emit(T r19, kotlin.coroutines.Continuation r20) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.util.kotlin.FlowKt$throttle$1.AnonymousClass1.C04151.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C04151 c04151 = new C04151(ref$ObjectRef, ref$ObjectRef2, this.$clock, ref$LongRef, this.$periodMs, coroutineScope, this.$$this$channelFlow, coroutineScope);
                this.label = 1;
                if (flow.collect(c04151, this) == coroutineSingletons) {
                    return coroutineSingletons;
                }
            } else {
                if (i != 1) {
