...
public final class UserAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public UserAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1(Continuation continuation, UserAwareSettingsRepository userAwareSettingsRepository, String str, boolean z) {
    ...
    public final Object invoke(FlowCollector flowCollector, UserInfo userInfo, Continuation continuation) {
        UserAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1 userAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1 = new UserAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1(continuation, this.this$0, this.$name$inlined, this.$defaultValue$inlined);
        userAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1.L$0 = flowCollector;
        userAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1.L$1 = userInfo;
        return userAwareSettingsRepository$boolSetting$$inlined$flatMapLatest$1.invokeSuspend(Unit.INSTANCE);
    }
}
