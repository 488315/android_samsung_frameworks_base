...
public abstract class UserAwareSettingsRepository {
    ...
    public final <T> Flow settingObserver(String str, int i, final Function0 function0) {
        final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new UserAwareSettingsRepository$settingObserver$1(null), SettingsProxyExt.INSTANCE.observerFlow(this.userSettings, i, str));
            ...
            public final class AnonymousClass2<T> implements FlowCollector {
                ...
                */
                public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
                    /*
                        r4 = this;
                        boolean r0 = r6 instanceof com.android.systemui.util.settings.repository.UserAwareSettingsRepository$settingObserver$$inlined$map$1.AnonymousClass2.AnonymousClass1
                        if (r0 == 0) goto L13
                        r0 = r6
                        com.android.systemui.util.settings.repository.UserAwareSettingsRepository$settingObserver$$inlined$map$1$2$1 r0 = (com.android.systemui.util.settings.repository.UserAwareSettingsRepository$settingObserver$$inlined$map$1.AnonymousClass2.AnonymousClass1) r0
                        int r1 = r0.label
                        ...
                        goto L18
                    L13:
                        com.android.systemui.util.settings.repository.UserAwareSettingsRepository$settingObserver$$inlined$map$1$2$1 r0 = new com.android.systemui.util.settings.repository.UserAwareSettingsRepository$settingObserver$$inlined$map$1$2$1
                        r0.<init>(r6)
                    L18:
                    ...
                    L45:
                        ...
                        return r4
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.util.settings.repository.UserAwareSettingsRepository$settingObserver$$inlined$map$1.AnonymousClass2.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }
    ...
    public final Object getInt(String str, int i, Continuation continuation) {
        return BuildersKt.withContext(this.bgContext, new UserAwareSettingsRepository$getInt$2(this, str, i, null), continuation);
    }

    public final Object getString(String str, Continuation continuation) {
        return BuildersKt.withContext(this.bgContext, new UserAwareSettingsRepository$getString$2(this, str, null), continuation);
    }
    ...
    public final Object setBoolean(String str, boolean z, Continuation continuation) {
        Object withContext = BuildersKt.withContext(this.bgContext, new UserAwareSettingsRepository$setBoolean$2(this, str, z, null), continuation);
        return withContext == CoroutineSingletons.COROUTINE_SUSPENDED ? withContext : Unit.INSTANCE;
    }

    public final Object setInt(String str, int i, Continuation continuation) {
        Object withContext = BuildersKt.withContext(this.bgContext, new UserAwareSettingsRepository$setInt$2(this, str, i, null), continuation);
        return withContext == CoroutineSingletons.COROUTINE_SUSPENDED ? withContext : Unit.INSTANCE;
    }
}
