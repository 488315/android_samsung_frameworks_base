...
public class FalsingCollectorImpl implements FalsingCollector {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [com.android.systemui.classifier.FalsingCollectorImpl$$ExternalSyntheticLambda1] */
    /* JADX WARN: Type inference failed for: r0v2, types: [com.android.systemui.classifier.FalsingCollectorImpl$1] */
    /* JADX WARN: Type inference failed for: r0v3, types: [com.android.systemui.classifier.FalsingCollectorImpl$2] */
    /* JADX WARN: Type inference failed for: r0v5, types: [com.android.systemui.classifier.FalsingCollectorImpl$4] */
    /* JADX WARN: Type inference failed for: r0v6, types: [com.android.systemui.classifier.FalsingCollectorImpl$5] */
    ...
    public final void init() {
        ...
        AnonymousClass1 anonymousClass1 = this.mStatusBarStateListener;
        StatusBarStateController statusBarStateController = this.mStatusBarStateController;
        statusBarStateController.addCallback(anonymousClass1);
