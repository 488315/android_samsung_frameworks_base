...
public class NotificationControlActionInteractor implements ActionInteractor {
    ...
    static final String CATEGORY_NOTIFICATION_NOT_RING_AS_SET = "NOTIFICATION_NOT_RING_AS_SET";
    ...
    static final int RESULT_ALREADY_TURNED_ON_ALERTS = 131072;
    ...
    static final int RESULT_SETTING_BLOCKED_BY_DND = 1048576;
    static final int RESULT_SETTING_BLOCKED_BY_NO_CHANNEL = 8388608;
    static final int RESULT_SETTING_BLOCKED_BY_NO_PERMISSION = 16777216;
    static final int RESULT_SETTING_BLOCKED_BY_SETTING_OFF = 4194304;
    static final int RESULT_SETTING_BLOCKED_BY_SOUND_MUTE = 2097152;
    ...
    public class DisplayContent {
        ...
        public DisplayContent(NotificationControlActionInteractor notificationControlActionInteractor, String str, String str2) {
            this.appName = str;
            this.notiCount = str2;
        }
    ...
    public class NotificationList {
        ...
        public NotificationList(NotificationControlActionInteractor notificationControlActionInteractor, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8) {
            this.notiID = str;
            this.notiTitle = str2;
            this.notiText = str3;
            this.canReply = str4;
    ...
    public class Result {
        ...
        public Result(NotificationControlActionInteractor notificationControlActionInteractor) {
        }
        ...
        public Result(NotificationControlActionInteractor notificationControlActionInteractor, String str, String str2, String str3) {
            this.result = str;
    ...
    private CommandActionResponse respondCompleted(int i) {
        return i != 1 ? i != 2 ? i != 3 ? i != 4 ? new CommandActionResponse(2, ActionResults.RESULT_FAIL) : new CommandActionResponse(2, ActionResults.RESULT_ALL_IS_ONGOING_NOTI) : new CommandActionResponse(2, ActionResults.RESULT_NO_MATCHED_APP_NAME) : new CommandActionResponse(2, ActionResults.RESULT_NO_NOTIFICATION_EXIST) : new CommandActionResponse(1, "success");
    }

    @Override // com.android.systemui.bixby2.interactor.ActionInteractor
    public List<String> getSupportingActions() {
        return (List) Arrays.stream(Action.values()).map(new NotificationControlActionInteractor$$ExternalSyntheticLambda0()).collect(Collectors.toList());
    }
    ...
    public Command loadStatefulCommandInteractor(String str, Command command) {
        ...
        if (matchAction(str)) {
            ...
            if (Action.query_notification_settings.toString().equals(str)) {
    ...
    public void performCommandActionInteractor(String str, CommandAction commandAction, ICommandActionCallback iCommandActionCallback) {
        if (matchAction(str)) {
            ...
            String str2 = commandAction.getActionType() != 5 ? null : ((JSONStringAction) commandAction).mNewValue;
            if (isNotiPerformAction(str)) {
                ...
                if (Action.delete_notification.toString().equals(str)) {
                    ...
                    ListPopupWindow$$ExternalSyntheticOutline0.m(notificationTurnOffForPackage, "setNotificationTurnOffForPackage() result = ", "NotificationControlActionInteractor");
                    commandActionResponse = notificationTurnOffForPackage == 8 ? new CommandActionResponse(2, ActionResults.RESULT_CANNOT_SET_OFF_NOTIFICATION) : notificationTurnOffForPackage == 9 ? new CommandActionResponse(2, "already_set") : notificationTurnOffForPackage == 1 ? new CommandActionResponse(1, "success") : new CommandActionResponse(2, ActionResults.RESULT_FAIL);
                }
                ...
                commandActionResponse = this.mNotificationController.goToNotiSettings(this.mContext) ? new CommandActionResponse(1, "success") : new CommandActionResponse(2, ActionResults.RESULT_FAIL);
            } else if (Action.query_notification_settings.toString().equals(str)) {
                if (str2 == null) {
                    Log.d("NotificationControlActionInteractor", "jsonString is null !! ");
                }
                PackageInfoBixby packageInfoFromJson2 = ParamsParser.getPackageInfoFromJson(str2);
                ExifInterface$$ExternalSyntheticOutline0.m(new StringBuilder("Category = "), packageInfoFromJson2.Category, "NotificationControlActionInteractor");
                if (packageInfoFromJson2.Category.equals(CATEGORY_NOTIFICATION_NOT_RECEIVED)) {
                    commandActionResponse = (this.mNotificationController.getNotificationSettingStatus(true) & RESULT_SETTING_BLOCKED_BY_DND) != 0 ? new CommandActionResponse(1, "1") : new CommandActionResponse(1, "0");
                } else if (packageInfoFromJson2.Category.equals(CATEGORY_NOTIFICATION_NOT_RING_AS_SET)) {
                    commandActionResponse = (this.mNotificationController.getNotificationSettingStatus(false) & RESULT_SETTING_BLOCKED_BY_SOUND_MUTE) != 0 ? new CommandActionResponse(1, "1") : new CommandActionResponse(1, "0");
                } else if (packageInfoFromJson2.Category.equals(CATEGORY_APP_NOTIFICATION_NOT_RECEIVED)) {
                    String str3 = packageInfoFromJson2.PackageName;
                    if (str3 != null) {
                        int appNotificationSettingStatus = this.mNotificationController.getAppNotificationSettingStatus(str3);
                        commandActionResponse = (appNotificationSettingStatus & RESULT_SETTING_BLOCKED_BY_DND) != 0 ? new CommandActionResponse(1, "2") : (RESULT_SETTING_BLOCKED_BY_SETTING_OFF & appNotificationSettingStatus) != 0 ? new CommandActionResponse(1, "1") : (appNotificationSettingStatus & RESULT_SETTING_BLOCKED_BY_NO_CHANNEL) != 0 ? new CommandActionResponse(1, "3") : new CommandActionResponse(1, "0");
                    } else {
                        commandActionResponse = new CommandActionResponse(2, ActionResults.RESULT_FAIL);
                    }
                }
            }
            if (commandActionResponse == null && iCommandActionCallback == null) {
                return;
            }
            if (this.DEBUG) {
                StringBuilder sb = new StringBuilder("responseCode = ");
                sb.append(commandActionResponse.responseCode);
                sb.append(", responseMessage = ");
                ExifInterface$$ExternalSyntheticOutline0.m(sb, commandActionResponse.responseMessage, "NotificationControlActionInteractor");
            }
            ((CommandProvider.AnonymousClass1) iCommandActionCallback).onActionFinished(commandActionResponse.responseCode, commandActionResponse.responseMessage);
        }
    }
    ...
    private CommandActionResponse respondCompleted(int i, Bundle bundle) {
        ...
        if (i != 5) {
            ...
            if (bundle != null) {
                ...
                ArrayList arrayList = new ArrayList(Arrays.asList((NotificationList[]) this.mGson.fromJson(bundle.getString(NOTI_LIST), NotificationList[].class)));
                if (this.DEBUG) {
        ...
        if (bundle != null) {
            ...
            ArrayList arrayList2 = new ArrayList(Arrays.asList((NotificationList[]) this.mGson.fromJson(bundle.getString(NOTI_LIST), NotificationList[].class)));
            if (this.DEBUG) {
            ...
            ArrayList arrayList3 = new ArrayList(Arrays.asList((DisplayContent[]) this.mGson.fromJson(this.mNotificationController.getDisplayDescription().toString(), DisplayContent[].class)));
