        ...
        if (matchAction(str)) {
            ...
            if (isNotiPerformAction(str)) {
                ...
                if (packageInfoFromJson2.Category.equals(CATEGORY_NOTIFICATION_NOT_RECEIVED)) {
                    commandActionResponse = (this.mNotificationController.getNotificationSettingStatus(true) & 1048576) != 0 ? new CommandActionResponse(1, "1") : new CommandActionResponse(1, "0");
                } else if (packageInfoFromJson2.Category.equals(CATEGORY_NOTIFICATION_NOT_RING_AS_SET)) {
                    commandActionResponse = (this.mNotificationController.getNotificationSettingStatus(false) & 2097152) != 0 ? new CommandActionResponse(1, "1") : new CommandActionResponse(1, "0");
                    ...
                    if (str3 != null) {
                        ...
                        commandActionResponse = (appNotificationSettingStatus & 1048576) != 0 ? new CommandActionResponse(1, "2") : (4194304 & appNotificationSettingStatus) != 0 ? new CommandActionResponse(1, "1") : (appNotificationSettingStatus & 8388608) != 0 ? new CommandActionResponse(1, "3") : new CommandActionResponse(1, "0");
                    } else {
