...
public final class FlagsFactory {
    ...
    public static ReleasedFlag releasedFlag$default(FlagsFactory flagsFactory, String str) {
        flagsFactory.getClass();
        ReleasedFlag releasedFlag = new ReleasedFlag(str, "systemui", false, 4, null);
