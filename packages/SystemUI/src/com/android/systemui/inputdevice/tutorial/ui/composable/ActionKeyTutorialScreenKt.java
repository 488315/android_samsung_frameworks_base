    ...
    */
    public static final void ActionKeyTutorialScreen(final Function0 function0, final Function0 function02, Composer composer, final int i) {
        ...
        if ((i2 & 19) == 18 && composerImpl.getSkipping()) {
            ...
            LottieDynamicProperties lottieDynamicPropertiesRememberLottieDynamicProperties = LottieDynamicPropertiesKt.rememberLottieDynamicProperties(new LottieDynamicProperty[]{LottieHelpersKt.m2585rememberColorFilterPropertyRPmYEkk(".primaryFixedDim", j, composerImpl), LottieHelpersKt.m2585rememberColorFilterPropertyRPmYEkk(".secondaryFixedDim", j2, composerImpl), LottieHelpersKt.m2585rememberColorFilterPropertyRPmYEkk(".onSecondaryFixed", j3, composerImpl), LottieHelpersKt.m2585rememberColorFilterPropertyRPmYEkk(".onSecondaryFixedVariant", ((AndroidColorScheme) composerImpl.consume(staticProvidableCompositionLocal)).onSecondaryFixedVariant, composerImpl)}, composerImpl);
