...
public final class KeyboardTouchpadTutorialActivity extends ComponentActivity {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        CoroutineTracingKt.launchTraced$default(LifecycleKt.getCoroutineScope(lifecycleRegistry), null, null, new KeyboardTouchpadTutorialActivity$onCreate$1(this, null), 7);
        String stringExtra = getIntent().getStringExtra("entry_point");
        final boolean equals = stringExtra == null ? true : stringExtra.equals("scheduler");
        final boolean equals2 = SystemUIAnalytics.QPNE_VID_COVER_ALL.equals(getIntent().getStringExtra("tutorial_scope"));
        ...
        if (bundle == null) {
            ...
            if ("scheduler".equals(stringExtra)) {
                if (stringExtra2 != null) {
                    ...
                    if (hashCode != -819522316) {
                        if (hashCode != 96673) {
                            if (hashCode == 503739367 && stringExtra2.equals("keyboard")) {
