...
public final class SearcleManager {
    ...
    public SearcleManager(Context context) {
        ...
        this.ctsBroadcastReceiver = new BroadcastReceiver() { // from class: com.android.systemui.searcle.SearcleManager$ctsBroadcastReceiver$1
            ...
            public final void onReceive(Context context2, Intent intent) {
                ...
                if (Intrinsics.areEqual(str, "android.permissionui.cts") || Intrinsics.areEqual(str, "android.voicerecognition.cts") || Intrinsics.areEqual(str, "android.input.cts") || Intrinsics.areEqual(str, "com.google.android.permissionui.gts")) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0225, code lost:
        ...
        if (com.android.systemui.searcle.OmniAPI.mIsOmniPackageEnabled == false) goto L111;
     */
    ...
    */
    public final void startSearcleByHomeKey(boolean r24, boolean r25) {
        /*
