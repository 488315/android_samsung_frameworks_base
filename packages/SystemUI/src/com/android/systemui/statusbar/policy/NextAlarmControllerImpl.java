...
public class NextAlarmControllerImpl extends BroadcastReceiver implements NextAlarmController, Dumpable {
    ...
    public NextAlarmControllerImpl(Executor executor, AlarmManager alarmManager, BroadcastDispatcher broadcastDispatcher, DumpManager dumpManager, UserTracker userTracker) {
        ...
        broadcastDispatcher.registerReceiver(this, AppCompatDelegateImpl$AutoBatteryNightModeManager$$ExternalSyntheticOutline0.m("com.samsung.android.action.ALARM_CLOCK_CHANGED"), null, UserHandle.ALL);
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        while (i < size) {
            ...
            i++;
            printWriter.print("    ");
            printWriter.println(((NextAlarmController.NextAlarmChangeCallback) obj).toString());
        }
    }
