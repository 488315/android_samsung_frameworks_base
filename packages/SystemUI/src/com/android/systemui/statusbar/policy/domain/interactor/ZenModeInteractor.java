...
public final class ZenModeInteractor {
    public ZenModeInteractor(ZenModeRepository zenModeRepository) {
        ZenModeRepositoryImpl zenModeRepositoryImpl = (ZenModeRepositoryImpl) zenModeRepository;
        final Flow flow = zenModeRepositoryImpl.zenMode;
        FlowKt.distinctUntilChanged(new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.statusbar.policy.domain.interactor.ZenModeInteractor$special$$inlined$map$1
        ...
        }), zenModeRepositoryImpl.consolidatedNotificationPolicy, new ZenModeInteractor$areNotificationsHiddenInShade$1(null)));
    }
}
