...
public class NetspeedViewController extends ViewController implements ConfigurationController.ConfigurationListener {
    ...
    public static void m3102$$Nest$monNetspeedSwitchChange(NetspeedViewController netspeedViewController) {
        ...
        if (z && !netspeedViewController.mRegisterReceiver) {
            ((BroadcastDispatcher) Dependency.sDependency.getDependencyInner(BroadcastDispatcher.class)).registerReceiver(AppCompatDelegateImpl$AutoBatteryNightModeManager$$ExternalSyntheticOutline0.m("android.net.conn.CONNECTIVITY_CHANGE"), anonymousClass1);
    ...
    public final NetspeedView getView() {
        return (NetspeedView) this.mView;
    }
    ...
    public final void onViewAttached() {
        ...
        if (!this.mRegisterReceiver && sNetspeedSwitch) {
            ((BroadcastDispatcher) Dependency.sDependency.getDependencyInner(BroadcastDispatcher.class)).registerReceiver(AppCompatDelegateImpl$AutoBatteryNightModeManager$$ExternalSyntheticOutline0.m("android.net.conn.CONNECTIVITY_CHANGE"), this.mNetworkStatsReceiver);
