...
import com.android.systemui.statusbar.notification.row.NotificationContentView$$ExternalSyntheticLambda5;
...
public class RemoteInputView extends LinearLayout implements View.OnClickListener {
    ...
    public NotificationContentView$$ExternalSyntheticLambda5 mOnVisibilityChangedListener;
    ...
    public class EditorActionHandler implements TextView.OnEditorActionListener {
        ...
        public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
            ...
            if (RemoteInputView.this.mEditText.length() > 0 || RemoteInputView.this.mEntry.remoteInputAttachment != null) {
                ...
                ArrayList arrayList = new ArrayList(remoteInputView.mOnSendListeners);
    ...
    public class RemoteEditText extends EditText {
        ...
        public final void onFocusChanged(boolean z, int i, Rect rect) {
            ...
            if (remoteInputView != null) {
                Object obj = RemoteInputView.VIEW_TAG;
                remoteInputView.getClass();
                ArrayList arrayList = new ArrayList(remoteInputView.mEditTextFocusChangeListeners);
                int size = arrayList.size();
                int i2 = 0;
                while (i2 < size) {
                    Object obj2 = arrayList.get(i2);
                    i2++;
                    ((View.OnFocusChangeListener) obj2).onFocusChange(this, z);
                }
            }
            if (!z) {
            ...
            if (remoteInputView2 != null) {
                Object obj3 = RemoteInputView.VIEW_TAG;
                remoteInputView2.getClass();
                LightBarControllerImpl lightBarControllerImpl = (LightBarControllerImpl) this.mLightBarController;
                if (lightBarControllerImpl.mDirectReplying == z) {
                    return;
                }
                lightBarControllerImpl.mDirectReplying = z;
    ...
    public RemoteInputView(Context context, AttributeSet attributeSet) {
        ...
        this.mLastBackgroundColor = getContext().getColor(android.R.color.surface_header_light);
    }
    ...
    public final void focus() {
        ...
        viewRootImpl.getOnBackInvokedDispatcher().registerOnBackInvokedCallback(0, this.mEditText.mOnBackInvokedCallback);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        RemoteInputView remoteInputView = this.mEditText.mRemoteInputView;
        if (remoteInputView != null) {
    ...
    public final void onFinishInflate() {
        ...
        remoteEditText.setPrivateImeOptions("disableSticker=true;disableGifKeyboard=true;disableDirectWriting=true");
        RemoteEditText remoteEditText2 = this.mEditText;
        ...
        if (this.mProgressBar.getVisibility() == 0) {
            ...
            onDefocus(true, false, new Runnable() { // from class: com.android.systemui.statusbar.policy.RemoteInputView$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ...
                    remoteInputView.mEntry.hasSentReply = false;
                }
            });
        }
    ...
    public final void onVisibilityChanged(View view, int i) {
        super.onVisibilityChanged(view, i);
        if (view == this) {
            NotificationContentView$$ExternalSyntheticLambda5 notificationContentView$$ExternalSyntheticLambda5 = this.mOnVisibilityChangedListener;
            if (notificationContentView$$ExternalSyntheticLambda5 != null) {
                notificationContentView$$ExternalSyntheticLambda5.accept(Boolean.valueOf(i == 0));
            }
