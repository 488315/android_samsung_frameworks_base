...
public class FlashlightControllerImpl implements FlashlightController {
            ...
            public final void onTorchModeChanged(String str, boolean z) {
                if (TextUtils.equals(str, (CharSequence) FlashlightControllerImpl.this.mCameraId.get())) {
                    ...
                    if (secFlashlightControllerImpl != null) {
                        ...
                        if (QpRune.QUICK_SUBSCREEN_SETTINGS && !secFlashlightControllerImpl2.mDisplayLifecycle.mIsFolderOpened) {
                            ...
                            if (z) {
                                ...
                                SubroomFlashLightSettingsActivity subroomFlashLightSettingsActivity2 = subscreenFlashLightController.mFlashLightPresentationView;
                                if (subroomFlashLightSettingsActivity2 != null) {
                                    RecyclerView$$ExternalSyntheticOutline0.m(subroomFlashLightSettingsActivity2.mSubScreen, "SubroomFlashLightSettingsActivity", new StringBuilder("getCurrentSubScreen: "));
                                    if (subroomFlashLightSettingsActivity2.mSubScreen == 5) {
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        if (secFlashlightControllerImpl != null) {
            ...
            printWriter.println(secFlashlightControllerImpl.isThermalRestricted());
        }
    }
    ...
    public final synchronized boolean isAvailable() {
        SecFlashlightControllerImpl secFlashlightControllerImpl = this.mSecFlashlightController;
        if (secFlashlightControllerImpl != null) {
            return (!this.mTorchAvailable || secFlashlightControllerImpl.isThermalRestricted() || this.mSecFlashlightController.isFlashlightBlinking()) ? false : true;
        }
