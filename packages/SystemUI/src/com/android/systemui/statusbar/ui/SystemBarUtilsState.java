...
public final class SystemBarUtilsState {
    ...
    public SystemBarUtilsState(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, ConfigurationController configurationController, final SystemBarUtilsProxy systemBarUtilsProxy) {
        final Flow buffer$default = FlowKt.buffer$default(FlowKt.flowOn(new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new SystemBarUtilsState$statusBarHeight$1(null), ConfigurationControllerExtKt.getOnConfigChanged(configurationController)), coroutineContext2), -1, 2);
        ...
        final Flow buffer$default2 = FlowKt.buffer$default(FlowKt.flowOn(new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new SystemBarUtilsState$statusBarHeaderHeightKeyguard$1(null), ConfigurationControllerExtKt.getOnConfigChanged(configurationController)), coroutineContext2), -1, 2);
