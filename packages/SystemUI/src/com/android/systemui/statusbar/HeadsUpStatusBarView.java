...
public class HeadsUpStatusBarView extends AlphaOptimizedLinearLayout {
    ...
    public HeadsUpAppearanceController$$ExternalSyntheticLambda3 mOnDrawingRectChangedListener;
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        HeadsUpAppearanceController$$ExternalSyntheticLambda3 headsUpAppearanceController$$ExternalSyntheticLambda3;
        super.onLayout(z, i, i2, i3, i4);
        this.mLayoutedIconRect.set(0, 0, 0, 0);
        Rect rect = this.mIconDrawingRect;
        float f = rect.left;
        rect.set(this.mLayoutedIconRect);
        if (f == this.mIconDrawingRect.left || (headsUpAppearanceController$$ExternalSyntheticLambda3 = this.mOnDrawingRectChangedListener) == null) {
            return;
        }
