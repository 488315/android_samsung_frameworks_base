...
public class AccessPointControllerImpl implements AccessPointController, WifiPickerTracker.WifiPickerTrackerCallback, LifecycleOwner {
    ...
    public final AnonymousClass1 mSemWifiApSmartCallback = new SemWifiManager.SemWifiApSmartCallback() { // from class: com.android.systemui.statusbar.connectivity.AccessPointControllerImpl.1
        public final void onStateChanged(int i, String str) {
            ...
            ArrayList arrayList = AccessPointControllerImpl.this.mWifiApBleCallbacks;
            int size = arrayList.size();
            int i2 = 0;
            while (i2 < size) {
                Object obj = arrayList.get(i2);
                i2++;
                WifiDetailAdapter wifiDetailAdapter = (WifiDetailAdapter) ((AccessPointController.WifiApBleStateChangeCallback) obj);
    ...
    public final AnonymousClass2 mConnectCallback = new WifiEntry.ConnectCallback(this) { // from class: com.android.systemui.statusbar.connectivity.AccessPointControllerImpl.2
    ...
    public AccessPointControllerImpl(Context context, UserManager userManager, UserTracker userTracker, Executor executor, WifiPickerTrackerFactory wifiPickerTrackerFactory) {
        ...
        executor.execute(new AccessPointControllerImpl$$ExternalSyntheticLambda0(this, 0));
    ...
    public final boolean canConfigWifi() {
        if (this.mWifiPickerTrackerFactory.wifiManager != null) {
            return !this.mUserManager.hasUserRestriction("no_config_wifi", UserHandle.of(this.mCurrentUser));
        }
        return false;
    }
    ...
    public final void fireAccessPointsCallback(List list) {
        ...
        while (i < size) {
            ...
            i++;
            ((AccessPointController.AccessPointCallback) obj).onAccessPointsChanged(list);
        }
    }
    ...
    public final MergedCarrierEntry getMergedCarrierEntry() {
        ...
        fireAccessPointsCallback(Collections.EMPTY_LIST);
        return null;
    }
    ...
    public final void onScanRequested() {
        ...
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            ((AccessPointController.AccessPointCallback) obj).onWifiScan(true);
        }
    }
    ...
    public final void scanForAccessPoints() {
        ...
        List list = (List) new ArrayList(wifiPickerTracker.mWifiEntries).stream().filter(new WifiPickerTracker$$ExternalSyntheticLambda11(wifiPickerTracker, 2)).collect(Collectors.toList());
    ...
    public final void startSettings(WifiEntry wifiEntry) {
        ...
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            ((AccessPointController.AccessPointCallback) obj).onSettingsActivityTriggered(intent);
        }
    }
    ...
    public final void onWifiEntriesChanged(int i) {
        ...
        if (i == 1) {
            ...
            while (i2 < size) {
                Object obj = arrayList.get(i2);
                i2++;
                ((AccessPointController.AccessPointCallback) obj).onWifiScan(false);
            }
        }
    }
}
