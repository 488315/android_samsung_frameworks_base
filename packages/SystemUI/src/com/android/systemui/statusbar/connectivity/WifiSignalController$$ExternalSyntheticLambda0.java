...
public final /* synthetic */ class WifiSignalController$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i2) {
            case 0:
                int i3 = WifiSignalController.$r8$clinit;
                wifiSignalController.doInBackground(new WifiSignalController$$ExternalSyntheticLambda0(wifiSignalController, i));
                break;
            case 1:
                int i4 = WifiSignalController.$r8$clinit;
