...
public final class WifiState extends ConnectivityState {
    ...
    public final List tableColumns() {
        return CollectionsKt___CollectionsKt.plus((Iterable) Arrays.asList("ssid", "isTransient", Account.IS_DEFAULT, "statusLabel", "isCarrierMerged", "isDefaultConnectionValidated", "subId"), (Collection) super.tableColumns());
    }
