...
public interface BatteryGlyph {
    ...
    public final class Bolt implements BatteryGlyph {
        ...
        static {
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M2.766,4.23L1.588,6.545C1.448,6.869 1.808,7.171 2.046,6.931L5.913,3.12C6.106,2.958 6.004,2.657 5.815,2.679L3.08,2.679L4.46,0.489C4.468,0.477 4.474,0.464 4.479,0.451C4.594,0.132 4.236,-0.149 4.006,0.094L0.1,3.783C-0.068,3.921 -0.005,4.238 0.2,4.23L2.766,4.23Z");
        }
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Bolt);
        }
    ...
    public final class BoltLarge implements BatteryGlyph {
        ...
        static {
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M7.191,3L4.031,3L4.721,0.5C4.791,0.25 4.601,0 4.341,0C4.231,0 4.121,0.05 4.051,0.13L0.081,4.49C-0.099,4.69 0.041,5 0.311,5L3.471,5L2.781,7.5C2.711,7.75 2.901,8 3.161,8C3.271,8 3.381,7.95 3.451,7.87L7.421,3.51C7.601,3.31 7.461,3 7.191,3Z");
        }
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof BoltLarge);
        }
    ...
    public final class Defend implements BatteryGlyph {
        ...
        public static final AndroidPath fgPath = null;

        static {
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M4.915,1.774C5.027,1.811 5.129,1.84 5.214,1.861C5.332,1.889 5.431,1.99 5.427,2.111C5.38,3.714 4.811,5.322 3.203,5.964L3.203,1.036C3.319,1.034 3.418,1.061 3.502,1.119C3.679,1.24 3.92,1.367 4.173,1.482C4.426,1.597 4.691,1.7 4.915,1.774Z");
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M3.602,0.118C3.373,-0.039 2.967,-0.039 2.738,0.118C2.486,0.29 2.144,0.47 1.784,0.633C1.425,0.797 1.049,0.943 0.73,1.048C0.571,1.1 0.426,1.143 0.305,1.172C0.138,1.212 -0.002,1.356 0.003,1.527C0.07,3.804 0.886,6.088 3.17,7C5.454,6.088 6.27,3.804 6.337,1.527C6.342,1.356 6.202,1.212 6.035,1.172C5.914,1.143 5.769,1.1 5.61,1.048C5.291,0.943 4.915,0.797 4.556,0.633C4.196,0.47 3.854,0.29 3.602,0.118Z");
        }
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Defend);
        }
    ...
    public final class DefendLarge implements BatteryGlyph {
        ...
        static {
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M3.5,6.919C4.12,6.559 5.75,5.349 5.98,2.409C5.32,2.159 4.37,1.729 3.5,1.129L3.5,6.919Z");
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M3.5,8.009C3.29,8.009 0.17,6.639 0,2.079C0,1.859 0.13,1.659 0.33,1.589C0.92,1.379 2.18,0.879 3.19,0.109C3.28,0.039 3.39,-0.001 3.5,-0.001C3.61,-0.001 3.72,0.039 3.81,0.109C4.82,0.879 6.08,1.379 6.67,1.589C6.88,1.659 7.01,1.859 7,2.079C6.83,6.639 3.71,8.009 3.5,8.009Z");
        }
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof DefendLarge);
        }
    ...
    public final class Eight implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Eight);
        }
    ...
    public final class Five implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Five);
        }
    ...
    public final class Four implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Four);
        }
    ...
    public final class Nine implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Nine);
        }
    ...
    public final class PlusLarge implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof PlusLarge);
        }
    ...
    public final class Seven implements BatteryGlyph {
        ...
        static {
            PathSvgKt.addSvg(AndroidPath_androidKt.Path(), "M1.481,9.278C1.234,9.187 1.056,9.02 0.948,8.777C0.839,8.53 0.835,8.283 0.935,8.036L3.112,1.77L3.093,1.724L0.87,1.724C0.632,1.724 0.426,1.64 0.252,1.471C0.083,1.298 -0.001,1.094 -0.001,0.86C-0.001,0.626 0.083,0.425 0.252,0.256C0.426,0.087 0.632,0.002 0.87,0.002L4.191,0.002C4.503,0.002 4.763,0.104 4.971,0.308C5.184,0.511 5.29,0.763 5.29,1.062C5.29,1.205 5.277,1.315 5.251,1.393C5.225,1.467 5.19,1.582 5.147,1.737L2.709,8.712C2.618,8.963 2.452,9.145 2.209,9.258C1.971,9.366 1.728,9.373 1.481,9.278Z");
        }
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Seven);
        }
    ...
    public final class Six implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Six);
        }
    ...
    public final class Three implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Three);
        }
    ...
    public final class Zero implements BatteryGlyph {
        ...
        public final boolean equals(Object obj) {
            return this == obj || (obj instanceof Zero);
        }
