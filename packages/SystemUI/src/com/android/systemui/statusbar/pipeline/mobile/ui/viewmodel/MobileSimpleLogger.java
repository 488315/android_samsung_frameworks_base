...
public final class MobileSimpleLogger {
    ...
    public final int hashCode() {
        return this.simCard.hashCode() + TransitionData$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.overrideNetworkType, ReorderTile$$ExternalSyntheticOutline0.m(this.networkType, (this.dataType.hashCode() + TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(PropertyValuesHolder2D$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.subId, Integer.hashCode(this.slotId) * 31, 31), 31, this.slotName), 31, this.connected), 31, this.dataConnected)) * 31, 31), 31), 31, this.fivegavailable);
    }
