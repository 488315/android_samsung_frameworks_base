...
final class MobileConnectionRepositoryImpl$callbackEvents$1$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            MobileConnectionRepositoryImpl$callbackEvents$1$1$callback$1 mobileConnectionRepositoryImpl$callbackEvents$1$1$callback$1 = new MobileConnectionRepositoryImpl$callbackEvents$1$1$callback$1(this.$logger, this.$this_run, producerScope);
            ...
            MobileConnectionRepositoryImpl$imsRegState$1$$ExternalSyntheticLambda0 mobileConnectionRepositoryImpl$imsRegState$1$$ExternalSyntheticLambda0 = new MobileConnectionRepositoryImpl$imsRegState$1$$ExternalSyntheticLambda0(1, this.$this_run, mobileConnectionRepositoryImpl$callbackEvents$1$1$callback$1);
            this.label = 1;
