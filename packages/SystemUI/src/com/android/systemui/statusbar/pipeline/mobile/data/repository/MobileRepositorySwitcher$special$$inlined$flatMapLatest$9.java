...
public final class MobileRepositorySwitcher$special$$inlined$flatMapLatest$9 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlow stateFlowIsDeviceEmergencyCallCapable = ((MobileConnectionsRepository) this.L$1).isDeviceEmergencyCallCapable();
            this.label = 1;
            if (FlowKt.emitAll(flowCollector, stateFlowIsDeviceEmergencyCallCapable, this) == coroutineSingletons) {
