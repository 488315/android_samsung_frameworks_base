...
public interface CallbackEvent {
    ...
    public final class OnCallBackModeStopped implements CallbackEvent {
        ...
        public OnCallBackModeStopped(int i) {
            this.type = i;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof OnCallBackModeStopped) && this.type == ((OnCallBackModeStopped) obj).type;
        }
        ...
        public final String toString() {
            return ReorderTile$$ExternalSyntheticOutline0.m(this.type, ")", new StringBuilder("OnCallBackModeStopped(type="));
        }
    }
    ...
    public final class OnCallStateChanged implements CallbackEvent {
        ...
        public final String toString() {
            return ReorderTile$$ExternalSyntheticOutline0.m(this.callState, ")", new StringBuilder("OnCallStateChanged(callState="));
        }
    }
    ...
    public final class OnCarrierNetworkChange implements CallbackEvent {
        ...
        public final String toString() {
            return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("OnCarrierNetworkChange(active="), this.active, ")");
        }
    }
    ...
    public final class OnCarrierRoamingNtnModeChanged implements CallbackEvent {
        ...
        public final String toString() {
            return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("OnCarrierRoamingNtnModeChanged(active="), this.active, ")");
        }
    }
    ...
    public final class OnDataActivity implements CallbackEvent {
        ...
        public final String toString() {
            return ReorderTile$$ExternalSyntheticOutline0.m(this.direction, ")", new StringBuilder("OnDataActivity(direction="));
        }
    }
    ...
    public final class OnDataConnectionStateChanged implements CallbackEvent {
        ...
        public final String toString() {
            return ReorderTile$$ExternalSyntheticOutline0.m(this.dataState, ")", new StringBuilder("OnDataConnectionStateChanged(dataState="));
        }
    }
    ...
    public final class OnDataEnabledChanged implements CallbackEvent {
        ...
        public final String toString() {
            return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("OnDataEnabledChanged(enabled="), this.enabled, ")");
        }
    }
