...
final class WifiInteractorImpl$wifiIconGroup$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        wifiInteractorImpl$wifiIconGroup$1.Z$0 = zBooleanValue;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        EmergencyButtonController$$ExternalSyntheticOutline0.m("get wifiIconGroup ePDGConnected : ", "WifiInteractor", z);
        WifiSignalIconResource wifiSignalIconResource = this.$wifiSignalIconResource;
        wifiSignalIconResource.getClass();
        WifiNetworkModel.WifiNetworkType wifiNetworkType = ((WifiNetworkModel.Active) wifiNetworkModel).wifiNetworkType;
        WifiNetworkModel.WifiNetworkType wifiNetworkType2 = WifiNetworkModel.WifiNetworkType.FIVEG;
        ...
        } else if (wifiNetworkType == WifiNetworkModel.WifiNetworkType.SIXG) {
            SamsungWifiIcons.Companion.getClass();
            signalIcon$IconGroup = SamsungWifiIcons.WIFI_ICON_6G;
        } else if (wifiNetworkType == WifiNetworkModel.WifiNetworkType.SIXGE) {
            SamsungWifiIcons.Companion.getClass();
            signalIcon$IconGroup = SamsungWifiIcons.WIFI_ICON_6GE;
        } else if (wifiNetworkType == WifiNetworkModel.WifiNetworkType.SEVENG) {
            SamsungWifiIcons.Companion.getClass();
