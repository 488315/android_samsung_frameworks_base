...
public final class SatelliteIconModel {
    ...
    public static Icon.Resource fromConnectionState(SatelliteConnectionState satelliteConnectionState, int i) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[satelliteConnectionState.ordinal()];
        if (i2 == 1 || i2 == 2 || i2 == 3) {
    ...
    public static Icon.Resource fromSignalStrengthKDDI(int i) {
        if (i == 0) {
