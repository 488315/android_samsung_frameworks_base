    ...
    public FullMobileConnectionRepository(int i, boolean z, TableLogBuffer tableLogBuffer, final Flow flow, NetworkNameModel networkNameModel, String str, CoroutineScope coroutineScope, MobileConnectionRepositoryImpl.Factory factory, CarrierMergedConnectionRepository.Factory factory2, DummyMobileConnectionRepository.Factory factory3) {
        ...
        Lazy lazy2 = LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.statusbar.pipeline.mobile.data.repository.prod.FullMobileConnectionRepository$$ExternalSyntheticLambda1
            ...
            public final Object invoke() {
                ...
                return new CarrierMergedConnectionRepository(i2, fullMobileConnectionRepository.tableLogBuffer, createForSubscriptionId, factory4.bgContext, factory4.scope, factory4.wifiRepository);
            }
        });
        ...
        this.isUsingNonTerrestrialNetwork = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$28(null)), tableLogBuffer, "", "isUsingNonTerrestrialNetwork", ((Boolean) ((MobileConnectionRepository) stateFlow.getValue()).isUsingNonTerrestrialNetwork().getValue()).booleanValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).isUsingNonTerrestrialNetwork().getValue());
        this.mobileServiceState = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$29(null)), tableLogBuffer, "", (Diffable) ((MobileConnectionRepository) stateFlow.getValue()).getMobileServiceState().getValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).getMobileServiceState().getValue());
        this.semOMCChangedEvent = FlowKt.stateIn(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$30(null)), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), Unit.INSTANCE);
        this.imsRegState = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$31(null)), tableLogBuffer, "", (Diffable) ((MobileConnectionRepository) stateFlow.getValue()).getImsRegState().getValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).getImsRegState().getValue());
        this.mobileDataEnabledChanged = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$32(null)), tableLogBuffer, "", "", ((Boolean) ((MobileConnectionRepository) stateFlow.getValue()).getMobileDataEnabledChanged().getValue()).booleanValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).getMobileDataEnabledChanged().getValue());
        this.semSatelliteServiceState = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$33(null)), tableLogBuffer, "", "", ((Number) ((MobileConnectionRepository) stateFlow.getValue()).getSemSatelliteServiceState().getValue()).intValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).getSemSatelliteServiceState().getValue());
        this.semSatelliteSignalStrength = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$34(null)), tableLogBuffer, "", "", ((Number) ((MobileConnectionRepository) stateFlow.getValue()).getSemSatelliteSignalStrength().getValue()).intValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).getSemSatelliteSignalStrength().getValue());
        this.semSatelliteEnabled = FlowKt.stateIn(DiffableKt.logDiffsForTable(FlowKt.transformLatest(stateIn2, new FullMobileConnectionRepository$special$$inlined$flatMapLatest$35(null)), tableLogBuffer, "", "", ((Boolean) ((MobileConnectionRepository) stateFlow.getValue()).getSemSatelliteEnabled().getValue()).booleanValue()), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), ((MobileConnectionRepository) stateFlow.getValue()).getSemSatelliteEnabled().getValue());
    }
