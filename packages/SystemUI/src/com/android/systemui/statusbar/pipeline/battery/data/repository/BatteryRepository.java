...
public final class BatteryRepository {
    ...
    public BatteryRepository(Context context, CoroutineScope coroutineScope, CoroutineDispatcher coroutineDispatcher, BatteryController batteryController, SystemSettingsRepository systemSettingsRepository) throws Resources.NotFoundException {
        this.controller = batteryController;
        Flow flowFlowOn = FlowKt.flowOn(new FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1(new BatteryCallbackState(null, false, false, false, false, 31, null), FlowConflatedKt.conflatedCallbackFlow(new BatteryRepository$batteryState$1(this, null)), new BatteryRepository$batteryState$2(null)), coroutineDispatcher);
        SharingStarted.Companion.getClass();
        StartedLazily startedLazily = SharingStarted.Companion.Lazily;
        final ReadonlyStateFlow readonlyStateFlowStateIn = FlowKt.stateIn(flowFlowOn, coroutineScope, startedLazily, new BatteryCallbackState(null, false, false, false, false, 31, null));
        this.batteryState = readonlyStateFlowStateIn;
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        Boolean boolValueOf = Boolean.valueOf(((BatteryCallbackState) obj).isPluggedIn);
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Boolean boolValueOf = Boolean.valueOf(((BatteryCallbackState) obj).isPowerSaveEnabled);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(boolValueOf, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Boolean boolValueOf = Boolean.valueOf(((BatteryCallbackState) obj).isBatteryDefenderEnabled);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(boolValueOf, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Integer num = ((BatteryCallbackState) obj).level;
                        anonymousClass1.label = 1;
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Boolean boolValueOf = Boolean.valueOf(((BatteryCallbackState) obj).isStateUnknown);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(boolValueOf, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
