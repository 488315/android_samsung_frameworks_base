...
public final class DeXStatusBarIconModel {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.roamingId) + ReorderTile$$ExternalSyntheticOutline0.m(this.activityId, TransitionData$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.netwotkTypeId, ReorderTile$$ExternalSyntheticOutline0.m(this.strengthId, ReorderTile$$ExternalSyntheticOutline0.m(this.subId, ReorderTile$$ExternalSyntheticOutline0.m(this.slotId, Boolean.hashCode(this.isVisible) * 31, 31), 31), 31), 31), 31, this.showTriangle), 31);
    }
    ...
    public final String toString() {
        ...
        sb.append(", roamingId=");
        return ReorderTile$$ExternalSyntheticOutline0.m(this.roamingId, ")", sb);
    }
