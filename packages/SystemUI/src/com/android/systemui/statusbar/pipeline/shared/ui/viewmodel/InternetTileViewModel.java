...
public final class InternetTileViewModel {
    ...
    public InternetTileViewModel(AirplaneModeRepository airplaneModeRepository, ConnectivityRepository connectivityRepository, EthernetInteractor ethernetInteractor, MobileIconsInteractor mobileIconsInteractor, WifiInteractor wifiInteractor, Context context, CoroutineScope coroutineScope) {
        ...
        this.mobileDataContentName = FlowKt.transformLatest(mobileIconsInteractor.getActiveDataIconInteractor(), new InternetTileViewModel$special$$inlined$flatMapLatest$2(null, this));
        this.mobileIconFlow = FlowKt.transformLatest(mobileIconsInteractor.getActiveDataIconInteractor(), new InternetTileViewModel$special$$inlined$flatMapLatest$3(null, this));
