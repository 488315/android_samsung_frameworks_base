...
final class WifiUiAdapter$bindGroup$1 extends SuspendLambda implements Function3 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        final class C03831 extends SuspendLambda implements Function2 {
            final /* synthetic */ LocationBasedWifiViewModel $locationViewModel;
            int label;
            final /* synthetic */ WifiUiAdapter this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C03831(LocationBasedWifiViewModel locationBasedWifiViewModel, WifiUiAdapter wifiUiAdapter, Continuation continuation) {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new C03831(this.$locationViewModel, this.this$0, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return ((C03831) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.pipeline.wifi.ui.WifiUiAdapter.bindGroup.1.1.1.1
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            if (((WifiIcon) obj2) instanceof WifiIcon.Visible) {
                                ...
                                String string = statusBarIconControllerImpl.mContext.getString(17043305);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            CoroutineTracingKt.launchTraced$default((CoroutineScope) this.L$0, null, null, new C03831(this.$locationViewModel, this.this$0, null), 7);
            return Unit.INSTANCE;
        }
    }
