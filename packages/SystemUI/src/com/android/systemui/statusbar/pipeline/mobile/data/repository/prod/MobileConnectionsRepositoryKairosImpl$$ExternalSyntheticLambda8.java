    ...
    public final Object mo779invoke(Object obj) {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                Flow flowOn = FlowKt.flowOn(FlowConflatedKt.conflatedCallbackFlow(new MobileConnectionsRepositoryKairosImpl$isAnySimSecure$1$1(mobileConnectionsRepositoryKairosImpl, null)), mobileConnectionsRepositoryKairosImpl.mainDispatcher);
                Boolean bool = Boolean.FALSE;
                BuildScopeImpl buildScopeImpl = (BuildScopeImpl) buildScope;
                buildScopeImpl.getClass();
                StateInit holdState = buildScopeImpl.stateScope.holdState(BuildScope.DefaultImpls.toEvents(buildScopeImpl, flowOn), bool);
                DiffableKt.logBooleanDiffsForTable(buildScopeImpl, holdState, mobileConnectionsRepositoryKairosImpl.tableLogger, "Repo", "isAnySimSecure");
                return holdState;
            case 1:
                int i3 = MobileConnectionsRepositoryKairosImpl.$r8$clinit;
                Flow flowOn2 = FlowKt.flowOn(FlowConflatedKt.conflatedCallbackFlow(new MobileConnectionsRepositoryKairosImpl$mobileSubscriptionsChangeEvent$1$1(mobileConnectionsRepositoryKairosImpl, null)), mobileConnectionsRepositoryKairosImpl.bgDispatcher);
                BuildScopeImpl buildScopeImpl2 = (BuildScopeImpl) buildScope;
                buildScopeImpl2.getClass();
                return BuildScope.DefaultImpls.toEvents(buildScopeImpl2, flowOn2);
            case 2:
                StateInit stateInit = mobileConnectionsRepositoryKairosImpl.activeMobileDataSubscriptionId;
                EventsInit mapNotNull = EventsKt.mapNotNull(EventsKt.map(StateKt.getChanges(stateInit), new StateKt$$ExternalSyntheticLambda8(stateInit, 0)), new MobileConnectionsRepositoryKairosImpl$$ExternalSyntheticLambda10(i));
                ...
                Events events = (Events) buildScopeImpl3.applyLatestSpec(EventsKt.mapCheap(mapNotNull, new BuildScope$DefaultImpls$$ExternalSyntheticLambda7(2, new BuildScope$DefaultImpls$$ExternalSyntheticLambda7(0, mobileConnectionsRepositoryKairosImpl$activeSubChangedInGroupEvent$1$2))), new BuildScope$DefaultImpls$$ExternalSyntheticLambda10()).getFirst();
            ...
            case 3:
                ...
                Flow flowOn3 = FlowKt.flowOn(FlowKt.callbackFlow(new MobileConnectionsRepositoryKairosImpl$telephonyManagerState$1$1(mobileConnectionsRepositoryKairosImpl, null)), mobileConnectionsRepositoryKairosImpl.bgDispatcher);
                ...
                return BuildScope.DefaultImpls.scanToState(buildScopeImpl4, flowOn3, pair, new BuildScope$DefaultImpls$$ExternalSyntheticLambda0(3));
            case 4:
            ...
            case 6:
                StateInit holdState2 = ((BuildScopeImpl) buildScope).stateScope.holdState(SwitchKt.switchEvents(BuildScopeKt.rebuildOn(buildScope, mobileConnectionsRepositoryKairosImpl.serviceStateChangedEvent, new MobileConnectionsRepositoryKairosImpl$$ExternalSyntheticLambda8(mobileConnectionsRepositoryKairosImpl, 4))), Boolean.FALSE);
                DiffableKt.logBooleanDiffsForTable(buildScope, holdState2, mobileConnectionsRepositoryKairosImpl.tableLogger, "Repo", "deviceEmergencyOnly");
                return holdState2;
            case 7:
                BuildScopeImpl buildScopeImpl5 = (BuildScopeImpl) buildScope;
                StateInit holdState3 = buildScopeImpl5.stateScope.holdState(SwitchKt.switchEvents(BuildScopeKt.rebuildOn(buildScope, MergeKt.mergeLeft(mobileConnectionsRepositoryKairosImpl.mobileSubscriptionsChangeEvent, StateKt.getChanges(mobileConnectionsRepositoryKairosImpl.carrierMergedSubId)), new MobileConnectionsRepositoryKairosImpl$$ExternalSyntheticLambda8(mobileConnectionsRepositoryKairosImpl, 5))), EmptyList.INSTANCE);
                Ref$BooleanRef ref$BooleanRef = new Ref$BooleanRef();
                ref$BooleanRef.element = true;
                buildScopeImpl5.observe(holdState3, new DiffableKt$$ExternalSyntheticLambda5(mobileConnectionsRepositoryKairosImpl.tableLogger, "Repo", "subscriptions", ref$BooleanRef, 2));
                return holdState3;
            case 8:
                IncrementalInit applyLatestSpecForKey$default = BuildScope.DefaultImpls.applyLatestSpecForKey$default(buildScope, IncrementalKt.mapValues(IncrementalKt.asIncremental(mobileConnectionsRepositoryKairosImpl.subscriptionsById), new MobileConnectionsRepositoryKairosImpl$$ExternalSyntheticLambda4(mobileConnectionsRepositoryKairosImpl, 2)));
                ((BuildScopeImpl) buildScope).observe(applyLatestSpecForKey$default, new MobileConnectionsRepositoryKairosImpl$$ExternalSyntheticLambda4(mobileConnectionsRepositoryKairosImpl, 3));
                return applyLatestSpecForKey$default;
            case 9:
                MobileMappings.Config readConfig = MobileMappings.Config.readConfig(mobileConnectionsRepositoryKairosImpl.context);
                BuildScopeKt.effect$default(buildScope, new MobileConnectionsRepositoryKairosImpl$$ExternalSyntheticLambda2(mobileConnectionsRepositoryKairosImpl, readConfig));
                return readConfig;
            default:
