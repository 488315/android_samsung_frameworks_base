...
final class BTTetherUiAdapter$bindGroup$1 extends SuspendLambda implements Function3 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        final class C03681 extends SuspendLambda implements Function2 {
            int label;
            final /* synthetic */ BTTetherUiAdapter this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C03681(BTTetherUiAdapter bTTetherUiAdapter, Continuation continuation) {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new C03681(this.this$0, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return ((C03681) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
                ...
                if (i == 0) {
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.pipeline.shared.ui.BTTetherUiAdapter.bindGroup.1.1.1.1
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            ...
                            statusBarIconControllerImpl.setIconVisibility(statusBarIconControllerImpl.mContext.getString(17043262), ((DefaultConnectionModel) obj2).btTether.isDefault);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            BuildersKt.launch$default((CoroutineScope) this.L$0, null, null, new C03681(this.this$0, null), 3);
            return Unit.INSTANCE;
        }
    }
