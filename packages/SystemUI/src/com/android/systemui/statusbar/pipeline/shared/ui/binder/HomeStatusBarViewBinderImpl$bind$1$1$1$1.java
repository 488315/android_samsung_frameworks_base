...
final class HomeStatusBarViewBinderImpl$bind$1$1$1$1 extends SuspendLambda implements Function2 {
    ...
    public HomeStatusBarViewBinderImpl$bind$1$1$1$1(HomeStatusBarViewModel homeStatusBarViewModel, StatusBarVisibilityChangeListener statusBarVisibilityChangeListener, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new HomeStatusBarViewBinderImpl$bind$1$1$1$1(this.$viewModel, this.$listener, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((HomeStatusBarViewBinderImpl$bind$1$1$1$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ReadonlyStateFlow readonlyStateFlow = ((HomeStatusBarViewModelImpl) this.$viewModel).isTransitioningFromLockscreenToOccluded;
            final StatusBarVisibilityChangeListener statusBarVisibilityChangeListener = this.$listener;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.pipeline.shared.ui.binder.HomeStatusBarViewBinderImpl$bind$1$1$1$1.1
