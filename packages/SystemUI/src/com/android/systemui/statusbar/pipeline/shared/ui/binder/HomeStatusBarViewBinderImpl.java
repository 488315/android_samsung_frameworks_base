...
public final class HomeStatusBarViewBinderImpl implements HomeStatusBarViewBinder {
    ...
    /* renamed from: com.android.systemui.statusbar.pipeline.shared.ui.binder.HomeStatusBarViewBinderImpl$bind$1, reason: invalid class name */
    final class AnonymousClass1 extends SuspendLambda implements Function3 {
        ...
        /* renamed from: com.android.systemui.statusbar.pipeline.shared.ui.binder.HomeStatusBarViewBinderImpl$bind$1$1, reason: invalid class name and collision with other inner class name */
        final class C05731 extends SuspendLambda implements Function2 {
                    ...
                    if (i == 0) {
                        ...
                        FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.pipeline.shared.ui.binder.HomeStatusBarViewBinderImpl.bind.1.1.3.1
                            ...
                            public final Object emit(Object obj2, Continuation continuation) {
                                ...
                                homeStatusBarViewBinderImpl.getClass();
                                view2.animate().cancel();
                                final float f = zBooleanValue ? 1.0f : 0.0f;
                                long j = zBooleanValue ? 750L : 250L;
                                final int i2 = zBooleanValue ? 0 : 8;
                                if (zBooleanValue) {
                                    view2.setAlpha(0.0f);
            ...
            final class AnonymousClass4 extends SuspendLambda implements Function2 {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        C05751 c05751 = new FlowCollector() { // from class: com.android.systemui.statusbar.pipeline.shared.ui.binder.HomeStatusBarViewBinderImpl.bind.1.1.4.1
                            @Override // kotlinx.coroutines.flow.FlowCollector
                            public final Object emit(Object obj2, Continuation continuation) {
                                ...
                                if (mediaProjectionStopDialogModel instanceof MediaProjectionStopDialogModel.Shown) {
                                    ...
                                    SystemUIDialog systemUIDialogCreateDialog = shown.dialogDelegate.createDialog();
                                    systemUIDialogCreateDialog.setCanceledOnTouchOutside(false);
                                    systemUIDialogCreateDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.android.systemui.statusbar.chips.mediaprojection.domain.model.MediaProjectionStopDialogModel$Shown$createAndShowDialog$1
                                        @Override // android.content.DialogInterface.OnCancelListener
                                        public final void onCancel(DialogInterface dialogInterface) {
                                            shown.onDismissAction.invoke();
                                        }
                                    });
                                    systemUIDialogCreateDialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.android.systemui.statusbar.chips.mediaprojection.domain.model.MediaProjectionStopDialogModel$Shown$createAndShowDialog$2
                        ...
                        this.label = 1;
                        if (readonlyStateFlow.$$delegate_0.collect(c05751, this) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i != 1) {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C05731(HomeStatusBarViewBinderImpl homeStatusBarViewBinderImpl, int i, StatusBarVisibilityChangeListener statusBarVisibilityChangeListener, View view, View view2, HomeStatusBarViewModel homeStatusBarViewModel, LifecycleOwner lifecycleOwner, View view3, View view4, View view5, Function1 function1, Function1 function12, Continuation continuation) {
                super(2, continuation);
                this.this$0 = homeStatusBarViewBinderImpl;
                this.$displayId = i;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                C05731 c05731 = new C05731(this.this$0, this.$displayId, this.$listener, this.$view, this.$primaryChipView, this.$viewModel, this.$$this$repeatWhenAttached, this.$clockView, this.$notificationIconsArea, this.$systemInfoView, this.$systemEventChipAnimateIn, this.$systemEventChipAnimateOut, continuation);
                c05731.L$0 = obj;
                return c05731;
            }
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return ((C05731) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(int i, StatusBarVisibilityChangeListener statusBarVisibilityChangeListener, View view, View view2, HomeStatusBarViewModel homeStatusBarViewModel, View view3, View view4, View view5, Function1 function1, Function1 function12, Continuation continuation) {
        ...
        public final Object invoke(Object obj, Object obj2, Object obj3) {
            AnonymousClass1 anonymousClass1 = HomeStatusBarViewBinderImpl.this.new AnonymousClass1(this.$displayId, this.$listener, this.$view, this.$primaryChipView, this.$viewModel, this.$clockView, this.$notificationIconsArea, this.$systemInfoView, this.$systemEventChipAnimateIn, this.$systemEventChipAnimateOut, (Continuation) obj3);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C05731 c05731 = new C05731(HomeStatusBarViewBinderImpl.this, this.$displayId, this.$listener, this.$view, this.$primaryChipView, this.$viewModel, lifecycleOwner, this.$clockView, this.$notificationIconsArea, this.$systemInfoView, this.$systemEventChipAnimateIn, this.$systemEventChipAnimateOut, null);
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(lifecycleOwner, state, c05731, this) == coroutineSingletons) {
                    return coroutineSingletons;
                }
            } else {
                if (i != 1) {
    ...
    public final void bind(int i, View view, HomeStatusBarViewModel homeStatusBarViewModel, Function1 function1, Function1 function12, CollapsedStatusBarFragment.AnonymousClass5 anonymousClass5) {
        RepeatWhenAttachedKt.repeatWhenAttached(view, EmptyCoroutineContext.INSTANCE, new AnonymousClass1(i, anonymousClass5, view, view.requireViewById(R.id.ongoing_activity_chip_primary), homeStatusBarViewModel, view.requireViewById(R.id.clock), view.requireViewById(R.id.notificationIcons), view.requireViewById(R.id.status_bar_end_side_content), function1, function12, null));
    }
}
