...
public final class MobileServiceState implements Diffable {
    ...
    public final int hashCode() {
        return this.simCardInfo.hashCode() + ((this.telephonyDisplayInfo.hashCode() + ReorderTile$$ExternalSyntheticOutline0.m(this.mSimSubmode, ReorderTile$$ExternalSyntheticOutline0.m(this.voiceNetworkType, ReorderTile$$ExternalSyntheticOutline0.m(this.dataRoamingType, ReorderTile$$ExternalSyntheticOutline0.m(this.dataRegState, TransitionData$$ExternalSyntheticOutline0.m(Integer.hashCode(this.optionalRadioTech) * 31, 31, this.vioceCallAvailable), 31), 31), 31), 31)) * 31);
    }
