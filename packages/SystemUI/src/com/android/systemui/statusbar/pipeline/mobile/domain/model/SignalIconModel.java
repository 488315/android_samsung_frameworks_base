...
public interface SignalIconModel extends Diffable {
    ...
    public final class Cellular implements SignalIconModel {
        ...
        public final int hashCode() {
            return Integer.hashCode(this.iconId) + TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.numberOfLevels, Integer.hashCode(this.level) * 31, 31), 31, this.showExclamationMark), 31, this.carrierNetworkChange);
        }
        ...
        public final String toString() {
            ...
            sb.append(", iconId=");
            return ReorderTile$$ExternalSyntheticOutline0.m(this.iconId, ")", sb);
        }
