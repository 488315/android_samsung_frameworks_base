...
public interface WifiIcon extends Diffable {
    ...
    public final class Companion {
        ...
        public static WifiIcon fromModel(WifiNetworkModel wifiNetworkModel, Context context, boolean z, SignalIcon$IconGroup signalIcon$IconGroup) {
            ...
            int i2 = NO_INTERNET;
            if (z2) {
                return new Visible(android.R.drawable.list_selector_background_disabled, new ContentDescription.Loaded(AbstractResolvableFuture$$ExternalSyntheticOutline0.m(context.getString(R.string.accessibility_no_wifi), ",", context.getString(i2))));
            }
            ...
            if (!z || (hotspotDeviceType = active.hotspotDeviceType) == WifiNetworkModel.HotspotDeviceType.NONE) {
                if (signalIcon$IconGroup == null) {
                    String string = context.getString(AccessibilityContentDescriptions.WIFI_CONNECTION_STRENGTH[active.level]);
                    boolean z3 = active.isValidated;
                    int i3 = active.level;
