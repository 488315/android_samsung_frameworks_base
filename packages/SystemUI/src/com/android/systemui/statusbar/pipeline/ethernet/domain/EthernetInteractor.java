                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        if (defaultConnectionModel.ethernet.isDefault) {
                            int[] iArr = AccessibilityContentDescriptions.ETHERNET_CONNECTION_VALUES;
                            resource = defaultConnectionModel.isValidated ? new Icon.Resource(R.drawable.stat_sys_ethernet_fully, new ContentDescription.Resource(iArr[1])) : new Icon.Resource(R.drawable.stat_sys_ethernet, new ContentDescription.Resource(iArr[0]));
                        } else {
                            resource = null;
                        }
