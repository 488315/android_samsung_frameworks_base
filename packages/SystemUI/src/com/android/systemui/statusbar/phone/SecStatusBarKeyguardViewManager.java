...
public class SecStatusBarKeyguardViewManager extends StatusBarKeyguardViewManager {
    ...
    public SecStatusBarKeyguardViewManager(KeyguardViewMediatorHelper keyguardViewMediatorHelper, KeyguardFastBioUnlockController keyguardFastBioUnlockController, Lazy lazy, SettingsHelper settingsHelper, Context context, ViewMediatorCallback viewMediatorCallback, LockPatternUtils lockPatternUtils, SysuiStatusBarStateController sysuiStatusBarStateController, ConfigurationController configurationController, KeyguardUpdateMonitor keyguardUpdateMonitor, DreamOverlayStateController dreamOverlayStateController, NavigationModeController navigationModeController, DockManager dockManager, NotificationShadeWindowController notificationShadeWindowController, KeyguardStateController keyguardStateController, Optional<SysUIUnfoldComponent> optional, Lazy lazy2, LatencyTracker latencyTracker, KeyguardSecurityModel keyguardSecurityModel, PrimaryBouncerCallbackInteractor primaryBouncerCallbackInteractor, PrimaryBouncerInteractor primaryBouncerInteractor, BouncerView bouncerView, AlternateBouncerInteractor alternateBouncerInteractor, ActivityStarter activityStarter, KeyguardTransitionInteractor keyguardTransitionInteractor, KeyguardDismissTransitionInteractor keyguardDismissTransitionInteractor, CoroutineDispatcher coroutineDispatcher, Lazy lazy3, SelectedUserInteractor selectedUserInteractor, JavaAdapter javaAdapter, Lazy lazy4, StatusBarKeyguardViewManagerInteractor statusBarKeyguardViewManagerInteractor, DelayableExecutor delayableExecutor, Lazy lazy5, DismissCallbackRegistry dismissCallbackRegistry, Lazy lazy6, CommunalSceneInteractor communalSceneInteractor) {
            ...
            public final void onOrientationChanged(int i) {
                ...
                if (secStatusBarKeyguardViewManager.mCurrentOrientation != i) {
                    ...
                    if (keyguardBiometricToastView != null) {
                        keyguardBiometricToastView.setViewAttribution(biometricUnlockController.mUpdateMonitor.getUserHasTrust(((SelectedUserInteractor) biometricUnlockController.mSelectedUserInteractor.get()).getSelectedUserId()));
                    }
                }
            }
        };
        this.mUpdateMonitorCallback = new KeyguardUpdateMonitorCallback() { // from class: com.android.systemui.statusbar.phone.SecStatusBarKeyguardViewManager.2
            ...
            public final void onEmergencyCallAction() {
                ...
                if (((KeyguardStateControllerImpl) secStatusBarKeyguardViewManager.mKeyguardStateController).mOccluded) {
                    secStatusBarKeyguardViewManager.reset(true, false);
                }
            }
        ...
        this.mSystemUIWidgetCallback = new SystemUIWidgetCallback() { // from class: com.android.systemui.statusbar.phone.SecStatusBarKeyguardViewManager.3
            ...
            public final void updateStyle(long j, SemWallpaperColors semWallpaperColors) {
                if ((j & 512) != 0) {
                    SecStatusBarKeyguardViewManager.this.updateBouncerNavigationBar(WallpaperUtils.isWhiteKeyguardWallpaper(BriefViewController.SUGGESTION_BACKGROUND_KEY));
                }
            }
        };
        ...
        if (keyguardStateControllerImpl.mShowing) {
            ...
            if (z) {
                if (z2) {
                    ...
                    primaryBouncerInteractor.show("SecStatusBarKeyguardViewManager#dismissWithAction afterKeyguardGone&&isInstantDismiss", true);
                } else {
                    this.mAfterKeyguardGoneAction = onDismissAction;
                }
            } else if (z2) {
    ...
    public final Bundle getIncorrectBouncerMessage() {
        ...
        String string = keyguardPluginControllerImpl.mContext.getResources().getString(i2 != 1 ? i2 != 2 ? i2 != 3 ? 0 : R.string.kg_incorrect_password : R.string.kg_incorrect_pattern : R.string.kg_incorrect_pin);
        if (remainingAttempt > 0) {
            string = TransitionKt$$ExternalSyntheticOutline0.m(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(string, " ("), keyguardPluginControllerImpl.mContext.getResources().getQuantityString(R.plurals.kg_attempt_left, remainingAttempt, Integer.valueOf(remainingAttempt)), ")");
        }
    ...
    public final void hide(long j, long j2) {
        ...
        if (keyguardStateControllerImpl.mShowing && !keyguardStateControllerImpl.mOccluded) {
            if (((StatusBarStateControllerImpl) this.mStatusBarStateController).mLeaveOpenOnKeyguardHide) {
                com.android.systemui.keyguard.Log.d("SecStatusBarKeyguardViewManager", "leaveOpenOnKeyguardHide true");
            } else {
    ...
    public final void hideBouncer(boolean z) {
        ...
        if (z2 && ((KeyguardFoldControllerImpl) ((KeyguardFoldController) Dependency.sDependency.getDependencyInner(KeyguardFoldController.class))).isUnlockOnFoldOpened() && LsRune.SECURITY_SWIPE_BOUNCER && !primaryBouncerInteractor.isSwipeBouncer()) {
            Log.d("SecStatusBarKeyguardViewManager", "do not hideBouncer when folder is opening");
            return;
        }
        ...
        if (primaryBouncerInteractor.isFullyShowing()) {
            ...
            if (!isScrimmed || needsFullscreenBouncer()) {
                ...
                if (LsRune.SECURITY_SWIPE_BOUNCER && this.mPrimaryBouncerInteractor.isSwipeBouncer()) {
                    showBouncerOrKeyguard("onBackPressed", z, false);
                } else {
                    hideBouncer(false);
                }
    ...
    public final void onKeyguardFadedAway() {
        if (LsRune.SECURITY_BOUNCER_WINDOW) {
            Log.d("SecStatusBarKeyguardViewManager", "onKeyguardFadedAway");
            final int i = 0;
            this.mCentralSurfaces.getNotificationShadeWindowViewController().mView.post(new Runnable(this) { // from class: com.android.systemui.statusbar.phone.SecStatusBarKeyguardViewManager$$ExternalSyntheticLambda0
    ...
    public final void onStartedGoingToSleep() {
        ...
        if (keyguardVisibilityMonitor.cancelExecToken != null) {
            com.android.systemui.keyguard.Log.d("KeyguardVisible", "cancelAll");
    ...
    public final void postSetOccluded(boolean z) {
        ...
        if (this.mKeyguardUpdateManager.isEarlyWakeUp() && z) {
            ...
            if (LsRune.KEYGUARD_SUB_DISPLAY_LOCK && this.mDozing) {
                com.android.systemui.keyguard.Log.d("SecStatusBarKeyguardViewManager", "hideBounce even though fold opened");
            }
            reset(z, false);
        }
    ...
    public final void registerCentralSurfaces(CentralSurfacesImpl centralSurfacesImpl, ShadeLockscreenInteractor shadeLockscreenInteractor, ShadeExpansionStateManager shadeExpansionStateManager, BiometricUnlockController biometricUnlockController, View view) {
        ...
        super.registerCentralSurfaces(centralSurfacesImpl, shadeLockscreenInteractor, shadeExpansionStateManager, biometricUnlockController, view);
        ...
        this.mStatusBarStateController.addCallback(new StatusBarStateController.StateListener() { // from class: com.android.systemui.statusbar.phone.SecStatusBarKeyguardViewManager.5
            ...
            public final void onStatePreChange(int i, int i2) {
                if (i == 1 && i2 == 0) {
                    SecStatusBarKeyguardViewManager secStatusBarKeyguardViewManager = SecStatusBarKeyguardViewManager.this;
                    if (((KeyguardStateControllerImpl) secStatusBarKeyguardViewManager.mKeyguardStateController).mShowing || !secStatusBarKeyguardViewManager.mCentralSurfaces.mBouncerShowing) {
                        return;
                    }
                    secStatusBarKeyguardViewManager.updateStates();
                }
    ...
    public final void requestUnlock(String str) {
        ...
        if (delegate != null) {
            ...
            boolean z = selectedUserInteractor.getSelectedUserId() == selectedUserId2;
    ...
    public final void resetKeyguardDismissAction() {
        ...
        if (keyguardUpdateMonitor.isActiveDismissAction()) {
            ...
            if (needsFullscreenBouncer()) {
                primaryBouncerInteractor.show("SecStatusBarKeyguardViewManager#resetKeyguardDismissAction", true);
    ...
    public final void setShowSwipeBouncer(boolean z) {
        ...
        Log.d("PrimaryBouncerInteractor", "setShowSwipeBouncer " + z);
        KeyguardBouncerViewBinder$bind$delegate$1 delegate = ((BouncerViewImpl) primaryBouncerInteractor.primaryBouncerView).getDelegate();
        if (delegate != null) {
    ...
    @Override // com.android.systemui.statusbar.phone.StatusBarKeyguardViewManager
    public final void showBouncerOrKeyguard(String str, boolean z, boolean z2) {
        boolean z3 = this.mDozing;
        PrimaryBouncerInteractor primaryBouncerInteractor = this.mPrimaryBouncerInteractor;
        if (z3 || !needsFullscreenBouncer()) {
            ...
            if (z4 == this.mDozing) {
                primaryBouncerInteractor.show(str, true);
            } else {
                Log.d("SecStatusBarKeyguardViewManager", "showBouncerOrKeyguard dozing is changed");
                showBouncerOrKeyguard("dozing is changed ", z, z2);
            }
        }
        updateStates();
    }
    ...
    public final void updateBouncerNavigationBar(boolean z) {
        FrameLayout frameLayout = this.mCentralSurfaces.mBouncerContainer;
    ...
    public final void updateLockContainerMargin() {
        if (this.mKeyguardUpdateManager.isSecure()) {
            DeviceState.getRotation(((DisplayLifecycle) Dependency.sDependency.getDependencyInner(DisplayLifecycle.class)).getDisplay(0).getRotation());
            ViewGroup viewGroup = this.mLockIconContainer;
            if (viewGroup == null) {
                return;
            }
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) viewGroup.getLayoutParams();
            layoutParams.topMargin = SecurityUtils.getLockIconTopMargin(this.mContext);
    ...
    public final void reset(boolean z, boolean z2) {
        ...
        if (keyguardStateControllerImpl.mShowing) {
            ...
            KeyguardUpdateMonitor keyguardUpdateMonitor = this.mKeyguardUpdateManager;
            if (!z3 || (this.mDozing && !keyguardUpdateMonitor.isEarlyWakeUp())) {
