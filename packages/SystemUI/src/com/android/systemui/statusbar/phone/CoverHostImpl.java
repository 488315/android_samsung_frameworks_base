...
public class CoverHostImpl implements CoverHost {
        ...
        if (!coverState.getAttachState()) {
            ...
            if (DeviceState.isCoverUIType(i)) {
                if (DeviceState.isCoverUIType(this.mCoverState.type)) {
                    if (this.mKeyguardDisplayManager.isDesktopMode()) {
            ...
            if (!this.mIsCoverClosed) {
                ...
                if (this.mSysuiStatusBarStateController.getState() == 0) {
