...
final class KnoxStatusBarControlBinder$bind$1 extends SuspendLambda implements Function3 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        final class C03341 extends SuspendLambda implements Function2 {
            ...
            public C03341(KnoxStatusBarControlViewModel knoxStatusBarControlViewModel, KnoxStatusBarViewControl knoxStatusBarViewControl, Continuation continuation) {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new C03341(this.$viewModel, this.$knoxStatusBarViewControl, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return ((C03341) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
                ...
                if (i == 0) {
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.phone.knox.ui.binder.KnoxStatusBarControlBinder.bind.1.1.1.1
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            ...
                            Log.d("KnoxStatusBarControlViewModel", "updateHiddenState(hidden:" + booleanValue);
                            ...
                            if (keyguardStatusBarViewController$$ExternalSyntheticLambda12 != null) {
                                keyguardStatusBarViewController$$ExternalSyntheticLambda12.mo779invoke(bool);
                            } else {
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            ...
                            if (knoxStatusBarTextView != null) {
                                ...
                                if (str == null || str.length() == 0) {
                                    ...
                                    StringBuilder m888m = ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m888m(i3, "setKnoxText(", str, ") size:", ", textWidth:");
                                    ViewPager$$ExternalSyntheticOutline0.m(m888m, i4, ", scrollWidth:", i5, ", visibility:");
                                    m888m.append(visibility);
                                    Log.d("KnoxStatusBarTextView", m888m.toString());
                ...
                if (i == 0) {
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.phone.knox.ui.binder.KnoxStatusBarControlBinder.bind.1.1.3.1
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            ...
                            Log.d("KnoxStatusBarControlViewModel", "updateSystemIconEnabledState(enabled:" + booleanValue);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            BuildersKt.launch$default(coroutineScope, null, null, new C03341(this.$viewModel, this.$knoxStatusBarViewControl, null), 3);
