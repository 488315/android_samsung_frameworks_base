...
public class DemoStatusIcons extends StatusIconContainer implements DemoMode, DarkIconDispatcher.DarkReceiver {
    ...
    public DemoStatusIcons(LinearLayout linearLayout, MobileIconsViewModel mobileIconsViewModel, StatusBarLocation statusBarLocation, int i, Lazy lazy, KairosNetwork kairosNetwork, CoroutineScope coroutineScope) {
    ...
    public final void onDarkChangedWithContrast(ArrayList arrayList, int i, int i2) {
        ...
        ArrayList arrayList2 = this.mModernMobileViews;
        int size = arrayList2.size();
        int i3 = 0;
        while (i3 < size) {
            Object obj = arrayList2.get(i3);
            i3++;
            ((ModernStatusBarMobileView) obj).onDarkChangedWithContrast(arrayList, i, i2);
        }
    }
