...
public final /* synthetic */ class CentralSurfacesImpl$$ExternalSyntheticLambda12 implements Runnable {
    ...
    public /* synthetic */ CentralSurfacesImpl$$ExternalSyntheticLambda12(CentralSurfacesImpl centralSurfacesImpl, ExpandableNotificationRow expandableNotificationRow, String str, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                centralSurfacesImpl.mMainHandler.postDelayed(new CentralSurfacesImpl$$ExternalSyntheticLambda12(centralSurfacesImpl, expandableNotificationRow, str, i), 500L);
                break;
            default:
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    Object tag = childAt.getTag(R.id.stateVisible);
