...
public final class CutoutType {
    ...
    public static final CutoutType SIDELING_CENTER_CUTOUT;
    ...
    static {
        ...
        CutoutType cutoutType5 = new CutoutType("SIDELING_CENTER_CUTOUT", 4);
        SIDELING_CENTER_CUTOUT = cutoutType5;
        CutoutType cutoutType6 = new CutoutType("UDC", 5);
        UDC = cutoutType6;
        CutoutType[] cutoutTypeArr = {cutoutType, cutoutType2, cutoutType3, cutoutType4, cutoutType5, cutoutType6};
