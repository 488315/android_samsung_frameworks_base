    ...
    public final void onFinishInflate() {
        ...
        if (BasicRune.STATUS_REAL_TIME_NETWORK_SPEED) {
            ...
            if (netspeedView != null) {
                netspeedView.onDarkChanged(arrayListOf, 0.0f, color);
            }
        }
        ...
        ArrayList arrayListOf2 = CollectionsKt__CollectionsKt.arrayListOf(new Rect(0, 0, 0, 0));
        ...
        if (batteryMeterView != null) {
            batteryMeterView.onDarkChanged(arrayListOf2, 0.0f, color2);
        }
    }
}
