...
public final class StatusBarModel {
    ...
    public final int hashCode() {
        return Boolean.hashCode(this.isWhiteKeyguardStatusBar) + ReorderTile$$ExternalSyntheticOutline0.m(this.barState, PropertyValuesHolder2D$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.statusBarMode, (this.lightBarBounds.hashCode() + ReorderTile$$ExternalSyntheticOutline0.m(this.numStacks, this.logText.hashCode() * 31, 31)) * 31, 31), 31, this.packageName), 31);
    }
