...
public final class KnoxStatusBarControlModel {
    ...
    public int customTextStyle;
    public int customTextWidth;
    public String knoxStatusBarCustomText;
    ...
    public final String toString() {
        String str = this.knoxStatusBarCustomText;
        int i = this.customTextStyle;
        int i2 = this.customTextSize;
        int i3 = this.customTextWidth;
        ...
        ViewPager$$ExternalSyntheticOutline0.m(sb, i, ", customTextSize=", i2, ", customTextWidth=");
