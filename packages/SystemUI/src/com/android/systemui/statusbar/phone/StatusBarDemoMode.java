...
public class StatusBarDemoMode extends ViewController implements DemoMode {
    ...
    public final void dispatchDemoCommand(Bundle bundle, String str) {
        ...
        if (str.equals("bars")) {
            ...
            if (i != -1) {
                ...
                ((NavigationBarControllerImpl) this.mNavigationBarController).transitionTo(this.mDisplayId, i);
            }
        }
    }
