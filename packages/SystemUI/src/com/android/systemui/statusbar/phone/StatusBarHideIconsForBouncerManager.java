...
public final class StatusBarHideIconsForBouncerManager implements Dumpable {
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "isShadeOrQsExpanded=", ((Boolean) ((ShadeInteractorImpl) this.shadeInteractor).baseShadeInteractor.isAnyExpanded().getValue()).booleanValue());
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "isOccluded=", this.isOccluded);
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "bouncerShowing=", this.bouncerShowing);
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "topAppHideStatusBar=", this.topAppHidesStatusBar);
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "statusBarWindowHidden=", this.statusBarWindowHidden);
        printWriter.println("displayId=" + this.displayId);
        printWriter.println("---- State variables calculated internally ----");
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "hideIconsForBouncer=", this.hideIconsForBouncer);
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "bouncerWasShowingWhenHidden=", this.bouncerWasShowingWhenHidden);
        ActiveUnlockConfig$$ExternalSyntheticOutline0.m(printWriter, "wereIconsJustHidden=", this.wereIconsJustHidden);
    }
