...
public class SecStatusBarAudioManagerHelper {
    ...
    /* compiled from: qb/97869455 e70885ee4e20e40425471e4b47759369a50273352e1b7033cea52247075b3cbb */
    public class SecStatusBarAudioManagerHelperBroadcastReceiver extends BroadcastReceiver {
    ...
    public SecStatusBarAudioManagerHelper(Context context) {
        ...
        ((BroadcastDispatcher) Dependency.sDependency.getDependencyInner(BroadcastDispatcher.class)).registerReceiver(AppCompatDelegateImpl$AutoBatteryNightModeManager$$ExternalSyntheticOutline0.m("android.media.INTERNAL_RINGER_MODE_CHANGED_ACTION"), SecStatusBarAudioManagerHelper.this.mReceiver);
