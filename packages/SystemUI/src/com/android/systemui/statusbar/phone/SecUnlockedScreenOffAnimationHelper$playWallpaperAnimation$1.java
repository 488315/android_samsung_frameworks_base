...
final class SecUnlockedScreenOffAnimationHelper$playWallpaperAnimation$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i = ((KeyguardFoldControllerImpl) this.this$0.keyguardFoldController).isFoldOpened() ? 4 : 16;
        if (!this.this$0.wallpaperManager.isSystemAndLockPaired(i)) {
            this.this$0.wallpaperManager.semSendWallpaperCommand(i | 2, "samsung.android.wallpaper.goingtosleep", new Bundle());
        }
