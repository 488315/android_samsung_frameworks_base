    ...
    public final Object mo781invoke(Object obj) {
        switch (this.$r8$classId) {
            case 0:
                ...
                StringBuilder sbM = SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("LOCALLY DISMISS Already Parent-Dismissed Child ", str1, " of parent ", str2, " (");
                sbM.append(int1);
                sbM.append("/");
                sbM.append(int2);
                sbM.append(")");
            ...
            case 3:
                ...
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage3.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage3.getInt1(), "LOCALLY DISMISSED ", logMessage3.getStr1(), " (", "/"));
            case 4:
                LogMessage logMessage4 = (LogMessage) obj;
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage4.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage4.getInt1(), "LOCALLY DISMISS Already Dismissed ", logMessage4.getStr1(), " (", "/"));
            case 5:
            ...
            case 6:
                ...
                StringBuilder sbM890m = ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(int12, "DISMISS Already Parent-Dismissed ", str12, " (", "/");
                sbM890m.append(int22);
                sbM890m.append(") with summary ");
            ...
            case 8:
                ...
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage7.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage7.getInt1(), "DISMISS Non Existent ", logMessage7.getStr1(), " (", "/"));
            case 9:
                ...
                StringBuilder sbM2 = MutableObjectList$$ExternalSyntheticOutline0.m(int13, int23, "Collection missing ", " entries in ranking update. Just lost ", ": ");
                sbM2.append(str13);
                return sbM2.toString();
            case 10:
                String strLogKey = NotificationUtils.logKey((String) obj);
                return strLogKey != null ? strLogKey : "null";
            case 11:
                LogMessage logMessage9 = (LogMessage) obj;
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage9.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage9.getInt1(), "LOCALLY DISMISS Already Dismissed ", logMessage9.getStr1(), " (", "/"));
            case 12:
                LogMessage logMessage10 = (LogMessage) obj;
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage10.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage10.getInt1(), "DISMISS INTERCEPTED ", logMessage10.getStr1(), " (", "/"));
            case 13:
                ...
                StringBuilder sbM3 = MutableObjectList$$ExternalSyntheticOutline0.m(int14, int24, "Ranking update is missing ranking for ", " entries (", " new): ");
                sbM3.append(str14);
            ...
            case 17:
                String strLogKey2 = NotificationUtils.logKey((String) obj);
                return strLogKey2 != null ? strLogKey2 : "null";
            case 18:
                ...
                StringBuilder sbM890m2 = ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(int15, "RemoteException while attempting to clear ", str15, " (", "/");
                sbM890m2.append(int25);
                sbM890m2.append("):\n");
                sbM890m2.append(str23);
            ...
            case 20:
                ...
                StringBuilder sbM4 = SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("While ending lifetime extension by ", str24, " of ", str16, ", entry in collection is ");
                sbM4.append(str3);
            ...
            case 22:
                ...
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage15.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage15.getInt1(), "CLEAR ALL DISMISSAL INTERCEPTED ", logMessage15.getStr1(), " (", "/"));
            case 23:
                LogMessage logMessage16 = (LogMessage) obj;
                return ReorderTile$$ExternalSyntheticOutline0.m(logMessage16.getInt2(), ")", ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage16.getInt1(), "DISMISS Already Dismissed ", logMessage16.getStr1(), " (", "/"));
            case 24:
            ...
            case 25:
                ...
                StringBuilder sbM5 = MutableObjectList$$ExternalSyntheticOutline0.m(int16, int26, "Collection missing ", " entries in ranking update. Just found ", ": ");
                sbM5.append(str17);
                return sbM5.toString();
            case 26:
                String strLogKey3 = NotificationUtils.logKey((String) obj);
                return strLogKey3 != null ? strLogKey3 : "null";
            case 27:
