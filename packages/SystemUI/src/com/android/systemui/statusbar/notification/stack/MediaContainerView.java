...
public final class MediaContainerView extends ExpandableView {
    ...
    public final void setVisibility(int i) {
        ...
        if ((expandableViewState instanceof MediaContainerViewState ? (MediaContainerViewState) expandableViewState : null) == null || i == 8) {
            super.setVisibility(i);
        }
        ExpandableViewState expandableViewState2 = this.mViewState;
        if (expandableViewState2 instanceof MediaContainerViewState) {
            ((MediaContainerViewState) expandableViewState2).getClass();
            if (i == 0) {
