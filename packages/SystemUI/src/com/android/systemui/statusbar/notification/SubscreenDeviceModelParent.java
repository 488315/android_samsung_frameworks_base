...
public class SubscreenDeviceModelParent {
    ...
    public final boolean checkEntryConditionsForNonAddition(NotificationEntry notificationEntry, String str) {
        boolean z;
        boolean checkBubbleLastHistoryReply = checkBubbleLastHistoryReply(notificationEntry);
        String str2 = notificationEntry.mKey;
        if (checkBubbleLastHistoryReply) {
            MWBixbyController$$ExternalSyntheticOutline0.m("updateMainListArray ", str, " skip - mBubbleReplyEntry: ", str2, "S.S.N.");
        ...
        if (isBubbleNotificationSuppressed(notificationEntry)) {
            MWBixbyController$$ExternalSyntheticOutline0.m("updateMainListArray ", str, " skip - isBubbleNotificationSuppressed: ", str2, "S.S.N.");
            z = true;
        }
        if (this.mIsNotificationRemoved) {
            ...
            if (notificationEntry2 != null) {
                MWBixbyController$$ExternalSyntheticOutline0.m("updateMainListArray ", str, " skip - mIsNotificationRemoved: ", str2, "S.S.N.");
    ...
    public final void dismissImmediately(int i) {
        ...
        StringBuilder m = KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m(" DISMISS IMMEDIATELY(popupType) - popupViewShowing : ", ", presentationShowing : ", ", mNotiPopupView : ", z, z2);
        m.append(view2);
        ...
        if (subscreenSubRoomNotification2 != null && (subscreenNotificationInfoManager = subscreenSubRoomNotification2.mNotificationInfoManager) != null) {
            ...
            while (true) {
                ...
                if (notificationEntry2.mRanking.canBubble()) {
                    ...
                    notifCollection.mMainHandler.post(new NotifCollection$$ExternalSyntheticLambda9(notifCollection, notificationEntry2.mSbn, str, "Update the bubble notification in the subscreen state"));
                    break;
                }
                i++;
            }
    ...
    public final SubscreenSubRoomNotification getSubRoomNotification() {
        ...
        SubscreenSubRoomNotification subscreenSubRoomNotification = this.mSubRoomNotification;
        Intrinsics.checkNotNull(subscreenSubRoomNotification);
    ...
    public void initialize() {
        ...
        this.presentationTimeoutRunnable = new Runnable() { // from class: com.android.systemui.statusbar.notification.SubscreenDeviceModelParent$initTimeoutRunnable$1
            ...
            public final void run() {
                ...
                StringBuilder m = CarrierTextManagerLogger$logCallbackSentFromUpdate$2$$ExternalSyntheticOutline0.m(" TIMEOUT Run Parent PRESENTATION - RELEASE DOZE STATE - TIMEOUT : ", str, " , presentationShowing : ", ", mPresentation : ", z);
                m.append(subscreenNotificationPresentation);
                Log.d("S.S.N.", m.toString());
                SubscreenDeviceModelParent subscreenDeviceModelParent2 = SubscreenDeviceModelParent.this;
        ...
        this.popupViewTimeoutRunnable = new Runnable() { // from class: com.android.systemui.statusbar.notification.SubscreenDeviceModelParent$initTimeoutRunnable$2
            ...
            public final void run() {
                ...
                StringBuilder m = CarrierTextManagerLogger$logCallbackSentFromUpdate$2$$ExternalSyntheticOutline0.m(" TIMEOUT Run Parent POPUPVIEW - RELEASE DOZE STATE - TIMEOUT : ", str, " ,popupViewShowing : ", " , mNotiPopupView : ", z);
                m.append(view2);
                Log.d("S.S.N.", m.toString());
                SubscreenDeviceModelParent subscreenDeviceModelParent2 = SubscreenDeviceModelParent.this;
    ...
    public final boolean isGrayScaleIcon(NotificationEntry notificationEntry) {
        ...
        if (!notificationEntry.mRanking.getChannel().isImportantConversation()) {
            return NotificationUtils.isGrayscale(notificationEntry.mIcons.mStatusBarIcon, ContrastColorUtil.getInstance(this.mContext));
        }
        ImageView imageView = new ImageView(this.mContext);
        imageView.setImageIcon(notificationEntry.mSbn.getNotification().getSmallIcon());
        return NotificationUtils.isGrayscale(imageView, ContrastColorUtil.getInstance(this.mContext));
    }
    ...
    */
    ...
    public final void makeSubScreenNotification(NotificationEntry notificationEntry) {
        ...
        ComposerImpl$$ExternalSyntheticOutline0.m(sb, str4, " notiPopupType - ", i, " fullScreenNoti - ");
        ...
        if (this.mNotiPopupType == 2) {
            ...
            SubscreenNotificationDetail subscreenNotificationDetail = new SubscreenNotificationDetail(context);
        ...
        if (this.mNotiPopupType == 1) {
            ...
            SubscreenNotificationDetail subscreenNotificationDetail2 = new SubscreenNotificationDetail(context2 != null ? context2 : null);
    ...
    public final int notifyGroupAdapterItemRemoved(NotificationEntry notificationEntry) {
        ...
        StringBuilder sb = new StringBuilder("notifyGroupAdapterItemRemoved parent - Entry  : ");
        ComposerImpl$$ExternalSyntheticOutline0.m(sb, notificationEntry.mKey, ", index :", intValue, ", isLaunchApp :");
        sb.append(isLaunchApp);
        sb.append(", mMainViewAnimator :");
        sb.append(animator);
    ...
    public void setContentViewItem(Context context, SubscreenNotificationDetailAdapter.ItemViewHolder itemViewHolder) {
        ...
        while (i4 < size) {
            ...
            itemViewHolder.mBodyLayoutString = itemViewHolder.mBodyLayoutString + ((Object) (textView3 != null ? textView3.getText() : null)) + ((Object) (findViewById2 != null ? findViewById2.getText() : null));
            i4++;
            i = R.id.detail_clock;
    ...
    public final void showSubscreenNotification() {
        ...
        if (i == 1) {
            ...
            if (this.mPresentation == null) {
                ...
                SubscreenNotificationPresentation subscreenNotificationPresentation = new SubscreenNotificationPresentation(context, display2, subscreenNotificationDetail != null ? subscreenNotificationDetail.mLayout : null, this);
                this.mPresentation = subscreenNotificationPresentation;
                try {
                    subscreenNotificationPresentation.setOnShowListener(new DialogInterface.OnShowListener() { // from class: com.android.systemui.statusbar.notification.SubscreenDeviceModelParent$showSubscreenNotification$4
    ...
    public final void updateWakeLock(boolean z, boolean z2) {
        ...
        EmergencyButtonController$$ExternalSyntheticOutline0.m(" updateWakeLock - acquire : ", ", force : ", "S.S.N.", z, z2);
        if (z) {
    ...
    public final void dismissImmediately(NotificationEntry notificationEntry) {
        ...
        StringBuilder m = KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m(" DISMISS IMMEDIATELY(entry) - popupViewShowing : ", ", presentationShowing : ", ", currentPopupViewEntry : ", z, z2);
        ConstraintWidget$$ExternalSyntheticOutline0.m(m, str, ", currentPresentationEntry : ", str2, ", key : ");
