...
public class SubscreenSubRoomNotification implements SubRoom {
    ...
    public AnonymousClass2 linearLayoutManager = new LinearLayoutManager(mContext, 1, false) { // from class: com.android.systemui.statusbar.notification.SubscreenSubRoomNotification.2
        ...
        public final void onLayoutCompleted(RecyclerView.State state) {
            ...
            if (!subscreenSubRoomNotification.mIsShownDetail) {
                ...
                if (subscreenSubRoomNotification.mIsShownGroup || !SubscreenSubRoomNotification.getDeviceModel().isOneUI7_0()) {
                    return;
                }
                subscreenSubRoomNotification.mNotificationListAdapter.updateGroupViewHolderLayout();
                return;
            }
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [android.content.BroadcastReceiver, com.android.systemui.statusbar.notification.SubscreenSubRoomNotification$4] */
    ...
    /* JADX WARN: Type inference failed for: r5v0, types: [android.content.BroadcastReceiver, com.android.systemui.statusbar.notification.SubscreenSubRoomNotification$3] */
    private SubscreenSubRoomNotification() {
        ?? r5 = new BroadcastReceiver() { // from class: com.android.systemui.statusbar.notification.SubscreenSubRoomNotification.3
        ...
        this.mRemoteInputEmojiActionBroadcastReceiver = r5;
        ?? r0 = new BroadcastReceiver() { // from class: com.android.systemui.statusbar.notification.SubscreenSubRoomNotification.4
            @Override // android.content.BroadcastReceiver
            public final void onReceive(Context context, Intent intent) {
                Objects.toString(intent);
        ...
        context.registerReceiverAsUser(r5, userHandle, new IntentFilter("com.samsung.android.action.RETURN_REMOTE_INPUT"), "com.samsung.android.permission.RETURN_REMOTE_INPUT", null, 2);
        mContext.registerReceiverAsUser(r0, userHandle, new IntentFilter("com.samsung.android.action.RETURN_REMOTE_INPUT_VOICE"), "com.samsung.android.permission.RETURN_REMOTE_INPUT_VOICE", null, 2);
    }
    ...
    public final void initAdapter(SubscreenParentAdapter subscreenParentAdapter) {
        ...
        subscreenParentAdapter.mController = (SubscreenNotificationController) Dependency.sDependency.getDependencyInner(SubscreenNotificationController.class);
    ...
    public final void initRecyclerView() {
        ...
        if (subscreenRecyclerView != null) {
            ...
            List list = this.mNotificationRecyclerView.mScrollListeners;
            if (list != null) {
        ...
        DefaultItemAnimator defaultItemAnimator = subscreenRecyclerView6.mItemAnimator;
    ...
    public final Bundle request(String str, Bundle bundle) {
        ...
        if (SubRoom.STATE_BIO_POPUP_CANCELED.equals(str)) {
            Log.d("SubscreenSubRoomNotification", "request() STATE_BIO_POPUP_CANCELED ");
            this.mNotificationDetailAdapter.cleanAdapter();
            getDeviceModel().initKeyguardActioninfo();
            return bundle;
        }
        if (SubRoom.STATE_WINDOW_INSETS_DISPLAY_CUTOUT.equals(str)) {
            int[] intArray = bundle.getIntArray(SubRoom.EXTRA_KEY_DISPLAY_CUTOUT_TOP);
            int[] intArray2 = bundle.getIntArray(SubRoom.EXTRA_KEY_DISPLAY_CUTOUT_BOTTOM);
            Log.d("SubscreenSubRoomNotification", "request() STATE_WINDOW_INSETS_DISPLAY_CUTOUT \n  top   : " + Arrays.toString(intArray) + "\n  bottom: " + Arrays.toString(intArray2));
            getDeviceModel().adjustLayoutByCutout(intArray[3] - intArray[1], intArray2[3] - intArray2[1]);
        }
        return bundle;
    }
    ...
    public final void scrollToSelectedPosition() {
        ...
        while (true) {
            ...
            if ((subscreenNotificationInfoManager.mIsShownGroup ? ((SubscreenNotificationInfo) subscreenNotificationInfoManager.mGroupDataArray.get(i2)).mKey : ((SubscreenNotificationInfo) SubscreenNotificationInfoManager.mSubscreenNotificationInfoList.get(i2)).mKey).equals(str)) {
                i = subscreenNotificationInfoManager.mIsShownGroup ? i2 + (1 ^ (subscreenNotificationInfoManager.mSubscreenNotificationController.mDeviceModel.isMainHeader() ? 1 : 0)) : i2;
            } else {
                i2++;
            }
        }
    ...
    public final void showDetailNotification(SubscreenNotificationInfo subscreenNotificationInfo) {
        ...
        if (subscreenNotificationInfo.mIsMessagingStyle && (!subscreenNotificationInfo.mRow.needsRedaction() || !getDeviceModel().isNotShwonNotificationState(subscreenNotificationInfo.mRow.mEntry))) {
            ...
            subscreenNotificationController.conversationNotificationManager.states.compute(notificationEntry.mKey, new ConversationNotificationManager$sam$java_util_function_BiFunction$0(new ConversationNotificationManager$$ExternalSyntheticLambda0()));
        ...
        getDeviceModel().initFirstHistoryItemPostTimeInDetailAdapter();
    }
    ...
    public final void startReplyActivity(int i, SubscreenNotificationInfo subscreenNotificationInfo) {
        ...
        if (display != null) {
            ...
            if (i == 1) {
                ...
                intent.putExtra("locale", Locale.getDefault().toString());
    ...
    public final void updateNotificationState(NotificationEntry notificationEntry, int i) {
        ...
        if (i != 0) {
            ...
            if (!this.mIsInNotiRoom && (!((SettingsHelper) Dependency.sDependency.getDependencyInner(SettingsHelper.class)).isShowSilentNotificationOnLockscreen() ? notificationEntry.mRanking.getImportance() >= 3 : notificationEntry.mRanking.getImportance() >= 2) && !notificationEntry.mSbn.getNotification().isGroupSummary()) {
