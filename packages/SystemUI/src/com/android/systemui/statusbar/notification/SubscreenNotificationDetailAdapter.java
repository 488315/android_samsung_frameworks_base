...
public class SubscreenNotificationDetailAdapter extends SubscreenParentAdapter {
    ...
    public final int getItemViewType(int i) {
        ...
        return ((subscreenNotificationInfo2.mContentView == null || subscreenNotificationInfo2.mHasSemanticCall || subscreenNotificationInfo2.mIsMissedCall) && !subscreenNotificationInfo2.mRow.mEntry.isOngoingActivity()) ? 0 : 1;
    }
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) throws Resources.NotFoundException {
        if (!(viewHolder instanceof ItemViewHolder)) {
            if (viewHolder instanceof TextViewHolder) {
                ...
                subscreenNotificationDetailAdapter.mDeviceModel.updateKnoxIcon(textViewHolder.mSecureIcon, subscreenNotificationInfo);
                return;
            }
            return;
        }
        ...
        SubscreenDeviceModelParent subscreenDeviceModelParent2 = subscreenNotificationDetailAdapter2.mDeviceModel;
        ImageView imageView2 = itemViewHolder.mTwoPhoneIcon;
        subscreenDeviceModelParent2.getClass();
        SubscreenDeviceModelParent.updateTwoPhoneIcon(imageView2, subscreenNotificationInfo2);
        subscreenNotificationDetailAdapter2.mDeviceModel.updateKnoxIcon(itemViewHolder.mSecureIcon, subscreenNotificationInfo2);
    }
