...
final class OriginalUnseenKeyguardCoordinator$trackSeenNotificationsWhileLocked$2 extends SuspendLambda implements Function2 {
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.OriginalUnseenKeyguardCoordinator.trackSeenNotificationsWhileLocked.2.1.1
                    ...
                    public final Object emit(NotificationEntry notificationEntry, Continuation continuation) {
                        ...
                        if (set.remove(notificationEntry)) {
                            keyguardCoordinatorLogger = originalUnseenKeyguardCoordinator.logger;
    ...
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(OriginalUnseenKeyguardCoordinator originalUnseenKeyguardCoordinator, Set<NotificationEntry> set, Continuation continuation) {
            super(2, continuation);
            this.this$0 = originalUnseenKeyguardCoordinator;
            this.$notificationsSeenWhileLocked = set;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (!this.Z$0) {
                    ...
                    this.label = 1;
                    trackSeenNotificationsWhileLockedAndNotDozing = originalUnseenKeyguardCoordinator.trackSeenNotificationsWhileLockedAndNotDozing(set, this);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OriginalUnseenKeyguardCoordinator$trackSeenNotificationsWhileLocked$2(OriginalUnseenKeyguardCoordinator originalUnseenKeyguardCoordinator, Set<NotificationEntry> set, Continuation continuation) {
        super(2, continuation);
        this.this$0 = originalUnseenKeyguardCoordinator;
        this.$notificationsSeenWhileLocked = set;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            CoroutineTracingKt.launchTraced$default((CoroutineScope) this.L$0, null, null, new AnonymousClass1(this.this$0, this.$notificationsSeenWhileLocked, null), 7);
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((OriginalUnseenKeyguardCoordinator$trackSeenNotificationsWhileLocked$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
