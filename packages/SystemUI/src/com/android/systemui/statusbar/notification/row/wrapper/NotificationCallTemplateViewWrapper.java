...
public final class NotificationCallTemplateViewWrapper extends NotificationTemplateViewWrapper {
    ...
    public final void onContentUpdated(ExpandableNotificationRow expandableNotificationRow) {
        ...
        this.conversationIconContainer = callLayout.requireViewById(android.R.id.eight);
        this.conversationIconView = callLayout.requireViewById(android.R.id.dvorak);
        this.conversationBadgeBg = callLayout.requireViewById(android.R.id.editable);
        this.expandBtn = callLayout.requireViewById(android.R.id.flagRetrieveInteractiveWindows);
        this.appName = callLayout.requireViewById(android.R.id.beforeDescendants);
        this.conversationTitleView = callLayout.requireViewById(android.R.id.end);
