...
public abstract class NotificationViewWrapper implements TransformableView {
    ...
    public static NotificationViewWrapper wrap(Context context, View view, ExpandableNotificationRow expandableNotificationRow) {
        ...
        if (notificationEntry != null && notificationEntry.isOngoingActivity()) {
        ...
        if (SystemUIAnalytics.QPNE_VID_CONVERSATION.equals(view.getTag())) {
        ...
        if ("compactMessagingHUN".equals(view.getTag())) {
            return new NotificationCompactMessagingTemplateViewWrapper(context, view, expandableNotificationRow);
        }
        if ("progress".equals(view.getTag())) {
            return new NotificationProgressTemplateViewWrapper(context, view, expandableNotificationRow);
        }
        int i = NotificationBundleUi.$r8$clinit;
        return expandableNotificationRow.getEntryLegacy().mSbn.getNotification().isStyle(Notification.DecoratedCustomViewStyle.class) ? new NotificationDecoratedCustomViewWrapper(context, view, expandableNotificationRow) : NotificationDecoratedCustomViewWrapper.getWrappedCustomView(view) != null ? new NotificationDecoratedCustomViewWrapper(context, view, expandableNotificationRow) : new NotificationTemplateViewWrapper(context, view, expandableNotificationRow);
    }
    ...
    public final boolean needsInversion(View view, int i) {
        if (view == null || (this.mView.getResources().getConfiguration().uiMode & 48) != 32) {
            return false;
        }
        int i2 = NotificationBundleUi.$r8$clinit;
        if (this.mRow.getEntryLegacy().targetSdk >= 29) {
            return false;
        }
    ...
    public final int resolveBackgroundColor() {
        ...
        return customBackgroundColor != 0 ? customBackgroundColor : this.mView.getContext().getColor(R.color.sliding_tab_text_color_shadow);
    }
