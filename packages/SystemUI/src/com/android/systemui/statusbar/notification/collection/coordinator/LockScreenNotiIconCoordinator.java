...
public class LockScreenNotiIconCoordinator implements Coordinator, ConfigurationController.ConfigurationListener {
    ...
    private final NotifFilter mNotifFilter = new NotifFilter(TAG) { // from class: com.android.systemui.statusbar.notification.collection.coordinator.LockScreenNotiIconCoordinator.3
        ...
        public boolean shouldFilterOut(NotificationEntry notificationEntry, long j) {
            boolean z = NotiRune.NOTI_SUBSCREEN_ALL && LockScreenNotiIconCoordinator.this.mSubscreenController != null && LockScreenNotiIconCoordinator.this.mSubscreenController.mDeviceModel.isSubScreen();
            return (LsRune.LOCKUI_NOW_BAR_DEMO && notificationEntry.mBlockVisible) || (!(((StatusBarStateControllerImpl) LockScreenNotiIconCoordinator.this.mStatusBarStateController).mUpcomingState == 1 && notificationEntry.isOngoingActivity() && notificationEntry.isPromotedState()) ? z || ((StatusBarStateControllerImpl) LockScreenNotiIconCoordinator.this.mStatusBarStateController).mUpcomingState != 1 || !notificationEntry.isInsignificant() || LockScreenNotiIconCoordinator.this.needLockScreenExpandPanel() : LockScreenNotiIconCoordinator.this.needLockScreenExpandPanel() || z);
        }
    };
    private final PluginLockListener.State mPluginLockListener = new PluginLockListener.State() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.LockScreenNotiIconCoordinator.4
        ...
        public void onViewModeChanged(int i) {
            ...
            if (LockScreenNotiIconCoordinator.this.mAmbientState != null) {
                ...
                if (LockScreenNotiIconCoordinator.this.mAmbientState.mDragDownOnKeyguard && LockScreenNotiIconCoordinator.this.mPluginLockMode != 1) {
    ...
    public LockScreenNotiIconCoordinator(LockscreenNotificationManager lockscreenNotificationManager, KeyguardStateController keyguardStateController, NotificationLockscreenUserManager notificationLockscreenUserManager, GroupMembershipManager groupMembershipManager, PluginLockMediator pluginLockMediator, StatusBarStateController statusBarStateController, LockscreenShadeTransitionController lockscreenShadeTransitionController, AmbientState ambientState, ConfigurationController configurationController, SubscreenNotificationController subscreenNotificationController) {
        ...
        lockscreenShadeTransitionController.addCallback(new LockscreenShadeTransitionController.Callback() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.LockScreenNotiIconCoordinator.1
            ...
            @Override // com.android.systemui.statusbar.LockscreenShadeTransitionController.Callback
            public /* bridge */ /* synthetic */ void setOverDragAmount(float f) {
            }
    ...
    private void applyNotificationInfoArray(List<PipelineEntry> list) {
        ...
        for (PipelineEntry pipelineEntry : list) {
            ...
            if (((this.mPluginLockMode == 1 && z3) || ((KeyguardStateControllerImpl) this.mKeyguardStateController).mPrimaryBouncerShowing) && !this.mAmbientState.mDragDownOnKeyguard) {
                ...
                lambda$restoreVisibility$0(pipelineEntry);
            } else {
                expandableNotificationRow.setVisibility(8);
            }
        }
    ...
    private boolean needToSendOngoingEntry(NotificationEntry notificationEntry, boolean z) {
        ...
        return z ? ongoingActivityDataByKey == null || !ongoingActivityDataByKey.mIsMediaOngoingData : (notificationEntry.isOngoingActivity() && notificationEntry.isPromotedState()) ? false : true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void notifyLockScreenNotiInfoArrayUpdated(List<PipelineEntry> list) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void resetNotificationInfoArray(List<PipelineEntry> list) {
        this.mLockscreenNotificationManager.getClass();
        this.mNotificationInfoArray = new ArrayList<>();
    }
    ...
    public void lambda$restoreVisibility$0(PipelineEntry pipelineEntry) {
        ExpandableNotificationRow expandableNotificationRow = pipelineEntry.getRepresentativeEntry().row;
    ...
    public void onOrientationChanged(int i) {
        if (((needLockScreenExpandPanel() || !this.mAmbientState.mDragDownOnKeyguard) && !((SettingsHelper) Dependency.sDependency.getDependencyInner(SettingsHelper.class)).isNotificationAsCard()) || i != 1 || this.mPluginLockMode == 1) {
            return;
        }
        this.mAmbientState.setDragDownOnKeyguard(false);
