    ...
    public final boolean handleCloseControls(boolean z, boolean z2) {
        ...
        if (z && !this.mIsNonblockable) {
            ...
            if (this.mChosenImportance != null) {
                ...
                ((OnUserInteractionCallbackImpl) this.mOnUserInteractionCallback).mVisualStabilityCoordinator.temporarilyAllowSectionChanges(this.mEntry, SystemClock.uptimeMillis());
            }
        }
