...
public final class NotificationInterruptStateProviderWrapper implements VisualInterruptionDecisionProvider {
    ...
    public final void addLegacySuppressor(StatusBarNotificationPresenter.AnonymousClass3 anonymousClass3) {
        ((ArrayList) ((NotificationInterruptStateProviderImpl) this.wrapped).mSuppressors).add(anonymousClass3);
    }
