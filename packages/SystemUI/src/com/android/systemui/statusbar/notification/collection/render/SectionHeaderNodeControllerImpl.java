    ...
    public SectionHeaderNodeControllerImpl(String str, LayoutInflater layoutInflater, int i, ActivityStarter activityStarter, String str2) {
        ...
        new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.collection.render.SectionHeaderNodeControllerImpl$onHeaderClickListener$1
            ...
            public final void onClick(View view) {
                SectionHeaderNodeControllerImpl.this.activityStarter.startActivity(new Intent(SectionHeaderNodeControllerImpl.this.clickIntentAction), true, true, VolumePanelValues.FLAG_SHOW_CSD_100_WARNINGS);
            }
        };
    }
    ...
    */
    public final void reinflateView(android.view.ViewGroup r7) {
        ...
        L17:
            ...
            r3 = 2131559626(0x7f0d04ca, float:1.8744601E38)
            r4 = 0
