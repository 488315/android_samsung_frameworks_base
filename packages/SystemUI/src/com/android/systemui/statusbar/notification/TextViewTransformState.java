...
public class TextViewTransformState extends TransformState {
    ...
    public final boolean sameAs(TransformState transformState) {
        ...
        if (transformState instanceof TextViewTransformState) {
            ...
            if (TextUtils.equals(textViewTransformState.mText.getText(), this.mText.getText()) && getEllipsisCount() == textViewTransformState.getEllipsisCount() && this.mText.getLineCount() == textViewTransformState.mText.getLineCount() && (z = (callback = this.mText) instanceof Spanned) == (textViewTransformState.mText instanceof Spanned)) {
                if (!z) {
                    return true;
                }
