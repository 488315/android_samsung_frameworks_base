...
final class OriginalUnseenKeyguardCoordinator$clearUnseenNotificationsWhenShadeIsExpanded$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(boolean z, Continuation continuation) {
        return ((OriginalUnseenKeyguardCoordinator$clearUnseenNotificationsWhenShadeIsExpanded$2) create(Boolean.valueOf(z), continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
