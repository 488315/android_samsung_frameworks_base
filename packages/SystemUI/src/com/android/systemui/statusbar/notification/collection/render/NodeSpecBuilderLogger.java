...
public final class NodeSpecBuilderLogger {
    public NodeSpecBuilderLogger(final NotifPipelineFlags notifPipelineFlags, LogBuffer logBuffer) {
        LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.statusbar.notification.collection.render.NodeSpecBuilderLogger$$ExternalSyntheticLambda0
