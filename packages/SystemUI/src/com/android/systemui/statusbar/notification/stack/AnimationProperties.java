...
public class AnimationProperties {
    ...
    public DynamicAnimation.OnAnimationEndListener getAnimationEndListener(final Property property) {
        ...
        return new DynamicAnimation.OnAnimationEndListener() { // from class: com.android.systemui.statusbar.notification.stack.AnimationProperties$$ExternalSyntheticLambda0
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                Consumer consumer3 = consumer2;
                Property property2 = property;
                Consumer consumer4 = consumer;
                if (z && consumer3 != null) {
                    consumer3.accept(property2);
                } else {
                    if (z || consumer4 == null) {
                        return;
                    }
                    consumer4.accept(property2);
                }
            }
        };
    }
    ...
    public Consumer getAnimationStartListener() {
        return null;
    }
