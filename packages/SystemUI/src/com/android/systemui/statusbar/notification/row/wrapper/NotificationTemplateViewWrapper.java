...
public class NotificationTemplateViewWrapper extends NotificationHeaderViewWrapper {
    ...
    public final boolean hasRightIcon() {
        ...
        return imageView.getTag(R.id.image_icon_tag) != null;
    }
    ...
    public void onContentUpdated(ExpandableNotificationRow expandableNotificationRow) {
        ...
        ImageView imageView4 = (ImageView) this.mView.findViewById(android.R.id.multipleChoice);
        ...
        this.mNotificationChildrenCount = (TextView) this.mView.findViewById(android.R.id.input_minute);
        NotificationActionListLayout notificationActionListLayout = this.mActions;
        ...
        if (notificationActionListLayout2 != null) {
            int childCount2 = notificationActionListLayout2.getChildCount();
            for (int i4 = 0; i4 < childCount2; i4++) {
                Button button2 = (Button) this.mActions.getChildAt(i4);
