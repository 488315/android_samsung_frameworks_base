...
public final class NotificationSectionHeadersModule_ProvidesFavoriteHeaderSubcomponentFactory implements Provider {
    ...
    public NotificationSectionHeadersModule_ProvidesFavoriteHeaderSubcomponentFactory(Provider provider) {
        this.builderProvider = provider;
    }

    public static DaggerReferenceGlobalRootComponent.SectionHeaderControllerSubcomponentImpl providesFavoriteHeaderSubcomponent(javax.inject.Provider provider) {
