...
public final class NotificationSectionHeadersModule_ProvidesOngoingActivityHeaderSubcomponentFactory implements Provider {
    ...
    public NotificationSectionHeadersModule_ProvidesOngoingActivityHeaderSubcomponentFactory(Provider provider) {
        this.builderProvider = provider;
    }

    public static DaggerReferenceGlobalRootComponent.SectionHeaderControllerSubcomponentImpl providesOngoingActivityHeaderSubcomponent(javax.inject.Provider provider) {
