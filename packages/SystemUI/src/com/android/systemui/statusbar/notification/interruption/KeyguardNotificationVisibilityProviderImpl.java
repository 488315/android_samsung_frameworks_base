...
public final class KeyguardNotificationVisibilityProviderImpl implements CoreStartable, KeyguardNotificationVisibilityProvider {
    ...
    */
    public final boolean shouldHideIfEntrySilent(com.android.systemui.statusbar.notification.collection.PipelineEntry r5) {
        /*
            r4 = this;
        ...
        L4d:
            ...
            goto L5c
        L52:
            com.android.systemui.statusbar.notification.collection.PipelineEntry r5 = r5.getParent()
            if (r5 == 0) goto L37
        ...
        L5c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.statusbar.notification.interruption.KeyguardNotificationVisibilityProviderImpl.shouldHideIfEntrySilent(com.android.systemui.statusbar.notification.collection.PipelineEntry):boolean");
    }

    /* JADX WARN: Code restructure failed: missing block: B:18:0x0061, code lost:
    
        if ((r0.getNotification().visibility == -1 && (!"com.nttdocomo.android.atf".equals(r0.getPackageName()) || ((com.android.systemui.statusbar.policy.KeyguardStateControllerImpl) r6.keyguardStateController).mSecure)) != false) goto L32;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
