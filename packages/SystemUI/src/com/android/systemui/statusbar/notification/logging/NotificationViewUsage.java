...
public final class NotificationViewUsage {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.softwareBitmapsPenalty) + ReorderTile$$ExternalSyntheticOutline0.m(this.customViews, ReorderTile$$ExternalSyntheticOutline0.m(this.style, ReorderTile$$ExternalSyntheticOutline0.m(this.systemIcons, ReorderTile$$ExternalSyntheticOutline0.m(this.largeIcon, ReorderTile$$ExternalSyntheticOutline0.m(this.smallIcon, this.viewType.hashCode() * 31, 31), 31), 31), 31), 31);
    }
    ...
    public final String toString() {
        ...
        return ReorderTile$$ExternalSyntheticOutline0.m(this.softwareBitmapsPenalty, ")", sb);
    }
}
