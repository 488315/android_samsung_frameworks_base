...
public final class NotificationSectionHeadersModule_ProvidesPromoHeaderSubcomponentFactory implements Provider {
    ...
    public NotificationSectionHeadersModule_ProvidesPromoHeaderSubcomponentFactory(Provider provider) {
        this.builderProvider = provider;
    }

    public static DaggerReferenceGlobalRootComponent.SectionHeaderControllerSubcomponentImpl providesPromoHeaderSubcomponent(javax.inject.Provider provider) {
    ...
    public final Object get() {
        return providesPromoHeaderSubcomponent(this.builderProvider);
    }
}
