...
final class NotificationShelfViewBinder$bind$2$3$3 extends SuspendLambda implements Function2 {
    ...
    public NotificationShelfViewBinder$bind$2$3$3(NotificationShelfViewModel notificationShelfViewModel, NotificationShelf notificationShelf, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new NotificationShelfViewBinder$bind$2$3$3(this.$viewModel, this.$this_apply, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((NotificationShelfViewBinder$bind$2$3$3) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlowImpl stateFlowImpl = ((KeyguardRepositoryImpl) this.$viewModel.interactor.keyguardRepository).isKeyguardShowing;
