...
public final class SubscreenDeviceModelCover extends SubscreenDeviceModelParent {
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.statusbar.notification.SubscreenDeviceModelCover$mUpdateMonitorCallback$1] */
            ...
            public final void onUpdateCoverState(CoverState coverState) {
                if (coverState != null) {
                    ...
                    if (subscreenDeviceModelCover.mIsCovered) {
                        subscreenDeviceModelCover.againPipLine();
                    } else {
    ...
    public final void makePopupDetailView(Context context, NotificationEntry notificationEntry, boolean z, FrameLayout frameLayout) {
        ...
        boolean z5 = title == null || StringsKt__StringsKt.trim(title.toString()).toString().length() == 0;
        boolean z6 = str == null || StringsKt__StringsKt.trim(str.toString()).toString().length() == 0;
        if (z5) {
            if (textView2 != null) {
                textView2.setVisibility(8);
            }
        ...
        if (subscreenNotificationDetail != null) {
            subscreenNotificationDetail.mMarqueeText = textView2;
        }
    }
