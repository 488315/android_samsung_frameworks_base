...
public final class ShelfNotificationIconViewStore {
    ...
    public ShelfNotificationIconViewStore(NotifCollection notifCollection) {
        this.$$delegate_0 = new NotificationIconContainerViewBinderKt$iconViewStoreBy$1(notifCollection, new ShelfNotificationIconViewStore$$ExternalSyntheticLambda0());
    }
}
