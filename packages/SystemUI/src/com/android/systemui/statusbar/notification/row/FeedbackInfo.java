...
public class FeedbackInfo extends LinearLayout implements NotificationGuts.GutsContent {
    ...
    public final void bindGuts(PackageManager packageManager, StatusBarNotification statusBarNotification, NotificationListenerService.Ranking ranking, ExpandableNotificationRow expandableNotificationRow, AssistantFeedbackController assistantFeedbackController, IStatusBarService iStatusBarService, NotificationGutsManager notificationGutsManager) throws PackageManager.NameNotFoundException {
        ...
        int feedbackStatus = this.mFeedbackController.getFeedbackStatus(this.mRanking);
        if (feedbackStatus == 1) {
