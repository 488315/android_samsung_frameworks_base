...
public class SubscreenParentDetailItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public SubscreenParentDetailItemViewHolder(View view) {
        ...
        linearLayout.setVisibility(((SubscreenNotificationController) Dependency.sDependency.getDependencyInner(SubscreenNotificationController.class)).mDeviceModel.isMainHeader() ? 8 : 0);
    }
    ...
    public final void setIconDrawable() {
        ...
        if (subscreenNotificationInfo.mAppIcon != null && !subscreenNotificationInfo.useSmallIcon() && !this.mInfo.isSportsOngoing()) {
    ...
    public final void updateShowInAppButtonVisibility() {
        ...
        Log.d("SubscreenParentDetailItemViewHolder", "updateShowInAppButtonVisibility - " + this.mInfo.mKey + " : " + this.mInfo.mContentIntent);
    }
}
