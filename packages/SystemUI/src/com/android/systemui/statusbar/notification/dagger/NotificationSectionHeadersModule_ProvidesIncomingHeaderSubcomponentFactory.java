...
public final class NotificationSectionHeadersModule_ProvidesIncomingHeaderSubcomponentFactory implements Provider {
    ...
    public static DaggerReferenceGlobalRootComponent.SectionHeaderControllerSubcomponentImpl providesIncomingHeaderSubcomponent(javax.inject.Provider provider) {
