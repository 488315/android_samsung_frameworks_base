...
public final class ListAttachState {
    ...
    public /* synthetic */ ListAttachState(PipelineEntry pipelineEntry, NotifSection notifSection, NotifFilter notifFilter, NotifPromoter notifPromoter, String str, SuppressedAttachState suppressedAttachState, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private ListAttachState(PipelineEntry pipelineEntry, NotifSection notifSection, NotifFilter notifFilter, NotifPromoter notifPromoter, String str, SuppressedAttachState suppressedAttachState) {
