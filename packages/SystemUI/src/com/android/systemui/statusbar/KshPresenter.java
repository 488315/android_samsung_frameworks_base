...
public class KshPresenter {
    ...
    public final AnonymousClass1 mConfigurationListener = new ConfigurationController.ConfigurationListener() { // from class: com.android.systemui.statusbar.KshPresenter.1
        ...
        public final void onConfigChanged(Configuration configuration) {
            ...
            if (kshPresenter.mLastConfig.orientation != configuration.orientation && (dialog = kshPresenter.mKshView.mKeyboardShortcutsDialog) != null && dialog.isShowing()) {
    ...
    public KshPresenter(Context context) {
        ...
        this.mConfigurationController = (ConfigurationController) Dependency.sDependency.getDependencyInner(ConfigurationController.class);
    }
