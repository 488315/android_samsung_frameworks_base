...
public final class PulseExpansionHandler implements Gefingerpoken, Dumpable {
    ...
    public QuickSettingsControllerImpl$$ExternalSyntheticLambda10 pulseExpandAbortListener;
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        CoverScreenDecorHwcLayer$$ExternalSyntheticOutline0.m("isExpanding: ", this.isExpanding, indentingPrintWriter);
        CoverScreenDecorHwcLayer$$ExternalSyntheticOutline0.m("leavingLockscreen: ", this.leavingLockscreen, indentingPrintWriter);
        CoverScreenDecorHwcLayer$$ExternalSyntheticOutline0.m("mPulsing: ", this.mPulsing, indentingPrintWriter);
        CoverScreenDecorHwcLayer$$ExternalSyntheticOutline0.m("bouncerShowing: ", this.bouncerShowing, indentingPrintWriter);
    }
    ...
    public final void setExpanding(boolean z) {
        ...
        if (z2) {
            if (z) {
                ...
                LSShadeTransitionLogger$$ExternalSyntheticLambda0 lSShadeTransitionLogger$$ExternalSyntheticLambda0 = new LSShadeTransitionLogger$$ExternalSyntheticLambda0(10);
                ...
                QuickSettingsControllerImpl$$ExternalSyntheticLambda10 quickSettingsControllerImpl$$ExternalSyntheticLambda10 = this.pulseExpandAbortListener;
                if (quickSettingsControllerImpl$$ExternalSyntheticLambda10 != null) {
                    quickSettingsControllerImpl$$ExternalSyntheticLambda10.run();
                }
            }
            ((HeadsUpManagerImpl) this.headsUpManager).unpinAll();
        }
    }
