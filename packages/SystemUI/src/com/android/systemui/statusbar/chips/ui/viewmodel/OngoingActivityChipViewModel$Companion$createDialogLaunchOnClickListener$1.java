...
public final class OngoingActivityChipViewModel$Companion$createDialogLaunchOnClickListener$1 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        SystemUIDialog systemUIDialogCreateDialog = this.$dialogDelegate.createDialog();
        ...
        ViewDialogTransitionAnimatorController viewDialogTransitionAnimatorControllerFromView = DialogTransitionAnimator.Controller.Companion.fromView(chipBackgroundContainer, dialogCuj);
        if (viewDialogTransitionAnimatorControllerFromView == null) {
            systemUIDialogCreateDialog.show();
        } else {
            dialogTransitionAnimator.show(systemUIDialogCreateDialog, viewDialogTransitionAnimatorControllerFromView, false);
        }
    }
}
