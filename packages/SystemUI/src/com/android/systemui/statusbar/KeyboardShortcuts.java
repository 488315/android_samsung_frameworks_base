...
public final class KeyboardShortcuts {
    ...
    public KeyboardShortcuts(Context context, WindowManager windowManager) {
        ...
        sparseArray.put(111, context.getString(com.android.systemui.R.string.keyboard_key_esc));
    ...
    public static void show(Context context, int i, WindowManagerProvider windowManagerProvider) {
        ...
        synchronized (sLock) {
            ...
            if (sInstance == null) {
                ...
                sInstance = new KeyboardShortcuts(context, WindowManagerUtils.getWindowManager(context));
            }
            sInstance.showKeyboardShortcuts(i);
        }
    }

    public static void toggle(Context context, int i, WindowManagerProvider windowManagerProvider) {
        Dialog dialog;
        synchronized (sLock) {
            try {
                KeyboardShortcuts keyboardShortcuts = sInstance;
                if ((keyboardShortcuts == null || (dialog = keyboardShortcuts.mKeyboardShortcutsDialog) == null || !dialog.isShowing()) ? false : true) {
                    ...
                    show(context, i, windowManagerProvider);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void showKeyboardShortcuts(int i) {
        ...
        if (i == -1 || (inputDevice = inputManager.getInputDevice(i)) == null) {
            ...
            while (true) {
                ...
                if (inputDevice2 != null && inputDevice2.getId() != -1 && inputDevice2.isFullKeyboard()) {
        ...
        ((WindowManager) kshPresenter.mContext.getSystemService("window")).requestAppKeyboardShortcuts(new WindowManager.KeyboardShortcutsReceiver() { // from class: com.android.systemui.statusbar.KshPresenter.3
            ...
            public final void onKeyboardShortcutsReceived(final List list) {
                KshPresenter kshPresenter2 = KshPresenter.this;
                if (kshPresenter2.mKshView == null || kshPresenter2.mKshData == null) {
                    return;
                }
                ...
                final KshPresenter kshPresenter3 = KshPresenter.this;
                ...
                kshPresenter3.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.KshPresenter$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        ...
                        if (kshPresenter4.mKshData == null) {
                            return;
                        }
                        kshPresenter4.mKshView.showKshDialog(list3);
                    }
                });
            }
        }, i);
