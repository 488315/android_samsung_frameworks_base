...
public final class SecSelectedComponentRepositoryImpl implements SecSelectedComponentRepository {
    ...
    public final SelectedComponentRepository.SelectedComponent getSelectedComponent(UserHandle userHandle) {
        SharedPreferences sharedPreferences$1 = ((UserFileManagerImpl) this.userFileManager).getSharedPreferences$1(Intrinsics.areEqual(userHandle, UserHandle.CURRENT) ? ((UserTrackerImpl) this.userTracker).getUserId() : userHandle.getIdentifier(), SystemUIAnalytics.CONTROL_PREF_NAME);
