...
public final class ControlInfo {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.layoutType) + ReorderTile$$ExternalSyntheticOutline0.m(this.deviceType, ControlInfo$$ExternalSyntheticOutline0.m(ControlInfo$$ExternalSyntheticOutline0.m(this.controlId.hashCode() * 31, 31, this.controlTitle), 31, this.controlSubtitle), 31);
    }
