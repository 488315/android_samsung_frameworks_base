    ...
    public final void bindToPanelInternal() {
        ...
        if (preferredComponentSelectedItem instanceof SelectedItem.PanelItem) {
            ...
            if (obj != null) {
                ...
                ControlsProviderLifecycleManager retrieveLifecycleManager = ((ControlsBindingControllerImpl) ((ControlsControllerImpl) ((ControlsController) controlsComponent.controlsController.get())).bindingController).retrieveLifecycleManager(panelItem.componentName);
