...
public final class SecControlsReorderActivity extends BaseActivity {
    ...
    public SecControlsReorderActivity(Executor executor, ControlsController controlsController, BroadcastDispatcher broadcastDispatcher, LayoutUtil layoutUtil, ControlsUtil controlsUtil, AUIFacade aUIFacade, UserTracker userTracker) {
    ...
    public final String getTag() {
        return "SecControlsReorderActivity";
    }
    ...
    public final void onBackKeyPressed() {
        ...
        if (!Intrinsics.areEqual(arrayList, currentStructureList)) {
            ...
            Log.d("SecControlsReorderActivity", "saveStructureOrder origin=" + (arrayList2 != null ? arrayList2 : null) + ", current=" + currentStructureList + " ");
            Intent intent = new Intent(this, (Class<?>) SecControlsFavoritingActivity.class);
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if ((((ComponentName) getIntent().getParcelableExtra("android.intent.extra.COMPONENT_NAME")) != null ? Unit.INSTANCE : null) == null) {
            finish();
        }
        ...
        SecStructureAdapter secStructureAdapter2 = this.structureAdapter;
        if (secStructureAdapter2 == null) {
            secStructureAdapter2 = null;
        }
        ...
        secStructureAdapter2.model = reorderStructureModel2;
        secStructureAdapter2.notifyDataSetChanged();
        ...
        SecStructureAdapter secStructureAdapter3 = this.structureAdapter;
        reorderStructureModel3.adapter = secStructureAdapter3 != null ? secStructureAdapter3 : null;
    }
