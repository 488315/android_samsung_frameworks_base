...
public class ControlsActivity extends ComponentActivity {
    ...
    /* JADX WARN: Type inference failed for: r10v7, types: [com.android.systemui.controls.ui.ControlsActivity$initBroadcastReceiver$1] */
    ...
    public final void onCreate(Bundle bundle) {
        ...
        ((ViewGroup) requireViewById(R.id.control_detail_root)).setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.android.systemui.controls.management.ControlsManagementActivityKt$applyInsets$1$1
