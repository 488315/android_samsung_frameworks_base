...
public final class ControlActionCoordinatorImpl$showDetail$1 implements Runnable {
    ...
    public final void run() {
        final List<ResolveInfo> listQueryIntentActivities = this.this$0.context.getPackageManager().queryIntentActivities(this.$pendingIntent.getIntent(), 65536);
        ...
        delayableExecutor.execute(new Runnable() { // from class: com.android.systemui.controls.ui.ControlActionCoordinatorImpl$showDetail$1.1
            ...
            public final void run() throws Resources.NotFoundException, PendingIntent.CanceledException {
                if (listQueryIntentActivities.isEmpty() || !controlActionCoordinatorImpl.taskViewFactory.isPresent()) {
                ...
                if (controlActionCoordinatorImpl2.dialog == null) {
                    ...
                    TaskViewFactoryController.this.mShellExecutor.execute(new TaskViewFactoryController$TaskViewFactoryImpl$$ExternalSyntheticLambda0(taskViewFactoryImpl, context, controlActionCoordinatorImpl3.uiExecutor, new Consumer() { // from class: com.android.systemui.controls.ui.ControlActionCoordinatorImpl.showDetail.1.1.1
                        ...
                        public final void accept(Object obj) {
                            ...
                            ControlActionCoordinatorImpl controlActionCoordinatorImpl4 = controlActionCoordinatorImpl3;
                            Context context2 = controlActionCoordinatorImpl3.activityContext;
                            context2.getClass();
                            BroadcastSender broadcastSender = controlActionCoordinatorImpl3.broadcastSender;
                            taskView.getClass();
                            PendingIntent pendingIntent4 = pendingIntent3;
                            ControlViewHolder controlViewHolder3 = controlViewHolder2;
                            ControlActionCoordinatorImpl controlActionCoordinatorImpl5 = controlActionCoordinatorImpl3;
                            ...
                            final ControlActionCoordinatorImpl controlActionCoordinatorImpl6 = controlActionCoordinatorImpl3;
                            ...
                            detailDialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.android.systemui.controls.ui.ControlActionCoordinatorImpl$showDetail$1$1$1$1$1
                                ...
                                public final void onDismiss(DialogInterface dialogInterface) {
                                    controlActionCoordinatorImpl6.dialog = null;
                                }
                            });
                            detailDialog.show();
