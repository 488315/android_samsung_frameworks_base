...
public class SamsungScreenPinningRequest implements DialogInterface.OnClickListener, NavigationModeController.ModeChangedListener {
    ...
    private static final String HAS_PERMISSION_COLUMN = "hasPermission";
    private static final String KEY_SPC_ENABLED = "spc_enabled";
    private static final String METHOD_GET_SPC_INFO = "GetSPCInfo";
    ...
    private static final String QUERY_APPS = "careapps";
    private static final String REQUEST_CALL = "requests";
    private static final String TAG = "SamsungScreenPinningRequest";
    private static final String URI_APPS = "content://com.samsung.android.app.parentalcare.provider/careapps";
    private static final String URI_REQUEST = "content://com.samsung.android.app.parentalcare.provider/requests";
    ...
    private void extractRecentTaskInfo(int i) {
        ...
        while (true) {
            ...
            ActivityInfo activityInfo = PackageManagerWrapper.getActivityInfo(i3, componentName);
            ...
            if (recentTaskInfo.persistentId == i) {
                ...
                this.mIsExcluded = z;
                if (z) {
                    this.mLogWrapper.d(TAG, "flag:" + String.valueOf(recentTaskInfo.baseIntent.getFlags()) + " / intent:" + String.valueOf(8388608));
                }
            } else {
                i2++;
            }
    ...
    private boolean isParentalControlEnabled() {
        try {
            ...
            Log.e(TAG, "Failed to fetch SPC info", e);
        }
        return false;
    }
