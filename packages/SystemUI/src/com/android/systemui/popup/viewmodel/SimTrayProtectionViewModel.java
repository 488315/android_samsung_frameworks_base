...
public class SimTrayProtectionViewModel implements PopupUIViewModel, WakefulnessLifecycle.Observer {
    ...
    public void show(Intent intent) {
        if (this.mIntentWrapper.getAction(intent).equals(getAction())) {
            ...
            if ("factory".equalsIgnoreCase(SemSystemProperties.get("ro.factory.factory_binary", C2paManifestList.UNKNOWN_VALUE)) && PopupUIUtil.ACTION_SIM_CARD_TRAY_PROTECTION_POPUP.equals(getAction())) {
                return;
            }
