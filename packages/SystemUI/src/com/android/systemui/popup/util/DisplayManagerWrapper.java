...
public class DisplayManagerWrapper {
    ...
    public void registerDisplayChangedListener(final Runnable runnable) {
        DisplayManager.DisplayListener displayListener = new DisplayManager.DisplayListener(this) { // from class: com.android.systemui.popup.util.DisplayManagerWrapper.1
