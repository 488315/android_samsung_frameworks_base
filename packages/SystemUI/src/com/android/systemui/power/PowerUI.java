...
public class PowerUI implements CoreStartable, ConfigurationController.ConfigurationListener, CommandQueue.Callbacks {
    ...
    final class Receiver extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            PowerUI.this.getClass();
            int i5 = PowerUI.this.mBatteryLevel;
            throw null;
        }
    }
    ...
    public PowerUI(Context context, BroadcastDispatcher broadcastDispatcher, CommandQueue commandQueue, IVrManager iVrManager, WarningsUI warningsUI, EnhancedEstimates enhancedEstimates, WakefulnessLifecycle wakefulnessLifecycle, PowerManager powerManager, UserTracker userTracker, WindowManager windowManager) {
    ...
    public boolean shouldShowLowBatteryWarning(BatteryStateSnapshot batteryStateSnapshot, BatteryStateSnapshot batteryStateSnapshot2) {
        ...
        int i = batteryStateSnapshot2.bucket;
        int i2 = batteryStateSnapshot.bucket;
        return (i2 < i || batteryStateSnapshot2.plugged) && i2 < 0 && batteryStateSnapshot.batteryStatus != 1;
    }

    @Override // com.android.systemui.statusbar.CommandQueue.Callbacks
    public final void showInattentiveSleepWarning() {
        if (this.mOverlayView == null) {
            this.mOverlayView = new InattentiveSleepWarningView(this.mContext, this.mWindowManager);
        }
        InattentiveSleepWarningView inattentiveSleepWarningView = this.mOverlayView;
