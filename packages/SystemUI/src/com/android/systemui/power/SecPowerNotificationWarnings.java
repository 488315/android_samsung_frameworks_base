...
import com.android.systemui.power.sound.PowerUiSoundBuilder;
...
import com.android.systemui.power.view.UnintentionalLcdOnView;
...
public class SecPowerNotificationWarnings implements SecWarningsUI {
    ...
    public final SecPowerNotificationWarnings$$ExternalSyntheticLambda0 mUsbDamageProtectionAlertTask;
    ...
    public final SecPowerNotificationWarnings$$ExternalSyntheticLambda0 mWaterProtectionAlertTask;
    ...
    public SecPowerNotificationWarnings(Context context) {
        ...
        this.mWaterProtectionAlertTask = new SecPowerNotificationWarnings$$ExternalSyntheticLambda0(this, 0);
        this.mUsbDamageProtectionAlertTask = new SecPowerNotificationWarnings$$ExternalSyntheticLambda0(this, 1);
        ...
        KeyguardUpdateMonitor$$ExternalSyntheticOutline0.m(intentFilter, "com.samsung.intent.action.EMERGENCY_STATE_CHANGED", "com.samsung.systemui.power.action.ACTION_BATTERY_OVER_HEAT", "com.samsung.systemui.power.action.ACTION_BATTERY_SAFE_MODE", "com.sec.factory.app.factorytest.FTA_ON");
        ...
        contentResolver.registerContentObserver(Settings.Global.getUriFor(SettingsHelper.INDEX_LOW_POWER_MODE), false, new ContentObserver(handler) { // from class: com.android.systemui.power.SecPowerNotificationWarnings.1
            ...
            public final void onChange(boolean z) {
                ...
                if (secPowerNotificationWarnings2.mWarning && i != secPowerNotificationWarnings2.mCurrentBatteryMode) {
                    secPowerNotificationWarnings2.updateNotification();
                }
        ...
        int i = Settings.Global.getInt(context.getContentResolver(), SettingsHelper.INDEX_LOW_POWER_MODE, 0);
    ...
    public final void cancelNotification(int i) {
        ...
        if (notification2 == null) {
            ClockEventController$$ExternalSyntheticOutline0.m(i, "Illegal notification type : ", "PowerUI.Notification");
            return;
        }
    ...
    public final AlertDialog getPopupDialog(int i) {
        ...
        if (incompleteChargerDialog == null) {
            ClockEventController$$ExternalSyntheticOutline0.m(i, "Illegal dialog type : ", "PowerUI.Notification");
            return null;
        }
    ...
    public final void playPowerSound(int i) {
        ...
        powerUiSoundBuilder.isInCall = this.mIsInCall;
        powerUiSoundBuilder.chargingType = this.mSuperFastCharger;
        powerUiSoundBuilder.audioManager = this.mAudioManager;
            ...
            try {
                ...
                if (split.length >= 2) {
                    ...
                    if (parseInt > 30000) {
                        ...
                        if (z && (powerManager = this.mPowerManager) != null) {
                            Slog.i("PowerUi.PowerUtils", "Request userActivity() for reset screen on time");
    ...
    public final void showChargingNotice() {
        ...
        if (PowerUiRune.POLICY_CHARGING_NOTIFICATION && this.mDoNotShowChargingNotice && z == this.mIsMaximumProtectionEnabled && i2 == this.mMaximumThresholdValue && (i = this.mChargingType) != 8 && i != 9) {
        ...
        Slog.d("PowerUI.Notification", "showChargingNotice - Battery Level : " + this.mOldBatteryLevel + " -> " + this.mBatteryLevel + ", Charging Type : " + this.mOldChargingType + " -> " + this.mChargingType + ", Charging Time : " + j + " -> " + this.mChargingTime + ", Maximum protection : " + z + " -> " + this.mIsMaximumProtectionEnabled + ", Maximum threshold : " + i2 + " -> " + this.mMaximumThresholdValue);
        ...
        if (i3 != 8 && i4 == 8) {
            Slog.i("PowerUI.Notification", "Show slow charging toast");
            Context context2 = this.mContext;
            Toast.makeText(context2, context2.getString(R.string.battery_slow_charging_toast_text), 0).show();
            turnOnScreen();
            return;
        }
        if (i3 == 9 || i4 != 9) {
        ...
        if (this.mSlowByChargerConnectionInfoDialog == null) {
            ...
            popupDialog.setOnDismissListener(new SecPowerNotificationWarnings$$ExternalSyntheticLambda3(this, 3));
    ...
    public final void showUnintentionalLcdOnNotice() {
        ...
        EmergencyButtonController$$ExternalSyntheticOutline0.m("showUnintentionallyLcdOnNotice() - isLock ? ", "PowerUI.Notification", z);
        synchronized (this) {
            try {
                if (this.mIsUnintentionalPopupShowing) {
                    return;
                ...
                if (this.mWindowManager == null || this.mUnintentionalLcdOnWindow == null) {
                    ...
                    if (z2) {
                        Context subDisplayContext = DisplayUtils.getSubDisplayContext(this.mContext);
    ...
    public final void showUsbDamageProtectionAlertDialog() {
        ...
        if (this.mUsbDamageProtectionAlertDialog == null) {
            ...
            popupDialog.setOnDismissListener(new SecPowerNotificationWarnings$$ExternalSyntheticLambda3(this, 0));
            this.mUsbDamageProtectionAlertDialog.show();
            this.mUsbDamageProtectionAlertDialog.getButton(-1).setOnClickListener(new SecPowerNotificationWarnings$$ExternalSyntheticLambda4(this, 0));
            turnOnScreen();
        }
        playPowerSound(7);
    ...
    public final void showWaterProtectionAlertDialog(boolean z) {
        ...
        if (this.mWaterProtectionAlertDialog == null) {
            ...
            popupDialog.setOnDismissListener(new SecPowerNotificationWarnings$$ExternalSyntheticLambda3(this, 1));
            this.mWaterProtectionAlertDialog.show();
            if (this.mIsHiccupState) {
                this.mWaterProtectionAlertDialog.getButton(-1).setOnClickListener(new SecPowerNotificationWarnings$$ExternalSyntheticLambda4(this, 1));
            }
            turnOnScreen();
        }
        playPowerSound(6);
    ...
    public final void showWirelessChargerDisconnectNotice() {
        if (this.mFTAMode) {
            Log.d("PowerUI.Notification", "FTA Mode is ON so don't show Wireless charging disconnect warning");
        } else {
            Toast.makeText(this.mContext, DeviceType.isTablet() ? this.mContext.getString(R.string.battery_wireless_charging_disconnect_by_high_temperature_text_tablet) : this.mContext.getString(R.string.battery_wireless_charging_disconnect_by_high_temperature_text), 0).show();
            Slog.d("PowerUI.Notification", "showWirelessChargerDisconnectToast()");
        }
    }
