...
public final class BatteryStateData {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.batteryStatus) + ReorderTile$$ExternalSyntheticOutline0.m(this.bucket, TransitionData$$ExternalSyntheticOutline0.m(Integer.hashCode(this.batteryLevel) * 31, 31, this.plugged), 31);
    }
