...
public final class BatteryStateSnapshot {
    ...
    public final int hashCode() {
        return Boolean.hashCode(this.isLowWarningEnabled) + TransitionData$$ExternalSyntheticOutline0.m(MoveResult$$ExternalSyntheticOutline0.m(MoveResult$$ExternalSyntheticOutline0.m(MoveResult$$ExternalSyntheticOutline0.m(MoveResult$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.lowLevelThreshold, ReorderTile$$ExternalSyntheticOutline0.m(this.severeLevelThreshold, ReorderTile$$ExternalSyntheticOutline0.m(this.batteryStatus, ReorderTile$$ExternalSyntheticOutline0.m(this.bucket, TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(Integer.hashCode(this.batteryLevel) * 31, 31, this.isPowerSaver), 31, this.plugged), 31), 31), 31), 31), 31, this.timeRemainingMillis), 31, this.averageTimeToDischargeMillis), 31, this.severeThresholdMillis), 31, this.lowThresholdMillis), 31, this.isBasedOnUsage);
    }
    ...
    public final String toString() {
        ...
        return MoveResult$$ExternalSyntheticOutline0.m(sb, this.isLowWarningEnabled, ")");
    }
