...
public class OptimizationChargingNotification extends PowerUiNotification {
    ...
    public final Notification.Builder getBuilder() {
        ...
        return getCommonBuilder(NotificationChannels.CHARGING, this.mContext.getString(R.string.battery_protection_noti_title), this.mContext.getString(R.string.opt_charging_noti_content, this.mFinishTime)).setSmallIcon(R.drawable.stat_notify_battery_protection).setGroup("CHARGING").setOnlyAlertOnce(true).setContentIntent(PowerUtils.pendingBroadcast(this.mContext, "PNW.batteryInfo")).setOngoing(true).addExtras(bundle).setCategory("sys").addAction(new Notification.Action.Builder((Icon) null, this.mContext.getString(R.string.opt_charging_noti_btn_text), PendingIntent.getBroadcastAsUser(this.mContext, 0, new Intent("com.samsung.android.sm.ACTION_OPTIMIZED_CHARGING_NOTI_DISMISSED").setPackage("android").setFlags(268435456), 67108864, UserHandle.OWNER)).build());
    }
