...
public class BatterySwellingNotification extends PowerUiNotification {
    ...
    public final Notification.Builder getBuilder() {
        ...
        return getCommonBuilder(NotificationChannels.CHARGING, this.mContext.getString(R.string.battery_swelling_mode_noti_title), getContentText()).setSmallIcon(R.drawable.ic_charging_noti).setGroup("CHARGING").setOnlyAlertOnce(true).setOngoing(true).addExtras(bundle).setPriority(-2).setCategory("sys");
    }
