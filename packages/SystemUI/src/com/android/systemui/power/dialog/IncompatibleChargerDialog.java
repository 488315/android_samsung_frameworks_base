...
public class IncompatibleChargerDialog extends PowerUiDialog {
    ...
    public final AlertDialog getDialog() {
        ...
        ((TextView) viewInflate.findViewById(R.id.notice_text)).setText(DeviceType.isTablet() ? this.mContext.getString(R.string.incompatible_charger_dialog_text_for_tablet) : this.mContext.getString(R.string.incompatible_charger_dialog_text));
