...
public class BatterySwellingLowTempDialog extends PowerUiDialog {
    ...
    public final AlertDialog getDialog() {
        ...
        ((TextView) viewInflate.findViewById(R.id.notice_text)).setText((DeviceType.isTablet() ? this.mContext.getString(R.string.battery_swelling_mode_low_temp_popup_text_tablet) : this.mContext.getString(R.string.battery_swelling_mode_low_temp_popup_text)) + "\n\n");
