...
final class BrightnessSliderKt$BrightnessSliderContainer$4$5$1$1 extends SuspendLambda implements Function2 {
    ...
    public BrightnessSliderKt$BrightnessSliderContainer$4$5$1$1(BrightnessSliderViewModel brightnessSliderViewModel, int i, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new BrightnessSliderKt$BrightnessSliderContainer$4$5$1$1(this.$viewModel, this.$it, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((BrightnessSliderKt$BrightnessSliderContainer$4$5$1$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
