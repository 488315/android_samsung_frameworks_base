...
import com.android.systemui.charging.WiredChargingRippleController.ChargingRippleCommand;
...
public final class WiredChargingRippleController {
        ...
        public final void execute(PrintWriter printWriter, List list) {
            ...
            rippleView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.android.systemui.charging.WiredChargingRippleController$startRipple$1
                ...
                public final void onViewAttachedToWindow(View view) {
                    ...
                    float fMax = Integer.max(iWidth, iHeight) * 2.0f;
                    ...
                    rippleSize.getClass();
                    rippleSize.setSizeAtProgresses(rippleSize.initialSize, new RippleShader.SizeAtProgress(1.0f, fMax, fMax));
                    ...
                    if (numValueOf != null && numValueOf.intValue() == 0) {
                        rippleView2.setCenter(iWidth * f2, iHeight * f);
                    } else if (numValueOf != null && numValueOf.intValue() == 1) {
                        rippleView2.setCenter(iWidth * f, (1 - f2) * iHeight);
                    } else if (numValueOf != null && numValueOf.intValue() == 2) {
                        float f3 = 1;
                        rippleView2.setCenter((f3 - f2) * iWidth, (f3 - f) * iHeight);
                    } else if (numValueOf != null && numValueOf.intValue() == 3) {
                        rippleView2.setCenter((1 - f) * iWidth, iHeight * f2);
                    }
                    final WiredChargingRippleController wiredChargingRippleController3 = wiredChargingRippleController;
                    wiredChargingRippleController3.rippleView.startRipple(new Runnable() { // from class: com.android.systemui.charging.WiredChargingRippleController$startRipple$1$onViewAttachedToWindow$1
                        ...
                        public final void run() {
                            WiredChargingRippleController wiredChargingRippleController4 = wiredChargingRippleController3;
                            wiredChargingRippleController4.windowManager.removeView(wiredChargingRippleController4.rippleView);
                        }
                    });
                    wiredChargingRippleController.rippleView.removeOnAttachStateChangeListener(this);
                }
    ...
    public WiredChargingRippleController(CommandRegistry commandRegistry, BatteryController batteryController, ConfigurationController configurationController, FeatureFlags featureFlags, Context context, WindowManager windowManager, SystemClock systemClock, UiEventLogger uiEventLogger) {
        ...
        commandRegistry.registerCommand("charging-ripple", new Function0() { // from class: com.android.systemui.charging.WiredChargingRippleController$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f$0.new ChargingRippleCommand();
            }
        });
