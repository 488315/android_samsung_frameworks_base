...
public class WirelessChargingAnimation {
    ...
    /* compiled from: qb/97869455 e70885ee4e20e40425471e4b47759369a50273352e1b7033cea52247075b3cbb */
    public class WirelessChargingView {
        ...
        /* JADX WARN: Type inference failed for: r8v10, types: [com.android.systemui.charging.WirelessChargingAnimation$WirelessChargingView$1] */
        public WirelessChargingView(Context context, Looper looper, int i, int i2, Callback callback, boolean z, RippleShader.RippleShape rippleShape, UiEventLogger uiEventLogger, WindowManager windowManager, WindowManagerProvider windowManagerProvider) {
            ...
            this.mHandler = new Handler(looper, null) { // from class: com.android.systemui.charging.WirelessChargingAnimation.WirelessChargingView.1
                ...
                public final void handleMessage(Message message) {
                    ...
                    if (wirelessChargingView.mView != wirelessChargingView.mNextView) {
                        ...
                        ((WindowManagerProviderImpl) wirelessChargingView.mWindowManagerProvider).getClass();
                        wirelessChargingView.mWM = WindowManagerUtils.getWindowManager(applicationContext);
    ...
    private WirelessChargingAnimation(Context context, Looper looper, int i, int i2, Callback callback, boolean z, RippleShader.RippleShape rippleShape, UiEventLogger uiEventLogger, WindowManager windowManager, WindowManagerProvider windowManagerProvider) {
        this.mCurrentWirelessChargingView = new WirelessChargingView(context, looper, i, i2, callback, z, rippleShape, uiEventLogger, windowManager, windowManagerProvider);
    }

    public static WirelessChargingAnimation makeWirelessChargingAnimation(Context context, int i, CentralSurfacesImpl.AnonymousClass7 anonymousClass7, RippleShader.RippleShape rippleShape, UiEventLogger uiEventLogger, WindowManager windowManager, WindowManagerProvider windowManagerProvider) {
        return new WirelessChargingAnimation(context, null, -1, i, anonymousClass7, false, rippleShape, uiEventLogger, windowManager, windowManagerProvider);
    }
}
