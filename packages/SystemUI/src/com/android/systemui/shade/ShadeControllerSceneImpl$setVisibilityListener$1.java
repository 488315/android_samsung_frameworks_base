        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.shade.ShadeControllerSceneImpl$setVisibilityListener$1.1
                ...
                final class C03041 extends SuspendLambda implements Function2 {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public C03041(ShadeController.ShadeVisibilityListener shadeVisibilityListener, boolean z, Continuation continuation) {
                        super(2, continuation);
                        this.$listener = shadeVisibilityListener;
                        this.$isVisible = z;
                    }
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation create(Object obj, Continuation continuation) {
                        return new C03041(this.$listener, this.$isVisible, continuation);
                    }

                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return ((C03041) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
                    }
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    Object withContext = BuildersKt.withContext(ShadeControllerSceneImpl.this.mainDispatcher, new C03041(shadeVisibilityListener, ((Boolean) obj2).booleanValue(), null), continuation);
