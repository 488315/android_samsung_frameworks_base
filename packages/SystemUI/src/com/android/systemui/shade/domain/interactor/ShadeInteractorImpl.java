...
public final class ShadeInteractorImpl implements ShadeInteractor, BaseShadeInteractor {
    ...
    public ShadeInteractorImpl(CoroutineScope coroutineScope, DeviceProvisioningInteractor deviceProvisioningInteractor, DisableFlagsInteractor disableFlagsInteractor, DozeParameters dozeParameters, KeyguardRepository keyguardRepository, KeyguardTransitionInteractor keyguardTransitionInteractor, PowerInteractor powerInteractor, UserSetupRepository userSetupRepository, UserSwitcherInteractor userSwitcherInteractor, BaseShadeInteractor baseShadeInteractor) {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        Boolean boolValueOf = Boolean.valueOf((((DisableFlagsModel) obj).disable2 & 4) == 0);
        ...
        this.isShadeEnabled = readonlyStateFlowStateIn;
        ...
        this.isShadeAnyExpanded = FlowKt.stateIn(new Flow() { // from class: com.android.systemui.shade.domain.interactor.ShadeInteractorImpl$special$$inlined$map$5
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = shadeExpansion2.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        }, coroutineScope, startedEagerly, bool);
        ...
        this.isShadeFullyCollapsed = FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.shade.domain.interactor.ShadeInteractorImpl$special$$inlined$map$6
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = shadeExpansion3.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        });
        ...
        Edge.StateToState stateToStateCreate$default = Edge.Companion.create$default(Edge.Companion, null, KeyguardState.AOD, 1);
        String str = KeyguardTransitionInteractor.TAG;
        Flow flowIsInTransition = keyguardTransitionInteractor.isInTransition(stateToStateCreate$default, null);
        ...
        this.isShadeTouchable = FlowKt.combine(powerInteractor$special$$inlined$map$2, flowIsInTransition, new Flow() { // from class: com.android.systemui.shade.domain.interactor.ShadeInteractorImpl$special$$inlined$map$7
        ...
        this.isExpandToQsEnabled = FlowKt.combine(disableFlagsInteractor.disableFlags, readonlyStateFlowStateIn, keyguardRepositoryImpl.isDozing, ((UserSetupRepositoryImpl) userSetupRepository).isUserSetUp, deviceProvisioningInteractor.isDeviceProvisioned, new ShadeInteractorImpl$isExpandToQsEnabled$1(userSwitcherInteractor, null));
    }
