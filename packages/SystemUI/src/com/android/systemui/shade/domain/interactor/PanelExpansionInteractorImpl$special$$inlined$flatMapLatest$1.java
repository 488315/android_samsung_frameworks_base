    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (observableTransitionState instanceof ObservableTransitionState.Idle) {
                flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(new Float(Intrinsics.areEqual(((ObservableTransitionState.Idle) observableTransitionState).currentScene, Scenes.Gone) ? 0.0f : 1.0f));
            } else {
                ...
                SceneKey sceneKey = transition.fromScene;
                ...
                if (areEqual) {
                    ...
                    flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = (Intrinsics.areEqual(sceneKey3, Scenes.Shade) || Intrinsics.areEqual(sceneKey3, Scenes.QuickSettings)) ? flow : new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(new Float(1.0f));
                } else if (Intrinsics.areEqual(sceneKey3, sceneKey2)) {
                    this.this$0.getClass();
                    SceneKey sceneKey4 = Scenes.Shade;
                    SceneKey sceneKey5 = transition.fromScene;
                    flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = (Intrinsics.areEqual(sceneKey5, sceneKey4) || Intrinsics.areEqual(sceneKey5, Scenes.QuickSettings)) ? new Flow() { // from class: com.android.systemui.shade.domain.interactor.PanelExpansionInteractorImpl$legacyPanelExpansion$lambda$1$$inlined$map$1
                    ...
                    } : new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(new Float(0.0f));
                } else {
