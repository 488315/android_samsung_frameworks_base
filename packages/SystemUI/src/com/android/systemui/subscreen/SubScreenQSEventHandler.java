...
public class SubScreenQSEventHandler implements PanelScreenShotLogger.LogProvider {
    ...
    private final SysUiState.SysUiStateCallback mSysUiStateCallback = new SysUiState.SysUiStateCallback() { // from class: com.android.systemui.subscreen.SubScreenQSEventHandler.4
        ...
        public final void onSystemUiStateChanged(int i, long j) {
            SubScreenQSEventHandler.this.mIsNaviBarShowing = (j & 1099511627776L) == 0;
        }
    };
    ...
    private final OnBackAnimationCallback mOnBackInvokedCallback = new OnBackAnimationCallback() { // from class: com.android.systemui.subscreen.SubScreenQSEventHandler.7
    ...
    private final ConfigurationController mConfigurationController = (ConfigurationController) Dependency.sDependency.getDependencyInner(ConfigurationController.class);
    ...
    */
    ...
    private void receiveInputEvent(Context context) {
        ...
        this.mInputEventReceiver = new BatchedInputEventReceiver(this.mInputMonitor.getInputChannel(), Looper.myLooper(), Choreographer.getInstance()) { // from class: com.android.systemui.subscreen.SubScreenQSEventHandler.8
    ...
    private void unregisterEvents() {
        ...
        ((SysUiStateImpl) sysUiState).stateDispatcher.listeners.remove(this.mSysUiStateCallback);
