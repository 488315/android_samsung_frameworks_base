...
public class SubScreenManager implements PluginListener, ScreenLifecycle.Observer, DisplayLifecycle.Observer, Dumpable, WakefulnessLifecycle.Observer {
    ...
    public final SubScreenLogger mSubScreenLogger;
    ...
    public final KeyguardUpdateMonitorCallback mCallback = new KeyguardUpdateMonitorCallback() { // from class: com.android.systemui.subscreen.SubScreenManager.1
        ...
        public final void onLockDisabledChanged(boolean z) {
            ...
            if (subScreenManager.mSubScreenPlugin == null) {
                ...
                EmergencyButtonController$$ExternalSyntheticOutline0.m("onLockDisabledChanged() ", "SubScreenManager", z);
    ...
    public final AnonymousClass2 mKeyguardStateCallback = new KeyguardStateController.Callback() { // from class: com.android.systemui.subscreen.SubScreenManager.2
        ...
        public final void onKeyguardShowingChanged() {
            ...
            if (subScreenManager.mSubScreenPlugin == null) {
                ...
                EmergencyButtonController$$ExternalSyntheticOutline0.m("onKeyguardShowingChanged() ", "SubScreenManager", z);
        ...
        public final void onUnlockedChanged() {
            ...
            if (subScreenManager.mSubScreenPlugin == null) {
                ...
                EmergencyButtonController$$ExternalSyntheticOutline0.m("onUnlockedChanged() ", "SubScreenManager", z);
    ...
    public class AnonymousClass4 implements DeviceStateManager.DeviceStateCallback {
        ...
        public final void onDeviceStateChanged(DeviceState deviceState) {
            ...
            if (deviceState.getIdentifier() != 0) {
                int i = SubScreenManager.this.mDeviceState;
                if (i != 4 && i != -1 && deviceState.getIdentifier() == 3) {
                    SubScreenManager subScreenManager = SubScreenManager.this;
                    if (subScreenManager.mSubDisplay != null && subScreenManager.mActivity != null && subScreenManager.isTurnOnWhenUnFolding() && SubScreenManager.this.mKeyguardUpdateMonitor.isUserUnlocked$1()) {
                        ...
                        SubScreenManager.this.mBackgroundExecutor.executeDelayed(new SubScreenManager$$ExternalSyntheticLambda0(this, 3), 100L);
                    }
                }
    ...
    public SubScreenManager(Context context, ScreenLifecycle screenLifecycle, DisplayLifecycle displayLifecycle, DisplayManager displayManager, KeyguardUpdateMonitor keyguardUpdateMonitor, Lazy lazy, Lazy lazy2, PluginManager pluginManager, DelayableExecutor delayableExecutor, DumpManager dumpManager, WakefulnessLifecycle wakefulnessLifecycle, Lazy lazy3, KeyguardStateController keyguardStateController, ActivityManager activityManager, KeyguardManager keyguardManager, DeviceStateManager deviceStateManager, NotifPipeline notifPipeline, DismissCallbackRegistry dismissCallbackRegistry, TaskStackChangeListeners taskStackChangeListeners, KeyguardInteractor keyguardInteractor, JavaAdapter javaAdapter, SubScreenLogger subScreenLogger) {
        ...
        javaAdapter.alwaysCollectFlow(keyguardInteractor.dozeTimeTick, new SubScreenManager$$ExternalSyntheticLambda1(this, 0));
        this.mSubScreenLogger = subScreenLogger;
        this.mHandler = new Handler(Looper.getMainLooper()) { // from class: com.android.systemui.subscreen.SubScreenManager.5
    ...
    public static String getRoomName$1(int i) {
        switch (i) {
            ...
            case 302:
            default:
                return ParcelableSnapshotMutableState$Companion$CREATOR$1$$ExternalSyntheticOutline0.m(i, "INVALID TYPE [", "]");
            case 303:
    ...
    public final void addPluginListener$2() {
        boolean z = this.mIsPluginConnected;
        SubScreenLogger subScreenLogger = this.mSubScreenLogger;
        if (z) {
            subScreenLogger.debug("addPluginListener() already connected");
            return;
        }
        subScreenLogger.info("addPluginListener() ");
                ...
                if (!z) {
                    ...
                    if (runningTasks != null && !runningTasks.isEmpty()) {
                        ...
                        if (componentName2 != null) {
                            moveToFrontCoverLauncherTask(componentName2.getClassName());
                        }
                    }
                } else if (LsRune.SUBSCREEN_LARGE_FRONT_SUB_DISPLAY) {
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        return this.mSubScreenPlugin.dispatchKeyEvent(keyEvent);
    }
    ...
    public final void moveToFrontCoverLauncherTask(String str) {
        if ("com.android.systemui.subscreen.SubHomeActivity".equals(str)) {
            if (!this.mTaskStack.isEmpty() && ((ActivityManager.RunningTaskInfo) this.mTaskStack.getFirst()).topActivity != null) {
                ComponentName componentName = ((ActivityManager.RunningTaskInfo) this.mTaskStack.getFirst()).topActivity;
                Objects.requireNonNull(componentName);
                if (!SubScreenComponentChecker.isCellBroadCastAlertDialog(componentName)) {
    ...
    public final void onFolderStateChanged(boolean z) {
        EmergencyButtonController$$ExternalSyntheticOutline0.m("onFolderStateChanged() opened = ", "SubScreenManager", z);
    ...
    public final boolean onPluginAttached(PluginLifecycleManager pluginLifecycleManager) {
        final SubScreenLogger subScreenLogger = this.mSubScreenLogger;
        subScreenLogger.info("onPluginAttached()");
        pluginLifecycleManager.setLogFunc(new BiConsumer() { // from class: com.android.systemui.subscreen.SubScreenManager$$ExternalSyntheticLambda2
            ...
            public final void accept(Object obj, Object obj2) {
                ...
                Log.i(str, str2);
                LogBuffer.log$default(subScreenLogger2.buffer, "SubScreenLog", LogLevel.INFO, AnimatorInflaterCompat$$ExternalSyntheticOutline0.m("[", str, "] : ", str2));
            }
        });
        return super.onPluginAttached(pluginLifecycleManager);
    }
    ...
    public final void onPluginConnected(Plugin plugin, Context context) {
        ...
        SubScreenLogger subScreenLogger = this.mSubScreenLogger;
        subScreenLogger.info("onPluginConnected() [" + pluginSubScreen + "]");
        ...
        if (window$1 == null) {
            subScreenLogger.warn("startSubScreen() no window");
            return;
        }
        subScreenLogger.info("startSubScreen() " + pluginSubScreen);
    ...
    public final void onPluginDetached(PluginLifecycleManager pluginLifecycleManager) {
        super.onPluginDetached(pluginLifecycleManager);
        this.mSubScreenLogger.info("onPluginDetached()");
    }

    @Override // com.android.systemui.plugins.PluginListener
    public final void onPluginDisconnected(Plugin plugin) {
        this.mSubScreenLogger.info("onPluginDisconnected() [" + ((PluginSubScreen) plugin) + "]");
        stopSubScreen();
    }

    @Override // com.android.systemui.plugins.PluginListener
    public final void onPluginLoaded(Plugin plugin, Context context, PluginLifecycleManager pluginLifecycleManager) {
        super.onPluginLoaded((PluginSubScreen) plugin, context, pluginLifecycleManager);
        this.mSubScreenLogger.info("onPluginLoaded");
    }

    @Override // com.android.systemui.plugins.PluginListener
    public final void onPluginUnloaded(Plugin plugin, PluginLifecycleManager pluginLifecycleManager) {
        super.onPluginUnloaded((PluginSubScreen) plugin, pluginLifecycleManager);
        this.mSubScreenLogger.info("onPluginUnloaded");
    }
    ...
    public final void onStartedWakingUp() throws SecurityException {
        ...
        if (LsRune.SUBSCREEN_LARGE_FRONT_SUB_DISPLAY && !this.mIsFolderOpened) {
            int i = this.mWakefulnessLifeCycle.mLastWakeReason;
            if (i == 2) {
                ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(i, " onStartedWakingUp wake up reason  ", "SubScreenManager");
            } else {
                List<ActivityManager.RunningTaskInfo> runningTasks = this.mActivityManager.getRunningTasks(1);
    ...
    public final void requestDualState(boolean z) {
        AODAmbientWallpaperHelper$initAODAmbientWallpaperHelper$1$$ExternalSyntheticOutline0.m("requestDualState ", "SubScreenManager", z);
        try {
    ...
    public final void setSubHomeActivityResumed(boolean z) {
        ...
        AODAmbientWallpaperHelper$initAODAmbientWallpaperHelper$1$$ExternalSyntheticOutline0.m("setSubHomeActivityResumed() ", "SubScreenManager", z);
    ...
    public final void updatePluginListener$1() {
        String str = "updatePluginListener() mIsPluginConnected = " + this.mIsPluginConnected;
        SubScreenLogger subScreenLogger = this.mSubScreenLogger;
        subScreenLogger.info(str);
        boolean z = this.mIsPluginConnected;
        if (z) {
            if (z) {
                subScreenLogger.info("removePluginListener() ");
                this.mPluginManager.removePluginListener(this);
                this.mIsPluginConnected = false;
            } else {
                subScreenLogger.debug("removePluginListener() already disconnected");
            }
        }
        if (SafeUIState.isSysUiSafeModeEnabled()) {
            subScreenLogger.info("Do not plug in connection in safe mode");
            return;
        }
        if (DeviceType.isFactoryBinary()) {
            subScreenLogger.info("Do not plug in connection in factory mode");
            return;
        }
        if (this.mActivity == null && this.mPresentation == null) {
            subScreenLogger.debug("requestPluginConnection() no activity and no presentation");
        } else if (((PluginFaceWidgetManager) this.mFaceWidgetManagerLazy.get()).mIsConnected) {
            addPluginListener$2();
        } else {
            subScreenLogger.warn("requestPluginConnection() PluginFaceWidget is not connected, wait connection");
