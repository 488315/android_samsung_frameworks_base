...
public final class UnfoldLightRevealOverlayAnimation implements FullscreenLightRevealAnimation {
    ...
    public final class TransitionListener implements UnfoldTransitionProgressProvider.TransitionProgressListener {
        ...
        public final void onTransitionFinished() {
            ...
            Function0 function0 = new Function0() { // from class: com.android.systemui.unfold.UnfoldLightRevealOverlayAnimation$TransitionListener$$ExternalSyntheticLambda0
        ...
        public final void onTransitionProgress(final float f) {
            final UnfoldLightRevealOverlayAnimation unfoldLightRevealOverlayAnimation = UnfoldLightRevealOverlayAnimation.this;
            Function0 function0 = new Function0() { // from class: com.android.systemui.unfold.UnfoldLightRevealOverlayAnimation$TransitionListener$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    int i = UnfoldLightRevealOverlayAnimation.$r8$clinit;
        ...
        executeInBackground(new Function0() { // from class: com.android.systemui.unfold.UnfoldLightRevealOverlayAnimation$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                ...
                try {
                    ...
                    if (unfoldLightRevealOverlayAnimation.isUnfoldHandled) {
                        throw null;
                    }
                    ScaleAwareTransitionProgressProvider.Companion companion = ScaleAwareTransitionProgressProvider.Companion;
                    ContentResolver contentResolver = unfoldLightRevealOverlayAnimation.contentResolver;
                    companion.getClass();
                    if (!ScaleAwareTransitionProgressProvider.Companion.areAnimationsEnabled(contentResolver)) {
                        throw null;
                    }
                    unfoldLightRevealOverlayAnimation.overlayAddReason = UnfoldLightRevealOverlayAnimation.AddOverlayReason.UNFOLD;
                    unfoldLightRevealOverlayAnimation.calculateRevealAmount(null);
                    throw null;
                } catch (Throwable th) {
                    Trace.endSection();
                    throw th;
