...
final class DisplaySwitchLatencyTracker$waitForDisplaySwitch$3 extends SuspendLambda implements Function1 {
    ...
    public final Continuation create(Continuation continuation) {
        return new DisplaySwitchLatencyTracker$waitForDisplaySwitch$3(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        return ((DisplaySwitchLatencyTracker$waitForDisplaySwitch$3) create((Continuation) obj)).invokeSuspend(Unit.INSTANCE);
    }
