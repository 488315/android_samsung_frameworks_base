...
final class UnfoldTraceLogger$start$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow foldUpdate = ((FoldStateRepositoryImpl) this.this$0.foldStateRepository).getFoldUpdate();
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.unfold.UnfoldTraceLogger$start$1.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    TraceStateLogger.this.log(((FoldStateRepository.FoldUpdate) obj2).name());
