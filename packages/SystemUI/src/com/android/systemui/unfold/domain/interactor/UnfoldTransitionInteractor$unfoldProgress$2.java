...
final class UnfoldTransitionInteractor$unfoldProgress$2 extends SuspendLambda implements Function2 {
    ...
    public UnfoldTransitionInteractor$unfoldProgress$2(Continuation continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        UnfoldTransitionInteractor$unfoldProgress$2 unfoldTransitionInteractor$unfoldProgress$2 = new UnfoldTransitionInteractor$unfoldProgress$2(continuation);
