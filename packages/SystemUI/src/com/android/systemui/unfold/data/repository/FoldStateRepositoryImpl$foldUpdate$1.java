...
final class FoldStateRepositoryImpl$foldUpdate$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FoldStateProvider.FoldUpdatesListener foldUpdatesListener = new FoldStateProvider.FoldUpdatesListener() { // from class: com.android.systemui.unfold.data.repository.FoldStateRepositoryImpl$foldUpdate$1$callback$1
                ...
                public final void onFoldUpdate(int i2) {
                    ...
                    ((ChannelCoroutine) ProducerScope.this).mo3456trySendJP2dKIU(foldUpdate);
                }
            };
            ((DeviceFoldStateProvider) this.this$0.foldStateProvider).addCallback(foldUpdatesListener);
            FoldStateRepositoryImpl$foldUpdate$1$$ExternalSyntheticLambda0 foldStateRepositoryImpl$foldUpdate$1$$ExternalSyntheticLambda0 = new FoldStateRepositoryImpl$foldUpdate$1$$ExternalSyntheticLambda0(this.this$0, foldUpdatesListener, 0);
            this.label = 1;
