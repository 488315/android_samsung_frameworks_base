...
public final class SubscreenQSHostAdapter implements QSHost {
    ...
    public SubscreenQSHostAdapter(CurrentTilesInteractor currentTilesInteractor, Context context, CoroutineScope coroutineScope, DumpManager dumpManager, TileFeatureChecker tileFeatureChecker) {
        this.interactor = currentTilesInteractor;
        this.context = context;
        this.scope = coroutineScope;
        this.tileFeatureChecker = tileFeatureChecker;
        dumpManager.registerNormalDumpable("SubscreenQSHost", currentTilesInteractor);
    }

    @Override // com.android.systemui.qs.QSHost
    public final void addCallback(QSHost.Callback callback) {
        StandaloneCoroutine standaloneCoroutineLaunch$default = BuildersKt.launch$default(this.scope, null, null, new SubscreenQSHostAdapter$addCallback$job$1(this, callback, null), 3);
