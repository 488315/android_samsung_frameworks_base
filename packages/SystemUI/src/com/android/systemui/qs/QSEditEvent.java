...
public final class QSEditEvent implements UiEventLogger.UiEventEnum {
    ...
    public static final QSEditEvent QS_EDIT_RESIZE_LARGE;
    public static final QSEditEvent QS_EDIT_RESIZE_SMALL;
    ...
    static {
        ...
        QSEditEvent qSEditEvent7 = new QSEditEvent("QS_EDIT_RESIZE_LARGE", 6, 2122);
        QS_EDIT_RESIZE_LARGE = qSEditEvent7;
        QSEditEvent qSEditEvent8 = new QSEditEvent("QS_EDIT_RESIZE_SMALL", 7, 2123);
        QS_EDIT_RESIZE_SMALL = qSEditEvent8;
        QSEditEvent[] qSEditEventArr = {qSEditEvent, qSEditEvent2, qSEditEvent3, qSEditEvent4, qSEditEvent5, qSEditEvent6, qSEditEvent7, qSEditEvent8};
