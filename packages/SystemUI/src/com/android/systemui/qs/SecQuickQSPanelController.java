...
public class SecQuickQSPanelController extends SecQSPanelControllerBase {
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [com.android.systemui.qs.SecQuickQSPanelController$1] */
    public SecQuickQSPanelController(SecQuickQSPanel secQuickQSPanel, QSHost qSHost, MetricsLogger metricsLogger, UiEventLogger uiEventLogger, QSLogger qSLogger, DumpManager dumpManager, QSPanelHost qSPanelHost, Provider provider, SecQSPanelResourcePicker secQSPanelResourcePicker, MediaHost mediaHost, SecQSDetailController secQSDetailController, SecPanelSplitHelper secPanelSplitHelper) {
        ...
        this.mPanelTransitionStateListener = new PanelTransitionStateListener() { // from class: com.android.systemui.qs.SecQuickQSPanelController.1
            ...
            public final void onPanelTransitionStateChanged(PanelTransitionStateChangeEvent panelTransitionStateChangeEvent) {
                ...
                secQuickQSPanelController.updateVisibility$6();
            }
        };
        this.mPanelSplitEnabled = SecPanelSplitHelper.isEnabled();
        BarController barController = (BarController) provider.get();
        ((SecQuickQSPanel) this.mView).mMeasuredHeightSupplier = new SecQuickQSPanelController$$ExternalSyntheticLambda0(this, barController);
    ...
    public final void updatePaddingAndMargins() {
        ...
        int qQSPanelStartEndPadding = secQSPanelResourcePickHelper.getTargetPicker().getQQSPanelStartEndPadding(i, context);
        if (this.mTileLayout != null) {
            int quickSettingExtraSidePadding = qQSPanelStartEndPadding - secQSPanelResourcePickHelper.getTargetPicker().getQuickSettingExtraSidePadding(context);
        ...
        if (view != null) {
            view.setPadding(qQSPanelStartEndPadding, view.getPaddingTop(), qQSPanelStartEndPadding, this.mBrightnessMediaDeviceBar.getPaddingBottom());
        }
    }
