        ...
        if (i == 0) {
            ...
            final ?? r1 = new FlashlightController.FlashlightListener() { // from class: com.android.systemui.qs.tiles.impl.flashlight.domain.interactor.FlashlightTileDataInteractor$tileData$1$callback$1
                ...
                public final void onFlashlightAvailabilityChanged(boolean z) {
                    ((ChannelCoroutine) ProducerScope.this).mo3456trySendJP2dKIU(z ? FlashlightTileModel.FlashlightAvailable.m2912boximpl(((FlashlightControllerImpl) flashlightTileDataInteractor.flashlightController).isEnabled()) : FlashlightTileModel.FlashlightTemporarilyUnavailable.INSTANCE);
                }

                @Override // com.android.systemui.statusbar.policy.FlashlightController.FlashlightListener
                public final void onFlashlightChanged(boolean z) {
                    ((ChannelCoroutine) ProducerScope.this).mo3456trySendJP2dKIU(FlashlightTileModel.FlashlightAvailable.m2912boximpl(z));
                }

                @Override // com.android.systemui.statusbar.policy.FlashlightController.FlashlightListener
                public final void onFlashlightError() {
                    ((ChannelCoroutine) ProducerScope.this).mo3456trySendJP2dKIU(FlashlightTileModel.FlashlightAvailable.m2912boximpl(false));
                }
            };
