    ...
    public final Object mo781invoke(Object obj) {
        ...
        switch (this.$r8$classId) {
            ...
            case 5:
                ...
                return KeyguardSecUpdateMonitorImpl$$ExternalSyntheticOutline0.m(SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("tile ", str13, ": statusBarState=", string, ", hasState="), logMessage.getBool1(), ", hasData=", logMessage.getBool2());
            case 6:
                int i7 = QSTileLogger.$r8$clinit;
                String str14 = logMessage.getStr1();
                String string2 = StatusBarState.toString(logMessage.getInt1());
                return MutablePreferences$$ExternalSyntheticOutline0.m(SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("tile ", str14, " pipeline: statusBarState=", string2, ", state="), logMessage.getStr2(), ", data=", logMessage.getStr3());
            case 7:
