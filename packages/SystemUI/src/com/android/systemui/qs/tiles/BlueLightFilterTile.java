...
public class BlueLightFilterTile extends SQSTileImpl {
    ...
    public final void sendIntent(int i) {
        if (this.DEBUG) {
            Log.d(this.TAG, ParcelableSnapshotMutableState$Companion$CREATOR$1$$ExternalSyntheticOutline0.m(i, "sendIntent( key:", " ) BLUE_LIGHT_SETTING"));
        }
    ...
    public final void setMode(boolean z) {
        Log.d(this.TAG, KeyguardUpdateMonitorLogger$$ExternalSyntheticOutline0.m("setMode : ", z));
