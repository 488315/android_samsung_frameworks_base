...
public class OneHandedModeTile extends QSTileImpl {
    public QSTile.Icon mIcon;
    public final AnonymousClass1 mSetting;

    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.qs.tiles.OneHandedModeTile$1] */
    ...
    public final void handleUpdateState(QSTile.State state, Object obj) {
        ...
        if (this.mIcon == null) {
            ...
            this.mIcon = QSTileImpl.ResourceIcon.get(android.R.drawable.jog_dial_arrow_short_left);
        }
        booleanState.value = (obj instanceof Integer ? ((Integer) obj).intValue() : getValue()) != 0;
        String string = this.mContext.getString(R.string.quick_settings_onehanded_label);
