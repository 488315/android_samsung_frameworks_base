...
public class SyncTile extends SQSTileImpl {
    ...
    public final void handleClick(final Expandable expandable) {
        ...
        boolean masterSyncAutomaticallyAsUser = ContentResolver.getMasterSyncAutomaticallyAsUser(ActivityManager.getCurrentUser());
        final boolean z2 = masterSyncAutomaticallyAsUser ^ true;
        ...
        if (systemUIDialog == null || !systemUIDialog.isShowing()) {
            ...
            this.mAlertDialog.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: com.android.systemui.qs.tiles.SyncTile$$ExternalSyntheticLambda1
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    syncTile.mAlertDialog.sendAnnouncementEvent(syncTile.mContext.getString(z3 ? R.string.accessibility_desc_on : R.string.accessibility_desc_off));
                }
            });
