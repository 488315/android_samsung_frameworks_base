...
import com.android.systemui.qs.tiles.dialog.WifiStateWorker$$ExternalSyntheticLambda1;
...
public class InternetTile extends QSTileImpl {
    ...
    public final class CellularCallbackInfo {
        ...
        public /* synthetic */ CellularCallbackInfo(int i) {
            this();
        }
        ...
        public final String toString() {
            ...
            return BoundsAnimationElement$$ExternalSyntheticOutline0.m(sb, this.mNoNetworksAvailable, ']');
        }
    ...
    public final class EthernetCallbackInfo {
        ...
        public /* synthetic */ EthernetCallbackInfo(int i) {
            this();
        }
    ...
    public final class InternetSignalCallback implements SignalCallback {
        ...
        public final WifiCallbackInfo mWifiInfo;

        public InternetSignalCallback() {
            int i = 0;
            this.mWifiInfo = new WifiCallbackInfo(i);
            this.mCellularInfo = new CellularCallbackInfo(i);
            this.mEthernetInfo = new EthernetCallbackInfo(i);
        }
        ...
        public final void setConnectivityStatus(boolean z, boolean z2, boolean z3) {
            ...
            Intent intent = InternetTile.WIFI_SETTINGS;
            if (internetTile.DEBUG) {
                ActionBarContextView$$ExternalSyntheticOutline0.m(EmergencyButtonController$$ExternalSyntheticOutline0.m("setConnectivityStatus: noDefaultNetwork = ", ",noValidatedNetwork = ", ",noNetworksAvailable = ", z, z2), z3, internetTile.TAG);
            }
        ...
        public final void setEthernetIndicators(IconState iconState) {
            ...
            Intent intent = InternetTile.WIFI_SETTINGS;
            if (internetTile.DEBUG) {
                ExifInterface$$ExternalSyntheticOutline0.m(new StringBuilder("setEthernetIndicators: icon = "), iconState == null ? "" : iconState.toString(), internetTile.TAG);
            }
        ...
        public final void setIsAirplaneMode(IconState iconState) {
            ...
            Intent intent = InternetTile.WIFI_SETTINGS;
            if (internetTile.DEBUG) {
                ExifInterface$$ExternalSyntheticOutline0.m(new StringBuilder("setIsAirplaneMode: icon = "), iconState == null ? "" : iconState.toString(), internetTile.TAG);
            }
            CellularCallbackInfo cellularCallbackInfo = this.mCellularInfo;
        ...
        public final void setNoSims(boolean z, boolean z2) {
            ...
            Intent intent = InternetTile.WIFI_SETTINGS;
            if (internetTile.DEBUG) {
                KeyguardKnoxGuardViewController$$ExternalSyntheticOutline0.m("setNoSims: show = ", ",simDetected = ", internetTile.TAG, z, z2);
            }
            synchronized (this.mCellularInfo) {
                try {
                    CellularCallbackInfo cellularCallbackInfo = this.mCellularInfo;
    ...
    public final class WifiCallbackInfo {
        ...
        public /* synthetic */ WifiCallbackInfo(int i) {
            this();
        }
    ...
    public InternetTile(QSHost qSHost, QsEventLogger qsEventLogger, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, NetworkController networkController, AccessPointController accessPointController, InternetDialogManager internetDialogManager, WifiStateWorker wifiStateWorker) {
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        printWriter.print("    ");
        printWriter.println(((QSTile.BooleanState) getState()).toString());
        printWriter.print("    ");
    ...
    public final void handleSecondaryClick(Expandable expandable) {
        WifiStateWorker wifiStateWorker = this.mWifiStateWorker;
    ...
    */
    ...
    public final void handleUpdateEthernetState(QSTile.BooleanState booleanState, EthernetCallbackInfo ethernetCallbackInfo) {
        ...
        if (ethernetCallbackInfo.mConnected) {
            ...
            booleanState.state = 2;
            int i = ethernetCallbackInfo.mEthernetSignalIconId;
            int i2 = QsInCompose.$r8$clinit;
    ...
    public final void handleUpdateState(QSTile.State state, Object obj) {
        ...
        if (obj instanceof CellularCallbackInfo) {
            ...
            CellularCallbackInfo cellularCallbackInfo2 = new CellularCallbackInfo(i2);
            synchronized (cellularCallbackInfo) {
        ...
        if (obj instanceof WifiCallbackInfo) {
            ...
            WifiCallbackInfo wifiCallbackInfo2 = new WifiCallbackInfo(i2);
        ...
        if (obj instanceof EthernetCallbackInfo) {
            ...
            EthernetCallbackInfo ethernetCallbackInfo2 = new EthernetCallbackInfo(i2);
        ...
        int i3 = this.mLastTileState;
        if (i3 == 0) {
            CellularCallbackInfo cellularCallbackInfo3 = new CellularCallbackInfo(i2);
        ...
        if (i3 == 1) {
            WifiCallbackInfo wifiCallbackInfo3 = new WifiCallbackInfo(i2);
        ...
        if (i3 == 2) {
            EthernetCallbackInfo ethernetCallbackInfo3 = new EthernetCallbackInfo(i2);
    ...
    public final void handleUpdateWifiState(QSTile.BooleanState booleanState, WifiCallbackInfo wifiCallbackInfo) {
        ...
        if (wifiCallbackInfo.mAirplaneModeEnabled) {
            if (!booleanState.value) {
                ...
                int i2 = wifiCallbackInfo.mWifiSignalIconId;
                int i3 = QsInCompose.$r8$clinit;
            ...
            if (wifiCallbackInfo.mNoNetworksAvailable || !wifiCallbackInfo.mEnabled) {
                int i5 = QsInCompose.$r8$clinit;
                booleanState.icon = QSTileImpl.ResourceIcon.get(R.drawable.ic_qs_no_internet_unavailable);
                booleanState.secondaryLabel = resources.getString(R.string.quick_settings_networks_unavailable);
            } else {
                int i6 = QsInCompose.$r8$clinit;
                booleanState.icon = QSTileImpl.ResourceIcon.get(R.drawable.ic_qs_no_internet_available);
                booleanState.secondaryLabel = resources.getString(R.string.quick_settings_networks_available);
            }
        } else if (wifiCallbackInfo.mIsTransient) {
            int i7 = QsInCompose.$r8$clinit;
            booleanState.icon = QSTileImpl.ResourceIcon.get(android.R.drawable.jog_tab_right_confirm_red);
        } else if (!booleanState.value) {
            booleanState.state = 1;
            int i8 = QsInCompose.$r8$clinit;
            booleanState.icon = QSTileImpl.ResourceIcon.get(android.R.drawable.list_selector_background_disabled);
        } else if (z3) {
            int i9 = wifiCallbackInfo.mWifiSignalIconId;
            int i10 = QsInCompose.$r8$clinit;
            booleanState.icon = QSTileImpl.ResourceIcon.get(i9);
        } else if (z2) {
            int i11 = QsInCompose.$r8$clinit;
            booleanState.icon = QSTileImpl.ResourceIcon.get(android.R.drawable.list_selector_background_disabled);
        } else {
            int i12 = QsInCompose.$r8$clinit;
            booleanState.icon = QSTileImpl.ResourceIcon.get(android.R.drawable.list_selector_background_disabled);
        }
    ...
    public final boolean isAvailable() {
        ...
        return ((NetworkControllerImpl) this.mController).mHasMobileDataFeature && this.mHost.getUserContext().getUserId() == 0;
    }
