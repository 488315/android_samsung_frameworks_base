...
public class FlashlightTile extends SQSTileImpl implements FlashlightController.FlashlightListener {
    ...
    /* JADX WARN: Type inference failed for: r10v1, types: [android.content.BroadcastReceiver, com.android.systemui.qs.tiles.FlashlightTile$1] */
    public FlashlightTile(QSHost qSHost, QsEventLogger qsEventLogger, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, FlashlightController flashlightController, SettingsHelper settingsHelper, BroadcastDispatcher broadcastDispatcher, DisplayLifecycle displayLifecycle) {
        ...
        ?? r10 = new BroadcastReceiver() { // from class: com.android.systemui.qs.tiles.FlashlightTile.1
        ...
        broadcastDispatcher.registerReceiver(intentFilter, r10);
    ...
    public final void handleClick(final Expandable expandable) {
        ...
        SubroomFlashLightSettingsActivity subroomFlashLightSettingsActivity;
        ...
        if ((flashlightController == null || !((FlashlightControllerImpl) flashlightController).isEnabled()) && ((subroomFlashLightSettingsActivity = subscreenFlashLightController.mFlashLightPresentationView) == null || subroomFlashLightSettingsActivity.getActivityState() == 0)) {
    ...
    public final void handleSecondaryClick(Expandable expandable) {
        ...
        if (this.mIsLowBattery) {
            showWarningMessage(this.mContext.getString(R.string.flash_light_disabled_by_low_battery));
        } else if (QpRune.QUICK_TILE_FLASHLIGHT_INTENSITY && secFlashlightControllerImpl.isTorchStrengthControllable()) {
            showDetail$1(true);
        } else {
            Log.d(this.TAG, "handleSecondaryClick: torch strength change is not supported");
