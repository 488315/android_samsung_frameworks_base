...
public final class UiModeNightTileModel {
    ...
    public final int hashCode() {
        return this.customNightModeStart.hashCode() + ((this.customNightModeEnd.hashCode() + TransitionData$$ExternalSyntheticOutline0.m(ReorderTile$$ExternalSyntheticOutline0.m(this.nightModeCustomType, TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(TransitionData$$ExternalSyntheticOutline0.m(Integer.hashCode(this.uiMode) * 31, 31, this.isNightMode), 31, this.isPowerSave), 31, this.isLocationEnabled), 31), 31, this.is24HourFormat)) * 31);
    }
