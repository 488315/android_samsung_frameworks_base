...
public class HotspotTile extends SQSTileImpl {
    ...
    public final class CallbackInfo {
        ...
        public final String toString() {
            ...
            return BoundsAnimationElement$$ExternalSyntheticOutline0.m(sb, this.isDataSaverEnabled, ']');
        }
    }
    ...
    public final class HotspotAndDataSaverCallbacks implements HotspotController.Callback, DataSaverController.Listener {
        ...
        public final void onDataSaverChanged(boolean z) {
            AODAmbientWallpaperHelper$initAODAmbientWallpaperHelper$1$$ExternalSyntheticOutline0.m("onDataSaverChanged: ", "HotspotTile", z);
        ...
        public final void onHotspotAvailabilityChanged(boolean z) {
            AODAmbientWallpaperHelper$initAODAmbientWallpaperHelper$1$$ExternalSyntheticOutline0.m("onHotspotAvailabilityChanged: ", "HotspotTile", z);
            if (z) {
                return;
            }
        ...
        public final void onHotspotChanged(int i, boolean z) {
            AODAmbientWallpaperHelper$initAODAmbientWallpaperHelper$1$$ExternalSyntheticOutline0.m("onHotspotChanged: ", "HotspotTile", z);
            CallbackInfo callbackInfo = this.mCallbackInfo;
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [com.android.systemui.qs.tiles.HotspotTile$1] */
    ...
    public static boolean isSatelliteModeOn(Context context) {
        ...
        return string != null && string.contains(ImsProfile.PDN_WIFI) && Settings.Global.getInt(context.getContentResolver(), "satellite_mode_enabled", 0) == 1;
    }
    ...
    public final void handleClick(final Expandable expandable) {
        ...
        if (z && wifiApState != 13) {
            ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(wifiApState, "return, wifiapstate", "HotspotTile");
            return;
        }
        if (!z) {
