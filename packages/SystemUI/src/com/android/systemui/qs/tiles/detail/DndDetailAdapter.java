...
public final class DndDetailAdapter implements DetailAdapter, View.OnAttachStateChangeListener, DNDDetailItems.Callback {
    ...
    /* JADX WARN: Removed duplicated region for block: B:136:0x0199 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    */
    public final android.view.View createDetailView(android.content.Context r23, android.view.View r24, android.view.ViewGroup r25) {
        /*
    ...
    public final void updateDetailItem(DNDDetailItems.Item item, boolean z) {
        ...
        FontSizeUtils.updateFontSize(checkedTextView, R.dimen.qs_detail_dnd_check_text_size, 0.8f, 1.6f);
