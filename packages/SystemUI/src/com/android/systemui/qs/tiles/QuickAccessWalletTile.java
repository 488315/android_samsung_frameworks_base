    ...
    public final void handleClick(Expandable expandable) {
        ...
        this.mUiHandler.post(new Runnable() { // from class: com.android.systemui.qs.tiles.QuickAccessWalletTile$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ...
                if (walletCard == null) {
                    quickAccessWalletController.mQuickAccessWalletClient.getWalletPendingIntent(quickAccessWalletController.mExecutor, new QuickAccessWalletController$$ExternalSyntheticLambda3(quickAccessWalletController, activityStarter, controller, walletCard != null));
                } else {
