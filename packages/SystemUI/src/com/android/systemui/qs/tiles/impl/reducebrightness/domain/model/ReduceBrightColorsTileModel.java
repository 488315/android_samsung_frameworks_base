...
public final class ReduceBrightColorsTileModel {
    ...
    public static final /* synthetic */ ReduceBrightColorsTileModel m2917boximpl(boolean z) {
    ...
    public final String toString() {
        return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("ReduceBrightColorsTileModel(isEnabled="), this.isEnabled, ")");
    }
}
