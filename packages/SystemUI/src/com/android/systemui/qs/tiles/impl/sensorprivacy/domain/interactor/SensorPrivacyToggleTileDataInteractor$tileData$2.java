...
final class SensorPrivacyToggleTileDataInteractor$tileData$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SensorPrivacyToggleTileModel m2919boximpl = SensorPrivacyToggleTileModel.m2919boximpl(((IndividualSensorPrivacyControllerImpl) sensorPrivacyToggleTileDataInteractor.privacyController).isSensorBlocked(sensorPrivacyToggleTileDataInteractor.sensorId));
            this.label = 1;
            if (flowCollector.emit(m2919boximpl, this) == coroutineSingletons) {
