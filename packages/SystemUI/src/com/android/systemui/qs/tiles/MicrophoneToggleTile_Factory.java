...
public final class MicrophoneToggleTile_Factory implements Provider {
    ...
    public MicrophoneToggleTile_Factory(Provider provider, Provider provider2, Provider provider3, Provider provider4, Provider provider5, Provider provider6, Provider provider7, Provider provider8, Provider provider9, Provider provider10, Provider provider11, Provider provider12, Provider provider13) {
    ...
    public static MicrophoneToggleTile newInstance(QSHost qSHost, QsEventLogger qsEventLogger, Looper looper, Handler handler, MetricsLogger metricsLogger, FalsingManager falsingManager, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, IndividualSensorPrivacyController individualSensorPrivacyController, KeyguardStateController keyguardStateController, SafetyCenterManager safetyCenterManager, PanelInteractor panelInteractor) {
        return new MicrophoneToggleTile(qSHost, qsEventLogger, looper, handler, metricsLogger, falsingManager, statusBarStateController, activityStarter, qSLogger, individualSensorPrivacyController, keyguardStateController, safetyCenterManager, panelInteractor);
    }

    @Override // javax.inject.Provider
    public final Object get() {
        return new MicrophoneToggleTile((QSHost) this.hostProvider.get(), (QsEventLogger) this.uiEventLoggerProvider.get(), (Looper) this.backgroundLooperProvider.get(), (Handler) this.mainHandlerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get(), (FalsingManager) this.falsingManagerProvider.get(), (StatusBarStateController) this.statusBarStateControllerProvider.get(), (ActivityStarter) this.activityStarterProvider.get(), (QSLogger) this.qsLoggerProvider.get(), (IndividualSensorPrivacyController) this.sensorPrivacyControllerProvider.get(), (KeyguardStateController) this.keyguardStateControllerProvider.get(), (SafetyCenterManager) this.safetyCenterManagerProvider.get(), (PanelInteractor) this.panelInteractorProvider.get());
    }
}
