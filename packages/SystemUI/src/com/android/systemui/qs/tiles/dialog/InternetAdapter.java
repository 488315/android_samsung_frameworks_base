...
public class InternetAdapter extends RecyclerView.Adapter {
    ...
    public class InternetViewHolder extends RecyclerView.ViewHolder {
        ...
        public InternetViewHolder(View view, InternetDetailsContentController internetDetailsContentController, CoroutineScope coroutineScope) {
            super(view);
        ...
        public final void wifiConnect(WifiEntry wifiEntry, View view) {
            ...
            if (shouldEditBeforeConnect) {
                ...
                internetDetailsContentController.mActivityStarter.startActivity(intent, false);
                return;
            }
            if (!wifiEntry.canConnect()) {
                if (wifiEntry.isSaved()) {
                    ...
                    internetDetailsContentController.launchWifiDetailsSetting(view, wifiEntry.getKey());
                    return;
                }
                return;
            }
            ...
            if (wifiEntry.getWifiConfiguration() != null) {
                if (z) {
                    RecyclerView$$ExternalSyntheticOutline0.m(wifiEntry.getWifiConfiguration().networkId, "InternetDetailsContentController", new StringBuilder("connect networkId="));
                }
            } else if (z) {
                Log.d("InternetDetailsContentController", "connect to unsaved network " + wifiEntry.getTitle());
            }
            wifiEntry.connect(new InternetDetailsContentController.WifiEntryConnectCallback(internetDetailsContentController.mActivityStarter, wifiEntry, internetDetailsContentController));
        }
    }

    public InternetAdapter(InternetDetailsContentController internetDetailsContentController, CoroutineScope coroutineScope) {
        this.mInternetDetailsContentController = internetDetailsContentController;
        this.mCoroutineScope = coroutineScope;
    }
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        Drawable wifiDrawable = internetViewHolder.mInternetDetailsContentController.getWifiDrawable(wifiEntry);
        ...
        if (connectedState != 0) {
            ...
            internetViewHolder.mWifiListLayout.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.qs.tiles.dialog.InternetAdapter$InternetViewHolder$$ExternalSyntheticLambda0
                /* JADX WARN: Type inference failed for: r5v0, types: [com.android.systemui.qs.tiles.dialog.InternetAdapter$InternetViewHolder$$ExternalSyntheticLambda2] */
                /* JADX WARN: Type inference failed for: r6v0, types: [com.android.systemui.qs.tiles.dialog.InternetAdapter$InternetViewHolder$$ExternalSyntheticLambda3] */
                /* JADX WARN: Type inference failed for: r7v0, types: [com.android.systemui.qs.tiles.dialog.InternetAdapter$InternetViewHolder$$ExternalSyntheticLambda4] */
                @Override // android.view.View.OnClickListener
                public final void onClick(final View view) {
                    switch (i2) {
                        case 0:
                            internetViewHolder.mInternetDetailsContentController.launchWifiDetailsSetting(view, wifiEntry.getKey());
                            break;
                        default:
                            final InternetAdapter.InternetViewHolder internetViewHolder2 = internetViewHolder;
                            final WifiEntry wifiEntry2 = wifiEntry;
                            int i3 = InternetAdapter.InternetViewHolder.$r8$clinit;
                ...
                public final void onClick(final View view) {
                    switch (i3) {
                        ...
                        default:
                            final InternetAdapter.InternetViewHolder internetViewHolder2 = internetViewHolder;
                            final WifiEntry wifiEntry2 = wifiEntry;
                            int i32 = InternetAdapter.InternetViewHolder.$r8$clinit;
                            if (!wifiEntry2.getSecurityTypes().contains(1)) {
                                internetViewHolder2.wifiConnect(wifiEntry2, view);
                                break;
                            } else if (internetViewHolder2.mJob == null) {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        this.mHolderView = KeyguardSecurityContainer$UserSwitcherViewMode$2$$ExternalSyntheticOutline0.m(viewGroup, R.layout.internet_list_item, viewGroup, false);
        return new InternetViewHolder(this.mHolderView, this.mInternetDetailsContentController, this.mCoroutineScope);
    }
}
