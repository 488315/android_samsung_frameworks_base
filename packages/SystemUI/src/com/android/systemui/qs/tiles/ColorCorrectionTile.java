...
public class ColorCorrectionTile extends QSTileImpl {
    public final QSSettingsPackageRepository mQSSettingsPackageRepository;
    public final AnonymousClass1 mSetting;

    /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.qs.tiles.ColorCorrectionTile$1] */
    public ColorCorrectionTile(QSHost qSHost, QsEventLogger qsEventLogger, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, UserTracker userTracker, SecureSettings secureSettings, QSSettingsPackageRepository qSSettingsPackageRepository) {
        super(qSHost, qsEventLogger, looper, handler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qSLogger);
        this.mQSSettingsPackageRepository = qSSettingsPackageRepository;
        this.mSetting = new UserSettingObserver(secureSettings, this.mHandler, SettingsHelper.INDEX_ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED, ((UserTrackerImpl) userTracker).getUserId()) { // from class: com.android.systemui.qs.tiles.ColorCorrectionTile.1
    ...
    public final Intent getLongClickIntent() {
        return new Intent("com.android.settings.ACCESSIBILITY_COLOR_SPACE_SETTINGS").setPackage(this.mQSSettingsPackageRepository.getSettingsPackageName());
    }
