...
public class ColorInversionTile extends QSTileImpl {
    ...
    public ColorInversionTile(QSHost qSHost, QsEventLogger qsEventLogger, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, UserTracker userTracker, SecureSettings secureSettings, QSSettingsPackageRepository qSSettingsPackageRepository) {
        super(qSHost, qsEventLogger, looper, handler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qSLogger);
        this.mQSSettingsPackageRepository = qSSettingsPackageRepository;
        this.mSetting = new UserSettingObserver(secureSettings, this.mHandler, SettingsHelper.INDEX_ACCESSIBILITY_DISPLAY_INVERSION_ENABLED, ((UserTrackerImpl) userTracker).getUserId()) { // from class: com.android.systemui.qs.tiles.ColorInversionTile.1
    ...
    public final Intent getLongClickIntent() {
        return new Intent("android.settings.COLOR_INVERSION_SETTINGS").setPackage(this.mQSSettingsPackageRepository.getSettingsPackageName());
    }
