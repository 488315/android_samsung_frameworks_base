...
public final class NoLabelTileView extends QSTileView implements LaunchableView {
    ...
    public NoLabelTileView(Context context, SecQSPanelResourcePicker secQSPanelResourcePicker) {
        ...
        SecQSCommonTileView secQSCommonTileView = new SecQSCommonTileView(context, secQSPanelResourcePicker, qSIconViewImpl, this, null, null, false, true, 112, null);
        this.commonTileView = secQSCommonTileView;
        FrameLayout frameLayout = secQSCommonTileView.iconFrame;
        addView(frameLayout);
        this.iconFrame = frameLayout;
        int tileImageSize = secQSPanelResourcePicker.getTileImageSize(getContext());
        setLayoutParams(new LinearLayout.LayoutParams(tileImageSize, tileImageSize));
