...
public class SecQSTileBaseView extends QSTileView implements LaunchableView {
    ...
    public int getCircleColor(int i) {
        ...
        ClockEventController$$ExternalSyntheticOutline0.m(i, "Invalid state ", "QSTileBaseView");
        return 0;
    }
    ...
    public void handleStateChanged(QSTile.State state) {
        ...
        if (str == null || str.contains("SoundMode")) {
            ...
            if (!TextUtils.isEmpty(state.stateDescription)) {
                ...
                if (i3 != -1 && state.state == i3 && (charSequence = state.stateDescription) != null && !charSequence.equals(this.mLastStateDescription)) {
            ...
            public final void onClick(View view) {
                switch (i) {
                    case 0:
                        ...
                        qSTile2.click(expandable$Companion$fromView$12);
                        break;
                    default:
                        QSTile qSTile3 = qSTile;
                        Expandable$Companion$fromView$1 expandable$Companion$fromView$13 = expandable$Companion$fromView$1;
                        int i4 = SecQSTileBaseView.$r8$clinit;
                        qSTile3.secondaryClick(expandable$Companion$fromView$13);
                        break;
                }
            }
