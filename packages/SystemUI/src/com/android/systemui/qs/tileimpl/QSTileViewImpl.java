...
public class QSTileViewImpl extends QSTileView implements HeightOverrideable, LaunchableView {
    ...
    public static Unit $r8$lambda$z2I2f7JdMBvprJ5PkXXY6cmrYYU(QSTileViewImpl qSTileViewImpl, int i) {
    ...
    public final int getBackgroundColorForState(int i, boolean z) {
        ...
        ClockEventController$$ExternalSyntheticOutline0.m(i, "Invalid state ", "QSTileViewImpl");
        return 0;
    }
    ...
    public void handleStateChanged(QSTile.State state) {
        ...
        CharSequence stateText = state.getStateText(SubtitleArrayMapping.getSubtitleId(str), getResources());
        ...
        boolean z3 = state.handlesLongClick;
        QSLongPressEffect qSLongPressEffect = this.longPressEffect;
        if ((qSLongPressEffect != null ? qSLongPressEffect.state : null) != QSLongPressEffect.State.IDLE) {
            if ((qSLongPressEffect != null ? qSLongPressEffect.state : null) != QSLongPressEffect.State.CLICKED) {
                return;
            }
        }
        QSTile qSTile = qSLongPressEffect.qsTile;
        if (qSTile != null && (state3 = qSTile.getState()) != null) {
            state3.handlesLongClick = z3;
        }
        if (z3) {
            QSLongPressEffect qSLongPressEffect2 = this.longPressEffect;
            int longPressEffectDuration = getLongPressEffectDuration();
            if (longPressEffectDuration > 0) {
                if (longPressEffectDuration != qSLongPressEffect2.effectDuration) {
                    qSLongPressEffect2.effectDuration = longPressEffectDuration;
                    LongPressHapticBuilder longPressHapticBuilder = LongPressHapticBuilder.INSTANCE;
                    int[] iArr = qSLongPressEffect2.durations;
                    ...
                    } else if (longPressEffectDuration < i3 + 99) {
                ...
                if (qSTile2 != null && (state2 = qSTile2.getState()) != null) {
                    state2.state = this.lastState;
                }
    ...
    public final void init(final QSTile qSTile) {
        ...
        View.OnClickListener onClickListener2 = new View.OnClickListener() { // from class: com.android.systemui.qs.tileimpl.QSTileViewImpl$init$1
            ...
            public final void onClick(View view) {
                ...
                QSLongPressEffect.State state = qSLongPressEffect3.state;
                boolean z = state == QSLongPressEffect.State.TIMEOUT_WAIT || state == QSLongPressEffect.State.IDLE;
                if (((KeyguardStateControllerImpl) qSLongPressEffect3.keyguardStateController).mPrimaryBouncerShowing || !z) {
                    return;
                }
                qSLongPressEffect3.setState(qSLongPressEffect3.getStateForClick());
                QSTile qSTile2 = qSLongPressEffect3.qsTile;
                qSLongPressEffect3.logEvent(qSTile2 != null ? qSTile2.getTileSpec() : null, qSLongPressEffect3.state, "click action triggered from onTileClick");
                QSTile qSTile3 = qSLongPressEffect3.qsTile;
                if (qSTile3 != null) {
                    qSTile3.click(qSLongPressEffect3.expandable);
                }
            }
        };
        View.OnLongClickListener onLongClickListener2 = new View.OnLongClickListener() { // from class: com.android.systemui.qs.tileimpl.QSTileViewImpl$init$2
            ...
            public final boolean onLongClick(View view) {
                QSLongPressEffect qSLongPressEffect3 = QSTileViewImpl.this.longPressEffect;
                if (qSLongPressEffect3.state != QSLongPressEffect.State.IDLE) {
                    return true;
                }
                QSTile qSTile2 = qSLongPressEffect3.qsTile;
                if (qSTile2 != null) {
                ...
                QSTile qSTile3 = qSLongPressEffect3.qsTile;
                qSLongPressEffect3.logEvent(qSTile3 != null ? qSTile3.getTileSpec() : null, qSLongPressEffect3.state, "long click action triggered from OnLongClickListener");
                return true;
            }
        };
    ...
    public final void initializeLongPressProperties(int i, int i2) {
        ...
        QSLongPressProperties qSLongPressProperties = new QSLongPressProperties(f * 1.2f, f2 * 1.1f, getResources().getDimensionPixelSize(R.dimen.qs_corner_radius) - 20, getBackgroundColorForState(2, false), getLabelColorForState(2, false), getSecondaryLabelColorForState(2, false), getSecondaryLabelColorForState(2, false), this.overlayColorActive, Utils.getColorAttrDefaultColor(getContext(), R.attr.onShadeActive, 0));
        this.finalLongPressProperties = qSLongPressProperties;
        QSLongPressProperties qSLongPressProperties2 = this.initialLongPressProperties;
        int i3 = qSLongPressProperties2 != null ? (int) qSLongPressProperties2.height : 0;
        int i4 = qSLongPressProperties2 != null ? (int) qSLongPressProperties2.width : 0;
        int i5 = (int) (qSLongPressProperties.height - i3);
        int i6 = (int) (qSLongPressProperties.width - i4);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.longPressEffect != null) {
            ...
            if (valueOf != null && valueOf.intValue() == 0) {
                ...
                } else if ((i == 4 || i == 5) && (qSTileViewImpl$initLongPressEffectCallback$1 = qSLongPressEffect.callback) != null) {
                                        ...
                                        if (qSLongPressEffect3 != null) {
                                            ...
                                            if (i2 == 4) {
                                                ...
                                                if (qSTileViewImpl$initLongPressEffectCallback$13 != null) {
                                                    qSTileViewImpl$initLongPressEffectCallback$13.this$0.haveLongPressPropertiesBeenReset = true;
                                                }
                                                qSLongPressEffect3.setState(qSLongPressEffect3.getStateForClick());
                                                QSTile qSTile3 = qSLongPressEffect3.qsTile;
                                                qSLongPressEffect3.logEvent(qSTile3 != null ? qSTile3.getTileSpec() : null, qSLongPressEffect3.state, "click action triggered from handleAnimationComplete");
                                                QSTile qSTile4 = qSLongPressEffect3.qsTile;
                                                if (qSTile4 != null) {
                                                    qSTile4.click(qSLongPressEffect3.expandable);
                                                    return;
                                                }
                                                return;
                                            }
                                            if (i2 == 5) {
                                                ...
                                                if (qSTileViewImpl$initLongPressEffectCallback$14 != null) {
                                                    qSTileViewImpl$initLongPressEffectCallback$14.this$0.haveLongPressPropertiesBeenReset = true;
                                                }
                                                qSLongPressEffect3.setState(QSLongPressEffect.State.IDLE);
                                                return;
                                            }
                                            ...
                                            if (qSLongPressEffect3.falsingManager.isFalseLongTap(1)) {
                                                QSTileViewImpl$initLongPressEffectCallback$1 qSTileViewImpl$initLongPressEffectCallback$15 = qSLongPressEffect3.callback;
                                                if (qSTileViewImpl$initLongPressEffectCallback$15 != null) {
                                                    qSTileViewImpl$initLongPressEffectCallback$15.this$0.resetLongPressEffectProperties();
                                                }
                                                qSLongPressEffect3.setState(QSLongPressEffect.State.IDLE);
                                                QSTile qSTile5 = qSLongPressEffect3.qsTile;
                                            ...
                                            if (isUnlocked) {
                                                ...
                                                qSLongPressEffect3.setState(QSLongPressEffect.State.LONG_CLICKED);
                                                QSTile qSTile6 = qSLongPressEffect3.qsTile;
                                                if (qSTile6 != null) {
                                                    qSTile6.longClick(qSLongPressEffect3.expandable);
                                                }
                                                QSTile qSTile7 = qSLongPressEffect3.qsTile;
                                                qSLongPressEffect3.logEvent(qSTile7 != null ? qSTile7.getTileSpec() : null, qSLongPressEffect3.state, "long click action triggered");
                                                return;
                                            }
                                            VibrationEffect vibrationEffect2 = qSLongPressEffect3.snapEffect;
                                            if (vibratorHelper != null && vibrationEffect2 != null) {
                                                vibratorHelper.vibrate(vibrationEffect2);
                                            }
                                            QSTileViewImpl$initLongPressEffectCallback$1 qSTileViewImpl$initLongPressEffectCallback$16 = qSLongPressEffect3.callback;
                                            if (qSTileViewImpl$initLongPressEffectCallback$16 != null) {
                                                qSTileViewImpl$initLongPressEffectCallback$16.this$0.resetLongPressEffectProperties();
                                            }
                                            qSLongPressEffect3.setState(QSLongPressEffect.State.IDLE);
                                            QSTile qSTile8 = qSLongPressEffect3.qsTile;
                                            if (qSTile8 != null) {
                                                qSTile8.longClick(qSLongPressEffect3.expandable);
                                            }
                                            QSTile qSTile9 = qSLongPressEffect3.qsTile;
                                            qSLongPressEffect3.logEvent(qSTile9 != null ? qSTile9.getTileSpec() : null, qSLongPressEffect3.state, "properties reset and long click action triggered");
                                        }
                                    }
                ...
                if (qSLongPressEffect2.state == QSLongPressEffect.State.RUNNING_FORWARD) {
                    qSLongPressEffect2.setState(QSLongPressEffect.State.RUNNING_BACKWARDS_FROM_UP);
                ...
                if (i2 == 6) {
                    ...
                    qSLongPressEffect3.setState(QSLongPressEffect.State.RUNNING_BACKWARDS_FROM_CANCEL);
                    QSTileViewImpl$initLongPressEffectCallback$1 qSTileViewImpl$initLongPressEffectCallback$13 = qSLongPressEffect3.callback;
                    if (qSTileViewImpl$initLongPressEffectCallback$13 != null) {
    ...
    public QSTileViewImpl(Context context, boolean z, QSLongPressEffect qSLongPressEffect) {
        ...
        if (getContext().getTheme().resolveAttribute(R.attr.isQsTheme, new TypedValue(), true)) {
            ...
            this.label = (TextView) (ignorableChildLinearLayout == null ? null : ignorableChildLinearLayout).requireViewById(R.id.tile_label);
            ...
            this.customDrawableView = (ImageView) (viewGroup == null ? null : viewGroup).requireViewById(R.id.customDrawable);
