    ...
    public final void setListening(boolean z, boolean z2) {
        ...
        if (z != qSButtonsContainer.mListening) {
            ...
            if (UserManager.supportsMultipleUsers()) {
                qSButtonsContainer.mMumButton.setListening(z);
            }
        }
        ...
        if (UserManager.supportsMultipleUsers()) {
            QSMumButton qSMumButton = qSButtonsContainer2.mMumButton;
            if (qSMumButton.mExpanded != z2) {
                qSMumButton.mExpanded = z2;
                qSMumButton.isExpandedOnLockScreen = false;
            }
        }
        qSButtonsContainer2.post(new QSButtonsContainer$$ExternalSyntheticLambda1(qSButtonsContainer2));
    }
}
