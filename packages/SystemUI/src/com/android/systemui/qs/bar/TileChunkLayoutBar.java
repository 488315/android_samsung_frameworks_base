...
import com.android.systemui.qs.SecTileChunkLayout$$ExternalSyntheticLambda0;
...
public class TileChunkLayoutBar extends BarItemImpl {
    ...
    public final float BUTTON_WIDTH_MIN_RATIO;
    public int mCollapsedRow;
    public int mCollapsedRowSettingValue;
    ...
    public TileChunkLayoutBar(Context context, SecQSPanelResourcePicker secQSPanelResourcePicker) {
        ...
        this.mCollapsedRowSettingValue = 2;
        ...
        this.BUTTON_WIDTH_MAX_RATIO = this.mSecQsUiDisplayModeInteractor.isTablet() ? 1.41f : 1.5f;
        ...
        this.mSettingListener = new SettingsHelper.OnChangedCallback() { // from class: com.android.systemui.qs.bar.TileChunkLayoutBar.1
            ...
            public final void onChanged(Uri uri) {
                ...
                String str = tileChunkLayoutBar.TAG;
                Log.d(str, "settingsHelper onChanged() Settings:" + ((SettingsHelper) Dependency.sDependency.getDependencyInner(SettingsHelper.class)).isQSButtonGridPopupEnabled());
    ...
    public final void calculateContainerHeight() {
        ...
        if (this.mTileLayout == null) {
            ...
            int i2 = (i <= 0 || this.mCollapsedRowSettingValue <= i) ? this.mCollapsedRowSettingValue : i;
    ...
    public final int getDefaultProgress() {
        float f = this.BUTTON_WIDTH_MIN_RATIO;
        float f2 = this.BUTTON_WIDTH_MAX_RATIO;
        return Math.min(Math.max(Math.round((f2 - 1.0f) / ((f2 - f) / 10.0f)), 0), 10);
    }
    ...
    public final void setListening(boolean z) {
        ...
        if (secTileChunkLayout != null) {
            secTileChunkLayout.setListening(z && this.mQsExpanded, null);
            if (this.mTileLayout.rows != 0) {
