...
public final class VideoCallMicModeBar extends BarItemImpl {
    ...
    public VideoCallMicModeBar(Context context, SettingsHelper settingsHelper, SecQSPanelResourcePicker secQSPanelResourcePicker, PanelInteractor panelInteractor, SecQSDetailController secQSDetailController) {
        super(context);
        ...
        this.lastConfigurationState = new ConfigurationState(Arrays.asList(ConfigurationState.ConfigurationField.ORIENTATION, ConfigurationState.ConfigurationField.SCREEN_HEIGHT_DP, ConfigurationState.ConfigurationField.DISPLAY_DEVICE_TYPE));
    }
    ...
    public final void onConfigChanged(Configuration configuration) {
        ...
        if (!configurationState.needToUpdate(configuration) && this.orientation == i && this.fontScale == f) {
            return;
        }
        this.orientation = i;
        this.fontScale = f;
    ...
    public final void updateBarVisibilities$1() {
    ...
    public final void updateHeightMargins() {
        ...
        boolean z = this.orientation == 2 && !this.mSecQsUiDisplayModeInteractor.isTablet();
        VideoCallMicModeBar$$ExternalSyntheticLambda0 videoCallMicModeBar$$ExternalSyntheticLambda0 = new VideoCallMicModeBar$$ExternalSyntheticLambda0(0);
        Sequence sequence = this.items;
        List list = SequencesKt___SequencesKt.toList(new TransformingSequence(sequence, videoCallMicModeBar$$ExternalSyntheticLambda0));
