...
public class BrightnessBar extends BarItemImpl implements TunerService.Tunable, TileHostable {
            ...
            this.mToggleSeekBar.setOnTouchListener(new View.OnTouchListener() { // from class: com.android.systemui.qs.bar.BrightnessBar$$ExternalSyntheticLambda0
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    if (!((KnoxStateMonitorImpl) ((KnoxStateMonitor) Dependency.sDependency.getDependencyInner(KnoxStateMonitor.class))).isBrightnessBlocked()) {
                        ...
                        if (secBrightnessSliderController == null || secBrightnessSliderController.isSliderEnabled()) {
                            SecBrightnessSliderController secBrightnessSliderController2 = brightnessBar.mSecBrightnessSliderController;
                            if (secBrightnessSliderController2 == null || !secBrightnessSliderController2.view.mSecBrightnessSliderView.highBrightnessModeEnter || !secBrightnessSliderController2.isAdaptiveBrightness || motionEvent.getAction() != 0) {
                                return false;
                            }
    ...
    public final void makeCloneBar() {
        ...
        SecQSPanelResourcePicker secQSPanelResourcePicker = this.mResourcePicker;
        createTilesViewAndDistribute(linearLayout2, arrayList, secQSPanelResourcePicker, bool);
        ...
        slider.setMaxHeight(secQSPanelResourcePicker.getBrightnessBarExpandedHeight(this.mContext));
    ...
    public final void removeCloneTileBG() {
        ViewGroup viewGroup = (ViewGroup) this.mClonedBarView.findViewById(R.id.brightness_tile_layout);
    ...
    public final void updateIconSize$1() {
        Context context = this.mContext;
    ...
    public final void updateVisibility$8() {
        boolean z = ((KnoxStateMonitorImpl) ((KnoxStateMonitor) Dependency.sDependency.getDependencyInner(KnoxStateMonitor.class))).isBrightnessControllerEnabled() && (!this.mIsOnCollapsedState || this.mIsAllowedOnTop);
        if (this.mShowing != z) {
            showBar(z);
        }
    }
