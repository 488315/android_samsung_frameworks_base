...
public final class VideoCallMicModeResources {
    ...
    public final int hashCode() {
        return Integer.hashCode(this.dividerPadding) + ReorderTile$$ExternalSyntheticOutline0.m(this.betweenMargin, ReorderTile$$ExternalSyntheticOutline0.m(this.defaultMargin, ReorderTile$$ExternalSyntheticOutline0.m(this.textContainerPaddingEnd, ReorderTile$$ExternalSyntheticOutline0.m(this.textContainerPaddingStart, ReorderTile$$ExternalSyntheticOutline0.m(this.startPadding, ReorderTile$$ExternalSyntheticOutline0.m(this.defaultStartPadding, ReorderTile$$ExternalSyntheticOutline0.m(this.iconSize, Integer.hashCode(this.iconPadding) * 31, 31), 31), 31), 31), 31), 31), 31);
    }
    ...
    public final String toString() {
        ...
        return ReorderTile$$ExternalSyntheticOutline0.m(this.dividerPadding, ")", sb);
    }
}
