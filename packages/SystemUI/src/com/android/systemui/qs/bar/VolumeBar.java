...
public class VolumeBar extends BarItemImpl implements TileHostable {
    ...
    public final void addTile(SecQSPanelControllerBase.TileRecord tileRecord) {
        ...
        if (linearLayout != null) {
            ...
            tileRecord.tile.setListening(this, true);
    ...
    public final void inflateViews(ViewGroup viewGroup) {
        ...
        if (volumeSeekBar != null) {
            ...
            this.mVolumeSeekBar.initialize(this.mSlider, this.mVolumeIcon);
        }
    ...
    public final void makeCloneBar() {
        ...
        this.mVolumeSeekBarForEditMode.initialize(volumeToggleSeekBar, (QPVolumeIcon) this.mClonedBarView.findViewById(R.id.qs_volume_button));
        createTilesViewAndDistribute(linearLayout, this.mTiles, this.mResourcePicker, Boolean.FALSE);
    ...
    public final void removeCloneTileBG() {
        ViewGroup viewGroup = (ViewGroup) this.mClonedBarView.findViewById(R.id.volume_tile_layout);
