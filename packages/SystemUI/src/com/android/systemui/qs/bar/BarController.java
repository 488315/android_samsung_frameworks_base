...
import com.android.systemui.qs.SecQSImpl$onComponentCreated$3$1;
...
public class BarController implements Dumpable, PanelScreenShotLogger.LogProvider, PanelTransitionStateListener {
    ...
    public QSImpl$$ExternalSyntheticLambda2 mQSLastExpansionInitializer;
    public SecQSPanel mQsPanel;
    public final SecQSPanelResourcePicker mResourcePicker;
    private final SettingsHelper mSettingsHelper;
    public int mThemeSeq;
    public int mUiMode;
    public SecQSImpl$onComponentCreated$3$1 mUpdateAnimatorsRunner;
    ...
    public static void logForColors(final Context context, final Consumer consumer) {
        Map.ofEntries(Map.entry("open_theme_qp_bg_color", Integer.valueOf(R.color.open_theme_qp_bg_color)), Map.entry("sec_panel_background_color", Integer.valueOf(R.color.sec_panel_background_color)), Map.entry("sec_panel_background_color_tablet", Integer.valueOf(R.color.sec_panel_background_color_tablet)), Map.entry("animated_brightness_sun_icon_color", Integer.valueOf(R.color.animated_brightness_sun_icon_color)), Map.entry("tw_progress_color_control_activated", Integer.valueOf(R.color.tw_progress_color_control_activated)), Map.entry("tw_progress_color_control_normal", Integer.valueOf(R.color.tw_progress_color_control_normal)), Map.entry("qs_tile_round_background_off", Integer.valueOf(R.color.qs_tile_round_background_off)), Map.entry("qs_tile_round_background_on", Integer.valueOf(R.color.qs_tile_round_background_on)), Map.entry("qs_tile_icon_on_dim_tint_color", Integer.valueOf(R.color.qs_tile_icon_on_dim_tint_color)), Map.entry("qs_tile_label", Integer.valueOf(R.color.qs_tile_label)), Map.entry("qs_tile_container_bg", Integer.valueOf(R.color.qs_tile_container_bg))).forEach(new BiConsumer() { // from class: com.android.systemui.qs.bar.BarController$$ExternalSyntheticLambda11
