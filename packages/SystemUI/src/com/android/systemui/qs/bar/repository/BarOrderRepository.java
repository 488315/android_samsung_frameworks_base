...
public final class BarOrderRepository {
    ...
    public final List nonEditableBars = Arrays.asList(BarClsName.VIDEOCALL_MICMODE_BAR.getCls(), BarClsName.SECURITY_FOOTER_BAR.getCls(), BarClsName.DATAUSAGE_BAR.getCls());
    ...
    public final class BarClsName {
        ...
        static {
            ...
            BarClsName barClsName3 = new BarClsName("DATAUSAGE_BAR", 2, BarType.DATAUSAGE.getCls().getSimpleName());
            DATAUSAGE_BAR = barClsName3;
            BarClsName[] barClsNameArr = {barClsName, barClsName2, barClsName3};
    ...
    public final void setBarOrder(List list) {
        if (Intrinsics.areEqual(list, this.barOrder)) {
            return;
        }
