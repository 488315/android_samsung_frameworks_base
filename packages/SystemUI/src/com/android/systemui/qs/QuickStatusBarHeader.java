...
public class QuickStatusBarHeader extends FrameLayout {
    ...
    public final void updateResources() {
        boolean zShouldUseLargeScreenShadeHeader = LargeScreenUtils.shouldUseLargeScreenShadeHeader(((FrameLayout) this).mContext.getResources());
        ...
        if (zShouldUseLargeScreenShadeHeader) {
