...
public final class SecTileChunkLayout extends ViewGroup implements SecQSPanel.QSTileLayout {
    ...
    public final class Cell {
        ...
        public final int hashCode() {
            return Integer.hashCode(this.heightExpanded) + ReorderTile$$ExternalSyntheticOutline0.m(this.heightCollapsed, ReorderTile$$ExternalSyntheticOutline0.m(this.height, Integer.hashCode(this.width) * 31, 31), 31);
        }
    ...
    public final class CellMargin {
        ...
        public final int hashCode() {
            return Integer.hashCode(this.verticalExpanded) + ReorderTile$$ExternalSyntheticOutline0.m(this.verticalCollapsed, Integer.hashCode(this.horizontal) * 31, 31);
        }

        public final String toString() {
            return ReorderTile$$ExternalSyntheticOutline0.m(this.verticalExpanded, ")", MutableObjectList$$ExternalSyntheticOutline0.m(this.horizontal, this.verticalCollapsed, "CellMargin(horizontal=", ", verticalCollapsed=", ", verticalExpanded="));
        }
    }
    ...
    public final void setListening(boolean z, UiEventLogger uiEventLogger) {
        ...
        while (i < size) {
            ...
            i++;
            ((SecQSPanelControllerBase.TileRecord) obj).tile.setListening(this, this.oldListening);
        }
    }
    ...
    public final boolean updateResources() {
        ...
        int i = this.columns;
        int tileChunkWidth = (this.resourcePicker.resourcePickHelper.getTargetPicker().getTileChunkWidth(this.context) - (this.sidePadding * 2)) / this.cell.width;
        if (1 >= tileChunkWidth) {
            tileChunkWidth = 1;
        }
        this.columns = tileChunkWidth;
        int size = this.records.size();
        int i2 = this.columns;
        int i3 = size / i2;
        this.rows = i3;
