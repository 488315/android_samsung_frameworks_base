            ...
            checkedTextView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.qs.DNDDetailItems.Adapter.1
                ...
                public final void onClick(View view2) {
                    ...
                    if (callback != null) {
                        ...
                        ArrayList arrayList = dndDetailAdapter.mItemsList;
                        ...
                        int i5 = dndTile.mDndMenuSelectedItem;
                        if (i5 != 5) {
                            String[] strArr = {"a", "b", "c", "d", "e", "f"};
                            SystemUIAnalytics.sendEventCDLog(SystemUIAnalytics.getCurrentScreenID(), SystemUIAnalytics.EID_QPNE_DND_DETAIL_OPTION, i5 == 0 ? dndTile.mIsSettingsUpdated ? strArr[5] : strArr[0] : strArr[i5], new String[]{"turn off", "on for 1 hr", "on for 2 hrs", "on for 4 hrs", "on until i turn it off"}[dndTile.mDndMenuSelectedItem]);
                        }
