...
public final class QSCPopupButtonController {
    ...
    public abstract class POPUPTYPE {
        ...
        final class MULTISIM extends POPUPTYPE {
            ...
            @Override // com.android.systemui.qs.customize.QSCPopupButtonController.POPUPTYPE
            public final boolean isAvailable(TunerService tunerService) {
                return Rune.SYSUI_MULTI_SIM && ((MultiSIMViewModelImpl) ((MultiSIMController) Dependency.sDependency.getDependencyInner(MultiSIMController.class)).mMultiSIMViewModel).isAvailable() && tunerService != null && tunerService.getValue(0, "multi_sim_bar_hide_by_knox_restrictions") == 0;
            }
