...
public class QSImpl implements QS, CommandQueue.Callbacks, StatusBarStateController.StateListener, Dumpable {
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        this.mQSCustomizerController.isCustomizing();
        indentingPrintWriter.println("isCustomizing: false");
    ...
    public final int getDesiredHeight() {
        ...
        return ((ShadeHeaderController) secQSImpl.shadeHeaderController$delegate.getValue()).header.getMeasuredHeight() + this.mRootView.getMeasuredHeight();
    }
    ...
    public final int getQsMinExpansionHeight() {
        ...
        return ((ShadeHeaderController) secQSImpl.shadeHeaderController$delegate.getValue()).header.getMeasuredHeight() + this.mHeader.getHeight();
    }
    ...
    public final void notifyCustomizeChanged() {
        ...
        this.mQSCustomizerController.isCustomizing();
        int i = SceneContainerFlag.$r8$clinit;
        this.mQSPanelScrollView.setVisibility(0);
    ...
    public final void onComponentCreated(QSComponent qSComponent, Bundle bundle) throws Resources.NotFoundException {
        ...
        if (listeningAndVisibilityLifecycleOwner.getLifecycle().getCurrentState() == Lifecycle.State.DESTROYED) {
        ...
        ReadonlyStateFlow readonlyStateFlow = ((ShadeModeInteractorImpl) factory.shadeModeInteractor).shadeMode;
        globalActionsDialogLite.getClass();
        this.mQSFooterActionsViewModel = FooterActionsViewModelKt.createFooterActionsViewModel(context, factory.footerActionsInteractor, readonlyStateFlow, factory.falsingManager, globalActionsDialogLite, factory.activityStarter, factory.showPowerButton);
        ...
        if (secQSImpl != null) {
            ...
            SecQSImpl$onComponentCreated$3$1 secQSImpl$onComponentCreated$3$1 = new SecQSImpl$onComponentCreated$3$1(secQSImpl);
            barController.mQSLastExpansionInitializer = qSImpl$$ExternalSyntheticLambda22;
            barController.mUpdateAnimatorsRunner = secQSImpl$onComponentCreated$3$1;
            barController.mBarListener = barController.new AnonymousClass3(secQSImpl$onComponentCreated$3$1, qSImpl$$ExternalSyntheticLambda2);
            BarController.AnonymousClass2 anonymousClass2 = barController.mOnConfigurationChangedListener;
            SecQSPanel secQSPanel = (SecQSPanel) getView().findViewById(R.id.quick_settings_panel);
            barController.mQsPanel = secQSPanel;
            ((ArrayList) secQSPanel.mOnConfigurationChangedListeners).add(anonymousClass2);
            ...
            SecNonInterceptingScrollView secNonInterceptingScrollView = nonInterceptingScrollView2.mSecNonInterceptingScrollView;
            ...
            coloredBGHelper.wallpaperManager.addOnSemColorsChangedListener(coloredBGHelper, coloredBGHelper.handler);
        }
        ...
        onStateChanged(sysuiStatusBarStateController.getState());
    ...
    public final void onConfigurationChanged(Configuration configuration) throws Resources.NotFoundException {
        ...
        if (secQSImpl != null && (barController = secQSImpl.barController) != null) {
            if (barController.mOrientation != configuration.orientation) {
                QSImpl$$ExternalSyntheticLambda2 qSImpl$$ExternalSyntheticLambda2 = barController.mQSLastExpansionInitializer;
    ...
    public final void onDestroy() {
        ...
        dumpManager.unregisterDumpable(getClass().getSimpleName());
        ListeningAndVisibilityLifecycleOwner listeningAndVisibilityLifecycleOwner = this.mListeningAndVisibilityLifecycleOwner;
        ...
        if (secQSImpl != null) {
            ...
            ColoredBGHelper coloredBGHelper = (ColoredBGHelper) secQSImpl.coloredBGHelper$delegate.getValue();
            coloredBGHelper.barBGList.clear();
            coloredBGHelper.noRippleBarBGList.clear();
            coloredBGHelper.actualAppliedColor = -1;
            coloredBGHelper.curExtractColor = -1;
            coloredBGHelper.curAlpha = 0;
            coloredBGHelper.wallpaperManager.removeOnSemColorsChangedListener(coloredBGHelper);
        }
    }
