...
final class IconAndNameCustomRepository$getCustomTileData$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        for (ServiceInfo serviceInfo : list2) {
            ...
            arrayList.add(loadIcon != null ? new EditTileData(create, new Icon.Loaded(loadIcon, new ContentDescription.Loaded(loadLabel.toString()), null, 4, null), new Text.Loaded(loadLabel.toString()), new Text.Loaded(serviceInfo.applicationInfo.loadLabel(packageManager).toString()), TileCategory.PROVIDED_BY_APP) : null);
        }
