...
public final class QSColumnsViewModel extends ExclusiveActivatable {
    ...
    /* renamed from: com.android.systemui.qs.panels.ui.viewmodel.QSColumnsViewModel$onActivated$1, reason: invalid class name */
    final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return QSColumnsViewModel.this.onActivated(this);
        }
    }

    /* renamed from: com.android.systemui.qs.panels.ui.viewmodel.QSColumnsViewModel$onActivated$2, reason: invalid class name */
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
        private /* synthetic */ Object L$0;
        int label;

        /* renamed from: com.android.systemui.qs.panels.ui.viewmodel.QSColumnsViewModel$onActivated$2$1, reason: invalid class name */
        final class AnonymousClass1 extends SuspendLambda implements Function2 {
            int label;
            final /* synthetic */ QSColumnsViewModel this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public AnonymousClass1(QSColumnsViewModel qSColumnsViewModel, Continuation continuation) {
                super(2, continuation);
                this.this$0 = qSColumnsViewModel;
            }
        ...
        /* renamed from: com.android.systemui.qs.panels.ui.viewmodel.QSColumnsViewModel$onActivated$2$2, reason: invalid class name and collision with other inner class name */
        final class C03952 extends SuspendLambda implements Function2 {
            int label;
            final /* synthetic */ QSColumnsViewModel this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C03952(QSColumnsViewModel qSColumnsViewModel, Continuation continuation) {
                super(2, continuation);
                this.this$0 = qSColumnsViewModel;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                return new C03952(this.this$0, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return ((C03952) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    MediaInRowInLandscapeViewModel mediaInRowInLandscapeViewModel = this.this$0.mediaInRowInLandscapeViewModel;
                    if (mediaInRowInLandscapeViewModel == null) {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            AnonymousClass2 anonymousClass2 = QSColumnsViewModel.this.new AnonymousClass2(continuation);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                BuildersKt.launch$default(coroutineScope, null, null, new AnonymousClass1(QSColumnsViewModel.this, null), 3);
                BuildersKt.launch$default(coroutineScope, null, null, new C03952(QSColumnsViewModel.this, null), 3);
                this.label = 1;
    ...
    public QSColumnsViewModel(QSColumnsInteractor qSColumnsInteractor, MediaInRowInLandscapeViewModel.Factory factory, Integer num) {
        ...
        this.columns$delegate = SnapshotStateKt.derivedStateOf(new Function0() { // from class: com.android.systemui.qs.panels.ui.viewmodel.QSColumnsViewModel$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                QSColumnsViewModel qSColumnsViewModel = this.f$0;
