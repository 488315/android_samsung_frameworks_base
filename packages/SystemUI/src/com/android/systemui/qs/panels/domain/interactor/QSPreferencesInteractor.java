...
public final class QSPreferencesInteractor {
    ...
    public final void setLargeTilesSpecs(Set set) {
        ...
        SharedPreferences.Editor editorEdit = sharedPreferences$1.edit();
        Set set2 = set;
        ...
        editorEdit.putStringSet("large_tiles_specs", CollectionsKt___CollectionsKt.toSet(arrayList)).apply();
