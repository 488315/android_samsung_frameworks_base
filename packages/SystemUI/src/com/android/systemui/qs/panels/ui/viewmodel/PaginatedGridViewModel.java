...
public final class PaginatedGridViewModel extends ExclusiveActivatable implements IconTilesViewModel {
    ...
    */
    public final java.lang.Object onActivated(kotlin.coroutines.Continuation r5) {
        /*
            r4 = this;
            boolean r0 = r5 instanceof com.android.systemui.qs.panels.ui.viewmodel.PaginatedGridViewModel$onActivated$1
            if (r0 == 0) goto L13
            r0 = r5
        ...
        L2f:
            kotlin.ResultKt.throwOnFailure(r5)
            com.android.systemui.qs.panels.ui.viewmodel.PaginatedGridViewModel$onActivated$2 r5 = new com.android.systemui.qs.panels.ui.viewmodel.PaginatedGridViewModel$onActivated$2
            r2 = 0
            r5.<init>(r4, r2)
            r0.label = r3
