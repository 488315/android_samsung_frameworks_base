...
public final class UnloadedEditTileViewModel {
    ...
    public final int hashCode() {
        ...
        return this.category.hashCode() + ((this.availableEditActions.hashCode() + TransitionData$$ExternalSyntheticOutline0.m((iHashCode + (text == null ? 0 : text.hashCode())) * 31, 31, this.isCurrent)) * 31);
    }
