        ...
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                if (selection != null) {
                    ...
                    ((Function1) this.f$1).mo779invoke(selection);
                }
                break;
            case 2:
                ((Function1) this.f$0).mo779invoke(new ResizingState.ResizeOperation.FinalResizeOperation(((TileGridCell) this.f$1).tile.tileSpec, !r1.isIcon()));
                break;
            default:
