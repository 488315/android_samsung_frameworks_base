    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ...
                List listSplit$default = StringsKt__StringsKt.split$default(barOrderRepository.getDefaultBarOrderList(), new String[]{","}, 0, 6);
                Log.d("BarOrderRepository", "resetBarOrder");
                barOrderRepository.setBarOrder(barOrderInteractor.toFilteredNonEditBars(listSplit$default));
