...
public class TileLayout extends ViewGroup implements SecQSPanel.QSTileLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i2) == 0) {
            this.mRows = ((size + r11) - 1) / this.mColumns;
        }
    ...
    public final void removeAllViews() {
        ...
        while (i < size) {
            ...
            i++;
            ((SecQSPanelControllerBase.TileRecord) obj).tile.setListening(this, false);
        }
        this.mRecords.clear();
    ...
    public void setListening(boolean z, UiEventLogger uiEventLogger) {
        ...
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            ((SecQSPanelControllerBase.TileRecord) obj).tile.setListening(this, this.mListening);
        }
    }
    ...
    public TileLayout(Context context, AttributeSet attributeSet) {
        ...
        RefactorFlag.Companion.getClass();
        Boolean bool = (Boolean) new RefactorFlag(null, unreleasedFlag, new RefactorFlag$$ExternalSyntheticLambda0(1), 0 == true ? 1 : 0).isEnabled$delegate.getValue();
        bool.booleanValue();
