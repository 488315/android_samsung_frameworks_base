    ...
    public final Object mo781invoke(Object obj) {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                return MutablePreferences$$ExternalSyntheticOutline0.m(ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage.getInt1(), "[", str1, "][", "] Tile secondary clicked. StatusBarState="), logMessage.getStr2(), ". TileState=", logMessage.getStr3());
            case 1:
                String str12 = logMessage.getStr1();
                String str2 = logMessage.getStr2();
                int int1 = logMessage.getInt1();
                String str3 = logMessage.getStr3();
                StringBuilder sbM = SeslRoundedCorner$SeslRoundedChunkingDrawable$$ExternalSyntheticOutline0.m("[", str12, "] Tile updated. Label=", str2, ". State=");
                sbM.append(int1);
                sbM.append(". Icon=");
                sbM.append(str3);
                sbM.append(".");
            ...
            case 5:
                ...
                return TransitionKt$$ExternalSyntheticOutline0.m(ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage.getInt1(), "[", str13, "] mLastTileState=", ", Callback="), logMessage.getStr2(), ".");
            case 6:
                return logMessage.getStr1() + " expanded=" + logMessage.getBool1();
            case 7:
                String str14 = logMessage.getStr1();
                return MutablePreferences$$ExternalSyntheticOutline0.m(ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage.getInt1(), "[", str14, "][", "] Tile clicked. StatusBarState="), logMessage.getStr2(), ". TileState=", logMessage.getStr3());
            case 8:
            ...
            case 9:
                ...
                return MutablePreferences$$ExternalSyntheticOutline0.m(ConstraintSet$WriteJsonEngine$$ExternalSyntheticOutline0.m890m(logMessage.getInt1(), "[", str15, "][", "] Tile long clicked. StatusBarState="), logMessage.getStr2(), ". TileState=", logMessage.getStr3());
            case 10:
