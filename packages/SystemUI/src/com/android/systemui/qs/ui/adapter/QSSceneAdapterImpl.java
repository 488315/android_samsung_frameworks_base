...
public final class QSSceneAdapterImpl implements QSContainerController, QSSceneAdapter, Dumpable {
    ...
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
        ...
        final class AnonymousClass4 extends SuspendLambda implements Function2 {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public AnonymousClass4(ShadeModeInteractor shadeModeInteractor, QSSceneAdapterImpl qSSceneAdapterImpl, Continuation continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                return new AnonymousClass4(this.$shadeModeInteractor, this.this$0, continuation);
            }
        ...
        final class AnonymousClass5 extends SuspendLambda implements Function2 {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    FlowKt__ZipKt$combine$$inlined$unsafeFlow$1 flowKt__ZipKt$combine$$inlined$unsafeFlow$1 = new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(((DisplayStateInteractorImpl) this.$displayStateInteractor).isLargeScreen, new FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1(this.this$0.qsImpl), AnonymousClass3.INSTANCE);
                    AnonymousClass4 anonymousClass4 = new FlowCollector() { // from class: com.android.systemui.qs.ui.adapter.QSSceneAdapterImpl.2.5.4
                        @Override // kotlinx.coroutines.flow.FlowCollector
                        public final Object emit(Object obj2, Continuation continuation) {
                            ((QSImpl) ((Pair) obj2).getSecond()).mIsSmallScreen = !((Boolean) r1.getFirst()).booleanValue();
                            return Unit.INSTANCE;
                        }
                    };
                    this.label = 1;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(ShadeModeInteractor shadeModeInteractor, DisplayStateInteractor displayStateInteractor, Continuation continuation) {
            super(2, continuation);
            this.$shadeModeInteractor = shadeModeInteractor;
            this.$displayStateInteractor = displayStateInteractor;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            AnonymousClass2 anonymousClass2 = QSSceneAdapterImpl.this.new AnonymousClass2(this.$shadeModeInteractor, this.$displayStateInteractor, continuation);
    ...
    public final void dump(PrintWriter printWriter, String[] strArr) {
        ...
        if (qSImpl != null) {
            qSImpl.mContainer.getClass();
            SceneContainerFlag.unsafeAssertInNewMode();
            throw null;
        }
        printWriter.println("QQS height: 0");
    ...
    public QSSceneAdapterImpl(QSSceneComponent.Factory factory, Provider provider, ShadeModeInteractor shadeModeInteractor, DisplayStateInteractor displayStateInteractor, DumpManager dumpManager, CoroutineDispatcher coroutineDispatcher, CoroutineScope coroutineScope, ConfigurationInteractor configurationInteractor) {
        this(factory, provider, shadeModeInteractor, displayStateInteractor, dumpManager, coroutineDispatcher, coroutineScope, configurationInteractor, AnonymousClass1.INSTANCE);
    }
}
