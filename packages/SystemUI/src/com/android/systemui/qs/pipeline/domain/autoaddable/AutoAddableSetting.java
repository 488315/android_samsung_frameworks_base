...
public final class AutoAddableSetting implements AutoAddable {
    ...
    /* renamed from: com.android.systemui.qs.pipeline.domain.autoaddable.AutoAddableSetting$autoAddSignal$1, reason: invalid class name */
    ...
    public final Flow autoAddSignal(final int i) {
        final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AnonymousClass1(null), SettingsProxyExt.INSTANCE.observerFlow(this.secureSettings, i, this.setting));
        final Flow flowDistinctUntilChanged = FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.qs.pipeline.domain.autoaddable.AutoAddableSetting$autoAddSignal$$inlined$map$1
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        AutoAddableSetting autoAddableSetting = this.this$0;
                        Boolean boolValueOf = Boolean.valueOf(autoAddableSetting.secureSettings.getIntForUser(autoAddableSetting.setting, 0, this.$userId$inlined) != 0);
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        AutoAddSignal.Add add = new AutoAddSignal.Add(this.this$0.spec, 0, 2, null);
                        anonymousClass1.label = 1;
