...
final class UserTileSpecRepository$startFlowCollections$1 extends SuspendLambda implements Function2 {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.qs.pipeline.data.repository.UserTileSpecRepository.startFlowCollections.1.1.1
                    ...
                    public final Object emit(Object obj2, Continuation continuation) throws Throwable {
                        UserTileSpecRepository userTileSpecRepository2 = userTileSpecRepository;
                        Object objAccess$storeTiles = UserTileSpecRepository.access$storeTiles(userTileSpecRepository2, userTileSpecRepository2.userId, (List) obj2, continuation);
    ...
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
        ...
        final class AnonymousClass1 extends SuspendLambda implements Function2 {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    Function0 function0 = new Function0() { // from class: com.android.systemui.qs.pipeline.data.repository.UserTileSpecRepository$startFlowCollections$1$2$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            userTileSpecRepository2.secureSettings.unregisterContentObserverSync(r1);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                final UserTileSpecRepository userTileSpecRepository = this.this$0;
                Flow flowFlowOn = FlowKt.flowOn(new Flow() { // from class: com.android.systemui.qs.pipeline.data.repository.UserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1
                        ...
                        */
                        public final Object emit(Object obj, Continuation continuation) throws Throwable {
                            ...
                            if (i2 == 0) {
                                ...
                                UserTileSpecRepository userTileSpecRepository = this.this$0;
                                int i3 = userTileSpecRepository.userId;
                                flowCollector = this.$this_unsafeFlow;
                                anonymousClass1.L$0 = flowCollector;
                                anonymousClass1.label = 1;
                                objLoadTilesFromSettings = userTileSpecRepository.loadTilesFromSettings(i3, anonymousClass1);
                    ...
                    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                        Object objCollect = flowConflatedCallbackFlow.collect(new AnonymousClass2(flowCollector, userTileSpecRepository), continuation);
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.qs.pipeline.data.repository.UserTileSpecRepository.startFlowCollections.1.2.3
                    ...
                    public final Object emit(Object obj2, Continuation continuation) throws Throwable {
                        ...
                        Object objAccess$storeTiles = UserTileSpecRepository.access$storeTiles(userTileSpecRepository3, userTileSpecRepository3.userId, list, continuation);
                        return objAccess$storeTiles == CoroutineSingletons.COROUTINE_SUSPENDED ? objAccess$storeTiles : Unit.INSTANCE;
                    }
                };
                this.label = 1;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        CoroutineTracingKt.launchTraced$default(coroutineScope, null, null, new AnonymousClass1(this.$tiles, this.this$0, null), 7);
        CoroutineTracingKt.launchTraced$default(coroutineScope, null, null, new AnonymousClass2(this.this$0, this.$tiles, null), 7);
        return Unit.INSTANCE;
    }
}
