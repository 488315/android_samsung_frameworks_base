...
public final class QQSTileSpecSettingsRepository implements TileSpecRepository {
    ...
    public final Lazy retailModeTiles$delegate = LazyKt__LazyJVMKt.lazy(new Function0() { // from class: com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$$ExternalSyntheticLambda0
        ...
        public final Object invoke() {
            int i = 0;
            List<String> split$default = StringsKt__StringsKt.split$default(QQSTileSpecSettingsRepository.this.resources.getString(R.string.quick_settings_tiles_retail_mode), new String[]{","}, 0, 6);
    ...
    public final Object addTile(int i, TileSpec tileSpec, int i2, SuspendLambda suspendLambda) {
        ...
        if (z) {
            ...
            emit = qQSUserTileSpecRepository.changeEvents.emit(new QQSUserTileSpecRepository.AddTile(tileSpec, i2), suspendLambda);
    ...
    public final Object prependDefault(int i, SuspendLambda suspendLambda) {
        ...
        Object emit = qQSUserTileSpecRepository.changeEvents.emit(new QQSUserTileSpecRepository.PrependDefault(qQSUserTileSpecRepository.defaultTilesRepository.getDefaultTiles()), suspendLambda);
    ...
    public final Object removeTiles(int i, Collection collection, SuspendLambda suspendLambda) {
        ...
        Object emit = qQSUserTileSpecRepository.changeEvents.emit(new QQSUserTileSpecRepository.RemoveTiles(collection), suspendLambda);
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.COROUTINE_SUSPENDED;
        if (emit != coroutineSingletons) {
            emit = Unit.INSTANCE;
        }
    ...
    public final Object resetToDefault(int i, SuspendLambda suspendLambda) {
        ...
        Object emit = qQSUserTileSpecRepository.changeEvents.emit(new QQSUserTileSpecRepository.ResetToDefault(qQSUserTileSpecRepository.defaultTilesRepository.getDefaultTiles()), suspendLambda);
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.COROUTINE_SUSPENDED;
        if (emit != coroutineSingletons) {
            emit = Unit.INSTANCE;
        }
    ...
    public final Object setTiles(int i, List list, SuspendLambda suspendLambda) {
        ...
        Object emit = qQSUserTileSpecRepository.changeEvents.emit(new QQSUserTileSpecRepository.ChangeTiles(list), suspendLambda);
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.COROUTINE_SUSPENDED;
        if (emit != coroutineSingletons) {
            emit = Unit.INSTANCE;
        }
    ...
    */
    public final java.lang.Object tilesSpecs(int r5, kotlin.coroutines.jvm.internal.ContinuationImpl r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$1
            if (r0 == 0) goto L13
            r0 = r6
            com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$1 r0 = (com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$1) r0
            int r1 = r0.label
            ...
            goto L18
        L13:
            com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$1 r0 = new com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$1
            r0.<init>(r4, r6)
        L18:
            ...
            com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository r4 = (com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository) r4
        ...
        L33:
            ...
            if (r6 != 0) goto L49
            com.android.systemui.qs.pipeline.data.repository.QQSUserTileSpecRepository$Factory r6 = r4.userTileSpecRepositoryFactory
            com.android.systemui.qs.pipeline.data.repository.QQSUserTileSpecRepository r6 = r6.create(r5)
        ...
        L5c:
            ...
            com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$$inlined$flatMapLatest$1 r0 = new com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository$tilesSpecs$$inlined$flatMapLatest$1
            r1 = 0
            r0.<init>(r1, r4, r6)
            kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest r4 = kotlinx.coroutines.flow.FlowKt.transformLatest(r5, r0)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.qs.pipeline.data.repository.QQSTileSpecSettingsRepository.tilesSpecs(int, kotlin.coroutines.jvm.internal.ContinuationImpl):java.lang.Object");
    }
}
