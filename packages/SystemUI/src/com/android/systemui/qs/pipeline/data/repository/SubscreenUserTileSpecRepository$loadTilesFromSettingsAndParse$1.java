...
final class SubscreenUserTileSpecRepository$loadTilesFromSettingsAndParse$1 extends ContinuationImpl {
    int I$0;
    Object L$0;
    int label;
    ...
    public SubscreenUserTileSpecRepository$loadTilesFromSettingsAndParse$1(SubscreenUserTileSpecRepository subscreenUserTileSpecRepository, Continuation continuation) {
        super(continuation);
