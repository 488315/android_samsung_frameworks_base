            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository.startFlowCollections.1.1.1
                    ...
                    public final Object emit(Object obj2, Continuation continuation) {
                        SubscreenUserTileSpecRepository subscreenUserTileSpecRepository2 = SubscreenUserTileSpecRepository.this;
                        Object access$storeTiles = SubscreenUserTileSpecRepository.access$storeTiles(subscreenUserTileSpecRepository2, subscreenUserTileSpecRepository2.userId, (List) obj2, continuation);
    ...
    final class AnonymousClass2 extends SuspendLambda implements Function2 {
                ...
                if (i == 0) {
                    ...
                    Function0 function0 = new Function0() { // from class: com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$1$$ExternalSyntheticLambda0
                        ...
                        public final Object invoke() {
                            SubscreenUserTileSpecRepository.this.secureSettings.unregisterContentObserverSync(r1);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                final SubscreenUserTileSpecRepository subscreenUserTileSpecRepository = this.this$0;
                Flow flowOn = FlowKt.flowOn(new Flow() { // from class: com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1
                    ...
                    public final class AnonymousClass2 implements FlowCollector {
                        ...
                        */
                        public final java.lang.Object emit(java.lang.Object r6, kotlin.coroutines.Continuation r7) {
                            /*
                                r5 = this;
                                boolean r0 = r7 instanceof com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1.AnonymousClass2.AnonymousClass1
                                if (r0 == 0) goto L13
                                r0 = r7
                                com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1$2$1 r0 = (com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1.AnonymousClass2.AnonymousClass1) r0
                                int r1 = r0.label
                                ...
                                goto L18
                            L13:
                                com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1$2$1 r0 = new com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1$2$1
                                r0.<init>(r7)
                            L18:
                            ...
                            L3a:
                                ...
                                com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository r6 = r5.this$0
                                int r7 = r6.userId
                            ...
                            L5c:
                                ...
                                return r5
                            */
                            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository$startFlowCollections$1$2$invokeSuspend$$inlined$map$1.AnonymousClass2.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                        }
                    }

                    @Override // kotlinx.coroutines.flow.Flow
                    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                        Object collect = Flow.this.collect(new AnonymousClass2(flowCollector, subscreenUserTileSpecRepository), continuation);
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.qs.pipeline.data.repository.SubscreenUserTileSpecRepository.startFlowCollections.1.2.3
                    ...
                    public final Object emit(Object obj2, Continuation continuation) {
                        ...
                        Object access$storeTiles = SubscreenUserTileSpecRepository.access$storeTiles(subscreenUserTileSpecRepository3, subscreenUserTileSpecRepository3.userId, list, continuation);
                        return access$storeTiles == CoroutineSingletons.COROUTINE_SUSPENDED ? access$storeTiles : Unit.INSTANCE;
                    }
                };
                this.label = 1;
