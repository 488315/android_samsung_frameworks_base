...
public class WifiDebuggingActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        View inflate = LayoutInflater.from(alertParams.mContext).inflate(android.R.layout.app_not_authorized, (ViewGroup) null);
        CheckBox checkBox = (CheckBox) inflate.findViewById(android.R.id.ampm_layout);
    ...
    public final void onStart() {
        ...
        sendBroadcast(new Intent(PopupUIUtil.ACTION_CLOSE_SYSTEM_DIALOGS));
    }
