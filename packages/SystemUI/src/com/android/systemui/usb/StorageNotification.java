...
public class StorageNotification implements CoreStartable {
    ...
    public final AnonymousClass4 mSDCardPolicyToastReceiver = new BroadcastReceiver(this) { // from class: com.android.systemui.usb.StorageNotification.4
        ...
        public final void onReceive(Context context, Intent intent) {
            if ("com.samsung.intent.action.SDCARD_ITPOLICY_TOAST_EVENT".equals(intent.getAction())) {
                ...
                Toast.makeText(context, 17042591, 1).show();
            }
        }
    };
    public final AnonymousClass5 mBadRemovalReceiver = new BroadcastReceiver() { // from class: com.android.systemui.usb.StorageNotification.5
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            if (stringExtra.contains("BAD_REMOVAL")) {
                ...
                String string = storageNotification2.mContext.getString(R.string.locale_replacement);
                String string2 = storageNotification2.mContext.getString(17042859);
                if (stringExtra.contains(PeripheralConstants.ConnectivityType.USB)) {
                    string2 = storageNotification2.mContext.getString(17043469);
                    i = 17304593;
                    i2 = 122;
                } else {
                ...
                String string3 = storageNotification2.mContext.getString(R.string.loading);
                Intent intent2 = new Intent();
                intent2.setClassName("android", "com.android.server.StorageManagerService$StorageBadRemovalReceiver");
                intent2.putExtra("msg", "reboot");
    ...
    public final AnonymousClass12 mMoveCallback = new PackageManager.MoveCallback() { // from class: com.android.systemui.usb.StorageNotification.12
        ...
        public final void onStatusChanged(int i, int i2, long j) {
            String string;
            String string2;
            StringBuilder m = MutableObjectList$$ExternalSyntheticOutline0.m(i, i2, "mMoveCallback (", ", ", ", ");
            m.append(j);
            m.append(")");
            ...
            if (!PackageManager.isMoveStatusFinished(i2)) {
                if (((Integer) StorageNotification.this.mPrevStatus.get(Integer.valueOf(i))).intValue() != i2) {
                    ...
                    String string3 = !TextUtils.isEmpty(moveInfo.label) ? storageNotification.mContext.getString(R.string.kg_login_instructions, moveInfo.label) : storageNotification.mContext.getString(R.string.kg_login_submit_button);
            ...
            if (str != null) {
                ...
                if (i2 == -100) {
                    string = storageNotification2.mContext.getString(R.string.kg_login_password_hint);
                    string2 = storageNotification2.mContext.getString(R.string.kg_login_invalid_input, bestVolumeDescription);
                } else {
                    string = storageNotification2.mContext.getString(R.string.kg_login_checking_password);
                    string2 = storageNotification2.mContext.getString(R.string.kg_login_account_recovery_hint);
                }
    ...
    public final Notification.Builder buildNotificationBuilder(VolumeInfo volumeInfo, CharSequence charSequence, CharSequence charSequence2) {
        ...
        DiskInfo disk = volumeInfo.getDisk();
        volumeInfo.getState();
        Notification.Builder extend = builder.setSmallIcon((!disk.isSd() && disk.isUsb()) ? 17304593 : R.drawable.stat_notify_sdcard).setColor(this.mContext.getColor(R.color.system_notification_accent_color)).setContentTitle(charSequence).setContentText(charSequence2).setStyle(new Notification.BigTextStyle().bigText(charSequence2)).setVisibility(1).setShowWhen(false).setLocalOnly(true).extend(new Notification.TvExtender());
    ...
    public final void onDiskScannedInternal(DiskInfo diskInfo, int i) {
        ...
        String string = this.mContext.getString(R.string.leave_accessibility_shortcut_on, diskInfo.getDescription());
        String string2 = this.mContext.getString(R.string.launch_warning_title, diskInfo.getDescription());
    ...
    /* JADX WARN: Removed duplicated region for block: B:22:0x039c A[ADDED_TO_REGION] */
    ...
    */
    ...
    public final void showExtStorageReadOnlyMountNoti(String str, boolean z) {
        ...
        if (equalsIgnoreCase) {
            string = this.mContext.getString(17042876);
            string2 = this.mContext.getString(17042875);
        } else if (str.equalsIgnoreCase("usb")) {
            string = this.mContext.getString(17043572);
            string2 = this.mContext.getString(17043571);
            i2 = 17304593;
        } else {
            string = this.mContext.getString(17042876);
            string2 = this.mContext.getString(17042875);
    ...
    public final void showSDcardErrorNoti(boolean z) {
        ...
        String string = this.mContext.getString(17042873);
        String string2 = this.mContext.getString(17042872);
        ...
        for (VolumeRecord volumeRecord : this.mStorageManager.getVolumeRecords()) {
            if (volumeRecord.getType() == 1) {
                ...
                if ((findVolumeByUuid == null || !findVolumeByUuid.isMountedWritable()) && !volumeRecord.isSnoozed()) {
                    String string = this.mContext.getString(R.string.kg_invalid_sim_puk_hint, volumeRecord.getNickname());
                    String string2 = this.mContext.getString(R.string.kg_invalid_sim_pin_hint);
