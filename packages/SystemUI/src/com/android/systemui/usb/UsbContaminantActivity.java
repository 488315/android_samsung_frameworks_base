...
public class UsbContaminantActivity extends Activity implements View.OnClickListener {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        window.addSystemFlags(NetworkAnalyticsConstants.DataPoints.FLAG_INTERFACE_NAME);
        window.setType(2008);
        ...
        if (getResources().getBoolean(android.R.bool.config_supportsInsecureLockScreen)) {
