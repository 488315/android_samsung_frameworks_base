    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.mForwardResolveInfo != null) {
            if (arrayList2.size() > 1) {
                ...
                intent4.setComponent(ComponentName.unflattenFromString(getResources().getString(R.string.face_dangling_notification_title)));
        ...
        super.onCreate(bundle, intent2, getResources().getText(R.string.config_screenshotErrorReceiverComponent), (Intent[]) null, arrayList, true);
        CheckBox checkBox = (CheckBox) findViewById(R.id.ampm_layout);
        if (checkBox != null) {
