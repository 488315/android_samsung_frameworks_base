...
public final class UserActionModel {
    ...
    public static final UserActionModel SIGN_OUT;
    ...
    static {
        ...
        UserActionModel userActionModel5 = new UserActionModel("SIGN_OUT", 4);
        SIGN_OUT = userActionModel5;
        UserActionModel[] userActionModelArr = {userActionModel, userActionModel2, userActionModel3, userActionModel4, userActionModel5};
