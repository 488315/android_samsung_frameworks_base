...
public final class UserRecord {
    ...
    public UserRecord() {
        this(null, null, false, false, false, false, false, false, false, null, false, CustomDeviceManager.SETTINGS_ALL_PREVIOUS, null);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.info, userRecord.info) && Intrinsics.areEqual(this.picture, userRecord.picture) && this.isGuest == userRecord.isGuest && this.isCurrent == userRecord.isCurrent && this.isAddUser == userRecord.isAddUser && this.isRestricted == userRecord.isRestricted && this.isSwitchToEnabled == userRecord.isSwitchToEnabled && this.isAddSupervisedUser == userRecord.isAddSupervisedUser && this.isSignOut == userRecord.isSignOut && Intrinsics.areEqual(this.enforcedAdmin, userRecord.enforcedAdmin) && this.isManageUsers == userRecord.isManageUsers;
    }
    ...
    public final String toString() {
        ...
        sb.append(", isSignOut=");
        sb.append(this.isSignOut);
        sb.append(", enforcedAdmin=");
        sb.append(this.enforcedAdmin);
        sb.append(", isManageUsers=");
        return MoveResult$$ExternalSyntheticOutline0.m(sb, this.isManageUsers, ")");
    }

    public UserRecord(UserInfo userInfo, Bitmap bitmap, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, RestrictedLockUtils.EnforcedAdmin enforcedAdmin, boolean z8) {
        this.info = userInfo;
        this.picture = bitmap;
        this.isGuest = z;
        this.isCurrent = z2;
        ...
        this.isManageUsers = z8;
    }

    public /* synthetic */ UserRecord(UserInfo userInfo, Bitmap bitmap, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, RestrictedLockUtils.EnforcedAdmin enforcedAdmin, boolean z8, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : userInfo, (i & 2) != 0 ? null : bitmap, (i & 4) != 0 ? false : z, (i & 8) != 0 ? false : z2, (i & 16) != 0 ? false : z3, (i & 32) != 0 ? false : z4, (i & 64) != 0 ? false : z5, (i & 128) != 0 ? false : z6, (i & 256) != 0 ? false : z7, (i & 512) != 0 ? null : enforcedAdmin, (i & 1024) != 0 ? false : z8);
    }
}
