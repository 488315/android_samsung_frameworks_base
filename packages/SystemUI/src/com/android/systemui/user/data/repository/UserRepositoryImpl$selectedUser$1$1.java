        ...
        if (i == 0) {
            ...
            final ?? r1 = new UserTracker.Callback() { // from class: com.android.systemui.user.data.repository.UserRepositoryImpl$selectedUser$1$1$callback$1
                ...
                public final void onBeforeUserSwitching(int i2) {
                    UserRepositoryImpl$selectedUser$1$1.invokeSuspend$send(ref$ObjectRef, producerScope, userRepositoryImpl, SelectionStatus.SELECTION_IN_PROGRESS);
                }
                ...
                public final void onUserChanged(int i2, Context context) {
                    UserRepositoryImpl$selectedUser$1$1.invokeSuspend$send(ref$ObjectRef, producerScope, userRepositoryImpl, SelectionStatus.SELECTION_COMPLETE);
                }
            };
