...
public final class UserSwitcherInteractor {
    ...
    */
    public static final java.lang.Object access$onBroadcastReceived(com.android.systemui.user.domain.interactor.UserSwitcherInteractor r6, android.content.Intent r7, android.content.pm.UserInfo r8, kotlin.coroutines.jvm.internal.ContinuationImpl r9) {
        ...
        L63:
            ...
            com.android.app.tracing.coroutines.CoroutineTracingKt.launchTraced$default(r2, r3, r3, r8, r9)
        ...
        La0:
            ...
            com.android.app.tracing.coroutines.CoroutineTracingKt.launchTraced$default(r6, r8, r3, r7, r9)
        Lb4:
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object access$toRecord(com.android.systemui.user.domain.interactor.UserSwitcherInteractor r24, android.content.pm.UserInfo r25, int r26, kotlin.coroutines.jvm.internal.ContinuationImpl r27) {
        /*
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:39:0x0170 -> B:11:0x0173). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object access$toUserModels(com.android.systemui.user.domain.interactor.UserSwitcherInteractor r18, java.util.List r19, int r20, boolean r21, kotlin.coroutines.jvm.internal.ContinuationImpl r22) {
        /*
    ...
    public final void addCallback(UserCallback userCallback) {
        CoroutineTracingKt.launchTraced$default(this.applicationScope, null, null, new UserSwitcherInteractor$addCallback$1(this, userCallback, null), 7);
    }
    ...
    */
    ...
    public final void executeAction(UserActionModel userActionModel, final DialogShowerImpl dialogShowerImpl) {
        ...
        if (i == 1) {
            ...
            Function1 function1 = new Function1() { // from class: com.android.systemui.user.domain.interactor.UserSwitcherInteractor$$ExternalSyntheticLambda1
                ...
                public final Object mo779invoke(Object obj) {
                    ...
                    UserSwitcherInteractor.this.selectUser(intValue, dialogShowerImpl);
                    return Unit.INSTANCE;
                }
            };
            GuestUserInteractor guestUserInteractor = this.guestUserInteractor;
            guestUserInteractor.getClass();
            CoroutineTracingKt.launchTraced$default(guestUserInteractor.applicationScope, null, null, new GuestUserInteractor$createAndSwitchTo$1(guestUserInteractor, userSwitcherInteractor$executeAction$1, userSwitcherInteractor$executeAction$2, function1, null), 7);
            return;
        }
        if (i == 2) {
        ...
        if (i == 3) {
            ...
            dismissDialog();
            activityStarter.startActivity(new Intent().setAction("android.os.action.CREATE_SUPERVISED_USER").setPackage(this.applicationContext.getString(R.string.face_or_screen_lock_app_setting_name)).addFlags(268435456), true);
        } else if (i == 4) {
            ...
            dismissDialog();
            CoroutineTracingKt.launchTraced$default(this.applicationScope, null, null, new UserSwitcherInteractor$executeAction$4(this, null), 7);
        }
    }
    ...
    public final void exitGuestUser(int i, int i2, boolean z) {
        ...
        if (selectedUserInfo.isGuest()) {
            CoroutineTracingKt.launchTraced$default(guestUserInteractor.applicationScope, null, null, new GuestUserInteractor$exit$1(guestUserInteractor, i2, selectedUserInfo, z, userSwitcherInteractor$exitGuestUser$1, userSwitcherInteractor$exitGuestUser$2, userSwitcherInteractor$exitGuestUser$3, null), 7);
        } else {
    ...
    */
    ...
    public final void removeCallback(UserCallback userCallback) {
        CoroutineTracingKt.launchTraced$default(this.applicationScope, null, null, new UserSwitcherInteractor$removeCallback$1(this, userCallback, null), 7);
    }

    public final void removeGuestUser(int i) {
        CoroutineTracingKt.launchTraced$default(this.applicationScope, null, null, new UserSwitcherInteractor$removeGuestUser$1(this, i, -10000, null), 7);
    }
    ...
    public final void selectUser(int i, DialogShowerImpl dialogShowerImpl) {
        ...
        if (i == i2 && selectedUserInfo.isGuest()) {
            showDialog(new ShowDialogRequestModel.ShowExitGuestDialog(selectedUserInfo.id, userRepositoryImpl.lastSelectedNonGuestUserId, selectedUserInfo.isEphemeral(), keyguardInteractor.isKeyguardShowing(), new UserSwitcherInteractor$selectUser$1(this), dialogShowerImpl));
        } else {
            if (selectedUserInfo.isGuest()) {
                showDialog(new ShowDialogRequestModel.ShowExitGuestDialog(selectedUserInfo.id, i, selectedUserInfo.isEphemeral(), keyguardInteractor.isKeyguardShowing(), new UserSwitcherInteractor$selectUser$2(this), dialogShowerImpl));
                return;
            }
    ...
    public final void switchUser(final int i) {
        ...
        CoroutineTracingKt.launchTraced$default(this.applicationScope, null, null, new UserSwitcherInteractor$switchUser$1(this, new Runnable() { // from class: com.android.systemui.user.domain.interactor.UserSwitcherInteractor$switchUser$runnable$1
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object access$toRecord(com.android.systemui.user.domain.interactor.UserSwitcherInteractor r23, com.android.systemui.user.shared.model.UserActionModel r24, int r25, boolean r26, kotlin.coroutines.jvm.internal.ContinuationImpl r27) {
        /*
