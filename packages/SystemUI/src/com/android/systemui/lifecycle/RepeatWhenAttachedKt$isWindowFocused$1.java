...
final class RepeatWhenAttachedKt$isWindowFocused$1 extends SuspendLambda implements Function2 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Boolean valueOf = Boolean.valueOf(this.$this_isWindowFocused.hasWindowFocus());
                this.label = 1;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (viewTreeObserver != null) {
            ...
            Flow conflatedCallbackFlow = FlowConflatedKt.conflatedCallbackFlow(new RepeatWhenAttachedKt$isWindowFocused$2(viewTreeObserver, null));
            if (conflatedCallbackFlow != null) {
                return new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AnonymousClass1(this.$this_isWindowFocused, null), conflatedCallbackFlow);
            }
        }
