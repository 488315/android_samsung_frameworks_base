...
public final /* synthetic */ class HighlightDbHelper$$ExternalSyntheticLambda0 implements BiConsumer {
    ...
    public final void accept(Object obj, Object obj2) throws SQLException {
        ...
        switch (i) {
            ...
            default:
                ...
                StringBuilder sbM = ActivityResultRegistry$register$3$$ExternalSyntheticOutline0.m("CREATE TABLE ", str, " (");
                ...
                sbM.append(");");
                sQLiteDatabase.execSQL(sbM.toString());
                break;
        }
    }
}
