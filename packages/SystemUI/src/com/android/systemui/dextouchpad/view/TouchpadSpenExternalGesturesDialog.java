...
public class TouchpadSpenExternalGesturesDialog extends AlertDialog {
    ...
    public final void onCreate(Bundle bundle) throws Resources.NotFoundException, NoSuchMethodException, SecurityException {
        ...
        View viewInflate = this.mInflater.inflate(R.layout.dialog_spen_gestures_external, new LinearLayout(this.mContext));
        ...
        for (int i = 0; i < sPenGesturesGuideItems.mItemList.size(); i++) {
            View viewInflate2 = this.mInflater.inflate(R.layout.dialog_spen_gestures_external_content, (ViewGroup) null);
            TextView textView = (TextView) viewInflate2.findViewById(R.id.title);
            TextView textView2 = (TextView) viewInflate2.findViewById(R.id.content_text);
