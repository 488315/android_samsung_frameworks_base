...
public final class KnoxStateMonitorImpl implements KnoxStateMonitor, Dumpable {
    ...
    public final boolean isAirplaneModeTileBlocked() {
        ...
        return (edmMonitor.mSettingsChangesAllowed && edmMonitor.mAirplaneModeAllowed) ? false : true;
    }
    ...
    public final boolean isBluetoothTileBlocked() {
        ...
        Context context = edmMonitor.knoxStateMonitor.mContext;
        return (edmMonitor.mSettingsChangesAllowed && edmMonitor.mBluetoothAllowed) ? false : true;
    }
    ...
    public final boolean isBrightnessBlocked() {
        ...
        Context context = edmMonitor.knoxStateMonitor.mContext;
        return !edmMonitor.mSettingsChangesAllowed;
    }

    public final boolean isBrightnessControllerEnabled() {
        CustomSdkMonitor customSdkMonitor = this.mCustomSdkMonitor;
        return customSdkMonitor != null && (customSdkMonitor.mKnoxCustomQuickPanelButtons & 4) == 4;
    }
    ...
    public final boolean isMobileDataTileBlocked() {
        ...
        Context context = edmMonitor.knoxStateMonitor.mContext;
        return (edmMonitor.mSettingsChangesAllowed && edmMonitor.mCellularDataAllowed) ? false : true;
    }
    ...
    public final boolean isStatusBarHidden() {
        CustomSdkMonitor customSdkMonitor = this.mCustomSdkMonitor;
        if (customSdkMonitor != null) {
            return customSdkMonitor.mIsCustomSdkStatusBarHidden || this.mEdmMonitor.mIsStatusBarHidden;
        }
        return false;
    }
    ...
    public final boolean isWifiHotspotTileBlocked() {
        ...
        Context context = edmMonitor.knoxStateMonitor.mContext;
        return (edmMonitor.mSettingsChangesAllowed && edmMonitor.mWifiTetheringAllowed) ? false : true;
    }
    ...
    public final boolean isWifiTileBlocked() {
        ...
        Context context = edmMonitor.knoxStateMonitor.mContext;
        return (edmMonitor.mSettingsChangesAllowed && edmMonitor.mWifiAllowed && edmMonitor.mWifiStateChangeAllowed) ? false : true;
    }
