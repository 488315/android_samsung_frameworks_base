...
public final class CommunalScene extends ExclusiveActivatable implements Scene {
    ...
    public CommunalScene(CommunalViewModel communalViewModel, CommunalUserActionsViewModel.Factory factory, CommunalColors communalColors, CommunalContent communalContent) {
        ...
        CommunalUserActionsViewModel create = factory.create();
        this.actionsViewModel = create;
        this.userActions = create.actions;
    }
    ...
    */
    public final java.lang.Object onActivated(kotlin.coroutines.Continuation r5) {
        /*
            r4 = this;
            boolean r0 = r5 instanceof com.android.systemui.communal.ui.compose.CommunalScene$onActivated$1
            if (r0 == 0) goto L13
            r0 = r5
            com.android.systemui.communal.ui.compose.CommunalScene$onActivated$1 r0 = (com.android.systemui.communal.ui.compose.CommunalScene$onActivated$1) r0
            int r1 = r0.label
            ...
            goto L18
        L13:
            com.android.systemui.communal.ui.compose.CommunalScene$onActivated$1 r0 = new com.android.systemui.communal.ui.compose.CommunalScene$onActivated$1
            r0.<init>(r4, r5)
        L18:
        ...
        L2f:
            kotlin.ResultKt.throwOnFailure(r5)
            r0.label = r3
            com.android.systemui.communal.ui.viewmodel.CommunalUserActionsViewModel r4 = r4.actionsViewModel
        ...
        L3d:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.communal.ui.compose.CommunalScene.onActivated(kotlin.coroutines.Continuation):java.lang.Object");
    }
}
