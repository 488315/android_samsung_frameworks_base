...
public final class PosturingInteractor {
    ...
    public PosturingInteractor(PosturingRepository posturingRepository, AsyncSensorManager asyncSensorManager, CoroutineScope coroutineScope, CoroutineDispatcher coroutineDispatcher, LogBuffer logBuffer, SystemClock systemClock) {
        ...
        StateFlowImpl stateFlowImplMutableStateFlow = StateFlowKt.MutableStateFlow(unknown);
        this.debugPostured = stateFlowImplMutableStateFlow;
        Sensor defaultSensor = asyncSensorManager.getDefaultSensor(25);
        final Flow flowObserveTriggerSensor = defaultSensor == null ? EmptyFlow.INSTANCE : AsyncSensorManagerExtKt.observeTriggerSensor(asyncSensorManager, defaultSensor);
        FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new Flow() { // from class: com.android.systemui.communal.posturing.domain.interactor.PosturingInteractor$special$$inlined$map$1
            ...
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = flowObserveTriggerSensor.collect(new AnonymousClass2(flowCollector), continuation);
        ...
        final Flow flowObserveTriggerSensor2 = defaultSensor2 == null ? EmptyFlow.INSTANCE : AsyncSensorManagerExtKt.observeTriggerSensor(asyncSensorManager, defaultSensor2);
        FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$12 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new Flow() { // from class: com.android.systemui.communal.posturing.domain.interactor.PosturingInteractor$special$$inlined$map$2
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = flowObserveTriggerSensor2.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        PositionState.StationaryState stationaryState = ((PositionState) obj).stationary;
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(stationaryState, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        if (!(((PositionState.StationaryState) obj) instanceof PositionState.StationaryState.Unknown)) {
                            anonymousClass1.label = 1;
        ...
        ChannelLimitedFlowMerge channelLimitedFlowMergeMerge = FlowKt.merge(flowKt__TransformKt$onEach$$inlined$unsafeTransform$1, flowKt__TransformKt$onEach$$inlined$unsafeTransform$12, new Flow() { // from class: com.android.systemui.communal.posturing.domain.interactor.PosturingInteractor$special$$inlined$map$4
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        PositionState.StationaryState stationaryState = (PositionState.StationaryState) obj;
                        Float f = new Float(stationaryState instanceof PositionState.StationaryState.Stationary ? ((PositionState.StationaryState.Stationary) stationaryState).confidence : Float.NEGATIVE_INFINITY);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(f, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        List list = (List) obj;
                        double dAverageOfFloat = CollectionsKt___CollectionsKt.averageOfFloat(list);
                        Logger logger = this.this$0.logger;
                        LogMessage logMessageObtain = logger.getBuffer().obtain(logger.getTag(), LogLevel.INFO, PosturingInteractor$stationarySmoothed$9$1.INSTANCE, null);
                        logMessageObtain.setStr1(CollectionsKt___CollectionsKt.joinToString$default(list, null, "[", "]", new PosturingInteractorKt$$ExternalSyntheticLambda0(), 25));
                        logMessageObtain.setDouble1(dAverageOfFloat);
                        logger.getBuffer().commit(logMessageObtain);
                        Boolean boolValueOf = Boolean.valueOf(dAverageOfFloat > 0.800000011920929d);
                        anonymousClass1.label = 1;
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        PositionState.OrientationState orientationState = ((PositionState) obj).orientation;
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(orientationState, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        if (!(((PositionState.OrientationState) obj) instanceof PositionState.OrientationState.Unknown)) {
                            anonymousClass1.label = 1;
                            if (this.$this_unsafeFlow.emit(obj, anonymousClass1) == coroutineSingletons) {
                                return coroutineSingletons;
                            }
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        PositionState.OrientationState orientationState = (PositionState.OrientationState) obj;
                        Float f = new Float(orientationState instanceof PositionState.OrientationState.Postured ? ((PositionState.OrientationState.Postured) orientationState).confidence : Float.NEGATIVE_INFINITY);
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(f, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        double dAverageOfFloat = CollectionsKt___CollectionsKt.averageOfFloat(list);
                        Logger logger = this.this$0.logger;
                        LogMessage logMessageObtain = logger.getBuffer().obtain(logger.getTag(), LogLevel.INFO, PosturingInteractor$orientationSmoothed$5$1.INSTANCE, null);
                        logMessageObtain.setStr1(CollectionsKt___CollectionsKt.joinToString$default(list, null, "[", "]", new PosturingInteractorKt$$ExternalSyntheticLambda0(), 25));
                        logMessageObtain.setDouble1(dAverageOfFloat);
                        logger.getBuffer().commit(logMessageObtain);
                        Boolean boolValueOf = Boolean.valueOf(dAverageOfFloat > 0.800000011920929d);
        ...
        final Flow flowAllOf = BooleanFlowOperators.INSTANCE.allOf(r8, r7);
        Flow flowFlowOn = FlowKt.flowOn(new Flow() { // from class: com.android.systemui.communal.posturing.domain.interactor.PosturingInteractor$special$$inlined$map$9
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Object obj3 = ((Boolean) obj).booleanValue() ? PosturedState.Postured.INSTANCE : PosturedState.NotPostured.INSTANCE;
                        anonymousClass1.label = 1;
