    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if ((list2 instanceof Collection) && list2.isEmpty()) {
                ...
                flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(arrayList);
                this.label = 1;
                ...
                while (it.hasNext()) {
                    if (((CommunalWidgetRepositoryLocalImpl.CommunalWidgetEntry) it.next()).providerInfo == null) {
                        ...
                        flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = new Flow() { // from class: com.android.systemui.communal.data.repository.CommunalWidgetRepositoryLocalImpl$communalWidgets$lambda$3$$inlined$map$1
                            ...
                            public final class AnonymousClass2 implements FlowCollector {
                                ...
                                */
                                public final Object emit(Object obj, Continuation continuation) {
                                    ...
                                    Object next;
                                    CommunalWidgetContentModel.Available pending;
                                    ...
                                    if (i2 == 0) {
                                        ...
                                        List list = (List) obj;
                                        List<CommunalWidgetRepositoryLocalImpl.CommunalWidgetEntry> list2 = this.$widgetEntries$inlined;
                                        ArrayList arrayList = new ArrayList();
                                        for (CommunalWidgetRepositoryLocalImpl.CommunalWidgetEntry communalWidgetEntry : list2) {
                                            int i3 = CommunalWidgetRepositoryLocalImpl.$r8$clinit;
                                            this.this$0.getClass();
                                            if (communalWidgetEntry.providerInfo != null) {
                                                AppWidgetProviderInfo appWidgetProviderInfo = communalWidgetEntry.providerInfo;
                                                appWidgetProviderInfo.getClass();
                                                pending = new CommunalWidgetContentModel.Available(communalWidgetEntry.appWidgetId, appWidgetProviderInfo, communalWidgetEntry.rank, communalWidgetEntry.spanY);
                                            } else {
                                                ComponentName componentNameUnflattenFromString = ComponentName.unflattenFromString(communalWidgetEntry.componentName);
                                                ...
                                                while (true) {
                                                    ...
                                                    next = it.next();
                                                    if (Intrinsics.areEqual(((PackageInstallSession) next).packageName, componentNameUnflattenFromString != null ? componentNameUnflattenFromString.getPackageName() : null)) {
                                                        break;
                                                    }
                                                }
                                                PackageInstallSession packageInstallSession = (PackageInstallSession) next;
                                                pending = (componentNameUnflattenFromString == null || packageInstallSession == null) ? null : new CommunalWidgetContentModel.Pending(communalWidgetEntry.appWidgetId, communalWidgetEntry.rank, componentNameUnflattenFromString, packageInstallSession.icon, packageInstallSession.user, communalWidgetEntry.spanY);
                                            }
                                            if (pending != null) {
                            ...
                            public final Object collect(FlowCollector flowCollector2, Continuation continuation) {
                                Object objCollect = readonlyStateFlow.collect(new AnonymousClass2(flowCollector2, list, communalWidgetRepositoryLocalImpl), continuation);
                ...
                for (CommunalWidgetRepositoryLocalImpl.CommunalWidgetEntry communalWidgetEntry : list2) {
                    ...
                    AppWidgetProviderInfo appWidgetProviderInfo = communalWidgetEntry.providerInfo;
                    appWidgetProviderInfo.getClass();
                    arrayList2.add(new CommunalWidgetContentModel.Available(i3, appWidgetProviderInfo, communalWidgetEntry.rank, communalWidgetEntry.spanY));
                }
                flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(arrayList2);
                this.label = 1;
                if (FlowKt.emitAll(flowCollector, flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2, this) == coroutineSingletons) {
                    return coroutineSingletons;
                }
