        ...
        if (i == 0) {
            ...
            Flow flow = new Flow() { // from class: com.android.systemui.communal.data.repository.CommunalPrefsRepositoryImpl$readKeyForUser$lambda$2$$inlined$map$1
                    ...
                    */
                    public final Object emit(Object obj, Continuation continuation) {
                        ...
                        if (i2 == 0) {
                            ...
                            Boolean boolValueOf = Boolean.valueOf(this.$sharedPrefs$inlined.getBoolean(this.$key$inlined, false));
                ...
                public final Object collect(FlowCollector flowCollector2, Continuation continuation) {
                    Object objCollect = flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1.collect(new AnonymousClass2(flowCollector2, sharedPreferences$1, str), continuation);
