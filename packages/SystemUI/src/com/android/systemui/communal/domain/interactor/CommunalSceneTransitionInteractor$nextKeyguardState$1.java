...
final class CommunalSceneTransitionInteractor$nextKeyguardState$1 extends SuspendLambda implements Function2 {
    ...
    public CommunalSceneTransitionInteractor$nextKeyguardState$1(Continuation continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        CommunalSceneTransitionInteractor$nextKeyguardState$1 communalSceneTransitionInteractor$nextKeyguardState$1 = new CommunalSceneTransitionInteractor$nextKeyguardState$1(continuation);
