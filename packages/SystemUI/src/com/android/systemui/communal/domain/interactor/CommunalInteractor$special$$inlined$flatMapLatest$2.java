...
public final class CommunalInteractor$special$$inlined$flatMapLatest$2 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow communalWidgets = !((Boolean) this.L$1).booleanValue() ? EmptyFlow.INSTANCE : this.this$0.widgetRepository.getCommunalWidgets();
            this.label = 1;
            if (FlowKt.emitAll(flowCollector, communalWidgets, this) == coroutineSingletons) {
