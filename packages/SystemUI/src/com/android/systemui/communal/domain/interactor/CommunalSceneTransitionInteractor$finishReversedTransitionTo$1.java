...
final class CommunalSceneTransitionInteractor$finishReversedTransitionTo$1 extends ContinuationImpl {
    ...
    public CommunalSceneTransitionInteractor$finishReversedTransitionTo$1(CommunalSceneTransitionInteractor communalSceneTransitionInteractor, Continuation continuation) {
        super(continuation);
