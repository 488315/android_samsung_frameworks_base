...
public final class CommunalSettingsInteractor$special$$inlined$flatMapLatest$2 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow widgetCategories = ((CommunalSettingsRepositoryImpl) this.this$0.repository).getWidgetCategories((UserInfo) this.L$1);
            this.label = 1;
            if (FlowKt.emitAll(this, widgetCategories, flowCollector) == coroutineSingletons) {
