...
final class CommunalSceneTransitionInteractor$finishCurrentTransition$1 extends ContinuationImpl {
    ...
    public CommunalSceneTransitionInteractor$finishCurrentTransition$1(CommunalSceneTransitionInteractor communalSceneTransitionInteractor, Continuation continuation) {
        super(continuation);
