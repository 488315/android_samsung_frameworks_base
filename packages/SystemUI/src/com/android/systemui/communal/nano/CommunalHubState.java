    ...
    public final class CommunalWidgetItem extends MessageNano {
        ...
        public int computeSerializedSize() {
            ...
            if (!this.componentName.equals("")) {
                iComputeInt32Size += CodedOutputByteBufferNano.computeStringSize(2, this.componentName);
            }
            int i2 = this.rank;
            if (i2 != 0) {
            ...
            int i4 = this.spanY;
            if (i4 != 0) {
                iComputeInt32Size += CodedOutputByteBufferNano.computeInt32Size(5, i4);
            }
            int i5 = this.spanYNew;
            return i5 != 0 ? CodedOutputByteBufferNano.computeInt32Size(6, i5) + iComputeInt32Size : iComputeInt32Size;
        }
    ...
    public int computeSerializedSize() {
        ...
        while (true) {
            ...
            if (communalWidgetItem != null) {
                iComputeMessageSize = CodedOutputByteBufferNano.computeMessageSize(1, communalWidgetItem) + iComputeMessageSize;
            }
            i++;
        }
    }
