...
final class AuthenticationInteractor$isInputTooShort$1 extends ContinuationImpl {
    int I$0;
    int label;
    ...
    public AuthenticationInteractor$isInputTooShort$1(AuthenticationInteractor authenticationInteractor, Continuation continuation) {
        super(continuation);
