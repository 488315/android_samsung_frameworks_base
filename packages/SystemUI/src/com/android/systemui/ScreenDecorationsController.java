...
public class ScreenDecorationsController implements CoreStartable, Dumpable {
    ...
    public final void createScreenDecorations(Display display) {
        ...
        ((ArrayList) this.mScreenDecorationsList).add(((DaggerReferenceGlobalRootComponent.ScreenDecorationsComponentImpl) this.mScreenDecorationsFactory.create(z ? this.mContext : this.mContext.createWindowContext(display, 2024, null), z ? this.mPrivacyDotViewController : this.mCoverPrivacyDotViewController, z ? this.mDotFactory : this.mCoverDotFactory)).getScreenDecorations());
    }

    @Override // com.android.systemui.CoreStartable, com.android.systemui.Dumpable
    public final void dump(final PrintWriter printWriter, final String[] strArr) {
        printWriter.println("ScreenDecorationsController state:");
        ((ArrayList) this.mScreenDecorationsList).forEach(new Consumer() { // from class: com.android.systemui.ScreenDecorationsController$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PrintWriter printWriter2 = printWriter;
                String[] strArr2 = strArr;
                int i = ScreenDecorationsController.$r8$clinit;
                ((ScreenDecorations) obj).dump(printWriter2, strArr2);
            }
        });
    }
    ...
    public final void start() {
        ...
        ((ArrayList) this.mScreenDecorationsList).forEach(new ScreenDecorationsController$$ExternalSyntheticLambda1());
    }
}
