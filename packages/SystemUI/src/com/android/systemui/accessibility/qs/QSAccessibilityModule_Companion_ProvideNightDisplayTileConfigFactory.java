...
public final class QSAccessibilityModule_Companion_ProvideNightDisplayTileConfigFactory implements Provider {
    ...
    public QSAccessibilityModule_Companion_ProvideNightDisplayTileConfigFactory(javax.inject.Provider provider) {
    ...
    public static QSTileConfig provideNightDisplayTileConfig(QsEventLogger qsEventLogger) {
        ...
        return new QSTileConfig(TileSpec.Companion.create("night"), new QSTileUIConfig.Resource(R.drawable.qs_nightlight_icon_off, R.string.quick_settings_night_display_label), ((QsEventLoggerImpl) qsEventLogger).sequence.newInstanceId(), null, null, 24, null);
    }
