...
public class SecSeekBarWithIconButtonsView extends LinearLayout {
    ...
    public class SeekBarChangeListener implements SeslSeekBar.OnSeekBarChangeListener {
        ...
        public final void onProgressChanged(SeslSeekBar seslSeekBar, int i, boolean z) {
            ...
            WindowMagnificationSettings.ZoomSeekbarChangeListener zoomSeekbarChangeListener = this.mOnSeekBarChangeListener;
            if (zoomSeekbarChangeListener != null) {
                if (secSeekBarWithIconButtonsView.mSetProgressFromButtonFlag) {
                    ...
                    zoomSeekbarChangeListener.onProgressChanged(seslSeekBar, i, true);
                    this.mOnSeekBarChangeListener.onUserInteractionFinalized(seslSeekBar);
                } else {
                    zoomSeekbarChangeListener.onProgressChanged(seslSeekBar, i, z);
        ...
        public final void onStopTrackingTouch(SeslSeekBar seslSeekBar) {
            ...
            WindowMagnificationSettings.ZoomSeekbarChangeListener zoomSeekbarChangeListener = this.mOnSeekBarChangeListener;
            if (zoomSeekbarChangeListener != null) {
                zoomSeekbarChangeListener.onUserInteractionFinalized(seslSeekBar);
            }
        }
