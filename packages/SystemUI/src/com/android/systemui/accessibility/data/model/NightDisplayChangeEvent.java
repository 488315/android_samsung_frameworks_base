...
public interface NightDisplayChangeEvent {
    ...
    public final class OnActivatedChanged implements NightDisplayChangeEvent {
        ...
        public final String toString() {
            return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("OnActivatedChanged(isActivated="), this.isActivated, ")");
        }
    }
    ...
    public final class OnAutoModeChanged implements NightDisplayChangeEvent {
        ...
        public final String toString() {
            return ReorderTile$$ExternalSyntheticOutline0.m(this.autoMode, ")", new StringBuilder("OnAutoModeChanged(autoMode="));
        }
    }
    ...
    public final class OnForceAutoModeChanged implements NightDisplayChangeEvent {
        ...
        public final String toString() {
            return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("OnForceAutoModeChanged(shouldForceAutoMode="), this.shouldForceAutoMode, ")");
        }
    }
    ...
    public final class OnLocationEnabledChanged implements NightDisplayChangeEvent {
        ...
        public final String toString() {
            return MoveResult$$ExternalSyntheticOutline0.m(new StringBuilder("OnLocationEnabledChanged(locationEnabled="), this.locationEnabled, ")");
        }
    }
}
