...
public class WindowMagnificationSettings implements MagnificationGestureDetector.OnGestureListener {
    ...
    public final WindowMagnificationSettings$$ExternalSyntheticLambda5 mWindowInsetChangeRunnable;
    ...
    public final int mLastSelectedButtonIndex = 2;
    ...
    public final AnonymousClass3 mButtonClickListener = new View.OnClickListener() { // from class: com.android.systemui.accessibility.WindowMagnificationSettings.3
        ...
        public final void onClick(View view) {
            ...
            magnificationImpl.mHandler.post(new MagnificationImpl$$ExternalSyntheticLambda4(anonymousClass4, i, 1));
    ...
    public class AnonymousClass1 extends ContentObserver {
        ...
        @Override // android.database.ContentObserver
        public final void onChange(boolean z) {
            WindowMagnificationSettings.this.mSettingView.post(new WindowMagnificationSettings$$ExternalSyntheticLambda5(this, 3));
        }
    }
    ...
    public class ZoomSeekbarChangeListener implements SecSeekBarWithIconButtonsView.OnSeekBarWithIconButtonsChangeListener {
        ...
        public final void onUserInteractionFinalized(SeslSeekBar seslSeekBar) {
    ...
    public static void m1000$$Nest$msetMagnifierSize(WindowMagnificationSettings windowMagnificationSettings, int i) {
        ...
        if (i == 4) {
            ...
            MagnificationSettingsController.Callback callback = magnificationSettingsController.mSettingsControllerCallback;
            MagnificationImpl.AnonymousClass4 anonymousClass4 = (MagnificationImpl.AnonymousClass4) callback;
            MagnificationImpl.this.mHandler.post(new MagnificationImpl$4$$ExternalSyntheticLambda0(anonymousClass4, magnificationSettingsController.mDisplayId, i2, 0));
            return;
        }
        if (i != 0) {
            ...
            MagnificationImpl.AnonymousClass4 anonymousClass42 = (MagnificationImpl.AnonymousClass4) callback2;
            MagnificationImpl magnificationImpl = MagnificationImpl.this;
            magnificationImpl.mHandler.post(new MagnificationImpl$4$$ExternalSyntheticLambda0(anonymousClass42, i3, i, 1));
            magnificationImpl.mA11yLogger.uiEventLogger.logWithPosition(AccessibilityLogger.MagnificationSettingsEvent.MAGNIFICATION_SETTINGS_WINDOW_SIZE_SELECTED, 0, (String) null, i);
            ...
            MagnificationImpl.AnonymousClass4 anonymousClass43 = (MagnificationImpl.AnonymousClass4) callback3;
            MagnificationImpl.this.mHandler.post(new MagnificationImpl$4$$ExternalSyntheticLambda0(anonymousClass43, magnificationSettingsController3.mDisplayId, 2, 0));
            if (i == 1) {
    ...
    /* JADX WARN: Type inference failed for: r1v5, types: [com.android.systemui.accessibility.WindowMagnificationSettings$5] */
    public WindowMagnificationSettings(Context context, WindowMagnificationSettingsCallback windowMagnificationSettingsCallback, SfVsyncFrameCallbackProvider sfVsyncFrameCallbackProvider, SecureSettings secureSettings, WindowManager windowManager) {
        this.mAllowDiagonalScrolling = false;
        this.mContext = context;
        context.setTheme(2132018763);
        ...
        this.mWindowInsetChangeRunnable = new WindowMagnificationSettings$$ExternalSyntheticLambda5(this, 0);
        inflateView();
    ...
    public final void hideSettingPanel(boolean z) {
        if (this.mIsVisible) {
            ...
            MagnificationSettingsController.Callback callback = magnificationSettingsController.mSettingsControllerCallback;
            MagnificationImpl.AnonymousClass4 anonymousClass4 = (MagnificationImpl.AnonymousClass4) callback;
            MagnificationImpl.this.mHandler.post(new MagnificationImpl$4$$ExternalSyntheticLambda1(anonymousClass4, magnificationSettingsController.mDisplayId, z2, 0));
        ...
        this.mSettingView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.android.systemui.accessibility.WindowMagnificationSettings$$ExternalSyntheticLambda4
            ...
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                if (windowMagnificationSettings.mSettingView.isAttachedToWindow()) {
                    ...
                    if (!handler.hasCallbacks(windowMagnificationSettings$$ExternalSyntheticLambda5)) {
                        windowMagnificationSettings.mSettingView.getHandler().post(windowMagnificationSettings$$ExternalSyntheticLambda5);
                    }
                }
    ...
    public void setDiagonalScrolling(boolean z) {
        ...
        MagnificationSettingsController.Callback callback = magnificationSettingsController.mSettingsControllerCallback;
        MagnificationImpl.AnonymousClass4 anonymousClass4 = (MagnificationImpl.AnonymousClass4) callback;
        MagnificationImpl.this.mHandler.post(new MagnificationImpl$4$$ExternalSyntheticLambda1(anonymousClass4, magnificationSettingsController.mDisplayId, z, 1));
    ...
    public final void showSettingPanel(boolean z) {
        if (!this.mIsVisible) {
            ...
            this.mSettingView.post(new WindowMagnificationSettings$$ExternalSyntheticLambda5(this, 2));
            this.mIsVisible = true;
            MagnificationSettingsController magnificationSettingsController = MagnificationSettingsController.this;
            MagnificationImpl.AnonymousClass4 anonymousClass4 = (MagnificationImpl.AnonymousClass4) magnificationSettingsController.mSettingsControllerCallback;
            MagnificationImpl.this.mHandler.post(new MagnificationImpl$4$$ExternalSyntheticLambda1(anonymousClass4, magnificationSettingsController.mDisplayId, true, 0));
            ...
            this.mSettingView.postDelayed(new WindowMagnificationSettings$$ExternalSyntheticLambda5(this, 1), 200L);
        }
    ...
    public final void updateUIControlsIfNeeded() {
        SecureSettings secureSettings = this.mSecureSettings;
        int intForUser = secureSettings.getIntForUser("accessibility_magnification_capability", 3, -2);
        ...
        if (intForUser == 1) {
            ...
            if (this.mLastSelectedButtonIndex == 4) {
                windowMagnificationFrameSizePrefs.getIndexForCurrentDensity();
            }
        } else if (intForUser == 3) {
            int intForUser2 = secureSettings.getIntForUser("accessibility_magnification_mode", secureSettings.getIntForUser("accessibility_magnification_capability", 3, -2) != 2 ? 1 : 2, -2);
            this.mFullScreenButton.setVisibility(0);
            if (intForUser2 != 1) {
                windowMagnificationFrameSizePrefs.getIndexForCurrentDensity();
            }
