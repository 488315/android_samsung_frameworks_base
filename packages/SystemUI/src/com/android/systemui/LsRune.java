...
public class LsRune extends Rune {
    ...
    public static final boolean AOD_MAIN_FULLSCREEN;
    ...
    public static final boolean KEYGUARD_FIX_ROTATION_FOR_FACTORY;
    ...
    public static final boolean LOCKUI_NOW_BAR_DEMO;
    ...
    public static final boolean SECURITY_CONTINUITY_LOCKSCREEN_VI;
    ...
    public static final boolean SECURITY_FINGERPRINT_HOME;
    ...
    public static final boolean SUBSCREEN_REMOTE_TRANSITION;
    ...
    static {
        ...
        KEYGUARD_EM_TOKEN_CAPTURE_WINDOW = !z2;
        ...
        KEYGUARD_SUB_DISPLAY_LARGE_FRONT = string.contains("LARGESCREEN");
        KEYGUARD_SCREEN_ON_FADE_OUT_ANIM = Build.VERSION.SEM_FIRST_SDK_INT >= 34 && SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_AOD_ITEM", "").contains("clocktransition");
        KEYGUARD_FIX_ROTATION_FOR_FACTORY = FactoryTest.isFactoryBinary();
        SECURITY_OPEN_THEME = true;
        boolean z3 = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_GRAPHICS_SUPPORT_3D_SURFACE_TRANSITION_FLAG");
        SECURITY_BLUR = z3;
        boolean z4 = !z3 && SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_GRAPHICS_SUPPORT_CAPTURED_BLUR");
        SECURITY_CAPTURED_BLUR = z4;
        boolean z5 = !z4;
        ...
        boolean z8 = (BasicRune$$ExternalSyntheticOutline0.m("SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_AOD_ITEM", "activeclock") || SemFloatingFeature.getInstance().getString("SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_AOD_ITEM", "").contains("clocktransition")) ? false : true;
        AOD_DISABLE_CLOCK_TRANSITION = z8;
        AOD_SAFEMODE = SafeUIState.isSysUiSafeModeEnabled();
        AOD_LIGHT_REVEAL = !z8 && DeviceType.isSupportLightReveal();
        boolean z9 = SemFloatingFeature.getInstance().getInt("SEC_FLOATING_FEATURE_LCD_CONFIG_AOD_FULLSCREEN", -1) >= 1;
        AOD_FULLSCREEN = z9;
        AOD_FULLSCREEN_APPEAR_ANIMATION = z9;
        AOD_SUB_FULLSCREEN = SemFloatingFeature.getInstance().getInt("SEC_FLOATING_FEATURE_LCD_CONFIG_AOD_FULLSCREEN", -1) == 3;
        AOD_MAIN_FULLSCREEN = SemFloatingFeature.getInstance().getInt("SEC_FLOATING_FEATURE_LCD_CONFIG_AOD_FULLSCREEN", -1) == 2;
        AOD_HYSTERESIS_BRIGHTNESS = z9;
        ...
        boolean z10 = SemFloatingFeature.getInstance().getBoolean("SEC_FLOATING_FEATURE_GRAPHICS_SUPPORT_3D_SURFACE_TRANSITION_FLAG");
        WALLPAPER_BLUR = z10;
        if (!z10) {
