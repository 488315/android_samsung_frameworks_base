...
public final class NavBarIconResourceMapper {
    ...
    public final NavBarIconResourceMapper$$ExternalSyntheticLambda0 supportLargeCover;
    public final NavBarIconResourceMapper$$ExternalSyntheticLambda0 supportThemeIcon;
    public boolean themeIcon;
    public final List themeIconList;
    public final String themePostfix;

    public NavBarIconResourceMapper(KeyButtonDrawableProvider keyButtonDrawableProvider, NavBarStore navBarStore, Context context) {
        ...
        this.themeIconList = Arrays.asList(iconType, iconType2, iconType3, iconType4, iconType5, iconType6);
        this.largeScreenIconList = Arrays.asList(iconType, iconType2, iconType3, iconType4, iconType5);
        this.themePostfix = "_theme";
        this.largeScreenPostfix = "_front";
        this.TAG = "NavBarIconResourceMapper";
        this.supportThemeIcon = new NavBarIconResourceMapper$$ExternalSyntheticLambda0(this, 0);
        this.supportLargeCover = new NavBarIconResourceMapper$$ExternalSyntheticLambda0(this, 1);
    }
    ...
    public final IconResource getIconResource(IconType iconType) {
        ...
        boolean z = false;
        this.themeIcon = ((Boolean) this.supportThemeIcon.invoke()).booleanValue() && ((NavBarStateManagerImpl) this.navBarStore.getNavStateManager()).isNavigationBarUseThemeDefault() && this.themeIconList.contains(iconType);
        if (((Boolean) this.supportLargeCover.invoke()).booleanValue() && this.largeScreenIconList.contains(iconType)) {
            z = true;
        }
        this.coverIcon = z;
    ...
    public final class IconResourceIdInfo {
        ...
        public final int hashCode() {
            return Boolean.hashCode(this.needRtl) + ReorderTile$$ExternalSyntheticOutline0.m(this.darkResId, ReorderTile$$ExternalSyntheticOutline0.m(this.lightResId, this.type.hashCode() * 31, 31), 31);
        }
