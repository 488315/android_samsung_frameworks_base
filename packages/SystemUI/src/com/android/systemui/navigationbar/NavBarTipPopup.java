...
public final class NavBarTipPopup {
    ...
    public NavBarTipPopup(Context context, WindowManager windowManager, LogWrapper logWrapper) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.navbar_tip_popup, (ViewGroup) null);
        this.tipLayout = viewInflate;
        ...
        ?? r2 = new View.OnAttachStateChangeListener() { // from class: com.android.systemui.navigationbar.NavBarTipPopup$onAttachStateChangeListener$1
            ...
            public final void onViewAttachedToWindow(View view) throws Resources.NotFoundException {
                final NavBarTipPopup navBarTipPopup = this.this$0;
                if (view == navBarTipPopup.tipLayout) {
                    navBarTipPopup.isTipPopupShowing = true;
                    int i = navBarTipPopup.navBarWidth / 2;
                    int iM = StrongAuthPopup$$ExternalSyntheticOutline0.m(navBarTipPopup.context, R.dimen.navbar_tip_window_padding_bottom, navBarTipPopup.context.getResources().getDimensionPixelOffset(R.dimen.navbar_tip_window_height));
                    ...
                    semTipPopup4.setTargetPosition(i, iM);
                    ...
                    navBarTipPopup.handler.post(new Runnable() { // from class: com.android.systemui.navigationbar.NavBarTipPopup$showTipPopup$2
                        ...
                        public final void run() {
                            if (navBarTipPopup.tipLayout.isAttachedToWindow()) {
                                SemTipPopup semTipPopup6 = navBarTipPopup.tipPopup;
            ...
            public final void onViewDetachedFromWindow(View view) {
                ...
                if (view == navBarTipPopup.tipLayout) {
                    ...
                    this.this$0.hide();
                    this.this$0.isTipPopupShowing = false;
                }
            }
        };
        this.onAttachStateChangeListener = r2;
        viewInflate.addOnAttachStateChangeListener(r2);
    }
