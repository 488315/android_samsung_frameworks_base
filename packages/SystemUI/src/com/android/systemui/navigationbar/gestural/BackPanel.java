...
public class BackPanel extends View {
    ...
    public BackPanel(Context context, LatencyTracker latencyTracker) {
        ...
        Float f3 = null;
        Float f4 = null;
        AnimatedFloat animatedFloat4 = new AnimatedFloat(this, "backgroundEdgeCornerRadius", f3, f4, f2, i3, defaultConstructorMarker);
    ...
    public void updateArrowPaint$frameworks__base__packages__SystemUI__android_common__SystemUI_core(float f) {
        ...
        this.arrowPaint.setColor(getContext().getColor(z ? R.color.search_url_text : R.color.search_url_text_holo));
    ...
    public void updateBackGestureIcon$frameworks__base__packages__SystemUI__android_common__SystemUI_core(Drawable drawable, Drawable drawable2) {
    }
