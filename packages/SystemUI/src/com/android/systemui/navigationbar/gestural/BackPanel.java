...
public class BackPanel extends View {
    ...
    public void updateArrowPaint$frameworks__base__packages__SystemUI__android_common__SystemUI_core(float f) {
        ...
        this.arrowPaint.setColor(Utils.getColorAttrDefaultColor(getContext(), z ? R.^attr-private.materialColorOnSurface : R.^attr-private.materialColorOnSurfaceInverse, 0));
