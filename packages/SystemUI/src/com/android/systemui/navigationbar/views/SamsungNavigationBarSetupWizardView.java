...
public final class SamsungNavigationBarSetupWizardView extends FrameLayout {
    ...
    public static void sendEvent$default(SamsungNavigationBarSetupWizardView samsungNavigationBarSetupWizardView, int i) {
        ...
        int displayId = samsungNavigationBarSetupWizardView.getDisplay() != null ? samsungNavigationBarSetupWizardView.getDisplay().getDisplayId() : -1;
        BackAnimationController.BackAnimationImpl backAnimationImpl = samsungNavigationBarSetupWizardView.mBackAnimation;
        if (backAnimationImpl != null) {
            backAnimationImpl.setTriggerBack(true);
        }
        BackAnimationController.BackAnimationImpl backAnimationImpl2 = samsungNavigationBarSetupWizardView.mBackAnimation;
        if (backAnimationImpl2 != null) {
            backAnimationImpl2.onBackMotion(keyEvent.getAction(), 2, displayId, 0.0f, 0.0f);
        }
    }
