...
public final class NavigationBarTransitions extends BarTransitions implements LightBarTransitionsController.DarkIntensityApplier {
    ...
    public class NavigationBarBackgroundDrawable extends BarTransitions.BarBackgroundDrawable {
        ...
        @Override // com.android.systemui.shared.statusbar.phone.BarTransitions.BarBackgroundDrawable, android.graphics.drawable.Drawable
        ...
        @Override // com.android.systemui.shared.statusbar.phone.BarTransitions.BarBackgroundDrawable
    ...
    public final void applyDarkIntensity(float f) {
        ...
        ArrayList arrayList = (ArrayList) this.mDarkIntensityListeners;
        int size3 = arrayList.size();
        int i2 = 0;
        while (i2 < size3) {
            Object obj = arrayList.get(i2);
            i2++;
            ((DarkIntensityListener) obj).onDarkIntensity(f);
        }
        if (this.mAutoDim) {
    ...
    public final void applyLightsOut(boolean z, boolean z2) {
        ...
        boolean z4 = BasicRune.NAVBAR_LIGHTBAR;
        if (z4 && this.mLightsOutDisabled) {
            return;
        }
        if (z2 || z3 != this.mLightsOut) {
            ...
            view.animate().cancel();
            float f = z3 ? BasicRune.NAVBAR_ENABLED ? 0.7f : (this.mLightTransitionsController.mDarkIntensity / 10.0f) + 0.6f : 1.0f;
            if (z) {
                this.mNavButtons.animate().alpha(f).setDuration(z4 ? 10 : z3 ? 1500 : IKnoxCustomManager.Stub.TRANSACTION_addDexURLShortcutExtend).start();
            } else {
    ...
    public final void onTransition(int i, int i2, boolean z) {
        ...
        while (i3 < size) {
            ...
            i3++;
            NavigationBar navigationBar = ((NavigationBar$$ExternalSyntheticLambda2) obj).f$0;
            ...
            if (i2 == 4) {
                ...
                if (z2) {
                    ...
                    int i4 = navBarStateManagerImpl.states.transitionMode;
                    lightBarTransitionsController.setIconsDark((i4 == 4 || i4 == 3 || (i4 == 8 && !navBarStateManagerImpl.isNavigationBarUseThemeDefault())) && !navBarStateManagerImpl.states.darkMode, true);
                } else {
