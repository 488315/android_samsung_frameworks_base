...
public class KeyButtonDrawable extends Drawable {
    ...
    public static final AnonymousClass2 KEY_DRAWABLE_TRANSLATE_Y = new FloatProperty("KeyButtonTranslateY") { // from class: com.android.systemui.navigationbar.views.buttons.KeyButtonDrawable.2
        @Override // android.util.Property
        public final Float get(Object obj) {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [android.graphics.drawable.Drawable$Callback, com.android.systemui.navigationbar.views.buttons.KeyButtonDrawable$3] */
    private KeyButtonDrawable(Drawable drawable, ShadowDrawableState shadowDrawableState) {
        ...
        ?? r0 = new Drawable.Callback() { // from class: com.android.systemui.navigationbar.views.buttons.KeyButtonDrawable.3
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [com.android.systemui.navigationbar.views.buttons.KeyButtonDrawable$3] */
    public KeyButtonDrawable(Drawable[] drawableArr) {
        this.mIconPaint = new Paint(3);
        this.mShadowPaint = new Paint(3);
        this.mAnimatedDrawableCallback = new Drawable.Callback() { // from class: com.android.systemui.navigationbar.views.buttons.KeyButtonDrawable.3
            @Override // android.graphics.drawable.Drawable.Callback
            public final void invalidateDrawable(Drawable drawable2) {
                KeyButtonDrawable.this.invalidateSelf();
            }
