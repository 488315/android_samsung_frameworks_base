...
public final class TaskBarInteractor {
    ...
    public boolean fitToActiveDisplay;
    ...
    public TaskBarInteractor(Context context, BroadcastDispatcher broadcastDispatcher, Handler handler, SettingsHelper settingsHelper, DisplayManager displayManager, LogWrapper logWrapper) {
        ...
        this.fitToActiveDisplay = displayManager.semIsFitToActiveDisplay();
    ...
    public final void addCallback(final NavBarStoreImpl$initInteractor$7 navBarStoreImpl$initInteractor$7) {
            ...
            public final void onReceive(Context context, Intent intent) {
                ...
                if (action != null) {
                    ...
                    if (hashCode != 833559602) {
                        ...
                        Runnable runnable2 = navBarStoreImpl$initInteractor$7;
                        if (runnable2 != null) {
                            runnable2.run();
                        }
                    }
        ...
        BroadcastDispatcher.registerReceiverWithHandler$default(this.broadcastDispatcher, r3, intentFilter, this.bgHandler, userHandle, null, 48);
