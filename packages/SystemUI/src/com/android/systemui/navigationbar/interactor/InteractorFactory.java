...
public final class InteractorFactory {
    ...
    public InteractorFactory(Context context, SettingsHelper settingsHelper, BroadcastDispatcher broadcastDispatcher, UserTracker userTracker, LogWrapper logWrapper, Handler handler) {
        ...
        linkedHashMap.put(DesktopModeInteractor.class, new DesktopModeInteractor(context, broadcastDispatcher, (Handler) Dependency.sDependency.getDependencyInner(dependencyKey), settingsHelper));
        ...
        linkedHashMap.put(TaskBarInteractor.class, new TaskBarInteractor(context, broadcastDispatcher, (Handler) Dependency.sDependency.getDependencyInner(dependencyKey), settingsHelper, logWrapper));
