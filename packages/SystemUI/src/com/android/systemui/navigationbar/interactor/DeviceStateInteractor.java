...
public final class DeviceStateInteractor {
    ...
    public NavBarStoreImpl$initInteractor$20 largeCoverRotationCallback;
                ...
                public final void run() {
                    ...
                    if (tasks != null) {
                        ...
                        if (runningTaskInfo2 != null) {
                            ...
                            boolean z2 = runningTaskInfo2.isCoverLauncherWidgetTask;
        ...
        this.componentCallbacks = new ComponentCallbacks() { // from class: com.android.systemui.navigationbar.interactor.DeviceStateInteractor$componentCallbacks$1
            ...
            public final void onConfigurationChanged(Configuration configuration) {
                ...
                if (deviceStateInteractor.lastCoverRotation != rotation) {
                    ...
                    if (navBarStoreImpl$initInteractor$20 != null) {
                        navBarStoreImpl$initInteractor$20.accept(Integer.valueOf(rotation));
                    }
                }
            }
