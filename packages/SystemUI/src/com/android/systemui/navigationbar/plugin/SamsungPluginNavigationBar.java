...
public final class SamsungPluginNavigationBar implements ExtendableBar {
    ...
    public final int FORCE_SHOW_NAVIGATION_BAR = 8388608;
    ...
    public final boolean isCoverLargeScreenTaskEnabled() {
        return ((NavBarStateManagerImpl) ((NavBarStoreImpl) this.navBarStore).getNavStateManager(1)).isLargeCoverTaskEnabled();
    }
