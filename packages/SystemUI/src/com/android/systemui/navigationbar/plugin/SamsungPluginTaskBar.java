...
public final class SamsungPluginTaskBar implements ExtendableBar {
    ...
    public final NavBarStoreAdapter getNavBarStoreAdapter() {
        ...
        companion.getClass();
        NavBarStoreAdapterImpl navBarStoreAdapterImpl = NavBarStoreAdapterImpl.INSTANCE;
        if (navBarStoreAdapterImpl != null) {
            return navBarStoreAdapterImpl;
        }
        NavBarStoreAdapterImpl navBarStoreAdapterImpl2 = new NavBarStoreAdapterImpl(navBarStoreImpl, logWrapper);
        NavBarStoreAdapterImpl.INSTANCE = navBarStoreAdapterImpl2;
        return navBarStoreAdapterImpl2;
    }
    ...
    public final boolean isTaskbarEnabled() {
        return ((NavBarStateManagerImpl) this.navBarStateManager).isTaskBarEnabled(false);
    }
    ...
    public final void updateActiveIndicatorSpringParams(float f, float f2) {
        TaskbarDelegate taskbarDelegate = this.taskbarDelegate;
        if (taskbarDelegate != null) {
            taskbarDelegate.mEdgeBackGestureHandler.mEdgeBackPlugin.updateActiveIndicatorSpringParams(f, f2);
        }
    }
    ...
    public final void updateBackGestureIcon(Drawable drawable, Drawable drawable2) {
        ...
        TaskbarDelegate taskbarDelegate = this.taskbarDelegate;
        if (taskbarDelegate == null || (navigationEdgeBackPlugin = taskbarDelegate.mEdgeBackGestureHandler.mEdgeBackPlugin) == null) {
            return;
        }
    ...
    public final void updateBackPanelColor(int i, int i2, int i3, int i4) {
        TaskbarDelegate taskbarDelegate = this.taskbarDelegate;
        if (taskbarDelegate != null) {
            taskbarDelegate.mEdgeBackGestureHandler.mEdgeBackPlugin.updateBackPanelColor(i, i2, i3, i4);
        }
    }
    ...
    public final void updatePluginBundle() {
        ...
        TaskbarDelegate taskbarDelegate = this.taskbarDelegate;
        if (taskbarDelegate != null) {
            taskbarDelegate.sendNavbarEvent(navBarEvents);
        }
    }
