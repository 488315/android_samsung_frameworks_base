...
public final class BouncerMessageViewBinder {
    ...
    /* renamed from: com.android.systemui.bouncer.ui.binder.BouncerMessageViewBinder$bind$1, reason: invalid class name */
    final class AnonymousClass1 extends SuspendLambda implements Function3 {
        ...
        /* renamed from: com.android.systemui.bouncer.ui.binder.BouncerMessageViewBinder$bind$1$1, reason: invalid class name and collision with other inner class name */
        final class C01201 extends SuspendLambda implements Function2 {
            ...
            final class C01211 extends SuspendLambda implements Function2 {
                final /* synthetic */ BouncerLogger $bouncerLogger;
                final /* synthetic */ BouncerMessageInteractor $interactor;
                final /* synthetic */ BouncerMessageView $view;
                int label;
                ...
                public C01211(BouncerMessageInteractor bouncerMessageInteractor, BouncerLogger bouncerLogger, BouncerMessageView bouncerMessageView, Continuation continuation) {
                ...
                public final Continuation create(Object obj, Continuation continuation) {
                    return new C01211(this.$interactor, this.$bouncerLogger, this.$view, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return ((C01211) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
                }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C01201(BouncerLogger bouncerLogger, BouncerMessageInteractor bouncerMessageInteractor, BouncerMessageView bouncerMessageView, Continuation continuation) {
                super(2, continuation);
                this.$bouncerLogger = bouncerLogger;
                this.$interactor = bouncerMessageInteractor;
                this.$view = bouncerMessageView;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                C01201 c01201 = new C01201(this.$bouncerLogger, this.$interactor, this.$view, continuation);
                c01201.L$0 = obj;
                return c01201;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                CoroutineTracingKt.launchTraced$default(coroutineScope, null, null, new C01211(this.$interactor, this.$bouncerLogger, this.$view, null), 7);
                return Unit.INSTANCE;
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(BouncerMessageView bouncerMessageView, KeyguardMessageAreaController.Factory factory, BouncerLogger bouncerLogger, BouncerMessageInteractor bouncerMessageInteractor, Continuation continuation) {
        ...
        public final Object invoke(Object obj, Object obj2, Object obj3) {
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$view, this.$factory, this.$bouncerLogger, this.$interactor, (Continuation) obj3);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C01201 c01201 = new C01201(this.$bouncerLogger, this.$interactor, this.$view, null);
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(lifecycleOwner, state, c01201, this) == coroutineSingletons) {
                    return coroutineSingletons;
                }
            } else {
                if (i != 1) {
    ...
    */
    public static final void access$updateView(BouncerMessageViewBinder bouncerMessageViewBinder, KeyguardSecMessageAreaController keyguardSecMessageAreaController, BouncerKeyguardMessageArea bouncerKeyguardMessageArea, Message message, boolean z) throws Resources.NotFoundException {
        ColorStateList colorStateList;
        bouncerMessageViewBinder.getClass();
        if (bouncerKeyguardMessageArea == null || keyguardSecMessageAreaController == null) {
            return;
        }
        if ((message != null ? message.message : null) != null) {
            ...
            Integer num = message.messageResId;
            if (num != null && num.intValue() != 0) {
                string = bouncerKeyguardMessageArea.getResources().getString(num.intValue());
                if (message.formatterArgs != null) {
                    string = PluralsMessageFormatter.format(bouncerKeyguardMessageArea.getResources(), message.formatterArgs, num.intValue());
                }
            }
            keyguardSecMessageAreaController.setMessage(string, message.animate);
        } else {
            if ((message != null ? message.messageResId : null) == null) {
                keyguardSecMessageAreaController.setIsVisible(false);
                keyguardSecMessageAreaController.setMessage(0);
            }
        }
        if (message != null && (colorStateList = message.colorState) != null) {
            keyguardSecMessageAreaController.setNextMessageColor(colorStateList);
        }
        bouncerKeyguardMessageArea.setEllipsize(z ? TextUtils.TruncateAt.END : TextUtils.TruncateAt.MARQUEE);
    }
    ...
    public static final void bind(BouncerMessageView bouncerMessageView, BouncerMessageInteractor bouncerMessageInteractor, KeyguardMessageAreaController.Factory factory, BouncerLogger bouncerLogger) {
        RepeatWhenAttachedKt.repeatWhenAttached(bouncerMessageView, EmptyCoroutineContext.INSTANCE, new AnonymousClass1(bouncerMessageView, factory, bouncerLogger, bouncerMessageInteractor, null));
    }
}
