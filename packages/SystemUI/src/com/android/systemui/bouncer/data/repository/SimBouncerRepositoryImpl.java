...
public final class SimBouncerRepositoryImpl implements SimBouncerRepository {
    ...
    public SimBouncerRepositoryImpl(CoroutineScope coroutineScope, CoroutineDispatcher coroutineDispatcher, final Resources resources, final KeyguardUpdateMonitor keyguardUpdateMonitor, SubscriptionManagerProxy subscriptionManagerProxy, BroadcastDispatcher broadcastDispatcher, final EuiccManager euiccManager) {
        ...
        final Flow conflatedCallbackFlow = FlowConflatedKt.conflatedCallbackFlow(new SimBouncerRepositoryImpl$simBouncerModel$1(keyguardUpdateMonitor, null));
        ...
        final ReadonlyStateFlow stateIn = FlowKt.stateIn(flow, coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), -1);
        ...
        final ReadonlyStateFlow stateIn2 = FlowKt.stateIn(flow2, coroutineScope, startedEagerly, null);
        this.activeSubscriptionInfo = stateIn2;
        ...
        Flow broadcastFlow$default = BroadcastDispatcher.broadcastFlow$default(broadcastDispatcher, new IntentFilter("com.android.keyguard.disable_esim"), null, new Function2() { // from class: com.android.systemui.bouncer.data.repository.SimBouncerRepositoryImpl$$ExternalSyntheticLambda0
        ...
        this.simVerificationErrorMessage = MutableStateFlow;
        this.errorDialogMessage = FlowKt.stateIn(FlowKt.merge(broadcastFlow$default, MutableStateFlow), coroutineScope, SharingStarted.Companion.WhileSubscribed$default(companion, 3), null);
