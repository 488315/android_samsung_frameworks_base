...
public abstract class BouncerMessageInteractorKt {
    ...
    public static final BouncerMessageModel toMessage(Pair pair) {
        return new BouncerMessageModel(new Message(null, (Integer) pair.getFirst(), null, null, false, 13, null), new Message(null, Integer.valueOf(pair.getSecond() instanceof Integer ? ((Integer) pair.getSecond()).intValue() : 0), null, null, false, 13, null));
    }
}
