...
final class SimBouncerInteractor$verifySimPin$1 extends ContinuationImpl {
    int I$0;
    Object L$0;
    int label;
    ...
    public SimBouncerInteractor$verifySimPin$1(SimBouncerInteractor simBouncerInteractor, Continuation continuation) {
        super(continuation);
