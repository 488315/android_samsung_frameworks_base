        ...
        public final Object invoke(Object obj, Object obj2, Object obj3) {
            ...
            if ((((Number) obj3).intValue() & 17) == 16) {
                ...
                if (composerImpl.getSkipping()) {
                    ...
                    TextKt.m317Text4IGK_g(StringResources_androidKt.stringResource(R.string.got_it, composer), null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, null, composer, 0, 0, 131070);
                    if (ComposerKt.isTraceInProgress()) {
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            if ((((Number) obj2).intValue() & 3) == 2) {
                ...
                if (composerImpl.getSkipping()) {
                    ...
                    Modifier modifierM126paddingVpY3zN4 = PaddingKt.m126paddingVpY3zN4(companion, 16, 20);
                    ...
                    Modifier modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composer, modifierM126paddingVpY3zN4);
                    ...
                    Updater.m337setimpl(composer, rowMeasurePolicy, function2);
                    Function2 function22 = ComposeUiNode.Companion.SetResolvedCompositionLocals;
                    Updater.m337setimpl(composer, persistentCompositionLocalMapCurrentCompositionLocalScope, function22);
                    ...
                    Updater.m337setimpl(composer, modifierMaterializeModifier, function24);
                    ...
                    Updater.m337setimpl(composer, columnMeasurePolicy, function2);
                    Updater.m337setimpl(composer, persistentCompositionLocalMapCurrentCompositionLocalScope2, function22);
                    ...
                    Updater.m337setimpl(composer, modifierMaterializeModifier2, function24);
                    ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
                    ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.ic_avatar_with_badge, composer, 0), null, SizeKt.m140size3ABfNKs(companion, 40), null, null, 0.0f, null, composer, 432, 120);
                    SpacerKt.Spacer(composer, SizeKt.m131height3ABfNKs(companion, 2));
                    String strStringResource = StringResources_androidKt.stringResource(R.string.empty_user_name, composer);
                    MaterialTheme.INSTANCE.getClass();
                    TextStyle textStyle = MaterialTheme.getTypography(composer).labelMedium;
                    TextOverflow.Companion.getClass();
                    int i = TextOverflow.Ellipsis;
                    TextKt.m317Text4IGK_g(strStringResource, null, 0L, 0L, null, null, null, 0L, null, null, 0L, i, false, 1, 0, null, textStyle, composer, 0, 3120, 55294);
                    composerImpl2.end(true);
                    SpacerKt.Spacer(composer, SizeKt.m144width3ABfNKs(companion, 24));
                    TextKt.m317Text4IGK_g(StringResources_androidKt.stringResource(R.string.empty_status, composer), null, 0L, 0L, null, null, null, 0L, null, null, 0L, i, false, 1, 0, null, MaterialTheme.getTypography(composer).labelMedium, composer, 0, 3120, 55294);
                    composerImpl2.end(true);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
