            ...
            public final void appTransitionFinished(int i) {
                ...
                if (launchConversationActivity.mBubblesManagerOptional.isPresent()) {
                    if (launchConversationActivity.mBubble != null) {
                        ...
                        ((HandlerExecutor) BubbleController.this.mMainExecutor).execute(new BubbleController$$ExternalSyntheticLambda16(3, bubblesImpl, bubble));
                        ...
                        ((HandlerExecutor) BubbleController.this.mMainExecutor).execute(new BubbleController$BubblesImpl$$ExternalSyntheticLambda4(bubblesImpl2, notifToBubbleEntry, 1));
                    }
                }
