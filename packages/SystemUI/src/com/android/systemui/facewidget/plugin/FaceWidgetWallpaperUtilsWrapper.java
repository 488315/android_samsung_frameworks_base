...
public class FaceWidgetWallpaperUtilsWrapper implements PluginSystemUIWallpaperUtils, Dumpable {
    public final HashMap mCallbackMap = new HashMap();
    public final KeyguardWallpaper mKeyguardWallpaper;

    /* compiled from: qb/97869455 e70885ee4e20e40425471e4b47759369a50273352e1b7033cea52247075b3cbb */
    public class FaceWidgetSystemUIWidgetCallbackWrapper implements SystemUIWidgetCallback, Dumpable {
        ...
        public final void updateStyle(long j, SemWallpaperColors semWallpaperColors) {
            ...
            if (pluginSystemUIWidgetCallback != null) {
                int i = (int) j;
                ExifInterface$$ExternalSyntheticOutline0.m(ActivityResultRegistry$register$3$$ExternalSyntheticOutline0.m("updateStyle: updateFlag = ", KeyguardWallpaperColors.getChangeFlagsString(i), ", colors = "), semWallpaperColors == null ? "null" : semWallpaperColors.toSimpleString(), "FaceWidgetWallpaperUtilsWrapper");
