...
public final class ScreenOnAffordanceViewController extends ViewAnimationController {
                    ...
                    public final Object emit(Object obj2, Continuation continuation) {
                        ...
                        if (screenPowerState == ScreenPowerState.SCREEN_ON) {
                            ...
                            while (i3 < size) {
                                ...
                                i3++;
                                arrayList2.add(keyguardTouchAnimator2.getView$frameworks__base__packages__SystemUI__android_common__SystemUI_core(((Number) obj3).intValue()));
                            }
                            ...
                            while (i5 < size3) {
                                ...
                                springAnimation.mSpring = ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(150.0f, 1.0f);
                                ...
                                springAnimation2.mSpring = ConnectedDisplayKeyguardPresentation$$ExternalSyntheticOutline0.m(150.0f, 1.0f);
    ...
    public ScreenOnAffordanceViewController(KeyguardTouchAnimator keyguardTouchAnimator, PowerInteractor powerInteractor, CoroutineScope coroutineScope, DozeParameters dozeParameters) {
        ...
        this.screenONAffordanceViews = Arrays.asList(7, 1, 2, 4, 5, 6, 12, 14, 9, 10);
