...
public class KeyguardTouchSwipeDetector extends KeyguardTouchBase {
    ...
    public KeyguardSwipeViewController mUnlockCallback;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 1) {
                ...
                setIntercept(false);
                KeyguardSwipeViewController keyguardSwipeViewController = this.mUnlockCallback;
                if (keyguardSwipeViewController != null) {
                    keyguardSwipeViewController.callUserActivity();
                }
