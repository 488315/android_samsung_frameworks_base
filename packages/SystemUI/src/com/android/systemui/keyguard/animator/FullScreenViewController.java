...
public final class FullScreenViewController extends ViewAnimationController {
    ...
    public FullScreenViewController(KeyguardTouchAnimator keyguardTouchAnimator) {
        ...
        this.fullScreenViews = Arrays.asList(1, 2, 4, 5, 6, 0, 7, 8, 9, 10, 12, 14);
    ...
    public final void setFullScreenMode$frameworks__base__packages__SystemUI__android_common__SystemUI_core(final boolean z) {
        ...
        EmergencyButtonController$$ExternalSyntheticOutline0.m("setFullScreenMode enabled=", "KeyguardTouchAnimator", z);
        ...
        if (isKeyguardState()) {
            ...
            while (i2 < size) {
                ...
                i2++;
                arrayList2.add(keyguardTouchAnimator.getView$frameworks__base__packages__SystemUI__android_common__SystemUI_core(((Number) obj2).intValue()));
            }
