...
public class KeyguardSliceProvider extends SliceProvider implements NextAlarmController.NextAlarmChangeCallback, ZenModeController.Callback, NotificationMediaManager.MediaListener, StatusBarStateController.StateListener, SystemUIAppComponentFactoryBase.ContextInitializer {
    ...
    public final void addMediaLocked(ListBuilder listBuilder) {
        ...
        if (notificationMediaManager == null || (str = notificationMediaManager.mMediaNotificationKey) == null) {
            ...
            final int i = 0;
            Optional map = Optional.ofNullable(notificationMediaManager.mNotifPipeline.mNotifCollection.getEntry(str)).map(new Function() { // from class: com.android.systemui.media.NotificationMediaManager$$ExternalSyntheticLambda1
            ...
            final int i2 = 1;
            icon = (Icon) map.map(new Function() { // from class: com.android.systemui.media.NotificationMediaManager$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    switch (i2) {
                        case 0:
        ...
        this.mBgHandler.post(new Runnable() { // from class: com.android.systemui.keyguard.KeyguardSliceProvider$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ...
                try {
                    ...
                    android.util.Log.e("KgdSliceProvider", "Error on mContentResolver.notifyChange()", e);
                }
            }
        });
    }
    ...
    public final boolean onCreateSliceProvider() {
        ...
        if (this.mMediaManager == null) {
            android.util.Log.e("KgdSliceProvider", "Dagger injection failed, cannot start. See any above warnings with string: \"No injector for class\"");
            return false;
        }
