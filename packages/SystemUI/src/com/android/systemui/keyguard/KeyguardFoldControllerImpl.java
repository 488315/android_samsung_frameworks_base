...
public final class KeyguardFoldControllerImpl implements KeyguardFoldController {
    ...
    public final void changeFoldState(boolean z) {
        ...
        if (z3) {
            ...
            if (z4 == 0 && z2 != 0 && this.initShowTime > 0 && (!this.updateMonitor.isSecure() || this.updateMonitor.getUserCanSkipBouncer(this.selectedUserInteractor.getSelectedUserId(false)))) {
    ...
    public final void onFoldStateChanged(List list, final boolean z, boolean z2, boolean z3) {
        ...
        while (it.hasNext()) {
            final RankedStateListener rankedStateListener = (RankedStateListener) it.next();
            if (z3) {
