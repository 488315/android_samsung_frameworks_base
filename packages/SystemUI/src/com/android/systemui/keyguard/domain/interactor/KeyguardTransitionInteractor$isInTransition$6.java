...
final class KeyguardTransitionInteractor$isInTransition$6 extends SuspendLambda implements Function2 {
    ...
    public KeyguardTransitionInteractor$isInTransition$6(Continuation continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        KeyguardTransitionInteractor$isInTransition$6 keyguardTransitionInteractor$isInTransition$6 = new KeyguardTransitionInteractor$isInTransition$6(continuation);
