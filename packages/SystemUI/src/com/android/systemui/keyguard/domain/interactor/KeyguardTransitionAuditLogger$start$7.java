...
final class KeyguardTransitionAuditLogger$start$7 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow flow = (Flow) this.this$0.deviceEntryInteractor.isLockscreenEnabled$delegate.getValue();
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$7.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    bool.booleanValue();
                    KeyguardTransitionAuditLogger.this.logger.log(KeyguardTransitionAuditLoggerKt.TAG, LogLevel.VERBOSE, "DeviceEntry isLockscreenEnabled", bool);
