        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromDreamingTransitionInteractor$listenForDreamingToGoneWhenDismissable$1.2
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    if (!((Boolean) fromDreamingTransitionInteractor3.keyguardInteractor.isKeyguardDismissible.getValue()).booleanValue() || ((Boolean) fromDreamingTransitionInteractor3.keyguardInteractor.isKeyguardShowing.getValue()).booleanValue()) {
