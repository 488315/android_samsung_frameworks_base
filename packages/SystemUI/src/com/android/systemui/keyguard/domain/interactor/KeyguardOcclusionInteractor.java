...
public final class KeyguardOcclusionInteractor {
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [com.android.systemui.keyguard.domain.interactor.KeyguardOcclusionInteractor$special$$inlined$map$1, kotlinx.coroutines.flow.Flow] */
    public KeyguardOcclusionInteractor(CoroutineScope coroutineScope, KeyguardOcclusionRepository keyguardOcclusionRepository, PowerInteractor powerInteractor, KeyguardTransitionInteractor keyguardTransitionInteractor, InternalKeyguardTransitionInteractor internalKeyguardTransitionInteractor, KeyguardInteractor keyguardInteractor, Lazy lazy) {
        this.repository = keyguardOcclusionRepository;
        this.powerInteractor = powerInteractor;
        this.internalTransitionInteractor = internalKeyguardTransitionInteractor;
        final ReadonlyStateFlow readonlyStateFlowAsStateFlow = FlowKt.asStateFlow(keyguardOcclusionRepository.showWhenLockedActivityInfo);
        this.showWhenLockedActivityInfo = readonlyStateFlowAsStateFlow;
        final ?? r5 = new Flow() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardOcclusionInteractor$special$$inlined$map$1
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        Boolean boolValueOf = Boolean.valueOf(((ShowWhenLockedActivityInfo) obj).isOnTop);
        ...
        this.isShowWhenLockedActivityOnTop = r5;
        ReadonlyStateFlow readonlyStateFlow = powerInteractor.detailedWakefulness;
        SceneKey sceneKey = Scenes.Communal;
        final Flow flowSample = com.android.systemui.util.kotlin.FlowKt.sample(readonlyStateFlow, keyguardTransitionInteractor.isFinishedIn(KeyguardState.GONE), KeyguardOcclusionInteractor$showWhenLockedActivityLaunchedFromPowerGesture$3.INSTANCE);
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Pair pair = (Pair) obj;
                        Boolean boolValueOf = Boolean.valueOf(((WakefulnessModel) pair.component1()).powerButtonLaunchGestureTriggered && !((Boolean) pair.component2()).booleanValue());
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(boolValueOf, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
        ...
        ChannelLimitedFlowMerge channelLimitedFlowMergeMerge = FlowKt.merge(flow, new Flow() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardOcclusionInteractor$special$$inlined$map$3
        ...
        Boolean bool = Boolean.FALSE;
        this.showWhenLockedActivityLaunchedFromPowerGesture = FlowKt.stateIn(channelLimitedFlowMergeMerge, coroutineScope, startedEagerly, bool);
