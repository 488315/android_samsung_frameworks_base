...
final class FromOccludedTransitionInteractor$listenForOccludedToGone$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            TransitionInteractor$filterRelevantKeyguardStateAnd$$inlined$filter$1 transitionInteractor$filterRelevantKeyguardStateAnd$$inlined$filter$1 = new TransitionInteractor$filterRelevantKeyguardStateAnd$$inlined$filter$1(FlowKt.sample(keyguardInteractor.isKeyguardOccluded, keyguardInteractor.isKeyguardShowing, AnonymousClass3.INSTANCE), fromOccludedTransitionInteractor, new FromOccludedTransitionInteractor$listenForOccludedToGone$1$$ExternalSyntheticLambda0(0));
            final FromOccludedTransitionInteractor fromOccludedTransitionInteractor2 = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToGone$1.5
                @Override // kotlinx.coroutines.flow.FlowCollector
                public final Object emit(Object obj2, Continuation continuation) {
                    Object objStartTransitionTo$default = TransitionInteractor.startTransitionTo$default(fromOccludedTransitionInteractor2, KeyguardState.GONE, null, null, null, continuation, 14);
