...
final class FromGoneTransitionInteractor$listenForGoneToAodOrDozing$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FromGoneTransitionInteractor$listenForGoneToAodOrDozing$1$$ExternalSyntheticLambda0 fromGoneTransitionInteractor$listenForGoneToAodOrDozing$1$$ExternalSyntheticLambda0 = new FromGoneTransitionInteractor$listenForGoneToAodOrDozing$1$$ExternalSyntheticLambda0();
            this.label = 1;
            if (fromGoneTransitionInteractor.listenForSleepTransition(fromGoneTransitionInteractor$listenForGoneToAodOrDozing$1$$ExternalSyntheticLambda0, this) == coroutineSingletons) {
