...
final class FromOccludedTransitionInteractor$listenForOccludedToLockscreenOrHub$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlowImpl stateFlowImpl = keyguardInteractor.isKeyguardOccluded;
            CommunalInteractor communalInteractor = fromOccludedTransitionInteractor.communalInteractor;
            TransitionInteractor$filterRelevantKeyguardStateAnd$$inlined$filter$1 transitionInteractor$filterRelevantKeyguardStateAnd$$inlined$filter$1 = new TransitionInteractor$filterRelevantKeyguardStateAnd$$inlined$filter$1(companion.sample(stateFlowImpl, keyguardInteractor.isKeyguardShowing, communalInteractor.isIdleOnCommunal, communalInteractor.showCommunalFromOccluded, communalInteractor.dreamFromOccluded), fromOccludedTransitionInteractor, new FromOccludedTransitionInteractor$listenForOccludedToGone$1$$ExternalSyntheticLambda0(1));
