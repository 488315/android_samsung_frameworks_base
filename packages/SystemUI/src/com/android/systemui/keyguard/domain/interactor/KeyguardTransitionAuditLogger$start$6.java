...
final class KeyguardTransitionAuditLogger$start$6 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ReadonlyStateFlow readonlyStateFlow = keyguardTransitionAuditLogger.deviceEntryInteractor.isUnlocked;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$6.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    bool.booleanValue();
                    KeyguardTransitionAuditLogger.this.logger.log(KeyguardTransitionAuditLoggerKt.TAG, LogLevel.VERBOSE, "DeviceEntry isUnlocked", bool);
