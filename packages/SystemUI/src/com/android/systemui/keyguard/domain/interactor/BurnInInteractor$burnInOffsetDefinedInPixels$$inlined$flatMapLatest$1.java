...
public final class BurnInInteractor$burnInOffsetDefinedInPixels$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) throws Resources.NotFoundException {
        ...
        if (i == 0) {
            ...
            ChannelFlowTransformLatest channelFlowTransformLatestMapLatest = FlowKt.mapLatest(burnInInteractor.keyguardInteractor.dozeTimeTick, new BurnInInteractor$burnInOffsetDefinedInPixels$1$1(burnInInteractor, dimensionPixelSize, this.$isXAxis$inlined, fFloatValue, null));
            this.label = 1;
