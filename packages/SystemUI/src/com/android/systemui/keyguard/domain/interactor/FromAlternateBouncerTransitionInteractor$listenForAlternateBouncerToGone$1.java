...
final class FromAlternateBouncerTransitionInteractor$listenForAlternateBouncerToGone$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ReadonlyStateFlow readonlyStateFlow = fromAlternateBouncerTransitionInteractor.keyguardInteractor.isKeyguardGoingAway;
            final Flow flow = new Flow() { // from class: com.android.systemui.keyguard.domain.interactor.FromAlternateBouncerTransitionInteractor$listenForAlternateBouncerToGone$1$invokeSuspend$$inlined$filter$1
            ...
            Flow flow2 = new Flow() { // from class: com.android.systemui.keyguard.domain.interactor.FromAlternateBouncerTransitionInteractor$listenForAlternateBouncerToGone$1$invokeSuspend$$inlined$map$1
            ...
            TransitionInteractor$filterRelevantKeyguardState$$inlined$filter$1 transitionInteractor$filterRelevantKeyguardState$$inlined$filter$1 = new TransitionInteractor$filterRelevantKeyguardState$$inlined$filter$1(FlowKt.merge(flow2, FlowKt.transformLatest(fromAlternateBouncerTransitionInteractor2.keyguardInteractor.isKeyguardOccluded, new FromAlternateBouncerTransitionInteractor$listenForAlternateBouncerToGone$1$invokeSuspend$$inlined$flatMapLatest$1(null, fromAlternateBouncerTransitionInteractor2))), fromAlternateBouncerTransitionInteractor);
