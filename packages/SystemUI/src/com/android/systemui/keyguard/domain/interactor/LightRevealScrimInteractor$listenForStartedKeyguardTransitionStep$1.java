        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.LightRevealScrimInteractor$listenForStartedKeyguardTransitionStep$1.1
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    long j = (keyguardState2 == keyguardState && ((WakefulnessModel) ((PowerInteractor) lightRevealScrimInteractor2.powerInteractor.get()).detailedWakefulness.$$delegate_0.getValue()).lastSleepReason == WakeSleepReason.FOLD) ? 0L : 500L;
                    switch (LightRevealScrimInteractor.WhenMappings.$EnumSwitchMapping$0[keyguardState2.ordinal()]) {
                        case 1:
                        case 2:
                        case 3:
                            z = false;
                    ...
                    LightRevealScrimRepositoryImpl lightRevealScrimRepositoryImpl = (LightRevealScrimRepositoryImpl) lightRevealScrimInteractor2.repository;
