        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToPrimaryBouncer$1.2
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    ...
                    Object startTransitionTo$default = TransitionInteractor.startTransitionTo$default(FromLockscreenTransitionInteractor.this, KeyguardState.PRIMARY_BOUNCER, null, null, "#listenForLockscreenToPrimaryBouncer", continuation, 6);
