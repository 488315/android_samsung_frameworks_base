...
public final class WindowManagerLockscreenVisibilityInteractor$special$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            int i3 = WindowManagerLockscreenVisibilityInteractor.WhenMappings.$EnumSwitchMapping$0[transitionStep.from.ordinal()];
            Flow flowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2 = i3 != 1 ? i3 != 2 ? i3 != 3 ? i3 != 4 ? new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(null) : new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(Boolean.FALSE) : this.$fromAlternateBouncerInteractor$inlined.surfaceBehindVisibility : this.$fromBouncerInteractor$inlined.surfaceBehindVisibility : this.$fromLockscreenInteractor$inlined.surfaceBehindVisibility;
            this.label = 1;
