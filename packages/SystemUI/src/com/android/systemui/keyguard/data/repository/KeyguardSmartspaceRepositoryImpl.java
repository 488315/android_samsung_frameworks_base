...
public final class KeyguardSmartspaceRepositoryImpl implements KeyguardSmartspaceRepository {
    ...
    public KeyguardSmartspaceRepositoryImpl(SecureSettings secureSettings, UserTracker userTracker, CoroutineScope coroutineScope) {
        ...
        StateFlowImpl stateFlowImplMutableStateFlow = StateFlowKt.MutableStateFlow(8);
        this._bcSmartspaceVisibility = stateFlowImplMutableStateFlow;
        this.bcSmartspaceVisibility = FlowKt.asStateFlow(stateFlowImplMutableStateFlow);
        final FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new KeyguardSmartspaceRepositoryImpl$isWeatherEnabled$1(null), SettingsProxyExt.INSTANCE.observerFlow(secureSettings, -1, "lockscreen_weather_enabled"));
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        KeyguardSmartspaceRepositoryImpl keyguardSmartspaceRepositoryImpl = this.this$0;
                        Boolean boolValueOf = Boolean.valueOf(keyguardSmartspaceRepositoryImpl.secureSettings.getIntForUser("lockscreen_weather_enabled", 1, ((UserTrackerImpl) keyguardSmartspaceRepositoryImpl.userTracker).getUserId()) == 1);
        ...
        }, coroutineScope, SharingStarted.Companion.WhileSubscribed$default(SharingStarted.Companion, 3), Boolean.valueOf(secureSettings.getIntForUser("lockscreen_weather_enabled", 1, ((UserTrackerImpl) userTracker).getUserId()) == 1));
    }
}
