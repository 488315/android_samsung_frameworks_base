...
public final class DoNotDisturbQuickAffordanceConfig implements KeyguardQuickAffordanceConfig {
    ...
    public DoNotDisturbQuickAffordanceConfig(Context context, ZenModeController zenModeController, ZenModeInteractor zenModeInteractor, SecureSettings secureSettings, UserTracker userTracker, CoroutineDispatcher coroutineDispatcher, CoroutineScope coroutineScope, Uri uri, EnableDndDialogFactory enableDndDialogFactory) {
        ...
        this.callback = new ZenModeController.Callback() { // from class: com.android.systemui.keyguard.data.quickaffordance.DoNotDisturbQuickAffordanceConfig$callback$1
            ...
            public final void onZenAvailableChanged(boolean z) {
                DoNotDisturbQuickAffordanceConfig.this.oldIsAvailable = z;
            ...
            public final void onZenChanged(int i) {
                DoNotDisturbQuickAffordanceConfig.this.zenMode = i;
                ((KeyguardShortcutManager) Dependency.sDependency.getDependencyInner(KeyguardShortcutManager.class)).updateShortcutIcons();
            }
        };
    ...
    public static final KeyguardQuickAffordanceConfig.LockScreenState access$updateState(DoNotDisturbQuickAffordanceConfig doNotDisturbQuickAffordanceConfig) {
        ...
        if (doNotDisturbQuickAffordanceConfig.zenMode == 0) {
            ...
            Drawable convertTaskDrawable = keyguardShortcutManager.convertTaskDrawable(keyguardShortcutManager.context.getDrawable(R.drawable.fg_do_not_disturb_off), WallpaperUtils.isWhiteKeyguardWallpaper("navibar"), false, false, false);
            convertTaskDrawable.getClass();
            return new KeyguardQuickAffordanceConfig.LockScreenState.Visible(new Icon.Loaded(convertTaskDrawable, new ContentDescription.Resource(R.string.dnd_is_off), null, 4, null), ActivationState.Inactive.INSTANCE);
        }
        ...
        Drawable convertTaskDrawable2 = keyguardShortcutManager2.convertTaskDrawable(keyguardShortcutManager2.context.getDrawable(R.drawable.fg_do_not_disturb_off), WallpaperUtils.isWhiteKeyguardWallpaper("navibar"), true, false, false);
        convertTaskDrawable2.getClass();
        return new KeyguardQuickAffordanceConfig.LockScreenState.Visible(new Icon.Loaded(convertTaskDrawable2, new ContentDescription.Resource(R.string.dnd_is_on), null, 4, null), ActivationState.Active.INSTANCE);
    }
