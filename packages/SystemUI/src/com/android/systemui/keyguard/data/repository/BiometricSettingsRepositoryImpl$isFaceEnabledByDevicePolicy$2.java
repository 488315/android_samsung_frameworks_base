...
final class BiometricSettingsRepositoryImpl$isFaceEnabledByDevicePolicy$2 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Boolean boolValueOf = Boolean.valueOf(BiometricSettingsRepositoryKt.isNotActive(this.$devicePolicyManager, ((UserRepositoryImpl) this.this$0.userRepository).getSelectedUserInfo().id, 128));
            this.label = 1;
