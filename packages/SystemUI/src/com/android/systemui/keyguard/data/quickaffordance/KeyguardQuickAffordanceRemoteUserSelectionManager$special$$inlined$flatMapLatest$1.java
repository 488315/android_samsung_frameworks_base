    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (customizationProviderClient != null) {
                final CustomizationProviderClientImpl$observeSelections$$inlined$map$1 customizationProviderClientImpl$observeSelections$$inlined$map$1ObserveSelections = ((CustomizationProviderClientImpl) customizationProviderClient).observeSelections();
                flow = new Flow() { // from class: com.android.systemui.keyguard.data.quickaffordance.KeyguardQuickAffordanceRemoteUserSelectionManager$_selections$lambda$4$$inlined$map$1
                    ...
                    public final Object collect(FlowCollector flowCollector2, Continuation continuation) {
                        Object objCollect = customizationProviderClientImpl$observeSelections$$inlined$map$1ObserveSelections.collect(new AnonymousClass2(flowCollector2), continuation);
