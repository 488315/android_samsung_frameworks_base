...
final class KeyguardQuickAffordanceLegacySettingSyncer$startSyncing$3 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        bool.booleanValue();
        return ((KeyguardQuickAffordanceLegacySettingSyncer$startSyncing$3) create(bool, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (CollectionsKt___CollectionsKt.toSet(CollectionsKt__IterablesKt.flatten(((LinkedHashMap) keyguardQuickAffordanceLegacySettingSyncer.selectionsManager.getSelections()).values())).contains(this.$binding.affordanceId) != z) {
            if (z) {
                ...
                Collection collection = (List) ((LinkedHashMap) keyguardQuickAffordanceLocalUserSelectionManager.getSelections()).get(str);
                if (collection == null) {
                ...
                LinkedHashMap linkedHashMap2 = (LinkedHashMap) selections;
                ...
                while (i < size) {
                    ...
                    Collection collection2 = (List) linkedHashMap2.get(str4);
                    if (collection2 == null) {
