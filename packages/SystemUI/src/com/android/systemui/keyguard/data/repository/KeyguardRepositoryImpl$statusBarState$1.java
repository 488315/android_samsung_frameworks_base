...
final class KeyguardRepositoryImpl$statusBarState$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            StatusBarStateController.StateListener stateListener = new StatusBarStateController.StateListener() { // from class: com.android.systemui.keyguard.data.repository.KeyguardRepositoryImpl$statusBarState$1$callback$1
                @Override // com.android.systemui.plugins.statusbar.StatusBarStateController.StateListener
                public final void onStateChanged(int i2) {
                    ChannelExt channelExt = ChannelExt.INSTANCE;
                    int i3 = KeyguardRepositoryImpl.$r8$clinit;
                    keyguardRepositoryImpl.getClass();
                    StatusBarState statusBarStateStatusBarStateIntToObject = KeyguardRepositoryImpl.statusBarStateIntToObject(i2);
                    channelExt.getClass();
                    ChannelExt.trySendWithFailureLogging(producerScope, statusBarStateStatusBarStateIntToObject, "KeyguardRepositoryImpl", "state");
                }
            };
            this.$statusBarStateController.addCallback(stateListener);
            KeyguardRepositoryImpl$statusBarState$1$$ExternalSyntheticLambda0 keyguardRepositoryImpl$statusBarState$1$$ExternalSyntheticLambda0 = new KeyguardRepositoryImpl$statusBarState$1$$ExternalSyntheticLambda0(0, this.$statusBarStateController, stateListener);
            this.label = 1;
