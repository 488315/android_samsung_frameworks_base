...
final class QuickAccessWalletKeyguardQuickAffordanceConfig$lockScreenState$1 extends SuspendLambda implements Function2 {
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ?? r10 = new QuickAccessWalletClient.OnWalletCardsRetrievedCallback() { // from class: com.android.systemui.keyguard.data.quickaffordance.QuickAccessWalletKeyguardQuickAffordanceConfig$lockScreenState$1$callback$1
                public final void onWalletCardRetrievalError(GetWalletCardsError getWalletCardsError) {
                    ...
                    ChannelExt.trySendWithFailureLogging$default(ChannelExt.INSTANCE, producerScope, null, "QuickAccessWalletKeyguardQuickAffordanceConfig");
                }

                public final void onWalletCardsRetrieved(GetWalletCardsResponse getWalletCardsResponse) {
                    boolean z = false;
                    if (WalletCardUtilsKt.getPaymentCards(getWalletCardsResponse.getWalletCards()) != null && (!r3.isEmpty())) {
                        z = true;
                    }
                    ChannelExt.trySendWithFailureLogging$default(ChannelExt.INSTANCE, producerScope, Boolean.valueOf(z), "QuickAccessWalletKeyguardQuickAffordanceConfig");
                }
            };
        ...
        Function0 function0 = new Function0() { // from class: com.android.systemui.keyguard.data.quickaffordance.QuickAccessWalletKeyguardQuickAffordanceConfig$lockScreenState$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                quickAccessWalletKeyguardQuickAffordanceConfig2.walletController.unregisterWalletChangeObservers(QuickAccessWalletController.WalletChangeEvent.WALLET_PREFERENCE_CHANGE, QuickAccessWalletController.WalletChangeEvent.DEFAULT_PAYMENT_APP_CHANGE, QuickAccessWalletController.WalletChangeEvent.DEFAULT_WALLET_APP_CHANGE);
                return Unit.INSTANCE;
            }
        };
        this.L$0 = null;
