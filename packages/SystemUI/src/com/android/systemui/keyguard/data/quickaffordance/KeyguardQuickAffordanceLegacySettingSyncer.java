...
public final class KeyguardQuickAffordanceLegacySettingSyncer {
    ...
    public final class Binding {
        ...
        public final String toString() {
            ...
            return TransitionKt$$ExternalSyntheticOutline0.m(sb, this.affordanceId, ")");
        }
    }
    ...
    static {
        new Companion(null);
        BINDINGS = Arrays.asList(new Binding("lockscreen_show_controls", "bottom_start", BcSmartspaceDataPlugin.UI_SURFACE_HOME_SCREEN), new Binding("lockscreen_show_wallet", "bottom_end", "wallet"), new Binding("lock_screen_show_qr_code_scanner", "bottom_end", "qr_code_scanner"));
    }
    ...
    public static void startSyncing$default(KeyguardQuickAffordanceLegacySettingSyncer keyguardQuickAffordanceLegacySettingSyncer) {
        ...
        CoroutineTracingKt.launchTraced$default(keyguardQuickAffordanceLegacySettingSyncer.scope, null, null, new KeyguardQuickAffordanceLegacySettingSyncer$startSyncing$1(list, keyguardQuickAffordanceLegacySettingSyncer, null), 7);
    }
}
