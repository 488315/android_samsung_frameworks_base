...
public final class StrongAuthTracker extends LockPatternUtils.StrongAuthTracker {
    ...
    public StrongAuthTracker(UserRepository userRepository, Context context) {
        ...
        Flow distinctUntilChanged = FlowKt.distinctUntilChanged(new Flow() { // from class: com.android.systemui.keyguard.data.repository.StrongAuthTracker$special$$inlined$map$1
    ...
    public final void onIsNonStrongBiometricAllowedChanged(int i) {
        ...
        this._nonStrongBiometricAllowed.updateState(null, new Pair(Integer.valueOf(i), Boolean.valueOf(isNonStrongBiometricAllowedAfterIdleTimeout)));
    ...
    public final void onStrongAuthRequiredChanged(int i) {
        ...
        KeyguardSecUpdateMonitorImpl$$ExternalSyntheticOutline0.m(new StringBuilder("onStrongAuthRequiredChanged for userId: "), i, ", flag value: ", strongAuthForUser, "BiometricsRepositoryImpl");
    }
}
