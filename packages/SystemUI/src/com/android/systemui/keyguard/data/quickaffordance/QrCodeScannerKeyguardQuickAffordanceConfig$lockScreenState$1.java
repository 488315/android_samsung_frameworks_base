        ...
        if (i == 0) {
            ...
            final ?? r1 = new QRCodeScannerController.Callback() { // from class: com.android.systemui.keyguard.data.quickaffordance.QrCodeScannerKeyguardQuickAffordanceConfig$lockScreenState$1$callback$1
                ...
                public final void onQRCodeScannerActivityChanged() {
                    ChannelExt.trySendWithFailureLogging$default(ChannelExt.INSTANCE, producerScope, QrCodeScannerKeyguardQuickAffordanceConfig.access$state(qrCodeScannerKeyguardQuickAffordanceConfig), "QrCodeScannerKeyguardQuickAffordanceConfig");
                }
            ...
            KeyguardQuickAffordanceConfig.LockScreenState lockScreenStateAccess$state = QrCodeScannerKeyguardQuickAffordanceConfig.access$state(this.this$0);
            channelExt.getClass();
            ChannelExt.trySendWithFailureLogging(producerScope, lockScreenStateAccess$state, "initial state", "QrCodeScannerKeyguardQuickAffordanceConfig");
            final QrCodeScannerKeyguardQuickAffordanceConfig qrCodeScannerKeyguardQuickAffordanceConfig2 = this.this$0;
            Function0 function0 = new Function0() { // from class: com.android.systemui.keyguard.data.quickaffordance.QrCodeScannerKeyguardQuickAffordanceConfig$lockScreenState$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    QrCodeScannerKeyguardQuickAffordanceConfig qrCodeScannerKeyguardQuickAffordanceConfig3 = qrCodeScannerKeyguardQuickAffordanceConfig2;
                    qrCodeScannerKeyguardQuickAffordanceConfig3.controller.unregisterQRCodeScannerChangeObservers(0, 1);
                    qrCodeScannerKeyguardQuickAffordanceConfig3.controller.removeCallback((QRCodeScannerController.Callback) r1);
