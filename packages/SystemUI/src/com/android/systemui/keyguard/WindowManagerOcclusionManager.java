...
public final class WindowManagerOcclusionManager {
    ...
    public WindowManagerOcclusionManager$unoccludeAnimationRunner$1$onAnimationStart$1 unoccludeAnimationFinishedCallback;
    ...
    public final WindowManagerOcclusionManager$occludeAnimationRunner$1 occludeAnimationRunner = new IRemoteAnimationRunner.Stub() { // from class: com.android.systemui.keyguard.WindowManagerOcclusionManager$occludeAnimationRunner$1
        ...
        /* JADX WARN: Type inference failed for: r1v1, types: [com.android.systemui.keyguard.WindowManagerOcclusionManager$occludeAnimationRunner$1$onAnimationStart$1] */
    ...
    public final WindowManagerOcclusionManager$occludeAnimationController$1 occludeAnimationController = new ActivityTransitionAnimator.Controller() { // from class: com.android.systemui.keyguard.WindowManagerOcclusionManager$occludeAnimationController$1
        ...
        public final TransitionAnimator.State createAnimatorState() {
            ...
            return new TransitionAnimator.State(((int) f9) / 2, (int) ((f9 / f10) + f6), ((int) f11) / 2, (int) ((f11 / f10) + f8), f12, f12);
        }
    ...
    /* JADX WARN: Type inference failed for: r1v4, types: [com.android.systemui.keyguard.WindowManagerOcclusionManager$occludeAnimationRunner$1] */
