...
public final class BurnInModel {
    ...
    public final int hashCode() {
        return Boolean.hashCode(this.scaleClockOnly) + FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.scale, ReorderTile$$ExternalSyntheticOutline0.m(this.translationY, Integer.hashCode(this.translationX) * 31, 31), 31);
    }
    ...
    public final String toString() {
        ...
        return MoveResult$$ExternalSyntheticOutline0.m(sb, this.scaleClockOnly, ")");
    }
