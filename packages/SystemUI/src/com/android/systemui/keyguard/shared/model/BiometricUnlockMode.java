...
public final class BiometricUnlockMode {
    ...
    static {
        ...
        wakeAndUnlockModes = ArraysKt___ArraysKt.toSet(new BiometricUnlockMode[]{biometricUnlockMode2, biometricUnlockMode8, biometricUnlockMode3});
        dismissesKeyguardModes = ArraysKt___ArraysKt.toSet(new BiometricUnlockMode[]{biometricUnlockMode2, biometricUnlockMode3, biometricUnlockMode6, biometricUnlockMode8, biometricUnlockMode7});
    }
