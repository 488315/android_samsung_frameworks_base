...
public final class WindowManagerOcclusionManager$unoccludeAnimationRunner$1 extends IRemoteAnimationRunner.Stub {
    ...
    public final void onAnimationStart(int i, RemoteAnimationTarget[] remoteAnimationTargetArr, RemoteAnimationTarget[] remoteAnimationTargetArr2, RemoteAnimationTarget[] remoteAnimationTargetArr3, IRemoteAnimationFinishedCallback iRemoteAnimationFinishedCallback) {
        ...
        this.this$0.unoccludeAnimationFinishedCallback = new WindowManagerOcclusionManager$unoccludeAnimationRunner$1$onAnimationStart$1(iRemoteAnimationFinishedCallback, this.this$0);
        ...
        windowManagerOcclusionManager.interactionJankMonitor.begin(InteractionJankMonitor.Configuration.Builder.withView(64, ((KeyguardViewController) windowManagerOcclusionManager.keyguardViewController.get()).getViewRootImpl().getView()).setTag("UNOCCLUDE"));
        if (remoteAnimationTargetArr.length == 0) {
            ...
            WindowManagerOcclusionManager$unoccludeAnimationRunner$1$onAnimationStart$1 windowManagerOcclusionManager$unoccludeAnimationRunner$1$onAnimationStart$1 = this.this$0.unoccludeAnimationFinishedCallback;
            if (windowManagerOcclusionManager$unoccludeAnimationRunner$1$onAnimationStart$1 != null) {
                windowManagerOcclusionManager$unoccludeAnimationRunner$1$onAnimationStart$1.onAnimationFinished();
                return;
            }
            return;
        }
