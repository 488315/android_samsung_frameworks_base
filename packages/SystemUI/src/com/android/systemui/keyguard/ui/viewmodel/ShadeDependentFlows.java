...
public final class ShadeDependentFlows {
    ...
    public final ChannelLimitedFlowMerge transitionFlow(Flow flow, Flow flow2) {
        ...
        final Flow flowSample = FlowKt.sample(flow, flow3, shadeDependentFlows$transitionFlow$filteredFlowWhenShadeIsExpanded$3);
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(objComponent1, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
        ...
        final Flow flowSample2 = FlowKt.sample(flow2, flow3, ShadeDependentFlows$transitionFlow$filteredFlowWhenShadeIsNotExpanded$3.INSTANCE);
