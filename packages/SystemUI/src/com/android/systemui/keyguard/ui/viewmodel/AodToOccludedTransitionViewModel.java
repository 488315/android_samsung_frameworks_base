...
public final class AodToOccludedTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public AodToOccludedTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder m2598setupVtjQ1oo = keyguardTransitionAnimationFlow.m2598setupVtjQ1oo(FromAodTransitionInteractor.TO_OCCLUDED_DURATION, KeyguardInteractor$$ExternalSyntheticOutline0.m(Edge.Companion, KeyguardState.AOD, KeyguardState.OCCLUDED));
    ...
    public final Flow lockscreenAlpha(final ViewStateAccessor viewStateAccessor) {
        ...
        return KeyguardTransitionAnimationFlow.FlowBuilder.m2599sharedFlow74qcysc$default(this.transitionAnimation, duration, new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodToOccludedTransitionViewModel$$ExternalSyntheticLambda0
