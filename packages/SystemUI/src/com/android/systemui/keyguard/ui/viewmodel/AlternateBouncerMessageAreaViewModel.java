...
public final class AlternateBouncerMessageAreaViewModel {
    ...
    public AlternateBouncerMessageAreaViewModel(BiometricMessageInteractor biometricMessageInteractor, AlternateBouncerInteractor alternateBouncerInteractor, final SystemClock systemClock) {
        ...
        final Flow flow2 = new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.AlternateBouncerMessageAreaViewModel$special$$inlined$map$1
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        Pair pair = new Pair((FingerprintMessage) obj, new Long(this.$systemClock$inlined.uptimeMillis()));
                        anonymousClass1.label = 1;
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = flow.collect(new AnonymousClass2(flowCollector, systemClock), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        };
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ...
                        first.getClass();
                        anonymousClass1.label = 1;
                        if (this.$this_unsafeFlow.emit(first, anonymousClass1) == coroutineSingletons) {
                            return coroutineSingletons;
                        }
                    } else {
                        if (i2 != 1) {
        ...
        final Flow flowSample = FlowKt.sample(new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.AlternateBouncerMessageAreaViewModel$special$$inlined$filterNot$2
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        if (!(((FaceMessage) obj) instanceof FaceTimeoutMessage)) {
                            anonymousClass1.label = 1;
                            if (this.$this_unsafeFlow.emit(obj, anonymousClass1) == coroutineSingletons) {
                                return coroutineSingletons;
                            }
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = channelLimitedFlowMerge2.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        ...
        final Flow flow4 = new Flow() { // from class: com.android.systemui.keyguard.ui.viewmodel.AlternateBouncerMessageAreaViewModel$special$$inlined$filter$2
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        if (this.$systemClock$inlined.uptimeMillis() - ((Number) ((Pair) ((Pair) obj).component2()).getSecond()).longValue() >= 3500) {
                            anonymousClass1.label = 1;
                            if (this.$this_unsafeFlow.emit(obj, anonymousClass1) == coroutineSingletons) {
                                return coroutineSingletons;
                            }
            ...
            @Override // kotlinx.coroutines.flow.Flow
            public final Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = flowSample.collect(new AnonymousClass2(flowCollector, systemClock), continuation);
                return objCollect == CoroutineSingletons.COROUTINE_SUSPENDED ? objCollect : Unit.INSTANCE;
            }
        };
            ...
            public final class AnonymousClass2 implements FlowCollector {
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i2 == 0) {
                        ResultKt.throwOnFailure(obj2);
                        FaceMessage faceMessage = (FaceMessage) ((Pair) obj).component1();
                        anonymousClass1.label = 1;
