...
public final class DozingToOccludedTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public DozingToOccludedTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilderM2613setupVtjQ1oo = keyguardTransitionAnimationFlow.m2613setupVtjQ1oo(FromAodTransitionInteractor.TO_OCCLUDED_DURATION, KeyguardInteractor$$ExternalSyntheticOutline0.m(Edge.Companion, KeyguardState.DOZING, KeyguardState.OCCLUDED));
    ...
    public final Flow lockscreenAlpha(final ViewStateAccessor viewStateAccessor) {
        ...
        return KeyguardTransitionAnimationFlow.FlowBuilder.m2614sharedFlow74qcysc$default(this.transitionAnimation, duration, new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.DozingToOccludedTransitionViewModel$$ExternalSyntheticLambda0
