...
public final class AlternateBouncerToLockscreenTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public AlternateBouncerToLockscreenTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder m2598setupVtjQ1oo = keyguardTransitionAnimationFlow.m2598setupVtjQ1oo(FromAlternateBouncerTransitionInteractor.TO_LOCKSCREEN_DURATION, KeyguardInteractor$$ExternalSyntheticOutline0.m(Edge.Companion, KeyguardState.ALTERNATE_BOUNCER, KeyguardState.LOCKSCREEN));
        this.transitionAnimation = m2598setupVtjQ1oo;
        m2598setupVtjQ1oo.immediatelyTransitionTo(1.0f);
