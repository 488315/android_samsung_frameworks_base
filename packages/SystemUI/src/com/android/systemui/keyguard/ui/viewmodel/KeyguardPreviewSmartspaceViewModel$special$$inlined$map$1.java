...
public final class KeyguardPreviewSmartspaceViewModel$special$$inlined$map$1 implements Flow {
        ...
        */
        public final Object emit(Object obj, Continuation continuation) {
            ...
            if (i2 == 0) {
                ...
                Pair pair = (Pair) obj;
                ClockSizeSetting clockSizeSetting = (ClockSizeSetting) pair.component1();
                String str = (String) pair.component2();
                int i3 = KeyguardPreviewSmartspaceViewModel.WhenMappings.$EnumSwitchMapping$0[clockSizeSetting.ordinal()];
                if (i3 == 1) {
                    zAreEqual = Intrinsics.areEqual(str, "DIGITAL_CLOCK_WEATHER");
                } else {
                    if (i3 != 2) {
    ...
    public KeyguardPreviewSmartspaceViewModel$special$$inlined$map$1(Flow flow) {
