...
public final class BouncerToGoneFlows {
    ...
    public final ChannelFlowTransformLatest m2604createScrimAlphaFlowKLykuaI(long j, KeyguardState keyguardState, Function0 function0) {
        Edge stateToContent;
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder m2598setupVtjQ1oo = this.animationFlow.m2598setupVtjQ1oo(j, stateToContent);
        Edge.Companion companion2 = Edge.Companion;
        KeyguardState keyguardState2 = KeyguardState.GONE;
        companion2.getClass();
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilder = m2598setupVtjQ1oo.setupWithoutSceneContainer(new Edge.StateToState(keyguardState, keyguardState2));
    ...
    public final Flow m2605showAllNotificationsVtjQ1oo(long j, KeyguardState keyguardState) {
        Edge stateToContent;
