...
public final class AlternateBouncerToOccludedTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public AlternateBouncerToOccludedTransitionViewModel(KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        this.deviceEntryParentViewAlpha = keyguardTransitionAnimationFlow.m1961setupVtjQ1oo(FromAlternateBouncerTransitionInteractor.TO_OCCLUDED_DURATION, KeyguardTransitionInteractor$2$1$$ExternalSyntheticOutline0.m(Edge.Companion, KeyguardState.ALTERNATE_BOUNCER, KeyguardState.OCCLUDED)).immediatelyTransitionTo(0.0f);
    }
