...
public final class LockscreenToAodTransitionViewModel$lockscreenAlpha$$inlined$transform$1 extends SuspendLambda implements Function2 {
    ...
    public final class AnonymousClass1 implements FlowCollector {
        ...
        public final class C03301 extends ContinuationImpl {
            int label;
        ...
        public final Object emit(Object obj, Continuation continuation) {
            ...
            if (continuation instanceof C03301) {
                ...
                if ((i & Integer.MIN_VALUE) != 0) {
                    c03301.label = i - Integer.MIN_VALUE;
                } else {
                    c03301 = new C03301(continuation);
                }
            }
            Object obj2 = c03301.result;
            ...
            if (i2 == 0) {
                ...
                if (((WakefulnessModel) pair.component2()).lastSleepReason != WakeSleepReason.FOLD) {
                    ...
                    c03301.label = 1;
                    if (this.$$this$flow.emit(f, c03301) == coroutineSingletons) {
