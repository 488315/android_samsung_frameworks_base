...
final class KeyguardSmartspaceViewBinder$bind$1 extends SuspendLambda implements Function3 {
    ...
    final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        final class C02051 extends SuspendLambda implements Function2 {
            final /* synthetic */ KeyguardBlueprintInteractor $blueprintInteractor;
            final /* synthetic */ KeyguardClockViewModel $clockViewModel;
            final /* synthetic */ ConstraintLayout $keyguardRootView;
            final /* synthetic */ KeyguardSmartspaceViewModel $smartspaceViewModel;
            ...
            public C02051(KeyguardSmartspaceViewModel keyguardSmartspaceViewModel, KeyguardClockViewModel keyguardClockViewModel, ConstraintLayout constraintLayout, KeyguardBlueprintInteractor keyguardBlueprintInteractor, Continuation continuation) {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new C02051(this.$smartspaceViewModel, this.$clockViewModel, this.$keyguardRootView, this.$blueprintInteractor, continuation);
            }
                ...
                if (i == 0) {
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.ui.binder.KeyguardSmartspaceViewBinder.bind.1.1.1.4
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            ...
                            boolean booleanValue = ((Boolean) keyguardClockViewModel2.hasCustomWeatherDataDisplay.$$delegate_0.getValue()).booleanValue();
                    ...
                    FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.ui.binder.KeyguardSmartspaceViewBinder.bind.1.1.2.1
                        ...
                        public final Object emit(Object obj2, Continuation continuation) {
                            ...
                            if (requireViewById.getVisibility() == 0) {
                                layer.addView(requireViewById);
                            } else {
                                layer.removeView(requireViewById);
                            }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$keyguardRootView, this.$smartspaceViewModel, this.$clockViewModel, this.$blueprintInteractor, this.$keyguardRootViewModel, continuation);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            CoroutineTracingKt.launchTraced$default(coroutineScope, null, null, new C02051(this.$smartspaceViewModel, this.$clockViewModel, this.$keyguardRootView, this.$blueprintInteractor, null), 6);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KeyguardSmartspaceViewBinder$bind$1(ConstraintLayout constraintLayout, KeyguardSmartspaceViewModel keyguardSmartspaceViewModel, KeyguardClockViewModel keyguardClockViewModel, KeyguardBlueprintInteractor keyguardBlueprintInteractor, KeyguardRootViewModel keyguardRootViewModel, Continuation continuation) {
    ...
    @Override // kotlin.jvm.functions.Function3
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        KeyguardSmartspaceViewBinder$bind$1 keyguardSmartspaceViewBinder$bind$1 = new KeyguardSmartspaceViewBinder$bind$1(this.$keyguardRootView, this.$smartspaceViewModel, this.$clockViewModel, this.$blueprintInteractor, this.$keyguardRootViewModel, (Continuation) obj3);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$keyguardRootView, this.$smartspaceViewModel, this.$clockViewModel, this.$blueprintInteractor, this.$keyguardRootViewModel, null);
            this.label = 1;
