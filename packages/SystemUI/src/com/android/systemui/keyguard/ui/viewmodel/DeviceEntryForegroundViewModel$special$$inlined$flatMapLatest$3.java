    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (((Boolean) this.L$1).booleanValue()) {
                flow = FlowKt.debounce(this.$udfpsOverlayInteractor$inlined.iconPadding, this.this$0.context.getResources().getInteger(R.integer.udfps_padding_debounce_duration));
            } else {
