...
public final class LockscreenToAodTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public LockscreenToAodTransitionViewModel(DeviceEntryUdfpsInteractor deviceEntryUdfpsInteractor, PowerInteractor powerInteractor, ShadeDependentFlows shadeDependentFlows, KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilderM2613setupVtjQ1oo = keyguardTransitionAnimationFlow.m2613setupVtjQ1oo(j, KeyguardInteractor$$ExternalSyntheticOutline0.m(companion, keyguardState, keyguardState2));
        this.transitionAnimation = flowBuilderM2613setupVtjQ1oo;
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilderM2613setupVtjQ1oo2 = keyguardTransitionAnimationFlow.m2613setupVtjQ1oo(FromLockscreenTransitionInteractor.TO_AOD_FOLD_DURATION, new Edge.StateToState(keyguardState, keyguardState2));
        this.transitionAnimationOnFold = flowBuilderM2613setupVtjQ1oo2;
        KeyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1 keyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1ImmediatelyTransitionTo = flowBuilderM2613setupVtjQ1oo.immediatelyTransitionTo(0.0f);
        Duration.Companion companion2 = Duration.Companion;
        DurationUnit durationUnit = DurationUnit.MILLISECONDS;
        final int i = 0;
        this.deviceEntryBackgroundViewAlpha = shadeDependentFlows.transitionFlow(keyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1ImmediatelyTransitionTo, KeyguardTransitionAnimationFlow.FlowBuilder.m2614sharedFlow74qcysc$default(flowBuilderM2613setupVtjQ1oo, DurationKt.toDuration(300, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.LockscreenToAodTransitionViewModel$$ExternalSyntheticLambda0
