...
public final class LockscreenToAodTransitionViewModel implements DeviceEntryIconTransition {
    ...
    public LockscreenToAodTransitionViewModel(DeviceEntryUdfpsInteractor deviceEntryUdfpsInteractor, PowerInteractor powerInteractor, ShadeDependentFlows shadeDependentFlows, KeyguardTransitionAnimationFlow keyguardTransitionAnimationFlow) {
        ...
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilderM2615setupVtjQ1oo = keyguardTransitionAnimationFlow.m2615setupVtjQ1oo(j, KeyguardInteractor$$ExternalSyntheticOutline0.m(companion, keyguardState, keyguardState2));
        this.transitionAnimation = flowBuilderM2615setupVtjQ1oo;
        KeyguardTransitionAnimationFlow.FlowBuilder flowBuilderM2615setupVtjQ1oo2 = keyguardTransitionAnimationFlow.m2615setupVtjQ1oo(FromLockscreenTransitionInteractor.TO_AOD_FOLD_DURATION, new Edge.StateToState(keyguardState, keyguardState2));
        this.transitionAnimationOnFold = flowBuilderM2615setupVtjQ1oo2;
        KeyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1 keyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1ImmediatelyTransitionTo = flowBuilderM2615setupVtjQ1oo.immediatelyTransitionTo(0.0f);
        Duration.Companion companion2 = Duration.Companion;
        DurationUnit durationUnit = DurationUnit.MILLISECONDS;
        final int i = 0;
        this.deviceEntryBackgroundViewAlpha = shadeDependentFlows.transitionFlow(keyguardTransitionAnimationFlow$FlowBuilder$sharedFlow74qcysc$$inlined$mapNotNull$1ImmediatelyTransitionTo, KeyguardTransitionAnimationFlow.FlowBuilder.m2616sharedFlow74qcysc$default(flowBuilderM2615setupVtjQ1oo, DurationKt.toDuration(300, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.LockscreenToAodTransitionViewModel$$ExternalSyntheticLambda0
        ...
        this.lockscreenAlphaOnFold = new SafeFlow(new LockscreenToAodTransitionViewModel$special$$inlined$transform$1(FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m2616sharedFlow74qcysc$default(flowBuilderM2615setupVtjQ1oo2, DurationKt.toDuration(500, durationUnit), new AodToLockscreenTransitionViewModel$$ExternalSyntheticLambda6(), DurationKt.toDuration(VolteConstants.ErrorCode.BUSY_EVERYWHERE, durationUnit), null, null, null, null, null, IKnoxCustomManager.Stub.TRANSACTION_removeDexShortcut), powerInteractor.detailedWakefulness, LockscreenToAodTransitionViewModel$lockscreenAlphaOnFold$4.INSTANCE), null));
        new SafeFlow(new LockscreenToAodTransitionViewModel$special$$inlined$transform$2(FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m2616sharedFlow74qcysc$default(flowBuilderM2615setupVtjQ1oo2, DurationKt.toDuration(1100, durationUnit), new DozingToGoneTransitionViewModel$$ExternalSyntheticLambda0(), 0L, null, null, new AnimatedBackgroundKt$$ExternalSyntheticLambda0(), null, null, 220), powerInteractor.detailedWakefulness, LockscreenToAodTransitionViewModel$notificationAlphaOnFold$5.INSTANCE), null));
