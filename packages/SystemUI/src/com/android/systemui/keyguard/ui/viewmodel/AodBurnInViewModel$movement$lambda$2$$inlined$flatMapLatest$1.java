...
public final class AodBurnInViewModel$movement$lambda$2$$inlined$flatMapLatest$1 extends SuspendLambda implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$13 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$3(null), new SafeFlow(new GoneToAodTransitionViewModel$enterFromTopTranslationY$$inlined$transform$1(com.android.systemui.util.kotlin.FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m2615sharedFlowWithState74qcysc$default(goneToAodTransitionViewModel.transitionAnimation, duration2, new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.GoneToAodTransitionViewModel$$ExternalSyntheticLambda0
            ...
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$14 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$4(null), new SafeFlow(new GoneToAodTransitionViewModel$enterFromSideTranslationX$$inlined$transform$1(com.android.systemui.util.kotlin.FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m2615sharedFlowWithState74qcysc$default(goneToAodTransitionViewModel2.transitionAnimation, DurationKt.toDuration(VolteConstants.ErrorCode.BUSY_EVERYWHERE, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.GoneToAodTransitionViewModel$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                /* renamed from: invoke */
            ...
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$15 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$5(null), new SafeFlow(new LockscreenToAodTransitionViewModel$enterFromSideTranslationX$$inlined$transform$1(com.android.systemui.util.kotlin.FlowKt.sample(KeyguardTransitionAnimationFlow.FlowBuilder.m2615sharedFlowWithState74qcysc$default(lockscreenToAodTransitionViewModel.transitionAnimationOnFold, DurationKt.toDuration(500, durationUnit), new Function1() { // from class: com.android.systemui.keyguard.ui.viewmodel.LockscreenToAodTransitionViewModel$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function1
                /* renamed from: invoke */
            ...
            final int i4 = 1;
            FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 flowKt__EmittersKt$onStart$$inlined$unsafeFlow$17 = new FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1(new AodBurnInViewModel$movement$1$1$7(null), KeyguardTransitionAnimationFlow.FlowBuilder.m2615sharedFlowWithState74qcysc$default(aodToLockscreenTransitionViewModel.transitionAnimation, DurationKt.toDuration(500, durationUnit), new AodToLockscreenTransitionViewModel$$ExternalSyntheticLambda0(ref$FloatRef, 1), 0L, new Function0() { // from class: com.android.systemui.keyguard.ui.viewmodel.AodToLockscreenTransitionViewModel$$ExternalSyntheticLambda1
