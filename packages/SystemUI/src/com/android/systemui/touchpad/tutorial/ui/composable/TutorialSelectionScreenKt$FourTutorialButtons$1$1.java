...
final class TutorialSelectionScreenKt$FourTutorialButtons$1$1 extends SuspendLambda implements Function2 {
    ...
    public TutorialSelectionScreenKt$FourTutorialButtons$1$1(Screen screen, FocusRequester focusRequester, FocusRequester focusRequester2, FocusRequester focusRequester3, FocusRequester focusRequester4, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new TutorialSelectionScreenKt$FourTutorialButtons$1$1(this.$lastSelectedScreen, this.$homeFocusRequester, this.$backFocusRequester, this.$recentAppsFocusRequester, this.$switchAppsFocusRequester, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((TutorialSelectionScreenKt$FourTutorialButtons$1$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
