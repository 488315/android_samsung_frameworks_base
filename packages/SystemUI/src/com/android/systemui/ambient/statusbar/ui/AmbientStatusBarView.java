...
public class AmbientStatusBarView extends ConstraintLayout {
    ...
    public final void onFinishInflate() {
        ...
        this.mKeyShadowInfo = new DoubleShadowTextHelper.ShadowInfo(this.mContext.getResources().getDimension(R.dimen.dream_overlay_icon_shadow_radius), this.mContext.getResources().getDimension(R.dimen.dream_overlay_status_bar_key_text_shadow_dx), this.mContext.getResources().getDimension(R.dimen.dream_overlay_status_bar_key_text_shadow_dy), 0.9f);
        this.mAmbientShadowInfo = new DoubleShadowTextHelper.ShadowInfo(this.mContext.getResources().getDimension(R.dimen.dream_overlay_icon_ambient_shadow_radius), this.mContext.getResources().getDimension(R.dimen.dream_overlay_status_bar_ambient_text_shadow_dx), this.mContext.getResources().getDimension(R.dimen.dream_overlay_status_bar_ambient_text_shadow_dy), 0.7f);
