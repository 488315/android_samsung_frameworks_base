...
public final class ChangeSceneSwipeTransition extends TransitionState.Transition.ChangeScene {
    ...
    public ChangeSceneSwipeTransition(SwipeAnimation swipeAnimation, TransitionKey transitionKey, ChangeSceneSwipeTransition changeSceneSwipeTransition) {
