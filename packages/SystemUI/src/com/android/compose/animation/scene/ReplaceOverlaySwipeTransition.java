...
public final class ReplaceOverlaySwipeTransition extends TransitionState.Transition.ReplaceOverlay {
    ...
    public ReplaceOverlaySwipeTransition(SwipeAnimation swipeAnimation, TransitionKey transitionKey, ReplaceOverlaySwipeTransition replaceOverlaySwipeTransition) {
        super((OverlayKey) swipeAnimation.fromContent, (OverlayKey) swipeAnimation.toContent, replaceOverlaySwipeTransition);
    ...
    public final Object run(Continuation continuation) {
        Object objRun = this.swipeAnimation.run((ContinuationImpl) continuation);
        return objRun == CoroutineSingletons.COROUTINE_SUSPENDED ? objRun : Unit.INSTANCE;
    }
}
