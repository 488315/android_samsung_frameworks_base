    ...
    public PolymorphicSerializer(KClass kClass) {
        ...
        this.descriptor$delegate = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: kotlinx.serialization.PolymorphicSerializer$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                final PolymorphicSerializer polymorphicSerializer = this.f$0;
                return new ContextDescriptor(SerialDescriptorsKt.buildSerialDescriptor("kotlinx.serialization.Polymorphic", PolymorphicKind.OPEN.INSTANCE, new SerialDescriptor[0], new Function1() { // from class: kotlinx.serialization.PolymorphicSerializer$$ExternalSyntheticLambda1
                    ...
                    public final Object mo781invoke(Object obj) {
                        ...
                        String strM = ContentInViewNode$Request$$ExternalSyntheticOutline0.m("kotlinx.serialization.Polymorphic<", ((ClassReference) polymorphicSerializer.baseClass).getSimpleName(), ">");
                        ...
                        ClassSerialDescriptorBuilder classSerialDescriptorBuilder2 = new ClassSerialDescriptorBuilder(strM);
                        Unit unit = Unit.INSTANCE;
                        ClassSerialDescriptorBuilder.element$default(classSerialDescriptorBuilder, "value", new SerialDescriptorImpl(strM, contextual, ((ArrayList) classSerialDescriptorBuilder2.elementNames).size(), ArraysKt___ArraysKt.toList(serialDescriptorArr), classSerialDescriptorBuilder2));
