...
public final class LockFreeTaskQueueCore {
    ...
    public final int addLast(Object obj) {
        ...
        while (true) {
            ...
            Companion.getClass();
            if (atomicLong2.compareAndSet(j, ((-1152921503533105153L) & j) | (((i2 + 1) & 1073741823) << 30))) {
                this.array.array[i2 & i3].setValue(obj);
                while ((this._state.value & 1152921504606846976L) != 0) {
                    ...
                    if ((obj2 instanceof Placeholder) && ((Placeholder) obj2).index == i2) {
                        this.array.array[this.mask & i2].setValue(obj);
                    } else {
                        this = null;
                    }
                    if (this == null) {
        ...
        while (true) {
            ...
            if ((j & 1152921504606846976L) == 0) {
                ...
                if (obj == null) {
                    ...
                    if (atomicLong2.compareAndSet(j, (j & (-1073741824)) | j3)) {
