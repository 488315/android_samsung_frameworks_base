    ...
    */
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        if (i2 == 0) {
            ...
            Object objEmit = flowCollector.emit(r2, anonymousClass1);
        ...
        FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1 flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1 = (FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1) anonymousClass1.L$0;
        ResultKt.throwOnFailure(obj);
        ref$ObjectRef = ref$ObjectRef2;
        this = flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1;
        flowCollector2 = flowCollector3;
        Flow flow = this.$this_runningFold$inlined;
        FlowKt__TransformKt$runningFold$1$1 flowKt__TransformKt$runningFold$1$1 = new FlowKt__TransformKt$runningFold$1$1(ref$ObjectRef, this.$operation$inlined, flowCollector2);
