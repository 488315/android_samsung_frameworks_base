...
final class ChannelFlowTransformLatest$flowCollect$3$1$emit$1 extends ContinuationImpl {
    ...
    public ChannelFlowTransformLatest$flowCollect$3$1$emit$1(ChannelFlowTransformLatest.AnonymousClass3.AnonymousClass1 anonymousClass1, Continuation continuation) {
        super(continuation);
