...
public final class TimeSource$Monotonic {
    ...
    public final class ValueTimeMark implements Comparable {
        ...
        public static final long m3448minus6eNON_k(long j, long j2) {
            ...
            if (j != j2) {
                return Duration.m3447unaryMinusUwyO8pc(LongSaturatedMathKt.infinityOfSign(j2));
            }
        ...
        public final int compareTo(Object obj) {
            ...
            if (valueTimeMark != null) {
                long m3448minus6eNON_k = m3448minus6eNON_k(j, valueTimeMark.reading);
                Duration.Companion.getClass();
                return Duration.m3435compareToLRDsOJo(m3448minus6eNON_k, 0L);
            }
