...
public final class C1238SegmentedByteString extends ByteString {
    public final transient int[] directory;
    public final transient byte[][] segments;

    public C1238SegmentedByteString(byte[][] bArr, int[] iArr) {
    ...
    public final boolean rangeEquals(int i, int i2, int i3, byte[] bArr) {
        ...
        while (i < i4) {
            ...
            int i7 = iArr[this.segments.length + iSegment];
            int iMin = Math.min(i4, i6 + i5) - i;
            if (!SegmentedByteString.arrayRangeEquals(this.segments[iSegment], (i - i5) + i7, i2, bArr, iMin)) {
                return false;
            }
            i2 += iMin;
            i += iMin;
    ...
    public final ByteString substring(int i, int i2) {
        ...
        int iSegment = okio.internal.SegmentedByteString.segment(this, i);
        int iSegment2 = okio.internal.SegmentedByteString.segment(this, i2 - 1);
        byte[][] bArr = this.segments;
        int i4 = iSegment2 + 1;
        ...
        int i8 = iSegment != 0 ? this.directory[iSegment - 1] : 0;
        int length = bArr2.length;
        iArr[length] = (i - i8) + iArr[length];
        return new C1238SegmentedByteString(bArr2, iArr);
    }
    ...
    public final void write$external__okio__android_common__okio_lib(Buffer buffer, int i) {
        int iSegment = okio.internal.SegmentedByteString.segment(this, 0);
        int i2 = 0;
        while (i2 < i) {
            int i3 = iSegment == 0 ? 0 : this.directory[iSegment - 1];
            int[] iArr = this.directory;
            int i4 = iArr[iSegment] - i3;
            int i5 = iArr[this.segments.length + iSegment];
            int iMin = Math.min(i, i4 + i3) - i2;
            int i6 = (i2 - i3) + i5;
            Segment segment = new Segment(this.segments[iSegment], i6, i6 + iMin, true, false);
    ...
    public final boolean rangeEquals(int i, ByteString byteString, int i2) {
        if (i >= 0 && i <= getSize$external__okio__android_common__okio_lib() - i2) {
            ...
            while (i < i3) {
                ...
                if (byteString.rangeEquals(i4, (i - i5) + i7, iMin, this.segments[iSegment])) {
                    i4 += iMin;
                    i += iMin;
                    iSegment++;
                }
