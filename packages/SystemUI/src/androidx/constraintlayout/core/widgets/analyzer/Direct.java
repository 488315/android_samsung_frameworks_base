...
public class Direct {
    ...
    public static boolean canMeasure(ConstraintWidget constraintWidget) {
        ...
        return (constraintWidget.mDimensionRatio > 0.0f && (z || z2)) || (z && z2);
    }
    ...
    public static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (hashSet != null && anchor.mHasFinalValue) {
            ...
            while (it.hasNext()) {
                ...
                } else if (dimensionBehaviour == dimensionBehaviour2 && constraintWidget2.mMatchConstraintMaxWidth >= 0 && constraintWidget2.mMatchConstraintMinWidth >= 0 && (constraintWidget2.mVisibility == 8 || (constraintWidget2.mMatchConstraintDefaultWidth == 0 && constraintWidget2.mDimensionRatio == 0.0f))) {
                    if (!constraintWidget2.isInHorizontalChain() && !constraintWidget2.mInVirtualLayout && z2 && !constraintWidget2.isInHorizontalChain()) {
    ...
    public static void verticalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ...
        if (hashSet != null && anchor.mHasFinalValue) {
            ...
            while (it.hasNext()) {
                ...
                char c4 = ((constraintAnchor5 == constraintAnchor6 && (constraintAnchor4 = constraintAnchor7.mTarget) != null && constraintAnchor4.mHasFinalValue) || (constraintAnchor5 == constraintAnchor7 && (constraintAnchor3 = constraintAnchor6.mTarget) != null && constraintAnchor3.mHasFinalValue)) ? c3 : (char) 0;
        ...
        if (hashSet2 != null && anchor2.mHasFinalValue) {
            ...
            while (it2.hasNext()) {
                ...
                } else if (dimensionBehaviour3 == dimensionBehaviour4 && constraintWidget3.mMatchConstraintMaxHeight >= 0 && constraintWidget3.mMatchConstraintMinHeight >= 0 && (constraintWidget3.mVisibility == 8 || (constraintWidget3.mMatchConstraintDefaultHeight == 0 && constraintWidget3.mDimensionRatio == 0.0f))) {
                    ...
                    if (!constraintWidget4.isMeasureRequested()) {
                        ...
                        if (constraintAnchor11 == constraintAnchor12) {
                            ...
                            if (constraintWidget4.mHasBaseline) {
                                ...
                                constraintWidget4.mResolvedVertical = z2;
                                c = z2;
                            } else {
                                c = c6 == true ? 1 : 0;
                            }
        ...
        constraintWidget.mVerticalSolvingPass = c6;
    }
}
