    ...
    public class Model {
        ...
        public final void build() throws Resources.NotFoundException {
                ...
                if (motionController2 == null) {
                    ...
                    if (constraintSet != null) {
                        ...
                        if (widget != null) {
                            ...
                            motionController2.mQuantizeMotionInterpolator = interpolatorLoadInterpolator;
                        } else {
                            i = childCount;
                            sparseArray = sparseArray2;
                            iArr = iArr2;
                        ...
                        if (motionLayout.mInRotation) {
                            ...
                            int i8 = motionLayout.mRotatMode;
                            int i9 = motionLayout.mPreRotateWidth;
                            int i10 = motionLayout.mPreRotateHeight;
                            motionPaths.mTime = 0.0f;
                            motionPaths.mPosition = 0.0f;
                            Rect rect = new Rect();
                            if (i8 == 1) {
                                int i11 = viewState.left;
                                int i12 = viewState.right;
                                int i13 = viewState.top;
                                int i14 = viewState.bottom;
                                int i15 = ((i13 + i14) - (i12 - i11)) / 2;
                                rect.left = i15;
                                int i16 = i9 - (((i14 - i13) + (i11 + i12)) / 2);
                                rect.top = i16;
                                rect.right = (i12 - i11) + i15;
                                rect.bottom = (i14 - i13) + i16;
                            } else if (i8 == 2) {
                                int i17 = viewState.left;
                                int i18 = viewState.right;
                                int i19 = i17 + i18;
                                int i20 = viewState.top;
                                int i21 = viewState.bottom;
                                int i22 = i10 - (((i18 - i17) + (i20 + i21)) / 2);
                                rect.left = i22;
                                int i23 = (i19 - (i21 - i20)) / 2;
                                rect.top = i23;
                                rect.right = (i18 - i17) + i22;
                            ...
                            if (i8 == 1) {
                                motionConstrainedPoint.mRotation = f - 90.0f;
                            } else if (i8 == 2) {
                                motionConstrainedPoint.mRotation = f + 90.0f;
                            }
                        }
                    ...
                    model = this;
                    if (model.mEnd != null) {
                        ConstraintWidget widget2 = getWidget(model.mLayoutEnd, childAt2);
                        if (widget2 != null) {
                            Rect rectAccess$20002 = MotionLayout.access$2000(motionLayout, widget2);
                            ConstraintSet constraintSet3 = model.mEnd;
                            int width2 = motionLayout.getWidth();
                            int height2 = motionLayout.getHeight();
                            int i24 = constraintSet3.mRotate;
                            if (i24 != 0) {
                                MotionController.rotate(rectAccess$20002, motionController2.mTempRect, i24, width2, height2);
                                rectAccess$20002 = motionController2.mTempRect;
                            }
                            ...
                            motionPaths2.setBounds(rectAccess$20002.left, rectAccess$20002.top, rectAccess$20002.width(), rectAccess$20002.height());
                            motionPaths2.applyParameters(constraintSet3.getParameters(motionController2.mId));
                            motionController2.mEndPoint.setState(rectAccess$20002, constraintSet3, i24, motionController2.mId);
            ...
            while (i26 < i25) {
                ...
                MotionController motionController3 = (MotionController) sparseArray4.get(iArr3[i26]);
                int i27 = motionController3.mStartMotionPath.mAnimateRelativeTo;
                if (i27 != -1) {
                    MotionController motionController4 = (MotionController) sparseArray4.get(i27);
