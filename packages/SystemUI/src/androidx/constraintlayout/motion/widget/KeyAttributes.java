        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (sparseIntArray2.get(index)) {
                ...
                case 18:
                    ...
                    break;
                case 19:
                    this.mPivotX = typedArrayObtainStyledAttributes.getDimension(index, this.mPivotX);
                    break;
                case 20:
                    this.mPivotY = typedArrayObtainStyledAttributes.getDimension(index, this.mPivotY);
                    break;
            }
        }
    }
