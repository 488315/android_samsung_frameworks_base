        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(TransitionKt$$ExternalSyntheticOutline0.m(new StringBuilder("Left to "), sideToString(i3), " undefined"));
                    }
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(TransitionKt$$ExternalSyntheticOutline0.m(new StringBuilder("right to "), sideToString(i3), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(TransitionKt$$ExternalSyntheticOutline0.m(sb, sideToString(i3), " unknown"));
        }
    }
