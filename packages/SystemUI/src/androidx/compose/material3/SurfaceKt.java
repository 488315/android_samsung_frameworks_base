...
public abstract class SurfaceKt {
    public static final DynamicProvidableCompositionLocal LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(new Function0() { // from class: androidx.compose.material3.SurfaceKt$LocalAbsoluteTonalElevation$1
        ...
        public final Object invoke() {
            return Dp.m835boximpl(0);
        }
    });

    /* renamed from: Surface-T9BRK9s, reason: not valid java name */
    public static final void m303SurfaceT9BRK9s(Modifier modifier, Shape shape, final long j, long j2, float f, float f2, BorderStroke borderStroke, final ComposableLambdaImpl composableLambdaImpl, Composer composer, int i, int i2) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 8) != 0) {
            j2 = ColorSchemeKt.m258contentColorForek8zF_U(j, composer);
        }
        if ((i2 & 16) != 0) {
            f = 0;
        ...
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.LocalContentColor.defaultProvidedValue$runtime_release(Color.m454boximpl(j2)), dynamicProvidableCompositionLocal.defaultProvidedValue$runtime_release(Dp.m835boximpl(f3))}, ComposableLambdaKt.rememberComposableLambda(-70914509, new Function2() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final Object invoke(Object obj, Object obj2) {
                ...
                then = SemanticsModifierKt.semantics(SurfaceKt.m305access$surfaceXOJAsU(Modifier.this, shape2, SurfaceKt.m306access$surfaceColorAtElevationCLU3JFs(j, f3, composer2), borderStroke2, ((Density) composerImpl3.consume(CompositionLocalsKt.LocalDensity)).mo57toPx0680j_4(f4)), false, new Function1() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.2
    ...
    public static final void m304Surfaceo_FOJdg(final Function0 function0, Modifier modifier, boolean z, final Shape shape, final long j, long j2, float f, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final ComposableLambdaImpl composableLambdaImpl, Composer composer, int i, int i2) {
        final Modifier modifier2 = (i2 & 2) != 0 ? Modifier.Companion : modifier;
        final boolean z2 = (i2 & 4) != 0 ? true : z;
        long m258contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m258contentColorForek8zF_U(j, composer) : j2;
        float f2 = 0;
        Dp.Companion companion = Dp.Companion;
        ...
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.LocalContentColor.defaultProvidedValue$runtime_release(Color.m454boximpl(m258contentColorForek8zF_U)), dynamicProvidableCompositionLocal.defaultProvidedValue$runtime_release(Dp.m835boximpl(f4))}, ComposableLambdaKt.rememberComposableLambda(1279702876, new Function2() { // from class: androidx.compose.material3.SurfaceKt$Surface$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final Object invoke(Object obj, Object obj2) {
                ...
                then = ClickableKt.m34clickableO2vRcR0$default(SurfaceKt.m305access$surfaceXOJAsU(modifier3.then(MinimumInteractiveModifier.INSTANCE), shape, SurfaceKt.m306access$surfaceColorAtElevationCLU3JFs(j, f4, composer2), borderStroke2, ((Density) composerImpl4.consume(CompositionLocalsKt.LocalDensity)).mo57toPx0680j_4(f3)), mutableInteractionSource2, RippleKt.m280rippleH2RKhps$default(0.0f, false, 7), z2, null, null, function0, 24).then(new ChildSemanticsNodeElement(new Function1() { // from class: androidx.compose.material3.internal.ChildParentSemanticsKt$childSemantics$1
                    @Override // kotlin.jvm.functions.Function1
                    /* renamed from: invoke */
                ...
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(composerImpl4, then2);
                ComposeUiNode.Companion.getClass();
    ...
    public static final Modifier m305access$surfaceXOJAsU(Modifier modifier, Shape shape, long j, BorderStroke borderStroke, float f) {
        Shape shape2;
        Modifier modifier2;
        if (f > 0.0f) {
            shape2 = shape;
            modifier2 = GraphicsLayerModifierKt.m476graphicsLayerAp8cVGQ$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, f, shape2, 124895);
        } else {
            shape2 = shape;
        ...
        if (borderStroke != null) {
            modifier3 = BorderKt.m29borderziNgDLE(modifier3, borderStroke.width, borderStroke.brush, shape2);
        }
        return ClipKt.clip(BackgroundKt.m26backgroundbw27NRU(then.then(modifier3), j, shape2), shape2);
    }

    /* renamed from: access$surfaceColorAtElevation-CLU3JFs, reason: not valid java name */
    public static final long m306access$surfaceColorAtElevationCLU3JFs(long j, float f, Composer composer) {
        if (ComposerKt.isTraceInProgress()) {
        ...
        boolean booleanValue = ((Boolean) ((ComposerImpl) composer).consume(ColorSchemeKt.LocalTonalElevationEnabled)).booleanValue();
