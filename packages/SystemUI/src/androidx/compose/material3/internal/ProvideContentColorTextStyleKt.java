...
public abstract class ProvideContentColorTextStyleKt {
    ...
    public static final void m320ProvideContentColorTextStyle3JVO9M(final long j, final TextStyle textStyle, final Function2 function2, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 147) == 146 && composerImpl.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.LocalContentColor.defaultProvidedValue$runtime_release(Color.m454boximpl(j)), dynamicProvidableCompositionLocal.defaultProvidedValue$runtime_release(((TextStyle) composerImpl.consume(dynamicProvidableCompositionLocal)).merge(textStyle))}, function2, composerImpl, ((i2 >> 3) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.block = new Function2() { // from class: androidx.compose.material3.internal.ProvideContentColorTextStyleKt$ProvideContentColorTextStyle$1
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    ProvideContentColorTextStyleKt.m320ProvideContentColorTextStyle3JVO9M(j, textStyle, function2, (Composer) obj, RecomposeScopeImplKt.updateChangedFlags(i | 1));
