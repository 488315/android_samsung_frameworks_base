...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public final MeasureResult mo4measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!measureScope.isLookingAhead() || !this.didLookahead) {
            Pair pair = (Pair) this.anchors.invoke(IntSize.m861boximpl(IntSizeKt.IntSize(placeableMo610measureBRTryo0.width, placeableMo610measureBRTryo0.height)), Constraints.m815boximpl(j));
        ...
        return measureScope.layout$1(placeableMo610measureBRTryo0.width, placeableMo610measureBRTryo0.height, MapsKt__MapsKt.emptyMap(), new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$measure$1
            ...
            public final Object mo781invoke(Object obj) {
                ...
                final float fPositionOf = measureScope.isLookingAhead() ? ((MapDraggableAnchors) this.state.getAnchors()).positionOf(this.state.targetValue$delegate.getValue()) : this.state.requireOffset();
                ...
                Function1 function1 = new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$measure$1.1
                    ...
                    public final Object mo781invoke(Object obj2) {
                        ((Placeable.PlacementScope) obj2).place(placeable, MathKt__MathJVMKt.roundToInt(f), MathKt__MathJVMKt.roundToInt(fPositionOf), 0.0f);
