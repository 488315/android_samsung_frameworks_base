...
final class AnchoredDraggableState$anchoredDrag$4 extends SuspendLambda implements Function1 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (((Boolean) this.this$0.confirmValueChange.mo779invoke(this.$targetValue)).booleanValue()) {
            float positionOf = ((DefaultDraggableAnchors) this.this$0.getAnchors()).positionOf(this.$targetValue);
            AnchoredDraggableState<Object> anchoredDraggableState3 = this.this$0;
            anchoredDraggableState3.anchoredDragScope.dragTo(positionOf, ((SnapshotMutableFloatStateImpl) anchoredDraggableState3.lastVelocity$delegate).getFloatValue());
