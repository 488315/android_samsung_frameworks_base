...
final class AnchoredDraggableState$anchoredDrag$2 extends SuspendLambda implements Function1 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Object closestAnchor = ((DefaultDraggableAnchors) this.this$0.getAnchors()).closestAnchor(((SnapshotMutableFloatStateImpl) this.this$0.offset$delegate).getFloatValue());
        if (closestAnchor != null) {
            if (Math.abs(((SnapshotMutableFloatStateImpl) this.this$0.offset$delegate).getFloatValue() - ((DefaultDraggableAnchors) this.this$0.getAnchors()).positionOf(closestAnchor)) < 0.5f && ((Boolean) this.this$0.confirmValueChange.mo779invoke(closestAnchor)).booleanValue()) {
                ((SnapshotMutableStateImpl) this.this$0.settledValue$delegate).setValue(closestAnchor);
