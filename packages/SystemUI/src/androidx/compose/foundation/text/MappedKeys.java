...
public final class MappedKeys {
    ...
    public static final long Paste = Key_androidKt.Key(IKnoxCustomManager.Stub.TRANSACTION_setForceSingleView);
    public static final long Cut = Key_androidKt.Key(IKnoxCustomManager.Stub.TRANSACTION_clearForcedDisplaySizeDensity);
    public static final long Copy = Key_androidKt.Key(IKnoxCustomManager.Stub.TRANSACTION_startSmartView);
