...
final class PagerKt$pagerSemantics$performForwardPaging$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (pagerState.getCurrentPage() + 1 >= pagerState.getPageCount() || (objAnimateScrollToPage = pagerState.animateScrollToPage(pagerState.getCurrentPage() + 1, AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7), this)) != obj2) {
