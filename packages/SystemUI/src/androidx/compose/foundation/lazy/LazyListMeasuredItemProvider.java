...
public abstract class LazyListMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public static LazyListMeasuredItem m156getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i) {
        ...
        return lazyListMeasuredItemProvider.mo151createItemX9ElhV4(i, lazyListItemProviderImpl.getKey(i), lazyListItemProviderImpl.intervalContent.getContentType(i), ((LazyLayoutMeasureScopeImpl) lazyListMeasuredItemProvider.measureScope).m170measure0kLqBqw(i, j), j);
    }

    /* renamed from: createItem-X9ElhV4 */
    public abstract LazyListMeasuredItem mo151createItemX9ElhV4(int i, Object obj, Object obj2, List list, long j);
    ...
    public final LazyLayoutMeasuredItem mo157getAndMeasurehBUhpc(int i, int i2, int i3, long j) {
        ...
        return mo151createItemX9ElhV4(i, lazyListItemProviderImpl.getKey(i), lazyListItemProviderImpl.intervalContent.getContentType(i), ((LazyLayoutMeasureScopeImpl) this.measureScope).m170measure0kLqBqw(i, j), j);
    }
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m823getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m822getMaxHeightimpl(j), 5);
    }
}
