...
final /* synthetic */ class LegacyDragSourceNodeWithDefaultPainter$cacheDrawScopeDragShadowCallback$1$1 extends FunctionReferenceImpl implements Function1 {
    ...
    public final DrawResult mo781invoke(CacheDrawScope cacheDrawScope) {
        ...
        function0.getClass();
        GraphicsLayer graphicsLayerCreateGraphicsLayer = ((GraphicsContext) function0.invoke()).createGraphicsLayer();
        CacheDrawScope.m362recordTdoYBX4$default(cacheDrawScope, graphicsLayerCreateGraphicsLayer, new Function1() { // from class: androidx.compose.foundation.draganddrop.CacheDrawScopeDragShadowCallback$cachePicture$1$1$1
            @Override // kotlin.jvm.functions.Function1
            /* renamed from: invoke */
        ...
        cacheDrawScopeDragShadowCallback.graphicsLayer = graphicsLayerCreateGraphicsLayer;
