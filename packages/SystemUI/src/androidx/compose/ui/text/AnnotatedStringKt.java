    ...
    public static final List getLocalAnnotations(AnnotatedString annotatedString, int i, int i2, Function1 function1) {
        ...
        if (i != 0 || i2 < annotatedString.text.length()) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if ((function1 != null ? ((Boolean) ((AnnotatedStringKt$substringWithoutParagraphStyles$1) function1).mo779invoke(range.item)).booleanValue() : true) && intersect(i, i2, range.start, range.end)) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (((Boolean) ((AnnotatedStringKt$substringWithoutParagraphStyles$1) function1).mo779invoke(((AnnotatedString.Range) obj).item)).booleanValue()) {
                arrayList2.add(obj);
            }
        }
        return arrayList2;
