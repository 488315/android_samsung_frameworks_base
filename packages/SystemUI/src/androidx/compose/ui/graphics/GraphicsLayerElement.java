...
public final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public final int hashCode() {
        int iM = FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.cameraDistance, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.rotationZ, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.rotationY, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.rotationX, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.shadowElevation, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.translationY, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.translationX, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.alpha, FlingCalculator$FlingInfo$$ExternalSyntheticOutline0.m(this.scaleY, Float.hashCode(this.scaleX) * 31, 31), 31), 31), 31), 31), 31), 31), 31), 31);
        TransformOrigin.Companion companion = TransformOrigin.Companion;
        int iM2 = TransitionData$$ExternalSyntheticOutline0.m((this.shape.hashCode() + MoveResult$$ExternalSyntheticOutline0.m(iM, 31, this.transformOrigin)) * 31, 31, this.clip);
        RenderEffect renderEffect = this.renderEffect;
        int iHashCode = (iM2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31;
        Color.Companion companion2 = Color.Companion;
        int i = ULong.$r8$clinit;
        int iM3 = MoveResult$$ExternalSyntheticOutline0.m(MoveResult$$ExternalSyntheticOutline0.m(iHashCode, 31, this.ambientShadowColor), 31, this.spotShadowColor);
        CompositingStrategy.Companion companion3 = CompositingStrategy.Companion;
        int iM4 = ReorderTile$$ExternalSyntheticOutline0.m(this.compositingStrategy, iM3, 31);
        BlendMode.Companion companion4 = BlendMode.Companion;
        int iM5 = ReorderTile$$ExternalSyntheticOutline0.m(this.blendMode, iM4, 31);
        ColorFilter colorFilter = this.colorFilter;
        return iM5 + (colorFilter != null ? colorFilter.hashCode() : 0);
    }
    ...
    public final void update(Modifier.Node node) {
        ...
        NodeCoordinator nodeCoordinator = DelegatableNodeKt.m634requireCoordinator64DMado(simpleGraphicsLayerModifier, 2).wrapped;
