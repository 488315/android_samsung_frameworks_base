...
public abstract class GraphicsLayerModifierKt {
    ...
    public static Modifier m478graphicsLayerAp8cVGQ$default(Modifier modifier, float f, float f2, float f3, float f4, Shape shape, int i) {
        ...
        return modifier.then(new GraphicsLayerElement(f5, f6, f7, 0.0f, 0.0f, f8, 0.0f, 0.0f, 0.0f, 8.0f, j, shape2, false, null, j2, j2, 0, BlendMode.SrcOver, null, null));
    }

    /* renamed from: graphicsLayer-_6ThJ44$default, reason: not valid java name */
    public static Modifier m479graphicsLayer_6ThJ44$default(Modifier modifier, float f, float f2, float f3, float f4, float f5, Shape shape, boolean z, int i, int i2) {
        int i3;
