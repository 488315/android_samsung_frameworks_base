...
public abstract class Adaptation {
    public static final Adaptation$Companion$Bradford$1 Bradford;
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [androidx.compose.ui.graphics.colorspace.Adaptation$Companion$Bradford$1] */
    static {
        ...
        new Adaptation(fArr2) { // from class: androidx.compose.ui.graphics.colorspace.Adaptation$Companion$VonKries$1
            {
                DefaultConstructorMarker defaultConstructorMarker = null;
            }
        ...
        new Adaptation(fArr3) { // from class: androidx.compose.ui.graphics.colorspace.Adaptation$Companion$Ciecat02$1
            {
                DefaultConstructorMarker defaultConstructorMarker = null;
            }
