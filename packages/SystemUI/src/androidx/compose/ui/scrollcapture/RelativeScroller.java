...
final class RelativeScroller {
    ...
    */
    public final Object scrollBy(float f, ContinuationImpl continuationImpl) {
        ...
        if (i2 == 0) {
            ...
            objInvoke = this.scrollBy.invoke(f2, anonymousClass1);
            ...
            this = (RelativeScroller) anonymousClass1.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
