...
public class SeslColorPicker extends LinearLayout {
    ...
    public final View mCurrentColorContainer;
    ...
    public final SeslOpacitySeekBar mOpacitySeekBar;
    public final FrameLayout mOpacitySeekBarContainer;
    ...
    public SeslColorPicker(Context context, AttributeSet attributeSet) throws Resources.NotFoundException {
        ...
        for (int i4 = 0; i4 < 6; i4++) {
            View childAt = this.mRecentColorListLayout.getChildAt(i4);
