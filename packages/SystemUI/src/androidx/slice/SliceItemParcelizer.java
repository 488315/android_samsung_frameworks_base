    ...
    */
    public static SliceItem read(VersionedParcel versionedParcel) {
        ...
        if (sliceItemHolder != null) {
            ...
            SliceProviderCompat.AnonymousClass2 anonymousClass2 = SliceItemHolder.sHandler;
            if (anonymousClass2 != null) {
                anonymousClass2.handle(sliceItemHolder);
            }
            str.getClass();
            switch (str.hashCode()) {
                case -1422950858:
    ...
    public static void write(SliceItem sliceItem, VersionedParcel versionedParcel) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
