...
public class TemplateView extends SliceChildView {
    ...
    public final void resetView() {
        ...
        this.mAdapter.setSliceItems(2, null);
    ...
    @Override // androidx.slice.widget.SliceChildView
    public final void setSliceActionListener(VolumePanelDialog$$ExternalSyntheticLambda5 volumePanelDialog$$ExternalSyntheticLambda5) {
        this.mObserver = volumePanelDialog$$ExternalSyntheticLambda5;
        SliceAdapter sliceAdapter = this.mAdapter;
        if (sliceAdapter != null) {
            sliceAdapter.mSliceObserver = volumePanelDialog$$ExternalSyntheticLambda5;
        }
    }
    ...
    public final void updateDisplayedItems(int i) {
        ...
        sliceAdapter.setSliceItems(2, list2);
