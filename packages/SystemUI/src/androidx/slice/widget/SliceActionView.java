...
public class SliceActionView extends FrameLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public final void setAction(SliceActionImpl sliceActionImpl, EventInfo eventInfo, VolumePanelDialog$$ExternalSyntheticLambda5 volumePanelDialog$$ExternalSyntheticLambda5, int i, SliceAdapter sliceAdapter) {
        View view = this.mActionView;
        if (view != null) {
            removeView(view);
        ...
        if (zIsDefaultToggle) {
            ...
            if (i != -1) {
                ...
                if (colorAttr2 == 0) {
                    colorAttr2 = getContext().getColor(com.android.systemui.R.color.switch_thumb_normal_material_light);
                }
