    ...
    public FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ...
        ?? r2 = new RecyclerView.OnScrollListener() { // from class: androidx.recyclerview.widget.FastScroller.2
            ...
            public final void onScrolled(RecyclerView recyclerView2, int i4, int i5) {
                ...
                boolean z = iComputeHorizontalScrollRange - i9 > 0 && i9 >= i8;
                ...
                if (z2) {
                    ...
                    fastScroller.mVerticalThumbHeight = Math.min(i6, (i6 * i6) / iComputeVerticalScrollRange);
                }
                if (fastScroller.mNeedHorizontalScrollbar) {
                    ...
                    fastScroller.mHorizontalThumbWidth = Math.min(i9, (i9 * i9) / iComputeHorizontalScrollRange);
                }
        ...
        if (motionEvent.getAction() == 2 && this.mState == 2) {
            ...
            if (i == 1) {
                ...
                if (Math.abs(this.mHorizontalThumbCenterX - fMax) >= 2.0f) {
                    int iScrollTo = scrollTo(this.mHorizontalDragX, fMax, iArr, this.mRecyclerView.computeHorizontalScrollRange(), this.mRecyclerView.computeHorizontalScrollOffset(), this.mRecyclerViewWidth);
                    if (iScrollTo != 0) {
            ...
            if (this.mDragState == 2) {
                ...
                if (Math.abs(this.mVerticalThumbCenterY - fMax2) < 2.0f) {
                    return;
                }
                int iScrollTo2 = scrollTo(this.mVerticalDragY, fMax2, iArr2, this.mRecyclerView.computeVerticalScrollRange(), this.mRecyclerView.computeVerticalScrollOffset(), this.mRecyclerViewHeight);
                if (iScrollTo2 != 0) {
                    this.mRecyclerView.scrollBy(0, iScrollTo2);
                }
                this.mVerticalDragY = fMax2;
            }
        }
    }
