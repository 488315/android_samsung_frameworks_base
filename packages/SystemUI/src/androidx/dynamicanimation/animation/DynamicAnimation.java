...
public abstract class DynamicAnimation implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final AnonymousClass13 SCROLL_X = null;
    public static final AnonymousClass14 SCROLL_Y = null;
    ...
    public static final AnonymousClass9 X = new ViewProperty("x") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.9
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public final float getValue(Object obj) {
    ...
    public static final AnonymousClass10 Y = new ViewProperty("y") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.10
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public final float getValue(Object obj) {
    ...
    /* JADX WARN: Type inference failed for: r0v8, types: [androidx.dynamicanimation.animation.DynamicAnimation$9] */
    /* JADX WARN: Type inference failed for: r0v9, types: [androidx.dynamicanimation.animation.DynamicAnimation$10] */
    static {
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [android.animation.ValueAnimator$DurationScaleChangeListener, androidx.dynamicanimation.animation.AnimationHandler$DurationScaleChangeListener33$$ExternalSyntheticLambda0] */
    public void start() {
        if (!getAnimationHandler().mScheduler.isCurrentThread()) {
