...
public class WindowInsetsCompat {
    ...
    public class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i, boolean z) {
            ...
            if (i != 8) {
                ...
                return displayCutout != null ? Insets.of(displayCutout.mDisplayCutout.getSafeInsetLeft(), displayCutout.mDisplayCutout.getSafeInsetTop(), displayCutout.mDisplayCutout.getSafeInsetRight(), displayCutout.mDisplayCutout.getSafeInsetBottom()) : Insets.NONE;
            }
    ...
    public final class Type {
        ...
        public static int indexOf(int i) {
            ...
            throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m(i, "type needs to be >= FIRST and <= LAST, type="));
        }
    }
