...
public final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, View.OnKeyListener {
    ...
    public final boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        if (!menuPopupHelper.isShowing()) {
            ...
            menuPopupHelper.showPopup(true, true);
        }
    ...
    public final void show() {
        ...
        if (!z && (appCompatPopupWindow = this.mPopup.mPopup) != null && (declaredMethod = SeslBaseReflector.getDeclaredMethod(SeslPopupWindowReflector.mClass, "setAllowScrollingAnchorParent", Boolean.TYPE)) != null) {
            SeslBaseReflector.invoke(appCompatPopupWindow, declaredMethod, Boolean.valueOf(z));
        }
        ...
        boolean z3 = this.mIsSubMenu;
        this.mTmpListView = z3 ? null : dropDownListView;
        if (this.mShowTitle && this.mMenu.mHeaderTitle != null && !z3) {
