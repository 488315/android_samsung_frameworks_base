...
public final class MenuItemImpl implements SupportMenuItem, SeslMenuItem {
    ...
    public final MenuItem setChecked(boolean z) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            MenuItemImpl menuItemImpl = (MenuItemImpl) menuBuilder.mItems.get(i4);
            if (menuItemImpl.mGroup == i3 && (menuItemImpl.mFlags & 4) != 0 && menuItemImpl.isCheckable()) {
    ...
    @Override // androidx.core.internal.view.SupportMenuItem
    public final void setSeslNaviMenuItemType() {
        this.mMenu.onItemsChanged(false);
    }
