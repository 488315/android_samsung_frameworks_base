...
public final class BooleanArrayList extends AbstractProtobufList implements RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public final void add(int i, Object obj) {
        ...
        if (i2 < zArr.length) {
            ...
            boolean[] zArr2 = new boolean[BooleanArrayList$$ExternalSyntheticOutline0.m(i2, 3, 2, 1)];
    ...
    public final void addBoolean(boolean z) {
        ...
        boolean[] zArr = this.array;
        if (i == zArr.length) {
            boolean[] zArr2 = new boolean[BooleanArrayList$$ExternalSyntheticOutline0.m(i, 3, 2, 1)];
            System.arraycopy(zArr, 0, zArr2, 0, i);
            this.array = zArr2;
        }
