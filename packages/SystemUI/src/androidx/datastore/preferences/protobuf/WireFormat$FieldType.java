...
public class WireFormat$FieldType {
    ...
    static {
        ...
        String str = "STRING";
        WireFormat$FieldType wireFormat$FieldType9 = new WireFormat$FieldType(str, 8, WireFormat$JavaType.STRING, 2) { // from class: androidx.datastore.preferences.protobuf.WireFormat$FieldType.1
        };
