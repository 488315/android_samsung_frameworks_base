...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        if (classAttribute != null && findFragmentById == null) {
            ...
            if (!backStackRecord.mAddToBackStack) {
                ...
                if (fragmentManager2.mHost != null && !fragmentManager2.mDestroyed) {
                    ...
                    BackStackRecord backStackRecord2 = fragmentManager2.mTransitioningOp;
                    if (backStackRecord2 != null) {
                        backStackRecord2.mCommitted = false;
                        if (FragmentManager.isLoggingEnabled(3)) {
                            Log.d("FragmentManager", "Reversing mTransitioningOp " + fragmentManager2.mTransitioningOp + " as part of execSingleAction for action " + backStackRecord);
                        }
                        fragmentManager2.mTransitioningOp.commitInternal(false, false);
                        fragmentManager2.mTransitioningOp.generateOps(fragmentManager2.mTmpRecords, fragmentManager2.mTmpIsPop);
                        ArrayList arrayList = fragmentManager2.mTransitioningOp.mOps;
                        ...
                        fragmentManager2.mTransitioningOp = null;
                    }
        ...
        ArrayList arrayList2 = (ArrayList) fragmentManager.mFragmentStore.getActiveFragmentStateManagers();
        int size2 = arrayList2.size();
        while (i < size2) {
            Object obj2 = arrayList2.get(i);
            i++;
            FragmentStateManager fragmentStateManager = (FragmentStateManager) obj2;
