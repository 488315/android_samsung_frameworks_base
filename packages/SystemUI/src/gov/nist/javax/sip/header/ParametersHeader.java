        ...
        if (this != parameters) {
            ...
            while (true) {
                if (parameterNames.hasNext()) {
                    ...
                    if (((parameter == null) ^ (parameter2 == null)) || (parameter != null && !parameter.equalsIgnoreCase(parameter2))) {
                        break;
                    }
                } else {
                    ...
                    while (parameterNames2.hasNext()) {
                        ...
                        if (!((parameter3 == null) ^ (parameter4 == null)) && (parameter3 == null || parameter3.equalsIgnoreCase(parameter4))) {
                        }
                    }
                }
            }
