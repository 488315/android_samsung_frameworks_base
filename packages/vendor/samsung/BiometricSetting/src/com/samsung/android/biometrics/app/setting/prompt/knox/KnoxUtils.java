...
public abstract class KnoxUtils {
    ...
    public static int getAdminUid(Context context, int i) {
        try {
    ...
    public static int getDisplayRotation(Context context) {
        int rotation =
                ((DisplayManager) context.getSystemService("display")).getDisplay(0).getRotation();
        if (rotation == 0) {
            return 0;
        }
        if (rotation == 1) {
        ...
        KnoxContainerManager knoxContainerManager =
                EnterpriseKnoxManager.getInstance()
                        .getKnoxContainerManager(
                                context, new ContextInfo(getAdminUid(context, i), i));
