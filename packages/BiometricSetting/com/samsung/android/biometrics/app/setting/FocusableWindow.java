...
public abstract class FocusableWindow extends SysUiWindow implements ViewTreeObserver.OnWindowFocusChangeListener {
        ...
        this.mRunnableHandleWindowFocus = new Runnable() { // from class: com.samsung.android.biometrics.app.setting.FocusableWindow$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ...
                try {
                    ...
                    DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("hasFocus: "), focusableWindow.getLogTag());
                }
                if (view != null) {
    ...
    public void addView() {
        ...
        if (this.mCloseSystemDialogBR == null) {
            ...
            try {
                ...
                getContext().registerReceiverAsUser(this.mCloseSystemDialogBR, UserHandle.ALL, intentFilter, null, this.f22mH);
            } catch (Exception e) {
                DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("registerBroadcastReceiverForSystemDialog: "), getLogTag());
            }
        }
        super.addView();
    }
    ...
    protected void onAttachedToWindow(View view) {
        ...
        if (focusableWindow$$ExternalSyntheticLambda0 != null) {
            this.f22mH.postDelayed(focusableWindow$$ExternalSyntheticLambda0, 500L);
        }
    }
    ...
    public void removeView() {
        this.f22mH.removeCallbacks(this.mRunnableHandleWindowFocus);
        if (this.mCloseSystemDialogBR != null) {
            try {
                getContext().unregisterReceiver(this.mCloseSystemDialogBR);
                this.mCloseSystemDialogBR = null;
            } catch (Exception e) {
                DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("unregisterBroadcastReceiverForSystemDialog: "), getLogTag());
            }
        }
        super.removeView();
    }
