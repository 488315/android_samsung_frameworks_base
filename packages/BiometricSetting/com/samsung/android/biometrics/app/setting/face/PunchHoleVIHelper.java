...
public final class PunchHoleVIHelper {
    ...
    public final String getAnimationName(boolean z) {
        ...
        String m1m = (z || Utils.isNightThemeOn(this.mContext)) ? AbstractResolvableFuture$$ExternalSyntheticOutline0.m1m(str, ".json") : AbstractResolvableFuture$$ExternalSyntheticOutline0.m1m(str, "_whitebg.json");
        Log.d("BSS_PunchHoleVIHelper", "Punch hole name : " + m1m);
        return m1m;
    }
