...
public final class Utils {
    ...
    public static int getIntDb(Context context, String str, boolean z, int i) {
        ...
        try {
            ...
            DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("getIntDb: "), "BSS_Utils");
            return i;
        }
    }
    ...
    public static long getLongDb(Context context, String str, long j) {
        try {
            ...
            DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("getLongDb: "), "BSS_Utils");
            return j;
        }
    }
    ...
    public static boolean isForegroundTask(String str) {
        try {
            ...
            DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("isForegroundTask: "), "BSS_Utils");
            return false;
        }
    }
    ...
    public static void putIntDb(Context context, String str, boolean z, int i) {
        ...
        try {
            ...
            DisplayStateManager$Injector$$ExternalSyntheticOutline0.m9m(e, new StringBuilder("putIntDb: "), "BSS_Utils");
        }
    }
