...
public final class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public final String toString() {
        ...
        String str = "";
        for (int i2 = 0; i != -1 && i2 < this.mCurrentSize; i2++) {
            StringBuilder m2m = ArrayLinkedVariables$$ExternalSyntheticOutline0.m2m(AbstractResolvableFuture$$ExternalSyntheticOutline0.m1m(str, " -> "));
            m2m.append(this.mArrayValues[i]);
            m2m.append(" : ");
            StringBuilder m2m2 = ArrayLinkedVariables$$ExternalSyntheticOutline0.m2m(m2m.toString());
            m2m2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
            str = m2m2.toString();
            i = this.mArrayNextIndices[i];
        }
        return str;
