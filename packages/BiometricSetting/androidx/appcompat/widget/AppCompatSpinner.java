...
public class AppCompatSpinner extends Spinner {
    ...
    static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new C00481();
        boolean mShowDropdown;

        /* renamed from: androidx.appcompat.widget.AppCompatSpinner$SavedState$1 */
        final class C00481 implements Parcelable.Creator<SavedState> {
    ...
    */
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i) {
        ...
        CharSequence[] textArray = obtainStyledAttributes.getTextArray();
        if (textArray != null) {
            ArrayAdapter arrayAdapter = new ArrayAdapter(context, R.layout.simple_spinner_item, textArray);
            arrayAdapter.setDropDownViewResource(com.samsung.android.biometrics.app.setting.R.layout.support_simple_spinner_dropdown_item);
