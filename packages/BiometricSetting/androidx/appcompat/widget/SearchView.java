...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new C00631();
        boolean isIconified;

        /* renamed from: androidx.appcompat.widget.SearchView$SavedState$1 */
        final class C00631 implements Parcelable.ClassLoaderCreator<SavedState> {
    ...
    */
    private void updateSubmitButton(boolean z) {
        ...
        if (z2) {
            i = 0;
            if ((z2 || this.mVoiceButtonEnabled) && !this.mIconified) {
                if (hasFocus()) {
                    if (!z) {
                    }
