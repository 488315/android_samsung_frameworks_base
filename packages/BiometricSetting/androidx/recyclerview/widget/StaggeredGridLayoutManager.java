...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new C01701();
        ...
        final class C01701 implements Parcelable.Creator<SavedState> {
    ...
    */
            ...
            if (bitSet.get(layoutParams.mSpan.mIndex)) {
                ...
                if (this.mShouldReverseLayout) {
                    ...
                    if (i3 < this.mPrimaryOrientation.getEndAfterPadding()) {
                        ...
                        Span.getLayoutParams(arrayList.get(arrayList.size() - 1)).getClass();
                        z2 = true;
                    }
                    z2 = false;
                } else {
                    ...
                    if (i4 > this.mPrimaryOrientation.getStartAfterPadding()) {
                        Span.getLayoutParams(span.mViews.get(0)).getClass();
                        z2 = true;
                    }
                    z2 = false;
                }
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new C01691();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            final class C01691 implements Parcelable.Creator<FullSpanItem> {
                @Override // android.os.Parcelable.Creator
